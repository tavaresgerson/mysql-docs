...
<table frame="box" rules="all" summary="Uma referência que lista todas as tabelas de resumo de eventos de espera do Schema de Desempenho."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td>events_waits_summary_by_account_by_event_name</td> <td>Eventos de espera por conta e nome de evento</td> </tr><tr><td>events_waits_summary_by_host_by_event_name</td> <td>Eventos de espera por nome de host e nome de evento</td> </tr><tr><td>events_waits_summary_by_instance</td> <td>Eventos de espera por instância</td> </tr><tr><td>events_waits_summary_by_thread_by_event_name</td> <td>Eventos de espera por thread e nome de evento</td> </tr><tr><td>events_waits_summary_by_user_by_event_name</td> <td>Eventos de espera por nome de usuário e nome de evento</td> </tr><tr><td>events_waits_summary_global_by_event_name</td> <td>Eventos de espera por nome de evento</td> </tr></tbody></table>

#### Resumos de Estágio

**Tabela 29.7 Tabelas de Resumo de Eventos de Mensagens do Schema de Desempenho**

<table frame="box" rules="all" summary="Uma referência que lista todas as tabelas de resumo de eventos de mensagens do Schema de Desempenho."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>statements_by_account_by_event_name</code></td> <td>Eventos de mensagens por conta e nome de evento</td> </tr><tr><td><code>statements_by_host_by_event_name</code></td> <td>Eventos de mensagens por nome de host e nome de evento</td> </tr><tr><td><code>statements_by_thread_by_event_name</code></td> <td>Eventos de mensagens por thread e nome de evento</td> </tr><tr><td><code>statements_by_user_by_event_name</code></td> <td>Eventos de mensagens por nome de usuário e nome de evento</td> </tr><tr><td><code>statements_by_event_name_global</code></td> <td>Eventos de mensagens por nome de evento</td> </tr></tbody></table>
...
<thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td>eventos_statements_histogram_by_digest</td> <td>Histogramas de declarações por esquema e valor de digest</td> </tr><tr><td>eventos_statements_histogram_global</td> <td>Histogramas de declarações resumidos globalmente</td> </tr><tr><td>events_statements_summary_by_account_by_event_name</td> <td>Eventos de declarações por conta e nome de evento</td> </tr><tr><td>events_statements_summary_by_digest</td> <td>Eventos de declarações por esquema e valor de digest</td> </tr><tr><td>events_statements_summary_by_host_by_event_name</td> <td>Eventos de declarações por nome de host e nome de evento</td> </tr><tr><td>events_statements_summary_by_program</td> <td>Eventos de declarações por programa armazenado</td> </tr><tr><td>events_statements_summary_by_thread_by_event_name</td> <td>Eventos de declarações por thread e nome de evento</td> </tr><tr><td>events_statements_summary_by_user_by_event_name</td> <td>Eventos de declarações por nome de usuário e nome de evento</td> </tr><tr><td>events_statements_summary_global_by_event_name</td> <td>Eventos de declarações por nome de evento</td> </tr><tr><td>prepared_statements_instances</td> <td>Instâncias e estatísticas de declarações preparadas</td> </tr></tbody></table>

#### Resumos de Transações

**Tabela 29.8 Tabelas de Resumo de Eventos de Transações do Schema de Desempenho**

<table frame="box" rules="all" summary="Uma referência que lista todas as tabelas de resumo de eventos de transações do Schema de Desempenho."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>events_transactions_summary_by_account_by_event_name</code></td> <td>Eventos de transações por conta e nome de evento</td> </tr><tr><td><code>events_transactions_summary_by_host_by_event_name</code></td> <td>Eventos de transações por nome de host e nome de evento</td> </tr><tr><td><code>events_transactions_summary_by_thread_by_event_name</code></td> <td>Eventos de transações por thread e nome de evento</td> </tr><tr><td><code>events_transactions_summary_by_user_by_event_name</code></td> <td>Eventos de transações por nome de usuário e nome de evento</td> </tr><tr><td><code>events_transactions_summary_global_by_event_name</code></td> <td>Eventos de transações por nome de evento</td> </tr></tbody></table>
...
<tbody><tr><td><code>objects_summary_global_by_type</code></td> <td>Sumários de objetos</td> </tr></tbody></table>
...
<col style="width: 28%"/><col style="width: 71%"/>
<thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead>
<tbody><tr><td><code>file_summary_by_event_name</code></td> <td>Eventos de arquivo/S por nome de evento</td> </tr>
<tr><td><code>file_summary_by_instance</code></td> <td>Eventos de arquivo/S por instância de arquivo</td> </tr></tbody></table>
...
<col style="width: 28%"/><col style="width: 71%"/>
<thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>table_io_waits_summary_by_index_usage</code></td> <td>Esperas de I/O por índice</td> </tr><tr><td><code>table_io_waits_summary_by_table</code></td> <td>Esperas de I/O por tabela</td> </tr><tr><td><code>table_lock_waits_summary_by_table</code></td> <td>Esperas de bloqueio por tabela</td> </tr></tbody></table>
...
<col style="width: 28%"/><col style="width: 71%"/>
<thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>summary_of_errors_by_account_by_event_name</code></td> <td>Operações de memória por conta e nome de evento</td> </tr><tr><td><code>summary_of_errors_by_host_by_event_name</code></td> <td>Operações de memória por host e nome de evento</td> </tr><tr><td><code>summary_of_errors_by_thread_by_event_name</code></td> <td>Operações de memória por thread e nome de evento</td> </tr><tr><td><code>summary_of_errors_by_user_by_event_name</code></td> <td>Operações de memória por usuário e nome de evento</td> </tr><tr><td><code>summary_of_errors_global_by_event_name</code></td> <td>Operações de memória globalmente por nome de evento</td> </tr></tbody></table>
...
<col style="width: 28%"/><col style="width: 71%"/>
<thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>events_status_errors_summary_by_account_by_error</code></td> <td>Erros por conta e código de erro</td> </tr><tr><td><code>events_status_errors_summary_by_host_by_error</code></td> <td>Erros por host e código de erro</td> </tr><tr><td><code>events_status_errors_summary_by_thread_by_error</code></td> <td>Erros por thread e código de erro</td> </tr><tr><td><code>events_status_errors_summary_by_user_by_error</code></td> <td>Erros por usuário e código de erro</td> </tr><tr><td><code>events_status_errors_summary_global_by_error</code></td> <td>Erros por código de erro</td> </tr></tbody></table>

<table frame="box" rules="all" summary="Uma referência que lista todas as tabelas de resumo de eventos de estágio do Schema de Desempenho."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome da Tabela</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>events_stages_summary_by_account_by_event_name</code></td> <td>Eventos de estágio por conta e nome de evento</td> </tr><tr><td><code>events_stages_summary_by_host_by_event_name</code></td> <td>Eventos de estágio por nome de host e nome de evento</td> </tr><tr><td><code>events_stages_summary_by_thread_by_event_name</code></td> <td>Espera de estágio por thread e nome de evento</td> </tr><tr><td><code>events_stages_summary_by_user_by_event_name</code></td> <td>Eventos de estágio por nome de usuário e nome de evento</td> </tr><tr><td><code>events_stages_summary_global_by_event_name</code></td> <td>Espera de estágio por nome de evento</td> </tr></tbody></table>
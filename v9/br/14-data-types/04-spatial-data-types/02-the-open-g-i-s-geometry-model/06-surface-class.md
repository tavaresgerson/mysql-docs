...
Superfícies poliédricas são formadas “costurando” superfícies simples ao longo de seus limites, e superfícies poliédricas no espaço tridimensional podem não ser planas como um todo.

**Propriedades da `Surface`**

* Uma `Surface` é definida como uma geometria bidimensional.

* A especificação OpenGIS define uma `Surface` simples como uma geometria que consiste em um único “patch” associado a um único limite exterior e zero ou mais limites interiores.

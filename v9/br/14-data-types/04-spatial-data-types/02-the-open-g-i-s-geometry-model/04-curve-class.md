...
Uma `Curva` é uma geometria unidimensional, geralmente representada por uma sequência de pontos. Subclasses particulares de `Curva` definem o tipo de interpolação entre os pontos. `Curva` é uma classe não instanciável.

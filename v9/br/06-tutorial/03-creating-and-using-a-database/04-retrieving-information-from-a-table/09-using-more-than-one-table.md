...
A tabela `pet` mantém o registro de quais animais você possui. Se você quiser registrar outras informações sobre eles, como eventos em suas vidas, como visitas ao veterinário ou quando os ninhadas nascem, você precisa de outra tabela. Como essa tabela deve ser estruturada? Ela precisa conter as seguintes informações:
...
Assim como a tabela `pet`, é mais fácil carregar os registros iniciais criando um arquivo de texto delimitado por tabulação contendo as seguintes informações.

<table summary="dados de registro de animais de estimação que aparecem em um arquivo de texto delimitado por tabulação, conforme descrito no texto anterior."><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 35%"/><thead><tr> <th scope="col">nome</th> <th scope="col">data</th> <th scope="col">tipo</th> <th scope="col">nota</th> </tr></thead><tbody><tr> <th scope="row">Fluffy</th> <td>1995-05-15</td> <td>camarada</td> <td>4 gatinhos, 3 fêmeas, 1 macho</td> </tr><tr> <th scope="row">Buffy</th> <td>1993-06-23</td> <td>camarada</td> <td>5 filhotes, 2 fêmeas, 3 machos</td> </tr><tr> <th scope="row">Buffy</th> <td>1994-06-19</td> <td>camarada</td> <td>3 filhotes, 3 fêmeas</td> </tr><tr> <th scope="row">Chirpy</th> <td>1999-03-21</td> <td>veterinário</td> <td>necessitava do bico alinhado</td> </tr><tr> <th scope="row">Slim</th> <td>1997-08-03</td> <td>veterinário</td> <td>costela quebrada</td> </tr><tr> <th scope="row">Bowser</th> <td>1991-10-12</td> <td>canil</td> <td></td> </tr><tr> <th scope="row">Fang</th> <td>1991-10-12</td> <td>canil</td> <td></td> </tr><tr> <th scope="row">Fang</th> <td>1998-08-28</td> <td>aniversário</td> <td>Deu-lhe um novo brinquedo para mastigar</td> </tr><tr> <th scope="row">Claws</th> <td>1998-03-17</td> <td>aniversário</td> <td>Deu-lhe um novo colar antipulgas</td> </tr><tr> <th scope="row">Whistler</th> <td>1998-12-09</td> <td>aniversário</td> <td>Primeiro aniversário</td> </tr></tbody></table>
...
* Ao combinar (unir) informações de várias tabelas, você precisa especificar como os registros em uma tabela podem ser correspondidos com registros na outra. Isso é fácil porque ambas têm uma coluna `name`. A consulta usa uma cláusula `ON` para combinar os registros nas duas tabelas com base nos valores da coluna `name`.

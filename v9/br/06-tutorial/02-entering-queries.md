...
<table summary="Prompts do MySQL e o significado de cada prompt."><col style="width: 10%"/><col style="width: 80%"/><thead><tr> <th>Prompt</th> <th>Significado</th> </tr></thead><tbody><tr> <td><code class="literal">mysql&gt;</code></td> <td>Pronto para nova consulta</td> </tr><tr> <td><code class="literal">-&gt;</code></td> <td>Esperando a próxima linha de consulta de várias linhas</td> </tr><tr> <td><code class="literal">'&gt;</code></td> <td>Esperando a próxima linha, aguardando a conclusão de uma string que começou com uma única aspas (<code class="literal">'</code>)</td> </tr><tr> <td><code class="literal">"&gt;</code></td> <td>Esperando a próxima linha, aguardando a conclusão de uma string que começou com duas aspas duplas (<code class="literal">"</code>)</td> </tr><tr> <td><code class="literal">`&gt;</code></td> <td>Esperando a próxima linha, aguardando a conclusão de um identificador que começou com um til (<code class="literal">`</code>)</td> </tr><tr> <td><code class="literal">/*&gt;</code></td> <td>Esperando a próxima linha, aguardando a conclusão de um comentário que começou com <code class="literal">/*</code></td> </tr></tbody></table>

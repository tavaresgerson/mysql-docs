...
Algumas instalações do MySQL permitem que os usuários se conectem como o usuário anônimo (sem nome) ao servidor que está rodando no host local. Se esse for o caso da sua máquina, você deve ser capaz de se conectar ao servidor invocando **mysql** sem quaisquer opções:

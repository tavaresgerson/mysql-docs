...
<tbody><tr><th><code>cmk_id</code></th><th>—</th><th>Identificador do CMK (Customer Managed Key) obtido do servidor KMS da AWS</th><th>—</th><th>Sim</th><th>—</th><th>—</th></tr>
<tr><th><code>data_file</code></th><th>—</th><th>Localização do arquivo de armazenamento JSON do componente</th><th>—</th><th>Sim</th><th>—</th></tr>
<tr><th><code>cache_keys</code></th><th>—</th><th><code>true</code>: Chaves armazenadas em cache na memória em texto plano; <code>false</code>: Chaves descriptografadas ao serem acessadas</th><th>—</th><th>Não</th><th><code>false</code></th><th><code>true</code>, <code>false</code></th></tr>
<tr><th><code>mode</code></th><th><code>aws_authentication</code></th><th>Modo de autenticação da AWS</th><th>—</th><th>Sim</th><th>—</th></tr>
<tr><th><code>profile</code></th><th><code>aws_authentication</code></th><th>Nome do perfil da AWS usado para autenticação nativa da AWS</th><th>Quando <code>aws_authentication.mode</code> é <code>native</code></th><th>Não</th><th><code>default</code></th></tr>
<tr><th><code>region</code></th><th><code>aws_authentication</code></th><th>Região da AWS</th><th>Quando <code>aws_authentication.mode</code> é <code>simple</code></th><th>Sim, quando <code>aws_authentication.mode</code> é <code>simple</code></th><th><code>us-east-1</code></th></tr>
<tr><th><code>access_key_id</code></th><th><code>aws_authentication</code></th><th>Identificador de chave de acesso da AWS</th><th>Quando <code>aws_authentication.mode</code> é <code>simple</code></th><th>Sim, quando <code>aws_authentication.mode</code> é <code>simple</code></th><th>—</th></tr>
<tr><th><code>access_key_secret</code></th><th><code>aws_authentication</code></th><th>Segredo da chave de acesso da AWS</th><th>Quando <code>aws_authentication.mode</code> é <code>simple</code></th><th>Sim, quando <code>aws_authentication.mode</code> é <code>simple</code></th><th>—</th></tr>
<tr><th><code>connect_timeout_ms</code></th><th><code>aws_connection</code></th><th>Timeout da conexão de rede</th><th> </th><th>Não</th><th><code>1000</code></th></tr>
<tr><th><code>host</code></th><th><code>aws_connection.proxy</code></th><th>Host do proxy</th><th>—</th><th>Não</th><th>—</th></tr>
<tr><th><code>port</code></th><th><code>aws_connection.proxy</code></th><th>Porta do proxy</th><th>—</th><th>Não</th><th>—</th></tr>
<tr><th><code>user</code></th><th><code>aws_connection.proxy</code></th><th>Nome do usuário do proxy</th><th>—</th><th>Não</th><th>—</th></tr>
<tr><th><code>password</code></th><th><code>aws_connection.proxy</code></th><th>Senha do usuário do proxy</th><th>—</th><th>Não</th><th>—</th></tr>
<tr><th><code>read_only</code></th><th>—</th><th>Quando <code>true</code>, operações que modificam o keyring não são permitidas</th><th>—</th><th>Não</th><th><code>false</code></th><th><code>true</code>, <code>false</code></th></tr></tbody></table>

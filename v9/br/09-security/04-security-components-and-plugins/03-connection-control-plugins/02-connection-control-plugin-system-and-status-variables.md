...
* `Connection_control_delay_generated`
  ...
  Esta variável fornece um contador simples. Para obter informações mais detalhadas sobre o monitoramento do controle de conexão, examine a tabela `INFORMATION_SCHEMA` `CONNECTION_CONTROL_FAILED_LOGIN_ATTEMPTS`; consulte a Seção 28.6.2, “A Tabela `INFORMATION\_SCHEMA CONNECTION\_CONTROL\_FAILED\_LOGIN\_ATTEMPTS`”.

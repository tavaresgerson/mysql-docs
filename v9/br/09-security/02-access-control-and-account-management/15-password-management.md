...
<table summary="Interação da tabela mysql.user e da variável de sistema password_require_current para a política de verificação de senha."><col style="width: 40%"/><col style="width: 30%"/><col style="width: 30%"/><thead><tr> <th scope="col">Configuração por Conta</th> <th scope="col">Variável de Sistema password_require_current</th> <th scope="col">As mudanças de senha requerem a senha atual?</th> </tr></thead><tbody><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL</code></th> <td><code class="literal">DESATIVADO</code></td> <td>Sim</td> </tr><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL</code></th> <td><code class="literal">ATIVADO</code></td> <td>Sim</td> </tr><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL OPCIONAL</code></th> <td><code class="literal">DESATIVADO</code></td> <td>Não</td> </tr><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL OPCIONAL</code></th> <td><code class="literal">ATIVADO</code></td> <td>Não</td> </tr><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL DEFAULT</code></th> <td><code class="literal">DESATIVADO</code></td> <td>Não</td> </tr><tr> <th scope="row"><code class="literal">REQUERER SENHA ATUAL DEFAULT</code></th> <td><code class="literal">ATIVADO</code></td> <td>Sim</td> </tr></tbody></table>

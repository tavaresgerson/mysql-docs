...
<table><thead><tr> <th>Privilegio</th> <th>Significado e Níveis de Concedi­do</th> </tr></thead><tbody><tr> <td><a class="link" href="privileges-provided.html#priv_all"><code>ALL [PRIVILEGES]</code></a></td> <td>Concede todos os privilégios no nível de acesso especificado, exceto <a class="link" href="privileges-provided.html#priv_grant-option"><code>GRANT OPTION</code></a> e <a class="link" href="privileges-provided.html#priv_proxy"><code>PROXY</code></a>.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter"><code>ALTER</code></a></td> <td>Habilita o uso de <a class="link" href="alter-table.html" title="15.1.11 ALTER TABLE Statement"><code>ALTER TABLE</code></a>. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter-routine"><code>ALTER ROUTINE</code></a></td> <td>Habilita a alteração ou remoção de rotinas armazenadas. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create"><code>CREATE</code></a></td> <td>Habilita a criação de bancos de dados e tabelas. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-role"><code>CREATE ROLE</code></a></td> <td>Habilita a criação de um papel. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-routine"><code>CREATE ROUTINE</code></a></td> <td>Habilita a criação de rotinas armazenadas. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-tablespace"><code>CREATE TABLESPACE</code></a></td> <td>Habilita a criação de espaços de tabelas e grupos de arquivos de log. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-temporary-tables"><code>CREATE TEMPORARY TABLES</code></a></td> <td>Habilita o uso de <a class="link" href="create-table.html" title="15.1.24 CREATE TABLE Statement"><code>CREATE TEMPORARY TABLE</code></a>. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-user"><code>CREATE USER</code></a></td> <td>Habilita o uso de <a class="link" href="create-user.html" title="15.7.1.3 CREATE USER Statement"><code>CREATE USER</code></a>, <a class="link" href="drop-user.html" title="15.7.1.5 DROP USER Statement"><code>DROP USER</code></a>, <a class="link" href="rename-user.html" title="15.7.1.7 RENAME USER Statement"><code>RENAME USER</code></a>, e <a class="link" href="revoke.html" title="15.7.1.8 REVOKE ALL PRIVILEGES Statement"><code>REVOKE ALL PRIVILEGES</code></a>. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-view"><code>CREATE VIEW</code></a></td> <td>Habilita a criação ou alteração de visualizações. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_delete"><code>DELETE</code></a></td> <td>Habilita o uso de <a class="link" href="delete.html" title="15.2.2 DELETE Statement"><code>DELETE</code></a>. N

**Tabela 15.12 Prerrogativas Dinâmicas Permitidas para GRANTE e REVOGAR**

<table><thead><tr> <th>Privilegio</th> <th>Significado e Níveis de Concedibilidade</th> </tr></thead><tbody><tr> <td><a class="link" href="privileges-provided.html#priv_application-password_admin"><code>APPLICATION_PASSWORD_ADMIN</code></a></td> <td>Habilitar administração de senha dupla. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_audit_abort_exempt"><code>AUDIT_ABORT_EXEMPT</code></a></td> <td>Permitir consultas bloqueadas pelo filtro do log de auditoria. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_audit_admin"><code>AUDIT_ADMIN</code></a></td> <td>Habilitar a configuração do log de auditoria. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_authentication_policy_admin"><code>AUTHENTICATION_POLICY_ADMIN</code></a></td> <td>Habilitar a administração da política de autenticação. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_backup_admin"><code>BACKUP_ADMIN</code></a></td> <td>Habilitar a administração de backups. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_binlog_admin"><code>BINLOG_ADMIN</code></a></td> <td>Habilitar o controle do log binário. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_binlog_encryption_admin"><code>BINLOG_ENCRYPTION_ADMIN</code></a></td> <td>Habilitar a ativação e desativação da criptografia do log binário. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_clone_admin"><code>CLONE_ADMIN</code></a></td> <td>Habilitar a administração de clones. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_connection_admin"><code>CONNECTION_ADMIN</code></a></td> <td>Habilitar o controle do limite/restrição de conexões. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_encryption_key_admin"><code>ENCRYPTION_KEY_ADMIN</code></a></td> <td>Habilitar a rotação da chave <code>InnoDB</code>. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_firewall_admin"><code>FIREWALL_ADMIN</code></a></td> <td>Habilitar a administração das regras de firewall, qualquer usuário. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_firewall_exempt"><code>FIREWALL_EXEMPT</code></a></td> <td>Eximir o usuário das restrições do firewall. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_firewall_user"><code>FIREWALL_USER</code></a></td> <td>Habilitar a administração das regras de firewall, para o próprio usuário. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_flush_optimizer_costs"><code>FLUSH_OPTIMIZER_COSTS</code></a></td> <td>Habilitar a recarga dos custos do otimizador. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_flush_status"><code>FLUSH_STATUS</code></a></td> <td>Habilitar o envio do indicador de status. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_flush_tables"><code>FLUSH_TABLES</code></a></td> <td>Habilitar o esvaziamento das tabelas. Nível: Global.</td> </tr><tr> <td><a class

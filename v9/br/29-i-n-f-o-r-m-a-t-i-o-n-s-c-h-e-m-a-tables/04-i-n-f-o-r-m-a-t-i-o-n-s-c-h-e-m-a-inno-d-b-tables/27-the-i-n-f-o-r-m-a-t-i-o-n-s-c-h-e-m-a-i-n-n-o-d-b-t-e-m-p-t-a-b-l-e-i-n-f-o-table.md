### 28.4.27 A Tabela `INFORMATION\_SCHEMA\_INNODB\_TEMP\_TABLE\_INFO`
...
Para informações de uso e exemplos, consulte a Seção 17.15.7, “Tabela de Informações de Tabela Temporária `INFORMATION\_SCHEMA` InnoDB”.

...
<table summary="Arquivos de opções lidos por programas MySQL em sistemas Windows."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Nome do arquivo</th> <th>Propósito</th> </tr></thead><tbody><tr> <td><code class="filename"><code class="literal">%WINDIR%</code>\my.ini</code>, <code class="filename"><code class="literal">%WINDIR%</code>\my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="filename">C:\my.ini</code>, <code class="filename">C:\my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="filename"><em class="replaceable"><code>BASEDIR</code></em>\my.ini</code>, <code class="filename"><em class="replaceable"><code>BASEDIR</code></em>\my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="literal">defaults-extra-file</code></td> <td>O arquivo especificado com <a class="link" href="option-file-options.html#option_general_defaults-extra-file"><code class="option">--defaults-extra-file</code></a>, se houver</td> </tr><tr> <td><code class="filename"><code class="literal">%APPDATA%</code>\MySQL\.mylogin.cnf</code></td> <td>Opções de caminho de login (apenas clientes)</td> </tr><tr> <td><code class="filename"><em class="replaceable"><code>DATADIR</code></em>\mysqld-auto.cnf</code></td> <td>Variáveis do sistema persistidas com <a class="link" href="set-variable.html" title="15.7.6.1 SINTAXE DE DEFINIÇÃO DE VARIÁVEL"><code class="literal">SET PERSIST</code></a> ou <a class="link" href="set-variable.html" title="15.7.6.1 SINTAXE DE DEFINIÇÃO DE VARIÁVEL"><code class="literal">SET PERSIST_ONLY</code></a> (apenas servidor)</td> </tr></tbody></table>
...
<table summary="Arquivos de opções lidos por programas MySQL em sistemas Unix e semelhantes ao Unix."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Nome do arquivo</th> <th>Propósito</th> </tr></thead><tbody><tr> <td><code class="filename">/etc/my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="filename">/etc/mysql/my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="filename"><em class="replaceable"><code>SYSCONFDIR</code></em>/my.cnf</code></td> <td>Opções globais</td> </tr><tr> <td><code class="filename">$MYSQL_HOME/my.cnf</code></td> <td>Opções específicas do servidor (apenas para o servidor)</td> </tr><tr> <td><code class="literal">defaults-extra-file</code></td> <td>O arquivo especificado com <a class="link" href="option-file-options.html#option_general_defaults-extra-file"><code class="option">--defaults-extra-file</code></a>, se houver</td> </tr><tr> <td><code class="filename">~/.my.cnf</code></td> <td>Opções específicas do usuário</td> </tr><tr> <td><code class="filename">~/.mylogin.cnf</code></td> <td>Opções de caminho de login específicas do usuário (apenas para clientes)</td> </tr><tr> <td><code class="filename"><em class="replaceable"><code>DATADIR</code></em>/mysqld-auto.cnf</code></td> <td>Variáveis do sistema persistidas com <a class="link" href="set-variable.html" title="15.7.6.1 SINTAXE DE DEFINIÇÃO DE VARIÁVEIS para atribuição de variáveis"><code class="literal">SET PERSIST</code></a> ou <a class="link" href="set-variable.html" title="15.7.6.1 SINTAXE DE DEFINIÇÃO DE VARIÁVEIS para atribuição de variáveis"><code class="literal">SET PERSIST_ONLY</code></a> (apenas para o servidor)</td> </tr></tbody></table>

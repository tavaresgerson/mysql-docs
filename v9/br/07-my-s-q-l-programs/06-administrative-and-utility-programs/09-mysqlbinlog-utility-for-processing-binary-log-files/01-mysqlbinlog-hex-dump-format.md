...
A saída do dump hexadecimal atualmente contém os elementos da lista a seguir. Esse formato está sujeito a alterações. Para mais informações sobre o formato do log binário, consulte MySQL Internals: O Log Binário.

...
* `--database=db_name`, -d db_name
  ...
  <table frame="box" rules="all" summary="Propriedades para o banco de dados"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de Linha de Comando</th> <td><code class="literal">--database=db_name</code></td> </tr><tr><th>Tipo</th> <td>String</td> </tr></tbody></table>
...
* `--force-read`, `-f`
  ...
  <table frame="box" rules="all" summary="Propriedades de saída em base64"><col style="width: 30%"/><col style="width: 70%"/>
...
* `--get-server-public-key`
  ...
  <table frame="box" rules="all" summary="Propriedades para saída em base64"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td><code class="literal">--base64-output=valor</code></td> </tr><tr><th>Tipo</th> <td>String</td> </tr><tr><th>Valor padrão</th> <td><code class="literal">AUTO</code></td> </tr><tr><th>Valores válidos</th> <td><p class="valid-value"><code class="literal">AUTO</code></p><p class="valid-value"><code class="literal">NEVER</code></p><p class="valid-value"><code class="literal">DECODE-ROWS</code></p></td> </tr></tbody></table>1
...
* `--plugin-dir=dir_name`
  ...
  <table frame="box" rules="all" summary="Propriedades para bind-address"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de Linha de Comando</th> <td><code class="literal">--bind-address=ip_address</code></td> </tr></tbody></table>3
...
* `--socket=caminho`, `-S caminho`
  ...
  <table frame="box" rules="all" summary="Propriedades para character-sets-dir"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td><code class="literal">--character-sets-dir=caminho_nome</code></td> </tr><tr><th>Tipo</th> <td>Nome do diretório</td> </tr></tbody></table>2

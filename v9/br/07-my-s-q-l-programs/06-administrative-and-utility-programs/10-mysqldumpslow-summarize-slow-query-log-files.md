...
* `--debug`, `-d`
  ...
  <table frame="box" rules="all" summary="Propriedades para debug"><tbody><tr><th>Formato de linha de comando</th> <td><code>--debug</code></td> </tr></tbody></table>

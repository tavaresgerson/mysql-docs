...
* `--debug[=debug_options]`, `-# debug_options`
  ...
  <table frame="box" rules="all" summary="Propriedades para depuração"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de Linha de Comando</th> <td><code class="literal">--debug[=debug_options]</code></td> </tr><tr><th>Tipo</th> <td>String</td> </tr><tr><th>Valor Padrão</th> <td><code class="literal">d:t:o</code></td> </tr></tbody></table>
...
* `--version`, `-V`
  ...
  <table frame="box" rules="all" summary="Propriedades para versão"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td><code class="literal">--version</code></td> </tr></tbody></table>

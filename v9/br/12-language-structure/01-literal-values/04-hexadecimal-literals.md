...
Valores escritos usando a notação `X'val'` devem conter um número par de dígitos ou uma sintaxe incorreta. Para corrigir o problema, adicione um zero inicial:
...
Para converter uma string ou um número em uma string hexadecimal, use a função `HEX()`:

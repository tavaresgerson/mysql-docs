#### 30.4.3.8 As visualizações innodb_buffer_stats_by_table e x$innodb_buffer_stats_by_table
...
As visualizações `innodb_buffer_stats_by_table` e `x$innodb_buffer_stats_by_table` têm essas colunas:

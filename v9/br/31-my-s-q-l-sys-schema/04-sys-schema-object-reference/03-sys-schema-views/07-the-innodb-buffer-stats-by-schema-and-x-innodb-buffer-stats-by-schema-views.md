#### 30.4.3.7 As visualizações innodb_buffer_stats_by_schema e x$innodb_buffer_stats_by_schema
...
As visualizações `innodb_buffer_stats_by_schema` e `x$innodb_buffer_stats_by_schema` têm essas colunas:

...
Este procedimento pode ser usado para exibir uma imagem de alto nível da distribuição de latência das declarações que estão sendo executadas nesta instância do MySQL.

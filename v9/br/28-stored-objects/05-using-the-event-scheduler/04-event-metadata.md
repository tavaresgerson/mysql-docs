...
<table summary="Resumo da representação do tempo do evento (como valores em UTC, EZT ou STZ) da Tabela INFORMATION_SCHEMA.EVENTS e da Declaração SHOW EVENTS".><col style="width: 25%"/><col style="width: 25%"/><col style="width: 25%"/><thead><tr> <th scope="col">Valor</th> <th scope="col"><a class="link" href="information-schema-events-table.html" title="28.3.14 A Tabela Tabela INFORMATION_SCHEMA EVENTS"><code class="literal">EVENTS</code></a></th> <th scope="col"><a class="link" href="show-events.html" title="15.7.7.20 Declaração SHOW EVENTS"><code class="literal">SHOW EVENTS</code></a></th> </tr></thead><tbody><tr> <th scope="row">Executado em</th> <td>ETZ</td> <td>ETZ</td> </tr><tr> <th scope="row">Começa</th> <td>ETZ</td> <td>ETZ</td> </tr><tr> <th scope="row">Termina</th> <td>ETZ</td> <td>ETZ</td> </tr><tr> <th scope="row">Última execução</th> <td>ETZ</td> <td>n/a</td> </tr><tr> <th scope="row">Criado</th> <td>STZ</td> <td>n/a</td> </tr><tr> <th scope="row">Última alteração</th> <td>STZ</td> <td>n/a</td> </tr></tbody></table>
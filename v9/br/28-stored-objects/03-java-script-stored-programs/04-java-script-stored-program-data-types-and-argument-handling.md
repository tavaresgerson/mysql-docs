...
<table><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Tipo de MySQL</th> <th>Tipo de JavaScript</th> </tr></thead><tbody><tr> <td><code>TINYINT</code>, <code>SMALLINT</code>, <code>MEDIUMINT</code>, <code>INT</code>, <code>BOOL</code>, <code>BIGINT</code>, ou <code>SERIAL</code></td> <td>Se seguro: <code>Number</code>; caso contrário: <code>String</code></td> </tr><tr> <td><code>FLOAT</code> ou <code>DOUBLE</code></td> <td><code>Number</code></td> </tr><tr> <td><code>CHAR</code>, <code>VARCHAR</code>, <code>TINYTEXT</code>, <code>TEXT</code>, <code>MEDIUMTEXT</code>, ou <code>LONGTEXT</code></td> <td><code>String</code></td> </tr><tr> <td><code>TINYBLOB</code>, <code>BLOB</code>, <code>MEDIUMBLOB</code>, <code>LONGBLOB</code>, <code>BINARY</code>, ou <code>VARBINARY</code></td> <td><code>Uint8Array</code></td> </tr><tr> <td><code>DATE</code>, <code>DATETIME</code>, ou <code>TIMESTAMP</code></td> <td><code>Date</code></td> </tr><tr> <td><code>TIME</code></td> <td><code>String</code></td> </tr><tr> <td><code>YEAR</code></td> <td><code>Number</code></td> </tr><tr> <td><code>VECTOR</code></td> <td><code>Float32Array</code></td> </tr><tr> <td><code>DECIMAL</code></td> <td><code>String</code> ou <code>Number</code>, dependendo do valor de <code>session.options.decimalType</code> (<code>STRING</code> ou <code>NUMBER</code>, respectivamente). Por padrão, convertido em <code>String</code>.</td> </tr><tr> <td><code>BIT(<em class="replaceable"><code>M</code></em>)</code></td> <td> <div class="itemizedlist" style="list-style-type: disc; "><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p> <code>BIT(<em class="replaceable"><code>M</code></em>)</code> &lt;= <code>JavaScript.MAX_SAFE_INTEGER</code>: <code>Number</code> </p></li><li class="listitem"><p> <code>BIT(<em class="replaceable"><code>M</code></em>)</code> &gt; <code>JavaScript.MAX_SAFE_INTEGER</code>: <code>BigInt</code> </p></li></ul> </div> </td> </tr></tbody></table>
...
<table border="1" class="table" summary="Conversão de tipos de dados JavaScript para tipos MySQL"><colgroup><col/><col/><col/><col/><col/><col/><col/><col/><col/></colgroup><thead><tr><th>Tipo de Dados JavaScript</th><th>Para MySQL <code>TINYINT</code>, <code>SMALLINT</code>, <code>MEDIUMINT</code>, <code>INT</code>, <code>BIGINT</code>, <code>BOOLEAN</code>, ou <code>SERIAL</code></th><th>Para MySQL <code>CHAR</code> ou <code>VARCHAR</code></th><th>Para MySQL <code>FLOAT</code> ou <code>DOUBLE</code></th><th>Para MySQL <code>TINYTEXT</code>, <code>TEXT</code>, <code>MEDIUMTEXT</code>, ou <code>LONGTEXT</code></th><th>Para MySQL <code>TINYBLOB</code>, <code>BLOB</code>, <code>MEDIUMBLOB</code>, <code>LONGBLOB</code>, <code>BINARY</code>, <code>VARBINARY</code></th><th>Para MySQL <code>VECTOR</code></th><th>Para MySQL <code>DECIMAL</code> (<code>NUMERIC</code>)</th><th>Para MySQL <code>BIT</code></th></tr></thead><tbody><tr><td><code>Boolean</code></td><td>Converter para <code>Integer</code></td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Converter para <code>Float</code></td><td>Se <code>Boolean</code> JavaScript <code>true</code>: converter para <span class="quote">“<span class="quote">true</span>”</span>; se <code>Boolean</code> JavaScript <code>false</code>: converter para <span class="quote">“<span class="quote">false</span>”</span></td><td>Erro</td><td>Erro</td><td>Converter para <code>Decimal</code></td><td>Converter para <code>Bit</code></td></tr><tr><td><code>Number</code></td><td>Arredondar o valor para <code>Integer</code>; verificar se o valor está fora da faixa</td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Retirar o valor; verificar se este está fora da faixa</td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Erro</td><td>Erro</td><td>Converter para <code>Decimal</code></td><td>Converter para <code>Bit</code></td></tr><tr><td><code>BigInteger</code></td><td>Retirar o valor; verificar se está fora da faixa</td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Converter para <code>Float</code>; verificar se o resultado está fora da faixa</td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Erro</td><td>Erro</td><td>Converter para <code>Decimal</code></td><td>Converter para <code>Bit</code></td></tr><tr><td><code>String</code></td><td>Converter como número e arredondar para <code>Integer</code>; verificar se o valor está fora da faixa</td><td>Retirar o valor; verificar se o comprimento está dentro da faixa</td><td>Converter o valor para <code>Float</code>; verificar se o valor está fora da faixa</td><td>Usar o valor existente; verificar se o comprimento da string está dentro da faixa esperada</td><td>Erro</td><td>Erro</td><td>Converter para <code>Decimal</code></td><td>Converter para <code>Bit</code></td></tr><tr><td><code>Symbol</code> ou <code>Object</code></td><td>Lançar erro de conversão de tipo inválida</td><td>Converter para <code>String</code>; verificar se o comprimento do resultado está dentro da faixa esperada</td><td>Lançar erro de conversão de tipo inválida</td><td>Converter para <code
...
<table border="1" class="table" summary="Conversão de valores de data JavaScript para tipos temporais do MySQL"><colgroup><col/><col/><col/><col/></colgroup><thead><tr><th>Tipo JavaScript</th><th>MySQL <code>DATE</code></th><th>MySQL <code>DATETIME</code>, <code>TIMESTAMP</code></th><th>MySQL YEAR</th></tr></thead><tbody><tr><td><code>null</code> or <code>undefined</code></td><td><code>NULL</code></td><td><code>NULL</code></td><td><code>NULL</code></td></tr><tr><td><code>Date</code></td><td>Retem o valor como está, arredondando qualquer parte de tempo para o segundo mais próximo.</td><td>Mantenham o valor como está.</td><td>Extraem o ano do <code>Date</code></td></tr><tr><td>Tipo conversível para JavaScript <code>Date</code> (string formatado)</td><td>Convertirem o valor para JavaScript <code>Date</code> e lidem conforme necessário</td><td>Convertirem o valor para JavaScript <code>Date</code> e lidem conforme necessário</td><td>Se o valor contiver um ano de 4 dígitos, use-o.</td></tr><tr><td>Tipo não conversível para JavaScript <code>Date</code></td><td>Erro de conversão de tipo inválido</td><td>Erro de conversão de tipo inválido</td><td>Se o valor contiver um ano de 4 dígitos, use-o.</td></tr></tbody></table>
...
<table><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Tipo de JavaScript</th> <th>Tipo de JSON MySQL</th> </tr></thead><tbody><tr> <td><code>null</code>, <code>undefined</code></td> <td><code>NULL</code></td> </tr><tr> <td><code>Boolean</code></td> <td>Erro</td> </tr><tr> <td><code>Number</code></td> <td>Erro</td> </tr><tr> <td><code>String</code></td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p> Pode ser convertido para JSON: string JSON, objeto JSON ou array JSON </p></li><li class="listitem"><p> Não pode ser convertido para JSON: Erro </p></li><li class="listitem"><p> <code>'null'</code>: JSON <code>null</code> </p></li></ul> </div> </td> </tr><tr> <td><code>BigInt</code></td> <td>Erro</td> </tr><tr> <td><code>Object</code></td> <td>Objeto JSON ou erro (consulte o texto após a tabela)</td> </tr><tr> <td><code>Array</code></td> <td>Array JSON</td> </tr><tr> <td><code>Symbol</code></td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p> Dentro de um objeto: ignorado </p></li><li class="listitem"><p> Dentro de um array: JSON <code>null</code> </p></li></ul> </div> </div> Valor escalar: Erro</td> </tr></tbody></table>
...
<table><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <td>Tipo MySQL</td> <td>Tipo JavaScript</td> </tr></thead><tbody><tr> <td><a class="link" href="enum.html" title="13.3.6 O tipo ENUM"><code>ENUM</code></a></td> <td><code>String</code></td> </tr><tr> <td><a class="link" href="set.html" title="13.3.7 O tipo SET"><code>SET</code></a></td> <td><code><a class="ulink" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference//Global_Objects/Set" target="_blank">Set</a></code></td> </tr></tbody></table>
...
<table border="1" class="table" summary="Conversão de tipos JavaScript para os tipos ENUM e SET do MySQL"><colgroup><col/><col/><col/></colgroup><thead><tr><th>Tipo JavaScript</th><th>Para MySQL <code>ENUM</code></th><th>Para MySQL <code>SET</code></th></tr></thead><tbody><tr><td>String</td><td>Preserva o valor; verifique se a string é um valor válido <code>ENUM</code></td><td>Preserva o valor; verifique se a string é um valor válido <code>SET</code></td></tr><tr><td><code>null</code>, <code>undefined</code></td><td><code>NULL</code></td><td><code>NULL</code></td></tr><tr><td><code>Set</code></td><td>Erro</td><td>Converte para uma string separada por vírgula; verifique se a string é um valor válido <code>SET</code></td></tr><tr><td>Qualquer outro tipo</td><td>Erro</td><td>Erro</td></tr></tbody></table>
...
<table border="1" class="table" summary="Conversão de tipos JavaScript para o tipo DECIMAL do MySQL"><colgroup><col/><col/></colgroup><thead><tr><th>Tipo JavaScript</th><th>Retorna</th></tr></thead><tbody><tr><td><code>Object</code>, <code>Array</code>, ou <code>Symbol</code></td><td>Erro: Conversão não suportada</td></tr><tr><td><code>Boolean</code>, <code>Number</code>, <code>String</code>, ou <code>BigInt</code></td><td><code>DECIMAL</code> valor</td></tr><tr><td><code>null</code>, <code>undefined</code></td><td>SQL <code>NULL</code></td></tr></tbody></table>

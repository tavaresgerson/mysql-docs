...
<table frame="all"><col style="width: 35%"/><col style="width: 25%"/><thead><tr> <th>Nome do Pacote</th> <th>Resumo</th> </tr></thead><tbody><tr> <td><code class="literal">mysql-community-client</code></td> <td>Aplicativos e ferramentas de cliente MySQL</td> </tr><tr> <td><code class="literal">mysql-community-client-plugins</code></td> <td>Plugins compartilhados para aplicativos de cliente MySQL</td> </tr><tr> <td><code class="literal">mysql-community-common</code></td> <td>Arquivos comuns para bibliotecas de servidor e cliente</td> </tr><tr> <td><code class="literal">mysql-community-devel</code></td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para aplicativos de cliente de banco de dados MySQL</td> </tr><tr> <td><code class="literal">mysql-community-embedded-compat</code></td> <td>Servidor MySQL como uma biblioteca embutida com compatibilidade para aplicativos que usam a versão 18 da biblioteca</td> </tr><tr> <td><code class="literal">mysql-community-icu-data-files</code></td> <td>Pacote MySQL de arquivos de dados ICU necessários para expressões regulares MySQL</td> </tr><tr> <td><code class="literal">mysql-community-libs</code></td> <td>Bibliotecas compartilhadas para aplicativos de cliente de banco de dados MySQL</td> </tr><tr> <td><code class="literal">mysql-community-libs-compat</code></td> <td>Bibliotecas de compatibilidade compartilhadas para instalações anteriores do MySQL; apenas presentes se as versões anteriores do MySQL forem suportadas pela plataforma</td> </tr><tr> <td><code class="literal">mysql-community-server</code></td> <td>Servidor de banco de dados e ferramentas relacionadas</td> </tr><tr> <td><code class="literal">mysql-community-server-debug</code></td> <td>Binários de servidor e plugins de depuração</td> </tr><tr> <td><code class="literal">mysql-community-test</code></td> <td>Conjunto de testes para o servidor MySQL</td> </tr><tr> <td><code class="literal">mysql-community</code></td> <td>O código-fonte RPM do mysql-community-9.5.0-1.el7.src.rpm é semelhante, dependendo do sistema operacional selecionado</td> </tr><tr> <td>RPMs adicionais de *debuginfo*</td> <td>Existem vários pacotes <code class="literal">debuginfo</code>: mysql-community-client-debuginfo, mysql-community-libs-debuginfo mysql-community-server-debug-debuginfo mysql-community-server-debuginfo e mysql-community-test-debuginfo.</td> </tr></tbody></table>

**Tabela 2.11 Pacotes RPM para a Edição Empresarial do MySQL**

<table frame="all"><col style="width: 35%"/><col style="width: 25%"/><thead><tr> <th>Nome do Pacote</th> <th>Resumo</th> </tr></thead><tbody><tr> <td><code class="literal">mysql-commercial-backup</code></td> <td>MySQL Enterprise Backup</td> </tr><tr> <td><code class="literal">mysql-commercial-client</code></td> <td>Aplicativos e ferramentas de cliente MySQL</td> </tr><tr> <td><code class="literal">mysql-commercial-client-plugins</code></td> <td>Plugins compartilhados para aplicativos de cliente MySQL</td> </tr><tr> <td><code class="literal">mysql-commercial-common</code></td> <td>Arquivos comuns para bibliotecas de servidor e cliente</td> </tr><tr> <td><code class="literal">mysql-commercial-devel</code></td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para aplicativos de cliente de banco de dados MySQL</td> </tr><tr> <td><code class="literal">mysql-commercial-embedded-compat</code></td> <td>Servidor MySQL como uma biblioteca embutida com compatibilidade para aplicativos que usam a versão 18 da biblioteca</td> </tr><tr> <td><code class="literal">mysql-commercial-icu-data-files</code></td> <td>Pacote MySQL de arquivos de dados ICU necessários para expressões regulares MySQL</td> </tr><tr> <td><code class="literal">mysql-commercial-libs</code></td> <td>Bibliotecas compartilhadas para aplicativos de cliente de banco de dados MySQL</td> </tr><tr> <td><code class="literal">mysql-commercial-libs-compat</code></td> <td>Bibliotecas de compatibilidade compartilhadas para instalações anteriores do MySQL; apenas presentes se as versões anteriores do MySQL forem suportadas pela plataforma. A versão das bibliotecas corresponde à versão das bibliotecas instaladas por padrão pela distribuição que você está usando.</td> </tr><tr> <td><code class="literal">mysql-commercial-server</code></td> <td>Servidor de banco de dados e ferramentas relacionadas</td> </tr><tr> <td><code class="literal">mysql-commercial-test</code></td> <td>Conjunto de testes para o servidor MySQL</td> </tr><tr> <td>RPMs adicionais de *debuginfo*</td> <td>Existem vários pacotes <code class="literal">debuginfo</code>: mysql-commercial-client-debuginfo, mysql-commercial-libs-debuginfo mysql-commercial-server-debug-debuginfo mysql-commercial-server-debuginfo e mysql-commercial-test-debuginfo.</td> </tr></tbody></table>
...
<table><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>Valor da Distribuição</th> <th>Uso Pretendido</th> </tr></thead><tbody><tr> <td>el<em class="replaceable"><code>{version}</code></em> onde <em class="replaceable"><code>{version}</code></em> é a versão principal da Enterprise Linux, como <code class="literal">el8</code></td> <td>Plataformas baseadas em EL6 (8.0), EL7, EL8, EL9 e EL10 (por exemplo, as versões correspondentes do Oracle Linux, Red Hat Enterprise Linux e CentOS)</td> </tr><tr> <td>fc<em class="replaceable"><code>{version}</code></em> onde <em class="replaceable"><code>{version}</code></em> é a versão principal do Fedora, como <code class="literal">fc37</code></td> <td>Fedora 41 e 42</td> </tr><tr> <td><code class="literal">sl5</code></td> <td>SUSE Linux Enterprise Server 15</td> </tr></tbody></table>
...
<table><col style="width: 55%"/><col style="width: 45%"/><thead><tr> <th>Arquivos ou Recursos</th> <th>Localização</th> </tr></thead><tbody><tr> <td>Programas e scripts do cliente</td> <td><code class="filename">/usr/bin</code></td> </tr><tr> <td><a class="link" href="mysqld.html" title="6.3.1 mysqld — O Servidor MySQL"><span class="command"><strong>mysqld</strong></span></a> servidor</td> <td><code class="filename">/usr/sbin</code></td> </tr><tr> <td>Arquivo de configuração</td> <td><code class="filename">/etc/my.cnf</code></td> </tr><tr> <td>Diretório de dados</td> <td><code class="filename">/var/lib/mysql</code></td> </tr><tr> <td>Arquivo de log de erro</td> <td><p> Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: <code class="filename">/var/log/mysqld.log</code> </p><p> Para SLES: <code class="filename">/var/log/mysql/mysqld.log</code> </p></td> </tr><tr> <td>Valor de <a class="link" href="server-system-variables.html#sysvar_secure_file_priv"><code class="literal">secure_file_priv</code></a></td> <td><code class="filename">/var/lib/mysql-files</code></td> </tr><tr> <td>Script de inicialização System V</td> <td><p> Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: <code class="filename">/etc/init.d/mysqld</code> </p><p> Para SLES: <code class="filename">/etc/init.d/mysql</code> </p></td> </tr><tr> <td>Serviço SystemD</td> <td><p> Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: <code class="filename">mysqld</code> </p><p> Para SLES: <code class="filename">mysql</code> </p></td> </tr><tr> <td>Arquivo de PID</td> <td><code class="filename"> /var/run/mysql/mysqld.pid</code></td> </tr><tr> <td>Soquete</td> <td><code class="filename">/var/lib/mysql/mysql.sock</code></td> </tr><tr> <td>Diretório de chaveiro</td> <td><code class="filename">/var/lib/mysql-keyring</code></td> </tr><tr> <td>Páginas do manual do Unix</td> <td><code class="filename">/usr/share/man</code></td> </tr><tr> <td>Arquivos de cabeçalho (incluídos)</td> <td><code class="filename">/usr/include/mysql</code></td> </tr><tr> <td>Bibliotecas</td> <td><code class="filename">/usr/lib/mysql</code></td> </tr><tr> <td>Arquivos de suporte diversos (por exemplo, mensagens de erro e arquivos de conjunto de caracteres)</td> <td><code class="filename">/usr/share/mysql</code></td> </tr></tbody></table>

...
<table summary="Servidores disponíveis para Windows no MySQL 9.5."><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Binário</th> <th>Descrição</th> </tr></thead><tbody><tr> <td><a class="link" href="mysqld.html" title="6.3.1 mysqld — O Servidor MySQL"><span class="command"><strong>mysqld</strong></span></a></td> <td>Binário otimizado com suporte a pipes nomeados</td> </tr><tr> <td><a class="link" href="mysqld.html" title="6.3.1 mysqld — O Servidor MySQL"><span class="command"><strong>mysqld-debug</strong></span></a></td> <td>Como <a class="link" href="mysqld.html" title="6.3.1 mysqld — O Servidor MySQL"><span class="command"><strong>mysqld</strong></span></a>, mas compilado com depuração completa e verificação automática de alocação de memória</td> </tr></tbody></table>

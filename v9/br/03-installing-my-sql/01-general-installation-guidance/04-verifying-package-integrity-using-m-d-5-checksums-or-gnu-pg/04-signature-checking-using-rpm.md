...
Para pacotes RPM, não há uma assinatura separada. Os pacotes RPM têm uma assinatura GPG embutida e um checksum MD5. Você pode verificar um pacote executando o seguinte comando:
...
Alternativamente, o **rpm** também suporta a carga da chave diretamente de um URL:

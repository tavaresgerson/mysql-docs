...
A seguinte chave de construção pública GPG (keyID `3A79BD29`) pode ser usada para verificar a autenticidade e integridade das versões dos pacotes MySQL 8.0.28 a 8.0.35, 8.1.0 e 8.2.0. Para instruções de verificação de assinatura, consulte a Seção 2.1.4.2, “Verificação de Assinatura Usando GnuPG”. Ela expirou em 14 de dezembro de 2023.
...
A seguinte chave de construção pública GPG (keyID `5072E1F5`) pode ser usada para verificar a autenticidade e integridade dos pacotes MySQL 8.0.27 e anteriores. Para instruções de verificação de assinatura, consulte a Seção 2.1.4.2, “Verificação de Assinatura Usando GnuPG”.

...
<table><col style="width: 45%"/><col style="width: 55%"/><thead><tr> <th>Diretório</th> <th>Conteúdo do Diretório</th> </tr></thead><tbody><tr> <td><code>bin</code></td> <td>Programas do servidor, cliente e utilitários do MySQL</td> </tr><tr> <td><code>data</code></td> <td>Arquivos de log, bancos de dados, onde <code>/usr/local/mysql/data/mysqld.local.err</code> é o log de erro padrão</td> </tr><tr> <td><code>docs</code></td> <td>Documentos de ajuda, como as Notas de Lançamento e informações de compilação</td> </tr><tr> <td><code>include</code></td> <td>Arquivos de inclusão (cabeçalho)</td> </tr><tr> <td><code>lib</code></td> <td>Bibliotecas</td> </tr><tr> <td><code>man</code></td> <td>Páginas do manual do Unix</td> </tr><tr> <td><code>mysql-test</code></td> <td>Suíte de testes do MySQL ('MySQL Test' está desativado por padrão durante o processo de instalação ao usar o pacote de instalador (DMG))</td> </tr><tr> <td><code>share</code></td> <td>Arquivos de suporte diversos, incluindo mensagens de erro, <code>dictionary.txt</code> e rewriter SQL</td> </tr><tr> <td><code>support-files</code></td> <td>Scripts de suporte, como <code>mysqld_multi.server</code>, <code>mysql.server</code> e <code>mysql-log-rotate</code>.</td> </tr><tr> <td><code>/tmp/mysql.sock</code></td> <td>Localização do soquete Unix do MySQL</td> </tr></tbody></table>
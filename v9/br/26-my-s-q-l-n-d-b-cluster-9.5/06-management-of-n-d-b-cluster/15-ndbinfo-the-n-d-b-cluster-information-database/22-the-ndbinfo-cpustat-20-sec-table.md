...
Assim como a `cpustat_50ms` e a `cpustat_1sec`, esta tabela mostra 20 conjuntos de medição por fio, cada um referenciando um período da duração nomeada. Assim, a `cpsustat_20sec` fornece 400 segundos de histórico.

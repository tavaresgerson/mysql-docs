...
_scan_count</code></a> </p></li></ul> </div> </td> </tr><tr> <th><code>TableScanCompleteCount</code></th> <td>Number of table scans that have completed.</td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-type: disc; "><li class="listitem"><p> <code>Ndb_api_table_scan_complete_count_session</code> </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_complete_count_replica</code> </p></li><li class="listitem"><p> [none] </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_complete_count</code> </p></li></ul> </div> </td> </tr><tr> <th><code>TableScanFailedCount</code></th> <td>Number of table scans that have failed.</td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-type: disc; "><li class="listitem"><p> <code>Ndb_api_table_scan_failed_count_session</code> </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_failed_count_replica</code> </p></li><li class="listitem"><p> [none] </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_failed_count</code> </p></li></ul> </div> </td> </tr><tr> <th><code>TableScanTime</code></th> <td>Total time (in nanoseconds) spent on table scans.</td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p> <code>Ndb_api_table_scan_time_session</code> </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_time_replica</code> </p></li><li class="listitem"><p> [none] </p></li><li class="listitem"><p> <code>Ndb_api_table_scan_time</code> </p></li></ul> </div> </td> </tr><tr> <th><code>TableScanBytes</code></th> <td>Total amount of data (in bytes) sent to the data nodes during table scans.</td> <td> <div class="itemizedlist"> <ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p> <a class="link" href="mysql-cluster-options-variables.html#statvar_Ndb_api_table_scan_bytes_session"><code>Ndb_api_table_scan_bytes_session</code>

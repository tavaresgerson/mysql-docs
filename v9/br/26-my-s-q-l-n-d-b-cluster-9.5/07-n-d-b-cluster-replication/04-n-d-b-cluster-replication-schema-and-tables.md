...
<table><col width="10%"/><col width="55%"/><thead><tr> <th scope="col">Valor</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <td>0</td> <td>Usar o valor padrão do servidor</td> </tr><tr> <td>1</td> <td>Não registrar esta tabela no log binário (mesmo efeito que <a class="link" href="replication-options-binary-log.html#sysvar_sql_log_bin"><code class="literal">sql_log_bin = 0</code></a>, mas aplica-se a uma ou mais tabelas especificadas)</td> </tr><tr> <td>2</td> <td>Registrar apenas os atributos atualizados; registrar esses como eventos <code class="literal">WRITE_ROW</code></td> </tr><tr> <td>3</td> <td>Registrar a linha completa, mesmo que não seja atualizada (comportamento padrão do servidor MySQL)</td> </tr><tr> <td>6</td> <td>Usar atributos atualizados, mesmo que os valores não tenham sido alterados</td> </tr><tr> <td>7</td> <td>Registrar a linha completa, mesmo que não haja alterações nos valores; registrar as atualizações como eventos <code class="literal">UPDATE_ROW</code></td> </tr><tr> <td>8</td> <td>Registrar a atualização como <code class="literal">UPDATE_ROW</code>; registrar apenas as colunas da chave primária na imagem anterior e apenas as colunas atualizadas na imagem posterior (mesmo efeito que <a class="link" href="mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-minimal"><code class="option">--ndb-log-update-minimal</code></a>, mas aplica-se a uma ou mais tabelas especificadas)</td> </tr><tr> <td>9</td> <td>Registrar a atualização como <code class="literal">UPDATE_ROW</code>; registrar apenas as colunas da chave primária na imagem anterior e todas as colunas, exceto as colunas da chave primária, na imagem posterior</td> </tr></tbody></table>

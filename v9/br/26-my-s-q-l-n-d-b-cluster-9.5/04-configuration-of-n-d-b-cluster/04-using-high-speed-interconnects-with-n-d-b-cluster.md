...
O NDB Cluster suporta três desses mecanismos (veja a Seção 25.2.1, “Conceitos Básicos do NDB Cluster”). Um quarto transportador, a Interface Coherente Escalável (SCI), também era suportado em versões muito antigas do `NDB`. Isso exigia hardware, software e binários do MySQL especializados que já não estão disponíveis.
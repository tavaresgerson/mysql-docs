...
Na verdade, um nó SQL é apenas um tipo especializado de nó API, que designa qualquer aplicativo que acesse os dados do clúster NDB. Outro exemplo de um nó API é o utilitário **ndb_restore** que é usado para restaurar uma cópia de segurança do clúster. É possível escrever tais aplicativos usando a API NDB. Para informações básicas sobre a API NDB, consulte Começando com a API NDB.

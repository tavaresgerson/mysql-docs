...
<table frame="box" rules="all" summary="Propriedades para cluster-config-suffix">
  <tr>
    ...
    <td><code>--cluster-config-suffix=nome</code></td>
  </tr>
  <tr>
    <th>Tipo</th>
    <td>String</td>
...
* `--config-binary-file=caminho-para-arquivo`
  ...
  <table frame="box" rules="all" summary="Propriedades para config-binary-file">
    <tr>
      <th>Formato de linha de comando</th>
      <td><code>--config-binary-file=caminho/para/arquivo</code></td>
    </tr>
    <tr>
      <th>Tipo</th>
...
<table frame="box" rules="all" summary="Propriedades para connections">
  <tr><th>Formato de linha de comando</th> <td><code>--connections</code></td> </tr>
</table>
...
* `--defaults-extra-file`
  ...
  <table frame="box" rules="all" summary="Propriedades para o sufixo de configuração do cluster">
    <tr><th>Formato de linha de comando</th> <td><code>--cluster-config-suffix=nome</code></td> </tr>
    <tr><th>Tipo</th> <td>String</td> </tr>
...
<table frame="box" rules="all" summary="Propriedades para cluster-config-suffix"><tbody><tr><th>Formato de linha de comando</th> <td><code>--cluster-config-suffix=nome</code></td> </tr><tr><th>Tipo</th> <td>String</td> </tr><tr><th>Valor padrão</th> <td><code>[nenhum]</code></td> </tr></tbody></table>
...
<table frame="box" rules="all" summary="Propriedades para cluster-config-suffix"><tr><th>Formato de linha de comando</th> <td><code>--cluster-config-suffix=nome</code></td> </tr><tr><th>Tipo</th> <td>String</td> </tr><tr><th>Valor padrão</th> <td><code>[nenhum]</code></td> </tr></table>
...
<table frame="box" rules="all" summary="Propriedades para config-binary-file"><tr><th>Formato de linha de comando</th> <td><code>--config-binary-file=caminho/para/arquivo</code></td> </tr><tr><th>Tipo</th> <td>Nome do arquivo</td> </tr><tr><th>Valor padrão</th> <td><code></code></td> </tr></table>
...
<table frame="box" rules="all" summary="Propriedades para config-binary-file"><tbody><tr><th>Formato de linha de comando</th> <td><code>--config-binary-file=caminho/para/arquivo</code></td> </tr><tr><th>Tipo</th> <td>Nome do arquivo</td> </tr><tr><th>Valor padrão</th> <td><code></code></td> </tr></tbody></table>
...
* `--query=opções-de-consulta`, `-q` *`opções-de-consulta`*
  ...
  <table frame="box" rules="all" summary="Propriedades para config-file">
    <tr>
      <th>Formato de linha de comando</th>
      <td><code>--config-file=nome_do_arquivo</code></td>
    </tr>
    <tr>
      <th>Tipo</th>
      <td>Nome do arquivo</td>

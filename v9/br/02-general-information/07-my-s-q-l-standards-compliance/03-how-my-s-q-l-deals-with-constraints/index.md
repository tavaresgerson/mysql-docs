...
1.7.3.1 Restrições de índice PRIMARY KEY e UNIQUE

1.7.3.2 Restrições FOREIGN KEY

1.7.3.3 Estruturas de dados ENUM e SET
...
A filosofia básica é que o MySQL Server tenta produzir um erro para qualquer coisa que ele possa detectar durante a análise de uma instrução a ser executada e tenta se recuperar de quaisquer erros que ocorram durante a execução da instrução. Fazemos isso na maioria dos casos, mas ainda não para todos.

...
Você pode obter informações sobre o número de linhas realmente inseridas ou atualizadas com a função C `mysql_info()`. Você também pode usar a declaração `SHOW WARNINGS`. Veja mysql_info() e a Seção 15.7.7.43, “Declaração SHOW WARNINGS”.

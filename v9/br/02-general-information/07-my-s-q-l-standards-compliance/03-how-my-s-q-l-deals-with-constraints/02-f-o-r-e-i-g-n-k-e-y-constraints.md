...
As chaves estrangeiras permitem a referência cruzada de dados relacionados entre tabelas, e as restrições de chave estrangeira ajudam a manter esses dados dispersos consistentes.
...
Você pode obter informações sobre chaves estrangeiras a partir da tabela do Schema de Informações `KEY_COLUMN_USAGE`. Um exemplo de consulta contra essa tabela é mostrado aqui:

...
O SQL padrão utiliza a sintaxe C `/* este é um comentário */` para comentários, e o MySQL Server também suporta essa sintaxe. O MySQL também suporta extensões dessa sintaxe que permitem que o SQL específico do MySQL seja incorporado no comentário; veja a Seção 11.7, “Comentários”.

...
* Se o arquivo de índice do conjunto de caracteres (`Index.xml`) não contiver o nome do conjunto de caracteres, o seu programa exibe uma mensagem de erro:
  ...
  Para resolver esse problema, você deve obter um novo arquivo de índice ou adicionar manualmente o nome dos conjuntos de caracteres ausentes no arquivo atual.

...
O MySQL 9.5 interpreta o conjunto de caracteres nacional como `utf8mb3`, que agora está desatualizado. Assim, usar `CARACTERE NACIONAL` ou um de seus sinônimos para definir o conjunto de caracteres para um banco de dados, tabela ou coluna gera uma mensagem de aviso semelhante a esta:

...
O MySQL Server possui um conjunto de caracteres do servidor e uma ordenação do servidor. Por padrão, esses são `utf8mb4` e `utf8mb4_0900_ai_ci`, mas podem ser definidos explicitamente na inicialização do servidor na linha de comando ou em um arquivo de opções e alterados em tempo de execução.

...
O exemplo a seguir passa condições de busca para o método `delete()`. Todos os registros que correspondem à condição são excluídos da tabela cidade. Neste exemplo, um registro corresponde à condição.
...
Para excluir o primeiro registro na tabela cidade, use o método `limit()` com um valor de 1.

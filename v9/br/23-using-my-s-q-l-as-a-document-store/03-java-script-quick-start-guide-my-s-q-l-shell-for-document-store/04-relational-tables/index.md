...
<table summary="Operações CRUD para uso interativo em tabelas no MySQL Shell"><col style="width: 32%"/><col style="width: 68%"/><thead><tr> <th>Forma da operação</th> <th>Descrição</th> </tr></thead><tbody><tr> <td><code>db.<em><code>name</code></em>.insert()</code></td> <td>O método insert() insere um ou mais registros na tabela nomeada.</td> </tr><tr> <td><code>db.<em><code>name</code></em>.select()</code></td> <td>O método select() retorna alguns ou todos os registros na tabela nomeada.</td> </tr><tr> <td><code>db.<em><code>name</code></em>.update()</code></td> <td>O método update() atualiza registros na tabela nomeada.</td> </tr><tr> <td><code>db.<em><code>name</code></em>.delete()</code></td> <td>O método delete() exclui um ou mais registros da tabela nomeada.</td> </tr></tbody></table>
...
* Veja a Seção 22.3.2, “Baixar e importar o banco de dados world_x” para instruções sobre a configuração da amostra de esquema `world_x`.
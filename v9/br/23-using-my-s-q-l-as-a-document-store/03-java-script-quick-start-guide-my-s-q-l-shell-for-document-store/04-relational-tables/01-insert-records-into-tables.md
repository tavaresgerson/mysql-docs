...
Para inserir um registro completo, passe para o método `insert()` todas as colunas da tabela. Em seguida, passe para o método `values()` um valor para cada coluna da tabela. Por exemplo, para adicionar um novo registro à tabela cidade no esquema `world_x`, insira o seguinte registro e pressione **Enter** duas vezes.

...
Os exemplos nesta seção usam a coleção `countryinfo` no esquema `world_x`. Para instruções sobre como configurar o esquema `world_x`, consulte a Seção 22.4.2, “Baixar e Importar o Banco de Dados world_x”.

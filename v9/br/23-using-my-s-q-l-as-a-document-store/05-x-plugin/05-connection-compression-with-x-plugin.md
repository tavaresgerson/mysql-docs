...
<table frame="void"><col align="center" style="width: 18%"/><col align="center" style="width: 14%"/><col align="center" style="width: 18%"/><col align="center" style="width: 17%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Algoritmo</th> <th scope="col">Alias</th> <th scope="col">Taxa de Compressão</th> <th scope="col">Produtividade</th> <th scope="col">Custo do CPU</th> <th scope="col">Prioridade Padrão</th> </tr></thead><tbody><tr> <th scope="row"><code class="literal">zsth_stream</code></th> <td><code class="literal">zstd</code></td> <td>Alto</td> <td>Alto</td> <td>Médio</td> <td>Primeiro</td> </tr><tr> <th scope="row"><code class="literal">lz4_message</code></th> <td><code class="literal">lz4</code></td> <td>Baixo</td> <td>Alto</td> <td>Menor</td> <td>Segundo</td> </tr><tr> <th scope="row"><code class="literal">deflate_stream</code></th> <td><code class="literal">deflate</code></td> <td>Alto</td> <td>Baixo</td> <td>Maior</td> <td>Terceiro</td> </tr></tbody></table>

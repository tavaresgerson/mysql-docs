...
Se você receber o seguinte erro, significa que, quando o **mysqld** foi iniciado ou quando ele recarregou as tabelas de concessão, ele encontrou uma conta na tabela `user` com uma senha inválida.

...
* O conjunto de caracteres é um conjunto de caracteres multibyte e você não tem suporte para o conjunto de caracteres no cliente. Nesse caso, você precisa recompilar o cliente executando o **CMake** com a opção `-DDEFAULT_CHARSET=charset_name`. Veja a Seção 2.8.7, “Opções de Configuração de Fonte do MySQL”.

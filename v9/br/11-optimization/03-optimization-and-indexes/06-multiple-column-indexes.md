...
Se um índice de múltiplas colunas existir em `col1` e `col2`, as linhas apropriadas podem ser recuperadas diretamente. Se existirem índices separados de uma única coluna em `col1` e `col2`, o otimizador tenta usar a otimização de fusão de índices (consulte a Seção 10.2.1.3, “Otimização de Fusão de Índices”) ou tenta encontrar o índice mais restritivo, decidindo qual índice exclui mais linhas e usando esse índice para recuperar as linhas.

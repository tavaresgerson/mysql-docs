...
<table frame="box" rules="all" summary="Uma referência que lista funções vetoriais."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>DISTANCE()</code></td> <td> Calcula a distância entre dois vetores conforme o método especificado </td> </tr><tr><td><code>STRING_TO_VECTOR()</code></td> <td> Obtém o valor binário da coluna `VECTOR` representada por uma string compatível </td> </tr><tr><td><code>VECTOR_DIM()</code></td> <td> Obtém o comprimento de um vetor (ou seja, o número de entradas que ele contém) </td> </tr><tr><td><code>VECTOR_TO_STRING()</code></td> <td> Obtém a representação em string de uma coluna `VECTOR`, dado seu valor como uma string binária </td> </tr></tbody></table>

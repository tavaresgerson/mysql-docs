...
<table frame="box" rules="all" summary="Uma referência que lista funções vetoriais."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="vector-functions.html#function_distance"><code class="literal">DISTANCE()</code></a></td> <td> Calcula a distância entre dois vetores conforme o método especificado </td> </tr><tr><td><a class="link" href="vector-functions.html#function_string-to-vector"><code class="literal">STRING_TO_VECTOR()</code></a></td> <td> Obtém o valor binário da coluna `VECTOR` representada por uma string compatível </td> </tr><tr><td><a class="link" href="vector-functions.html#function_vector-dim"><code class="literal">VECTOR_DIM()</code></a></td> <td> Obtém o comprimento de um vetor (ou seja, o número de entradas que ele contém) </td> </tr><tr><td><a class="link" href="vector-functions.html#function_vector-to-string"><code class="literal">VECTOR_TO_STRING()</code></a></td> <td> Obtém a representação em string de uma coluna `VECTOR`, dado seu valor como uma string binária </td> </tr></tbody></table>

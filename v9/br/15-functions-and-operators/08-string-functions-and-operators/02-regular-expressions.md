...
<table frame="box" rules="all" summary="Uma referência que lista as funções e operadores de expressões regulares."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="regexp.html#operator_not-regexp"><code>NOT REGEXP</code></a></td> <td>Negação de REGEXP</td> </tr><tr><td><a class="link" href="regexp.html#operator_regexp"><code>REGEXP</code></a></td> <td>Se a string corresponde à expressão regular</td> </tr><tr><td><a class="link" href="regexp.html#function_regexp-instr"><code>REGEXP_INSTR()</code></a></td> <td>Índice inicial da substring que corresponde à expressão regular</td> </tr><tr><td><a class="link" href="regexp.html#function_regexp-like"><code>REGEXP_LIKE()</code></a></td> <td>Se a string corresponde à expressão regular</td> </tr><tr><td><a class="link" href="regexp.html#function_regexp-replace"><code>REGEXP_REPLACE()</code></a></td> <td>Substituir substrings que correspondem à expressão regular</td> </tr><tr><td><a class="link" href="regexp.html#function_regexp-substr"><code>REGEXP_SUBSTR()</code></a></td> <td>Retornar a substring que corresponde à expressão regular</td> </tr><tr><td><a class="link" href="regexp.html#operator_regexp"><code>RLIKE</code></a></td> <td>Se a string corresponde à expressão regular</td> </tr></tbody></table>

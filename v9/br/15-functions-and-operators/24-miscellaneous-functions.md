...
<table frame="box" rules="all" summary="Uma referência que lista funções diversas."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><code>ANY_VALUE()</code></td> <td> Supressão da rejeição do valor <code>ONLY_FULL_GROUP_BY</code></td> </tr><tr><td><code>BIN_TO_UUID()</code></td> <td> Conversão de UUID binário em string</td> </tr><tr><td><code>DEFAULT()</code></td> <td> Retorna o valor padrão para uma coluna de tabela</td> </tr><tr><td><code>ETAG()</code></td> <td> Calcular hash para cada linha, usando uma ou mais colunas ou outros valores</td> </tr><tr><td><code>GROUPING()</code></td> <td> Distinguir linhas de ROLLUP de superagregados de linhas regulares</td> </tr><tr><td><code>INET_ATON()</code></td> <td> Retornar o valor numérico de um endereço IP</td> </tr><tr><td><code>INET_NTOA()</code></td> <td> Retornar o endereço IP a partir de um valor numérico</td> </tr><tr><td><code>IS_UUID()</code></td> <td> Se o argumento é um UUID válido</td> </tr><tr><td><code>NAME_CONST()</code></td> <td> Tornar a coluna com o nome dado</td> </tr><tr><td><code>SLEEP()</code></td> <td> Dormir por um número de segundos</td> </tr><tr><td><code>UUID()</code></td> <td> Retornar um identificador único universal (UUID)</td> </tr><tr><td><code>UUID_SHORT()</code></td> <td> Retornar um identificador universal com valor inteiro</td> </tr><tr><td><code>UUID_TO_BIN()</code></td> <td> Converter UUID em binário</td> </tr><tr><td><code>VALUES()</code></td> <td> Definir os valores a serem usados durante um INSERT</td> </tr></tbody></table>

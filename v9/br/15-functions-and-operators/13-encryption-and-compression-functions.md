...
<table frame="box" rules="all" summary="Uma referência que lista funções de criptografia."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Nome</th> <th>Descrição</th> <th>Desatualizado</th> </tr></thead><tbody><tr><th scope="row"><a class="link" href="encryption-functions.html#function_aes-decrypt"><code class="literal">AES_DECRYPT()</code></a></th> <td> Decrypta usando AES </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_aes-encrypt"><code class="literal">AES_ENCRYPT()</code></a></th> <td> Criptota usando AES </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_compress"><code class="literal">COMPRESS()</code></a></th> <td> Retorna o resultado como uma string binária </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_md5"><code class="literal">MD5()</code></a></th> <td> Calcula o checksum MD5 </td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_random-bytes"><code class="literal">RANDOM_BYTES()</code></a></th> <td> Retorna um vetor de bytes aleatórios </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_sha1"><code class="literal">SHA1()</code>, <code class="literal">SHA()</code></a></th> <td> Calcula o checksum SHA-1 de 160 bits </td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_sha2"><code class="literal">SHA2()</code></a></th> <td> Calcula o checksum SHA-2 </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_statement-digest"><code class="literal">STATEMENT_DIGEST()</code></a></th> <td> Calcula o valor do hash do digest de declaração </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_statement-digest-text"><code class="literal">STATEMENT_DIGEST_TEXT()</code></a></th> <td> Calcula o digest normalizado da declaração </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_uncompress"><code class="literal">UNCOMPRESS()</code></a></th> <td> Descomprime uma string comprimida </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_uncompressed-length"><code class="literal">UNCOMPRESSED_LENGTH()</code></a></th> <td> Retorna o comprimento de uma string antes da compressão </td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_validate-password-strength"><code class="literal">VALIDATE_PASSWORD_STRENGTH()</code></a></th> <td> Determina a força da senha </td> <td></td> </tr></tbody></table>

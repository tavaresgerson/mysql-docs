...
<table frame="box" rules="all" summary="Uma referência que lista os operadores aritméticos."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_mod"><code class="literal">%</code>, <code class="literal">MOD</code></a></td> <td> Operador de módulo </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_times"><code class="literal">*</code></a></td> <td> Operador de multiplicação </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_plus"><code class="literal">+</code></a></td> <td> Operador de adição </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_minus"><code class="literal">-</code></a></td> <td> Operador de subtração </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_unary-minus"><code class="literal">-</code></a></td> <td> Altera o sinal do argumento </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_divide"><code class="literal">/</code></a></td> <td> Operador de divisão </td> </tr><tr><td><a class="link" href="funcoes_aritmeticas.html#operador_div"><code class="literal">DIV</code></a></td> <td> Divisão inteira </td> </tr></tbody></table>

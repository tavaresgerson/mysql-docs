...
<table frame="box" rules="all" summary="Uma referência que lista os operadores de atribuição."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="operadores-de-atribuicao.html#operador_assign-valor"><code class="literal">:=</code></a></td> <td> Atribuir um valor </td> </tr><tr><td><a class="link" href="operadores-de-atribuicao.html#operador_assign-igual"><code class="literal">=</code></a></td> <td> Atribuir um valor (como parte de uma declaração <a class="link" href="set-variable.html" title="15.7.6.1 Sintaxe SET para Atribuição de Variáveis"><code class="literal">SET</code></a>, ou como parte da cláusula <code class="literal">SET</code> em uma declaração <a class="link" href="update.html" title="15.2.17 Declaração UPDATE"><code class="literal">UPDATE</code></a> statement) </td> </tr></tbody></table>

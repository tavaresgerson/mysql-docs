...
* `ST_Latitude(p [, new_latitude_val])`
  ...
  Com um único argumento representando um objeto `Point` válido *`p`* que tem um sistema de referência espacial geográfico (SRS), `ST_Latitude()` retorna o valor de latitude de *`p`* como um número de precisão dupla.
...
* `ST_Longitude(p [, new_longitude_val])`
  ...
  Com um único argumento representando um objeto `Point` válido *`p`* que tem um sistema de referência espacial geográfico (SRS), `ST_Longitude()` retorna o valor de longitude de *`p`* como um número de precisão dupla.
...
Com o segundo argumento opcional, `ST_X()` retorna um objeto `Point` como o primeiro argumento, com sua coordenada X igual ao segundo argumento. Se o objeto `Point` tiver um SRS geográfico, o segundo argumento deve estar dentro do intervalo adequado para valores de longitude ou latitude.
...
* `ST_Y(p [, new_y_val])`
  ...
  Com o segundo argumento opcional, `ST_Y()` retorna um objeto `Point` como o primeiro argumento, com sua coordenada Y igual ao segundo argumento. Se o objeto `Point` tiver um SRS geográfico, o segundo argumento deve estar dentro do intervalo adequado para valores de longitude ou latitude.

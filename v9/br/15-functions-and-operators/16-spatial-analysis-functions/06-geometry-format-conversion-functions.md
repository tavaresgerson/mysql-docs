...
* Se qualquer argumento de geometria estiver em um sistema de referência espacial indefinido, os eixos são exibidos na ordem em que aparecem na geometria e uma mensagem de aviso `ER_WARN_SRS_NOT_FOUND_AXIS_ORDER` é exibida.

...
<table summary="Suporte DDL online para operações de índice, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstitui a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Criando ou adicionando um índice secundário</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Excluindo um índice</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Renomeando um índice</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Adicionando um índice <code class="literal">FULLTEXT</code></th> <td>Não</td> <td>Sim*</td> <td>Não*</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Adicionando um índice <code class="literal">SPATIAL</code></th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Mudando o tipo de índice</th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de chave primária indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstrói a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Adicionar uma chave primária</th> <td>Não</td> <td>Sim*</td> <td>Sim*</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Remover uma chave primária</th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Remover uma chave primária e adicionar outra</th> <td>Não</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de coluna, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstitui a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Adicionar uma coluna</th> <td>Sim*</td> <td>Sim</td> <td>Não*</td> <td>Sim*</td> <td>Sim</td> </tr><tr> <th scope="row">Remover uma coluna</th> <td>Sim*</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Renomear uma coluna</th> <td>Sim*</td> <td>Sim</td> <td>Não</td> <td>Sim*</td> <td>Sim</td> </tr><tr> <th scope="row">Rearranjar colunas</th> <td>Não</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Definir um valor padrão para uma coluna</th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Alterar o tipo de dados de uma coluna</th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Aumentar o tamanho de uma coluna <code class="literal">VARCHAR</code></th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Remover o valor padrão da coluna</th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Alterar o valor de autoincremento</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Não*</td> </tr><tr> <th scope="row">Tornar uma coluna <code class="literal">NULL</code></th> <td>Não</td> <td>Sim</td> <td>Sim*</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Tornar uma coluna <code class="literal">NOT NULL</code></th> <td>Não</td> <td>Sim*</td> <td>Sim*</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Modificar a definição de uma coluna <code class="literal">ENUM</code> ou <code class="literal">SET</code></th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de coluna gerada indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstrói a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Adicionar uma coluna <code class="literal">STORED</code></th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Modificar a ordem da coluna <code class="literal">STORED</code></th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Remover uma coluna <code class="literal">STORED</code></th> <td>Não</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Adicionar uma coluna <code class="literal">VIRTUAL</code></th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Modificar a ordem da coluna <code class="literal">VIRTUAL</code></th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Remover uma coluna <code class="literal">VIRTUAL</code></th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de chave estrangeira, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstrói a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Adicionar uma restrição de chave estrangeira</th> <td>Não</td> <td>Sim*</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Remover uma restrição de chave estrangeira</th> <td>Não</td> <td>Sim</th> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de tabela, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instante</th> <th scope="col">No Local</th> <th scope="col">Reconstitui a Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Alterar o <code class="literal">ROW_FORMAT</code></th> <td>Não</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Alterar o <code class="literal">KEY_BLOCK_SIZE</code></th> <td>Não</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Definir estatísticas persistentes da tabela</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Especificar um conjunto de caracteres</th> <td>Não</td> <td>Sim</td> <td>Sim*</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Converter um conjunto de caracteres</th> <td>Não</td> <td>Sim</td> <td>Sim*</td> <td>Não</td> <td>Não</td> </tr><tr> <th scope="row">Otimizar uma tabela</th> <td>Não</td> <td>Sim*</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Reconstituir com a opção <code class="literal">FORCE</code></th> <td>Não</td> <td>Sim*</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Realizar uma reconstrução nula</th> <td>Não</td> <td>Sim*</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Renomear uma tabela</th> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte DDL online para operações de tablespace indicando se a operação é realizada no local, reconstrui tabelas dentro do tablespace, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><col align="center" style="width: 16%"/><thead><tr> <th scope="col">Operação</th> <th scope="col">Instantânea</th> <th scope="col">No Local</th> <th scope="col">Reconstrói Tabela</th> <th scope="col">Permite DML Concorrente</th> <th scope="col">Apenas Modifica Metadados</th> </tr></thead><tbody><tr> <th scope="row">Renomear um tablespace geral</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">Habilitar ou desabilitar criptografia de tablespace geral</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">Habilitar ou desabilitar criptografia de tablespace por arquivo</th> <td>Não</td> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr></tbody></table>
...
<thead><tr>
<th scope="col">Cláusula de Particionamento</th>
<th scope="col">Instantâneo</th>
<th scope="col">In-Place</th>
<th scope="col">Permite DML</th>
...
<td>Não</td>
<td>Não</td>
<td>Permite <code class="literal">ALGORITHM=COPY</code>, <code class="literal">LOCK={DEFAULT|SHARED|EXCLUSIVE}</code></td>
</tr><tr>
...
<td>Sim*</td>
<td>Sim*</td>
<td><code class="literal">ALGORITHM=INPLACE, LOCK={DEFAULT|NONE|SHARED|EXCLUSISVE}</code> é suportado para partições <code class="literal">RANGE</code> e <code class="literal">LIST</code>, <code class="literal">ALGORITHM=INPLACE, LOCK={DEFAULT|SHARED|EXCLUSISVE}</code> para partições <code class="literal">HASH</code> e <code class="literal">KEY</code>, e <code class="literal">ALGORITHM=COPY, LOCK={SHARED|EXCLUSIVE}</code> para todos os tipos de partições. Não copia dados para tabelas particionadas por <code class="literal">RANGE</code> ou <code class="literal">LIST</code>. Consultas concorrentes são permitidas com <code class="literal">ALGORITHM=COPY</code> para tabelas particionadas por <code class="literal">HASH</code> ou <code class="literal">LIST</code>, pois o MySQL copia os dados enquanto mantém um bloqueio compartilhado.</td>
</tr><tr>
...
<td>Sim*</td>
<td>Sim*</td>
<td><p> <code class="literal">ALGORITHM=INPLACE, LOCK={DEFAULT|NONE|SHARED|EXCLUSISVE}</code> é suportado. Não copia dados para tabelas particionadas por <code class="literal">RANGE</code> ou <code class="literal">LIST</code>. </p><p> <code class="literal">DROP PARTITION</code> com <code class="literal">ALGORITHM=INPLACE</code> exclui os dados armazenados na partição e exclui a partição. No entanto, <code class="literal">DROP PARTITION</code> com <code class="literal">ALGORITHM=COPY</code> ou <a class="link" href="server-system-variables.html#sysvar_old_alter_table"><code class="literal">old_alter_table=ON</code></a> reconstrui a tabela particionada e tenta mover dados de uma partição excluída para outra partição com uma definição de <code class="literal">PARTITION ... VALUES</code> compatível. Os dados que não podem ser movidos para outra partição são excluídos. </p></td>
</tr><tr>
...
<td>Não</td>
<td>Não</td>
<td>Permite apenas <code class="literal">ALGORITHM=DEFAULT</code>, <code class="literal">LOCK=DEFAULT</code></td>
</tr><tr>

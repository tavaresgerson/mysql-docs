...
<table summary="Tipos de log do servidor MySQL e as informações escritas em cada log."><thead><tr> <th>Tipo de Log</th> <th>Informações Escritas no Log</th> </tr></thead><tbody><tr> <td>Log de Erros</td> <td>Problemas encontrados ao iniciar, executar ou parar <span><strong>mysqld</strong></span></td> </tr><tr> <td>Log de Consultas Gerais</td> <td>Conexões estabelecidas com clientes e instruções recebidas dos clientes</td> </tr><tr> <td>Log Binário</td> <td>Instruções que alteram dados (também usadas para replicação)</td> </tr><tr> <td>Log de Relevo</td> <td>Alterações de dados recebidas de um servidor de origem de replicação</td> </tr><tr> <td>Log de Consultas Lentas</td> <td>Consultas que levaram mais de <code>long_query_time</code> segundos para executar</td> </tr><tr> <td>Logs de DDL</td> <td>Operações DDL atômicas realizadas por instruções DDL</td> </tr></tbody></table>

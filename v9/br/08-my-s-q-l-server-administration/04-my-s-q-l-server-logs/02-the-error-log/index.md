...
7.4.2.5 Filtragem do Diário de Erros Baseada em Prioridade (log_filter_internal)

7.4.2.6 Filtragem do Diário de Erros Baseada em Regras (log_filter_dragnet)
...
Dependendo da configuração do diário de erros, os erros também podem preencher a tabela `error_log` do Schema de Desempenho, para fornecer uma interface SQL ao log e permitir que seu conteúdo seja pesquisado. Consulte a Seção 29.12.22.3, “A Tabela error_log”.
...
Se usado para iniciar o **mysqld**, o **mysqld_safe** pode escrever mensagens no diário de erros. Por exemplo, quando o **mysqld_safe** nota uma saída anormal do **mysqld**, ele reinicia o **mysqld** e escreve uma mensagem `mysqld reiniciado` no diário de erros.

...
<table>
  ...
  <tr>
    <td><td align="left" valign="top"><p>Qual versão do MySQL está pronta para produção (GA)? </p></td>
    ...
    <p> O MySQL 8.0 alcançou o status de General Availability (GA) com o MySQL 8.0.11, que foi lançado para uso em produção em 19 de abril de 2018. Ele se tornou uma série de correções de bugs a partir do MySQL 8.0.34 com a introdução do modelo de lançamento de inovação e LTS Inovação e LTS. </p>
  ...
  <tr>
    <td><td align="left" valign="top"><p><b>A.1.2.</b></p></td>
    <td><p> Por que a numeração da versão do MySQL saltou as versões 6 e 7 e foi diretamente para 8.0? </p></td>
  </tr>
  <tr>
    <td><td align="left" valign="top"><p>O MySQL pode fazer subqueries? </p></td>

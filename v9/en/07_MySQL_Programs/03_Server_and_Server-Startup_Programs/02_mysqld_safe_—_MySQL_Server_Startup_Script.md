...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is the recommended way to start a
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server on Unix.
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") adds some safety features such as
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is not installed because it is
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") on platforms that use systemd
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") tries to start an executable
named [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). To override the default
...
to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). You can also use
[`--ledir`](mysqld-safe.html#option_mysqld_safe_ledir) to indicate the
directory where [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") should look for
the server.

Many of the options to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") are the
same as the options to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). See
[Section 7.1.7, “Server Command Options”](server-options.html "7.1.7 Server Command Options").

Options unknown to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") are passed to
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") if they are specified on the command
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") reads all options from the
`[mysqld]`, `[server]`, and
`[mysqld_safe]` sections in option files. For
example, if you specify a `[mysqld]` section
like this, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") finds and uses the
...
For backward compatibility, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") also
reads `[safe_mysqld]` sections, but to be
current you should rename such sections to
`[mysqld_safe]`.

[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") accepts options on the command
...
<td>String</td>
  ...
  The size of the core file that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  ...
  **ulimit -c**.
  ...
  see [Section 17.8.3.7, “Excluding or Including Buffer Pool Pages from Core Files”](innodb-buffer-pool-in-core-file.html "17.8.3.7 Excluding or Including Buffer Pool Pages from Core Files").
...
<td>Directory name</td>
  ...
  If [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") cannot find the server,
  ...
  See [Section 2.5.9, “Managing MySQL Server with systemd”](using-systemd.html "2.5.9 Managing MySQL Server with systemd").
...
<td><p class="valid-value"><code class="literal">system</code></p><p class="valid-value"><code class="literal">hyphen</code></p><p class="valid-value"><code class="literal">legacy</code></p></td>
  ...
  produced by [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). The following
  list describes the permitted values. For any other value,
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") logs a warning and uses
  `UTC` format.
  ...
  + `HYPHEN`, `hyphen`
    ...
    *`YY-MM-DD h:mm:ss`* format, as
    in [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") for MySQL 5.6.

  + `LEGACY`, `legacy`

    *`YYMMDD hh:mm:ss`* format, as in
    [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") prior to MySQL 5.6.
...
<td><code class="literal">--help</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") runs:
  ...
  + Prior to MySQL 8.0.21, if the option is given as
    ...
    [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") looks for a
    `tcmalloc` library in
    `/usr/lib`. If
    `tmalloc` is found, its path name is
    added to the beginning of the
    `LD_PRELOAD` value for
    [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). If
    `tcmalloc` is not found,
    [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") aborts with an error.
  ...
  + For cases where [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") adds a
  ...
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is not available. Instead,
...
<td><code class="literal">--help</code></td>
  ...
  binary distribution. If [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")
...
<td><code class="literal">--help</code></td>
  ...
  base name is assumed to be [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). For
  example, if you use
  [`--mysqld-version=debug`](mysqld-safe.html#option_mysqld_safe_mysqld-version),
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") starts the
  [**mysqld-debug**](mysqld.html "6.3.1 mysqld — The MySQL Server") program in the
  `ledir` directory. If the argument to
  [`--mysqld-version`](mysqld-safe.html#option_mysqld_safe_mysqld-version) is
  empty, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") uses
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") in the `ledir`
  directory.
...
<td><code class="literal">--help</code></td>
  ...
  The number of files that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") should be
  able to open. The option value is passed to **ulimit
  -n**.

  Note

  You must start [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") as
...
<td><code class="literal">--help</code></td>
  ...
  The path name that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") should use for
  its process ID file.
...
<td><code class="literal">--help</code></td>
  ...
  Do not try to kill stray [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes
...
<td>Directory name</td>
  ...
  Using these options to control [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  logging is deprecated. To write error log output to the
  system log, use the instructions at
  [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log"). To control the facility,
  use the server
  [`log_syslog_facility`](/doc/refman/8.0/en/server-system-variables.html#sysvar_log_syslog_facility) system
  variable.
...
<td>Directory name</td>
  ...
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") and [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  ...
  Using this option to control [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  logging is deprecated. Use the server
  [`log_syslog_tag`](/doc/refman/8.0/en/server-system-variables.html#sysvar_log_syslog_tag) system
  variable instead. See [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log").
...
If you execute [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") with the
...
The [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") script is written so that it
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") expects one of the following
conditions to be true:

* The server and databases can be found relative to the
  working directory (the directory from which
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is invoked). For binary
  distributions, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") looks under
  ...
  be met if you execute [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") from
...
* If the server and databases cannot be found relative to the
  working directory, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") attempts
...
Because [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") tries to find the server
...
run [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") from the MySQL installation
directory:
...
If [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") fails, even when invoked from
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") tries to use the
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") waits 1 full second before
starting again. This is intended to prevent excessive CPU usage
in the event of repeated failures. (Bug #11761530, Bug #54035)

When you use [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") to start
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")
arranges for error (and notice) messages from itself and from
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to go to the same destination.

There are several [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") options for
...
When [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") writes a message, notices go
...
Controlling [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") logging from
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is deprecated. Use the server's
native `syslog` support instead. For more
information, see [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log").
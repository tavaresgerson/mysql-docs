...
* Several MySQL Connectors implement DNS SRV support;
  ...
  [Connections Using DNS SRV Records](/doc/x-devapi-userguide/en/connecting-dns-srv.html). For details, see the
...
* The C API provides a
  ...
  [`mysql_real_connect()`](/doc/c-api/9.5/en/mysql-real-connect.html), except
  ...
  [mysql\_real\_connect\_dns\_srv()](/doc/c-api/9.5/en/mysql-real-connect-dns-srv.html).

* The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client has a
  [`--dns-srv-name`](mysql-command-options.html#option_mysql_dns-srv-name) option to
  indicate a DNS SRV record that specifies a group of servers.
  See [Section 6.5.1, “mysql — The MySQL Command-Line Client”](mysql.html "6.5.1 mysql — The MySQL Command-Line Client").
...
X DevAPI, see [Connections Using DNS SRV Records](/doc/x-devapi-userguide/en/connecting-dns-srv.html).
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")), MySQL
...
* [Transport Protocol Selection](transport-protocols.html#transport-protocol-selection "Transport Protocol Selection")
* [Transport Support for Local and Remote Connections](transport-protocols.html#transport-protocol-local-remote "Transport Support for Local and Remote Connections")
* [Interpretation of localhost](transport-protocols.html#transport-protocol-localhost "Interpretation of localhost")
* [Encryption and Security Characteristics](transport-protocols.html#transport-protocol-encryption "Encryption and Security Characteristics")
* [Connection Compression](transport-protocols.html#transport-protocol-compression "Connection Compression")
...
additional information, see [Section 6.2.4, “Connecting to the MySQL Server Using Command Options”](connecting.html "6.2.4 Connecting to the MySQL Server Using Command Options").

To specify the protocol explicitly, use the
[`--protocol`](connection-options.html#option_general_protocol) command option. The
following table shows the permissible values for
[`--protocol`](connection-options.html#option_general_protocol) and indicates the
...
[`--protocol=TCP`](connection-options.html#option_general_protocol), a connection to
...
[Command Options for Encrypted Connections](connection-options.html#encrypted-connection-options "Command Options for Encrypted Connections"). Named-pipe and
...
If the [`require_secure_transport`](server-system-variables.html#sysvar_require_secure_transport)

...
Option syntax is described in [Section 6.2.2, “Specifying Program Options”](program-options.html "6.2.2 Specifying Program Options").

Nonoption arguments (arguments with no leading dash) provide
additional information to the program. For example, the
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") program interprets the first nonoption
...
[`--host`](connection-options.html#option_general_host) (or `-h`),
[`--user`](connection-options.html#option_general_user) (or `-u`),
and [`--password`](connection-options.html#option_general_password) (or
...
[`--port`](connection-options.html#option_general_port) (or `-P`) to
specify a TCP/IP port number and
[`--socket`](connection-options.html#option_general_socket) (or `-S`)
...
options, see [Section 6.2.4, “Connecting to the MySQL Server Using Command Options”](connecting.html "6.2.4 Connecting to the MySQL Server Using Command Options").
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") is installed in
`/usr/local/mysql/bin`, you can run the program
by invoking it as [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), and it is not
...
[Section 6.2.9, “Setting Environment Variables”](setting-environment-variables.html "6.2.9 Setting Environment Variables").) After modifying

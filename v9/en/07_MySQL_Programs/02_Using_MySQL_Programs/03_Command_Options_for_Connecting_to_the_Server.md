...
* [Command Options for Connection Establishment](connection-options.html#connection-establishment-options "Command Options for Connection Establishment")
...
* [Command Options for Connection Compression](connection-options.html#connection-compression-options "Command Options for Connection Compression")
...
<table frame="box" rules="all" summary="Command-line options available for establishing connections to the server."><col style="width: 35%"/><col style="width: 64%"/><thead><tr><th>Option Name</th>
<th>Description</th>
</tr></thead><tbody><tr><td><a class="link" href="connection-options.html#option_general_default-auth">--default-auth</a></td>
<td>Authentication plugin to use</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_host">--host</a></td>
<td>Host on which MySQL server is located</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_password">--password</a></td>
<td>Password to use when connecting to server</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_password1">--password1</a></td>
<td>First multifactor authentication password to use when connecting to server</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_password2">--password2</a></td>
<td>Second multifactor authentication password to use when connecting to server</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_password3">--password3</a></td>
<td>Third multifactor authentication password to use when connecting to server</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_pipe">--pipe</a></td>
<td>Connect to server using named pipe (Windows only)</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_plugin-dir">--plugin-dir</a></td>
<td>Directory where plugins are installed</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_port">--port</a></td>
<td>TCP/IP port number for connection</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_protocol">--protocol</a></td>
<td>Transport protocol to use</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_shared-memory-base-name">--shared-memory-base-name</a></td>
<td>Shared-memory name for shared-memory connections (Windows only)</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_socket">--socket</a></td>
<td>Unix socket file or Windows named pipe to use</td>
</tr><tr><td><a class="link" href="connection-options.html#option_general_user">--user</a></td>
<td>MySQL user name to use when connecting to server</td>
</tr></tbody></table>

* [`--default-auth=plugin`](connection-options.html#option_general_default-auth)
...
* [`--host=host_name`](connection-options.html#option_general_host),
  `-h host_name`
...
* [`--password[=pass_val]`](connection-options.html#option_general_password),
  `-p[pass_val]`
...
<td><code class="literal">[none]</code></td>
  ...
  *no space* between
  [`--password=`](connection-options.html#option_general_password) or
  ...
  [`--skip-password`](connection-options.html#option_general_password)
  option.

* [`--password1[=pass_val]`](connection-options.html#option_general_password1)

  <table frame="box" rules="all" summary="Properties for password1"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--password1[=password]</code></td>
</tr><tr><th>Type</th>
<td>String</td>
</tr></tbody></table>
  ...
  space* between
  [`--password1=`](connection-options.html#option_general_password1) and the
  ...
  To explicitly specify that there is no password and that the
  client program should not prompt for one, use the
  [`--skip-password1`](connection-options.html#option_general_password1)
  option.

  [`--password1`](connection-options.html#option_general_password1) and
  [`--password`](connection-options.html#option_general_password) are synonymous,
  as are
  [`--skip-password1`](connection-options.html#option_general_password1)
  and
  [`--skip-password`](connection-options.html#option_general_password).
...
* [`--password2[=pass_val]`](connection-options.html#option_general_password2)
  ...
  <table frame="box" rules="all" summary="Properties for password2"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--password2[=password]</code></td>
</tr><tr><th>Type</th>
<td>String</td>
</tr></tbody></table>
  ...
  [`--password1`](connection-options.html#option_general_password1); see the
  description of that option for details.

* [`--password3[=pass_val]`](connection-options.html#option_general_password3)

  <table frame="box" rules="all" summary="Properties for password3"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--password3[=password]</code></td>
</tr><tr><th>Type</th>
<td>String</td>
</tr></tbody></table>
...
* [`--pipe`](connection-options.html#option_general_pipe), `-W`
...
* [`--plugin-dir=dir_name`](connection-options.html#option_general_plugin-dir)
...
<td>Directory name</td>
  ...
  option if the [`--default-auth`](connection-options.html#option_general_default-auth)
...
* [`--port=port_num`](connection-options.html#option_general_port),
  `-P port_num`
...
<td>String</td>
  ...
  [`--protocol`](connection-options.html#option_general_protocol) option:
  ...
  [`--protocol`](connection-options.html#option_general_protocol) option values and
...
<td>String</td>
  ...
  See also [Section 6.2.7, “Connection Transport Protocols”](transport-protocols.html "6.2.7 Connection Transport Protocols")

* [`--shared-memory-base-name=name`](connection-options.html#option_general_shared-memory-base-name)
...
* [`--socket=path`](connection-options.html#option_general_socket),
  `-S path`
...
* [`--user=user_name`](connection-options.html#option_general_user),
  `-u user_name`
...
C API, see [Support for Encrypted Connections](/doc/c-api/9.5/en/c-api-encrypted-connections.html).
...
* [`--get-server-public-key`](connection-options.html#option_general_get-server-public-key)
...
<td>String</td>
  ...
  If
  [`--server-public-key-path=file_name`](connection-options.html#option_general_server-public-key-path)
...
<td>String</td>
  ...
  (deprecated) and `caching_sha2_password`
  plugins, see
...
* [`--ssl-ca=file_name`](connection-options.html#option_general_ssl-ca)
...
<td>String</td>
  ...
  [`--ssl-ca`](connection-options.html#option_general_ssl-ca) nor
  [`--ssl-capath`](connection-options.html#option_general_ssl-capath). The server
  still verifies the client according to any applicable
  requirements established for the client account, and it
  still uses any [`ssl_ca`](server-system-variables.html#sysvar_ssl_ca) or
  [`ssl_capath`](server-system-variables.html#sysvar_ssl_capath) system variable
  values specified on the server side.

  To specify the CA file for the server, set the
  [`ssl_ca`](server-system-variables.html#sysvar_ssl_ca) system variable.

* [`--ssl-capath=dir_name`](connection-options.html#option_general_ssl-capath)
...
* [`--ssl-cert=file_name`](connection-options.html#option_general_ssl-cert)
...
<td><code class="literal">localhost</code></td>
  ...
  the [`ssl_cert`](server-system-variables.html#sysvar_ssl_cert) system
  variable.

* [`--ssl-cipher=cipher_list`](connection-options.html#option_general_ssl-cipher)
...
<td><code class="literal">localhost</code></td>
  ...
  *`cipher_list`* should be a list of
  ...
  [`ssl_cipher`](server-system-variables.html#sysvar_ssl_cipher) system variable.

* [`--ssl-crl=file_name`](connection-options.html#option_general_ssl-crl)
...
<td><code class="literal">localhost</code></td>
  ...
  If neither [`--ssl-crl`](connection-options.html#option_general_ssl-crl) nor
  [`--ssl-crlpath`](connection-options.html#option_general_ssl-crlpath) is given, no
  CRL checks are performed, even if the CA path contains
  certificate revocation lists.

  To specify the revocation-list file for the server, set the
  [`ssl_crl`](server-system-variables.html#sysvar_ssl_crl) system variable.

* [`--ssl-crlpath=dir_name`](connection-options.html#option_general_ssl-crlpath)
...
<td><code class="literal">localhost</code></td>
  ...
  the [`ssl_crlpath`](server-system-variables.html#sysvar_ssl_crlpath) system
  variable.

* [`--ssl-fips-mode={OFF|ON|STRICT}`](connection-options.html#option_general_ssl-fips-mode)
...
<td><code class="literal">localhost</code></td>
  ...
  [`--ssl-fips-mode`](connection-options.html#option_general_ssl-fips-mode) option
  differs from other
  `--ssl-xxx`
  ...
  These [`--ssl-fips-mode`](connection-options.html#option_general_ssl-fips-mode) values
  are permissible:
  ...
  [`--ssl-fips-mode`](connection-options.html#option_general_ssl-fips-mode) is
  `OFF`. In this case, setting
  [`--ssl-fips-mode`](connection-options.html#option_general_ssl-fips-mode) to
  `ON` or `STRICT` causes
  the client to produce a warning at startup and to operate
  in non-FIPS mode.

  To specify the FIPS mode for the server, set the
  [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) system
  variable.

* [`--ssl-key=file_name`](connection-options.html#option_general_ssl-key)
...
<td><code class="literal">localhost</code></td>
  ...
  [`ssl_key`](server-system-variables.html#sysvar_ssl_key) system variable.

* [`--ssl-mode=mode`](connection-options.html#option_general_ssl-mode)
...
<td><code class="literal">localhost</code></td>
  ...
  + `PREFERRED`: Establish an encrypted
    ...
    default if [`--ssl-mode`](connection-options.html#option_general_ssl-mode) is
    not specified.
  ...
  + If [`--ssl-mode`](connection-options.html#option_general_ssl-mode) is not
    explicitly set otherwise, use of
    [`--ssl-ca`](connection-options.html#option_general_ssl-ca) or
    [`--ssl-capath`](connection-options.html#option_general_ssl-capath) implies
    [`--ssl-mode=VERIFY_CA`](connection-options.html#option_general_ssl-mode).

  + For [`--ssl-mode`](connection-options.html#option_general_ssl-mode) values of
    `VERIFY_CA` or
    `VERIFY_IDENTITY`,
    [`--ssl-ca`](connection-options.html#option_general_ssl-ca) or
    [`--ssl-capath`](connection-options.html#option_general_ssl-capath) is also
    required, to supply a CA certificate that matches the
    one used by the server.

  + An explicit [`--ssl-mode`](connection-options.html#option_general_ssl-mode)
    option with a value other than
    `VERIFY_CA` or
    `VERIFY_IDENTITY`, together with an
    explicit [`--ssl-ca`](connection-options.html#option_general_ssl-ca) or
    [`--ssl-capath`](connection-options.html#option_general_ssl-capath) option,
  ...
  use [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") to create the
  account with a `REQUIRE SSL` clause, or use
  [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") for an existing
...
* [`--ssl-session-data=file_name`](connection-options.html#option_general_ssl-session-data)
...
<td><code class="literal">localhost</code></td>
  ...
  [`--ssl-session-data`](connection-options.html#option_general_ssl-session-data) option,
  ...
  the
  [`--ssl-session-data-continue-on-failed-reuse`](connection-options.html#option_general_ssl-session-data-continue-on-failed-reuse)
  option on the command line when you invoked the client
  program.

  The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") command,
  `ssl_session_data_print`, generates the
  session data file (see [Section 6.5.1.2, “mysql Client Commands”](mysql-commands.html "6.5.1.2 mysql Client Commands")).
...
<td><code class="literal">localhost</code></td>
  ...
  [`--ssl-session-data`](connection-options.html#option_general_ssl-session-data)
  ...
  with both the
  [`--ssl-session-data`](connection-options.html#option_general_ssl-session-data) and
  [`--ssl-session-data-continue-on-failed-reuse`](connection-options.html#option_general_ssl-session-data-continue-on-failed-reuse)
  command-line options.

* [`--tls-ciphersuites=ciphersuite_list`](connection-options.html#option_general_tls-ciphersuites)
...
<td><code class="literal">localhost</code></td>
  ...
  [`tls_ciphersuites`](server-system-variables.html#sysvar_tls_ciphersuites) system
  variable.

* [`--tls-version=protocol_list`](connection-options.html#option_general_tls-version)
...
<td><code class="literal">[none]</code></td>
  ...
  + Clients, including MySQL Shell, that support the
    [`--tls-version`](connection-options.html#option_general_tls-version) option
    ...
    [`--ssl-mode`](connection-options.html#option_general_ssl-mode) is set to
  ...
  + Support for the TLSv1.3 protocol is available in MySQL
    ...
    (such as the
    [`tls_version`](server-system-variables.html#sysvar_tls_version) system
    variable).
...
* [`--compress`](connection-options.html#option_general_compress),
  `-C`
...
* [`--compression-algorithms=value`](connection-options.html#option_general_compression-algorithms)
...
* [`--zstd-compression-level=level`](connection-options.html#option_general_zstd-compression-level)

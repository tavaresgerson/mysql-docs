...
* List the options in environment variables (see
  [Section 6.2.9, “Setting Environment Variables”](setting-environment-variables.html "6.2.9 Setting Environment Variables")). This method
  is useful for options that you want to apply each time the
  program runs. In practice, option files are used more commonly
  for this purpose, but [Section 7.8.3, “Running Multiple MySQL Instances on Unix”](multiple-unix-servers.html "7.8.3 Running Multiple MySQL Instances on Unix"),
...
following command causes [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") to connect to
...
There is one exception: For [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), the
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") in “no column names” mode:

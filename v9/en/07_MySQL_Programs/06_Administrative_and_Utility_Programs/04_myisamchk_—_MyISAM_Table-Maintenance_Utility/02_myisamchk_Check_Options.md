...
* [`--check`](myisamchk-check-options.html#option_myisamchk_check),
  `-c`
...
* [`--check-only-changed`](myisamchk-check-options.html#option_myisamchk_check-only-changed),
  ...
  <table frame="box" rules="all" summary="Properties for check-only-changed"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--check-only-changed</code></td>
</tr></tbody></table>
...
<td><code class="literal">--extend-check</code></td>
  ...
  extreme cases. Normally, [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") or
  [**myisamchk --medium-check**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") should be able
  to determine whether there are any errors in the table.

  If you are using
  [`--extend-check`](myisamchk-check-options.html#option_myisamchk_extend-check) and have
...
* [`--fast`](myisamchk-check-options.html#option_myisamchk_fast),
  `-F`

  <table frame="box" rules="all" summary="Properties for fast"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">--force</code></td>
  ...
  [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") finds any errors in the table.
  The repair type is the same as that specified with the
  [`--recover`](myisamchk-repair-options.html#option_myisamchk_recover) or
  `-r` option.

* [`--information`](myisamchk-check-options.html#option_myisamchk_information),
  `-i`

  <table frame="box" rules="all" summary="Properties for information"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`--medium-check`](myisamchk-check-options.html#option_myisamchk_medium-check),
  `-m`

  <table frame="box" rules="all" summary="Properties for medium-check"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--medium-check</code></td>
</tr></tbody></table>

  Do a check that is faster than an
  [`--extend-check`](myisamchk-check-options.html#option_myisamchk_extend-check) operation.
  This finds only 99.99% of all errors, which should be good
  enough in most cases.

* [`--read-only`](myisamchk-check-options.html#option_myisamchk_read-only),
  `-T`

  <table frame="box" rules="all" summary="Properties for read-only"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--read-only</code></td>
</tr></tbody></table>

  Do not mark the table as checked. This is useful if you use
  [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") to check a table that is in use
  by some other application that does not use locking, such as
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") when run with external locking
  disabled.

* [`--update-state`](myisamchk-check-options.html#option_myisamchk_update-state),
  `-U`

  <table frame="box" rules="all" summary="Properties for update-state"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--update-state</code></td>
</tr></tbody></table>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server is using the table and you

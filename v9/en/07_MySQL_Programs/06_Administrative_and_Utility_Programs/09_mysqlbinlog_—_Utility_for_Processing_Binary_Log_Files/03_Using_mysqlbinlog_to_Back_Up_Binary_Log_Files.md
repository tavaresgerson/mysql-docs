...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")). [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") can
...
contents from that server. [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") writes
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") can read binary log files and
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") can make a static backup, backing
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") runs until the connection ends
(for example, when the server exits) or
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") is forcibly terminated. When the
connection ends, [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") does not wait
...
restart [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files").

Important

[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") can back up both encrypted and
unencrypted binary log files . However, copies of encrypted
binary log files that are generated using
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") are stored in an unencrypted
format.

##### mysqlbinlog Backup Options

Binary log backup requires that you invoke
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") with two options at minimum:

* The
  [`--read-from-remote-server`](mysqlbinlog.html#option_mysqlbinlog_read-from-remote-server)
  (or `-R`) option tells
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") to connect to a server and
...
* The [`--raw`](mysqlbinlog.html#option_mysqlbinlog_raw) option tells
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") to write raw (binary) output,
  not text output.
...
* [`--connection-server-id=id`](mysqlbinlog.html#option_mysqlbinlog_connection-server-id):
  The server ID that [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") reports
  ...
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") process, use
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"), you must specify file names that
actually exist on the server. If you do not know the names,
connect to the server and use the [`SHOW
BINARY LOGS`](show-binary-logs.html "15.7.7.2 SHOW BINARY LOGS Statement") statement to see the current names.
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") to back up the binary log to the
...
* To make a static backup of
  ...
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") reaches the end of
  `binlog.000132`, the first command does
  not read it, but the second command does.

* To make a live backup in which
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") starts with
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") produces text output and the
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") writes one binary output file for
each log file transferred from the server. By default,
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") writes the files in the current
...
[**mysqlbinlog --raw**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") to back up the files, the
...
to use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") together to back up a server's
...
Use [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") to make a continuous backup
of the binary log:
...
Use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to create a dump file as a
...
data, and [`--source-data=2`](mysqldump.html#option_mysqldump_source-data) to
...
Execute the [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") command periodically to
...
Binary log backups with [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") are
subject to these restrictions:

* [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") does not automatically

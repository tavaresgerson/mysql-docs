...
MySQL system tables still exist in MySQL 9.5 and can
be viewed by issuing a [`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement")
...
[`SET`](set.html "13.3.7 The SET Type") statement to make data
...
Use [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") to view

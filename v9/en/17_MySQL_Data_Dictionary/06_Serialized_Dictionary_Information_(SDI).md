...
SDI data is updated by DDL operations on a table or [`CHECK TABLE FOR UPGRADE`](check-table.html "15.7.3.2 CHECK TABLE Statement"). SDI data is not updated when the MySQL server is upgraded to a new release or version.

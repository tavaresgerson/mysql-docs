...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table, invoke
...
cardinality of [`SHOW INDEX`](show-index.html "15.7.7.24 SHOW INDEX Statement") or
[`INFORMATION_SCHEMA.STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table"),
...
* [`--delete`](mysql-cluster-programs-ndb-index-stat.html#option_ndb_index_stat_delete)
  ...
  <table frame="box" rules="all" summary="Properties for delete"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`--no-login-paths`](mysql-cluster-programs-ndb-index-stat.html#option_ndb_index_stat_no-login-paths)
...
* [`--ndb-mgm-tls`](mysql-cluster-programs-ndb-index-stat.html#option_ndb_index_stat_ndb-mgm-tls)
...
* [`--ndb-tls-search-path`](mysql-cluster-programs-ndb-index-stat.html#option_ndb_index_stat_ndb-tls-search-path)

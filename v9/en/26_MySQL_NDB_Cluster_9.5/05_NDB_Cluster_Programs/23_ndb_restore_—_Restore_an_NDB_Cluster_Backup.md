...
<td><code class="literal">1</code></td>
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements after
...
<td><code class="literal">./</code></td>
  ...
  cluster running NDB Cluster 8.4.7 to a
  cluster running NDB Cluster 8.0.44, you
...
<td><code class="literal">[none]</code></td>
  ...
  [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") waits for it to be supplied
  from `stdin`, as when using
...
<td><code class="literal">--append</code></td>
  ...
  MySQL can open an `NDB` table for which one
  or more indexes cannot be found, provided the query does not
  use any of the affected indexes; otherwise the query is
  rejected with
  [`ER_NOT_KEYFILE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_not_keyfile). In the
  latter case, you can temporarily work around the problem by
  executing an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
  ...
  as well as [Section 10.3.12, “Invisible Indexes”](invisible-indexes.html "10.3.12 Invisible Indexes").
...
<td><code class="literal">--append</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") system table that is
...
<td><code class="literal">--append</code></td>
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
<td><code class="literal">./</code></td>
  ...
  **Table 25.23 Several invocations of ndb\_restore using --exclude-\*
...
<td><code class="literal">./</code></td>
  ...
  [`ENUM`](enum.html "13.3.6 The ENUM Type")).
...
<td><code class="literal">[none]</code></td>
  ...
  **Table 25.24 Several invocations of ndb\_restore using --include-\*
...
* [`--no-login-paths`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_no-login-paths)
...
<td><code class="literal">[none]</code></td>
  ...
  `NULL` column as `NOT
  NULL`. The column must not contain any
...
* [`--ndb-mgm-tls`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_ndb-mgm-tls)
...
* [`--ndb-tls-search-path`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_ndb-tls-search-path)
...
<td><code class="literal">--backup-password-from-stdin</code></td>
  ...
  [Restoring to a different number of data nodes](/doc/refman/8.0/en/ndb-restore-different-number-nodes.html), for
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  1. Prepare the table to which the backup is to be restored.
     ...
     promote using [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement"); the
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  Output [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table data and logs.
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table metadata.
  ...
  [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") uses the default number of
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") backup, and to continue
...
<td><code class="literal">--character-sets-dir=path</code></td>
  ...
  native [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") backup. This can be
...
[**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") can decrypt an encrypted backup
using [`--decrypt`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_decrypt) and
...
[`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") statement on that
SQL node before running [`START
REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement"). This is a known issue in NDB Cluster.
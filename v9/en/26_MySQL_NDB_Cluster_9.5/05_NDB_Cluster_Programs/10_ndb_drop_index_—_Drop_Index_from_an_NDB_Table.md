...
an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table. *It is
...
* [`--no-login-paths`](mysql-cluster-programs-ndb-drop-index.html#option_ndb_drop_index_no-login-paths)
...
* [`--ndb-mgm-tls`](mysql-cluster-programs-ndb-drop-index.html#option_ndb_drop_index_ndb-mgm-tls)
...
* [`--ndb-tls-search-path`](mysql-cluster-programs-ndb-drop-index.html#option_ndb_drop_index_ndb-tls-search-path)
...
statement[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") or the

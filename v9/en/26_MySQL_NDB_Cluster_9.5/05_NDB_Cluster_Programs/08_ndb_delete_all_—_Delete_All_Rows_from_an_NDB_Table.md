...
given [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table. In some cases,
...
* [`--diskscan`](mysql-cluster-programs-ndb-delete-all.html#option_ndb_delete_all_diskscan)
  ...
  <table frame="box" rules="all" summary="Properties for diskscan"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--diskscan</code></td>
</tr></tbody></table>
...
* [`--no-login-paths`](mysql-cluster-programs-ndb-delete-all.html#option_ndb_delete_all_no-login-paths)
...
* [`--ndb-mgm-tls`](mysql-cluster-programs-ndb-delete-all.html#option_ndb_delete_all_ndb-mgm-tls)
...
* [`--ndb-tls-search-path`](mysql-cluster-programs-ndb-delete-all.html#option_ndb_delete_all_ndb-tls-search-path)

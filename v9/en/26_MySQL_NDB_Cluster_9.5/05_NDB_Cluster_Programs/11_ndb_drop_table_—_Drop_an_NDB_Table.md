...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table. (If you try to use this
on a table created with a storage engine other than
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"), the attempt fails with the
...
TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") statement on an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
table.
...
* [`--no-login-paths`](mysql-cluster-programs-ndb-drop-table.html#option_ndb_drop_table_no-login-paths)
...
* [`--ndb-mgm-tls`](mysql-cluster-programs-ndb-drop-table.html#option_ndb_drop_table_ndb-mgm-tls)
...
* [`--ndb-tls-search-path`](mysql-cluster-programs-ndb-drop-table.html#option_ndb_drop_table_ndb-tls-search-path)

...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
(also known as [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")) is an in-memory
storage engine offering high-availability and data-persistence
features.

The [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine can be
...
level. NDB Cluster's [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
...
* Management node: The
  ...
  command [**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon").
...
* Data node: This type of
  ...
  (see [Section 25.2.2, “NDB Cluster Nodes, Node Groups, Fragment Replicas, and Partitions”](mysql-cluster-nodes-groups.html "25.2.2 NDB Cluster Nodes, Node Groups, Fragment Replicas, and Partitions")). For
  ...
  data node is started with the command [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon")
  (see [Section 25.5.1, “ndbd — The NDB Cluster Data Node Daemon”](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon")) or
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") (see
...
* SQL node: This is a node
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. An SQL
  node is a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process started with the
  ...
  [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") utility that is used to restore
...
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") management client supplied with NDB
Cluster (see [Section 25.5.5, “ndb\_mgm — The NDB Cluster Management Client”](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")).
...
parameters as well as [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server options and
variables relating to NDB Cluster. See [MySQL Cluster Manager 9.5.0 User Manual](/doc/mysql-cluster-manager/9.5/en/), for
more information.
...
[Section 25.6.3, “Event Reports Generated in NDB Cluster”](mysql-cluster-event-reports.html "25.6.3 Event Reports Generated in NDB Cluster"). Event logs are of
...
With regard to the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
...
* Local Checkpoint (LCP):
  ...
  NDB 9.5 supports partial LCPs, which can
...
Cluster 9.5 supports three of these, which are
listed here:

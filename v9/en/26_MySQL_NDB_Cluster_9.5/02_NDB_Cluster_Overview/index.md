...
clustered storage engine called [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
(which stands for “*N*etwork
*D*ata*B*ase”). In our
documentation, the term [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") refers to
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine, the tables (and
...
An NDB Cluster 9.5 SQL node uses the
...
9.5 distributions. You should keep in mind that
*an instance of [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), regardless of
version, that is not connected to an NDB Cluster cannot use the
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine and cannot access

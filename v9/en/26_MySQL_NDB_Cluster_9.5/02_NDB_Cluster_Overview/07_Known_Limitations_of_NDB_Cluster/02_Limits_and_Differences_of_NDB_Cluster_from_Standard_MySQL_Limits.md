...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table is not automatically
...
* A [`DELETE`](delete.html "15.2.2 DELETE Statement") statement on an
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table makes the memory
...
* A [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") or
  [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") operation on
  an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table frees the memory
  that was used by this table for re-use by any
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table, either by the same
  table or by another [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table.

  Note

  Recall that [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement")
...
* **Limits imposed by the cluster's configuration.**
  ...
  + The maximum number of operations that can be performed
    ...
    TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"), and [`ALTER
    TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") are handled as special cases by

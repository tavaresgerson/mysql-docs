...
errors when used with [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables,
as described in the following list:

* **Temporary tables.**
  Temporary tables are not supported. Trying either to
  create a temporary table that uses the
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine or to
  alter an existing temporary table to use
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") fails with the error
...
* **Indexes and keys in NDB tables.**
  ...
  + **Column width.**
    ...
    [`ER_TOO_LONG_KEY`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_too_long_key):
  ...
  + **TEXT and BLOB columns.**
    ...
    [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table columns that
    use any of the [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") or
    [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data types.

  + **FULLTEXT indexes.**
    The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine
    ...
    [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") tables only.

    However, you can create indexes on
    [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") columns of
  ...
  + **BIT columns.**
    A [`BIT`](bit-type.html "13.1.5 Bit-Value Type - BIT") column cannot be
  ...
  + **AUTO\_INCREMENT columns.**
    ...
    [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine can
    ...
    TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements do not work, as shown here:
...
* **Restrictions on foreign keys.**
  ...
  9.5 is comparable to that provided by
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine"), subject to the
  ...
  + `ON DELETE CASCADE` is also not
    ...
    [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") types. (Bug #89511,
    Bug #27484882)

  + `SET DEFAULT` is not supported. (Also
    not supported by [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine").)

  + The `NO ACTION` keyword is accepted but
    treated as `RESTRICT`. `NO
    ACTION`, which is a standard SQL keyword, is
    the default in MySQL 9.5. (Also the same as
    with `InnoDB`.)
...
* **NDB Cluster and geometry data types.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. However, spatial
...
* **Creating NDB tables with user-defined partitioning.**
  ...
  **Default partitioning scheme.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine is used
  instead. For additional discussion of these and related
  issues, see [Section 26.2.5, “KEY Partitioning”](partitioning-key.html "26.2.5 KEY Partitioning").
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table not to meet
  ...
  **Exception.**
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table is created
  ...
  **Maximum number of partitions for NDBCLUSTER tables.**
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table when
  ...
  **DROP PARTITION not supported.**
  ...
  [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")—`ADD PARTITION`,
  `REORGANIZE PARTITION`, and
  `COALESCE PARTITION`—are supported
  for NDB tables, but use copying and so are not optimized.
  See [Section 26.3.1, “Management of RANGE and LIST Partitions”](partitioning-management-range-list.html "26.3.1 Management of RANGE and LIST Partitions")
  and [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement").

  **Partition selection.**
  Partition selection is not supported for
  `NDB` tables. See
  [Section 26.5, “Partition Selection”](partitioning-selection.html "26.5 Partition Selection"), for more
  information.

* **JSON data type.**
  The MySQL [`JSON`](json.html "13.5 The JSON Data Type") data type is
  supported for `NDB` tables in the
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") supplied with NDB
  9.5.

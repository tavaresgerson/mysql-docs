...
* **Machine architecture.**
  ...
  apply to machines simply running [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
...
* **Binary logging.**
  ...
  + NDB Cluster cannot produce a binary log for tables
    having [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") columns but
    no primary key.

  + Only the following schema operations are logged in a
    cluster binary log which is *not* on
    the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") executing the statement:
    ...
    - [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") /
      [`CREATE
      SCHEMA`](create-database.html "15.1.14 CREATE DATABASE Statement")

    - [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") /
      [`DROP
      SCHEMA`](drop-database.html "15.1.28 DROP DATABASE Statement")
    ...
    - [`DROP LOGFILE GROUP`](drop-logfile-group.html "15.1.33 DROP LOGFILE GROUP Statement")
* **Schema operations.**
...
* **Number of fragment replicas.**
  ...
  [`NoOfReplicas`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-noofreplicas) data
  ...
  Setting [`NoOfReplicas`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-noofreplicas)

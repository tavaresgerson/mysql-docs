...
given in [Section 1.6, “How to Report Bugs or Problems”](bug-reports.html "1.6 How to Report Bugs or Problems"). Any problem which we do
not plan to fix in NDB Cluster 9.5, is added to the
list.

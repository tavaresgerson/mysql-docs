...
* **Stored programs not distributed.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine, but these
...
* **ALTER TABLE operations.**
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") is not fully

...
See also [Section 25.2.7.2, “Limits and Differences of NDB Cluster from Standard MySQL Limits”](mysql-cluster-limitations-limits.html "25.2.7.2 Limits and Differences of NDB Cluster from Standard MySQL Limits").
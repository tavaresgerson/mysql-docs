...
supported for [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. Trying to
...
* **Index prefixes.**
  ...
  [`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement"), the prefix is
  not created by `NDB`.
...
See [Section 25.2.7.3, “Limits Relating to Transaction Handling in NDB Cluster”](mysql-cluster-limitations-transactions.html "25.2.7.3 Limits Relating to Transaction Handling in NDB Cluster"),
for more information relating to limitations on transaction
handling in [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5").
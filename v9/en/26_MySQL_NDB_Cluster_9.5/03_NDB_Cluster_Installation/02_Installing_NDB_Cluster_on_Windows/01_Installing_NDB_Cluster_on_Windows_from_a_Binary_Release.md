...
[Section 25.3, “NDB Cluster Installation”](mysql-cluster-installation.html "25.3 NDB Cluster Installation")), as shown in the
following table:
...
<td>SQL node (<a class="link" href="mysqld.html" title="6.3.1 mysqld — The MySQL Server"><span class="command"><strong>mysqld</strong></span></a>)</td>
<td>198.51.100.20</td>
</tr><tr>
<td>Data node "A" (<a class="link" href="mysql-cluster-programs-ndbd.html" title="25.5.1 ndbd — The NDB Cluster Data Node Daemon"><span class="command"><strong>ndbd</strong></span></a>)</td>
<td>198.51.100.30</td>
</tr><tr>
<td>Data node "B" (<a class="link" href="mysql-cluster-programs-ndbd.html" title="25.5.1 ndbd — The NDB Cluster Data Node Daemon"><span class="command"><strong>ndbd</strong></span></a>)</td>
<td>198.51.100.40</td>
</tr></tbody></table>

As on other platforms, the NDB Cluster host computer running an
SQL node must have installed on it a MySQL Server binary
([**mysqld.exe**](mysqld.html "6.3.1 mysqld — The MySQL Server")). You should also have the MySQL
client ([**mysql.exe**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")) on this host. For
...
the management server daemon ([**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon"));
each data node requires the data node daemon
([**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd.exe**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)")).
For this example, we refer to [**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") as the
data node executable, but you can install
[**ndbmtd.exe**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"), the multithreaded version of this
program, instead, in exactly the same way. You should also
install the management client ([**ndb\_mgm.exe**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client"))
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"),
[**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon"), and so on. You should understand
that, whether we refer (for example) to
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") or [**mysqld.exe**](mysqld.html "6.3.1 mysqld — The MySQL Server"),
...
Cluster 9.4.0 archive for 64-bit Windows
systems is named
`mysql-cluster-gpl-9.4.0-win64.zip`.
...
[Section 2.3.3, “Configuration: Manually”](windows-install-archive.html "2.3.3 Configuration: Manually").
...
[`--ndb-connectstring`](mysql-cluster-options-variables.html#option_mysqld_ndb-connectstring). While you
...
(see [Section 2.3.3.2, “Creating an Option File”](windows-create-option-file.html "2.3.3.2 Creating an Option File")), but the file
...
single executable, one of either [**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon")
or [**ndbmtd.exe**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"). For this example, we assume
that you are using [**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon"), but the same
instructions apply when using [**ndbmtd.exe**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)").
...
[`--ndb-connectstring`](mysql-cluster-programs-ndb-config.html#option_ndb_config_ndb-connectstring) or
...
server program [**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon"). However, in
order to administer the NDB Cluster once it has been started,
you should also install the NDB Cluster management client
program [**ndb\_mgm.exe**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") on the same machine as
...
2. A global configuration file from which the management node
   ...
   * The data memory and index memory allocated to each data
     node ([`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory)
   ...
   * The directory where each data node stores it data and
     ...
     [`DataDir`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datadir)

...
* You must configure the build using the
  [`WITH_NDB`](source-configuration-options.html#option_cmake_with_ndb) option in addition to
  any other build options you wish to use with
  **CMake**.
  [`WITH_NDBCLUSTER`](source-configuration-options.html#option_cmake_with_ndbcluster) is also
...
[Section 2.8.4, “Installing MySQL Using a Standard Source Distribution”](installing-source-distribution.html "2.8.4 Installing MySQL Using a Standard Source Distribution") provides the

...
* [Versions Supported for Upgrade to NDB 9.5](mysql-cluster-upgrade-downgrade.html#mysql-cluster-upgrade-versions "Versions Supported for Upgrade to NDB 9.5")
...
when upgrading or downgrading to or from NDB 9.5.

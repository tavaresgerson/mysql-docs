...
depends on the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine for
clustering functionality, it is not necessary to use
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") as the storage engine for the
...
`_replica` status variables, as seen in the
output of [`SHOW STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"), or in the
...
Replication. [Section 25.6.14, “NDB API Statistics Counters and Variables”](mysql-cluster-ndb-api-statistics.html "25.6.14 NDB API Statistics Counters and Variables"),
provides additional information.

**Replication from NDB to non-NDB tables.**
It is possible to replicate [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")

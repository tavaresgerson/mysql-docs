...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes for the primary and secondary
...
REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement on each of the replicas. The commands
...
5. Finally, initiate replication on the primary channel by
   executing the [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement")

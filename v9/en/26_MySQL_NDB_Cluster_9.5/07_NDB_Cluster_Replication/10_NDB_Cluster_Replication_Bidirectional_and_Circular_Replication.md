...
system variable
[`log_replica_updates`](replication-options-binary-log.html#sysvar_log_replica_updates) enabled. This
...
[`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") statement on that SQL
node; this should be done prior to running
[`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement"). This is a known
issue.
...
enabled. Which [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes require this
...
SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement:
...
[`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement on MySQL
...
[`IGNORE_SERVER_IDS`](change-replication-source-to.html#crs-opt-ignore_server_ids) option which
...
[Section 15.7.7.36, “SHOW REPLICA STATUS Statement”](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement"). For information about how

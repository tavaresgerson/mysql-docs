...
maintained by the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") binary log
(binlog) injector thread. This keeps the source
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process updated to changes performed by
the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. The
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") binlog
injector thread receives events directly from the
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. The
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") injector is responsible for
...
[`SHOW BINLOG EVENTS`](show-binlog-events.html "15.7.7.3 SHOW BINLOG EVENTS Statement") statement on
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, applications should
wait until the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
not exist on the replica, [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup")
re-creates it.
...
[`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) to
...
not restored by [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup"). In some cases,
...
[`--with-apply-status`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_with-apply-status) option.
...
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") storage engine. This means
that it must be created separately on each
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") participating in the source cluster.
...
upgrade causes an
[`ALTER TABLE ...
ENGINE=INNODB`](alter-table.html "15.1.11 ALTER TABLE Statement") statement to be executed for this
...
see [Section 15.1.25, “CREATE TABLESPACE Statement”](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement"), and
[Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"), as well as
...
[`--ndb-log-empty-epochs`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-empty-epochs) option is
...
[`--ndb-log-empty-epochs=ON`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-empty-epochs) can
actually have a much higher number of
`ndb_binlog_index` rows per file than one with
a great deal of activity.

When [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is started with the
[`--ndb-log-orig`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-orig) option, the
`orig_server_id` and
...
sources. The [`SELECT`](select.html "15.2.13 SELECT Statement") statement
...
running with
[`--ndb-log-empty-epochs=ON`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-empty-epochs). You
...
See [Section 25.7.8, “Implementing Failover with NDB Cluster Replication”](mysql-cluster-replication-failover.html "25.7.8 Implementing Failover with NDB Cluster Replication"), for
...
* `db` column
  ...
  database name. (See
  [Matching with wildcards](mysql-cluster-replication-schema.html#ndb-replication-wildcards "Matching with wildcards"), later in this
  section.)
...
* `server_id` column
  ...
  ID. (See [Matching with wildcards](mysql-cluster-replication-schema.html#ndb-replication-wildcards "Matching with wildcards"), later
  in this section.)
...
* `binlog_row_slice_count` column
  ...
  The number of slices into which to divide the binary log.
  `1` if slicing is not being used for this
  table; `0` is ignored and is thus
  effectively the same as `1`.

* `binlog_row_slice_id` column

  The ID of the slice for this server to log.
  `0` if slicing is not being used for this
  table.
...
* `conflict_fn` column
  ...
  [NDB$MAX\_INS()](mysql-cluster-replication-conflict-resolution.html#mysql-cluster-replication-ndb-max-ins "NDB$MAX_INS()"), or
  ...
  See [Conflict Resolution Functions](mysql-cluster-replication-conflict-resolution.html#conflict-resolution-functions "Conflict Resolution Functions"), for
...
various combinations of the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") logging
options [`--ndb-log-updated-only`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-updated-only),
[`--ndb-log-update-as-write`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-as-write), and
[`--ndb-log-update-minimal`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-minimal), as
...
[`sql_log_bin = 0`](replication-options-binary-log.html#sysvar_sql_log_bin), except that it
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with the slice ID `0`
to log half of the row changes for table `t1`,
while another [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") (whose slice ID is
...
following [`INSERT`](insert.html "15.2.7 INSERT Statement") statement yields
...
[`--ndb-log-row-slice-count`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-row-slice-count) and
[`--ndb-log-row-slice-id`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-row-slice-id) options.
...
[`LIKE`](string-comparison-functions.html#operator_like) operator.)
...
the setting of the
[`--ndb-log-updated-only`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-updated-only) option
for [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"):
...
[`--ndb-log-updated-only`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-updated-only) to
`0` or `OFF`.
...
storage engine; see
[Replication from NDB to other storage engines](mysql-cluster-replication-issues.html#mysql-cluster-replication-ndb-to-non-ndb "Replication from NDB to other storage engines"), and
[Replication from NDB to a nontransactional storage engine](mysql-cluster-replication-issues.html#mysql-cluster-replication-ndb-to-nontransactional "Replication from NDB to a nontransactional storage engine"),
for more information.
...
is, a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process) can record row

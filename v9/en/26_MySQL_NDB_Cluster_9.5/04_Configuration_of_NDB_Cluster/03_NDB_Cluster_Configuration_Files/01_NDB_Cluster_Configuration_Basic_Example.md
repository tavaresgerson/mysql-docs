...
the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") and
...
For additional [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") variables that
...
* `[shm]`: Defines shared-memory connections
  between nodes. In MySQL 9.5, it is enabled by

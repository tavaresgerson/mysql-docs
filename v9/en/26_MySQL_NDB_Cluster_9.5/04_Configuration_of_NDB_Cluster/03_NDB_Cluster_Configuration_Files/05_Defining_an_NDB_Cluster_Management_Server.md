...
* `Id`
  ...
  <table frame="box" rules="all" summary="Id management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
...
<span class="bold"><strong>Initial System Restart:
  ...
  [`NodeId`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-nodeid). Although
...
* `NodeId`
  ...
  <table frame="box" rules="all" summary="NodeId management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Initial System Restart:
  ...
  [`Id`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-id) continues to be
...
* `ExecuteOnComputer`
  ...
  <table frame="box" rules="all" summary="ExecuteOnComputer management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>System Restart:
  ...
  [`HostName`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-hostname) parameter
  instead.

* `PortNumber`

  <table frame="box" rules="all" summary="PortNumber management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* The node ID for this node can be given out only to
  ...
  [`HostName`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-hostname) is not
  sufficient for distinguishing among processes.

* `HostName`

  <table frame="box" rules="all" summary="HostName management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* [`LocationDomainId`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-locationdomainid)
  ...
  <table frame="box" rules="all" summary="LocationDomainId management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* [`LogDestination`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-logdestination)
  ...
  <table frame="box" rules="all" summary="LogDestination management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `ArbitrationRank`
  ...
  <table frame="box" rules="all" summary="ArbitrationRank management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Node Restart:
  ...
  file. Setting
  [`Arbitration`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-arbitration) causes
  any settings for `ArbitrationRank` to be
  disregarded.

* `ArbitrationDelay`

  <table frame="box" rules="all" summary="ArbitrationDelay management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `DataDir`
  ...
  <table frame="box" rules="all" summary="DataDir management node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Node Restart:
  ...
  for [`LogDestination`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-logdestination),
  as discussed previously in this section.)

  The default value for this parameter is the directory in
  which [**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") is located.
...
<span class="bold"><strong>Initial System Restart:
  ...
  set using
  [`TotalSendBufferMemory`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-totalsendbuffermemory),
...
<span class="bold"><strong>Initial System Restart:
  ...
  If this parameter is set to `true`, a
  client, once connected to this management node, must be
  authenticated using TLS before the connection can be used
  for anything else.

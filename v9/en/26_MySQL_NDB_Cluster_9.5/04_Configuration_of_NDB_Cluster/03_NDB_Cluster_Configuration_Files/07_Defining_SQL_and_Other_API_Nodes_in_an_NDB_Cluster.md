...
applications other than [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes
...
[Section 25.4.3.9.1, “MySQL Server Options for NDB Cluster”](mysql-cluster-options-variables.html#mysql-cluster-program-options-mysqld "25.4.3.9.1 MySQL Server Options for NDB Cluster"). For
...
* `Id`
  ...
  <table frame="box" rules="all" summary="Id API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
...
<span class="bold"><strong>Initial System Restart:
  ...
  the node IDs for API nodes (and management nodes) to
  values greater than 144.

  [`NodeId`](mysql-cluster-api-definition.html#ndbparam-api-nodeid) is the
...
* `ConnectionMap`
  ...
  <table frame="box" rules="all" summary="ConnectionMap API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `NodeId`
  ...
  <table frame="box" rules="all" summary="NodeId API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `ExecuteOnComputer`
  ...
  <table frame="box" rules="all" summary="ExecuteOnComputer API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>System Restart:
  ...
  [`HostName`](mysql-cluster-api-definition.html#ndbparam-api-hostname) parameter
  instead.
...
* The node ID for this node can be given out only to
  ...
  [`HostName`](mysql-cluster-api-definition.html#ndbparam-api-hostname) is not
  sufficient for distinguishing among processes.

* `HostName`

  <table frame="box" rules="all" summary="HostName API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Node Restart:
  ...
  computer on which the SQL node (API node) is to reside. Use
...
* [`LocationDomainId`](mysql-cluster-api-definition.html#ndbparam-api-locationdomainid)
  ...
  <table frame="box" rules="all" summary="LocationDomainId API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `ArbitrationRank`
  ...
  <table frame="box" rules="all" summary="ArbitrationRank API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* `ArbitrationDelay`
  ...
  <table frame="box" rules="all" summary="ArbitrationDelay API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
* [`BatchByteSize`](mysql-cluster-api-definition.html#ndbparam-api-batchbytesize)
  ...
  <table frame="box" rules="all" summary="BatchByteSize API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Node Restart:
  ...
  ([`BatchSize`](mysql-cluster-api-definition.html#ndbparam-api-batchsize)) and in
...
* [`BatchSize`](mysql-cluster-api-definition.html#ndbparam-api-batchsize)
  ...
  <table frame="box" rules="all" summary="BatchSize API node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
<th>Version (or later)</th>
<td>NDB 9.5.0</td>
</tr><tr>
<th>Type or units</th>
...
<span class="bold"><strong>Node Restart:
  ...
  set using
  [`TotalSendBufferMemory`](mysql-cluster-api-definition.html#ndbparam-api-totalsendbuffermemory),
...
<span class="bold"><strong>Node Restart:
  ...
  [Ndb\_cluster\_connection::set\_auto\_reconnect()](/doc/ndbapi/en/ndb-ndb-cluster-connection.html#ndb-ndb-cluster-connection-set-auto-reconnect),
  and
  [Ndb\_cluster\_connection::get\_auto\_reconnect()](/doc/ndbapi/en/ndb-ndb-cluster-connection.html#ndb-ndb-cluster-connection-get-auto-reconnect).
...
<span class="bold"><strong>Node Restart:
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") is configurable using this
...
cluster log; 2 adds [`DBDICT`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbdict.html)
debugging output as well. (Bug #20638450) See also
[DUMP 1229](/doc/ndb-internals/en/dump-command-1229.html).

You can also obtain information from a MySQL server running as
an NDB Cluster SQL node using [`SHOW
STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, as
shown here:

...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") can be used for
...
The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") memory manager, which
...
calculated by [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"), based on the
...
part of a [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement")

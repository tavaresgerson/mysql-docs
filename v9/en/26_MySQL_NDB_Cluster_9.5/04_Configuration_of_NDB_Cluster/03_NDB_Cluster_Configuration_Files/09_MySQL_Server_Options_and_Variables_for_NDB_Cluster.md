...
specific to NDB Cluster, see [Section 7.1, “The MySQL Server”](mysqld-server.html "7.1 The MySQL Server").

For NDB Cluster configuration parameters used in the cluster
configuration file (usually named `config.ini`),
see [Section 25.4, “Configuration of NDB Cluster”](mysql-cluster-configuration.html "25.4 Configuration of NDB Cluster").

##### 25.4.3.9.1 MySQL Server Options for NDB Cluster

This section provides descriptions of [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
server options relating to NDB Cluster. For information about
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") options not specific to NDB Cluster, and
for general information about the use of options with
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), see [Section 7.1.7, “Server Command Options”](server-options.html "7.1.7 Server Command Options").

For information about command-line options used with other NDB
Cluster processes, see [Section 25.5, “NDB Cluster Programs”](mysql-cluster-programs.html "25.5 NDB Cluster Programs").

* [`--ndbcluster`](mysql-cluster-options-variables.html#option_mysqld_ndbcluster)

  <table frame="box" rules="all" summary="Properties for ndbcluster"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p></td>
  ...
  The [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine is
  necessary for using NDB Cluster. If a
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary includes support for the
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine, the
  engine is disabled by default. Use the
  [`--ndbcluster`](mysql-cluster-options-variables.html#option_mysqld_ndbcluster) option to enable
  ...
  *not* enabled) if
  [`--initialize`](server-options.html#option_mysqld_initialize) is also used. (It
  is neither necessary nor desirable to use this option together
  with `--initialize`.)

* `--ndb-allow-copying-alter-table=[ON|OFF]`

  <table frame="box" rules="all" summary="Properties for ndb-allow-copying-alter-table"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">ON</code></td>
  ...
  Let [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") and other DDL
...
* `--ndb-applier-allow-skip-epoch`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-applier-allow-skip-epoch"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--ndb-applier-allow-skip-epoch</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal">ndb_applier_allow_skip_epoch</code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>No</td>
...
<td>No</td>
  ...
  Use together with
  [`--replica-skip-errors`](replication-options-replica.html#sysvar_replica_skip_errors) to cause
  `NDB` to ignore skipped epoch transactions.
  Has no effect when used alone.

* `--ndb-batch-size=#`

  <table frame="box" rules="all" summary="Properties for ndb-batch-size"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* `--ndb-cluster-connection-pool=#`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-cluster-connection-pool"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">63</code></td>
  ...
  default), a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process can use multiple
  ...
  an SQL node whose [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process was
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") on host machines having multiple
  ...
  starting any [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process that employs
  connection pooling.
...
* `--ndb-cluster-connection-pool-nodeids=list`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-cluster-connection-pool-nodeids"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal"></code></td>
  ...
  [`--ndb-cluster-connection-pool`](mysql-cluster-options-variables.html#option_mysqld_ndb-cluster-connection-pool)
  option.

* `--ndb-blob-read-batch-bytes=bytes`

  <table frame="box" rules="all" summary="Properties for ndb-blob-read-batch-bytes"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">4294967295</code></td>
  ...
  batching of [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data reads in
  NDB Cluster applications. When this batch size is exceeded by
  the amount of [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data to be
  read within the current transaction, any pending
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") read operations are
  immediately executed.

  The maximum value for this option is 4294967295; the default
  is 65536. Setting it to 0 has the effect of disabling
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") read batching.

  Note

  In NDB API applications, you can control
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") write batching with the
  [`setMaxPendingBlobReadBytes()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-setmaxpendingblobreadbytes)
  and
  [`getMaxPendingBlobReadBytes()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-getmaxpendingblobreadbytes)
  methods.

* `--ndb-blob-write-batch-bytes=bytes`

  <table frame="box" rules="all" summary="Properties for ndb-blob-write-batch-bytes"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td>bytes</td>
  ...
  This option can be used to set the size (in bytes) for
  batching of [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data writes in
  NDB Cluster applications. When this batch size is exceeded by
  the amount of [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data to be
  written within the current transaction, any pending
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") write operations are
  immediately executed.

  The maximum value for this option is 4294967295; the default
  is 65536. Setting it to 0 has the effect of disabling
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") write batching.

  Note

  In NDB API applications, you can control
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") write batching with the
  [`setMaxPendingBlobWriteBytes()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-setmaxpendingblobwritebytes)
  and
  [`getMaxPendingBlobWriteBytes()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-getmaxpendingblobwritebytes)
  methods.
...
<td>String</td>
  ...
  When using the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
  engine, this option specifies the management server that
  distributes cluster configuration data. See
  [Section 25.4.3.3, “NDB Cluster Connection Strings”](mysql-cluster-connection-strings.html "25.4.3.3 NDB Cluster Connection Strings"), for
  syntax.

* `--ndb-default-column-format=[FIXED|DYNAMIC]`

  <table frame="box" rules="all" summary="Properties for ndb-default-column-format"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement")). The default is
  `FIXED`.
...
<td><code class="literal">ON</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") waits for a schema operation to
...
<td><code class="literal">ON</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. Can be set to either
...
<td><code class="literal">ON</code></td>
  ...
  Causes a replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to log any updates
  ...
  with the [`--ndbcluster`](mysql-cluster-options-variables.html#option_mysqld_ndbcluster) option.
...
<td><code class="literal">ON</code></td>
  ...
  [`log_replica_updates`](replication-options-binary-log.html#sysvar_log_replica_updates) is
  enabled.
...
<td><code class="literal">ON</code></td>
  ...
  [Read conflict detection and resolution](mysql-cluster-replication-conflict-resolution.html#conflict-resolution-read-conflicts "Read conflict detection and resolution").
...
<td><code class="literal">ON</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is terminated.
...
<td><code class="literal">ON</code></td>
  ...
  Sets the number of slices (*`count`*)
  used by this server when subscribing to NDB table change event
  streams used for writing binary logs. If this
  *`count`* is greater than 1, the stream
  of change events for a given table is divided into `1
  / count` logical slices.
  Each [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") performing binary logging can
  subscribe to one slice (as determined by
  [`--ndb-log-row-slice-id`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-row-slice-id)),
  receiving `100 /
  count` percent of the
  changes for each affected table.

  This option cannot be set at runtime; the corresponding
  `ndb_log_row_slice_count` system variable is
  read-only.
...
<td>No</td>
  ...
  Specifies the ID of the virtual slice of the NDB table change
  event streams this server subscribes to. The
  *effective* maximum ID value is
  [`--ndb-log-row-slice-count`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-row-slice-count) - 1.
  Suppose there are four MySQL servers, all with binary logging
  enabled and attached to the same NDB Cluster, which we label
  A, B, C, and D. We can cause each [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to
  log one of four equally-sized slices of the table change event
  stream, by specifying
  [`--ndb-log-row-slice-count=4`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-row-slice-count)
  when starting each [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). For each
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), we can specify which of the four
  slices to log using the
  `--ndb-log-row-slice-id` option, starting with
  0 for server A. Using the two options together in this way
  rsults in the following four invocations of
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"):
  ...
  In addition to providing scaleout capability for binary
  logging, it is also possible to establish redundant sets of
  MySQL servers. Using the same four servers A, B, C, and D from
  the previous example, we can instead create two groups of two
  servers each, each group splitting the changes to be logged
  into two parts, by starting the servers as shown here:
  ...
  Here, servers A and B split the binary log, and servers C and
  D do so as well. It is also possible to leverage redundancy
  for scaleout while maintaining the redundancy. Consider a
  setup with two MySQL servers started as shown here:
  ...
  A second set of servers does not have to be the same size as
  the first. You can start a second set which consists of three
  servers D, E, and F, like this:
  ...
  Now that the second set is writing a complete copy of the
  binary log between its three members, you can restart servers
  A and B, and start another server C (assumed not to be running
  already), as shown here:
  ...
  This option cannot be set at runtime; the corresponding
  `ndb_log_row_slice_id` system variable is
  read-only.

  It is also possible to control binary logging in this fashion,
  but on a per-table basis, using the
  `mysql.ndb_replication` table. See
  [ndb\_replication Table](mysql-cluster-replication-schema.html#ndb-replication-ndb-replication "ndb_replication Table"), for more
  information.
...
<td>No</td>
  ...
  Causes a replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to write the NDB
...
<td>No</td>
  ...
  [`--ndb-log-updated-only`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-updated-only) and
  [`--ndb-log-update-minimal`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-minimal) are
...
<td>No</td>
  ...
  Whether [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") writes updates only
  (`ON`) or complete rows
  (`OFF`) to the binary log. When this option
  is enabled, and both
  [`--ndb-log-update-as-write`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-as-write) and
  [`--ndb-log-update-minimal`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-minimal) are
  disabled, operations of different types are loǵged as
  described in the following list:
...
<td>No</td>
  ...
  [`--ndb-log-updated-only`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-updated-only) and
  [`--ndb-log-update-as-write`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-update-as-write) are
  disabled, operations of different types are loǵged as
  described in the following list:
...
<td>No</td>
  ...
  NDB Cluster; the value is one of `relaxed` or
  `strict`. `relaxed` means
  that a TLS connection is attempted, but success is not
  required; `strict` means that TLS is required
  to connect. The default is `relaxed`.
...
<td>No</td>
  ...
  [`--ndb-connectstring`](mysql-cluster-options-variables.html#option_mysqld_ndb-connectstring) option
  instead.
...
<td>No</td>
  ...
  set with [`--ndb-connectstring`](mysql-cluster-options-variables.html#option_mysqld_ndb-connectstring),
  ...
  [`SHOW STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"), and as
  ...
  see [Section 25.4.3.7, “Defining SQL and Other API Nodes in an NDB Cluster”](mysql-cluster-api-definition.html "25.4.3.7 Defining SQL and Other API Nodes in an NDB Cluster").
...
<td>No</td>
  ...
  [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.15 ndbinfo: The NDB Cluster Information Database") information
...
<td>bytes</td>
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") statements on
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. The default is 10.
...
<td>bytes</td>
  ...
  [`SHOW PLUGINS`](show-plugins.html "15.7.7.28 SHOW PLUGINS Statement").
...
<td>bytes</td>
  ...
  waits for the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine
  to complete setup before timing out and treating
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") as unavailable. The time is
...
<td>bytes</td>
  ...
  Disable the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
  ...
  [`--ndbcluster`](mysql-cluster-options-variables.html#option_mysqld_ndbcluster) option is given
  explicitly. See [Section 25.4.1, “Quick Test Setup of NDB Cluster”](mysql-cluster-quick.html "25.4.1 Quick Test Setup of NDB Cluster"), for an
  example.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. For system
variables not specific to NDB Cluster, see
[Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables"). For general information
...
<td>bytes</td>
  ...
  REPLICA`](reset-replica.html "15.4.2.3 RESET REPLICA Statement") causes an NDB Cluster replica to purge all
...
<td>bytes</td>
  ...
  `ndb_conflict_role` can take any one of the
  values `PRIMARY`,
  `SECONDARY`, `PASS`, or
  `NULL` (the default). The replica SQL thread
  must be stopped before you can change
  `ndb_conflict_role`. In addition, it is not
  possible to change directly between `PASS`
  and either of `PRIMARY` or
  `SECONDARY` directly; in such cases, you must
  ensure that the SQL thread is stopped, then execute
  [`SET
  @@GLOBAL.ndb_conflict_role = 'NONE'`](set-statement.html "15.7.6 SET Statements") first.
...
<td><code class="literal">63</code></td>
  ...
  See [Section 15.1.24.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.24.12 Setting NDB Comment Options"), for
  further information.

  Note

  An equivalent method
  [`set_data_node_neighbour()`](/doc/ndbapi/en/ndb-ndb-cluster-connection.html#ndb-ndb-cluster-connection-set-data-node-neighbour)
  is provided for use in NDB API applications.

* [`ndb_dbg_check_shares`](mysql-cluster-options-variables.html#sysvar_ndb_dbg_check_shares)
...
<td><code class="literal">63</code></td>
  ...
  information specific to the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  storage engine.
...
<td><code class="literal">63</code></td>
  ...
  Forces sending of buffers to [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
<td><code class="literal">63</code></td>
  ...
  a [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement; see
  [Section 15.1.24.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.24.12 Setting NDB Comment Options"), for syntax
...
<td><code class="literal"></code></td>
  ...
  Use [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") index statistics in query
...
<td><code class="literal"></code></td>
  ...
  **Table 25.19 ndb\_index\_stat\_option options
  and values**
...
<td><code class="literal"></code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables are pushed down to the
  NDB kernel (data nodes). Previously, a join was handled using
  multiple accesses of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") by the
  SQL node; however, when
  [`ndb_join_pushdown`](mysql-cluster-options-variables.html#sysvar_ndb_join_pushdown) is enabled,
  ...
  merged result being returned to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
  This can reduce greatly the number of round trips between an
  SQL node and the data nodes required to handle such a join.

  By default, [`ndb_join_pushdown`](mysql-cluster-options-variables.html#sysvar_ndb_join_pushdown)
  is enabled.
  ...
  **Conditions for NDB pushdown joins.**
  ...
  1. Only columns can be compared, and all columns to be joined
     ...
     [`INT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column and a
     [`BIGINT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column also cannot
     be pushed down.
  ...
  2. Queries referencing [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") or
     [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns are not
     supported.

  3. Explicit locking is not supported; however, the
     [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine's
  ...
  4. In order for a join to be pushed down, child tables in the
     ...
     [`ref`](explain-output.html#jointype_ref),
     [`eq_ref`](explain-output.html#jointype_eq_ref), or
     [`const`](explain-output.html#jointype_const) access methods,
     or some combination of these methods.

     Outer joined child tables can only be pushed using
     [`eq_ref`](explain-output.html#jointype_eq_ref).

     If the root of the pushed join is an
     [`eq_ref`](explain-output.html#jointype_eq_ref) or
     [`const`](explain-output.html#jointype_const), only child
     tables joined by [`eq_ref`](explain-output.html#jointype_eq_ref)
     can be appended. (A table joined by
     [`ref`](explain-output.html#jointype_ref) is likely to become
  ...
  checking it with [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement"); when
  ...
  *and* the result is ordered or grouped by
  ...
  1. The status variables
     ...
     and [`Ndb_pushed_reads`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_reads).

  2. The counters in the
     [`ndbinfo.counters`](mysql-cluster-ndbinfo-counters.html "25.6.15.13 The ndbinfo counters Table") table
     that belong to the
     [`DBSPJ`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbspj.html) kernel block.
...
<td><code class="literal"></code></td>
  ...
  started with the
  [`--ndb-log-apply-status`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-apply-status) option.
...
<td><code class="literal"></code></td>
  ...
  [`log_bin`](replication-options-binary-log.html#sysvar_log_bin). (In addition,
  [`ndb_log_bin`](mysql-cluster-options-variables.html#sysvar_ndb_log_bin) must not be
  disabled.) `ndb_log_binlog_index` defaults to
  `1` (`ON`); normally, there
  is never any need to change this value in a production
  environment.

* [`ndb_log_cache_size`](mysql-cluster-options-variables.html#sysvar_ndb_log_cache_size)
...
<td><code class="literal"></code></td>
  ...
  Set the size of the transaction cache used session for writing
  the `NDB` binary log.
...
<td><code class="literal">4294967295</code></td>
  ...
  the [`--ndb-log-orig`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-orig) server
  option.
...
<td><code class="literal">4294967295</code></td>
  ...
  replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") writes NDB transaction IDs
  ...
  [`--ndb-log-transaction-id`](mysql-cluster-options-variables.html#option_mysqld_ndb-log-transaction-id)
  option.

  [`ndb_log_transaction_id`](mysql-cluster-options-variables.html#sysvar_ndb_log_transaction_id) is not
  supported in mainline MySQL Server 9.5.
...
<td><code class="literal">4294967295</code></td>
  ...
  Whether a replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") writes compressed
  transactions in the binary log; present only if
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was compiled with support for
  `NDB`.

  You should note that starting the MySQL server with
  [`--binlog-transaction-compression`](replication-options-binary-log.html#sysvar_binlog_transaction_compression)
  ...
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") or other client session after
  starting [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
...
<td><code class="literal">4294967295</code></td>
  ...
  enabled by
  [`ndb_log_transaction_compression`](mysql-cluster-options-variables.html#sysvar_ndb_log_transaction_compression).
  Not supported if [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was not compiled
  with support for the `NDB` storage engine.

  See [Section 7.4.4.5, “Binary Log Transaction Compression”](binary-log-transaction-compression.html "7.4.4.5 Binary Log Transaction Compression"), for
  more information.

* [`ndb_metadata_check`](mysql-cluster-options-variables.html#sysvar_ndb_metadata_check)
...
<td><code class="literal">4294967295</code></td>
  ...
  Setting this variable to `true` causes the
  list of excluded objects to be cleared; setting it to
  `false` clears the list of objects to be
  retried.
...
<td><code class="literal">4294967295</code></td>
  ...
  1. Start with the value set for the
     [`Group`](mysql-cluster-tcp-definition.html#ndbparam-tcp-group) parameter
     (default 55).
...
<td><code class="literal">4294967295</code></td>
  ...
  value of
  [`ndb_data_node_neighbour`](mysql-cluster-options-variables.html#sysvar_ndb_data_node_neighbour) on
  ...
  accordingly, in a [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  or [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement; see
  [Section 15.1.24.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.24.12 Setting NDB Comment Options"), for more
  information.
...
<td>bytes</td>
  ...
  [Section 25.6.2.3, “Event Buffer Reporting in the Cluster Log”](mysql-cluster-logs-event-buffer.html "25.6.2.3 Event Buffer Reporting in the Cluster Log")). Slip is
  ...
  [`Ndb::setEventBufferQueueEmptyEpoch()`](/doc/ndbapi/en/ndb-ndb.html#ndb-ndb-seteventbufferqueueemptyepoch)
...
* [`ndb_schema_dist_lock_wait_timeout`](mysql-cluster-options-variables.html#sysvar_ndb_schema_dist_lock_wait_timeout)
...
* [`ndb_schema_dist_timeout`](mysql-cluster-options-variables.html#sysvar_ndb_schema_dist_timeout)
...
* [`ndb_schema_dist_upgrade_allowed`](mysql-cluster-options-variables.html#sysvar_ndb_schema_dist_upgrade_allowed)
...
<td>bytes</td>
  ...
  [`foreign_key_checks=0`](server-system-variables.html#sysvar_foreign_key_checks). When
...
<td>String</td>
  ...
  tables, see
  [NDB\_TABLE Options](create-table-ndb-comment-options.html#create-table-ndb-comment-table-options "NDB_TABLE Options").

  [`ndb_table_no_logging`](mysql-cluster-options-variables.html#sysvar_ndb_table_no_logging) has no
  effect on the creation of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  table schema files; to suppress these, use
  [`ndb_table_temporary`](mysql-cluster-options-variables.html#sysvar_ndb_table_temporary) instead.
...
<td>String</td>
  ...
  When set to `ON` or `1`,
  this variable causes [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables
...
<td>String</td>
  ...
  Forces [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") to use copying of
  tables in the event of problems with online
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations. The
...
<td>String</td>
  ...
  Forces [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") to use a count of
...
<td>String</td>
  ...
  [`JSON`](json.html "13.5 The JSON Data Type") columns. For this reason,
  ...
  MySQL Server 9.5, it is present but does nothing.
  For more information, see
...
<td>String</td>
  ...
  [`--ndb-batch-size`](mysql-cluster-options-variables.html#option_mysqld_ndb-batch-size) option to
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  within the 32-bit [`server_id`](replication-options.html#sysvar_server_id)
  ...
  `AnyValue` of an
  [`OperationOptions`](/doc/ndbapi/en/ndb-ndboperation.html#ndb-ndboperation-operationoptions)
  structure (NDB Cluster uses the `AnyValue` to
  store the server ID).

  When extracting the effective server ID from
  [`server_id`](replication-options.html#sysvar_server_id) for purposes such
  as detection of replication loops, the server ignores the
  remaining bits. The
  [`server_id_bits`](mysql-cluster-options-variables.html#sysvar_server_id_bits) variable is
  used to mask out any irrelevant bits of
  [`server_id`](replication-options.html#sysvar_server_id) in the I/O and SQL
  threads when deciding whether an event should be ignored based
  on the server ID.

  This data can be read from the binary log by
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"), provided that it is run with
  its own [`server_id_bits`](mysql-cluster-options-variables.html#sysvar_server_id_bits)
  variable set to 32 (the default).

  If the value of [`server_id`](replication-options.html#sysvar_server_id)
  greater than or equal to 2 to the power of
  [`server_id_bits`](mysql-cluster-options-variables.html#sysvar_server_id_bits); otherwise,
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") refuses to start.

  This system variable is supported only by NDB Cluster. It is
  not supported in the standard MySQL 9.5 Server.
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [`autocommit`](server-system-variables.html#sysvar_autocommit) must first be
  ...
  [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") if desired) before
  issuing a [`SELECT`](select.html "15.2.13 SELECT Statement").
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  Place the [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.15 ndbinfo: The NDB Cluster Information Database") database
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"). No rows are returned from
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  Whether or not the [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.15 ndbinfo: The NDB Cluster Information Database")
  database's underlying internal tables are shown in the
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client. The default is
  `OFF`.
  ...
  [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") or other
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [`ndbinfo_show_hidden`](mysql-cluster-options-variables.html#sysvar_ndbinfo_show_hidden)). This is
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.15 ndbinfo: The NDB Cluster Information Database") engine in use;
  read-only.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. For status
...
* [`Handler_discover`](mysql-cluster-options-variables.html#statvar_Handler_discover)
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine if it
...
* [`Ndb_api_bytes_sent_count_session`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count_session)
  ...
  [`SHOW GLOBAL
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"), it relates to the current session only, and
...
* [`Ndb_api_bytes_sent_count_replica`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count_replica)
  ...
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"), it is effectively global in scope. If this
...
* [`Ndb_api_bytes_sent_count`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count)
  ...
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"), it is effectively global in scope.
...
* [`Ndb_api_read_row_count`](mysql-cluster-options-variables.html#statvar_Ndb_api_read_row_count)
  ...
  [`COUNT(*)`](aggregate-functions.html#function_count) queries, due to the
...
* [`Ndb_api_wait_exec_complete_count_session`](mysql-cluster-options-variables.html#statvar_Ndb_api_wait_exec_complete_count_session)
  ...
  [`execute()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-execute)
...
* [`Ndb_config_generation`](mysql-cluster-options-variables.html#statvar_Ndb_config_generation)
...
* [`Ndb_conflict_fn_epoch`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_epoch)
  ...
  given [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") since the last time it was
  restarted.
...
* [`Ndb_conflict_fn_epoch_trans`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_epoch_trans)
  ...
  on a given [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") since the last time it
  was restarted.
...
* [`Ndb_conflict_fn_epoch2_trans`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_epoch2_trans)
  ...
  resolution on a given [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") since the last
...
* [`Ndb_conflict_fn_max`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_max)
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was started.
...
* [`Ndb_conflict_fn_max_del_win`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_max_del_win)
  ...
  since the last time that this [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was
  started.

  For more information, see
  [Section 25.7.12, “NDB Cluster Replication Conflict Resolution”](mysql-cluster-replication-conflict-resolution.html "25.7.12 NDB Cluster Replication Conflict Resolution").

* [`Ndb_conflict_fn_max_del_win_ins`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_max_del_win_ins)
  ...
  that this [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was started.

  For more information, see
  [Section 25.7.12, “NDB Cluster Replication Conflict Resolution”](mysql-cluster-replication-conflict-resolution.html "25.7.12 NDB Cluster Replication Conflict Resolution").

* [`Ndb_conflict_fn_max_ins`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_max_ins)
...
* [`Ndb_conflict_trans_row_conflict_count`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_trans_row_conflict_count)
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") since the last time it was
  restarted.
...
* [`Ndb_execute_count`](mysql-cluster-options-variables.html#statvar_Ndb_execute_count)
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") kernel made by operations.

* [`Ndb_fetch_table_stats`](mysql-cluster-options-variables.html#statvar_Ndb_fetch_table_stats)
...
* [`Ndb_pushed_queries_defined`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_queries_defined)
  ...
  Joins tested using [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement")
...
* [`Ndb_pushed_queries_executed`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_queries_executed)
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") and executed there.

* [`Ndb_pushed_reads`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_reads)

  The number of rows returned to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") from
  the NDB kernel by joins that were pushed down.

  Note

  Executing [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") on joins
  that can be pushed down to [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
* [`Ndb_pruned_scan_count`](mysql-cluster-options-variables.html#statvar_Ndb_pruned_scan_count)
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") since the NDB Cluster
  was last started where [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  was able to use partition pruning.

  Using this variable together with
  [`Ndb_scan_count`](mysql-cluster-options-variables.html#statvar_Ndb_scan_count) can be
...
* [`Ndb_scan_count`](mysql-cluster-options-variables.html#statvar_Ndb_scan_count)
  ...
  executed by [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") since the
  NDB Cluster was last started.

* [`Ndb_schema_participant_count`](mysql-cluster-options-variables.html#statvar_Ndb_schema_participant_count)
...
* [`Ndb_trans_hint_count_session`](mysql-cluster-options-variables.html#statvar_Ndb_trans_hint_count_session)

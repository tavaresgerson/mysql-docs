...
[**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") binaries
...
`ExecuteOnComputer`; this must be defined in
the local `[ndbd]` section.
...
All of these parameters also apply to [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)")
(the multithreaded version of [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon")). Three
...
to [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") only; these have no effect when
used with [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon"). For more information, see
...
See also [Section 25.5.3, “ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)”](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)").
...
<span class="bold"><strong>Initial System Restart:
                    ...
                    system from a
                    <a class="link" href="mysql-cluster-backup.html" title="25.6.8 Online Backup of NDB Cluster">backup</a>,
                    and then restarting the cluster. (NDB 9.5.0)
                  </p></td>
</tr></tbody></table>
...
* The node ID for this node can be given out only to
  ...
  [`HostName`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-hostname) is not
...
<span class="bold"><strong>Node Restart:
                    ...
                    <a class="link" href="mysql-cluster-rolling-restart.html" title="25.6.5 Performing a Rolling Restart of an NDB Cluster">rolling
                    restart</a> of the cluster. (NDB 9.5.0)
                  </p></td>
</tr></tbody></table>
...
<span class="bold"><strong>System Restart:
  ...
  using the [**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") management port (the
  management server's
...
<span class="bold"><strong>Initial Node Restart:
                    ...
                    be restarted with
                    <a class="link" href="mysql-cluster-programs-ndbd.html#option_ndbd_initial"><code class="option">--initial</code></a>. (NDB 9.5.0)
                  </p></td>
</tr></tbody></table>
...
<span class="bold"><strong>Initial Node Restart:
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") process is initiated.
...
understand how
[`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) is used, as
...
<span class="bold"><strong>System Restart:
  ...
  [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) is 98MB.
...
<span class="bold"><strong>System Restart:
  ...
  same pool as
  [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory), which is
  solely responsible for all resources needed for storing data
  and indexes in memory. In NDB 9.5, the use of
...
[`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) can be
...
[`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) is kept in
...
([`DBTC`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbtc.html)). Leaving any one of
...
[`MaxNoOfConcurrentTransactions`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-maxnoofconcurrenttransactions),
[`MaxNoOfFiredTriggers`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-maxnooffiredtriggers),
[`MaxNoOfLocalScans`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-maxnooflocalscans), or
[`TransactionBufferMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-transactionbuffermemory)
(see [Transaction parameters](mysql-cluster-ndbd-definition.html#mysql-cluster-transaction-parameters "Transaction parameters")
and
[Transaction temporary storage](mysql-cluster-ndbd-definition.html#mysql-cluster-transaction-temporary-storage "Transaction temporary storage")).
...
<span class="bold"><strong>Node Restart:
  ...
  **Parameters incompatible with TransactionMemory.**
  ...
  `TransactionMemory` and are therefore
  deprecated:
...
has no effect in NDB 9.5. It is deprecated and
subject to removal in a future release.

##### Multiple Transporters

`NDB` allocates multiple transporters for
...
<span class="bold"><strong>System Restart:
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements that
  you might want to perform in the future. This is due to the
  fact, during the execution of [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") on a Cluster table, 3 times the number of
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") after configuring the parameter. If this is
...
<span class="bold"><strong>System Restart:
  ...
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data type an extra table
  is used to store most of the
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") data. These tables also
...
<span class="bold"><strong>System Restart:
  ...
  Each [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table in an NDB
...
<span class="bold"><strong>System Restart:
  ...
  nodes]`. There is one subscription per
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table for each of two MySQL
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes included in replication
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") attached to each cluster, and each
  of these [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes acts as a
...
<span class="bold"><strong>Initial System Restart:
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") on a diskless computer.
...
<span class="bold"><strong>Initial System Restart:
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") to attempt using
...
<span class="bold"><strong>Initial Node Restart:
  ...
  [Starting and Stopping the Agent on Linux](/doc/mysql-cluster-manager/9.5/en/mcm-using-start-stop-agent-linux.html), for more
  information.
...
<span class="bold"><strong>Initial Node Restart:
  ...
  See [Section 25.6.7, “Adding NDB Cluster Data Nodes Online”](mysql-cluster-online-add-node.html "25.6.7 Adding NDB Cluster Data Nodes Online"), for
  more information.
...
<span class="bold"><strong>Initial Node Restart:
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") client.) It may be
...
* [`KeepAliveSendInterval`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-keepalivesendinterval)
...
<span class="bold"><strong>System Restart:
  ...
  The default for `KeepAliveSendInterval` is
...
“faked” by the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
<span class="bold"><strong>System Restart:
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine issues error
  ...
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") allocates a separate buffer for
  each LDM thread (see
  [`ThreadConfig`](mysql-cluster-ndbd-definition.html#ndbparam-ndbmtd-threadconfig)). For
  example, with 4 LDM threads, an [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)")
...
<span class="bold"><strong>System Restart:
  ...
  [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory), as set
  ...
  [Section 25.6.3.2, “NDB Cluster Log Events”](mysql-cluster-log-events.html "25.6.3.2 NDB Cluster Log Events").
...
<span class="bold"><strong>System Restart:
  ...
  [Section 25.6.4, “Summary of NDB Cluster Start Phases”](mysql-cluster-start-phases.html "25.6.4 Summary of NDB Cluster Start Phases")). When very
...
<span class="bold"><strong>System Restart:
  ...
  a backup is single-threaded; since NDB 9.5
...
<span class="bold"><strong>System Restart:
  ...
  is used with [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")).
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)").
...
<span class="bold"><strong>System Restart:
  ...
  When used with [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon"), this parameter (now
  a string) specifies the ID of the CPU assigned to handle the
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") execution thread.
  When used with [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"), the value of this
...
<span class="bold"><strong>System Restart:
  ...
  handle [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") maintenance
  threads.
...
<span class="bold"><strong>System Restart:
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"). By
  ...
  **numactl**. For many Linux systems, the
  ...
  problematic when using [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"); this is
...
<span class="bold"><strong>System Restart:
  ...
  If [`SpinMethod`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-spinmethod) is
  set, any setting for this parameter is ignored.

* [`SpinMethod`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-spinmethod)
...
<span class="bold"><strong>System Restart:
  ...
  [`SpinMethod`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-spinmethod) are
  ...
  + `EnableAdaptiveSpinning`: Enables or
    ...
    [`DUMP 104004 1`](/doc/ndb-internals/en/dump-command-104004.html) or
    disabled with [`DUMP 104004
    0`](/doc/ndb-internals/en/dump-command-104004.html) in the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") management
    client.
  ...
  + `SetAllowedSpinOverhead`: Sets the
    ...
    use [`DUMP 104002
    overhead`](/doc/ndb-internals/en/dump-command-104002.html) to do so,
...
[**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") runs by default as a single-threaded
...
set up more complex rules for [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)")
...
[Section 25.6.8.5, “Taking an NDB Backup with Parallel Data Nodes”](mysql-cluster-backup-parallel-data-nodes.html "25.6.8.5 Taking an NDB Backup with Parallel Data Nodes"), as
well as
[Restoring from a backup taken in parallel](/doc/refman/8.0/en/ndb-restore-parallel-data-node-backup.html).
...
<span class="bold"><strong>System Restart:
  ...
  [`NumCPUs`](mysql-cluster-ndbd-definition.html#ndbparam-ndbmtd-numcpus) to the
...
<span class="bold"><strong>System Restart:
  ...
  `NDB` distributes fragments among LDMs such
...
<span class="bold"><strong>System Restart:
  ...
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"). To force a single-threaded backup
  that can be restored easily using older versions of
  [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup"), disable multi-threaded
  ...
  and [Restoring from a backup taken in parallel](/doc/refman/8.0/en/ndb-restore-parallel-data-node-backup.html),
...
<span class="bold"><strong>System Restart:
  ...
  threads used by [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"), up to a maximum
  of 72. Although this parameter is set in
  `[ndbd]` or `[ndbd
  default]` sections of the
  `config.ini` file, it is exclusive to
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") and does not apply to
...
<span class="bold"><strong>System Restart:
  ...
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"), as determined by the setting for
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") is used on the data nodes rather
  than [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"), then there is always a
  single LDM thread; in this case, the number of partitions
  created automatically is simply equal to the number of data
  nodes. See [Section 25.2.2, “NDB Cluster Nodes, Node Groups, Fragment Replicas, and Partitions”](mysql-cluster-nodes-groups.html "25.2.2 NDB Cluster Nodes, Node Groups, Fragment Replicas, and Partitions"), for
  more information.
  ...
  *`value`* for parameter
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") to 2, so that 2 is
...
<span class="bold"><strong>System Restart:
  ...
  this [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"). The value of this parameter
  should be set equal to the number of LDM threads used by
  [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") as determined by the setting for
  [`MaxNoOfExecutionThreads`](mysql-cluster-ndbd-definition.html#ndbparam-ndbmtd-maxnoofexecutionthreads).
...
* [`NumCPUs`](mysql-cluster-ndbd-definition.html#ndbparam-ndbmtd-numcpus)
...
<span class="bold"><strong>System Restart:
  ...
  This parameter is used with [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") to
  ...
  **thread\_prio settings and effects by platform.**
  ...
  + *Linux and FreeBSD*: We map
    ...
    **Table 25.12 Mapping of thread\_prio to nice values on Linux
    and FreeBSD**
...
<span class="bold"><strong>System Restart:
  ...
  + *Solaris*: Setting
    ...
    **Table 25.13 Mapping of thread\_prio to FX priority on
    Solaris**
...
<span class="bold"><strong>System Restart:
  ...
  + *Windows*: We map
    ...
    **Table 25.14 Mapping of thread\_prio to Windows thread
    priority**
...
<span class="bold"><strong>System Restart:
  ...
  + `ldm`: Local query handler
    ...
    `ldm` can be set to any value in the
    range 0 to 332 inclusive. When setting it to 0,
    `main`, `rep`, and
    `tc` must also be 0, and
    `recv` must also be set to 1; doing
    this causes [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") to emulate
    [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon").
    ...
    If `ldm` is not included in the
    `ThreadConfig` value string, one
    `ldm` thread is created.

  + `query`: A query thread is tied to an
    LDM and together with it forms an LDM group; acts only
    on [`READ COMMITTED`](innodb-transaction-isolation-levels.html#isolevel_read-committed)
    ...
    setting `query` to a nonzero value, or
    by enabling the
    [`AutomaticThreadConfig`](mysql-cluster-ndbd-definition.html#ndbparam-ndbmtd-automaticthreadconfig)
    parameter.
  ...
  + `recover`: A recovery thread restores
  ...
  + `main`: Data dictionary and transaction
    ...
    `rep` thread; the combined thread is
    shown in the
    [`ndbinfo.threads`](mysql-cluster-ndbinfo-threads.html "25.6.15.63 The ndbinfo threads Table") table
    as `main_rep`. This is effectively the
    same as setting `rep` equal to 1 and
    `main` equal to 0.

    It is also possible to set both `main`
    and `rep` to 0, in which case both
    threads are placed in the first `recv`
    thread; the resulting combined thread is named
    `main_rep_recv` in the
    [`threads`](mysql-cluster-ndbinfo-threads.html "25.6.15.63 The ndbinfo threads Table") table.

    If `main` is omitted from the
    `ThreadConfig` value stringthis, one
  ...
  + `recv`: Receive thread
    ...
    If `recv` is omitted from the
    `ThreadConfig` value string, one
    `recv` thread is created.
  ...
  + `rep`: Replication thread
    ...
    `main` thread; the combined thread is
    shown in the
    [`ndbinfo.threads`](mysql-cluster-ndbinfo-threads.html "25.6.15.63 The ndbinfo threads Table") table
    as `main_rep`. This is effectively the
    same as setting `main` equal to 1 and
    `rep` equal to 0.
    ...
    If `rep` is omitted from the
    `ThreadConfig` value string, one
    `rep` thread is created.
  ...
  + `idxbld`: Offline index build threads.
    ...
    when running [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup")
...
<span class="bold"><strong>System Restart:
  ...
  You can query the
  [`ndbinfo.diskpagebuffer`](mysql-cluster-ndbinfo-diskpagebuffer.html "25.6.15.31 The ndbinfo diskpagebuffer Table")
  table to help determine whether the value for this parameter
  should be increased to minimize unnecessary disk seeks. See
  [Section 25.6.15.31, “The ndbinfo diskpagebuffer Table”](mysql-cluster-ndbinfo-diskpagebuffer.html "25.6.15.31 The ndbinfo diskpagebuffer Table"), for
  more information.
...
<span class="bold"><strong>System Restart:
  ...
  [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") and
  [`ALTER LOGFILE GROUP`](alter-logfile-group.html "15.1.8 ALTER LOGFILE GROUP Statement")
...
<span class="bold"><strong>System Restart:
  ...
  + **Disk performance and types.**
    ...
    [Disk Data latency parameters](mysql-cluster-ndbd-definition.html#mysql-cluster-ndbd-definition-disk-data-latency-parameters "Disk Data latency parameters").
...
<span class="bold"><strong>System Restart:
    ...
    [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") or
    ...
    [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") or
    [`ALTER LOGFILE GROUP`](alter-logfile-group.html "15.1.8 ALTER LOGFILE GROUP Statement")
    statement. If
    [`FileSystemPathDD`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-filesystempathdd)
...
<span class="bold"><strong>System Restart:
    ...
    GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") or [`ALTER LOGFILE
    GROUP`](alter-logfile-group.html "15.1.8 ALTER LOGFILE GROUP Statement") statement used to create that data file.
    If
    [`FileSystemPathUndoFiles`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-filesystempathundofiles)
    is not specified, then
    [`FileSystemPathDD`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-filesystempathdd)
...
[Section 25.4.3.14, “Configuring NDB Cluster Send Buffer Parameters”](mysql-cluster-config-send-buffers.html "25.4.3.14 Configuring NDB Cluster Send Buffer Parameters").
...
See also [Section 25.6.7, “Adding NDB Cluster Data Nodes Online”](mysql-cluster-online-add-node.html "25.6.7 Adding NDB Cluster Data Nodes Online").
...
<span class="bold"><strong>System Restart:
  ...
  any given index in the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  system tables and in the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") memory
  cache.

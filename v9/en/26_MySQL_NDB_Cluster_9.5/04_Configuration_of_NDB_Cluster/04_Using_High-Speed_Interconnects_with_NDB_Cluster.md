...
Even before design of [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") was designed from the very
beginning to permit the use of a number of different data
transport mechanisms, or transporters.

NDB Cluster supports three of these (see
[Section 25.2.1, “NDB Cluster Core Concepts”](mysql-cluster-basics.html "25.2.1 NDB Cluster Core Concepts")). A fourth transporter,

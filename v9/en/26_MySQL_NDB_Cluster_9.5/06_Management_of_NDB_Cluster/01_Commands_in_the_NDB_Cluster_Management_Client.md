...
the management client [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client"). This is the
primary administrative interface to a running cluster.

Commands for the event logs are given in
[Section 25.6.3, “Event Reports Generated in NDB Cluster”](mysql-cluster-event-reports.html "25.6.3 Event Reports Generated in NDB Cluster"); commands for
...
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") for these tasks for an NDB Cluster
that is under MySQL Cluster Manager control. It is recommended
*not* to use the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")
...
information, see [MySQL Cluster Manager Process Commands](/doc/mysql-cluster-manager/9.5/en/mcm-process-commands.html).
...
* [`CREATE NODEGROUP
  ...
  [Section 25.6.7, “Adding NDB Cluster Data Nodes Online”](mysql-cluster-online-add-node.html "25.6.7 Adding NDB Cluster Data Nodes Online").
...
* [`DROP NODEGROUP
  ...
  *`nodegroup_id`*.
  ...
  no way using [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") or the
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to remove all data from a
  ...
  1. After issuing [`CREATE
     NODEGROUP`](mysql-cluster-mgm-client-commands.html#ndbclient-create-nodegroup) in the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")
     client, but before issuing any
     [`ALTER TABLE
     ... REORGANIZE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statements in the
     [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client.

  2. After dropping all [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
     tables using [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement").

     [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") does not
     work for this purpose because this removes only the table
     data; the data nodes continue to store an
     [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table's
     definition until a [`DROP
     TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") statement is issued that causes the table
     metadata to be dropped.

  For more information about `DROP NODEGROUP`,
  see [Section 25.6.7, “Adding NDB Cluster Data Nodes Online”](mysql-cluster-online-add-node.html "25.6.7 Adding NDB Cluster Data Nodes Online").
...
* [`ENTER SINGLE USER MODE
  ...
  The [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") client provides a clear
  ...
  [`SHOW`](mysql-cluster-mgm-client-commands.html#ndbclient-show) command, like this:
...
* [`EXIT SINGLE USER MODE`](mysql-cluster-mgm-client-commands.html#ndbclient-exit-single-user-mode)
  ...
  running [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") processes) to access the
  database.
...
* [`PROMPT
  ...
  Changes the prompt shown by [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") to the
  string literal *`prompt`*.

  *`prompt`* should not be quoted (unless
  you want the prompt to include the quotation marks). Unlike
  the case with the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, special
...
* [`node_id
  ...
  *`report-type`*:
  ...
  + `MemoryUsage` displays how much data
    ...
    [`ndbinfo.memoryusage`](mysql-cluster-ndbinfo-memoryusage.html "25.6.15.46 The ndbinfo memoryusage Table")
    table.
...
* [`node_id
  ...
  *`node_id`* (or all data nodes).
  ...
  using [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon")
  ...
  [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") [`--nostart`](mysql-cluster-programs-ndbd.html#option_ndbd_nostart)
  or [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") `-n` from the system
  shell.
...
* [`SHOW`](mysql-cluster-mgm-client-commands.html#ndbclient-show)
  ...
  command, as well as
  [Section 25.6.6, “NDB Cluster Single User Mode”](mysql-cluster-single-user-mode.html "25.6.6 NDB Cluster Single User Mode")). It also
...
* [`node_id
  ...
  *`node_id`*.
  ...
  and its associated [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or
  [**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") process terminates.
...
* [`TLS INFO`](mysql-cluster-mgm-client-commands.html#ndbclient-tls-info)
  ...
  For more information, see [Section 25.6.19.5, “TLS Link Encryption for NDB Cluster”](mysql-cluster-tls.html "25.6.19.5 TLS Link Encryption for NDB Cluster").

**Additional commands.**
A number of other commands available in the
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") client are described elsewhere, as
shown in the following list:

* [`START BACKUP`](mysql-cluster-backup-using-management-client.html "25.6.8.2 Using The NDB Cluster Management Client to Create a Backup") is used to
  perform an online backup in the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")
  ...
  more information, see [Section 25.6.8, “Online Backup of NDB Cluster”](mysql-cluster-backup.html "25.6.8 Online Backup of NDB Cluster").

* The [`CLUSTERLOG`](mysql-cluster-logging-management-commands.html "25.6.3.1 NDB Cluster Logging Management Commands") command is
  used to perform various logging functions. See
  [Section 25.6.3, “Event Reports Generated in NDB Cluster”](mysql-cluster-event-reports.html "25.6.3 Event Reports Generated in NDB Cluster"), for more

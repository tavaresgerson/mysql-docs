...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") instance, and serves as a companion
table to [`server_operations`](mysql-cluster-ndbinfo-server-operations.html "25.6.15.55 The ndbinfo server_operations Table").
...
output of [**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "25.5.27 ndb_show_tables — Display List of NDB Tables").

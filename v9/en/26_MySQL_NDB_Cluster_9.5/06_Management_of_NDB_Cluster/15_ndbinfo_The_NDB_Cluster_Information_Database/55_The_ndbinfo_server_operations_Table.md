...
for all ongoing [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") operations that
the current SQL node (MySQL Server) is currently involved in. It
effectively is a subset of the
[`cluster_operations`](mysql-cluster-ndbinfo-cluster-operations.html "25.6.15.8 The ndbinfo cluster_operations Table") table, in
...
[`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement"). It is obtained

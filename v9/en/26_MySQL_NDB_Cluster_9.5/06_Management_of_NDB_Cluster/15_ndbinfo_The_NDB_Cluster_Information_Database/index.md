...
[25.6.15.1 The ndbinfo arbitrator\_validity\_detail Table](mysql-cluster-ndbinfo-arbitrator-validity-detail.html)

[25.6.15.2 The ndbinfo arbitrator\_validity\_summary Table](mysql-cluster-ndbinfo-arbitrator-validity-summary.html)

[25.6.15.3 The ndbinfo backup\_id Table](mysql-cluster-ndbinfo-backup-id.html)

[25.6.15.4 The ndbinfo blobs Table](mysql-cluster-ndbinfo-blobs.html)

[25.6.15.5 The ndbinfo blocks Table](mysql-cluster-ndbinfo-blocks.html)

[25.6.15.6 The ndbinfo certificates Table](mysql-cluster-ndbinfo-certificates.html)

[25.6.15.7 The ndbinfo cluster\_locks Table](mysql-cluster-ndbinfo-cluster-locks.html)

[25.6.15.8 The ndbinfo cluster\_operations Table](mysql-cluster-ndbinfo-cluster-operations.html)

[25.6.15.9 The ndbinfo cluster\_transactions Table](mysql-cluster-ndbinfo-cluster-transactions.html)

[25.6.15.10 The ndbinfo config\_nodes Table](mysql-cluster-ndbinfo-config-nodes.html)

[25.6.15.11 The ndbinfo config\_params Table](mysql-cluster-ndbinfo-config-params.html)

[25.6.15.12 The ndbinfo config\_values Table](mysql-cluster-ndbinfo-config-values.html)

[25.6.15.13 The ndbinfo counters Table](mysql-cluster-ndbinfo-counters.html)

[25.6.15.14 The ndbinfo cpudata Table](mysql-cluster-ndbinfo-cpudata.html)

[25.6.15.15 The ndbinfo cpudata\_1sec Table](mysql-cluster-ndbinfo-cpudata-1sec.html)

[25.6.15.16 The ndbinfo cpudata\_20sec Table](mysql-cluster-ndbinfo-cpudata-20sec.html)

[25.6.15.17 The ndbinfo cpudata\_50ms Table](mysql-cluster-ndbinfo-cpudata-50ms.html)

[25.6.15.18 The ndbinfo cpuinfo Table](mysql-cluster-ndbinfo-cpuinfo.html)

[25.6.15.19 The ndbinfo cpustat Table](mysql-cluster-ndbinfo-cpustat.html)

[25.6.15.20 The ndbinfo cpustat\_50ms Table](mysql-cluster-ndbinfo-cpustat-50ms.html)

[25.6.15.21 The ndbinfo cpustat\_1sec Table](mysql-cluster-ndbinfo-cpustat-1sec.html)

[25.6.15.22 The ndbinfo cpustat\_20sec Table](mysql-cluster-ndbinfo-cpustat-20sec.html)

[25.6.15.23 The ndbinfo dictionary\_columns Table](mysql-cluster-ndbinfo-dictionary-columns.html)

[25.6.15.24 The ndbinfo dictionary\_tables Table](mysql-cluster-ndbinfo-dictionary-tables.html)

[25.6.15.25 The ndbinfo dict\_obj\_info Table](mysql-cluster-ndbinfo-dict-obj-info.html)

[25.6.15.26 The ndbinfo dict\_obj\_tree Table](mysql-cluster-ndbinfo-dict-obj-tree.html)

[25.6.15.27 The ndbinfo dict\_obj\_types Table](mysql-cluster-ndbinfo-dict-obj-types.html)

[25.6.15.28 The ndbinfo disk\_write\_speed\_base Table](mysql-cluster-ndbinfo-disk-write-speed-base.html)

[25.6.15.29 The ndbinfo disk\_write\_speed\_aggregate Table](mysql-cluster-ndbinfo-disk-write-speed-aggregate.html)

[25.6.15.30 The ndbinfo disk\_write\_speed\_aggregate\_node Table](mysql-cluster-ndbinfo-disk-write-speed-aggregate-node.html)

[25.6.15.31 The ndbinfo diskpagebuffer Table](mysql-cluster-ndbinfo-diskpagebuffer.html)

[25.6.15.32 The ndbinfo diskstat Table](mysql-cluster-ndbinfo-diskstat.html)

[25.6.15.33 The ndbinfo diskstats\_1sec Table](mysql-cluster-ndbinfo-diskstats-1sec.html)

[25.6.15.34 The ndbinfo error\_messages Table](mysql-cluster-ndbinfo-error-messages.html)

[25.6.15.35 The ndbinfo events Table](mysql-cluster-ndbinfo-events.html)

[25.6.15.36 The ndbinfo files Table](mysql-cluster-ndbinfo-files.html)

[25.6.15.37 The ndbinfo foreign\_keys Table](mysql-cluster-ndbinfo-foreign-keys.html)

[25.6.15.38 The ndbinfo hash\_maps Table](mysql-cluster-ndbinfo-hash-maps.html)

[25.6.15.39 The ndbinfo hwinfo Table](mysql-cluster-ndbinfo-hwinfo.html)

[25.6.15.40 The ndbinfo index\_columns Table](mysql-cluster-ndbinfo-index-columns.html)

[25.6.15.41 The ndbinfo index\_stats Table](mysql-cluster-ndbinfo-index-stats.html)

[25.6.15.42 The ndbinfo locks\_per\_fragment Table](mysql-cluster-ndbinfo-locks-per-fragment.html)

[25.6.15.43 The ndbinfo logbuffers Table](mysql-cluster-ndbinfo-logbuffers.html)

[25.6.15.44 The ndbinfo logspaces Table](mysql-cluster-ndbinfo-logspaces.html)

[25.6.15.45 The ndbinfo membership Table](mysql-cluster-ndbinfo-membership.html)

[25.6.15.46 The ndbinfo memoryusage Table](mysql-cluster-ndbinfo-memoryusage.html)

[25.6.15.47 The ndbinfo memory\_per\_fragment Table](mysql-cluster-ndbinfo-memory-per-fragment.html)

[25.6.15.48 The ndbinfo nodes Table](mysql-cluster-ndbinfo-nodes.html)

[25.6.15.49 The ndbinfo operations\_per\_fragment Table](mysql-cluster-ndbinfo-operations-per-fragment.html)

[25.6.15.50 The ndbinfo pgman\_time\_track\_stats Table](mysql-cluster-ndbinfo-pgman-time-track-stats.html)

[25.6.15.51 The ndbinfo processes Table](mysql-cluster-ndbinfo-processes.html)

[25.6.15.52 The ndbinfo resources Table](mysql-cluster-ndbinfo-resources.html)

[25.6.15.53 The ndbinfo restart\_info Table](mysql-cluster-ndbinfo-restart-info.html)

[25.6.15.54 The ndbinfo server\_locks Table](mysql-cluster-ndbinfo-server-locks.html)

[25.6.15.55 The ndbinfo server\_operations Table](mysql-cluster-ndbinfo-server-operations.html)

[25.6.15.56 The ndbinfo server\_transactions Table](mysql-cluster-ndbinfo-server-transactions.html)

[25.6.15.57 The ndbinfo table\_distribution\_status Table](mysql-cluster-ndbinfo-table-distribution-status.html)

[25.6.15.58 The ndbinfo table\_fragments Table](mysql-cluster-ndbinfo-table-fragments.html)

[25.6.15.59 The ndbinfo table\_info Table](mysql-cluster-ndbinfo-table-info.html)

[25.6.15.60 The ndbinfo table\_replicas Table](mysql-cluster-ndbinfo-table-replicas.html)

[25.6.15.61 The ndbinfo tc\_time\_track\_stats Table](mysql-cluster-ndbinfo-tc-time-track-stats.html)

[25.6.15.62 The ndbinfo threadblocks Table](mysql-cluster-ndbinfo-threadblocks.html)

[25.6.15.63 The ndbinfo threads Table](mysql-cluster-ndbinfo-threads.html)

[25.6.15.64 The ndbinfo threadstat Table](mysql-cluster-ndbinfo-threadstat.html)

[25.6.15.65 The ndbinfo transporter\_details Table](mysql-cluster-ndbinfo-transporter-details.html)

[25.6.15.66 The ndbinfo transporters Table](mysql-cluster-ndbinfo-transporters.html)

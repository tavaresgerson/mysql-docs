...
[`dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table") table. This is
...
* `type`
  ...
  join on [`dict_obj_types`](mysql-cluster-ndbinfo-dict-obj-types.html "25.6.15.27 The ndbinfo dict_obj_types Table") to
  obtain the name of the object type

* `id`

  Object identifier; same as the `id` column
  in [`dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table")
  ...
  [`logbuffers`](mysql-cluster-ndbinfo-logbuffers.html "25.6.15.43 The ndbinfo logbuffers Table") and
  [`logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.15.44 The ndbinfo logspaces Table") tables

* `name`

  The fully qualified name of the object; the same as the
  `fq_name` column in
  [`dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table")
...
* `parent_type`
  ...
  [`dict_obj_types`](mysql-cluster-ndbinfo-dict-obj-types.html "25.6.15.27 The ndbinfo dict_obj_types Table") to obtain
  the name of the object type

* `parent_id`

  Identifier for this object's parent object; the same as
  the [`dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table")
  table's `id` column
...
* `parent_name`
  ...
  the same as the
  [`dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table") table's
  `fq_name` column
...
from [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") and then

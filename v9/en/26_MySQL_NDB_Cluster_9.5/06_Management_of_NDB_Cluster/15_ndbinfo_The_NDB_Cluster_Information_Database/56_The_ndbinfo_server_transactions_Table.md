...
the [`cluster_transactions`](mysql-cluster-ndbinfo-cluster-transactions.html "25.6.15.9 The ndbinfo cluster_transactions Table")
...
threads from the [`threadblocks`](mysql-cluster-ndbinfo-threadblocks.html "25.6.15.62 The ndbinfo threadblocks Table")
table.
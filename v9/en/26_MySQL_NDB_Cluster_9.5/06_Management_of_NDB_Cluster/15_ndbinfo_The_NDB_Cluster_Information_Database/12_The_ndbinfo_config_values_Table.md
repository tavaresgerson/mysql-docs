...
[`config_params`](mysql-cluster-ndbinfo-config-params.html "25.6.15.11 The ndbinfo config_params Table") table's
...
[`NodeId`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-nodeid),
[`NoOfReplicas`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-noofreplicas),
[`HostName`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-hostname),

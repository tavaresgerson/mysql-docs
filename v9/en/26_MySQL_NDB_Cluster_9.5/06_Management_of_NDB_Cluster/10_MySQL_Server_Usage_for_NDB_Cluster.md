...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is the traditional MySQL server process.
To be used with NDB Cluster, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") needs to be
built with support for the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
[`-DWITH_NDB=1`](source-configuration-options.html#option_cmake_with_ndb) or (deprecated)
...
(For information about [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") options and
variables, in addition to those discussed in this section, which
are relevant to NDB Cluster, see
[Section 25.4.3.9, “MySQL Server Options and Variables for NDB Cluster”](mysql-cluster-options-variables.html "25.4.3.9 MySQL Server Options and Variables for NDB Cluster").)

If the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary has been built with
Cluster support, the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine enabled is
to issue the [`SHOW ENGINES`](show-engines.html "15.7.7.18 SHOW ENGINES Statement") statement
in the MySQL Monitor ([**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")). You should see
the value `YES` as the `Support`
value in the row for [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"). If
you see `NO` in this row or if there is no such
row displayed in the output, you are not running an
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")-enabled version of MySQL. If you
...
The [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") parameter
...
See [Section 25.4.3.3, “NDB Cluster Connection Strings”](mysql-cluster-connection-strings.html "25.4.3.3 NDB Cluster Connection Strings"), for more
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process running in this manner as an SQL
...
You can see in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client whether a MySQL
server is connected to the cluster using [`SHOW
PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement"). If the MySQL server is connected to the
...
To participate in an NDB Cluster, the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is started with only the
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, *nor is it
...
as [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables while the SQL node is
not connected to the cluster. If you wish to create tables using
a different storage engine while the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")

...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, databases containing
such tables, and columns within such tables are identical in all
respects with the [`GRANT`](grant.html "15.7.1.6 GRANT Statement") and
[`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement") statements used in
...
[`DROP USER`](drop-user.html "15.7.1.5 DROP USER Statement") statements.

It is important to keep in mind that, by default, the MySQL
grant tables use the [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") storage
...
[Section 25.6.13, “Privilege Synchronization and NDB\_STORED\_USER”](mysql-cluster-privilege-synchronization.html "25.6.13 Privilege Synchronization and NDB_STORED_USER"), for
details.
...
* Execute metadata statements such as
  [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement") statement (to
  obtain a list of all [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  databases on the server) or
  [`SHOW TABLES
  FROM some_ndb_database`](show-tables.html "15.7.7.40 SHOW TABLES Statement")
  statement to obtain a list of all
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables in a given database
...
* Run any legal MySQL statements on any of the discovered
  ...
  access the [`INFORMATION_SCHEMA`](information-schema.html "Chapter 28 INFORMATION_SCHEMA Tables")
...
in synch using the
[`NDB_STORED_USER`](privileges-provided.html#priv_ndb-stored-user) privilege.
...
2. You can share MySQL users and privileges among SQL nodes
   using [`NDB_STORED_USER`](privileges-provided.html#priv_ndb-stored-user).

3. Once a MySQL user is granted privileges on an
   [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table from one SQL node in

...
are using [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)")
...
2. Perform a rolling restart of all NDB Cluster management
   ...
   [`--initial`](mysql-cluster-programs-ndb-mgmd.html#option_ndb_mgmd_initial) option to force
...
3. Perform a rolling restart of all existing NDB Cluster data
   ...
   use [`--initial`](mysql-cluster-programs-ndbd.html#option_ndbd_initial) when restarting
...
6. Execute one or more [`CREATE
   NODEGROUP`](mysql-cluster-mgm-client-commands.html#ndbclient-create-nodegroup) commands in the NDB Cluster management
...
7. Redistribute the cluster's data among all data nodes,
   ...
   [`ALTER TABLE ...
   ALGORITHM=INPLACE, REORGANIZE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statement
   in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client for each
   [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table.
...
8. `ALTER TABLE ... REORGANIZE PARTITION
   ...
   [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table, an
   [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") statement in
...
[`CREATE NODEGROUP`](mysql-cluster-mgm-client-commands.html#ndbclient-create-nodegroup) commands in

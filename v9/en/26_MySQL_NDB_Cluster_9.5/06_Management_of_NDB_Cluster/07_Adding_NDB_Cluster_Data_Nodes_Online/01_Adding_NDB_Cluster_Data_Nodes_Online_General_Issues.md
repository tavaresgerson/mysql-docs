...
reorganize [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table data
and indexes so that they are distributed across all data
nodes, including the new ones, by means of the
[`ALTER
TABLE ... REORGANIZE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement. Table
...
The redistribution for [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
tables already existing before the new data nodes were added is
not automatic, but can be accomplished using simple SQL
statements in [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") or another MySQL client
...
[`ALTER TABLE ...
REORGANIZE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statement is executing. In
...
The [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") client supports a
...
2. After dropping all [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
   ...
   [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") does not work

...
`START BACKUP` supports the creation of
encrypted backups using `ENCRYPT
...
The `PASSWORD` option can be omitted from
...
* [**ndb\_print\_backup\_file**](mysql-cluster-programs-ndb-print-backup-file.html "25.5.17 ndb_print_backup_file — Print NDB Backup File Contents")
  [`-P`](mysql-cluster-programs-ndb-print-backup-file.html#option_ndb_print_backup_file_backup-password)
  *`password`*
  *`file_name`*
...
* [**ndb\_print\_backup\_file**](mysql-cluster-programs-ndb-print-backup-file.html "25.5.17 ndb_print_backup_file — Print NDB Backup File Contents")
  [`--backup-password=password`](mysql-cluster-programs-ndb-print-backup-file.html#option_ndb_print_backup_file_backup-password)
  *`file_name`*
...
1. Start the management client ([**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")), if
...
invoking [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") with the `-e`
or [`--execute`](mysql-cluster-programs-ndb-mgm.html#option_ndb_mgm_execute) option, as shown in
this example:
...
[`DataDir`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datadir) on each data

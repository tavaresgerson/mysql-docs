...
for each [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") performing binary logging
...
* `PARTIALLY_BUFFERING`: The buffer free
  ...
  which can be set in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client
  using the

...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") cluster log messages. For
information about the cluster log, log events, and event types,
see [Section 25.6.3, “Event Reports Generated in NDB Cluster”](mysql-cluster-event-reports.html "25.6.3 Event Reports Generated in NDB Cluster"). These log
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>mgm_node_id</code></em>: Node
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>data_node_id</code></em>: Communication to
...
<td>The API node having node ID <em class="replaceable"><code>api_node_id</code></em> has
              ...
              <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a> API version
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Global checkpoint
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Local checkpoint
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Table ID =
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: ACC Blocked
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Start initiated
              <em class="replaceable"><code>version</code></em></code></th>
<td>Data node <em class="replaceable"><code>node_id</code></em>, running
              <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a> version
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Started
              <em class="replaceable"><code>version</code></em></code></th>
<td>Data node <em class="replaceable"><code>node_id</code></em>, running
              <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a> version
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: STTORRY received after
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Start phase
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: CM_REGCONF president =
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: CM_REGREF from Node
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: We are Node
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>:
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Node shutdown
...
<td>The node has been shut down. This report may include an
              ...
              <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a> Protocol
              <em class="replaceable"><code>signal</code></em>; for possible signals,
              refer to
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-ndb-protocol-operations-signals.html" target="_top">Operations and Signals</a>.</td>
<td><code class="literal">NDBStopCompleted</code></td>
<td><code class="literal">StartUp</code></td>
<td>1</td>
<td><code class="literal">INFO</code></td>
</tr><tr>
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Forced node shutdown
              completed </code>[<code class="literal">,
...
<td>The node has been forcibly shut down. The
              ...
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-ndb-protocol-operations-signals.html" target="_top">Operations and Signals</a>,
              for more information). If the error causing the failure is
              known, this is also included; for more information about
              <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a> error messages and
              classifications, see <a class="ulink" href="/doc/ndb-internals/en/ndb-errors.html" target="_top">NDB Cluster API Errors</a>.</td>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: StartLog: [GCI Keep:
...
<th scope="row"><em class="replaceable"><code>startup_message</code></em> [<span class="emphasis"><em>Listed separately;
...
<td>There are a number of possible startup messages that can be logged under
              ...
              <a class="xref" href="mysql-cluster-log-startup-messages.html" title="25.6.2.2 NDB Cluster Log Startup Messages">Section 25.6.2.2, “NDB Cluster Log Startup Messages”</a>.</td>
<td><code class="literal">StartReport</code></td>
<td><code class="literal">StartUp</code></td>
<td>4</td>
<td><code class="literal">INFO</code></td>
</tr><tr>
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Node restart completed
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Node restart starting
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Node
...
<th scope="row"><code class="literal">All nodes completed failure of Node
              <em class="replaceable"><code>node_id</code></em></code></th>
...
<th scope="row"><code class="literal">Node failure of
...
<td>The failure of data node <em class="replaceable"><code>node_id</code></em> has been
              detected in the
              <em class="replaceable"><code>block</code></em><a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a>
              kernel block, where block is 1 of
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbtc.html" target="_top"><code class="literal">DBTC</code></a>,
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbdict.html" target="_top"><code class="literal">DBDICT</code></a>,
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbdih.html" target="_top"><code class="literal">DBDIH</code></a>, or
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-kernel-blocks-dblqh.html" target="_top"><code class="literal">DBLQH</code></a>; for more
              information, see
              <a class="ulink" href="/doc/ndb-internals/en/ndb-internals-kernel-blocks.html" target="_top">NDB Kernel Blocks</a></td>
<td><code class="literal">NodeFailCompleted</code></td>
<td><code class="literal">NodeRestart</code></td>
<td>8</td>
<td><code class="literal">ALERT</code></td>
...
<th scope="row"><code class="literal">President restarts arbitration thread
...
<th scope="row"><code class="literal">Arbitration check lost - less than 1/2 nodes left</code> or
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: GCP Take over
              started</code></th>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: LCP Take over
              started</code></th>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Trans. Count =
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Table with ID =
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Mean loop Counter in
...
<th scope="row"><code class="literal">Mean send size to Node = <em class="replaceable"><code>node_id</code></em>
...
<th scope="row"><code class="literal">Mean receive size to Node = <em class="replaceable"><code>node_id</code></em>
              last 4096 sends = <em class="replaceable"><code>bytes</code></em>
              bytes</code></th>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Data usage is
...
<td>This report is generated when a <a class="ulink" href="/doc/ndb-internals/en/dump-command-1000.html" target="_top"><code class="literal">DUMP
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node1_id</code></em>: Transporter to node
...
<td>A transporter error occurred while communicating with node
              ...
              <a class="ulink" href="/doc/ndb-internals/en/ndb-transporter-errors.html" target="_top">NDB Transporter Errors</a>, in
              <a class="ulink" href="/doc/ndb-internals/en/" target="_top">MySQL NDB Cluster Internals Manual</a></td>
...
<td>A warning of a potential transporter problem while communicating with
              ...
              transporter error codes and messages, see
              <a class="ulink" href="/doc/ndb-internals/en/ndb-transporter-errors.html" target="_top">NDB Transporter Errors</a>, for more
              information</td>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node1_id</code></em>: Node
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node1_id</code></em>: Node Sent Heartbeat
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Event buffer status
...
<td>This report is seen during heavy event buffer usage, for example, when
              ...
              <a class="xref" href="mysql-cluster-logs-event-buffer.html" title="25.6.2.3 Event Buffer Reporting in the Cluster Log">Section 25.6.2.3, “Event Buffer Reporting in the Cluster Log”</a></td>
<td><code class="literal">EventBufferStatus2</code></td>
<td><code class="literal">Info</code></td>
<td>7</td>
<td><code class="literal">INFO</code></td>
</tr><tr>
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Entering single user
...
<td>These reports are written to the cluster log when entering and exiting
              ...
              <a class="xref" href="mysql-cluster-single-user-mode.html" title="25.6.6 NDB Cluster Single User Mode">Section 25.6.6, “NDB Cluster Single User Mode”</a>); the
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Backup
...
<td>A backup has been started using the management node having
              ...
              <a class="link" href="mysql-cluster-backup-using-management-client.html" title="25.6.8.2 Using The NDB Cluster Management Client to Create a Backup"><code class="literal">START BACKUP</code></a> command
              is issued; for more information, see
              <a class="xref" href="mysql-cluster-backup-using-management-client.html" title="25.6.8.2 Using The NDB Cluster Management Client to Create a Backup">Section 25.6.8.2, “Using The NDB Cluster Management Client to Create a Backup”</a></td>
...
<th scope="row"><code class="literal">Node <em class="replaceable"><code>node_id</code></em>: Backup request from
...
<td>The backup failed to start; for error codes, see
              <a class="ulink" href="/doc/ndbapi/en/mgm-errors.html" target="_top">MGM API Errors</a></td>

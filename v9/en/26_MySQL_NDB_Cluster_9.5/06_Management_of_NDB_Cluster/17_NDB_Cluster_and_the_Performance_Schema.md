...
Performance Schema [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table,
...
[`setup_threads`](performance-schema-setup-threads-table.html "29.12.2.5 The setup_threads Table") table.
...
by the [`performance_schema`](performance-schema.html "Chapter 29 MySQL Performance Schema") engine,
...
[`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table, as shown
here:

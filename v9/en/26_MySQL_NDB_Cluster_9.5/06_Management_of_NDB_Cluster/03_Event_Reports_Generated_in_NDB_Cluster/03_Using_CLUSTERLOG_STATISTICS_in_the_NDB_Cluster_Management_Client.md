...
The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") management client's
...
the following command in the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
management client:

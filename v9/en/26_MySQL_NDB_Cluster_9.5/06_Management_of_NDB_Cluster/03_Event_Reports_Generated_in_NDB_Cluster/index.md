...
* The cluster log, which
  ...
  [`DataDir`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-datadir).
  ...
  [`DataDir`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-datadir) and
...
* Node logs are local to
  ...
  [`DataDir`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datadir). Node event
...
management client [`CLUSTERLOG`](mysql-cluster-logging-management-commands.html "25.6.3.1 NDB Cluster Logging Management Commands")
...
can be turned on and off using the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client")
[`NODELOG DEBUG`](mysql-cluster-mgm-client-commands.html#ndbclient-nodelog-debug) command.

...
Use [`SHOW ENGINE PERFORMANCE_SCHEMA STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") to inspect the internal operation of the Performance Schema code:
...
This statement is intended to help the DBA understand the effects that different Performance Schema options have on memory requirements. For a description of the field meanings, see Section 15.7.7.17, “SHOW ENGINE Statement”.
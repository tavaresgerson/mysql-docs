...
[`SHOW STATUS LIKE
'perf%'`](show-status.html "15.7.7.38 SHOW STATUS Statement") says that nothing was lost (all values are
...
Use [`SHOW ENGINE
PERFORMANCE_SCHEMA STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") to inspect the internal

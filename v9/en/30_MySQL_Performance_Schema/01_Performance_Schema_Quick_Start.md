...
[`SHOW ENGINES`](show-engines.html "15.7.7.18 SHOW ENGINES Statement") statement:
...
COLUMNS`](show-columns.html "15.7.7.6 SHOW COLUMNS Statement").
...
[`performance_timers`](performance-schema-performance-timers-table.html "29.12.22.8 The performance_timers Table") lists the

...
* [`Performance_schema_accounts_lost`](performance-schema-status-variables.html#statvar_Performance_schema_accounts_lost)
  ...
  [`accounts`](performance-schema-accounts-table.html "29.12.8.1 The accounts Table") table because it was
  full.
...
* [`Performance_schema_hosts_lost`](performance-schema-status-variables.html#statvar_Performance_schema_hosts_lost)
  ...
  The number of times a row could not be added to the
  [`hosts`](performance-schema-hosts-table.html "29.12.8.2 The hosts Table") table because it was full.
...
* [`Performance_schema_metadata_lock_lost`](performance-schema-status-variables.html#statvar_Performance_schema_metadata_lock_lost)
  ...
  the [`metadata_locks`](performance-schema-metadata-locks-table.html "29.12.13.3 The metadata_locks Table") table. This
...
* [`Performance_schema_meter_lost`](performance-schema-status-variables.html#statvar_Performance_schema_meter_lost)

  Number of meter instruments that failed to be created.

* [`Performance_schema_metric_lost`](performance-schema-status-variables.html#statvar_Performance_schema_metric_lost)
...
* [`Performance_schema_thread_instances_lost`](performance-schema-status-variables.html#statvar_Performance_schema_thread_instances_lost)
  ...
  in the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table. This can be
...
* [`Performance_schema_users_lost`](performance-schema-status-variables.html#statvar_Performance_schema_users_lost)
  ...
  The number of times a row could not be added to the
  [`users`](performance-schema-users-table.html "29.12.8.3 The users Table") table because it was full.

* [`Performance_schema_logger_lost`](performance-schema-status-variables.html#statvar_Performance_schema_logger_lost)

  Displays the number of logger instruments which failed to be
  created.
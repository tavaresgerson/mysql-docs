...
events, so [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") can be
...
TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"). Generally, the effect is to reset the summary

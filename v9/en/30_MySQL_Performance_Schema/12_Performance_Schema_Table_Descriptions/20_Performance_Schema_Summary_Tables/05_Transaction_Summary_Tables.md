...
* [`events_transactions_summary_by_thread_by_event_name`](performance-schema-transaction-summary-tables.html "29.12.20.5 Transaction Summary Tables")
  has `THREAD_ID` and
  `EVENT_NAME` columns. Each row summarizes
...
* `COUNT_STAR`,
  ...
  rather than
  [`events_waits_current`](performance-schema-events-waits-current-table.html "29.12.4.1 The events_waits_current Table"). These

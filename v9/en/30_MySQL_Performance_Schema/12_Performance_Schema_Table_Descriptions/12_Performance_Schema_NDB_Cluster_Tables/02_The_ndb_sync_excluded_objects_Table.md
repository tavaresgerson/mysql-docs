...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") database objects which cannot
be automatically synchronized between NDB Cluster's
dictionary and the MySQL data dictionary.

Example information about [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
The [`ndb_sync_excluded_objects`](performance-schema-ndb-sync-excluded-objects-table.html "29.12.12.2 The ndb_sync_excluded_objects Table")
...
* `REASON`: The reason for exclusion
  ...
  change in future [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  releases.
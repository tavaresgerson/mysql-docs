...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") database objects for which
mismatches have been detected and which are waiting to be
synchronized between the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")

...
[Section 7.1.10, “Server Status Variables”](server-status-variables.html "7.1.10 Server Status Variables")). Status variable
information is available in these Performance Schema tables:

* [`global_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Global status
  variables. An application that wants only global values
  should use this table.

* [`session_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Status
...
* [`status_by_thread`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Session
...
([`session_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"),
[`status_by_thread`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables")) contain
...
in the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table. Statistics
...
The [`global_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables") and
[`session_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables") tables have these
columns:
...
* `VARIABLE_VALUE`
  ...
  [`global_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"), this column
  contains the global value. For
  [`session_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"), this column
...
The [`status_by_thread`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables") table contains
...
The [`status_by_thread`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables") table has
these indexes:
...
TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") for status variable tables as follows:

* [`global_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Resets thread,
  account, host, and user status. Resets global status
  variables except those that the server never resets.

* [`session_status`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Not supported.
* [`status_by_thread`](performance-schema-status-variable-tables.html "29.12.15 Performance Schema Status Variable Tables"): Aggregates
...
[`FLUSH STATUS`](flush.html#flush-status) adds the session

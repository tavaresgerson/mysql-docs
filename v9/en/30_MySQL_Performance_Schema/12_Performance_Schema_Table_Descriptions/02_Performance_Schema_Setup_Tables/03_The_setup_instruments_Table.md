...
the [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table, even
...
`xxx_instances`
tables, such as [`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table") or
...
[`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table in event
filtering, see
[Section 29.4.3, “Event Pre-Filtering”](performance-schema-pre-filtering.html "29.4.3 Event Pre-Filtering").

The [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table has
these columns:
...
* `PROPERTIES`
  ...
  [`SET`](set.html "13.3.7 The SET Type") data type, so multiple
...
* `VOLATILITY`
  ...
  [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") is never
  used. To enable or disable this mutex, use the
  [`mutex_instances`](performance-schema-mutex-instances-table.html "29.12.3.3 The mutex_instances Table") table
  instead.
...
for the [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table.
...
**ps** command, to display distinct
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") thread names rather than
“mysqld”. This feature is supported only on
Linux, macOS, and Windows.

Suppose that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is running on a system

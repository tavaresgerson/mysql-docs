...
server. The [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table is
...
The [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table can be
...
[`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table also serves
...
The [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table contains a
...
The [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table has these
columns:
...
* `ID`
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") statement,
  displayed in the `PROCESSLIST_ID` column
  of the Performance Schema
  [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table, and returned
...
* `USER`
  ...
  categories (see [Section 8.2.11, “Account Categories”](account-categories.html "8.2.11 Account Categories")).
...
* `STATE`
  ...
  values, see [Section 10.14, “Examining Server Thread (Process) Information”](thread-information.html "10.14 Examining Server Thread (Process) Information").
...
for the [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table.

As mentioned previously, if the
[`performance_schema_show_processlist`](performance-schema-system-variables.html#sysvar_performance_schema_show_processlist)
system variable is enabled, the
[`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table serves as the
...
* The [**mysqladmin processlist**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command
  (which uses [`SHOW
  PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") statement).

The default [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement")
...
alternative [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement")
...
[`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table contents as
follows:
...
* Minimum required configuration:
  ...
  satisfied, the [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table")
  table (and thus [`SHOW
...
* Recommended configuration:
  ...
  [`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") table (and thus
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement")) produce
...
[`processlist`](performance-schema-processlist-table.html "29.12.22.9 The processlist Table") contents are
unaffected by the
[`performance_schema_show_processlist`](performance-schema-system-variables.html#sysvar_performance_schema_show_processlist)
setting.

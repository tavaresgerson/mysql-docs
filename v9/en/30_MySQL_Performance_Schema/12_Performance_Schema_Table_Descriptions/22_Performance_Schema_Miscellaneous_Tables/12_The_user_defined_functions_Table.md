...
The [`user_defined_functions`](performance-schema-user-defined-functions-table.html "29.12.22.12 The user_defined_functions Table") table
...
* `UDF_NAME`
  ...
  FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") statement and is in the process of
  unloading.
...
* `UDF_LIBRARY`
  ...
  than by a [`CREATE FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement")
  statement.
...
for the [`user_defined_functions`](performance-schema-user-defined-functions-table.html "29.12.22.12 The user_defined_functions Table")
table.

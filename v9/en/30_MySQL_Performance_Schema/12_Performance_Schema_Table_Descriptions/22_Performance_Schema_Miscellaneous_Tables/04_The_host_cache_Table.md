...
size of the [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table. For
operational and configuration information about the host
cache, see [Section 7.1.12.3, “DNS Lookups and the Host Cache”](host-cache.html "7.1.12.3 DNS Lookups and the Host Cache").

Because the [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table
exposes the contents of the host cache, it can be examined
using [`SELECT`](select.html "15.2.13 SELECT Statement") statements. This
may help you diagnose the causes of connection problems.

The [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table has these
columns:
...
* `SUM_CONNECT_ERRORS`
  ...
  [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors), new
  connections from that host are blocked. The
  `SUM_CONNECT_ERRORS` value can exceed the
  [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors) value
  ...
  Suppose that
  [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors) is 200
...
* `COUNT_HOST_BLOCKED_ERRORS`
  ...
  of the [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors)
  system variable.
...
* `COUNT_HOST_ACL_ERRORS`
  ...
  the server returns
  [`ER_HOST_NOT_PRIVILEGED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_host_not_privileged) and
...
* `COUNT_PROXY_USER_ACL_ERRORS`
  ...
  have the [`PROXY`](privileges-provided.html#priv_proxy) privilege.
...
* `COUNT_MAX_USER_CONNECTIONS_ERRORS`
  ...
  connection quotas. See [Section 8.2.21, “Setting Account Resource Limits”](user-resources.html "8.2.21 Setting Account Resource Limits").
...
* `COUNT_UNKNOWN_ERRORS`
  ...
  of the [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table is
  required.
...
the [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table. It requires
the [`DROP`](privileges-provided.html#priv_drop) privilege for the

...
The [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table contains a row
...
[`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table based on the
...
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table. For
information about how to use the
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table to control
these columns, see
[Section 29.4.6, “Pre-Filtering by Thread”](performance-schema-thread-filtering.html "29.4.6 Pre-Filtering by Thread").

Removal of rows from the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table")
...
row in the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table that has
...
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table may have
...
`INSTRUMENTED` and `HISTORY`
columns of [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table rows.
...
For a comparison of the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table")
table columns with names having a prefix of
`PROCESSLIST_` to other process information
sources, see [Sources of Process Information](processlist-access.html#processlist-sources "Sources of Process Information").

Important

For thread information sources other than the
[`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table, information
about threads for other users is shown only if the current
user has the [`PROCESS`](privileges-provided.html#priv_process)
privilege. That is not true of the
[`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table; all rows are
...
users by accessing the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table")
table should not be given the
[`SELECT`](privileges-provided.html#priv_select) privilege for it.

The [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table has these
columns:
...
* `PROCESSLIST_ID`
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.28 The INFORMATION_SCHEMA PROCESSLIST Table") table, displayed
  in the `Id` column of
...
* `PROCESSLIST_HOST`
  ...
  `INFORMATION_SCHEMA`
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.28 The INFORMATION_SCHEMA PROCESSLIST Table") table or the
  `Host` column of
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") output,
  ...
  and examine the
  [`socket_instances`](performance-schema-socket-instances-table.html "29.12.3.5 The socket_instances Table") table:
...
* `PROCESSLIST_COMMAND`
  ...
  [Section 10.14, “Examining Server Thread (Process) Information”](thread-information.html "10.14 Examining Server Thread (Process) Information"). The value of this
...
* `PROCESSLIST_TIME`
  ...
  See [Section 19.2.3, “Replication Threads”](replication-threads.html "19.2.3 Replication Threads").
...
* `PROCESSLIST_STATE`
  ...
  [Section 10.14, “Examining Server Thread (Process) Information”](thread-information.html "10.14 Examining Server Thread (Process) Information"). If the value if
...
* `PROCESSLIST_INFO`
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") statement, the
...
* `INSTRUMENTED`
  ...
  + For foreground threads, the initial
    ...
    again for the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table")
    table row created for the subthread.

  + For background threads,
    `INSTRUMENTED` is
    `YES` by default.
    [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") is not
  ...
  + The `thread_instrumentation` consumer
    in the [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table")
    table must be `YES`.
  ...
  + Monitoring occurs only for those thread events
    ...
    `YES` in the
    [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table.
...
* `HISTORY`
  ...
  + The appropriate history-related consumers in the
    [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table") table
    must be enabled. For example, wait event logging in
    the [`events_waits_history`](performance-schema-events-waits-history-table.html "29.12.4.2 The events_waits_history Table")
    and
    [`events_waits_history_long`](performance-schema-events-waits-history-long-table.html "29.12.4.3 The events_waits_history_long Table")
...
* `THREAD_OS_ID`
  ...
  + When a MySQL thread is not associated with the same
    ...
    [Section 7.6.3, “MySQL Enterprise Thread Pool”](thread-pool.html "7.6.3 MySQL Enterprise Thread Pool")).
...
* `RESOURCE_GROUP`
  ...
  (see [Resource Group Restrictions](resource-groups.html#resource-group-restrictions "Resource Group Restrictions")).
...
for the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table.
...
The [`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.22.11 The tls_channel_status Table") table
...
The [`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.22.11 The tls_channel_status Table") table has
these columns:
...
* `CHANNEL`
  ...
  interfaces, see [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces").
...
for the [`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.22.11 The tls_channel_status Table") table.
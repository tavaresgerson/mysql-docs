...
[Section 7.4.2, “The Error Log”](error-log.html "7.4.2 The Error Log")). Typically, the server writes
...
Schema [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table. Granting
the [`SELECT`](privileges-provided.html#priv_select) privilege for the
[`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table thus gives
...
The [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table supports
...
Example [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") contents:
...
The [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table has the
...
* `LOGGED`
  ...
  + `time` values in the error log are
    ...
    [`log_timestamps`](server-system-variables.html#sysvar_log_timestamps) system
    variable setting; see
    [Early-Startup Logging Output Format](error-log-format.html#error-log-format-output-format-for-early-logging "Early-Startup Logging Output Format").

  + The `LOGGED` column stores values
    using the [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types")
    data type, for which values are stored in UTC but
    displayed when retrieved in the current session time
    zone; see [Section 13.2.2, “The DATE, DATETIME, and TIMESTAMP Types”](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types").
  ...
  If the [`log_timestamps`](server-system-variables.html#sysvar_log_timestamps)
  value is `UTC` and your system does not
  have named time zone support installed (see
  [Section 7.1.15, “MySQL Server Time Zone Support”](time-zone-support.html "7.1.15 MySQL Server Time Zone Support")), set the time zone
  like this:
...
* `THREAD_ID`
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table is most
  similar to the `PROCESSLIST_ID` column of
  the [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table:
  ...
  + For foreground threads, `THREAD_ID`
    ...
    `INFORMATION_SCHEMA`
    [`PROCESSLIST`](information-schema-processlist-table.html "28.3.28 The INFORMATION_SCHEMA PROCESSLIST Table") table,
    displayed in the `Id` column of
    [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement")
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") has a column named
...
* `DATA`
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") row. For example,
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table, and because
  different sinks produce different output formats, it is
  possible for rows written to the
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table at different
  times to have different `DATA` formats.

The [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table has these
indexes:
...
for the [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table.

##### Implementation and Configuration of the error\_log Table

The Performance Schema
[`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table is populated by
...
* A log sink can write new error events to the
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table as they
  occur.
...
* A log sink can provide a parser for extraction of
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table. Messages
...
events to the [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table
...
[`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table as follows:
...
* At startup, the server examines the
  ...
  + A sink that supports the
    [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table and
    provides a parser.

  + If none, a sink that supports the
    [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table but
    provides no parser.

  If no log sink satisfies those conditions, the
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table remains
...
* At runtime, if the value of
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table, regardless
  of whether it provides a parser.

  If no such log sink exists, no additional error events
  are written to the
  [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table. Otherwise,
  the newly configured sink writes new error events to the
  table as they occur.

Any configuration that affects output written to the error
log affects [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table
...
The [`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") table is a view
...
[`error_log`](performance-schema-error-log-table.html "29.12.22.3 The error_log Table") operation.

<table summary="error_log table status variables."><col style="width: 35%"/><col style="width: 35%"/><thead><tr>

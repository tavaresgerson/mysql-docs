...
* `WRITE_CONSENSUS_SINGLE_LEADER_CAPABLE`
  ...
  = ON`](group-replication-system-variables.html#sysvar_group_replication_paxos_single_leader)), and this is still shown if the value of
  [`group_replication_paxos_single_leader`](group-replication-system-variables.html#sysvar_group_replication_paxos_single_leader)
  has since been changed on this group member. 0 means that
  the group was started with single leader mode disabled
  ([`group_replication_paxos_single_leader
  = OFF`](group-replication-system-variables.html#sysvar_group_replication_paxos_single_leader)), or has a Group Replication communication

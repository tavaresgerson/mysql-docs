...
Schema [`PROCESSLIST`](information-schema-processlist-table.html "28.3.28 The INFORMATION_SCHEMA PROCESSLIST Table") table. Stages
...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement, select from the

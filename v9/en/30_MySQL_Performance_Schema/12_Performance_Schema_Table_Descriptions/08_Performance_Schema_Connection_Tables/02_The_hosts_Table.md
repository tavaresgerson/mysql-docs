...
The [`hosts`](performance-schema-hosts-table.html "29.12.8.2 The hosts Table") table contains a row
...
The [`hosts`](performance-schema-hosts-table.html "29.12.8.2 The hosts Table") table has the following
...
The [`hosts`](performance-schema-hosts-table.html "29.12.8.2 The hosts Table") table has these
indexes:

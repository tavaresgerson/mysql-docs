...
* Instrumented code is the source for events and produces
  ...
  [`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table lists
...
[Section 29.5, “Performance Schema Queries”](performance-schema-queries.html "29.5 Performance Schema Queries").
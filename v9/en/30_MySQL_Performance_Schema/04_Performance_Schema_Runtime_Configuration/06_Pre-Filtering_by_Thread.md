...
* The `thread_instrumentation` consumer in
  the [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table") table must
  be `YES`.
...
The [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table also indicates
...
* The appropriate history-related consumers in the
  [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table") table must be
...
`HISTORY` columns in
[`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table rows are determined
by whether the user account associated with a thread matches any
row in the [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table. The
values come from the `ENABLED` and
`HISTORY` columns of the matching
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table row.

For background threads, there is no associated user.
`INSTRUMENTED` and `HISTORY`
are `YES` by default and
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") is not consulted.

The initial [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") contents
look like this:
...
matching [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") rows can have
...
The `ENABLED` and `HISTORY`
columns in [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") rows can be
set to `YES` or `NO`
...
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") table initially
...
[`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table") as follows:
...
The [`UPDATE`](update.html "15.2.17 UPDATE Statement") statement changes the
default match to disable instrumentation and historical event
collection. The [`INSERT`](insert.html "15.2.7 INSERT Statement") statements
...
Modifications to the [`setup_actors`](performance-schema-setup-actors-table.html "29.12.2.1 The setup_actors Table")
...
`HISTORY` columns of
[`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table rows.
...
The [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table") table lists the
...
Modify the [`setup_consumers`](performance-schema-setup-consumers-table.html "29.12.2.2 The setup_consumers Table") table to
...
[Section 29.4.8, “Example Consumer Configurations”](performance-schema-consumer-configurations.html "29.4.8 Example Consumer Configurations").
...
* `events_waits_current`, if
  ...
  wait events in the
  [`events_waits_current`](performance-schema-events-waits-current-table.html "29.12.4.1 The events_waits_current Table") table.
...
[`events_statements_current`](performance-schema-events-statements-current-table.html "29.12.6.1 The events_statements_current Table"), which
is advantageous in terms of overhead. Conversely, you can get
detailed statements in
[`events_statements_current`](performance-schema-events-statements-current-table.html "29.12.6.1 The events_statements_current Table") without

...
* `ALTER INSTANCE ROTATE INNODB MASTER KEY`
  ...
  configured. For instructions, see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").

  `ALTER INSTANCE ROTATE INNODB MASTER KEY`
  supports concurrent DML. However, it cannot be run
  concurrently with
  [`CREATE TABLE ...
  ENCRYPTION`](create-table.html "15.1.24 CREATE TABLE Statement") or
  [`ALTER TABLE ...
  ENCRYPTION`](alter-table.html "15.1.11 ALTER TABLE Statement") operations, and locks are taken to
...
* `ALTER INSTANCE ROTATE BINLOG MASTER KEY`
  ...
  statement using a [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement")

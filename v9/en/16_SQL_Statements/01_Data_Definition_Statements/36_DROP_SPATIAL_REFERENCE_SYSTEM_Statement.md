...
This statement removes a spatial reference system (SRS) definition from the data dictionary. It requires the `CREATE_SPATIAL_REFERENCE_SYSTEM` privilege (or `SUPER`).

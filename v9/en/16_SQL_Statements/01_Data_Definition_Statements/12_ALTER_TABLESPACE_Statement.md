...
[`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") drops the data
...
tablespace with [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement")
or [`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement"). `DROP
...
9.5, it is supported in the following two cases only:
...
If an [`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") statement

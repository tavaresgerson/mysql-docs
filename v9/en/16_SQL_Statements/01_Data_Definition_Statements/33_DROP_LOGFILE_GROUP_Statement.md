...
log file groups, see [Section 15.1.20, “CREATE LOGFILE GROUP Statement”](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement").)
...
are [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") and
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5").

[`DROP LOGFILE GROUP`](drop-logfile-group.html "15.1.33 DROP LOGFILE GROUP Statement") is useful only

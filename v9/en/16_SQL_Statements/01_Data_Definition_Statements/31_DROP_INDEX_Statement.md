...
[`DROP INDEX`](drop-index.html "15.1.31 DROP INDEX Statement") drops the index named
*`index_name`* from the table
*`tbl_name`*. This statement is mapped to
an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement to drop
the index. See [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement").
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables are dropped online; that

...
[`SHOW CHARACTER SET`](show-character-set.html "15.7.7.4 SHOW CHARACTER SET Statement") and
[`SHOW COLLATION`](show-collation.html "15.7.7.5 SHOW COLLATION Statement") statements,
respectively. See [Section 15.7.7.4, “SHOW CHARACTER SET Statement”](show-character-set.html "15.7.7.4 SHOW CHARACTER SET Statement"), and
...
specified explicitly. See [Section 15.1.21, “CREATE PROCEDURE and CREATE FUNCTION Statements”](create-procedure.html "15.1.21 CREATE PROCEDURE and CREATE FUNCTION Statements").) If
...
[`SCHEMATA_EXTENSIONS`](information-schema-schemata-extensions-table.html "28.3.38 The INFORMATION_SCHEMA SCHEMATA_EXTENSIONS Table") table. See
[Section 28.3.38, “The INFORMATION\_SCHEMA SCHEMATA\_EXTENSIONS Table”](information-schema-schemata-extensions-table.html "28.3.38 The INFORMATION_SCHEMA SCHEMATA_EXTENSIONS Table").
...
[`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement"). However, for a
read-only database, the statement produced by
[`SHOW CREATE DATABASE`](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement") does include
...
DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") statement containing such a comment, the server
ignores the comment and the `READ ONLY` option is
not processed. This has implications for
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"), which uses [`SHOW
CREATE DATABASE`](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement") to produce [`CREATE
DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") statements in dump output:

* In a dump file, the [`CREATE
  DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") statement for a read-only database contains

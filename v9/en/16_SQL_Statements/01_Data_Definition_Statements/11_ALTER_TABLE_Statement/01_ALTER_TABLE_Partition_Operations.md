...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") can be used with partitioned tables for
...
* Simply using a *`partition_options`*
  clause with [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") on a
  ...
  *`partition_options`* clause for
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") (for more
  detailed information, see [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement")),
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement. (See
  [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"), for the syntax and
  ...
  *`partition_names`* list is
  ...
  tables that use the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  storage engine. See
  [Section 26.3.1, “Management of RANGE and LIST Partitions”](partitioning-management-range-list.html "26.3.1 Management of RANGE and LIST Partitions"), and
  ...
  The [`DISCARD
  PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") and
  [`IMPORT
  PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") options extend the
  [Transportable
  ...
  PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") and
  [`IMPORT
  PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") on subpartitioned tables,
  ...
  information, see [Section 17.6.1.3, “Importing InnoDB Tables”](innodb-table-import.html "17.6.1.3 Importing InnoDB Tables").
  ...
  following [`DELETE`](delete.html "15.2.2 DELETE Statement") statement:
  ...
  done with [`DELETE`](delete.html "15.2.2 DELETE Statement") statements.
  ...
  An equivalent [`DELETE`](delete.html "15.2.2 DELETE Statement")
...
* Several options provide partition maintenance and repair
  ...
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") (which are also
  supported for partitioned tables; for more information, see
  [Section 15.7.3, “Table Maintenance Statements”](table-maintenance-statements.html "15.7.3 Table Maintenance Statements")). These
...
* `REMOVE PARTITIONING` enables you to remove
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") options such as
  those used to add, drop, or rename columns or indexes.

* Using the `ENGINE` option with
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") changes the
...
be used in a given [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")

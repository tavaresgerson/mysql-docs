...
[`INTEGER`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") to `TINYINT NOT
...
To add a new [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column
named `d`:
...
For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, it is also possible
to change the storage type used for a table or column. For
example, consider an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table
...
following [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement:
...
referenced by the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"):
...
columns, using this [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
statement:
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement). However,
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") or by using the

...
* For non-partitioned tables, `ADD COLUMN`
  ...
  other [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations.
...
* When a `VIRTUAL` generated column is added
  ...
  [`ER_WRONG_USAGE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_wrong_usage) error occurs.
...
* An [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement that
  ...
  *`col_name`* may also change the
  ...
  For this reason, [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
  operations that change the definition of a column cause a
  table rebuild if any generated column expression uses
  [`DEFAULT()`](miscellaneous-functions.html#function_default).
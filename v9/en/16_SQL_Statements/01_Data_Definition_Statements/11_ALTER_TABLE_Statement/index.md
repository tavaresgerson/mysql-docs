...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") changes the structure
...
* To use [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), you need
  [`ALTER`](privileges-provided.html#priv_alter),
  [`CREATE`](privileges-provided.html#priv_create), and
  [`INSERT`](privileges-provided.html#priv_insert) privileges for the
  table. Renaming a table requires
  [`ALTER`](privileges-provided.html#priv_alter) and
...
* Following the table name, specify the alterations to be made.
  If none are given, [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
  does nothing.

* The syntax for many of the permissible alterations is similar
  to clauses of the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  statement. *`column_definition`*
  clauses use the same syntax for `ADD` and
  `CHANGE` as for [`CREATE
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"). For more information, see
...
* Multiple `ADD`, `ALTER`,
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement, separated by commas. This is a
  MySQL extension to standard SQL, which permits only one of
  each clause per [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
* If a storage engine does not support an attempted
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation, a
  ...
  [Section 15.7.7.43, “SHOW WARNINGS Statement”](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement"). For information on
  troubleshooting [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"),
  see [Section B.3.6.1, “Problems with ALTER TABLE”](alter-table-problems.html "B.3.6.1 Problems with ALTER TABLE").
...
* [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") supports addition of
...
* [Importing InnoDB Tables](alter-table.html#alter-table-import "Importing InnoDB Tables")
...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement, such as `ENGINE`,
`AUTO_INCREMENT`,
`AVG_ROW_LENGTH`, `MAX_ROWS`,
`ROW_FORMAT`, or `TABLESPACE`.

For descriptions of all table options, see
[Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"). However,
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") ignores `DATA
DIRECTORY` and `INDEX DIRECTORY` when
given as table options. [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
permits them only as partitioning options, and requires that you
have the `FILE` privilege.

Use of table options with [`ALTER
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") provides a convenient way of altering single table
...
* If `t1` is currently not an
  ...
  + See [Section 17.6.1.5, “Converting Tables from MyISAM to InnoDB”](converting-tables-to-innodb.html "17.6.1.5 Converting Tables from MyISAM to InnoDB") for
    considerations when switching tables to the
    `InnoDB` storage engine.

  + When you specify an `ENGINE` clause,
    [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") rebuilds the
    table. This is true even if the table already has the
    specified storage engine.

  + Running [`ALTER
    TABLE tbl_name
    ENGINE=INNODB`](alter-table.html "15.1.11 ALTER TABLE Statement") on an existing
    `InnoDB` table performs a
    “null” [`ALTER
    TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation, which can be used to defragment
    an `InnoDB` table, as described in
    [Section 17.11.4, “Defragmenting a Table”](innodb-file-defragmenting.html "17.11.4 Defragmenting a Table"). Running
    [`ALTER TABLE
    tbl_name FORCE`](alter-table.html "15.1.11 ALTER TABLE Statement") on an
    `InnoDB` table performs the same
    function.

  + [`ALTER TABLE
    tbl_name
    ENGINE=INNODB`](alter-table.html "15.1.11 ALTER TABLE Statement") and
    [`ALTER TABLE
    tbl_name FORCE`](alter-table.html "15.1.11 ALTER TABLE Statement") use
    [online DDL](innodb-online-ddl.html "17.12 InnoDB and Online DDL"). For
    more information, see [Section 17.12, “InnoDB and Online DDL”](innodb-online-ddl.html "17.12 InnoDB and Online DDL").
  ...
  + The outcome of attempting to change the storage engine of
    ...
    SQL mode, as described in [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").

  + To prevent inadvertent loss of data,
    [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") cannot be used
...
* Use `ALTER TABLE` with the
  ...
  [general
  tablespaces](glossary.html#glos_general_tablespace "general tablespace"),
  [file-per-table](glossary.html#glos_file_per_table "file-per-table")
  tablespaces, and the
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace). See
  [Moving Tables Between Tablespaces Using ALTER TABLE](general-tablespaces.html#general-tablespaces-moving-non-partitioned-tables "Moving Tables Between Tablespaces Using ALTER TABLE").
  ...
  + The `DATA DIRECTORY` clause, which is
    supported with
    [`CREATE TABLE
    ... TABLESPACE`](create-table.html "15.1.24 CREATE TABLE Statement"), is not supported with
    `ALTER TABLE ... TABLESPACE`, and is
    ignored if specified.

  + For more information about the capabilities and
    limitations of the `TABLESPACE` option,
    see [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement").
...
* MySQL NDB Cluster 9.5 supports setting
  ...
  for [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"), as shown in
  this example:
  ...
  options for columns of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables
  ...
  [Setting NDB\_TABLE options](create-table.html#create-table-comment-ndb-table-options "Setting NDB_TABLE options"), for
...
* `ENGINE_ATTRIBUTE` and
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement.

To verify that the table options were changed as intended, use
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement"), or query the
Information Schema [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table.

#### Performance and Space Requirements

[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations are
...
For tables using the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
...
See [Section 25.6.12, “Online Operations with ALTER TABLE in NDB Cluster”](mysql-cluster-online-operations.html "25.6.12 Online Operations with ALTER TABLE in NDB Cluster"), for more
information.

The `ALGORITHM` clause is optional. If the
`ALGORITHM` clause is omitted, MySQL uses
`ALGORITHM=INSTANT` for storage engines and
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") clauses that support
...
to perform
[`ALTER
TABLE ... EXCHANGE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") on the table.
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations that use the
...
table. While the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation begins are stalled until the new table
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") blocks reads (not just
...
An [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation that uses
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation that would
otherwise not use it, specify `ALGORITHM=COPY` or
enable the [`old_alter_table`](server-system-variables.html#sysvar_old_alter_table) system
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation that uses the
`COPY` algorithm on a table that resides in a
[shared tablespace](glossary.html#glos_shared_tablespace "shared tablespace")
...
a [file-per-table](glossary.html#glos_file_per_table "file-per-table")
tablespace.
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations that support
the `INPLACE` algorithm include:

* `ALTER TABLE` operations supported by the
  `InnoDB`
  [online DDL](glossary.html#glos_online_ddl "online DDL") feature. See
...
* Renaming a table. MySQL renames files that correspond to the
  ...
  TABLE`](rename-table.html "15.1.41 RENAME TABLE Statement") statement to rename tables. See
  [Section 15.1.41, “RENAME TABLE Statement”](rename-table.html "15.1.41 RENAME TABLE Statement").) Privileges granted
...
* Operations that modify table metadata only. These operations
  ...
  + Changing the default value of a column (except for
    [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables).

  + Modifying the definition of an
    [`ENUM`](enum.html "13.3.6 The ENUM Type") or
    [`SET`](set.html "13.3.7 The SET Type") column by adding new
    ...
    a member to a [`SET`](set.html "13.3.7 The SET Type") column
  ...
  + Changing a column character set, when these conditions
    ...
    - The column data type is
      ...
      [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"), a
      [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") type, or
...
* Adding or dropping a secondary index, for
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. See
  [Section 17.12.1, “Online DDL Operations”](innodb-online-ddl-operations.html "17.12.1 Online DDL Operations").

* For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, operations that
  ...
  See [Section 25.6.12, “Online Operations with ALTER TABLE in NDB Cluster”](mysql-cluster-online-operations.html "25.6.12 Online Operations with ALTER TABLE in NDB Cluster").
...
* Modifying the definition of an
  [`ENUM`](enum.html "13.3.6 The ENUM Type") or
  [`SET`](set.html "13.3.7 The SET Type") column. The same
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") upgrades MySQL 5.5
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") performs an in-place
operation for
[virtual generated
column](/doc/refman/8.4/en/glossary.html#glos_virtual_generated_column) modifications. See
[Section 15.1.11.2, “ALTER TABLE and Generated Columns”](alter-table-generated-columns.html "15.1.11.2 ALTER TABLE and Generated Columns").
...
been made, [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") rejects the
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables); however, these
...
setting the
[`myisam_sort_buffer_size`](server-system-variables.html#sysvar_myisam_sort_buffer_size) system
variable to a high value.

#### Concurrency Control

For [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations that
...
[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") statement instead.
...
information, see [Section 13.6, “Data Type Default Values”](data-type-defaults.html "13.6 Data Type Default Values"), and
...
before using [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") (see
...
* Generated column and partition expressions that refer to the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement as the
...
described in [Section 13.6, “Data Type Default Values”](data-type-defaults.html "13.6 Data Type Default Values").

`ALTER ... SET VISIBLE` and `ALTER ...
SET INVISIBLE` enable column visibility to be changed.
See [Section 15.1.24.10, “Invisible Columns”](invisible-columns.html "15.1.24.10 Invisible Columns").

#### Primary Keys and Indexes

`DROP PRIMARY KEY` drops the
[primary key](glossary.html#glos_primary_key "primary key"). If there is
no primary key, an error occurs. For information about the
performance characteristics of primary keys, especially for
`InnoDB` tables, see
[Section 10.3.2, “Primary Key Optimization”](primary-key-optimization.html "10.3.2 Primary Key Optimization").

If the [`sql_require_primary_key`](server-system-variables.html#sysvar_sql_require_primary_key)
...
[`DROP INDEX`](drop-index.html "15.1.31 DROP INDEX Statement") removes an index. This
is a MySQL extension to standard SQL. See
[Section 15.1.31, “DROP INDEX Statement”](drop-index.html "15.1.31 DROP INDEX Statement"). To determine index names, use
`SHOW INDEX FROM
tbl_name`.
...
`USING`, see [Section 15.1.18, “CREATE INDEX Statement”](create-index.html "15.1.18 CREATE INDEX Statement"). The
...
If you use [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") on a
`MyISAM` table, all nonunique indexes are created
in a separate batch (as for [`REPAIR
TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement")). This should make [`ALTER
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") much faster when you have many indexes.
...
[`INDEX`](privileges-provided.html#priv_index) privilege in addition to the
privileges mentioned earlier.

While the nonunique indexes are disabled, they are ignored for
statements such as [`SELECT`](select.html "15.2.13 SELECT Statement") and
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") that otherwise would use
them.

After an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement, it
may be necessary to run [`ANALYZE
TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement") to update index cardinality information. See
...
more information, see [Section 10.3.12, “Invisible Indexes”](invisible-indexes.html "10.3.12 Invisible Indexes").
...
(...)`. See [Section 15.1.24.5, “FOREIGN KEY Constraints”](create-table-foreign-keys.html "15.1.24.5 FOREIGN KEY Constraints").
For other storage engines, the clauses are parsed but ignored.

For [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), unlike
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"), `ADD FOREIGN
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to drop foreign keys:
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement is supported
for [`ALTER TABLE ...
ALGORITHM=INPLACE`](alter-table.html "15.1.11 ALTER TABLE Statement") but not for
[`ALTER TABLE ...
ALGORITHM=COPY`](alter-table.html "15.1.11 ALTER TABLE Statement").
...
to use [`ALTER TABLE
... DROP FOREIGN KEY`](alter-table.html "15.1.11 ALTER TABLE Statement") before changing the column
definition and [`ALTER
TABLE ... ADD FOREIGN KEY`](alter-table.html "15.1.11 ALTER TABLE Statement") afterward. Examples of
prohibited changes include:

* Changes to the data type of foreign key columns that may be
  unsafe. For example, changing
  [`VARCHAR(20)`](char.html "13.3.2 The CHAR and VARCHAR Types") to
  [`VARCHAR(30)`](char.html "13.3.2 The CHAR and VARCHAR Types") is permitted, but
  changing it to [`VARCHAR(1024)`](char.html "13.3.2 The CHAR and VARCHAR Types") is
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") permits
...
* Add a new `CHECK` constraint:
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"). See
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") permits more general
...
columns ([`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types")) to a new character set, use a
statement like this:
...
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") or one of the
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") types, `CONVERT TO
...
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column has two length bytes,
which store the byte-length of values in the column, up to a
maximum of 65,535. For a `latin1`
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column, each character
...
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column's length bytes, so
MySQL converts the data type to
[`MEDIUMTEXT`](blob.html "13.3.4 The BLOB and TEXT Types"), which is the smallest
string type for which the length bytes can record a value of
262,140. Similarly, a [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types")
column might be converted to
[`MEDIUMTEXT`](blob.html "13.3.4 The BLOB and TEXT Types").
...
the [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"), and
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns are converted to their
...
[`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types")). This means that the columns
...
[`character_set_database`](server-system-variables.html#sysvar_character_set_database) system
variable is used.
...
convert to or from [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") columns.
...
When the [`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks)
...
[`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks) before
...
before re-enabling
[`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks). If you
re-enable [`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks)
...
It is possible for an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
[Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"), and
[Section 15.1.11.1, “ALTER TABLE Partition Operations”](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations"). For

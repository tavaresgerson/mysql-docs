...
MySQL 9.5 supports atomic Data Definition Language
...
* [DDL Statement Behavior](atomic-ddl.html#atomic-ddl-statement-behavior "DDL Statement Behavior")
...
* [`CREATE SERVER`](create-server.html "15.1.22 CREATE SERVER Statement"),
  ...
  [`DROP SERVER`](drop-server.html "15.1.35 DROP SERVER Statement") statements.
...
* [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") operations are
  ...
  [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") fails with an
...
* [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") and
  [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") are fully
  atomic and crash-safe, provided that all tables in the named
  database use a storage engine which supports atomic DDL, in
  which case the statement either adds or drops all objects
  successfully, or is rolled back.
...
* For tables that do not use a storage engine which supports
  ...
  [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") transaction.
  ...
  [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") or
  [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") operation. For
...
* [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"),
  ...
  [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement"), and
  [`DROP TABLESPACE`](drop-tablespace.html "15.1.38 DROP TABLESPACE Statement") operations
  for tables that use a storage engine which supports atomic
  DDL are either fully committed or rolled back if the server
  halts during their operation. [`RENAME
  TABLE`](rename-table.html "15.1.41 RENAME TABLE Statement") operations are atomic only if all named
  tables use a storage engine which supports atomic DDL.

* For storage engines that support atomic DDL, the
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") statement is logged as one
  ...
  in
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") statements when row-based
  replication is in use. Foreign key constraints can be added
  later using [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement").

  When
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") is applied as an atomic
  operation, a metadata lock is held on the table while data
  is inserted, which prevents concurrent access to the table
  for the duration of the operation.

* [`DROP VIEW`](drop-view.html "15.1.40 DROP VIEW Statement") fails if a named
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") may perform the
*Prepare* and *Perform*
...
4. *Post-DDL*: Replay and remove DDL logs
   ...
   TABLE`](drop-table.html "15.1.37 DROP TABLE Statement"), [`TRUNCATE
   TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"), and other DDL operations that rebuild the
   table.

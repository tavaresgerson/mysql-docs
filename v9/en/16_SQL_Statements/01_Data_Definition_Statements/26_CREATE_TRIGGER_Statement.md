...
TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") syntax. For additional discussion, see
[Section 27.4.1, “Trigger Syntax and Examples”](trigger-syntax.html "27.4.1 Trigger Syntax and Examples").

[`CREATE TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") requires the
...
[Section 27.8, “Stored Object Access Control”](stored-objects-security.html "27.8 Stored Object Access Control"). If binary logging is
enabled, [`CREATE TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") might
require the [`SUPER`](privileges-provided.html#priv_super) privilege, as
discussed in [Section 27.9, “Stored Program Binary Logging”](stored-programs-logging.html "27.9 Stored Program Binary Logging").
...
* [`DELETE`](delete.html "15.2.2 DELETE Statement"): The trigger activates
  ...
  [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") statements on
  the table do *not* activate this trigger,
  because they do not use [`DELETE`](delete.html "15.2.2 DELETE Statement").
  Dropping a partition does not activate
  [`DELETE`](delete.html "15.2.2 DELETE Statement") triggers, either.
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") trigger activates not only
for [`INSERT`](insert.html "15.2.7 INSERT Statement") statements but also
[`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements because both
...
[Section 15.6.1, “BEGIN ... END Compound Statement”](begin-end.html "15.6.1 BEGIN ... END Compound Statement"). Some statements are not permitted in
...
TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") statement. This is the same as specifying
`DEFINER = CURRENT_USER` explicitly.

MySQL takes the `DEFINER` user into account when
checking trigger privileges as follows:

* At [`CREATE TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") time, the
...
If you use [`LOCK TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") to lock a

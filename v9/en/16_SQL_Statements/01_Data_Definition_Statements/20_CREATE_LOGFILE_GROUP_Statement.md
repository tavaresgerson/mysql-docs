...
named '*`undo_file`*'. A
[`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") statement has
...
storage engine. This must be [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") (or
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")). If
`ENGINE` is not set, MySQL tries to use the
engine specified by the
[`default_storage_engine`](server-system-variables.html#sysvar_default_storage_engine) server
system variable. In any case, if the engine is not specified as
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") or
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"), the `CREATE
...
effect in MySQL 9.5. These options are intended for
future expansion.
...
[`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") is useful only

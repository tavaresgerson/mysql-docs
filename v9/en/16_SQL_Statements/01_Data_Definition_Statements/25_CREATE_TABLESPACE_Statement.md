...
[`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") syntax is used to
...
[`ALTER TABLE
tbl_name TABLESPACE [=]
tablespace_name`](alter-table.html "15.1.11 ALTER TABLE Statement") to add tables
...
using the [`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement")
statement (see [Section 15.1.12, “ALTER TABLESPACE Statement”](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement")).
...
GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") (see [Section 15.1.20, “CREATE LOGFILE GROUP Statement”](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement")).
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") reserves 4% of a tablespace for
...
When [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") is used with
...
* `ADD DATAFILE`: Defines the name of a
  ...
  **NDB data files.**
  ...
  TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") statement.
...
* `USE LOGFILE GROUP`: Required for
  ...
  GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement"). Not supported for `InnoDB`,
...
* `INITIAL_SIZE`: This option is specific to
  ...
  [`ALTER
  TABLESPACE ... ADD DATAFILE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement").
...
* `ENGINE`: Defines the storage engine which
  ...
  *`engine_name`* is the name of the
  ...
  storage engine is supported by standard MySQL 9.5
...
* The `TABLESPACE` option may be used with
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to assign an
...
* General tablespaces support the addition of tables of any row
  format using
  [`CREATE TABLE ...
  TABLESPACE`](create-table.html "15.1.24 CREATE TABLE Statement").
...
* [`innodb_strict_mode`](innodb-parameters.html#sysvar_innodb_strict_mode) is not
  ...
  [`CREATE TABLE ...
  TABLESPACE`](create-table.html "15.1.24 CREATE TABLE Statement") or
  [`ALTER TABLE ...
  TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement"),
...
* Use `DROP TABLESPACE` to remove a tablespace.
  ...
  [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") prior to dropping
  the tablespace. Before dropping an NDB Cluster tablespace you
  must also remove all its data files using one or more
  [`ALTER
  TABLESPACE ... DROP DATATFILE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") statements. See
...
* Similar to the system tablespace, truncating or dropping
  ...
  [.ibd data file](/doc/refman/8.4/en/glossary.html#glos_ibd_file) which can
...
[`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement") statement
shown here:
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement with the

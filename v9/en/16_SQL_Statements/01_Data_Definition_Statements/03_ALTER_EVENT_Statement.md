...
when used with [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement"). (See
...
EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") such as `ENABLE`.
...
[`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statements. References

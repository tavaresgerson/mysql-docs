...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") creates a table with
...
[Section 15.1.24.1, “Files Created by CREATE TABLE”](create-table-files.html "15.1.24.1 Files Created by CREATE TABLE").

There are several aspects to the [`CREATE
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement, described under the following topics in
this section:
...
* `LIKE`
  ...
  For more information, see [Section 15.1.24.3, “CREATE TABLE ... LIKE Statement”](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement").
...
* `[AS]
  ...
  the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement:
...
* `data_type`
  ...
  *`data_type`* represents the data type
  ...
  + Character data types ([`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
    ...
    [`SET`](set.html "13.3.7 The SET Type"), and any synonyms) can
    ...
    MySQL 9.5 interprets length specifications in
  ...
  + For [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
    ...
    *`length`* bytes of each column
    ...
    prefixes, see [Section 15.1.18, “CREATE INDEX Statement”](create-index.html "15.1.18 CREATE INDEX Statement").
    ...
    TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") handles the index as follows:
...
* `DEFAULT`
  ...
  that mode, [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
* `AUTO_INCREMENT`
  ...
  *`value`* is the largest value for the
  ...
  or the [`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html) C API
  function. See [Section 14.15, “Information Functions”](information-functions.html "14.15 Information Functions"), and
  [mysql\_insert\_id()](/doc/c-api/9.5/en/mysql-insert-id.html).
...
* `COMMENT`
  ...
  CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") and
  [`SHOW FULL
  COLUMNS`](show-columns.html "15.7.7.6 SHOW COLUMNS Statement") statements. It is also shown in the
...
* `COLUMN_FORMAT`
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables using
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, the default value
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"). MySQL 9.5
...
* `STORAGE`
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, it is possible to
  ...
  be used. The [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, `STORAGE
  DEFAULT` is equivalent to `STORAGE
  MEMORY`.

  The `STORAGE` clause has no effect on tables
  using storage engines other than
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"). The
...
* `GENERATED ALWAYS`
  ...
  about [generated
  columns](/doc/refman/8.4/en/glossary.html#glos_generated_column), see
  ...
  [Stored generated
  columns](/doc/refman/8.4/en/glossary.html#glos_stored_generated_column) can be indexed. `InnoDB`
  supports secondary indexes on
  [virtual
  generated columns](/doc/refman/8.4/en/glossary.html#glos_virtual_generated_column). See
...
[Section 15.1.24.5, “FOREIGN KEY Constraints”](create-table-foreign-keys.html "15.1.24.5 FOREIGN KEY Constraints"), and
...
* `FULLTEXT`
  ...
  *`index_option`* value to associate a
  ...
  plugins. See [Full-Text Parser Plugins](/doc/extending-mysql/9.5/en/plugin-types.html#full-text-plugin-type) and
  [Writing Full-Text Parser Plugins](/doc/extending-mysql/9.5/en/writing-full-text-plugins.html) for more
  information.
...
* `key_part`
  ...
  + Prefixes, defined by the *`length`*
    ...
    TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"), [`ALTER
    TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), and [`CREATE
    INDEX`](create-index.html "15.1.18 CREATE INDEX Statement") statements are interpreted as number of
...
* `index_option`
  ...
  *`index_option`* values, see
  [Section 15.1.18, “CREATE INDEX Statement”](create-index.html "15.1.18 CREATE INDEX Statement"). For more information about
...
* `reference_definition`
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") and
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables support checking of
  ...
  examples, see [Section 15.1.24.5, “FOREIGN KEY Constraints”](create-table-foreign-keys.html "15.1.24.5 FOREIGN KEY Constraints").
  ...
  specification. MySQL also accepts implicit references to the
  parent table's primary key. For more information, see
  [Section 15.1.24.5, “FOREIGN KEY Constraints”](create-table-foreign-keys.html "15.1.24.5 FOREIGN KEY Constraints"), as well as
...
apply if you later use [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
<td><a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a></td>
<td>Clustered, fault-tolerant, memory-based tables, supporting transactions
                and foreign keys. Also known as
                <a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDBCLUSTER</code></a>. See
                <a class="xref" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5">Chapter 25, <i>MySQL NDB Cluster 9.5</i></a>.</td>
</tr></tbody></table>
...
* `AUTO_INCREMENT`
  ...
  table. In MySQL 9.5, this works for
  `MyISAM`, `MEMORY`,
  `InnoDB`, and `ARCHIVE`
  ...
  table option in [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
* `COMMENT`
  ...
  **Setting NDB\_TABLE options.**
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement which
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement"). The text of
  the comment is also available as the TABLE\_COMMENT column of
  the MySQL Information Schema
  [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table.

  This comment syntax is also supported with
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements for
  ...
  comments is not supported for [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
* `KEY_BLOCK_SIZE`
  ...
  for [compressed](/doc/refman/8.4/en/glossary.html#glos_compression)
  `InnoDB` tables. The
  ...
  [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") reports the
  actual `KEY_BLOCK_SIZE` used by the table, as
  does [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement").
...
* `MAX_ROWS`
  ...
  The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine treats
  this value as a maximum. If you plan to create very large NDB
  Cluster tables (containing millions of rows), you should use
  this option to insure that [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
* `ROW_FORMAT`
  ...
  STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement"). The `Create_options` column
  shows the row format that was specified in the
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement, as does
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, the default
...
* `START TRANSACTION`
  ...
  atomic DDL. Only [`BINLOG`](binlog.html "15.7.8.1 BINLOG Statement"),
...
* `STATS_AUTO_RECALC`
  ...
  [persistent
  statistics](/doc/refman/8.4/en/glossary.html#glos_persistent_statistics) for an `InnoDB` table. The
...
* `TABLESPACE`
  ...
  [`CREATE
  TEMPORARY TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") is deprecated; expect it to be
  removed in a future version of MySQL.

  The `STORAGE` table option is employed only
  with [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables.
...
accomplish these tasks, see [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement"). For
...
* `HASH(expr)`
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements using
  `PARTITION BY HASH`:
...
* `KEY(column_list)`
  ...
  output of [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement")
...
* `RANGE(expr)`
  ...
  a single integer value. In MySQL 9.5, you can
...
<td>2006 and later</td>
  ...
  realized by the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
* `LIST(expr)`
  ...
  integer values only. In MySQL 9.5, you can

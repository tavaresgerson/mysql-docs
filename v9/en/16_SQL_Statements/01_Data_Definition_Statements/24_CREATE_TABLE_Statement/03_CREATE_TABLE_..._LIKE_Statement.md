...
[`CREATE TABLE ...
LIKE`](create-table.html "15.1.24 CREATE TABLE Statement") makes the same checks as
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"). This means that
...
[`CREATE TABLE
... LIKE`](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement") operations apply all

...
those given in a [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. These
...
* Trailing spaces are automatically deleted from
  ...
  [`SET`](set.html "13.3.7 The SET Type") member values when the
  table is created.
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") statement after

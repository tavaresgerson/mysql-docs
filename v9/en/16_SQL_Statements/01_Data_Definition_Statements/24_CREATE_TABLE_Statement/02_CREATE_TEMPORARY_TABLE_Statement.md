...
[`CREATE TEMPORARY
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") returns an error if
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") causes an implicit
...
[`CREATE TEMPORARY
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") is deprecated; expect it to be removed in a

...
WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") immediately following this
`EXPLAIN` statement:
...
[`JSON`](json.html "13.5 The JSON Data Type") column using the
[`JSON_VALUE()`](json-search-functions.html#function_json-value) function with an
...
1. [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") handles a
...
2. The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine does

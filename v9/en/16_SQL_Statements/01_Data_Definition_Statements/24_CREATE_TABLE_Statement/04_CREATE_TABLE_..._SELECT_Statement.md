...
part of the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") options such as
`CHARSET`.
...
[`CREATE TABLE ...
SELECT`](create-table.html "15.1.24 CREATE TABLE Statement"), columns named only in the
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") part come first.
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") part.

For storage engines that support both atomic DDL and foreign key
constraints, creation of foreign keys is not permitted in
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") statements when row-based replication
...
You can also use a [`VALUES`](values.html "15.2.19 VALUES Statement")
statement in the [`SELECT`](select.html "15.2.13 SELECT Statement") part of
...
([`ER_OPERAND_COLUMNS`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_operand_columns)):
...
[`CREATE TABLE ...
SELECT`](create-table.html "15.1.24 CREATE TABLE Statement") does not automatically create any indexes for
...
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"), make sure to alias any function
...
For [`CREATE TABLE
... SELECT`](create-table.html "15.1.24 CREATE TABLE Statement"), if `IF NOT EXISTS` is
...
[`CREATE TABLE ...
SELECT`](create-table.html "15.1.24 CREATE TABLE Statement"). For more information, see
...
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") operations apply

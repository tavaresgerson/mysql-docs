...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") supports the
...
* Literals, deterministic built-in functions, and operators
  ...
  definition: [`CONNECTION_ID()`](information-functions.html#function_connection-id),
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") data type, the setting
for
...
[`CURRENT_TIMESTAMP`](date-and-time-functions.html#function_current-timestamp). If the column
...
For [`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"), the destination table does not
...
For [`INSERT`](insert.html "15.2.7 INSERT Statement"),
[`REPLACE`](replace.html "15.2.12 REPLACE Statement"), and
[`UPDATE`](update.html "15.2.17 UPDATE Statement"), if a generated column is
...
* Generated columns can simulate functional indexes: Use a
  ...
  [`JSON`](json.html "13.5 The JSON Data Type") columns; see

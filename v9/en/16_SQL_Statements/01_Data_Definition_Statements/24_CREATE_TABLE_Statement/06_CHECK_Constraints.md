...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") permits the core
features of table and column `CHECK`
constraints, for all storage engines.
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") permits the

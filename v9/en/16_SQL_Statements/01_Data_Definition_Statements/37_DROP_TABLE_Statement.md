...
[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") removes one or more
...
[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") causes an implicit
...
[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") behavior depends on
...
[`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") is not supported with
all [`innodb_force_recovery`](innodb-parameters.html#sysvar_innodb_force_recovery)
settings. See [Section 17.20.3, “Forcing InnoDB Recovery”](forcing-innodb-recovery.html "17.20.3 Forcing InnoDB Recovery").
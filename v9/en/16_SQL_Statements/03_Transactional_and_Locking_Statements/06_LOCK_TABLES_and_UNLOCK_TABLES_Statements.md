...
[`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"). For sessions
holding a `READ` lock, [`DROP
TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") and [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement")
...
[Automatic Reconnection Control](/doc/c-api/9.5/en/c-api-auto-reconnect.html).
...
attempt a second [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
effect: [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"),
[`CREATE TABLE ...
LIKE`](create-table.html "15.1.24 CREATE TABLE Statement"), [`CREATE VIEW`](create-view.html "15.1.27 CREATE VIEW Statement"),
[`DROP VIEW`](drop-view.html "15.1.40 DROP VIEW Statement"), and DDL statements on

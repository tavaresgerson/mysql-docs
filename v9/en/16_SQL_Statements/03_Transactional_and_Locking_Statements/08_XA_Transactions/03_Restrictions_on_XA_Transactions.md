...
* The use of replication filters or binary log filters in
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") tables (the default),
  ...
  The error
  [`ER_XA_REPLICATION_FILTERS`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_xa_replication_filters) is

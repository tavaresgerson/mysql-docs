...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")) are not made permanent
...
* If you issue a
  ...
  transaction, an
  [`ER_WARNING_NOT_COMPLETE_ROLLBACK`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_warning_not_complete_rollback)
...
PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") displays `Rolling back` in

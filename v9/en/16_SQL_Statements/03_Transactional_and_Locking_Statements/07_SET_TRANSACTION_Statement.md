...
operations on [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") tables. The
access mode specifies whether transactions operate in read/write
or read-only mode.

In addition, [`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") can
...
same [`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement.
...
[`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") with an access
mode of `READ WRITE`.
...
[`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement, as
...
* [`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") permits
  optional `GLOBAL` and
...
each [`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") and

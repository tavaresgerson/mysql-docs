...
in-place upgrade to MySQL 9.5 from an earlier
version.
...
TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"),
...
[`PURGE BINARY LOGS`](purge-binary-logs.html "15.4.1.1 PURGE BINARY LOGS Statement") cannot be issued
while a [`LOCK INSTANCE FOR BACKUP`](lock-instance-for-backup.html "15.3.5 LOCK INSTANCE FOR BACKUP and UNLOCK INSTANCE Statements")

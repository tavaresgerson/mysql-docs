...
GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement") the member is set to
[`super_read_only=ON`](server-system-variables.html#sysvar_super_read_only), which
...
GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement when starting Group
...
The [`STOP GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement")
...
REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") does. This is because on a Group Replication
...
GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement") statement cannot be issued while a

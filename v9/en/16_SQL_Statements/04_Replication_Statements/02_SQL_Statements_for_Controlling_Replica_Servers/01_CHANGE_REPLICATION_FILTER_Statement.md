...
1. The statement does not require restarting the server to take
   ...
   using [`STOP
   REPLICA SQL_THREAD`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") first (and restarted with
   [`START REPLICA
   SQL_THREAD`](start-replica.html "15.4.2.4 START REPLICA Statement") afterwards).
...
[`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
requires the
...
issuing [`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
...
The [`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
...
The [`RESET REPLICA
ALL`](reset-replica.html "15.4.2.3 RESET REPLICA Statement") statement removes channel specific replication

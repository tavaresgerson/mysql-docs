...
:   [15.1.1 Atomic Data Definition Statement Support](atomic-ddl.html)
    ...
    [15.1.6 ALTER JSON DUALITY VIEW Statement](alter-json-duality-view.html)

    [15.1.7 ALTER LIBRARY Statement](alter-library.html)

    [15.1.8 ALTER LOGFILE GROUP Statement](alter-logfile-group.html)

    [15.1.9 ALTER PROCEDURE Statement](alter-procedure.html)

    [15.1.10 ALTER SERVER Statement](alter-server.html)

    [15.1.11 ALTER TABLE Statement](alter-table.html)

    [15.1.12 ALTER TABLESPACE Statement](alter-tablespace.html)

    [15.1.13 ALTER VIEW Statement](alter-view.html)

    [15.1.14 CREATE DATABASE Statement](create-database.html)

    [15.1.15 CREATE EVENT Statement](create-event.html)

    [15.1.16 CREATE FUNCTION Statement](create-function.html)

    [15.1.17 CREATE JSON DUALITY VIEW Statement](create-json-duality-view.html)

    [15.1.18 CREATE INDEX Statement](create-index.html)

    [15.1.19 CREATE LIBRARY Statement](create-library.html)

    [15.1.20 CREATE LOGFILE GROUP Statement](create-logfile-group.html)

    [15.1.21 CREATE PROCEDURE and CREATE FUNCTION Statements](create-procedure.html)

    [15.1.22 CREATE SERVER Statement](create-server.html)

    [15.1.23 CREATE SPATIAL REFERENCE SYSTEM Statement](create-spatial-reference-system.html)

    [15.1.24 CREATE TABLE Statement](create-table.html)

    [15.1.25 CREATE TABLESPACE Statement](create-tablespace.html)

    [15.1.26 CREATE TRIGGER Statement](create-trigger.html)

    [15.1.27 CREATE VIEW Statement](create-view.html)

    [15.1.28 DROP DATABASE Statement](drop-database.html)

    [15.1.29 DROP EVENT Statement](drop-event.html)

    [15.1.30 DROP FUNCTION Statement](drop-function.html)

    [15.1.31 DROP INDEX Statement](drop-index.html)

    [15.1.32 DROP LIBRARY Statement](drop-library.html)

    [15.1.33 DROP LOGFILE GROUP Statement](drop-logfile-group.html)

    [15.1.34 DROP PROCEDURE and DROP FUNCTION Statements](drop-procedure.html)

    [15.1.35 DROP SERVER Statement](drop-server.html)

    [15.1.36 DROP SPATIAL REFERENCE SYSTEM Statement](drop-spatial-reference-system.html)

    [15.1.37 DROP TABLE Statement](drop-table.html)

    [15.1.38 DROP TABLESPACE Statement](drop-tablespace.html)

    [15.1.39 DROP TRIGGER Statement](drop-trigger.html)

    [15.1.40 DROP VIEW Statement](drop-view.html)

    [15.1.41 RENAME TABLE Statement](rename-table.html)

    [15.1.42 TRUNCATE TABLE Statement](truncate-table.html)
...
:   [15.4.1 SQL Statements for Controlling Source Servers](replication-statements-source.html)

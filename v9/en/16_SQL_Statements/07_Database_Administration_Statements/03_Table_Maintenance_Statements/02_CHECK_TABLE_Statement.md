...
more information, see [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement"), and
...
* Changes are sometimes made to character sets or collations
  ...
  [Section 3.5, “Changes in MySQL 9.5”](upgrading-from-previous-series.html "3.5 Changes in MySQL 9.5"). For
...
* `Found row where the auto_increment column has the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") on the table.
...
* When an `InnoDB` table is stored in its
  own
  [`.ibd`
  file](/doc/refman/8.4/en/glossary.html#glos_ibd_file), the first 3
...
* [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") supports parallel

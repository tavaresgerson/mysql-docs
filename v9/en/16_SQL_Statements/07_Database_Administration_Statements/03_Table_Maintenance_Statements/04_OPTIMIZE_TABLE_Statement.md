...
* After doing substantial insert, update, or delete operations
  ...
  [.ibd file](/doc/refman/8.4/en/glossary.html#glos_ibd_file) because it
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables. It does not work for
...
of rows by [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement").
...
[`OPTIMIZE_LOCAL_TABLE`](privileges-provided.html#priv_optimize-local-table) privilege to
use this option.
...
[`ALTER TABLE ...
FORCE`](alter-table.html "15.1.11 ALTER TABLE Statement"), which rebuilds the table to update index

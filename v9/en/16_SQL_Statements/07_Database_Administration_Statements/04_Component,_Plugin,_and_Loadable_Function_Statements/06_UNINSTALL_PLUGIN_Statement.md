...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement so that
you can reload the table later. If you do not care about the
table, [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") can be used

...
[Section 7.5, “MySQL Components”](components.html "7.5 MySQL Components"). [`INSTALL
COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") requires the
...
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") permits setting
...
* Dynamically while the server is running by means of the
  [`SET`](set.html "13.3.7 The SET Type") statement, which enables
...
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") statement,
...
using [`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") takes
...
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") loads the
...
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement"). Instead,

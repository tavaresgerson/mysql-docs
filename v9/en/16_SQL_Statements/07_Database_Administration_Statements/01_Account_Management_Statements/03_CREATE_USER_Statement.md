...
[`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") fails with an error
...
MySQL 9.5 treats grants made to such a user as
...
MySQL 9.5 supports multifactor authentication
...
USER`](create-user.html "15.7.1.3 CREATE USER Statement") also supports multifactor authentication (MFA),
...
([`ER_USER_DOES_NOT_EXIST`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_user_does_not_exist)), and
...
[`USER_ATTRIBUTES`](information-schema-user-attributes-table.html "28.3.51 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table. This query
...
[`USER_ATTRIBUTES`](information-schema-user-attributes-table.html "28.3.51 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table:
...
[`USER_ATTRIBUTES`](information-schema-user-attributes-table.html "28.3.51 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table for more

...
The [`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") statement
...
Rather than using [`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement")
to assign passwords, [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement")
...
the current password, see [Section 8.2.15, “Password Management”](password-management.html "8.2.15 Password Management").
...
[`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") permits these
...
PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") may be recorded in server logs or on the
...
[`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") can be used with or
...
[`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") interprets the
...
variable is enabled, [`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement")

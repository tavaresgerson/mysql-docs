...
[`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.26 SHOW OPEN TABLES Statement") lists the
...
[`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.26 SHOW OPEN TABLES Statement") output has these
columns:
...
the output from [`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.26 SHOW OPEN TABLES Statement").
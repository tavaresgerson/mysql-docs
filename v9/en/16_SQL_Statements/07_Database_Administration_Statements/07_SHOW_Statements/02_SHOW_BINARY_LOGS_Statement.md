...
LOGS`](show-binary-logs.html "15.7.7.2 SHOW BINARY LOGS Statement") requires the [`REPLICATION
...
[`SHOW BINARY LOGS`](show-binary-logs.html "15.7.7.2 SHOW BINARY LOGS Statement"). The

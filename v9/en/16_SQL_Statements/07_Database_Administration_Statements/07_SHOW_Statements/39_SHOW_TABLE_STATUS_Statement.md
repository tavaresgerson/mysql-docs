...
[`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") works like
[`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement"), but provides a lot
of information about each non-`TEMPORARY`
table. You can also get this list using the [**mysqlshow
--status *`db_name`***](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information") command.
...
[`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") output has
these columns:
...
* `Update_time`
  ...
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) and the data file timestamp does not
  apply. Even with
...
* For `InnoDB` tables,
  [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") does not
...
* For views, most columns displayed by
  [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") are 0 or

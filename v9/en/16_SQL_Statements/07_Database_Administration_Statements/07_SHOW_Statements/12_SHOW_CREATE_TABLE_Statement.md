...
Shows the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") displays all
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") quotes table
...
STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement"). [`SHOW CREATE
TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") shows the row format that was specified in the

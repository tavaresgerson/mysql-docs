...
[`SHOW ENGINE`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") displays operational
...
If the server has the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
...
* `NdbTransaction`: The number and size of
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")) is performed on
  an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table.
...
* `NdbBlob`: The number and size of
  ...
  column in an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables have been performed

...
Shows the [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement")
...
[`SHOW
CREATE SCHEMA`](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement") is a synonym for
...
[`SHOW CREATE DATABASE`](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement") quotes table

...
EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statement needed to re-create a given event. It
...
then altered in [Section 15.7.7.20, “SHOW EVENTS Statement”](show-events.html "15.7.7.20 SHOW EVENTS Statement")):

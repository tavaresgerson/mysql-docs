...
which are discussed in [Section 27.5, “Using the Event Scheduler”](event-scheduler.html "27.5 Using the Event Scheduler"). It
requires the [`EVENT`](privileges-provided.html#priv_event) privilege for
the database from which the events are to be shown.

In its simplest form, [`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement")
...
[`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement") output has these
columns:
...
* `Execute At`
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value specified in
  the `AT` clause of the
  [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statement used
  to create the event, or of the last
  [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statement that
...
* `Starts`
  ...
  displayed as a [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types")
...
* `Originator`
  ...
  [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") to the server ID
...
Times displayed by [`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement")
...
`INFORMATION_SCHEMA`
[`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table. See
...
[`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement"). Use
[`SHOW CREATE EVENT`](show-create-event.html "15.7.7.8 SHOW CREATE EVENT Statement") or the
`INFORMATION_SCHEMA`
[`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table.
...
[`SHOW TRIGGERS`](show-triggers.html "15.7.7.41 SHOW TRIGGERS Statement") lists the triggers
...
which you have the [`TRIGGER`](privileges-provided.html#priv_trigger)
privilege. The [`LIKE`](string-comparison-functions.html#operator_like) clause, if
...
[Section 27.4, “Using Triggers”](triggers.html "27.4 Using Triggers"), the output of
[`SHOW TRIGGERS`](show-triggers.html "15.7.7.41 SHOW TRIGGERS Statement") is as shown here:
...
[`SHOW TRIGGERS`](show-triggers.html "15.7.7.41 SHOW TRIGGERS Statement") output has these
columns:

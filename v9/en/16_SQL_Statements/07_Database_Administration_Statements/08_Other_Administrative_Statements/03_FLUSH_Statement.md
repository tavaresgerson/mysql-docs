...
triggers. See [Section 27.10, “Restrictions on Stored Programs”](stored-program-restrictions.html "27.10 Restrictions on Stored Programs").
...
* [`FLUSH PRIVILEGES`](flush.html#flush-privileges)
  ...
  [`FLUSH PRIVILEGES`](flush.html#flush-privileges) to be
  ...
  [`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement"), as described in
  [Section 8.2.8, “Adding Accounts, Assigning Privileges, and Dropping Accounts”](creating-accounts.html "8.2.8 Adding Accounts, Assigning Privileges, and Dropping Accounts"), instead.

  This operation requires the
  [`FLUSH_PRIVILEGES`](privileges-provided.html#priv_flush-privileges) privilege
  (deprecated) or the [`RELOAD`](privileges-provided.html#priv_reload)
  privilege.
  ...
  [`GRANT`](grant.html "15.7.1.6 GRANT Statement"),
  [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement"),
  [`CREATE SERVER`](create-server.html "15.1.22 CREATE SERVER Statement"), and
  ...
  [`DROP SERVER`](drop-server.html "15.1.35 DROP SERVER Statement"), and
...
* [`FLUSH
  ...
  [`ER_WRONG_OBJECT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_wrong_object) error
  occurs. Otherwise, an
  [`ER_NO_SUCH_TABLE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_such_table) error
  occurs.
...
* [`FLUSH
  ...
  2. It checks whether all storage engines for the tables
     ...
     [`ER_ILLEGAL_HA`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_illegal_ha) error
  ...
  [`.ibd`
  file](/doc/refman/8.4/en/glossary.html#glos_ibd_file) file (that is, tables created with the

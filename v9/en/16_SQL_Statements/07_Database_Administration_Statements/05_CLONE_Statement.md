...
be installed. See [Section 7.6.6, “The Clone Plugin”](clone-plugin.html "7.6.6 The Clone Plugin").
...
server instance, see [Section 7.6.6.3, “Cloning Remote Data”](clone-plugin-remote.html "7.6.6.3 Cloning Remote Data").
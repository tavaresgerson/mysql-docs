...
[`SELECT`](select.html "15.2.13 SELECT Statement") can contain:
`DISTINCT`, `GROUP BY`,
`ORDER BY`, `LIMIT`, joins,
index hints, [`UNION`](union.html "15.2.18 UNION Clause") constructs,
comments, functions, and so on.

[`TABLE`](table.html "15.2.16 TABLE Statement") and
[`VALUES`](values.html "15.2.19 VALUES Statement") statements can be used in
subqueries. Subqueries using `VALUES` are
generally more verbose versions of subqueries that can be
rewritten more compactly using set notation, or with
[`SELECT`](select.html "15.2.13 SELECT Statement") or `TABLE`
syntax; assuming that table `ts` is created using
the statement
[`CREATE TABLE
ts VALUES ROW(2), ROW(4), ROW(6)`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"), the statements shown
...
Examples of [`TABLE`](table.html "15.2.16 TABLE Statement") subqueries are
...
[`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"), or
...
Expressions”](subquery-optimization.html "10.2.2 Optimizing Subqueries, Derived Tables, View References, and Common Table Expressions"). For a discussion of

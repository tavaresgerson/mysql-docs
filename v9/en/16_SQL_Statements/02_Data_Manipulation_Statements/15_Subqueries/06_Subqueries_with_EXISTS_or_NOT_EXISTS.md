...
[`SELECT`](select.html "15.2.13 SELECT Statement") list in such a subquery,
...
You can also use `NOT EXISTS` or `NOT
EXISTS` with [`TABLE`](table.html "15.2.16 TABLE Statement") in

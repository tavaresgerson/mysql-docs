...
* If you use `FOR UPDATE` with a storage engine
  ...
  old_table ...`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"). (If you
...
* `SQL_CALC_FOUND_ROWS` tells MySQL to
  ...
  [`FOUND_ROWS()`](information-functions.html#function_found-rows) for information
  about an alternative strategy.

* The `SQL_CACHE` and
  `SQL_NO_CACHE` modifiers were used with the
  query cache prior to MySQL 9.5. The query cache
  was removed in MySQL 9.5. The

...
The [`CASE`](case.html "15.6.5.1 CASE Statement") statement for stored
programs implements a complex conditional construct.

Note

There is also a [`CASE`](flow-control-functions.html#operator_case)
*operator*, which differs from the
[`CASE`](case.html "15.6.5.1 CASE Statement")
*statement* described here. See
[Section 14.5, “Flow Control Functions”](flow-control-functions.html "14.5 Flow Control Functions"). The
...
is false. See [Section 5.3.4.6, “Working with NULL Values”](working-with-null.html "5.3.4.6 Working with NULL Values").
...
tested and the [`CASE`](case.html "15.6.5.1 CASE Statement") statement
...
containing an empty
[`BEGIN ...
END`](begin-end.html "15.6.1 BEGIN ... END Compound Statement") block, as shown in this example. (The indentation

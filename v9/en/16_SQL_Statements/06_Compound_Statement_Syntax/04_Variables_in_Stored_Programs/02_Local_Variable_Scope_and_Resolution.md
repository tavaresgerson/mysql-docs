...
[`SELECT ...
INTO`](select.html "15.2.13 SELECT Statement") statement, contains a reference to a column and a
...
[`SELECT`](select.html "15.2.13 SELECT Statement") statement as a reference
...
contains a [`SELECT`](select.html "15.2.13 SELECT Statement") statement that

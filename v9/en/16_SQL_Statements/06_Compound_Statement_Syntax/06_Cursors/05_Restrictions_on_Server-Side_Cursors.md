...
[`mysql_stmt_attr_set()`](/doc/c-api/9.5/en/mysql-stmt-attr-set.html) function.
...
[`max_heap_table_size`](server-system-variables.html#sysvar_max_heap_table_size) and
[`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) system
...
[Section 10.4.4, “Internal Temporary Table Use in MySQL”](internal-temporary-tables.html "10.4.4 Internal Temporary Table Use in MySQL"). One limitation of
...
TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement"), `HANDLER READ`, and
[`SHOW BINLOG EVENTS`](show-binlog-events.html "15.7.7.3 SHOW BINLOG EVENTS Statement").
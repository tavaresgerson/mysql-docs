...
[`SELECT`](select.html "15.2.13 SELECT Statement") statement associated with
...
[`BEGIN ...
END`](begin-end.html "15.6.1 BEGIN ... END Compound Statement") block so that it can be associated with its own
handler.
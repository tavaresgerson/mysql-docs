...
version 9.5, through release 9.5.0.
Differences between minor versions of MySQL 9.5 are
noted in the present text with reference to release numbers
(9.5.*`x`*). For license
information, see the [Legal
Notices](preface.html#legalnotice "Legal Notices").
...
between MySQL 9.5 and previous versions. If you are
using an earlier release of the MySQL software, please refer to
the appropriate manual. For example, the
[MySQL 8.0
Reference Manual](/doc/refman/8.0/en/) covers the 8.0 bugfix series of MySQL
software releases.
...
[https://dev.mysql.com/doc/](/doc/). Other formats also are available
...
from [https://dev.mysql.com/doc/index-other.html](/doc/index-other.html). It is also
...
* **Text in this style** indicates the names of
  ...
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") (the MySQL command-line client program)
  and [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") (the MySQL server executable).
...
* `Text in this style` is used to indicate a
  ...
  tells the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client program the hostname
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") command-line client.
...
[`SELECT ... INTO
OUTFILE`](select.html "15.2.13 SELECT Statement") is shorthand for the form of
[`SELECT`](select.html "15.2.13 SELECT Statement") statement that has an

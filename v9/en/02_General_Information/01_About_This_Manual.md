...
This is the Reference Manual for the MySQL Database System, version 9.5, through release 9.5.0. Differences between minor versions of MySQL 9.5 are noted in the present text with reference to release numbers (9.5.*`x`*). For license information, see the Legal Notices.

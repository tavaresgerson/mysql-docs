...
* SQL statement syntax
  ...
  + The [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement"),
    ...
    statements. See [Section 15.1.14, “CREATE DATABASE Statement”](create-database.html "15.1.14 CREATE DATABASE Statement"),
    [Section 15.1.28, “DROP DATABASE Statement”](drop-database.html "15.1.28 DROP DATABASE Statement"), and
  ...
  + Use of [`RENAME TABLE`](rename-table.html "15.1.41 RENAME TABLE Statement"). See
  ...
  + Use of `CHANGE
    ...
    `IGNORE` or `RENAME`
    in [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
    statements. Use of multiple `ADD`,
    `ALTER`, `DROP`, or
    `CHANGE` clauses in an
    [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement.
    See [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement").

  + Use of index names, indexes on a prefix of a column, and
    use of `INDEX` or
    `KEY` in [`CREATE
    TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements. See
  ...
  + The capability of dropping multiple tables with a single
    [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") statement.
...
* Data types
  ...
  + The [`MEDIUMINT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"),
    ...
    [`ENUM`](enum.html "13.3.6 The ENUM Type") data types, and the

...
* For an overview of new MySQL features, see Section 1.4, “What Is New in MySQL 9.5”. For information about the changes in each version, see the [Release Notes](/doc/relnotes/mysql/9.5/en/).
...
* For answers to a number of questions that are often asked concerning the MySQL Database Server and its capabilities, see Appendix A, *MySQL 9.5 Frequently Asked Questions*.

* For a history of new features and bug fixes, see the [Release Notes](/doc/relnotes/mysql/9.5/en/).

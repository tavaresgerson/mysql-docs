...
<table summary="Output columns produced by the EXPLAIN statement."><col style="width: 25%"/><col style="width: 25%"/><col style="width: 50%"/><thead><tr> <th>Column</th> <th>JSON Name</th> <th>Meaning</th> </tr></thead><tbody><tr> <th><code class="literal">id</code></th> <td><code class="literal">select_id</code></td> <td>The <code class="literal">SELECT</code> identifier</td> </tr><tr> <th><code class="literal">select_type</code></th> <td>None</td> <td>The <code class="literal">SELECT</code> type</td> </tr><tr> <th><code class="literal">table</code></th> <td><code class="literal">table_name</code></td> <td>The table for the output row</td> </tr><tr> <th><code class="literal">partitions</code></th> <td><code class="literal">partitions</code></td> <td>The matching partitions</td> </tr><tr> <th><code class="literal">type</code></th> <td><code class="literal">access_type</code></td> <td>The join type</td> </tr><tr> <th><code class="literal">possible_keys</code></th> <td><code class="literal">possible_keys</code></td> <td>The possible indexes to choose</td> </tr><tr> <th><code class="literal">key</code></th> <td><code class="literal">key</code></td> <td>The index actually chosen</td> </tr><tr> <th><code class="literal">key_len</code></th> <td><code class="literal">key_length</code></td> <td>The length of the chosen key</td> </tr><tr> <th><code class="literal">ref</code></th> <td><code class="literal">ref</code></td> <td>The columns compared to the index</td> </tr><tr> <th><code class="literal">rows</code></th> <td><code class="literal">rows</code></td> <td>Estimate of rows to be examined</td> </tr><tr> <th><code class="literal">filtered</code></th> <td><code class="literal">filtered</code></td> <td>Percentage of rows filtered by table condition</td> </tr><tr> <th><code class="literal">Extra</code></th> <td>None</td> <td>Additional information</td> </tr></tbody></table>

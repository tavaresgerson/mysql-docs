...
2. **Choose which track to install.**
   ...
   MySQL offers an [LTS series](glossary.html#glos_lts_series "LTS Series"), such as MySQL 8.4, and an Innovation series, such as 9.5. They address different use cases as described at Section 1.3, “MySQL Releases: Innovation and LTS”.

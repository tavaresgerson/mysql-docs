...
2.3 Installing MySQL on Microsoft Windows :   2.3.1 Choosing an Installation Package
...
If you are interested in migrating to MySQL from another database system, see Section A.8, “MySQL 9.5 FAQ: Migration”, which contains answers to some common questions concerning migration issues.
...
2. **Choose which track to install.**
   ...
   MySQL offers an LTS series, such as MySQL 8.4, and an Innovation series, such as 9.5. They address different use cases as described at Section 1.3, “MySQL Releases: Innovation and LTS”.

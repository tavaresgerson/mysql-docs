...
[**mysql\_secure\_installation**](mysql-secure-installation.html "6.4.2 mysql_secure_installation — Improve MySQL Installation Security") script that comes
...
You should check the notes in [Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL") before

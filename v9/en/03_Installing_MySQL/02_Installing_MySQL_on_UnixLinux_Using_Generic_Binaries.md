...
[Secure
Deployment Guide](/doc/mysql-secure-deployment-guide/en/). For other platform-specific binary package
formats, see the other platform-specific sections in this manual.
For example, for Windows distributions, see
[Section 2.3, “Installing MySQL on Microsoft Windows”](windows-installation.html "2.3 Installing MySQL on Microsoft Windows"). See
[Section 2.1.3, “How to Get MySQL”](getting-mysql.html "2.1.3 How to Get MySQL") on how to obtain MySQL in different
...
* If you have previously installed MySQL using your operating
  ...
  or [Replacing a Native Distribution of MySQL Using the MySQL APT Repository](linux-installation-apt-repo.html#repo-qg-apt-replacing "Replacing a Native Distribution of MySQL Using the MySQL APT Repository").
...
<table><col style="width: 45%"/><col style="width: 55%"/><thead><tr>
<th>Directory</th>
...
Debug versions of the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary are available
as [**mysqld-debug**](mysqld.html "6.3.1 mysqld — The MySQL Server"). To compile your own debug
...
running [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), you may need to create them. The
...
[Section 2.1.3, “How to Get MySQL”](getting-mysql.html "2.1.3 How to Get MySQL"). For a given release, binary

...
2. The [`WITH_SSL`](source-configuration-options.html#option_cmake_with_ssl)
   **CMake** option determines which SSL library
   to use for compiling MySQL (see
   [Section 2.8.7, “MySQL Source-Configuration Options”](source-configuration-options.html "2.8.7 MySQL Source-Configuration Options")). The default
   is [`-DWITH_SSL=system`](source-configuration-options.html#option_cmake_with_ssl), which uses
...
To check whether a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server supports

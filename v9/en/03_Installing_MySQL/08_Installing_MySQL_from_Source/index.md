...
[https://dev.mysql.com/doc/index-other.html](/doc/index-other.html). It is also possible to
generate this content locally from a MySQL source distribution using
the instructions at [Section 2.8.10, “Generating MySQL Doxygen Documentation Content”](source-installation-doxygen.html "2.8.10 Generating MySQL Doxygen Documentation Content").
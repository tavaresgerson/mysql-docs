...
* MySQL 9.5 source code permits use of C++17
...
* An SSL library is required for support of encrypted
  ...
  [`WITH_SSL`](source-configuration-options.html#option_cmake_with_ssl) option when you invoke
...
* The [Boost C++
  libraries](http://www.boost.org/) are required to build MySQL (but not to use
...
the instructions in [Section 1.6, “How to Report Bugs or Problems”](bug-reports.html "1.6 How to Report Bugs or Problems").
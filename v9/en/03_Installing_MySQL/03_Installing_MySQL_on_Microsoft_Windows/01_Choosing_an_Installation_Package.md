...
For MySQL 9.5, there are multiple installation
package formats to choose from when installing MySQL on Windows.
The package formats described in this section are:

* [MySQL Installation MSI](windows-choosing-package.html#windows-choosing-package-mysql-installer "MySQL Installation MSI")
* [MySQL noinstall ZIP Archives](windows-choosing-package.html#windows-choosing-package-no-zip "MySQL noinstall ZIP Archives")
* [MySQL Docker Images](windows-choosing-package.html#windows-choosing-package-docker "MySQL Docker Images")

#### MySQL Installation MSI

This package has a file name similar to
`mysql-community-9.5.0.msi` or
`mysql-commercial-9.5.0.msi`, and
...
Windows (see <https://www.mysql.com/support/supportedplatforms/database.html>). For
instructions on how to configure MySQL using MySQL Configurator, see
[Section 2.3.2, “Configuration: Using MySQL Configurator”](mysql-configurator.html "2.3.2 Configuration: Using MySQL Configurator").
...
1. If you are upgrading from a previous version please refer to
   [Section 3.11, “Upgrading MySQL on Windows”](windows-upgrading.html "3.11 Upgrading MySQL on Windows"), before beginning the
   upgrade process.
...
3. Choose an installation location. Traditionally, the MySQL
   ...
   The MSI installs MySQL under `C:\Program
...
5. Configure the MySQL server using either MySQL Configurator
   (recommended) or [Section 2.3.3, “Configuration: Manually”](windows-install-archive.html "2.3.3 Configuration: Manually").

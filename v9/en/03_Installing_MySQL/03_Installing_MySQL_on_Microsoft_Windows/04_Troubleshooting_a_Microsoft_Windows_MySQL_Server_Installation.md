...
* If the MySQL server cannot find the `mysql`
  ...
  Server 9.5` and `C:\Program
  Files\MySQL\MySQL Server 9.5\data`,
  respectively).
  ...
  9.5`, ensure that the MySQL server is
  ...
  See [Section 2.3.3.2, “Creating an Option File”](windows-create-option-file.html "2.3.3.2 Creating an Option File").

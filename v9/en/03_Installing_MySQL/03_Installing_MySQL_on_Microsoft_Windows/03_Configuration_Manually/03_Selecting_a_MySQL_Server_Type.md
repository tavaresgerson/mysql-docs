...
<table summary="Servers available for Windows in MySQL 9.5."><col style="width: 20%"/><col style="width: 80%"/><thead><tr>
<th>Binary</th>
<th>Description</th>
</tr></thead><tbody><tr>
...
storage engines. The [`SHOW ENGINES`](show-engines.html "15.7.7.18 SHOW ENGINES Statement")
statement displays which engines a given server supports.

All Windows MySQL 9.5 servers have support for

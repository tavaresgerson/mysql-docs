...
* The installation or data directory locations are different
  ...
  Files\MySQL\MySQL Server 9.5` and
...
[Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files")). The Windows directory typically
...
[Section 7.1.2, “Server Configuration Defaults”](server-configuration-defaults.html "7.1.2 Server Configuration Defaults").
...
[`--initialize-insecure`](server-options.html#option_mysqld_initialize-insecure). For
...
2. Use a [`--datadir`](server-system-variables.html#sysvar_datadir) option to

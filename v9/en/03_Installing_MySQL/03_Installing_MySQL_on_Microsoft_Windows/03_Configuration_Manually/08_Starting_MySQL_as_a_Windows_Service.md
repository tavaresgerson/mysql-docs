...
* Place your cursor at the end of the text appearing in the
  ...
  **End** key to ensure that your cursor is
  ...
  servers, the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, and all MySQL
  command-line utilities such as [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program")
...
* If a service name is given, it can be followed by a single
  ...
  [`--defaults-file`](option-file-options.html#option_general_defaults-file) is possible
  but discouraged.
  [`--defaults-file`](option-file-options.html#option_general_defaults-file) is more
...
* If the service-installation command specifies a
  [`--defaults-file`](option-file-options.html#option_general_defaults-file) option after
...
[`--defaults-file`](option-file-options.html#option_general_defaults-file) option had been
...
[`--defaults-file`](option-file-options.html#option_general_defaults-file) option is
...
[`--tmpdir`](server-options.html#option_mysqld_tmpdir) option has been used to
...
When run as a service, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") has no access
to a console window, so no messages can be seen there. If
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") does not start, check the error log to
...
Server 9.5\data`). It is the file with a
suffix of `.err`.
...
*`mysqld_service_name`***
command, or the [**mysqladmin shutdown**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command.
...
Alternatively, use the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
[`--remove`](server-options.html#option_mysqld_remove) option to remove the
service.
...
If [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is not running as a service, you
...
service, see [Section 7.8.2.2, “Starting Multiple MySQL Instances as Windows Services”](multiple-windows-services.html "7.8.2.2 Starting Multiple MySQL Instances as Windows Services").
...
If [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is slow to respond to TCP/IP
connections from client programs, there is probably a problem
with your DNS. In this case, start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
[`--pipe`](connection-options.html#option_general_pipe) or
[`--protocol=PIPE`](connection-options.html#option_general_protocol) option, or by
specifying `.` (period) as the host name. Use
the [`--socket`](connection-options.html#option_general_socket) option to specify
...
For more information about [**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information"), see

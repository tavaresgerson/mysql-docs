...
* [MySQL Configurator](mysql-configurator.html "2.3.2 Configuration: Using MySQL Configurator"): Used to
  configure the MySQL server.

* [MySQL Workbench](workbench.html "Chapter 33 MySQL Workbench"): Manages the
  MySQL server and edits SQL statements.

If necessary, initialize the data directory and create the MySQL
grant tables. Windows installation operations performed by
MySQL Configurator can initialize the data directory automatically. For
installation from a ZIP Archive package, initialize the data
...
Regarding passwords, if you configured MySQL using the MySQL Configurator,
you may have already assigned a password to the initial
`root` account. (See
[Section 2.3.2, “Configuration: Using MySQL Configurator”](mysql-configurator.html "2.3.2 Configuration: Using MySQL Configurator").) Otherwise, use the
...
running (see [Section 2.3.3.5, “Starting the Server for the First Time”](windows-server-first-start.html "2.3.3.5 Starting the Server for the First Time")). You
can also set up a MySQL service that runs automatically when
Windows starts (see [Section 2.3.3.8, “Starting MySQL as a Windows Service”](windows-start-service.html "2.3.3.8 Starting MySQL as a Windows Service")).
...
If you installed MySQL using the MSI, the default installation
...
See [Section 2.3.3.7, “Customizing the PATH for MySQL Tools”](mysql-installation-windows-path.html "2.3.3.7 Customizing the PATH for MySQL Tools").
...
Use [**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information") to see what databases exist:
...
as [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")) may not work if the correct MySQL
account does not exist. For example, the program may fail with an
error, or you may not be able to view all databases. If you
configured MySQL using MySQL Configurator, the `root` user
is created automatically with the password you supplied. In this
...
If you specify a database name, [**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information")
...
For more information about [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and
[**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information"), see [Section 6.5.1, “mysql — The MySQL Command-Line Client”](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), and

...
[MySQL
8.4 Secure Deployment Guide](/doc/mysql-secure-deployment-guide/en/).
...
[`-DWITH_SYSTEMD=1`](source-configuration-options.html#option_cmake_with_systemd)
**CMake** option. See
...
* [Overview of systemd](using-systemd.html#systemd-overview "Overview of systemd")
* [Configuring systemd for MySQL](using-systemd.html#systemd-mysql-configuration "Configuring systemd for MySQL")
* [Configuring Multiple MySQL Instances Using systemd](using-systemd.html#systemd-multiple-mysql-instances "Configuring Multiple MySQL Instances Using systemd")
* [Migrating from mysqld\_safe to systemd](using-systemd.html#mysqld-safe-to-systemd-migration "Migrating from mysqld_safe to systemd")

Note

On platforms for which systemd support for MySQL is installed,
scripts such as [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") and the System V
initialization script are unnecessary and are not installed. For
example, [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") can handle server
...
One implication of the non-use of [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")
...
installed, [**mysqld\_multi**](mysqld-multi.html "6.3.4 mysqld_multi — Manage Multiple MySQL Servers") and
...
* `mysqld_pre_systemd` (RPM platforms),
  ...
  writable for the user running the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  process.
...
* Parameters that specify values otherwise settable only using
  options known to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") must be
  specified using systemd because there is no corresponding
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") parameter.
...
* To set the number of file descriptors available to the MySQL
  ...
  variable for [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") or
  [`--open-files-limit`](mysqld-safe.html#option_mysqld_safe_open-files-limit)
  option for [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script").

* To set the maximum core file size, use
  `LimitCore` in
  `override.conf` rather than the
  [`--core-file-size`](mysqld-safe.html#option_mysqld_safe_core-file-size) option
  for [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script").

* To set the scheduling priority for the MySQL server, use
  `Nice` in
  `override.conf` rather than the
  [`--nice`](mysqld-safe.html#option_mysqld_safe_nice) option for
...
* `NOTIFY_SOCKET`: This environment variable
  specifies the socket that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") uses to
  communicate notification of startup completion and service
  status change with systemd. It is set by systemd when the
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") service is started. The
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") service reads the variable setting
  and writes to the defined location.

  In MySQL 9.5, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") uses
...
To specify options for [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") without
...
[**mysqld\_multi**](mysqld-multi.html "6.3.4 mysqld_multi — Manage Multiple MySQL Servers") and
**mysqld\_multi.server** are unnecessary and are
not installed.
...
Because [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") is not installed on
...
* Some [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") options are also
  understood by [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") and can be moved
  from the `[mysqld_safe]` or
  `[safe_mysqld]` option group to the
  `[mysqld]` group. This does
  *not* include
  [`--pid-file`](mysqld-safe.html#option_mysqld_safe_pid-file),
  [`--open-files-limit`](mysqld-safe.html#option_mysqld_safe_open-files-limit), or
  [`--nice`](mysqld-safe.html#option_mysqld_safe_nice). To specify those
...
* For some [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") options, there are
  alternative [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") procedures. For
  example, the [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") option for
  enabling `syslog` logging is
  [`--syslog`](mysqld-safe.html#option_mysqld_safe_syslog), which is
  deprecated. To write error log output to the system log, use
  the instructions at [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log").

* [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") options not understood by
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") can be specified in
  `override.conf` or environment variables.
  For example, with [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"), if the
  server should use a specific memory allocation library, this
  is specified using the
  [`--malloc-lib`](mysqld-safe.html#option_mysqld_safe_malloc-lib) option. For

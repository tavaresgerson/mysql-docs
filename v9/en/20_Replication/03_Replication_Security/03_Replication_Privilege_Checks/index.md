...
REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement. MySQL then checks each
...
reapply transactions from [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") output,
...
TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement when you specify the
...
* The `REQUIRE_TABLE_PRIMARY_KEY_CHECK` option
  ...
  the [`sql_require_primary_key`](server-system-variables.html#sysvar_sql_require_primary_key)
...
[Section 8.4.1.1, “Caching SHA-2 Pluggable Authentication”](caching-sha2-pluggable-authentication.html "8.4.1.1 Caching SHA-2 Pluggable Authentication")). To
...
REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement. If replication is
running, issue [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") before
the [`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement")
statement, and [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") after
...
account the [`SKIP_QUERY_REWRITE`](privileges-provided.html#priv_skip-query-rewrite)
privilege. This prevents statements issued by this user from being
rewritten. See [Section 7.6.4, “The Rewriter Query Rewrite Plugin”](rewriter-query-rewrite-plugin.html "7.6.4 The Rewriter Query Rewrite Plugin"),

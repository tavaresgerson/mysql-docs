...
* Setting the value of the system variables
  ...
  and [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode), to
...
TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement is set to the default value
`STREAM`, the
...
If the [`init_replica`](replication-options-replica.html#sysvar_init_replica) system

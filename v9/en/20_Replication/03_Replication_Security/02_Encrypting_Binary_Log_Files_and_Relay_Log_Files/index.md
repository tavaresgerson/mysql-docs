...
this, see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring"). Any supported keyring
...
(`0xFE62696E`). The [`SHOW
BINARY LOGS`](show-binary-logs.html "15.7.7.2 SHOW BINARY LOGS Statement") statement shows whether each binary log file
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"), note that the copies of the files
that are generated using [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") are stored

...
KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key). When the binary log master key is rotated
...
The [`BINLOG_ENCRYPTION_ADMIN`](privileges-provided.html#priv_binlog-encryption-admin)
privilege is required to issue [`ALTER
INSTANCE ROTATE BINLOG MASTER KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key), and the statement
...
KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) on the new server does not delete any earlier
...
[`ALTER INSTANCE ROTATE BINLOG MASTER
KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) again. Then investigate the status of individual
...
MASTER KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) again to retry the process.
...
ROTATE BINLOG MASTER KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) again after the restart.

[`ALTER INSTANCE ROTATE BINLOG MASTER
KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) actions are not written to the binary log and are
...
MASTER KEY`](alter-instance.html#alter-instance-rotate-binlog-master-key) statement using a
[`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statement. If you

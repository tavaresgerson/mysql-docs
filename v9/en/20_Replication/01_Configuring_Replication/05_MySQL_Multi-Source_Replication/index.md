...
function, see [Section 19.2.2, “Replication Channels”](replication-channels.html "19.2.2 Replication Channels").
...
When a multi-source replica is also up as a multi-threaded replica,
each channel on the replica has the specified number of applier
...
MySQL 9.5 also supports replication filters on specific

...
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") with
[`--set-gtid-purged=COMMENTED`](mysqldump.html#option_mysqldump_set-gtid-purged) to
...
5. On the replica, issue [`RESET BINARY LOGS
   AND GTIDS`](reset-binary-logs-and-gtids.html "15.4.1.2 RESET BINARY LOGS AND GTIDS Statement") to clear the GTID execution history

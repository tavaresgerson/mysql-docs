...
replication. See [Section 19.1.3.4, “Setting Up Replication Using GTIDs”](replication-gtids-howto.html "19.1.3.4 Setting Up Replication Using GTIDs") for how
to configure a source using GTID-based replication. See
[Section 19.1.2.1, “Setting the Replication Source Configuration”](replication-howto-masterbaseconfig.html "19.1.2.1 Setting the Replication Source Configuration") for how to
...
default in MySQL 9.5. Multi-source replication is not
...
the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to issue these statements on
each of the sources:
...
For more information about the default authentication plugin for
new users, see [Section 19.1.2.3, “Creating a User for Replication”](replication-howto-repuser.html "19.1.2.3 Creating a User for Replication").
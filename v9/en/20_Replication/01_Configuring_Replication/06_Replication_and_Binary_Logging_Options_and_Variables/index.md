...
in the output of [`SHOW REPLICAS`](show-replicas.html "15.7.7.37 SHOW REPLICAS Statement"). Once
[`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") has been executed, the
...
Issuing a [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") or
[`RESET REPLICA`](reset-replica.html "15.4.2.3 RESET REPLICA Statement") statement does
...
* The source's [`server_uuid`](replication-options.html#sysvar_server_uuid)
  ...
  SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement has ever been executed.
...
SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement. Others, such as the
...
<td><code class="literal">4294967295</code></td>
  ...
  `SOURCE_RETRY_COUNT` option of the
  [`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement")
  statement, instead.
...
<td>String</td>
  ...
  [`CHANGE
  REPLICATION FILTER REPLICATE_DO_DB`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement").
...
<td>String</td>
  ...
  Such filters can also be created using
  [`CHANGE
  REPLICATION FILTER REPLICATE_IGNORE_DB`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement").
...
<td>String</td>
  ...
  [`CHANGE
  REPLICATION FILTER REPLICATE_DO_TABLE`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement") statement.
...
<td>String</td>
  ...
  such a filter by issuing a
  [`CHANGE
  REPLICATION FILTER REPLICATE_IGNORE_TABLE`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
  statement.
...
<td>String</td>
  ...
  *`from_name`* on the source. Only
  ...
  such as [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement"),
  [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement"), and
  ...
  *before* the
  ...
  [`CHANGE
  REPLICATION FILTER REPLICATE_REWRITE_DB`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement") statement.
...
* [`--replicate-same-server-id`](replication-options-replica.html#option_mysqld_replicate-same-server-id)
  ...
  <table frame="box" rules="all" summary="Properties for replicate-same-server-id"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">OFF</code></td>
  ...
  of the
  [`--replicate-same-server-id`](replication-options-replica.html#option_mysqld_replicate-same-server-id)
  and [`--log-replica-updates`](replication-options-binary-log.html#sysvar_log_replica_updates)
  options on the replica can cause infinite loops in
  replication if the server is part of a circular replication
  topology. (In MySQL 9.5, binary logging is
...
<td><code class="literal">4096</code></td>
  ...
  also create such a filter by issuing a
  [`CHANGE
  REPLICATION FILTER REPLICATE_WILD_DO_TABLE`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
  statement.
  ...
  *`channel_1`* use
  ...
  DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement"), [`DROP
  DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement"), and [`ALTER
...
<td><code class="literal">4096</code></td>
  ...
  such a filter by issuing a
  [`CHANGE
  REPLICATION FILTER REPLICATE_WILD_IGNORE_TABLE`](change-replication-filter.html "15.4.2.1 CHANGE REPLICATION FILTER Statement")
  statement.
...
<td><code class="literal">4096</code></td>
  ...
  REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement.
...
<td><code class="literal">4096</code></td>
  ...
  [`--replica-skip-errors`](replication-options-replica.html#sysvar_replica_skip_errors).
...
<td><code class="literal">4096</code></td>
  ...
  Deprecated synonym for
  [`--replica-sql-verify-checksum`](replication-options-replica.html#sysvar_replica_sql_verify_checksum)
...
<td><code class="literal">4096</code></td>
  ...
  [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statements.
  ...
  executed when [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement")
  returns. See [Section 15.4.2.4, “START REPLICA Statement”](start-replica.html "15.4.2.4 START REPLICA Statement") for more
  information.
...
<td><code class="literal">4096</code></td>
  ...
  REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statements. Also note that the global
  ...
  issuing [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") and
  [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statements with
...
<td><code class="literal">ON</code></td>
  ...
  When `relay_log_recovery` is disabled, the
  ...
  + When a valid source position and source filename are
    ...
    to match the position of the applier
  ...
  Setting [`--relay-log-recovery`](replication-options-replica.html#sysvar_relay_log_recovery)
  at startup automatically handles any inconsistencies and
  gaps in the sequence of transactions that have been executed
  from the relay log. These gaps can occur when file position
  based replication is in use. (For more details, see
  ...
  same method as the
  [`START REPLICA
  UNTIL SQL_AFTER_MTS_GAPS`](start-replica.html "15.4.2.4 START REPLICA Statement") statement would. When the
  ...
  `SOURCE_AUTO_POSITION` is set to
...
<td><code class="literal">ON</code></td>
  ...
  [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement"). Setting
  ...
  subsequent [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement")
  statements.
...
<td><code class="literal">ON</code></td>
  ...
  a [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement, as
  ...
  SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement. In this case, connections to
...
<td>bytes</td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"),
...
<td>bytes</td>
  ...
  [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") commands.
  ...
  [`replication_connection_configuration`](performance-schema-replication-connection-configuration-table.html "29.12.11.12 The replication_connection_configuration Table")
  ...
  SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") to adjust the heartbeat interval to an
...
<td>bytes</td>
  ...
  The replica uses the specified number of worker threads to
  execute transactions, plus a coordinator thread that reads
  transactions from the relay log and schedules them to
  workers. If you are using multiple replication channels, the
  value of this variable applies to the threads used by each
  channel.

  The default value is 4, which means that replicas are
  multithreaded by default.

  For a single worker, set
  `replica_parallel_workers` to 1.

  When
  [`replica_preserve_commit_order`](replication-options-replica.html#sysvar_replica_preserve_commit_order)
  is `ON` (the default), transactions on a
  replica are externalized on the replica in the same order as
  they appear in the replica's relay log. These system
  ...
  [`replica_preserve_commit_order`](replication-options-replica.html#sysvar_replica_preserve_commit_order)
  has no effect and is ignored. With one parallel worker, the
  [`replica_preserve_commit_order`](replication-options-replica.html#sysvar_replica_preserve_commit_order)
  ...
  sure that all tables have primary keys.
...
<td>bytes</td>
  ...
  [`replica_preserve_commit_order=ON`](replication-options-replica.html#sysvar_replica_preserve_commit_order),
  and can be disabled if wanted. Before changing the value of
  [`replica_preserve_commit_order`](replication-options-replica.html#sysvar_replica_preserve_commit_order),
  ...
  + *Group Replication—MySQL 8.0.41 and
...
<td>bytes</td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")'s
...
<td>String</td>
  ...
  Use shared locks, and avoid lock acquisitions, to improve
  performance for semisynchronous replication. This setting
  and
...
<td>String</td>
  ...
  REPLICAS`](show-replicas.html "15.7.7.37 SHOW REPLICAS Statement") on the source server. Leave the value
...
<td>String</td>
  ...
  the output of [`SHOW REPLICAS`](show-replicas.html "15.7.7.37 SHOW REPLICAS Statement")
  on the source server if the source was started with
  [`--show-replica-auth-info`](replication-options-source.html#option_mysqld_show-replica-auth-info).
...
<td>String</td>
  ...
  only if the replica is listening on a non-default port or if
  ...
  displayed by [`SHOW REPLICAS`](show-replicas.html "15.7.7.37 SHOW REPLICAS Statement").
...
<td>String</td>
  ...
  [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") waits before
  timing out by setting this variable. This can be used to
  avoid deadlocks between [`STOP
  REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") and other SQL statements using different
  ...
  [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") statements.

  This variable affects only the client that issues a
  [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") statement. When
  ...
  [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") statement
  remains in effect. Once the replication threads are no
  longer busy, the [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement")
...
<td>String</td>
  ...
  [`SET`](set.html "13.3.7 The SET Type") statement. The
...
<td>String</td>
  ...
  of [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement").
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") mechanism for checking
  ...
  together with `--replica-skip-errors`; doing
  so causes `NDB` to ignore skipped epoch
  transactions.
...
<td>String</td>
  ...
  [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement; the
  next [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement
  ...
  REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") statement can only be used with the
  `FOR CHANNEL
  channel` clause.
  ...
  TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement,
...
<td>String</td>
  ...
  synchronizes its `relay-log.info` file to
  disk (using `fdatasync()`) after this many
  ...
  `sync_relay_log_info` to be removed in a
...
<td>String</td>
  ...
  repository is stored as an
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table (the default, it
  is updated after this number of events. If the connection
  metadata repository is stored as a file (deprecated), the
  replica synchronizes its `master.info` file
  to disk (using `fdatasync()`) after this
...
<td>String</td>
  ...
  applications, set
  `terminology_use_previous` to
  `BEFORE_8_0_26` to make the MySQL server
  ...
  MySQL 9.5 normally displays
  `REPLICA_SIDE_DISABLED` rather than
  `SLAVESIDE_DISABLED` in the output of
  `SHOW CREATE EVENT`, `SHOW
  EVENTS`, and queries against the Information Schema
  `EVENTS` table. You can cause
  `SLAVESIDE_DISABLED` to be shown instead by
  setting `terminology_use_previous` to
  `BEFORE_8_0_26` or
  `BEFORE_8_2_0`.

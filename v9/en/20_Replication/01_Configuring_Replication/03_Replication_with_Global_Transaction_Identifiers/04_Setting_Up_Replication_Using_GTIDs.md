...
GTID-based replication in MySQL 9.5. This is a
...
[`--skip-replica-start`](replication-options-replica.html#option_mysqld_skip-replica-start). For more
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") on
the replica, including the
`SOURCE_AUTO_POSITION` option in the statement

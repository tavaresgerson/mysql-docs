...
* Use MySQL Server's clone plugin to transfer all the data
  ...
  this method, see [Section 7.6.6.7, “Cloning for Replication”](clone-plugin-replication.html "7.6.6.7 Cloning for Replication").
...
[`--source-data`](mysqldump.html#option_mysqldump_source-data) option which
automatically appends the [`CHANGE
REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement required on the
...
If you do not use
[`--source-data`](mysqldump.html#option_mysqldump_source-data), then it is
...
tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) files, unless you have the

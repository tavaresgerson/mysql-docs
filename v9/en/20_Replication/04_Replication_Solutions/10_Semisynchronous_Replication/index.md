...
[`SET autocommit =
0`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")), autocommit is enabled and each statement commits
...
You can improve the performance of semisynchronous replication by
enabling the system variables

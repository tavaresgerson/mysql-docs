...
data from the server, such as [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
(see [Section 6.5.4, “mysqldump — A Database Backup Program”](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")). You should not attempt to
...
use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program").

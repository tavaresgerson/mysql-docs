...
Using [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to create a copy of a
...
[Section 6.5.4, “mysqldump — A Database Backup Program”](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")). Because the format of the
...
your data set is very large, [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") may be
impractical.
...
When using [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"), you should stop
...
2. Run [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to dump your databases. You
...
source. See [Section 19.1.7.1, “Checking Replication Status”](replication-administration-status.html "19.1.7.1 Checking Replication Status").

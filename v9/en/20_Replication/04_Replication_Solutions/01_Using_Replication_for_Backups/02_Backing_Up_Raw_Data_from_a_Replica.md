...
[Section 19.2.4, “Relay Log and Replication Metadata Repositories”](replica-logs.html "19.2.4 Relay Log and Replication Metadata Repositories")), which is the default in MySQL
9.5, these tables are backed up along with the data
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") with
...
DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements, you should also back up any
...
[`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement") operations. The

...
* The replication user account and password cannot be specified
  ...
  TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement on the replica, and recorded in the
...
see [MySQL InnoDB ClusterSet](/doc/mysql-shell/9.5/en/innodb-clusterset.html).
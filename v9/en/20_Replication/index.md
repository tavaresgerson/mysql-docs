...
[19.1 Configuring Replication](replication-configuration.html)
...
[19.2 Replication Implementation](replication-implementation.html)
...
[19.3 Replication Security](replication-security.html)
...
[19.4 Replication Solutions](replication-solutions.html)
...
[19.5 Replication Notes and Tips](replication-notes.html)
:   [19.5.1 Replication Features and Issues](replication-features.html)

    [19.5.2 Replication Compatibility Between MySQL Versions](replication-compatibility.html)

    [19.5.3 Upgrading or Downgrading a Replication Topology](replication-upgrade.html)

    [19.5.4 Troubleshooting Replication](replication-problems.html)

    [19.5.5 How to Report Replication Bugs or Problems](replication-bugs.html)
...
[Section 19.4, “Replication Solutions”](replication-solutions.html "19.4 Replication Solutions").

MySQL 9.5 supports different methods of replication.
...
[Section 19.1.3, “Replication with Global Transaction Identifiers”](replication-gtids.html "19.1.3 Replication with Global Transaction Identifiers"). For information on using binary
...
characteristic of NDB Cluster (see [Chapter 25, *MySQL NDB Cluster 9.5*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")).
In MySQL 9.5, semisynchronous replication is supported
...
[Section 19.4.10, “Semisynchronous Replication”](replication-semisync.html "19.4.10 Semisynchronous Replication"). MySQL 9.5 also
...
[Section 19.4.11, “Delayed Replication”](replication-delayed.html "19.4.11 Delayed Replication"). For scenarios where
*synchronous* replication is required, use NDB
Cluster (see [Chapter 25, *MySQL NDB Cluster 9.5*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")).
...
the available options, see [Section 19.1.2, “Setting Up Binary Log File Position Based Replication”](replication-howto.html "19.1.2 Setting Up Binary Log File Position Based Replication").
...
[Section 19.1.6, “Replication and Binary Logging Options and Variables”](replication-options.html "19.1.6 Replication and Binary Logging Options and Variables"). Additional security measures
...
and their resolution, see [Section 19.5, “Replication Notes and Tips”](replication-notes.html "19.5 Replication Notes and Tips"). For
answers to some questions often asked by those who are new to MySQL
Replication, see [Section A.14, “MySQL 9.5 FAQ: Replication”](faqs-replication.html "A.14 MySQL 9.5 FAQ: Replication").

...
in [Section 19.2.2.4, “Replication Channel Naming Conventions”](channels-naming-conventions.html "19.2.2.4 Replication Channel Naming Conventions"). The error codes
...
When a multi-source replica is also set up as a multi-threaded
replica, each channel on the replica has the specified number of
applier threads, plus a coordinator thread to manage them. You
cannot configure the number of applier threads for individual
channels.
...
[Section 19.2.2.2, “Compatibility with Previous Replication Statements”](channels-with-prev-replication.html "19.2.2.2 Compatibility with Previous Replication Statements"). Statements

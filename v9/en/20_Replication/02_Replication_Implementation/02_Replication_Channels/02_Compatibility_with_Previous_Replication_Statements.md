...
* [`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") starts
  replication threads for all channels, except the
  `group_replication_recovery` and
  `group_replication_applier` channels.

* [`STOP REPLICA`](stop-replica.html "15.4.2.5 STOP REPLICA Statement") stops replication
  threads for all channels, except the
  `group_replication_recovery` and
  `group_replication_applier` channels.

* [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement") reports the
  status for all channels, except the
  `group_replication_applier` channel.

* [`RESET REPLICA`](reset-replica.html "15.4.2.3 RESET REPLICA Statement") resets all
  channels.

Warning

Use [`RESET REPLICA`](reset-replica.html "15.4.2.3 RESET REPLICA Statement") with caution as

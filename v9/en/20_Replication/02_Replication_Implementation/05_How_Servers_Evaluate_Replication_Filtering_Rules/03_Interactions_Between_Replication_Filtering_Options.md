...
[`USE`](use.html "15.8.4 USE Statement") statement, regardless of the
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") statements, triggers,
...
1. If you use row-based binary logging format
   ...
   [`USE`](use.html "15.8.4 USE Statement") statement to set the
   ...
   [Section 7.4.4.2, “Setting The Binary Log Format”](binary-log-setting.html "7.4.4.2 Setting The Binary Log Format") for the conditions that
...
2. If you use statement-based or mixed binary logging format
   ...
   rely on the [`USE`](use.html "15.8.4 USE Statement") statement and
   do not use the database name. Also, do not use multi-table
   DML statements that update both filtered-in and filtered-out
   tables.

**Example 19.7 A [`--replicate-ignore-db`](replication-options-replica.html#option_mysqld_replicate-ignore-db) option and a
...
The DDL statement [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
creates the table in `db1`, as specified by
the preceding [`USE`](use.html "15.8.4 USE Statement") statement.
...
result of the DML [`INSERT`](insert.html "15.2.7 INSERT Statement")
...
* If row-based binary logging format is in use on the source
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement") operation using the
...
* If statement-based binary logging format is in use on the
  ...
  [`USE`](use.html "15.8.4 USE Statement") statement to
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement and relying on
a [`USE`](use.html "15.8.4 USE Statement") statement instead, as
follows:
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement based on the

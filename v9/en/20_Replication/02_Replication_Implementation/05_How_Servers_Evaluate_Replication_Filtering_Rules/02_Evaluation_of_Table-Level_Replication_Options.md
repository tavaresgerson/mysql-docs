...
[`--replicate-ignore-table`](replication-options-replica.html#option_mysqld_replicate-ignore-table) or
...
query. For example, a [`GRANT`](grant.html "15.7.1.6 GRANT Statement")
...
3. Are there any
   [`--replicate-do-table`](replication-options-replica.html#option_mysqld_replicate-do-table) options?

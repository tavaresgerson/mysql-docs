...
most recent
[`ER_BINLOG_UNSAFE_STATEMENT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_binlog_unsafe_statement)
...
* **References to system variables.**
  ...
  [Section 19.5.1.40, “Replication and Variables”](replication-features-variables.html "19.5.1.40 Replication and Variables"). For
...
* **`DEFAULT` clause that refers to a nondeterministic
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"). Unlike most

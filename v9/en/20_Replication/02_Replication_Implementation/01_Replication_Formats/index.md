...
9.5 is `ROW`. NDB Cluster
Replication uses row-based replication; that the
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine is incompatible
...
can expect `binlog_format` to be removed
...
information, see [Section 27.9, “Stored Program Binary Logging”](stored-programs-logging.html "27.9 Stored Program Binary Logging").
...
[Row-based logging of temporary tables](replication-rbr-usage.html#replication-rbr-usage-temptables "Row-based logging of temporary tables").
...
[`DROP TEMPORARY
TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") statements cannot be used inside a transaction,
...
[`autocommit=1`](server-system-variables.html#sysvar_autocommit) is set.
...
[`binlog_format`](replication-options-binary-log.html#sysvar_binlog_format) option.
...
2. Use [`SHOW STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") to check the
   value of the
...
4. When the value is 0, issue a [**mysqladmin
   shutdown**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command to stop the replica.
...
any matching [`--replicate-do-db`](replication-options-replica.html#option_mysqld_replicate-do-db),
...
[`--replicate-ignore-table`](replication-options-replica.html#option_mysqld_replicate-ignore-table) and
...
[`--replicate-wild-ignore-table=norep%`](replication-options-replica.html#option_mysqld_replicate-wild-ignore-table)

...
* Columns common to both versions of the table must be
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement on the replica where a new
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement shown here is executed on the
  replica:
  ...
  The previous [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") is
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement cannot be executed on the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement just
...
* Each “extra” column in the version of the
  ...
  see [Section 13.6, “Data Type Default Values”](data-type-defaults.html "13.6 Data Type Default Values")).
...
`replica_type_conversions` controls the
...
[*empty*]
:   When `replica_type_conversions` is not
...
* Between any of the decimal types
  ...
  [`NUMERIC`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC").
  ...
  [Section 14.25.4, “Rounding Behavior”](precision-math-rounding.html "14.25.4 Rounding Behavior"), for information
...
* Between any of the string types
  ...
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types"), including conversions
...
* Between any of the binary data types
  ...
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"), including conversions
  between different widths.
...
* Between any 2 [`BIT`](bit-type.html "13.1.5 Bit-Value Type - BIT") columns
  of any 2 sizes.

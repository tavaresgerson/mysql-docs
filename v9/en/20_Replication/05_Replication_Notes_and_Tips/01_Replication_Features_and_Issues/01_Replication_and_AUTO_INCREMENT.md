...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values is carried out
...
* An [`INSERT`](insert.html "15.2.7 INSERT Statement") into a table that
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") storage engine, since an
...
* Adding an `AUTO_INCREMENT` column to a
  table with [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") might
  ...
  *all* columns of `t1`.
  ...
  of [`CREATE
  TABLE ... LIKE`](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement"): Foreign key definitions are
  ...
  `t2` using a [`CREATE
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement that is identical to the one used

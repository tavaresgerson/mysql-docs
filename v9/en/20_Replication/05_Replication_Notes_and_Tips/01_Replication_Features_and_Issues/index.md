...
[19.5.1.18 Replication and JavaScript Stored Programs](replication-features-js-programs.html)

[19.5.1.19 Replication and LIMIT](replication-features-limit.html)

[19.5.1.20 Replication and LOAD DATA](replication-features-load-data.html)

[19.5.1.21 Replication and max\_allowed\_packet](replication-features-max-allowed-packet.html)

[19.5.1.22 Replication and MEMORY Tables](replication-features-memory.html)

[19.5.1.23 Replication of the mysql System Schema](replication-features-mysqldb.html)

[19.5.1.24 Replication and the Query Optimizer](replication-features-optimizer.html)

[19.5.1.25 Replication and Partitioning](replication-features-partitioning.html)

[19.5.1.26 Replication and REPAIR TABLE](replication-features-repair-table.html)

[19.5.1.27 Replication and Reserved Words](replication-features-reserved-words.html)

[19.5.1.28 Replication and Row Searches](replication-features-row-searches.html)

[19.5.1.29 Replication and Source or Replica Shutdowns](replication-features-shutdowns.html)

[19.5.1.30 Replica Errors During Replication](replication-features-errors.html)

[19.5.1.31 Replication and Server SQL Mode](replication-features-sql-mode.html)

[19.5.1.32 Replication and Temporary Tables](replication-features-temptables.html)

[19.5.1.33 Replication Retries and Timeouts](replication-features-timeout.html)

[19.5.1.34 Replication and Time Zones](replication-features-timezone.html)

[19.5.1.35 Replication and Transaction Inconsistencies](replication-features-transaction-inconsistencies.html)

[19.5.1.36 Replication and Transactions](replication-features-transactions.html)

[19.5.1.37 Replication and Triggers](replication-features-triggers.html)

[19.5.1.38 Replication and TRUNCATE TABLE](replication-features-truncate.html)

[19.5.1.39 Replication and User Name Length](replication-features-user-names.html)

[19.5.1.40 Replication and Variables](replication-features-variables.html)

[19.5.1.41 Replication and Views](replication-features-views.html)
...
MySQL 9.5 and a previous MySQL release series, it is
...
[Section 27.9, “Stored Program Binary Logging”](stored-programs-logging.html "27.9 Stored Program Binary Logging"). For more information

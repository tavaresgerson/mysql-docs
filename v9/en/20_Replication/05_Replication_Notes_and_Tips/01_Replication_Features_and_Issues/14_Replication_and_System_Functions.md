...
* The [`USER()`](information-functions.html#function_user),
  ...
  [Section 19.5.1.8, “Replication of CURRENT\_USER()”](replication-features-current-user.html "19.5.1.8 Replication of CURRENT_USER()").) This
...
* For [`NOW()`](date-and-time-functions.html#function_now), the binary log
  ...
  *as returned by the call to this function on the
  ...
  `mytable`, perform an
  [`INSERT`](insert.html "15.2.7 INSERT Statement") statement on this
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement") statements just shown
  ...
  See also [Section 19.5.1.34, “Replication and Time Zones”](replication-features-timezone.html "19.5.1.34 Replication and Time Zones").
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") is problematic due to the
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement and is available
for use in the [`INSERT`](insert.html "15.2.7 INSERT Statement").
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement. For example, if
...
should use [`SELECT
... INTO`](select-into.html "15.2.13.1 SELECT ... INTO Statement"), and then store the variable in the table,
like this:

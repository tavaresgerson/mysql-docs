...
possible for the [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement")
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") to repair it, you
should first stop replication (if it is still running) before
using [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), then

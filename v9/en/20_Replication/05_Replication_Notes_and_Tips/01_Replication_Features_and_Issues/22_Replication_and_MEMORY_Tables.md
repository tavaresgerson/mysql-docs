...
[`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") statement for that
...
or [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") statement to
...
where [`replica_exec_mode`](replication-options-replica.html#sysvar_replica_exec_mode) is
always `IDEMPOTENT`, and cannot be changed.)
...
[Section 19.5.1.40, “Replication and Variables”](replication-features-variables.html "19.5.1.40 Replication and Variables")). A change in
`max_heap_table_size` takes effect for
`MEMORY` tables that are created or updated
using [`ALTER TABLE
... ENGINE = MEMORY`](alter-table.html "15.1.11 ALTER TABLE Statement") or [`TRUNCATE
TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") following the change, or for all

...
In MySQL 9.5, it is possible to log partial updates
to JSON documents (see [Partial Updates of JSON Values](json.html#json-partial-updates "Partial Updates of JSON Values")).

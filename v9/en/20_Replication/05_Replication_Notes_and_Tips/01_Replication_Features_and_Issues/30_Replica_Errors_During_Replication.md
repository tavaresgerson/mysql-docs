...
problem. [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement") is
useful for this. Then fix the problem and run
[`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement"). For example, you
...
[`--replica-skip-errors`](replication-options-replica.html#sysvar_replica_skip_errors) option.

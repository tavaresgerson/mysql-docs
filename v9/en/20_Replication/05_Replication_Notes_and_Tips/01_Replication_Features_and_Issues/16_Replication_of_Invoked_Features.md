...
* In the case of [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement")
  and [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement"):

  + The status of the event is set to
    `REPLICA_SIDE_DISABLED` on the replica
    regardless of the state specified (this does not apply
    to [`DROP EVENT`](drop-event.html "15.1.29 DROP EVENT Statement")).
  ...
  + The source on which the event was created is identified
    ...
    [Section 15.7.7.20, “SHOW EVENTS Statement”](show-events.html "15.7.7.20 SHOW EVENTS Statement"), for more information.
...
EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement") statement, like this:
...
[`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement") statement in a
similar fashion:

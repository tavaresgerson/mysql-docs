...
Some forms of the [`FLUSH`](flush.html "15.7.8.3 FLUSH Statement") statement
...
a syntax example, see [Section 15.7.8.3, “FLUSH Statement”](flush.html "15.7.8.3 FLUSH Statement"). The
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") statements are
...
directly without using [`GRANT`](grant.html "15.7.1.6 GRANT Statement"), you

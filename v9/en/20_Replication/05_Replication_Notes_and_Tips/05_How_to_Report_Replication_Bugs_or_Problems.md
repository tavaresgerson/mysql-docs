...
given in [Section 1.6, “How to Report Bugs or Problems”](bug-reports.html "1.6 How to Report Bugs or Problems"). If you have a
...
3. Save all evidence before resetting the replication state. If
   ...
   * The output of [`SHOW BINARY LOG
     STATUS`](show-binary-log-status.html "15.7.7.1 SHOW BINARY LOG STATUS Statement") from the source at the time you
     discovered the problem

   * The output of [`SHOW REPLICA
     STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement") from the replica at the time you
     discovered the problem
...
the instructions at [Section 1.6, “How to Report Bugs or Problems”](bug-reports.html "1.6 How to Report Bugs or Problems").
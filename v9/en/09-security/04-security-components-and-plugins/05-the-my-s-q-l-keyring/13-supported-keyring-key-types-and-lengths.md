...
<table summary="General limits on keyring key lengths."><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Key Operation</th> <th>Maximum Key Length</th> </tr></thead><tbody><tr> <td>Generate key</td> <td><p> 16,384 bytes (2,048 previously); 1,024 for <code class="literal">keyring_aws</code> </p></td> </tr><tr> <td>Store key</td> <td><p> 16,384 bytes (2,048 previously); 4,096 for <code class="literal">keyring_aws</code> </p></td> </tr><tr> <td>Fetch key</td> <td><p> 16,384 bytes (2,048 previously); 4,096 for <code class="literal">keyring_aws</code> </p></td> </tr></tbody></table>

**Table 8.33 Keyring Plugin Key Types and Lengths**

<table summary="Key types and lengths supported by keyring plugins."><col style="width: 30%"/><col style="width: 25%"/><col style="width: 45%"/><thead><tr> <th>Plugin Name</th> <th>Permitted Key Type</th> <th>Plugin-Specific Length Restrictions</th> </tr></thead><tbody><tr> <th valign="top"><code class="literal">keyring_aws</code></th> <td><p> <code class="literal">AES</code> </p><p> <code class="literal">SECRET</code> </p></td> <td><p> 16, 24, or 32 bytes </p><p> None </p></td> </tr><tr> <th valign="top"><code class="literal">keyring_hashicorp</code></th> <td><p> <code class="literal">AES</code> </p><p> <code class="literal">DSA</code> </p><p> <code class="literal">RSA</code> </p><p> <code class="literal">SECRET</code> </p></td> <td><p> None </p><p> None </p><p> None </p><p> None </p></td> </tr><tr> <th valign="top"><code class="literal">keyring_okv</code></th> <td><p> <code class="literal">AES</code> </p><p> <code class="literal">SECRET</code> </p></td> <td><p> 16, 24, or 32 bytes </p><p> None </p></td> </tr></tbody></table>

...
<table frame="box" rules="all" summary="A reference that lists XML functions."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th> <th>Description</th> </tr></thead><tbody><tr><td><code class="literal">ExtractValue()</code></td> <td> Extract a value from an XML string using XPath notation </td> </tr><tr><td><code class="literal">UpdateXML()</code></td> <td> Return replaced XML fragment </td> </tr></tbody></table>

...
<table frame="box" rules="all" summary="A reference that lists flow control operators."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th> <th>Description</th> </tr></thead><tbody><tr><td><code class="literal">CASE</code></td> <td> Case operator </td> </tr><tr><td><code class="literal">IF()</code></td> <td> If/else construct </td> </tr><tr><td><code class="literal">IFNULL()</code></td> <td> Null if/else construct </td> </tr><tr><td><code class="literal">NULLIF()</code></td> <td> Return NULL if expr1 = expr2 </td> </tr></tbody></table>

...
<table frame="box" rules="all" summary="A reference that lists locking functions."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th> <th>Description</th> </tr></thead><tbody><tr><td><code class="literal">GET_LOCK()</code></td> <td> Get a named lock </td> </tr><tr><td><code class="literal">IS_FREE_LOCK()</code></td> <td> Whether the named lock is free </td> </tr><tr><td><code class="literal">IS_USED_LOCK()</code></td> <td> Whether the named lock is in use; return connection identifier if true </td> </tr><tr><td><code class="literal">RELEASE_ALL_LOCKS()</code></td> <td> Release all current named locks </td> </tr><tr><td><code class="literal">RELEASE_LOCK()</code></td> <td> Release the named lock </td> </tr></tbody></table>

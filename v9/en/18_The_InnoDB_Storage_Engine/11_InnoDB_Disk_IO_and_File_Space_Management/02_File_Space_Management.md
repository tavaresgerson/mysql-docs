...
[general
tablespaces](glossary.html#glos_general_tablespace "general tablespace"). General tablespaces are shared tablespaces
created using [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement")
...
[pages](glossary.html#glos_page "page"). Every tablespace in a
MySQL instance has the same [page
size](glossary.html#glos_page_size "page size"). By default, all tablespaces have a page size of
...
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) documentation.

The pages are grouped into
[extents](glossary.html#glos_extent "extent") of size 1MB for pages
...
[segments](glossary.html#glos_segment "segment") in
`InnoDB`. (These segments are different from
the [rollback
segment](glossary.html#glos_rollback_segment "rollback segment"), which actually contains many tablespace
segments.)
...
[B-tree](glossary.html#glos_b_tree "B-tree"), the other is for the
...
issuing a [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement")
...
[purge](/doc/refman/8.4/en/glossary.html#glos_purge) operation, which happens
...
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) settings, the
...
For a 64KB [`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size)
...
length,
[variable-length
columns](glossary.html#glos_variable_length_type "variable-length type") are chosen for external off-page storage until
...
* *COMPACT and REDUNDANT Row Formats*
  ...
  stored. See [Section 17.10, “InnoDB Row Formats”](innodb-row-format.html "17.10 InnoDB Row Formats").
...
* *DYNAMIC and COMPRESSED Row Formats*
  ...
  overflow pages. See [Section 17.10, “InnoDB Row Formats”](innodb-row-format.html "17.10 InnoDB Row Formats").

[`LONGBLOB`](blob.html "13.3.4 The BLOB and TEXT Types") and
[`LONGTEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns

...
You can also use [`ALTER TABLE tbl_name FORCE`](alter-table.html "15.1.11 ALTER TABLE Statement") to perform a “null” alter operation that rebuilds the table.

Both [`ALTER TABLE tbl_name ENGINE=INNODB`](alter-table.html "15.1.11 ALTER TABLE Statement") and [`ALTER TABLE tbl_name FORCE`](alter-table.html "15.1.11 ALTER TABLE Statement") use online DDL. For more information, see Section 17.12, “InnoDB and Online DDL”.

...
* [Configuring Redo Log Capacity](innodb-redo-log.html#innodb-modifying-redo-log-capacity "Configuring Redo Log Capacity")
...
the [`innodb_redo_log_files`](performance-schema-innodb-redo-log-files-table.html "29.12.22.5 The innodb_redo_log_files Table")
...
`InnoDB` automatically calculates and the sets
the values for certain `InnoDB` parameters,
...
[MySQL Enterprise Backup](/doc/mysql-enterprise-backup/en/),
available with [MySQL Enterprise Edition](https://www.mysql.com/products/enterprise/),

...
files, [system
tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) files, [undo
...
* If moving tablespace files to a different operating system
  ...
  [`CREATE TABLE ...
  DATA DIRECTORY`](create-table.html "15.1.24 CREATE TABLE Statement") and
  [`CREATE
  TABLESPACE ... ADD DATAFILE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement").

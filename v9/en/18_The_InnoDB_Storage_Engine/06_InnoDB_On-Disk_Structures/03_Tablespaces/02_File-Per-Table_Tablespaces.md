...
runtime using a
[`SET
GLOBAL`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") statement. Changing the setting at runtime
requires privileges sufficient to set global system variables.
See [Section 7.1.9.1, “System Variable Privileges”](system-variable-privileges.html "7.1.9.1 System Variable Privileges").
...
Using [`SET
GLOBAL`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") at runtime:
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement to
...
* A table-copying [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
* [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") performance is
...
* Tables created in file-per-table tablespaces can be backed
  ...
  [Making a Partial Backup](/doc/mysql-enterprise-backup/9.5/en/partial.html) for details.
...
* [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") must keep an open file handle for
...
* There is potential for more fragmentation, which can impede
  [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") and table scan

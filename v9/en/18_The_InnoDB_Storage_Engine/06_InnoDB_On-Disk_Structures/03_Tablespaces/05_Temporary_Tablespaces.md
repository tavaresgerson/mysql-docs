...
temporary tables use the `InnoDB` storage
engine.
...
[`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table using a query similar
to this one:

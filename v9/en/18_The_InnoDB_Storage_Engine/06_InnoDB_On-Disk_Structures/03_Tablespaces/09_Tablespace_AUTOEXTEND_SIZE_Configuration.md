...
<table summary="The minimum AUTOEXTEND_SIZE for each InnoDB page size"><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
...
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) setting:
...
[`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") cannot be used to
configure the `AUTOEXTEND_SIZE` of a
file-per-table tablespace. [`ALTER
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") must be used.

For tables created in file-per-table tablespaces,
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") shows the

...
system, storage subsystem, or unexpected [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
The doublewrite buffer storage area is located in doublewrite
files.
...
* [`innodb_doublewrite`](innodb-parameters.html#sysvar_innodb_doublewrite)
  ...
  [`innodb_doublewrite`](innodb-parameters.html#sysvar_innodb_doublewrite) supports
...
* [`innodb_doublewrite_dir`](innodb-parameters.html#sysvar_innodb_doublewrite_dir)
  ...
  The [`innodb_doublewrite_dir`](innodb-parameters.html#sysvar_innodb_doublewrite_dir)
  variable defines the directory where `InnoDB`
  creates doublewrite files. If no directory is specified,
...
* [`innodb_doublewrite_files`](innodb-parameters.html#sysvar_innodb_doublewrite_files)
  ...
  The [`innodb_doublewrite_files`](innodb-parameters.html#sysvar_innodb_doublewrite_files)
  variable defines the number of doublewrite files, which
  defaults to 2. By default, two doublewrite files are created
  for each buffer pool instance: A flush list doublewrite file
...
* [`innodb_doublewrite_pages`](innodb-parameters.html#sysvar_innodb_doublewrite_pages)
  ...
  The [`innodb_doublewrite_pages`](innodb-parameters.html#sysvar_innodb_doublewrite_pages)
  variable controls the maximum number of doublewrite pages per
  thread. This variable is intended for advanced performance
...
[Section 17.13, “InnoDB Data-at-Rest Encryption”](innodb-data-encryption.html "17.13 InnoDB Data-at-Rest Encryption")). Likewise, doublewrite

...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement is to be
...
[`CREATE TABLE ...
TABLESPACE`](create-table.html "15.1.24 CREATE TABLE Statement") syntax. For more information, see
...
in the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement. If
you create the table, load data, and then run
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to add a primary key
...
issue a [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement")
statement:
...
STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") output, see

...
* If the table has a foreign key relationship,
  ...
  [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") does not enforce foreign key
...
* If the table was created in an external directory by
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") to view the
...
* If a `ROW_FORMAT` option is not defined
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") to check
  the table definition. Use [`SHOW
  VARIABLES`](show-variables.html "15.7.7.42 SHOW VARIABLES Statement") to check the
  [`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
1. On the destination instance, create a table with the same
   ...
   CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") syntax.) If the table definition does
...
1. On the destination instance, create a partitioned table with
   ...
   [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") syntax.) If
...
1. On the destination instance, create a partitioned table with
   ...
   TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") syntax.) If the table definition does not
...
2. On the destination instance, discard the partitions that you
   ...
   When [`ALTER
   TABLE ... DISCARD PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") is
...
6. On the destination instance, import table partitions
   ...
   When [`ALTER
   TABLE ... IMPORT PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") is run
...
* With the exception of tables that contain instantly added or
  dropped columns,
  [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") does not require a
...
* When running
  [`ALTER TABLE ...
  DISCARD PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") and
  [`ALTER TABLE ...
  IMPORT PARTITION ... TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") on subpartitioned
...
When [`ALTER TABLE
... DISCARD TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") is run on the destination
instance:
...
When [`ALTER TABLE
... IMPORT TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") is run on the destination

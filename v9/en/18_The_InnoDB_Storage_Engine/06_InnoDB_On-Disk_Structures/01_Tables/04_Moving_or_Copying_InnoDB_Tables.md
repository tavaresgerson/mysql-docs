...
* [Importing Tables](innodb-migration.html#copy-tables-import "Importing Tables")
* [MySQL Enterprise Backup](innodb-migration.html#copy-tables-meb "MySQL Enterprise Backup")
* [Copying Data Files (Cold Backup Method)](innodb-migration.html#copy-tables-cold-backup "Copying Data Files (Cold Backup Method)")
* [Restoring from a Logical Backup](innodb-migration.html#copy-tables-logical-backup "Restoring from a Logical Backup")
...
[`DOUBLE`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") data types in your tables,
...
TABLE`](rename-table.html "15.1.41 RENAME TABLE Statement") statement:
...
2. Issue this [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement
...
4. Issue this [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement
   ...
   The [`ALTER TABLE
   ... IMPORT TABLESPACE`](alter-table.html "15.1.11 ALTER TABLE Statement") feature does not enforce
...
* [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") has flushed all modified pages of the
  `.ibd` file from the buffer pool to the file.

You can make a clean backup `.ibd` file using the
following method:

1. Stop all activity from the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server and
   commit all transactions.

2. Wait until [`SHOW
   ENGINE INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") shows that there are no active
...
2. Start a second [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server on the backup
   and let it clean up the `.ibd` files in the
   backup.

##### Restoring from a Logical Backup

You can use a utility such as [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to
...
[`autocommit`](server-system-variables.html#sysvar_autocommit) when importing data.

...
shutdown and restart (see [Section 17.20.3, “Forcing InnoDB Recovery”](forcing-innodb-recovery.html "17.20.3 Forcing InnoDB Recovery")
...
see [Section A.16, “MySQL 9.5 FAQ: InnoDB Change Buffer”](faqs-innodb-change-buffer.html "A.16 MySQL 9.5 FAQ: InnoDB Change Buffer").
...
`none`, and permitted values are described within
the [`innodb_change_buffering`](innodb-parameters.html#sysvar_innodb_change_buffering)
documentation.
...
set to 5. The maximum setting is 50.

...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"). Supported compression
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. However,
[`ALTER TABLE ...
COMPRESSION`](alter-table.html "15.1.11 ALTER TABLE Statement") only updates the tablespace compression
...
table using [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement").
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"). Writes to the
...
table using [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") after
...
[`INNODB_TABLESPACES`](information-schema-innodb-tablespaces-table.html "28.4.24 The INFORMATION_SCHEMA INNODB_TABLESPACES Table") table, in the
following columns:
...
Use [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") to view the
...
check the Information Schema [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table")
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") also shows the
...
* Before downgrading to an earlier version of MySQL that does
  ...
  [`ALTER TABLE ...
  COMPRESSION=None`](alter-table.html "15.1.11 ALTER TABLE Statement") and [`OPTIMIZE

...
about [compression](/doc/refman/8.4/en/glossary.html#glos_compression) for
...
[`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement"). If the row does not
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") and select a larger
...
information, see [Section 15.1.25, “CREATE TABLESPACE Statement”](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement").

##### Compressing BLOB, VARCHAR, and TEXT Columns

In an InnoDB table, [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"),
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"), and
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns that are not part of
...
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") columns may be stored
...
[`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") columns that are less than
...
of [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"),
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"), and
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns in the clustered
...
and I/O costs for [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"),
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"), or
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns, because such data
...
[`innodb_file_per_table`](innodb-parameters.html#sysvar_innodb_file_per_table) setting

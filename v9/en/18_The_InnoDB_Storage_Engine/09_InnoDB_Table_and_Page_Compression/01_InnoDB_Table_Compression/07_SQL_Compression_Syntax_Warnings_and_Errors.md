...
[Table 17.9, “ROW\_FORMAT and KEY\_BLOCK\_SIZE Options”](innodb-compression-syntax-warnings.html#innodb-compression-create-and-alter-options-table "Table 17.9 ROW_FORMAT and KEY_BLOCK_SIZE Options")
...
[Table 17.10, “CREATE/ALTER TABLE Warnings and Errors when InnoDB Strict Mode is OFF”](innodb-compression-syntax-warnings.html#innodb-compression-create-and-alter-errors-table "Table 17.10 CREATE/ALTER TABLE Warnings and Errors when InnoDB Strict Mode is OFF")
summarizes error conditions that occur with certain combinations
of configuration parameters and options on the
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements, and how
...
<td>Ignored for file-per-table tablespaces unless
              ...
              <a class="xref" href="general-tablespaces.html" title="17.6.3.3 General Tablespaces">Section 17.6.3.3, “General Tablespaces”</a>.</td>
...
tablespaces, see [Section 17.6.3.3, “General Tablespaces”](general-tablespaces.html "17.6.3.3 General Tablespaces").
...
The session 1 [`SELECT`](select.html "15.2.13 SELECT Statement") statement
...
The [`SELECT`](select.html "15.2.13 SELECT Statement") statement issued in
session 3 is blocked waiting for the exclusive metadata lock
requested by the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
operation in session 2 to be granted.

You can use
[`SHOW FULL
PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") to determine if transactions are waiting
for a metadata lock.
...
with [`old_alter_table`](server-system-variables.html#sysvar_old_alter_table) enabled to
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") progress. See

...
the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. These
...
* To avoid accidentally making the table unavailable for reads,
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation, specify a clause on the
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement such as
...
* To compare performance between algorithms, run a statement with
  ...
  with the [`old_alter_table`](server-system-variables.html#sysvar_old_alter_table)
  configuration option enabled to force the use of
  `ALGORITHM=COPY`.

* To avoid tying up the server with an [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation that copies the table, include

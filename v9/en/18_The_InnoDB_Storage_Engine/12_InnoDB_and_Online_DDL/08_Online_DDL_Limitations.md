...
* The [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") clause
...
* When running an in-place online DDL operation, the thread that
  runs the [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement
...
* [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") for an
  `InnoDB` table is mapped to an
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation to
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") is supported
...
* Tables created before MySQL 5.6 that include temporal columns
  ...
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types")) and have not been
  rebuilt using  `ALGORITHM=COPY` do not
  support `ALGORITHM=INPLACE`. In this case, an
  [`ALTER TABLE ...
  ALGORITHM=INPLACE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation returns the following
  error:

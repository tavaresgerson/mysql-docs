...
</tr></thead><tbody><tr><th scope="row"><a class="link" href="server-system-variables.html#sysvar_foreign_key_checks">foreign_key_checks</a></th>
<td></td>
<td></td>
<td>Yes</td>
<td></td>
...
<td><code class="literal">OFF</code></td>
  ...
  [Section 17.8.13, “Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server”](innodb-dedicated-server.html "17.8.13 Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server"), before using this
...
<td><code class="literal">OFF</code></td>
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output to it every 15 seconds,
  approximately.
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output generation can affect
  performance, and the
  `innodb_status.pid`
...
* [`innodb_adaptive_flushing`](innodb-parameters.html#sysvar_innodb_adaptive_flushing)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_adaptive_flushing"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--innodb-adaptive-flushing[={OFF|ON}]</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="innodb-parameters.html#sysvar_innodb_adaptive_flushing">innodb_adaptive_flushing</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`innodb_adaptive_flushing_lwm`](innodb-parameters.html#sysvar_innodb_adaptive_flushing_lwm)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_adaptive_flushing_lwm"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--innodb-adaptive-flushing-lwm=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="innodb-parameters.html#sysvar_innodb_adaptive_flushing_lwm">innodb_adaptive_flushing_lwm</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`innodb_adaptive_hash_index`](innodb-parameters.html#sysvar_innodb_adaptive_hash_index)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_adaptive_hash_index"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">OFF</code></td>
  ...
  use
  [`--innodb-adaptive-hash-index`](innodb-parameters.html#sysvar_innodb_adaptive_hash_index) at
...
* [`innodb_adaptive_hash_index_parts`](innodb-parameters.html#sysvar_innodb_adaptive_hash_index_parts)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_adaptive_hash_index_parts"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--innodb-adaptive-hash-index-parts=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="innodb-parameters.html#sysvar_innodb_adaptive_hash_index_parts">innodb_adaptive_hash_index_parts</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>No</td>
...
* [`innodb_adaptive_max_sleep_delay`](innodb-parameters.html#sysvar_innodb_adaptive_max_sleep_delay)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_adaptive_max_sleep_delay"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`innodb_autoextend_increment`](innodb-parameters.html#sysvar_innodb_autoextend_increment)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_autoextend_increment"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--innodb-autoextend-increment=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="innodb-parameters.html#sysvar_innodb_autoextend_increment">innodb_autoextend_increment</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td>megabytes</td>
  ...
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) file when it becomes full. The default value
...
* [`innodb_autoinc_lock_mode`](innodb-parameters.html#sysvar_innodb_autoinc_lock_mode)
  ...
  <table frame="box" rules="all" summary="Properties for innodb_autoinc_lock_mode"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--innodb-autoinc-lock-mode=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="innodb-parameters.html#sysvar_innodb_autoinc_lock_mode">innodb_autoinc_lock_mode</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>No</td>
...
<td><code class="literal">OFF</code></td>
  ...
  extension to `madvise()`, which is supported
  ...
  `MADV_DONTDUMP`, which is typically only
...
<td><code class="literal">OFF</code></td>
  ...
  information, see [Section 17.8.13, “Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server”](innodb-dedicated-server.html "17.8.13 Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server").
...
<td><code class="literal">ON</code></td>
  ...
  [compressed](/doc/refman/8.4/en/glossary.html#glos_compression) tables.
...
<td><code class="literal">ON</code></td>
  ...
  within [compressed](/doc/refman/8.4/en/glossary.html#glos_compression)
...
<td><code class="literal">ON</code></td>
  ...
  `InnoDB`
  [compressed](/doc/refman/8.4/en/glossary.html#glos_compression) tables and
...
<td><code class="literal">ON</code></td>
  ...
  a [compressed](/doc/refman/8.4/en/glossary.html#glos_compression) table or
...
<td><code class="literal">ON</code></td>
  ...
  `InnoDB`
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) data files. The default value is the MySQL
...
<td><code class="literal">70</code></td>
  ...
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace), cannot be defined as the default.
...
<td><code class="literal">70</code></td>
  ...
  respectively. `DETECT_AND_RECOVER` is the
  same as `ON`. With this setting, except that
  ...
  `DETECT_ONLY`, only metadata is written to
...
<td><code class="literal">OFF</code></td>
  ...
  full [purge](/doc/refman/8.4/en/glossary.html#glos_purge) and a change
...
<td><code class="literal">OFF</code></td>
  ...
  See [Section 17.6.3.5, “Temporary Tablespaces”](innodb-temporary-tablespace.html "17.6.3.5 Temporary Tablespaces").
...
<td><code class="literal">OFF</code></td>
  ...
  `O_DIRECT` if supported otherwise defaults to
  ...
  permits [`innodb_flush_method`](innodb-parameters.html#sysvar_innodb_flush_method)
  options that use `fsync()` to use
...
<td>megabytes</td>
  ...
  option. See also [Section 17.20.5, “InnoDB Error Handling”](innodb-error-handling.html "17.20.5 InnoDB Error Handling").
...
<td>megabytes</td>
  ...
  files](glossary.html#glos_log_file "log file") on disk. The default is 64MB. A large
...
<td>megabytes</td>
  ...
  [re-compressed](/doc/refman/8.4/en/glossary.html#glos_compression)
  ...
  the `LOG` section of
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output, or monitoring
...
<td><code class="literal">OFF</code></td>
  ...
  [`SHOW ENGINE
  INNODB MUTEX`](show-engine.html "15.7.7.17 SHOW ENGINE Statement"). For more information, see
...
<td><code class="literal">OFF</code></td>
  ...
  Linux system. The default value is `ON` if
...
<td><code class="literal">OFF</code></td>
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation fails and
...
<td><code class="literal">OFF</code></td>
  ...
  The [`innodb_open_files`](innodb-parameters.html#sysvar_innodb_open_files) limit
  can be set at runtime using a `SELECT
  ...
  [`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")
  statement. To set `innodb_open_files` at
  runtime, use the `SELECT
  innodb_set_open_files_limit(N)`
...
<td><code class="literal">OFF</code></td>
  ...
  [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") performance.
  `InnoDB` reads the clustered index twice
  during a [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") operation.
...
<td><code class="literal">OFF</code></td>
  ...
  STATUS` statement. An occasional
...
<td><code class="literal">OFF</code></td>
  ...
  `InnoDB`
  [purge](/doc/refman/8.4/en/glossary.html#glos_purge) operation. Increasing
...
<td><code class="literal">OFF</code></td>
  ...
  [`innodb_read_ahead_threshold`](innodb-parameters.html#sysvar_innodb_read_ahead_threshold)
  setting. [`SHOW
  ENGINE INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output displays counter
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") also shows the rate at which the
  ...
  the [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output.
...
<td><code class="literal">OFF</code></td>
  ...
  [Section 10.5.8, “Optimizing InnoDB Disk I/O”](optimizing-innodb-diskio.html "10.5.8 Optimizing InnoDB Disk I/O"). The default value
...
<td><code class="literal">OFF</code></td>
  ...
  Enabling [`innodb_read_only`](innodb-parameters.html#sysvar_innodb_read_only)
  prevents creating and dropping tables for all storage engines,
  and not only `InnoDB`. Table creation and
  ...
  + [`ALTER TABLE
    tbl_name
    ENGINE=engine_name`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
<td><code class="literal">OFF</code></td>
  ...
  set automatically if it is not explicitly defined. or more
  information, see [Section 17.8.13, “Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server”](innodb-dedicated-server.html "17.8.13 Enabling Automatic InnoDB Configuration for a Dedicated MySQL Server").
...
<td><code class="literal">OFF</code></td>
  ...
  [online DDL](glossary.html#glos_online_ddl "online DDL") operation,
...
<td><code class="literal">OFF</code></td>
  ...
  [persistent
  statistics](/doc/refman/8.4/en/glossary.html#glos_persistent_statistics) after the data in a table is changed
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. The
...
<td><code class="literal">OFF</code></td>
  ...
  STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement") or when accessing the Information Schema
  [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") or
  [`STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table") tables. (These updates
...
<td><code class="literal">OFF</code></td>
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements to
...
<td><code class="literal">OFF</code></td>
  ...
  `innodb_stats_sample_pages` that was removed
...
<td><code class="literal">OFF</code></td>
  ...
  optimizer using `InnoDB`. (Previously, the
  on-disk storage engine for internal temporary tables was
  determined by the
  [`internal_tmp_disk_storage_engine`](/doc/refman/8.0/en/server-system-variables.html#sysvar_internal_tmp_disk_storage_engine)
...
<td><code class="literal">OFF</code></td>
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations that rebuild the table.

  Online [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations
  ...
  *intermediate* table file in the same
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation reports
  ...
  for online [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
  operations.
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operations, see
...
<td><code class="literal">OFF</code></td>
  ...
  [`CREATE UNDO
  TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") syntax are created in the directory
  defined by the
  [`innodb_undo_directory`](innodb-parameters.html#sysvar_innodb_undo_directory)
...
<td><code class="literal">OFF</code></td>
  ...
  On platforms that support `fdatasync()`
  system calls, having
  [`innodb_use_fdatasync`](innodb-parameters.html#sysvar_innodb_use_fdatasync) enabled
...
* [`innodb_version`](innodb-parameters.html#sysvar_innodb_version)
  ...
  The `InnoDB` version number. This is a legacy

...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement without an `ENGINE`
...
* Its DML operations follow the ACID model, with transactions
  ...
  protect user data. See [Section 17.2, “InnoDB and the ACID Model”](mysql-acid.html "17.2 InnoDB and the ACID Model").
...
* `InnoDB` tables arrange your data on disk to
  ...
  primary key lookups. See [Section 17.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "17.6.2.1 Clustered and Secondary Indexes").
...
* The `InnoDB` enhancements list in
  [Section 1.4, “What Is New in MySQL 9.5”](mysql-nutshell.html "1.4 What Is New in MySQL 9.5").

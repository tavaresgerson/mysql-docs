...
with
[`--default-storage-engine=InnoDB`](server-system-variables.html#sysvar_default_storage_engine)
...
clause to the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
[`ALTER TABLE
table_name ENGINE=InnoDB;`](alter-table.html "15.1.11 ALTER TABLE Statement") for each table. Alternatively,

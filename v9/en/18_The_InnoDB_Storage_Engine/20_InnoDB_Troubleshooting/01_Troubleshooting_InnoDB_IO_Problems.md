...
(`#ib_redoN` files).
If you created any `InnoDB` tables, also delete
...
* Make sure [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") has access rights to
  create files in those directories.

* Make sure [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") can read the proper
  `my.cnf` or `my.ini`
...
* Doublecheck the syntax of the
  ...
  [`innodb_data_file_path`](innodb-parameters.html#sysvar_innodb_data_file_path) values.

...
* [Section 17.7.1, “InnoDB Locking”](innodb-locking.html "17.7.1 InnoDB Locking") describes lock types used by
  `InnoDB`.

* [Section 17.7.2, “InnoDB Transaction Model”](innodb-transaction-model.html "17.7.2 InnoDB Transaction Model") describes transaction
...
* [Section 17.7.3, “Locks Set by Different SQL Statements in InnoDB”](innodb-locks-set.html "17.7.3 Locks Set by Different SQL Statements in InnoDB") discusses specific types of
  locks set in `InnoDB` for various statements.

* [Section 17.7.4, “Phantom Rows”](innodb-next-key-locking.html "17.7.4 Phantom Rows") describes how
  `InnoDB` uses next-key locking to avoid phantom
  rows.

* [Section 17.7.5, “Deadlocks in InnoDB”](innodb-deadlocks.html "17.7.5 Deadlocks in InnoDB") provides a deadlock example,

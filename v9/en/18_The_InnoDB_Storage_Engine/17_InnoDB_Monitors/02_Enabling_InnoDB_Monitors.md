...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output, you are only required to enable
[`innodb_status_output_locks`](innodb-parameters.html#sysvar_innodb_status_output_locks).
...
INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") SQL statement, which fetches the output to
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") output also includes `InnoDB`

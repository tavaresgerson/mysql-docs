...
* The `autocommit` setting.
* Transaction isolation levels and the [`SET TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement. See Section 17.7.2.1, “Transaction Isolation Levels”.

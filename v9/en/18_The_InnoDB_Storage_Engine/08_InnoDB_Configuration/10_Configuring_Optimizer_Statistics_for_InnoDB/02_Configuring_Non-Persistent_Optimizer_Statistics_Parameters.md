...
[`STATS_PERSISTENT=0`](create-table.html "15.1.24 CREATE TABLE Statement").
...
* Running [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement"),
  [`SHOW INDEX`](show-index.html "15.7.7.24 SHOW INDEX Statement"), or querying the
  Information Schema [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") or
  [`STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table") tables with the

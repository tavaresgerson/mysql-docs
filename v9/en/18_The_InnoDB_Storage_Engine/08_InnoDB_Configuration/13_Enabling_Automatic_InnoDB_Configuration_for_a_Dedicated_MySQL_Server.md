...
[`--innodb-dedicated-server`](innodb-parameters.html#option_mysqld_innodb-dedicated-server) and
...
[`--innodb-dedicated-server`](innodb-parameters.html#option_mysqld_innodb-dedicated-server) (or
with `--innodb-dedicated-server=ON` or

...
[threads](glossary.html#glos_thread "thread") to service various
...
[`innodb_read_io_threads`](innodb-parameters.html#sysvar_innodb_read_io_threads) is the
number of available logical processors on the system divided by 2,
with a minimum default value of `4`. The default
value for [`innodb_write_io_threads`](innodb-parameters.html#sysvar_innodb_write_io_threads)
...
[read-ahead](glossary.html#glos_read_ahead "read-ahead") requests.
...
[`innodb_read_io_threads`](innodb-parameters.html#sysvar_innodb_read_io_threads) pending
...
performance, see [Section 10.5.8, “Optimizing InnoDB Disk I/O”](optimizing-innodb-diskio.html "10.5.8 Optimizing InnoDB Disk I/O").
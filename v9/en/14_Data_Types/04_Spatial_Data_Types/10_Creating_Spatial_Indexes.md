...
* With [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"):

  ```
  CREATE TABLE geom (g GEOMETRY NOT NULL SRID 4326, SPATIAL INDEX(g));
  ```

* With [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"):
...
* With [`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement"):
...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") or [`DROP INDEX`](drop-index.html "15.1.31 DROP INDEX Statement"):
...
* With [`DROP INDEX`](drop-index.html "15.1.31 DROP INDEX Statement"):

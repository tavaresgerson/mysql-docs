...
[Section 11.1.3, “Date and Time Literals”](date-and-time-literals.html "11.1.3 Date and Time Literals"). For information about
fractional seconds support in MySQL, see
[Section 13.2.6, “Fractional Seconds in Time Values”](fractional-seconds.html "13.2.6 Fractional Seconds in Time Values"). In particular, any
...
errors to occur. See [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").
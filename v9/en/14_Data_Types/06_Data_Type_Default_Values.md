...
* An expression default value for one column can refer to
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to reorder table
...
For [`CREATE
TABLE ... LIKE`](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement") and
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"), the destination table preserves
...
because replicas might diverge. When
[`binlog_format`](replication-options-binary-log.html#sysvar_binlog_format) is set to
`MIXED` or `ROW`, the
...
[`ER_UNSUPPORTED_ACTION_ON_DEFAULT_VAL_GENERATED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_unsupported_action_on_default_val_generated)
error occurs.
...
TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") statement displays which columns have an
...
* For string types other than
  [`ENUM`](enum.html "13.3.6 The ENUM Type"), the default value is
  the empty string. For [`ENUM`](enum.html "13.3.6 The ENUM Type"),

...
For [`CREATE TABLE ... LIKE`](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement") and [`CREATE TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement"), the destination table preserves expression default values from the original table.
...
For a given table, the [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") statement displays which columns have an explicit `DEFAULT` clause.

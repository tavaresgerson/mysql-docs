...
[`INT(4)`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") specifies an
[`INT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") with a display width of four
...
[`SMALLINT(3)`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") has the usual
[`SMALLINT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") range of
`-32768` to `32767`, and
...
declared as [`INT(4) ZEROFILL`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), a
...
[`UNION`](union.html "15.2.18 UNION Clause") queries.
...
integer data types. You should expect support for
...
if an [`INT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column is
...
values remains the same. `UNSIGNED` is
...
[`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") (and any synonyms) and
...
[`NO_AUTO_VALUE_ON_ZERO`](sql-mode.html#sqlmode_no_auto_value_on_zero) SQL mode
is enabled.
...
`AUTO_INCREMENT` is deprecated for
[`FLOAT`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") and
[`DOUBLE`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") columns; you should expect
support for it to be removed in a future version of MySQL.
Consider removing the `AUTO_INCREMENT`
attribute from such columns to avoid potential compatibility
issues, or convert them to an integer type.
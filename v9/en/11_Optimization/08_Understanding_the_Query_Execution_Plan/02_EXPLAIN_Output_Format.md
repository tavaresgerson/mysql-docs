...
* `ref` (JSON name: `ref`)
  ...
  [`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") following
...
* `Plan is not ready yet` (JSON property:
  none)
...
* `Range checked for each record (index map:
  ...
  as shown by [`SHOW INDEX`](show-index.html "15.7.7.24 SHOW INDEX Statement") for
...
* `Using index` (JSON property:
  ...
  `EXPLAIN FORMAT=JSON`. It is also shown
...
* `Using where with pushed condition` (JSON
  ...
  This item applies to [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to lengthen
...
[Optimizing IN and EXISTS Subquery Predicates with Semijoin Transformations](/doc/refman/8.0/en/semijoins.html).)

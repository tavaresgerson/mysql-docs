...
[Chapter 18, *Alternative Storage Engines*](storage-engines.html "Chapter 18 Alternative Storage Engines"). All storage engines support
...
* [Index Prefixes](column-indexes.html#column-indexes-prefix "Index Prefixes")
* [FULLTEXT Indexes](column-indexes.html#column-indexes-fulltext "FULLTEXT Indexes")
* [Spatial Indexes](column-indexes.html#column-indexes-spatial "Spatial Indexes")
* [Indexes in the MEMORY Storage Engine](column-indexes.html#column-indexes-memory-storage-engine "Indexes in the MEMORY Storage Engine")
...
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column, you
...
length in [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"),
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), and
[`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement") statements is
...
searches. Only the [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") and
...
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") for full-text queries

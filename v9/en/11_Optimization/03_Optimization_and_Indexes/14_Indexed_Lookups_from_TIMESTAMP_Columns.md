...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns as UTC values,
and values inserted into and retrieved from
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns are converted
between the session time zone and UTC. (This is the same type of
conversion performed by the
[`CONVERT_TZ()`](date-and-time-functions.html#function_convert-tz) function. If the
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column query, depending
...
* Unique UTC values stored in the
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column are not
...
[`FROM_UNIXTIME()`](date-and-time-functions.html#function_from-unixtime) and

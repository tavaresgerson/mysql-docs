...
* Strings are automatically prefix- and end-space compressed in `MyISAM` indexes. See Section 15.1.18, “CREATE INDEX Statement”.
...
<table summary="myisamchk variables and corresponding server system variables."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th><a class="link" href="myisamchk.html" title="6.6.4 myisamchk — MyISAM Table-Maintenance Utility"><span class="command"><strong>myisamchk</strong></span></a> Variable</th> <th>System Variable</th> </tr></thead><tbody><tr> <td><code class="literal">key_buffer_size</code></td> <td><a class="link" href="server-system-variables.html#sysvar_key_buffer_size"><code class="literal">key_buffer_size</code></a></td> </tr><tr> <td><code class="literal">myisam_sort_buffer_size</code></td> <td><a class="link" href="server-system-variables.html#sysvar_myisam_sort_buffer_size"><code class="literal">myisam_sort_buffer_size</code></a></td> </tr><tr> <td><code class="literal">read_buffer_size</code></td> <td><a class="link" href="server-system-variables.html#sysvar_read_buffer_size"><code class="literal">read_buffer_size</code></a></td> </tr><tr> <td><code class="literal">write_buffer_size</code></td> <td>none</td> </tr></tbody></table>

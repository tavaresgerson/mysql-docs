...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement instead of symbolic links, as
explained in [Section 17.6.1.2, “Creating Tables Externally”](innodb-create-table-external.html "17.6.1.2 Creating Tables Externally").

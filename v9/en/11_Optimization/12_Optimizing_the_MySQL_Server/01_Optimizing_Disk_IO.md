...
* Increase the number of available disk spindles (and thereby
  ...
  + Using symbolic links
    ...
    see [Section 10.5.8, “Optimizing InnoDB Disk I/O”](optimizing-innodb-diskio.html "10.5.8 Optimizing InnoDB Disk I/O").
  ...
  + Striping
    ...
    See [Section 10.13.2, “Using Your Own Benchmarks”](custom-benchmarks.html "10.13.2 Using Your Own Benchmarks").

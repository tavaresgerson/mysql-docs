...
* ICP is used for the
  ...
  [`eq_ref`](explain-output.html#jointype_eq_ref), and
  [`ref_or_null`](explain-output.html#jointype_ref_or_null) access
  methods when there is a need to access full table rows.

* ICP can be used for [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine")
  and [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") tables, including
...
* Conditions cannot be pushed down to derived tables
...
See [Section 10.9.2, “Switchable Optimizations”](switchable-optimizations.html "10.9.2 Switchable Optimizations").
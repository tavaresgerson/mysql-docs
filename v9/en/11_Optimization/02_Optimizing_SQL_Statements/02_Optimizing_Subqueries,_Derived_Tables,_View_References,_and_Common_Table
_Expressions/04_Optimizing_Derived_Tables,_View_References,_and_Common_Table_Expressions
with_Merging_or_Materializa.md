...
* Similarly, you can use the
  ...
  [`ER_UPDATE_TABLE_USED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_update_table_used)
  errors.
  ...
  [`ER_UPDATE_TABLE_USED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_update_table_used) error
...
[`CREATE VIEW`](create-view.html "15.1.27 CREATE VIEW Statement") does not affect

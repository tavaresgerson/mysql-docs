...
Examining a trace in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") command-line
...
[`end_markers_in_json`](server-system-variables.html#sysvar_end_markers_in_json) is

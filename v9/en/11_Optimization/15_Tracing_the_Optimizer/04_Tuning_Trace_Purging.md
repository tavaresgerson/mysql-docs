...
by setting the
[`optimizer_trace_offset`](server-system-variables.html#sysvar_optimizer_trace_offset) and
[`optimizer_trace_limit`](server-system-variables.html#sysvar_optimizer_trace_limit) system
variables, like this:
...
[`SET`](set.html "13.3.7 The SET Type") statement has the following
effects:

* All traces previously stored are cleared from memory.
* A subsequent [`SELECT`](select.html "15.2.13 SELECT Statement") from the
  [`OPTIMIZER_TRACE`](information-schema-optimizer-trace-table.html "28.3.24 The INFORMATION_SCHEMA OPTIMIZER_TRACE Table") table returns the

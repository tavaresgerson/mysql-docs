...
* Are the right
  [indexes](optimization-indexes.html "10.3 Optimization and Indexes") in place
...
* Does the application use an appropriate
  [locking strategy](locking-issues.html "10.11 Optimizing Locking Operations")? For
...
* Are all [memory areas used
  for caching](buffering-caching.html "10.10 Buffering and Caching") sized correctly? That is, large enough to
...
writing comments, see [Section 11.7, “Comments”](comments.html "11.7 Comments").
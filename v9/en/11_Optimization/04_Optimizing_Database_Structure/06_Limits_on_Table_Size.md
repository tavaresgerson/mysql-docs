...
* You are using `InnoDB` tables and have run
  ...
  [Section 17.21, “InnoDB Limits”](innodb-limits.html "17.21 InnoDB Limits").
...
* You are using a `MyISAM` table and the
  ...
  large files, the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  statement supports `AVG_ROW_LENGTH` and
  `MAX_ROWS` options. See
  [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"). The server uses these
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to increase a table's maximum
  permissible size. See [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement").
  ...
  for tables with [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") or
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns; in this case,
  ...
  /path/to/table-index-file**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility"). See
  [Section 15.7.7, “SHOW Statements”](show.html "15.7.7 SHOW Statements"), or [Section 6.6.4, “myisamchk — MyISAM Table-Maintenance Utility”](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").

  Other ways to work around file-size limits for
  `MyISAM` tables are as follows:

  + If your large table is read only, you can use
    [**myisampack**](myisampack.html "6.6.6 myisampack — Generate Compressed, Read-Only MyISAM Tables") to compress it.
    [**myisampack**](myisampack.html "6.6.6 myisampack — Generate Compressed, Read-Only MyISAM Tables") usually compresses a table
    by at least 50%, so you can have, in effect, much bigger
    tables. [**myisampack**](myisampack.html "6.6.6 myisampack — Generate Compressed, Read-Only MyISAM Tables") also can merge
  ...
  + MySQL includes a `MERGE` library that
    ...
    See [Section 18.7, “The MERGE Storage Engine”](merge-storage-engine.html "18.7 The MERGE Storage Engine").

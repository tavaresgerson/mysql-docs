...
When you execute a [**mysqladmin status**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program")
...
variable. See [Section B.3.2.16, “File Not Found and Similar Errors”](not-enough-file-handles.html "B.3.2.16 File Not Found and Similar Errors").
...
* When a table-flushing operation occurs. This happens when
  ...
  [**mysqladmin flush-tables**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") or
  [**mysqladmin refresh**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command.

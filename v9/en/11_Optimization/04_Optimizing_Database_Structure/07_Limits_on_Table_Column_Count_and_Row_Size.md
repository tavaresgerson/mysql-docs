...
* Storage engines may impose additional restrictions that
  ...
  columns per table. See [Section 17.21, “InnoDB Limits”](innodb-limits.html "17.21 InnoDB Limits").
...
* Functional key parts (see [Section 15.1.18, “CREATE INDEX Statement”](create-index.html "15.1.18 CREATE INDEX Statement"))

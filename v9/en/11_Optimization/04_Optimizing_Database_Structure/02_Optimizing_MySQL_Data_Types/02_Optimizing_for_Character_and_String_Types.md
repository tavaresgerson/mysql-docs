...
* Use binary collation order for fast comparison and sort
  ...
  [`BINARY`](cast-functions.html#operator_binary) operator to use binary
...
* See [Section 10.4.2.1, “Optimizing for Numeric Data”](optimize-numeric.html "10.4.2.1 Optimizing for Numeric Data") for reasons why a

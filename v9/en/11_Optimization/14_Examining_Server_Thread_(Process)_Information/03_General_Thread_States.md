...
* `committing alter table to storage engine`
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") and is committing
  the result.
...
* `copy to tmp table`
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. This state occurs after the table
...
* `Opening tables`
  ...
  example, an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") or a
  [`LOCK
...
* `rename result table`
  ...
  The thread is processing an [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement, has created the new table, and is
...
* `setup`
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation.
...
* `System lock`
  ...
  [`SHOW PROFILE`](show-profile.html "15.7.7.33 SHOW PROFILE Statement"), this state

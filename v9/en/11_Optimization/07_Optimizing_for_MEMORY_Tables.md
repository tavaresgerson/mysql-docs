...
hash index. On the [`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement")
...
[Section 10.2.1.23, “Avoiding Full Table Scans”](table-scan-avoidance.html "10.2.1.23 Avoiding Full Table Scans"). For implementation details

...
* Increase buffer pool size
  ...
  information see, [Section 10.12.3.1, “How MySQL Uses Memory”](memory-use.html "10.12.3.1 How MySQL Uses Memory").

* Adjust the flush method

  In some versions of GNU/Linux and Unix, flushing files to
  disk with the Unix `fsync()` call and
...
* Use fdatasync() instead of fsync()
  ...
  variable permits using `fdatasync()`
  instead of `fsync()` for operating system
  flushes. An `fdatasync()` system call does
...
* Use direct I/O on Solaris 10 for x86\_64 architecture
  ...
  [`innodb_flush_method =
  O_DIRECT`](innodb-parameters.html#sysvar_innodb_flush_method). With this setting,
  `InnoDB` calls
  `directio()` instead of
...
* Use raw storage for data and log files with Solaris 2.6 or
  ...
  [`innodb_flush_method`](innodb-parameters.html#sysvar_innodb_flush_method) if you
...
* Consider non-rotational storage
  ...
  and [general
  tablespace](glossary.html#glos_general_tablespace "general tablespace") data files,
  [undo tablespace](glossary.html#glos_undo_tablespace "undo tablespace")
  files, and
  [temporary
  tablespace](/doc/refman/8.4/en/glossary.html#glos_temporary_tablespace) files. Sequential I/O-oriented files
  include `InnoDB`
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace) files, doublewrite files, and log files
  such as [binary log](glossary.html#glos_binary_log "binary log")
  files and [redo log](glossary.html#glos_redo_log "redo log")
  files.
  ...
  + [`innodb_io_capacity_max`](innodb-parameters.html#sysvar_innodb_io_capacity_max)
    ...
    [`innodb_io_capacity`](innodb-parameters.html#sysvar_innodb_io_capacity)) is
  ...
  + [`innodb_log_compressed_pages`](innodb-parameters.html#sysvar_innodb_log_compressed_pages)
    ...
    [Disable
    logging of compressed pages](optimizing-innodb-diskio.html#innodb-disable-log-compressed-pages).
...
* Increase I/O capacity to avoid backlogs
  ...
  `InnoDB`
  [checkpoint](glossary.html#glos_checkpoint "checkpoint")
  operations, consider increasing the value of the
  [`innodb_io_capacity`](innodb-parameters.html#sysvar_innodb_io_capacity)
  configuration option. Higher values cause more frequent
  [flushing](glossary.html#glos_flush "flush"), avoiding the
...
* Lower I/O capacity if flushing does not fall behind
  ...
  `InnoDB`
  [flushing](glossary.html#glos_flush "flush") operations,
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement"):
  ...
  + `Log sequence number - Last checkpoint`
    ...
    [log files](glossary.html#glos_log_file "log file").
...
* Store system tablespace files on Fusion-io devices
  ...
  [Section 17.6.4, “Doublewrite Buffer”](innodb-doublewrite-buffer.html "17.6.4 Doublewrite Buffer").) When
...
* Disable logging of compressed pages
  ...
  [compression](/doc/refman/8.4/en/glossary.html#glos_compression) feature,
  images of re-compressed
  [pages](glossary.html#glos_page "page") are written to the
  [redo log](glossary.html#glos_redo_log "redo log") when changes

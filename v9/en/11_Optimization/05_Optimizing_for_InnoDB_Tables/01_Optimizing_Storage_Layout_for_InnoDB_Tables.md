...
* In `InnoDB`, having a long `PRIMARY
  ...
  the same row. (See [Section 17.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "17.6.2.1 Clustered and Secondary Indexes").)
...
* Use the [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") data type
  instead of [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") to store

...
* [Cost Model General Operation](cost-model.html#cost-model-operation "Cost Model General Operation")
* [The Cost Model Database](cost-model.html#cost-model-database "The Cost Model Database")
* [Making Changes to the Cost Model Database](cost-model.html#cost-model-database-modifications "Making Changes to the Cost Model Database")
...
* At runtime, the server may re-read the cost tables. This
  ...
  a [`FLUSH OPTIMIZER_COSTS`](flush.html#flush-optimizer-costs)
...
* Cost tables enable server administrators to easily adjust
  ...
  [`FLUSH OPTIMIZER_COSTS`](flush.html#flush-optimizer-costs) to
  take effect.
...
* `cost_value`
  ...
  execute [`FLUSH
  OPTIMIZER_COSTS`](flush.html#flush-optimizer-costs) to tell the server to re-read
  the cost tables.

...
As of MySQL 9.5, the compound-part
...
cache, use the [`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement")
statement (see [Section 15.7.8.2, “CACHE INDEX Statement”](cache-index.html "15.7.8.2 CACHE INDEX Statement")). For example,
...
INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") statement can be created by setting its size
with a [`SET
GLOBAL`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") parameter setting statement or by using
...
[`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) is the cache
component. See [Section 7.1.9.5, “Structured System Variables”](structured-system-variables.html "7.1.9.5 Structured System Variables"),
...
The [`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") statement sets
...
INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") statements to be executed. For example:

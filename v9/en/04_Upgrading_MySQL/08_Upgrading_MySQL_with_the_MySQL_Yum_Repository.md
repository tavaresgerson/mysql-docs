...
1. ### Selecting a Target Series
   ...
   * For important information about upgrading from MySQL 5.7 to 8.0, see [Upgrading from MySQL 5.7 to 8.0](/doc/refman/8.0/en/upgrading-from-previous-series.html).

   * For important information about upgrading from MySQL 8.0 to 8.4, see [Upgrading from MySQL 8.0 to 8.4](/doc/refman/8.4/en/upgrading-from-previous-series.html).

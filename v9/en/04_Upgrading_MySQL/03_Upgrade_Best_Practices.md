...
The MySQL Release Model makes a distinction between LTS (Long Term Support) and Innovation Releases. LTS releases have 8+ years of support and are meant for production use. Innovation Releases provide users with the latest features and capabilities. Learn more about the [MySQL Release Model](mysql-releases).
...
* [An in-place upgrade](upgrade-binary-package.html#upgrade-procedure-inplace "In-Place Upgrade"): Replacing the MySQL Server packages.

* [A logical upgrade](upgrade-binary-package.html#upgrade-procedure-logical "Logical Upgrade"): exporting SQL from the old MySQL instance to the new.

* [A replication topology upgrade](replication-upgrade.html "19.5.3 Upgrading or Downgrading a Replication Topology"): account for each server's topology role.
...
See: Section 3.5, “Changes in MySQL 9.5”.

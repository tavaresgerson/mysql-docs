...
* [Decide on Major or Minor Version for Upgrade](upgrade-best-practices.html#upgrade-best-practices-version "Decide on Major or Minor Version for Upgrade")
* [Decide on Upgrade Type](upgrade-best-practices.html#upgrade-best-practices-type "Decide on Upgrade Type")
* [Review Supported Platforms](upgrade-best-practices.html#upgrade-best-practices-platform "Review Supported Platforms")
* [Understand MySQL Server Changes](upgrade-best-practices.html#upgrade-best-practices-changes "Understand MySQL Server Changes")
* [Run Upgrade Checker and Fix Incompatibilities](upgrade-best-practices.html#upgrade-best-practices-check "Run Upgrade Checker and Fix Incompatibilities")
* [Run Applications in a Test Environment](upgrade-best-practices.html#upgrade-best-practices-test "Run Applications in a Test Environment")
* [Benchmark Applications and Workload Performance](upgrade-best-practices.html#upgrade-best-practices-benchmark "Benchmark Applications and Workload Performance")
* [Run Both MySQL Versions in Parallel](upgrade-best-practices.html#upgrade-best-practices-compare "Run Both MySQL Versions in Parallel")
* [Run Final Test Upgrade](upgrade-best-practices.html#upgrade-best-practices-final-test "Run Final Test Upgrade")
* [Check MySQL Backup](upgrade-best-practices.html#upgrade-best-practices-backup "Check MySQL Backup")
* [Upgrade Production Server](upgrade-best-practices.html#upgrade-best-practices-production "Upgrade Production Server")
* [Enterprise Support](upgrade-best-practices.html#upgrade-best-practices-support "Enterprise Support")
...
more about the [MySQL Release
Model](mysql-releases).
...
* [An in-place
  upgrade](upgrade-binary-package.html#upgrade-procedure-inplace "In-Place Upgrade"): Replacing the MySQL Server packages.

* [A logical
  upgrade](upgrade-binary-package.html#upgrade-procedure-logical "Logical Upgrade"): exporting SQL from the old MySQL instance to
  the new.

* [A replication topology
  upgrade](replication-upgrade.html "19.5.3 Upgrading or Downgrading a Replication Topology"): account for each server's topology role.
...
See: [Section 3.5, “Changes in MySQL 9.5”](upgrading-from-previous-series.html "3.5 Changes in MySQL 9.5").

### Run Upgrade Checker and Fix Incompatibilities

MySQL Shell's [Upgrade Checker Utility](/doc/mysql-shell/9.5/en/mysql-shell-utilities-upgrade.html)
...
[Valid Performance Regressions](/doc/refman/8.0/en/upgrading-from-previous-series.html#upgrade-performance-regressions).

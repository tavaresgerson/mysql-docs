...
[Section 1.7.1, “MySQL Extensions to Standard SQL”](extensions-to-ansi.html "1.7.1 MySQL Extensions to Standard SQL"). The
...
[`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) can only
...
<td>Table and database names are stored on disk using the lettercase
              specified in the <a class="link" href="create-table.html" title="15.1.24 CREATE TABLE Statement"><code class="literal">CREATE
              TABLE</code></a> or <a class="link" href="create-database.html" title="15.1.14 CREATE DATABASE Statement"><code class="literal">CREATE
...
* Use `lower_case_table_names=1` on all
  ...
  use [`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") or
  [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement"), you do not
...
* Use `lower_case_table_names=0` on Unix and
  ...
  **Exception**: If you are using
  ...
  [`lower_case_table_names=1`](server-system-variables.html#sysvar_lower_case_table_names) on
...
[`PREPARE`](prepare.html "15.5.1 PREPARE Statement"), tables, triggers, users,

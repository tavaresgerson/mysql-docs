...
* [Defining and Accessing Query Attributes](query-attributes.html#using-query-attributes "Defining and Accessing Query Attributes")
* [Prerequisites for Using Query Attributes](query-attributes.html#query-attributes-prerequisites "Prerequisites for Using Query Attributes")
* [Query Attribute Loadable Functions](query-attributes.html#query-attribute-functions "Query Attribute Loadable Functions")

### Defining and Accessing Query Attributes

Applications that use the MySQL C API define query attributes by
calling the [`mysql_bind_param()`](/doc/c-api/9.5/en/mysql-bind-param.html)
function. See [mysql\_bind\_param()](/doc/c-api/9.5/en/mysql-bind-param.html). Other MySQL
...
[Prerequisites for Using Query Attributes](query-attributes.html#query-attributes-prerequisites "Prerequisites for Using Query Attributes"). The component
implements a
[`mysql_query_attribute_string()`](query-attributes.html#function_mysql-query-attribute-string)
...
The following examples use the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client
...
[`mysql_query_attribute_string()`](query-attributes.html#function_mysql-query-attribute-string)
function. See [Section 7.5.4, “Query Attribute Components”](query-attribute-components.html "7.5.4 Query Attribute Components").
...
* [`mysql_query_attribute_string(name)`](query-attributes.html#function_mysql-query-attribute-string)
  ...
  [Section 11.6, “Query Attributes”](query-attributes.html "11.6 Query Attributes"), which also discusses the
  ...
  The following example uses the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")

...
<table summary="Permissible transport protocol values, the resulting transport protocol used, and the applicable platforms for each value."><col style="width: 20%"/><col style="width: 50%"/><col style="width: 30%"/><thead><tr> <th><code>--protocol</code> Value</th> <th>Transport Protocol Used</th> <th>Applicable Platforms</th> </tr></thead><tbody><tr> <th><code class="literal">TCP</code></th> <td>TCP/IP</td> <td>All</td> </tr><tr> <th><code class="literal">SOCKET</code></th> <td>Unix socket file</td> <td>Unix and Unix-like systems</td> </tr><tr> <th><code class="literal">PIPE</code></th> <td>Named pipe</td> <td>Windows</td> </tr><tr> <th><code class="literal">MEMORY</code></th> <td>Shared memory</td> <td>Windows</td> </tr></tbody></table>

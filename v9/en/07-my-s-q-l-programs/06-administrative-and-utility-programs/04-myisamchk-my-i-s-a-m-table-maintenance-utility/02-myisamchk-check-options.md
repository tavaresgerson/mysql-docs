...
* `--check-only-changed`, `-C`
  ...
  <table frame="box" rules="all" summary="Properties for check-only-changed"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--check-only-changed</code></td> </tr></tbody></table>
...
* `--fast`, `-F`
  ...
  <table frame="box" rules="all" summary="Properties for fast"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--fast</code></td> </tr></tbody></table>
...
* `--information`, `-i`
  ...
  <table frame="box" rules="all" summary="Properties for information"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--information</code></td> </tr></tbody></table>

  Print informational statistics about the table that is checked.

* `--medium-check`, `-m`

  <table frame="box" rules="all" summary="Properties for medium-check"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--medium-check</code></td> </tr></tbody></table>
...
* `--read-only`, `-T`
  ...
  <table frame="box" rules="all" summary="Properties for read-only"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--read-only</code></td> </tr></tbody></table>
...
* `--update-state`, `-U`
  ...
  <table frame="box" rules="all" summary="Properties for update-state"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--update-state</code></td> </tr></tbody></table>

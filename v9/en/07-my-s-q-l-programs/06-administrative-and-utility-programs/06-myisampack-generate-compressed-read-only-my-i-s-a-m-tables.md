...
* `--join=big_tbl_name`, `-j big_tbl_name`
  ...
  <table frame="box" rules="all" summary="Properties for join"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--join=big_tbl_name</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>
...
* `--test`, `-t`
  ...
  <table frame="box" rules="all" summary="Properties for test"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--test</code></td> </tr></tbody></table>

  Do not actually pack the table, just test packing it.

* `--tmpdir=dir_name`, `-T dir_name`

  <table frame="box" rules="all" summary="Properties for tmpdir"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--tmpdir=dir_name</code></td> </tr><tr><th>Type</th> <td>Directory name</td> </tr></tbody></table>

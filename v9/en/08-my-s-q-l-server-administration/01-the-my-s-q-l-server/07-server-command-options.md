...
* `--daemonize`, `-D`
  ...
  <table frame="box" rules="all" summary="Properties for daemonize"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--daemonize[={OFF|ON}]</code></td> </tr><tr><th>Type</th> <td>Boolean</td> </tr><tr><th>Default Value</th> <td><code class="literal">OFF</code></td> </tr></tbody></table>

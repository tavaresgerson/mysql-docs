...
<table border="0" style="width: 100%;"><colgroup><col align="left" width="1%"/><col/></colgroup><tbody><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-operations"></a><a name="id471165"></a><p><b>A.16.1.</b></p></td><td align="left" valign="top"><p>
...
<code class="literal">INSERT</code>, <code class="literal">UPDATE</code>, and
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-benefits"></a><a name="id471173"></a><p><b>A.16.2.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-index-types"></a><a name="id471179"></a><p><b>A.16.3.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-space-max-size"></a><a name="id471184"></a><p><b>A.16.4.</b></p></td><td align="left" valign="top"><p>
...
<code class="literal">InnoDB</code> does not buffer an operation if it
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-current-size"></a><a name="id471201"></a><p><b>A.16.5.</b></p></td><td align="left" valign="top"><p>
...
-------------------------------------
Ibuf: size 1, free list len 0, seg size 2, 0 merges</code></pre><p>
...
<p>
        ...
        <a class="xref" href="innodb-change-buffer.html" title="17.5.2 Change Buffer">Section 17.5.2, “Change Buffer”</a>.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-merging"></a><a name="id471221"></a><p><b>A.16.6.</b></p></td><td align="left" valign="top"><p>
...
<ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>
...
</td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-flush-time"></a><a name="id471241"></a><p><b>A.16.7.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-when-to-enable"></a><a name="id471246"></a><p><b>A.16.8.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-when-to-disable"></a><a name="id471252"></a><p><b>A.16.9.</b></p></td><td align="left" valign="top"><p>
        ...
        benefit.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-innodb-change-buffer-info"></a><a name="id471258"></a><p><b>A.16.10.</b></p></td><td align="left" valign="top"><p>
        Where can I find additional information about the change buffer?
      </p></td></tr><tr class="answer"><td align="left" valign="top"></td><td align="left" valign="top"><p>
        See <a class="xref" href="innodb-change-buffer.html" title="17.5.2 Change Buffer">Section 17.5.2, “Change Buffer”</a>.
</p></td></tr></tbody></table>
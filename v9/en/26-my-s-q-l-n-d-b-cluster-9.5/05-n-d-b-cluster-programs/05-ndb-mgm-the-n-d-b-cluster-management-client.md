...
* `--encrypt-backup`
  ...
  <table frame="box" rules="all" summary="Properties for encrypt-backup"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--encrypt-backup</code></td> </tr></tbody></table>

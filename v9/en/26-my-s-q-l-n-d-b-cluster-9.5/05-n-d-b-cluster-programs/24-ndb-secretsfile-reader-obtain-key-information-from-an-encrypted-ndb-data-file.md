...
* `--filesystem-password`
  ...
  <table frame="box" rules="all" summary="Properties for filesystem-password"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--filesystem-password=password</code></td> </tr></tbody></table>
...
* `--filesystem-password-from-stdin`
  ...
  <table frame="box" rules="all" summary="Properties for filesystem-password-from-stdin"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--filesystem-password-from-stdin={TRUE|FALSE}</code></td> </tr></tbody></table>

...
* `ndb_table_no_logging`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>0
...
* `ndb_table_temporary`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>1
...
* `ndb_use_copying_alter_table`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>2

  Forces `NDB` to use copying of tables in the event of problems with online `ALTER TABLE` operations. The default value is `OFF`.

* `ndb_use_exact_count`

  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>3
...
* `ndb_use_transactions`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>4
...
* `ndb_version`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>5

  `NDB` engine version, as a composite integer.

* `ndb_version_string`

  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>6

  `NDB` engine version in `ndb-x.y.z` format.

* `replica_allow_batching`

  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>7
...
* `ndb_replica_batch_size`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>8
...
* `ndb_replica_blob_write_batch_bytes`
  ...
  <table frame="box" rules="all" summary="Properties for ndb-connectstring"><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--ndb-connectstring</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>9

...
* `EXECUTE_AT`
  ...
  `AT` clause of the
  [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statement used to
...
* `STATUS`
  ...
  information, see
  [Section 19.5.1.16, “Replication of Invoked Features”](replication-features-invoked.html "19.5.1.16 Replication of Invoked Features"). information.
...
[`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement") statement. See
[Section 15.7.7.20, “SHOW EVENTS Statement”](show-events.html "15.7.7.20 SHOW EVENTS Statement"). The following statements are
equivalent:

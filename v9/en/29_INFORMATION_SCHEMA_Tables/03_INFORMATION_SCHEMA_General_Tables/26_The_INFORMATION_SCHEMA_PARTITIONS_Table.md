...
The [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table provides
...
The [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table has these
columns:
...
* `SUBPARTITION_NAME`
  ...
  If the [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table row
...
* `PARTITION_EXPRESSION`
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement that
  ...
  [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table row for a
...
* `TABLE_ROWS`
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, you can also
  obtain this information using the [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables")
  utility.
...
* `INDEX_LENGTH`
  ...
  For partitions of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables,
  ...
  [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables") utility.
...
* `NODEGROUP`
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5"), the value is also
...
* [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") is a nonstandard
  `INFORMATION_SCHEMA` table.

* A table using any storage engine other than
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") and which is not partitioned
  has one row in the [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table")

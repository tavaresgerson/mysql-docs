...
The [`ENGINES`](information-schema-engines-table.html "28.3.13 The INFORMATION_SCHEMA ENGINES Table") table provides
...
The [`ENGINES`](information-schema-engines-table.html "28.3.13 The INFORMATION_SCHEMA ENGINES Table") table has these columns:
...
<td>The engine is supported but has been disabled</td>
  ...
  started with a
  `--skip-engine_name`
  option. For the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
...
* [`ENGINES`](information-schema-engines-table.html "28.3.13 The INFORMATION_SCHEMA ENGINES Table") is a nonstandard
  `INFORMATION_SCHEMA` table.

Storage engine information is also available from the
[`SHOW ENGINES`](show-engines.html "15.7.7.18 SHOW ENGINES Statement") statement. See
[Section 15.7.7.18, “SHOW ENGINES Statement”](show-engines.html "15.7.7.18 SHOW ENGINES Statement"). The following statements are
equivalent:

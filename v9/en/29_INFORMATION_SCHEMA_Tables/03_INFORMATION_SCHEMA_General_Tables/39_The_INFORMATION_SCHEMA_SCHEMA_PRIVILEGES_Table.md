...
The [`SCHEMA_PRIVILEGES`](information-schema-schema-privileges-table.html "28.3.39 The INFORMATION_SCHEMA SCHEMA_PRIVILEGES Table") table provides
information about schema (database) privileges. It takes its
values from the `mysql.db` system table.

The [`SCHEMA_PRIVILEGES`](information-schema-schema-privileges-table.html "28.3.39 The INFORMATION_SCHEMA SCHEMA_PRIVILEGES Table") table has these
columns:
...
* [`SCHEMA_PRIVILEGES`](information-schema-schema-privileges-table.html "28.3.39 The INFORMATION_SCHEMA SCHEMA_PRIVILEGES Table") is a

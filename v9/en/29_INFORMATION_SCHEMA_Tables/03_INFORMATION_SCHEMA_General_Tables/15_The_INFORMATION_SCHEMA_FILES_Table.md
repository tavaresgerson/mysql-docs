...
* `FILE_NAME`
  ...
  created by [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement")
  or [`ALTER LOGFILE GROUP`](alter-logfile-group.html "15.1.8 ALTER LOGFILE GROUP Statement"), or of a
  data file created by [`CREATE
  TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") or [`ALTER
  TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement"). In NDB 9.5, the file name
...
* `LOGFILE_GROUP_NUMBER`
  ...
  `id` column in the
  [`ndbinfo.dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.15.25 The ndbinfo dict_obj_info Table") table
  and the `log_id` column in the
  [`ndbinfo.logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.15.44 The ndbinfo logspaces Table") and
  [`ndbinfo.logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.15.44 The ndbinfo logspaces Table") tables for
  this undo log file.
...
* `INITIAL_SIZE`
  ...
  [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.20 CREATE LOGFILE GROUP Statement"),
  ...
  [`ALTER TABLESPACE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") statement used
  to create the file.
...
* `EXTRA`
  ...
  *NULL*. A more detailed explanation is
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") stores a copy of each data
...
* Undo tablespace information is shown in
  ...
  present, as they are by default in MySQL 9.5.
...
* The `FILES` table provides information
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table having data stored on
...
* Much of the information contained in the
  ...
  `ndbinfo`
  [`files`](mysql-cluster-ndbinfo-files.html "25.6.15.36 The ndbinfo files Table") table.

* The `CREATION_TIME`,
  `LAST_UPDATE_TIME`, and
  `LAST_ACCESSED` values are as reported by
  the operating system, and are not supplied by the
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. Where no
...
* The difference between the `TOTAL EXTENTS`
  ...
  TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement") statement. For more information, see
...
* You can obtain information about Disk Data tablespaces using
  the [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables") utility. For more
  information, see

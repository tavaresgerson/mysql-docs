...
The [`ROUTINES`](information-schema-routines-table.html "28.3.36 The INFORMATION_SCHEMA ROUTINES Table") table provides
information about stored routines (stored procedures and stored
functions). The [`ROUTINES`](information-schema-routines-table.html "28.3.36 The INFORMATION_SCHEMA ROUTINES Table") table does
not include built-in (native) functions or loadable functions.

The [`ROUTINES`](information-schema-routines-table.html "28.3.36 The INFORMATION_SCHEMA ROUTINES Table") table has these columns:
...
* Information about stored function return values is also
  available in the [`PARAMETERS`](information-schema-parameters-table.html "28.3.25 The INFORMATION_SCHEMA PARAMETERS Table")

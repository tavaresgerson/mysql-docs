...
The [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "28.3.30 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table") table
provides information about foreign keys.

The [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "28.3.30 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table") table has
these columns:
...
* `TABLE_NAME`
  ...
  [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "28.3.47 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table") table.

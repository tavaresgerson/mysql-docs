...
The [`JSON_DUALITY_VIEWS`](information-schema-json-duality-views-table.html "28.3.18 The INFORMATION SCHEMA JSON_DUALITY_VIEWS Table") table provides
information about JSON duality views accessible by the current
user. There is one row in this table for each such view.

The [`JSON_DUALITY_VIEWS`](information-schema-json-duality-views-table.html "28.3.18 The INFORMATION SCHEMA JSON_DUALITY_VIEWS Table") table contains
...
also have [`SHOW VIEW`](privileges-provided.html#priv_show-view) and
[`SELECT`](privileges-provided.html#priv_select) privileges on the view.
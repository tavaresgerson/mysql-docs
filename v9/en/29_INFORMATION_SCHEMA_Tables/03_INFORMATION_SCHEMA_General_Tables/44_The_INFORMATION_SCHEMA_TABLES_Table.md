...
The [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table provides information
about tables in databases.

Columns in [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") that represent
...
The [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table has these columns:
...
* `TABLE_TYPE`
  ...
  The [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table does not list
  `TEMPORARY` tables.
...
* `DATA_FREE`
  ...
  `INFORMATION_SCHEMA`
  [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table, as shown in
  this example:
...
* `CREATE_OPTIONS`
  ...
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement").
...
* For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables, the output of
...
* For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables,
...
* For views, most [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") columns
...
[`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") statements. See
[Section 15.7.7.39, “SHOW TABLE STATUS Statement”](show-table-status.html "15.7.7.39 SHOW TABLE STATUS Statement"), and
[Section 15.7.7.40, “SHOW TABLES Statement”](show-tables.html "15.7.7.40 SHOW TABLES Statement"). The following statements are
equivalent:

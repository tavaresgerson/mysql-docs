...
The [`ROLE_TABLE_GRANTS`](information-schema-role-table-grants-table.html "28.3.34 The INFORMATION_SCHEMA ROLE_TABLE_GRANTS Table") table provides
information about the table privileges for roles that are
available to or granted by the currently enabled roles.

The [`ROLE_TABLE_GRANTS`](information-schema-role-table-grants-table.html "28.3.34 The INFORMATION_SCHEMA ROLE_TABLE_GRANTS Table") table has these
columns:

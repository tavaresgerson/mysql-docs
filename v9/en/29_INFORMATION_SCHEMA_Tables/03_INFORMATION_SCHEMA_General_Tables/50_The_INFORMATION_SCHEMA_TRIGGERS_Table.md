...
The [`TRIGGERS`](information-schema-triggers-table.html "28.3.50 The INFORMATION_SCHEMA TRIGGERS Table") table provides
information about triggers. To see information about a table's
triggers, you must have the [`TRIGGER`](privileges-provided.html#priv_trigger)
privilege for the table.

The [`TRIGGERS`](information-schema-triggers-table.html "28.3.50 The INFORMATION_SCHEMA TRIGGERS Table") table has these columns:
...
* `EVENT_OBJECT_CATALOG`,
  ...
  As noted in [Section 27.4, “Using Triggers”](triggers.html "27.4 Using Triggers"), every trigger is
...
defined in [Section 27.4, “Using Triggers”](triggers.html "27.4 Using Triggers"):
...
[`SHOW TRIGGERS`](show-triggers.html "15.7.7.41 SHOW TRIGGERS Statement") statement. See

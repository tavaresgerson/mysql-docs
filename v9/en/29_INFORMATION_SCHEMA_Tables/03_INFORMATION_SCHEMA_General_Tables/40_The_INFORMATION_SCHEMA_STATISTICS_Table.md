...
The [`STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table") table provides
information about table indexes.

Columns in [`STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table") that represent
...
The [`STATISTICS`](information-schema-statistics-table.html "28.3.40 The INFORMATION_SCHEMA STATISTICS Table") table has these
columns:
...
* `CARDINALITY`
  ...
  TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement") or (for `MyISAM` tables)
  [**myisamchk -a**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").
...
* `SUB_PART`
  ...
  [Section 10.3.5, “Column Indexes”](column-indexes.html "10.3.5 Column Indexes"), and
...
* `EXPRESSION`
  ...
  [Functional Key Parts](create-index.html#create-index-functional-key-parts "Functional Key Parts")), which
...
[`SHOW INDEX`](show-index.html "15.7.7.24 SHOW INDEX Statement") statement. See
[Section 15.7.7.24, “SHOW INDEX Statement”](show-index.html "15.7.7.24 SHOW INDEX Statement"). The following statements are
equivalent:
...
= OFF`](server-system-variables.html#sysvar_show_gipk_in_create_table_and_information_schema). For more information, see

...
:   [28.3.1 INFORMATION\_SCHEMA General Table Reference](information-schema-general-table-reference.html)
    ...
    [28.3.18 The INFORMATION SCHEMA JSON\_DUALITY\_VIEWS Table](information-schema-json-duality-views-table.html)

    [28.3.19 The INFORMATION SCHEMA JSON\_DUALITY\_VIEW\_COLUMNS Table](information-schema-json-duality-view-columns-table.html)

    [28.3.20 The INFORMATION SCHEMA JSON\_DUALITY\_VIEW\_LINKS Table](information-schema-json-duality-view-links-table.html)

    [28.3.21 The INFORMATION SCHEMA JSON\_DUALITY\_VIEW\_TABLES Table](information-schema-json-duality-view-tables-table.html)

    [28.3.22 The INFORMATION\_SCHEMA LIBRARIES Table](information-schema-libraries-table.html)

    [28.3.23 The INFORMATION\_SCHEMA ndb\_transid\_mysql\_connection\_map Table](information-schema-ndb-transid-mysql-connection-map-table.html)

    [28.3.24 The INFORMATION\_SCHEMA OPTIMIZER\_TRACE Table](information-schema-optimizer-trace-table.html)

    [28.3.25 The INFORMATION\_SCHEMA PARAMETERS Table](information-schema-parameters-table.html)

    [28.3.26 The INFORMATION\_SCHEMA PARTITIONS Table](information-schema-partitions-table.html)

    [28.3.27 The INFORMATION\_SCHEMA PLUGINS Table](information-schema-plugins-table.html)

    [28.3.28 The INFORMATION\_SCHEMA PROCESSLIST Table](information-schema-processlist-table.html)

    [28.3.29 The INFORMATION\_SCHEMA PROFILING Table](information-schema-profiling-table.html)

    [28.3.30 The INFORMATION\_SCHEMA REFERENTIAL\_CONSTRAINTS Table](information-schema-referential-constraints-table.html)

    [28.3.31 The INFORMATION\_SCHEMA RESOURCE\_GROUPS Table](information-schema-resource-groups-table.html)

    [28.3.32 The INFORMATION\_SCHEMA ROLE\_COLUMN\_GRANTS Table](information-schema-role-column-grants-table.html)

    [28.3.33 The INFORMATION\_SCHEMA ROLE\_ROUTINE\_GRANTS Table](information-schema-role-routine-grants-table.html)

    [28.3.34 The INFORMATION\_SCHEMA ROLE\_TABLE\_GRANTS Table](information-schema-role-table-grants-table.html)

    [28.3.35 The INFORMATION\_SCHEMA ROUTINE\_LIBRARIES Table](information-schema-routine-libraries-table.html)

    [28.3.36 The INFORMATION\_SCHEMA ROUTINES Table](information-schema-routines-table.html)

    [28.3.37 The INFORMATION\_SCHEMA SCHEMATA Table](information-schema-schemata-table.html)

    [28.3.38 The INFORMATION\_SCHEMA SCHEMATA\_EXTENSIONS Table](information-schema-schemata-extensions-table.html)

    [28.3.39 The INFORMATION\_SCHEMA SCHEMA\_PRIVILEGES Table](information-schema-schema-privileges-table.html)

    [28.3.40 The INFORMATION\_SCHEMA STATISTICS Table](information-schema-statistics-table.html)

    [28.3.41 The INFORMATION\_SCHEMA ST\_GEOMETRY\_COLUMNS Table](information-schema-st-geometry-columns-table.html)

    [28.3.42 The INFORMATION\_SCHEMA ST\_SPATIAL\_REFERENCE\_SYSTEMS Table](information-schema-st-spatial-reference-systems-table.html)

    [28.3.43 The INFORMATION\_SCHEMA ST\_UNITS\_OF\_MEASURE Table](information-schema-st-units-of-measure-table.html)

    [28.3.44 The INFORMATION\_SCHEMA TABLES Table](information-schema-tables-table.html)

    [28.3.45 The INFORMATION\_SCHEMA TABLES\_EXTENSIONS Table](information-schema-tables-extensions-table.html)

    [28.3.46 The INFORMATION\_SCHEMA TABLESPACES\_EXTENSIONS Table](information-schema-tablespaces-extensions-table.html)

    [28.3.47 The INFORMATION\_SCHEMA TABLE\_CONSTRAINTS Table](information-schema-table-constraints-table.html)

    [28.3.48 The INFORMATION\_SCHEMA TABLE\_CONSTRAINTS\_EXTENSIONS Table](information-schema-table-constraints-extensions-table.html)

    [28.3.49 The INFORMATION\_SCHEMA TABLE\_PRIVILEGES Table](information-schema-table-privileges-table.html)

    [28.3.50 The INFORMATION\_SCHEMA TRIGGERS Table](information-schema-triggers-table.html)

    [28.3.51 The INFORMATION\_SCHEMA USER\_ATTRIBUTES Table](information-schema-user-attributes-table.html)

    [28.3.52 The INFORMATION\_SCHEMA USER\_PRIVILEGES Table](information-schema-user-privileges-table.html)

    [28.3.53 The INFORMATION\_SCHEMA VIEWS Table](information-schema-views-table.html)

    [28.3.54 The INFORMATION\_SCHEMA VIEW\_ROUTINE\_USAGE Table](information-schema-view-routine-usage-table.html)

    [28.3.55 The INFORMATION\_SCHEMA VIEW\_TABLE\_USAGE Table](information-schema-view-table-usage-table.html)
...
[28.7 INFORMATION\_SCHEMA MySQL Enterprise Firewall Plugin Tables](firewall-information-schema-tables.html)

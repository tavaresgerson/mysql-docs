...
This table is deprecated, as are the Connection Control plugins;
users are encouraged to migrate to the Connection Control
component, which provides an equivalent Performance Schema table

...
The [`INNODB_COLUMNS`](information-schema-innodb-columns-table.html "28.4.9 The INFORMATION_SCHEMA INNODB_COLUMNS Table") table provides
...
The [`INNODB_COLUMNS`](information-schema-innodb-columns-table.html "28.4.9 The INFORMATION_SCHEMA INNODB_COLUMNS Table") table has these
columns:
...
* `HAS_DEFAULT`
  ...
  instantly using
  [`ALTER TABLE ...
  ADD COLUMN`](alter-table.html "15.1.11 ALTER TABLE Statement") with `ALGORITHM=INSTANT`
...
* `DEFAULT_VALUE`
  ...
  using [`ALTER TABLE
  ... ADD COLUMN`](alter-table.html "15.1.11 ALTER TABLE Statement") with

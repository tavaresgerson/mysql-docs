...
* `TYPE`
  ...
  [virtual
  generated column](/doc/refman/8.4/en/glossary.html#glos_virtual_generated_column).
...
* `SPACE`
  ...
  means the `InnoDB`
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace). Any other number represents a table created

...
The [`INNODB_TABLES`](information-schema-innodb-tables-table.html "28.4.23 The INFORMATION_SCHEMA INNODB_TABLES Table") table provides
...
The [`INNODB_TABLES`](information-schema-innodb-tables-table.html "28.4.23 The INFORMATION_SCHEMA INNODB_TABLES Table") table has these
columns:
...
* `N_COLS`
  ...
  includes [virtual
  generated columns](/doc/refman/8.4/en/glossary.html#glos_virtual_generated_column), if present.
...
* `SPACE`
  ...
  means the `InnoDB`
  [system
  tablespace](/doc/refman/8.4/en/glossary.html#glos_system_tablespace). Any other number represents either a
  ...
  same after a [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement")
...
* `SPACE_TYPE`
  ...
  TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement").
...
* `TOTAL_ROW_VERSIONS`
  ...
  [`ALTER TABLE ...
  ALGORITHM=INSTANT`](alter-table.html "15.1.11 ALTER TABLE Statement") operations that add or remove
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") operation, the
  ...
  The maximum `TOTAL_ROW_VERSIONS` value is
  255.

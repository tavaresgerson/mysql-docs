...
`InnoDB` [buffer
pool](glossary.html#glos_buffer_pool "buffer pool"); in particular, how they are ordered in the LRU list
that determines which pages to
[evict](glossary.html#glos_eviction "eviction") from the buffer pool
when it becomes full.

The [`INNODB_BUFFER_PAGE_LRU`](information-schema-innodb-buffer-page-lru-table.html "28.4.3 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE_LRU Table") table has
the same columns as the
[`INNODB_BUFFER_PAGE`](information-schema-innodb-buffer-page-table.html "28.4.2 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE Table") table with a few
...
Querying the [`INNODB_BUFFER_PAGE_LRU`](information-schema-innodb-buffer-page-lru-table.html "28.4.3 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE_LRU Table")
...
* `PAGE_TYPE`
  ...
  **Table 28.6 INNODB\_BUFFER\_PAGE\_LRU.PAGE\_TYPE Values**
  ...
  <table summary="Mapping for interpreting INNODB_BUFFER_PAGE_LRU.PAGE_TYPE values."><col style="width: 30%"/><col style="width: 30%"/><thead><tr>
<th>Page Type</th>
<th>Description</th>
</tr></thead><tbody><tr>
...
* When tables, table rows, partitions, or indexes are deleted,
  ...
  [`INNODB_BUFFER_PAGE_LRU`](information-schema-innodb-buffer-page-lru-table.html "28.4.3 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE_LRU Table") table

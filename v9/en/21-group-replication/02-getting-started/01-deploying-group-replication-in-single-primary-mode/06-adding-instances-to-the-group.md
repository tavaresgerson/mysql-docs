...
If you are providing user credentials for distributed recovery as part of `START GROUP_REPLICATION`, you can do so like this:
...
4. Start Group Replication:
   ...
   If you are providing user credentials for distributed recovery in the `START GROUP_REPLICATION` statement, you can do so like this:

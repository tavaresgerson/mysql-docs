...
IPv6 broker; see [Section 7.1.13.5, “Obtaining an IPv6 Address from a Broker”](ipv6-brokers.html "7.1.13.5 Obtaining an IPv6 Address from a Broker").
...
3. On the client host (`2001:db8:0:f101::2`),
   invoke the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to connect to the

...
MySQL supports a [`--validate-config`](server-options.html#option_mysqld_validate-config)
...
the server with [`--validate-config`](server-options.html#option_mysqld_validate-config)
again.

For the preceding example, where use of
[`--validate-config`](server-options.html#option_mysqld_validate-config) results in
...
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) value, but do
...
The scope of the [`--validate-config`](server-options.html#option_mysqld_validate-config)
...
[`--validate-config`](server-options.html#option_mysqld_validate-config) can be used any
...
that system variable in its `my.cnf` file and
then upgraded to MySQL 9.5. Running the upgraded
server with [`--validate-config`](server-options.html#option_mysqld_validate-config) to
...
[`--validate-config`](server-options.html#option_mysqld_validate-config) can be used with
the [`--defaults-file`](option-file-options.html#option_general_defaults-file) option to
...
Remember that [`--defaults-file`](option-file-options.html#option_general_defaults-file), if
...
[`--defaults-file`](option-file-options.html#option_general_defaults-file) itself is
unknown.)
...
The MySQL server, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), has many command
...
The command produces a list of all [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
Performance Schema; see [Chapter 29, *MySQL Performance Schema*](performance-schema.html "Chapter 29 MySQL Performance Schema"). In
addition, the MySQL `sys` schema is a set of
objects that provides convenient access to data collected by the
Performance Schema; see [Chapter 30, *MySQL sys Schema*](sys-schema.html "Chapter 30 MySQL sys Schema").

If you specify an option on the command line for
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") or [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"), it
...
Windows users may execute [Section 2.3.2, “Configuration: Using MySQL Configurator”](mysql-configurator.html "2.3.2 Configuration: Using MySQL Configurator") to

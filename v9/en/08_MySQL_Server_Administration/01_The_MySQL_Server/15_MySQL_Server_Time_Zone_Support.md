...
Time zone offsets are also supported for inserted datetime values;
see [Section 13.2.2, “The DATE, DATETIME, and TIMESTAMP Types”](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"), for more information.

For information about time zone settings in replication setups,
see [Section 19.5.1.14, “Replication and System Functions”](replication-features-functions.html "19.5.1.14 Replication and System Functions") and
...
* The server system time zone. When the server starts, it
  ...
  variable before you start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). If you
  start the server using [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"), its
  [`--timezone`](mysqld-safe.html#option_mysqld_safe_timezone) option
  provides another way to set the system time zone. The
  permissible values for `TZ` and
  [`--timezone`](mysqld-safe.html#option_mysqld_safe_timezone) are system
...
* The server current time zone. The global
  ...
  in. The initial [`time_zone`](server-system-variables.html#sysvar_time_zone)
  ...
  [`--default-time-zone`](server-options.html#option_mysqld_default-time-zone) option on
  ...
  [`SUPER`](privileges-provided.html#priv_super) privilege), you can set
...
* Per-session time zones. Each client that connects has its
  ...
  [`time_zone`](server-system-variables.html#sysvar_time_zone) variable.
  Initially, the session variable takes its value from the
  global [`time_zone`](server-system-variables.html#sysvar_time_zone) variable,
...
[`NOW()`](date-and-time-functions.html#function_now) or
[`CURTIME()`](date-and-time-functions.html#function_curtime), and values stored in
and retrieved from [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types")
columns. Values for [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types")
...
[`UTC_TIMESTAMP()`](date-and-time-functions.html#function_utc-timestamp) or values in
[`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"),
[`TIME`](time.html "13.2.3 The TIME Type"), or
[`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns. Nor are values
in those data types stored in UTC; the time zone applies for
them only when converting from
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values. If you want
locale-specific arithmetic for
[`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"),
[`TIME`](time.html "13.2.3 The TIME Type"), or
[`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values, convert them to
...
* As a string indicating an offset from UTC of the form
  ...
  This value must be in the range `'-13:59'`
  to `'+14:00'`, inclusive.
...
[Section 7.3, “The mysql System Schema”](system-schema.html "7.3 The mysql System Schema")). The MySQL installation
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") program to load the time
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") and send the output into
the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") program. For example:

```
mysql_tzinfo_to_sql /usr/share/zoneinfo | mysql -u root -p mysql
```

The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") command shown here assumes that you
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") reads your system's time
zone files and generates SQL statements from them.
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") processes those statements to load the
time zone tables.

[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") also can be used to load
...
* To load a single time zone file
  *`tz_file`* that corresponds to a
  ...
  [**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") like this:
...
After running [**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables"), restart
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.3 mysql_tzinfo_to_sql — Load the Time Zone Tables") utility instead.
...
* If you replace the system's
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") startup, restart
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") so that it uses the updated rules.
  Otherwise, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") might not notice when
...
* If you use named time zones with MySQL, make sure that the
  ...
  [Populating the Time Zone Tables](time-zone-support.html#time-zone-installation "Populating the Time Zone Tables").
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") caches time zone information that
  it looks up, so after updating the time zone tables, restart
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to make sure that it does not
...
[`NOW()`](date-and-time-functions.html#function_now) can return the same value
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values one second
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values (which are in

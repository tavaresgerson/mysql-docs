...
the [`SYSTEM_VARIABLES_ADMIN`](privileges-provided.html#priv_system-variables-admin)
privilege (or the deprecated [`SUPER`](privileges-provided.html#priv_super)
...
* To see the current values used by a running server, use the
  [`SHOW VARIABLES`](show-variables.html "15.7.7.42 SHOW VARIABLES Statement") statement or the
...
[Section 7.1.5, “Server System Variable Reference”](server-system-variable-reference.html "7.1.5 Server System Variable Reference"). For more
...
* [Section 7.1.9, “Using System Variables”](using-system-variables.html "7.1.9 Using System Variables"), discusses the syntax
  for setting and displaying system variable values.

* [Section 7.1.9.2, “Dynamic System Variables”](dynamic-system-variables.html "7.1.9.2 Dynamic System Variables"), lists the
  variables that can be set at runtime.

* Information on tuning system variables can be found in
  [Section 7.1.1, “Configuring the Server”](server-configuration.html "7.1.1 Configuring the Server").

* [Section 17.14, “InnoDB Startup Options and System Variables”](innodb-parameters.html "17.14 InnoDB Startup Options and System Variables"), lists
  `InnoDB` system variables.

* [Section 25.4.3.9.2, “NDB Cluster System Variables”](mysql-cluster-options-variables.html#mysql-cluster-system-variables "25.4.3.9.2 NDB Cluster System Variables"), lists system
  variables which are specific to NDB Cluster.

* For information on server system variables specific to
  replication, see [Section 19.1.6, “Replication and Binary Logging Options and Variables”](replication-options.html "19.1.6 Replication and Binary Logging Options and Variables").
...
[`FLOOR(value)`](mathematical-functions.html#function_floor)
`* block_size`.
...
A block size of 0 for a given variable indicates that no
rounding down of this variable's input values takes place.
In general, for those variables shown with no block size, you
may assume that it is 0.
...
* [`activate_all_roles_on_login`](server-system-variables.html#sysvar_activate_all_roles_on_login)
  ...
  <table frame="box" rules="all" summary="Properties for activate_all_roles_on_login"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--activate-all-roles-on-login[={OFF|ON}]</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="server-system-variables.html#sysvar_activate_all_roles_on_login">activate_all_roles_on_login</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">OFF</code></td>
  ...
  + If
    ...
    ROLE`](set-default-role.html "15.7.1.9 SET DEFAULT ROLE Statement").

  + If
    [`activate_all_roles_on_login`](server-system-variables.html#sysvar_activate_all_roles_on_login)
    is disabled, the server activates the default roles
    specified with [`SET DEFAULT
    ROLE`](set-default-role.html "15.7.1.9 SET DEFAULT ROLE Statement"), if any, at login time.
  ...
  [`SET ROLE`](set-role.html "15.7.1.11 SET ROLE Statement"). To change the active
  roles for a stored program, the program body should execute
  [`SET ROLE`](set-role.html "15.7.1.11 SET ROLE Statement").

* [`admin_address`](server-system-variables.html#sysvar_admin_address)

  <table frame="box" rules="all" summary="Properties for admin_address"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td>String</td>
  ...
  [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces")). There is no default
  [`admin_address`](server-system-variables.html#sysvar_admin_address) value. If this
  variable is not specified at startup, the server maintains no
  administrative interface. The server also has a
  [`bind_address`](server-system-variables.html#sysvar_bind_address) system variable
  for configuring regular (nonadministrative) client TCP/IP
  connections. See [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces").

  If [`admin_address`](server-system-variables.html#sysvar_admin_address) is
  ...
  The [`admin_address`](server-system-variables.html#sysvar_admin_address) system
  variable is similar to the
  [`bind_address`](server-system-variables.html#sysvar_bind_address) system variable
  that binds the server to an address for ordinary client
  connections, but with these differences:

  + [`bind_address`](server-system-variables.html#sysvar_bind_address) permits
    multiple addresses.
    [`admin_address`](server-system-variables.html#sysvar_admin_address) permits a
    single address.

  + [`bind_address`](server-system-variables.html#sysvar_bind_address) permits
    wildcard addresses.
    [`admin_address`](server-system-variables.html#sysvar_admin_address) does not.

* [`admin_port`](server-system-variables.html#sysvar_admin_port)

  <table frame="box" rules="all" summary="Properties for admin_port"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">65535</code></td>
  ...
  [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces")). Setting this
  variable to 0 causes the default value to be used.

  Setting [`admin_port`](server-system-variables.html#sysvar_admin_port) has no
  effect if [`admin_address`](server-system-variables.html#sysvar_admin_address) is
  not specified because in that case the server maintains no
  administrative network interface.

* [`admin_ssl_ca`](server-system-variables.html#sysvar_admin_ssl_ca)

  <table frame="box" rules="all" summary="Properties for admin_ssl_ca"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_ca`](server-system-variables.html#sysvar_admin_ssl_ca) system
...
* [`admin_ssl_capath`](server-system-variables.html#sysvar_admin_ssl_capath)

  <table frame="box" rules="all" summary="Properties for admin_ssl_capath"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_capath`](server-system-variables.html#sysvar_admin_ssl_capath) system
  variable is like [`ssl_capath`](server-system-variables.html#sysvar_ssl_capath),
  except that it applies to the administrative connection
  interface rather than the main connection interface. For
  information about configuring encryption support for the
  administrative interface, see
...
* [`admin_ssl_cert`](server-system-variables.html#sysvar_admin_ssl_cert)

  <table frame="box" rules="all" summary="Properties for admin_ssl_cert"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_cert`](server-system-variables.html#sysvar_admin_ssl_cert) system
...
* [`admin_ssl_cipher`](server-system-variables.html#sysvar_admin_ssl_cipher)

  <table frame="box" rules="all" summary="Properties for admin_ssl_cipher"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--admin-ssl-cipher=name</code></td>
</tr><tr><th>System Variable</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_cipher`](server-system-variables.html#sysvar_admin_ssl_cipher) system
  variable is like [`ssl_cipher`](server-system-variables.html#sysvar_ssl_cipher),
  except that it applies to the administrative connection
  interface rather than the main connection interface. For
  information about configuring encryption support for the
  administrative interface, see
  ...
  ([`ER_BLOCKED_CIPHER`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_blocked_cipher)).

* [`admin_ssl_crl`](server-system-variables.html#sysvar_admin_ssl_crl)

  <table frame="box" rules="all" summary="Properties for admin_ssl_crl"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--admin-ssl-crl=file_name</code></td>
</tr><tr><th>System Variable</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_crl`](server-system-variables.html#sysvar_admin_ssl_crl) system
...
* [`admin_ssl_crlpath`](server-system-variables.html#sysvar_admin_ssl_crlpath)

  <table frame="box" rules="all" summary="Properties for admin_ssl_crlpath"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--admin-ssl-crlpath=dir_name</code></td>
</tr><tr><th>System Variable</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_crlpath`](server-system-variables.html#sysvar_admin_ssl_crlpath) system
  variable is like [`ssl_crlpath`](server-system-variables.html#sysvar_ssl_crlpath),
  except that it applies to the administrative connection
  interface rather than the main connection interface. For
  information about configuring encryption support for the
  administrative interface, see
...
* [`admin_ssl_key`](server-system-variables.html#sysvar_admin_ssl_key)

  <table frame="box" rules="all" summary="Properties for admin_ssl_key"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">NULL</code></td>
  ...
  The [`admin_ssl_key`](server-system-variables.html#sysvar_admin_ssl_key) system
...
* [`admin_tls_ciphersuites`](server-system-variables.html#sysvar_admin_tls_ciphersuites)
...
<td>String</td>
  ...
  The [`admin_tls_ciphersuites`](server-system-variables.html#sysvar_admin_tls_ciphersuites)
  system variable is like
  [`tls_ciphersuites`](server-system-variables.html#sysvar_tls_ciphersuites), except that
...
* [`admin_tls_version`](server-system-variables.html#sysvar_admin_tls_version)
...
<td>String</td>
  ...
  The [`admin_tls_version`](server-system-variables.html#sysvar_admin_tls_version) system
  variable is like [`tls_version`](server-system-variables.html#sysvar_tls_version),
  except that it applies to the administrative connection
  interface rather than the main connection interface. For
  information about configuring encryption support for the
  administrative interface, see
  ...
  + MySQL 9.5 does not support the TLSv1 and
    TLSv1.1 connection protocols. See
    [Removal of Support for the TLSv1 and TLSv1.1 Protocols](/doc/refman/8.4/en/encrypted-connection-protocols-ciphers.html#encrypted-connection-deprecated-protocols)
    for more information.

  + MuySQL 9.5 supports the TLSv1.3 protocol,
...
* [`authentication_openid_connect_configuration`](server-system-variables.html#sysvar_authentication_openid_connect_configuration)
...
<td>String</td>
  ...
  for [Section 8.4.1.9, “OpenID Connect Pluggable Authentication”](openid-pluggable-authentication.html "8.4.1.9 OpenID Connect Pluggable Authentication"). It
...
<td>String</td>
  ...
  USER`](create-user.html "15.7.1.3 CREATE USER Statement") and [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement")
  ...
  `authentication_policy` determines the
  ...
  Because [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy)
  ...
  [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") statements, a user
  who has the
  ...
  The value of
  [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy) is a
  ...
  + `*:plugin_name`
    ...
    `plugin_name` is the default, but another
  ...
  [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy) and the
...
<td>String</td>
  ...
  [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") to accept a transaction
  or [`ROLLBACK`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
  to cancel it. If [`autocommit`](server-system-variables.html#sysvar_autocommit)
  is 0 and you change it to 1, MySQL performs an automatic
  [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") of any open transaction.
  Another way to begin a transaction is to use a
  [`START
  TRANSACTION`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") or
  [`BEGIN`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
  statement. See [Section 15.3.1, “START TRANSACTION, COMMIT, and ROLLBACK Statements”](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements").

  By default, client connections begin with
  [`autocommit`](server-system-variables.html#sysvar_autocommit) set to 1. To cause
  clients to begin with a default of 0, set the global
  [`autocommit`](server-system-variables.html#sysvar_autocommit) value by starting
  the server with the
  [`--autocommit=0`](server-system-variables.html#sysvar_autocommit) option. To set
...
<td>String</td>
  ...
  [`ALTER ROUTINE`](privileges-provided.html#priv_alter-routine) privileges to the
  creator of a stored routine, if the user cannot already
  execute and alter or drop the routine. (The
  [`ALTER ROUTINE`](privileges-provided.html#priv_alter-routine) privilege is
  required to drop the routine.) The server also automatically
  drops those privileges from the creator when the routine is
  dropped. If
  [`automatic_sp_privileges`](server-system-variables.html#sysvar_automatic_sp_privileges) is 0,
  ...
  [`automatic_sp_privileges`](server-system-variables.html#sysvar_automatic_sp_privileges) is
  set to `OFF`.

  The effects of this variable are the same with regard to
  JavaScript libraries as they are for stored routines; when
  `automatic_sp_privileges` is 1, the
  [`EXECUTE`](privileges-provided.html#priv_execute) and
  ...
  See also [Section 27.2.2, “Stored Routines and MySQL Privileges”](stored-routines-privileges.html "27.2.2 Stored Routines and MySQL Privileges").
...
<td><code class="literal">65535</code></td>
  ...
  directory if the
  [`auto_generate_certs`](server-system-variables.html#sysvar_auto_generate_certs) system
  ...
  and
  [`caching_sha2_password_auto_generate_rsa_keys`](server-system-variables.html#sysvar_caching_sha2_password_auto_generate_rsa_keys)
...
<td><code class="literal">65535</code></td>
  ...
  If explicitly set to 0 (zero), or -1, the value of
  [`max_connections`](server-system-variables.html#sysvar_max_connections) is used
  instead.
  ...
  [`back_log`](server-system-variables.html#sysvar_back_log) value indicates how
  ...
  this variable. [`back_log`](server-system-variables.html#sysvar_back_log)
  cannot be set higher than your operating system limit.

  On Linux platforms, it is recommended to set the following
  operating system configuration parameters to the same value as
  your [`max_connections`](server-system-variables.html#sysvar_max_connections) value:
  ...
  If you set [`max_connections`](server-system-variables.html#sysvar_max_connections)
  to a value greater than 10000, it is recommended to set
  these configuration parameters and
  `back_log` to that value also.
...
<td><code class="literal">65535</code></td>
  ...
  for [`SELECT`](select.html "15.2.13 SELECT Statement") operations that
...
<td><code class="literal">65535</code></td>
  ...
  [`admin_address`](server-system-variables.html#sysvar_admin_address) system variable
  that enables administrative connections on a dedicated
  interface. See [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces").

  If [`bind_address`](server-system-variables.html#sysvar_bind_address) is specified,
  ...
  + `bind_address=198.51.100.20,*`
    ...
    permitted when
    [`bind_address`](server-system-variables.html#sysvar_bind_address) names a list
    of multiple values.
  ...
  When [`bind_address`](server-system-variables.html#sysvar_bind_address) names a
  ...
  [`bind_address`](server-system-variables.html#sysvar_bind_address) names a list of
  ...
  the [`open_files_limit`](server-system-variables.html#sysvar_open_files_limit) system
  variable.
...
<td><code class="literal">65535</code></td>
  ...
  [`block_encryption_mode`](server-system-variables.html#sysvar_block_encryption_mode) takes a
  value in
  `aes-keylen-mode`
  ...
  *`keylen`* values are 128, 192, and
  ...
  [`block_encryption_mode`](server-system-variables.html#sysvar_block_encryption_mode) to a
  value containing an unsupported key length or a mode that the
  SSL library does not support.

* [`build_id`](server-system-variables.html#sysvar_build_id)
...
<td><code class="literal">65535</code></td>
  ...
  systems with [`-DWITH_BUILD_ID=ON`](source-configuration-options.html#option_cmake_with_build_id)
...
<td><code class="literal">65535</code></td>
  ...
  [`INSERT ...
  SELECT`](insert-select.html "15.2.7.1 INSERT ... SELECT Statement"), `INSERT ... VALUES (...), (...),
...
* [`caching_sha2_password_digest_rounds`](server-system-variables.html#sysvar_caching_sha2_password_digest_rounds)
...
<td><code class="literal">65535</code></td>
  ...
  [Section 8.4.1.2, “SHA-256 Pluggable Authentication”](sha256-pluggable-authentication.html "8.4.1.2 SHA-256 Pluggable Authentication"), and
  ...
  The [`auto_generate_certs`](server-system-variables.html#sysvar_auto_generate_certs)
...
<td><code class="literal">NULL</code></td>
  ...
  [Section 12.4, “Connection Character Sets and Collations”](charset-connection.html "12.4 Connection Character Sets and Collations").) The global value of the
  ...
  [`character_set_client`](server-system-variables.html#sysvar_character_set_client) value
...
<td><code class="literal">NULL</code></td>
  ...
  as [`character_set_server`](server-system-variables.html#sysvar_character_set_server).
  ...
  The global
  [`character_set_database`](server-system-variables.html#sysvar_character_set_database) and
  [`collation_database`](server-system-variables.html#sysvar_collation_database) system
...
<td><code class="literal">NULL</code></td>
  ...
  the [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement") and
  [`SELECT ... INTO
  OUTFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") statements and the
  [`LOAD_FILE()`](string-functions.html#function_load-file) function. Such file
  names are converted from
  [`character_set_client`](server-system-variables.html#sysvar_character_set_client) to
  [`character_set_filesystem`](server-system-variables.html#sysvar_character_set_filesystem)
  ...
  [`character_set_filesystem`](server-system-variables.html#sysvar_character_set_filesystem) to
  `'utf8mb4'`.
...
<td><code class="literal">NULL</code></td>
  ...
  [Section 12.15, “Character Set Configuration”](charset-configuration.html "12.15 Character Set Configuration"). If you set this
  variable, you should also set
  [`collation_server`](server-system-variables.html#sysvar_collation_server) to specify
...
<td><code class="literal">NULL</code></td>
  ...
  If the [`check_proxy_users`](server-system-variables.html#sysvar_check_proxy_users)
  ...
  support for the `sha256_password` plugin, you
  must enable
...
<td><code class="literal">NULL</code></td>
  ...
  [`collation_connection`](server-system-variables.html#sysvar_collation_connection) is
  important for comparisons of literal strings. For comparisons
  of strings with column values,
  [`collation_connection`](server-system-variables.html#sysvar_collation_connection) does not
...
<td><code class="literal">NULL</code></td>
  ...
  [`collation_database`](server-system-variables.html#sysvar_collation_database) raises a
  warning.
...
<td><code class="literal">NULL</code></td>
  ...
  [`completion_type`](server-system-variables.html#sysvar_completion_type) affects
  transactions that begin with
  [`START
  TRANSACTION`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") or
  [`BEGIN`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") and
  end with [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") or
  [`ROLLBACK`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements"). It
  does not apply to implicit commits resulting from execution of
  the statements listed in [Section 15.3.3, “Statements That Cause an Implicit Commit”](implicit-commit.html "15.3.3 Statements That Cause an Implicit Commit"). It
  also does not apply for
  [`XA
  COMMIT`](xa-statements.html "15.3.8.1 XA Transaction SQL Statements"),
  [`XA
  ROLLBACK`](xa-statements.html "15.3.8.1 XA Transaction SQL Statements"), or when
  [`autocommit=1`](server-system-variables.html#sysvar_autocommit).

* [`component_connection_control.failed_connections_threshold`](server-system-variables.html#sysvar_component_connection_control.failed_connections_threshold)
...
<td><code class="literal">NULL</code></td>
  ...
  The number of failed connection attempts by a given user
  before the Connection Control component institutes a
  connection delay for this user.

  See [Section 8.4.2, “The Connection Control Component”](connection-control-component.html "8.4.2 The Connection Control Component").

* [`component_connection_control.exempt_unknown_users`](server-system-variables.html#sysvar_component_connection_control.exempt_unknown_users)
...
<td><code class="literal">NULL</code></td>
  ...
  Configure whether failed connection attempts without user
  credentials should be penalized. This improves the Connection
  Control's component ability to handle legitimate connection
  attempts from load balancers, ensuring better server
  availability while maintaining effectiveness in thwarting
  brute force attacks. A new status variable
  [`Component_connection_control_exempted_unknown_users`](server-status-variables.html#statvar_Component_connection_control_exempted_unknown_users)
  provides insights into the number of exempted connections.

  See [Section 8.4.2, “The Connection Control Component”](connection-control-component.html "8.4.2 The Connection Control Component").

* [`component_connection_control.max_connection_delay`](server-system-variables.html#sysvar_component_connection_control.max_connection_delay)
...
<td><code class="literal">NULL</code></td>
  ...
  Maximum time (in milliseconds) for the Connection Control
  component to delay connections. This must be greater than or
  equal to
  [`component_connection_control.min_connection_delay`](server-system-variables.html#sysvar_component_connection_control.min_connection_delay).

  See [Section 8.4.2, “The Connection Control Component”](connection-control-component.html "8.4.2 The Connection Control Component"), for more
  information.
...
<td><code class="literal">NULL</code></td>
  ...
  Minimum time (in milliseconds) for the Connection Control
  component to delay connections. This must be less than or
  equal to
  [`component_connection_control.min_connection_delay`](server-system-variables.html#sysvar_component_connection_control.min_connection_delay).

  See [Section 8.4.2, “The Connection Control Component”](connection-control-component.html "8.4.2 The Connection Control Component").

* [`component_scheduler.enabled`](server-system-variables.html#sysvar_component_scheduler.enabled)
...
<td><code class="literal">NULL</code></td>
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") statements to run
...
<td><code class="literal">NULL</code></td>
  ...
  If you start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with
  [`--skip-new`](server-options.html#option_mysqld_skip-new),
  [`concurrent_insert`](server-system-variables.html#sysvar_concurrent_insert) is set to
  `NEVER`.

  See also [Section 10.11.3, “Concurrent Inserts”](concurrent-inserts.html "10.11.3 Concurrent Inserts").
...
<td><code class="literal">NULL</code></td>
  ...
  The number of seconds that the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  server waits for a connect packet before responding with
  `Bad handshake`. The default value is 10
  seconds.

  Increasing the
  [`connect_timeout`](server-system-variables.html#sysvar_connect_timeout) value might
  help if clients frequently encounter errors of the form
  `Lost connection to MySQL server at
  'XXX', system error:
  errno`.

* [`connection_memory_chunk_size`](server-system-variables.html#sysvar_connection_memory_chunk_size)
...
<td><code class="literal">NULL</code></td>
  ...
  counter
  [`Global_connection_memory`](server-status-variables.html#statvar_Global_connection_memory).
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") buffer pool is also not
  included.

  You must have the
  [`SYSTEM_VARIABLES_ADMIN`](privileges-provided.html#priv_system-variables-admin) or
  [`SUPER`](privileges-provided.html#priv_super) privilege to set this
  variable.

* [`connection_memory_limit`](server-system-variables.html#sysvar_connection_memory_limit)
...
<td><code class="literal">NULL</code></td>
  ...
  [`ER_CONN_LIMIT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_conn_limit), including any
...
* [`connection_memory_status_limit`](server-system-variables.html#sysvar_connection_memory_status_limit)
...
<td><code class="literal">NULL</code></td>
  ...
  [`Count_hit_query_past_connection_memory_status_limit`](server-status-variables.html#statvar_Count_hit_query_past_connection_memory_status_limit)
  is incremented.
...
<td><code class="literal">NULL</code></td>
  ...
  [`--core-file`](server-options.html#option_mysqld_core-file) option.

* [`create_admin_listener_thread`](server-system-variables.html#sysvar_create_admin_listener_thread)
...
<td><code class="literal">NULL</code></td>
  ...
  [Section 7.1.12.1, “Connection Interfaces”](connection-interfaces.html "7.1.12.1 Connection Interfaces")). The default is
  ...
  [`create_admin_listener_thread`](server-system-variables.html#sysvar_create_admin_listener_thread)
  has no effect if
  [`admin_address`](server-system-variables.html#sysvar_admin_address) is not
  specified because in that case the server maintains no
  administrative network interface.

* [`cte_max_recursion_depth`](server-system-variables.html#sysvar_cte_max_recursion_depth)
...
<td><code class="literal">NULL</code></td>
  ...
  see
  [Limiting Common Table Expression Recursion](with.html#common-table-expressions-recursion-limits "Limiting Common Table Expression Recursion").
...
<td><code class="literal">NULL</code></td>
  ...
  [`datadir`](server-system-variables.html#sysvar_datadir) value as an absolute
  path.
...
<td><code class="literal">NULL</code></td>
  ...
  [`--debug`](server-options.html#option_mysqld_debug) option given at server
  ...
  For more information, see [Section 7.9.4, “The DBUG Package”](dbug-package.html "7.9.4 The DBUG Package").
...
<td><code class="literal">NULL</code></td>
  ...
  with the [`-DWITH_DEBUG=ON`](source-configuration-options.html#option_cmake_with_debug)
  **CMake** option (see
  [Section 2.8.7, “MySQL Source-Configuration Options”](source-configuration-options.html "2.8.7 MySQL Source-Configuration Options")); otherwise,
  ...
  and the value of [`debug_sync`](server-system-variables.html#sysvar_debug_sync)
  ...
  [`debug_sync`](server-system-variables.html#sysvar_debug_sync) is `ON -
  ...
  *`N`* becomes the default timeout for
  ...
  [MySQL Server
  Doxygen Documentation](/doc/index-other.html).

* [`default_collation_for_utf8mb4`](server-system-variables.html#sysvar_default_collation_for_utf8mb4)
...
<td><code class="literal">NULL</code></td>
  ...
  `utf8mb4_0900_ai_ci` in later release series.
  ...
  + [`SHOW COLLATION`](show-collation.html "15.7.7.5 SHOW COLLATION Statement") and
    [`SHOW CHARACTER SET`](show-character-set.html "15.7.7.4 SHOW CHARACTER SET Statement").

  + [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") and
    [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") having a
    `CHARACTER SET utf8mb4` clause without a
    `COLLATION` clause, either for the table
    character set or for a column character set.

  + [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") and
    [`ALTER DATABASE`](alter-database.html "15.1.2 ALTER DATABASE Statement") having a
    `CHARACTER SET utf8mb4` clause without a
    `COLLATION` clause.
  ...
  See also [Section 12.9, “Unicode Support”](charset-unicode.html "12.9 Unicode Support").
...
<td><code class="literal">NULL</code></td>
  ...
  the value of
  [`default_password_lifetime`](server-system-variables.html#sysvar_default_password_lifetime) is
  ...
  option of the [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") and
  [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") statements. See
...
<td><code class="literal">NULL</code></td>
  ...
  [Chapter 18, *Alternative Storage Engines*](storage-engines.html "Chapter 18 Alternative Storage Engines"). This variable sets the
  ...
  the [`SHOW ENGINES`](show-engines.html "15.7.7.18 SHOW ENGINES Statement") statement or
...
<td><code class="literal">NULL</code></td>
  ...
  [`default_table_encryption`](server-system-variables.html#sysvar_default_table_encryption)
  supports [`SET
  PERSIST`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") and
  [`SET
  PERSIST_ONLY`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") syntax. See
...
<td><code class="literal">NULL</code></td>
  ...
  tables (created with
  [`CREATE TEMPORARY
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")). To set the storage engine for permanent
  tables, set the
  [`default_storage_engine`](server-system-variables.html#sysvar_default_storage_engine) system
...
<td><code class="literal">NULL</code></td>
  ...
  [`WEEK()`](date-and-time-functions.html#function_week) function. See
...
<td><code class="literal">NULL</code></td>
  ...
  See also [Section 18.2.1, “MyISAM Startup Options”](myisam-start.html "18.2.1 MyISAM Startup Options").
  ...
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements.
...
<td><code class="literal">NULL</code></td>
  ...
  [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility")) when the tables are in use.
  ...
  [`myisam_recover_options='BACKUP,FORCE'`](server-system-variables.html#sysvar_myisam_recover_options)).
  See [Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables"), and
  [Section 18.2.1, “MyISAM Startup Options”](myisam-start.html "18.2.1 MyISAM Startup Options").

  If you start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with
  [`--skip-new`](server-options.html#option_mysqld_skip-new),
  [`delay_key_write`](server-system-variables.html#sysvar_delay_key_write) is set to
  `OFF`.

  Warning

  If you enable external locking with
  [`--external-locking`](server-options.html#option_mysqld_external-locking), there is
...
<td><code class="literal">NULL</code></td>
  ...
  By default,
  [`disabled_storage_engines`](server-system-variables.html#sysvar_disabled_storage_engines) is
  ...
  [`CREATE TABLESPACE`](create-tablespace.html "15.1.25 CREATE TABLESPACE Statement"), and cannot
  be used with
  [`ALTER TABLE ...
  ENGINE`](alter-table.html "15.1.11 ALTER TABLE Statement") or
  [`ALTER
  TABLESPACE ... ENGINE`](alter-tablespace.html "15.1.12 ALTER TABLESPACE Statement") to change the storage engine
  of existing tables or tablespaces. Attempts to do so result in
  an [`ER_DISABLED_STORAGE_ENGINE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_disabled_storage_engine)
  error.

  [`disabled_storage_engines`](server-system-variables.html#sysvar_disabled_storage_engines) does
  ...
  [`DROP TABLESPACE`](drop-tablespace.html "15.1.38 DROP TABLESPACE Statement"). This permits a
  ...
  means such as
  [`ALTER TABLE ...
  ENGINE permitted_engine`](alter-table.html "15.1.11 ALTER TABLE Statement").

  It is permitted to set the
  [`default_storage_engine`](server-system-variables.html#sysvar_default_storage_engine) or
  [`default_tmp_storage_engine`](server-system-variables.html#sysvar_default_tmp_storage_engine)
  ...
  of these options: [`--initialize`](server-options.html#option_mysqld_initialize),
...
<td><code class="literal">NULL</code></td>
  ...
  performed with the
  [`/`](arithmetic-functions.html#operator_divide) operator.
...
<td><code class="literal">NULL</code></td>
  ...
  with a setting of
  [`log_error_verbosity=2`](server-system-variables.html#sysvar_log_error_verbosity).

  [`dragnet.Status`](server-status-variables.html#statvar_dragnet.Status) status
  variable can be consulted to determine the result of the most
  recent assignment to
  [`dragnet.log_error_filter_rules`](server-system-variables.html#sysvar_dragnet.log_error_filter_rules).

* [`enable_secondary_engine_statistics`](server-system-variables.html#sysvar_enable_secondary_engine_statistics)
...
<td><code class="literal">NULL</code></td>
  ...
  hypergraph query optimizer may fetch statistics from the
  secondary engine, if one is available. Applies to MySQL HeatWave
  only.
...
<td><code class="literal">NULL</code></td>
  ...
  [Section 8.6.2, “Configuring MySQL Enterprise Encryption”](enterprise-encryption-configuring.html "8.6.2 Configuring MySQL Enterprise Encryption") for more
  information.
...
<td><code class="literal">NULL</code></td>
  ...
  `openssl_udf` shared library functions can be
  decrypted or verified by the MySQL Enterprise Encryption
  component
  (`component_enterprise_encryption`). The
...
<td><code class="literal">NULL</code></td>
  ...
  *`N`* equality ranges. The optimizer
  ...
  If [`eq_range_index_dive_limit`](server-system-variables.html#sysvar_eq_range_index_dive_limit)
  is greater than 0, the optimizer uses existing index
  statistics instead of index dives if there are
  [`eq_range_index_dive_limit`](server-system-variables.html#sysvar_eq_range_index_dive_limit) or
  more equality ranges. Thus, to permit use of index dives for
  up to *`N`* equality ranges, set
  [`eq_range_index_dive_limit`](server-system-variables.html#sysvar_eq_range_index_dive_limit) to
  ...
  *`N`*, set
  ...
  For more information, see
  [Equality Range Optimization of Many-Valued Comparisons](range-optimization.html#equality-range-optimization "Equality Range Optimization of Many-Valued Comparisons").
...
<td><code class="literal">NULL</code></td>
  ...
  detail in [Section 27.5.2, “Event Scheduler Configuration”](events-configuration.html "27.5.2 Event Scheduler Configuration")

* [`explain_format`](server-system-variables.html#sysvar_explain_format)
...
<td><code class="literal">NULL</code></td>
  ...
  raises an error
  ([`ER_NOT_SUPPORTED_YET`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_not_supported_yet)).
  ...
  requires [`SYSTEM_VARIABLES_ADMIN`](privileges-provided.html#priv_system-variables-admin)
  (or the deprecated [`SUPER`](privileges-provided.html#priv_super)
  privilege). See [Section 7.1.9.1, “System Variable Privileges”](system-variable-privileges.html "7.1.9.1 System Variable Privileges").
...
<td><code class="literal">NULL</code></td>
  ...
  `EXPLAIN FORMAT=JSON` statements. Setting
  this variable to `1` causes the server to use
  Version 1, which is the linear format used for output from
  such statements in older versions of MySQL. Setting
  `explain_json_format_version` to
  `2` causes the Version 2 format to be used;
...
<td><code class="literal">NULL</code></td>
  ...
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns. By default,
  [`explicit_defaults_for_timestamp`](server-system-variables.html#sysvar_explicit_defaults_for_timestamp)
  ...
  handles [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns as
  follows:

  + [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns not
    ...
    *Exception*: Attempting to insert
    `NULL` into a generated column declared
    as `TIMESTAMP NOT NULL` is rejected with
    an error.

  + The first [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column
  ...
  + [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns following
  ...
  + It is not possible to assign a
    [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column a value of
    `NULL` to set it to the current
    timestamp. To assign the current timestamp, set the column
    to [`CURRENT_TIMESTAMP`](date-and-time-functions.html#function_current-timestamp) or a
  ...
  + [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns declared
  ...
  + No [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column is
  ...
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") behaviors that are
...
<td><code class="literal">NULL</code></td>
  ...
  synchronizing to disk. See [Section B.3.3.3, “What to Do If MySQL Keeps Crashing”](crashing.html "B.3.3.3 What to Do If MySQL Keeps Crashing"). This
  variable is set to `ON` if you start
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with the
  [`--flush`](server-options.html#option_mysqld_flush) option.

  Note

  If [`flush`](server-system-variables.html#sysvar_flush) is enabled, the
  value of [`flush_time`](server-system-variables.html#sysvar_flush_time) does
  not matter and changes to
  [`flush_time`](server-system-variables.html#sysvar_flush_time) have no effect
  on flush behavior.
...
<td><code class="literal">NULL</code></td>
  ...
  [`flush_time`](server-system-variables.html#sysvar_flush_time) seconds to free up
...
<td><code class="literal">NULL</code></td>
  ...
  Likewise, an [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") tables as it does for
  `InnoDB` tables. Typically you leave this
  setting enabled during normal operation, to enforce
  [referential
  integrity](glossary.html#glos_referential_integrity "referential integrity"). Disabling foreign key checking can be useful
  ...
  [`DROP
  SCHEMA`](drop-database.html "15.1.28 DROP DATABASE Statement") drops a schema even if it contains tables
  that have foreign keys that are referred to by tables outside
  the schema, and [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement")
  ...
  [`foreign_key_checks = 0`](server-system-variables.html#sysvar_foreign_key_checks) are
  not verified for consistency.

  Dropping an index required by a foreign key constraint is
  not permitted, even with
  [`foreign_key_checks=0`](server-system-variables.html#sysvar_foreign_key_checks). The
...
<td><code class="literal">NULL</code></td>
  ...
  [`log_output`](server-system-variables.html#sysvar_log_output) system variable;
...
<td><code class="literal">NULL</code></td>
  ...
  [`--general_log_file`](server-system-variables.html#sysvar_general_log_file) option.

* [`generated_random_password_length`](server-system-variables.html#sysvar_generated_random_password_length)
...
<td><code class="literal">NULL</code></td>
  ...
  generated for [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement"),
  [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement"), and
  [`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement") statements. For
  more information, see
  [Random Password Generation](password-management.html#random-password-generation "Random Password Generation").

* [`global_connection_memory_limit`](server-system-variables.html#sysvar_global_connection_memory_limit)
...
<td><code class="literal">NULL</code></td>
  ...
  are rejected with
  [`ER_GLOBAL_CONN_LIMIT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_global_conn_limit).
  ...
  Memory used by the [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") buffer
...
* [`global_connection_memory_status_limit`](server-system-variables.html#sysvar_global_connection_memory_status_limit)
...
<td>String</td>
  ...
  [`Count_hit_query_past_global_connection_memory_status_limit`](server-status-variables.html#statvar_Count_hit_query_past_global_connection_memory_status_limit)
  is incremented.

* [`global_connection_memory_tracking`](server-system-variables.html#sysvar_global_connection_memory_tracking)
...
<td>String</td>
  ...
  [`GROUP_CONCAT()`](aggregate-functions.html#function_group-concat) function. The
  default is 1024.
...
* [`have_compress`](server-system-variables.html#sysvar_have_compress)
  ...
  [`UNCOMPRESS()`](encryption-functions.html#function_uncompress) functions cannot
  be used.

* [`have_dynamic_loading`](server-system-variables.html#sysvar_have_dynamic_loading)

  `YES` if [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") supports
  dynamic loading of plugins, `NO` if not. If
  the value is `NO`, you cannot use options
  such as [`--plugin-load`](server-options.html#option_mysqld_plugin-load) to load
  plugins at server startup, or the [`INSTALL
  PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") statement to load plugins at runtime.
...
* [`have_query_cache`](server-system-variables.html#sysvar_have_query_cache)
  ...
  [`have_query_cache`](server-system-variables.html#sysvar_have_query_cache) is
...
<td>String</td>
  ...
  (see [Statement Execution Time Optimizer Hints](optimizer-hints.html#optimizer-hints-execution-time "Statement Execution Time Optimizer Hints")). The
...
* [`have_symlink`](server-system-variables.html#sysvar_have_symlink)
  ...
  [`--skip-symbolic-links`](server-options.html#option_mysqld_symbolic-links)
  ...
  [`--symbolic-links`](server-options.html#option_mysqld_symbolic-links) option that
  ...
  [`have_symlink`](server-system-variables.html#sysvar_have_symlink) system
  variable also is deprecated and you should expect it to be
  removed in a future version of MySQL.

* [`histogram_generation_max_mem_size`](server-system-variables.html#sysvar_histogram_generation_max_mem_size)
...
<td>String</td>
  ...
  [Section 10.9.6, “Optimizer Statistics”](optimizer-statistics.html "10.9.6 Optimizer Statistics"), and
...
<td>String</td>
  ...
  The [`host_cache_size`](server-system-variables.html#sysvar_host_cache_size) variable
  controls the size of the host cache, as well as the size of
  the Performance Schema [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table")
  table that exposes the cache contents. Setting
  [`host_cache_size`](server-system-variables.html#sysvar_host_cache_size) has these
  effects:
  ...
  + Changing the size at runtime causes an implicit host cache
    ...
    the [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table, and
    unblocks any blocked hosts.

  The default value is autosized to 128, plus 1 for a value of
  [`max_connections`](server-system-variables.html#sysvar_max_connections) up to 500,
  plus 1 for every increment of 20 over 500 in the
  [`max_connections`](server-system-variables.html#sysvar_max_connections) value, capped
  to a limit of 2000.
...
* [`identity`](server-system-variables.html#sysvar_identity)
  ...
  [`last_insert_id`](server-system-variables.html#sysvar_last_insert_id) variable. It
...
<td>String</td>
  ...
  the deprecated [`SUPER`](privileges-provided.html#priv_super)
  privilege), the content of
  [`init_connect`](server-system-variables.html#sysvar_init_connect) is not executed.
  This is done so that an erroneous value for
  [`init_connect`](server-system-variables.html#sysvar_init_connect) does not prevent
  ...
  [`init_connect`](server-system-variables.html#sysvar_init_connect) for users that
  have the [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) or
  [`SUPER`](privileges-provided.html#priv_super) privilege enables them to
  open a connection and fix the
  [`init_connect`](server-system-variables.html#sysvar_init_connect) value.

  [`init_connect`](server-system-variables.html#sysvar_init_connect) execution is
  skipped for any client user with an expired password. This is
  done because such a user cannot execute arbitrary statements,
  and thus [`init_connect`](server-system-variables.html#sysvar_init_connect)
  execution fails, leaving the client unable to connect.
  Skipping [`init_connect`](server-system-variables.html#sysvar_init_connect)
  execution enables the user to connect and change password.

  The server discards any result sets produced by statements in
  the value of [`init_connect`](server-system-variables.html#sysvar_init_connect).
...
<td>String</td>
  ...
  [`autocommit=0`](server-system-variables.html#sysvar_autocommit) or after
  [`START
...
<td>String</td>
  ...
  [`GRANT`](grant.html "15.7.1.6 GRANT Statement")), replication, and global
  transaction identifiers. See
  [Section 19.1.3, “Replication with Global Transaction Identifiers”](replication-gtids.html "19.1.3 Replication with Global Transaction Identifiers").
  ...
  [`completion_type`](server-system-variables.html#sysvar_completion_type),
  [`explicit_defaults_for_timestamp`](server-system-variables.html#sysvar_explicit_defaults_for_timestamp),
  and [`default_table_encryption`](server-system-variables.html#sysvar_default_table_encryption).

  These threads are also used to execute the statements in any
  file specified with [`init_file`](server-system-variables.html#sysvar_init_file)
  when starting the server, so such statements execute with the
  server's built-in default values for those system variables.

* `innodb_xxx`

  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") system variables are
  listed in [Section 17.14, “InnoDB Startup Options and System Variables”](innodb-parameters.html "17.14 InnoDB Startup Options and System Variables"). These variables
...
* [`insert_id`](server-system-variables.html#sysvar_insert_id)
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement when
...
<td>String</td>
  ...
  [`mysql_real_connect()`](/doc/c-api/9.5/en/mysql-real-connect.html). See also
  [`wait_timeout`](server-system-variables.html#sysvar_wait_timeout).

* [`internal_tmp_mem_storage_engine`](server-system-variables.html#sysvar_internal_tmp_mem_storage_engine)
...
<td>String</td>
  ...
  (see [Section 10.4.4, “Internal Temporary Table Use in MySQL”](internal-temporary-tables.html "10.4.4 Internal Temporary Table Use in MySQL")). Permitted
  values are `TempTable` (the default) and
  `MEMORY`.

  The [optimizer](glossary.html#glos_optimizer "optimizer") uses the
...
<td>String</td>
  ...
  [`join_buffer_size`](server-system-variables.html#sysvar_join_buffer_size) to get a
  ...
  [`join_buffer_size`](server-system-variables.html#sysvar_join_buffer_size) is
  ...
  [Section 10.9.3, “Optimizer Hints”](optimizer-hints.html "10.9.3 Optimizer Hints")). Memory allocation time can
  ...
  [`join_buffer_size`](server-system-variables.html#sysvar_join_buffer_size) defines how
  ...
  [Section 10.2.1.7, “Nested-Loop Join Algorithms”](nested-loop-joins.html "10.2.1.7 Nested-Loop Join Algorithms"). For information about
  Batched Key Access, see
  [Section 10.2.1.12, “Block Nested-Loop and Batched Key Access Joins”](bnl-bka-optimization.html "10.2.1.12 Block Nested-Loop and Batched Key Access Joins"). For information about
  hash joins, see [Section 10.2.1.4, “Hash Join Optimization”](hash-joins.html "10.2.1.4 Hash Join Optimization").
...
<td>String</td>
  ...
  [`keep_files_on_create`](server-system-variables.html#sysvar_keep_files_on_create) variable
...
<td>String</td>
  ...
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) is the size
  ...
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) to 0
  dynamically. A setting of 0 drops the key cache, which is not
  permitted at runtime. Setting
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) to 0 is
  permitted only at startup, in which case the key cache is not
  initialized. Changing the
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) setting at
  runtime from a value of 0 to a permitted non-zero value
  initializes the key cache.

  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) can be
  ...
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) is
  ...
  [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") storage engine, 25% of the
  ...
  use [`LOCK TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements"). See
  ...
  [`SHOW STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") statement and
  examining the
  ...
  [`Key_write_requests`](server-status-variables.html#statvar_Key_write_requests), and
  [`Key_writes`](server-status-variables.html#statvar_Key_writes) status variables.
  (See [Section 15.7.7, “SHOW Statements”](show.html "15.7.7 SHOW Statements").) The
  ...
  [`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) in
  conjunction with the
  [`Key_blocks_unused`](server-status-variables.html#statvar_Key_blocks_unused) status
  variable and the buffer block size, which is available from
  the [`key_cache_block_size`](server-system-variables.html#sysvar_key_cache_block_size)
  system variable:
...
<td>String</td>
  ...
  default value is 300. See [Section 10.10.2, “The MyISAM Key Cache”](myisam-key-cache.html "10.10.2 The MyISAM Key Cache").
...
<td>String</td>
  ...
  value is 1024. See [Section 10.10.2, “The MyISAM Key Cache”](myisam-key-cache.html "10.10.2 The MyISAM Key Cache").
...
<td>String</td>
  ...
  Whether [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was compiled with options
...
<td>String</td>
  ...
  [`--large-pages`](server-options.html#option_mysqld_large-pages) option). See
...
<td>String</td>
  ...
  See [Section 10.12.3.3, “Enabling Large Page Support”](large-page-support.html "10.12.3.3 Enabling Large Page Support").

* [`last_insert_id`](server-system-variables.html#sysvar_last_insert_id)

  The value to be returned from
  [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id). This is
  stored in the binary log when you use
  [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) in a statement
  that updates a table. Setting this variable does not update
  the value returned by the
  [`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html) C API
  function.
...
<td>String</td>
  ...
  [`lc_messages_dir`](server-system-variables.html#sysvar_lc_messages_dir) to produce
...
<td>String</td>
  ...
  [`lc_messages`](server-system-variables.html#sysvar_lc_messages) to produce the
...
<td>String</td>
  ...
  [`DATE_FORMAT()`](date-and-time-functions.html#function_date-format),
  [`DAYNAME()`](date-and-time-functions.html#function_dayname) and
  [`MONTHNAME()`](date-and-time-functions.html#function_monthname) functions. Locale
...
<td>String</td>
  ...
  [`local_infile`](server-system-variables.html#sysvar_local_infile) setting, the
  ...
  [`LOAD DATA
  LOCAL`](load-data.html "15.2.9 LOAD DATA Statement") statements (regardless of how client programs
  and libraries are configured at build time or runtime), start
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with
  [`local_infile`](server-system-variables.html#sysvar_local_infile) disabled or
  enabled, respectively.
  [`local_infile`](server-system-variables.html#sysvar_local_infile) can also be set
...
<td>String</td>
  ...
  and [`HANDLER`](handler.html "15.2.5 HANDLER Statement") statements.

  This timeout does not apply to implicit accesses to system
  tables in the `mysql` database, such as grant
  tables modified by [`GRANT`](grant.html "15.7.1.6 GRANT Statement") or
  [`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement") statements or table
  ...
  [`lock_wait_timeout`](server-system-variables.html#sysvar_lock_wait_timeout) value
  before reporting a timeout error. When lock timeout occurs,
  [`ER_LOCK_WAIT_TIMEOUT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_lock_wait_timeout) is
  reported.

  [`lock_wait_timeout`](server-system-variables.html#sysvar_lock_wait_timeout) also
  defines the amount of time that a [`LOCK
  INSTANCE FOR BACKUP`](lock-instance-for-backup.html "15.3.5 LOCK INSTANCE FOR BACKUP and UNLOCK INSTANCE Statements") statement waits for a lock
  before giving up.
...
<td>String</td>
  ...
  Whether [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was locked in memory with
...
<td>String</td>
  ...
  [`log_error`](server-system-variables.html#sysvar_log_error) value is the file
...
<td>String</td>
  ...
  [`log_error_services`](server-system-variables.html#sysvar_log_error_services) is
  implicitly loaded if it is not already loaded. For more
  information, see [Section 7.4.2.1, “Error Log Configuration”](error-log-configuration.html "7.4.2.1 Error Log Configuration").

* [`log_error_suppression_list`](server-system-variables.html#sysvar_log_error_suppression_list)
...
<td>String</td>
  ...
  [Section 7.5.3, “Error Log Components”](error-log-components.html "7.5.3 Error Log Components")). If
  ...
  [MySQL 9.5 Error Message Reference](/doc/mysql-errors/9.5/en/).

  The effect of
  [`log_error_suppression_list`](server-system-variables.html#sysvar_log_error_suppression_list)
  combines with that of
  [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity). For
...
<td>String</td>
  ...
  The [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity)
  ...
  [Section 7.5.3, “Error Log Components”](error-log-components.html "7.5.3 Error Log Components")). If
  `log_filter_internal` is disabled,
  [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) has no
  effect.

  Events intended for the error log have a priority of
  `ERROR`, `WARNING`, or
  `INFORMATION`.
  [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) controls
...
<td>String</td>
  ...
  [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) value.
  These messages include startup and shutdown messages, and some
  significant changes to settings.

  The effect of
  [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) combines
  with that of
  [`log_error_suppression_list`](server-system-variables.html#sysvar_log_error_suppression_list).
  For additional information, see
  [Section 7.4.2.5, “Priority-Based Error Log Filtering (log\_filter\_internal)”](error-log-priority-based-filtering.html "7.4.2.5 Priority-Based Error Log Filtering (log_filter_internal)").
...
<td>String</td>
  ...
  [`general_log`](server-system-variables.html#sysvar_general_log) and
  ...
  [`general_log`](server-system-variables.html#sysvar_general_log) and
  [`slow_query_log`](server-system-variables.html#sysvar_slow_query_log) system
  variables. For `FILE` logging, the
  [`general_log_file`](server-system-variables.html#sysvar_general_log_file) and
  [`slow_query_log_file`](server-system-variables.html#sysvar_slow_query_log_file) system
  variables determine the log file locations. For more
  information, see [Section 7.4.1, “Selecting General Query Log and Slow Query Log Output Destinations”](log-destinations.html "7.4.1 Selecting General Query Log and Slow Query Log Output Destinations").
...
<td>String</td>
  ...
  [Section 7.4.5, “The Slow Query Log”](slow-query-log.html "7.4.5 The Slow Query Log"). This option does not
...
* [`log_raw`](server-system-variables.html#sysvar_log_raw)
...
<td>String</td>
  ...
  The [`log_raw`](server-system-variables.html#sysvar_log_raw) system variable
  is initially set to the value of the
  [`--log-raw`](server-options.html#option_mysqld_log-raw) option. See the
...
<td>String</td>
  ...
  include [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"),
  [`ANALYZE TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement"),
...
* [`log_slow_extra`](server-system-variables.html#sysvar_log_slow_extra)
...
<td>String</td>
  ...
  statements. See [Section 7.4.5, “The Slow Query Log”](slow-query-log.html "7.4.5 The Slow Query Log").
...
<td>String</td>
  ...
  [`CONVERT_TZ()`](date-and-time-functions.html#function_convert-tz) or by setting the
  session [`time_zone`](server-system-variables.html#sysvar_time_zone) system
  variable.

  Permitted [`log_timestamps`](server-system-variables.html#sysvar_log_timestamps)
...
<td>String</td>
  ...
  increments the [`Slow_queries`](server-status-variables.html#statvar_Slow_queries)
  ...
  [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") performs a full table scan, which
  means its queries can often exceed a
  [`long_query_time`](server-system-variables.html#sysvar_long_query_time) setting that
  is useful for regular queries. If you want to exclude most or
  all of the queries generated by [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
  from the slow query log, you can use
  [`--mysqld-long-query-time`](mysqldump.html#option_mysqldump_mysqld-long-query-time) to
...
<td>String</td>
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement"),
  [`DELETE`](delete.html "15.2.2 DELETE Statement"), and `LOCK TABLE
  WRITE` statements wait until there is no pending
  [`SELECT`](select.html "15.2.13 SELECT Statement") or `LOCK TABLE
...
<td>String</td>
  ...
  [`lower_case_file_system`](server-system-variables.html#sysvar_lower_case_file_system)). On
  ...
  You should *not* set
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) to 0
  ...
  [`--lower_case_table_names=0`](server-system-variables.html#sysvar_lower_case_table_names) on
  a case-insensitive file system.

  The setting of this variable affects the behavior of
  replication filtering options with regard to case sensitivity.
  For more information, see [Section 19.2.5, “How Servers Evaluate Replication Filtering Rules”](replication-rules.html "19.2.5 How Servers Evaluate Replication Filtering Rules").
  ...
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) to the
  desired setting before initializing the server. In most cases,
  this requires configuring
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) in a
  ...
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names). To do
...
* [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles)
...
<td>String</td>
  ...
  setting [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) does
  ...
  Setting the runtime value of
  [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) requires the
  [`ROLE_ADMIN`](privileges-provided.html#priv_role-admin) privilege, in
  addition to the
  [`SYSTEM_VARIABLES_ADMIN`](privileges-provided.html#priv_system-variables-admin)
  privilege (or the deprecated
  [`SUPER`](privileges-provided.html#priv_super) privilege) normally
  ...
  The [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) value is
  ...
  [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) cannot be
  revoked with [`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement") or dropped
  with [`DROP ROLE`](drop-role.html "15.7.1.4 DROP ROLE Statement") or
  ...
  [`SYSTEM_USER`](privileges-provided.html#priv_system-user) privilege cannot be
  listed in the value of the
  [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) system
  variable:

  + If [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) is
    assigned a role at startup that has the
    [`SYSTEM_USER`](privileges-provided.html#priv_system-user) privilege, the
    server writes a message to the error log and exits.

  + If [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) is
    assigned a role at runtime that has the
    [`SYSTEM_USER`](privileges-provided.html#priv_system-user) privilege, an
    error occurs and the
    [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) value
    remains unchanged.

  Mandatory roles, like explicitly granted roles, do not take
  effect until activated (see
  [Activating Roles](roles.html#roles-activating "Activating Roles")). At login time, role
  ...
  [`SET ROLE`](set-role.html "15.7.1.11 SET ROLE Statement") activates roles.

  Roles that do not exist when assigned to
  [`mandatory_roles`](server-system-variables.html#sysvar_mandatory_roles) but are
  created later may require special treatment to be considered
  mandatory. For details, see [Defining Mandatory Roles](roles.html#mandatory-roles "Defining Mandatory Roles").
...
* [`activate_mandatory_roles`](server-system-variables.html#sysvar_activate_mandatory_roles)
...
<td>String</td>
  ...
  Activates mandatory roles.

  + If
    [`activate_all_roles_on_login`](server-system-variables.html#sysvar_activate_all_roles_on_login)
    is enabled,
    [`activate_mandatory_roles`](server-system-variables.html#sysvar_activate_mandatory_roles)
    is ignored, and both mandatory and granted roles are
    activated. If
    [`activate_all_roles_on_login`](server-system-variables.html#sysvar_activate_all_roles_on_login)
    is disabled and
    [`activate_mandatory_roles`](server-system-variables.html#sysvar_activate_mandatory_roles)
    is enabled, mandatory roles are activated in addition to
    any default roles associated with the account.

    If neither are activated, only the account's default roles
    are activated.
...
<td>String</td>
  ...
  [`mysql_stmt_send_long_data()`](/doc/c-api/9.5/en/mysql-stmt-send-long-data.html) C
  API function. The default is 64MB.

  The packet message buffer is initialized to
  [`net_buffer_length`](server-system-variables.html#sysvar_net_buffer_length) bytes, but
  can grow up to
  [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) bytes when
  ...
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") columns or long strings.
  It should be as big as the largest
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") you want to use. The
  protocol limit for
  [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) is 1GB.
  ...
  of the [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet)
  ...
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") have
  defaults of 16MB and 24MB, respectively. They also enable you
  to change the client-side value by setting
  [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) on the
...
<td>String</td>
  ...
  After [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors)
  ...
  [`max_connect_errors`](server-system-variables.html#sysvar_max_connect_errors) attempts
  ...
  [Flushing the Host Cache](host-cache.html#host-cache-flushing "Flushing the Host Cache").
...
<td>String</td>
  ...
  ) + 64`](encryption-functions.html#function_statement-digest-text). This means that, when the value of
  ...
  Setting [`max_digest_length`](server-system-variables.html#sysvar_max_digest_length)
  ...
  Decreasing the
  [`max_digest_length`](server-system-variables.html#sysvar_max_digest_length) value
  ...
  [`max_digest_length`](server-system-variables.html#sysvar_max_digest_length) bytes per
  session).
  ...
  [`performance_schema_max_digest_length`](performance-schema-system-variables.html#sysvar_performance_schema_max_digest_length)
  is less than
  [`max_digest_length`](server-system-variables.html#sysvar_max_digest_length), digest
...
<td>String</td>
  ...
  ERRORS`](show-errors.html "15.7.7.19 SHOW ERRORS Statement") and [`SHOW
  WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") statements. This is the same as the number
...
<td>String</td>
  ...
  [`max_execution_time`](server-system-variables.html#sysvar_max_execution_time) applies as
  follows:

  + The global
    [`max_execution_time`](server-system-variables.html#sysvar_max_execution_time) value
    ...
    [`MAX_EXECUTION_TIME(N)`](optimizer-hints.html#optimizer-hints-execution-time "Statement Execution Time Optimizer Hints")
    optimizer hint or for which *`N`*
    is 0.

  + [`max_execution_time`](server-system-variables.html#sysvar_max_execution_time)
    applies to read-only [`SELECT`](select.html "15.2.13 SELECT Statement")
    statements. Statements that are not read only are those
    that invoke a stored function that modifies data as a side
    effect.

  + [`max_execution_time`](server-system-variables.html#sysvar_max_execution_time) is
    ignored for [`SELECT`](select.html "15.2.13 SELECT Statement")
...
<td>String</td>
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or altered with
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") or
  [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"). A server
  ...
  [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) to limit the
  size of internal in-memory tables. See
  [Section 10.4.4, “Internal Temporary Table Use in MySQL”](internal-temporary-tables.html "10.4.4 Internal Temporary Table Use in MySQL") and
  [`Count_hit_tmp_table_size`](server-status-variables.html#statvar_Count_hit_tmp_table_size).

  `max_heap_table_size` is not replicated. See
  [Section 19.5.1.22, “Replication and MEMORY Tables”](replication-features-memory.html "19.5.1.22 Replication and MEMORY Tables"), and
  [Section 19.5.1.40, “Replication and Variables”](replication-features-variables.html "19.5.1.40 Replication and Variables"), for more
  information.
...
<td>String</td>
  ...
  [`max_delayed_threads`](server-system-variables.html#sysvar_max_delayed_threads). Like
  [`max_delayed_threads`](server-system-variables.html#sysvar_max_delayed_threads), it is
...
<td>String</td>
  ...
  [Section 15.7.7.24, “SHOW INDEX Statement”](show-index.html "15.7.7.24 SHOW INDEX Statement")). By setting this to a low value
...
<td>String</td>
  ...
  only the first
  [`max_sort_length`](server-system-variables.html#sysvar_max_sort_length) bytes of any
  such value and ignores the rest. Consequently, such values
  that differ only after the first
  [`max_sort_length`](server-system-variables.html#sysvar_max_sort_length) bytes compare
  ...
  [`max_sort_length`](server-system-variables.html#sysvar_max_sort_length) may require
  increasing the value of
  [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size) as well. For
  details, see [Section 10.2.1.16, “ORDER BY Optimization”](order-by-optimization.html "10.2.1.16 ORDER BY Optimization")
...
<td>String</td>
  ...
  [`max_sp_recursion_depth`](server-system-variables.html#sysvar_max_sp_recursion_depth), it
  may be necessary to increase thread stack size by increasing
  the value of [`thread_stack`](server-system-variables.html#sysvar_thread_stack) at
  server startup.
...
<td>String</td>
  ...
  [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") or
  [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") statement. See
...
<td>String</td>
  ...
  [`max_write_lock_count`](server-system-variables.html#sysvar_max_write_lock_count) is set
  ...
  [`max_write_lock_count`](server-system-variables.html#sysvar_max_write_lock_count) by
  default has a very large value.

* [`mecab_rc_file`](server-system-variables.html#sysvar_mecab_rc_file)
...
<td>String</td>
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") for
...
<td>String</td>
  ...
  (during [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"),
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), or
  [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement")). If the file size
...
<td>String</td>
  ...
  compressed [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") files. If many
...
<td>String</td>
  ...
  time [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") opens a
  ...
  disabled.) If this is the case, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") runs
  a check on the table. If the table was corrupted,
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") attempts to repair it.
...
<td>String</td>
  ...
  See [Section 18.2.1, “MyISAM Startup Options”](myisam-start.html "18.2.1 MyISAM Startup Options").
...
<td>String</td>
  ...
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") or when creating
  indexes with [`CREATE INDEX`](create-index.html "15.1.18 CREATE INDEX Statement") or
...
<td>String</td>
  ...
  execution, as described in [Section 10.3.8, “InnoDB and MyISAM Index Statistics Collection”](index-statistics.html "10.3.8 InnoDB and MyISAM Index Statistics Collection").
...
<td>String</td>
  ...
  [`named_pipe`](server-system-variables.html#sysvar_named_pipe) system variable is
...
<td>String</td>
  ...
  [`net_buffer_length`](server-system-variables.html#sysvar_net_buffer_length) but are
  dynamically enlarged up to
  [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) bytes as
  needed. The result buffer shrinks to
  [`net_buffer_length`](server-system-variables.html#sysvar_net_buffer_length) after each
  SQL statement.
  ...
  value to which
  [`net_buffer_length`](server-system-variables.html#sysvar_net_buffer_length) can be set
  is 1MB.
...
<td>String</td>
  ...
  client, [`net_read_timeout`](server-system-variables.html#sysvar_net_read_timeout) is
  the timeout value controlling when to abort. When the server
  is writing to the client,
  [`net_write_timeout`](server-system-variables.html#sysvar_net_write_timeout) is the
...
* [`ngram_token_size`](server-system-variables.html#sysvar_ngram_token_size)
...
<td>String</td>
  ...
  receive an error. The precise error and error message are
  determined as follows:

  1. The server attempts to obtain the value of an attribute
     named `reason` attached to
     [`offline_mode`](server-system-variables.html#sysvar_offline_mode); this is
  ...
  2. If `@sreason` is not
     `NULL`, the server tries to obtain the
     time the [`offline_mode`](server-system-variables.html#sysvar_offline_mode)
     ...
     + If *`@stime`* is not
       `NULL`, the server raises
       [`ER_SERVER_OFFLINE_MODE_REASON`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_server_offline_mode_reason),
     ...
     + If *`@stime`* is
       `NULL`, the server raises
       [`ER_SERVER_OFFLINE_MODE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_server_offline_mode)
       and prints the message The server is
       currently in offline mode.

  3. If *`@sreason`* is empty, the
     ...
     + If neither *`@stime`* nor
       *`@suser`* is
       `NULL`, the server raises
       `ER_SERVER_OFFLINE_MODE_USER` and
  ...
  For more information about the Performance Schema tables used
  here, see
  [Section 29.12.14.1, “Performance Schema global\_variable\_attributes Table”](performance-schema-global-variable-attributes-table.html "29.12.14.1 Performance Schema global_variable_attributes Table"),
  and [Section 29.12.14.3, “Performance Schema variables\_info Table”](performance-schema-variables-info-table.html "29.12.14.3 Performance Schema variables_info Table").

  To put a server in offline mode, change the value of the
  [`offline_mode`](server-system-variables.html#sysvar_offline_mode) system variable
  from `OFF` to `ON`. To
  resume normal operations, change
  [`offline_mode`](server-system-variables.html#sysvar_offline_mode) from
  `ON` to `OFF`. To control
  ...
  [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) is required,
  ...
  + Connected client users who have the
    [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) or
    [`SUPER`](privileges-provided.html#priv_super) privilege are not
    disconnected, and can initiate new connections to manage
    the server.

  + If the user that puts a server in offline mode does not
    have the [`SYSTEM_USER`](privileges-provided.html#priv_system-user)
    ...
    [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) or
    [`SUPER`](privileges-provided.html#priv_super) privilege as well. It
...
<td>String</td>
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") operation. It reverts to using a temporary
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), see
  [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement").

  `ALTER TABLE ... DROP PARTITION` with
  [`old_alter_table=ON`](server-system-variables.html#sysvar_old_alter_table) rebuilds
  ...
  with [`old_alter_table=ON`](server-system-variables.html#sysvar_old_alter_table)
...
<td>String</td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") from the operating system:

  + At startup, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") reserves descriptors
    with `setrlimit()`, using the value
    requested at by setting this variable directly or by using
    the [`--open-files-limit`](mysqld-safe.html#option_mysqld_safe_open-files-limit)
    option to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). If
    [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") produces the error `Too
    many open files`, try increasing the
    [`open_files_limit`](server-system-variables.html#sysvar_open_files_limit) value.
  ...
  + At runtime, the value of
    ...
    permitted to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") by the operating
    ...
    [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") writes a warning to the error
    log.

  The effective
  [`open_files_limit`](server-system-variables.html#sysvar_open_files_limit) value is
  based on the value specified at system startup (if any) and
  the values of [`max_connections`](server-system-variables.html#sysvar_max_connections)
  and [`table_open_cache`](server-system-variables.html#sysvar_table_open_cache), using
  these formulas:
...
<td>String</td>
  ...
  details, see [Section 10.15, “Tracing the Optimizer”](optimizer-tracing.html "10.15 Tracing the Optimizer").
...
* `performance_schema_xxx`
  ...
  [Section 29.15, “Performance Schema System Variables”](performance-schema-system-variables.html "29.15 Performance Schema System Variables"). These
...
* [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes)
...
<td>String</td>
  ...
  [`UPDATE`](privileges-provided.html#priv_update) privilege can be
  ...
  [`UPDATE`](privileges-provided.html#priv_update) privilege on all schemas
  except the `mysql` schema.) In this sense,
  the user's global [`UPDATE`](privileges-provided.html#priv_update)
  privilege is partially revoked.

  Once enabled, [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes)
  cannot be disabled if any account has privilege restrictions.
  If any such account exists, disabling
  [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes) fails:

  + For attempts to disable
    [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes) at
  ...
  + For attempts to disable
    ...
    [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes) value
    remains unchanged.

  To disable [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes) in
  ...
  [`partial_revokes`](server-system-variables.html#sysvar_partial_revokes) causes
  ...
  partial revokes, see [Section 8.2.12, “Privilege Restriction Using Partial Revokes”](partial-revokes.html "8.2.12 Privilege Restriction Using Partial Revokes").

* [`password_history`](server-system-variables.html#sysvar_password_history)
...
<td>String</td>
  ...
  USER`](create-user.html "15.7.1.3 CREATE USER Statement") and [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement")
  statements. See [Section 8.2.15, “Password Management”](password-management.html "8.2.15 Password Management").

* [`password_reuse_interval`](server-system-variables.html#sysvar_password_reuse_interval)
...
<td>String</td>
  ...
  [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files")). Disabling
  [`persisted_globals_load`](server-system-variables.html#sysvar_persisted_globals_load) causes
  ...
  [`SET
  PERSIST_ONLY`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"), and [`RESET
  PERSIST`](reset-persist.html "15.7.8.7 RESET PERSIST Statement") statements. See
  [Section 7.1.9.3, “Persisted System Variables”](persisted-system-variables.html "7.1.9.3 Persisted System Variables").

* [`persist_only_admin_x509_subject`](server-system-variables.html#sysvar_persist_only_admin_x509_subject)
...
<td>String</td>
  ...
  PERSIST`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") and
  [`SET
  PERSIST_ONLY`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") enable system variables to be persisted
  to the `mysqld-auto.cnf` option file in the
  data directory (see [Section 15.7.6.1, “SET Syntax for Variable Assignment”](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")).
  ...
  [`SET
  PERSIST_ONLY`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") to persist persist-restricted system
  variables. For information about persist-restricted system
  variables and instructions for configuring MySQL to enable
  [`persist_only_admin_x509_subject`](server-system-variables.html#sysvar_persist_only_admin_x509_subject),
  see [Section 7.1.9.4, “Nonpersistible and Persist-Restricted System Variables”](nonpersistible-system-variables.html "7.1.9.4 Nonpersistible and Persist-Restricted System Variables").

* [`persist_sensitive_variables_in_plaintext`](server-system-variables.html#sysvar_persist_sensitive_variables_in_plaintext)
...
<td>String</td>
  ...
  [`SET
  PERSIST`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") is used to set the value of the system
  ...
  variables; a keyring component (see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring"))
...
<td><code class="literal">65535</code></td>
  ...
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") to determine the server's
  process ID. On Windows, this variable also affects the default
  error log file name. See [Section 7.4.2, “The Error Log”](error-log.html "7.4.2 The Error Log").
...
<td><code class="literal">65535</code></td>
  ...
  ... INTO DUMPFILE`](select.html "15.2.13 SELECT Statement"). This can be prevented by making
  [`plugin_dir`](server-system-variables.html#sysvar_plugin_dir) read only to the
  server or by setting
  [`secure_file_priv`](server-system-variables.html#sysvar_secure_file_priv) to a
  directory where [`SELECT`](select.html "15.2.13 SELECT Statement") writes
  can be made safely.
...
<td><code class="literal">65535</code></td>
  ...
  CREATE USER`](show-create-user.html "15.7.7.14 SHOW CREATE USER Statement") may contain unprintable characters that
  have adverse effects on terminal displays and in other
  environments. Enabling
  [`print_identified_with_as_hex`](server-system-variables.html#sysvar_print_identified_with_as_hex)
  causes [`SHOW CREATE USER`](show-create-user.html "15.7.7.14 SHOW CREATE USER Statement") to
...
* [`profiling`](server-system-variables.html#sysvar_profiling)
  ...
  [`SHOW PROFILES`](show-profiles.html "15.7.7.34 SHOW PROFILES Statement") statements
...
* [`profiling_history_size`](server-system-variables.html#sysvar_profiling_history_size)
  ...
  information if [`profiling`](server-system-variables.html#sysvar_profiling) is
...
<td><code class="literal">65535</code></td>
  ...
  [Section 22.5.5, “Connection Compression with X Plugin”](x-plugin-connection-compression.html "22.5.5 Connection Compression with X Plugin") for
...
* [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode)
...
<td><code class="literal">65535</code></td>
  ...
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) is for
  ...
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) to true
  before executing any SQL statements.

  Setting the session value of
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) is a
  ...
  (see [Section 19.3.3, “Replication Privilege Checks”](replication-privilege-checks.html "19.3.3 Replication Privilege Checks")), or
  privileges sufficient to set restricted session variables (see
  [Section 7.1.9.1, “System Variable Privileges”](system-variable-privileges.html "7.1.9.1 System Variable Privileges")). However, note
  that the variable is not intended for users to set; it is set
  automatically by the replication infrastructure.

  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) has the
  ...
  [`XA START`](xa.html "15.3.8 XA Transactions")):

  + If true, and the handling session has executed an
    internal-use [`BINLOG`](binlog.html "15.7.8.1 BINLOG Statement")
    statement, XA transactions are automatically detached from
    the session as soon as the first part of the transaction
    up to [`XA
    PREPARE`](xa.html "15.3.8 XA Transactions") finishes, so they can be committed or
  ...
  + If false, the server rejects the statement with
    [`ER_UNSUPPORTED_SQL_MODE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_unsupported_sql_mode).
...
<td><code class="literal">65535</code></td>
  ...
  `query_prealloc_size` is deprecated, and
...
<td><code class="literal">65535</code></td>
  ...
  The [`rand_seed1`](server-system-variables.html#sysvar_rand_seed1) and
  [`rand_seed2`](server-system-variables.html#sysvar_rand_seed2) variables exist as
  session variables only, and can be set but not read. The
  variables—but not their values—are shown in the
  output of [`SHOW VARIABLES`](show-variables.html "15.7.7.42 SHOW VARIABLES Statement").

  The purpose of these variables is to support replication of
  the [`RAND()`](mathematical-functions.html#function_rand) function. For
  statements that invoke [`RAND()`](mathematical-functions.html#function_rand),
  ...
  [`rand_seed1`](server-system-variables.html#sysvar_rand_seed1) and
  [`rand_seed2`](server-system-variables.html#sysvar_rand_seed2) so that
  [`RAND()`](mathematical-functions.html#function_rand) on the replica generates
...
<td><code class="literal">65535</code></td>
  ...
  [Limiting Memory Use for Range Optimization](range-optimization.html#range-optimization-memory-use "Limiting Memory Use for Range Optimization").
...
<td><code class="literal">65535</code></td>
  ...
  For internal use by [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"). This
  variable switches the server between
  `IDEMPOTENT` mode and
  `STRICT` mode. `IDEMPOTENT`
  mode causes suppression of duplicate-key and no-key-found
  errors in [`BINLOG`](binlog.html "15.7.8.1 BINLOG Statement") statements
  generated by [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"). This mode is
  useful when replaying a row-based binary log on a server that
  causes conflicts with existing data.
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") sets this mode when you specify
  the [`--idempotent`](mysqlbinlog.html#option_mysqlbinlog_idempotent) option by
...
<td><code class="literal">65535</code></td>
  ...
  [`read_buffer_size`](server-system-variables.html#sysvar_read_buffer_size) is also used
  in one other storage engine-specific way: to determine the
  memory block size for [`MEMORY`](memory-storage-engine.html "18.3 The MEMORY Storage Engine")
  tables.

  [`select_into_buffer_size`](server-system-variables.html#sysvar_select_into_buffer_size) is
  used for the I/O cache buffer for
  [`SELECT INTO
  DUMPFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") and `SELECT INTO OUTFILE`
  statements. ([`read_buffer_size`](server-system-variables.html#sysvar_read_buffer_size)
  is used for the I/O cache buffer size in all other cases.)

  For more information about memory use during different
  operations, see [Section 10.12.3.1, “How MySQL Uses Memory”](memory-use.html "10.12.3.1 How MySQL Uses Memory").
...
<td><code class="literal">65535</code></td>
  ...
  If the [`read_only`](server-system-variables.html#sysvar_read_only) system
  ...
  [`super_read_only`](server-system-variables.html#sysvar_super_read_only) system
  variable (disabled by default), which has these effects:

  + If [`super_read_only`](server-system-variables.html#sysvar_super_read_only) is
    enabled, the server prohibits client updates, even from
    users who have the
    [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) or
    [`SUPER`](privileges-provided.html#priv_super) privilege.

  + Setting [`super_read_only`](server-system-variables.html#sysvar_super_read_only)
    to `ON` implicitly forces
    [`read_only`](server-system-variables.html#sysvar_read_only) to
    `ON`.

  + Setting [`read_only`](server-system-variables.html#sysvar_read_only) to
    `OFF` implicitly forces
    [`super_read_only`](server-system-variables.html#sysvar_super_read_only) to
    `OFF`.

  When [`read_only`](server-system-variables.html#sysvar_read_only) is enabled and
  when [`super_read_only`](server-system-variables.html#sysvar_super_read_only) is
  ...
  + Updates performed by replication threads, if the server is
    ...
    enable [`read_only`](server-system-variables.html#sysvar_read_only) on
  ...
  + Use of [`ANALYZE TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement") or
    [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") statements.
    ...
    with [**mysqlcheck**](mysqlcheck.html "6.5.3 mysqlcheck — A Table Maintenance Program")
    [`--all-databases`](mysqlcheck.html#option_mysqlcheck_all-databases)
    [`--analyze`](mysqlcheck.html#option_mysqlcheck_analyze).

  + Use of [`FLUSH STATUS`](flush.html#flush-status)
  ...
  + Updates to Performance Schema tables, such as
    ...
    [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") operations.

  Changes to [`read_only`](server-system-variables.html#sysvar_read_only) on a
  ...
  [`read_only`](server-system-variables.html#sysvar_read_only) (including implicit
  attempts resulting from enabling
  [`super_read_only`](server-system-variables.html#sysvar_super_read_only)):

  + The attempt fails and an error occurs if you have any
    explicit locks (acquired with [`LOCK
    TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements")) or have a pending transaction.
  ...
  + The attempt blocks while other clients have any ongoing
    ...
    enable [`read_only`](server-system-variables.html#sysvar_read_only) is
    pending, requests by other clients for table locks or to
    begin transactions also block until
    [`read_only`](server-system-variables.html#sysvar_read_only) has been set.

  + The attempt blocks if there are active transactions that
    hold metadata locks, until those transactions end.

  + [`read_only`](server-system-variables.html#sysvar_read_only) can be enabled
    while you hold a global read lock (acquired with
    [`FLUSH TABLES WITH READ
    LOCK`](flush.html#flush-tables-with-read-lock)) because that does not involve table locks.
...
<td><code class="literal">65535</code></td>
  ...
  [Section 10.2.1.16, “ORDER BY Optimization”](order-by-optimization.html "10.2.1.16 ORDER BY Optimization"). Setting the variable
  ...
  For more information about memory use during different
  operations, see [Section 10.12.3.1, “How MySQL Uses Memory”](memory-use.html "10.12.3.1 How MySQL Uses Memory"). For information
...
* [`regexp_stack_limit`](server-system-variables.html#sysvar_regexp_stack_limit)
...
<td><code class="literal">65535</code></td>
  ...
  [`REGEXP_LIKE()`](regexp.html#function_regexp-like) and similar
  functions (see [Section 14.8.2, “Regular Expressions”](regexp.html "14.8.2 Regular Expressions")).

* [`regexp_time_limit`](server-system-variables.html#sysvar_regexp_time_limit)
...
<td><code class="literal">65535</code></td>
  ...
  performed by [`REGEXP_LIKE()`](regexp.html#function_regexp-like) and
  similar functions (see [Section 14.8.2, “Regular Expressions”](regexp.html "14.8.2 Regular Expressions")). This limit
...
* [`require_row_format`](server-system-variables.html#sysvar_require_row_format)
...
<td><code class="literal">65535</code></td>
  ...
  [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"). It restricts DML events
...
<td><code class="literal">65535</code></td>
  ...
  [`require_secure_transport`](server-system-variables.html#sysvar_require_secure_transport) does
  ...
  [`shared_memory`](server-system-variables.html#sysvar_shared_memory) system variable
  disabled. Under these conditions, attempts to enable
  [`require_secure_transport`](server-system-variables.html#sysvar_require_secure_transport) at
  ...
  an
  [`ER_NO_SECURE_TRANSPORTS_CONFIGURED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_secure_transports_configured)
  error.
...
* [`restrict_fk_on_non_standard_key`](server-system-variables.html#sysvar_restrict_fk_on_non_standard_key)
...
<td><code class="literal">65535</code></td>
  ...
  This variable, when `ON` (the default),
  ...
  @@session.restrict_fk_on_non_standard_key=OFF`; to
  ...
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement is
  ...
  `ON`, attempts to do so are rejected with
  [`ER_FK_NO_INDEX_PARENT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_fk_no_index_parent); when it
  is `OFF`, this usage is permitted but still
  raises
  [`ER_WARN_DEPRECATED_NON_STANDARD_KEY`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_warn_deprecated_non_standard_key)
  as a warning.
  ...
  **Implication for MySQL Replication.**
  ...
  primary because
  `restrict_fk_on_non_standard_key` is
  `OFF`, the statement succeeds on the
  replica regardless of any setting on the replica for this
  variable.

* [`resultset_metadata`](server-system-variables.html#sysvar_resultset_metadata)
...
<td><code class="literal">65535</code></td>
  ...
  client sets the
  [`resultset_metadata`](server-system-variables.html#sysvar_resultset_metadata) system
  ...
  [`resultset_metadata`](server-system-variables.html#sysvar_resultset_metadata) to
  `NONE` produces an error.

  For details about managing result set metadata transfer, see
  [Optional Result Set Metadata](/doc/c-api/9.5/en/c-api-optional-metadata.html).

* [`secondary_engine_cost_threshold`](/doc/heatwave/en/heatwave-system-variables.html#sysvar_secondary_engine_cost_threshold)

  For use with MySQL HeatWave only. See
  [System Variables](/doc/heatwave/en/heatwave-system-variables.html), for more
  information.
...
<td><code class="literal">65535</code></td>
  ...
  [`SELECT ... INTO
  OUTFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") statements and the
  [`LOAD_FILE()`](string-functions.html#function_load-file) function. These
  operations are permitted only to users who have the
  [`FILE`](privileges-provided.html#priv_file) privilege.

  [`secure_file_priv`](server-system-variables.html#sysvar_secure_file_priv) may be set
  as follows:
  ...
  value of the [`INSTALL_LAYOUT`](source-configuration-options.html#option_cmake_install_layout)
  **CMake** option, as shown in the following
  table. To specify the default
  [`secure_file_priv`](server-system-variables.html#sysvar_secure_file_priv) value
  explicitly if you are building from source, use the
  [`INSTALL_SECURE_FILE_PRIVDIR`](source-configuration-options.html#option_cmake_install_secure_file_privdir)
  **CMake** option.
...
<td><code class="literal">65535</code></td>
  ...
  [`secure_file_priv`](server-system-variables.html#sysvar_secure_file_priv) at startup
  ...
  users. If [`secure_file_priv`](server-system-variables.html#sysvar_secure_file_priv) is
  set to a nonexistent path, the server writes an error message
  to the error log and exits.

* [`select_into_buffer_size`](server-system-variables.html#sysvar_select_into_buffer_size)
...
<td><code class="literal">65535</code></td>
  ...
  When using [`SELECT
  INTO OUTFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") or `SELECT INTO
  ...
  set for [`read_buffer_size`](server-system-variables.html#sysvar_read_buffer_size).
  (`select_into_buffer_size` and
  `read_buffer_size` have the same default,
  maximum, and minimum values.) You can also use
  [`select_into_disk_sync_delay`](server-system-variables.html#sysvar_select_into_disk_sync_delay)
...
* [`select_into_disk_sync`](server-system-variables.html#sysvar_select_into_disk_sync)
...
<td><code class="literal">65535</code></td>
  ...
  [`SELECT INTO
  OUTFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") or `SELECT INTO DUMPFILE`
  statement using
  [`select_into_buffer_size`](server-system-variables.html#sysvar_select_into_buffer_size).
...
<td><code class="literal">65535</code></td>
  ...
  [`select_into_disk_sync`](server-system-variables.html#sysvar_select_into_disk_sync), this
...
* [`server_memory`](server-system-variables.html#sysvar_server_memory)
...
<td><code class="literal">65535</code></td>
  ...
  Limits the maximum amount of physical memory the server can
  use when determining the default values of memory-dependent
  variables. The following system variables are affected:

  + [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram)
  + [`innodb_buffer_pool_size`](innodb-parameters.html#sysvar_innodb_buffer_pool_size),
    ...
    is enabled and
    [`server_memory`](server-system-variables.html#sysvar_server_memory) is set to a
    value larger than 1GB.

  If `server_memory` is set to a value larger
  than the available physical memory, or the memory restriction
  of the container, MySQL will not start and reports an error.
...
<td><code class="literal">65535</code></td>
  ...
  for [`session_track_gtids`](server-system-variables.html#sysvar_session_track_gtids) are
  as follows:
  ...
  [`session_track_gtids`](server-system-variables.html#sysvar_session_track_gtids) cannot be
...
<td><code class="literal">65535</code></td>
  ...
  [`session_track_schema`](server-system-variables.html#sysvar_session_track_schema) or
...
<td><code class="literal">65535</code></td>
  ...
  [`autocommit`](server-system-variables.html#sysvar_autocommit),
  [`character_set_client`](server-system-variables.html#sysvar_character_set_client),
  [`character_set_results`](server-system-variables.html#sysvar_character_set_results), and
  [`character_set_connection`](server-system-variables.html#sysvar_character_set_connection).
  (The latter three variables are those affected by
  [`SET NAMES`](set-names.html "15.7.6.3 SET NAMES Statement").)
  ...
  The special value `*` (asterisk) causes the
...
<td><code class="literal">65535</code></td>
  ...
  track the
  [`transaction_isolation`](server-system-variables.html#sysvar_transaction_isolation) and
  [`transaction_read_only`](server-system-variables.html#sysvar_transaction_read_only) system
...
* [`set_operations_buffer_size`](server-system-variables.html#sysvar_set_operations_buffer_size)
...
<td><code class="literal">65535</code></td>
  ...
  [`INTERSECT`](intersect.html "15.2.8 INTERSECT Clause") and
  [`EXCEPT`](except.html "15.2.4 EXCEPT Clause") operations that use hash
  tables when the
  [`hash_set_operations`](switchable-optimizations.html#optflag_hash-set-operations)
  optimizer switch is `ON`. In general,
...
<td><code class="literal">65535</code></td>
  ...
  `sha256_password` (deprecated) built-in
  authentication plugin supports proxy users. It has no effect
  unless the [`check_proxy_users`](server-system-variables.html#sysvar_check_proxy_users)
  system variable is enabled. For information about user
  proxying, see [Section 8.2.19, “Proxy Users”](proxy-users.html "8.2.19 Proxy Users").
...
<td><code class="literal">65535</code></td>
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") normally does
  not show the `ROW_FORMAT` table option if the
  row format is the default format. Enabling this variable
  causes [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") to
...
<td><code class="literal">65535</code></td>
  ...
  output of [`SHOW`](show.html "15.7.7 SHOW Statements") statements and
...
<td><code class="literal">65535</code></td>
  ...
  This is `OFF` if [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  uses external locking (system locking), `ON`
  if external locking is disabled. This affects only
  [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") table access.

  This variable is set by the
  [`--external-locking`](server-options.html#option_mysqld_external-locking) or
  ...
  [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") table access. For more
  information, including conditions under which it can and
  cannot be used, see [Section 10.11.5, “External Locking”](external-locking.html "10.11.5 External Locking").
...
<td><code class="literal">65535</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") resolves host names when checking
  client connections. If it is `ON`,
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") uses only IP numbers; in this case,
  all `Host` column values in the grant tables
  must be IP addresses. See [Section 7.1.12.3, “DNS Lookups and the Host Cache”](host-cache.html "7.1.12.3 DNS Lookups and the Host Cache").
  ...
  [`--host`](connection-options.html#option_general_host) option, such as
  [`--host=127.0.0.1`](connection-options.html#option_general_host) or
  [`--host=::1`](connection-options.html#option_general_host).
  ...
  [`skip_name_resolve`](server-system-variables.html#sysvar_skip_name_resolve) enabled. If
  you plan to do that, make sure an account exists that can
  accept a connection. For example, to be able to connect as
  `root` using
  [`--host=127.0.0.1`](connection-options.html#option_general_host) or
  [`--host=::1`](connection-options.html#option_general_host), create these
  accounts:
...
<td><code class="literal">65535</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") must be made using named pipes or
  shared memory (on Windows) or Unix socket files (on Unix).
  This option is highly recommended for systems where only local
  clients are permitted. See [Section 7.1.12.3, “DNS Lookups and the Host Cache”](host-cache.html "7.1.12.3 DNS Lookups and the Host Cache").

  Because starting the server with
  [`--skip-grant-tables`](server-options.html#option_mysqld_skip-grant-tables) disables
...
<td><code class="literal">65535</code></td>
  ...
  DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement") statement if they do not have the
  [`SHOW DATABASES`](privileges-provided.html#priv_show-databases) privilege. This
  can improve security if you have concerns about users being
  able to see databases belonging to other users. Its effect
  depends on the [`SHOW DATABASES`](privileges-provided.html#priv_show-databases)
  privilege: If the variable value is `ON`, the
  [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement") statement is
  permitted only to users who have the [`SHOW
  DATABASES`](privileges-provided.html#priv_show-databases) privilege, and the statement displays all
  database names. If the value is `OFF`,
  [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement") is permitted to
  all users, but displays the names of only those databases for
  which the user has the [`SHOW
  DATABASES`](privileges-provided.html#priv_show-databases) or other privilege.
  ...
  examining the [`SCHEMATA`](information-schema-schemata-table.html "28.3.37 The INFORMATION_SCHEMA SCHEMATA Table") table of
...
<td><code class="literal">65535</code></td>
  ...
  [`Slow_launch_threads`](server-status-variables.html#statvar_Slow_launch_threads) status
  variable.
...
<td><code class="literal">65535</code></td>
  ...
  [`long_query_time`](server-system-variables.html#sysvar_long_query_time) variable. See
  [Section 7.4.5, “The Slow Query Log”](slow-query-log.html "7.4.5 The Slow Query Log").
...
<td><code class="literal">65535</code></td>
  ...
  this size. [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size)
  is not specific to any storage engine and applies in a general
  manner for optimization. At minimum the
  [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size) value must
  be large enough to accommodate fifteen tuples in the sort
  buffer. Also, increasing the value of
  [`max_sort_length`](server-system-variables.html#sysvar_max_sort_length) may require
  increasing the value of
  [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size). For more
  information, see [Section 10.2.1.16, “ORDER BY Optimization”](order-by-optimization.html "10.2.1.16 ORDER BY Optimization")

  If you see many
  [`Sort_merge_passes`](server-status-variables.html#statvar_Sort_merge_passes) per second
  in [`SHOW GLOBAL
  STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement") output, you can consider increasing the
  [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size) value to
  ...
  The maximum permissible setting for
  [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size) is
  4GB−1. Larger values are permitted for 64-bit platforms
  (except 64-bit Windows, for which large values are truncated
...
<td><code class="literal">65535</code></td>
  ...
  [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) function. For
  details, including the return value after a multiple-row
  insert, see [Section 14.15, “Information Functions”](information-functions.html "14.15 Information Functions"). If no
  `AUTO_INCREMENT` value was successfully
  inserted, the [`SELECT`](select.html "15.2.13 SELECT Statement") statement
  returns no row.

  The behavior of retrieving an
  `AUTO_INCREMENT` value by using an
  [`IS NULL`](comparison-operators.html#operator_is-null) comparison is used by
  ...
  [`sql_auto_is_null`](server-system-variables.html#sysvar_sql_auto_is_null) to
  `OFF`.

  The default value of
  [`sql_auto_is_null`](server-system-variables.html#sysvar_sql_auto_is_null) is
  `OFF`.
...
<td><code class="literal">65535</code></td>
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") statements that are
  ...
  [`max_join_size`](server-system-variables.html#sysvar_max_join_size)). This is
  ...
  If you set the [`max_join_size`](server-system-variables.html#sysvar_max_join_size)
  system variable to a value other than
  `DEFAULT`,
  [`sql_big_selects`](server-system-variables.html#sysvar_sql_big_selects) is set to
  `OFF`.
...
<td><code class="literal">65535</code></td>
  ...
  If enabled, [`sql_buffer_result`](server-system-variables.html#sysvar_sql_buffer_result)
  forces results from [`SELECT`](select.html "15.2.13 SELECT Statement")
...
<td><code class="literal">65535</code></td>
  ...
  any [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table that is created
  without one.
  ...
  TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement, optionally specifying a replication
  channel.
...
<td><code class="literal">65535</code></td>
  ...
  the session [`sql_log_off`](server-system-variables.html#sysvar_sql_log_off)
...
<td><code class="literal">65535</code></td>
  ...
  details, see [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").
...
<td><code class="literal">65535</code></td>
  ...
  increment [`warning_count`](server-system-variables.html#sysvar_warning_count) and
  the server does not record them. [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
...
<td><code class="literal">65535</code></td>
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") and
  [`SHOW CREATE DATABASE`](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement")
  statements. If disabled, quoting is disabled. This option is
  enabled by default so that replication works for identifiers
  that require quoting. See [Section 15.7.7.12, “SHOW CREATE TABLE Statement”](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement"),
  and [Section 15.7.7.7, “SHOW CREATE DATABASE Statement”](show-create-database.html "15.7.7.7 SHOW CREATE DATABASE Statement").
...
<td><code class="literal">65535</code></td>
  ...
  When enabled,
  [`sql_require_primary_key`](server-system-variables.html#sysvar_sql_require_primary_key) has
  these effects:
  ...
  TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement enables a replica to select its own
...
<td><code class="literal">65535</code></td>
  ...
  it possible to catch [`UPDATE`](update.html "15.2.17 UPDATE Statement") and
  [`DELETE`](delete.html "15.2.2 DELETE Statement") statements where keys
  are not used properly and that would probably change or delete
  a large number of rows. The default value is
  `OFF`.

  For the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client,
  [`sql_safe_updates`](server-system-variables.html#sysvar_sql_safe_updates) can be
  enabled by using the
  [`--safe-updates`](mysql-command-options.html#option_mysql_safe-updates) option. For more
  information, see [Using Safe-Updates Mode (--safe-updates)](mysql-tips.html#safe-updates "Using Safe-Updates Mode (--safe-updates)").
...
<td><code class="literal">65535</code></td>
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") statements. For more
  information, see [Using Safe-Updates Mode (--safe-updates)](mysql-tips.html#safe-updates "Using Safe-Updates Mode (--safe-updates)").
  ...
  If a [`SELECT`](select.html "15.2.13 SELECT Statement") has a
...
<td><code class="literal">65535</code></td>
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement") statements produce an
...
<td><code class="literal">65535</code></td>
  ...
  TLS`](alter-instance.html#alter-instance-reload-tls) or after a restart if the variable value was
  persisted. See
...
<td><code class="literal">65535</code></td>
  ...
  [`ssl_cert`](server-system-variables.html#sysvar_ssl_cert) set to a certificate
...
<td><code class="literal">65535</code></td>
  ...
  see [Section 8.3.2, “Encrypted Connection TLS Protocols and Ciphers”](encrypted-connection-protocols-ciphers.html "8.3.2 Encrypted Connection TLS Protocols and Ciphers").
...
* [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode)
...
<td><code class="literal">65535</code></td>
  ...
  [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) system variable
  differs from other
  `ssl_xxx` system
  ...
  These [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) values
  are permitted:
  ...
  permitted value for
  [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) is
  `OFF`. In this case, setting
  [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) to
  `ON` or `STRICT` at
...
* [`ssl_session_cache_mode`](server-system-variables.html#sysvar_ssl_session_cache_mode)
...
<td><code class="literal">65535</code></td>
  ...
  [`ssl_session_cache_mode`](server-system-variables.html#sysvar_ssl_session_cache_mode) system
  ...
  These [`ssl_session_cache_mode`](server-system-variables.html#sysvar_ssl_session_cache_mode)
  values are permitted:
  ...
  [`ssl_session_cache_mode`](server-system-variables.html#sysvar_ssl_session_cache_mode) is
  enabled.

  The current value in effect for
  [`ssl_session_cache_mode`](server-system-variables.html#sysvar_ssl_session_cache_mode) can be
  observed with the
  [`Ssl_session_cache_mode`](server-status-variables.html#statvar_Ssl_session_cache_mode)
  status variable.

* [`ssl_session_cache_timeout`](server-system-variables.html#sysvar_ssl_session_cache_timeout)
...
<td><code class="literal">65535</code></td>
  ...
  [`ssl_session_cache_timeout`](server-system-variables.html#sysvar_ssl_session_cache_timeout) can
  be observed with the
  [`Ssl_session_cache_timeout`](server-status-variables.html#statvar_Ssl_session_cache_timeout)
  status variable.

* [`statement_id`](server-system-variables.html#sysvar_statement_id)
...
<td><code class="literal">65535</code></td>
  ...
  [`events_statements_history`](performance-schema-events-statements-history-table.html "29.12.6.2 The events_statements_history Table") table.
...
<td><code class="literal">65535</code></td>
  ...
  the [dictionary
  object cache](/doc/refman/8.4/en/glossary.html#glos_dictionary_object_cache). The stored procedure and stored function
...
* [`stored_program_definition_cache`](server-system-variables.html#sysvar_stored_program_definition_cache)
...
<td><code class="literal">65535</code></td>
  ...
  [`stored_program_cache`](server-system-variables.html#sysvar_stored_program_cache) option.

  The [`stored_program_cache`](server-system-variables.html#sysvar_stored_program_cache)
...
<td><code class="literal">65535</code></td>
  ...
  [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) or
  [`SUPER`](privileges-provided.html#priv_super). See the description of
  ...
  [`read_only`](server-system-variables.html#sysvar_read_only) and
  [`super_read_only`](server-system-variables.html#sysvar_super_read_only) interact.

  Client updates prevented when
  [`super_read_only`](server-system-variables.html#sysvar_super_read_only) is enabled
  ...
  the [`event_scheduler`](server-system-variables.html#sysvar_event_scheduler) system
  ...
  [`super_read_only`](server-system-variables.html#sysvar_super_read_only) is
  subsequently disabled after being enabled, the server
  automatically restarts the Event Scheduler as needed.

  Changes to [`super_read_only`](server-system-variables.html#sysvar_super_read_only) on
  a replication source server are not replicated to replica
  servers. The value can be set on a replica independent of the
  setting on the source.

* [`syseventlog.facility`](server-system-variables.html#sysvar_syseventlog.facility)
...
<td><code class="literal">65535</code></td>
  ...
  installed. See [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log").
...
* [`syseventlog.include_pid`](server-system-variables.html#sysvar_syseventlog.include_pid)
...
* [`syseventlog.tag`](server-system-variables.html#sysvar_syseventlog.tag)
...
<td><code class="literal">65535</code></td>
  ...
  set [`system_time_zone`](server-system-variables.html#sysvar_system_time_zone). To
  explicitly specify the system time zone, set the
  `TZ` environment variable or use the
  [`--timezone`](mysqld-safe.html#option_mysqld_safe_timezone) option of the
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") script.

  In addition to startup time initialization, if the server host
  time zone changes (for example, due to daylight saving time),
  [`system_time_zone`](server-system-variables.html#sysvar_system_time_zone) reflects
  that change, which has these implications for applications:

  + Queries that reference
    [`system_time_zone`](server-system-variables.html#sysvar_system_time_zone) will get
  ...
  + For queries that begin executing before a daylight saving
    ...
    [`system_time_zone`](server-system-variables.html#sysvar_system_time_zone) remains
    constant within the query because the value is usually
    cached at the beginning of execution.

  The [`system_time_zone`](server-system-variables.html#sysvar_system_time_zone) variable
  differs from the [`time_zone`](server-system-variables.html#sysvar_time_zone)
  variable. Although they might have the same value, the latter
  variable is used to initialize the time zone for each client
  that connects. See [Section 7.1.15, “MySQL Server Time Zone Support”](time-zone-support.html "7.1.15 MySQL Server Time Zone Support").
...
<td><code class="literal">65535</code></td>
  ...
  For [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine"), the
  [`table_definition_cache`](server-system-variables.html#sysvar_table_definition_cache)
  ...
  cache exceeds the
  [`table_definition_cache`](server-system-variables.html#sysvar_table_definition_cache) limit,
  ...
  [`table_definition_cache`](server-system-variables.html#sysvar_table_definition_cache) and
  [`innodb_open_files`](innodb-parameters.html#sysvar_innodb_open_files) settings.
  ...
  [`table_definition_cache`](server-system-variables.html#sysvar_table_definition_cache) or
  [`innodb_open_files`](innodb-parameters.html#sysvar_innodb_open_files), an LRU
  ...
  [dictionary object
  cache](/doc/refman/8.4/en/glossary.html#glos_dictionary_object_cache). Both caches store table definitions but serve
...
<td><code class="literal">65535</code></td>
  ...
  Setting
  [`table_encryption_privilege_check`](server-system-variables.html#sysvar_table_encryption_privilege_check)
  at runtime requires the [`SUPER`](privileges-provided.html#priv_super)
  privilege.
...
<td><code class="literal">65535</code></td>
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") requires. The effective value of
  ...
  checking the [`Opened_tables`](server-status-variables.html#statvar_Opened_tables)
  status variable. If the value of
  [`Opened_tables`](server-status-variables.html#statvar_Opened_tables) is large and
  you do not use [`FLUSH TABLES`](flush.html#flush-tables)
  often (which just forces all tables to be closed and
  reopened), then you should increase the value of the
  [`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) variable.
...
<td><code class="literal">65535</code></td>
  ...
  [`table_open_cache_instances`](server-system-variables.html#sysvar_table_open_cache_instances) to
  1 in order to restrict memory usage.

* [`table_open_cache_triggers`](server-system-variables.html#sysvar_table_open_cache_triggers)
...
<td><code class="literal">65535</code></td>
  ...
  The total maximum number of cached open tables having fully
  loaded triggers. This includes both used and unused tables
  having fully loaded triggers.

  `table_open_cache_triggers` is similar to
  [`table_open_cache`](server-system-variables.html#sysvar_table_open_cache), but
  controls an eviction mechanism specifically for tables with
  fully loaded triggers. The default value for
  `table_open_cache_triggers` is the same as
  the maximum; setting the value less than this activates the
  eviction logic specific to tables with fully loaded triggers.
  Leaving `table_open_cache_triggers` at the
  ...
  `table_open_cache_triggers` `/`[`table_open_cache_instances`](server-system-variables.html#sysvar_table_open_cache_instances).
  When these system variables are allowed to retain their
  default values, this value is 32768.

* [`tablespace_definition_cache`](server-system-variables.html#sysvar_tablespace_definition_cache)
...
* [`telemetry.resource_provider`](server-system-variables.html#sysvar_telemetry.resource_provider)
...
<td><code class="literal">65535</code></td>
  ...
  Name of the component to invoke that provides an
  implementation of the resource provider service. Invoking the
  resource provider service allows to obtain the details about
  the opentelemetry resource used, which is implementation
  dependent.

* [`telemetry.secret_provider`](server-system-variables.html#sysvar_telemetry.secret_provider)
...
<td><code class="literal">65535</code></td>
  ...
  Name of the component to invoke that provides an
  implementation of the secret provider service. The content of
  the following system variables is decoded using the specified
  component:

  + [`telemetry.otel_exporter_otlp_traces_secret_headers`](telemetry-trace-configuration.html#sysvar_telemetry.otel_exporter_otlp_traces_secret_headers)
  + [`telemetry.otel_exporter_otlp_metrics_secret_headers`](telemetry-metrics-configuration.html#sysvar_telemetry.otel_exporter_otlp_metrics_secret_headers)
  + [`telemetry.otel_exporter_otlp_logs_secret_headers`](telemetry-logs-configuration.html#sysvar_telemetry.otel_exporter_otlp_logs_secret_headers)
* [`temptable_max_mmap`](server-system-variables.html#sysvar_temptable_max_mmap)
...
<td><code class="literal">65535</code></td>
  ...
  The
  [`TempTable_count_hit_max_ram`](server-status-variables.html#statvar_TempTable_count_hit_max_ram)
  status variable counts the number of times that the
  `TempTable` engine reached the
  [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram) limit.
...
<td><code class="literal">65535</code></td>
  ...
  [`thread_cache_size`](server-system-variables.html#sysvar_thread_cache_size) threads
  ...
  should normally set
  [`thread_cache_size`](server-system-variables.html#sysvar_thread_cache_size) high enough
  so that most new connections use cached threads. By examining
  the difference between the
  [`Connections`](server-status-variables.html#statvar_Connections) and
  [`Threads_created`](server-status-variables.html#statvar_Threads_created) status
  variables, you can see how efficient the thread cache is. For
  details, see [Section 7.1.10, “Server Status Variables”](server-status-variables.html "7.1.10 Server Status Variables").
...
<td><code class="literal">65535</code></td>
  ...
  enabled. See [Section 7.6.3, “MySQL Enterprise Thread Pool”](thread-pool.html "7.6.3 MySQL Enterprise Thread Pool").

* [`thread_pool_dedicated_listeners`](server-system-variables.html#sysvar_thread_pool_dedicated_listeners)
...
<td><code class="literal">65535</code></td>
  ...
  This variable is available only with MySQL Enterprise Edition, and not supported
  in MySQL 9.5.
...
* [`thread_pool_max_active_query_threads`](server-system-variables.html#sysvar_thread_pool_max_active_query_threads)
...
<td><code class="literal">NULL</code></td>
  ...
  [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) privilege is
...
* [`thread_pool_query_threads_per_group`](server-system-variables.html#sysvar_thread_pool_query_threads_per_group)
...
<td><code class="literal">NULL</code></td>
  ...
  `--thread-pool-size=0` starts the server
  with `--thread-pool-size=1`

  To disable the Thread Pool plugin, you must run the server
  with `--thread-pool-size=OFF`.
...
* [`thread_pool_transaction_delay`](server-system-variables.html#sysvar_thread_pool_transaction_delay)
...
<td><code class="literal">NULL</code></td>
  ...
  the [`--default-time-zone`](server-options.html#option_mysqld_default-time-zone) option.
  See [Section 7.1.15, “MySQL Server Time Zone Support”](time-zone-support.html "7.1.15 MySQL Server Time Zone Support").
...
<td><code class="literal">NULL</code></td>
  ...
  *`timestamp_value`* should be a Unix
  ...
  [`UNIX_TIMESTAMP()`](date-and-time-functions.html#function_unix-timestamp), not a value
  in `'YYYY-MM-DD
  hh:mm:ss'` format) or
  `DEFAULT`.

  Setting [`timestamp`](server-system-variables.html#sysvar_timestamp) to a
  constant value causes it to retain that value until it is
  changed again. Setting
  [`timestamp`](server-system-variables.html#sysvar_timestamp) to
  `DEFAULT` causes its value to be the current
  date and time as of the time it is accessed.

  [`timestamp`](server-system-variables.html#sysvar_timestamp) is a
  `DOUBLE` rather than
  ...
  the [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") data type.
  ...
  invocations of [`SYSDATE()`](date-and-time-functions.html#function_sysdate). The
  server can be started with the
  [`--sysdate-is-now`](server-options.html#option_mysqld_sysdate-is-now) option to
  cause [`SYSDATE()`](date-and-time-functions.html#function_sysdate) to be a synonym
  for [`NOW()`](date-and-time-functions.html#function_now), in which case
  `SET timestamp` affects both functions.

* [`tls_certificates_enforced_validation`](server-system-variables.html#sysvar_tls_certificates_enforced_validation)
...
<td><code class="literal">NULL</code></td>
  ...
  `--tls-certificates-enforced-validation` option
...
* [`tls_ciphersuites`](server-system-variables.html#sysvar_tls_ciphersuites)
...
<td><code class="literal">NULL</code></td>
  ...
  + Support for the TLSv1.3 protocol is available in MySQL
    9.5, provided that MySQL Server was
...
<td><code class="literal">NULL</code></td>
  ...
  tables created by the `MEMORY` and
  `TempTable` storage engines. If an internal
  in-memory temporary table exceeds this size, it is
  automatically converted to an on-disk internal temporary
  table.

  The [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) variable
  ...
  the smaller of [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size)
  and [`max_heap_table_size`](server-system-variables.html#sysvar_max_heap_table_size). The
  [`max_heap_table_size`](server-system-variables.html#sysvar_max_heap_table_size) setting
  does not apply to `TempTable` tables.

  Increase the value of
  [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) (and
  [`max_heap_table_size`](server-system-variables.html#sysvar_max_heap_table_size) if
  ...
  The [`Count_hit_tmp_table_size`](server-status-variables.html#statvar_Count_hit_tmp_table_size)
  status variable counts the number of
  [internal temporary
  tables](internal-temporary-tables.html "10.4.4 Internal Temporary Table Use in MySQL") that were converted from in-memory to on-disk
  ...
  [`Created_tmp_disk_tables`](server-status-variables.html#statvar_Created_tmp_disk_tables) and
  [`Created_tmp_tables`](server-status-variables.html#statvar_Created_tmp_tables) values.

  See also [Section 10.4.4, “Internal Temporary Table Use in MySQL”](internal-temporary-tables.html "10.4.4 Internal Temporary Table Use in MySQL").
...
<td><code class="literal">NULL</code></td>
  ...
  [`tmpdir`](server-system-variables.html#sysvar_tmpdir) can be a non-permanent
  ...
  [`tmpdir`](server-system-variables.html#sysvar_tmpdir), consider setting a
  different temporary directory for the replica using the
  [`replica_load_tmpdir`](replication-options-replica.html#sysvar_replica_load_tmpdir) variable.
  For a replica, the temporary files used to replicate
  [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements are stored
  ...
  files, see [Section B.3.3.5, “Where MySQL Stores Temporary Files”](temporary-files.html "B.3.3.5 Where MySQL Stores Temporary Files").
...
<td><code class="literal">NULL</code></td>
  ...
  the [`--transaction-isolation`](server-options.html#option_mysqld_transaction-isolation)
  server option.

  At runtime, the isolation level can be set directly using the
  [`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")
  statement to assign a value to the
  [`transaction_isolation`](server-system-variables.html#sysvar_transaction_isolation) system
  variable, or indirectly using the [`SET
  TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement. If you set
  [`transaction_isolation`](server-system-variables.html#sysvar_transaction_isolation)
  ...
  Setting the global
  [`transaction_isolation`](server-system-variables.html#sysvar_transaction_isolation) value
  ...
  + To set the session isolation level, use any of these
    ...
    - Corresponds to
      [`SET
      SESSION TRANSACTION ISOLATION LEVEL`](set-transaction.html "15.3.7 SET TRANSACTION Statement") (with
      the `SESSION` keyword).
  ...
  + To set the next-transaction isolation level, use this
    ...
    - Corresponds to
      [`SET
      TRANSACTION ISOLATION LEVEL`](set-transaction.html "15.3.7 SET TRANSACTION Statement") (without the
      `SESSION` keyword).

  For more information about [`SET
  TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") and its relationship to the
  [`transaction_isolation`](server-system-variables.html#sysvar_transaction_isolation) system
  variable, see [Section 15.3.7, “SET TRANSACTION Statement”](set-transaction.html "15.3.7 SET TRANSACTION Statement").
...
<td><code class="literal">NULL</code></td>
  ...
  [`--transaction-read-only`](server-options.html#option_mysqld_transaction-read-only) server
  option.
  ...
  [`transaction_read_only`](server-system-variables.html#sysvar_transaction_read_only) system
  variable, or indirectly using the [`SET
  TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement. For example, use this
  [`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")
  statement to set the global value:
  ...
  Setting the global
  [`transaction_read_only`](server-system-variables.html#sysvar_transaction_read_only) value
  ...
  + To set the session access mode, use any of these syntaxes:
    ...
    - Corresponds to
      [`SET
      SESSION TRANSACTION {READ WRITE | READ ONLY}`](set-transaction.html "15.3.7 SET TRANSACTION Statement")
  ...
  + To set the next-transaction access mode, use this syntax:
    ...
    - Corresponds to
      [`SET
      TRANSACTION {READ WRITE | READ ONLY}`](set-transaction.html "15.3.7 SET TRANSACTION Statement")
...
<td><code class="literal">NULL</code></td>
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") or
  [`DELETE`](delete.html "15.2.2 DELETE Statement") statement. Primary key
...
* [`use_secondary_engine`](/doc/heatwave/en/heatwave-system-variables.html#sysvar_use_secondary_engine)
...
* [`version_compile_zlib`](server-system-variables.html#sysvar_version_compile_zlib)
...
<td><code class="literal">NULL</code></td>
  ...
  [`wait_timeout`](server-system-variables.html#sysvar_wait_timeout) value is
  initialized from the global
  [`wait_timeout`](server-system-variables.html#sysvar_wait_timeout) value or from
  the global
  [`interactive_timeout`](server-system-variables.html#sysvar_interactive_timeout) value,
  depending on the type of client (as defined by the
  `CLIENT_INTERACTIVE` connect option to
  [`mysql_real_connect()`](/doc/c-api/9.5/en/mysql-real-connect.html)). See
  also [`interactive_timeout`](server-system-variables.html#sysvar_interactive_timeout).
...
* [`warning_count`](server-system-variables.html#sysvar_warning_count)
  ...
  read only. See [Section 15.7.7.43, “SHOW WARNINGS Statement”](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement").

* [`windowing_use_high_precision`](server-system-variables.html#sysvar_windowing_use_high_precision)
...
<td><code class="literal">NULL</code></td>
  ...
  precision. See [Section 10.2.1.21, “Window Function Optimization”](window-function-optimization.html "10.2.1.21 Window Function Optimization").

* [`xa_detach_on_prepare`](server-system-variables.html#sysvar_xa_detach_on_prepare)
...
<td><code class="literal">NULL</code></td>
  ...
  (session) as part of
  [`XA
  PREPARE`](xa-statements.html "15.3.8.1 XA Transaction SQL Statements"). This means that the XA transaction can be
  ...
  For more information, see [Section 15.3.8.2, “XA Transaction States”](xa-states.html "15.3.8.2 XA Transaction States").
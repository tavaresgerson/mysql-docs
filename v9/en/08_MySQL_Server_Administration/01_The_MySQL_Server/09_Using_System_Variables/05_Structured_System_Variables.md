...
elsewhere, in [Section 10.10.2, “The MyISAM Key Cache”](myisam-key-cache.html "10.10.2 The MyISAM Key Cache").
...
[`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) both refer to
...
[`LIKE`](string-comparison-functions.html#operator_like) pattern-matching operation:

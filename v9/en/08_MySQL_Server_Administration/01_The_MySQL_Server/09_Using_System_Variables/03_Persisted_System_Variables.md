...
[`persisted_variables`](performance-schema-persisted-variables-table.html "29.12.14.2 Performance Schema persisted_variables Table") table
...
The Performance Schema
[`variables_info`](performance-schema-variables-info-table.html "29.12.14.3 Performance Schema variables_info Table") table contains
...
contents of the
[`persisted_variables`](performance-schema-persisted-variables-table.html "29.12.14.2 Performance Schema persisted_variables Table") table because
...
the [`variables_info`](performance-schema-variables-info-table.html "29.12.14.3 Performance Schema variables_info Table") table until
...
MySQL 9.5 has the capability to store persisted
...
in the future. A `mysqld-auto.cnf` option
file created by MySQL 9.5 cannot be read by older
...
support the function. See [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").
...
[`persisted_variables`](performance-schema-persisted-variables-table.html "29.12.14.2 Performance Schema persisted_variables Table"),

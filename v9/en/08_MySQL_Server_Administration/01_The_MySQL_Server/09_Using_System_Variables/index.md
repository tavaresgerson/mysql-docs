...
`K`, `M`, `G`,
`T`, `P`, or
`E` (either uppercase or lowercase) to indicate a
...
[`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size) from being
...
[Section 7.1.9.2, “Dynamic System Variables”](dynamic-system-variables.html "7.1.9.2 Dynamic System Variables"). To change a system
variable with
[`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"), refer
...
[`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")
syntax, see [Section 15.7.6.1, “SET Syntax for Variable Assignment”](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"). For a description of
...
[`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") you
...
For [`SHOW VARIABLES`](show-variables.html "15.7.7.42 SHOW VARIABLES Statement"), if you specify

...
* [`bind_address`](server-system-variables.html#sysvar_bind_address) and
...
* For replication connections from replica servers to source
  ...
  SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement and specify the
...
* The
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement") statement.
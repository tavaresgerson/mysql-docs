...
[`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table exposes the
...
Performance Schema [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table")
...
* It removes all rows from the Performance Schema
  [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table that exposes
  the cache contents.
...
* Execute a [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement")
  statement that truncates the Performance Schema
  [`host_cache`](performance-schema-host-cache-table.html "29.12.22.4 The host_cache Table") table. This

...
MySQL, see [Section A.3, “MySQL 9.5 FAQ: Server SQL Mode”](faqs-sql-modes.html "A.3 MySQL 9.5 FAQ: Server SQL Mode").
...
The default SQL mode in MySQL 9.5 includes these
...
a [`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment")
statement:
...
[`SYSTEM_VARIABLES_ADMIN`](privileges-provided.html#priv_system-variables-admin) privilege
...
* [`TRADITIONAL`](sql-mode.html#sqlmode_traditional)
  ...
  enabled, an [`INSERT`](insert.html "15.2.7 INSERT Statement") or
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") aborts as soon as an
...
* [`ALLOW_INVALID_DATES`](sql-mode.html#sqlmode_allow_invalid_dates)
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns. It does not
  apply to [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns,
...
* [`ERROR_FOR_DIVISION_BY_ZERO`](sql-mode.html#sqlmode_error_for_division_by_zero)
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement")), its effect also
  ...
  For [`SELECT`](select.html "15.2.13 SELECT Statement"), division by zero
...
* [`IGNORE_SPACE`](sql-mode.html#sqlmode_ignore_space)
  ...
  quoted as described in [Section 11.2, “Schema Object Names”](identifiers.html "11.2 Schema Object Names"). For
...
* [`NO_AUTO_VALUE_ON_ZERO`](sql-mode.html#sqlmode_no_auto_value_on_zero)
  ...
  with [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and then reload it, MySQL
  ...
  reason, [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") automatically includes
...
* [`NO_ENGINE_SUBSTITUTION`](sql-mode.html#sqlmode_no_engine_substitution)
  ...
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") specifies a storage engine that is disabled
  or not compiled in.
  ...
  With
  [`NO_ENGINE_SUBSTITUTION`](sql-mode.html#sqlmode_no_engine_substitution)
  disabled, for [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  the default engine is used and a warning occurs if the
  desired engine is unavailable. For
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), a warning occurs
...
* [`PAD_CHAR_TO_FULL_LENGTH`](sql-mode.html#sqlmode_pad_char_to_full_length)
  ...
  [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") column values on
  retrieval. If
  [`PAD_CHAR_TO_FULL_LENGTH`](sql-mode.html#sqlmode_pad_char_to_full_length) is
  enabled, trimming does not occur and retrieved
  [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") values are padded to
  their full length. This mode does not apply to
  [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") columns, for which
...
* [`REAL_AS_FLOAT`](sql-mode.html#sqlmode_real_as_float)
  ...
  Treat [`REAL`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") as a synonym for
  [`FLOAT`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE"). By default, MySQL
  treats [`REAL`](floating-point-types.html "13.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") as a synonym for
...
* [`TIME_TRUNCATE_FRACTIONAL`](sql-mode.html#sqlmode_time_truncate_fractional)

  Control whether rounding or truncation occurs when inserting
  a [`TIME`](time.html "13.2.3 The TIME Type"),
  [`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"), or
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value with a
  ...
  See also [Section 13.2.6, “Fractional Seconds in Time Values”](fractional-seconds.html "13.2.6 Fractional Seconds in Time Values").
...
* [`ANSI`](sql-mode.html#sqlmode_ansi)
  ...
  [`PIPES_AS_CONCAT`](sql-mode.html#sqlmode_pipes_as_concat),
  [`ANSI_QUOTES`](sql-mode.html#sqlmode_ansi_quotes),
  [`IGNORE_SPACE`](sql-mode.html#sqlmode_ignore_space), and
  [`ONLY_FULL_GROUP_BY`](sql-mode.html#sqlmode_only_full_group_by).
  ...
  *`S`* with an outer reference
  ...
  See [Section 1.7, “MySQL Standards Compliance”](compatibility.html "1.7 MySQL Standards Compliance").
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement"). A value can be invalid
...
[Section 15.7.7.43, “SHOW WARNINGS Statement”](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement")). In strict mode, you can
produce this behavior by using
[`INSERT IGNORE`](insert.html "15.2.7 INSERT Statement")
or [`UPDATE
IGNORE`](update.html "15.2.17 UPDATE Statement").

For statements such as [`SELECT`](select.html "15.2.13 SELECT Statement")
...
[`NO_ZERO_IN_DATE`](sql-mode.html#sqlmode_no_zero_in_date) modes.
...
<th scope="row">Without <code class="literal">IGNORE</code> or strict SQL mode</th>
<td>Error</td>
<td>Warning</td>
</tr><tr>
<th scope="row">With <code class="literal">IGNORE</code></th>
<td>Warning</td>
<td>Warning (same as without <code class="literal">IGNORE</code> or strict SQL mode)</td>
</tr><tr>
<th scope="row">With strict SQL mode</th>
<td>Error (same as without <code class="literal">IGNORE</code> or strict SQL mode)</td>
<td>Error</td>
</tr><tr>
<th scope="row">With <code class="literal">IGNORE</code> and strict SQL mode</th>
<td>Warning</td>
<td>Warning</td>
</tr></tbody></table>
...
* [`CREATE TABLE
  ... SELECT`](create-table.html "15.1.24 CREATE TABLE Statement"): `IGNORE` does not
  apply to the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or
  [`SELECT`](select.html "15.2.13 SELECT Statement") parts of the statement
  but to inserts into the table of rows produced by the
  [`SELECT`](select.html "15.2.13 SELECT Statement"). Rows that duplicate
...
* [`INSERT`](insert.html "15.2.7 INSERT Statement"): With
...
* [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement"),
  [`LOAD XML`](load-xml.html "15.2.10 LOAD XML Statement"): With
  `IGNORE`, rows that duplicate an existing
  row on a unique key value are discarded.

* [`UPDATE`](update.html "15.2.17 UPDATE Statement"): With
...
* [`ER_BAD_NULL_ERROR`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_bad_null_error)
* [`ER_DUP_ENTRY`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_dup_entry)
* [`ER_DUP_ENTRY_WITH_KEY_NAME`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_dup_entry_with_key_name)
* [`ER_DUP_KEY`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_dup_key)
* [`ER_NO_PARTITION_FOR_GIVEN_VALUE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_partition_for_given_value)
* [`ER_NO_PARTITION_FOR_GIVEN_VALUE_SILENT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_partition_for_given_value_silent)
* [`ER_NO_REFERENCED_ROW_2`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_referenced_row_2)
* [`ER_ROW_DOES_NOT_MATCH_GIVEN_PARTITION_SET`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_row_does_not_match_given_partition_set)
* [`ER_ROW_IS_REFERENCED_2`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_row_is_referenced_2)
* [`ER_SUBQUERY_NO_1_ROW`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_subquery_no_1_row)
* [`ER_VIEW_CHECK_FAILED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_view_check_failed)
...
* [`CREATE TABLE
  ... SELECT`](create-table.html "15.1.24 CREATE TABLE Statement")

* [`DELETE`](delete.html "15.2.2 DELETE Statement") (both single table and
  multiple table)
...
* [`SELECT
  SLEEP()`](select.html "15.2.13 SELECT Statement")

* [`UPDATE`](update.html "15.2.17 UPDATE Statement") (both single table and
  multiple table)

...
[Section 7.1.7, “Server Command Options”](server-options.html "7.1.7 Server Command Options"), and
...
instructions given in [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files"). Without an
option file, the server just starts with its default
settings—see [Section 7.1.2, “Server Configuration Defaults”](server-configuration-defaults.html "7.1.2 Server Configuration Defaults")

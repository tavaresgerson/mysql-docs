...
[Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables"). Those system
...
* [`mysql_session_track_get_first()`](/doc/c-api/9.5/en/mysql-session-track-get-first.html)
  fetches the first part of the state-change information
  received from the server. See
  [mysql\_session\_track\_get\_first()](/doc/c-api/9.5/en/mysql-session-track-get-first.html).

* [`mysql_session_track_get_next()`](/doc/c-api/9.5/en/mysql-session-track-get-next.html)
  ...
  See [mysql\_session\_track\_get\_next()](/doc/c-api/9.5/en/mysql-session-track-get-next.html).
...
Preceding the [`START
TRANSACTION`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") statement, two [`SET
TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statements execute that set the isolation
...
Following the [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") statement

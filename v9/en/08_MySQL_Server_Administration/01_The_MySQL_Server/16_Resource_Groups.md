...
* [Resource Group Elements](resource-groups.html#resource-group-elements "Resource Group Elements")
* [Resource Group Attributes](resource-groups.html#resource-group-attributes "Resource Group Attributes")
* [Resource Group Management](resource-groups.html#resource-group-management "Resource Group Management")
* [Resource Group Replication](resource-groups.html#resource-group-replication "Resource Group Replication")
...
* The Information Schema
  [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.31 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table exposes
...
* Each group has a type, which is either
  ...
  [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table.
...
* [`CREATE RESOURCE GROUP`](create-resource-group.html "15.7.2.2 CREATE RESOURCE GROUP Statement") creates
  a new group. See [Section 15.7.2.2, “CREATE RESOURCE GROUP Statement”](create-resource-group.html "15.7.2.2 CREATE RESOURCE GROUP Statement").

* [`ALTER RESOURCE GROUP`](alter-resource-group.html "15.7.2.1 ALTER RESOURCE GROUP Statement") modifies
...
* [`DROP RESOURCE GROUP`](drop-resource-group.html "15.7.2.3 DROP RESOURCE GROUP Statement") drops an
  existing group. See [Section 15.7.2.3, “DROP RESOURCE GROUP Statement”](drop-resource-group.html "15.7.2.3 DROP RESOURCE GROUP Statement").

Those statements require the
[`RESOURCE_GROUP_ADMIN`](privileges-provided.html#priv_resource-group-admin) privilege.

To manage resource group assignments, use these capabilities:

* [`SET RESOURCE GROUP`](set-resource-group.html "15.7.2.4 SET RESOURCE GROUP Statement") assigns
...
* The [`RESOURCE_GROUP`](optimizer-hints.html#optimizer-hints-resource-group "Resource Group Hint Syntax")
...
[`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.31 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table, which is
implemented as a view on the data dictionary table. See
[Section 28.3.31, “The INFORMATION\_SCHEMA RESOURCE\_GROUPS Table”](information-schema-resource-groups-table.html "28.3.31 The INFORMATION_SCHEMA RESOURCE_GROUPS Table").

Initially, the [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.31 The INFORMATION_SCHEMA RESOURCE_GROUPS Table")
...
the [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.31 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table:
...
group, use the [`RESOURCE_GROUP`](optimizer-hints.html#optimizer-hints-resource-group "Resource Group Hint Syntax")
optimizer hint:
...
* On Linux, resource groups thread priorities are ignored
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary unmodified. To adjust the
  ...
  name to the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") executable (this
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary to the
...
* On Windows, threads run at one of five thread priority
  ...
  **Table 7.6 Resource Group Thread Priority on Windows**
  ...
  <table summary="Priority ranges for resource group threads on Windows."><col style="width: 20%"/><col style="width: 40%"/><thead><tr>

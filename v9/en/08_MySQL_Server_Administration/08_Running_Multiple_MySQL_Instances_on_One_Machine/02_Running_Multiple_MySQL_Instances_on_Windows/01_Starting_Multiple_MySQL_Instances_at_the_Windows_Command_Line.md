...
[Section 2.3.3.6, “Starting MySQL from the Windows Command Line”](windows-start-command-line.html "2.3.3.6 Starting MySQL from the Windows Command Line"). To start multiple
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") on port 3307 with a data directory of

...
* Start the client with
  ...
  [`--port=port_number`](connection-options.html#option_general_port)
  to connect using TCP/IP to a remote server, with
  [`--host=127.0.0.1`](connection-options.html#option_general_host)
  [`--port=port_number`](connection-options.html#option_general_port)
  to connect using TCP/IP to a local server, or with
  [`--host=localhost`](connection-options.html#option_general_host)
  [`--socket=file_name`](connection-options.html#option_general_socket)
  to connect to a local server using a Unix socket file or a
  Windows named pipe.

* Start the client with
  [`--protocol=TCP`](connection-options.html#option_general_protocol) to connect
  using TCP/IP,
  [`--protocol=SOCKET`](connection-options.html#option_general_protocol) to connect
  using a Unix socket file,
  [`--protocol=PIPE`](connection-options.html#option_general_protocol) to connect
  using a named pipe, or
  [`--protocol=MEMORY`](connection-options.html#option_general_protocol) to connect
  using shared memory. For TCP/IP connections, you may also need
  to specify [`--host`](connection-options.html#option_general_host) and
  [`--port`](connection-options.html#option_general_port) options. For the other
  types of connections, you may need to specify a
  [`--socket`](connection-options.html#option_general_socket) option to specify a
  Unix socket file or Windows named-pipe name, or a
  [`--shared-memory-base-name`](connection-options.html#option_general_shared-memory-base-name)
...
* Specify the default Unix socket file and TCP/IP port number in
  ...
  directory on Unix. See [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files").

* In a C program, you can specify the socket file or port number
  arguments in the
  [`mysql_real_connect()`](/doc/c-api/9.5/en/mysql-real-connect.html) call. You
  can also have the program read option files by calling
  [`mysql_options()`](/doc/c-api/9.5/en/mysql-options.html). See
  [C API Basic Function Descriptions](/doc/c-api/9.5/en/c-api-function-descriptions.html).
...
* If you are using the Perl `DBD::mysql`
  ...
  See [Section 31.9, “MySQL Perl API”](apis-perl.html "31.9 MySQL Perl API").

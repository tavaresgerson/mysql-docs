...
* `events`: Information about Event Scheduler
  events. See [Section 27.5, “Using the Event Scheduler”](event-scheduler.html "27.5 Using the Event Scheduler"). If the server
  is started with the
...
output of [`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement"), are not
...
`INFORMATION_SCHEMA`
[`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "28.3.30 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table") and
...
The MySQL 9.5 grant tables are
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") (transactional) tables.
...
* `func`: The registry for loadable functions
  ...
  Performance Schema
  [`user_defined_functions`](performance-schema-user-defined-functions-table.html "29.12.22.12 The user_defined_functions Table") table
...
* `ndb_binlog_index`: Binary log information
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") support. See

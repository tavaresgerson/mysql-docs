...
modify the [`log_error_services`](server-system-variables.html#sysvar_log_error_services)
value:
...
[`log_error_services`](server-system-variables.html#sysvar_log_error_services) value. For
example, to write unfiltered events with one instance and
filtered events with another instance, you could set
[`log_error_services`](server-system-variables.html#sysvar_log_error_services) like this:
...
[`log_error`](server-system-variables.html#sysvar_log_error) system variable. If
[`log_error`](server-system-variables.html#sysvar_log_error) names a file, the
...
[`log_error_services`](server-system-variables.html#sysvar_log_error_services) value write
to
`file_name.00.json`,
`file_name.01.json`,
and so forth.
...
the [`log_error_services`](server-system-variables.html#sysvar_log_error_services) value,

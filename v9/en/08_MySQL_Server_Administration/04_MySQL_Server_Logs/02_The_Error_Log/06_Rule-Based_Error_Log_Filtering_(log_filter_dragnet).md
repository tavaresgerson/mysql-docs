...
* Error codes can be specified in numeric form or as the
  ...
  [`ER_STARTUP`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_startup) is the symbolic
  ...
  + Use the [**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information") command. Given an
    error number argument, [**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information")
  ...
  Using [**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information"), determine the error
  symbols:

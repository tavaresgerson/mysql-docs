...
* [Verbosity Filtering](error-log-priority-based-filtering.html#error-log-verbosity-filtering "Verbosity Filtering")
* [Suppression-List Filtering](error-log-priority-based-filtering.html#error-log-suppression-filtering "Suppression-List Filtering")
* [Verbosity and Suppression-List Interaction](error-log-priority-based-filtering.html#error-log-verbosity-suppression-interaction "Verbosity and Suppression-List Interaction")
...
<table summary="Permitted log_error_verbosity values and corresponding permitted message priorities."><col style="width: 40%"/><col style="width: 40%"/><thead><tr>
...
If [`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) is 2
...
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) value of
...
[Section B.1, “Error Message Sources and Elements”](error-message-elements.html "B.1 Error Message Sources and Elements"), and
...
In this case,
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) permits
...
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) to 3 if
you want
[`log_error_suppression_list`](server-system-variables.html#sysvar_log_error_suppression_list)
...
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) setting.
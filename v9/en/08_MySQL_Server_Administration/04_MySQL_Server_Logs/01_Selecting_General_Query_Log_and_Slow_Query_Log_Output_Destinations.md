...
* [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"),
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), and
  [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") are valid
  operations on a log table. For [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") and [`DROP
  TABLE`](drop-table.html "15.1.37 DROP TABLE Statement"), the log table cannot be in use and must be
...
* By default, the log tables use the `CSV`
  ...
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to alter a log
  ...
  **Log Tables and “Too many open files” Errors.**
  ...
  [`FLUSH
  TABLES`](flush.html "15.7.8.3 FLUSH Statement") or ensure that the value of
...
* [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") is a valid
  operation on a log table. It can be used to expire log
  entries.

* [`RENAME TABLE`](rename-table.html "15.1.41 RENAME TABLE Statement") is a valid
...
* [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") is a valid
  operation on a log table.

* [`LOCK TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") cannot be used on
  a log table.

* [`INSERT`](insert.html "15.2.7 INSERT Statement"),
  [`DELETE`](delete.html "15.2.2 DELETE Statement"), and
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") cannot be used on a
...
* A [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") dump includes statements to

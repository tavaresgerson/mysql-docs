...
* Statements that change the `mysql` database
  ...
  [`CREATE TABLE
  ... SELECT`](create-table.html "15.1.24 CREATE TABLE Statement")), `ALTER` (all forms),
  and `DROP` (all forms).

[`CREATE TABLE ...
SELECT`](create-table.html "15.1.24 CREATE TABLE Statement") is a combination of data definition and data
manipulation. The [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")

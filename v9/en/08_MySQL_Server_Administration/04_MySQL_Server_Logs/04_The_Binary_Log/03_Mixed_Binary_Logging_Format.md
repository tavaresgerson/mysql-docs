...
session were dropped. In MySQL 9.5, operations on
...
output of [`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement")) and
through the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") error log. A warning is
added to the [`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement")
...
<th scope="row"><a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 9.5"><code class="literal">NDB</code></a></th>
<td>Yes</td>
<td>No</td>
</tr></tbody></table>
...
[`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement")). The information
is also written to the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") error log. Only
...
If a replica has
[`log_error_verbosity`](server-system-variables.html#sysvar_log_error_verbosity) set to

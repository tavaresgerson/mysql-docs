...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is doing. The server writes information
...
exactly what the client sent to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") writes statements to the query log in
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") utility and passes them to the
server.
...
Replication”](replication-sbr-rbr.html "19.2.1.1 Advantages and Disadvantages of Statement-Based and Row-Based Replication"), for more information.

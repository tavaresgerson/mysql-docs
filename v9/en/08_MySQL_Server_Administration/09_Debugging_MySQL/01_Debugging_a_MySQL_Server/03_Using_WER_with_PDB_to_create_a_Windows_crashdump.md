...
[Microsoft
Knowledge Base Article 121366](http://support.microsoft.com/kb/121366/). For more information on
the debugging options available, see
[Debugging
Tools for Windows](http://www.microsoft.com/whdc/devtools/debugging/default.mspx).
...
1. To generate a minidump `mysqld.dmp`,
   enable the [`core-file`](server-options.html#option_mysqld_core-file) option

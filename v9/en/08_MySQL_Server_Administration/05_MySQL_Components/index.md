...
* Components for use with MySQL Replication and MySQL Group
  Replication. See [Section 7.5.6, “Replication Components”](replication-components.html "7.5.6 Replication Components").

* A component that enables creation and use of MySQL stored
  programs written in JavaScript. See

...
the [`SET`](set.html "13.3.7 The SET Type") statement, which enables
...
[`SUPER`](privileges-provided.html#priv_super) privilege). For more
information, see [Section 7.1.9.1, “System Variable Privileges”](system-variable-privileges.html "7.1.9.1 System Variable Privileges").

Clone variables are configured on the recipient MySQL server
instance where the cloning operation is executed.

* [`clone_autotune_concurrency`](clone-plugin-options-variables.html#sysvar_clone_autotune_concurrency)

  <table frame="box" rules="all" summary="Properties for clone_autotune_concurrency"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">ON</code></td>
  ...
  The [`clone_max_concurrency`](clone-plugin-options-variables.html#sysvar_clone_max_concurrency)
  ...
  [`clone_autotune_concurrency`](clone-plugin-options-variables.html#sysvar_clone_autotune_concurrency)
  is disabled,
  [`clone_max_concurrency`](clone-plugin-options-variables.html#sysvar_clone_max_concurrency)
  defines the number of threads spawned for a remote cloning
  operation.

* [`clone_buffer_size`](clone-plugin-options-variables.html#sysvar_clone_buffer_size)

  <table frame="box" rules="all" summary="Properties for clone_buffer_size"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_block_ddl`](clone-plugin-options-variables.html#sysvar_clone_block_ddl)
  ...
  <table frame="box" rules="all" summary="Properties for clone_block_ddl"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_delay_after_data_drop`](clone-plugin-options-variables.html#sysvar_clone_delay_after_data_drop)
  ...
  <table frame="box" rules="all" summary="Properties for clone_delay_after_data_drop"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_ddl_timeout`](clone-plugin-options-variables.html#sysvar_clone_ddl_timeout)

  <table frame="box" rules="all" summary="Properties for clone_ddl_timeout"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td>seconds</td>
  ...
  operation if
  [`clone_block_ddl`](clone-plugin-options-variables.html#sysvar_clone_block_ddl) is set to
  `OFF` (the default). In this case, the
  cloning operation does not have to wait for a backup lock on
  the donor. See
  [Section 7.6.6.4, “Cloning and Concurrent DDL”](clone-plugin-concurrent-ddl.html "7.6.6.4 Cloning and Concurrent DDL").
...
* [`clone_donor_timeout_after_network_failure`](clone-plugin-options-variables.html#sysvar_clone_donor_timeout_after_network_failure)
  ...
  <table frame="box" rules="all" summary="Properties for clone_donor_timeout_after_network_failure"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_enable_compression`](clone-plugin-options-variables.html#sysvar_clone_enable_compression)
  ...
  <table frame="box" rules="all" summary="Properties for clone_enable_compression"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_max_concurrency`](clone-plugin-options-variables.html#sysvar_clone_max_concurrency)
  ...
  <table frame="box" rules="all" summary="Properties for clone_max_concurrency"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td>threads</td>
  ...
  [`clone_max_concurrency`](clone-plugin-options-variables.html#sysvar_clone_max_concurrency) is
  ...
  by the
  [`clone_max_data_bandwidth`](clone-plugin-options-variables.html#sysvar_clone_max_data_bandwidth)
  variable.

* [`clone_max_data_bandwidth`](clone-plugin-options-variables.html#sysvar_clone_max_data_bandwidth)

  <table frame="box" rules="all" summary="Properties for clone_max_data_bandwidth"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`clone_max_network_bandwidth`](clone-plugin-options-variables.html#sysvar_clone_max_network_bandwidth)

  <table frame="box" rules="all" summary="Properties for clone_max_network_bandwidth"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td>bytes</td>
  ...
  The [`clone_valid_donor_list`](clone-plugin-options-variables.html#sysvar_clone_valid_donor_list)
  variable adds a layer of security by providing control over
  the sources of cloned data. The privilege required to
  configure
  [`clone_valid_donor_list`](clone-plugin-options-variables.html#sysvar_clone_valid_donor_list) is
  ...
  requires the [`CLONE_ADMIN`](privileges-provided.html#priv_clone-admin)
  privilege.

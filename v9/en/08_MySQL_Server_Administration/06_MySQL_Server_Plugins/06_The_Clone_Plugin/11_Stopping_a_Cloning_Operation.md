...
[`KILL QUERY
processlist_id`](kill.html "15.7.8.4 KILL Statement") statement.
...
`Id` column of [`SHOW
PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") output, or the
`PROCESSLIST_ID` column of the Performance
Schema [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table. These methods

...
[Section 7.6.6.7, “Cloning for Replication”](clone-plugin-replication.html "7.6.6.7 Cloning for Replication")). Group Replication
...
data. See [Section 7.6.6.5, “Cloning Encrypted Data”](clone-plugin-encrypted-data.html "7.6.6.5 Cloning Encrypted Data"), and
[Section 7.6.6.6, “Cloning Compressed Data”](clone-plugin-compressed-data.html "7.6.6.6 Cloning Compressed Data").

The clone plugin must be installed before you can use it. For
installation instructions, see
[Section 7.6.6.1, “Installing the Clone Plugin”](clone-plugin-installation.html "7.6.6.1 Installing the Clone Plugin"). For cloning
instructions, see [Section 7.6.6.2, “Cloning Data Locally”](clone-plugin-local.html "7.6.6.2 Cloning Data Locally"), and

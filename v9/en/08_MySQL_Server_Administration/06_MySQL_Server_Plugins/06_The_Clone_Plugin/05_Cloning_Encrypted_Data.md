...
* A secure connection is required when cloning remote data to
  ...
  [`CLONE
  INSTANCE`](clone.html "15.7.5 CLONE Statement") statement. For information about
...
The [`innodb_redo_log_encrypt`](innodb-parameters.html#sysvar_innodb_redo_log_encrypt)

...
[`--early-plugin-load`](server-options.html#option_mysqld_early-plugin-load) is
deprecated, and subject to removal in a future version of
MySQL. See the description of this option for more
information.
...
[`PLUGINS`](information-schema-plugins-table.html "28.3.27 The INFORMATION_SCHEMA PLUGINS Table") table.
...
* It cannot unload plugins that are built in to the server.
  ...
  Schema [`PLUGINS`](information-schema-plugins-table.html "28.3.27 The INFORMATION_SCHEMA PLUGINS Table") table or
...
* It cannot unload plugins for which the server was started
  ...
  the [`PLUGINS`](information-schema-plugins-table.html "28.3.27 The INFORMATION_SCHEMA PLUGINS Table") table.
...
3. Plugins normally are installed using either a plugin-loading
   ...
   [`PLUGINS`](information-schema-plugins-table.html "28.3.27 The INFORMATION_SCHEMA PLUGINS Table") or
   [`SHOW PLUGINS`](show-plugins.html "15.7.7.28 SHOW PLUGINS Statement"), use

...
functions, [Section 8.4.5.15, “General-Purpose Keyring Key-Management Functions”](keyring-functions-general-purpose.html "8.4.5.15 General-Purpose Keyring Key-Management Functions").
For general keyring information, see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").
...
* `user_id`: The session effective user ID.
  ...
  the value of [`CURRENT_USER()`](information-functions.html#function_current-user)
...
* `my_key_generate()`
  ...
  keyring plugin. See [Section 8.4.5.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.5.13 Supported Keyring Key Types and Lengths").

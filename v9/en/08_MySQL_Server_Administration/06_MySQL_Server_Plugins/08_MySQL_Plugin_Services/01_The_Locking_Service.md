...
[Section 7.6.8, “MySQL Plugin Services”](plugin-services.html "7.6.8 MySQL Plugin Services"). For general information about
...
* Namespace and lock names must be
  ...
  [`ER_LOCKING_SERVICE_WRONG_NAME`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_locking_service_wrong_name)
  error.
...
* Locks can be waited for if not immediately available. Lock
  ...
  acquisition, an
  [`ER_LOCKING_SERVICE_TIMEOUT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_locking_service_timeout)
...
* The locking interface detects deadlock between
  ...
  [`ER_LOCKING_SERVICE_DEADLOCK`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_locking_service_deadlock)
...
[Section 7.6.8.1.2, “The Locking Service Function Interface”](locking-service.html#locking-service-interface "7.6.8.1.2 The Locking Service Function Interface") For general
characteristics of the locking service interface, see
[Section 7.6.8.1, “The Locking Service”](locking-service.html "7.6.8.1 The Locking Service"). For general information
about plugin services, see [Section 7.6.8, “MySQL Plugin Services”](plugin-services.html "7.6.8 MySQL Plugin Services").
...
[Section 7.6.8.1.1, “The Locking Service C Interface”](locking-service.html#locking-service-c-interface "7.6.8.1.1 The Locking Service C Interface") For general
characteristics of the locking service interface, see
[Section 7.6.8.1, “The Locking Service”](locking-service.html "7.6.8.1 The Locking Service"). For general information
...
[Section 7.6.8.1.1, “The Locking Service C Interface”](locking-service.html#locking-service-c-interface "7.6.8.1.1 The Locking Service C Interface") need not be
...
[`CREATE FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") statement,
...
[`DROP FUNCTION`](drop-function.html "15.1.30 DROP FUNCTION Statement") statement:

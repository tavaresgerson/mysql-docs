...
functions, see [Section 14.2, “Loadable Function Reference”](loadable-function-reference.html "14.2 Loadable Function Reference").
...
a table, see [Section 14.1, “Built-In Function and Operator Reference”](built-in-function-reference.html "14.1 Built-In Function and Operator Reference").
...
* MySQL Enterprise Edition includes functions that perform encryption operations
  ...
  [Section 8.6, “MySQL Enterprise Encryption”](enterprise-encryption.html "8.6 MySQL Enterprise Encryption").
...
* MySQL Enterprise Edition includes functions that provide an SQL-level API for
  ...
  [Section 8.5, “MySQL Enterprise Data Masking”](data-masking.html "8.5 MySQL Enterprise Data Masking").
...
* MySQL Enterprise Edition includes audit logging for monitoring and logging of
  ...
  and [Section 8.4.7, “The Audit Message Component”](audit-api-message-emit.html "8.4.7 The Audit Message Component").
...
* MySQL Enterprise Edition includes a firewall capability that implements an
  ...
  patterns for accepted statement. See [Section 8.4.8, “MySQL Enterprise Firewall”](firewall.html "8.4.8 MySQL Enterprise Firewall").
...
* Version Tokens enables creation of and synchronization around
  ...
  incorrect or out-of-date data. Deprecated; see
  [Version Tokens](/doc/refman/8.4/en/version-tokens.html), for more information.
...
* A locking service provides a locking interface for application
  use. See [Section 7.6.8.1, “The Locking Service”](locking-service.html "7.6.8.1 The Locking Service").
...
[Adding Functions to MySQL](/doc/extending-mysql/9.5/en/adding-functions.html).
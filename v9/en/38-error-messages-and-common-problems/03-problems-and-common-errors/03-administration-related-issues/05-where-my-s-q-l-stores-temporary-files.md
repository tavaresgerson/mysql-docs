...
The optional `EXTENDED` modifier causes `SHOW TABLES` to list hidden tables created by failed `ALTER TABLE` statements. See Section 15.7.7.40, “SHOW TABLES Statement”.

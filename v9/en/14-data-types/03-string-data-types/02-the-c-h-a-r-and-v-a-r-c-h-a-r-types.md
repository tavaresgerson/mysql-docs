...
<table summary="Illustration of the difference between CHAR and VARCHAR storage requirements by showing the required storage for various string values in CHAR(4) and VARCHAR(4) columns."><col style="width: 15%"/><col style="width: 15%"/><col style="width: 20%"/><col style="width: 15%"/><col style="width: 20%"/><thead><tr> <th>Value</th> <th><code class="literal">CHAR(4)</code></th> <th>Storage Required</th> <th><code class="literal">VARCHAR(4)</code></th> <th>Storage Required</th> </tr></thead><tbody><tr> <th><code class="literal">''</code></th> <td><code class="literal">'    '</code></td> <td>4 bytes</td> <td><code class="literal">''</code></td> <td>1 byte</td> </tr><tr> <th><code class="literal">'ab'</code></th> <td><code class="literal">'ab  '</code></td> <td>4 bytes</td> <td><code class="literal">'ab'</code></td> <td>3 bytes</td> </tr><tr> <th><code class="literal">'abcd'</code></th> <td><code class="literal">'abcd'</code></td> <td>4 bytes</td> <td><code class="literal">'abcd'</code></td> <td>5 bytes</td> </tr><tr> <th><code class="literal">'abcdefgh'</code></th> <td><code class="literal">'abcd'</code></td> <td>4 bytes</td> <td><code class="literal">'abcd'</code></td> <td>5 bytes</td> </tr></tbody></table>

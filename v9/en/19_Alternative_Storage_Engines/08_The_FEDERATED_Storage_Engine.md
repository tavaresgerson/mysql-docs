...
* When using a `CONNECTION` string, you cannot use an '@' character in the password. You can get round this limitation by using the [`CREATE SERVER`](create-server.html "15.1.22 CREATE SERVER Statement") statement to create a server connection.

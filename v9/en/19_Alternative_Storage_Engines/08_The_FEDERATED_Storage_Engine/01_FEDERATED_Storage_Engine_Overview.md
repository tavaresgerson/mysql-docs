...
is shown in [Figure 18.2, “FEDERATED Table Structure”](federated-description.html#figure-se-federated-structure "Figure 18.2 FEDERATED Table Structure").
...
[`mysql_real_query()`](/doc/c-api/9.5/en/mysql-real-query.html) to send the
statement. To read a result set, it uses
[`mysql_store_result()`](/doc/c-api/9.5/en/mysql-store-result.html) and fetches
rows one at a time using
[`mysql_fetch_row()`](/doc/c-api/9.5/en/mysql-fetch-row.html).
...
* The [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is killed in the
  middle of a write.
...
* You are using an external program (such as
  [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility")) to modify a table that is
...
using the [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") statement,
and repair a corrupted `MyISAM` table with
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"). When
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is not running, you can also check or
repair a table with the [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") command.
See [Section 15.7.3.2, “CHECK TABLE Statement”](check-table.html "15.7.3.2 CHECK TABLE Statement"),
[Section 15.7.3.5, “REPAIR TABLE Statement”](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), and [Section 6.6.4, “myisamchk — MyISAM Table-Maintenance Utility”](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").

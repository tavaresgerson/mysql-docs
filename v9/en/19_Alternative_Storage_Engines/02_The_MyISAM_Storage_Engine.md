...
* You can put the data file and index file in different directories on different physical devices to get more speed with the `DATA DIRECTORY` and `INDEX DIRECTORY` table options to [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"). See Section 15.1.24, “CREATE TABLE Statement”.
...
See Section 15.1.24, “CREATE TABLE Statement”, for information about `ROW_FORMAT`.

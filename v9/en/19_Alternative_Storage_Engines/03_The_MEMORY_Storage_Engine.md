...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"), or a subsequent
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") or
[`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement"), is the value used
...
must be emptied by writing a [`TRUNCATE
TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") statement for that table to the binary log. When a
...
it writes a [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement")
...
errors, see [Section 19.5.1.22, “Replication and MEMORY Tables”](replication-features-memory.html "19.5.1.22 Replication and MEMORY Tables").
...
[`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") to remove all rows,
or remove the table altogether using [`DROP
TABLE`](drop-table.html "15.1.37 DROP TABLE Statement"). To free up the memory used by deleted rows, use
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements for

...
compressed with [**myisampack**](myisampack.html "6.6.6 myisampack — Generate Compressed, Read-Only MyISAM Tables"). See
[Section 6.6.6, “myisampack — Generate Compressed, Read-Only MyISAM Tables”](myisampack.html "6.6.6 myisampack — Generate Compressed, Read-Only MyISAM Tables"). Differences between tables such as
these do not matter:
...
more information, see [Chapter 26, *Partitioning*](partitioning.html "Chapter 26 Partitioning").
...
You can use [`SELECT`](select.html "15.2.13 SELECT Statement"),
[`DELETE`](delete.html "15.2.2 DELETE Statement"),
[`UPDATE`](update.html "15.2.17 UPDATE Statement"), and
[`INSERT`](insert.html "15.2.7 INSERT Statement") on `MERGE`
...
Use of [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") with a
...
* Use `ALTER TABLE tbl_name
  ...
  [`UNION`](union.html "15.2.18 UNION Clause") clause) to remove all of
  ...
  with [`CREATE
  TABLE ... LIKE`](create-table-like.html "15.1.24.3 CREATE TABLE ... LIKE Statement").
...
TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") displays information about which table caused the
problem.

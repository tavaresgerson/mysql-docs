...
* **Cloning Operations.**
  ...
  operation must therefore include the `DATA
  DIRECTORY` clause if Group Replication is running.
  See [Section 20.5.4.2.4, “Cloning for Other Purposes”](group-replication-cloning.html#group-replication-cloning-manual "20.5.4.2.4 Cloning for Other Purposes").

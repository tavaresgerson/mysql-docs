...
[Backing Up a Database Server](/doc/mysql-enterprise-backup/9.5/en/backing-up.html). Also note the requirements described
in [Grant MySQL Privileges to Backup Administrator](/doc/mysql-enterprise-backup/9.5/en/mysqlbackup.privileges.html) and
[Using MySQL Enterprise Backup with Group Replication](/doc/mysql-enterprise-backup/9.5/en/meb-group-replication.html).
...
2. *Restore the backup.* Connect to the target
   ...
   4. Restore backup of `s2` onto the host for
      ...
      should use the [`--log-bin`](/doc/mysql-enterprise-backup/9.5/en/server-repository-options.html#option_meb_log-bin) and
      [`--relay-log`](/doc/mysql-enterprise-backup/9.5/en/server-repository-options.html#option_meb_relay-log) options to
...
2. *Restore the backup.* Connect to the target
   ...
   4. Restore the backup of `s2` onto the host
      ...
      using the [`--skip-binlog`](/doc/mysql-enterprise-backup/9.5/en/backup-capacity-options.html#option_meb_skip-binlog) and
      [`--skip-relaylog`](/doc/mysql-enterprise-backup/9.5/en/backup-capacity-options.html#option_meb_skip-relaylog) options:

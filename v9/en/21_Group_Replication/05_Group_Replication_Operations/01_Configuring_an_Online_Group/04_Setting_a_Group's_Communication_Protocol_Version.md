...
Group Replication in MySQL 9.5 uses the concept of
...
[InnoDB Cluster and Group Replication Protocol](/doc/mysql-shell/9.5/en/monitoring-innodb-cluster.html#innodb-cluster-group-replication-protocol).
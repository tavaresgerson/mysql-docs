...
[`replication_group_member_actions`](performance-schema-replication-group-member-actions-table.html "29.12.11.16 The replication_group_member_actions Table")
...
[`replication_group_configuration_version`](performance-schema-replication-group-configuration-version-table.html "29.12.11.15 The replication_group_configuration_version Table"),
...
writeable (with the [`read_only`](server-system-variables.html#sysvar_read_only)
...
The member action
`mysql_disable_super_read_only_if_primary` can
...
[`SUPER`](privileges-provided.html#priv_super) privilege. It does continue

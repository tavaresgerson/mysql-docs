...
[Section 20.8.3.2, “Upgrading a Group Replication Member”](group-replication-upgrading-member.html "20.8.3.2 Upgrading a Group Replication Member") for how to
remove members from a group and shutdown MySQL.

Once the group is offline, upgrade all of the members. See
[Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL") for how to perform an upgrade. When

...
middleware framework such as [MySQL Router 9.5](/doc/mysql-router/9.5/en/), a
proxy, a connector, or the application itself.
[Figure 20.5, “Client Failover”](group-replication-multi-primary-mode.html#group-replication-multi-primary-diagram "Figure 20.5 Client Failover") shows
...
control, see [Section 20.7.2, “Flow Control”](group-replication-flow-control.html "20.7.2 Flow Control").

If you want transaction consistency guaranteed for every
transaction in the group, you can do this using the
...
For more information about atomic DDL support, see
...
read-only in any case.) Members take into account the
major.minor.release version of the MySQL software (and thus,
of the Group Replication plugin) when checking their
compatibility.

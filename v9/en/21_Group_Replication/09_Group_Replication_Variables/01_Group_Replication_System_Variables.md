...
[`group_replication_communication_stack`](group-replication-system-variables.html#sysvar_group_replication_communication_stack)
is `MYSQL`, not `XCOM` as it
is for a default Group Replication implementation.

For more information, see
[MySQL InnoDB Cluster](/doc/mysql-shell/9.5/en/mysql-innodb-cluster.html).
...
* [`group_replication_view_change_uuid`](group-replication-system-variables.html#sysvar_group_replication_view_change_uuid)
  (deprecated)
...
and
[`group_replication_switch_to_multi_primary_mode()`](group-replication-functions-for-mode.html#function_group-replication-switch-to-multi-primary-mode)
...
* [`group_replication_communication_max_message_size`](group-replication-system-variables.html#sysvar_group_replication_communication_max_message_size)
...
The value of
[`group_replication_preemptive_garbage_collection`](group-replication-system-variables.html#sysvar_group_replication_preemptive_garbage_collection)
...
using a [`STOP GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement")
statement followed by a [`START
GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement. Changes to the following
system variables take effect without stopping and restarting Group
Replication:

* [`group_replication_advertise_recovery_endpoints`](group-replication-system-variables.html#sysvar_group_replication_advertise_recovery_endpoints)
* [`group_replication_autorejoin_tries`](group-replication-system-variables.html#sysvar_group_replication_autorejoin_tries)
* [`group_replication_consistency`](group-replication-system-variables.html#sysvar_group_replication_consistency)
* [`group_replication_elect_prefers_most_updated.enabled`](group-replication-system-variables.html#sysvar_group_replication_elect_prefers_most_updated.enabled)
...
* [`group_replication_flow_control_period`](group-replication-system-variables.html#sysvar_group_replication_flow_control_period)
* [`group_replication_flow_control_release_percent`](group-replication-system-variables.html#sysvar_group_replication_flow_control_release_percent)
* [`group_replication_force_members`](group-replication-system-variables.html#sysvar_group_replication_force_members)
* [`group_replication_ip_allowlist`](group-replication-system-variables.html#sysvar_group_replication_ip_allowlist)
...
[`STOP GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement") statement or
...
[Section 20.5.2, “Restarting a Group”](group-replication-restarting-group.html "20.5.2 Restarting a Group"). In the case
...
* System variables for Group Replication that specify IP
  ...
  until a [`START
  GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement is issued. Group
...
* [`group_replication_advertise_recovery_endpoints`](group-replication-system-variables.html#sysvar_group_replication_advertise_recovery_endpoints)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_advertise_recovery_endpoints"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-advertise-recovery-endpoints=value</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_advertise_recovery_endpoints">group_replication_advertise_recovery_endpoints</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">DEFAULT</code></td>
  ...
  [`hostname`](server-system-variables.html#sysvar_hostname) and
  [`port`](server-system-variables.html#sysvar_port) system variables. If an
  alternative port number is specified by the
  [`report_port`](replication-options-replica.html#sysvar_report_port) system variable,
  that one is used instead. The Performance Schema table
  [`replication_group_members`](performance-schema-replication-group-members-table.html "29.12.11.18 The replication_group_members Table") shows
  ...
  + The ports do have to be configured for MySQL Server using
    the [`port`](server-system-variables.html#sysvar_port),
    [`report_port`](replication-options-replica.html#sysvar_report_port), or
    [`admin_port`](server-system-variables.html#sysvar_admin_port) system
    variable.

  + Appropriate permissions are required for the replication
    user for distributed recovery if the
    [`admin_port`](server-system-variables.html#sysvar_admin_port) is used.
...
* [`group_replication_auto_increment_increment`](group-replication-system-variables.html#sysvar_group_replication_auto_increment_increment)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_auto_increment_increment"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-auto-increment-increment=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_auto_increment_increment">group_replication_auto_increment_increment</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">65535</code></td>
  ...
  [`auto_increment_increment`](replication-options-source.html#sysvar_auto_increment_increment) is
  changed to this value, and the value of the server system
  variable
  [`auto_increment_offset`](replication-options-source.html#sysvar_auto_increment_offset) is
  changed to the server ID. The changes are reverted when Group
  Replication is stopped. These changes are only made and
  reverted if
  [`auto_increment_increment`](replication-options-source.html#sysvar_auto_increment_increment) and
  [`auto_increment_offset`](replication-options-source.html#sysvar_auto_increment_offset) each
...
* [`group_replication_autorejoin_tries`](group-replication-system-variables.html#sysvar_group_replication_autorejoin_tries)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_autorejoin_tries"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-autorejoin-tries=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_autorejoin_tries">group_replication_autorejoin_tries</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">2016</code></td>
  ...
  immediately. The system variable's current value is read
...
* [`group_replication_bootstrap_group`](group-replication-system-variables.html#sysvar_group_replication_bootstrap_group)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_bootstrap_group"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-bootstrap-group[={OFF|ON}]</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_bootstrap_group">group_replication_bootstrap_group</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">OFF</code></td>
  ...
  [Section 20.2.1.5, “Bootstrapping the Group”](group-replication-bootstrap.html "20.2.1.5 Bootstrapping the Group"). For
  instructions to safely bootstrap a group where transactions
  have been executed and certified, see
  [Section 20.5.2, “Restarting a Group”](group-replication-restarting-group.html "20.5.2 Restarting a Group").

* [`group_replication_clone_threshold`](group-replication-system-variables.html#sysvar_group_replication_clone_threshold)

  <table frame="box" rules="all" summary="Properties for group_replication_clone_threshold"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-clone-threshold=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_clone_threshold">group_replication_clone_threshold</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td>transactions</td>
  ...
  instructions, see [Section 20.5.4.2, “Cloning for Distributed Recovery”](group-replication-cloning.html "20.5.4.2 Cloning for Distributed Recovery").
  ...
  [`group_replication_start_on_boot=ON`](group-replication-system-variables.html#sysvar_group_replication_start_on_boot)
...
* [`group_replication_communication_debug_options`](group-replication-system-variables.html#sysvar_group_replication_communication_debug_options)

  <table frame="box" rules="all" summary="Properties for group_replication_communication_debug_options"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-communication-debug-options=value</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_communication_debug_options">group_replication_communication_debug_options</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`group_replication_communication_max_message_size`](group-replication-system-variables.html#sysvar_group_replication_communication_max_message_size)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_communication_max_message_size"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-communication-max-message-size=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_communication_max_message_size">group_replication_communication_max_message_size</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td>bytes</td>
  ...
  [`group_replication_get_communication_protocol()`](group-replication-functions-for-communication-protocol.html#function_group-replication-get-communication-protocol)
...
* [`group_replication_communication_stack`](group-replication-system-variables.html#sysvar_group_replication_communication_stack)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_communication_stack"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_communication_stack">group_replication_communication_stack</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">XCOM</code></td>
</tr><tr><th>Valid Values</th>
<td><p class="valid-value"><code class="literal">XCOM</code></p><p class="valid-value"><code class="literal">MYSQL</code></p></td>
</tr></tbody></table>
...
* [`group_replication_components_stop_timeout`](group-replication-system-variables.html#sysvar_group_replication_components_stop_timeout)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_components_stop_timeout"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-components-stop-timeout=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_components_stop_timeout">group_replication_components_stop_timeout</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`group_replication_compression_threshold`](group-replication-system-variables.html#sysvar_group_replication_compression_threshold)
  ...
  <table frame="box" rules="all" summary="Properties for group_replication_compression_threshold"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--group-replication-compression-threshold=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="group-replication-system-variables.html#sysvar_group_replication_compression_threshold">group_replication_compression_threshold</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">65535</code></td>
  ...
  + `EVENTUAL`
    ...
    failover, the new primary can accept new read-only
    transactions before the previous primary transactions have
    all been applied, though read/write transactions are not
    allowed.
  ...
  For more information, see
  [Section 20.5.3, “Transaction Consistency Guarantees”](group-replication-consistency-guarantees.html "20.5.3 Transaction Consistency Guarantees").
...
<td><code class="literal">65535</code></td>
  ...
  Whether the Group Replication Primary Election component is
  enabled on this server. All group members must have it enabled
  (set to `ON`) in order for the
  most-up-to-date primary selection mechanism to function
  properly. If any member has it disabled or if any member does
  not support, the primary selection is based on member weights.

  Provided by the Group Replication Primary Election component,
  part of MySQL Enterprise Edition. See
...
<td><code class="literal">65535</code></td>
  ...
  setting the system variable
  [`offline_mode`](server-system-variables.html#sysvar_offline_mode) to
  ...
  [`super_read_only=ON`](server-system-variables.html#sysvar_super_read_only) is set
  ...
  GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") command.
...
<td><code class="literal">2016</code></td>
  ...
  GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement.
...
<td><code class="literal">2016</code></td>
  ...
  [`hostname`](server-system-variables.html#sysvar_hostname) and
  [`port`](server-system-variables.html#sysvar_port) system variables). The
  ...
  GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement is issued and the Group
  ...
  [`START GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") fails.
...
<td><code class="literal">2016</code></td>
  ...
  ([`group_replication_communication_stack=XCOM`](group-replication-system-variables.html#sysvar_group_replication_communication_stack)),
...
<td><code class="literal">2016</code></td>
  ...
  IPv6, see [Section 20.5.5, “Support For IPv6 And For Mixed IPv6 And IPv4 Groups”](group-replication-ipv6.html "20.5.5 Support For IPv6 And For Mixed IPv6 And IPv4 Groups").

  If you are using the XCom communication stack to establish
  group communication connections between members
  ([`group_replication_communication_stack
  = XCOM`](group-replication-system-variables.html#sysvar_group_replication_communication_stack)), the address that you specify for each group
  member in
  [`group_replication_local_address`](group-replication-system-variables.html#sysvar_group_replication_local_address)
...
<td><code class="literal">OFF</code></td>
  ...
  table shows whether the group supports the use of a single
  leader, even if
  [`group_replication_paxos_single_leader`](group-replication-system-variables.html#sysvar_group_replication_paxos_single_leader)
...
* [`group_replication_preemptive_garbage_collection_rows_threshold`](group-replication-system-variables.html#sysvar_group_replication_preemptive_garbage_collection_rows_threshold)
...
<td><code class="literal">OFF</code></td>
  ...
  enabled
  ([`group_replication_preemptive_garbage_collection`](group-replication-system-variables.html#sysvar_group_replication_preemptive_garbage_collection)
  is `ON`), this is the number of rows of
...
<td><code class="literal">OFF</code></td>
  ...
  support cloning (see
  [Section 20.5.4.2, “Cloning for Distributed Recovery”](group-replication-cloning.html "20.5.4.2 Cloning for Distributed Recovery")) and a remote
...
* [`group_replication_recovery_get_public_key`](group-replication-system-variables.html#sysvar_group_replication_recovery_get_public_key)
...
<td><code class="literal">OFF</code></td>
  ...
  [`group_replication_recovery_public_key_path`](group-replication-system-variables.html#sysvar_group_replication_recovery_public_key_path)
  ...
  ([`group_replication_recovery_use_ssl=ON`](group-replication-system-variables.html#sysvar_group_replication_recovery_use_ssl)),
...
<td><code class="literal">OFF</code></td>
  ...
  `caching_sha2_password` plugin (the default)
  or the `sha256_password` plugin (deprecated).
  (For `sha256_password`, setting
...
<td>transactions</td>
  ...
  [Section 20.5.4.2, “Cloning for Distributed Recovery”](group-replication-cloning.html "20.5.4.2 Cloning for Distributed Recovery")), and you have set
  [`group_replication_recovery_use_ssl`](group-replication-system-variables.html#sysvar_group_replication_recovery_use_ssl)
  to `ON`, Group Replication automatically
  configures the setting for the clone SSL option
  [`clone_ssl_ca`](clone-plugin-options-variables.html#sysvar_clone_ssl_ca) to match your
  setting for
  [`group_replication_recovery_ssl_ca`](group-replication-system-variables.html#sysvar_group_replication_recovery_ssl_ca).

  When the MySQL communication stack is in use for the group
  ([`group_replication_communication_stack
  = MYSQL`](group-replication-system-variables.html#sysvar_group_replication_communication_stack)), this setting is used for the TLS/SSL
...
<td>transactions</td>
  ...
  to `ON`, Group Replication automatically
  configures the setting for the clone SSL option
  [`clone_ssl_cert`](clone-plugin-options-variables.html#sysvar_clone_ssl_cert) to match your
  setting for
  [`group_replication_recovery_ssl_cert`](group-replication-system-variables.html#sysvar_group_replication_recovery_ssl_cert).
...
<td>transactions</td>
  ...
  to `ON`, Group Replication automatically
  configures the setting for the clone SSL option
  [`clone_ssl_key`](clone-plugin-options-variables.html#sysvar_clone_ssl_key) to match your
  setting for
  [`group_replication_recovery_ssl_key`](group-replication-system-variables.html#sysvar_group_replication_recovery_ssl_key).
...
* [`group_replication_recovery_tls_ciphersuites`](group-replication-system-variables.html#sysvar_group_replication_recovery_tls_ciphersuites)
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  listed in
  [Section 8.3.2, “Encrypted Connection TLS Protocols and Ciphers”](encrypted-connection-protocols-ciphers.html "8.3.2 Encrypted Connection TLS Protocols and Ciphers"). If
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  + Support for the TLSv1.3 protocol is available in MySQL
    9.5, provided that MySQL was compiled using
    ...
    In that case, the default is `TLSv1.2`.
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  If this server has been set up to support cloning (see
  [Section 20.5.4.2, “Cloning for Distributed Recovery”](group-replication-cloning.html "20.5.4.2 Cloning for Distributed Recovery")), and you set this
...
* [`group_replication_recovery_zstd_compression_level`](group-replication-system-variables.html#sysvar_group_replication_recovery_zstd_compression_level)
...
* [`group_replication_resource_manager.applier_channel_lag`](group-replication-system-variables.html#sysvar_group_replication_resource_manager.applier_channel_lag)
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  Specifies the maximum allowed lag time for an applier on a
  Group Replication secondary. Provided by the Group Replication
  Resource Manager component.

  The default value of this variable is equivalent to 1 hour;
  the maximum is equivalent to 12 hours. Setting
  `group_replication_resource_manager.applier_channel_lag`
  to `0` disables applier lag handling.

  If the current lag by a secondary applier as shown by
  [`Gr_resource_manager_applier_channel_lag`](group-replication-status-variables.html#statvar_Gr_resource_manager_applier_channel_lag)
  exceeds
  `group_replication_resource_manager.applier_channel_lag`
  10 times in succession, the system initiates a graceful exit
  from the current group and sets the member's state to
  `ERROR`.
...
* [`group_replication_resource_manager.memory_used_limit`](group-replication-system-variables.html#sysvar_group_replication_resource_manager.memory_used_limit)
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  Specifies the maximum allowed memory usage on a Group
  Replication secondary, as a percent of system memory. Provided
  by the Group Replication Resource Manager component.

  Setting
  `group_replication_resource_manager.memory_used_limit`
  to `0` disables memory usage monitoring.

  If the current memory usage on a group replication secondary
  as shown by
  [`Gr_resource_manager_memory_used`](group-replication-status-variables.html#statvar_Gr_resource_manager_memory_used)
  exceeds
  `group_replication_resource_manager.memory_used_limit`
  10 times in succession, the system initiates a graceful exit
  from the current group and sets the member's state to
...
* [`group_replication_resource_manager.quarantine_time`](group-replication-system-variables.html#sysvar_group_replication_resource_manager.quarantine_time)
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  Length of time, in seconds, to prevent the immediate
  re-ejection of a member attempting to join or rejoin a group
  after it has been expelled. Provided by the Group Replication
  Resource Manager component.
...
* [`group_replication_resource_manager.recovery_channel_lag`](group-replication-system-variables.html#sysvar_group_replication_resource_manager.recovery_channel_lag)
...
<td><p class="valid-value"><code class="literal">GCS_DEBUG_NONE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_BASIC</code></p><p class="valid-value"><code class="literal">XCOM_DEBUG_TRACE</code></p><p class="valid-value"><code class="literal">GCS_DEBUG_ALL</code></p></td>
  ...
  Specifies the maximum allowed lag time for a recovery thread
  on a Group Replication secondary. Provided by the Group
  Replication Resource Manager component.

  The default value of this variable is equivalent to 1 hour;
  the maximum is equivalent to 12 hours. Setting
  `group_replication_resource_manager.recovery_channel_lag`
  to `0` disables recovery lag handling.

  If the current lag by a recovery thread as shown by
  [`Gr_resource_manager_recovery_channel_lag`](group-replication-status-variables.html#statvar_Gr_resource_manager_recovery_channel_lag)
  exceeds
  `group_replication_resource_manager.recovery_channel_lag`
  10 times in succession, the system initiates a graceful exit
  from the current group and sets the member's state to
...
<td>bytes</td>
  ...
  TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement. If you prefer to specify user
  credentials as part of [`START
  GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement"), which stores the user credentials
  in memory only, ensure that
  [`group_replication_start_on_boot`](group-replication-system-variables.html#sysvar_group_replication_start_on_boot)
  is set to `OFF`.

* [`group_replication_tls_source`](group-replication-system-variables.html#sysvar_group_replication_tls_source)
...
The previous list includes those system variables provided by the
Group Replication Flow Control Statistics component and by the
Group Replication Resource Manager component. See

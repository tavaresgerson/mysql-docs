...
MySQL 9.5 Group Replication can secure group
...
* The [`require_secure_transport`](server-system-variables.html#sysvar_require_secure_transport)
...
2. On each of the group members, set the system variable
   ...
   [`SET`](set.html "13.3.7 The SET Type") statement. For example:

...
SSL, see [Configuring an Encrypted Connection for Cloning](clone-plugin-remote.html#clone-plugin-remote-ssl "Configuring an Encrypted Connection for Cloning").)
...
* [`group_replication_recovery_use_ssl`](group-replication-system-variables.html#sysvar_group_replication_recovery_use_ssl):
  ...
  [Section 8.3.1, “Configuring MySQL to Use Encrypted Connections”](using-encrypted-connections.html "8.3.1 Configuring MySQL to Use Encrypted Connections")), use the
...
* [`group_replication_recovery_ssl_ca`](group-replication-system-variables.html#sysvar_group_replication_recovery_ssl_ca):
  ...
  [`clone_ssl_ca`](clone-plugin-options-variables.html#sysvar_clone_ssl_ca) to match this.
...
* [`group_replication_recovery_ssl_cert`](group-replication-system-variables.html#sysvar_group_replication_recovery_ssl_cert):
  ...
  for distributed recovery connections. Group Replication
  automatically configures the clone SSL option
  [`clone_ssl_cert`](clone-plugin-options-variables.html#sysvar_clone_ssl_cert) to match
  this.

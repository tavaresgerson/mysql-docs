...
Data collected for [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure")
includes this information:

* Information from the [`metrics`](sys-metrics.html "30.4.3.21 The metrics View")
  view (see [Section 30.4.3.21, “The metrics View”](sys-metrics.html "30.4.3.21 The metrics View"))
...
* Information from the
  [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.15 ndbinfo: The NDB Cluster Information Database") schema, if the
...
* The initial view is the content of the view at the start
  of the [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure")
...
* The overall view is the content of the view at the end of
  the [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") procedure.
...
* The delta view is the difference from the beginning to the
  ...
  [`metrics`](sys-metrics.html "30.4.3.21 The metrics View") view, the delta is
...
[`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") operation can be
...
* `diagnostics.allow_i_s_tables`,
  ...
  Schema [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table. This
...
* `diagnostics.include_raw`,
  ...
  [`metrics`](sys-metrics.html "30.4.3.21 The metrics View") view. The default
  is `OFF`.
...
* `statement_truncate_len`,
  ...
  [`format_statement()`](sys-format-statement.html "30.4.5.5 The format_statement() Function")
...
runs, use the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client `tee
filename` and
`notee` commands (see

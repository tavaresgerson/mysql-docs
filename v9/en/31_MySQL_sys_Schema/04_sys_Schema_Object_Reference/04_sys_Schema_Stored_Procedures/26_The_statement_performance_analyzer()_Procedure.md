...
* `in_views SET
  ...
  + `analysis`: Use the
    [`statement_analysis`](sys-statement-analysis.html "30.4.3.35 The statement_analysis and x$statement_analysis Views")
    view.
  ...
  + `with_sorting`: Use the
    [`statements_with_sorting`](sys-statements-with-sorting.html "30.4.3.39 The statements_with_sorting and x$statements_with_sorting Views")
    view.

  + `with_temp_tables`: Use the
    [`statements_with_temp_tables`](sys-statements-with-temp-tables.html "30.4.3.40 The statements_with_temp_tables and x$statements_with_temp_tables Views")
    view.

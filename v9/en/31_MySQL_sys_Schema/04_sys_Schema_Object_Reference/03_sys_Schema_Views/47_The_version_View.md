...
This view is deprecated, and subject to removal in a future
MySQL version. Applications that use it should be migrated
to use an alternative instead. For example, use the
[`VERSION()`](information-functions.html#function_version) function to

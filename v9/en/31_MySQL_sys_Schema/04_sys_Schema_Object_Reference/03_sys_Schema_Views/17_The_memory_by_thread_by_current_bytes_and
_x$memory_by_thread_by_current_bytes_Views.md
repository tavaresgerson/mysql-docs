...
The
[`memory_by_thread_by_current_bytes`](sys-memory-by-thread-by-current-bytes.html "30.4.3.17 The memory_by_thread_by_current_bytes and x$memory_by_thread_by_current_bytes Views")
and
[`x$memory_by_thread_by_current_bytes`](sys-memory-by-thread-by-current-bytes.html "30.4.3.17 The memory_by_thread_by_current_bytes and x$memory_by_thread_by_current_bytes Views")

...
This table contains [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema
...
The [`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table has these
columns:
...
* `set_by`
  ...
  [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema was installed.

As an efficiency measure to minimize the number of direct
reads from the [`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table,
[`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema functions that use a
...
[`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table. Otherwise, the
...
the [`format_statement()`](sys-format-statement.html "30.4.5.5 The format_statement() Function") function.
...
[`format_statement()`](sys-format-statement.html "30.4.5.5 The format_statement() Function") within the
...
in the [`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table and
...
[`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table and the
...
* `diagnostics.allow_i_s_tables`,
  ...
  [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") procedure is
  permitted to perform table scans on the Information Schema
  [`TABLES`](information-schema-tables-table.html "28.3.44 The INFORMATION_SCHEMA TABLES Table") table. This can be
...
* `diagnostics.include_raw`,
  ...
  If this option is `ON`, the
  [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") procedure
...
* `ps_thread_trx_info.max_length`,
  ...
  [`ps_thread_trx_info()`](sys-ps-thread-trx-info.html "30.4.5.17 The ps_thread_trx_info() Function")
...
* `statement_performance_analyzer.limit`,
  ...
  [`statements_with_runtimes_in_95th_percentile`](sys-statements-with-runtimes-in-95th-percentile.html "30.4.3.38 The statements_with_runtimes_in_95th_percentile and x$statements_with_runtimes_in_95th_percentile Views")
...
* `statement_performance_analyzer.view`,
  ...
  [`statement_performance_analyzer()`](sys-statement-performance-analyzer.html "30.4.4.26 The statement_performance_analyzer() Procedure")
  procedure (which is itself invoked by the
  [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") procedure). If
...
* `statement_truncate_len`,
  ...
  [`format_statement()`](sys-format-statement.html "30.4.5.5 The format_statement() Function") function.
  Longer statements are truncated to this length. The
  default is 64.

Other options can be added to the
[`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table. For example,
the [`diagnostics()`](sys-diagnostics.html "30.4.4.2 The diagnostics() Procedure") and
[`execute_prepared_stmt()`](sys-execute-prepared-stmt.html "30.4.4.3 The execute_prepared_stmt() Procedure")
procedures use the `debug` option if it
exists, but this option is not part of the
[`sys_config`](sys-sys-config.html "30.4.2.1 The sys_config Table") table by default

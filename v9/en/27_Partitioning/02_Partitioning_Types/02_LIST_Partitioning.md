...
In MySQL 9.5, it is possible to match against
only a list of integers (and possibly
`NULL`—see
[Section 26.2.7, “How MySQL Partitioning Handles NULL”](partitioning-handling-nulls.html "26.2.7 How MySQL Partitioning Handles NULL")) when
...
[Section 26.2.1, “RANGE Partitioning”](partitioning-range.html "26.2.1 RANGE Partitioning"). As with the other
...
you could use the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
...
In MySQL 9.5, all rows relating to employees
...
than the equivalent [`DELETE`](delete.html "15.2.2 DELETE Statement")
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement containing an
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement into a single
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table,
...
[`TABLE`](table.html "15.2.16 TABLE Statement") statement that rows
...
[Section 26.2.3.2, “LIST COLUMNS partitioning”](partitioning-columns-list.html "26.2.3.2 LIST COLUMNS partitioning").
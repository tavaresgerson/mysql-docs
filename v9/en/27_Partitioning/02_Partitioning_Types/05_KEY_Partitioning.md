...
* `KEY` takes only a list of zero or more
  ...
  TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") or in the
  ...
  [`VARBINARY`](binary-varbinary.html "13.3.3 The BINARY and VARBINARY Types") columns can be used
  ...
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns in index
  ...
  Tables using the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage
  ...
  key generated by the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")
  storage engine for each NDB Cluster table is used as the
  partitioning key.

  If you define an explicit partitioning scheme for an
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table, the table must
  ...
  [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables") utility (with the
  `-p` option).
  ...
  partitioning key. See [Chapter 25, *MySQL NDB Cluster 9.5*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5").
...
arithmetic. See [Section 26.2.4.1, “LINEAR HASH Partitioning”](partitioning-linear-hash.html "26.2.4.1 LINEAR HASH Partitioning"), for

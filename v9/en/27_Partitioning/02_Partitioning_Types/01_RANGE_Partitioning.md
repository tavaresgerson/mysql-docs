...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement that provides for all values greater
...
[`INSERT`](insert.html "15.2.7 INSERT Statement") statement. For an example,
see [Section 26.2.2, “LIST Partitioning”](partitioning-list.html "26.2.2 LIST Partitioning").
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement to add new partitions for stores
21-25, 26-30, and so on (see
[Section 26.3, “Partition Management”](partitioning-management.html "26.3 Partition Management"), for details of how to
do this).
...
[`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns instead. For
...
[`YEAR(separated)`](date-and-time-functions.html#function_year). An example of a
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement that
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column, using the
[`UNIX_TIMESTAMP()`](date-and-time-functions.html#function_unix-timestamp) function, as
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values are not
...
* You want or need to delete “old” data. If you
  ...
  [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement"), and
  [Section 26.3, “Partition Management”](partitioning-management.html "26.3 Partition Management"), for more
  information.) For a table with a great many rows, this can
  be much more efficient than running a
  [`DELETE`](delete.html "15.2.2 DELETE Statement") query such as
...
* You frequently run queries that depend directly on the
  ...
  AND '2000-12-31' GROUP BY store_id;`](explain.html "15.8.2 EXPLAIN Statement"), MySQL can
  ...
  clause. See [Section 26.4, “Partition Pruning”](partitioning-pruning.html "26.4 Partition Pruning"), for more
...
pruning. See [Section 26.2.3.1, “RANGE COLUMNS partitioning”](partitioning-columns-range.html "26.2.3.1 RANGE COLUMNS partitioning"), for
more information.

**Partitioning schemes based on time intervals.**
If you wish to implement a partitioning scheme based on ranges
or intervals of time in MySQL 9.5, you have two
options:
...
1. Partition the table by `RANGE`, and for the
   ...
   [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column and returning
   ...
   In MySQL 9.5, it is also possible to partition
   ...
   In MySQL 9.5, any other expressions involving
   [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") values are not
   permitted. (See Bug #42849.)

   Note

   It is also possible in MySQL 9.5 to use
   [`UNIX_TIMESTAMP(timestamp_column)`](date-and-time-functions.html#function_unix-timestamp)
...
2. Partition the table by `RANGE COLUMNS`,
   using a [`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") or
   [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") column as the
...
other than [`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") or
[`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") is not supported with
`RANGE COLUMNS`.
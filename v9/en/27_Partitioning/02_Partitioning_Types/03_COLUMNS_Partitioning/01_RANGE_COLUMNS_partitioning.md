...
* `RANGE COLUMNS` partitioning columns are
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns can also
  be used as partitioning columns. (See
  [Section 26.2.3, “COLUMNS Partitioning”](partitioning-columns.html "26.2.3 COLUMNS Partitioning"), for details.)
...
Not all [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") options
...
of the [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement.
...
The [`SELECT`](select.html "15.2.13 SELECT Statement") statement in the
...
MySQL, see [Section 15.2.15.5, “Row Subqueries”](row-subqueries.html "15.2.15.5 Row Subqueries").
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, like this:
...
If a [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement
...
[Section 26.2.3, “COLUMNS Partitioning”](partitioning-columns.html "26.2.3 COLUMNS Partitioning"), for a complete listing
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement:
...
collations, see [Chapter 12, *Character Sets, Collations, Unicode*](charset.html "Chapter 12 Character Sets, Collations, Unicode").
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement shown here:
...
See [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"), for additional information

...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement with the `DROP
...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") and [`INSERT`](insert.html "15.2.7 INSERT Statement")
statements:
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") that are described in this chapter.
...
(See [Section 15.1.42, “TRUNCATE TABLE Statement”](truncate-table.html "15.1.42 TRUNCATE TABLE Statement").)
...
in [Section 15.1.11, “ALTER TABLE Statement”](alter-table.html "15.1.11 ALTER TABLE Statement"), for information about
`REORGANIZE PARTITION`.

If you now execute a [`SHOW CREATE
TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") statement, you can see how the partitioning
...
Using [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.12 SHOW CREATE TABLE Statement") you can
...
See also [Section 15.1.11.1, “ALTER TABLE Partition Operations”](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations").
...
[`CREATE TABLE ...
SELECT ...`](create-table.html "15.1.24 CREATE TABLE Statement"), then drop the old table and rename the new
...
[`ALTER
TABLE ... ADD PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations"). However, you can use another
partition-related extension to
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") to accomplish this:
...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"). You are not limited
...
* You cannot use `REORGANIZE PARTITION` to
  ...
  can use
  [`ALTER
  TABLE ... PARTITION BY ...`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations"), as shown here:

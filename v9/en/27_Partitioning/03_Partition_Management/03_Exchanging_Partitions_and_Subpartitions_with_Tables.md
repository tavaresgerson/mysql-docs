...
10. `INDEX DIRECTORY` cannot differ between the
    table and the partition to be exchanged with it.

11. No table or partition `TABLESPACE` options
...
required for [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
statements, you must have the
[`DROP`](privileges-provided.html#priv_drop) privilege to perform
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement").
...
* Executing [`ALTER
  TABLE ... EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") does not invoke any
...
The syntax for
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") is shown here, where
...
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") operation does not perform any
...
[`ALTER TABLE
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. To exchange multiple
partitions or subpartitions, use multiple
[`ALTER TABLE
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statements. `EXCHANGE
PARTITION` may not be combined with other
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") options. The
...
[`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table, like this:
...
Information Schema [`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table")
...
use
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations"), as shown here:
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement as previously:
...
issuing the
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement, have now switched places:
...
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statement must meet the conditions
...
[`ALTER
TABLE ... REPAIR PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations").
...
VALIDATION` to the
[`ALTER
TABLE ... EXCHANGE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement.
...
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. In the following
...
[`PARTITIONS`](information-schema-partitions-table.html "28.3.26 The INFORMATION_SCHEMA PARTITIONS Table") table from
...
The following
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statement exchanges subpartition
...
The `ALTER TABLE ... ENGINE ...` statement in
this example works because the previous `ALTER
TABLE` removed the partitioning from table
`es3`.
...
using the statements [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement"),
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), which are supported
for partitioned tables.

You can use a number of extensions to
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") for performing operations of this type on one or
...
* **Optimizing partitions.**
  ...
  having [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types"),
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"), or
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns), you can use
  [`ALTER
  TABLE ... OPTIMIZE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") to reclaim any
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine"), do not support
  per-partition optimization; in these cases,
  [`ALTER
  TABLE ... OPTIMIZE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") analyzes and rebuilds
...
* **Repairing partitions.**
  ...
  [`ALTER
  IGNORE TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") with this option, in which case all
...
* **Checking partitions.**
  ...
  use
  [`ALTER
  TABLE ... REPAIR PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") to repair the
  partition.

  Normally, `CHECK PARTITION` fails when the
  partition contains duplicate key errors. You can use
  [`ALTER
  IGNORE TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") with this option, in which case the
...
[`ALTER TABLE ...
TRUNCATE PARTITION`](alter-table.html "15.1.11 ALTER TABLE Statement"). This statement can be used to
delete all rows from one or more partitions in much the same way
that [`TRUNCATE TABLE`](truncate-table.html "15.1.42 TRUNCATE TABLE Statement") deletes all
rows from a table.

[`ALTER TABLE ...
TRUNCATE PARTITION ALL`](alter-table.html "15.1.11 ALTER TABLE Statement") truncates all partitions in the
table.
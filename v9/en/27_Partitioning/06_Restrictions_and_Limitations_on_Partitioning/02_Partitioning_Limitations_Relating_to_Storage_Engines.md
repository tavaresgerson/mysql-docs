...
In MySQL 9.5, partitioning support is not actually
provided by the MySQL Server, but rather by a table storage
engine's own or native partitioning handler. In MySQL
9.5, only the [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine")
and [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engines provide
...
[`ALTER
TABLE ... OPTIMIZE PARTITION`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") does not work correctly
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine. It is not
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table depends on the number of
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.11.1 ALTER TABLE Partition Operations") statements that would cause a user-partitioned
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table not to meet either or
...
**Exception.**
If a user-partitioned [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") table

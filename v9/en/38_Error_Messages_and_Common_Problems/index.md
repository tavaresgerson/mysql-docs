...
B.3 Problems and Common Errors :   B.3.1 How to Determine What Is Causing a Problem
...
* Information about errors related to `InnoDB`: Section 17.20.5, “InnoDB Error Handling”
...
* Descriptions of the error messages that the MySQL server and client programs generate: MySQL 9.5 Error Message Reference

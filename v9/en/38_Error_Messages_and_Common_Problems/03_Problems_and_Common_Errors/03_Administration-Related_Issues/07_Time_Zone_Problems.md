...
[**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script")). See
...
option to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). You can also set it

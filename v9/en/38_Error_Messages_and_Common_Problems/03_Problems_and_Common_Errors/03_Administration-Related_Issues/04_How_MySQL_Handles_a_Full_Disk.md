...
* Alternatively, to abort the thread, use
  [**mysqladmin kill**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program"). The thread is aborted
...
[`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") or when the
indexes are created in a batch after [`LOAD
DATA`](load-data.html "15.2.9 LOAD DATA Statement") or after an [`ALTER
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statement. All of these statements may create
...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"), the old table is left unchanged.
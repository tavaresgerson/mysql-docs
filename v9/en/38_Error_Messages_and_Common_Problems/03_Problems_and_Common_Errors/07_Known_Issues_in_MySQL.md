...
* With statement-based binary logging, the source server
  ...
  + [`CREATE
    TABLE ... SELECT`](create-table-select.html "15.1.24.4 CREATE TABLE ... SELECT Statement") or
    [`INSERT
...
* You can have up to 255 [`ENUM`](enum.html "13.3.6 The ENUM Type")
  and [`SET`](set.html "13.3.7 The SET Type") columns in one table.
...
* If you use [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to add
  ...
  because [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") puts

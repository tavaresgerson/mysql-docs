...
[`CREATE TEMPORARY
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") have the following limitations:
...
* The [`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") statement
  does not list `TEMPORARY` tables.

* To rename `TEMPORARY` tables,
  `RENAME TABLE` does not work. Use
  [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") instead:
...
* You cannot refer to a `TEMPORARY` table
  ...
  [`WITH`](with.html "15.2.20 WITH (Common Table Expressions)") clause that defines a
...
* There are known issues in using temporary tables with
  replication. See
  [Section 19.5.1.32, “Replication and Temporary Tables”](replication-features-temptables.html "19.5.1.32 Replication and Temporary Tables"), for
  more information.
...
[`DELETE`](delete.html "15.2.2 DELETE Statement") statement for
...
multiple [`DELETE`](delete.html "15.2.2 DELETE Statement") statements. You
probably get the fastest [`DELETE`](delete.html "15.2.2 DELETE Statement")

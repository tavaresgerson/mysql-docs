...
[`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") values that are larger
...
see an [`ER_NET_PACKET_TOO_LARGE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_net_packet_too_large)

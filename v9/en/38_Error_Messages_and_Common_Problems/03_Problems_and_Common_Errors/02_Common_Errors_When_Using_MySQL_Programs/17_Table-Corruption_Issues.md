...
without [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") having died unexpectedly
...
See also [Section 7.1.7, “Server Command Options”](server-options.html "7.1.7 Server Command Options"), and

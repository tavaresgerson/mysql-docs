...
clients) errors, see [MySQL 9.5 Error Message Reference](/doc/mysql-errors/9.5/en/).
...
* SQL statement warning and error information is available
  through the [`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") and
  [`SHOW ERRORS`](show-errors.html "15.7.7.19 SHOW ERRORS Statement") statements. The
...
* [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.36 SHOW REPLICA STATUS Statement") statement
  output includes information about replication errors
  occurring on replica servers.

* [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.17 SHOW ENGINE Statement") statement output includes
  information about the most recent foreign key error if a
  [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement for an
...
* [`mysql_sqlstate()`](/doc/c-api/9.5/en/mysql-sqlstate.html) returns the
  SQLSTATE value.

* [`mysql_error()`](/doc/c-api/9.5/en/mysql-error.html) returns the
  message string.

* [`mysql_stmt_errno()`](/doc/c-api/9.5/en/mysql-stmt-errno.html),
  [`mysql_stmt_sqlstate()`](/doc/c-api/9.5/en/mysql-stmt-sqlstate.html), and
  [`mysql_stmt_error()`](/doc/c-api/9.5/en/mysql-stmt-error.html) are the
  corresponding error functions for prepared statements.

* [`mysql_warning_count()`](/doc/c-api/9.5/en/mysql-warning-count.html)
  returns the number of errors, warnings, and notes for the
  most recent statement.

For descriptions of the client library error functions, see
[MySQL 9.5 C API Developer Guide](/doc/c-api/9.5/en/).
...
The [**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information") program provides information from

...
displayed by the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client:
...
client library, as displayed by the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
client:
...
* Error code: This value is numeric. It is MySQL-specific and
  ...
  + The symbol for server error number
    `1146` is
    [`ER_NO_SUCH_TABLE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_no_such_table).

  + The symbol for client error number
    `2005` is
    [`CR_UNKNOWN_HOST`](/doc/mysql-errors/9.5/en/client-error-reference.html#error_cr_unknown_host).
...
* When the server writes a message to the error log, it pads
  ...
  [`MY-000022`](/doc/mysql-errors/9.5/en/global-error-reference.html#error_ee_unknown_charset),
  [`MY-010048`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_scheduler_stopped)).

* When the server sends a message to a client program, it adds
  no zero-padding or prefix to the error code (examples:
  [`1036`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_open_as_readonly),
  [`3013`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_field_size)).
...
This section gives some detail on connecting from a UNIX-like platform to the OCI Compute. For more information on connecting with SSH, see [Accessing an Oracle Linux Instance Using SSH](https://docs.oracle.com/en/cloud/iaas/compute-iaas-cloud/stcsg/accessing-oracle-linux-instance-using-ssh.html#GUID-D947E2CC-0D4C-43F4-B2A9-A517037D6C11) and [Connecting to Your Instance](https://docs.cloud.oracle.com/iaas/Content/GSG/Tasks/testingconnection.htm).

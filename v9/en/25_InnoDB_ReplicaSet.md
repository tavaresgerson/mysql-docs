...
[MySQL InnoDB ReplicaSet](/doc/mysql-shell/9.5/en/mysql-innodb-replicaset.html).
...
[MySQL InnoDB Cluster](/doc/mysql-shell/9.5/en/mysql-innodb-cluster.html), you use MySQL Shell to work
...
[add an instance](/doc/mysql-shell/9.5/en/add-instance-replicaset.html) to
...
[create MySQL Router users](/doc/mysql-shell/9.5/en/configuring-router-user.html)

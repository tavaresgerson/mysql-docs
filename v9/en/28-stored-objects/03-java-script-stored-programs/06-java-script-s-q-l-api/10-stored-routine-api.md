...
<table border="1" class="informaltable" summary="Descriptive text"><colgroup><col/><col/><col/></colgroup><thead><tr><th>MySQL Type</th><th>Javascript Type</th><th>Notes</th></tr></thead><tbody><tr><td><code class="literal">NULL</code></td><td><code class="literal">null</code></td><td>-</td></tr><tr><td><code class="literal">BIGINT</code></td><td><code class="literal">Number</code>, <code class="literal">String</code>, <code class="literal">BigInt</code></td><td>Depends on <code class="literal">session.sql()</code> method <code class="literal">integerType</code> option value</td></tr><tr><td><code class="literal">DECIMAL</code></td><td>-</td><td>Error: Unsupported type</td></tr><tr><td><code class="literal">DOUBLE</code></td><td><code class="literal">Number</code></td><td>-</td></tr><tr><td>Binary string (<code class="literal">BINARY</code>, <code class="literal">BLOB</code>)</td><td><code class="literal">Uint8Array</code></td><td>-</td></tr><tr><td>Non-binary string (<code class="literal">TEXT</code>)</td><td><code class="literal">String</code></td><td>-</td></tr><tr><td><code class="literal">VECTOR</code></td><td><code class="literal">Float32Array</code></td><td>-</td></tr><tr><td><code class="literal">JSON</code></td><td><code class="literal">Object</code></td><td>-</td></tr><tr><td><code class="literal">DATE</code>, <code class="literal">DATETIME</code>, <code class="literal">TIMESTAMP</code></td><td><code class="literal">Date</code></td><td>-</td></tr><tr><td><code class="literal">ENUM</code></td><td><code class="literal">String</code></td><td>-</td></tr><tr><td><code class="literal">SET</code></td><td><code class="literal">Set</code> (<code class="literal">String</code>)</td><td>JavaScript <code class="literal">Set</code> can be converted to a comma-delimited string</td></tr></tbody></table>

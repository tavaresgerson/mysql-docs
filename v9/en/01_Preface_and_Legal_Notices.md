...
9.5.0 Innovation release. For license information, see
the [Legal Notices](preface.html#legalnotice "Legal Notices").
...
MySQL 9.5 and previous versions. If you are using an
earlier release of the MySQL software, please refer to the
appropriate manual. For example,
[MySQL 8.4
Reference Manual](/doc/refman/8.4/en/) covers the 8.4 bugfix series of MySQL
software releases.

**Licensing information—MySQL 9.6.**
This product may include third-party software, used under license.
If you are using a *Commercial* release of MySQL
9.6, see the
[MySQL 9.6
Commercial Release License Information User Manual](https://downloads.mysql.com/docs/licenses/mysqld-9.5-com-en.pdf) for licensing information,
...
*Community* release of MySQL 9.6, see the
[MySQL 9.6
Community Release License Information User Manual](https://downloads.mysql.com/docs/licenses/mysqld-9.5-gpl-en.pdf) for licensing information,
including licensing information relating to third-party software
that may be included in this Community release.

**Licensing information—MySQL NDB Cluster 9.5.**
This product may include third-party software, used under license.
If you are using a *Commercial* release of MySQL
NDB Cluster 9.5, see the
[MySQL NDB
Cluster 9.5 Commercial Release License Information User Manual](https://downloads.mysql.com/docs/licenses/cluster-9.5-com-en.pdf) for licensing
...
9.5, see the
[MySQL NDB
Cluster 9.5 Community Release License Information User Manual](https://downloads.mysql.com/docs/licenses/cluster-9.5-gpl-en.pdf) for licensing
information, including licensing information relating to third-party

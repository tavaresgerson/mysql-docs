...
* **Performance with LOAD DATA.** In MySQL 9.5, `LOAD DATA` uses buffering to improve performance. You should be aware that the buffer uses 130 KB memory per partition to achieve this.

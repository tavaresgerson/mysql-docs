...
[Chapter 25, *MySQL NDB Cluster 9.5*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") and
...
* [MySQL Shell](/doc/mysql-shell/9.5/en/), which is an
...
* [MySQL Router](/doc/mysql-router/9.5/en/), a lightweight
...
[AdminAPI](/doc/mysql-shell/9.5/en/admin-api-overview.html), provided as
...
and [install](/doc/mysql-shell/9.5/en/mysql-shell-install.html) MySQL Shell.
You need some hosts with MySQL Server instances
[installed](installing.html "Chapter 2 Installing MySQL"), and you can also
[install](/doc/mysql-router/9.5/en/mysql-router-installation.html) MySQL Router.

InnoDB Cluster supports [MySQL
Clone](clone-plugin.html "7.6.6 The Clone Plugin"), which enables you to provision instances simply. In
...
instance](/doc/mysql-shell/9.5/en/add-instances-cluster.html) to the cluster and it is automatically provisioned.

Similarly, InnoDB Cluster is tightly integrated with
[MySQL Router](/doc/mysql-router/9.5/en/), and you can use
AdminAPI to [work with](/doc/mysql-shell/9.5/en/registered-routers.html)
them together. MySQL Router can automatically configure itself based on
an InnoDB Cluster, in a process called
[bootstrapping](/doc/mysql-shell/9.5/en/admin-api-bootstrapping-router.html),
...
users](/doc/mysql-shell/9.5/en/configuring-router-user.html) at the cluster level, to work with the MySQL Routers

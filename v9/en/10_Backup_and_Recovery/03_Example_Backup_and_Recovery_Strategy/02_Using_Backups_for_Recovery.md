...
[`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin) option that specifies a
...
using [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") and
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") to restore the most recent data changes
...
For more information about using [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files")

...
[`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements for the
...
[`replica_load_tmpdir`](replication-options-replica.html#sysvar_replica_load_tmpdir). If the

...
[**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information") *`nnn`*, where
*`nnn`* is the error number. The
following example shows how to use [**perror**](perror.html "6.8.1 perror — Display MySQL Error Message Information") to
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to increase the
`MAX_ROWS` and

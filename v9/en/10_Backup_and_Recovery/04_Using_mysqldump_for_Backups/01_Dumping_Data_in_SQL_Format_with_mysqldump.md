...
This section describes how to use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
...
By default, [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") writes information as
...
To dump all databases, invoke [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") with
the [`--all-databases`](mysqldump.html#option_mysqldump_all-databases) option:
...
and use the [`--databases`](mysqldump.html#option_mysqldump_databases)
option:
...
The [`--databases`](mysqldump.html#option_mysqldump_databases) option causes
all names on the command line to be treated as database names.
Without this option, [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") treats the
first name as a database name and those following as table
names.

With [`--all-databases`](mysqldump.html#option_mysqldump_all-databases) or
[`--databases`](mysqldump.html#option_mysqldump_databases),
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") writes [`CREATE
...
[`--add-drop-database`](mysqldump.html#option_mysqldump_add-drop-database) option as
well. In this case, [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") writes a
[`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") statement preceding
each [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") statement.
...
without [`--databases`](mysqldump.html#option_mysqldump_databases), the dump
output contains no [`CREATE
DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") or [`USE`](use.html "15.8.4 USE Statement")
...
* Because the output contains no [`CREATE
  DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement") statement, the
  [`--add-drop-database`](mysqldump.html#option_mysqldump_add-drop-database) option
  has no effect. If you use it, it produces no
  [`DROP DATABASE`](drop-database.html "15.1.28 DROP DATABASE Statement") statement.
...
the dump file ([`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode)),
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") includes a `SET
@@GLOBAL.gtid_purged` statement in the output to add
the GTIDs from the
[`gtid_executed`](replication-options-gtids.html#sysvar_gtid_executed) set on the source
server to the [`gtid_purged`](replication-options-gtids.html#sysvar_gtid_purged) set
on the target server. If you are dumping only specific databases
or tables, it is important to note that the value that is
included by [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") includes the GTIDs of
...
either set the [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") option

...
[Section 9.5.2, “Point-in-Time Recovery Using Event Positions”](point-in-time-recovery-positions.html "9.5.2 Point-in-Time Recovery Using Event Positions"), explains the
operation in details with an example.

Note

Many of the examples in this and the next section use the
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to process binary log output
produced by [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files"). If your binary log
contains `\0` (null) characters, that output
cannot be parsed by [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") unless you invoke
it with the [`--binary-mode`](mysql-command-options.html#option_mysql_binary-mode)
option.
...
the default setting for MySQL 9.5
...
[`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin) option to place the
...
The [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") utility converts the events
in the binary log files from binary format to text so that they
can be viewed or applied. [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") has
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") output using the
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") cannot read them directly as in
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") in an unencrypted format.
...
result. See [Command Options for Encrypted Connections](connection-options.html#encrypted-connection-options "Command Options for Encrypted Connections").
...
[**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files") output into a paging program:

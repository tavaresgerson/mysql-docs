...
You can get information about the number of rows actually inserted or updated with the `mysql_info()` C API function. You can also use the `SHOW WARNINGS` statement. See mysql_info(), and Section 15.7.7.43, “SHOW WARNINGS Statement”.

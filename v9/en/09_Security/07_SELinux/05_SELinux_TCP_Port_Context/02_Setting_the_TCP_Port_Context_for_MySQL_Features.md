...
[MySQL Port Reference](/doc/mysql-port-reference/en/).

For MySQL 9.5, enabling
...
variable. [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") must be able to bind to
...
[`mysqlx_port`](x-plugin-options-system-variables.html#sysvar_mysqlx_port) variable.
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") must be able to bind to the

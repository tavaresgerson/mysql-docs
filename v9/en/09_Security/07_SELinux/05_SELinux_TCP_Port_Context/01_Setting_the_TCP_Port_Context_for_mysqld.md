...
The default TCP port for [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is
`3306`; and the SELinux context type used is
`mysqld_port_t`.

If you configure [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to use a different
TCP [`port`](server-system-variables.html#sysvar_port), you may need to set

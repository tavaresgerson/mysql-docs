...
to removal in a future version of MySQL. They are superseded by
the Connection Control Component. For more information, see
...
* `CONNECTION_CONTROL` checks incoming
  ...
  [Writing Audit Plugins](/doc/extending-mysql/9.5/en/writing-audit-plugins.html)). To collect

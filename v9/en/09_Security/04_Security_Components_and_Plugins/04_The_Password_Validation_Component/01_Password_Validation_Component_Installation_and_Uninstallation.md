...
uninstalling components, see [Section 7.5, “MySQL Components”](components.html "7.5 MySQL Components").

Note

If you install MySQL 9.5 using the
[MySQL Yum
...
by Oracle](linux-installation-rpm.html "2.5.4 Installing MySQL on Linux Using RPM Packages from Oracle"), the `validate_password`
component is enabled by default after you start your MySQL
Server for the first time.

Upgrades to MySQL 9.5 from 9.4
...
see [Section 8.4.4.3, “Transitioning to the Password Validation Component”](validate-password-transitioning.html "8.4.4.3 Transitioning to the Password Validation Component").

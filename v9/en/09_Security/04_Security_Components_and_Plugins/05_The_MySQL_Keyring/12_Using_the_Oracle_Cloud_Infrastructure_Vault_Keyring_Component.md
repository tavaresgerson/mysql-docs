...
`component_keyring_oci` replaces the old
`keyring_oci` plugin (no longer available), and
employs the component infrastructure. For more information, see
...
* [Configuration Notes](keyring-oci-component.html#keyring-oci-component-configure "Configuration Notes")
* [Verify the Component Installation](keyring-oci-component.html#keyring-oci-component-verify "Verify the Component Installation")
* [Vault Keyring Component Usage](keyring-oci-component.html#keyring-oci-component-usage "Vault Keyring Component Usage")

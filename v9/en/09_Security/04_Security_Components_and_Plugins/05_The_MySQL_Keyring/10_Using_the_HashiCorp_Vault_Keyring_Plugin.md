...
The `keyring_hashicorp` keyring plugin is
deprecated, and is being replaced by the Hashicorp Keyring
component (`component_keyring_hashicorp`).
Deprecation of the plugin means that you should expect the
plugin to be removed in a future version of MySQL. For more
information, including information about migrating from the
`keyring_hashicorp` plugin to
`component_keyring_hashicorp`, see
...
* [HashiCorp Vault Setup](keyring-hashicorp-plugin.html#keyring-hashicorp-vault-configuration "HashiCorp Vault Setup")
...
[HashiCorp Vault Setup](keyring-hashicorp-plugin.html#keyring-hashicorp-vault-configuration "HashiCorp Vault Setup").) The
...
<table summary="keyring_hashicorp configuration parameters and corresponding system variables."><col style="width: 35%"/><col style="width: 50%"/><col style="width: 15%"/><thead><tr>
...
values to the
[`keyring_hashicorp_role_id`](keyring-system-variables.html#sysvar_keyring_hashicorp_role_id) and
...
[Section 8.4.5.19, “Keyring System Variables”](keyring-system-variables.html "8.4.5.19 Keyring System Variables"), and

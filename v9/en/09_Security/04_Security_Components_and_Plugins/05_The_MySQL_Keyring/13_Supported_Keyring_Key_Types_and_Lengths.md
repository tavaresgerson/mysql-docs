...
* The permitted key lengths are subject to multiple factors:
  ...
  + General keyring loadable-function interface limits (for
    ...
    described in
    [Section 8.4.5.15, “General-Purpose Keyring Key-Management Functions”](keyring-functions-general-purpose.html "8.4.5.15 General-Purpose Keyring Key-Management Functions")), or
...
[Table 8.32, “General Keyring Key Length Limits”](keyring-key-types.html#keyring-general-key-length-limits-table "Table 8.32 General Keyring Key Length Limits") shows
...
[Table 8.33, “Keyring Plugin Key Types and Lengths”](keyring-key-types.html#keyring-key-types-table "Table 8.33 Keyring Plugin Key Types and Lengths") shows the key types

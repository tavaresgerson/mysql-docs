...
keyring information, see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").
...
FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") statements, adjusting the
...
[`DROP FUNCTION`](drop-function.html "15.1.30 DROP FUNCTION Statement") statements:
...
* The keyring functions invoke keyring service functions
  (see [Section 7.6.8.2, “The Keyring Service”](keyring-service.html "7.6.8.2 The Keyring Service")). The service
  functions in turn use whatever keyring plugin is installed
  (for example, `keyring_okv`). Therefore,
...
* Keyring functions support the key types and lengths
  ...
  plugin, see [Section 8.4.5.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.5.13 Supported Keyring Key Types and Lengths").
...
* [`keyring_key_fetch(key_id)`](keyring-functions-general-purpose.html#function_keyring-key-fetch)
  ...
  in [Section 8.4.5.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.5.13 Supported Keyring Key Types and Lengths"). A key value
  longer than that length can be stored using a keyring
  service function (see
  [Section 7.6.8.2, “The Keyring Service”](keyring-service.html "7.6.8.2 The Keyring Service")), but if retrieved

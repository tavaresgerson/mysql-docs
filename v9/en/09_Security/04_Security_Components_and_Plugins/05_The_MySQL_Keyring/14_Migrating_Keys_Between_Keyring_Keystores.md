...
* Migration from one keyring component to another: The **mysql\_migrate\_keyring** utility provides this capability.
...
A migration server does not support migration from one keyring component to another. For that type of migration, see Key Migration Using the mysql\_migrate\_keyring Utility.
...
The **mysql\_migrate\_keyring** utility migrates keys from one keyring component to another. It does not support migrations involving keyring plugins. For that type of migration, use a MySQL server operating in key migration mode; see Key Migration Using a Migration Server.

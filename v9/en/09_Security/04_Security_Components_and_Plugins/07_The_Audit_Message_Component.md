...
use [`CREATE FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") or
[`DROP FUNCTION`](drop-function.html "15.1.30 DROP FUNCTION Statement") to do so.
...
* [`audit_api_message_emit_udf(component,
  ...
  [Section 8.4.6, “MySQL Enterprise Audit”](audit-log.html "8.4.6 MySQL Enterprise Audit")) logs message values as follows,

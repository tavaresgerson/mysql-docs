...
[Section 8.4.6.2, “Installing or Uninstalling MySQL Enterprise Audit”](audit-log-installation.html "8.4.6.2 Installing or Uninstalling MySQL Enterprise Audit"). Unless those objects
...
the [`audit_log_database`](audit-log-reference.html#sysvar_audit_log_database) system
...
* `FILTER`
  ...
  [`JSON`](json.html "13.5 The JSON Data Type") values.
...
invoked, see [Section 8.4.6.7, “Audit Log Filtering”](audit-log-filtering.html "8.4.6.7 Audit Log Filtering").
...
`utf8mb4` strings. Previously, audit log
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, binary string results display
...
* [`audit_log_encryption_password_get([keyring_id])`](audit-log-reference.html#function_audit-log-encryption-password-get)
  ...
  instructions, see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").
  ...
  *`keyring_id`*: This optional
  ...
  Schema [`keyring_keys`](performance-schema-keyring-keys-table.html "29.12.18.2 The keyring_keys table") table:
...
* [`audit_log_filter_flush()`](audit-log-reference.html#function_audit-log-filter-flush)
  ...
  [`DELETE`](delete.html "15.2.2 DELETE Statement"), the changes do not
  ...
  [`UNINSTALL PLUGIN`](uninstall-plugin.html "15.7.4.6 UNINSTALL PLUGIN Statement") plus
...
* [`audit_log_filter_set_filter(filter_name,
  definition)`](audit-log-reference.html#function_audit-log-filter-set-filter)
  ...
  + *`definition`*: A
    [`JSON`](json.html "13.5 The JSON Data Type") value that
...
* [`audit_log_filter_set_user(user_name,
  filter_name)`](audit-log-reference.html#function_audit-log-filter-set-user)
...
* [`audit_log_read([arg])`](audit-log-reference.html#function_audit-log-read)
  ...
  [`JSON`](json.html "13.5 The JSON Data Type") string result. If the
  audit log format is not
  [`JSON`](json.html "13.5 The JSON Data Type"), an error occurs.

  With no argument or a [`JSON`](json.html "13.5 The JSON Data Type")
  hash argument,
  [`audit_log_read()`](audit-log-reference.html#function_audit-log-read) reads
  events from the audit log and returns a
  [`JSON`](json.html "13.5 The JSON Data Type") string containing an
  ...
  [`JSON`](json.html "13.5 The JSON Data Type") hash, with the
  ...
  [`JSON`](json.html "13.5 The JSON Data Type")
  `null` value,
  [`audit_log_read()`](audit-log-reference.html#function_audit-log-read) closes the
  current read sequence.

  For additional details about the audit log-reading
  process, see [Section 8.4.6.6, “Reading Audit Log Files”](audit-log-file-reading.html "8.4.6.6 Reading Audit Log Files").
  ...
  *`arg`*: The argument is optional.
  ...
  or a [`JSON`](json.html "13.5 The JSON Data Type") hash. Within a
  ...
  + `timestamp`, `id`:
    ...
    an [`audit_log_read()`](audit-log-reference.html#function_audit-log-read)
  ...
  [`audit_log_read()`](audit-log-reference.html#function_audit-log-read), pass a
...
* [`audit_log_read_bookmark()`](audit-log-reference.html#function_audit-log-read-bookmark)
  ...
  A [`JSON`](json.html "13.5 The JSON Data Type") string containing a
...
* [`audit_log_rotate()`](audit-log-reference.html#function_audit-log-rotate)
  ...
  [`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin) privilege.

##### Audit Log Option and Variable Reference

**Table 8.44 Audit Log Option and Variable Reference**

<table frame="box" rules="all" summary="Reference for audit log command-line options, system variables, and status variables."><col style="width: 20%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><thead><tr><th scope="col">Name</th>
...
* [`--audit-log[=value]`](audit-log-reference.html#option_mysqld_audit-log)
  ...
  <table frame="box" rules="all" summary="Properties for audit-log"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") or is loaded with
  ...
  [`--audit-log=FORCE_PLUS_PERMANENT`](audit-log-reference.html#option_mysqld_audit-log)
...
* [`audit_log_buffer_size`](audit-log-reference.html#sysvar_audit_log_buffer_size)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_buffer_size"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`audit_log_compression`](audit-log-reference.html#sysvar_audit_log_compression)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_compression"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`audit_log_connection_policy`](audit-log-reference.html#sysvar_audit_log_connection_policy)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_connection_policy"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><p class="valid-value"><code class="literal">ALL</code></p><p class="valid-value"><code class="literal">ERRORS</code></p><p class="valid-value"><code class="literal">NONE</code></p></td>
  ...
  <table summary="Permitted values for the audit_log_connection_policy variable."><col style="width: 15%"/><col style="width: 85%"/><thead><tr>
<th>Value</th>
<th>Description</th>
</tr></thead><tbody><tr>
<td><code class="literal">ALL</code></td>
...
<td>Do not log connection events</td>
  ...
  [`audit_log_policy`](audit-log-reference.html#sysvar_audit_log_policy) is
...
* [`audit_log_current_session`](audit-log-reference.html#sysvar_audit_log_current_session)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_current_session"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>System Variable</th>
...
* [`audit_log_database`](audit-log-reference.html#sysvar_audit_log_database)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_database"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
* [`audit_log_disable`](audit-log-reference.html#sysvar_audit_log_disable)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_disable"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">OFF</code></td>
  ...
  [`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin) privilege. See
...
* [`audit_log_encryption`](audit-log-reference.html#sysvar_audit_log_encryption)
  ...
  <table frame="box" rules="all" summary="Properties for audit_log_encryption"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  If the value of
  [`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) is a
  ...
  [`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) value and
  ...
  [`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) value) as
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  case, enabling
  [`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) by
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  [Section 7.5.5, “Scheduler Component”](scheduler-component.html "7.5.5 Scheduler Component")). To check the
  ...
  `60` (1 to 59) are not acknowledged;
  instead, these values adjust to `60`
  automatically and the server emits a warning. Values
  greater than `60` define the number of
  seconds the `scheduler` component waits
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  see [Section 8.4.6.4, “Audit Log File Formats”](audit-log-file-formats.html "8.4.6.4 Audit Log File Formats").
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  [`audit_log_format_unix_timestamp`](audit-log-reference.html#sysvar_audit_log_format_unix_timestamp)
  requires the [`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin)
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  If you set
  [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) to a
  ...
  [`audit_log_rotate_on_size`](audit-log-reference.html#sysvar_audit_log_rotate_on_size)
  are greater than 0,
  [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) should
  ...
  Setting
  [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) by
...
* [`audit_log_password_history_keep_days`](audit-log-reference.html#sysvar_audit_log_password_history_keep_days)
...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  [Encrypting Audit Log Files](audit-log-logging-configuration.html#audit-log-file-encryption "Encrypting Audit Log Files")). The plugin
  ...
  + When the
    [`audit_log_encryption_password_set()`](audit-log-reference.html#function_audit-log-encryption-password-set)
...
<td><code class="literal">4096</code></td>
  ...
  [`audit_log_policy`](audit-log-reference.html#sysvar_audit_log_policy) can be
  ...
  [`audit_log_policy`](audit-log-reference.html#sysvar_audit_log_policy) at
...
<td><code class="literal">4096</code></td>
  ...
  bytes. The [`audit_log_read()`](audit-log-reference.html#function_audit-log-read)
  function reads no more than this many bytes. Log file
  reading is supported only for JSON log format. For more
  information, see [Section 8.4.6.6, “Reading Audit Log Files”](audit-log-file-reading.html "8.4.6.6 Reading Audit Log Files").
  ...
  [`audit_log_read()`](audit-log-reference.html#function_audit-log-read).
...
* [`Audit_log_direct_writes`](audit-log-reference.html#statvar_Audit_log_direct_writes)
...
* [`Audit_log_events_lost`](audit-log-reference.html#statvar_Audit_log_events_lost)
  ...
  to set
  [`audit_log_buffer_size`](audit-log-reference.html#sysvar_audit_log_buffer_size) to

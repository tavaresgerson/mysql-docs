...
In MySQL 9.5, you can extend log files in JSON
...
see [Section 8.4.5, “The MySQL Keyring”](keyring.html "8.4.5 The MySQL Keyring").
...
* If
  ...
  + To rotate the current file, use one of the following
    ...
    See [Manual Audit Log File Rotation](audit-log-logging-configuration.html#audit-log-manual-rotation "Manual Audit Log File Rotation"), for
    more information.
...
* For JSON-format log files: Enable log file pruning as
  described in [Audit Log File Pruning](audit-log-logging-configuration.html#audit-log-pruning "Audit Log File Pruning").
...
* [Manual Audit Log File Rotation](audit-log-logging-configuration.html#audit-log-manual-rotation "Manual Audit Log File Rotation")
* [Manual Audit Log File Rotation (Old Method)](audit-log-logging-configuration.html#audit-log-manual-rotation-old "Manual Audit Log File Rotation (Old Method)")
...
The [`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin) privilege is
required to use the
...
[Section 8.4.6.6, “Reading Audit Log Files”](audit-log-file-reading.html "8.4.6.6 Reading Audit Log Files")). Consider setting
[`audit_log_rotate_on_size`](audit-log-reference.html#sysvar_audit_log_rotate_on_size)

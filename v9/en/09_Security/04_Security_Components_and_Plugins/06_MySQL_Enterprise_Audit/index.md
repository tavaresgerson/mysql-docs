...
[Section 8.4.6.2, “Installing or Uninstalling MySQL Enterprise Audit”](audit-log-installation.html "8.4.6.2 Installing or Uninstalling MySQL Enterprise Audit")), it writes an audit log
...
contents, see [Section 8.4.6.4, “Audit Log File Formats”](audit-log-file-formats.html "8.4.6.4 Audit Log File Formats").

For more information about controlling how logging occurs,
including audit log file naming and format selection, see
[Section 8.4.6.5, “Configuring Audit Logging Characteristics”](audit-log-logging-configuration.html "8.4.6.5 Configuring Audit Logging Characteristics"). To perform
filtering of audited events, see
[Section 8.4.6.7, “Audit Log Filtering”](audit-log-filtering.html "8.4.6.7 Audit Log Filtering"). For descriptions of the

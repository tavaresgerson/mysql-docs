...
[Section 8.4.6.10, “Legacy Mode Audit Log Filtering”](audit-log-legacy-filtering.html "8.4.6.10 Legacy Mode Audit Log Filtering"). Legacy mode
...
* Audit log filters can be defined and modified using an SQL
  ...
  table instead. See
  [Section 8.4.6.2, “Installing or Uninstalling MySQL Enterprise Audit”](audit-log-installation.html "8.4.6.2 Installing or Uninstalling MySQL Enterprise Audit"), for more
  information.
...
* [`audit_log_filter_remove_filter()`](audit-log-reference.html#function_audit-log-filter-remove-filter):
  Remove a filter.

* [`audit_log_filter_set_user()`](audit-log-reference.html#function_audit-log-filter-set-user):
  Start filtering a user account.

* [`audit_log_filter_remove_user()`](audit-log-reference.html#function_audit-log-filter-remove-user):
...
functions, see
[Using Audit Log Filtering Functions](audit-log-filtering.html#audit-log-filtering-function-usage "Using Audit Log Filtering Functions"), and
...
* To use any filtering function, a user must possess the
  ...
  [`SUPER`](privileges-provided.html#priv_super) privilege or an error
  ...
  [`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin) or
  [`SUPER`](privileges-provided.html#priv_super) privilege while still
  ...
  functions in [Using General-Purpose Keyring Functions](keyring-functions-general-purpose.html#keyring-function-usage "Using General-Purpose Keyring Functions"); it
...
[Section 8.4.6.2, “Installing or Uninstalling MySQL Enterprise Audit”](audit-log-installation.html "8.4.6.2 Installing or Uninstalling MySQL Enterprise Audit"). The
[`AUDIT_ADMIN`](privileges-provided.html#priv_audit-admin) or
[`SUPER`](privileges-provided.html#priv_super) privilege is required to
...
[Section 13.5, “The JSON Data Type”](json.html "13.5 The JSON Data Type"). This section shows some simple filter
definitions. For more information about filter definitions,
see [Section 8.4.6.8, “Writing Audit Log Filter Definitions”](audit-log-filter-definitions.html "8.4.6.8 Writing Audit Log Filter Definitions").
...
[mysql\_change\_user()](/doc/c-api/9.5/en/mysql-change-user.html)), filter assignment for
...
and user accounts (see [Audit Log Tables](audit-log-reference.html#audit-log-tables "Audit Log Tables")). It
is also possible to modify the audit log tables directly using
statements such as [`INSERT`](insert.html "15.2.7 INSERT Statement"),
[`UPDATE`](update.html "15.2.17 UPDATE Statement"), and
[`DELETE`](delete.html "15.2.2 DELETE Statement"), but such changes do not

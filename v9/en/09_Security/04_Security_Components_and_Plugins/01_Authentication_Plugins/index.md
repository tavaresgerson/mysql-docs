...
If you are looking for information about the `authentication_oci` plugin, it is MySQL HeatWave Service only. See authentication\_oci plugin, in the *MySQL HeatWave Service* manual.

...
<table summary="Names for the plugins and library file used for cleartext password authentication."><col style="width: 30%"/><col style="width: 70%"/><thead><tr>
...
[Section 8.4.1.4, “PAM Pluggable Authentication”](pam-pluggable-authentication.html "8.4.1.4 PAM Pluggable Authentication"), and
...
[Section 8.3, “Using Encrypted Connections”](encrypted-connections.html "8.3 Using Encrypted Connections")), IPsec, or a private
network.
...
* The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program"),
  ...
  [**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information"), and
  [**mysqlslap**](mysqlslap.html "6.5.7 mysqlslap — A Load Emulation Client") client programs support an
  `--enable-cleartext-plugin` option that
  enables the plugin on a per-invocation basis.

* The [`mysql_options()`](/doc/c-api/9.5/en/mysql-options.html) C API
  function supports a

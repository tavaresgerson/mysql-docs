...
This section describes how to install or uninstall MySQL Enterprise Data Masking, which
...
[Section 7.6.1, “Installing and Uninstalling Plugins”](plugin-loading.html "7.6.1 Installing and Uninstalling Plugins"), and
...
To install the MySQL Enterprise Data Masking plugin and functions, use the
[`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") and
[`CREATE FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") statements,

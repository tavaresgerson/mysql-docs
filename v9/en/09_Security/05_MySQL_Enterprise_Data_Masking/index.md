...
MySQL Enterprise Data Masking provides the following data masking and de-identification
capabilities:
...
MySQL Enterprise Data Masking was implemented originally in MySQL as a plugin library. As
of MySQL 9.5, MySQL Enterprise Edition also provides components to
access data masking and de-identification capabilities. For
information about the similarities and differences, see
[Table 8.46, “Comparison Between Data-Masking Components and Plugin Elements”](data-masking-components-vs-plugin.html#data-masking-component-vs-plugin "Table 8.46 Comparison Between Data-Masking Components and Plugin Elements").

If you are using MySQL Enterprise Data Masking for the first time, consider installing
...
MySQL Enterprise Data Masking can help application developers satisfy privacy requirements:
...
The following sections describe the elements of MySQL Enterprise Data Masking, discuss how
to install and use it, and provide reference information for its
elements.
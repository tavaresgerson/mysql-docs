...
Before using MySQL Enterprise Data Masking, install it according to the instructions
provided at
...
To use MySQL Enterprise Data Masking in applications, invoke the functions that are
appropriate for the operations you wish to perform. For detailed
function descriptions, see
[Section 8.5.2.4, “MySQL Enterprise Data Masking Component Function Descriptions”](data-masking-component-functions.html "8.5.2.4 MySQL Enterprise Data Masking Component Function Descriptions"). This section
...
* [Masking Data to Remove Identifying Characteristics](data-masking-component-usage.html#data-masking-component-usage-masking-functions "Masking Data to Remove Identifying Characteristics")
* [Generating Random Data with Specific Characteristics](data-masking-component-usage.html#data-masking-component-usage-generation-functions "Generating Random Data with Specific Characteristics")
* [Generating Random Data Using Dictionaries](data-masking-component-usage.html#data-masking-component-usage-dictionary-functions "Generating Random Data Using Dictionaries")
* [Using Masked Data for Customer Identification](data-masking-component-usage.html#data-masking-component-usage-customer-identification "Using Masked Data for Customer Identification")
* [Creating Views that Display Masked Data](data-masking-component-usage.html#data-masking-component-usage-views "Creating Views that Display Masked Data")
...
[`mask_inner()`](data-masking-component-functions.html#function_mask-inner) and
[`mask_outer()`](data-masking-component-functions.html#function_mask-outer) are
...
* [`mask_inner()`](data-masking-component-functions.html#function_mask-inner) masks the
...
* [`mask_outer()`](data-masking-component-functions.html#function_mask-outer) does the
...
By default, [`mask_inner()`](data-masking-component-functions.html#function_mask-inner) and
[`mask_outer()`](data-masking-component-functions.html#function_mask-outer) use
...
* [`mask_pan()`](data-masking-component-functions.html#function_mask-pan) masks all but
...
* [`mask_pan_relaxed()`](data-masking-component-functions.html#function_mask-pan-relaxed) is
...
[`mask_iban()`](data-masking-component-functions.html#function_mask-iban) masks all but the
...
[`mask_uuid()`](data-masking-component-functions.html#function_mask-uuid) masks all
...
[`mask_ssn()`](data-masking-component-functions.html#function_mask-ssn) masks all but the
...
[`mask_canada_sin()`](data-masking-component-functions.html#function_mask-canada-sin) masks
...
[`mask_uk_nin()`](data-masking-component-functions.html#function_mask-uk-nin) masks all but
...
[`gen_range()`](data-masking-component-functions.html#function_gen-range) returns a random
...
[`gen_rnd_canada_sin()`](data-masking-component-functions.html#function_gen-rnd-canada-sin) returns a
random Canadian Social Insurance Number (SIN).

Because it cannot be guaranteed that the number generated has
not been assigned, the result of
[`gen_rnd_canada_sin()`](data-masking-component-functions.html#function_gen-rnd-canada-sin) should
never be displayed (except possibly in testing). For display
in user-facing applications, always employ a masking function
such as [`mask_canada_sin()`](data-masking-component-functions.html#function_mask-canada-sin), as
shown here:
...
[`gen_rnd_email()`](data-masking-component-functions.html#function_gen-rnd-email) returns a
...
[`gen_rnd_iban()`](data-masking-component-functions.html#function_gen-rnd-iban) returns a number
...
[`gen_rnd_pan()`](data-masking-component-functions.html#function_gen-rnd-pan) returns a random
...
[`gen_rnd_pan()`](data-masking-component-functions.html#function_gen-rnd-pan) should never be
...
[`mask_pan_relaxed()`](data-masking-component-functions.html#function_mask-pan-relaxed). We show
such use of the latter function with
[`gen_rnd_pan()`](data-masking-component-functions.html#function_gen-rnd-pan) here:
...
[`gen_rnd_ssn()`](data-masking-component-functions.html#function_gen-rnd-ssn) returns a random
...
[`gen_rnd_uk_nin()`](data-masking-component-functions.html#function_gen-rnd-uk-nin) returns a
random UK National Insurance Number (NIN).

Because it cannot be guaranteed that the number generated has
not been assigned, the result of
[`gen_rnd_uk_nin()`](data-masking-component-functions.html#function_gen-rnd-uk-nin) should never
be displayed (except possibly in testing). For display in
user-facing applications, always employ a masking function
such as [`mask_uk_nin()`](data-masking-component-functions.html#function_mask-uk-nin), as shown
here:
...
[`gen_rnd_us_phone()`](data-masking-component-functions.html#function_gen-rnd-us-phone) returns a
...
[`gen_rnd_uuid()`](data-masking-component-functions.html#function_gen-rnd-uuid) returns a number
...
MySQL Enterprise Data Masking enables dictionaries to be used as sources of random
...
The [`gen_blocklist()`](data-masking-component-functions.html#function_gen-blocklist) function
...
[`gen_blocklist()`](data-masking-component-functions.html#function_gen-blocklist) like this:
...
[`gen_blocklist()`](data-masking-component-functions.html#function_gen-blocklist) returns it
unchanged:
...
[`mask_ssn()`](data-masking-component-functions.html#function_mask-ssn)? Because
[`mask_ssn()`](data-masking-component-functions.html#function_mask-ssn) requires an argument

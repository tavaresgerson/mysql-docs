...
[Section 7.5.2, “Obtaining Component Information”](obtaining-component-information.html "7.5.2 Obtaining Component Information"). For general
...
* [Install Using the mysql System Schema](data-masking-components-installation.html#data-masking-components-installation-mysql "Install Using the mysql System Schema")
...
* [Uninstall MySQL Enterprise Data Masking Components](data-masking-components-installation.html#data-masking-components-uninstall "Uninstall MySQL Enterprise Data Masking Components")
...
1. Run `masking_functions_install.sql` to
   add the `masking_dictionaries` table to
   the `mysql` schema and install the
...
1. Create a database to store the
   `masking_dictionaries` table. For
   example, to use `mask_db` as the database
...
2. Run `masking_functions_install.sql` to
   add the `masking_dictionaries` table to
   the `mask_db` schema and install the
   components. The script is located in the
   `share` directory of your MySQL
   installation.
...
3. Set and persist the `mask_db` schema at
...
1. Run `masking_functions_uninstall.sql`
   to remove the `masking_dictionaries`
...
3. [Optional] Drop the dedicated schema to ensure that it is

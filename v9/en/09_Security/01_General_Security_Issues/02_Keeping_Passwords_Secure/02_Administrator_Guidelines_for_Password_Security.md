...
See [Section 8.2.15, “Password Management”](password-management.html "8.2.15 Password Management"), and
...
of the [`plugin_dir`](server-system-variables.html#sysvar_plugin_dir) system
...
should be protected. See [Section 8.1.2.3, “Passwords and Logging”](password-logging.html "8.1.2.3 Passwords and Logging").
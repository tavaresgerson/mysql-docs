...
[Section 8.4.6.3, “MySQL Enterprise Audit Security Considerations”](audit-log-security.html "8.4.6.3 MySQL Enterprise Audit Security Considerations").

Statements received by the server may be rewritten if a query
rewrite plugin is installed (see
[Query Rewrite Plugins](/doc/extending-mysql/9.5/en/plugin-types.html#query-rewrite-plugin-type)). In this case, the
...
[`START REPLICA`](start-replica.html "15.4.2.4 START REPLICA Statement") or

...
* Use the [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") utility,
...
* Store your password in an option file. For example, on Unix,
  ...
  [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files"), discusses option files in
  more detail.

On Unix, the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client writes a record of
executed statements to a history file (see
[Section 6.5.1.3, “mysql Client Logging”](mysql-logging.html "6.5.1.3 mysql Client Logging")). By default, this file is named
...
and [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement"), so if you use

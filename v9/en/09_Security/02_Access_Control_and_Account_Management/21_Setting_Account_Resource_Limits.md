...
([`ER_TOO_MANY_USER_CONNECTIONS`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_too_many_user_connections) or
[`ER_USER_LIMIT_REACHED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_user_limit_reached)) if the

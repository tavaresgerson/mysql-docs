...
* When used with [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement"),
...
* When used with [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement"),
  ...
  [`ALTER USER ...
  UNLOCK`](alter-user.html "15.7.1.1 ALTER USER Statement") unlocks any account named by the statement
...
[`SHOW CREATE USER`](show-create-user.html "15.7.7.14 SHOW CREATE USER Statement") indicates whether
...
[`Locked_connects`](server-status-variables.html#statvar_Locked_connects) status variable
that indicates the number of attempts to connect to a locked
account, returns an
[`ER_ACCOUNT_HAS_BEEN_LOCKED`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_account_has_been_locked) error,
...
[Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL"). For nonupgraded installations that

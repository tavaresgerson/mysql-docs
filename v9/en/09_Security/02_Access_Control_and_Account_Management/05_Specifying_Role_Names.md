...
privileges. For role usage examples, see [Section 8.2.10, “Using Roles”](roles.html "8.2.10 Using Roles").

Role names have syntax and semantics similar to account names; see
[Section 8.2.4, “Specifying Account Names”](account-names.html "8.2.4 Specifying Account Names"). As stored in the grant tables,
...
* An account name is permitted to be
  [`CURRENT_USER()`](information-functions.html#function_current-user) in several

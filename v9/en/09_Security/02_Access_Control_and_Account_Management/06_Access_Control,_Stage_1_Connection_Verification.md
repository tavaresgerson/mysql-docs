...
traveling over the connection. See [Section 8.2.1, “Account User Names and Passwords”](user-names.html "8.2.1 Account User Names and Passwords").
...
`localhost` is deprecated; you should expect this
...
[Section 14.15, “Information Functions”](information-functions.html "14.15 Information Functions").) It returns a value in
`user_name@host_name`

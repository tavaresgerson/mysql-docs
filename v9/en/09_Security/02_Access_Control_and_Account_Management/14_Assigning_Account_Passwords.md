...
[`CREATE USER`](privileges-provided.html#priv_create-user) privilege, or,
alternatively, privileges for the `mysql`
database ([`INSERT`](privileges-provided.html#priv_insert) privilege to
create new accounts, [`UPDATE`](privileges-provided.html#priv_update)
...
[`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") additionally requires
the [`CONNECTION_ADMIN`](privileges-provided.html#priv_connection-admin) privilege (or
...
possibilities, see [Section 15.7.1.3, “CREATE USER Statement”](create-user.html "15.7.1.3 CREATE USER Statement"),
[Section 15.7.1.1, “ALTER USER Statement”](alter-user.html "15.7.1.1 ALTER USER Statement"), and [Section 15.7.1.10, “SET PASSWORD Statement”](set-password.html "15.7.1.10 SET PASSWORD Statement").

MySQL uses plugins to perform client authentication; see
[Section 8.2.17, “Pluggable Authentication”](pluggable-authentication.html "8.2.17 Pluggable Authentication"). In password-assigning
...
USER`](create-user.html "15.7.1.3 CREATE USER Statement") and [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") that
...
[`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") and include an
...
[`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") also supports syntax
...
[**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command:
...
Setting a password using [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") should be
...
If you are using MySQL Replication, be aware that a password used
by a replica as part of [`CHANGE REPLICATION
SOURCE TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") is effectively limited to 32 characters in
length; if the password is longer, any excess characters are
truncated. This is not due to any limit imposed by MySQL Server

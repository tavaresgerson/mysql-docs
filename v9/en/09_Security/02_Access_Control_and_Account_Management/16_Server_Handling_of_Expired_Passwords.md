...
[`ER_MUST_CHANGE_PASSWORD_LOGIN`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_must_change_password_login)
error:
...
returns an [`ER_MUST_CHANGE_PASSWORD`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_must_change_password)
error:
...
* Pass the
  ...
  to [`mysql_options()`](/doc/c-api/9.5/en/mysql-options.html) prior to
  connecting:

...
initialization (see
[Section 2.9.1, “Initializing the Data Directory”](data-directory-initialization.html "2.9.1 Initializing the Data Directory")). During data
...
* `'mysql.sys'@'localhost'`: Used as the
  `DEFINER` for
  [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema objects. Use of the
...
* `'mysql.infoschema'@'localhost'`: Used as the
  `DEFINER` for
  [`INFORMATION_SCHEMA`](information-schema.html "Chapter 28 INFORMATION_SCHEMA Tables") views. Use of

...
* Each execution of the statements contained in the body of an
  ...
  [`SHOW STATUS`](show-status.html "15.7.7.38 SHOW STATUS Statement"). However, such
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") storage engine, you must keep
...
[`CREATE TRIGGER`](create-trigger.html "15.1.26 CREATE TRIGGER Statement") statements on each
...
database tables to use the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5")

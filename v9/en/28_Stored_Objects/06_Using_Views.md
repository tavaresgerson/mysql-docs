...
* For answers to some commonly asked questions regarding views in MySQL, see Section A.6, “MySQL 9.5 FAQ: Views”.
...
* Query the `VIEWS` table of the `INFORMATION_SCHEMA` database. See Section 28.3.53, “The INFORMATION\_SCHEMA VIEWS Table”.

* Use the `SHOW CREATE VIEW` statement. See Section 15.7.7.15, “SHOW CREATE VIEW Statement”.

...
You can use [`DROP TABLE`](drop-table.html "15.1.37 DROP TABLE Statement") or
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") to drop or alter a
...
cannot call [`SHOW CREATE VIEW`](show-create-view.html "15.7.7.15 SHOW CREATE VIEW Statement") on
...
[`SHOW CREATE VIEW`](show-create-view.html "15.7.7.15 SHOW CREATE VIEW Statement") displays view
...
column names in [`CREATE VIEW`](create-view.html "15.1.27 CREATE VIEW Statement")
...
CREATE VIEW`](show-create-view.html "15.7.7.15 SHOW CREATE VIEW Statement") fail if any column alias exceeds 64
...
VIEW`](drop-view.html "15.1.40 DROP VIEW Statement") and [`CREATE VIEW`](create-view.html "15.1.27 CREATE VIEW Statement"), or
replace the definition with
[`CREATE OR REPLACE
VIEW`](create-view.html "15.1.27 CREATE VIEW Statement").
...
[`CREATE VIEW`](create-view.html "15.1.27 CREATE VIEW Statement") statements. However,

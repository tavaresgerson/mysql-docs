...
using the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 9.5") API.
...
* For answers to commonly asked questions regarding triggers in
  MySQL, see [Section A.5, “MySQL 9.5 FAQ: Triggers”](faqs-triggers.html "A.5 MySQL 9.5 FAQ: Triggers").

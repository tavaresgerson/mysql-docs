...
* [LLM Constructor](srjsapi-llm.html#srjs-llm-constructor "LLM Constructor")
* [LLM.unload()](srjsapi-llm.html#srjsapi-llm-unload "LLM.unload()")
* [LLM.generate()](srjsapi-llm.html#srjsapi-llm-generate "LLM.generate()")
* [LLM.embed()](srjsapi-llm.html#srjsapi-llm-embed "LLM.embed()")
* [LLM.rag()](srjsapi-llm.html#srjsapi-llm-rag "LLM.rag()")

This class represents a large language model. Members accessible
from instances of this class are listed here:
...
`LLM` provides methods for creating
embeddings, generating responses, and performing Retrieval
Augmented Generation. The API also provides convenience
methods; see [Section 27.3.10.8, “Convenience Methods”](srjsapi-convenience-methods.html "27.3.10.8 Convenience Methods").
Both versions of these methods support variants of the methods
for performing single jobs and batch processing.

##### LLM.unload()

Unloads the model that was loaded in the constructor. This is
optional, but recommended, since doing so can reduce memory
usage; after unloading, any subsequent attempt to use the
...
[`ML_GENERATE`](/doc/heatwave/en/mys-hwgenai-ml-generate.html), and generates a
...
[`ML_EMBED_ROW`](/doc/heatwave/en/mys-hwgenai-ml-embed-row.html), and generates an
embedding whose type corresponds to the MySQL
[`VECTOR`](vector.html "13.3.5 The VECTOR Type") type. It supports two
...
for [`ML_RAG`](/doc/heatwave/en/mys-hwgenai-ml-rag.html). It supports two
variants, one for a single invocation, and one for batch
processing; both of these are described in the next few
paragraphs.

...
PROCEDURE`](create-procedure.html "15.1.21 CREATE PROCEDURE and CREATE FUNCTION Statements") and [`CREATE
FUNCTION`](create-function.html "15.1.16 CREATE FUNCTION Statement") statements (see
[Section 15.1.21, “CREATE PROCEDURE and CREATE FUNCTION Statements”](create-procedure.html "15.1.21 CREATE PROCEDURE and CREATE FUNCTION Statements")). A procedure is invoked using
...
PROCEDURE`](drop-procedure.html "15.1.34 DROP PROCEDURE and DROP FUNCTION Statements") and [`DROP
FUNCTION`](drop-function.html "15.1.30 DROP FUNCTION Statement") statements (see
[Section 15.1.34, “DROP PROCEDURE and DROP FUNCTION Statements”](drop-procedure.html "15.1.34 DROP PROCEDURE and DROP FUNCTION Statements")), and altered with the
[`ALTER PROCEDURE`](alter-procedure.html "15.1.9 ALTER PROCEDURE Statement") and
...
function. See [mysql\_real\_connect()](/doc/c-api/9.5/en/mysql-real-connect.html), and

...
of [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement"), as shown in
...
* `ON`: The Event Scheduler is started; the
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") as a daemon
...
* `OFF`: The Event Scheduler is stopped. The
  ...
  output of [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement"), and
...
* `DISABLED`: This value renders the Event
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement")). In addition,
...
VARIABLES`](show-variables.html "15.7.7.42 SHOW VARIABLES Statement") is always one of `OFF`,
`ON`, or `DISABLED`.
...
been defined on the server. See [Section 27.5.4, “Event Metadata”](events-metadata.html "27.5.4 Event Metadata"),
...
system, see [Section 27.5.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "27.5.6 The Event Scheduler and MySQL Privileges").
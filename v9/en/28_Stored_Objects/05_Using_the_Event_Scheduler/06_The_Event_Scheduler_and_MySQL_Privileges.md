...
be bestowed using [`GRANT`](grant.html "15.7.1.6 GRANT Statement"). For
example, this [`GRANT`](grant.html "15.7.1.6 GRANT Statement") statement
...
[`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table shows that
...
the [`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement") statement. In this
...
Schema [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table before and after
issuing a [`DROP USER`](drop-user.html "15.7.1.5 DROP USER Statement") or
[`RENAME USER`](rename-user.html "15.7.1.7 RENAME USER Statement") statement.
...
[`GRANT`](grant.html "15.7.1.6 GRANT Statement") creates a row in
...
EVENT`](grant.html "15.7.1.6 GRANT Statement") and `REVOKE EVENT` statements
...
see [Section 27.10, “Restrictions on Stored Programs”](stored-program-restrictions.html "27.10 Restrictions on Stored Programs")). These are:

* `Com_create_event`: The number of
  [`CREATE EVENT`](create-event.html "15.1.15 CREATE EVENT Statement") statements
  executed since the last server restart.

* `Com_alter_event`: The number of
  [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statements executed
  since the last server restart.

* `Com_drop_event`: The number of
  [`DROP EVENT`](drop-event.html "15.1.29 DROP EVENT Statement") statements executed
  since the last server restart.

* `Com_show_create_event`: The number of
  [`SHOW CREATE EVENT`](show-create-event.html "15.7.7.8 SHOW CREATE EVENT Statement") statements
  executed since the last server restart.

* `Com_show_events`: The number of
  [`SHOW EVENTS`](show-events.html "15.7.7.20 SHOW EVENTS Statement") statements executed
  since the last server restart.

...
the type discussed in [Section 27.4, “Using Triggers”](triggers.html "27.4 Using Triggers"). Events should
...
* Users can create, modify, and drop scheduled events using SQL
  ...
  fails. See [Section 27.5.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "27.5.6 The Event Scheduler and MySQL Privileges") for details.

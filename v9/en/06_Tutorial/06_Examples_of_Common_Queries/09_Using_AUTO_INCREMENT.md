...
To start with an `AUTO_INCREMENT` value other than 1, set that value with [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") or `ALTER TABLE`, like this:

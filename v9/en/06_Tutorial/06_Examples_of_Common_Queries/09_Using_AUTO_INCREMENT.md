...
[`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) SQL function or
the [`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html) C API
...
[`TINYINT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), the maximum permissible
sequence number is 127. For
[`TINYINT
UNSIGNED`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), the maximum is 255. See
[Section 13.1.2, “Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT,
MEDIUMINT, BIGINT”](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") for the ranges of all the
integer types.
...
[`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html) actually
...
* For `MyISAM` tables, you can specify
  ...
  + 1 WHERE
  prefix=given-prefix`](aggregate-functions.html#function_max).
...
* How to assign the `AUTO_INCREMENT`
  attribute to a column: [Section 15.1.24, “CREATE TABLE Statement”](create-table.html "15.1.24 CREATE TABLE Statement"), and
...
* How `AUTO_INCREMENT` behaves depending on
  ...
  SQL mode: [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").

* How to use the
  [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) function
...
* Setting the `AUTO_INCREMENT` value to be
  used: [Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables").

...
TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement for the `event`
...
<table summary="pet record data that appears in a tab delimited text file, as described in the preceding text."><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 35%"/><thead><tr>

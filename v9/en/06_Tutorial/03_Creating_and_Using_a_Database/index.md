...
Zip formats at [https://dev.mysql.com/doc/](/doc/).

Use the [`SHOW`](show.html "15.7.7 SHOW Statements") statement to find out
...
on your machine; [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement")
does not show databases that you have no privileges for if you do
not have the [`SHOW DATABASES`](show-databases.html "15.7.7.16 SHOW DATABASES Statement")
privilege. See [Section 15.7.7.16, “SHOW DATABASES Statement”](show-databases.html "15.7.7.16 SHOW DATABASES Statement").

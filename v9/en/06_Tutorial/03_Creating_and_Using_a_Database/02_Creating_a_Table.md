...
empty, as [`SHOW TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") tells you:
...
Use a [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement to
...
[`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") is a good choice for the
`name`, `owner`, and
...
The use of the [`DATE`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") data type for
the `birth` and `death`
columns is a fairly obvious choice.

Once you have created a table, [`SHOW
TABLES`](show-tables.html "15.7.7.40 SHOW TABLES Statement") should produce some output:
...
a [`DESCRIBE`](describe.html "15.8.1 DESCRIBE Statement") statement:
...
You can use [`DESCRIBE`](describe.html "15.8.1 DESCRIBE Statement") any time,

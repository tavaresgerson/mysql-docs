...
collation. The [`CREATE DATABASE`](create-database.html "15.1.14 CREATE DATABASE Statement")
...
* For [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statements,

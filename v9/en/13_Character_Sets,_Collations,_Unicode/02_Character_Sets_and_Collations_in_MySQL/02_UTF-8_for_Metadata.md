...
[`SHOW`](show.html "15.7.7 SHOW Statements") are metadata. This is also
...
* All metadata must be in the same character set. Otherwise,
  neither the [`SHOW`](show.html "15.7.7 SHOW Statements") statements
  nor [`SELECT`](select.html "15.2.13 SELECT Statement") statements for
...
of [`DESCRIBE`](describe.html "15.8.1 DESCRIBE Statement") functions in the
...
[`SET NAMES`](set-names.html "15.7.6.3 SET NAMES Statement") statement to force the
server to perform character set conversion.
[`SET NAMES`](set-names.html "15.7.6.3 SET NAMES Statement") sets the
[`character_set_results`](server-system-variables.html#sysvar_character_set_results) and other
related system variables. (See
[Section 12.4, “Connection Character Sets and Collations”](charset-connection.html "12.4 Connection Character Sets and Collations").) Alternatively, a client

...
and [**mysqlshow**](mysqlshow.html "6.5.6 mysqlshow — Display Database, Table, and Column Information") client programs determine the
...
* Each client can autodetect which character set to use based
  ...
  [`mysql_options()`](/doc/c-api/9.5/en/mysql-options.html) as follows

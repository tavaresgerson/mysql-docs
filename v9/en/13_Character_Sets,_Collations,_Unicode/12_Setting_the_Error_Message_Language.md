...
By default, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") produces error messages in
...
language), see [Section 12.6, “Error Message Character Set”](charset-errors.html "12.6 Error Message Character Set"). For general
...
* It looks for the file in a directory constructed from two
  ...
  In this case, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") maps the locale

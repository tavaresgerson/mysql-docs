...
MySQL 9.5 server issues a warning for any use of
`COLLATE
...
The [`WEIGHT_STRING()`](string-functions.html#function_weight-string) function can be
...
[Section 12.14.1, “Collation Implementation Types”](charset-collation-implementations.html "12.14.1 Collation Implementation Types"). Some of these
...
[Section 12.13, “Adding a Character Set”](adding-character-set.html "12.13 Adding a Character Set"). However, instead of adding

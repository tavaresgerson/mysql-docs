...
* For the variable-length character data types
  ...
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") types), the maximum
...
TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement"). Suppose that a table has this definition:
...
[`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") data types, watch for these
...
* A [`TINYTEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column can hold up
  to 255 bytes, so it can hold up to 85 3-byte or 63 4-byte
  characters. Suppose that you have a
  [`TINYTEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column that uses
  ...
  [`VARCHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") column may need to be
  changed to one of the longer
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") types if you want to
...
* `InnoDB` has a maximum index length of 767
  ...
  prefixes](glossary.html#glos_index_prefix "index prefix") longer than 767 bytes (up to 3072 bytes)
  ...
  related information, see [Section 17.21, “InnoDB Limits”](innodb-limits.html "17.21 InnoDB Limits"),
  and [DYNAMIC Row Format](innodb-row-format.html#innodb-row-format-dynamic "DYNAMIC Row Format").
...
problems, using [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") as
...
* For object definitions that refer to the
  ...
  with [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") prior to downgrading, edit

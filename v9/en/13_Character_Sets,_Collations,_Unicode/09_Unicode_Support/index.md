...
* `utf8mb3`: A UTF-8 encoding of the Unicode
  ...
  character set is deprecated andsubject to removal in a future
  release; use `utf8mb4` instead.
...
* `utf8`: A deprecated alias for
  ...
  `utf8` is expected in a future version of
  MySQL to become an alias for `utf8mb4`.
...
reference to `utf8mb4`. MySQL 9.5
...
[Table 12.2, “Unicode Character Set General Characteristics”](charset-unicode.html#charset-unicode-charset-characteristics "Table 12.2 Unicode Character Set General Characteristics"),
...
applications; see [Section 12.9.8, “Converting Between 3-Byte and 4-Byte Unicode Character Sets”](charset-unicode-conversion.html "12.9.8 Converting Between 3-Byte and 4-Byte Unicode Character Sets").
...
characters, see [Section 12.10.1, “Unicode Character Sets”](charset-unicode-sets.html "12.10.1 Unicode Character Sets").

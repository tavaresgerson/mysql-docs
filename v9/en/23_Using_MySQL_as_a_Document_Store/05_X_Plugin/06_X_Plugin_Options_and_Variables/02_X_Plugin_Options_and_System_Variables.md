...
<td><p class="valid-value"><code class="literal">ON</code></p><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p><p class="valid-value"><code class="literal">FORCE_PLUS_PERMANENT</code></p></td>
  ...
  startup. In MySQL 9.5, X Plugin is enabled by
...
<td><code class="literal">*</code></td>
  ...
  [`mysqlx_bind_address`](x-plugin-options-system-variables.html#sysvar_mysqlx_bind_address) is
  ...
  + A single address value, which may specify a single
    ...
    name, or one of the wildcard address formats that permit
    listening on multiple network interfaces
    (`*`, `0.0.0.0`, or
    `::`).

  + A list of comma-separated values. When the variable
    names a list of multiple values, each value must specify
    a single non-wildcard IP address (either IPv4 or IPv6)
    or a host name. Wildcard address formats
    (`*`, `0.0.0.0`, or
    `::`) are not allowed in a list of
    values.

  + The value may also include a network namespace
    specifier.
  ...
  does for [`bind_address`](server-system-variables.html#sysvar_bind_address)
  ...
  [`Mysqlx_address`](x-plugin-status-variables.html#statvar_Mysqlx_address) status
  ...
  [`ER_XPLUGIN_FAILED_TO_PREPARE_IO_INTERFACES`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_xplugin_failed_to_prepare_io_interfaces)
...
* [`mysqlx_compression_algorithms`](x-plugin-options-system-variables.html#sysvar_mysqlx_compression_algorithms)

  <table frame="box" rules="all" summary="Properties for mysqlx_compression_algorithms"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--mysqlx-compression-algorithms=value</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_compression_algorithms">mysqlx_compression_algorithms</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_connect_timeout">mysqlx_connect_timeout</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`mysqlx_deflate_default_compression_level`](x-plugin-options-system-variables.html#sysvar_mysqlx_deflate_default_compression_level)

  <table frame="box" rules="all" summary="Properties for mysqlx_deflate_default_compression_level"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--mysqlx_deflate_default_compression_level=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_deflate_default_compression_level">mysqlx_deflate_default_compression_level</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td><code class="literal">9</code></td>
  ...
  see [Section 22.5.5, “Connection Compression with X Plugin”](x-plugin-connection-compression.html "22.5.5 Connection Compression with X Plugin").

* [`mysqlx_deflate_max_client_compression_level`](x-plugin-options-system-variables.html#sysvar_mysqlx_deflate_max_client_compression_level)

  <table frame="box" rules="all" summary="Properties for mysqlx_deflate_max_client_compression_level"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--mysqlx_deflate_max_client_compression_level=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_deflate_max_client_compression_level">mysqlx_deflate_max_client_compression_level</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`mysqlx_document_id_unique_prefix`](x-plugin-options-system-variables.html#sysvar_mysqlx_document_id_unique_prefix)

  <table frame="box" rules="all" summary="Properties for mysqlx_document_id_unique_prefix"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal">65535</code></td>
  ...
  [Understanding Document IDs](/doc/x-devapi-userguide/en/understanding-automatic-document-ids.html).

* [`mysqlx_enable_hello_notice`](x-plugin-options-system-variables.html#sysvar_mysqlx_enable_hello_notice)

  <table frame="box" rules="all" summary="Properties for mysqlx_enable_hello_notice"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_idle_worker_thread_timeout">mysqlx_idle_worker_thread_timeout</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
* [`mysqlx_interactive_timeout`](x-plugin-options-system-variables.html#sysvar_mysqlx_interactive_timeout)

  <table frame="box" rules="all" summary="Properties for mysqlx_interactive_timeout"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code class="literal">--mysqlx-interactive-timeout=#</code></td>
</tr><tr><th>System Variable</th>
<td><code class="literal"><a class="link" href="x-plugin-options-system-variables.html#sysvar_mysqlx_interactive_timeout">mysqlx_interactive_timeout</a></code></td>
</tr><tr><th>Scope</th>
<td>Global</td>
</tr><tr><th>Dynamic</th>
<td>Yes</td>
...
<td>seconds</td>
  ...
  [`mysqlx_wait_timeout`](x-plugin-options-system-variables.html#sysvar_mysqlx_wait_timeout) session
...
* [`mysqlx_read_timeout`](x-plugin-options-system-variables.html#sysvar_mysqlx_read_timeout)
...
<td><code class="literal">*</code></td>
  ...
  [Section 6.9, “Environment Variables”](environment-variables.html "6.9 Environment Variables")). If you set this
...
* [`mysqlx_wait_timeout`](x-plugin-options-system-variables.html#sysvar_mysqlx_wait_timeout)
...
* [`mysqlx_write_timeout`](x-plugin-options-system-variables.html#sysvar_mysqlx_write_timeout)
...
* [`mysqlx_zstd_default_compression_level`](x-plugin-options-system-variables.html#sysvar_mysqlx_zstd_default_compression_level)
...
* [`mysqlx_zstd_max_client_compression_level`](x-plugin-options-system-variables.html#sysvar_mysqlx_zstd_max_client_compression_level)

...
* See [CollectionRemoveFunction](/doc/x-devapi-userguide/en/crud-ebnf-collection-crud-functions.html#crud-ebnf-collectionremovefunction)
  for the full syntax definition.

* See [Section 22.4.2, “Download and Import world\_x Database”](mysql-shell-tutorial-python-download.html "22.4.2 Download and Import world_x Database")

...
automatically set an `_id` value. MySQL sets
an `_id` value if the document does not
contain the `_id` field. For more
information, see
[Understanding Document IDs](/doc/x-devapi-userguide/en/understanding-automatic-document-ids.html).

##### Related Information

* See [CollectionAddFunction](/doc/x-devapi-userguide/en/crud-ebnf-collection-crud-functions.html#crud-ebnf-collectionaddfunction) for

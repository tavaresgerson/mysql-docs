...
[`port`](server-system-variables.html#sysvar_port) of 3306 instead of the
[`mysqlx_port`](x-plugin-options-system-variables.html#sysvar_mysqlx_port), you
...
* See [Interactive Code Execution](/doc/mysql-shell/9.5/en/mysql-shell-interactive-code-execution.html)
  for an explanation of how interactive code execution works
  in MySQL Shell.

* See [Getting Started with MySQL Shell](/doc/mysql-shell/9.5/en/mysql-shell-getting-started.html) to learn

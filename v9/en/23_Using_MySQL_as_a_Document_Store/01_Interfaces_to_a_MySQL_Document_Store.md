...
* MySQL Shell is an interactive interface to MySQL supporting
  ...
  [Installing MySQL Shell](/doc/mysql-shell/9.5/en/mysql-shell-install.html) has instructions to
...
* The quick-start guides (tutorials) in this chapter help you to
  ...
  [Section 22.3, “JavaScript Quick-Start Guide: MySQL Shell for Document Store”](mysql-shell-tutorial-javascript.html "22.3 JavaScript Quick-Start Guide: MySQL Shell for Document Store").

  The quick-start guide for Python is here:
  [Section 22.4, “Python Quick-Start Guide: MySQL Shell for Document Store”](mysql-shell-tutorial-python.html "22.4 Python Quick-Start Guide: MySQL Shell for Document Store").

* The *MySQL Shell User Guide* at
  [MySQL Shell 9.5](/doc/mysql-shell/9.5/en/) provides detailed information

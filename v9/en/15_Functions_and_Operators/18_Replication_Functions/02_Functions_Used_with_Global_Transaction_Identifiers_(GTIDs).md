...
<table frame="box" rules="all" summary="A reference that lists functions used with global transaction identifiers (GTIDs)."><thead><tr><th>Name</th> <th>Description</th> </tr></thead><tbody><tr><td><code>WAIT_FOR_EXECUTED_GTID_SET()</code></td> <td> Wait until the given GTIDs have executed on the replica. </td> </tr></tbody></table>

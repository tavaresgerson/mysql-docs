...
them. See [GTID Sets](replication-gtids-concepts.html#replication-gtids-concepts-gtid-sets "GTID Sets")
...
are used in practice, see [Section 19.1.3, “Replication with Global Transaction Identifiers”](replication-gtids.html "19.1.3 Replication with Global Transaction Identifiers").
...
<th>Description</th>
</tr></thead><tbody><tr><td><a class="link" href="gtid-functions.html#function_wait-for-executed-gtid-set"><code class="literal">WAIT_FOR_EXECUTED_GTID_SET()</code></a></td>
<td>
...
* [`WAIT_FOR_EXECUTED_GTID_SET(gtid_set[,
  ...
  *`gtid_set`*; that is, until the
  ...
  [Section 19.1.3.1, “GTID Format and Storage”](replication-gtids-concepts.html "19.1.3.1 GTID Format and Storage") for a
  ...
  *`timeout`* value is immediately
  ...
  ([`ER_WRONG_ARGUMENTS`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_wrong_arguments));

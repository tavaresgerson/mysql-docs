...
the
[`group_replication_enable_member_action`](group-replication-functions-for-member-actions.html#function_group-replication-enable-member-action)
and
...
The
[`group_replication_reset_member_actions`](group-replication-functions-for-member-actions.html#function_group-replication-reset-member-actions)
...
[`read_only`](server-system-variables.html#sysvar_read_only) system variable set
...
:   This member action is taken after a member is elected as
    ...
    [`SUPER`](privileges-provided.html#priv_super) privilege. It does
...
:   This member action is taken after a member is elected as
    ...
    TO`](change-replication-source-to.html "15.4.2.2 CHANGE REPLICATION SOURCE TO Statement") statement for the channel. When the feature
...
* [`group_replication_reset_member_actions()`](group-replication-functions-for-member-actions.html#function_group-replication-reset-member-actions)
  ...
  (with the [`read_only`](server-system-variables.html#sysvar_read_only)

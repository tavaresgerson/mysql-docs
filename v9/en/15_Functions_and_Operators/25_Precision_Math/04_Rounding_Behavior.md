...
[`ROUND()`](mathematical-functions.html#function_round) function and for inserts
into columns with exact-value types
([`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") and integer).

The [`ROUND()`](mathematical-functions.html#function_round) function rounds
differently depending on whether its argument is exact or
approximate:

* For exact-value numbers,
  [`ROUND()`](mathematical-functions.html#function_round) uses the “round
...
For inserts into a [`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") or
...
The [`SHOW WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") statement

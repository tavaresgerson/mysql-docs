...
* If at least one of the arguments is not valid JSON, the
  ...
  ([`ER_INVALID_TYPE_FOR_JSON`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_type_for_json))

* In addition, if the schema is not a valid JSON object, the
  function returns
  [`ER_INVALID_JSON_TYPE`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_json_type).
...
* [`JSON_SCHEMA_VALID(schema,document)`](json-validation-functions.html#function_json-schema-valid)
  ...
  **JSON\_SCHEMA\_VALID() and CHECK constraints.**
  ...
  WARNINGS`](show-warnings.html "15.7.7.43 SHOW WARNINGS Statement") statement:
  ...
  *************************** 2. row ***************************
  ...
  See [Section 15.1.24.6, “CHECK Constraints”](create-table-check-constraints.html "15.1.24.6 CHECK Constraints"), for more
  information.

...
convert JSON data to tabular data. MySQL 9.5 supports
one such function, `JSON_TABLE()`.

[`JSON_TABLE(expr,
path COLUMNS
(column_list) [AS]
alias)`](json-table-functions.html#function_json-table)
...
for table aliases apply (see [Section 11.2, “Schema Object Names”](identifiers.html "11.2 Schema Object Names")).
...
1. `name FOR
   ...
   *`name`* is a counter whose type is
   ...
   `AUTO_INCREMENT` in a
   [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement") statement, and can
...
3.14159 in a [`DECIMAL(10,1)`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") column,
...
governing table column names. See [Section 11.2, “Schema Object Names”](identifiers.html "11.2 Schema Object Names").
...
query raises [`ER_PARSE_ERROR`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_parse_error).
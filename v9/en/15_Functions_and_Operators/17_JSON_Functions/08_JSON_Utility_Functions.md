...
[`JSON_PRETTY()`](json-utility-functions.html#function_json-pretty) prints out a JSON
value in a format that is easy to read.
[`JSON_STORAGE_SIZE()`](json-utility-functions.html#function_json-storage-size) and
[`JSON_STORAGE_FREE()`](json-utility-functions.html#function_json-storage-free) show,
...
* [`JSON_PRETTY(json_val)`](json-utility-functions.html#function_json-pretty)
  ...
  + Special characters in string scalars and key names are
    ...
    [`JSON_QUOTE()`](json-creation-functions.html#function_json-quote) function.
...
* [`JSON_STORAGE_FREE(json_val)`](json-utility-functions.html#function_json-storage-free)

  For a [`JSON`](json.html "13.5 The JSON Data Type") column value, this
  ...
  [`JSON_REMOVE()`](json-modification-functions.html#function_json-remove). The argument can
...
* [`JSON_STORAGE_SIZE(json_val)`](json-utility-functions.html#function_json-storage-size)
  ...
  the column using
  [`JSON_STORAGE_FREE()`](json-utility-functions.html#function_json-storage-free); since no
  updates have yet been performed, this is 0, as expected.

  Next we perform an [`UPDATE`](update.html "15.2.17 UPDATE Statement") on
  ...
  [`JSON_SET()`](json-modification-functions.html#function_json-set),
  [`JSON_REPLACE()`](json-modification-functions.html#function_json-replace), or
  [`JSON_REMOVE()`](json-modification-functions.html#function_json-remove). The direct

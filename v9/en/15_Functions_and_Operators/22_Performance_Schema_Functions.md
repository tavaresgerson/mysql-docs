...
<table frame="box" rules="all" summary="A reference that lists Performance Schema functions."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th>
<th>Description</th>
</tr></thead><tbody><tr><td><a class="link" href="performance-schema-functions.html#function_format-bytes"><code class="literal">FORMAT_BYTES()</code></a></td>
<td>
      Convert byte count to value with units
    </td>
</tr><tr><td><a class="link" href="performance-schema-functions.html#function_format-pico-time"><code class="literal">FORMAT_PICO_TIME()</code></a></td>
<td>
      Convert time in picoseconds to value with units
    </td>
</tr><tr><td><a class="link" href="performance-schema-functions.html#function_ps-current-thread-id"><code class="literal">PS_CURRENT_THREAD_ID()</code></a></td>
<td>
      Performance Schema thread ID for current thread
    </td>
</tr><tr><td><a class="link" href="performance-schema-functions.html#function_ps-thread-id"><code class="literal">PS_THREAD_ID()</code></a></td>
<td>
...
* [`FORMAT_BYTES(count)`](performance-schema-functions.html#function_format-bytes)
  ...
  *`count`* is `NULL`.
  ...
  <table summary="Units indicators used by FORMAT_BYTES() function."><col style="width: 30%"/><col style="width: 25%"/><col style="width: 45%"/><thead><tr>
...
<td>EiB</td>
  ...
  [`FORMAT_BYTES()`](performance-schema-functions.html#function_format-bytes) may be used
  instead of the `sys` schema
  [`format_bytes()`](sys-format-bytes.html "30.4.5.3 The format_bytes() Function") function, keeping
  in mind this difference:

  + [`FORMAT_BYTES()`](performance-schema-functions.html#function_format-bytes) uses the
    `EiB` units indicator.
    [`sys.format_bytes()`](sys-format-bytes.html "30.4.5.3 The format_bytes() Function") does not.

* [`FORMAT_PICO_TIME(time_val)`](performance-schema-functions.html#function_format-pico-time)
  ...
  <table summary="Units indicators used by FORMAT_PICO_TIME() function."><col style="width: 30%"/><col style="width: 25%"/><col style="width: 45%"/><thead><tr>
<th scope="col">Argument Value</th>
<th scope="col">Result Units</th>
<th scope="col">Result Units Indicator</th>
</tr></thead><tbody><tr>
...
<td>d</td>
  ...
  [`FORMAT_PICO_TIME()`](performance-schema-functions.html#function_format-pico-time) may be used
  instead of the `sys` schema
  [`format_time()`](sys-format-time.html "30.4.5.6 The format_time() Function") function, keeping
  in mind these differences:

  + To indicate minutes,
    [`sys.format_time()`](sys-format-time.html "30.4.5.6 The format_time() Function") uses the
    `m` units indicator, whereas
    [`FORMAT_PICO_TIME()`](performance-schema-functions.html#function_format-pico-time) uses
    `min`.

  + [`sys.format_time()`](sys-format-time.html "30.4.5.6 The format_time() Function") uses the
    `w` (weeks) units indicator.
    [`FORMAT_PICO_TIME()`](performance-schema-functions.html#function_format-pico-time) does
    not.
...
* [`PS_CURRENT_THREAD_ID()`](performance-schema-functions.html#function_ps-current-thread-id)
  ...
  [`PS_CURRENT_THREAD_ID()`](performance-schema-functions.html#function_ps-current-thread-id) the same
  way as for [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id). For
  ...
  [`PS_CURRENT_THREAD_ID()`](performance-schema-functions.html#function_ps-current-thread-id) may be
  used as a shortcut for invoking the `sys`
  schema [`ps_thread_id()`](sys-ps-thread-id.html "30.4.5.15 The ps_thread_id() Function") function
  with an argument of `NULL` or
  [`CONNECTION_ID()`](information-functions.html#function_connection-id).

* [`PS_THREAD_ID(connection_id)`](performance-schema-functions.html#function_ps-thread-id)
  ...
  Schema [`threads`](performance-schema-threads-table.html "29.12.22.10 The threads Table") table or the
  `Id` column of [`SHOW
  PROCESSLIST`](show-processlist.html "15.7.7.32 SHOW PROCESSLIST Statement") output.
  ...
  Performance Schema configuration affects
  [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id) operation as
  ...
  + Disabling the `thread_instrumentation`
    ...
    [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id).
  ...
  + If
    ...
    and [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id) returns
    `NULL`.

  + If the Performance Schema itself is disabled,
    [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id) produces an
    error.
  ...
  [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id) may be used
  instead of the `sys` schema
  [`ps_thread_id()`](sys-ps-thread-id.html "30.4.5.15 The ps_thread_id() Function") function, keeping
  in mind this difference:

  + With an argument of `NULL`,
    [`sys.ps_thread_id()`](sys-ps-thread-id.html "30.4.5.15 The ps_thread_id() Function") returns

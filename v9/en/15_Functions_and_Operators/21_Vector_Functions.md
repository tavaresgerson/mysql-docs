...
<table frame="box" rules="all" summary="A reference that lists vector functions."><thead><tr><th>Name</th> <th>Description</th> </tr></thead><tbody><tr><td><code>DISTANCE()</code></td> <td> Calculates the distance between two vectors per the specified method </td> </tr><tr><td><code>STRING_TO_VECTOR()</code></td> <td> Get the binary value of the VECTOR column represented by a conforming string </td> </tr><tr><td><code>VECTOR_DIM()</code></td> <td> Get the length of a vector (that is, the number of entries it contains) </td> </tr><tr><td><code>VECTOR_TO_STRING()</code></td> <td> Get the string representation of a VECTOR column, given its value as a binary string </td> </tr></tbody></table>

...
* [`:=`](assignment-operators.html#operator_assign-value)
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement"), such as
  [`UPDATE`](update.html "15.2.17 UPDATE Statement"), as shown here:
  ...
  [Section 11.4, “User-Defined Variables”](user-variables.html "11.4 User-Defined Variables"), explains why you should
  avoid doing this.
...
* [`=`](assignment-operators.html#operator_assign-equal)
  ...
  are part of the [`UPDATE`](update.html "15.2.17 UPDATE Statement") are
  ...
  For more information, see [Section 15.7.6.1, “SET Syntax for Variable Assignment”](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"),
  [Section 15.2.17, “UPDATE Statement”](update.html "15.2.17 UPDATE Statement"), and [Section 15.2.15, “Subqueries”](subqueries.html "15.2.15 Subqueries").
...
* [`CAST(expr AS
  ...
  *`timezone_specifier`*: [INTERVAL]
  ...
  INDEX`](create-index.html "15.1.18 CREATE INDEX Statement"), [`CREATE
  TABLE`](create-table.html "15.1.24 CREATE TABLE Statement"), and [`ALTER
  TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements. `ARRAY` is not
...
* If the expression to cast is a well-formed geometry of type
  ...
  than one `Point`, an
  [`ER_INVALID_CAST_TO_GEOMETRY`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_cast_to_geometry)
  error occurs.
...
* If the expression to cast is a well-formed geometry of type
  ...
  [`ER_INVALID_CAST_POLYGON_RING_DIRECTION`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_cast_polygon_ring_direction)
  error occurs.
...
* If the expression to cast is a well-formed geometry of type
  ...
  [`ER_WRONG_PARAMETERS_TO_STORED_FCT`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_wrong_parameters_to_stored_fct)
  error occurs.
...
specific type in a
[`CREATE TABLE ...
SELECT`](create-table.html "15.1.24 CREATE TABLE Statement") statement:
...
[`ENUM`](enum.html "13.3.6 The ENUM Type") columns in lexical order.
Normally, sorting of [`ENUM`](enum.html "13.3.6 The ENUM Type") columns

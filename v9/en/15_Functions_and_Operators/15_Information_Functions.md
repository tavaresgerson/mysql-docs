...
<th scope="row"><code class="literal">7</code></th>
<td>No collation</td>
<td>Concatenation of strings with different collations</td>
</tr></tbody></table>

  `1` was previously used for “No
  collation”. It is unused in MySQL 9.5 but
  still considered valid for backwards compatibility. (Bug
  #37285902)
...
* [`CURRENT_USER`](information-functions.html#function_current-user),
  ...
  following [`CREATE TABLE`](create-table.html "15.1.24 CREATE TABLE Statement")
  statement:
...
* [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id),
  ...
  *************************** 1. row ***************************
  ...
  [`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html)), without
  affecting or being affected by other clients that generate
  their own sequence values.

  Note that [`mysql_insert_id()`](/doc/c-api/9.5/en/mysql-insert-id.html) is
...
* [`ROW_COUNT()`](information-functions.html#function_row-count)
  ...
  + DML statements other than
    ...
    TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") and [`LOAD
  ...
  [`mysql_real_connect()`](/doc/c-api/9.5/en/mysql-real-connect.html) when
...
* [`SESSION_USER()`](information-functions.html#function_session-user)
  ...
  Like [`USER()`](information-functions.html#function_user), this function can

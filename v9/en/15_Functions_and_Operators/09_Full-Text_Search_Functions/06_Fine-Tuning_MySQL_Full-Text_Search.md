...
[**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") in the instructions that follow
...
[Section 7.1.9.1, “System Variable Privileges”](system-variable-privileges.html "7.1.9.1 System Variable Privileges")). No rebuilding
...
* Modify a character set file: This requires no
  ...
  the `<ctype><map>` array
  format, see [Section 12.13.1, “Character Definition Arrays”](character-arrays.html "12.13.1 Character Definition Arrays").
...
* Add a new collation for the character set used by the
  ...
  collations, see [Section 12.14, “Adding a Collation to a Character Set”](adding-collation.html "12.14 Adding a Collation to a Character Set"). For an
...
Running [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") on a
...
TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") is run. Subsequent
[`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") operations
continue from where the preceding
[`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") operation ended.
...
Alternatively, use [`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement")
...
If you use [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") to perform an
...
An alternative to using [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") for
...
[`ALTER TABLE`](alter-table.html "15.1.11 ALTER TABLE Statement") statements. These

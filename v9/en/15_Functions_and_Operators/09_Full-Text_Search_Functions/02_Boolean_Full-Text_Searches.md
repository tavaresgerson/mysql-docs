...
* `InnoDB` tables require a
  ...
  [`MATCH()`](fulltext-search.html#function_match) expression to perform
...
* The minimum and maximum word length full-text parameters
  ...
  [`ft_max_word_len`](server-system-variables.html#sysvar_ft_max_word_len) are used
...
* (no operator)
  ...
  AGAINST()`](fulltext-search.html#function_match) without the `IN BOOLEAN
  MODE` modifier.
...
* `*`
  ...
  *appended* to the word to be affected.
  ...
  [`ft_min_word_len`](server-system-variables.html#sysvar_ft_min_word_len) for
...
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") full-text search is
modeled on the
...
from [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") relevancy rankings.

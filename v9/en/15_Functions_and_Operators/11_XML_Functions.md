...
<table frame="box" rules="all" summary="A reference that lists XML functions."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th>
<th>Description</th>
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
clients by invoking them with the
[`--xml`](mysql-command-options.html#option_mysql_xml) option. See
...
9.5 and onwards. You may discuss these, ask
...
* [`ExtractValue(xml_frag,
  xpath_expr)`](xml-functions.html#function_extractvalue)

  [`ExtractValue()`](xml-functions.html#function_extractvalue) takes two string
  ...
  *`xpath_expr`* (also known as a
  ...
  '/a/b')`](xml-functions.html#function_extractvalue) and
  [`ExtractValue('<a><b>Sakila</b></a>',
  '/a/b/text()')`](xml-functions.html#function_extractvalue) produce the same result. If
  *`xml_frag`* or
  *`xpath_expr`* is
  ...
  *`xml_frag`* consists of elements which
  ...
  [`ExtractValue()`](xml-functions.html#function_extractvalue) returns only
  ...
  [`CONCAT()`](string-functions.html#function_concat)), in taking into
  account the collation coercibility of their arguments; see
  [Section 12.8.4, “Collation Coercibility in Expressions”](charset-collation-coercibility.html "12.8.4 Collation Coercibility in Expressions"), for an
...
* [`UpdateXML(xml_target,
  xpath_expr,
  new_xml)`](xml-functions.html#function_updatexml)
...
[`ExtractValue()`](xml-functions.html#function_extractvalue) and
[`UpdateXML()`](xml-functions.html#function_updatexml) may contain the colon
...
**Error handling.**
For both [`ExtractValue()`](xml-functions.html#function_extractvalue) and
[`UpdateXML()`](xml-functions.html#function_updatexml), the XPath locator
...
[`UpdateXML()`](xml-functions.html#function_updatexml) is
...
[`ExtractValue()`](xml-functions.html#function_extractvalue) function:
...
Because [`ExtractValue()`](xml-functions.html#function_extractvalue) returns

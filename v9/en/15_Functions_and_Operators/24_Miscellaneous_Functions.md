...
</tr><tr><td><a class="link" href="miscellaneous-functions.html#function_etag"><code class="literal">ETAG()</code></a></td>
<td>
...
* [`ETAG(col [,
  col[, ...]])`](miscellaneous-functions.html#function_etag)

  Computes a 128-bit hash for each row, given a comma-separated
  list of one or more column values. An item in this list can be
  a column name, a constant value, or an expression, and can be
  `NULL`.

  [`VECTOR`](vector.html "13.3.5 The VECTOR Type") and
  [`GEOMETRY`](spatial-type-overview.html "13.4.1 Spatial Data Types") columns are not
  supported by this function; trying to reference a column of
  either type raises an error
  .

  The ordering of items in the argument list does not affect the
...
* [`NAME_CONST(name,value)`](miscellaneous-functions.html#function_name-const)
  ...
  [Section 27.9, “Stored Program Binary Logging”](stored-programs-logging.html "27.9 Stored Program Binary Logging"). You might see this

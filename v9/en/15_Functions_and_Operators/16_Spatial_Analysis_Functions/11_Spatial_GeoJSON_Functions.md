...
MySQL also supports a native [`JSON`](json.html "13.5 The JSON Data Type")
data type and a set of SQL functions to enable operations on JSON
values. For more information, see [Section 13.5, “The JSON Data Type”](json.html "13.5 The JSON Data Type"), and
[Section 14.17, “JSON Functions”](json-functions.html "14.17 JSON Functions").

* [`ST_AsGeoJSON(g
  [, max_dec_digits [,
  options]])`](spatial-geojson-functions.html#function_st-asgeojson)
  ...
  *`options`*, if specified, is a
  ...
  <table summary="Option flags for the ST_AsGeoJSON() function."><col style="width: 10%"/><col style="width: 90%"/><thead><tr>
<th>Flag Value</th>
<th>Meaning</th>
</tr></thead><tbody><tr>
<td>0</td>
...
<td>Add a short-format CRS URN to the output. The default format is a short
                format
                (<code class="literal">EPSG:<em class="replaceable"><code>srid</code></em></code>).
                If the SRID is 0, the CRS URN is
                <code class="literal">MySQL:0</code>.</td>
</tr><tr>
<td>4</td>
<td>Add a long-format CRS URN
                ...
                long-format CRS URN). If the SRID is 0, the CRS URN is
                <code class="literal">urn:ogc:def:crs:MySQL::0</code>.</td>
</tr></tbody></table>
...
* [`ST_GeomFromGeoJSON(str
  [, options [,
  srid]])`](spatial-geojson-functions.html#function_st-geomfromgeojson)
  ...
  *`options`*, if given, describes how to
  ...
  <table summary="Option flags for the ST_GeomFromGeoJSON() function."><col style="width: 10%"/><col style="width: 90%"/><thead><tr>
<th>Option Value</th>
<th>Meaning</th>
</tr></thead><tbody><tr>
<td>1</td>
...
<td>Accept the document and strip off the coordinates for higher coordinate
  ...
  *`srid`* argument is given, any CRS is
  ...
  [`ER_INVALID_GEOJSON_CRS_NOT_TOP_LEVEL`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_invalid_geojson_crs_not_top_level)
  error occurs.

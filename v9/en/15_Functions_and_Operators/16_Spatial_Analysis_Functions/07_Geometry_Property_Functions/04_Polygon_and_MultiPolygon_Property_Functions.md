...
* [`ST_Area({poly|mpoly})`](gis-polygon-property-functions.html#function_st-area)
  ...
  [`ST_Area()`](gis-polygon-property-functions.html#function_st-area) handles its
...
* [`ST_Centroid({poly|mpoly})`](gis-polygon-property-functions.html#function_st-centroid)
  ...
  [`ST_Centroid()`](gis-polygon-property-functions.html#function_st-centroid) handles its
  arguments as described in the introduction to this section,
  with these exceptions:
...
* [`ST_ExteriorRing(poly)`](gis-polygon-property-functions.html#function_st-exteriorring)
  ...
  [`ST_ExteriorRing()`](gis-polygon-property-functions.html#function_st-exteriorring) handles its
  arguments as described in the introduction to this section.
...
* [`ST_InteriorRingN(poly,
  ...
  *`poly`* as a
  ...
  [`ST_InteriorRingN()`](gis-polygon-property-functions.html#function_st-interiorringn) handles

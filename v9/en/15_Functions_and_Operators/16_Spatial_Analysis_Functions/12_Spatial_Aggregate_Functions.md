...
[Section 14.19.1, “Aggregate Function Descriptions”](aggregate-functions.html "14.19.1 Aggregate Function Descriptions"). This section describes the
[`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) spatial aggregate
function.

[`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) can be used as a
...
* [`ST_Collect([DISTINCT]
  g)
  [over_clause]`](spatial-aggregate-functions.html#function_st-collect)
  ...
  [`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) returns an
  aggregate value for each subset.

  This function executes as a window function if
  *`over_clause`* is present.
  *`over_clause`* is as described in
  [Section 14.20.2, “Window Function Concepts and Syntax”](window-functions-usage.html "14.20.2 Window Function Concepts and Syntax"). In contrast to most
  aggregate functions that support windowing,
  [`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) permits use of
  *`over_clause`* together with
  `DISTINCT`.

  [`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) handles its
  ...
  + If any geometry argument is a syntactically well-formed
    ...
    an [`ER_SRS_NOT_FOUND`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_srs_not_found) error
    occurs.
  ...
  + If there are multiple geometry arguments and those
    ...
    [`ER_GIS_DIFFERENT_SRIDS_AGGREGATION`](/doc/mysql-errors/9.5/en/server-error-reference.html#error_er_gis_different_srids_aggregation)
    error occurs.
  ...
  [`ST_Collect()`](spatial-aggregate-functions.html#function_st-collect) on the data set:

...
* Problems with collations generate warnings that clients can display with [`SHOW WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement"). Suppose that a reset rule contains an expansion longer than the maximum supported length of 6 characters:

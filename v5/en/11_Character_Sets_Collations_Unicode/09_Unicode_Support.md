...
Client applications that communicate with the server using Unicode should set the client character set accordingly (for example, by issuing a `SET NAMES 'utf8mb4'` statement). Some character sets cannot be used as the client character set. Attempting to use them with [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or [`SET CHARACTER SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") produces an error. See Impermissible Client Character Sets.
...
Tables can be converted from `utf8mb3` to `utf8mb4` by using [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). Suppose that a table has this definition:

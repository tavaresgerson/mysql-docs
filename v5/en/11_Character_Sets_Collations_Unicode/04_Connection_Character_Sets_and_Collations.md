...
* The [`SET NAMES 'charset_name'`](set-names.html "13.7.4.3 SET NAMES Statement") statement.

* The [`SET CHARACTER SET 'charset_name'`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") statement.
...
* `SET NAMES 'charset_name' [COLLATE 'collation_name']`
  ...
  `SET NAMES` indicates what character set the client uses to send SQL statements to the server. Thus, [`SET NAMES 'cp1251'`](set-names.html "13.7.4.3 SET NAMES Statement") tells the server, “future incoming messages from this client are in character set `cp1251`.” It also specifies the character set that the server should use for sending results back to the client. (For example, it indicates what character set to use for column values if you use a `SELECT` statement that produces a result set.)

  A [`SET NAMES 'charset_name'`](set-names.html "13.7.4.3 SET NAMES Statement") statement is equivalent to these three statements:
...
* `SET CHARACTER SET 'charset_name`'
  ...
  A [`SET CHARACTER SET charset_name`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") statement is equivalent to these three statements:
...
Some character sets cannot be used as the client character set. Attempting to use them with [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or [`SET CHARACTER SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") produces an error. See Impermissible Client Character Sets.

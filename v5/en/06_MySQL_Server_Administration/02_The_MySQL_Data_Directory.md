...
* Data directory subdirectories. Each subdirectory of the data
  ...
  + The `mysql` directory corresponds to the
    `mysql` system database, which contains
    information required by the MySQL server as it runs. See
  ...
  + The `sys` directory corresponds to the
    ...
    more easily. See [Chapter 26, *MySQL sys Schema*](sys-schema.html "Chapter 26 MySQL sys Schema").
  ...
  [`INFORMATION_SCHEMA`](information-schema.html "Chapter 24 INFORMATION_SCHEMA Tables") is a
...
* Default/autogenerated SSL and RSA certificate and key files.
  See [Section 6.3.3, “Creating SSL and RSA Certificates and Keys”](creating-ssl-rsa-files.html "6.3.3 Creating SSL and RSA Certificates and Keys").

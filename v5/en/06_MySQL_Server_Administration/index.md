...
[5.1 The MySQL Server](mysqld-server.html)
...
[5.4 MySQL Server Logs](server-logs.html)
...
[5.5 MySQL Server Plugins](server-plugins.html)
...
[5.6 MySQL Server Loadable Functions](server-loadable-functions.html)
...
[5.7 Running Multiple MySQL Instances on One Machine](multiple-servers.html)
...
[5.8 Debugging MySQL](debugging-mysql.html)
:   [5.8.1 Debugging a MySQL Server](debugging-server.html)
...
MySQL Server ([`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server")) is the main program that

...
* The [`SHOW PLUGINS`](show-plugins.html "13.7.5.25 SHOW PLUGINS Statement") statement
...
* The `mysql.plugin` table shows which plugins
  ...
  PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement"). The table contains only plugin names and
  library file names, so it does not provide as much information
  as the [`PLUGINS`](information-schema-plugins-table.html "24.3.17 The INFORMATION_SCHEMA PLUGINS Table") table or the

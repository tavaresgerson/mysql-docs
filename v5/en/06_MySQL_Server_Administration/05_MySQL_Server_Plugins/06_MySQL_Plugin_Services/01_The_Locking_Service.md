...
[Section 5.5.6, “MySQL Plugin Services”](plugin-services.html "5.5.6 MySQL Plugin Services"). For general information about
loadable functions, see
[Adding a Loadable Function](/doc/extending-mysql/5.7/en/adding-loadable-function.html).
...
* Namespace and lock names must be
  ...
  [`ER_LOCKING_SERVICE_WRONG_NAME`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_locking_service_wrong_name)
  error.
...
* Locks can be waited for if not immediately available. Lock
  ...
  acquisition, an
  [`ER_LOCKING_SERVICE_TIMEOUT`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_locking_service_timeout)
...
* The locking interface detects deadlock between
  ...
  [`ER_LOCKING_SERVICE_DEADLOCK`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_locking_service_deadlock)
...
related SQL functions (see [Section 12.14, “Locking Functions”](locking-functions.html "12.14 Locking Functions")).
...
[Section 5.5.6.1.2, “The Locking Service Function Interface”](locking-service.html#locking-service-interface "5.5.6.1.2 The Locking Service Function Interface") For general
characteristics of the locking service interface, see
[Section 5.5.6.1, “The Locking Service”](locking-service.html "5.5.6.1 The Locking Service"). For general information
about plugin services, see [Section 5.5.6, “MySQL Plugin Services”](plugin-services.html "5.5.6 MySQL Plugin Services").
...
[Section 5.5.6.1.1, “The Locking Service C Interface”](locking-service.html#locking-service-c-interface "5.5.6.1.1 The Locking Service C Interface") For general
characteristics of the locking service interface, see
[Section 5.5.6.1, “The Locking Service”](locking-service.html "5.5.6.1 The Locking Service"). For general information
...
[Section 5.5.6.1.1, “The Locking Service C Interface”](locking-service.html#locking-service-c-interface "5.5.6.1.1 The Locking Service C Interface") need not be
...
[`CREATE FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement") statement,
...
[`DROP FUNCTION`](drop-function.html "13.1.24 DROP FUNCTION Statement") statement:
...
find that the session holds six distinct locks with the same
`(ns, lock1)` identifier. (For details, see
[Locking Service Monitoring](locking-service.html#locking-service-monitoring "Locking Service Monitoring").)
...
for. You see `PENDING` if one session holds

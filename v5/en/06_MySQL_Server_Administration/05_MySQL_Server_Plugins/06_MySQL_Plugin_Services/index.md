...
[5.5.6.1 The Locking Service](locking-service.html)

[5.5.6.2 The Keyring Service](keyring-service.html)
...
[MySQL Services for Plugins](/doc/extending-mysql/5.7/en/services-for-plugins.html). The following sections

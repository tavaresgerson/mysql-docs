...
* A server-side plugin named `version_tokens`
  ...
  the [audit plugin
  API](/doc/extending-mysql/5.7/en/plugin-types.html#audit-plugin-type) to monitor incoming statements from clients and
...
* A set of loadable functions provides an SQL-level API for
  ...
  to call any of the Version Token functions.

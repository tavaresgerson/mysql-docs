...
described in [Section 5.5.2, “Obtaining Server Plugin Information”](obtaining-plugin-information.html "5.5.2 Obtaining Server Plugin Information").
...
A plugin located in a plugin library file can be loaded at
runtime with the [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement")
...
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") requires the
...
Alternatively, the [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement")
...
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") also causes
...
PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") produce an error:
...
PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") statement) in the
...
* `--plugin_name=FORCE_PLUS_PERMANENT`
  ...
  do so with [`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement"),
  an error occurs.

Plugin activation states are visible in the
`LOAD_OPTION` column of the Information Schema
[`PLUGINS`](information-schema-plugins-table.html "24.3.17 The INFORMATION_SCHEMA PLUGINS Table") table.
...
to disable [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine"), other
`innodb_xxx`
options likely need to be omitted at startup. In addition,
because [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") is the default
...
At runtime, the [`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement")
...
[`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement") statement
...
[`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement") can unload a
plugin regardless of whether it was loaded at runtime with
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") or at startup with
...
* It cannot unload plugins that are built in to the server.
  ...
  [`INFORMATION_SCHEMA.PLUGINS`](information-schema-plugins-table.html "24.3.17 The INFORMATION_SCHEMA PLUGINS Table") or
...
3. Plugins normally are installed using either a plugin-loading
   ...
   PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") at runtime, but not both. However, removing
   options for a plugin from the `my.cnf`
   file may not be sufficient to uninstall it if at some point
   [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") has also been
   used. If the plugin still appears in the output from
   [`INFORMATION_SCHEMA.PLUGINS`](information-schema-plugins-table.html "24.3.17 The INFORMATION_SCHEMA PLUGINS Table") or
   [`SHOW PLUGINS`](show-plugins.html "13.7.5.25 SHOW PLUGINS Statement"), use
   [`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement") to remove it

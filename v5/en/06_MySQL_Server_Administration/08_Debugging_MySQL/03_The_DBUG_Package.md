...
For [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), it is also possible to change
`DBUG` settings at runtime by setting the
[`debug`](server-system-variables.html#sysvar_debug) system variable. This
...
Changing the global [`debug`](server-system-variables.html#sysvar_debug) value
requires privileges sufficient to set global system variables.
Changing the session [`debug`](server-system-variables.html#sysvar_debug) value
...
<table frame="all" summary="Descriptions of permitted debug_options flag characters."><col style="width: 8%"/><col style="width: 92%"/><thead><tr>
<th><p>
              Flag
            </p></th>
<th><p>
...
<td><p>
              Enable output from
              <code>DBUG_<em class="replaceable"><code>XXX</code></em></code>
              macros for the current state. May be followed by a list of
              keywords, which enables output only for the
              <code>DBUG</code> macros with that keyword. An empty
              ...
              <code>info</code>, and <code>loop</code>.
            </p></td>
</tr><tr>
<td><p>
<code>D</code>
...
<td><p>
              ...
              capabilities. For example, <code>D,20</code>
...
<td><p>
              ...
              appropriate <code>d</code> or <code>t</code>
...
<td><p>
              ...
              The default output is <code>stderr</code>.
            </p></td>
</tr><tr>
<td><p>
<code>O</code>
...
<td><p>
              Like <code>o</code>, but the file is really flushed
...
<td><p>
              ...
              <code>DBUG_PROCESS</code> macro and match one in the

...
The discussion here uses [`mysqld_safe`](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script") to
...
5.7.44 server to have different operating parameters,
...
[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") defaults to using a Unix socket file
...
option to [`mysqld_safe`](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script") so that the server uses a
...
[Section 4.9, “Environment Variables”](environment-variables.html "4.9 Environment Variables"), includes a list of other
environment variables you can use to affect MySQL programs.

On Unix, the [`mysqld_multi`](mysqld-multi.html "4.3.4 mysqld_multi — Manage Multiple MySQL Servers") script provides

...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") servers that they manage themselves. (For
...
5.6 and one from MySQL 5.7, to see how
...
[Section 4.2.2, “Specifying Program Options”](program-options.html "4.2.2 Specifying Program Options"). To see the values used by a given
...
directory. [`mysqld_safe`](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script") determines the proper
[`--basedir`](server-system-variables.html#sysvar_basedir) option to pass to
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), and you need specify only the

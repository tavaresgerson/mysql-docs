...
* Specify the default Unix socket file and TCP/IP port number in
  ...
  directory on Unix. See [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").

* In a C program, you can specify the socket file or port number
  arguments in the
  [`mysql_real_connect()`](/doc/c-api/5.7/en/mysql-real-connect.html) call. You
  can also have the program read option files by calling
  [`mysql_options()`](/doc/c-api/5.7/en/mysql-options.html). See
  [C API Basic Function Descriptions](/doc/c-api/5.7/en/c-api-function-descriptions.html).

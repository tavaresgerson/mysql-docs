...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server from two different versions of
...
* **Approach 1:** Specify the
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") using the service name of
  `mysqld1` and the 5.7.44
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") using the service name
  `mysqld2`. In this case, you can use the
  `[mysqld1]` group for 5.7.9 and the
  `[mysqld2]` group for 5.7.44.
...
* **Approach 2:** Specify options
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), create a file
  ...
  For the 5.7.44 [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), create
...
each one. Alternatively, use [**mysqld --remove**](mysqld.html "4.3.1 mysqld — The MySQL Server")
...
when using [**mysqld --remove**](mysqld.html "4.3.1 mysqld — The MySQL Server").
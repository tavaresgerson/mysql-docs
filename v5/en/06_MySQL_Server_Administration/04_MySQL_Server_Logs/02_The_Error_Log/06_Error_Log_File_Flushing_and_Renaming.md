...
LOGS`](flush.html#flush-logs) statment, or a [**mysqladmin
flush-logs**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command, the server closes and reopens any
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"). For information about handling this
case, see [Section 5.4.7, “Server Log Maintenance”](log-file-maintenance.html "5.4.7 Server Log Maintenance").

...
[`ALTER
TABLE t3 DROP PARTITION p2`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations"), where we must make certain
...
file `ddl_log.log`, in the MySQL data
...
following a successful start of [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"). Thus,
...
There are no user-configurable server options or variables

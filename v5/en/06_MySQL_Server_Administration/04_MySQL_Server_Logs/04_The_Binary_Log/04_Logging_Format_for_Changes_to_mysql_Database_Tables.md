...
[`DELETE`](delete.html "13.2.2 DELETE Statement")) or indirectly (for
example, with [`GRANT`](grant.html "13.7.1.4 GRANT Statement") or
...
* Data manipulation statements that change data in
  ...
  DATA`](load-data.html "13.2.6 LOAD DATA Statement"), [`SELECT`](select.html "13.2.9 SELECT Statement"), and
...
* Statements that change the `mysql` database
  ...
  [`CREATE TABLE
  ... SELECT`](create-table.html "13.1.18 CREATE TABLE Statement")), `ALTER` (all forms),
  and `DROP` (all forms).

[`CREATE TABLE ...
SELECT`](create-table.html "13.1.18 CREATE TABLE Statement") is a combination of data definition and data
manipulation. The [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
part is logged using statement format and the
[`SELECT`](select.html "13.2.9 SELECT Statement") part is logged according

...
* MySQL account names permit IPv6 addresses to enable DBAs to
  ...
  IPv6. See [Section 6.2.4, “Specifying Account Names”](account-names.html "6.2.4 Specifying Account Names"). IPv6 addresses can
  ...
  [`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement"). For example:

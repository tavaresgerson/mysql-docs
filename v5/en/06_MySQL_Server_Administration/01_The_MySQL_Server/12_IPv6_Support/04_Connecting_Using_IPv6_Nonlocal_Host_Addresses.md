...
IPv6 broker; see [Section 5.1.12.5, “Obtaining an IPv6 Address from a Broker”](ipv6-brokers.html "5.1.12.5 Obtaining an IPv6 Address from a Broker").
...
2. On the server host (`2001:db8:0:f101::1`),
   create an account for a user who connects from the client
...
3. On the client host (`2001:db8:0:f101::2`),
   invoke the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client to connect to the

...
[Section 5.1.6, “Server Command Options”](server-options.html "5.1.6 Server Command Options"), and
...
As of MySQL 5.7.18, `my-default.ini` is no
...
instructions given in [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files"). Without an
option file, the server just starts with its default
settings—see [Section 5.1.2, “Server Configuration Defaults”](server-configuration-defaults.html "5.1.2 Server Configuration Defaults")

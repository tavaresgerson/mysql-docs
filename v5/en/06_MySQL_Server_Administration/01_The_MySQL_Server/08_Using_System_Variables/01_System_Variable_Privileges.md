...
statement. See [Section 13.7.4.1, “SET Syntax for Variable Assignment”](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment"). This section
...
[`SET
SESSION`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") statement. In contrast to setting global
...
[`SUPER`](privileges-provided.html#priv_super) privilege. If a session

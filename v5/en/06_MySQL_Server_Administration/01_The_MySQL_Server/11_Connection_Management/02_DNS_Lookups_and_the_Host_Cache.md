...
[`host_cache`](performance-schema-host-cache-table.html "25.12.16.1 The host_cache Table") table exposes the
contents of the host cache so that it can be examined using
[`SELECT`](select.html "13.2.9 SELECT Statement") statements. This may help
...
Performance Schema [`host_cache`](performance-schema-host-cache-table.html "25.12.16.1 The host_cache Table")
...
be examined using [`SELECT`](select.html "13.2.9 SELECT Statement")
statements, which may help you diagnose the causes of
connection problems. The Performance Schema must be enabled or
this table is empty. For information about this table, see
[Section 25.12.16.1, “The host\_cache Table”](performance-schema-host-cache-table.html "25.12.16.1 The host_cache Table").
...
* Execute a [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement")
  statement that truncates the Performance Schema
  [`host_cache`](performance-schema-host-cache-table.html "25.12.16.1 The host_cache Table") table. This
...
* Execute a [**mysqladmin flush-hosts**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program")
...
occurs, it means that [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") has received

...
* When used with [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement"),
  ...
  it does not permit creating an account without a password,
...
* When used with [`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement"),
...
[`SHOW CREATE USER`](show-create-user.html "13.7.5.12 SHOW CREATE USER Statement") indicates whether
...
account, returns an
[`ER_ACCOUNT_HAS_BEEN_LOCKED`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_account_has_been_locked) error,
...
[Section 2.10, “Upgrading MySQL”](upgrading.html "2.10 Upgrading MySQL"). For nonupgraded installations that

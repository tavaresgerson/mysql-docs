...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement"), and [`SET
PASSWORD`](set-password.html "13.7.1.7 SET PASSWORD Statement") and follow these rules:
...
* For a host value specified as an IPv4 address, a netmask can
  ...
  *`client_ip`* for which the following
  ...
  That is, for the [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement")

...
options of the [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") and
[`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement") statements. See
[Section 13.7.1.2, “CREATE USER Statement”](create-user.html "13.7.1.2 CREATE USER Statement"), and [Section 13.7.1.1, “ALTER USER Statement”](alter-user.html "13.7.1.1 ALTER USER Statement").
...
[Section 6.2.12, “Server Handling of Expired Passwords”](expired-password-handling.html "6.2.12 Server Handling of Expired Passwords")). Operations
...
[`SET PASSWORD`](set-password.html "13.7.1.7 SET PASSWORD Statement") must be used instead
of [`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement") and the account
password has a hashing format that requires
[`old_passwords`](server-system-variables.html#sysvar_old_passwords) to be set to a

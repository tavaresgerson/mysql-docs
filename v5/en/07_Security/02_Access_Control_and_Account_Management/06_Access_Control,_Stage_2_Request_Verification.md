...
* The wildcard characters `%` and
  ...
  in the [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement.
...
shutdown**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") but your `user` table row does
not grant the [`SHUTDOWN`](privileges-provided.html#priv_shutdown) privilege to
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement"), and so on), the server
...
[`INSERT INTO ...
SELECT`](insert-select.html "13.2.5.1 INSERT ... SELECT Statement") statement, you need both the

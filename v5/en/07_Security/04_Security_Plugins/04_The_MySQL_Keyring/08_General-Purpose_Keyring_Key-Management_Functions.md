...
server components and plugins to store sensitive information
...
functions that access the capabilities provided by the internal
keyring service. The keyring functions are contained in a plugin
library file, which also contains a
`keyring_udf` plugin that must be enabled prior
to function invocation. For these functions to be used, a
keyring plugin such as `keyring_file` or
...
functions, see [Section 5.5.6.2, “The Keyring Service”](keyring-service.html "5.5.6.2 The Keyring Service"). For general
keyring information, see [Section 6.4.4, “The MySQL Keyring”](keyring.html "6.4.4 The MySQL Keyring").
...
and loadable functions, see [Section 5.5.1, “Installing and Uninstalling Plugins”](plugin-loading.html "5.5.1 Installing and Uninstalling Plugins"),
and [Section 5.6.1, “Installing and Uninstalling Loadable Functions”](function-loading.html "5.6.1 Installing and Uninstalling Loadable Functions").
...
PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") and [`CREATE
FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement") statements, adjusting the
...
* The keyring functions invoke keyring service functions
  (see [Section 5.5.6.2, “The Keyring Service”](keyring-service.html "5.5.6.2 The Keyring Service")). The service
...
* Keyring functions support the key types and lengths
  ...
  plugin, see [Section 6.4.4.6, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "6.4.4.6 Supported Keyring Key Types and Lengths").
...
* [`keyring_key_fetch(key_id)`](keyring-functions-general-purpose.html#function_keyring-key-fetch)
  ...
  in [Section 6.4.4.6, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "6.4.4.6 Supported Keyring Key Types and Lengths"). A key value
  longer than that length can be stored using a keyring
  service function (see
  [Section 5.5.6.2, “The Keyring Service”](keyring-service.html "5.5.6.2 The Keyring Service")), but if retrieved

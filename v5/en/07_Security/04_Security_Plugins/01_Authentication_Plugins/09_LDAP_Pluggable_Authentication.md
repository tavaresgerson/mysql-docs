...
<td>Server-side plugin name</td>
<td><code>authentication_ldap_sasl</code></td>
</tr><tr>
<td>Client-side plugin name</td>
<td><code>authentication_ldap_sasl_client</code></td>
</tr><tr>
<td>Library file names</td>
<td><code>authentication_ldap_sasl.so</code>,
              <code>authentication_ldap_sasl_client.so</code></td>
</tr></tbody></table>
...
* If the MySQL account names an LDAP user distinguished name
  ...
  USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement that creates the account.)
...
* If you installed the plugins at runtime using
  [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement"), they remain
...
* There must be a MySQL user account that specifies a
  ...
  [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement that
...
* [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statements that
...
a [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement to
...
Had the [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement
...
Use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") command-line client to

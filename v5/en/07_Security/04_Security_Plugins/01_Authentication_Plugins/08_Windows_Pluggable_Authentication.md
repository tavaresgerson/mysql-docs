...
<table summary="Names for the plugins and library file used for Windows password authentication."><col style="width: 30%"/><col style="width: 70%"/><thead><tr>
<th>Plugin or File</th>
<th>Plugin or File Name</th>
</tr></thead><tbody><tr>
<td>Server-side plugin</td>
<td><code>authentication_windows</code></td>
</tr><tr>
<td>Client-side plugin</td>
<td><code>authentication_windows_client</code></td>
</tr><tr>
<td>Library file</td>
<td><code>authentication_windows.dll</code></td>
</tr></tbody></table>
...
see [Section 6.2.13, “Pluggable Authentication”](pluggable-authentication.html "6.2.13 Pluggable Authentication"). For proxy user
information, see [Section 6.2.14, “Proxy Users”](proxy-users.html "6.2.14 Proxy Users").
...
* Each user mapping associates a Windows user or group name
  ...
  *`mysql_user_name`* value given,
  ...
  [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement.
...
[Section 6.2.14, “Proxy Users”](proxy-users.html "6.2.14 Proxy Users")). Suppose that you want Windows
...
2. For proxying to work, the proxied accounts must exist, so
   ...
   who authenticate using Windows use the
   ...
   [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements (not
...
proxy accounts, see [Section 6.2.14, “Proxy Users”](proxy-users.html "6.2.14 Proxy Users").
...
[Connector/NET Authentication](/doc/connector-net/en/connector-net-authentication.html).
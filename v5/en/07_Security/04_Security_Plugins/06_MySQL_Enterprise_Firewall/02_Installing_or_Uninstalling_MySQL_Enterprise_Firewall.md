...
elements described in [Section 6.4.6.1, “Elements of MySQL Enterprise Firewall”](firewall-elements.html "6.4.6.1 Elements of MySQL Enterprise Firewall").
...
firewall (see [Section 8.10.3.3, “Query Cache Configuration”](query-cache-configuration.html "8.10.3.3 Query Cache Configuration")).

For usage instructions, see [Section 6.4.6.3, “Using MySQL Enterprise Firewall”](firewall-usage.html "6.4.6.3 Using MySQL Enterprise Firewall").
...
[Figure 6.2, “MySQL Enterprise Firewall Installation on Windows”](firewall-installation.html#firewall-installation-windows-installer "Figure 6.2 MySQL Enterprise Firewall Installation on Windows").
...
`MyISAM` for the firewall tables. For
...
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") statements in
...
[MySQL Enterprise Firewall Interface](/doc/workbench/en/wb-mysql-firewall.html), in
[Chapter 29, *MySQL Workbench*](workbench.html "Chapter 29 MySQL Workbench").

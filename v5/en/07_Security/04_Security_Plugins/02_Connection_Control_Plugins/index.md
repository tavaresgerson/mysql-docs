...
response to connection attempts after a configurable number of
consecutive failed attempts. This capability provides a deterrent
...
* `CONNECTION_CONTROL` checks incoming
  ...
  [Writing Audit Plugins](/doc/extending-mysql/5.7/en/writing-audit-plugins.html)). To collect

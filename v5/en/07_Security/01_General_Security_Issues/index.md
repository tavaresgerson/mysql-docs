...
checking database access, see [Section 2.9, “Postinstallation Setup and Testing”](postinstallation.html "2.9 Postinstallation Setup and Testing").

For answers to some questions that are often asked about MySQL
Server security issues, see [Section A.9, “MySQL 5.7 FAQ: Security”](faqs-security.html "A.9 MySQL 5.7 FAQ: Security").
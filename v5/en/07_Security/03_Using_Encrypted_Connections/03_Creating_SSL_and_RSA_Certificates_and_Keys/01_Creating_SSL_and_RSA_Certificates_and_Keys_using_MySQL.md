...
* Users can invoke the [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files")
  utility manually.

* For some distribution types, such as RPM and DEB packages,
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") invocation occurs
...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") help lower the barrier
...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") utility that can be
invoked manually to generate SSL and RSA files. This utility
is included with all MySQL distributions, but it does require
that the **openssl** command be available. For
usage instructions, see [Section 4.4.5, “mysql_ssl_rsa_setup — Create SSL/RSA Files”](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files").

##### SSL and RSA File Characteristics

SSL and RSA files created automatically by the server or by
invoking [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") have these
characteristics:
...
* SSL certificates use these Common Name (CN) values, with
  ...
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files"), the suffix can be
...
* SSL files created by the server or by
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") are valid for ten
...
* Files created automatically by the server are owned by the
  ...
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") are owned by the

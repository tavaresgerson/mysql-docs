...
* OpenSSL supports a more flexible syntax for specifying ciphers
  (for the [`ssl_cipher`](server-system-variables.html#sysvar_ssl_cipher) system
  variable and [`--ssl-cipher`](connection-options.html#option_general_ssl-cipher)
  client option), and supports a wider range of encryption
  ciphers from which to choose. See
  [Command Options for Encrypted Connections](connection-options.html#encrypted-connection-options "Command Options for Encrypted Connections"), and
...
* OpenSSL supports the
  ...
  and [`--ssl-capath`](connection-options.html#option_general_ssl-capath) client
  option. MySQL distributions compiled using yaSSL do not
  because yaSSL does not look in any directory and do not follow
  a chained certificate tree. yaSSL requires that all components
  of the CA certificate tree be contained within a single CA
  ...
  value of the [`ssl_ca`](server-system-variables.html#sysvar_ssl_ca) system
  variable and [`--ssl-ca`](connection-options.html#option_general_ssl-ca) option.

* OpenSSL supports certificate revocation-list capability (for
  the [`ssl_crl`](server-system-variables.html#sysvar_ssl_crl) and
  [`ssl_crlpath`](server-system-variables.html#sysvar_ssl_crlpath) system variables
  and [`--ssl-crl`](connection-options.html#option_general_ssl-crl) and
  [`--ssl-crlpath`](connection-options.html#option_general_ssl-crlpath) client options).
...
* OpenSSL supports more encryption modes for the
  ...
  [`AES_DECRYPT()`](encryption-functions.html#function_aes-decrypt) functions. See

...
If a change-user operation occurs during a session (see [mysql_change_user()](/doc/c-api/5.7/en/mysql-change-user.html)), filter assignment for the session is updated using the same rules but for the new user.

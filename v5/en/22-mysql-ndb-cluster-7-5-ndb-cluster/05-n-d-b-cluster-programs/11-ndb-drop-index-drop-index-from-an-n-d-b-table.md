...
[**ndb_drop_index**](mysql-cluster-programs-ndb-drop-index.html "21.5.11 ndb_drop_index — Drop Index from an NDB Table") drops the specified index from an [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table. *It is recommended that you use this utility only as an example for writing NDB API applications*—see the Warning later in this section for details.
...
Options that can be used with [**ndb_drop_index**](mysql-cluster-programs-ndb-drop-index.html "21.5.11 ndb_drop_index — Drop Index from an NDB Table") are shown in the following table. Additional descriptions follow the table.

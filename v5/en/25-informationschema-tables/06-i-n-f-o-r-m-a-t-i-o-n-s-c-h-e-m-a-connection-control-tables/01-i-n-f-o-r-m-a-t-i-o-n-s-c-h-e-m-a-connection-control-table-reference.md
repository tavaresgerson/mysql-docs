...
<table frame="box" rules="all" summary="A reference that lists INFORMATION_SCHEMA connection control tables."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Table Name</th> <th>Description</th> <th>Introduced</th> </tr></thead><tbody><tr><th scope="row"><a class="link" href="information-schema-connection-control-failed-login-attempts-table.html" title="24.6.2 The INFORMATION_SCHEMA CONNECTION_CONTROL_FAILED_LOGIN_ATTEMPTS Table"><code>CONNECTION_CONTROL_FAILED_LOGIN_ATTEMPTS</code></a></th> <td>Current number of consecutive failed connection attempts per account</td> <td>5.7.17</td> </tr></tbody></table>

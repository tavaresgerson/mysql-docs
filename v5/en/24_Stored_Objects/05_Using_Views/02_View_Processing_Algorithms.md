...
[`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") or
[`ALTER VIEW`](alter-view.html "13.1.10 ALTER VIEW Statement") is a MySQL extension to
...
* No `ALGORITHM` clause is present in the
  [`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statement.

* The [`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statement has

...
You can use [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") or
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") to drop or alter a
...
TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") can be used to check for views that have been
...
cannot call [`SHOW CREATE VIEW`](show-create-view.html "13.7.5.13 SHOW CREATE VIEW Statement") on
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"), which may fail due to insufficient
...
since MySQL does not grant it implicitly when views are created.

Views do not have indexes, so index hints do not apply. Use of
index hints when selecting from a view is not permitted.

[`SHOW CREATE VIEW`](show-create-view.html "13.7.5.13 SHOW CREATE VIEW Statement") displays view
...
column names in [`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement")
...
CREATE VIEW`](show-create-view.html "13.7.5.13 SHOW CREATE VIEW Statement") fail if any column alias exceeds 64
...
* Dump files created with [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") cannot be
...
VIEW`](drop-view.html "13.1.32 DROP VIEW Statement") and [`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement"), or
replace the definition with
[`CREATE OR REPLACE
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement").
...
[`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statements. However,

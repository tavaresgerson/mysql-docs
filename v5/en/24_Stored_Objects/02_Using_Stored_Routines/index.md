...
exists. See [Section 4.4.7, “mysql_upgrade — Check and Upgrade MySQL Tables”](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables").
...
* For answers to some commonly asked questions regarding stored
  routines in MySQL, see [Section A.4, “MySQL 5.7 FAQ: Stored Procedures and Functions”](faqs-stored-procs.html "A.4 MySQL 5.7 FAQ: Stored Procedures and Functions").

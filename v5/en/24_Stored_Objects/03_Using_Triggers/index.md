...
[`INSERT`](insert.html "13.2.5 INSERT Statement") or [`LOAD
DATA`](load-data.html "13.2.6 LOAD DATA Statement") statements, and an insert trigger activates for each
...
using the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") API.
...
* For answers to commonly asked questions regarding triggers in
  MySQL, see [Section A.5, “MySQL 5.7 FAQ: Triggers”](faqs-triggers.html "A.5 MySQL 5.7 FAQ: Triggers").

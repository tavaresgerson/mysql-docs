...
the type discussed in [Section 23.3, “Using Triggers”](triggers.html "23.3 Using Triggers"). Events should
...
* An event performs a specific action according to a schedule.
  ...
  [`BEGIN ...
  END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block if desired (see
  [Section 13.6, “Compound Statements”](sql-compound-statements.html "13.6 Compound Statements")). An event's timing
...
* Users can create, modify, and drop scheduled events using SQL
  ...
  fails. See [Section 23.4.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "23.4.6 The Event Scheduler and MySQL Privileges") for details.
...
* Many of the properties of an event can be set or modified
  ...
  is assigned. See [Section 13.1.2, “ALTER EVENT Statement”](alter-event.html "13.1.2 ALTER EVENT Statement").
  ...
  [`ALTER EVENT`](alter-event.html "13.1.2 ALTER EVENT Statement") statement affecting

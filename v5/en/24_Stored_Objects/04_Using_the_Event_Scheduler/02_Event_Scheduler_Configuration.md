...
of [`SHOW PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement"), as shown in
...
* `OFF`: The Event Scheduler is stopped. The
  ...
  output of [`SHOW PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement"), and
  no scheduled events execute. `OFF` is the
  default [`event_scheduler`](server-system-variables.html#sysvar_event_scheduler)
  value.
...
* `ON`: The Event Scheduler is started; the
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement") as a daemon
...
* `DISABLED`: This value renders the Event
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement")). In addition,
...
[`SET`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment")). It
is also possible to use `0` for
`OFF`, and `1` for
`ON` when setting this variable. Thus, any of the
following 4 statements can be used in the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
[`SELECT`](select.html "13.2.9 SELECT Statement") or [`SHOW
VARIABLES`](show-variables.html "13.7.5.39 SHOW VARIABLES Statement") is always one of `OFF`,
`ON`, or `DISABLED`.
...
MySQL provides an [`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") table in the
`INFORMATION_SCHEMA` database. This table can be
queried to obtain information about scheduled events which have
been defined on the server. See [Section 23.4.4, “Event Metadata”](events-metadata.html "23.4.4 Event Metadata"),
and [Section 24.3.8, “The INFORMATION\_SCHEMA EVENTS Table”](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table"), for more
information.

For information regarding event scheduling and the MySQL privilege
system, see [Section 23.4.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "23.4.6 The Event Scheduler and MySQL Privileges").
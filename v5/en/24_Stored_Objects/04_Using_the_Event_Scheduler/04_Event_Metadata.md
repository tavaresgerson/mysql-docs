...
* Query the [`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") table of the
...
* Use the [`SHOW CREATE EVENT`](show-create-event.html "13.7.5.7 SHOW CREATE EVENT Statement")
  statement. See [Section 13.7.5.7, “SHOW CREATE EVENT Statement”](show-create-event.html "13.7.5.7 SHOW CREATE EVENT Statement").

* Use the [`SHOW EVENTS`](show-events.html "13.7.5.18 SHOW EVENTS Statement") statement.
  See [Section 13.7.5.18, “SHOW EVENTS Statement”](show-events.html "13.7.5.18 SHOW EVENTS Statement").
...
[`CREATE EVENT`](create-event.html "13.1.12 CREATE EVENT Statement") or
[`ALTER EVENT`](alter-event.html "13.1.2 ALTER EVENT Statement") statement executes is
...
[`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") table or from
[`SHOW EVENTS`](show-events.html "13.7.5.18 SHOW EVENTS Statement"), but they are reported
...
<table summary="Summary of event time representation (as UTC, EZT, or STZ values) from mysql.event, INFORMATION_SCHEMA.EVENTS, and SHOW EVENTS."><col style="width: 25%"/><col style="width: 25%"/><col style="width: 25%"/><col style="width: 25%"/><thead><tr>
<th>Value</th>
<th><code>mysql.event</code></th>
<th><code>EVENTS</code> Table</th>
<th><code>SHOW EVENTS</code></th>
</tr></thead><tbody><tr>
<th>Execute at</th>
<td>UTC</td>
<td>ETZ</td>

...
made up of a [`BEGIN ...
END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block that contains a
[`SET`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment")
statement and a [`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement") loop that
...
If you use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client program to define a
stored program containing semicolon characters, a problem arises.
By default, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") itself recognizes the
semicolon as a statement delimiter, so you must redefine the
delimiter temporarily to cause [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") to pass
the entire stored program definition to the server.

To redefine the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") delimiter, use the
...
server rather than being interpreted by [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
itself.

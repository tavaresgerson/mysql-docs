...
capabilities of [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") with
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6"), some are clearly more
...
**Table 21.3 Supported application features according to the
...
<th>Preferred application requirements for
              <code>InnoDB</code></th>
<th>Preferred application requirements for <code>NDB</code></th>
</tr></thead><tbody><tr>
<td>

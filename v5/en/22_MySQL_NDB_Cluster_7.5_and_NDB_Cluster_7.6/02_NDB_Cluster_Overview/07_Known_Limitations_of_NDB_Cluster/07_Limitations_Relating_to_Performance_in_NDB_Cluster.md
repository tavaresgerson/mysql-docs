...
* **Range scans.**
  ...
  access to the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage
...
* **Reliability of Records in range.**
  ...
  the execution plan. See [Section 8.9.4, “Index Hints”](index-hints.html "8.9.4 Index Hints"), for

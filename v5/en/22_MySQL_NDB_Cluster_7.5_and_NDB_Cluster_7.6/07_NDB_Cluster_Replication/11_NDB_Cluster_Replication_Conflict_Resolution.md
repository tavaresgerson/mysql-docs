...
its type cannot be [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), as
...
* On the source writing the binary logs, you must determine
  ...
  by applying the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") startup option
  ...
  (such as [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") or
...
* `NDB` applies `WRITE_ROW`
  events strictly as inserts, requiring that there is not
  already any such row; that is, an incoming write is always
  rejected if the row already exists.
...
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"); instead, its data type
should be [`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
([`INTEGER`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")) or
[`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"). The
...
for [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), as described later in this
section.
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), or start a new
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") instance with different logging
options.
...
Replication. These functions are listed here in alphabetical
order:
...
coming from the source is higher than that on the replica, it is
...
* Tables having [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") or
...
recorded in the secondary's binary log, using
...
corresponding to each [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table for
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine. (An example
...
[Section 21.7.5, “Preparing the NDB Cluster for Replication”](mysql-cluster-replication-preparation.html "21.7.5 Preparing the NDB Cluster for Replication"), and
...
2. On the source, perform this
   ...
   on a specific [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") only, use the actual
   server ID.
...
**NDB$OLD() example.**
Suppose an [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table such as the

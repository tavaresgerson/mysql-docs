...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") from a `my.cnf` file
...
requires restarting each [**ndbd**](mysql-cluster-programs-ndbd.html "21.5.1 ndbd — The NDB Cluster Data Node Daemon") process with
the `--initial` option.
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") sources as

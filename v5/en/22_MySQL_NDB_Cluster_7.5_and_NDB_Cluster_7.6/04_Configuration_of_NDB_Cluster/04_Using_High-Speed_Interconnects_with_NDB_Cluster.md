...
Even before design of [`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") was designed from the very
beginning to permit the use of a number of different data
transport mechanisms, or transporters.

NDB Cluster 7.5 and 7.6 support three of these (see
[Section 21.2.1, “NDB Cluster Core Concepts”](mysql-cluster-basics.html "21.2.1 NDB Cluster Core Concepts")). A fourth transporter,

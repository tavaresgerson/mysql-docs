...
<td>TCP</td>
<td><code>SendBufferMemory</code> (default = 2M)</td>
</tr><tr>
<td>SHM</td>
<td>20K</td>
</tr></tbody></table>
...
* **ReservedSendBufferMemory.**
  ...
  <table frame="box" rules="all" summary="ReservedSendBufferMemory data node configuration parameter type and value information" width="35%"><col style="width: 50%"/><col style="width: 50%"/><tbody><tr>
...
<span class="bold"><strong>Node Restart:
  ...
  Previously, this data node parameter was present, but not
  actually used (Bug #77404, Bug #21280428).

You can use the
[`ndbinfo.transporters`](mysql-cluster-ndbinfo-transporters.html "21.6.15.44 The ndbinfo transporters Table") table to

...
([**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "21.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon")), each node that is part of an NDB
...
* For backward compatibility, two other options are available,
  ...
  These should be considered deprecated, and not used for new
  installations.

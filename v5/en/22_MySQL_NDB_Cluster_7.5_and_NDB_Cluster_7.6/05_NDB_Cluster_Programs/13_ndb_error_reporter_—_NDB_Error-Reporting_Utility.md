...
[**ndb\_error\_reporter**](mysql-cluster-programs-ndb-error-reporter.html "21.5.13 ndb_error_reporter — NDB Error-Reporting Utility") creates an archive from
...
[**ndb\_error\_reporter**](mysql-cluster-programs-ndb-error-reporter.html "21.5.13 ndb_error_reporter — NDB Error-Reporting Utility") are shown in the following
...
[**ndb\_error\_reporter**](mysql-cluster-programs-ndb-error-reporter.html "21.5.13 ndb_error_reporter — NDB Error-Reporting Utility") then includes all of these
...
[**ndb\_error\_reporter**](mysql-cluster-programs-ndb-error-reporter.html "21.5.13 ndb_error_reporter — NDB Error-Reporting Utility") also accepts the options
listed here:
...
<td><code>--dry-scp</code></td>
</tr></tbody></table>

  Run [**ndb\_error\_reporter**](mysql-cluster-programs-ndb-error-reporter.html "21.5.13 ndb_error_reporter — NDB Error-Reporting Utility") without using scp

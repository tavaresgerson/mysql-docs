...
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table") prints all rows from an
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table to
`stdout`.
...
Options that can be used with [**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table")
...
* `--gci`
  ...
  See [Section 21.2, “NDB Cluster Overview”](mysql-cluster-overview.html "21.2 NDB Cluster Overview"), and
  [Section 21.6.3.2, “NDB Cluster Log Events”](mysql-cluster-log-events.html "21.6.3.2 NDB Cluster Log Events"), for more
...
Output from a MySQL [`SELECT`](select.html "13.2.9 SELECT Statement")
statement:
...
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table"):
...
(`[`...`]`) in the output of
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table"). For another example, consider
...
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table") options:

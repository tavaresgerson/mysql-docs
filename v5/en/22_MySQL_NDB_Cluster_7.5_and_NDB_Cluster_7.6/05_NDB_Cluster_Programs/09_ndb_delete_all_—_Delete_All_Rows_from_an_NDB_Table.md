...
[**ndb\_delete\_all**](mysql-cluster-programs-ndb-delete-all.html "21.5.9 ndb_delete_all — Delete All Rows from an NDB Table") deletes all rows from the
given [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table. In some cases,
this can be much faster than
[`DELETE`](delete.html "13.2.2 DELETE Statement") or even
...
Options that can be used with [**ndb\_delete\_all**](mysql-cluster-programs-ndb-delete-all.html "21.5.9 ndb_delete_all — Delete All Rows from an NDB Table")

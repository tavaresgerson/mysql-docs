...
[**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables") displays a list of all
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") database objects in the
cluster. By default, this includes not only both user-created
tables and [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") system tables, but
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")-specific indexes, internal
triggers, and NDB Cluster Disk Data objects as well.

Options that can be used with [**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables")
...
* `--database`, `-d`
  ...
  [**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables") issues a warning.
...
* `--type`, `-t`
  ...
  Any other value causes all [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
...
not visible to [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"). However, you can
examine the contents of system tables using
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") API applications such as
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table") (see
...
`NDBT` testing library. This dependency is has

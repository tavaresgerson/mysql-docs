...
[**ndb\_drop\_index**](mysql-cluster-programs-ndb-drop-index.html "21.5.11 ndb_drop_index — Drop Index from an NDB Table") drops the specified index from
an [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table. *It is
...
Options that can be used with [**ndb\_drop\_index**](mysql-cluster-programs-ndb-drop-index.html "21.5.11 ndb_drop_index — Drop Index from an NDB Table")
...
statement[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") or the
[**ndb\_drop\_table**](mysql-cluster-programs-ndb-drop-table.html "21.5.12 ndb_drop_table — Drop an NDB Table") utility (see
[Section 21.5.12, “ndb\_drop\_table — Drop an NDB Table”](mysql-cluster-programs-ndb-drop-table.html "21.5.12 ndb_drop_table — Drop an NDB Table")) to drop
the table.
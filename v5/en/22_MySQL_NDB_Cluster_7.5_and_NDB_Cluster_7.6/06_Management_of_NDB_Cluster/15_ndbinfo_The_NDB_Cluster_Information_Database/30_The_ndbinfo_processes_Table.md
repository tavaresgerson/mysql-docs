...
[`nodes`](mysql-cluster-ndbinfo-nodes.html "21.6.15.28 The ndbinfo nodes Table") and
[`config_nodes`](mysql-cluster-ndbinfo-config-nodes.html "21.6.15.7 The ndbinfo config_nodes Table") tables.
...
`node_version` shows the two-part MySQL NDB
Cluster version string, such as
`5.7.44-ndb-7.5.36` or
`5.7.44-ndb-7.6.36`, that it was
compiled with. See
[Version strings used in NDB Cluster software](mysql-cluster-general-info.html#mysql-cluster-version-strings "Version strings used in NDB Cluster software"), for more
information.
...
[`Ndb_cluster_connection::set_name()`](/doc/ndbapi/en/ndb-ndb-cluster-connection.html#ndb-ndb-cluster-connection-set-name).

...
[**ndb\_perror**](mysql-cluster-programs-ndb-perror.html "21.5.17 ndb_perror — Obtain NDB Error Message Information") or [**perror**](perror.html "4.8.2 perror — Display MySQL Error Message Information")
...
The `error_messages` table was added in NDB
7.6.
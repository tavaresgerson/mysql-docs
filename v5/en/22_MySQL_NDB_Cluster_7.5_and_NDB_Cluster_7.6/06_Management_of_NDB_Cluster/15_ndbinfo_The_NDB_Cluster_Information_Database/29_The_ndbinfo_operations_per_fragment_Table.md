...
is added by [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"); for an index created by a
...
[**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables") utility.
...
[`threadblocks`](mysql-cluster-ndbinfo-threadblocks.html "21.6.15.41 The ndbinfo threadblocks Table") table. The first
such instance is always numbered 0.

Since there are typically two replicas, and assuming that this
is so, each `fragment_num` value should appear
...
[`REPLACE`](replace.html "13.2.8 REPLACE Statement") SQL statement.)

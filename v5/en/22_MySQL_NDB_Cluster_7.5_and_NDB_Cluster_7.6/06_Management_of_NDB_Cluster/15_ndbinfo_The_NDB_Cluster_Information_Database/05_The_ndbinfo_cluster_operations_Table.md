#### 21.6.15.5 The ndbinfo cluster\_operations Table
...
[The DBLQH Block](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dblqh.html)).
...
respectively, the [`DBLQH`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dblqh.html) and
[`DBTC`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbtc.html) block instance numbers.

...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") instance, and serves as a companion
table to [`server_operations`](mysql-cluster-ndbinfo-server-operations.html "21.6.15.34 The ndbinfo server_operations Table").
...
output of [**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables").
...
The `server_locks` table was added in NDB
7.5.3.
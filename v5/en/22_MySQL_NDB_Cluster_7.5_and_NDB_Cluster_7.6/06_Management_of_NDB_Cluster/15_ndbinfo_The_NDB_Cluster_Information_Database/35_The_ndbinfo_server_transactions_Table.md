...
the [`cluster_transactions`](mysql-cluster-ndbinfo-cluster-transactions.html "21.6.15.6 The ndbinfo cluster_transactions Table")
...
threads from the [`threadblocks`](mysql-cluster-ndbinfo-threadblocks.html "21.6.15.41 The ndbinfo threadblocks Table")
table.
...
The [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") management client's
[`CLUSTERLOG STATISTICS`](mysql-cluster-logging-management-commands.html "21.6.3.1 NDB Cluster Logging Management Commands")
...
in a cluster having two fragment replicas, the write to the
...
[**ndbd**](mysql-cluster-programs-ndbd.html "21.5.1 ndbd — The NDB Cluster Data Node Daemon") process has a scheduler which also
...
the following command in the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
management client:

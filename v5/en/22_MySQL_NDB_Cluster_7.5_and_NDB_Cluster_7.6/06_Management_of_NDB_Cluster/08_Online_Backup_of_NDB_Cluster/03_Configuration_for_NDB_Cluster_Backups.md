...
In addition,
[`CompressedBackup`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-compressedbackup) causes
...
[Backup
Parameters](mysql-cluster-ndbd-definition.html#mysql-cluster-backup-parameters "Backup parameters").
...
[`FileSystemPath`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-filesystempath)`/BACKUP/BACKUP-backup_id`.
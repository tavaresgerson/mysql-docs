...
[`BackupMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-backupmemory) as well.

You should also make sure that there is sufficient space on the
hard drive partition of the backup target.

[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") does not support repeatable

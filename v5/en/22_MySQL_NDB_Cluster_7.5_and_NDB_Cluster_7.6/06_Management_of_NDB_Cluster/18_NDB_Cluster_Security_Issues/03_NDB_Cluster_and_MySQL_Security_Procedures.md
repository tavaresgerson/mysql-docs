...
can verify that the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") process is running
...
If the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") process is running as any other
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server")) is owned by the
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") running as another user
unintentionally. The [`mysqld_safe`](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script") startup
script forces MySQL to run as the `mysql` user.

Important

Never run [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") as the system root user.
...
[Section 21.6.18.2, “NDB Cluster and MySQL Privileges”](mysql-cluster-security-mysql-privileges.html "21.6.18.2 NDB Cluster and MySQL Privileges")), you
...
[`DELETE`](delete.html "13.2.2 DELETE Statement") statement not to omit the
...
[**ndb\_show\_tables**](mysql-cluster-programs-ndb-show-tables.html "21.5.27 ndb_show_tables — Display List of NDB Tables"),
[**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "21.5.10 ndb_desc — Describe NDB Tables"), and
[**ndb\_select\_all**](mysql-cluster-programs-ndb-select-all.html "21.5.25 ndb_select_all — Print Rows from an NDB Table") also work without
...
See [Section 21.5, “NDB Cluster Programs”](mysql-cluster-programs.html "21.5 NDB Cluster Programs"), for more

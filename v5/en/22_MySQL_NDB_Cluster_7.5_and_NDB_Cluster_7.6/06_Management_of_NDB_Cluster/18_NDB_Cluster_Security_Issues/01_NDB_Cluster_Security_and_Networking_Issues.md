...
effectively slow communications.
...
* SQL or API nodes using “free slots” created by
  ...
  parameter. Also see [Section 21.4.1, “Quick Test Setup of NDB Cluster”](mysql-cluster-quick.html "21.4.1 Quick Test Setup of NDB Cluster"),
...
1. Keeping Cluster nodes on a network that is physically
   ...
   **Figure 21.9 NDB Cluster with Hardware Firewall**
   ...
   [Section 6.1.3, “Making MySQL Secure Against Attackers”](security-against-attack.html "6.1.3 Making MySQL Secure Against Attackers"), for a
...
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "21.5.5 ndb_mgm — The NDB Cluster Management Client") to manage a Cluster directly from

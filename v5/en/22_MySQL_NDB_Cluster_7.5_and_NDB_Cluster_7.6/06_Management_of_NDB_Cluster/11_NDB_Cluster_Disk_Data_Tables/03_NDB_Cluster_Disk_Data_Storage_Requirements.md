...
* Variable-length columns of Disk Data tables take up a fixed
  ...
  Schema [`FILES`](information-schema-files-table.html "24.3.9 The INFORMATION_SCHEMA FILES Table") table. For more
  ...
  The [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement")
...
* In a Disk Data table, the first 256 bytes of a
  ...
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") column are stored in
...
[`diskpagebuffer`](mysql-cluster-ndbinfo-diskpagebuffer.html "21.6.15.20 The ndbinfo diskpagebuffer Table") table to help

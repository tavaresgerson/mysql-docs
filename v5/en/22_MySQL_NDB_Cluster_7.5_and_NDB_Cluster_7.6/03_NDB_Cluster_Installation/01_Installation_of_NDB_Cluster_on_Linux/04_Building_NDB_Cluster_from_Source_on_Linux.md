...
[Section 2.8, “Installing MySQL from Source”](source-installation.html "2.8 Installing MySQL from Source"). For information about
...
The [`WITH_NDBCLUSTER_STORAGE_ENGINE`](source-configuration-options.html#option_cmake_with_ndbcluster_storage_engine)
option for **CMake** causes the binaries for the
management nodes, data nodes, and other NDB Cluster programs to
be built; it also causes [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") to be
compiled with [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine
support. This option (or its alias
[`WITH_NDBCLUSTER`](source-configuration-options.html#option_cmake_with_ndbcluster)) is required when
building NDB Cluster.

Important

The [`WITH_NDB_JAVA`](source-configuration-options.html#option_cmake_with_ndb_java) option is
...
[`WITH_CLASSPATH`](source-configuration-options.html#option_cmake_with_classpath) to provide the
...
management client binaries ([**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "21.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") and
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "21.5.5 ndb_mgm — The NDB Cluster Management Client")) can be found in
`/usr/local/mysql/bin`. Only
[**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "21.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") is required to be present on a
management node host; however, it is also a good idea to have
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "21.5.5 ndb_mgm — The NDB Cluster Management Client") present on the same host machine.
...
node binary [**ndbd**](mysql-cluster-programs-ndbd.html "21.5.1 ndbd — The NDB Cluster Data Node Daemon") or
[**ndbmtd**](mysql-cluster-programs-ndbmtd.html "21.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)"). ([`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), for
...
[**ndbd**](mysql-cluster-programs-ndbd.html "21.5.1 ndbd — The NDB Cluster Data Node Daemon") or [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "21.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") need be
...
Configuring the build with [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
storage engine support causes [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "21.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") to be
built automatically; **make install** places the
[**ndbmtd**](mysql-cluster-programs-ndbmtd.html "21.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") binary in the installation
`bin` directory along with
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), [**ndbd**](mysql-cluster-programs-ndbd.html "21.5.1 ndbd — The NDB Cluster Data Node Daemon"), and
[**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "21.5.5 ndb_mgm — The NDB Cluster Management Client").
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") is placed in
`/usr/local/mysql/bin`. Follow the steps
given in [Section 2.8, “Installing MySQL from Source”](source-installation.html "2.8 Installing MySQL from Source") to make
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") ready for use. If you want to run
multiple SQL nodes, you can use a copy of the same
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") executable and its associated
...
[Section 2.8, “Installing MySQL from Source”](source-installation.html "2.8 Installing MySQL from Source") on each machine. If you
configure the build with a nondefault `PREFIX`
option, you must adjust the directory accordingly.

In [Section 21.3.3, “Initial Configuration of NDB Cluster”](mysql-cluster-install-configuration.html "21.3.3 Initial Configuration of NDB Cluster"), we

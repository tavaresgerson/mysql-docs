...
* For a table to be replicated in the cluster, it must use the
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine. To
  ...
  storage engine, use [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
* Every [`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table has a
  primary key. If no primary key is defined by the user when a
  table is created, the [`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
...
output of [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"), you can open the SQL
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") statements necessary to
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine for this
...
tables, and then use [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") to
...
then use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") command-line client to read
...
on the SQL node, use [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") on the
...
Running [`SELECT`](select.html "13.2.9 SELECT Statement") queries on the SQL
...
between nodes. See
[Section 21.6.18.2, “NDB Cluster and MySQL Privileges”](mysql-cluster-security-mysql-privileges.html "21.6.18.2 NDB Cluster and MySQL Privileges"), for
more information.
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables. It is important to
...
might execute the [`SELECT`](select.html "13.2.9 SELECT Statement") statement

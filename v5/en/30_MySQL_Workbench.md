...
and databases. MySQL Workbench is developed and tested with MySQL Server
8.0. MySQL Workbench may connect to MySQL Server 8.4 and higher but some
MySQL Workbench features may not function with those newer server
versions.
...
[https://dev.mysql.com/doc/workbench/en/](/doc/workbench/en/).

MySQL Workbench provides five main areas of functionality:

* **SQL Development**: Enables you to

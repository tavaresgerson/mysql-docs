...
Antelope
:   The code name for the original `InnoDB`
    **file format**. It supports the
    **REDUNDANT** and
    ...
    **COMPRESSED** row formats
    ...
    See Also [Barracuda](glossary.html#glos_barracuda), [compact row format](glossary.html#glos_compact_row_format), [compressed row format](glossary.html#glos_compressed_row_format), [dynamic row format](glossary.html#glos_dynamic_row_format), [file format](glossary.html#glos_file_format), [innodb\_file\_format](glossary.html#glos_innodb_file_format), [redundant row format](glossary.html#glos_redundant_row_format).
...
:   An atomic *DDL* statement is one that
    ...
    *binary log* writes associated with a DDL
    ...
    For more information, see [Atomic Data Definition Statement Support](/doc/refman/8.0/en/atomic-ddl.html).

    See Also [binary log](glossary.html#glos_binary_log), [data dictionary](glossary.html#glos_data_dictionary), [DDL](glossary.html#glos_ddl), [storage engine](glossary.html#glos_storage_engine).
...
:   A setting that causes a **commit**
    ...
    **undo** data, especially in MySQL
    ...
    [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables, where transactions
    are not applicable.
...
:   A licensed product that performs **hot
    ...
    [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables, but can also back up
    [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") and other kinds of tables.
...
:   A tree data structure that is popular for use in database
    ...
    engines, such as [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") and
    ...
    is only available in the [`MEMORY`](memory-storage-engine.html "15.3 The MEMORY Storage Engine")
...
Barracuda
:   The code name for an `InnoDB`
    **file format** that supports the
    **COMPRESSED** row format that
    enables InnoDB table compression, and the
    **DYNAMIC** row format that
    improves the storage layout for long variable-length columns.

    The **MySQL Enterprise Backup** product version 3.5
    and above supports backing up tablespaces that use the Barracuda
    file format.

    See Also [Antelope](glossary.html#glos_antelope), [compact row format](glossary.html#glos_compact_row_format), [compressed row format](glossary.html#glos_compressed_row_format), [dynamic row format](glossary.html#glos_dynamic_row_format), [file format](glossary.html#glos_file_format), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [innodb\_file\_format](glossary.html#glos_innodb_file_format), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [row format](glossary.html#glos_row_format), [system tablespace](glossary.html#glos_system_tablespace).
...
:   A non-generated table column upon which a stored generated
    ...
    See Also [generated column](glossary.html#glos_generated_column), [stored generated column](glossary.html#glos_stored_generated_column), [virtual generated column](glossary.html#glos_virtual_generated_column).
...
:   A file containing a record of all statements or row changes that
    ...
    **replication** scenario, or to
    ...
    [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") command. For full information
    about the binary log, see [Section 5.4.4, “The Binary Log”](binary-log.html "5.4.4 The Binary Log"). For
...
BLOB
:   An SQL data type ([`TINYBLOB`](blob.html "11.3.4 The BLOB and TEXT Types"),
    [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types"),
    [`MEDIUMBLOB`](blob.html "11.3.4 The BLOB and TEXT Types"), and
    [`LONGBLOB`](blob.html "11.3.4 The BLOB and TEXT Types")) for objects containing
...
:   A metadata file used with the `InnoDB`
    ...
    **space ID**, during the
    ...
    See Also [.ibd file](glossary.html#glos_ibd_file), [space ID](glossary.html#glos_space_id), [transportable tablespace](glossary.html#glos_transportable_tablespace).
...
:   The number of different values in a table
    ...
    **composite index**.
    ...
    See Also [column](glossary.html#glos_column), [composite index](glossary.html#glos_composite_index), [index](glossary.html#glos_index), [index hint](glossary.html#glos_index_hint), [persistent statistics](glossary.html#glos_persistent_statistics), [random dive](glossary.html#glos_random_dive), [selectivity](glossary.html#glos_selectivity), [unique constraint](glossary.html#glos_unique_constraint).

change buffer
:   A special data structure that records changes to
    **pages** in
    **secondary indexes**. These values
    could result from SQL [`INSERT`](insert.html "13.2.5 INSERT Statement"),
...
:   In `InnoDB`, a validation mechanism to detect
    ...
    **tablespace** is read from disk
    ...
    The [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") command helps diagnose
    ...
    [`source_verify_checksum`](/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_source_verify_checksum) or
    [`master_verify_checksum`](replication-options-binary-log.html#sysvar_master_verify_checksum), and
    [`replica_sql_verify_checksum`](/doc/refman/8.0/en/replication-options-replica.html#sysvar_replica_sql_verify_checksum) or
...
:   A program that runs outside the database server, communicating
    ...
    **client libraries**. It can run on
    ...
    [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") command-line processor.
...
:   A type of **prepared statement**
    ...
    **Connector/PHP** developers to
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [Connector/ODBC](glossary.html#glos_connector_odbc), [Connector/PHP](glossary.html#glos_connector_php), [prepared statement](glossary.html#glos_prepared_statement).

CLOB
:   An SQL data type ([`TINYTEXT`](blob.html "11.3.4 The BLOB and TEXT Types"),
    [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types"),
    [`MEDIUMTEXT`](blob.html "11.3.4 The BLOB and TEXT Types"), or
    [`LONGTEXT`](blob.html "11.3.4 The BLOB and TEXT Types")) for objects containing
...
:   Synonym for **statement
    ...
    **exception interceptor**.
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [Connector/NET](glossary.html#glos_connector_net), [exception interceptor](glossary.html#glos_exception_interceptor), [interceptor](glossary.html#glos_interceptor), [statement interceptor](glossary.html#glos_statement_interceptor).
...
:   The default `InnoDB` **row
    format** for InnoDB tables from MySQL 5.0.3 to MySQL
    5.7.8. As of MySQL 5.7.9, the default row format is defined by
    ...
    **COMPACT** row format provides a
    ...
    columns than the prior default
    ...
    See Also [Antelope](glossary.html#glos_antelope), [dynamic row format](glossary.html#glos_dynamic_row_format), [file format](glossary.html#glos_file_format), [redundant row format](glossary.html#glos_redundant_row_format), [row format](glossary.html#glos_row_format).
...
:   The compression feature of the
    ...
    **binary log** takes longer, and
    ...
    See Also [apply](glossary.html#glos_apply), [binary log](glossary.html#glos_binary_log), [compression](glossary.html#glos_compression), [hot backup](glossary.html#glos_hot_backup), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [tablespace](glossary.html#glos_tablespace).
...
:   A **row format** that enables data
    ...
    **Barracuda** file format. Large
    ...
    format**. Both index pages and large fields are
    ...
    [Section 14.9, “InnoDB Table and Page Compression”](innodb-compression.html "14.9 InnoDB Table and Page Compression") for usage details.

    For additional information about `InnoDB`
    `COMPRESSED` row format, see
    [DYNAMIC Row Format](innodb-row-format.html#innodb-row-format-dynamic "DYNAMIC Row Format").

    See Also [Barracuda](glossary.html#glos_barracuda), [compression](glossary.html#glos_compression), [dynamic row format](glossary.html#glos_dynamic_row_format), [row format](glossary.html#glos_row_format).

compressed table
:   A table for which the data is stored in compressed form. For
    `InnoDB`, it is a table created with
    `ROW_FORMAT=COMPRESSED`. See
    [Section 14.9, “InnoDB Table and Page Compression”](innodb-compression.html "14.9 InnoDB Table and Page Compression") for more information.

    See Also [compressed row format](glossary.html#glos_compressed_row_format), [compression](glossary.html#glos_compression).
...
:   A feature with wide-ranging benefits from using less disk space,
    ...
    **transparent page compression**.
    ...
    compression, see [Section 14.9, “InnoDB Table and Page Compression”](innodb-compression.html "14.9 InnoDB Table and Page Compression").

    Another type of compression is the
    **compressed backup** feature of
    the **MySQL Enterprise Backup** product.

    See Also [Barracuda](glossary.html#glos_barracuda), [buffer pool](glossary.html#glos_buffer_pool), [compressed backup](glossary.html#glos_compressed_backup), [compressed row format](glossary.html#glos_compressed_row_format), [DML](glossary.html#glos_dml), [transparent page compression](glossary.html#glos_transparent_page_compression).
...
:   Not actually an error, rather an expensive operation that can
    ...
    **page** overflow the area on the
    ...
    condition, query the
    [`INFORMATION_SCHEMA.INNODB_CMP`](information-schema-innodb-cmp-table.html "24.4.5 The INFORMATION_SCHEMA INNODB_CMP and INNODB_CMP_RESET Tables") table
    ...
    See Also [compression](glossary.html#glos_compression), [DML](glossary.html#glos_dml), [page](glossary.html#glos_page).
...
:   The file that holds the **option**
    ...
    See [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files") for information about where
...
:   A cache area that allows database
    ...
    **Tomcat** and other application
    ...
    See Also [connection](glossary.html#glos_connection), [Connector/J](glossary.html#glos_connector_j), [J2EE](glossary.html#glos_j2ee), [Tomcat](glossary.html#glos_tomcat).
...
:   MySQL Connectors provide connectivity to the MySQL server for
    **client** programs. Several
    ...
    See Also [API](glossary.html#glos_api), [client](glossary.html#glos_client), [Connector/C++](glossary.html#glos_connector_c__), [Connector/J](glossary.html#glos_connector_j), [Connector/NET](glossary.html#glos_connector_net), [Connector/ODBC](glossary.html#glos_connector_odbc).

Connector/C++
:   Connector/C++ 8.0 can be used to access MySQL servers that implement a
    [document store](document-store.html "Chapter 19 Using MySQL as a Document Store"), or in a
    ...
    information, see [MySQL Connector/C++ 9.5 Developer Guide](/doc/connector-cpp/9.4/en/).
...
:   A **JDBC** driver that provides
    ...
    **Java** programming language.
    Different versions are available that are compatible with the
    JDBC 3.0 and JDBC 4.0 specifications. MySQL Connector/J is a
    JDBC Type 4 driver: a pure-Java implementation of the MySQL
    protocol that does not rely on the MySQL
    **client libraries**. For full
    details, see [MySQL Connector/J Developer Guide](/doc/connector-j/en/).

    See Also [client](glossary.html#glos_client), [client libraries](glossary.html#glos_client_libraries), [connector](glossary.html#glos_connector), [Java](glossary.html#glos_java), [JDBC](glossary.html#glos_jdbc).
...
:   The cleanup activities that occur when MySQL is started again
    ...
    **change buffer** for a period of
    ...
    See Also [change buffer](glossary.html#glos_change_buffer), [commit](glossary.html#glos_commit), [crash](glossary.html#glos_crash), [data files](glossary.html#glos_data_files), [doublewrite buffer](glossary.html#glos_doublewrite_buffer), [InnoDB](glossary.html#glos_innodb), [purge](glossary.html#glos_purge), [redo log](glossary.html#glos_redo_log).
...
:   Metadata that keeps track of InnoDB-related objects such as
    ...
    **system tablespace**. For
    historical reasons, it overlaps to some degree with information
    stored in the **.frm files**.

    Because the **MySQL Enterprise Backup** product
    always backs up the system tablespace, all backups include the
    contents of the data dictionary.

    See Also [column](glossary.html#glos_column), [file-per-table](glossary.html#glos_file_per_table), [.frm file](glossary.html#glos_frm_file), [index](glossary.html#glos_index), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [system tablespace](glossary.html#glos_system_tablespace), [table](glossary.html#glos_table).
...
:   The files that physically contain
    ...
    **data dictionary** and is capable
    ...
    See Also [data dictionary](glossary.html#glos_data_dictionary), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [.ibd file](glossary.html#glos_ibd_file), [ibdata file](glossary.html#glos_ibdata_file), [index](glossary.html#glos_index), [system tablespace](glossary.html#glos_system_tablespace), [table](glossary.html#glos_table), [tablespace](glossary.html#glos_tablespace).
...
:   Within the MySQL **data
    ...
    **instance**, and can be assigned
    ...
    See Also [data files](glossary.html#glos_data_files), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [instance](glossary.html#glos_instance), [schema](glossary.html#glos_schema), [system tablespace](glossary.html#glos_system_tablespace).

DCL
:   Data control language, a set of
    **SQL** statements for managing
    privileges. In MySQL, consists of the
    [`GRANT`](grant.html "13.7.1.4 GRANT Statement") and
    [`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement") statements. Contrast with
    **DDL** and
    **DML**.
...
:   Data definition language, a set of
    ...
    **rolled back**.
    ...
    INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"), [`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement"), and
    many types of [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
    operations. See [Section 14.13, “InnoDB and Online DDL”](innodb-online-ddl.html "14.13 InnoDB and Online DDL") for more
    ...
    TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") and [`TRUNCATE
    TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") operations.
...
:   A situation where different
    ...
    **gaps**, with each transaction
    ...
    [Section 14.7.5.2, “Deadlock Detection”](innodb-deadlock-detection.html "14.7.5.2 Deadlock Detection"). For tips on
...
:   A mechanism that automatically detects when a
    ...
    **victim**). Deadlock detection can
    ...
    See Also [deadlock](glossary.html#glos_deadlock), [rollback](glossary.html#glos_rollback), [transaction](glossary.html#glos_transaction), [victim](glossary.html#glos_victim).
...
:   When `InnoDB` processes a
    ...
    **DROP**.
    ...
    See Also [drop](glossary.html#glos_drop), [purge](glossary.html#glos_purge), [truncate](glossary.html#glos_truncate).
...
descending index
:   A type of **index** available with
    some database systems, where index storage is optimized to
    process `ORDER BY column
    DESC` clauses. Currently, although MySQL allows the
    `DESC` keyword in the
    [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement, it does
    not use any special storage layout for the resulting index.
...
:   Data manipulation language, a set of
    **SQL** statements for performing
    ...
    [`DELETE`](delete.html "13.2.2 DELETE Statement") operations. The
    [`SELECT`](select.html "13.2.9 SELECT Statement") statement is sometimes
...
:   `InnoDB` uses a file flush technique called
    ...
    **data files**,
    ...
    storage subsystem or [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") process crash in
    ...
    **crash recovery**.
    ...
    See Also [crash recovery](glossary.html#glos_crash_recovery), [data files](glossary.html#glos_data_files), [page](glossary.html#glos_page), [purge](glossary.html#glos_purge).
...
:   A kind of **DDL** operation that
    ...
    [`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement"). It maps internally to
    an [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. From an
    ...
    **truncate** operation
    ([`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") statement).

    See Also [buffer pool](glossary.html#glos_buffer_pool), [data dictionary](glossary.html#glos_data_dictionary), [DDL](glossary.html#glos_ddl), [table](glossary.html#glos_table), [truncate](glossary.html#glos_truncate).
...
:   A row format introduced in the `InnoDB` Plugin,
    ...
    **file format**. Because long
    ...
    See Also [Barracuda](glossary.html#glos_barracuda), [buffer pool](glossary.html#glos_buffer_pool), [file format](glossary.html#glos_file_format), [row format](glossary.html#glos_row_format).
...
:   A programming language including many object-oriented features.
    ...
    **C#** developers. For the
    ...
    MySQL, see [Section 27.13, “MySQL Eiffel Wrapper”](apis-eiffel.html "27.13 MySQL Eiffel Wrapper").
...
:   A type of **log** showing
    ...
    **crash** information. For details,
    see [Section 5.4.2, “The Error Log”](error-log.html "5.4.2 The Error Log").
...
:   A type of **interceptor** for
    ...
    **Connector/J**, setting up this
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [Connector/NET](glossary.html#glos_connector_net), [interceptor](glossary.html#glos_interceptor), [Java](glossary.html#glos_java), [Visual Studio](glossary.html#glos_visual_studio).
...
:   A file containing the metadata, such as the table definition, of
    ...
    `.frm` file, `InnoDB`
    maintains its own table metadata in the
    **system tablespace**.

    `.frm` files are backed up by the
    **MySQL Enterprise Backup** product. These files must
    not be modified by an [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
    operation while the backup is taking place, which is why backups
    that include non-`InnoDB` tables perform a
    [`FLUSH TABLES WITH READ LOCK`](flush.html#flush-tables-with-read-lock)
    operation to freeze such activity while backing up
    `.frm` files. Restoring a backup can result
    in `.frm` files being created, changed, or
    removed to match the state of the database at the time of the
    backup.

    See Also [data dictionary](glossary.html#glos_data_dictionary), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [system tablespace](glossary.html#glos_system_tablespace).
...
:   The ability to automatically switch to a standby server in the
    ...
    **J2EE** environments by the
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [J2EE](glossary.html#glos_j2ee).
...
:   A capability first introduced in the InnoDB Plugin, now part of
    ...
    more kinds of [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
file format
:   The file format for `InnoDB` tables, enabled
    using the [`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format)
    configuration option. Supported file formats are
    **Antelope** and
    **Barracuda**. Antelope is the
    original `InnoDB` file format and supports the
    **REDUNDANT** and
    **COMPACT** row formats. Barracuda
    is the newer `InnoDB` file format and supports
    the **COMPRESSED** and
    **DYNAMIC** row formats.

    See Also [Antelope](glossary.html#glos_antelope), [Barracuda](glossary.html#glos_barracuda), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [ibdata file](glossary.html#glos_ibdata_file), [row format](glossary.html#glos_row_format).
...
:   A general name for the setting controlled by the
    ...
    **compression**. The
    ...
    See Also [compressed row format](glossary.html#glos_compressed_row_format), [compression](glossary.html#glos_compression), [file format](glossary.html#glos_file_format), [.ibd file](glossary.html#glos_ibd_file), [ibdata file](glossary.html#glos_ibdata_file), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [row format](glossary.html#glos_row_format), [system tablespace](glossary.html#glos_system_tablespace).
...
:   In an `InnoDB`
    ...
    **page** that is taken up by index
    ...
    [Section 14.6.2.2, “The Physical Structure of an InnoDB Index”](innodb-physical-structure.html "14.6.2.2 The Physical Structure of an InnoDB Index") for more
    information.
...
:   This row format is used by the `MyISAM` storage
    ...
    See Also [compact row format](glossary.html#glos_compact_row_format), [row format](glossary.html#glos_row_format).
...
:   A **backup** that includes all the
    ...
    **database**, and all the databases
    ...
    See Also [backup](glossary.html#glos_backup), [database](glossary.html#glos_database), [instance](glossary.html#glos_instance), [partial backup](glossary.html#glos_partial_backup), [table](glossary.html#glos_table).
...
:   A type of **log** used for
    ...
    **binary log**, which is used for
    ...
    [`SELECT`](select.html "13.2.9 SELECT Statement") statements and does not
...
:   A shared `InnoDB`
    **tablespace** created using
    [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") syntax. General
    ...
    **tables**, and support tables of
    ...
    [`CREATE TABLE
    tbl_name ... TABLESPACE [=]
    tablespace_name`](create-table.html "13.1.18 CREATE TABLE Statement") or
    [`ALTER TABLE
    tbl_name TABLESPACE [=]
    tablespace_name`](alter-table.html "13.1.8 ALTER TABLE Statement") syntax.

    Contrast with **system tablespace**
    and **file-per-table** tablespace.

    For more information, see [Section 14.6.3.3, “General Tablespaces”](general-tablespaces.html "14.6.3.3 General Tablespaces").

    See Also [file-per-table](glossary.html#glos_file_per_table), [system tablespace](glossary.html#glos_system_tablespace), [table](glossary.html#glos_table), [tablespace](glossary.html#glos_tablespace).
...
:   A column whose values are computed from an expression included
    ...
    **stored**.
    ...
    See Also [base column](glossary.html#glos_base_column), [stored generated column](glossary.html#glos_stored_generated_column), [virtual generated column](glossary.html#glos_virtual_generated_column).

generated stored column
:   See [stored generated column](glossary.html#glos_stored_generated_column).

generated virtual column
:   See [virtual generated column](glossary.html#glos_virtual_generated_column).
...
:   A type of **transaction** involved
    ...
    **ACID** properties “up a
    ...
    See Also [ACID](glossary.html#glos_acid), [transaction](glossary.html#glos_transaction), [XA](glossary.html#glos_xa).
...
:   A type of **index** intended for
    ...
    available for [`MEMORY`](memory-storage-engine.html "15.3 The MEMORY Storage Engine") tables.
    Although hash indexes are the default for
    [`MEMORY`](memory-storage-engine.html "15.3 The MEMORY Storage Engine") tables for historic reasons,
    ...
    **adaptive hash index**, that is
    ...
    [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables if needed based on
    runtime conditions.
...
:   A list of **transactions** with
    ...
    See Also [DML](glossary.html#glos_dml), [flush](glossary.html#glos_flush), [purge](glossary.html#glos_purge), [purge lag](glossary.html#glos_purge_lag), [rollback segment](glossary.html#glos_rollback_segment), [transaction](glossary.html#glos_transaction), [undo log](glossary.html#glos_undo_log).
...
:   The data file for
    **file-per-table** tablespaces and
    ...
    table and index data for multiple tables. General tablespaces
    ...
    **system tablespace**, which
    ...
    outside the normal data directory, and is pointed to by a
    **.isl file**.
    ...
    See Also [database](glossary.html#glos_database), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [ibdata file](glossary.html#glos_ibdata_file), [.ibz file](glossary.html#glos_ibz_file), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [.isl file](glossary.html#glos_isl_file), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [system tablespace](glossary.html#glos_system_tablespace).
...
:   When the **MySQL Enterprise Backup** product performs
    ...
    **compressed row format** that
    ...
    See Also [compressed backup](glossary.html#glos_compressed_backup), [compressed row format](glossary.html#glos_compressed_row_format), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [tablespace](glossary.html#glos_tablespace).

.isl file
:   A file that specifies the location of an
    **.ibd file** for an
    `InnoDB` table created with the `DATA
    DIRECTORY =` clause in MySQL 5.6 and higher, or with
    the `CREATE TABLESPACE ... ADD DATAFILE` clause
    in MySQL 5.7 and higher. It functions like a symbolic link,
    without the platform restrictions of the actual symbolic link
    mechanism. You can store `InnoDB`
    ...
    **database** directory, for
    ...
    [Section 14.6.1.2, “Creating Tables Externally”](innodb-create-table-external.html "14.6.1.2 Creating Tables Externally"), and
    [Section 14.6.3.3, “General Tablespaces”](general-tablespaces.html "14.6.3.3 General Tablespaces").

    See Also [database](glossary.html#glos_database), [.ibd file](glossary.html#glos_ibd_file), [table](glossary.html#glos_table), [tablespace](glossary.html#glos_tablespace).
...
:   The set of files managed by `InnoDB` within a
    ...
    **file-per-table** tablespace
    ...
    See Also [database](glossary.html#glos_database), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [redo log](glossary.html#glos_redo_log), [system tablespace](glossary.html#glos_system_tablespace), [temporary tablespace](glossary.html#glos_temporary_tablespace), [undo tablespace](glossary.html#glos_undo_tablespace).
...
:   A set of files with names such as `ibdata1`,
    ...
    See Also [change buffer](glossary.html#glos_change_buffer), [data dictionary](glossary.html#glos_data_dictionary), [doublewrite buffer](glossary.html#glos_doublewrite_buffer), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [system tablespace](glossary.html#glos_system_tablespace), [undo log](glossary.html#glos_undo_log).
...
:   The `InnoDB` **temporary
    ...
    **temporary tables** and related
    ...
    See Also [data files](glossary.html#glos_data_files), [temporary table](glossary.html#glos_temporary_table), [temporary tablespace](glossary.html#glos_temporary_tablespace).
...
:   A type of database system that maintains data in memory, to
    ...
    **read-only transaction**
    optimization, the [`MEMORY`](memory-storage-engine.html "15.3 The MEMORY Storage Engine") storage
...
:   The name of the **database** that
    ...
    **data dictionary**. (This name is
    ...
    See Also [data dictionary](glossary.html#glos_data_dictionary), [database](glossary.html#glos_database), [InnoDB](glossary.html#glos_innodb).
...
:   A MySQL component that combines high performance with
    ...
    **ACID** design philosophy.
    ...
    [Chapter 14, *The InnoDB Storage Engine*](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") for architectural
    details and administration procedures, and
    [Section 8.5, “Optimizing for InnoDB Tables”](optimizing-innodb.html "8.5 Optimizing for InnoDB Tables") for performance advice.
    ...
    **hot backups**. See
    [Section 28.1, “MySQL Enterprise Backup Overview”](mysql-enterprise-backup.html "28.1 MySQL Enterprise Backup Overview") for information about
...
:   The [`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) option
    ...
    **Barracuda** file formats.
    ...
    See Also [Antelope](glossary.html#glos_antelope), [Barracuda](glossary.html#glos_barracuda), [file format](glossary.html#glos_file_format), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace).
...
:   An important configuration option that affects many aspects of
    ...
    [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") and
    ...
    **compression** and named-table
    ...
    See Also [compression](glossary.html#glos_compression), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [system tablespace](glossary.html#glos_system_tablespace).
...
:   The [`innodb_lock_wait_timeout`](innodb-parameters.html#sysvar_innodb_lock_wait_timeout)
    ...
    **deadlocks** are caused by updates
    ...
    See Also [deadlock](glossary.html#glos_deadlock), [deadlock detection](glossary.html#glos_deadlock_detection), [lock](glossary.html#glos_lock), [wait](glossary.html#glos_wait).
...
:   The former name of the **change
    ...
    [`DELETE`](delete.html "13.2.2 DELETE Statement") and
    [`UPDATE`](update.html "13.2.11 UPDATE Statement") operations. Previously,
    only changes resulting from
    [`INSERT`](insert.html "13.2.5 INSERT Statement") operations were buffered.
...
insert buffering
:   The technique of storing changes to secondary index pages,
    resulting from [`INSERT`](insert.html "13.2.5 INSERT Statement") operations,
...
:   A type of **gap lock** that is set
    by [`INSERT`](insert.html "13.2.5 INSERT Statement") operations prior to row
...
:   A single `mysqld` daemon managing
    ...
    **disk-bound** workload, the server
    ...
    See Also [data directory](glossary.html#glos_data_directory), [database](glossary.html#glos_database), [disk-bound](glossary.html#glos_disk_bound), [mysqld](glossary.html#glos_mysqld), [replication](glossary.html#glos_replication), [server](glossary.html#glos_server), [table](glossary.html#glos_table).
...
:   A kind of **lock** that applies to
    ...
    *intention shared* (IS) lock on a table
    ...
    locking mechanism, see [Section 14.7.1, “InnoDB Locking”](innodb-locking.html "14.7.1 InnoDB Locking").
...
:   Code for instrumenting or debugging some aspect of an
    ...
    See Also [command interceptor](glossary.html#glos_command_interceptor), [Connector/J](glossary.html#glos_connector_j), [Connector/NET](glossary.html#glos_connector_net), [exception interceptor](glossary.html#glos_exception_interceptor).

intrinsic temporary table
:   An optimized internal `InnoDB` temporary table
    used by the *optimizer*.

    See Also [optimizer](glossary.html#glos_optimizer).
...
:   Java Platform, Enterprise Edition: Oracle's enterprise Java
    ...
    **failover** support.
    ...
    See Also [connection pool](glossary.html#glos_connection_pool), [Connector/J](glossary.html#glos_connector_j), [failover](glossary.html#glos_failover), [Java](glossary.html#glos_java), [JBoss](glossary.html#glos_jboss), [Spring](glossary.html#glos_spring), [Tomcat](glossary.html#glos_tomcat).
...
:   A programming language combining high performance, rich built-in
    ...
    **Connector/J**.
    ...
    See Also [C](glossary.html#glos_c), [Connector/J](glossary.html#glos_connector_j), [C++](glossary.html#glos_cplusplus), [JDBC](glossary.html#glos_jdbc).
...
:   Abbreviation for “Java Database Connectivity”, an
    ...
    **Connector/J** component as their
    ...
    See Also [API](glossary.html#glos_api), [Connector/J](glossary.html#glos_connector_j), [J2EE](glossary.html#glos_j2ee), [Java](glossary.html#glos_java).
...
:   An option to specify the size of data pages within an
    ...
    **compressed row format**. The
    ...
    For [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables,
    ...
    See Also [compressed row format](glossary.html#glos_compressed_row_format).
...
:   A type of **interceptor** supported
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [interceptor](glossary.html#glos_interceptor).
...
locking read
:   A [`SELECT`](select.html "13.2.9 SELECT Statement") statement that also
    ...
    **read-only transaction**.
    ...
    See [Section 14.7.2.4, “Locking Reads”](innodb-locking-reads.html "14.7.2.4 Locking Reads").
...
:   A **backup** that reproduces table
    ...
    **`mysqldump`**
    ...
    statements such as [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
    and [`INSERT`](insert.html "13.2.5 INSERT Statement") that can re-create the
...
:   A file that MySQL uses to store data for a
    [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") table.
...
:   A popular component of many MySQL and
    ...
    **memcached** protocol, supported by client
    ...
    See Also [NoSQL](glossary.html#glos_nosql).
...
:   A type of **lock** that prevents
    ...
    **transaction**. For details, see
    ...
    [`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement") and
    [`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement") for
...
:   A feature implemented by the
    [`INNODB_METRICS`](information-schema-innodb-metrics-table.html "24.4.16 The INFORMATION_SCHEMA INNODB_METRICS Table") table in the
...
:   An internal phase of `InnoDB` processing, when
    ...
    **purge** processing by background
    ...
    See Also [commit](glossary.html#glos_commit), [crash recovery](glossary.html#glos_crash_recovery), [DML](glossary.html#glos_dml), [physical](glossary.html#glos_physical), [purge](glossary.html#glos_purge), [redo log](glossary.html#glos_redo_log), [rollback](glossary.html#glos_rollback), [transaction](glossary.html#glos_transaction).

mixed-mode insert
:   An [`INSERT`](insert.html "13.2.5 INSERT Statement") statement where
    **auto-increment** values are
    ...
    [`INSERT ...
    ON DUPLICATE KEY UPDATE`](insert-on-duplicate.html "13.2.5.2 INSERT ... ON DUPLICATE KEY UPDATE Statement") statement, where
...
:   An older JDBC driver for MySQL that evolved into
    **Connector/J** when it was
    ...
    See Also [Connector/J](glossary.html#glos_connector_j).
...
mysql
:   The [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") program is the command-line
    interpreter for the MySQL database. It processes
    **SQL** statements, and also
    MySQL-specific commands such as [`SHOW
    TABLES`](show-tables.html "13.7.5.37 SHOW TABLES Statement"), by passing requests to the
    [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") daemon.
...
:   A command-line tool of the
    ...
    **hot backup** operation for
    [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables, and a
    [warm backup](glossary.html#glos_warm_backup "warm backup") for
    [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") and other kinds of tables.
    See [Section 28.1, “MySQL Enterprise Backup Overview”](mysql-enterprise-backup.html "28.1 MySQL Enterprise Backup Overview") for more
...
mysqld
:   [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), also known as MySQL Server, is a
    ...
    [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") runs as a Unix daemon or Windows
...
:   A broad term for a set of data access technologies that do not
    ...
    **memcached** API to directly
    ...
    See Also [ACID](glossary.html#glos_acid), [memcached](glossary.html#glos_memcached), [schema](glossary.html#glos_schema), [SQL](glossary.html#glos_sql).
...
:   A column containing variable-length data (such as
    ...
    [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types")) that is too long to fit
    ...
    **COMPACT** row format.
    ...
    See Also [B-tree](glossary.html#glos_b_tree), [compact row format](glossary.html#glos_compact_row_format), [dynamic row format](glossary.html#glos_dynamic_row_format), [overflow page](glossary.html#glos_overflow_page).
...
:   A feature that improves the performance, concurrency, and
    ...
    **DDL** (primarily
    [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")) operations. See
    [Section 14.13, “InnoDB and Online DDL”](innodb-online-ddl.html "14.13 InnoDB and Online DDL") for details.

    The details vary according to the type of operation. In some
    cases, the table can be modified concurrently while the
    [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") is in progress. The
...
:   The MySQL component that determines the best
    ...
    **tables**.
    ...
    See Also [index](glossary.html#glos_index), [join](glossary.html#glos_join), [query](glossary.html#glos_query), [table](glossary.html#glos_table).
...
:   A unit representing how much data `InnoDB`
    ...
    **extent** at a time.
    ...
    See Also [buffer pool](glossary.html#glos_buffer_pool), [compact row format](glossary.html#glos_compact_row_format), [compressed row format](glossary.html#glos_compressed_row_format), [data files](glossary.html#glos_data_files), [extent](glossary.html#glos_extent), [page size](glossary.html#glos_page_size), [row](glossary.html#glos_row).
...
:   A **backup** that contains some of
    ...
    **full backup**.
    ...
    See Also [backup](glossary.html#glos_backup), [full backup](glossary.html#glos_full_backup), [table](glossary.html#glos_table).
...
:   An open-source **API** for MySQL
    ...
    **Perl** language. Implemented
    ...
    [Section 27.9, “MySQL Perl API”](apis-perl.html "27.9 MySQL Perl API").
...
:   A feature that stores **index**
    ...
    **queries**. For more information,
    ...
    See Also [index](glossary.html#glos_index), [optimizer](glossary.html#glos_optimizer), [plan stability](glossary.html#glos_plan_stability), [query](glossary.html#glos_query), [table](glossary.html#glos_table).
...
:   A type of garbage collection performed by one or more separate
    ...
    [`innodb_purge_threads`](innodb-parameters.html#sysvar_innodb_purge_threads)) that runs
    ...
    **history list** for the purpose of
    ...
    for deletion (by previous [`DELETE`](delete.html "13.2.2 DELETE Statement")
    statements) and are no longer required for
    **MVCC** or
    **rollback**. Purge frees undo log
    pages from the history list after processing them.

    See Also [history list](glossary.html#glos_history_list), [MVCC](glossary.html#glos_mvcc), [rollback](glossary.html#glos_rollback), [undo log](glossary.html#glos_undo_log).
...
:   Another name for the `InnoDB`
    **history list**. Related to the
    ...
    See Also [history list](glossary.html#glos_history_list), [purge](glossary.html#glos_purge).
...
:   A **thread** within the
    ...
    See Also [purge](glossary.html#glos_purge), [thread](glossary.html#glos_thread).
...
:   In **SQL**, an operation that reads
    ...
    **DML** statements.
    ...
    See Also [DDL](glossary.html#glos_ddl), [DML](glossary.html#glos_dml), [index](glossary.html#glos_index), [join](glossary.html#glos_join), [SQL](glossary.html#glos_sql), [table](glossary.html#glos_table).
...
:   To reduce the amount of database activity, often in preparation
    ...
    TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"), a **backup**, or a
...
:   A type of **transaction** that can
    ...
    **read view** for each transaction.
    ...
    READ ONLY`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements"), or automatically under certain conditions.
    See [Section 8.5.3, “Optimizing InnoDB Read-Only Transactions”](innodb-performance-ro-txn.html "8.5.3 Optimizing InnoDB Read-Only Transactions") for details.
...
:   A disk-based data structure used during
    ...
    **LSN** value.
    ...
    For more information, see [Section 14.6.6, “Redo Log”](innodb-redo-log.html "14.6.6 Redo Log")
...
:   An `InnoDB` feature that, when enabled,
    ...
    [Redo Log Archiving](/doc/refman/8.0/en/innodb-redo-log.html#innodb-redo-log-archiving).
...
:   The oldest `InnoDB` **row
    ...
    **DYNAMIC**. You can still specify
    ...
    For more information, see [Section 14.11, “InnoDB Row Formats”](innodb-row-format.html "14.11 InnoDB Row Formats").

    See Also [compact row format](glossary.html#glos_compact_row_format), [dynamic row format](glossary.html#glos_dynamic_row_format), [row format](glossary.html#glos_row_format).
...
:   The storage area containing the **undo
    ...
    *global temporary tablespace*.
    ...
    See Also [system tablespace](glossary.html#glos_system_tablespace), [undo log](glossary.html#glos_undo_log), [undo tablespace](glossary.html#glos_undo_tablespace).
...
:   The logical data structure defined by a set of
    ...
    **row format** for consistency with
    ...
    See Also [column](glossary.html#glos_column), [data files](glossary.html#glos_data_files), [page](glossary.html#glos_page), [row format](glossary.html#glos_row_format), [table](glossary.html#glos_table).
...
:   The disk storage format for
    ...
    **compression**, new row formats
    ...
    [`SHOW TABLE STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement") statement or
    query `InnoDB` table metadata in the
    [`INFORMATION_SCHEMA`](information-schema.html "Chapter 24 INFORMATION_SCHEMA Tables").

    See Also [compact row format](glossary.html#glos_compact_row_format), [compressed row format](glossary.html#glos_compressed_row_format), [compression](glossary.html#glos_compression), [dynamic row format](glossary.html#glos_dynamic_row_format), [redundant row format](glossary.html#glos_redundant_row_format), [row](glossary.html#glos_row), [table](glossary.html#glos_table).
...
:   A **lock** that prevents a row from
    ...
    **InnoDB** tables.
    ...
    by [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine"), or during
    **DDL** operations on
...
:   `mysql2`, based based on the
    **libmysqlclient** API library, is
    ...
    For more information, see [Section 27.11, “MySQL Ruby APIs”](apis-ruby.html "27.11 MySQL Ruby APIs").
...
:   A division within an `InnoDB`
    ...
    **extent** (1 megabyte) at a time.
    ...
    See Also [extent](glossary.html#glos_extent), [file-per-table](glossary.html#glos_file_per_table), [rollback segment](glossary.html#glos_rollback_segment), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace), [undo log](glossary.html#glos_undo_log).
...
:   A type of read operation used for `UPDATE`
    ...
    **isolation level**, or when the
    ...
    See Also [consistent read](glossary.html#glos_consistent_read), [isolation level](glossary.html#glos_isolation_level), [READ COMMITTED](glossary.html#glos_read_committed).
...
:   A **prepared statement** managed by
    ...
    **Connector/PHP** developers to
    ...
    See Also [client-side prepared statement](glossary.html#glos_client_side_prepared_statement), [Connector/J](glossary.html#glos_connector_j), [Connector/PHP](glossary.html#glos_connector_php), [prepared statement](glossary.html#glos_prepared_statement).
...
:   Another way of referring to the **system
    ...
    *file-per-table* tablespace.
    ...
    See Also [general tablespace](glossary.html#glos_general_tablespace), [system tablespace](glossary.html#glos_system_tablespace).
...
:   A type of **log** used for
    ...
    information, see [Section 5.4.5, “The Slow Query Log”](slow-query-log.html "5.4.5 The Slow Query Log").
...
:   An identifier used to uniquely identify an
    ...
    **transportable tablespace**
    ...
    [Section 14.6.1.3, “Importing InnoDB Tables”](innodb-table-import.html "14.6.1.3 Importing InnoDB Tables") for details.

    See Also [.cfg file](glossary.html#glos_cfg_file), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [.ibd file](glossary.html#glos_ibd_file), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace), [transportable tablespace](glossary.html#glos_transportable_tablespace).
...
:   The Structured Query Language that is standard for performing
    ...
    **replication**. See
    [Chapter 9, *Language Structure*](language-structure.html "Chapter 9 Language Structure") for the building blocks of
    SQL syntax, [Chapter 11, *Data Types*](data-types.html "Chapter 11 Data Types") for the data types to
    use for MySQL table columns, [Chapter 13, *SQL Statements*](sql-statements.html "Chapter 13 SQL Statements")
    for details about SQL statements and their associated
    categories, and [Chapter 12, *Functions and Operators*](functions.html "Chapter 12 Functions and Operators") for standard and
...
:   An error code defined by the
    ...
    **Connector/J**.
    ...
    See Also [Connector/J](glossary.html#glos_connector_j), [JDBC](glossary.html#glos_jdbc).
...
:   The process of starting the MySQL server. Typically done by one
    of the programs listed in [Section 4.3, “Server and Server-Startup Programs”](programs-server.html "4.3 Server and Server-Startup Programs"). The
...
:   A type of **interceptor** for
    ...
    **Connector/J**, setting up this
    ...
    See Also [command interceptor](glossary.html#glos_command_interceptor), [connection string](glossary.html#glos_connection_string), [Connector/J](glossary.html#glos_connector_j), [Connector/NET](glossary.html#glos_connector_net), [interceptor](glossary.html#glos_interceptor), [Java](glossary.html#glos_java), [Visual Studio](glossary.html#glos_visual_studio).
...
:   Estimated values relating to each `InnoDB`
    ...
    **persistent statistics**, where
    ...
    [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") statement.
    ...
    **PERFORMANCE\_SCHEMA** tables.
    ...
    See Also [cardinality](glossary.html#glos_cardinality), [index](glossary.html#glos_index), [INFORMATION\_SCHEMA](glossary.html#glos_information_schema), [NULL](glossary.html#glos_null), [Performance Schema](glossary.html#glos_performance_schema), [persistent statistics](glossary.html#glos_persistent_statistics), [primary key](glossary.html#glos_primary_key), [query execution plan](glossary.html#glos_query_execution_plan), [secondary index](glossary.html#glos_secondary_index), [table](glossary.html#glos_table), [transaction](glossary.html#glos_transaction).
...
:   In a **FULLTEXT index**, a word
    ...
    `MyISAM` tables. See
    [Section 12.9.4, “Full-Text Stopwords”](fulltext-stopwords.html "12.9.4 Full-Text Stopwords") for details.
...
:   A component of the MySQL database that performs the low-level
    ...
    tables, so we refer to [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine")
    tables, [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables, and so on.
...
:   A column whose values are computed from an expression included
    ...
    See Also [base column](glossary.html#glos_base_column), [generated column](glossary.html#glos_generated_column), [virtual generated column](glossary.html#glos_virtual_generated_column).
...
:   The general name for the setting controlled by the
    ...
    **row format**, that normally
    ...
    See Also [file format](glossary.html#glos_file_format), [innodb\_strict\_mode](glossary.html#glos_innodb_strict_mode), [row format](glossary.html#glos_row_format).
...
:   One or more data files (**ibdata
    files**) containing metadata for
    `InnoDB`-related objects (the
    `InnoDB` **data
    dictionary**), and the storage areas for the
    **change buffer**, the
    **doublewrite buffer**, and
    possibly **undo logs**. It may also
    ...
    **instance**.
    ...
    then deleted. In MySQL 5.7, the default is
    ...
    **.ibd file**. This default makes
    ...
    the **Barracuda** file format, such
    as table **compression**, efficient
    storage of **off-page columns**,
    ...
    option defines the number of undo tablespaces for undo logs.
    ...
    **MySQL Enterprise Backup** product might back up a
    ...
    TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") syntax. They can be created outside of the
    MySQL data directory, are capable of holding multiple tables,
    and support tables of all row formats.

    See Also [Barracuda](glossary.html#glos_barracuda), [change buffer](glossary.html#glos_change_buffer), [compression](glossary.html#glos_compression), [data dictionary](glossary.html#glos_data_dictionary), [database](glossary.html#glos_database), [doublewrite buffer](glossary.html#glos_doublewrite_buffer), [dynamic row format](glossary.html#glos_dynamic_row_format), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [.ibd file](glossary.html#glos_ibd_file), [ibdata file](glossary.html#glos_ibdata_file), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [instance](glossary.html#glos_instance), [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [off-page column](glossary.html#glos_off_page_column), [tablespace](glossary.html#glos_tablespace), [undo log](glossary.html#glos_undo_log).
...
:   A file containing trigger parameters. Files with this extension
    ...
    **MySQL Enterprise Backup** product.
    ...
    See Also [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [mysqlbackup command](glossary.html#glos_mysqlbackup_command), [.TRN file](glossary.html#glos_trn_file).
...
:   A file containing trigger namespace information. Files with this
    ...
    **MySQL Enterprise Backup** product.
    ...
    See Also [MySQL Enterprise Backup](glossary.html#glos_mysql_enterprise_backup), [mysqlbackup command](glossary.html#glos_mysqlbackup_command), [.TRG file](glossary.html#glos_trg_file).
...
:   Each MySQL table is associated with a particular
    ...
    **index** data.
    ...
    tablespaces can use the
    **Barracuda** file format, and
    Barracuda tables can use
    **DYNAMIC** or
    ...
    **compression**, efficient storage
    ...
    [`innodb_large_prefix`](innodb-parameters.html#sysvar_innodb_large_prefix)). General
    tablespaces support all row formats regardless of the
    [`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) setting.

    Up to MySQL 5.7.5, `InnoDB` tables inside the
    system tablespace had to use the
    **Antelope** file format for
    backward compatibility with MySQL 5.1 and earlier. The
    **Antelope** file format supports
    **COMPACT** and
    **REDUNDANT** row format. The
    system tablespace supports tables that use
    **DYNAMIC** row format as of MySQL
    5.7.6.
    ...
    **primary key** columns of the
    ...
    See Also [Antelope](glossary.html#glos_antelope), [backup](glossary.html#glos_backup), [Barracuda](glossary.html#glos_barracuda), [clustered index](glossary.html#glos_clustered_index), [compact row format](glossary.html#glos_compact_row_format), [compressed row format](glossary.html#glos_compressed_row_format), [compression](glossary.html#glos_compression), [dynamic row format](glossary.html#glos_dynamic_row_format), [Fast Index Creation](glossary.html#glos_fast_index_creation), [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [index](glossary.html#glos_index), [off-page column](glossary.html#glos_off_page_column), [primary key](glossary.html#glos_primary_key), [redundant row format](glossary.html#glos_redundant_row_format), [row](glossary.html#glos_row), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace).
...
:   Obsolete synonym for **storage
    engine**. We refer to
    [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables,
    [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables, and so on.
...
:   A data file that can hold data for one or more
    ...
    **off-page columns**, table
    ...
    [Section 14.6.3.2, “File-Per-Table Tablespaces”](innodb-file-per-table-tablespaces.html "14.6.3.2 File-Per-Table Tablespaces") for details.

    `InnoDB` introduced general tablespaces in
    MySQL 5.7.6. General tablespaces are shared tablespaces created
    using [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") syntax.
    ...
    [Section 21.6.11.1, “NDB Cluster Disk Data Objects”](mysql-cluster-disk-data-objects.html "21.6.11.1 NDB Cluster Disk Data Objects") for details.

    See Also [compressed row format](glossary.html#glos_compressed_row_format), [data dictionary](glossary.html#glos_data_dictionary), [data files](glossary.html#glos_data_files), [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [index](glossary.html#glos_index), [innodb\_file\_per\_table](glossary.html#glos_innodb_file_per_table), [system tablespace](glossary.html#glos_system_tablespace), [table](glossary.html#glos_table).
...
:   A programming language originating in the Unix scripting world.
    ...
    **API** for MySQL, see
    [Section 27.12, “MySQL Tcl API”](apis-tcl.html "27.12 MySQL Tcl API").
...
:   A **table** whose data does not
    ...
    See Also [table](glossary.html#glos_table).
...
:   The tablespace for non-compressed `InnoDB`
    **temporary tables** and related
    ...
    each server start and receives a dynamically generated space ID.
    The temporary tablespace cannot reside on a raw device. Startup
    is refused if the temporary tablespace cannot be created.
    ...
    See Also [temporary table](glossary.html#glos_temporary_table).
...
:   An internal field associated with each
    **row**. This field is physically
    changed by [`INSERT`](insert.html "13.2.5 INSERT Statement"),
    [`UPDATE`](update.html "13.2.11 UPDATE Statement"), and
    [`DELETE`](delete.html "13.2.2 DELETE Statement") operations to record which
...
:   A feature added in MySQL 5.7.8 that permits page-level
    ...
    **file-per-table** tablespaces.
    ...
    [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). For more
    information, see [Section 14.9.2, “InnoDB Page Compression”](innodb-page-compression.html "14.9.2 InnoDB Page Compression").
...
:   A feature that allows a
    **tablespace** to be moved from one
    ...
    running [`ALTER TABLE
    ... DISCARD TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") and
    [`ALTER TABLE ...
    IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") on the other server brings the
    ...
    **space ID**) as the tablespace is
    imported. See [Section 14.6.1.3, “Importing InnoDB Tables”](innodb-table-import.html "14.6.1.3 Importing InnoDB Tables") for usage
    information.

    See Also [.cfg file](glossary.html#glos_cfg_file), [.ibd file](glossary.html#glos_ibd_file), [space ID](glossary.html#glos_space_id), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace).
...
:   An operation that is part of a distributed
    ...
    **commit** the changes, or all
    ...
    See Also [commit](glossary.html#glos_commit), [rollback](glossary.html#glos_rollback), [transaction](glossary.html#glos_transaction), [XA](glossary.html#glos_xa).
...
:   Data that is maintained throughout the life of a
    ...
    **undo tablespaces**. As of MySQL
    ...
    See Also [rollback](glossary.html#glos_rollback), [rollback segment](glossary.html#glos_rollback_segment), [system tablespace](glossary.html#glos_system_tablespace), [transaction](glossary.html#glos_transaction), [undo log](glossary.html#glos_undo_log), [undo tablespace](glossary.html#glos_undo_tablespace).
...
:   A storage area that holds copies of data modified by active
    ...
    **consistent read** operation), the
    ...
    [`CREATE UNDO
    TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") syntax.

    The undo log is split into separate portions, the
    **insert undo buffer** and the
    **update undo buffer**.

    See Also [consistent read](glossary.html#glos_consistent_read), [rollback segment](glossary.html#glos_rollback_segment), [SSD](glossary.html#glos_ssd), [system tablespace](glossary.html#glos_system_tablespace), [transaction](glossary.html#glos_transaction), [undo tablespace](glossary.html#glos_undo_tablespace).
...
:   An undo tablespace contains **undo
    ...
    **undo log segments**, which are
    ...
    See Also [rollback segment](glossary.html#glos_rollback_segment), [system tablespace](glossary.html#glos_system_tablespace), [undo log](glossary.html#glos_undo_log), [undo log segment](glossary.html#glos_undo_log_segment).
...
:   A data type of variable length.
    ...
    [`VARBINARY`](binary-varbinary.html "11.3.3 The BINARY and VARBINARY Types"), and
    [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
    [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") types are variable-length
    types.
...
:   The **transaction** that is
    ...
    **Deadlock detection** can be
    ...
    See Also [deadlock](glossary.html#glos_deadlock), [deadlock detection](glossary.html#glos_deadlock_detection), [innodb\_lock\_wait\_timeout](glossary.html#glos_innodb_lock_wait_timeout), [transaction](glossary.html#glos_transaction).
...
:   A column whose values are computed from an expression included
    ...
    See Also [base column](glossary.html#glos_base_column), [generated column](glossary.html#glos_generated_column), [stored generated column](glossary.html#glos_stored_generated_column).
...
:   A virtual index is a **secondary
    ...
    See Also [secondary index](glossary.html#glos_secondary_index), [stored generated column](glossary.html#glos_stored_generated_column), [virtual generated column](glossary.html#glos_virtual_generated_column).
...
:   For supported versions of Visual Studio, see the following
    ...
    * Connector/C++ 8.0: [Platform Support and Prerequisites](/doc/connector-cpp/9.4/en/connector-cpp-introduction.html#connector-cpp-prerequisites)
...
:   A standard interface for coordinating distributed
    ...
    **ACID** compliance. For full
    details, see [Section 13.3.7, “XA Transactions”](xa.html "13.3.7 XA Transactions").

    XA Distributed Transaction support is enabled by default. If you
    are not using this feature, you can disable the
    [`innodb_support_xa`](innodb-parameters.html#sysvar_innodb_support_xa) configuration
    option, avoiding the performance overhead of an extra fsync for
    each transaction.

    As of MySQL 5.7.10, disabling
    [`innodb_support_xa`](innodb-parameters.html#sysvar_innodb_support_xa) is not
    permitted as it makes replication unsafe and prevents
    performance gains associated with **binary
    log** group commit. The
    [`innodb_support_xa`](innodb-parameters.html#sysvar_innodb_support_xa) configuration
    option is removed in MySQL 8.0.

    See Also [ACID](glossary.html#glos_acid), [binary log](glossary.html#glos_binary_log), [commit](glossary.html#glos_commit), [transaction](glossary.html#glos_transaction), [two-phase commit](glossary.html#glos_two_phase_commit).

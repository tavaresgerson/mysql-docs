...
[ngram](fulltext-search-ngram.html "12.9.8 ngram Full-Text Parser") full-text
...
[Section 12.9, “Full-Text Search Functions”](fulltext-search.html "12.9 Full-Text Search Functions") applies to the MeCab parser
...
1. In the MySQL configuration file, set the
   ...
   [option modifier](option-modifiers.html "4.2.2.4 Program Option Modifiers"). The
   ...
   location, see [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").
...
3. Modify the `mecabrc` configuration file
   ...
   entry in the `mecabrc` file differs, as
...
5. Install the MeCab parser plugin:
   ...
   [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement"). The plugin
...
Information Schema
[`INNODB_FT_INDEX_CACHE`](information-schema-innodb-ft-index-cache-table.html "24.4.12 The INFORMATION_SCHEMA INNODB_FT_INDEX_CACHE Table") table:
...
you can use [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") or
[`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"). For example:

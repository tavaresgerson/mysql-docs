...
collation is `latin1_swedish_ci`, whereas
lookups are case-sensitive if the collation is
`latin1_general_cs` or
`latin1_bin`.
...
have a single [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") column
...
[`INNODB_FT_INDEX_TABLE`](information-schema-innodb-ft-index-table-table.html "24.4.13 The INFORMATION_SCHEMA INNODB_FT_INDEX_TABLE Table") table.

...
[`MATCH()`](fulltext-search.html#function_match) function
...
[Section 12.9.2, “Boolean Full-Text Searches”](fulltext-boolean.html "12.9.2 Boolean Full-Text Searches"), and
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement includes neither
`WHERE` nor `ORDER BY`
clauses:
...
[`SELECT`](select.html "13.2.9 SELECT Statement") list and once in the
...
full-text parser. For details, see [The MySQL Plugin API](/doc/extending-mysql/5.7/en/plugin-api.html).
...
See [Section 12.9.4, “Full-Text Stopwords”](fulltext-stopwords.html "12.9.4 Full-Text Stopwords") to view default
...
mode explained in [Section 12.9.2, “Boolean Full-Text Searches”](fulltext-boolean.html "12.9.2 Boolean Full-Text Searches").
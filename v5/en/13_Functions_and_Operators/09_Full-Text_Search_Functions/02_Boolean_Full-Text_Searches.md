...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") full-text search is
modeled on the
...
from [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") relevancy rankings.

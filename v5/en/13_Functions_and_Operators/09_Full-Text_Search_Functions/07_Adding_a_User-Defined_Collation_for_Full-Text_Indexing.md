...
is given in [Section 10.14, “Adding a Collation to a Character Set”](adding-collation.html "10.14 Adding a Collation to a Character Set"); it is assumed
...
[Section 10.14, “Adding a Collation to a Character Set”](adding-collation.html "10.14 Adding a Collation to a Character Set"), can be created using a
...
1. Add a collation to the `Index.xml` file.
   ...
   given in [Section 10.14.2, “Choosing a Collation ID”](adding-collation-choosing-id.html "10.14.2 Choosing a Collation ID"). The

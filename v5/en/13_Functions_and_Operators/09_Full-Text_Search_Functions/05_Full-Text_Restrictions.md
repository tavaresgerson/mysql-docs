...
* Full-text searches are supported for
  ...
  [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables only.

* Full-text searches are not supported for partitioned tables.
  See [Section 22.6, “Restrictions and Limitations on Partitioning”](partitioning-limitations.html "22.6 Restrictions and Limitations on Partitioning").
...
* For `InnoDB`, all DML operations
  ...
  [`DELETE`](delete.html "13.2.2 DELETE Statement")) involving columns

...
<table frame="box" rules="all" summary="A reference that lists cast functions and operators."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th>
<th>Description</th>
</tr></thead><tbody><tr><td><code>BINARY</code></td>
<td>
      Cast a string to a binary string
    </td>
</tr><tr><td><code>CAST()</code></td>
<td>
      Cast a value as a certain type
    </td>
</tr><tr><td><code>CONVERT()</code></td>
<td>
      Cast a value as a certain type
    </td>
</tr></tbody></table>
...
* [`BINARY`](cast-functions.html#operator_binary)
  *`expr`*
  ...
  sets, see [Section 10.8.5, “The binary Collation Compared to \_bin Collations”](charset-binary-collations.html "10.8.5 The binary Collation Compared to _bin Collations").
  ...
  definition of a [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"),
  [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"), or
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") column causes the column
...
* [`CAST(expr AS
  type)`](cast-functions.html#function_cast)

  [`CAST(expr AS
  type`](cast-functions.html#function_cast) takes an
  ...
  + `BINARY[(N)]`
    ...
    [`VARBINARY`](binary-varbinary.html "11.3.3 The BINARY and VARBINARY Types") data type,
  ...
  + `CHAR[(N)]
    ...
    Produces a string with the
    [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") data type, unless
  ...
  + `DATE`
    ...
    Produces a [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value.

  + `DATETIME[(M)]`

    Produces a [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types")
  ...
  + `DECIMAL[(M[,D])]`
    ...
    Produces a [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") value.
  ...
  + `JSON`
    ...
    Produces a [`JSON`](json.html "11.5 The JSON Data Type") value.
    For details on the rules for conversion of values
    between [`JSON`](json.html "11.5 The JSON Data Type") and other
  ...
  + `NCHAR[(N)]`
    ...
    [Section 10.3.7, “The National Character Set”](charset-national.html "10.3.7 The National Character Set").
  ...
  + `SIGNED [INTEGER]`
    ...
    Produces a signed [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
    value.

  + `TIME[(M)]`

    Produces a [`TIME`](time.html "11.2.3 The TIME Type") value. If
...
and collation (see [Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations")).
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") value or other binary string
...
specific type in a
[`CREATE TABLE ...
SELECT`](create-table.html "13.1.18 CREATE TABLE Statement") statement:
...
[`ENUM`](enum.html "11.3.5 The ENUM Type") columns in lexical order.
Normally, sorting of [`ENUM`](enum.html "11.3.5 The ENUM Type") columns
occurs using the internal numeric values. Casting the values to
[`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") results in a lexical sort:
...
see [Section 12.3, “Type Conversion in Expression Evaluation”](type-conversion.html "12.3 Type Conversion in Expression Evaluation").
...
default (see [Section 12.6.1, “Arithmetic Operators”](arithmetic-functions.html "12.6.1 Arithmetic Operators")). To
...
(In this context, [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") column
...
[Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes")). Examples:

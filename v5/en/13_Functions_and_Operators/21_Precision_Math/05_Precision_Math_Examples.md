...
described in [Section 12.21.3, “Expression Handling”](precision-math-expressions.html "12.21.3 Expression Handling"), and
...
* Rounding for exact-value columns
  ([`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") and integer) and

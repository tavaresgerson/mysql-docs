...
([`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") and integer).
...
For inserts into a [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") or
...
The [`SHOW WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement") statement

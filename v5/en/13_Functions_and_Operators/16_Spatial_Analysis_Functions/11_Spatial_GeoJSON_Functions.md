...
MySQL also supports a native [`JSON`](json.html "11.5 The JSON Data Type")
data type and a set of SQL functions to enable operations on JSON
values. For more information, see [Section 11.5, “The JSON Data Type”](json.html "11.5 The JSON Data Type"), and
[Section 12.17, “JSON Functions”](json-functions.html "12.17 JSON Functions").
...
<td>Accept the document and strip off the coordinates for higher coordinate
  ...
  *`options`* values of 2, 3, and 4
  ...
  future, these values can be expected to produce different
  effects.

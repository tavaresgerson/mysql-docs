...
* [`ST_Distance_Sphere(g1,
  ...
  `NULL` if any geometry argument is
  `NULL` or empty.

  Calculations use a spherical earth and a configurable radius.
  The optional *`radius`* argument should
  ...
  occurs if the *`radius`* argument is
  ...
  `MultiPoint`), and
  (`MultiPoint`, `Point`). An
  [`ER_GIS_UNSUPPORTED_ARGUMENT`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_gis_unsupported_argument)
...
* [`ST_IsValid(g)`](spatial-convenience-functions.html#function_st-isvalid)
  ...
  `NULL`. Geometry validity is defined by the
  OGC specification.
  ...
  [`ST_IsValid()`](spatial-convenience-functions.html#function_st-isvalid) works only for the
...
* [`ST_MakeEnvelope(pt1,
  ...
  *`pt2`*,
  ...
  [`ST_MakeEnvelope()`](spatial-convenience-functions.html#function_st-makeenvelope) requires
  `Point` geometry arguments with an SRID of 0.
  An [`ER_WRONG_ARGUMENTS`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_wrong_arguments) error
  occurs otherwise.
...
* [`ST_Validate(g)`](spatial-convenience-functions.html#function_st-validate)
  ...
  [`ST_Validate()`](spatial-convenience-functions.html#function_st-validate) works only for

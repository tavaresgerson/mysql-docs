...
[`ST_Distance()`](spatial-relation-functions-object-shapes.html#function_st-distance) and
[`Distance()`](spatial-relation-functions-object-shapes.html#function_spatial-distance),
...
* [`Crosses(g1,
  g2)`](spatial-relation-functions-object-shapes.html#function_crosses)

  [`ST_Crosses()`](spatial-relation-functions-object-shapes.html#function_st-crosses) and
  [`Crosses()`](spatial-relation-functions-object-shapes.html#function_crosses) are synonyms. For
  more information, see the description of
  [`ST_Crosses()`](spatial-relation-functions-object-shapes.html#function_st-crosses).

  [`Crosses()`](spatial-relation-functions-object-shapes.html#function_crosses) is deprecated;
  expect it to be removed in a future MySQL release. Use
  [`ST_Crosses()`](spatial-relation-functions-object-shapes.html#function_st-crosses) instead.

* [`Distance(g1,
  g2)`](spatial-relation-functions-object-shapes.html#function_spatial-distance)

  [`ST_Distance()`](spatial-relation-functions-object-shapes.html#function_st-distance) and
  [`Distance()`](spatial-relation-functions-object-shapes.html#function_spatial-distance)
  are synonyms. For more information, see the description of
  [`ST_Distance()`](spatial-relation-functions-object-shapes.html#function_st-distance).

  [`Distance()`](spatial-relation-functions-object-shapes.html#function_spatial-distance)
  is deprecated; expect it to be removed in a future MySQL
  release. Use [`ST_Distance()`](spatial-relation-functions-object-shapes.html#function_st-distance)
  instead.
...
* [`ST_Contains(g1,
  ...
  *`g2`*. This tests the opposite
  relationship as [`ST_Within()`](spatial-relation-functions-object-shapes.html#function_st-within).
...
* [`ST_Crosses(g1,
  ...
  *`g2`* is a `Point`
  ...
  [`ST_Crosses()`](spatial-relation-functions-object-shapes.html#function_st-crosses) and
  [`Crosses()`](spatial-relation-functions-object-shapes.html#function_crosses) are synonyms.
...
* [`ST_Distance(g1,
  g2)`](spatial-relation-functions-object-shapes.html#function_st-distance)
...
* [`ST_Touches(g1,
  ...
  *`g2`*.
  ...
  [`ST_Touches()`](spatial-relation-functions-object-shapes.html#function_st-touches) and
  [`Touches()`](spatial-relation-functions-object-shapes.html#function_touches) are synonyms.
...
* [`Touches(g1,
  g2)`](spatial-relation-functions-object-shapes.html#function_touches)

  [`ST_Touches()`](spatial-relation-functions-object-shapes.html#function_st-touches) and
  [`Touches()`](spatial-relation-functions-object-shapes.html#function_touches) are synonyms. For
  more information, see the description of
  [`ST_Touches()`](spatial-relation-functions-object-shapes.html#function_st-touches).

  [`Touches()`](spatial-relation-functions-object-shapes.html#function_touches) is deprecated;
  expect it to be removed in a future MySQL release. Use
  [`ST_Touches()`](spatial-relation-functions-object-shapes.html#function_st-touches) instead.
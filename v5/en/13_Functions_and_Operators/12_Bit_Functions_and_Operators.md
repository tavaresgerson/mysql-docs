...
</tr><tr><td><code>BIT_COUNT()</code></td>
<td>
...
* [`<<`](bit-functions.html#operator_left-shift)
  ...
  Shifts a longlong ([`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"))
  number to the left.
...
[`BIT_XOR()`](aggregate-functions.html#function_bit-xor) functions are aggregate
functions described at [Section 12.19.1, “Aggregate Function Descriptions”](aggregate-functions.html "12.19.1 Aggregate Function Descriptions").)
...
and return [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") values, so they
have a maximum range of 64 bits. Arguments of other types are
converted to [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") and truncation
might occur.

An extension for MySQL 8.0 changes this
cast-to-[`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") behavior: Bit
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") types), enabling them to take
...
Those expressions return [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") in
...
* *`nonliteral_binary`*: An argument that
...
argument to [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") with
[`CAST(... AS UNSIGNED)`](cast-functions.html#function_cast). This makes
...
* Replication to MySQL 8.0 from older versions might fail for
  ...
  example, using [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files")). To avoid this,
  switch to row-based binary logging on the older source server.
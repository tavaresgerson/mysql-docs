...
<th>Description</th>
</tr></thead><tbody><tr><td><code>%</code>, <code>MOD</code></td>
<td>
      Modulo operator
    </td>
...
* In the case of
  ...
  is calculated with [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
...
evaluation, see [Section 11.1.7, “Out-of-Range and Overflow Handling”](out-of-range-and-overflow.html "11.1.7 Out-of-Range and Overflow Handling").
...
see [Section 12.7, “Date and Time Functions”](date-and-time-functions.html "12.7 Date and Time Functions").
...
* [`-`](arithmetic-functions.html#operator_unary-minus)
  ...
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), the return value is
  also a [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"). This means
...
* [`*`](arithmetic-functions.html#operator_times)
  ...
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") calculations. (See
...
* [`/`](arithmetic-functions.html#operator_divide)
  ...
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") arithmetic only if
...
* [`DIV`](arithmetic-functions.html#operator_div)
  ...
  converted to [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") and
  divided using [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC")
  arithmetic before converting the result to
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"). If the result exceeds
...
* [`N
  ...
  *`M`*. For more information, see the
  ...
  function in [Section 12.6.2, “Mathematical Functions”](mathematical-functions.html "12.6.2 Mathematical Functions").
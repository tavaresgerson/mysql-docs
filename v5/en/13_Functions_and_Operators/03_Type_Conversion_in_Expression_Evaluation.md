...
This does *not* occur when `SELECT` is part of a data definition statement such as [`CREATE TABLE ... SELECT`](create-table-select.html "13.1.18.4 CREATE TABLE ... SELECT Statement"); in strict mode, the statement fails due to the invalid comparison:

...
<th>Description</th>
</tr></thead><tbody><tr><td><code>BENCHMARK()</code></td>
<td>
...
</tr><tr><td><code>COERCIBILITY()</code></td>
<td>
      Return the collation coercibility value of the string argument
    </td>
</tr><tr><td><code>COLLATION()</code></td>
<td>
      Return the collation of the string argument
    </td>
</tr><tr><td><code>CONNECTION_ID()</code></td>
<td>
      Return the connection ID (thread ID) for the connection
    </td>
</tr><tr><td><code>CURRENT_USER()</code>, <code>CURRENT_USER</code></td>
<td>
      The authenticated user name and host name
    </td>
</tr><tr><td><code>DATABASE()</code></td>
<td>
      Return the default (current) database name
    </td>
</tr><tr><td><code>FOUND_ROWS()</code></td>
<td>
      For a SELECT with a LIMIT clause, the number of rows that would be
      returned were there no LIMIT clause
    </td>
</tr><tr><td><code>LAST_INSERT_ID()</code></td>
<td>
      Value of the AUTOINCREMENT column for the last INSERT
    </td>
</tr><tr><td><code>ROW_COUNT()</code></td>
<td>
      The number of rows updated
    </td>
</tr><tr><td><code>SCHEMA()</code></td>
<td>
      Synonym for DATABASE()
    </td>
</tr><tr><td><code>SESSION_USER()</code></td>
<td>
      Synonym for USER()
    </td>
</tr><tr><td><code>SYSTEM_USER()</code></td>
<td>
      Synonym for USER()
    </td>
...
* [`BENCHMARK(count,expr)`](information-functions.html#function_benchmark)
  ...
  The intended use is from within the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
<td>Value with <code>COLLATE</code> clause</td>
</tr><tr>
<th><code>1</code></th>
<td>No collation</td>
...
<td><code>USER()</code> return value</td>
</tr><tr>
<th><code>4</code></th>
<td>Coercible</td>
...
<th><code>6</code></th>
<td>Ignorable</td>
<td><code>NULL</code> or an expression derived from
                <code>NULL</code></td>
</tr></tbody></table>
...
* [`CONNECTION_ID()`](information-functions.html#function_connection-id)
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "24.3.18 The INFORMATION_SCHEMA PROCESSLIST Table") table, the
  `Id` column of [`SHOW
  PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement") output, and the
  `PROCESSLIST_ID` column of the Performance
  Schema [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table.
...
* [`DATABASE()`](information-functions.html#function_database)
  ...
  database, [`DATABASE()`](information-functions.html#function_database) returns
...
* [`FOUND_ROWS()`](information-functions.html#function_found-rows)
  ...
  A [`SELECT`](select.html "13.2.9 SELECT Statement") statement may include
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement, and then
  ...
  The second [`SELECT`](select.html "13.2.9 SELECT Statement") returns a
  number indicating how many rows the first
  [`SELECT`](select.html "13.2.9 SELECT Statement") would have returned had
  ...
  for [`UNION`](union.html "13.2.9.3 UNION Clause") statements than for
  simple [`SELECT`](select.html "13.2.9 SELECT Statement") statements,
  because `LIMIT` may occur at multiple places
  in a [`UNION`](union.html "13.2.9.3 UNION Clause"). It may be applied
  to individual [`SELECT`](select.html "13.2.9 SELECT Statement") statements
  in the [`UNION`](union.html "13.2.9.3 UNION Clause"), or global to the
  [`UNION`](union.html "13.2.9.3 UNION Clause") result as a whole.

  The intent of `SQL_CALC_FOUND_ROWS` for
  [`UNION`](union.html "13.2.9.3 UNION Clause") is that it should return
  the row count that would be returned without a global
  `LIMIT`. The conditions for use of
  `SQL_CALC_FOUND_ROWS` with
  [`UNION`](union.html "13.2.9.3 UNION Clause") are:

  + The `SQL_CALC_FOUND_ROWS` keyword must
    appear in the first [`SELECT`](select.html "13.2.9 SELECT Statement")
    of the [`UNION`](union.html "13.2.9.3 UNION Clause").

  + The value of [`FOUND_ROWS()`](information-functions.html#function_found-rows)
    is exact only if
    [`UNION ALL`](union.html "13.2.9.3 UNION Clause")
    is used. If [`UNION`](union.html "13.2.9.3 UNION Clause") without
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement that fails
  with an error).
...
* [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id),
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement. The value of
  ...
  multiple-row [`INSERT`](insert.html "13.2.5 INSERT Statement") statement
  ...
  rows is not affected by the earlier row insertions. (However,
  if you mix references to
  ...
  + For stored functions and triggers that change the value,
    ...
    so statements following them do not see a changed value.
  ...
  *per-connection basis*. This means that the
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement against some
  other server.
  ...
  Although the second [`INSERT`](insert.html "13.2.5 INSERT Statement")
  ...
  following [`SELECT`](select.html "13.2.9 SELECT Statement") statement.

  If you use [`INSERT
  IGNORE`](insert.html "13.2.5 INSERT Statement") and the row is ignored, the
  [`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) remains
  ...
  *************************** 1. row ***************************
  ...
  2. Use the table to generate sequence numbers like this:
     ...
     [`SELECT`](select.html "13.2.9 SELECT Statement") statement retrieves
     that value. The
  ...
  issue the [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement and
  get their own sequence value with the
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement (or
  [`mysql_insert_id()`](/doc/c-api/5.7/en/mysql-insert-id.html)), without
  affecting or being affected by other clients that generate
  their own sequence values.

  Note that [`mysql_insert_id()`](/doc/c-api/5.7/en/mysql-insert-id.html) is
  only updated after [`INSERT`](insert.html "13.2.5 INSERT Statement") and
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") statements, so you
...
* [`ROW_COUNT()`](information-functions.html#function_row-count)
  ...
  + DML statements other than
    [`SELECT`](select.html "13.2.9 SELECT Statement"): The number of
    ...
    [`DELETE`](delete.html "13.2.2 DELETE Statement") (as before), but now
    also to statements such as [`ALTER
    TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") and [`LOAD
    DATA`](load-data.html "13.2.6 LOAD DATA Statement").

  + [`SELECT`](select.html "13.2.9 SELECT Statement"): -1 if the statement
  ...
  + [`SIGNAL`](signal.html "13.6.7.5 SIGNAL Statement") statements: 0.

  For [`UPDATE`](update.html "13.2.11 UPDATE Statement") statements, the
  affected-rows value by default is the number of rows actually
  changed. If you specify the
  `CLIENT_FOUND_ROWS` flag to
  [`mysql_real_connect()`](/doc/c-api/5.7/en/mysql-real-connect.html) when
  connecting to [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"), the affected-rows
  value is the number of rows “found”; that is,
  matched by the `WHERE` clause.

  For [`REPLACE`](replace.html "13.2.8 REPLACE Statement") statements, the
  ...
  For
  [`INSERT
  ... ON DUPLICATE KEY UPDATE`](insert-on-duplicate.html "13.2.5.2 INSERT ... ON DUPLICATE KEY UPDATE Statement") statements, the
  ...
  function and the row count that the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")

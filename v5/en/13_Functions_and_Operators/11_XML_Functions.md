...
<th>Description</th>
</tr></thead><tbody><tr><td><code>ExtractValue()</code></td>
<td>
      Extract a value from an XML string using XPath notation
    </td>
</tr><tr><td><code>UpdateXML()</code></td>
<td>
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") and [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")
...
* [`ExtractValue(xml_frag,
  ...
  *`xml_frag`* consists of elements which
  ...
  [Section 10.8.4, “Collation Coercibility in Expressions”](charset-collation-coercibility.html "10.8.4 Collation Coercibility in Expressions"), for an

...
<table frame="box" rules="all" summary="A reference that lists assignment operators."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Name</th>
<th>Description</th>
...
* [`:=`](assignment-operators.html#operator_assign-value)
  ...
  Unlike
  [`=`](assignment-operators.html#operator_assign-equal), the
  [`:=`](assignment-operators.html#operator_assign-value)
  operator is never interpreted as a comparison operator. This
  means you can use
  [`:=`](assignment-operators.html#operator_assign-value) in
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement"), such as
  [`UPDATE`](update.html "13.2.11 UPDATE Statement"), as shown here:
  ...
  [Section 9.4, “User-Defined Variables”](user-variables.html "9.4 User-Defined Variables"), explains why you should
  avoid doing this.
...
* [`=`](assignment-operators.html#operator_assign-equal)
  ...
  are part of the [`UPDATE`](update.html "13.2.11 UPDATE Statement") are
  met. You can make multiple assignments in the same
  `SET` clause of an
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement.

  In any other context, `=` is treated as a
  [comparison operator](comparison-operators.html#operator_equal).
  ...
  For more information, see [Section 13.7.4.1, “SET Syntax for Variable Assignment”](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment"),
  [Section 13.2.11, “UPDATE Statement”](update.html "13.2.11 UPDATE Statement"), and [Section 13.2.10, “Subqueries”](subqueries.html "13.2.10 Subqueries").
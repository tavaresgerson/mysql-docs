...
</tr><tr><td><code>BETWEEN ... AND ...</code></td>
<td>
      Whether a value is within a range of values
    </td>
</tr><tr><td><code>COALESCE()</code></td>
<td>
      Return the first non-NULL argument
    </td>
</tr><tr><td><code>EXISTS()</code></td>
<td>
      Whether the result of a query contains any rows
    </td>
</tr><tr><td><code>GREATEST()</code></td>
<td>
...
</tr><tr><td><code>INTERVAL()</code></td>
<td>
      Return the index of the argument that is less than the first
      argument
    </td>
</tr><tr><td><code>IS</code></td>
<td>
      Test a value against a boolean
    </td>
</tr><tr><td><code>IS NOT</code></td>
<td>
      Test a value against a boolean
    </td>
</tr><tr><td><code>IS NOT NULL</code></td>
<td>
      NOT NULL value test
    </td>
</tr><tr><td><code>IS NULL</code></td>
<td>
      NULL value test
    </td>
</tr><tr><td><code>ISNULL()</code></td>
<td>
      Test whether the argument is NULL
    </td>
</tr><tr><td><code>LEAST()</code></td>
<td>
...
</tr><tr><td><code>NOT BETWEEN ... AND ...</code></td>
<td>
      Whether a value is not within a range of values
    </td>
</tr><tr><td><code>NOT EXISTS()</code></td>
<td>
      Whether the result of a query contains no rows
    </td>
</tr><tr><td><code>NOT IN()</code></td>
<td>
...
[Section 13.2.10.5, “Row Subqueries”](row-subqueries.html "13.2.10.5 Row Subqueries").
...
such functions; [Section 12.3, “Type Conversion in Expression Evaluation”](type-conversion.html "12.3 Type Conversion in Expression Evaluation"), describes the
...
* [`expr
  ...
  *`max`*,
  ...
  [Section 12.3, “Type Conversion in Expression Evaluation”](type-conversion.html "12.3 Type Conversion in Expression Evaluation"), but applied to all the
  three arguments.
  ...
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") to two
  [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values, convert the
  [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values to
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values. If you use a
  string constant such as `'2001-1-1'` in a
  comparison to a [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), cast
  the string to a [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types").
...
* [`expr
  ...
  *`expr`* is equal to any of the
  ...
  in [Section 12.3, “Type Conversion in Expression Evaluation”](type-conversion.html "12.3 Type Conversion in Expression Evaluation"), applied to all the
  arguments. If no type conversion is needed for the values in
  the `IN()` list, they are all constants of
  the same type, and *`expr`* can be
  ...
  *`expr`* is done using a binary
  ...
  [Section 13.2.10.3, “Subqueries with ANY, IN, or SOME”](any-in-some-subqueries.html "13.2.10.3 Subqueries with ANY, IN, or SOME").
...
* [`IS NULL`](comparison-operators.html#operator_is-null)
  ...
  + If [`sql_auto_is_null`](server-system-variables.html#sysvar_sql_auto_is_null)
    ...
    [Section 12.15, “Information Functions”](information-functions.html "12.15 Information Functions"). If no
    `AUTO_INCREMENT` value was successfully
    inserted, the [`SELECT`](select.html "13.2.9 SELECT Statement")
  ...
  + For [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") and
    [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns that are
...
* [`LEAST(value1,value2,...)`](comparison-operators.html#function_least)
  ...
  + If at least one argument is double precision, they are
    ...
    [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") value, they are
    compared as [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC")
    values.

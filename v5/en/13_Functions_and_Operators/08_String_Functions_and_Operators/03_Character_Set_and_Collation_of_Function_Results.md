...
applies for [`UNION`](union.html "13.2.9.3 UNION Clause"),
...
and collation (see [Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations")). This
applies only to [`CAST()`](cast-functions.html#function_cast),
...
As of MySQL 5.7.19, an exception to the preceding principle

...
<th>Description</th>
</tr></thead><tbody><tr><td><code>LIKE</code></td>
<td>
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client, binary strings display using
...
* [`expr
  ...
  *`pat`* is `NULL`,
  ...
  MySQL string types (see [Section 11.3, “String Data Types”](string-types.html "11.3 String Data Types")).
  ...
  true for comparisons of nonbinary strings
  (`CHAR`, `VARCHAR`, and
  `TEXT` values) performed with the

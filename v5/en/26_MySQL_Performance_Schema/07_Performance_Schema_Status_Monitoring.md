...
[`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table. This single
...
[`SHOW STATUS LIKE
'perf%'`](show-status.html "13.7.5.35 SHOW STATUS Statement") says that nothing was lost (all values are

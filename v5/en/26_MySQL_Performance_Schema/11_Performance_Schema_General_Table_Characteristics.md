...
events, so [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") can be
...
TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement"). Generally, the effect is to reset the summary

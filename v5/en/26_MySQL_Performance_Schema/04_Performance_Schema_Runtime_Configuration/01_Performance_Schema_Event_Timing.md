...
* [`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table") indicates which
  timers are used for which instruments.

Each timer row in [`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table")
must refer to one of the timers listed in
[`performance_timers`](performance-schema-performance-timers-table.html "25.12.16.2 The performance_timers Table").

Timers vary in precision and amount of overhead. To see what
timers are available and their characteristics, check the
[`performance_timers`](performance-schema-performance-timers-table.html "25.12.16.2 The performance_timers Table") table:
...
[`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table").
...
* The `TIMER_NAME` column shows the names
  ...
  [`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table") that you can use
...
the [`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table") table:
...
The [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table has
...
Modifications to the [`setup_timers`](performance-schema-setup-timers-table.html "25.12.2.5 The setup_timers Table")
...
[`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") to reset

...
The [`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table contains
...
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table. If a row from
...
[`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table row for the thread.
...
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table match any user
...
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table to affect
...
The [`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table has these
columns:
...
the [`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table. It
removes the rows.
...
the [`table_handles`](performance-schema-table-handles-table.html "25.12.12.2 The table_handles Table") table to show
the table locks currently in effect for each opened table
handle. [`table_handles`](performance-schema-table-handles-table.html "25.12.12.2 The table_handles Table") reports
...
The [`table_handles`](performance-schema-table-handles-table.html "25.12.12.2 The table_handles Table") table is read
...
The [`table_handles`](performance-schema-table-handles-table.html "25.12.12.2 The table_handles Table") table has these
columns:
...
for the [`table_handles`](performance-schema-table-handles-table.html "25.12.12.2 The table_handles Table") table.
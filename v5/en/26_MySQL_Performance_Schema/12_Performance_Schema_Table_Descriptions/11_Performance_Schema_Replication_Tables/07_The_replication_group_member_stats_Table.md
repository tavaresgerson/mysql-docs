...
This table shows statistical information for MySQL Group
Replication members. It is populated only when Group
...
* `TRANSACTIONS_COMMITTED_ALL_MEMBERS`
  ...
  [GTID Sets](replication-gtids-concepts.html#replication-gtids-concepts-gtid-sets "GTID Sets").

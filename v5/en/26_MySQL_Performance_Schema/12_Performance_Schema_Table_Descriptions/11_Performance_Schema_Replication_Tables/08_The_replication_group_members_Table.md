...
The `replication_group_members` table has
these columns:
...
* `MEMBER_HOST`
  ...
  [`hostname`](server-system-variables.html#sysvar_hostname) variable.
...
for the [`replication_group_members`](performance-schema-replication-group-members-table.html "25.12.11.8 The replication_group_members Table")
table.
...
The [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table") table
...
3. When a connection terminates, the row in
   [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table")
   corresponding to it is deleted.

The [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table") table has
these columns:
...
* `STATE`
  ...
  [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table") that is
  ...
  the [`events_waits_current`](performance-schema-events-waits-current-table.html "25.12.4.1 The events_waits_current Table")
...
for the [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table") table.

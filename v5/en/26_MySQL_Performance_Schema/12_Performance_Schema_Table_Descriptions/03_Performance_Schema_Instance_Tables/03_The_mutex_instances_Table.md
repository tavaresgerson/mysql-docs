...
The [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") table lists
...
The [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") table has
these columns:
...
for the [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") table.
...
* When some code creates a mutex, a row is added to the
  [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") table. The
...
* When a thread succeeds in locking a mutex:
  ...
  + [`events_waits_current`](performance-schema-events-waits-current-table.html "25.12.4.1 The events_waits_current Table")
  ...
  + [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") shows
    that the mutex is now owned by the thread (in the
    `THREAD_ID` column).

* When a thread unlocks a mutex,
  [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") shows that
  the mutex now has no owner (the
  `THREAD_ID` column is
  `NULL`).

* When a mutex object is destroyed, the corresponding row is
  removed from [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table").
...
* [`events_waits_current`](performance-schema-events-waits-current-table.html "25.12.4.1 The events_waits_current Table"), to see
  what mutex a thread is waiting for

* [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table"), to see which

...
The [`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table") table lists
all the [rwlock](glossary.html#glos_rw_lock "rw-lock") (read write
...
The [`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table") table has
these columns:
...
for the [`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table") table.
...
* [`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table"), to see
  which other thread currently owns an
  `rwlock`

There is a limitation: The
[`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table") can be used only

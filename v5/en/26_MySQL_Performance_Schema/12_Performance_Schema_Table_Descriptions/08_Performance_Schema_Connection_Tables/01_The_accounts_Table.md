...
The [`accounts`](performance-schema-accounts-table.html "25.12.8.1 The accounts Table") table contains a row
...
The [`accounts`](performance-schema-accounts-table.html "25.12.8.1 The accounts Table") table has the
following columns. For a description of how the Performance
Schema maintains rows in this table, including the effect of
[`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement"), see

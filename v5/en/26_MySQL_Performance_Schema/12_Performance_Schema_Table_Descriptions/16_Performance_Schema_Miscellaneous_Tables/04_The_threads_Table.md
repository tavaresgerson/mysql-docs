...
The [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table contains a row
...
[`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table based on the
...
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table. For
information about how to use the
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table to control
these columns, see
[Section 25.4.6, “Pre-Filtering by Thread”](performance-schema-thread-filtering.html "25.4.6 Pre-Filtering by Thread").

Removal of rows from the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table")
...
row in the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table that has
...
[`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") table may have
...
`INSTRUMENTED` and `HISTORY`
columns of [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table rows.
...
For a comparison of the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table")
...
[`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table, information
...
[`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table; all rows are
...
users by accessing the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table")
table should not be given the
[`SELECT`](privileges-provided.html#priv_select) privilege for it.

The [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table has these
columns:
...
* `PROCESSLIST_ID`
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "24.3.18 The INFORMATION_SCHEMA PROCESSLIST Table") table, displayed
  in the `Id` column of
...
* `PROCESSLIST_HOST`
  ...
  and examine the
  [`socket_instances`](performance-schema-socket-instances-table.html "25.12.3.5 The socket_instances Table") table:
...
* `PROCESSLIST_COMMAND`
  ...
  [Section 8.14, “Examining Server Thread (Process) Information”](thread-information.html "8.14 Examining Server Thread (Process) Information"). The value of this
...
* `PROCESSLIST_TIME`
  ...
  See [Section 16.2.3, “Replication Threads”](replication-threads.html "16.2.3 Replication Threads").
...
* `PROCESSLIST_STATE`
  ...
  [Section 8.14, “Examining Server Thread (Process) Information”](thread-information.html "8.14 Examining Server Thread (Process) Information"). If the value if
...
* `PROCESSLIST_INFO`
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement, the
...
* `INSTRUMENTED`
  ...
  + For foreground threads, the initial
    ...
    again for the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table")
    table row created for the subthread.

  + For background threads,
    `INSTRUMENTED` is
    `YES` by default.
    [`setup_actors`](performance-schema-setup-actors-table.html "25.12.2.1 The setup_actors Table") is not
  ...
  + The `thread_instrumentation` consumer
    in the [`setup_consumers`](performance-schema-setup-consumers-table.html "25.12.2.2 The setup_consumers Table")
    table must be `YES`.
  ...
  + Monitoring occurs only for those thread events
    ...
    `YES` in the
    [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table.
...
* `HISTORY`
  ...
  + The appropriate history-related consumers in the
    [`setup_consumers`](performance-schema-setup-consumers-table.html "25.12.2.2 The setup_consumers Table") table
    must be enabled. For example, wait event logging in
    the [`events_waits_history`](performance-schema-events-waits-history-table.html "25.12.4.2 The events_waits_history Table")
    and
    [`events_waits_history_long`](performance-schema-events-waits-history-long-table.html "25.12.4.3 The events_waits_history_long Table")
...
* `THREAD_OS_ID`
  ...
  + When a MySQL thread is not associated with the same
    ...
    [Section 5.5.3, “MySQL Enterprise Thread Pool”](thread-pool.html "5.5.3 MySQL Enterprise Thread Pool")).
...
[`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") is not permitted
for the [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table.
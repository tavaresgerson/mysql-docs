...
#### 26.4.4.1 The create\_synonym\_db() Procedure
...
#### 26.4.4.3 The execute\_prepared\_stmt() Procedure
...
`execute_prepared_stmt()` Procedure") operation can be modified using the following configuration options or their corresponding user-defined variables (see Section 26.4.2.1, “The sys\_config Table”):
...
#### 26.4.4.4 The ps\_setup\_disable\_background\_threads() Procedure
...
#### 26.4.4.5 The ps\_setup\_disable\_consumer() Procedure
...
#### 26.4.4.6 The ps\_setup\_disable\_instrument() Procedure
...
#### 26.4.4.8 The ps\_setup\_enable\_background\_threads() Procedure
...
#### 26.4.4.9 The ps\_setup\_enable\_consumer() Procedure
...
#### 26.4.4.10 The ps\_setup\_enable\_instrument() Procedure
...
#### 26.4.4.13 The ps\_setup\_reset\_to\_default() Procedure
...
#### 26.4.4.14 The ps\_setup\_save() Procedure
...
#### 26.4.4.15 The ps\_setup\_show\_disabled() Procedure
...
#### 26.4.4.20 The ps\_setup\_show\_enabled\_instruments() Procedure
...
#### 26.4.4.22 The ps\_trace\_statement\_digest() Procedure
...
* `in_verbose BOOLEAN`: Whether to display each [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") statement before executing it.
...
#### 26.4.4.25 The statement\_performance\_analyzer() Procedure
...
`statement_performance_analyzer()` Procedure") operation can be modified using the following configuration options or their corresponding user-defined variables (see Section 26.4.2.1, “The sys\_config Table”):
...
#### 26.4.4.26 The table\_exists() Procedure
...
#### 26.4.5.4 The format\_path() Function
...
#### 26.4.5.5 The format\_statement() Function
...
`format_statement()` Function") operation can be modified using the following configuration options or their corresponding user-defined variables (see Section 26.4.2.1, “The sys\_config Table”):
...
#### 26.4.5.8 The list\_drop() Function
...
#### 26.4.5.9 The ps\_is\_account\_enabled() Function
...
#### 26.4.5.10 The ps\_is\_consumer\_enabled() Function
...
#### 26.4.5.16 The ps\_thread\_stack() Function
...
#### 26.4.5.19 The sys\_get\_config() Function
...
#### 26.4.5.21 The version\_minor() Function
...
#### 26.4.5.22 The version\_patch() Function

...
Before using the [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema, the
prerequisites described in this section must be satisfied.

Because the [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema provides an
alternative means of accessing the Performance Schema, the
Performance Schema must be enabled for the
[`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema to work. See
...
For full access to the [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema, a
user must have these privileges:

* [`SELECT`](privileges-provided.html#priv_select) on all
  [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") tables and views

* [`EXECUTE`](privileges-provided.html#priv_execute) on all
  [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") stored procedures and
  functions

* [`INSERT`](privileges-provided.html#priv_insert) and
  [`UPDATE`](privileges-provided.html#priv_update) for the
  [`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table") table, if changes are
  to be made to it

* Additional privileges for certain
  [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema stored procedures and
  functions, as noted in their descriptions (for example, the
  [`ps_setup_save()`](sys-ps-setup-save.html "26.4.4.14 The ps_setup_save() Procedure") procedure)

It is also necessary to have privileges for the objects underlying
the [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema objects:

* [`SELECT`](privileges-provided.html#priv_select) on any Performance
  Schema tables accessed by [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema")
  schema objects, and [`UPDATE`](privileges-provided.html#priv_update) for
  any tables to be updated using
  [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema objects

* [`PROCESS`](privileges-provided.html#priv_process) for the
  `INFORMATION_SCHEMA`
  [`INNODB_BUFFER_PAGE`](information-schema-innodb-buffer-page-table.html "24.4.2 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE Table") table

Certain Performance Schema instruments and consumers must be
enabled and (for instruments) timed to take full advantage of
[`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema capabilities:
...
You can use the [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema itself to

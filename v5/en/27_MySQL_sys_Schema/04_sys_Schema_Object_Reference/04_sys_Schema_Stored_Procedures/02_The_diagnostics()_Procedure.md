...
Data collected for [`diagnostics()`](sys-diagnostics.html "26.4.4.2 The diagnostics() Procedure")
includes this information:

* Information from the [`metrics`](sys-metrics.html "26.4.3.21 The metrics View")
  view (see [Section 26.4.3.21, “The metrics View”](sys-metrics.html "26.4.3.21 The metrics View"))

* Information from other relevant `sys`
  schema views, such as the one that detemines queries in
  the 95th percentile

* Information from the `ndbinfo` schema, if
  the MySQL server is part of NDB Cluster
...
* The initial view is the content of the view at the start
  of the [`diagnostics()`](sys-diagnostics.html "26.4.4.2 The diagnostics() Procedure")
...
* The overall view is the content of the view at the end of
  the [`diagnostics()`](sys-diagnostics.html "26.4.4.2 The diagnostics() Procedure") procedure.
...
* The delta view is the difference from the beginning to the
  ...
  [`metrics`](sys-metrics.html "26.4.3.21 The metrics View") view, the delta is
...
[`diagnostics()`](sys-diagnostics.html "26.4.4.2 The diagnostics() Procedure") operation can be
...
* `diagnostics.allow_i_s_tables`,
  ...
  Schema [`TABLES`](information-schema-tables-table.html "24.3.25 The INFORMATION_SCHEMA TABLES Table") table. This
...
* `diagnostics.include_raw`,
  ...
  [`metrics`](sys-metrics.html "26.4.3.21 The metrics View") view. The default
  is `OFF`.
...
* `statement_truncate_len`,
  ...
  [`format_statement()`](sys-format-statement.html "26.4.5.5 The format_statement() Function")
...
runs, use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client `tee
filename` and
`notee` commands (see

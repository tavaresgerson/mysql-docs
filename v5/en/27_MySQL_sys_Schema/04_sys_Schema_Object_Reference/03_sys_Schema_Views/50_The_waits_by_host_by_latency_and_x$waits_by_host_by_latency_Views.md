...
The [`waits_by_host_by_latency`](sys-waits-by-host-by-latency.html "26.4.3.50 The waits_by_host_by_latency and x$waits_by_host_by_latency Views") and
[`x$waits_by_host_by_latency`](sys-waits-by-host-by-latency.html "26.4.3.50 The waits_by_host_by_latency and x$waits_by_host_by_latency Views") views
have these columns:

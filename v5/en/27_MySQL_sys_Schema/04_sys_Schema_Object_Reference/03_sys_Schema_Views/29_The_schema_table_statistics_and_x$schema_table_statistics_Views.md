...
The [`schema_table_statistics`](sys-schema-table-statistics.html "26.4.3.29 The schema_table_statistics and x$schema_table_statistics Views") and
[`x$schema_table_statistics`](sys-schema-table-statistics.html "26.4.3.29 The schema_table_statistics and x$schema_table_statistics Views") views
have these columns:

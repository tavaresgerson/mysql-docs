...
[`metadata_locks`](performance-schema-metadata-locks-table.html "25.12.12.1 The metadata_locks Table") table at
...
The [`schema_table_lock_waits`](sys-schema-table-lock-waits.html "26.4.3.28 The schema_table_lock_waits and x$schema_table_lock_waits Views") and
[`x$schema_table_lock_waits`](sys-schema-table-lock-waits.html "26.4.3.28 The schema_table_lock_waits and x$schema_table_lock_waits Views") views
have these columns:
...
* `sql_kill_blocking_query`
  ...
  The [`KILL`](kill.html "13.7.6.4 KILL Statement") statement to

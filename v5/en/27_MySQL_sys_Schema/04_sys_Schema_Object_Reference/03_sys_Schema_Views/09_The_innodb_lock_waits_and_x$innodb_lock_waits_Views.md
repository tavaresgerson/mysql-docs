...
The [`innodb_lock_waits`](sys-innodb-lock-waits.html "26.4.3.9 The innodb_lock_waits and x$innodb_lock_waits Views") and
[`x$innodb_lock_waits`](sys-innodb-lock-waits.html "26.4.3.9 The innodb_lock_waits and x$innodb_lock_waits Views") views have
these columns:
...
* `wait_age`
  ...
  [`TIME`](time.html "11.2.3 The TIME Type") value.
...
* `locked_table`
  ...
  The name of the locked table. This column contains
  combined schema/table name values.

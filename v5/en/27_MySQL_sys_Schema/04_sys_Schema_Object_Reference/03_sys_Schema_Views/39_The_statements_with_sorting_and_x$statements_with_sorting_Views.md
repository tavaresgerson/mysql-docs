...
The [`statements_with_sorting`](sys-statements-with-sorting.html "26.4.3.39 The statements_with_sorting and x$statements_with_sorting Views") and
[`x$statements_with_sorting`](sys-statements-with-sorting.html "26.4.3.39 The statements_with_sorting and x$statements_with_sorting Views") views
have these columns:

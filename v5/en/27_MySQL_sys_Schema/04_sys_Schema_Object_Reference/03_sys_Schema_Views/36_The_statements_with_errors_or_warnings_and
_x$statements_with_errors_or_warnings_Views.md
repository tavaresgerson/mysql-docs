...
and
[`x$statements_with_errors_or_warnings`](sys-statements-with-errors-or-warnings.html "26.4.3.36 The statements_with_errors_or_warnings and x$statements_with_errors_or_warnings Views")

...
The
[`memory_by_user_by_current_bytes`](sys-memory-by-user-by-current-bytes.html "26.4.3.18 The memory_by_user_by_current_bytes and x$memory_by_user_by_current_bytes Views")
and
[`x$memory_by_user_by_current_bytes`](sys-memory-by-user-by-current-bytes.html "26.4.3.18 The memory_by_user_by_current_bytes and x$memory_by_user_by_current_bytes Views")

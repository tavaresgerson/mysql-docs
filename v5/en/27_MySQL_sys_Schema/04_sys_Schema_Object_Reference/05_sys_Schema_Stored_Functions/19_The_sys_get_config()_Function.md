...
from the [`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table") table, or
the provided default value (which may be
`NULL`) if the option does not exist in the
table.

If [`sys_get_config()`](sys-sys-get-config.html "26.4.5.19 The sys_get_config() Function") returns the
...
[`sys_get_config()`](sys-sys-get-config.html "26.4.5.19 The sys_get_config() Function") first check
...
[`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table") table. If the
...
[`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table") table, falling back
...
[`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table") table):
...
value from the [`sys_config`](sys-sys-config.html "26.4.2.1 The sys_config Table")
table:

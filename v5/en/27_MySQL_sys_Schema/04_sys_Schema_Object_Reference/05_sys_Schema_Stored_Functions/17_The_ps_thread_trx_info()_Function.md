...
Performance Schema
[`events_transactions_current`](performance-schema-events-transactions-current-table.html "25.12.7.1 The events_transactions_current Table") and
[`events_statements_history`](performance-schema-events-statements-history-table.html "25.12.6.2 The events_statements_history Table") tables.
...
* `in_thread_id BIGINT UNSIGNED`: The
  ...
  [`threads`](performance-schema-threads-table.html "25.12.16.4 The threads Table") table row.

##### Configuration Options

[`ps_thread_trx_info()`](sys-ps-thread-trx-info.html "26.4.5.17 The ps_thread_trx_info() Function") operation

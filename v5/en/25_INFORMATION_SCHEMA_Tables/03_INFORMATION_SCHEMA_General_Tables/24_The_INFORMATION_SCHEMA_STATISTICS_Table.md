...
The [`STATISTICS`](information-schema-statistics-table.html "24.3.24 The INFORMATION_SCHEMA STATISTICS Table") table provides
information about table indexes.

The [`STATISTICS`](information-schema-statistics-table.html "24.3.24 The INFORMATION_SCHEMA STATISTICS Table") table has these
columns:
...
* `CARDINALITY`
  ...
  TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") or (for `MyISAM` tables)
  [**myisamchk -a**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility").
...
* `SUB_PART`
  ...
  [Section 8.3.4, “Column Indexes”](column-indexes.html "8.3.4 Column Indexes"), and
...
[`SHOW INDEX`](show-index.html "13.7.5.22 SHOW INDEX Statement") statement. See
[Section 13.7.5.22, “SHOW INDEX Statement”](show-index.html "13.7.5.22 SHOW INDEX Statement"). The following statements are
equivalent:

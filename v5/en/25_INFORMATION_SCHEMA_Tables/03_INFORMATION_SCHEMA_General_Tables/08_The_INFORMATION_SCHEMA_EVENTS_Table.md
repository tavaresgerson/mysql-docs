...
The [`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") table provides information
...
* `EVENT_BODY`
  ...
  [`DO`](do.html "13.2.3 DO Statement") clause. The value is always
  `SQL`.

* `EVENT_DEFINITION`

  The text of the SQL statement making up the event's
  [`DO`](do.html "13.2.3 DO Statement") clause; in other words, the
...
* `EXECUTE_AT`
  ...
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value specified in the
  `AT` clause of the
  [`CREATE EVENT`](create-event.html "13.1.12 CREATE EVENT Statement") statement used to
  create the event, or of the last [`ALTER
  EVENT`](alter-event.html "13.1.2 ALTER EVENT Statement") statement that modified the event. The value
...
* `STARTS`
  ...
  displayed as a [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value,
  ...
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. As with the
...
* `ENDS`
  ...
  corresponding [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value.
...
* `STATUS`
  ...
  see [Section 16.4.1.16, “Replication of Invoked Features”](replication-features-invoked.html "16.4.1.16 Replication of Invoked Features").
  information.
...
* `LAST_ALTERED`
  ...
  [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. If the event
...
* `LAST_EXECUTED`
  ...
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. If the event
...
* `ORIGINATOR`
  ...
  [`ALTER EVENT`](alter-event.html "13.1.2 ALTER EVENT Statement") to the server ID of
...
* [`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") is a nonstandard
  `INFORMATION_SCHEMA` table.

* Times in the [`EVENTS`](information-schema-events-table.html "24.3.8 The INFORMATION_SCHEMA EVENTS Table") table are
...
EVENT`](alter-event.html "13.1.2 ALTER EVENT Statement") statement, as shown here:
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement, and obtain the
output shown:
...
[`SHOW EVENTS`](show-events.html "13.7.5.18 SHOW EVENTS Statement") statement. See
[Section 13.7.5.18, “SHOW EVENTS Statement”](show-events.html "13.7.5.18 SHOW EVENTS Statement"). The following statements are
equivalent:

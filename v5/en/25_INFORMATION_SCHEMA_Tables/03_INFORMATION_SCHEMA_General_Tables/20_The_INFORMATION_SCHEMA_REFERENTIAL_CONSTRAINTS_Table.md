...
The [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "24.3.20 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table") table
provides information about foreign keys.

The [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "24.3.20 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table") table has
these columns:
...
* `UNIQUE_CONSTRAINT_SCHEMA`
  ...
  The name of the schema (database) containing the unique
  constraint that the constraint references.
...
* `TABLE_NAME`
  ...
  [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "24.3.27 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table") table.

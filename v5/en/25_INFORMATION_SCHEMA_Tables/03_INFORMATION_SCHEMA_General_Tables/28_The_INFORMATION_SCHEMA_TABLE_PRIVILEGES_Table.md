...
The [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "24.3.28 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") table provides
information about table privileges. It takes its values from the
`mysql.tables_priv` system table.

The [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "24.3.28 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") table has these
columns:
...
* `PRIVILEGE_TYPE`
  ...
  be granted at the table level; see [Section 13.7.1.4, “GRANT Statement”](grant.html "13.7.1.4 GRANT Statement").
...
* [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "24.3.28 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") is a nonstandard

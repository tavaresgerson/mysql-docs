...
The [`TRIGGERS`](information-schema-triggers-table.html "24.3.29 The INFORMATION_SCHEMA TRIGGERS Table") table provides
...
* `EVENT_OBJECT_CATALOG`,
  ...
  As noted in [Section 23.3, “Using Triggers”](triggers.html "23.3 Using Triggers"), every trigger is
...
* `CREATED`
  ...
  in hundredths of seconds) for triggers created in MySQL 5.7.2
  or later, `NULL` for triggers created prior
  to 5.7.2.
...
defined in [Section 23.3, “Using Triggers”](triggers.html "23.3 Using Triggers"):
...
[`SHOW TRIGGERS`](show-triggers.html "13.7.5.38 SHOW TRIGGERS Statement") statement. See

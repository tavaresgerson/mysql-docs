...
The [`ROUTINES`](information-schema-routines-table.html "24.3.21 The INFORMATION_SCHEMA ROUTINES Table") table provides
information about stored routines (stored procedures and stored
functions). The [`ROUTINES`](information-schema-routines-table.html "24.3.21 The INFORMATION_SCHEMA ROUTINES Table") table does
...
[`ROUTINES`](information-schema-routines-table.html "24.3.21 The INFORMATION_SCHEMA ROUTINES Table") table column, if any.
...
* `LAST_ALTERED`
  ...
  a [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. If the
...
* `SQL_MODE`
  ...
  permitted values, see [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").
...
* To see information about a routine, you must be the user named
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") access to the
...
* Information about stored function return values is also
  available in the [`PARAMETERS`](information-schema-parameters-table.html "24.3.15 The INFORMATION_SCHEMA PARAMETERS Table")

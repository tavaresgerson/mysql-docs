...
The [`INNODB_BUFFER_PAGE`](information-schema-innodb-buffer-page-table.html "24.4.2 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE Table") table provides
...
The [`INNODB_BUFFER_PAGE`](information-schema-innodb-buffer-page-table.html "24.4.2 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE Table") table has
these columns:
...
<td><code>READY_FOR_USE</code></td>
<td>A free page</td>
</tr><tr>
<td><code>REMOVE_HASH</code></td>
...
* When tables, table rows, partitions, or indexes are deleted,
  ...
  [`INNODB_BUFFER_PAGE`](information-schema-innodb-buffer-page-table.html "24.4.2 The INFORMATION_SCHEMA INNODB_BUFFER_PAGE Table") table reports

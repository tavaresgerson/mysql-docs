...
The [`INNODB_SYS_TABLESTATS`](information-schema-innodb-sys-tablestats-table.html "24.4.25 The INFORMATION_SCHEMA INNODB_SYS_TABLESTATS View") table
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") operations that modify
indexed columns. Statistics are not updated by operations that
modify only nonindexed columns.

[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") clears table
...
The [`INNODB_SYS_TABLESTATS`](information-schema-innodb-sys-tablestats-table.html "24.4.25 The INFORMATION_SCHEMA INNODB_SYS_TABLESTATS View") table has
these columns:

...
The [`INNODB_SYS_INDEXES`](information-schema-innodb-sys-indexes-table.html "24.4.22 The INFORMATION_SCHEMA INNODB_SYS_INDEXES Table") table provides
...
The [`INNODB_SYS_INDEXES`](information-schema-innodb-sys-indexes-table.html "24.4.22 The INFORMATION_SCHEMA INNODB_SYS_INDEXES Table") table has
these columns:
...
* `TYPE`
  ...
  [virtual
  generated column](glossary.html#glos_virtual_generated_column "virtual generated column").
...
* `SPACE`
  ...
  means the `InnoDB`
  [system
  tablespace](glossary.html#glos_system_tablespace "system tablespace"). Any other number represents a table created

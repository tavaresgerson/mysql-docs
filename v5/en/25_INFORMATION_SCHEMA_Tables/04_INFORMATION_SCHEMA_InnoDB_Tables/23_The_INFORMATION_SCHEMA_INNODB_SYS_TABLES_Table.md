...
The [`INNODB_SYS_TABLES`](information-schema-innodb-sys-tables-table.html "24.4.23 The INFORMATION_SCHEMA INNODB_SYS_TABLES Table") table provides
...
The [`INNODB_SYS_TABLES`](information-schema-innodb-sys-tables-table.html "24.4.23 The INFORMATION_SCHEMA INNODB_SYS_TABLES Table") table has these
columns:
...
* `N_COLS`
  ...
  includes [virtual
  generated columns](glossary.html#glos_virtual_generated_column "virtual generated column"), if present.
...
* `SPACE`
  ...
  means the `InnoDB`
  [system
  tablespace](glossary.html#glos_system_tablespace "system tablespace"). Any other number represents either a
  ...
  same after a [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement")
...
* `SPACE_TYPE`
  ...
  TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement").

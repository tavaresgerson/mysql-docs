...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") output. Much of the same information may also be
obtained using `InnoDB` buffer pool
[server status
variables](server-status-variables.html "5.1.9 Server Status Variables").

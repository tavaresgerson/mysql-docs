...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is run, when the server is shut down, or when the
...
The [`INNODB_FT_INDEX_CACHE`](information-schema-innodb-ft-index-cache-table.html "24.4.12 The INFORMATION_SCHEMA INNODB_FT_INDEX_CACHE Table") table has
these columns:

...
the default database with a [`USE`](use.html "13.8.4 USE Statement")
...
[`DELETE`](delete.html "13.2.2 DELETE Statement") operations on them.
...
see [Section 10.8.7, “Using Collation in INFORMATION\_SCHEMA Searches”](charset-collation-information-schema.html "10.8.7 Using Collation in INFORMATION_SCHEMA Searches").
...
[`SHOW`](show.html "13.7.5 SHOW Statements") statements that MySQL
supports ([`SHOW DATABASES`](show-databases.html "13.7.5.14 SHOW DATABASES Statement"),
[`SHOW TABLES`](show-tables.html "13.7.5.37 SHOW TABLES Statement"), and so forth). Using
[`SELECT`](select.html "13.2.9 SELECT Statement") has these advantages,
compared to [`SHOW`](show.html "13.7.5 SHOW Statements"):

* It conforms to Codd's rules, because all access is done on
  tables.

* You can use the familiar syntax of the
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement, and only
...
Because [`SHOW`](show.html "13.7.5 SHOW Statements") is familiar and
widely used, the [`SHOW`](show.html "13.7.5 SHOW Statements") statements
remain as an alternative. In fact, along with the implementation
of `INFORMATION_SCHEMA`, there are enhancements
to [`SHOW`](show.html "13.7.5 SHOW Statements") as described in
...
`INFORMATION_SCHEMA`
[`ROUTINES`](information-schema-routines-table.html "24.3.21 The INFORMATION_SCHEMA ROUTINES Table") table), users who have
...
For example, [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables (tables
...
information through [`SHOW`](show.html "13.7.5 SHOW Statements")
...
can use [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement"). For information
about using [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output to
...
[`TABLES`](information-schema-tables-table.html "24.3.25 The INFORMATION_SCHEMA TABLES Table") table.) See the list of
...
* “[`SHOW`](show.html "13.7.5 SHOW Statements") Name”
  indicates the equivalent field name in the closest
  [`SHOW`](show.html "13.7.5 SHOW Statements") statement, if there is
  one.
...
Many sections indicate what [`SHOW`](show.html "13.7.5 SHOW Statements")
statement is equivalent to a
[`SELECT`](select.html "13.2.9 SELECT Statement") that retrieves information
from `INFORMATION_SCHEMA`. For
[`SHOW`](show.html "13.7.5 SHOW Statements") statements that display
...
* information about `INFORMATION_SCHEMA`
  tables specific to the [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine")
  storage engine:
  [Section 24.4, “INFORMATION\_SCHEMA InnoDB Tables”](innodb-information-schema-tables.html "24.4 INFORMATION_SCHEMA InnoDB Tables")
...
* information about `INFORMATION_SCHEMA`
  ...
  plugin:
  [Section 24.6, “INFORMATION\_SCHEMA Connection Control Tables”](connection-control-information-schema-tables.html "24.6 INFORMATION_SCHEMA Connection Control Tables")

* Answers to questions that are often asked concerning the
  `INFORMATION_SCHEMA` database:
  [Section A.7, “MySQL 5.7 FAQ: INFORMATION\_SCHEMA”](faqs-information-schema.html "A.7 MySQL 5.7 FAQ: INFORMATION_SCHEMA")

* `INFORMATION_SCHEMA` queries and the
  optimizer: [Section 8.2.3, “Optimizing INFORMATION\_SCHEMA Queries”](information-schema-optimization.html "8.2.3 Optimizing INFORMATION_SCHEMA Queries")

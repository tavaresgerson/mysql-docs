...
The [`TP_THREAD_GROUP_STATE`](information-schema-tp-thread-group-state-table.html "24.5.2 The INFORMATION_SCHEMA TP_THREAD_GROUP_STATE Table") table has
...
* `RESERVE_THREADS`
  ...
  they are not started until there is a need to wake a new
...
* `ALGORITHM`
  ...
  The value of the
  [`thread_pool_algorithm`](server-system-variables.html#sysvar_thread_pool_algorithm) system
...
* `MAX_THREAD_IDS_IN_GROUP`
  ...
  same as [`MAX(TP_THREAD_NUMBER)`](aggregate-functions.html#function_max)
  for the threads when selected from the
  [`TP_THREAD_STATE`](information-schema-tp-thread-state-table.html "24.5.4 The INFORMATION_SCHEMA TP_THREAD_STATE Table") table. That is,

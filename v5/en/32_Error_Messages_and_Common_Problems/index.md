...
* Information about configuring where and how the server writes
  the error log: [Section 5.4.2, “The Error Log”](error-log.html "5.4.2 The Error Log")
...
* Descriptions of the error messages that the MySQL server and
  client programs generate: [MySQL 5.7 Error Message Reference](/doc/mysql-errors/5.7/en/)
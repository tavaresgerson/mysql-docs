...
* Information about errors related to `InnoDB`: Section 14.22.4, “InnoDB Error Handling”
...
* Descriptions of the error messages that the MySQL server and client programs generate: MySQL 5.7 Error Message Reference
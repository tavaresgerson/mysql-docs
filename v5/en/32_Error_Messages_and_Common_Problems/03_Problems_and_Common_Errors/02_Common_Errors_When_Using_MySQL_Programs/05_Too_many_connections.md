...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server, all available connections
...
[`max_connections`](server-system-variables.html#sysvar_max_connections) to a larger
value.
...
connections, see [Section 5.1.11.1, “Connection Interfaces”](connection-interfaces.html "5.1.11.1 Connection Interfaces").
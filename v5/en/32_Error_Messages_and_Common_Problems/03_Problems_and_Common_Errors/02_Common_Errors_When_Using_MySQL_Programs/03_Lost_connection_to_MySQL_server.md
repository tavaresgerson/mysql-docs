...
increasing [`net_read_timeout`](server-system-variables.html#sysvar_net_read_timeout)
...
[`connect_timeout`](server-system-variables.html#sysvar_connect_timeout) value is set
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") values that are larger
...
see an [`ER_NET_PACKET_TOO_LARGE`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_net_packet_too_large)

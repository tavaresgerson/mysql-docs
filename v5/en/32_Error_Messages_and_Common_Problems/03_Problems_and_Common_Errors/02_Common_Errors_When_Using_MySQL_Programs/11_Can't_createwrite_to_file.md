...
One fix is to start [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with the
...
[**perror**](perror.html "4.8.2 perror — Display MySQL Error Message Information"). One reason the server cannot write

...
without [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") having died unexpectedly
...
See also [Section 5.1.6, “Server Command Options”](server-options.html "5.1.6 Server Command Options"), and

...
variable when you start [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"). See
...
* You (or the db administrator) has killed the running
  thread with a [`KILL`](kill.html "13.7.6.4 KILL Statement")
  statement or a [**mysqladmin kill**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command.
...
* You got a timeout from the TCP/IP connection on the client
  ...
  [`mysql_options(...,
  MYSQL_OPT_READ_TIMEOUT,...)`](/doc/c-api/5.7/en/mysql-options.html) or
  [`mysql_options(...,
  MYSQL_OPT_WRITE_TIMEOUT,...)`](/doc/c-api/5.7/en/mysql-options.html). In this case
...
* You are using a Windows client and the server had dropped
  ...
  [`mysql_ping()`](/doc/c-api/5.7/en/mysql-ping.html) on the
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server so high that it in
  practice never times out.

* You can also get these errors if you send a query to the
  server that is incorrect or too large. If
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") receives a packet that is too
  ...
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") columns), you can
  ...
  An [`INSERT`](insert.html "13.2.5 INSERT Statement") or
  [`REPLACE`](replace.html "13.2.8 REPLACE Statement") statement that
...
executing [**mysqladmin version**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") and examining
the server's uptime. If the client connection was broken
because [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") crashed and restarted, you
...
starting [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with the
...
* If a specific query kills [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") and
  the tables involved were checked with
  [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") before you ran
...
* What is the value of the
  ...
  variables**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") gives you the value of this variable.)

* Have you tried to run [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with the

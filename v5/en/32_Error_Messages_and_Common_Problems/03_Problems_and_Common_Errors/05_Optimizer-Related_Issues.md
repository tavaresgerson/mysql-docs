...
* Use the [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") statement to
  get information about how MySQL processes a query. To use
  it, just add the keyword
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") to the front of your
  ...
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") is discussed in more
  detail in [Section 13.8.2, “EXPLAIN Statement”](explain.html "13.8.2 EXPLAIN Statement").
...
* You can tune global or thread-specific system variables. For
  example, start [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with the

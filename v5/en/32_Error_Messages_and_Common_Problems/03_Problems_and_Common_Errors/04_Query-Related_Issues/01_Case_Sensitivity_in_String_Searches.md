...
For nonbinary strings ([`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"),
[`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"),
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types")), string searches use the
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types")), comparisons use the
...
string, use the [`COLLATION()`](information-functions.html#function_collation)
function. This example shows that
[`VERSION()`](information-functions.html#function_version) returns a string that
...
See [Section 12.8, “String Functions and Operators”](string-functions.html "12.8 String Functions and Operators").
...
[**mysql.server**](mysql-server.html "4.3.3 mysql.server — MySQL Server Startup Script")). See
...
[`--timezone=timezone_name`](mysqld-safe.html#option_mysqld_safe_timezone)
option to [`mysqld_safe`](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script"). You can also set it
...
[`--timezone`](mysqld-safe.html#option_mysqld_safe_timezone) or

...
* If the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server is causing problems,
  can you get any response from it with [**mysqladmin -u
  root ping**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") or [**mysqladmin -u root
  processlist**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program")?

* What does a client program say when you try to connect to
  the MySQL server? (Try with [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), for

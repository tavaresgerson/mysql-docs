...
[`CHANGE MASTER TO`](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement") statement used to
...
[`replication_connection_status`](performance-schema-replication-connection-status-table.html "25.12.11.2 The replication_connection_status Table") table
...
[`ER_FOUND_MISSING_GTIDS`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_found_missing_gtids). The
...
[`ER_FOUND_MISSING_GTIDS`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_found_missing_gtids) message

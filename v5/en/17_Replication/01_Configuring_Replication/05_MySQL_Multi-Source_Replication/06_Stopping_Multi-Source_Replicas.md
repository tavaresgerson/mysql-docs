...
The [`STOP SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") statement can be
used to stop a multi-source replica. By default, if you use the
[`STOP SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") statement on a
...
SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") command and other available options, see

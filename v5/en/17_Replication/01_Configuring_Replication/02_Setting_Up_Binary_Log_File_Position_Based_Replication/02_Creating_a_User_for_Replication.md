...
MASTER TO` command when you set up a replica. Any
account can be used for this operation, providing it has been
granted the [`REPLICATION SLAVE`](privileges-provided.html#priv_replication-slave)
...
and password are stored in plain text in the replication
metadata repositories (see
[Section 16.2.4.2, “Replication Metadata Repositories”](replica-logs-status.html "16.2.4.2 Replication Metadata Repositories")). Therefore, you may want
...
USER`](create-user.html "13.7.1.2 CREATE USER Statement"). To grant this account the privileges required
for replication, use the [`GRANT`](grant.html "13.7.1.4 GRANT Statement")
...
See [Section 13.7.1, “Account Management Statements”](account-management-statements.html "13.7.1 Account Management Statements"), for more

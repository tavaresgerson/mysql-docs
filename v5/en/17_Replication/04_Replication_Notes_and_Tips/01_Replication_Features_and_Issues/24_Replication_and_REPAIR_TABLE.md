...
possible for the [`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement")
...
[`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") to repair it, you
should first stop replication (if it is still running) before
using [`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement"), then

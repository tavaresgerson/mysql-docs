...
The [`DROP DATABASE
IF EXISTS`](drop-database.html "13.1.22 DROP DATABASE Statement"),
[`DROP TABLE IF
EXISTS`](drop-table.html "13.1.29 DROP TABLE Statement"), and
[`DROP VIEW IF
EXISTS`](drop-view.html "13.1.32 DROP VIEW Statement") statements are always replicated, even if the

...
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) sets an
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") columns) and
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) is too small
...
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) large enough
...
[`slave_pending_jobs_size_max`](replication-options-replica.html#sysvar_slave_pending_jobs_size_max) is
...
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet), which is
64M. [`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) limits
...
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) size,
because the value of
[`max_allowed_packet`](server-system-variables.html#sysvar_max_allowed_packet) only limits
...
of [`slave_pending_jobs_size_max`](replication-options-replica.html#sysvar_slave_pending_jobs_size_max)
...
larger than
[`slave_pending_jobs_size_max`](replication-options-replica.html#sysvar_slave_pending_jobs_size_max) can

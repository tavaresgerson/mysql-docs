...
problem. [`SHOW SLAVE STATUS`](show-slave-status.html "13.7.5.34 SHOW SLAVE STATUS Statement") is
useful for this. Then fix the problem and run
[`START SLAVE`](start-slave.html "13.4.2.5 START SLAVE Statement"). For example, you
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") statement accessing an

...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement on the
...
the replica host's file system or if it exists but is not
accessible to the replica server. This can be overridden by
using the [`NO_DIR_IN_CREATE`](sql-mode.html#sqlmode_no_dir_in_create)
...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements. The

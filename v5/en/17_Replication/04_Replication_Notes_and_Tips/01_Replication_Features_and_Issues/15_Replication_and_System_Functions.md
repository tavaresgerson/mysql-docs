...
* The [`USER()`](information-functions.html#function_user),
  ...
  [`VERSION()`](information-functions.html#function_version), and
  [`LOAD_FILE()`](string-functions.html#function_load-file) functions are
  ...
  [`CURRENT_USER()`](information-functions.html#function_current-user) are
  ...
  [Section 16.4.1.8, “Replication of CURRENT\_USER()”](replication-features-current-user.html "16.4.1.8 Replication of CURRENT_USER()").) This
  is also true for [`VERSION()`](information-functions.html#function_version)
  and [`RAND()`](mathematical-functions.html#function_rand).

* For [`NOW()`](date-and-time-functions.html#function_now), the binary log
  ...
  *as returned by the call to this function on the
  ...
  `mytable`, perform an
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement on this
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements just shown
  ...
  Unlike [`NOW()`](date-and-time-functions.html#function_now), the
  [`SYSDATE()`](date-and-time-functions.html#function_sysdate) function is not
  ...
  cause [`SYSDATE()`](date-and-time-functions.html#function_sysdate) to be an
  alias for [`NOW()`](date-and-time-functions.html#function_now). This must be
  ...
  [`--sysdate-is-now`](server-options.html#option_mysqld_sysdate-is-now) is used on
  both the source and the replica.

  [`SYSDATE()`](date-and-time-functions.html#function_sysdate) is automatically
...
* *The following restriction applies to
  ...
  [`IS_FREE_LOCK()`](locking-functions.html#function_is-free-lock), and
  [`IS_USED_LOCK()`](locking-functions.html#function_is-used-lock) functions that
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") is problematic due to the
reference to the [`UUID()`](miscellaneous-functions.html#function_uuid) function:
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") statement and is available
for use in the [`INSERT`](insert.html "13.2.5 INSERT Statement").
...
Within a stored function, [`RAND()`](mathematical-functions.html#function_rand)
...
The [`FOUND_ROWS()`](information-functions.html#function_found-rows) and
[`ROW_COUNT()`](information-functions.html#function_row-count) functions are not
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") statement. For example, if
...
should use [`SELECT
... INTO`](select-into.html "13.2.9.1 SELECT ... INTO Statement"), and then store the variable in the table,
like this:
...
[`LAST_INSERT_ID()`](information-functions.html#function_last-insert-id) was not
replicated correctly if any filtering options such as
[`--replicate-ignore-db`](replication-options-replica.html#option_mysqld_replicate-ignore-db) and
[`--replicate-do-table`](replication-options-replica.html#option_mysqld_replicate-do-table) were enabled
on the replica. (Bug #17234370, BUG# 69861)
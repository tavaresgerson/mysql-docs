...
* Some expression results differ on source and replica.
  ...
  [`SYSDATE()`](date-and-time-functions.html#function_sysdate), or
  [`UTC_TIMESTAMP()`](date-and-time-functions.html#function_utc-timestamp)) interpret an

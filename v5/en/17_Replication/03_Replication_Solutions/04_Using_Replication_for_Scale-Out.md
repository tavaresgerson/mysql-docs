...
[Figure 16.1, “Using Replication to Improve Performance During Scale-Out”](replication-solutions-scaleout.html#figure_replication-scaleout "Figure 16.1 Using Replication to Improve Performance During Scale-Out").
...
conversion task by using the [**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") utility

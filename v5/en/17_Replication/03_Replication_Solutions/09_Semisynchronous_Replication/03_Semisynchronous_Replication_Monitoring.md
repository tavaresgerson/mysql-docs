...
VARIABLES`](show-variables.html "13.7.5.39 SHOW VARIABLES Statement"):
...
and [`Rpl_semi_sync_master_no_tx`](server-status-variables.html#statvar_Rpl_semi_sync_master_no_tx)
variables.

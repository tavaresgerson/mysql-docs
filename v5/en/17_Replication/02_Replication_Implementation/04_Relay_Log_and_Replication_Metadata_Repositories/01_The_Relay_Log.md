...
be read using [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") (see
...
However, [`FLUSH LOGS`](flush.html#flush-logs) rotates relay

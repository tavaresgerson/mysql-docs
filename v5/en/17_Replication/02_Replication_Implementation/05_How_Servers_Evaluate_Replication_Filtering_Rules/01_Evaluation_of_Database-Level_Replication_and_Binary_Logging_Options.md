...
[`USE`](use.html "13.8.4 USE Statement") statement) is the database
that is checked.
...
[`USE`](use.html "13.8.4 USE Statement") statement in order for a
...
2. Is there a default database (has any database been selected
   by [`USE`](use.html "13.8.4 USE Statement"))?
...
DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") statements. In those cases, the database

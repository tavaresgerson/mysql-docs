...
[Section 16.4.1.12, “Replication and Floating-Point Values”](replication-features-floatvalues.html "16.4.1.12 Replication and Floating-Point Values")).
...
source, this could lead to excessively large error log files. To
prevent this, MySQL 5.7 provides a warning suppression
mechanism, which behaves as follows: Whenever the 50 most recent
[`ER_BINLOG_UNSAFE_STATEMENT`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_binlog_unsafe_statement)
...
* **References to system variables.**
  ...
  [Section 16.4.1.37, “Replication and Variables”](replication-features-variables.html "16.4.1.37 Replication and Variables"). For
  exceptions, see [Section 5.4.4.3, “Mixed Binary Logging Format”](binary-log-mixed.html "5.4.4.3 Mixed Binary Logging Format").
...
* **Trigger or stored program updates a table having an AUTO\_INCREMENT
  ...
  In addition, an [`INSERT`](insert.html "13.2.5 INSERT Statement") into a
...
* **INSERT ... ON DUPLICATE KEY UPDATE statements on tables with multiple
  ...
  An
  [`INSERT
  ... ON DUPLICATE KEY UPDATE`](insert-on-duplicate.html "13.2.5.2 INSERT ... ON DUPLICATE KEY UPDATE Statement") statement against a
...
* **LOAD DATA statements.**
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement") is treated as
  unsafe and when
  ...
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement") does not generate

...
The [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") client utility performs
...
transfer to another SQL server. The [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") requires at least the
...
[`PROCESS`](privileges-provided.html#priv_process) if the
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") output can include
[`ALTER DATABASE`](alter-database.html "13.1.1 ALTER DATABASE Statement") statements that
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") issues DML instructions for the
...
* If your tables are primarily `InnoDB`
  ...
  **mysqlbackup** command of the MySQL Enterprise Backup product.
  ...
  from `MyISAM` and other storage engines;
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") can retrieve and dump table
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to generate a dump to be reloaded
...
For additional information about [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"),
see [Section 7.4, “Using mysqldump for Backups”](using-mysqldump.html "7.4 Using mysqldump for Backups").

#### Invocation Syntax

There are in general three ways to use
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")—in order to dump a set of one
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") supports, issue the command
[**mysqldump --help**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program").

#### Option Syntax - Alphabetical Summary

[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") supports the following options,
...
<table frame="box" rules="all" summary="Command-line options available for mysqldump."><col style="width: 27%"/><col style="width: 50%"/><col style="width: 11%"/><col style="width: 11%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
<th>Deprecated</th>
...
<td></td>
<td></td>
</tr><tr><th>--allow-keywords</th>
<td>Allow creation of column names that are keywords</td>
<td></td>
<td></td>
</tr><tr><th>--apply-slave-statements</th>
...
<td></td>
<td></td>
</tr><tr><th>--ignore-error</th>
<td>Ignore specified errors</td>
<td></td>
<td></td>
</tr><tr><th>--ignore-table</th>
<td>Do not dump given table</td>
<td></td>
<td></td>
</tr><tr><th>--include-master-host-port</th>
...
<td></td>
<td></td>
</tr><tr><th>--no-set-names</th>
<td>Same as --skip-set-charset</td>
<td></td>
<td></td>
</tr><tr><th>--no-tablespaces</th>
...
The [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command logs into a MySQL
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") prompts for one. If given,
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") should not prompt for one, use
  the
...
* `--pipe`, `-W`
  ...
  <table frame="box" rules="all" summary="Properties for pipe"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code>--bind-address=ip_address</code></td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") does not find it. See
...
* [`--secure-auth`](mysqldump.html#option_mysqldump_secure-auth)
...
<td><code>--bind-address=ip_address</code></td>
  ...
  ([`--skip-secure-auth`](mysqldump.html#option_mysqldump_secure-auth),
  [`--secure-auth=0`](mysqldump.html#option_mysqldump_secure-auth)) produces
...
<td><code>--bind-address=ip_address</code></td>
  ...
  The
  [`--server-public-key-path`](mysqldump.html#option_mysqldump_server-public-key-path)
  option was added in MySQL 5.7.23.

* [`--skip-mysql-schema`](mysqldump.html#option_mysqldump_skip-mysql-schema)

  <table frame="box" rules="all" summary="Properties for bind-address"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code>--bind-address=ip_address</code></td>
</tr></tbody></table>5

  Do not drop the `mysql` schema when the
...
<td><code>OFF</code></td>
  ...
  *`str`*. For example,
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") normally reads the
  `[client]` and
  `[mysqldump]` groups. If this option is
  given as
  [`--defaults-group-suffix=_other`](mysqldump.html#option_mysqldump_defaults-group-suffix),
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") also reads the
  `[client_other]` and
...
Usage scenarios for [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") include setting
...
<td><code>OFF</code></td>
  ...
  DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") statement. This option is typically used
  ...
  no [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") statements
...
<td><code>OFF</code></td>
  ...
  Write a [`DROP TRIGGER`](drop-trigger.html "13.1.31 DROP TRIGGER Statement")
  statement before each [`CREATE
  TRIGGER`](create-trigger.html "13.1.20 CREATE TRIGGER Statement") statement.
...
<td><code>OFF</code></td>
  ...
  tablespaces used by an [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
  table. This information is not otherwise included in the
  output from [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"). This option is
...
<td><code>OFF</code></td>
  ...
  Suppress the [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement")
...
<td><code>OFF</code></td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") output; however, you can use
...
<td>String</td>
  ...
  LOGFILE GROUP`](create-logfile-group.html "13.1.15 CREATE LOGFILE GROUP Statement") and [`CREATE
  TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") statements in the output of
...
<td>String</td>
  ...
  is given, [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") produces a comment at
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to continue executing even when
  it encounters a view that has become invalid because the
  definition refers to a table that has been dropped. Without
  `--force`, [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") exits
  with an error message. With `--force`,
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") prints the error message, but
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command itself.
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command represents character data
...
<td><code>FALSE</code></td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") uses `utf8`.
...
The [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command is frequently used to
...
<td><code>FALSE</code></td>
  ...
  [`--dump-slave`](mysqldump.html#option_mysqldump_dump-slave) option, add a
  [`STOP SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") statement before
  the [`CHANGE MASTER TO`](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement")
  statement and a [`START SLAVE`](start-slave.html "13.4.2.5 START SLAVE Statement")
...
<td><code>FALSE</code></td>
  ...
  sending a [`PURGE BINARY LOGS`](purge-binary-logs.html "13.4.1.1 PURGE BINARY LOGS Statement")
...
<td>Boolean</td>
  ...
  [`--master-data`](mysqldump.html#option_mysqldump_master-data) except that
  ...
  [`SHOW SLAVE STATUS`](show-slave-status.html "13.7.5.34 SHOW SLAVE STATUS Statement") output and
  ...
  [`--master-data`](mysqldump.html#option_mysqldump_master-data) (setting no
  ...
  This option causes [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to stop the
  replica SQL thread before the dump and restart it again
  after.

  `--dump-slave` sends a
  [`SHOW SLAVE STATUS`](show-slave-status.html "13.7.5.34 SHOW SLAVE STATUS Statement") statement
...
<td>Boolean</td>
  ...
  For the [`CHANGE MASTER TO`](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement")
  statement in a replica dump produced with the
  [`--dump-slave`](mysqldump.html#option_mysqldump_dump-slave) option, add
  `MASTER_HOST` and
...
<td>Boolean</td>
  ...
  to include a [`CHANGE MASTER TO`](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement")
  ...
  MASTER TO`](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement") statement is written as an SQL comment,
  ...
  `--master-data` sends a
  [`SHOW MASTER STATUS`](show-master-status.html "13.7.5.23 SHOW MASTER STATUS Statement") statement
  to the server to obtain information, so it requires
  privileges sufficient to execute that statement. This option
  ...
  turns off [`--lock-tables`](mysqldump.html#option_mysqldump_lock-tables).
  It also turns on
  [`--lock-all-tables`](mysqldump.html#option_mysqldump_lock-all-tables), unless
...
<td>Boolean</td>
  ...
  [`--set-gtid-purged={ON|OFF}`](mysqlpump.html#option_mysqlpump_set-gtid-purged)
  option to be specified. Use `ON` if the
  intention is to deploy a new replication replica using only
  some of the data from the dumped server. Use
  `OFF` if the intention is to repair a table
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") is being run.

  It is not recommended to load a dump file when GTIDs are
  enabled on the server
  ([`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode)), if your
...
<td>Boolean</td>
  ...
  *`name`* can be
  ...
  mode. See [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").
...
<td>Boolean</td>
  ...
  Use complete [`INSERT`](insert.html "13.2.5 INSERT Statement")
...
<td><code>--host</code></td>
  ...
  clause for [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement"). See
  [Section 13.2.6, “LOAD DATA Statement”](load-data.html "13.2.6 LOAD DATA Statement").
...
<td><code>--host</code></td>
  ...
  dumped table, [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") creates a
  `tbl_name.sql`
  file that contains the [`CREATE
  TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement that creates the table, and the
  server writes a
  `tbl_name.txt`
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") is run on the same machine as
  the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server. Because the server
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") creates
...
<td><code>--host</code></td>
  ...
  different time zones. [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") sets its
...
<td>String</td>
  ...
  The output from the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client when run
  ...
  XML output from [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") includes the
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") treats the first name argument
  ...
  DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") and [`USE`](use.html "13.8.4 USE Statement")
...
<td>String</td>
  ...
  contains [`CREATE EVENT`](create-event.html "13.1.12 CREATE EVENT Statement")
...
<td>String</td>
  ...
  ignore during [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") execution. If the
...
<td>String</td>
  ...
  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement for
...
<td>String</td>
  ...
  contains [`CREATE PROCEDURE`](create-procedure.html "13.1.16 CREATE PROCEDURE and CREATE FUNCTION Statements") and
...
<td>String</td>
  ...
  or `-B` option. [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") dumps triggers in activation
  order so that when the dump file is reloaded, triggers are
  created in the same activation order. However, if a
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") dump file contains multiple
  ...
  [Section 2.11.3, “Downgrade Notes”](downgrading-to-previous-series.html "2.11.3 Downgrade Notes"); you can
...
solution, such as
[MySQL Enterprise Backup](mysql-enterprise-backup.html "28.1 MySQL Enterprise Backup Overview") for
...
<td>String</td>
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements with
  `/*!40000 ALTER TABLE
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") and should not be confused
  ...
  packet from [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"), regardless of
  any setting for the [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") option,
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") creates rows up to
...
<td>String</td>
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to retrieve rows for a table
...
<td>String</td>
  ...
  Enclose the [`INSERT`](insert.html "13.2.5 INSERT Statement") statements
  for each dumped table within `SET autocommit =
  0` and [`COMMIT`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
  statements.
...
<td>String</td>
  ...
  The RELOAD or FLUSH\_TABLES privilege is required with
  [`--single-transaction`](mysqldump.html#option_mysqldump_single-transaction) if
  both gtid\_mode=ON and --set-gtid=purged=ON|AUTO. This
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to retrieve the table contents
  ...
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") causes any pending transactions to be
  committed implicitly.

  Using `--single-transaction` together with
  the [`--set-gtid-purged`](mysqldump.html#option_mysqldump_set-gtid-purged)
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") is also very useful for populating
...
For `InnoDB` tables,
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") provides a way of making an online
backup:
...
[`FLUSH`](flush.html "13.7.6.3 FLUSH Statement") statement is issued, the
...
[Section 5.4.4, “The Binary Log”](binary-log.html "5.4.4 The Binary Log")) or at least know the binary log
...
The [`--master-data`](mysqldump.html#option_mysqldump_master-data) and
[`--single-transaction`](mysqldump.html#option_mysqldump_single-transaction) options
...
[Section 7.2, “Database Backup Methods”](backup-methods.html "7.2 Database Backup Methods"), and
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") does not dump the
`INFORMATION_SCHEMA`,
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") does not dump the NDB Cluster
[`ndbinfo`](mysql-cluster-ndbinfo.html "21.6.15 ndbinfo: The NDB Cluster Information Database") information database.

[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") does not dump
`InnoDB` [`CREATE
TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") statements.

[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") always strips the
`NO_AUTO_CREATE_USER` SQL mode as
`NO_AUTO_CREATE_USER` is not compatible with
...
particular sql\_mode. It is stripped as of
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") 5.7.24.

It is not recommended to restore from a dump made using
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to a MySQL 5.6.9 or earlier server
that has GTIDs enabled. See
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") includes statements to recreate the
`general_log` and
...
privileges, see [Section 23.9, “Restrictions on Views”](view-restrictions.html "23.9 Restrictions on Views") for a
workaround.
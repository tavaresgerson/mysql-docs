...
[**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") is a diagnostic program designed to
...
Invoke [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") like this:
...
[**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") does not understand them.

[**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") runs in three stages:
...
Let [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") build the query SQL statement
with a table of two [`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") columns
and three [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") columns. Use
...
`--query` file has multiple queries delimited by
...
[**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") supports the following options,
...
<table frame="box" rules="all" summary="Command-line options available for mysqlslap."><col style="width: 27%"/><col style="width: 50%"/><col style="width: 11%"/><col style="width: 11%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
<th>Deprecated</th>
</tr></thead><tbody><tr><th>--auto-generate-sql</th>
<td>Generate SQL statements automatically when they are not supplied in files or using command options</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-add-autoincrement</th>
<td>Add AUTO_INCREMENT column to automatically generated tables</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-execute-number</th>
<td>Specify how many queries to generate automatically</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-guid-primary</th>
<td>Add a GUID-based primary key to automatically generated tables</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-load-type</th>
<td>Specify the test load type</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-secondary-indexes</th>
<td>Specify how many secondary indexes to add to automatically generated tables</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-unique-query-number</th>
<td>How many different queries to generate for automatic tests</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-unique-write-number</th>
<td>How many different queries to generate for --auto-generate-sql-write-number</td>
<td></td>
<td></td>
</tr><tr><th>--auto-generate-sql-write-number</th>
...
<td><code>--help</code></td>
  ...
  If the
  [`--auto-generate-sql`](mysqlslap.html#option_mysqlslap_auto-generate-sql)
  option is also given, [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") drops
...
<td><code>FALSE</code></td>
  ...
  *`str`*. For example,
  [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") normally reads the
  `[client]` and
  `[mysqlslap]` groups. If this option is
  given as
  [`--defaults-group-suffix=_other`](mysqlslap.html#option_mysqlslap_defaults-group-suffix),
  [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") also reads the
  `[client_other]` and
...
<td><code>FALSE</code></td>
  ...
  Prevent [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") from dropping any
...
<td><code>FALSE</code></td>
  ...
  The number of [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") columns
  to use if
...
<td><code>FALSE</code></td>
  ...
  The number of [`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") columns to
...
<td><code>FALSE</code></td>
  ...
  example, if you invoke [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") as
...
<td><code>FALSE</code></td>
  ...
  Do not connect to databases. [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client")
...
<td><code>FALSE</code></td>
  ...
  [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") prompts for one. If given,
  ...
  [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") should not prompt for one, use
  the
...
<td>Numeric</td>
  ...
  [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") does not find it. See
...
<td>Numeric</td>
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement to use for
  retrieving data.

* [`--secure-auth`](mysqlslap.html#option_mysqlslap_secure-auth)
...
<td>Numeric</td>
  ...
  ([`--skip-secure-auth`](mysqlslap.html#option_mysqlslap_secure-auth),
  [`--secure-auth=0`](mysqlslap.html#option_mysqlslap_secure-auth)) produces
...
<td><code>FALSE</code></td>
  ...
  The
  [`--server-public-key-path`](mysqlslap.html#option_mysqlslap_server-public-key-path)
  option was added in MySQL 5.7.23.

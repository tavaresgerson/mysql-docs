...
The [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") client utility performs
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") features include:
...
* Dumping of user accounts as account-management statements
  ...
  [`GRANT`](grant.html "13.7.1.4 GRANT Statement")) rather than as inserts
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") requires at least the
...
(see [Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations")), so the dump file
does not load correctly. To work around this issue, use the
...
By default, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") dumps all databases
...
By default, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not dump user
...
the form of [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") and
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements, use the
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") supports several options for
...
For example, use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client:
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") usage examples.

To see a list of the options [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program")
supports, issue the command [**mysqlpump --help**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program").

#### mysqlpump Option Summary

[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") supports the following options,
which can be specified on the command line or in the
`[mysqlpump]` and `[client]`
groups of an option file. (Prior to MySQL 5.7.30,
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") read the
`[mysql_dump]` group rather than
`[mysqlpump]`. As of 5.7.30,
...
<table frame="box" rules="all" summary="Command-line options available for mysqlpump."><col style="width: 31%"/><col style="width: 56%"/><col style="width: 12%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
</tr></thead><tbody><tr><th>--add-drop-database</th>
<td>Add DROP DATABASE statement before each CREATE DATABASE statement</td>
<td></td>
</tr><tr><th>--add-drop-table</th>
<td>Add DROP TABLE statement before each CREATE TABLE statement</td>
<td></td>
</tr><tr><th>--add-drop-user</th>
<td>Add DROP USER statement before each CREATE USER statement</td>
<td></td>
</tr><tr><th>--add-locks</th>
<td>Surround each table dump with LOCK TABLES and UNLOCK TABLES statements</td>
<td></td>
</tr><tr><th>--all-databases</th>
...
<td></td>
</tr><tr><th>--default-parallelism</th>
...
<td><code>--add-drop-database</code></td>
  ...
  Write a [`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement")
  statement before each [`CREATE
  DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") statement.
...
<td><code>--add-drop-table</code></td>
  ...
  Write a [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") statement
  before each [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
  statement.
...
<td><code>--add-drop-user</code></td>
</tr></tbody></table>

  Write a [`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") statement
  before each [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement")
  statement.
...
<td><code>--add-locks</code></td>
  ...
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") and
  [`UNLOCK
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") statements. This results in faster inserts
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements from
  different tables can be interleaved and
  [`UNLOCK
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") following the end of the inserts for one
...
* [`--complete-insert`](mysqlpump.html#option_mysqlpump_complete-insert)
  ...
  <table frame="box" rules="all" summary="Properties for complete-insert"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code>--complete-insert</code></td>
</tr></tbody></table>

  Write complete [`INSERT`](insert.html "13.2.5 INSERT Statement")
...
<td><code>--help</code></td>
  ...
  By default, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not compress
  ...
  **lz4** and **openssl zlib**
  ...
  include [**lz4\_decompress**](lz4-decompress.html "4.8.1 lz4_decompress — Decompress mysqlpump LZ4-Compressed Output") and
  [**zlib\_decompress**](zlib-decompress.html "4.8.5 zlib_decompress — Decompress mysqlpump ZLIB-Compressed Output") utilities that can be
  used to decompress [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") output that
  ...
  [Section 4.8.1, “lz4\_decompress — Decompress mysqlpump LZ4-Compressed Output”](lz4-decompress.html "4.8.1 lz4_decompress — Decompress mysqlpump LZ4-Compressed Output"), and
  ...
  `openssl` commands, if they are installed on
  your system. For example, **lz4** can
  uncompress `LZ4` output:
...
<td><code>--help</code></td>
  ...
  Normally, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") treats the first name
  ...
  [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") statements
...
<td><code>--help</code></td>
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") uses `utf8`.
...
<td><code>--help</code></td>
  ...
  options, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") runs as a
  ...
  [`--default-parallelism`](mysqlpump.html#option_mysqlpump_default-parallelism) to
  0 and not using any instances of
  [`--parallel-schemas`](mysqlpump.html#option_mysqlpump_parallel-schemas):
...
<td><code>--add-drop-database</code></td>
  ...
  *`str`*. For example,
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") normally reads the
  `[client]` and
  `[mysqlpump]` groups. If this option is
  given as
  [`--defaults-group-suffix=_other`](mysqlpump.html#option_mysqlpump_defaults-group-suffix),
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") also reads the
  `[client_other]` and
...
<td><code>--add-drop-database</code></td>
  ...
  [`CREATE EVENT`](create-event.html "13.1.12 CREATE EVENT Statement") statements to
  ...
  [`--events`](mysqlpump.html#option_mysqlpump_events). Instead, dump
...
<td><code>--add-drop-table</code></td>
  ...
  Write [`INSERT`](insert.html "13.2.5 INSERT Statement") statements using
  ...
  each [`INSERT`](insert.html "13.2.5 INSERT Statement") statement. The
  default is 250. A value of 1 produces one
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement per table
  row.
...
<td><code>--add-drop-table</code></td>
  ...
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") types,
  [`BIT`](bit-type.html "11.1.5 Bit-Value Type - BIT"), all spatial data types,
  and other non-binary data types when used with the
  [`binary`
  character set](charset-binary-set.html "10.10.8 The Binary Character Set").
...
<td><code>--add-drop-user</code></td>
  ...
  Write [`INSERT
  IGNORE`](insert.html "13.2.5 INSERT Statement") statements rather than
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements.
...
<td><code>--add-drop-user</code></td>
  ...
  If this option is not given, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program")
...
<td><code>--add-drop-user</code></td>
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements (as with
  the [`--extended-insert`](mysqlpump.html#option_mysqlpump_extended-insert)
  option), [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") creates rows up to
...
<td><code>--add-drop-user</code></td>
  ...
  Suppress any [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement")
...
<td><code>--add-drop-user</code></td>
  ...
  Do not write [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
...
<td><code>--add-drop-user</code></td>
  ...
  *`N`* is not given, the
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") also creates a default queue to
...
<td><code>--add-drop-user</code></td>
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") prompts for one. If given,
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") should not prompt for one, use
  the
...
<td><code>--add-locks</code></td>
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not find it. See
...
<td><code>--add-locks</code></td>
  ...
  Write [`REPLACE`](replace.html "13.2.8 REPLACE Statement") statements
  rather than [`INSERT`](insert.html "13.2.5 INSERT Statement")
  statements.
...
<td><code>--add-locks</code></td>
  ...
  [`CREATE PROCEDURE`](create-procedure.html "13.1.16 CREATE PROCEDURE and CREATE FUNCTION Statements") and
  [`CREATE FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement") statements to
  ...
  timestamp attributes, do not use
  [`--routines`](mysqlpump.html#option_mysqlpump_routines). Instead, dump
...
* [`--secure-auth`](mysqlpump.html#option_mysqlpump_secure-auth)
...
<td><code>--add-locks</code></td>
  ...
  future MySQL release. It is always enabled and attempting to
  disable it
  ([`--skip-secure-auth`](mysqlpump.html#option_mysqlpump_secure-auth),
  [`--secure-auth=0`](mysqlpump.html#option_mysqlpump_secure-auth)) produces
  an error.
...
<td><code>--add-locks</code></td>
  ...
  The
  [`--server-public-key-path`](mysqlpump.html#option_mysqlpump_server-public-key-path)
  option was added in MySQL 5.7.23.
...
<td><code>--add-locks</code></td>
  ...
  Write [`SET NAMES
  default_character_set`](set-names.html "13.7.4.3 SET NAMES Statement")
  to the output.

  This option is enabled by default. To disable it and
  suppress the [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement")
  statement, use
...
<td><code>--all-databases</code></td>
  ...
  whether to add a
  [`SET
  @@GLOBAL.gtid_purged`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") statement to the output. This
...
<td><code>--all-databases</code></td>
  ...
  a [`START
  TRANSACTION`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") SQL statement to the server before
  ...
  [`START
  TRANSACTION`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") was issued without blocking any
  applications.
  ...
  [`RENAME TABLE`](rename-table.html "13.1.33 RENAME TABLE Statement"),
  [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement"). A consistent
  read is not isolated from those statements, so use of them
  on a table to be dumped can cause the
  [`SELECT`](select.html "13.2.9 SELECT Statement") that is performed by
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") to retrieve the table contents
...
<td><code>--all-databases</code></td>
  ...
  This option enables [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types")
  columns to be dumped and reloaded between servers in
  different time zones. [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") sets its
  connection time zone to UTC and adds `SET
  TIME_ZONE='+00:00'` to the dump file. Without this
  option, [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns are
...
<td><code>--bind-address=ip_address</code></td>
  ...
  [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements.

  User definitions are stored in the grant tables in the
  `mysql` system database. By default,
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not include the grant
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") has a set of inclusion and
...
generally (see [Section 6.2.4, “Specifying Account Names”](account-names.html "6.2.4 Specifying Account Names")).

Inclusion and exclusion options interact as follows:

* By default, with no inclusion or exclusion options,
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") dumps all databases (with
...
* The [`--all-databases`](mysqlpump.html#option_mysqlpump_all-databases) option
  ...
  [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") action is to dump everything).
...
* The [`--databases`](mysqlpump.html#option_mysqlpump_databases) option
  causes [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") to treat all name
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") can use parallelism to achieve
...
By default, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") sets up one queue with
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") uses the default queue for
...
In general, with multiple queues, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program")
...
that uses multiple threads, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") uses
parallelism within databases, to dump multiple objects from a
given database simultaneously. Exceptions can occur; for
example, [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") may block queues while it
obtains from the server lists of objects in databases.

With parallelism enabled, it is possible for output from
different databases to be interleaved. For example,
[`INSERT`](insert.html "13.2.5 INSERT Statement") statements from multiple
...
[`USE`](use.html "13.8.4 USE Statement") statements as required.
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") sets up a queue to process
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") runs as a single-threaded process
and creates no queues.

Note

Before MySQL 5.7.11, use of the
[`--single-transaction`](mysqlpump.html#option_mysqlpump_single-transaction) option
is mutually exclusive with parallelism. To use
[`--single-transaction`](mysqlpump.html#option_mysqlpump_single-transaction),
disable parallelism by setting
[`--default-parallelism`](mysqlpump.html#option_mysqlpump_default-parallelism) to 0
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not dump the
`INFORMATION_SCHEMA`,
`performance_schema`,
...
[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") does not dump
`InnoDB` [`CREATE
TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") statements.

[**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program") dumps user accounts in logical form
using [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") and
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements (for example,
when you use the

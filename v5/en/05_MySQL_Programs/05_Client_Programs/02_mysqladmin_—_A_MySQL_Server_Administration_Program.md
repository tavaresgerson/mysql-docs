...
[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") is a client for performing
...
Invoke [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") like this:

```sql
mysqladmin [options] command [command-arg] [command [command-arg]] ...
```

[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") supports the following commands.
...
* `flush-logs [log_type
  ...
  The [**mysqladmin flush-logs**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command permits
...
* `kill
  ...
  must have the [`SUPER`](privileges-provided.html#priv_super)
  privilege.
...
* `old-password
  ...
  format. (See [Section 6.1.2.4, “Password Hashing in MySQL”](password-hashing.html "6.1.2.4 Password Hashing in MySQL").)
...
* `password
  ...
  *`new_password`* for the account that
  you use with [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") for connecting to
  the server. Thus, the next time you invoke
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") (or any other client program)
  using the same account, you must specify the new password.

  Warning

  Setting a password using [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program")
  ...
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") prompts for the password
  ...
  the [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command line. Otherwise,
  ...
  [**mysqladmin flush-privileges**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") to
  re-enable the grant table and then use a separate
  [**mysqladmin password**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command to change
  the password.

* `ping`

  Check whether the server is available. The return status
  from [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") is 0 if the server is
...
* `processlist`
  ...
  output of the [`SHOW
  PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement") statement. If the
  [`--verbose`](mysqladmin.html#option_mysqladmin_verbose) option is
  given, the output is like that of
  [`SHOW FULL
  PROCESSLIST`](show-processlist.html "13.7.5.29 SHOW PROCESSLIST Statement"). (See
...
The [**mysqladmin status**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command result displays
...
* `Slow queries`
  ...
  See [Section 5.4.5, “The Slow Query Log”](slow-query-log.html "5.4.5 The Slow Query Log").
...
If you execute [**mysqladmin shutdown**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") when
connecting to a local server using a Unix socket file,
[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") waits until the server's process
ID file has been removed, to ensure that the server has stopped
properly.

[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") supports the following options,
...
<table frame="box" rules="all" summary="Command-line options available for mysqladmin."><col style="width: 27%"/><col style="width: 50%"/><col style="width: 11%"/><col style="width: 11%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
<th>Deprecated</th>
...
<td><code>--connect-timeout=value</code></td>
</tr><tr><th>Type</th>
<td>Numeric</td>
</tr><tr><th>Default Value</th>
...
<td><code>--help</code></td>
  ...
  *`str`*. For example,
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") normally reads the
  `[client]` and
  `[mysqladmin]` groups. If this option is
  given as
  [`--defaults-group-suffix=_other`](mysqladmin.html#option_mysqladmin_defaults-group-suffix),
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") also reads the
  `[client_other]` and
...
<td><code>--bind-address=ip_address</code></td>
  ...
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") prompts for one. If given,
  ...
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") should not prompt for one, use
  the
...
<td><code>--bind-address=ip_address</code></td>
  ...
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") does not find it. See
...
* [`--secure-auth`](mysqladmin.html#option_mysqladmin_secure-auth)
...
<td><code>[none]</code></td>
  ...
  ([`--skip-secure-auth`](mysqladmin.html#option_mysqladmin_secure-auth),
  [`--secure-auth=0`](mysqladmin.html#option_mysqladmin_secure-auth)) produces
...
<td><code>[none]</code></td>
  ...
  The
  [`--server-public-key-path`](mysqladmin.html#option_mysqladmin_server-public-key-path)
  option was added in MySQL 5.7.23.
...
<td><code>[none]</code></td>
  ...
  *`delay`* seconds in between. The
  ...
  [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") executes commands indefinitely
  until interrupted.

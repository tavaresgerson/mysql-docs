...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") supports the following options, which
...
<table frame="box" rules="all" summary="Command-line options available for the mysql client."><col style="width: 27%"/><col style="width: 50%"/><col style="width: 11%"/><col style="width: 11%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
<th>Deprecated</th>
</tr></thead><tbody><tr><th>--auto-rehash</th>
<td>Enable automatic rehashing</td>
<td></td>
<td></td>
</tr><tr><th>--auto-vertical-output</th>
...
<td></td>
<td></td>
</tr><tr><th>--column-names</th>
<td>Write column names in results</td>
<td></td>
<td></td>
</tr><tr><th>--column-type-info</th>
<td>Display result set metadata</td>
<td></td>
<td></td>
</tr><tr><th>--commands</th>
...
<td></td>
<td></td>
</tr><tr><th>--skip-auto-rehash</th>
<td>Disable automatic rehashing</td>
<td></td>
<td></td>
</tr><tr><th>--skip-column-names</th>
<td>Do not write column names in results</td>
<td></td>
<td></td>
</tr><tr><th>--skip-line-numbers</th>
<td>Skip line numbers for errors</td>
<td></td>
<td></td>
</tr><tr><th>--skip-named-commands</th>
<td>Disable named mysql commands</td>
<td></td>
<td></td>
</tr><tr><th>--skip-pager</th>
<td>Disable paging</td>
<td></td>
<td></td>
</tr><tr><th>--skip-reconnect</th>
...
<td><code>skip-auto-rehash</code></td>
  ...
  to disable rehashing. That causes [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
  ...
  the name is unambiguous, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") completes
...
<td><code>--batch</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") does not use the history file.
...
<td><code>FALSE</code></td>
  ...
  When this option is given, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") displays
...
<td><code>--binary-mode</code></td>
  ...
  [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") output that may contain
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") values. By default,
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") translates `\r\n`
  in statement strings to `\n` and interprets
  `\0` as the statement terminator.
  [`--binary-mode`](mysql-command-options.html#option_mysql_binary-mode) disables both
  features. It also disables all [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
  commands except `charset` and
  `delimiter` in noninteractive mode (for
  input piped to [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") or loaded using the
  `source` command).

  (*NDB Cluster 7.6.35 and later:*)
...
* [`--column-names`](mysql-command-options.html#option_mysql_column-names)
  ...
  <table frame="box" rules="all" summary="Properties for column-names"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
...
<td><code>--help</code></td>
  ...
  structures. See [C API Basic Data Structures](/doc/c-api/5.7/en/c-api-data-structures.html).
...
<td><code>--help</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client commands. Setting this
  option to `FALSE` disables such processing,
  and has the effects listed here:

  + The following [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client commands
    are disabled:
  ...
  + The [`--system-command`](/doc/refman/8.0/en/mysql-command-options.html#option_mysql_system-command)
  ...
  [`--system-command`](/doc/refman/8.0/en/mysql-command-options.html#option_mysql_system-command) option.
...
<td><code>--help</code></td>
  ...
  In MySQL 5.7, the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
  ...
  version of the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client with a
  version of the server that understands optimizer hints,
  invoke [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") with the
  [`--comments`](mysql-command-options.html#option_mysql_comments) option.

  Comment stripping is deprecated as of MySQL 5.7.20. You
  should expect this feature and the options to control it
...
<td><code>--help</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") because normally the server
...
<td><code>skip-auto-rehash</code></td>
  ...
  character set and the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client by
  ...
  [Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations"), and
  [Section 10.15, “Character Set Configuration”](charset-configuration.html "10.15 Character Set Configuration").
...
<td><code>skip-auto-rehash</code></td>
  ...
  *`str`*. For example,
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") normally reads the
  `[client]` and `[mysql]`
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") also reads the
  `[client_other]` and
  `[mysql_other]` groups.
...
* [`--disable-named-commands`](mysql-command-options.html#option_mysql_disable-named-commands)
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") starts with this option
  *enabled* by default. However, even with
  this option, long-format commands still work from the first
  line. See [Section 4.5.1.2, “mysql Client Commands”](mysql-commands.html "4.5.1.2 mysql Client Commands").
...
<td><code>skip-auto-rehash</code></td>
  ...
  [Section 4.2.2.1, “Using Options on the Command Line”](command-line-options.html "4.2.2.1 Using Options on the Command Line"), for some examples.
  With this option, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") does not use the
  history file.
...
<td><code>skip-auto-rehash</code></td>
  ...
  The [`--get-server-public-key`](mysql-command-options.html#option_mysql_get-server-public-key)
...
<td><code>--auto-vertical-output</code></td>
  ...
  more information, see [Section 4.5.1.3, “mysql Client Logging”](mysql-logging.html "4.5.1.3 mysql Client Logging").
...
<td><code>--auto-vertical-output</code></td>
  ...
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement") is determined by
  ...
  within [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") also requires that the
...
<td><code>--batch</code></td>
  ...
  Enable named [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") commands. Long-format
...
<td><code>--batch</code></td>
  ...
  the [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") utility. See
  [Section 4.6.6, “mysql\_config\_editor — MySQL Configuration Utility”](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility").
...
<td><code>--batch</code></td>
  ...
  [`USE`](use.html "13.8.4 USE Statement") statements.

  Initially, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") executes statements in
  the input because specifying a database
  *`db_name`* on the command line is
  equivalent to inserting
  [`USE
  db_name`](use.html "13.8.4 USE Statement") at the
  beginning of the input. Then, for each
  [`USE`](use.html "13.8.4 USE Statement") statement encountered,
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") accepts or rejects following
  statements depending on whether the database named is the
  one on the command line. The content of the statements is
  immaterial.

  Suppose that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is invoked to process
  ...
  db1**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") handles the input as
  follows:

  + The [`DELETE`](delete.html "13.2.2 DELETE Statement") statement is
    executed because the default database is
    `db1`, even though the statement names
    a table in a different database.

  + The [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") and
  ...
  + The [`INSERT`](insert.html "13.2.5 INSERT Statement") and
    [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements
...
<td><code>--batch</code></td>
  ...
  **cat [> filename]**, and so forth. This
  ...
  [Section 4.5.1.2, “mysql Client Commands”](mysql-commands.html "4.5.1.2 mysql Client Commands"), discusses output paging
  further.
...
<td><code>--batch</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") prompts for one. If given, there
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") should not prompt for one, use the
...
<td><code>--batch</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") does not find it. See
...
<td><code>FALSE</code></td>
  ...
  suspended. With this option, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") does
  not use the history file.

  By default, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") fetches all result rows
  ...
  `--quick` is specified,
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") does not have the rows for which to
  ...
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") and containing 4 rows.
...
<td><code>FALSE</code></td>
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statements that
...
* [`--secure-auth`](mysql-command-options.html#option_mysql_secure-auth)
...
<td><code>FALSE</code></td>
  ...
  ([`--skip-secure-auth`](mysql-command-options.html#option_mysql_secure-auth),
  [`--secure-auth=0`](mysql-command-options.html#option_mysql_secure-auth)) produces an
...
<td><code>FALSE</code></td>
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statements when using
  [`--safe-updates`](mysql-command-options.html#option_mysql_safe-updates). (Default value
  is 1,000.)
...
<td><code>--binary-mode</code></td>
  ...
  This option causes [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") to send
  ...
  For more information, see [Section 4.5.1.3, “mysql Client Logging”](mysql-logging.html "4.5.1.3 mysql Client Logging").
...
<td><code>--bind-address=ip_address</code></td>
  ...
  only in interactive mode. [Section 4.5.1.2, “mysql Client Commands”](mysql-commands.html "4.5.1.2 mysql Client Commands"),
...
<td><code>--bind-address=ip_address</code></td>
  ...
  with [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") matches that of
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")
  [`--xml`](mysqldump.html#option_mysqldump_xml). See
  [Section 4.5.4, “mysqldump — A Database Backup Program”](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"), for details.

...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") sends each SQL statement that you issue
to the server to be executed. There is also a set of commands
that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") itself interprets. For a list of
...
If [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is invoked with the
[`--binary-mode`](mysql-command-options.html#option_mysql_binary-mode) option, all
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") commands are disabled except
`charset` and `delimiter` in
noninteractive mode (for input piped to [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
commands, either invoke [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") with the
[`--binary-mode`](mysql-command-options.html#option_mysql_binary-mode) option or use a
reload client other than [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client").
...
* `help [arg]`,
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") commands.

  If you provide an argument to the `help`
  command, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") uses it as a search string
...
* `charset
  ...
  [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") statement. This
  enables the character set to remain synchronized on the
  client and server if [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is run with
...
* `delimiter str`,
  ...
  Change the string that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") interprets
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") interprets instances of the
  ...
  `INDEX` in statements.
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") interprets this as
  `INDE` followed by the delimiter
  `X`.

  When the delimiter recognized by [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is
  ...
  [Multiple Statement Execution Support](/doc/c-api/5.7/en/c-api-multiple-queries.html)), and for parsing
  the body of stored procedures and functions, triggers, and
  events (see [Section 23.1, “Defining Stored Programs”](stored-programs-defining.html "23.1 Defining Stored Programs")).

* `edit`, `\e`

  Edit the current input statement. [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
* `exit`, `\q`
  ...
  Exit [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client").
...
* `pager
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), it is possible to browse or search
  query results in interactive mode with Unix programs such as
  **less**, **more**, or any
  other similar program. If you specify no value for the
  option, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") checks the value of the
...
* `prompt [str]`,
  ...
  Reconfigure the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") prompt to the given
  ...
  argument, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") resets the prompt to the
  default of `mysql>`.
...
* `resetconnection`, `\x`
  ...
  [`mysql_change_user()`](/doc/c-api/5.7/en/mysql-change-user.html) or an
  auto-reconnect except that the connection is not closed and
  reopened, and re-authentication is not done. See
  [mysql\_change\_user()](/doc/c-api/5.7/en/mysql-change-user.html), and
...
* `status`, `\s`
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") variables that affect your queries.
...
* `tee
  ...
  you invoke [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), you can log statements
  and their output. All the data displayed on the screen is
  appended into a given file. This can be very useful for
  debugging purposes also. [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") flushes
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") built-in `tee` command
...
on and off interactively from within [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client").
...
<td><p>
                Your full
                <code><em class="replaceable"><code>user_name</code></em>@<em class="replaceable"><code>host_name</code></em></code>
                account name
              </p></td>
</tr><tr>
<td><code>\u</code></td>
...
<td><code>\\</code></td>
<td>A literal <code>\</code> backslash character</td>
</tr><tr>
...
* *Use a command-line option.* You can set
  ...
  command line to [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"). For example:
...
* *Use an option file.* You can set the
  ...
  files are listed in [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").) The

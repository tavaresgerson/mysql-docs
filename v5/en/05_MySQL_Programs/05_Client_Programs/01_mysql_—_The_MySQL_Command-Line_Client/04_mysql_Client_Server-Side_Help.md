...
command, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") uses it as a search string to
...
Use [**help contents**](help.html "13.8.3 HELP Statement") to see a list of the help
categories:
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") shows a list of matching topics:

...
server named [**mysqld-debug**](mysqld.html "4.3.1 mysqld — The MySQL Server"). Invoke this
version instead of [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") for debugging
support, memory allocation checking, and trace file support
(see [Section 5.8.1.2, “Creating Trace Files”](making-trace-files.html "5.8.1.2 Creating Trace Files")).
...
The [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") program has many options that can
...
[Section 5.1, “The MySQL Server”](mysqld-server.html "5.1 The MySQL Server"). For information about
installing MySQL and setting up the initial configuration, see
[Chapter 2, *Installing and Upgrading MySQL*](installing.html "Chapter 2 Installing and Upgrading MySQL").
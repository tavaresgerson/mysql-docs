...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") and [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")), MySQL
...
additional information, see [Section 4.2.4, “Connecting to the MySQL Server Using Command Options”](connecting.html "4.2.4 Connecting to the MySQL Server Using Command Options").

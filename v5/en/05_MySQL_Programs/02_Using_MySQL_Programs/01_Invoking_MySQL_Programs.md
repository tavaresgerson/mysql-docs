...
Option syntax is described in [Section 4.2.2, “Specifying Program Options”](program-options.html "4.2.2 Specifying Program Options").

Nonoption arguments (arguments with no leading dash) provide
additional information to the program. For example, the
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") program interprets the first nonoption
...
options, see [Section 4.2.4, “Connecting to the MySQL Server Using Command Options”](connecting.html "4.2.4 Connecting to the MySQL Server Using Command Options").
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is installed in
`/usr/local/mysql/bin`, you can run the program
by invoking it as [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), and it is not
...
[Section 4.2.7, “Setting Environment Variables”](setting-environment-variables.html "4.2.7 Setting Environment Variables").) After modifying

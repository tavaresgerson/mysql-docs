...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") or [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"). For
...
The examples here use the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client program,
but the principles apply to other clients such as
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"), [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program"), or
[**mysqlshow**](mysqlshow.html "4.5.7 mysqlshow — Display Database, Table, and Column Information").

This command invokes [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") without specifying
...
* For [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), the first nonoption argument is
  taken as the name of the default database. Because there is no
  such argument, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") selects no default
  database.
...
[Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files")). Another workaround is to change
...
* Specify the connection parameters in the
  ...
  For more information, see [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").

* Some connection parameters can be specified using environment
  variables. Examples:

  + To specify the host for [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), use
    `MYSQL_HOST`.

  + On Windows, to specify the MySQL user name, use
    `USER`.

  + To specify the password, use `MYSQL_PWD`.
    However, this is insecure; see
    [Section 6.1.2.1, “End-User Guidelines for Password Security”](password-security-user.html "6.1.2.1 End-User Guidelines for Password Security").

...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client supports a
...
such as when sending the output of [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") into
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") only and permits a limit to be placed

...
statement. See [Section 13.7.4.1, “SET Syntax for Variable Assignment”](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment"), and
...
program options. For example, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") has a
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") to a value of 16MB, use either of the
following commands:
...
[`--compress`](mysqldump.html#option_mysqldump_compress) option could be
given to [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") as
...
the value with
[`SET`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") at

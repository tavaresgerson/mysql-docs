...
<th>Description</th>
</tr></thead><tbody><tr><td>--defaults-extra-file</td>
...
<td><code>[none]</code></td>
  ...
  [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").) If the file does not exist
...
<td><code>[none]</code></td>
  ...
  *`str`*. For example, the
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client normally reads the
  `[client]` and `[mysql]`
...
<td><code>[none]</code></td>
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") reads `[client]`

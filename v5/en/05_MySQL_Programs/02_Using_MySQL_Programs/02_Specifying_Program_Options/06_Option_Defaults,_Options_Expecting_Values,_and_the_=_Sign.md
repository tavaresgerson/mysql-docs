...
In both cases, the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client attempts to
...
In this case, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") was unable to find a
...
Because [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") assumes that any string
...
When the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client reads this file, these
...
Trying to start [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") in this case causes a
different error:

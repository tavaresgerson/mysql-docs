...
[**my\_print\_defaults**](my-print-defaults.html "4.7.2 my_print_defaults — Display Options from Option Files") program to parse option files
and see what options would be used by a given program. The following
example shows the output that [**my\_print\_defaults**](my-print-defaults.html "4.7.2 my_print_defaults — Display Options from Option Files")
...
handles multiply specified options this way but that does not read

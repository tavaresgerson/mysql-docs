...
The [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") utility enables you
...
option files are used, see [Section 4.2.2.2, “Using Option Files”](option-files.html "4.2.2.2 Using Option Files").
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility"), by standard MySQL
clients ([**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"),
[**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program"), and so forth), and by the
**mysql-test-run.pl** testing utility.

Programs use groups in the login path file as follows:

* [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") operates on the
...
* Without a [`--login-path`](option-file-options.html#option_general_login-path)
  ...
  By default, the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client reads the
  `[client]` and `[mysql]`
...
* With a [`--login-path`](option-file-options.html#option_general_login-path) option,
  ...
  The [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client reads
  `[client]` and `[mysql]`
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") obfuscates the
...
variable. [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") provides a
...
The obfuscation used by [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility")
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") ignores it, and client
programs do not use it, either.

Invoke [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") like this:
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") creates it.

Command arguments are given as follows:

* *`program_options`* consists of
  general [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") options.
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") help message, and ignores
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") uses the
...
To see what [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") writes to the
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") makes it easy to set up
...
Here, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") reads the
`[client]` and `[mysql]`
...
Because [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") reads the
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") adds login paths to the
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program"). Options specified later override
options specified earlier, so putting the login paths in the
order `client`, `mysqldump`
enables [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")-specific options to
override `client` options.

When you use the `set` command with
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") to create a login path,
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") supports the following
...
<td><code>--help</code></td>
  ...
  [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") as follows, where
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") commands, and, for each
one, the command-specific options permitted following the
command name on the command line.

In addition, [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") supports
...
[**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") supports these commands:
...
* `print
  ...
  + `--help`, `-?`
    ...
    [**mysql\_config\_editor --help**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility").
...
* `set [options]`
  ...
  `--socket`, and `--user`
  options. If none of those options are given,
  [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") writes the login path
  as an empty group.
  ...
  + `--password`, `-p`
    ...
    [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") displays the
    prompt, type the password and press Enter. To prevent
    other users from seeing the password,
    [**mysql\_config\_editor**](mysql-config-editor.html "4.6.6 mysql_config_editor — MySQL Configuration Utility") does not echo it.

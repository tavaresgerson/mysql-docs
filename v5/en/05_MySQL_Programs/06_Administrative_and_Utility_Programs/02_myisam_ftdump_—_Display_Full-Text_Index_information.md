...
[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") displays information about
...
is located. Before using [**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information"), be
sure to issue a `FLUSH TABLES` statement first
if the server is running.

[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") scans and dumps the entire
index, which is not particularly fast. On the other hand, the
distribution of words changes infrequently, so it need not be
run often.

Invoke [**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") like this:
...
[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") in the directory where the
...
[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") as follows:
...
[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") in the database directory:

```sql
myisam_ftdump /usr/local/mysql/data/test/mytexttable 1
```

You can use [**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") to generate a list
...
[**myisam\_ftdump**](myisam-ftdump.html "4.6.2 myisam_ftdump — Display Full-Text Index information") supports the following options:

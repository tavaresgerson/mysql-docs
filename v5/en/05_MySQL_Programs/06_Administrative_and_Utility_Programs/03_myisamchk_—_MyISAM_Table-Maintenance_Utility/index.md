...
[4.6.3.1 myisamchk General Options](myisamchk-general-options.html)

[4.6.3.2 myisamchk Check Options](myisamchk-check-options.html)

[4.6.3.3 myisamchk Repair Options](myisamchk-repair-options.html)

[4.6.3.4 Other myisamchk Options](myisamchk-other-options.html)

[4.6.3.5 Obtaining Table Information with myisamchk](myisamchk-table-info.html)

[4.6.3.6 myisamchk Memory Usage](myisamchk-memory.html)

The [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") utility gets information about
your database tables or checks, repairs, or optimizes them.
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") works with
`MyISAM` tables (tables that have
`.MYD` and `.MYI` files
for storing data and indexes).

You can also use the [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement")
and [`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") statements to
check and repair `MyISAM` tables. See
[Section 13.7.2.2, “CHECK TABLE Statement”](check-table.html "13.7.2.2 CHECK TABLE Statement"), and
[Section 13.7.2.5, “REPAIR TABLE Statement”](repair-table.html "13.7.2.5 REPAIR TABLE Statement").

The use of [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") with partitioned tables
is not supported.
...
Invoke [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") like this:
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to do. They are described in the
following sections. You can also get a list of options by
invoking [**myisamchk --help**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility").

With no options, [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") simply checks your
table as the default operation. To get more information or to
tell [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to take corrective action,
specify options as described in the following discussion.

*`tbl_name`* is the database table you
want to check or repair. If you run [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
somewhere other than in the database directory, you must specify
the path to the database directory, because
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") has no idea where the database is
located. In fact, [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") does not actually
...
You can name several tables on the [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"), see
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")*. The most effective
means of doing so is to shut down the MySQL server while
running [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"), or to lock all tables
that [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") is being used on.

Otherwise, when you run [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"), it may
...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server) that hasn't yet closed the
file or that has died without closing the file properly, which
can sometimes lead to the corruption of one or more
`MyISAM` tables.

If [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") is running, you must force it to
flush any table modifications that are still buffered in
memory by using [`FLUSH TABLES`](flush.html#flush-tables).
You should then ensure that no one is using the tables while
you are running [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")

However, the easiest way to avoid this problem is to use
[`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") instead of
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to check tables. See
[Section 13.7.2.2, “CHECK TABLE Statement”](check-table.html "13.7.2.2 CHECK TABLE Statement").

[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") supports the following options,

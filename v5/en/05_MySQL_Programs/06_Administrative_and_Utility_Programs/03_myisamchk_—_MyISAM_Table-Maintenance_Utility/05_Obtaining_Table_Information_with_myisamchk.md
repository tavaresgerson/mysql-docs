...
* [**myisamchk -d
  *`tbl_name`***](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
  ...
  Runs [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") in “describe
  mode” to produce a description of your table. If you
  start the MySQL server with external locking disabled,
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") may report an error for a table
  that is updated while it runs. However, because
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") does not change the table in
  describe mode, there is no risk of destroying data.

* [**myisamchk -dv
  *`tbl_name`***](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")

  Adding `-v` runs [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
...
index file, as described in [Section 4.6.3, “myisamchk — MyISAM Table-Maintenance Utility”](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility").
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") shown later, some values are
...
Example of [**myisamchk -dvv**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") output:
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") produces are given here.
...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") displays some low-level
information:
...
* `Rec/key`
  ...
  -a**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"). If this is not updated at all, a default value
  of 30 is given.
...
[**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"). See [Section 4.6.5, “myisampack — Generate Compressed, Read-Only MyISAM Tables”](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"),
for an example of this information.

Example of [**myisamchk -eiv**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") output:
...
[**myisamchk -eiv**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") output includes the following
information:
...
* `Keyblocks used`
  ...
  just been reorganized with [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"), the
...
* `Packed`
  ...
  [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") columns. For long
...
* `Blocks/Record`
  ...
  table. See [Section 7.6.4, “MyISAM Table Optimization”](myisam-optimization.html "7.6.4 MyISAM Table Optimization").

...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"). The sections following this one
...
<td><code>d:t:o,/tmp/myisamchk.trace</code></td>
</tr></tbody></table>
...
<td><code>--defaults-file=file_name</code></td>
</tr><tr><th>Type</th>
<td>File name</td>
</tr></tbody></table>
...
<td>String</td>
  ...
  *`str`*. For example,
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") normally reads the
  ...
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") also reads the
...
<td><code>--silent</code></td>
  ...
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") very silent.
...
<td><code>--HELP</code></td>
  ...
  are running [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with external locking
  disabled, the table can be locked only by another
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") command.
...
The possible [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") variables and their
default values can be examined with [**myisamchk
--help**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"):
...
* The temporary files needed to sort the keys would be more
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns, because the
  sort operation needs to store the complete key values as it
  proceeds. If you have lots of temporary space and you can
  force [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to repair by sorting, you
...
If you use [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to perform an operation
...
An alternative to using [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") is to use
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). These statements are

...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") prints checksums for
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") cannot be used on tablespace
files that the server already has open. For such files, you
should use [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") to check
tables within the tablespace. Attempting to run
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") on a tablespace that the server
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to make a backup of the tables
within the tablespace.

Invoke [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") like this:
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") supports the following options.
...
<td><code>--strict-check=algorithm</code></td>
</tr><tr><th>Type</th>
<td>Enumeration</td>
</tr><tr><th>Default Value</th>
<td><code>crc32</code></td>
</tr><tr><th>Valid Values</th>
<td><p class="valid-value"><code>innodb</code></p><p class="valid-value"><code>crc32</code></p><p class="valid-value"><code>none</code></p></td>
</tr></tbody></table>
  ...
  + If you do not specify the
    [`--strict-check`](innochecksum.html#option_innochecksum_strict-check)
    option, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") validates
    against `innodb`,
    `crc32` and `none`.
...
<td><code>false</code></td>
  ...
  specified, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") terminates.
...
<td><code>false</code></td>
  ...
  [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") terminates. The default
  setting is 0. If
  `--allow-mismatches=`*`N`*,
  where `N>=0`,
  *`N`* mismatches are permitted and
  [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") terminates at
  `N+1`. When
  `--allow-mismatches` is set to 0,
  [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") terminates on the first
  checksum mismatch.
...
<td><code>false</code></td>
  ...
  tells [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") to ignore verification
  ...
  [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") obtains an exclusive lock
...
<td><code>false</code></td>
  ...
  Log output for the [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") tool. A
...
* `-` option.
  ...
  expected, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") prints
  [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") usage information indicating
  ...
  In this example, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") writes the
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") on multiple user-defined
tablespace files (`.ibd` files).

Run [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") for all tablespace
...
Run [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") for all tablespace files
...
Running [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") on multiple
...
expansion. On Windows systems, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility")
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") on multiple files that form one
logical system tablespace, [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility")
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") command would be used:

```sql
cat ibdata* | innochecksum -
```

Refer to the [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") options information
for more information about the “-” option.

Note

Running [**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") on multiple files in
...
[**innochecksum**](innochecksum.html "4.6.1 innochecksum — Offline InnoDB File Checksum Utility") must be run separately for

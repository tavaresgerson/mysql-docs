...
[**mysqldumpslow**](mysqldumpslow.html "4.6.8 mysqldumpslow — Summarize Slow Query Log Files") parses MySQL slow query log
files and summarizes their contents.

Normally, [**mysqldumpslow**](mysqldumpslow.html "4.6.8 mysqldumpslow — Summarize Slow Query Log Files") groups queries that
...
Invoke [**mysqldumpslow**](mysqldumpslow.html "4.6.8 mysqldumpslow — Summarize Slow Query Log Files") like this:
...
[**mysqldumpslow**](mysqldumpslow.html "4.6.8 mysqldumpslow — Summarize Slow Query Log Files") supports the following options.
...
<td>String</td>
  ...
  [**mysql.server**](mysql-server.html "4.3.3 mysql.server — MySQL Server Startup Script") startup script).
...
<td><code>at</code></td>
  ...
  *`sort_type`* should be chosen from
  ...
  By default, [**mysqldumpslow**](mysqldumpslow.html "4.6.8 mysqldumpslow — Summarize Slow Query Log Files") sorts by

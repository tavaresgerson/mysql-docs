...
[**myisamlog**](myisamlog.html "4.6.4 myisamlog — Display MyISAM Log File Contents") processes the contents of a
`MyISAM` log file. To create such a file, start
the server with a
[`--log-isam=log_file`](server-options.html#option_mysqld_log-isam)
option.

Invoke [**myisamlog**](myisamlog.html "4.6.4 myisamlog — Display MyISAM Log File Contents") like this:
...
[**myisamlog**](myisamlog.html "4.6.4 myisamlog — Display MyISAM Log File Contents") supports the following options:

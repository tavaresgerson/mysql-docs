...
The [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") utility compresses
`MyISAM` tables. [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables")
works by compressing each column in the table separately.
Usually, [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") packs the data file 40%
to 70%.
...
* If the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server was invoked with
  external locking disabled, it is not a good idea to invoke
  [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") if the table might be updated
...
* [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") does not support partitioned
  tables.

Invoke [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") like this:
...
After you compress a table with [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"),
use [**myisamchk -rq**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to rebuild its indexes.
[Section 4.6.3, “myisamchk — MyISAM Table-Maintenance Utility”](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility").

[**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") supports the following options. It
also reads option files and supports the options for processing
them described at [Section 4.2.2.3, “Command-Line Options that Affect Option-File Handling”](option-file-options.html "4.2.2.3 Command-Line Options that Affect Option-File Handling").
...
<td><code>--force</code></td>
  ...
  invocation of [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") exists.
  ([**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") creates an intermediate file
  named
  `tbl_name.TMD`
  in the database directory while it compresses the table. If
  you kill [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"), the
  `.TMD` file might not be deleted.)
  Normally, [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") exits with an error
  if it finds that
  `tbl_name.TMD`
  exists. With [`--force`](myisampack.html#option_myisampack_force),
  [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") packs the table anyway.
...
<td><code>--tmpdir=dir_name</code></td>
</tr><tr><th>Type</th>
<td>Directory name</td>
</tr></tbody></table>

  Use the named directory as the location where
  [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") creates temporary files.
...
<td><code>--backup</code></td>
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server was invoked with external
...
[**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables") displays the following kinds of
information:
...
* `empty-fill`
  ...
  type. For example, a [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
  column (eight bytes) can be stored as a
  [`TINYINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column (one byte) if
...
* `table-lookup`
  ...
  [`ENUM`](enum.html "11.3.5 The ENUM Type") before Huffman
  compression.
...
lines displayed by [**myisamchk -dvv**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") include
...
After you run [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"), use
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to re-create any indexes. At this
...
flush-tables**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") to force [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") to

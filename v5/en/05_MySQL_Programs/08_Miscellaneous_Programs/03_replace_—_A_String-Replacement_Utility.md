...
The [**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") utility program changes strings
in place in files or on the standard input.

Note

The [**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") utility is deprecated as of
MySQL 5.7.18 and is removed in MySQL 8.0.

Invoke [**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") in one of the following ways:
...
[**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") reads the standard input and writes
to the standard output.

[**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") uses a finite state machine to match
...
[**replace**](replace-utility.html "4.8.3 replace — A String-Replacement Utility") supports the following options.

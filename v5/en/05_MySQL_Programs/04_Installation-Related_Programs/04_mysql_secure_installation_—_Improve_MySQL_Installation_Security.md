...
[`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") helps you implement
...
[`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") without arguments:

```sql
mysql_secure_installation
```

When executed, [`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security")
...
[`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") prompts the user
...
[`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") supports the
...
<table frame="box" rules="all" summary="Command-line options available for mysql_secure_installation."><col style="width: 31%"/><col style="width: 56%"/><col style="width: 12%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
</tr></thead><tbody><tr><th>--defaults-extra-file</th>
...
<td>String</td>
  ...
  *`str`*. For example,
  [`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") normally reads
  the `[client]` and
  ...
  [`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security") also reads the
  `[client_other]` and
...
<td><code>[none]</code></td>
  ...
  option is used, [`mysql_secure_installation`](mysql-secure-installation.html "4.4.4 mysql_secure_installation — Improve MySQL Installation Security")

...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables"), which looks for
...
If [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") finds that a table has a
possible incompatibility, it performs a table check and, if
problems are found, attempts a table repair. If the table cannot
be repaired, see [Section 2.10.12, “Rebuilding or Repairing Tables or Indexes”](rebuilding-tables.html "2.10.12 Rebuilding or Repairing Tables or Indexes") for manual
table repair strategies.

[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") communicates directly with the
...
default [`--early-plugin-load`](server-options.html#option_mysqld_early-plugin-load)
...
[`--early-plugin-load`](server-options.html#option_mysqld_early-plugin-load) option that
...
upgrade using [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables"). For details,
see [Section 2.10.3, “Changes in MySQL 5.7”](upgrading-from-previous-series.html "2.10.3 Changes in MySQL 5.7").

Note

On Windows, you must run [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") with
...
and running [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables"). See
[Section 2.10, “Upgrading MySQL”](upgrading.html "2.10 Upgrading MySQL"), for instructions on determining
whether any such incompatibilities apply to your installation
and how to handle them.

Use [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") like this:

1. Ensure that the server is running.
2. Invoke [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") to upgrade the
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") with connection parameters
...
By default, [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") runs as the MySQL
`root` user. If the `root`
password is expired when you run
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables"), it displays a message telling
you that your password is expired and that
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") failed as a result. To correct
this, reset the `root` password to unexpire it
and run [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") again. First, connect
...
USER`](alter-user.html "13.7.1.1 ALTER USER Statement"):

```sql
mysql> ALTER USER USER() IDENTIFIED BY 'root-password';
```

Then exit [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") and run
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") again:
...
example, `MyISAM`),
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") might fail with an error like
this:
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") successfully. After that,
...
option, [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") processes all tables in
...
the [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") statement. For
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") marks all checked and repaired
tables with the current MySQL version number. This ensures that
the next time you run [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") with the
same version of the server, it can be determined whether there
is any need to check or repair a given table again.

[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") saves the MySQL version number
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") checks
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") sets empty
`plugin` values to
...
upgrade instructions, see [Section 6.4.1.3, “Migrating Away from Pre-4.1 Password Hashing and the mysql\_old\_password
Plugin”](account-upgrades.html "6.4.1.3 Migrating Away from Pre-4.1 Password Hashing and the mysql_old_password Plugin").

[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") does not upgrade the contents
of the time zone tables or help tables. For upgrade
instructions, see [Section 5.1.13, “MySQL Server Time Zone Support”](time-zone-support.html "5.1.13 MySQL Server Time Zone Support"), and
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") installs the
...
[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") checks for partitioned
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client using the
[`ALTER
TABLE ... UPGRADE PARTITIONING`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") SQL statement.

[`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") supports the following options,
...
<table frame="box" rules="all" summary="Command-line options available for mysql_upgrade."><col style="width: 31%"/><col style="width: 56%"/><col style="width: 12%"/><thead><tr><th>Option Name</th>
<th>Description</th>
<th>Introduced</th>
...
<td>5.7.10</td>
</tr><tr><th>--upgrade-system-tables</th>
...
<td><code>d:t:O,/tmp/mysql_upgrade.trace</code></td>
</tr></tbody></table>
...
<td><code>--help</code></td>
  ...
  *`str`*. For example,
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") normally reads the
  `[client]` and
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") also reads the
  `[client_other]` and
...
<td><code>--help</code></td>
  ...
  force execution even if [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") has
...
<td><code>--help</code></td>
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") prompts for one. If given,
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") should not prompt for one,
  use the
...
<td><code>--bind-address=ip_address</code></td>
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") does not find it. See
...
<td><code>--bind-address=ip_address</code></td>
  ...
  By default, [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") installs the
  `sys` schema if it is not installed, and
...
<td>Directory name</td>
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") is connecting to verify
  that it is the same as the version for which
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") was built. If not,
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") exits. This option is
...
<td>Directory name</td>
  ...
  [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables") is disabled. Invoke the
  program with
  ...
  enable binary logging by [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables").
...
[**comp\_err**](comp-err.html "4.4.1 comp_err — Compile MySQL Error Message File") creates the
`errmsg.sys` file that is used by
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") to determine the error messages to
display for different error codes. [**comp\_err**](comp-err.html "4.4.1 comp_err — Compile MySQL Error Message File")
...
[**comp\_err**](comp-err.html "4.4.1 comp_err — Compile MySQL Error Message File") also generates the
`mysqld_error.h`,
`mysqld_ername.h`, and
...
the [MySQL Internals
Manual](/doc/internals/en).

Invoke [**comp\_err**](comp-err.html "4.4.1 comp_err — Compile MySQL Error Message File") like this:

```sql
comp_err [options]
```

[**comp\_err**](comp-err.html "4.4.1 comp_err — Compile MySQL Error Message File") supports the following options.
...
<td><code>d:t:O,/tmp/comp_err.trace</code></td>
  ...
  *`debug_options`* string is
  ...
  For non-debug builds, this option is non-functional and
  causes the program to exit with an explanatory message.
...
<td><code>--header-file=name</code></td>
</tr><tr><th>Type</th>
<td>File name</td>
</tr><tr><th>Default Value</th>
...
<td><code>--name-file=name</code></td>
</tr><tr><th>Type</th>
<td>File name</td>
</tr><tr><th>Default Value</th>
...
* [`--out-file=file_name`](comp-err.html#option_comp_err_out-file),
  ...
  <table frame="box" rules="all" summary="Properties for out-file"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code>--out-file=name</code></td>
</tr><tr><th>Type</th>
<td>File name</td>
</tr><tr><th>Default Value</th>
<td><code>errmsg.sys</code></td>
</tr></tbody></table>

  The name of the output file. The default is
  `errmsg.sys`.

* [`--state-file=file_name`](comp-err.html#option_comp_err_state-file),
  `-S file_name`

  <table frame="box" rules="all" summary="Properties for state-file"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th>
<td><code>--state-file=name</code></td>
</tr><tr><th>Type</th>
<td>File name</td>
</tr><tr><th>Default Value</th>
<td><code>sql_state.h</code></td>
</tr></tbody></table>

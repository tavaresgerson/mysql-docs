...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") can also be used to
create new SSL files if the existing ones have expired.

Note

[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") uses the
...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") helps lower the barrier
to using SSL by making it easier to generate the required
files. However, certificates generated by
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") are self-signed, which
is not very secure. After you gain experience using the files
created by [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files"), consider
obtaining a CA certificate from a registered certificate
authority.

Invoke [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") like this:
...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") executes.

[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") attempts to create SSL
and RSA files using a default set of file names. It works as
follows:

1. [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") checks for the
   **openssl** binary at the locations specified
   by the `PATH` environment variable. If
   **openssl** is not found,
   [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") does nothing. If
   **openssl** is present,
   [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") looks for default SSL
...
2. [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") checks the data
...
3. If any of those files are present,
   [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") creates no SSL files.
...
4. [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") checks the data
...
5. If any of these files are present,
   [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") creates no RSA files.
   Otherwise, it invokes **openssl** to create
...
created by [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") to enable SSL
...
[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") to enable RSA if no
...
because [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") by default
...
can use [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") to create new
ones:
...
2. Rename or remove the existing SSL files. You may wish to
   ...
   [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") sees that they exist
   and not overwrite them.)

3. Run [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") with the
   [`--datadir`](mysql-ssl-rsa-setup.html#option_mysql_ssl_rsa_setup_datadir) option
   to specify where to create the new files.

4. Restart the server.

[`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") supports the following
...
<th>Description</th>
</tr></thead><tbody><tr><td>--datadir</td>
...
<td>Directory name</td>
  ...
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") should check for
...
<td><code>--uid=name</code></td>
  ...
  [`mysql_ssl_rsa_setup`](mysql-ssl-rsa-setup.html "4.4.5 mysql_ssl_rsa_setup — Create SSL/RSA Files") are owned by the user

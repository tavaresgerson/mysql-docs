...
* **memcached** as a daemon plugin of
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server"). Both [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") and
...
* The [`innodb_api_trx_level`](innodb-parameters.html#sysvar_innodb_api_trx_level)
  ...
  **memcached** has no concept of
  [transactions](glossary.html#glos_transaction "transaction"), you can
  ...
  **daemon\_memcached** plugin. By default,
  [`innodb_api_trx_level`](innodb-parameters.html#sysvar_innodb_api_trx_level) is set
  to [`READ UNCOMMITTED`](innodb-transaction-isolation-levels.html#isolevel_read-uncommitted).

* The [`innodb_api_enable_mdl`](innodb-parameters.html#sysvar_innodb_api_enable_mdl)
  option can be used to lock the table at the MySQL level, so
  that the mapped table cannot be dropped or altered by
  [DDL](glossary.html#glos_ddl "DDL") through the SQL interface.

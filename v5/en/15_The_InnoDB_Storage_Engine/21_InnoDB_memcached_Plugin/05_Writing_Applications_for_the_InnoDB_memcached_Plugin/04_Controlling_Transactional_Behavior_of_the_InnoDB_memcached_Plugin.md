...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") command line or entered in a MySQL
configuration file.

##### Allowing or Disallowing DDL

By default, you can perform [DDL](glossary.html#glos_ddl "DDL")
operations such as [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") on
...
because it blocks [`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement")

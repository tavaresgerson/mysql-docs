...
* The **memcached** protocol passes numeric
  ...
  + Use [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") columns with
...
* To use an existing table with the
  ...
  **memcached** request in the form of
  ...
  [Example 14.13, “Using Your Own Table with an InnoDB memcached Application”](innodb-memcached-porting-mysql.html#innodb-memcached-tutorial-python "Example 14.13 Using Your Own Table with an InnoDB memcached Application"). For the
...
described in [Section 14.21.3, “Setting Up the InnoDB memcached Plugin”](innodb-memcached-setup.html "14.21.3 Setting Up the InnoDB memcached Plugin"). It also
...
6. Query the `multicol` table to view data
   ...
   [MySQL Connector or
   API](connectors-apis.html "Chapter 27 Connectors and APIs")).

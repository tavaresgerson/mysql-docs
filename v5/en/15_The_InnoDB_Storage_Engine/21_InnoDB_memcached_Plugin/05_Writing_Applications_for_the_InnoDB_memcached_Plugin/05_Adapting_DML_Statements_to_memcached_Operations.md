...
The following [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") and
[`DELETE`](delete.html "13.2.2 DELETE Statement") statements, which remove

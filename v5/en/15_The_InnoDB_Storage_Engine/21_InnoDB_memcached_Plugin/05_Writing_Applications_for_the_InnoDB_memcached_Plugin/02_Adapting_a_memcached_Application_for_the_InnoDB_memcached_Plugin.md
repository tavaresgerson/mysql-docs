...
* If there are key values longer than a few bytes, it may be
  ...
  [primary key](glossary.html#glos_primary_key "primary key") of the
...
* If you store several different classes of information using
  **memcached**, consider setting up a separate
  ...
  might enable
  [compression](glossary.html#glos_compression "compression") for a
  ...
  [secondary
  indexes](glossary.html#glos_secondary_index "secondary index") on tables that are frequently used to

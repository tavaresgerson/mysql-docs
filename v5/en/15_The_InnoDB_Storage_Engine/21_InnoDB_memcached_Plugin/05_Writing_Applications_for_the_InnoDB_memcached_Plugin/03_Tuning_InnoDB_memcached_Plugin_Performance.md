...
[DML](glossary.html#glos_dml "DML") operations (inserts,
...
[buffer pool](glossary.html#glos_buffer_pool "buffer pool"), through the
...
deprecated; expect it to be removed in a future release. As of
MySQL 5.7.10, `InnoDB` support for two-phase
...
[commit](glossary.html#glos_commit "commit") operations. On a busy

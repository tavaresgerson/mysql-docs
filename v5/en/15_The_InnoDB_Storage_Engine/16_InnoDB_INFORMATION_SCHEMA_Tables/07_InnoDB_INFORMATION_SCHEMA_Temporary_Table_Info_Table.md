...
[`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table") provides
...
2. Query [`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table") to
   ...
   *************************** 1. row ***************************
   ...
   `DB_TRX_ID`, and
   `DB_ROLL_PTR`).
   `PER_TABLE_TABLESPACE` and
   `IS_COMPRESSED` report
   `TRUE` for compressed temporary tables.
   Otherwise, these fields report `FALSE`.
...
4. Query [`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table")
   again.
   ...
   *************************** 2. row ***************************
   ...
   `PER_TABLE_TABLESPACE` and
   `IS_COMPRESSED` report
   `TRUE` for the compressed temporary table.
   The `SPACE` ID for the compressed temporary
   ...
   temporary tablespace (`ibtmp1`) and
   report the same `SPACE` ID.

5. Restart MySQL and query
   [`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table").
   ...
   [`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table") and its
...
7. Query [`INNODB_TEMP_TABLE_INFO`](information-schema-innodb-temp-table-info-table.html "24.4.27 The INFORMATION_SCHEMA INNODB_TEMP_TABLE_INFO Table") to
   view the temporary table metadata.

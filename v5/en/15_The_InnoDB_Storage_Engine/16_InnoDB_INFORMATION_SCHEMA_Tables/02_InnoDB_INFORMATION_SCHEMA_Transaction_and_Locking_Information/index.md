...
[14.16.2.1 Using InnoDB Transaction and Locking Information](innodb-information-schema-examples.html)

[14.16.2.2 InnoDB Lock and Lock-Wait Information](innodb-information-schema-understanding-innodb-locking.html)

[14.16.2.3 Persistence and Consistency of InnoDB Transaction and Locking Information](innodb-information-schema-internal-data.html)

Three `InnoDB`
`INFORMATION_SCHEMA` tables enable you to monitor
transactions and diagnose potential locking problems:

* [`INNODB_TRX`](information-schema-innodb-trx-table.html "24.4.28 The INFORMATION_SCHEMA INNODB_TRX Table"): Provides information
...
* [`INNODB_LOCKS`](information-schema-innodb-locks-table.html "24.4.14 The INFORMATION_SCHEMA INNODB_LOCKS Table"): Each transaction in
  InnoDB that is waiting for another transaction to release a
  lock (`INNODB_TRX.TRX_STATE` is `LOCK
  ...
  [`INNODB_LOCKS`](information-schema-innodb-locks-table.html "24.4.14 The INFORMATION_SCHEMA INNODB_LOCKS Table") contains one row
  that describes each lock the transaction has requested, and
  for which it is waiting.
  [`INNODB_LOCKS`](information-schema-innodb-locks-table.html "24.4.14 The INFORMATION_SCHEMA INNODB_LOCKS Table") also contains one
...
* [`INNODB_LOCK_WAITS`](information-schema-innodb-lock-waits-table.html "24.4.15 The INFORMATION_SCHEMA INNODB_LOCK_WAITS Table"): This table
  ...
  `REQUESTED_LOCK_ID` value refers to the lock
  requested by a transaction, and the
  `BLOCKING_LOCK_ID` value refers to the lock
  ...
  [`INNODB_LOCK_WAITS`](information-schema-innodb-lock-waits-table.html "24.4.15 The INFORMATION_SCHEMA INNODB_LOCK_WAITS Table") have the same
...
[Section 24.4.14, “The INFORMATION\_SCHEMA INNODB\_LOCKS Table”](information-schema-innodb-locks-table.html "24.4.14 The INFORMATION_SCHEMA INNODB_LOCKS Table"), and

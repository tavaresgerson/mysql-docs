...
* Temporary log files:
  ...
  [`innodb_sort_buffer_size`](innodb-parameters.html#sysvar_innodb_sort_buffer_size) up to
  ...
  `DB_ONLINE_LOG_TOO_BIG` error and uncommitted
  concurrent DML operations are rolled back. A large
  [`innodb_online_alter_log_max_size`](innodb-parameters.html#sysvar_innodb_online_alter_log_max_size)
  ...
  The [`innodb_sort_buffer_size`](innodb-parameters.html#sysvar_innodb_sort_buffer_size)
...
* Temporary sort files:
  ...
  [`--tmpdir`](server-system-variables.html#sysvar_tmpdir)) during index
  ...
  the sort files, set [`tmpdir`](server-system-variables.html#sysvar_tmpdir) to
  a different directory. Alternatively, define a separate
  temporary directory for online DDL operations using
  [`innodb_tmpdir`](innodb-parameters.html#sysvar_innodb_tmpdir). This option
...
* Intermediate table files:
  ...
  The [`innodb_tmpdir`](innodb-parameters.html#sysvar_innodb_tmpdir) option is

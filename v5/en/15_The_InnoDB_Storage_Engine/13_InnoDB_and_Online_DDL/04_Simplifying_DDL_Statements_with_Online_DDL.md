...
DDL](glossary.html#glos_online_ddl "online DDL"), it was common practice to combine many DDL operations
into a single [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
statement. Because each [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") for each slightly different scenario.

For DDL operations that can be done in place, you can separate
them into individual [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statements for:
...
* Operations for which you specify
  `ALGORITHM=COPY` or
  [`old_alter_table=1`](server-system-variables.html#sysvar_old_alter_table), to force

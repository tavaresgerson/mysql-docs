...
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server standard error output
...
information, see [Section 5.4.2.1, “Error Logging on Windows”](error-log-windows.html "5.4.2.1 Error Logging on Windows").

On Unix and Unix-like systems, `stderr` is
typically directed to the terminal unless configured otherwise.
For more information, see [Section 5.4.2.2, “Error Logging on Unix and Unix-Like Systems”](error-log-unix.html "5.4.2.2 Error Logging on Unix and Unix-Like Systems").
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") output, you are only required to enable
[`innodb_status_output_locks`](innodb-parameters.html#sysvar_innodb_status_output_locks).
...
INNODB STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") SQL statement, which fetches the output to
your client program. If you are using the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") output also includes `InnoDB`

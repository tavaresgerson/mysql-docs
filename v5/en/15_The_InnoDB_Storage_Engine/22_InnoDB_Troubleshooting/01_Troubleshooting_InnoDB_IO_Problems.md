...
* Make sure [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") has access rights to
  create files in those directories.

* Make sure [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") can read the proper
  `my.cnf` or `my.ini`

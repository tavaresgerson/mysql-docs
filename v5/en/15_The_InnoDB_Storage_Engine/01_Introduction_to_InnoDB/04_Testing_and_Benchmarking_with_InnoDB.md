...
clause to the [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
...
[`ALTER TABLE
table_name ENGINE=InnoDB;`](alter-table.html "13.1.8 ALTER TABLE Statement") for each table. Alternatively,

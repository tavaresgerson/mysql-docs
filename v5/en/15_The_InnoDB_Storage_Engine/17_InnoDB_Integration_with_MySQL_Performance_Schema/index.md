...
[Performance Schema
feature](performance-schema.html "Chapter 25 MySQL Performance Schema"). This type of tuning is primarily for expert users
...
* You must be generally familiar with how to use the
  [Performance Schema
  feature](performance-schema.html "Chapter 25 MySQL Performance Schema"). For example, you should know how enable
...
* You should be familiar with Performance Schema instruments that
  ...
  [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table for
  ...
  Schema
  [instances
  tables](performance-schema-instance-tables.html "25.12.3 Performance Schema Instance Tables"), which provide additional information about
  instrumented objects. Instance tables relevant to
  `InnoDB` include:

  + The [`mutex_instances`](performance-schema-mutex-instances-table.html "25.12.3.3 The mutex_instances Table") table
  + The [`rwlock_instances`](performance-schema-rwlock-instances-table.html "25.12.3.4 The rwlock_instances Table") table
  + The [`cond_instances`](performance-schema-cond-instances-table.html "25.12.3.1 The cond_instances Table") table
  + The [`file_instances`](performance-schema-file-instances-table.html "25.12.3.2 The file_instances Table") table
...
* You should be familiar with
  ...
  + The [Wait
    Event](performance-schema-wait-tables.html "25.12.4 Performance Schema Wait Event Tables") tables, which store wait events.

  + The
    [Summary](performance-schema-summary-tables.html "25.12.15 Performance Schema Summary Tables")
    tables, which provide aggregated information for terminated
    events over time. Summary tables include
    [file
    I/O summary tables](performance-schema-file-summary-tables.html "25.12.15.6 File I/O Summary Tables"), which aggregate information about
    I/O operations.

  + [Stage
    Event](performance-schema-stage-tables.html "25.12.5 Performance Schema Stage Event Tables") tables, which store event data for
    `InnoDB` [`ALTER
    TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") and buffer pool load operations. For more
    information, see
    [Section 14.17.1, “Monitoring ALTER TABLE Progress for InnoDB Tables Using Performance
    Schema”](monitor-alter-table-performance-schema.html "14.17.1 Monitoring ALTER TABLE Progress for InnoDB Tables Using Performance Schema"),
    and

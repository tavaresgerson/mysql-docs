...
[Performance Schema](performance-schema.html "Chapter 25 MySQL Performance Schema"). Wait
...
1. To view available `InnoDB` mutex wait
   ...
   [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table, as shown
   below. All `InnoDB` mutex wait instruments
...
2. Some `InnoDB` mutex instances are created at
   ...
   [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table. The
   `ENABLED` and `TIMED`
...
3. Enable wait event consumers by updating the
   [`setup_consumers`](performance-schema-setup-consumers-table.html "25.12.2.2 The setup_consumers Table") table. Wait event
   ...
   querying the [`setup_consumers`](performance-schema-setup-consumers-table.html "25.12.2.2 The setup_consumers Table")
   table. The [`events_waits_current`](performance-schema-events-waits-current-table.html "25.12.4.1 The events_waits_current Table"),
...
4. Once instruments and consumers are enabled, run the workload
   ...
   [**mysqlslap**](mysqlslap.html "4.5.8 mysqlslap — A Load Emulation Client") load emulation client is used to
   simulate a workload.

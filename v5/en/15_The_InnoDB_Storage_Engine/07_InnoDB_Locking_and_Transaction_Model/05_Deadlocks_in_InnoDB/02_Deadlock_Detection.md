...
When [deadlock
detection](glossary.html#glos_deadlock_detection "deadlock detection") is enabled (the default),
`InnoDB` automatically detects transaction
[deadlocks](glossary.html#glos_deadlock "deadlock") and rolls back a
...
lock set by a MySQL [`LOCK TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements")
...
[`innodb_lock_wait_timeout`](innodb-parameters.html#sysvar_innodb_lock_wait_timeout) system
variable.
...
deadlocks, see [Section 14.7.5, “Deadlocks in InnoDB”](innodb-deadlocks.html "14.7.5 Deadlocks in InnoDB").

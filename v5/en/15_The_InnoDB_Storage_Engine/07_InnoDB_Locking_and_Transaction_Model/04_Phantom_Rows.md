...
[`SELECT`](select.html "13.2.9 SELECT Statement") is executed twice, but
...
[`SELECT`](select.html "13.2.9 SELECT Statement") within the same transaction,
...
[Section 14.7.1, “InnoDB Locking”](innodb-locking.html "14.7.1 InnoDB Locking"). This may cause phantom problems

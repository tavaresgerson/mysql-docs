...
[14.7.2.1 Transaction Isolation Levels](innodb-transaction-isolation-levels.html)

[14.7.2.2 autocommit, Commit, and Rollback](innodb-autocommit-commit-rollback.html)

[14.7.2.3 Consistent Nonlocking Reads](innodb-consistent-read.html)

[14.7.2.4 Locking Reads](innodb-locking-reads.html)

The `InnoDB` transaction model aims combine the
best properties of a

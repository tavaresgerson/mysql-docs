...
information is stored in the system tablespace or undo tablespaces
in a data structure called a rollback segment. See
[Section 14.6.3.4, “Undo Tablespaces”](innodb-undo-tablespaces.html "14.6.3.4 Undo Tablespaces"). `InnoDB`
...
read. See [Section 14.7.2.3, “Consistent Nonlocking Reads”](innodb-consistent-read.html "14.7.2.3 Consistent Nonlocking Reads").
...
information about undo logs, see [Section 14.6.7, “Undo Logs”](innodb-undo-logs.html "14.6.7 Undo Logs").
...
logs, and the rollback segment may grow too big, filling up the
tablespace in which it resides. For information about managing undo
tablespaces, see [Section 14.6.3.4, “Undo Tablespaces”](innodb-undo-tablespaces.html "14.6.3.4 Undo Tablespaces").
...
[`innodb_max_purge_lag`](innodb-parameters.html#sysvar_innodb_max_purge_lag) system
...
However, if the
[index
condition pushdown (ICP)](index-condition-pushdown-optimization.html "8.2.1.5 Index Condition Pushdown Optimization") optimization is enabled, and parts

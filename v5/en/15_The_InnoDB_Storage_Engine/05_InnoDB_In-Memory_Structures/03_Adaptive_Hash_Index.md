...
predict in advance whether the adaptive hash index feature is
appropriate for a particular system and workload, consider running
benchmarks with it enabled and disabled.
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") output. If there are numerous threads waiting on
...
indexes, see [Section 8.3.8, “Comparison of B-Tree and Hash Indexes”](index-btree-hash.html "8.3.8 Comparison of B-Tree and Hash Indexes").
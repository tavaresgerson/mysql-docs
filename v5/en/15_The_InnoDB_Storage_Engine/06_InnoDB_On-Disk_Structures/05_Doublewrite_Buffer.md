...
system, storage subsystem, or unexpected [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server")
...
[`innodb_doublewrite`](innodb-parameters.html#sysvar_innodb_doublewrite) to 0.
...
an [`innodb_flush_method`](innodb-parameters.html#sysvar_innodb_flush_method) setting of

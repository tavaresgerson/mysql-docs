...
* If the table has a foreign key relationship,
  ...
  [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") does not enforce foreign key
...
* If the table was created in an external directory by
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") to view the
...
* If a `ROW_FORMAT` option is not defined
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") to check
  the table definition. Use [`SHOW
  VARIABLES`](show-variables.html "13.7.5.39 SHOW VARIABLES Statement") to check the
  [`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
1. On the destination instance, create a table with the same
   ...
   CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") syntax.) If the table definition does
...
5. On the source instance, use
   [`UNLOCK
   TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") to release the locks acquired by the
   [`FLUSH
   ...
   The [`UNLOCK
   TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") operation also removes the
   `.cfg` file.
...
1. On the destination instance, create a partitioned table with
   ...
   [`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") syntax.) If
...
5. On the source instance, use
   [`UNLOCK
   TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") to release the locks acquired by
   [`FLUSH
...
1. On the destination instance, create a partitioned table with
   ...
   TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") syntax.) If the table definition does not
...
2. On the destination instance, discard the partitions that you
   ...
   When [`ALTER
   TABLE ... DISCARD PARTITION ... TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") is
...
6. On the destination instance, import table partitions
   ...
   When [`ALTER
   TABLE ... IMPORT PARTITION ... TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") is run
...
* [`FLUSH
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") to rebuild the
...
* [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") does not require a
...
* On Windows, `InnoDB` stores database,
  ...
  [`lower_case_table_names=1`](server-system-variables.html#sysvar_lower_case_table_names) to
...
* When running
  [`ALTER TABLE ...
  DISCARD PARTITION ... TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") and
  [`ALTER TABLE ...
  IMPORT PARTITION ... TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") on subpartitioned
...
When [`ALTER TABLE
... DISCARD TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") is run on the destination
instance:
...
When [`UNLOCK
TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") is run on the source instance:
...
When [`ALTER TABLE
... IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") is run on the destination

...
* “[`INSERT`](insert.html "13.2.5 INSERT Statement")-like”
  statements

  All statements that generate new rows in a table, including
  [`INSERT`](insert.html "13.2.5 INSERT Statement"),
  [`INSERT ...
  SELECT`](insert-select.html "13.2.5.1 INSERT ... SELECT Statement"), [`REPLACE`](replace.html "13.2.8 REPLACE Statement"),
  [`REPLACE ...
  SELECT`](replace.html "13.2.8 REPLACE Statement"), and [`LOAD
  DATA`](load-data.html "13.2.6 LOAD DATA Statement"). Includes “simple-inserts”,
...
* “Simple inserts”
  ...
  [`REPLACE`](replace.html "13.2.8 REPLACE Statement") statements that do
  not have a nested subquery, but not
  [`INSERT
  ... ON DUPLICATE KEY UPDATE`](insert-on-duplicate.html "13.2.5.2 INSERT ... ON DUPLICATE KEY UPDATE Statement").
...
* “Bulk inserts”
  ...
  [`REPLACE ...
  SELECT`](replace.html "13.2.8 REPLACE Statement"), and [`LOAD
  DATA`](load-data.html "13.2.6 LOAD DATA Statement") statements, but not plain
...
* “Mixed-mode inserts”
  ...
  [`INSERT
  ... ON DUPLICATE KEY UPDATE`](insert-on-duplicate.html "13.2.5.2 INSERT ... ON DUPLICATE KEY UPDATE Statement"), which in the worst
  case is in effect an [`INSERT`](insert.html "13.2.5 INSERT Statement")
  followed by a [`UPDATE`](update.html "13.2.11 UPDATE Statement"), where
...
* `innodb_autoinc_lock_mode = 0`
  ...
  sequence of [`INSERT`](insert.html "13.2.5 INSERT Statement")
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements is
  deterministic, and the replica reproduces the same data as
  on the source. If auto-increment values generated by
  multiple [`INSERT`](insert.html "13.2.5 INSERT Statement") statements
  were interleaved, the result of two concurrent
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements would be
  ...
  using an
  [`INSERT ...
  SELECT`](insert-select.html "13.2.5.1 INSERT ... SELECT Statement") statement that inserts 1000 rows, and
  another is using a simple
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement that inserts
  one row:
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") in the
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement in Tx1, and
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement referring to
  ...
  the Tx1
  [`INSERT ...
  SELECT`](insert-select.html "13.2.5.1 INSERT ... SELECT Statement") statement are consecutive, and the (single)
  auto-increment value used by the
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statement in Tx2 is
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements using
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") in Tx2 depends on
  precisely when the statement executes. If the
  [`INSERT`](insert.html "13.2.5 INSERT Statement") of Tx2 executes while
  the [`INSERT`](insert.html "13.2.5 INSERT Statement") of Tx1 is running
  (rather than before it starts or after it completes), the
  specific auto-increment values assigned by the two
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements are
...
* `innodb_autoinc_lock_mode = 1`
  ...
  [`REPLACE ...
  SELECT`](replace.html "13.2.8 REPLACE Statement"), and [`LOAD
  DATA`](load-data.html "13.2.6 LOAD DATA Statement") statements. Only one statement holding the
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements where the
...
* Modifying `AUTO_INCREMENT` column values in
  ...
  of a sequence of [`INSERT`](insert.html "13.2.5 INSERT Statement")
  statements could lead to “Duplicate entry”
  errors. For example, if you perform an
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") operation that changes
  an `AUTO_INCREMENT` column value to a value
  larger than the current maximum auto-increment value,
  subsequent [`INSERT`](insert.html "13.2.5 INSERT Statement") operations
...
If a [`SHOW TABLE STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement") statement
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") to the table, as described
earlier.

A server restart also cancels the effect of the
`AUTO_INCREMENT = N`
table option in [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") and
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statements, which you

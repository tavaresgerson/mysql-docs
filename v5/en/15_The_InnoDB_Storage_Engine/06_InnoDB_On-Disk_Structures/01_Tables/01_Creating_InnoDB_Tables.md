...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement is to be
...
[`CREATE TABLE ...
TABLESPACE`](create-table.html "13.1.18 CREATE TABLE Statement") syntax. For more information, see
...
[.frm files](glossary.html#glos_frm_file ".frm file") in database
...
dictionary. You cannot move `InnoDB` tables
between databases simply by moving the `.frm`
files. For information about moving `InnoDB`
tables, see [Section 14.6.1.4, “Moving or Copying InnoDB Tables”](innodb-migration.html "14.6.1.4 Moving or Copying InnoDB Tables").
...
in the [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement. If
you create the table, load data, and then run
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") to add a primary key
...
keys, see [Section 14.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "14.6.2.1 Clustered and Secondary Indexes").

##### Viewing InnoDB Table Properties

To view the properties of an `InnoDB` table,
issue a [`SHOW TABLE STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement")
statement:
...
STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement") output, see

...
[`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") data types in your tables,
...
TABLE`](rename-table.html "13.1.33 RENAME TABLE Statement") statement:
...
2. Issue this [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement
...
4. Issue this [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement
   ...
   The [`ALTER TABLE
   ... IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") feature does not enforce
...
* [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") has flushed all modified pages of the
  `.ibd` file from the buffer pool to the file.

You can make a clean backup `.ibd` file using the
following method:

1. Stop all activity from the [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server and
   commit all transactions.

2. Wait until [`SHOW
   ENGINE INNODB STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement") shows that there are no active
...
2. Start a second [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server on the backup
   and let it clean up the `.ibd` files in the
   backup.

##### Restoring from a Logical Backup

You can use a utility such as [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to

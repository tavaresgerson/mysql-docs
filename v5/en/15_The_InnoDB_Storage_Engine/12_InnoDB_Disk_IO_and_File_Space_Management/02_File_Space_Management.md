...
created using [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement")
...
issuing a [`SHOW TABLE STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement")
...
The maximum row length is slightly less than half a database
page for 4KB, 8KB, 16KB, and 32KB
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) settings. For
example, the maximum row length is slightly less than 8KB for
the default 16KB `InnoDB` page size. For 64KB
pages, the maximum row length is slightly less than 16KB.
...
* *COMPACT and REDUNDANT Row Formats*
  ...
  stored. See [Section 14.11, “InnoDB Row Formats”](innodb-row-format.html "14.11 InnoDB Row Formats").
...
* *DYNAMIC and COMPRESSED Row Formats*
  ...
  overflow pages. See [Section 14.11, “InnoDB Row Formats”](innodb-row-format.html "14.11 InnoDB Row Formats").

[`LONGBLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`LONGTEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns
must be less than 4GB, and the total row length, including
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns, must be less than
4GB.
...
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) must be set
to `Barracuda`. You can set these parameters in
...
and [`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) options
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement to create a
...
* When creating a compressed table in a file-per-table
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns, because such
  ...
  [Section 14.9.1.5, “How Compression Works for InnoDB Tables”](innodb-compression-internals.html "14.9.1.5 How Compression Works for InnoDB Tables"). For general
...
* All indexes of a table (including the
  ...
  TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") statement).

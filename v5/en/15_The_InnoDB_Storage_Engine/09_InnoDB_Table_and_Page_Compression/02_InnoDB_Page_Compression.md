...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). Supported compression
...
size. For example, if
[`innodb_page_size=16K`](innodb-parameters.html#sysvar_innodb_page_size) and the file
...
<table frame="all" summary="Windows NTFS cluster size and compression units."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Cluster Size</th>
...
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) is also 64KB.

For page compression to work on Windows, the file system must be
created with a cluster size smaller than 4K, and the
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) must be at least
...
[`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) value of 16K or
greater.
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. However,
[`ALTER TABLE ...
COMPRESSION`](alter-table.html "13.1.8 ALTER TABLE Statement") only updates the tablespace compression
...
table using [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement").
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). Writes to the
...
table using [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") after
...
[`INNODB_SYS_TABLESPACES`](information-schema-innodb-sys-tablespaces-table.html "24.4.24 The INFORMATION_SCHEMA INNODB_SYS_TABLESPACES Table") table, in the
following columns:
...
Use [`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") to view the
...
query the Information Schema [`TABLES`](information-schema-tables-table.html "24.3.25 The INFORMATION_SCHEMA TABLES Table")
...
[`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") also shows the
...
* Before downgrading to an earlier version of MySQL that does
  ...
  [`ALTER TABLE ...
  COMPRESSION=None`](alter-table.html "13.1.8 ALTER TABLE Statement") and [`OPTIMIZE
  TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement").

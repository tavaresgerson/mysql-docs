...
`my.ini`) or modify it at runtime using a
[`SET
GLOBAL`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") statement, which requires privileges sufficient
...
[`innodb_io_capacity`](innodb-parameters.html#sysvar_innodb_io_capacity) or 2000,

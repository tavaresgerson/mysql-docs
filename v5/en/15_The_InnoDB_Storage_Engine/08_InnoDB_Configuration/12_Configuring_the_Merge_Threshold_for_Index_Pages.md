...
clause with [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"):
...
clause with [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement"),
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"), or
[`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"), as shown in the
following examples:

* Setting `MERGE_THRESHOLD` for an individual
  index using [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement"):
...
* Setting `MERGE_THRESHOLD` for an individual
  index using [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"):
...
* Setting `MERGE_THRESHOLD` for an individual
  index using [`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"):
...
[`INNODB_SYS_INDEXES`](information-schema-innodb-sys-indexes-table.html "24.4.22 The INFORMATION_SCHEMA INNODB_SYS_INDEXES Table") table. For
example:
...
You can use [`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") to
...
Likewise, you can use [`SHOW INDEX`](show-index.html "13.7.5.22 SHOW INDEX Statement") to
...
The [`INNODB_METRICS`](information-schema-innodb-metrics-table.html "24.4.16 The INFORMATION_SCHEMA INNODB_METRICS Table") table provides two
...
[`INNODB_METRICS`](information-schema-innodb-metrics-table.html "24.4.16 The INFORMATION_SCHEMA INNODB_METRICS Table") counters, see

...
[14.8.11.1 Configuring Persistent Optimizer Statistics Parameters](innodb-persistent-stats.html)

[14.8.11.2 Configuring Non-Persistent Optimizer Statistics Parameters](innodb-statistics-estimation.html)

[14.8.11.3 Estimating ANALYZE TABLE Complexity for InnoDB Tables](innodb-analyze-table-complexity.html)
...
[plan stability](glossary.html#glos_plan_stability "plan stability") and more
...
([`innodb_stats_persistent=ON`](innodb-parameters.html#sysvar_innodb_stats_persistent)).
...
[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") complexity, which may
be useful when attempting to achieve a balance between accurate
statistics and [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement")
execution time.
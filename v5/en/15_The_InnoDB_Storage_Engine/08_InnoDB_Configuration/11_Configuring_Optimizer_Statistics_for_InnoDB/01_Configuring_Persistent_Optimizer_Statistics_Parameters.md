...
[`STATS_PERSISTENT=1`](create-table.html "13.1.18 CREATE TABLE Statement").
...
immediately, run [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement")
...
TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") statement after making substantial changes to
indexed columns. You might also consider adding
[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") to setup scripts
that you run after loading data, and running
[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") on a schedule at
...
* `STATS_PERSISTENT` specifies whether to
  ...
  [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") to calculate
...
* `STATS_AUTO_RECALC` specifies whether to
  ...
  [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") to
...
* `STATS_SAMPLE_PAGES` specifies the number
  ...
  [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") operation,
  for example.

All three clauses are specified in the following
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") example:
...
TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") cause `InnoDB` to sample
...
1. *Statistics are not accurate enough and the
   ...
   [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output. You can
   check the accuracy of statistics by comparing the actual
   cardinality of an index (determined by running
   [`SELECT
   DISTINCT`](select.html "13.2.9 SELECT Statement") on the index columns) with the
   estimates in the
   ...
   [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") to run
   slowly.

2. *[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") is
   too slow*. In this case
   [`innodb_stats_persistent_sample_pages`](innodb-parameters.html#sysvar_innodb_stats_persistent_sample_pages)
   should be decreased until [`ANALYZE
   TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") execution time is acceptable. Decreasing
   ...
   TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") execution time, consider decreasing the
   number of indexed columns in the table or limiting the
   number of partitions to reduce
   [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") complexity.
...
<td><code>last_update</code></td>
<td>A timestamp indicating the last time that <code>InnoDB</code>
                updated this row</td>
</tr><tr>
<td><code>stat_name</code></td>
<td>The name of the statistic, whose value is reported in the
                <code>stat_value</code> column</td>
</tr><tr>
<td><code>stat_value</code></td>
<td>The value of the statistic that is named in <code>stat_name</code>
                column</td>
</tr><tr>
...
place. If you run [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement")
to initiate a synchronous recalculation of statistics, this
statement is replicated (unless you suppressed logging for
it), and recalculation takes place on the replicas.
...
[`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") (if
[`innodb_stats_auto_recalc`](innodb-parameters.html#sysvar_innodb_stats_auto_recalc) is

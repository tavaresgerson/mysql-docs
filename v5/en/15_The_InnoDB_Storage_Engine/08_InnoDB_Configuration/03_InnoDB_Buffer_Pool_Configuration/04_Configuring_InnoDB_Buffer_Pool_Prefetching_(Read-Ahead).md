...
A [read-ahead](glossary.html#glos_read_ahead "read-ahead") request is
an I/O request to prefetch multiple pages in the
[buffer pool](glossary.html#glos_buffer_pool "buffer pool")
asynchronously, in anticipation that these pages are needed
...
[`innodb_read_ahead_threshold`](innodb-parameters.html#sysvar_innodb_read_ahead_threshold) can
...
MySQL [configuration
file](glossary.html#glos_configuration_file "configuration file"), or change it dynamically with the
[`SET
...
[`innodb_random_read_ahead`](innodb-parameters.html#sysvar_innodb_random_read_ahead) to
`ON`.
...
[Section 8.5.8, “Optimizing InnoDB Disk I/O”](optimizing-innodb-diskio.html "8.5.8 Optimizing InnoDB Disk I/O") and

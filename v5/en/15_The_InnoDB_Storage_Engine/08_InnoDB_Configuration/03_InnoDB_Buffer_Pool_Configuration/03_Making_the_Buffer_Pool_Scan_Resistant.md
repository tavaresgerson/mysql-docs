...
LRU algorithm, see [Section 14.5.1, “Buffer Pool”](innodb-buffer-pool.html "14.5.1 Buffer Pool").
...
[`SET
GLOBAL`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") statement. Changing the value at runtime

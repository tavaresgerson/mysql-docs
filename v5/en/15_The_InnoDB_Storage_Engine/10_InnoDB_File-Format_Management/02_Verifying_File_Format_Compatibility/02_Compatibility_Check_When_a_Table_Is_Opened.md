...
when tables using a “too new” data structure are
encountered.
...
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) can prevent
...
Users are *strongly* urged not to use

...
(i.e., [`innodb_fast_shutdown`](innodb-parameters.html#sysvar_innodb_fast_shutdown) is
...
[`innodb_file_format_check`](innodb-parameters.html#sysvar_innodb_file_format_check), which
is `ON` by default.
...
[`innodb_file_format_check`](innodb-parameters.html#sysvar_innodb_file_format_check) is
...
You can also set
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) to a file
...
[`innodb_file_format_check`](innodb-parameters.html#sysvar_innodb_file_format_check) to
...
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) (which

...
[14.10.2.1 Compatibility Check When InnoDB Is Started](innodb-file-format-compatibility-checking.html)

[14.10.2.2 Compatibility Check When a Table Is Opened](innodb-file-format-compatibility-checking-table-access.html)
...
(In many cases, the [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
`*.ibd` file, support both Antelope and Barracuda
...
the term “ib-file set” to mean the set of operating
...
in a single “ib-file set”. (In MySQL, a
“database” is a logical collection of tables, what
other systems refer to as a “schema” or
“catalog”.)
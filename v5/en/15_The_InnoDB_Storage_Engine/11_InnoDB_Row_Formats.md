...
<table summary="Overview of InnoDB row formats incuding a description, supported features, and supported tablespace types."><col style="width: 10%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><thead><tr>
<th>Row Format</th>
...
* [REDUNDANT Row Format](innodb-row-format.html#innodb-row-format-redundant "REDUNDANT Row Format")
* [COMPACT Row Format](innodb-row-format.html#innodb-row-format-compact "COMPACT Row Format")
* [DYNAMIC Row Format](innodb-row-format.html#innodb-row-format-dynamic "DYNAMIC Row Format")
* [COMPRESSED Row Format](innodb-row-format.html#innodb-row-format-compressed "COMPRESSED Row Format")
* [Defining the Row Format of a Table](innodb-row-format.html#innodb-row-format-defining "Defining the Row Format of a Table")
* [Determining the Row Format of a Table](innodb-row-format.html#innodb-row-format-detrmining "Determining the Row Format of a Table")
...
The `REDUNDANT` row format is supported by both
`InnoDB` file formats
(`Antelope` and `Barracuda`).
For more information, see [Section 14.10, “InnoDB File-Format Management”](innodb-file-format.html "14.10 InnoDB File-Format Management").
...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") types) in the index record
...
* Internally, fixed-length character columns such as
  [`CHAR(10)`](char.html "11.3.2 The CHAR and VARCHAR Types") are stored in
...
The `COMPACT` row format is supported by both
`InnoDB` file formats
(`Antelope` and `Barracuda`).
For more information, see [Section 14.10, “InnoDB File-Format Management”](innodb-file-format.html "14.10 InnoDB File-Format Management").
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") types) in the index record
within the [B-tree](glossary.html#glos_b_tree "B-tree") node, with
...
* Internally, for nonvariable-length character sets,
  ...
  [`CHAR(10)`](char.html "11.3.2 The CHAR and VARCHAR Types") are stored in a
  fixed-length format.
...
* Internally, for variable-length character sets such as
  ...
  [`CHAR(N)`](char.html "11.3.2 The CHAR and VARCHAR Types")
...
row format. See [Section 14.10, “InnoDB File-Format Management”](innodb-file-format.html "14.10 InnoDB File-Format Management").
...
[`VARBINARY`](binary-varbinary.html "11.3.3 The BINARY and VARBINARY Types"), and
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") types) fully off-page, with
...
record fits on the [B-tree](glossary.html#glos_b_tree "B-tree") page.
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") columns that are less than or
...
[`innodb_large_prefix`](innodb-parameters.html#sysvar_innodb_large_prefix) variable,
...
[`innodb_file_per_table`](innodb-parameters.html#sysvar_innodb_file_per_table) and use a
...
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) variables are
not applicable to general tablespaces, nor are they applicable
when using the `TABLESPACE [=] innodb_system`
table option to store `DYNAMIC` tables in the
system tablespace.
...
characteristics, see
[COMPACT Row Format Storage Characteristics](innodb-row-format.html#innodb-compact-row-format-characteristics "COMPACT Row Format Storage Characteristics").
...
`COMPRESSED` row format, see
[Section 14.9, “InnoDB Table and Page Compression”](innodb-compression.html "14.9 InnoDB Table and Page Compression").
...
tablespace, the
[`innodb_file_per_table`](innodb-parameters.html#sysvar_innodb_file_per_table) variable
must be enabled and
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) must be set to
`Barracuda`. The
[`innodb_file_per_table`](innodb-parameters.html#sysvar_innodb_file_per_table) and
[`innodb_file_format`](innodb-parameters.html#sysvar_innodb_file_format) variables are
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. For example:
...
Valid [`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") or
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. Attempting
to set the
[`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
following [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements
...
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") operations that use
`ALGORITHM=COPY` or
`ALGORITHM=INPLACE` where table rebuilding is
required. See [Section 14.13.1, “Online DDL Operations”](innodb-online-ddl-operations.html "14.13.1 Online DDL Operations") for
more information. [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is
...
* The `REDUNDANT` and
  ...
  For related information, see [Section 14.23, “InnoDB Limits”](innodb-limits.html "14.23 InnoDB Limits").
...
[`INNODB_SYS_TABLES`](information-schema-innodb-sys-tables-table.html "24.4.23 The INFORMATION_SCHEMA INNODB_SYS_TABLES Table") table:

...
[download site](https://dev.mysql.com/downloads/shell). See
the [MySQL Shell 8.0](/doc/mysql-shell/8.0/en/) documentation for the latest
...
* The [Section 19.1, “Key Concepts”](document-store-concepts.html "19.1 Key Concepts") section covers
  concepts like Document, Collection, Session, and Schema to help
  you understand how to use MySQL as a document store.

* The [Section 19.2, “Setting Up MySQL as a Document Store”](document-store-setting-up.html "19.2 Setting Up MySQL as a Document Store") section explains
...
* [MySQL Shell 8.0](/doc/mysql-shell/8.0/en/) provides more detailed information

...
You can increase the size of an `NDB` blob column's blob part to the maximum of 13948 using `NDB_COLUMN` in a column comment when creating or altering the parent table. See NDB_COLUMN Options, for more information.

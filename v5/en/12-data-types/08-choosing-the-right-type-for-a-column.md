...
All basic calculations (`+`, `-`, `*`, and `/`) with `DECIMAL` - DECIMAL, NUMERIC") columns are done with precision of 65 decimal (base 10) digits. See Section 11.1.1, “Numeric Data Type Syntax”.

...
[`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") for
`MyISAM` tables is similar to using
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") for repair operations, and some of
the same performance optimizations apply:

* [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") has variables that control
...
* For [`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement"), the same
  principle applies, but because the repair is done by the
  server, you set server system variables instead of
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") variables. Also, in addition to
...
Suppose that a [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") table-repair
...
Some of those [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") variables correspond
...
<th><strong>myisamchk</strong> Variable</th>
...
example, if you set the [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
...
TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") operation can be done as follows to use settings
similar to the [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") command. Here a
...
TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") operation to minimally affect other users, save
...
TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") can be set globally at server startup if you

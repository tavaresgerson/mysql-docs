...
* To help MySQL better optimize queries, use
  [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement") or run
  [**myisamchk --analyze**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") on a table after it
  ...
  --description --verbose**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") shows index distribution
  information.

* To sort an index and data according to an index, use
  [**myisamchk --sort-index --sort-records=1**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")
...
* Try to avoid complex [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* `MyISAM` supports concurrent inserts: If a
  ...
  can [`INSERT`](insert.html "13.2.5 INSERT Statement") new rows into it
  ...
  TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") to defragment the table after you have
  ...
  See [Section 8.11.3, “Concurrent Inserts”](concurrent-inserts.html "8.11.3 Concurrent Inserts").
...
* For `MyISAM` tables that change frequently,
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types")). The table uses dynamic
  row format if it includes even a single variable-length
  column. See [Chapter 15, *Alternative Storage Engines*](storage-engines.html "Chapter 15 Alternative Storage Engines").
...
* It is normally not useful to split a table into different
  ...
  columns. See [Chapter 15, *Alternative Storage Engines*](storage-engines.html "Chapter 15 Alternative Storage Engines").
...
* Use [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement")
...
* Declaring a `MyISAM` table with the
  ...
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") before restarting the server.
...
* You can increase performance by caching queries or answers
  ...
  updates. You can also take advantage of MySQL's query
  cache to achieve similar results; see

...
using the [`LOCK TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") statement,
...
* [Performance Considerations Favoring InnoDB](table-locking.html#table-locking-innodb "Performance Considerations Favoring InnoDB")
* [Workarounds for Locking Performance Issues](table-locking.html#table-locking-workarounds "Workarounds for Locking Performance Issues")
...
* A [`SELECT`](select.html "13.2.9 SELECT Statement") statement that
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statements queue up
...
* Consider switching the table to the
  ...
  [Chapter 14, *The InnoDB Storage Engine*](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") for more details
  about this storage engine.

* Optimize [`SELECT`](select.html "13.2.9 SELECT Statement") statements
  to run faster so that they lock tables for a shorter time.
  You might have to create some summary tables to do this.

* Start [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with
  [`--low-priority-updates`](server-system-variables.html#sysvar_low_priority_updates). For
  storage engines that use only table-level locking (such as
  `MyISAM`, `MEMORY`, and
  `MERGE`), this gives all statements that
  update (modify) a table lower priority than
  [`SELECT`](select.html "13.2.9 SELECT Statement") statements. In this
  case, the second [`SELECT`](select.html "13.2.9 SELECT Statement")
  statement in the preceding scenario would execute before
  the [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement, and
  would not wait for the first
  [`SELECT`](select.html "13.2.9 SELECT Statement") to finish.
...
* To give a specific [`INSERT`](insert.html "13.2.5 INSERT Statement"),
  [`UPDATE`](update.html "13.2.11 UPDATE Statement"), or
  [`DELETE`](delete.html "13.2.2 DELETE Statement") statement lower
  priority, use the `LOW_PRIORITY`
  attribute.

* To give a specific [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* Start [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") with a low value for the
  ...
  priority of all [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* If you have problems with mixed
  ...
  [`DELETE`](delete.html "13.2.2 DELETE Statement") statements, the
  `LIMIT` option to
  [`DELETE`](delete.html "13.2.2 DELETE Statement") may help. See
  [Section 13.2.2, “DELETE Statement”](delete.html "13.2.2 DELETE Statement").

* Using `SQL_BUFFER_RESULT` with
  [`SELECT`](select.html "13.2.9 SELECT Statement") statements can help

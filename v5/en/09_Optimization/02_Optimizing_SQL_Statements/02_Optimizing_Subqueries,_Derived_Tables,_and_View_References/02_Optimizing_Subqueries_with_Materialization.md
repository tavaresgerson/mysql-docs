...
[Section 8.9.2, “Switchable Optimizations”](switchable-optimizations.html "8.9.2 Switchable Optimizations").) With the
...
Use of [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") with a query
...
* For extended [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement")
  output, the text displayed by a following
  [`SHOW WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement") includes
  `materialize` and

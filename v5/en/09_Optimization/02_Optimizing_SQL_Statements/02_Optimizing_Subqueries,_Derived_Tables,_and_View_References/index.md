...
[8.2.2.1 Optimizing Subqueries, Derived Tables, and View References with Semijoin Transformations](semijoins.html)

[8.2.2.2 Optimizing Subqueries with Materialization](subquery-materialization.html)

[8.2.2.3 Optimizing Subqueries with the EXISTS Strategy](subquery-optimization-with-exists.html)

[8.2.2.4 Optimizing Derived Tables and View References with Merging or Materialization](derived-table-optimization.html)
...
A limitation on [`UPDATE`](update.html "13.2.11 UPDATE Statement") and
[`DELETE`](delete.html "13.2.2 DELETE Statement") statements that use a

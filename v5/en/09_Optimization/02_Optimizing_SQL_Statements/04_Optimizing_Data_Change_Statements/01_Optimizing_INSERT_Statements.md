...
* If you are inserting many rows from the same client at the
  same time, use [`INSERT`](insert.html "13.2.5 INSERT Statement")
  ...
  separate single-row [`INSERT`](insert.html "13.2.5 INSERT Statement")
...
* When loading a table from a text file, use
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement"). This is usually
  20 times faster than using
  [`INSERT`](insert.html "13.2.5 INSERT Statement") statements. See
...
* See [Section 8.5.5, “Bulk Data Loading for InnoDB Tables”](optimizing-innodb-bulk-data-loading.html "8.5.5 Bulk Data Loading for InnoDB Tables")
  for tips specific to `InnoDB` tables.

* See [Section 8.6.2, “Bulk Data Loading for MyISAM Tables”](optimizing-myisam-bulk-data-loading.html "8.6.2 Bulk Data Loading for MyISAM Tables")

...
a [`UNION`](union.html "13.2.9.3 UNION Clause") with identical
[`SELECT`](select.html "13.2.9 SELECT Statement") statements, except
...
* If conditions that cover sets of rows contained within
  ...
  the [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output
...
* For [`UPDATE`](update.html "13.2.11 UPDATE Statement") and
  [`DELETE`](delete.html "13.2.2 DELETE Statement") statements, if the
...
with [`OR`](logical-operators.html#operator_or) was higher,

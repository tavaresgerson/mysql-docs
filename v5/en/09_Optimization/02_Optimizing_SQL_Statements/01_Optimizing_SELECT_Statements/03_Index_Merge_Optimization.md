...
In [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output, the Index
...
[`index_merge_sort_union`](switchable-optimizations.html#optflag_index-merge-sort-union) flags
of the [`optimizer_switch`](server-system-variables.html#sysvar_optimizer_switch)
system variable. See
[Section 8.9.2, “Switchable Optimizations”](switchable-optimizations.html "8.9.2 Switchable Optimizations"). By default, all
those flags are `on`. To enable only certain
algorithms, set [`index_merge`](switchable-optimizations.html#optflag_index-merge)
to `off`, and enable only such of the others

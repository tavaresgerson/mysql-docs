...
only by the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine.
...
of [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement"):
...
be used with either of these two queries:
...
`b` is indirect. (However, engine condition
...
* `column [NOT] LIKE
  ...
  *`pattern`* must be a string
  ...
  see [Section 12.8.1, “String Comparison Functions and Operators”](string-comparison-functions.html "12.8.1 String Comparison Functions and Operators").
...
* Columns used in comparisons cannot be of any of the
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") types. This exclusion
  extends to [`JSON`](json.html "11.5 The JSON Data Type"),
  [`BIT`](bit-type.html "11.1.5 Bit-Value Type - BIT"), and
  [`ENUM`](enum.html "11.3.5 The ENUM Type") columns as well.
...
* Joins are not directly supported; conditions involving
  ...
  extended [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output to

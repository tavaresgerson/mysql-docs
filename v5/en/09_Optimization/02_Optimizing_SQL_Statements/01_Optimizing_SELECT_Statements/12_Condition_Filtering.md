...
In [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output, the
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") produces output like
this:
...
result, [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") produces output
like this:
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement"): To provide more
...
system variable (see
[Section 8.9.2, “Switchable Optimizations”](switchable-optimizations.html "8.9.2 Switchable Optimizations")). This flag is

...
[8.2.1.1 WHERE Clause Optimization](where-optimization.html)

[8.2.1.2 Range Optimization](range-optimization.html)

[8.2.1.3 Index Merge Optimization](index-merge-optimization.html)

[8.2.1.4 Engine Condition Pushdown Optimization](engine-condition-pushdown-optimization.html)

[8.2.1.5 Index Condition Pushdown Optimization](index-condition-pushdown-optimization.html)

[8.2.1.6 Nested-Loop Join Algorithms](nested-loop-joins.html)

[8.2.1.7 Nested Join Optimization](nested-join-optimization.html)

[8.2.1.8 Outer Join Optimization](outer-join-optimization.html)

[8.2.1.9 Outer Join Simplification](outer-join-simplification.html)

[8.2.1.10 Multi-Range Read Optimization](mrr-optimization.html)

[8.2.1.11 Block Nested-Loop and Batched Key Access Joins](bnl-bka-optimization.html)

[8.2.1.12 Condition Filtering](condition-filtering.html)

[8.2.1.13 IS NULL Optimization](is-null-optimization.html)

[8.2.1.14 ORDER BY Optimization](order-by-optimization.html)

[8.2.1.15 GROUP BY Optimization](group-by-optimization.html)

[8.2.1.16 DISTINCT Optimization](distinct-optimization.html)

[8.2.1.17 LIMIT Query Optimization](limit-optimization.html)

[8.2.1.18 Function Call Optimization](function-optimization.html)

[8.2.1.19 Row Constructor Expression Optimization](row-constructor-optimization.html)

[8.2.1.20 Avoiding Full Table Scans](table-scan-avoidance.html)

Queries, in the form of [`SELECT`](select.html "13.2.9 SELECT Statement")
...
Besides [`SELECT`](select.html "13.2.9 SELECT Statement") statements, the
tuning techniques for queries also apply to constructs such as
[`CREATE
TABLE...AS SELECT`](create-table-select.html "13.1.18.4 CREATE TABLE ... SELECT Statement"),
[`INSERT
INTO...SELECT`](insert-select.html "13.2.5.1 INSERT ... SELECT Statement"), and `WHERE` clauses in
[`DELETE`](delete.html "13.2.2 DELETE Statement") statements. Those
...
[Conditions for NDB pushdown joins](mysql-cluster-options-variables.html#ndb_join_pushdown-conditions "Conditions for NDB pushdown joins").

The main considerations for optimizing queries are:

* To make a slow `SELECT ... WHERE` query
  faster, the first thing to check is whether you can add an
  [index](glossary.html#glos_index "index"). Set up indexes on
  ...
  [joins](glossary.html#glos_join "join") and
  [foreign keys](glossary.html#glos_foreign_key "foreign key"). You
  can use the [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") statement
  to determine which indexes are used for a
  [`SELECT`](select.html "13.2.9 SELECT Statement"). See
  [Section 8.3.1, “How MySQL Uses Indexes”](mysql-indexes.html "8.3.1 How MySQL Uses Indexes") and
...
* Minimize the number of
  [full table scans](glossary.html#glos_full_table_scan "full table scan")
...
* Learn the tuning techniques, indexing techniques, and
  ...
  details, see [Section 8.5.6, “Optimizing InnoDB Queries”](optimizing-innodb-queries.html "8.5.6 Optimizing InnoDB Queries") and
...
* If a performance issue is not easily solved by one of the
  ...
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") plan and adjusting
  your indexes, `WHERE` clauses, join
  clauses, and so on. (When you reach a certain level of
  expertise, reading the
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") plan might be your

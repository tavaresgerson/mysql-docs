...
[`TABLES`](information-schema-tables-table.html "24.3.25 The INFORMATION_SCHEMA TABLES Table"), using a constant lookup
value for `TABLE_SCHEMA` in the
`WHERE` clause enables a data directory scan to
be avoided.

<table summary="INFORMATION_SCHEMA tables and table columns for which a constant lookup value enables the server to avoid directory scans."><col style="width: 34%"/><col style="width: 33%"/><col style="width: 33%"/><thead><tr>
<th>Table</th>
...
* [`COLUMNS`](information-schema-columns-table.html "24.3.5 The INFORMATION_SCHEMA COLUMNS Table"):
  `OPEN_FRM_ONLY` applies to all columns

* [`KEY_COLUMN_USAGE`](information-schema-key-column-usage-table.html "24.3.12 The INFORMATION_SCHEMA KEY_COLUMN_USAGE Table"):
  `OPEN_FULL_TABLE` applies to all columns

* [`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table"):
  `OPEN_FULL_TABLE` applies to all columns

* [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "24.3.20 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table"):
  `OPEN_FULL_TABLE` applies to all columns

* [`STATISTICS`](information-schema-statistics-table.html "24.3.24 The INFORMATION_SCHEMA STATISTICS Table"):

  <table summary="Optimization types that apply to INFORMATION_SCHEMA STATISTICS table columns."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Column</th>
...
* [`TABLES`](information-schema-tables-table.html "24.3.25 The INFORMATION_SCHEMA TABLES Table"):

  <table summary="Optimization types that apply to INFORMATION_SCHEMA TABLES table columns."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Column</th>
<th>Optimization type</th>
</tr></thead><tbody><tr>
<td><code>TABLE_CATALOG</code></td>
...
* [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "24.3.27 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table"):
  `OPEN_FULL_TABLE` applies to all columns

* [`TRIGGERS`](information-schema-triggers-table.html "24.3.29 The INFORMATION_SCHEMA TRIGGERS Table"):
  `OPEN_TRIGGER_ONLY` applies to all columns

* [`VIEWS`](information-schema-views-table.html "24.3.31 The INFORMATION_SCHEMA VIEWS Table"):

  <table summary="Optimization types that apply to INFORMATION_SCHEMA VIEWS table columns."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Column</th>
<th>Optimization type</th>
</tr></thead><tbody><tr>
<td><code>TABLE_CATALOG</code></td>
...
**3) Use
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") to determine whether the
...
in [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output indicates
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") reports
...
respectively. [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") reports
...
For the first [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output row:
...
For the second [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output
row: All [`COLUMNS`](information-schema-columns-table.html "24.3.5 The INFORMATION_SCHEMA COLUMNS Table") table values are
...
[`COLLATIONS`](information-schema-collations-table.html "24.3.3 The INFORMATION_SCHEMA COLLATIONS Table") is not one of the

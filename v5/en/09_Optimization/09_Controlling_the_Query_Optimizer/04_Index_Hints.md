...
[Section 8.9.3, “Optimizer Hints”](optimizer-hints.html "8.9.3 Optimizer Hints"). Index and optimizer hints may
be used separately or together.

Index hints apply to [`SELECT`](select.html "13.2.9 SELECT Statement") and
[`UPDATE`](update.html "13.2.11 UPDATE Statement") statements. They also work
with multi-table [`DELETE`](delete.html "13.2.2 DELETE Statement")
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement, see
[Section 13.2.9.2, “JOIN Clause”](join.html "13.2.9.2 JOIN Clause").) The syntax for referring to an
...
if [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") shows that MySQL is
...
INDEX`](show-index.html "13.7.5.22 SHOW INDEX Statement") statement or the Information Schema
[`STATISTICS`](information-schema-statistics-table.html "24.3.24 The INFORMATION_SCHEMA STATISTICS Table") table.
...
Index hints work with [`DELETE`](delete.html "13.2.2 DELETE Statement")

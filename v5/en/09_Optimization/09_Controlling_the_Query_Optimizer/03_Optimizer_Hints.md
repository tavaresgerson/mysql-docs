...
variable (see [Section 8.9.2, “Switchable Optimizations”](switchable-optimizations.html "8.9.2 Switchable Optimizations")).
...
The [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client by default strips comments
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client with a version of the server
...
described in [Section 8.9.4, “Index Hints”](index-hints.html "8.9.4 Index Hints"). Optimizer and index
...
<th><code>SEMIJOIN</code>,
                <code>NO_SEMIJOIN</code></th>
<td>semijoin strategies</td>
<td>Query block</td>
</tr><tr>
<th><code>SUBQUERY</code></th>
<td>Affects materialization,
                <code>IN</code>-to-<code>EXISTS</code>
...
[Section 9.6, “Comments”](comments.html "9.6 Comments"). Optimizer hints must be specified
...
initial keyword of [`SELECT`](select.html "13.2.9 SELECT Statement"),
...
[`DELETE`](delete.html "13.2.2 DELETE Statement") statements. Hints are
...
* In hintable statements prefaced by
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement"). For example:
  ...
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") to see how
  optimizer hints affect execution plans. Use
  [`SHOW WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement") immediately
  after [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") to see how
  hints are used. The extended `EXPLAIN`
  output displayed by a following [`SHOW
  WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement") indicates which hints were used.
...
[Section 8.2.1.11, “Block Nested-Loop and Batched Key Access Joins”](bnl-bka-optimization.html "8.2.1.11 Block Nested-Loop and Batched Key Access Joins")). These hint types
...
* *`index_name`*: The name of an
  ...
  table, use [`SHOW INDEX`](show-index.html "13.7.5.22 SHOW INDEX Statement").
...
optimizations, see [Section 8.2.2, “Optimizing Subqueries, Derived Tables, and View References”](subquery-optimization.html "8.2.2 Optimizing Subqueries, Derived Tables, and View References").
...
is permitted only for [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* For statements with multiple `SELECT`
  ...
  first [`SELECT`](select.html "13.2.9 SELECT Statement").
...
* It does not apply to [`SELECT`](select.html "13.2.9 SELECT Statement")
...
Query block names are identifiers and follow the usual rules
about what names are valid and how to quote them (see
[Section 9.2, “Schema Object Names”](identifiers.html "9.2 Schema Object Names")). For example, a query block

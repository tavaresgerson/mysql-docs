...
hash index. On the [`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement")
...
[Section 8.2.1.20, “Avoiding Full Table Scans”](table-scan-avoidance.html "8.2.1.20 Avoiding Full Table Scans"). For implementation details

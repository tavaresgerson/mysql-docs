...
cache, use the [`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement")
statement (see [Section 13.7.6.2, “CACHE INDEX Statement”](cache-index.html "13.7.6.2 CACHE INDEX Statement")). For example,
...
INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") statement can be created by setting its size
with a [`SET
GLOBAL`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment") parameter setting statement or by using
...
component. See [Section 5.1.8.3, “Structured System Variables”](structured-system-variables.html "5.1.8.3 Structured System Variables"),
...
The [`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") statement sets
...
INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") statements to be executed. For example:

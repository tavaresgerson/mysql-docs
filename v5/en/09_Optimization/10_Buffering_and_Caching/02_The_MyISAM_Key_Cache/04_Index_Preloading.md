...
[`LOAD INDEX INTO
CACHE`](load-index.html "13.7.6.5 LOAD INDEX INTO CACHE Statement") statement. For example, the following
...
[`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") statement,

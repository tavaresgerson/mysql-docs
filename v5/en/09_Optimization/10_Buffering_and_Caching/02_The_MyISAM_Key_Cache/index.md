...
[8.10.2.1 Shared Key Cache Access](shared-key-cache.html)

[8.10.2.2 Multiple Key Caches](multiple-key-caches.html)

[8.10.2.3 Midpoint Insertion Strategy](midpoint-insertion.html)

[8.10.2.4 Index Preloading](index-preloading.html)

[8.10.2.5 Key Cache Block Size](key-cache-block-size.html)

[8.10.2.6 Restructuring a Key Cache](key-cache-restructuring.html)
...
[`key_buffer_size`](server-system-variables.html#sysvar_key_buffer_size) value is too

...
* Many DDL operations on tables and indexes
  ...
  See [Section 14.13, “InnoDB and Online DDL”](innodb-online-ddl.html "14.13 InnoDB and Online DDL") for details.
...
* Use [`TRUNCATE TABLE`](truncate-table.html "13.1.34 TRUNCATE TABLE Statement") to empty a
  ...
  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") might be
  fastest.
...
* Because the primary key is integral to the storage layout of
  ...
  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement, and

...
* In `InnoDB`, having a long `PRIMARY
  ...
  the same row. (See [Section 14.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "14.6.2.1 Clustered and Secondary Indexes").)
...
* Use the [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") data type
  instead of [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") to store

...
* The transaction is started with the
  [`START TRANSACTION
  READ ONLY`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") statement. In this case, attempting to
...
* The [`autocommit`](server-system-variables.html#sysvar_autocommit) setting is
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement. That is, a
...
ONLY`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") and
[`COMMIT`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements"), or by

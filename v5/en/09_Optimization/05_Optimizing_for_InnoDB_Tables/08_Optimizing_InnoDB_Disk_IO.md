...
* Increase buffer pool size
  ...
  information see, [Section 8.12.4.1, “How MySQL Uses Memory”](memory-use.html "8.12.4.1 How MySQL Uses Memory").
...
* Consider non-rotational storage
  ...
  [doublewrite
  buffering](glossary.html#glos_doublewrite_buffer "doublewrite buffer") and
  [change buffering](glossary.html#glos_change_buffer "change buffer"))
  and log files such as [binary
  log](glossary.html#glos_binary_log "binary log") files and [redo
...
* Lower I/O capacity if flushing does not fall behind
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "13.7.5.15 SHOW ENGINE Statement"):
...
* Store system tablespace files on Fusion-io devices
  ...
  ([`innodb_doublewrite`](innodb-parameters.html#sysvar_innodb_doublewrite)) is

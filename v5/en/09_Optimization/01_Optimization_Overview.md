...
* [Optimizing at the Database Level](optimize-overview.html#optimize-database-level "Optimizing at the Database Level")
* [Optimizing at the Hardware Level](optimize-overview.html#optimize-hardware-level "Optimizing at the Hardware Level")
* [Balancing Portability and Performance](optimize-overview.html#optimize-portability-performance "Balancing Portability and Performance")
...
* Are the right
  [indexes](optimization-indexes.html "8.3 Optimization and Indexes") in place
...
* Does the application use an appropriate
  [locking strategy](locking-issues.html "8.11 Optimizing Locking Operations")? For
...
* Are all [memory areas used
  for caching](buffering-caching.html "8.10 Buffering and Caching") sized correctly? That is, large enough to
  ...
  pool, the `MyISAM` key cache, and the MySQL
  query cache.
...
to avoid these
[bottlenecks](glossary.html#glos_bottleneck "bottleneck"), or whether
...
writing comments, see [Section 9.6, “Comments”](comments.html "9.6 Comments").
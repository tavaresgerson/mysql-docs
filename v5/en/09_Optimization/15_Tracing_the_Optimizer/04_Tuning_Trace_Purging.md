...
[`SET`](set.html "11.3.6 The SET Type") statement has the following
effects:

* All traces previously stored are cleared from memory.
* A subsequent [`SELECT`](select.html "13.2.9 SELECT Statement") from the
  [`OPTIMIZER_TRACE`](information-schema-optimizer-trace-table.html "24.3.14 The INFORMATION_SCHEMA OPTIMIZER_TRACE Table") table returns the

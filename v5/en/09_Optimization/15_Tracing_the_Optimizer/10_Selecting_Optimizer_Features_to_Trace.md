...
* *Dynamic range optimization*: Shown as
  ...
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output; each outer row
...
switches of the
[`optimizer_trace_features`](server-system-variables.html#sysvar_optimizer_trace_features) system

...
available in the extended [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement")
...
* The optimization applies to these operators:
  ...
  [`BETWEEN`](comparison-operators.html#operator_between), and
  [`IN()`](comparison-operators.html#operator_in).

  For operators other than
  [`BETWEEN`](comparison-operators.html#operator_between) and
  [`IN()`](comparison-operators.html#operator_in), either operand can be
  replaced by a matching generated column. For
  [`BETWEEN`](comparison-operators.html#operator_between) and
  [`IN()`](comparison-operators.html#operator_in), only the first argument
  can be replaced by a matching generated column, and the
  other arguments must have the same result type.
  [`BETWEEN`](comparison-operators.html#operator_between) and
  [`IN()`](comparison-operators.html#operator_in) are not yet supported for
...
* For comparisons of strings to indexed generated columns that
  ...
  string, [`JSON_UNQUOTE()`](json-modification-functions.html#function_json-unquote) is
  ...
  Without [`JSON_UNQUOTE()`](json-modification-functions.html#function_json-unquote) in the

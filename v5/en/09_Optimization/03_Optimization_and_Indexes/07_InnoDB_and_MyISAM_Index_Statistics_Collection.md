...
* To estimate how many rows must be read for each
  [`ref`](explain-output.html#jointype_ref) access
...
[`SHOW INDEX`](show-index.html "13.7.5.22 SHOW INDEX Statement") statement displays a
...
*`expr2`* (or both) are
`NULL`. This affects
[`ref`](explain-output.html#jointype_ref) accesses for comparisons
...
[`innodb_stats_method`](innodb-parameters.html#sysvar_innodb_stats_method) and
[`myisam_stats_method`](server-system-variables.html#sysvar_myisam_stats_method) system
...
* When the variable is set to `nulls_equal`,
  ...
  [`ref`](explain-output.html#jointype_ref) accesses when it
  should.
...
* When the variable is set to
  ...
  [`ref`](explain-output.html#jointype_ref) lookups when other
...
The [`innodb_stats_method`](innodb-parameters.html#sysvar_innodb_stats_method) system
...
* Change the table to cause its statistics to go out of date
  ...
  [`myisam_stats_method`](server-system-variables.html#sysvar_myisam_stats_method) and
...
* You can force table statistics to be collected explicitly,
  ...
  [`myisam_stats_method`](server-system-variables.html#sysvar_myisam_stats_method) has at

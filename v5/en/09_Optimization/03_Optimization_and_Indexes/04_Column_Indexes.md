...
[Chapter 15, *Alternative Storage Engines*](storage-engines.html "Chapter 15 Alternative Storage Engines"). All storage engines support
...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") column, you
...
[`innodb_large_prefix`](innodb-parameters.html#sysvar_innodb_large_prefix) set).

Note

Prefix limits are measured in bytes, whereas the prefix
length in [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement"),
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"), and
[`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement") statements is
...
searches. Only the [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") and
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") for full-text queries

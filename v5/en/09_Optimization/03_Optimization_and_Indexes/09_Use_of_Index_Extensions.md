...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") automatically extends each
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") for the query produces
this result:
...
[`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") output shows these
...
STATUS`](show-status.html "13.7.5.35 SHOW STATUS Statement"):
...
STATUS`](show-status.html "13.7.5.35 SHOW STATUS Statement") produces this result:
...
STATUS`](show-status.html "13.7.5.35 SHOW STATUS Statement") produces this result. The
...
improves performance, use this statement:

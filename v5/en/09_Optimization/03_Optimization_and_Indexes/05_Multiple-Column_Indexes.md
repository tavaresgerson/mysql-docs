...
[Section 8.2.1.3, “Index Merge Optimization”](index-merge-optimization.html "8.2.1.3 Index Merge Optimization")), or attempts to find
...
the [`SELECT`](select.html "13.2.9 SELECT Statement") statements shown here:

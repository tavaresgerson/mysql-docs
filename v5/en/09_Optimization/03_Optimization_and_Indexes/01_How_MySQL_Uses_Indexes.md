...
* To retrieve rows from other tables when performing joins.
  ...
  [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") are considered the same
  ...
  comparing a `utf8` column with a
...
* To sort or group a table if the sorting or grouping is done
  ...
  [Section 8.2.1.14, “ORDER BY Optimization”](order-by-optimization.html "8.2.1.14 ORDER BY Optimization"), and
...
for the query. See [Section 8.2.1.20, “Avoiding Full Table Scans”](table-scan-avoidance.html "8.2.1.20 Avoiding Full Table Scans") for
details.
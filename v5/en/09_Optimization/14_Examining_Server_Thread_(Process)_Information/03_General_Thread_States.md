...
* `committing alter table to storage engine`
  ...
  [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") and is committing
  the result.
...
* `copy to tmp table`
  ...
  TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. This state occurs after the table
...
* `Copying to tmp table on disk`
  ...
  [Section 8.4.4, “Internal Temporary Table Use in MySQL”](internal-temporary-tables.html "8.4.4 Internal Temporary Table Use in MySQL")). Consequently,
...
* `Creating sort index`
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") that is resolved using
...
* `init`
  ...
  [`INSERT`](insert.html "13.2.5 INSERT Statement"),
  [`SELECT`](select.html "13.2.9 SELECT Statement"), or
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") statements. Actions
...
* `Killed`
  ...
  Someone has sent a [`KILL`](kill.html "13.7.6.4 KILL Statement")
...
* `Opening tables`
  ...
  example, an [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") or a
  [`LOCK
  TABLE`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") statement can prevent opening a table until
...
* `Receiving from client`
  ...
  is called `Reading from net` prior to MySQL
  5.7.8.
...
* `Removing duplicates`
  ...
  The query was using
  [`SELECT
  DISTINCT`](select.html "13.2.9 SELECT Statement") in such a way that MySQL could not
...
* `removing tmp table`
  ...
  processing a [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* `rename result table`
  ...
  The thread is processing an [`ALTER
  TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement, has created the new table, and is
...
* `Searching rows for update`
  ...
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") is changing the index
  that is used to find the involved rows.

* `Sending data`

  The thread is reading and processing rows for a
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement, and sending
...
* `Sending to client`
  ...
  called `Writing to net` prior to MySQL
  5.7.8.

* `setup`

  The thread is beginning an [`ALTER
  TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") operation.
...
* `Sorting result`
  ...
  For a [`SELECT`](select.html "13.2.9 SELECT Statement") statement, this
...
* `System lock`
  ...
  can occur when [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") waits for
  a table-level lock during execution of
  [`LOCK TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements"). If this state is
  being caused by requests for external locks and you are not
  using multiple [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") servers that are
  accessing the same [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine")
  ...
  [`SHOW PROFILE`](show-profile.html "13.7.5.30 SHOW PROFILE Statement"), this state
...
* `Waiting for tables`
  ...
  [`ANALYZE TABLE`](analyze-table.html "13.7.2.1 ANALYZE TABLE Statement"), or
...
* `Waiting for lock_type
  ...
  *`lock_type`* indicates the type of
  ...
  [Section 8.11.1, “Internal Locking Methods”](internal-locking.html "8.11.1 Internal Locking Methods"). For information about
  metadata locking, see [Section 8.11.4, “Metadata Locking”](metadata-locking.html "8.11.4 Metadata Locking"). To
  see which locks are blocking lock requests, use the
  Performance Schema lock tables described at
  [Section 25.12.12, “Performance Schema Lock Tables”](performance-schema-lock-tables.html "25.12.12 Performance Schema Lock Tables").
...
* `Writing to net`
  ...
  called `Sending to client` as of MySQL
  5.7.8.
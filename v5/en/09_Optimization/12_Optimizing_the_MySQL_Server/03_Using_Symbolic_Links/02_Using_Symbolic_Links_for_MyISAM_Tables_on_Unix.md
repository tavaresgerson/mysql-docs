...
[Section 14.6.1.2, “Creating Tables Externally”](innodb-create-table-external.html "14.6.1.2 Creating Tables Externally") instead.
...
of the [`have_symlink`](server-system-variables.html#sysvar_have_symlink) system
...
* To instruct a running MySQL server to perform the
  ...
  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement"). See
  [Section 13.1.18, “CREATE TABLE Statement”](create-table.html "13.1.18 CREATE TABLE Statement"). Alternatively, if
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") is not running, symlinking can
...
* [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") does not replace a symlink
...
* Note
  ...
  *both the symlink and the file to which the
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") as the `root`
...
* If you rename a table with
  [`ALTER TABLE
  ... RENAME`](alter-table.html "13.1.8 ALTER TABLE Statement") or [`RENAME
  TABLE`](rename-table.html "13.1.33 RENAME TABLE Statement") and you do not move the table to another
...
* If you use
  [`ALTER TABLE
  ... RENAME`](alter-table.html "13.1.8 ALTER TABLE Statement") or [`RENAME
  TABLE`](rename-table.html "13.1.33 RENAME TABLE Statement") to move a table to another database, the
...
* If you are not using symlinks, start
  ...
  [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") to drop or rename a file outside
  of the data directory.

These table symlink operations are not supported:

* [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") ignores the
  `DATA DIRECTORY` and `INDEX
  DIRECTORY` table options.

* As indicated previously, only the data and index files can
  be symbolic links. The `.frm` file must
  *never* be a symbolic link. Attempting
  ...
  have a database `db1` under the MySQL

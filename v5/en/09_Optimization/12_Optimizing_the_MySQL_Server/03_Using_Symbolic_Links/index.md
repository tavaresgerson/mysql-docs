...
[8.12.3.1 Using Symbolic Links for Databases on Unix](symbolic-links-to-databases.html)

[8.12.3.2 Using Symbolic Links for MyISAM Tables on Unix](symbolic-links-to-tables.html)

[8.12.3.3 Using Symbolic Links for Databases on Windows](windows-symbolic-links.html)
...
TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement instead of symbolic links, as
explained in [Section 14.6.1.2, “Creating Tables Externally”](innodb-create-table-external.html "14.6.1.2 Creating Tables Externally").

...
* Increase the number of available disk spindles (and thereby
  ...
  + Using symbolic links
    ...
    see [Section 8.5.8, “Optimizing InnoDB Disk I/O”](optimizing-innodb-diskio.html "8.5.8 Optimizing InnoDB Disk I/O").
  ...
  + Striping
    ...
    See [Section 8.13.2, “Using Your Own Benchmarks”](custom-benchmarks.html "8.13.2 Using Your Own Benchmarks").

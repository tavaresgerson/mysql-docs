...
and [sys schema](sys-schema.html "Chapter 26 MySQL sys Schema") to monitor
MySQL memory usage.
...
2. To enable memory instruments, add a
   ...
   Schema [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table")
   table should report `YES` for memory
   instruments that you enabled. The `TIMED`
   column in the
   [`setup_instruments`](performance-schema-setup-instruments-table.html "25.12.2.3 The setup_instruments Table") table is
...
3. Query memory instrument data. In this example, memory
   ...
   [`memory_global_by_current_bytes`](sys-memory-global-by-current-bytes.html "26.4.3.19 The memory_global_by_current_bytes and x$memory_global_by_current_bytes Views")
   ...
   *************************** 1. row ***************************
   ...
   This [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema query
   ...
   [`sys`](sys-schema.html "Chapter 26 MySQL sys Schema") schema, see

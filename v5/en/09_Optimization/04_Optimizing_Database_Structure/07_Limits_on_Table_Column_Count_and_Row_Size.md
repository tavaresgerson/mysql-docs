...
* The storage requirements of individual columns constrain
  ...
  character set. See [Section 11.7, “Data Type Storage Requirements”](storage-requirements.html "11.7 Data Type Storage Requirements").

* Storage engines may impose additional restrictions that
  limit table column count. For example,
  [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") has a limit of 1017
  columns per table. See [Section 14.23, “InnoDB Limits”](innodb-limits.html "14.23 InnoDB Limits").
...
* The internal representation of a MySQL table has a maximum
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns only
...
* Different storage formats use different amounts of page
  ...
  + For information about `InnoDB` row
    formats, see [Section 14.11, “InnoDB Row Formats”](innodb-row-format.html "14.11 InnoDB Row Formats").
...
* The MySQL maximum row size limit of 65,535 bytes is
  ...
  changing a column to [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types")
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") avoids the MySQL
...
* Storage for variable-length columns includes length bytes,
  ...
  [`VARCHAR(255)
  CHARACTER SET utf8mb3`](char.html "11.3.2 The CHAR and VARCHAR Types") column takes two bytes to
...
* For [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables,
  ...
  because [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") requires space
  ...
  For information about [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine")

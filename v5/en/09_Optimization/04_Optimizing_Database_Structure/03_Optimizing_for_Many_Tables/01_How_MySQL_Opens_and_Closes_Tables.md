...
When you execute a [**mysqladmin status**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program")
...
The [`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) and
...
[`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) is related
to [`max_connections`](server-system-variables.html#sysvar_max_connections). For
...
[`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) setting. If
[`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) is set too
...
table. For a partitioned `MyISAM` table, two
file descriptors are required for each partition of the opened
table. (When `MyISAM` opens a partitioned
...
set the [`open_files_limit`](server-system-variables.html#sysvar_open_files_limit)
system variable. See
...
[`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) entries. The
...
* When the cache contains more than
  [`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) entries
...
* When a table-flushing operation occurs. This happens when
  ...
  TABLES`](flush.html#flush-tables) statement or executes a
  [**mysqladmin flush-tables**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") or
  [**mysqladmin refresh**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command.
...
[`Opened_tables`](server-status-variables.html#statvar_Opened_tables) status
...
TABLES`](flush.html#flush-tables) statements, increase the
[`table_open_cache`](server-system-variables.html#sysvar_table_open_cache) value at
server startup.
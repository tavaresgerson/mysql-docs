...
* `--parallel-recover`, `-p`
  ...
  <table frame="box" rules="all" summary="Properties for parallel-recover"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--parallel-recover</code></td> </tr></tbody></table>

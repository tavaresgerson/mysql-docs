...
* `--secure-auth`
  ...
  <table frame="box" rules="all" summary="Properties for secure-auth"><tbody><tr><th>Command-Line Format</th> <td><code>--secure-auth</code></td> </tr><tr><th>Deprecated</th> <td>Yes</td> </tr></tbody></table>

...
* `--column-names`
  ...
  <table frame="box" rules="all" summary="Properties for column-names"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code class="literal">--column-names</code></td> </tr></tbody></table>

...
decision, and is expelled after the expelling mechanism detects
and implements the expulsion.
...
[Responses to Failure Detection and Network Partitioning](/doc/refman/8.0/en/group-replication-responses-failure.html).
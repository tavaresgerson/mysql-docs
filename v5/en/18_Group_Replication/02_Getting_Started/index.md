...
[MySQL Shell 8.0](/doc/mysql-shell/8.0/en/). In addition, InnoDB Cluster
interfaces seamlessly with MySQL Router and simplifies deploying MySQL
with high availability. See [MySQL AdminAPI](/doc/mysql-shell/8.0/en/admin-api-userguide.html).
...
server using the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client, and issue the
...
(see [Section 2.10, “Upgrading MySQL”](upgrading.html "2.10 Upgrading MySQL")). If the upgrade is not run,

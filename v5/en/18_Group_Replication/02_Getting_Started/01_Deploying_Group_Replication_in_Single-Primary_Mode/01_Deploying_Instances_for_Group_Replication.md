...
is installed on each host (see [Chapter 2, *Installing and Upgrading MySQL*](installing.html "Chapter 2 Installing and Upgrading MySQL")).
The Group Replication plugin is provided with MySQL Server
5.7.17 and later; no additional software is required, although
the plugin must be installed in the running MySQL server. See
[Section 17.2.1.1, “Deploying Instances for Group Replication”](group-replication-deploying-instances.html "17.2.1.1 Deploying Instances for Group Replication"); for
additional information, see [Section 5.5, “MySQL Server Plugins”](server-plugins.html "5.5 MySQL Server Plugins").
...
[Section 17.1.3.2, “Failure Detection”](group-replication-failure-detection.html "17.1.3.2 Failure Detection").
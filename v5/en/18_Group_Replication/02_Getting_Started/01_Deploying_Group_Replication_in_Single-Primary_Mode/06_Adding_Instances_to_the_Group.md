...
in [Section 17.2.1.3, “User Credentials”](group-replication-user-credentials.html "17.2.1.3 User Credentials"). If
...
[`super_read_only`](server-system-variables.html#sysvar_super_read_only) variable is
...
*2. Start the server and connect to it. Configure the
recovery credentials for the group\_replication\_recovery
channel.*
...
*4. Install the Group Replication plugin and start
it.*

...
achieve
[Section 17.9.5, “Distributed Recovery”](group-replication-distributed-recovery.html "17.9.5 Distributed Recovery"),
...
Create a MySQL user with the [`REPLICATION
SLAVE`](privileges-provided.html#priv_replication-slave) privilege. This process can be captured in the
...
you can disable binary logging using `SET
...
has been created using `SET SQL_LOG_BIN=1;`.
...
See [Section 17.9.5, “Distributed Recovery”](group-replication-distributed-recovery.html "17.9.5 Distributed Recovery").
...
situation use [`report_host`](replication-options-replica.html#sysvar_report_host) to

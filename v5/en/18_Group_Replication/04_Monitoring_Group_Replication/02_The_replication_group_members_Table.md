...
[`server_uuid`](replication-options.html#sysvar_server_uuid) of the member. The
`MEMBER_STATE` column shows one of the
[Section 17.4.1, “Group Replication Server States”](group-replication-server-states.html "17.4.1 Group Replication Server States"), in this case it
...
MySQL versions. See
[Section 17.4.1, “Group Replication Server States”](group-replication-server-states.html "17.4.1 Group Replication Server States") for more
information.

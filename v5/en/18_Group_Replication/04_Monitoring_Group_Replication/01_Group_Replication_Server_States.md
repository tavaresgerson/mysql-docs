...
<table><col style="width: 38%"/><col style="width: 50%"/><col style="width: 12%"/><thead><tr>
<th><p>
              Field
            </p></th>
<th><p>
...
[`super_read_only`](server-system-variables.html#sysvar_super_read_only) option is set
to `ON`. To leave the `ERROR`
state you must manually configure the instance with
[`super_read_only=OFF`](server-system-variables.html#sysvar_super_read_only).

Note that Group Replication is *not*

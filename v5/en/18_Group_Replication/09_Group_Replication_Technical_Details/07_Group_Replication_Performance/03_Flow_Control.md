...
1. to keep the members close enough to make buffering and
...
3. to give each member a fair share of the available write
   capacity;

4. to not reduce throughput more than strictly necessary to
...
2. the throttling of members that are trying to write beyond
...
queue size of the certifier or the binary log applier exceeds

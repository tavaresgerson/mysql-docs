...
mechanism. See [Section 16.1.3, “Replication with Global Transaction Identifiers”](replication-gtids.html "16.1.3 Replication with Global Transaction Identifiers"). However,
...
*(i)* one that is randomly generated and
*(ii)* a monotonically increasing integer.

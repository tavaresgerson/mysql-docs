...
member (called the *donor*). Next, the server
...
*donor* of the state that it is missing.
...
[Section 16.2.2, “Replication Channels”](replication-channels.html "16.2.2 Replication Channels"). Through this

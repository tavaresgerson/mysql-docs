...
[`super-read-only=ON`](server-system-variables.html#sysvar_super_read_only)
...
[`server_uuid`](replication-options.html#sysvar_server_uuid) in lexicographical
...
[`server_uuid`](replication-options.html#sysvar_server_uuid) order from the

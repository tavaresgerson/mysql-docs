...
TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement a `PARTITION BY HASH
(expr)` clause, where
...
[Section 22.6, “Restrictions and Limitations on Partitioning”](partitioning-limitations.html "22.6 Restrictions and Limitations on Partitioning"). You should also keep
...
type [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), then the expression
...
[`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"). Now consider the expression
...
partitions to use based on the modulus of the result of the
expression. In other words, for a given expression
...
MySQL 5.7 also supports a variant of
...
[Section 22.2.4.1, “LINEAR HASH Partitioning”](partitioning-linear-hash.html "22.2.4.1 LINEAR HASH Partitioning"), for a description of
this algorithm.

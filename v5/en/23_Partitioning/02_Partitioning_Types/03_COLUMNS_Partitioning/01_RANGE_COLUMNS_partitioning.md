...
* `RANGE COLUMNS` partitioning columns are
  ...
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns can also
  be used as partitioning columns. (See
  [Section 22.2.3, “COLUMNS Partitioning”](partitioning-columns.html "22.2.3 COLUMNS Partitioning"), for details.)
...
Not all [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") options
...
of the [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement.
...
The [`SELECT`](select.html "13.2.9 SELECT Statement") statement in the
...
MySQL, see [Section 13.2.10.5, “Row Subqueries”](row-subqueries.html "13.2.10.5 Row Subqueries").
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client, like this:
...
If a [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement
...
[Section 22.2.3, “COLUMNS Partitioning”](partitioning-columns.html "22.2.3 COLUMNS Partitioning"), for a complete listing
...
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement:
...
collations, see [Chapter 10, *Character Sets, Collations, Unicode*](charset.html "Chapter 10 Character Sets, Collations, Unicode").
...
See [Section 13.1.18, “CREATE TABLE Statement”](create-table.html "13.1.18 CREATE TABLE Statement"), for additional information

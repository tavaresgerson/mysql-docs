...
In MySQL 5.7, it is possible to match against
only a list of integers (and possibly
`NULL`—see
[Section 22.2.7, “How MySQL Partitioning Handles NULL”](partitioning-handling-nulls.html "22.2.7 How MySQL Partitioning Handles NULL")) when
...
you could use the [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
...
In MySQL 5.7, all rows relating to employees
...
than the equivalent [`DELETE`](delete.html "13.2.2 DELETE Statement")
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") statement containing an
...
[`INSERT`](insert.html "13.2.5 INSERT Statement") statement the behavior
depends on whether the table uses a transactional storage
engine. For an [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") table, the
...
storage engine such as [`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine"), any
...
[`TABLE`](/doc/refman/8.0/en/table.html) statement that rows
...
[Section 22.2.3.2, “LIST COLUMNS partitioning”](partitioning-columns-list.html "22.2.3.2 LIST COLUMNS partitioning").
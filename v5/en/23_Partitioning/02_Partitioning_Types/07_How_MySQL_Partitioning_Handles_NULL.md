...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements using the
following query against the
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table in the
...
[Section 24.3.16, “The INFORMATION\_SCHEMA PARTITIONS Table”](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table").) Now let
...
[`INFORMATION_SCHEMA.PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") and
...
then re-running the [`SELECT`](select.html "13.2.9 SELECT Statement")
statements:
...
PARTITION`, see [Section 13.1.8, “ALTER TABLE Statement”](alter-table.html "13.1.8 ALTER TABLE Statement").)
...
TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement such as this one:
...
[`YEAR(NULL)`](date-and-time-functions.html#function_year) returns
...
By issuing the appropriate query against the Information Schema
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table, you can determine
which partitions were used to store the rows just inserted (we
assume, as in the previous examples, that the partitioned tables
were created in the `p` database):
...
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table once again, we can

...
* Subpartition names must be unique across the entire table.
  ...
  TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement is valid in MySQL
  5.7:
...
[`MyISAM`](myisam-storage-engine.html "15.2 The MyISAM Storage Engine") tables to distribute data
...
* Rows reflecting dates from the year 2000 to the present
  ...
  [Section 22.3, “Partition Management”](partitioning-management.html "22.3 Partition Management"), for an
...
[`NO_DIR_IN_CREATE`](sql-mode.html#sqlmode_no_dir_in_create) server SQL

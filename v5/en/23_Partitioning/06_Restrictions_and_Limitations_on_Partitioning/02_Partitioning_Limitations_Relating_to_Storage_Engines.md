...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") foreign keys and MySQL
...
In addition,
[`ALTER
TABLE ... OPTIMIZE PARTITION`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") does not work correctly
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine. It is not
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table depends on the number of
...
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statements that would cause a user-partitioned
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table not to meet either or
...
**Exception.**
If a user-partitioned [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table
...
than [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") must be dumped and
reloaded.
...
* Do *not* specify any engine for
  *any* partition or subpartition

* Specify the engine for *all* partitions
  or subpartitions
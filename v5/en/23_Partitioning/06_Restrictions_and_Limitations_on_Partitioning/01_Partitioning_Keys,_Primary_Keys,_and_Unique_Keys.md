...
The [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement fails
...
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statements:
...
[`ALTER
TABLE ... PARTITION BY`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations"). Consider a table
...
The following
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement fails with an error, because the

...
5. There are no rows in *`nt`* that lie
   ...
   *`p`*. This condition does not apply
   if the `WITHOUT VALIDATION` option is used.
   The `[{WITH|WITHOUT} VALIDATION]` option
   was added in MySQL 5.7.5.
...
7. For `InnoDB` tables, both tables must use
   ...
   `InnoDB` table, query the Information
   Schema [`INNODB_SYS_TABLES`](information-schema-innodb-sys-tables-table.html "24.4.23 The INFORMATION_SCHEMA INNODB_SYS_TABLES Table") table.
...
8. Any partition-level `MAX_ROWS` setting for
   ...
   `pt` has an exlpicit table-level
...
required for [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
statements, you must have the
[`DROP`](privileges-provided.html#priv_drop) privilege to perform
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement").
...
* Executing [`ALTER
  TABLE ... EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") does not invoke any
...
The syntax of the
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") statement is shown here, where
*`pt`* is the partitioned table,
*`p`* is the partition or subpartition to
be exchanged, and *`nt`* is the
...
or `WITHOUT VALIDATION` clause. When
`WITHOUT VALIDATION` is specified, the
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") operation does not perform
...
The `[{WITH|WITHOUT} VALIDATION]` option was
...
[`ALTER TABLE
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. To exchange multiple
partitions or subpartitions, use multiple
[`ALTER TABLE
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") statements. `EXCHANGE
PARTITION` may not be combined with other
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") options. The
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client as shown here:
...
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table, like this:
...
Information Schema [`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table")
...
use the
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement shown here:
...
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table:
...
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement as previously:
...
issuing the
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement, have now switched places:
...
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") statement must meet the conditions
...
[`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") or
[`ALTER
TABLE ... REPAIR PARTITION`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations").
...
VALIDATION` to the
[`ALTER
TABLE ... EXCHANGE PARTITION`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement.
...
TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") or
[`ALTER
TABLE ... REPAIR PARTITION`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations").
...
(see [Section 22.2.6, “Subpartitioning”](partitioning-subpartitions.html "22.2.6 Subpartitioning")) with a
nonpartitioned table using an
[`ALTER TABLE ...
EXCHANGE PARTITION`](alter-table.html "13.1.8 ALTER TABLE Statement") statement. In the following
...
`SUBPARTITION_NAME` of the
[`PARTITIONS`](information-schema-partitions-table.html "24.3.16 The INFORMATION_SCHEMA PARTITIONS Table") table from
...
The following
[`ALTER
TABLE`](alter-table-partition-operations.html "13.1.8.1 ALTER TABLE Partition Operations") statement exchanges subpartition
`p3sp0` table `es` with the

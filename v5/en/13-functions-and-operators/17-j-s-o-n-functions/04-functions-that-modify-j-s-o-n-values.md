...
* `JSON_UNQUOTE(json_val)`
  ...
  **Table 12.23 JSON\_UNQUOTE() Special Character Escape Sequences**
  ...
  <table><col style="width: 15%"/><col style="width: 85%"/><thead><tr> <th>Escape Sequence</th> <th>Character Represented by Sequence</th> </tr></thead><tbody><tr> <td><code class="literal">\"</code><a class="indexterm" name="id197822"></a><a class="indexterm" name="id197824"></a></td> <td>A double quote (<code class="literal">"</code>) character</td> </tr><tr> <td><code class="literal">\b</code><a class="indexterm" name="id197831"></a><a class="indexterm" name="id197833"></a></td> <td>A backspace character</td> </tr><tr> <td><code class="literal">\f</code><a class="indexterm" name="id197839"></a><a class="indexterm" name="id197841"></a></td> <td>A formfeed character</td> </tr><tr> <td><code class="literal">\n</code><a class="indexterm" name="id197847"></a><a class="indexterm" name="id197849"></a><a class="indexterm" name="id197851"></a><a class="indexterm" name="id197853"></a></td> <td>A newline (linefeed) character</td> </tr><tr> <td><code class="literal">\r</code><a class="indexterm" name="id197859"></a><a class="indexterm" name="id197861"></a><a class="indexterm" name="id197863"></a></td> <td>A carriage return character</td> </tr><tr> <td><code class="literal">\t</code><a class="indexterm" name="id197869"></a><a class="indexterm" name="id197871"></a></td> <td>A tab character</td> </tr><tr> <td><code class="literal">\\</code><a class="indexterm" name="id197877"></a><a class="indexterm" name="id197879"></a></td> <td>A backslash (<code class="literal">\</code>) character</td> </tr><tr> <td><code class="literal">\u<em class="replaceable"><code>XXXX</code></em></code><a class="indexterm" name="id197887"></a><a class="indexterm" name="id197889"></a></td> <td>UTF-8 bytes for Unicode value <em class="replaceable"><code>XXXX</code></em></td> </tr></tbody></table>

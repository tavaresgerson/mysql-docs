...
<table summary="What happens for combinations of strict and ERROR_FOR_DIVISION_BY_ZERO modes."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th><a class="link" href="server-system-variables.html#sysvar_sql_mode"><code>sql_mode</code></a> Value</th> <th>Result</th> </tr></thead><tbody><tr> <td><code>''</code> (Default)</td> <td>No warning, no error; <code>i</code> is set to <code>NULL</code>.</td> </tr><tr> <td>strict</td> <td>No warning, no error; <code>i</code> is set to <code>NULL</code>.</td> </tr><tr> <td><a class="link" href="sql-mode.html#sqlmode_error_for_division_by_zero"><code>ERROR_FOR_DIVISION_BY_ZERO</code></a></td> <td>Warning, no error; <code>i</code> is set to <code>NULL</code>.</td> </tr><tr> <td>strict,<a class="link" href="sql-mode.html#sqlmode_error_for_division_by_zero"><code>ERROR_FOR_DIVISION_BY_ZERO</code></a></td> <td>Error condition; no row is inserted.</td> </tr></tbody></table>

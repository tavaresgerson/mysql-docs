...
* The [`character_set_server`](server-system-variables.html#sysvar_character_set_server)
  ...
  See [Section 10.3.2, “Server Character Set and Collation”](charset-server.html "10.3.2 Server Character Set and Collation").
...
* What character set should the server translate query results
  ...
  messages, see [Section 10.6, “Error Message Character Set”](charset-errors.html "10.6 Error Message Character Set").
...
* The
  ...
  [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") and [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program").

* The [`SET NAMES
  'charset_name'`](set-names.html "13.7.4.3 SET NAMES Statement")
  statement.

* The [`SET
  CHARACTER SET
  'charset_name'`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement")
  statement.
...
the equivalent of a [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement")
operation.
...
The [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program"),
[**mysqlcheck**](mysqlcheck.html "4.5.3 mysqlcheck — A Table Maintenance Program"), [**mysqlimport**](mysqlimport.html "4.5.5 mysqlimport — A Data Import Program"),
and [**mysqlshow**](mysqlshow.html "4.5.7 mysqlshow — Display Database, Table, and Column Information") client programs determine the
...
* Each client can autodetect which character set to use based
  ...
  compiled-in default. For example, `ucs2` is
  ...
  [`mysql_options()`](/doc/c-api/5.7/en/mysql-options.html) as follows
...
With the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client, to use a character set
different from the default, you could explicitly execute a
[`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") statement every time
...
If you are using the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client with
auto-reconnect enabled (which is not recommended), it is
preferable to use the `charset` command rather
than [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement"). For example:
...
[`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") statement, and also
changes the default character set that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
* `SET NAMES 'charset_name'
  ...
  [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") indicates what
  character set the client uses to send SQL statements to the
  server. Thus, [`SET
  NAMES 'cp1251'`](set-names.html "13.7.4.3 SET NAMES Statement") tells the server, “future
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement that
...
* `SET CHARACTER SET
  ...
  [`SET CHARACTER SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") is similar
  to [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") but sets
  [`character_set_connection`](server-system-variables.html#sysvar_character_set_connection)
  ...
  A [`SET
  CHARACTER SET
  charset_name`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") statement
...
NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or [`SET CHARACTER
SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement") produces an error. See
[Impermissible Client Character Sets](charset-connection.html#charset-connection-impermissible-client-charset "Impermissible Client Character Sets").

Example: Suppose that `column1` is defined as
`CHAR(5) CHARACTER SET latin2`. If you do not
say [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or
[`SET CHARACTER SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement"), then for
...
the [`SELECT`](select.html "13.2.9 SELECT Statement") statement, the server
...
[`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or
[`SET CHARACTER SET`](set-character-set.html "13.7.4.2 SET CHARACTER SET Statement").

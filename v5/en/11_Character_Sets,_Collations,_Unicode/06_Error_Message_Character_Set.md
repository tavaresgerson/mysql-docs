...
[Section 10.12, “Setting the Error Message Language”](error-message-language.html "10.12 Setting the Error Message Language"). For general information
about configuring error logging, see [Section 5.4.2, “The Error Log”](error-log.html "5.4.2 The Error Log").
...
* Parameters in the message template are replaced with values
  ...
  + Binary string values are copied as is for bytes in the
    ...
    [`VARBINARY`](binary-varbinary.html "11.3.3 The BINARY and VARBINARY Types") unique column,
...
* If the server sends the error message to a client program,
  ...
  means such as [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement"). For

...
`INFORMATION_SCHEMA`
[`CHARACTER_SETS`](information-schema-character-sets-table.html "24.3.2 The INFORMATION_SCHEMA CHARACTER_SETS Table") table or the
[`SHOW CHARACTER SET`](show-character-set.html "13.7.5.3 SHOW CHARACTER SET Statement") statement. A
...
By default, the [`SHOW CHARACTER SET`](show-character-set.html "13.7.5.3 SHOW CHARACTER SET Statement")
...
[`COLLATIONS`](information-schema-collations-table.html "24.3.3 The INFORMATION_SCHEMA COLLATIONS Table") table or the
[`SHOW COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement") statement.

By default, the [`SHOW COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement")
...
`latin1` (cp1252 West European), use this
statement:
...
<table summary="latin1 character set collations, as described in the preceding example, and the meaning of each collation."><col style="width: 40%"/><col style="width: 60%"/><thead><tr>
<th>Collation</th>
<th>Meaning</th>
</tr></thead><tbody><tr>
<td><code>latin1_bin</code></td>
<td>Binary according to <code>latin1</code> encoding</td>
</tr><tr>
<td><code>latin1_danish_ci</code></td>
<td>Danish/Norwegian</td>
</tr><tr>
<td><code>latin1_general_ci</code></td>
<td>Multilingual (Western European)</td>
</tr><tr>
<td><code>latin1_general_cs</code></td>
...
<td><code>latin1_spanish_ci</code></td>
...
* Each character set has a *default
  ...
  `utf8_general_ci`, respectively. The
  `INFORMATION_SCHEMA`
  [`CHARACTER_SETS`](information-schema-character-sets-table.html "24.3.2 The INFORMATION_SCHEMA CHARACTER_SETS Table") table and the
  ...
  `INFORMATION_SCHEMA`
  [`COLLATIONS`](information-schema-collations-table.html "24.3.3 The INFORMATION_SCHEMA COLLATIONS Table") table and the
  [`SHOW COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement") statement have a
...
* Collation names start with the name of the character set with
  ...
  [Section 10.3.1, “Collation Naming Conventions”](charset-collation-names.html "10.3.1 Collation Naming Conventions").

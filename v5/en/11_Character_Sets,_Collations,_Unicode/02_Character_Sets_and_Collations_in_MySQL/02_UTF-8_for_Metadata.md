...
[`SHOW`](show.html "13.7.5 SHOW Statements") are metadata. This is also
...
* All metadata must be in the same character set. Otherwise,
  neither the [`SHOW`](show.html "13.7.5 SHOW Statements") statements
  nor [`SELECT`](select.html "13.2.9 SELECT Statement") statements for
...
[`DATABASE()`](information-functions.html#function_database), and
[`VERSION()`](information-functions.html#function_version) functions have the
UTF-8 character set by default.

The server sets the
[`character_set_system`](server-system-variables.html#sysvar_character_set_system) system
...
of [`DESCRIBE`](describe.html "13.8.1 DESCRIBE Statement") functions in the
[`character_set_system`](server-system-variables.html#sysvar_character_set_system) character
...
[`character_set_results`](server-system-variables.html#sysvar_character_set_results) system
...
NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") statement to force the server to perform
character set conversion. [`SET
NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") sets the
[`character_set_results`](server-system-variables.html#sysvar_character_set_results) and other
related system variables. (See
[Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations").) Alternatively, a client
...
If [`character_set_results`](server-system-variables.html#sysvar_character_set_results) is set
...
[`USER()`](information-functions.html#function_user) function for comparison or
...
This works because the contents of
[`USER()`](information-functions.html#function_user) are automatically

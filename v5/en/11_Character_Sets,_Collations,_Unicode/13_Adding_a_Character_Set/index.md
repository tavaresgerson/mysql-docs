...
2. This step depends on whether you are adding a simple or
   ...
   * The `<map>` array element for the
     ...
     [Section 10.13.1, “Character Definition Arrays”](character-arrays.html "10.13.1 Character Definition Arrays").
   ...
   * Create the file
     ...
     character set. See [Section 10.13.1, “Character Definition Arrays”](character-arrays.html "10.13.1 Character Definition Arrays").
   ...
   * If the character set requires string collating functions,
     see [Section 10.13.2, “String Collating Support for Complex Character Sets”](string-collating.html "10.13.2 String Collating Support for Complex Character Sets").

   * If the character set requires multibyte character support,
     see [Section 10.13.3, “Multi-Byte Character Support for Complex Character Sets”](multibyte-characters.html "10.13.3 Multi-Byte Character Support for Complex Character Sets").
   ...
   *`MYSYS`*. The example here assumes
   ...
   3. Edit `cmake/character_sets.cmake`:
      ...
      2. Add *`MYSET`* to the value of
         ...
         or **CMake** does not recognize
         [`-DDEFAULT_CHARSET=MYSET`](source-configuration-options.html#option_cmake_default_charset).

...
[`CONVERT()`](cast-functions.html#function_convert) would do. It does not
...
* If *`_charset_name`* is specified but
  ...
  *`charset_name`* and its default
  ...
  SET`](show-character-set.html "13.7.5.3 SHOW CHARACTER SET Statement") statement or query the
  `INFORMATION_SCHEMA`
  [`CHARACTER_SETS`](information-schema-character-sets-table.html "24.3.2 The INFORMATION_SCHEMA CHARACTER_SETS Table") table.
...
[`character_set_connection`](server-system-variables.html#sysvar_character_set_connection) even
in the presence of an introducer. The examples use
[`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") (which changes
[`character_set_connection`](server-system-variables.html#sysvar_character_set_connection), as
discussed in [Section 10.4, “Connection Character Sets and Collations”](charset-connection.html "10.4 Connection Character Sets and Collations")), and display
the resulting strings using the
[`HEX()`](string-functions.html#function_hex) function so that the exact
...
using the
[`character_set_connection`](server-system-variables.html#sysvar_character_set_connection) value
...
Here, [`character_set_connection`](server-system-variables.html#sysvar_character_set_connection)

...
collation. The [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement")
and [`ALTER DATABASE`](alter-database.html "13.1.1 ALTER DATABASE Statement") statements
...
variables, [`character_set_server`](server-system-variables.html#sysvar_character_set_server)
...
* For [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements,
...
* For [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement") statements that

...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") data types) have a character
...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") data types) have a character
...
* When assigning column values for
  ...
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") using a string
  literal:
...
For binary strings, all bytes are significant in comparisons,

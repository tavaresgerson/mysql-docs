...
[Section 10.14.4.2, “LDML Syntax Supported in MySQL”](ldml-rules.html "10.14.4.2 LDML Syntax Supported in MySQL").

The example adds a collation named
`utf8_phone_ci` to the
`utf8` character set. The collation is
...
1. Choose a collation ID, as shown in
   [Section 10.14.2, “Choosing a Collation ID”](adding-collation-choosing-id.html "10.14.2 Choosing a Collation ID"). The

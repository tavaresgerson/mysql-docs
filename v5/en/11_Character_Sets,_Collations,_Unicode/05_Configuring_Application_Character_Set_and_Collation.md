...
* Specify character settings per database. For example,
  ...
  `latin1`, whereas applications that use
...
character set and `utf8_general_ci` collation in
...
* **Specify character settings per database.**
  ...
  [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement") statement
  like this:
  ...
  Tables created in the database use `utf8` and
  ...
  regardless of connection method (the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
  ...
  to connect using [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client"), you can specify the
  ...
  If you use [`ALTER DATABASE`](alter-database.html "13.1.1 ALTER DATABASE Statement") to
...
* **Specify character settings at server startup.**
  ...
  connection using [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or
  ...
  'utf8'"`](server-system-variables.html#sysvar_init_connect) option to cause [`SET
  NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") to be executed automatically for each client
...
* **Specify character settings at MySQL configuration time.**
  ...
  **CMake** options:
  ...
  `utf8_general_ci` as the default for
  ...
  [`SET NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") or equivalent after
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client from within a terminal window, the

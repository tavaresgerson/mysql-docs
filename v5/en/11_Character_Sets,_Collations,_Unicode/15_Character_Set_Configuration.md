...
start the server. See [Section 5.1.6, “Server Command Options”](server-options.html "5.1.6 Server Command Options"). The
...
set, use the [`SHOW COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement")
...
* If the character set is a complex character set that cannot be
  ...
  [Section 10.14.4, “Adding a UCA Collation to a Unicode Character Set”](adding-collation-unicode-uca.html "10.14.4 Adding a UCA Collation to a Unicode Character Set").

...
character set, use [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). For
...
* If the column has a binary data type
  ...
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types")), all the values that it
...
* If the column has a nonbinary data type
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types")), its contents should be
...
[`TRIM()`](string-functions.html#function_trim) function:
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") after an upgrade to MySQL
4.1 or higher. In that case, MySQL stores new values in the column
using `latin1`, and the column contains a mix of
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"). For example, if you
...
useful. See [Section 13.1.8, “ALTER TABLE Statement”](alter-table.html "13.1.8 ALTER TABLE Statement").

Note

[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statements which make
changes in table or column character sets or collations must be
performed using `ALGORITHM=COPY`. For more
information, see [Section 14.13.1, “Online DDL Operations”](innodb-online-ddl-operations.html "14.13.1 Online DDL Operations").
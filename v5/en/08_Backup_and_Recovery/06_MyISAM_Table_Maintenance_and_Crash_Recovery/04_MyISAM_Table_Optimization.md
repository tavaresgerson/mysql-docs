...
[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") in recovery mode:
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") SQL statement.
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") does a table
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement"). See [Section 13.7.2.4, “OPTIMIZE TABLE Statement”](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement").

[**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") has a number of other options that
you can use to improve the performance of a table:

* [`--analyze`](myisamchk-other-options.html#option_myisamchk_analyze) or
...
* [`--sort-index`](myisamchk-other-options.html#option_myisamchk_sort-index) or
  `-S`: Sort the index blocks. This optimizes
  seeks and makes table scans that use indexes faster.

* [`--sort-records=index_num`](myisamchk-other-options.html#option_myisamchk_sort-records)
  or `-R index_num`:
  Sort data rows according to a given index. This makes your
  data much more localized and may speed up range-based
  [`SELECT`](select.html "13.2.9 SELECT Statement") and `ORDER

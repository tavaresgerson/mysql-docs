...
[MySQL Enterprise Backup](mysql-enterprise-backup.html "28.1 MySQL Enterprise Backup Overview") can perform
a [physical backup](glossary.html#glos_physical_backup "physical backup") of
an entire instance, with optimizations to minimize overhead and
avoid disruption when backing up `InnoDB` data
files; [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") provides online
[logical backup](glossary.html#glos_logical_backup "logical backup"). This
discussion uses [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program").
...
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") contains a set of SQL
[`INSERT`](insert.html "13.2.5 INSERT Statement") statements that can be
...
TABLES WITH READ LOCK`](flush.html#flush-tables-with-read-lock)). As soon as this lock has been
...
`InnoDB` tables, so
[`--single-transaction`](mysqldump.html#option_mysqldump_single-transaction) uses a
consistent read and guarantees that data seen by
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") does not change. (Changes made by
other clients to `InnoDB` tables are not seen
by the [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") process.) If the backup
...
[`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin) option to enable that
...
[`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin) option and that has
...
[`FLUSH LOGS`](flush.html#flush-logs) SQL statement or with
a [**mysqladmin flush-logs**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command.
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") also has an option to flush the
...
backup. Let's modify the previous [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program")
...
because the [`--flush-logs`](mysqldump.html#option_mysqldump_flush-logs)
option causes the server to flush its logs. The
[`--master-data`](mysqldump.html#option_mysqldump_master-data) option causes
[**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") to write binary log information to
...
Because the [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command made a full
...
executing a [**mysqladmin flush-logs**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command
...
another [**mysqladmin flush-logs**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command. All
...
--delete-master-logs**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") can be dangerous if your server
...
LOGS`](purge-binary-logs.html "13.4.1.1 PURGE BINARY LOGS Statement") statement explains what should be verified

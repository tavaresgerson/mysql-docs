...
[Section 7.5.2, “Point-in-Time Recovery Using Event Positions”](point-in-time-recovery-positions.html "7.5.2 Point-in-Time Recovery Using Event Positions"), explains the
operation in details with an example.

Note

Many of the examples in this and the next section use the
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client to process binary log output
produced by [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files"). If your binary log
contains `\0` (null) characters, that output
cannot be parsed by [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") unless you invoke
...
point-in-time, binary logging must be enabled on it (see
[Section 5.4.4, “The Binary Log”](binary-log.html "5.4.4 The Binary Log") for details).
...
The [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") utility converts the events
in the binary log files from binary format to text so that they
can be viewed or applied. [**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") has
...
[**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") output using the
...
[**mysqlbinlog**](mysqlbinlog.html "4.6.7 mysqlbinlog — Utility for Processing Binary Log Files") output into a paging program:

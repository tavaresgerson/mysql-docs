...
the [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") command line because that
causes `USE db1` to be included in the dump
file, which overrides the effect of naming
`db2` on the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") command
line.
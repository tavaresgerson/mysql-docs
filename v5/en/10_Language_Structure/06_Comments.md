...
statement, but other servers do not:
...
5.7.31 or later, use `50731` in the comment.

The comment syntax just described applies to how the
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") server parses SQL statements. The
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client program also performs some parsing
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client parsers, see
...
For more information, see [Section 8.9.3, “Optimizer Hints”](optimizer-hints.html "8.9.3 Optimizer Hints").

The use of short-form [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") commands such as
...
client other than [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client").
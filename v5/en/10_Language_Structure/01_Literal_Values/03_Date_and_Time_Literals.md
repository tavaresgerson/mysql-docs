...
produce [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"),
[`TIME`](time.html "11.2.3 The TIME Type"), and
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values, respectively,
including a trailing fractional seconds part if specified. The
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") syntax produces a
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value in MySQL because
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") has a range that more
closely corresponds to the standard SQL
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") type, which has a
year range from `0001` to
`9999`. (The MySQL
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") year range is
`1970` to `2038`.)

#### String and Numeric Literals in Date and Time Context

MySQL recognizes [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values in
these formats:
...
* As a string in either
  ...
  date parts. For example, `'2012-12-31'`,
  `'2012/12/31'`,
  `'2012^12^31'`, and
...
MySQL recognizes [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") and
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") values in these
formats:
...
A [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") or
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value can include a
...
See also [Section 11.2.10, “2-Digit Years in Dates”](two-digit-years.html "11.2.10 2-Digit Years in Dates").
...
MySQL recognizes [`TIME`](time.html "11.2.3 The TIME Type") values in
these formats:
...
For [`TIME`](time.html "11.2.3 The TIME Type") values specified as

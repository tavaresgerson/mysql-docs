...
[`SELECT ... INTO
OUTFILE`](select-into.html "13.2.9.1 SELECT ... INTO Statement"), `NULL` is represented by the
`\N` sequence. See [Section 13.2.6, “LOAD DATA Statement”](load-data.html "13.2.6 LOAD DATA Statement").

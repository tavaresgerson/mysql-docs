...
[Section 10.3.7, “The National Character Set”](charset-national.html "10.3.7 The National Character Set"), and
...
shown in [Table 9.1, “Special Character Escape Sequences”](string-literals.html#character-escape-sequences "Table 9.1 Special Character Escape Sequences"). For all
...
discussed in [Section 10.3.6, “Character String Literal Character Set and Collation”](charset-literal.html "10.3.6 Character String Literal Character Set and Collation").
...
[Section 12.8.1, “String Comparison Functions and Operators”](string-comparison-functions.html "12.8.1 String Comparison Functions and Operators"). If you use
`\%` or `\_` outside of
...
The following [`SELECT`](select.html "13.2.9 SELECT Statement") statements
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") column), you should
...
The [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client truncates quoted strings
...
[Table 9.1, “Special Character Escape Sequences”](string-literals.html#character-escape-sequences "Table 9.1 Special Character Escape Sequences").
...
* Process the string with a function that escapes the special
  ...
  [`mysql_real_escape_string_quote()`](/doc/c-api/5.7/en/mysql-real-escape-string-quote.html)
  C API function to escape characters. See
  [mysql\_real\_escape\_string\_quote()](/doc/c-api/5.7/en/mysql-real-escape-string-quote.html). Within SQL
  ...
  sequences. See [Section 27.9, “MySQL Perl API”](apis-perl.html "27.9 MySQL Perl API"). Other language

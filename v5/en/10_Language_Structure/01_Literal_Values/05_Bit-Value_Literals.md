...
see [Section 10.3.8, “Character Set Introducers”](charset-introducer.html "10.3.8 Character Set Introducers").
...
assigned to [`BIT`](bit-type.html "11.1.5 Bit-Value Type - BIT") columns:
...
[`BIN()`](string-functions.html#function_bin) or
[`HEX()`](string-functions.html#function_hex). High-order 0 digits are

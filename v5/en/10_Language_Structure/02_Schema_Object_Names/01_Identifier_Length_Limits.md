...
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statements are checked against the maximum column
...
`_ibfk_` and a number. If the table name is
...
NDB Cluster imposes a maximum length of 63 characters for names
of databases and tables. See

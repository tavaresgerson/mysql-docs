...
* The syntax
  `.tbl_name`
  means the table *`tbl_name`* in the
  default database.

  Note

  This syntax is deprecated as of MySQL 5.7.20; expect it to
...
* A column name may be given multiple qualifiers to indicate
  ...
  <table summary="Column reference formats that can be used to refer to table columns."><col style="width: 35%"/><col style="width: 65%"/><thead><tr>

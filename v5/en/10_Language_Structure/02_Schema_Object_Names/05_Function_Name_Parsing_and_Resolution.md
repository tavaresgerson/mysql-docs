...
* With [`IGNORE_SPACE`](sql-mode.html#sqlmode_ignore_space)
  ...
  [Section 9.3, “Keywords and Reserved Words”](keywords.html "9.3 Keywords and Reserved Words")). This means that a space
...
Check [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes"), to see which composite modes
...
* Loadable functions and stored functions
  ...
  Loadable functions and stored functions share the same
  namespace, so you cannot create a loadable function and a
  stored function with the same name.
...
* If you have already created a loadable function with a
  ...
  [`DROP FUNCTION`](drop-function.html "13.1.24 DROP FUNCTION Statement") to drop the
  loadable function and [`CREATE
  FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement") to re-create the loadable function with

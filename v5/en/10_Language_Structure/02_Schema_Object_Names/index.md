...
[9.2.1 Identifier Length Limits](identifier-length.html)

[9.2.2 Identifier Qualifiers](identifier-qualifiers.html)

[9.2.3 Identifier Case Sensitivity](identifier-case-sensitivity.html)

[9.2.4 Mapping of Identifiers to File Names](identifier-mapping.html)

[9.2.5 Function Name Parsing and Resolution](function-resolution.html)
...
describes the permissible syntax for identifiers in MySQL.
[Section 9.2.1, “Identifier Length Limits”](identifier-length.html "9.2.1 Identifier Length Limits"), indicates the maximum length
of each type of identifier.
[Section 9.2.3, “Identifier Case Sensitivity”](identifier-case-sensitivity.html "9.2.3 Identifier Case Sensitivity"), describes which
...
words are listed at [Section 9.3, “Keywords and Reserved Words”](keywords.html "9.3 Keywords and Reserved Words").
...
The [`ANSI_QUOTES`](sql-mode.html#sqlmode_ansi_quotes) mode causes the
...
as described in [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").
...
Be careful when using [`MD5()`](encryption-functions.html#function_md5) to
...
[Section 9.4, “User-Defined Variables”](user-variables.html "9.4 User-Defined Variables"), for more information and
...
[Section 9.2.4, “Mapping of Identifiers to File Names”](identifier-mapping.html "9.2.4 Mapping of Identifiers to File Names"). If you have databases or

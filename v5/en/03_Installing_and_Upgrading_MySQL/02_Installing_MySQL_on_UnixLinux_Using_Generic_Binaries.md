...
To install a compressed **tar** file binary distribution, unpack it at the installation location you choose (typically `/usr/local/mysql`). This creates the
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>bin</code></td>
      <td>mysqld server, client and utility programs</td>
    </tr>
    <tr>

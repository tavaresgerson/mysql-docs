...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns, which contribute only
9 to 12 bytes toward this size. For
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") data, the information is
...
information, see [Chapter 15, *Alternative Storage Engines*](storage-engines.html "Chapter 15 Alternative Storage Engines"), and
...
See [Section 14.11, “InnoDB Row Formats”](innodb-row-format.html "14.11 InnoDB Row Formats") for information about
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables use
4-byte alignment; all
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") data storage is done in
multiples of 4 bytes. Thus, a column value that would
typically take 15 bytes requires 16 bytes in an
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") table. For example, in
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables, the
...
([`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")) column types each require
4 bytes storage per record due to the alignment factor.

Each `BIT(M)`
column takes *`M`* bits of storage
space. Although an individual
[`BIT`](bit-type.html "11.1.5 Bit-Value Type - BIT") column is
*not* 4-byte aligned,
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") reserves 4 bytes (32 bits)
...
storage space, [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") reserves 4
...
Every table using the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage
engine requires a primary key; if you do not define a primary
key, a “hidden” primary key is created by
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6"). This hidden primary key
consumes 31-35 bytes per table record.

You can use the [**ndb\_size.pl**](mysql-cluster-programs-ndb-size-pl.html "21.5.28 ndb_size.pl — NDBCLUSTER Size Requirement Estimator") Perl script to
estimate [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage requirements.
...
if it used the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine.
See [Section 21.5.28, “ndb\_size.pl — NDBCLUSTER Size Requirement Estimator”](mysql-cluster-programs-ndb-size-pl.html "21.5.28 ndb_size.pl — NDBCLUSTER Size Requirement Estimator") for
more information.
...
[`NUMERIC`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC")) columns are represented
...
For [`TIME`](time.html "11.2.3 The TIME Type"),
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), and
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns, the storage
...
<th>Data Type</th>
<th>Storage Required Before MySQL 5.6.4</th>
<th>Storage Required as of MySQL 5.6.4</th>
</tr></thead><tbody><tr>
...
[`YEAR`](year.html "11.2.4 The YEAR Type") and
[`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") remains unchanged. However,
[`TIME`](time.html "11.2.3 The TIME Type"),
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), and
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") are represented
differently. [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") is packed
...
For example, [`TIME(0)`](time.html "11.2.3 The TIME Type"),
[`TIME(2)`](time.html "11.2.3 The TIME Type"),
[`TIME(4)`](time.html "11.2.3 The TIME Type"), and
[`TIME(6)`](time.html "11.2.3 The TIME Type") use 3, 4, 5, and 6 bytes,
respectively. [`TIME`](time.html "11.2.3 The TIME Type") and
[`TIME(0)`](time.html "11.2.3 The TIME Type") are equivalent and
...
[`MEDIUMTEXT`](blob.html "11.3.4 The BLOB and TEXT Types") value requires
...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") column value, you must take
...
can be stored in a [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") or
[`VARBINARY`](binary-varbinary.html "11.3.3 The BINARY and VARBINARY Types") column is subject to
the maximum row size of 65,535 bytes, which is shared among all
columns. For a [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") column
...
bytes per character, so a [`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types")
column that uses the `utf8mb3` character set
...
The [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine supports
variable-width columns. This means that a
[`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") column in an NDB Cluster
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types"), and
[`JSON`](json.html "11.5 The JSON Data Type") columns are implemented
differently in the [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage
...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") column is 256 if
*`size`* <= 256 (where
...
65,535 possible values. See [Section 11.3.5, “The ENUM Type”](enum.html "11.3.5 The ENUM Type").

The size of a [`SET`](set.html "11.3.6 The SET Type") object is
...
[`SET`](set.html "11.3.6 The SET Type") can have a maximum of 64
members. See [Section 11.3.6, “The SET Type”](set.html "11.3.6 The SET Type").
...
values, see [Section 11.4.3, “Supported Spatial Data Formats”](gis-data-formats.html "11.4.3 Supported Spatial Data Formats").

### JSON Storage Requirements

In general, the storage requirement for a
[`JSON`](json.html "11.5 The JSON Data Type") column is approximately the

...
* With [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement"):

  ```sql
  CREATE TABLE geom (g GEOMETRY NOT NULL, SPATIAL INDEX(g));
  ```

* With [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"):
...
* With [`CREATE INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"):
...
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") or [`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement"):
...
* With [`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement"):

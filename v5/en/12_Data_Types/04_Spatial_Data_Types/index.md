...
[`ARCHIVE`](archive-storage-engine.html "15.5 The ARCHIVE Storage Engine") tables. For indexing spatial
...
[Section 12.16, “Spatial Analysis Functions”](spatial-analysis-functions.html "12.16 Spatial Analysis Functions").
...
* The OpenGIS function [`Length()`](string-functions.html#function_length)
  on `LineString` and
  `MultiLineString` should be called in MySQL
  as [`ST_Length()`](gis-linestring-property-functions.html#function_st-length)
...
<http://www.opengeospatial.org/>. The specification

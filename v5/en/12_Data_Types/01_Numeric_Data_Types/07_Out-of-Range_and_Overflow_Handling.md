...
for [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"),
[`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement"),
[`UPDATE`](update.html "13.2.11 UPDATE Statement"), and multiple-row
[`INSERT`](insert.html "13.2.5 INSERT Statement") statements. In strict
...
[`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") value is
...
[`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") values have a larger
range than integers:

...
mode is enabled. See [Section 12.10, “Cast Functions and Operators”](cast-functions.html "12.10 Cast Functions and Operators").

* [`BIT[(M)]`](bit-type.html "11.1.5 Bit-Value Type - BIT")
...
* [`TINYINT[(M)]
  [UNSIGNED] [ZEROFILL]`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
...
* [`BOOL`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"),
  [`BOOLEAN`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")

  These types are synonyms for
  [`TINYINT(1)`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"). A value of zero
...
* [`INTEGER[(M)]
  ...
  [`INT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT").
...
* [`BIGINT[(M)]
  ...
  [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") columns:

  + All arithmetic is done using signed
    [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") or
    [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") values, so you
    ...
    [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") value to a
    [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE").

    MySQL can handle [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
    in the following cases:

    - When using integers to store large unsigned values
      in a [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column.
    ...
    - In
      ...
      a [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column.
  ...
  + You can always store an exact integer value in a
    [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") column by storing
  ...
  + The [`-`](arithmetic-functions.html#operator_minus),
    ...
    [`*`](arithmetic-functions.html#operator_times)
    operators use [`BIGINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT")
...
* [`DECIMAL[(M[,D])]
  [UNSIGNED] [ZEROFILL]`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC")
  ...
  *`D`* is 0, values have no decimal
  ...
  (*`M`*) for
  [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") is 65. The maximum
  ...
  text of [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") literals can
  be; see [Section 12.21.3, “Expression Handling”](precision-math-expressions.html "12.21.3 Expression Handling").)

  `UNSIGNED`, if specified, disallows
  negative values.

  All basic calculations (`+, -, *, /`) with
  [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") columns are done with
...
* [`DEC[(M[,D])]
  ...
  These types are synonyms for
  [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC"). The
  [`FIXED`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") synonym is available
  for compatibility with other database systems.

* [`FLOAT[(M,D)]
  [UNSIGNED] [ZEROFILL]`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE")
  ...
  *`M`* is the total number of digits
  ...
  Using [`FLOAT`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") might give you
...
* [`FLOAT(p)
  ...
  [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") for the resulting data
  type. If *`p`* is from 0 to 24, the
  data type becomes [`FLOAT`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") with
  no *`M`* or
  *`D`* values. If
  *`p`* is from 25 to 53, the data type
  becomes [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") with no
  *`M`* or *`D`*
  values. The range of the resulting column is the same as for
  the single-precision [`FLOAT`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") or
  double-precision [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") data
  types described earlier in this section.

  [`FLOAT(p)`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE")
...
* [`DOUBLE
  ...
  These types are synonyms for
  [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE"). Exception: If the
  [`REAL_AS_FLOAT`](sql-mode.html#sqlmode_real_as_float) SQL mode is
  enabled, [`REAL`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") is a synonym
  for [`FLOAT`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE") rather than
  [`DOUBLE`](floating-point-types.html "11.1.4 Floating-Point Types (Approximate Value) - FLOAT, DOUBLE").
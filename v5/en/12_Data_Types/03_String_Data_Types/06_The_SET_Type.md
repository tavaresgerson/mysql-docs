...
A [`SET`](set.html "11.3.6 The SET Type") column can have a maximum
...
See [String Type Storage Requirements](storage-requirements.html#data-types-storage-reqs-strings "String Type Storage Requirements") for
storage requirements for the [`SET`](set.html "11.3.6 The SET Type")
type.

See [Section 11.3.1, “String Data Type Syntax”](string-type-syntax.html "11.3.1 String Data Type Syntax") for
[`SET`](set.html "11.3.6 The SET Type") type syntax and length
limits.
...
<table summary="Decimal and binary values for members of a column specified as SET('a','b','c','d')."><col style="width: 15%"/><col style="width: 20%"/><col style="width: 20%"/><thead><tr>
<th><code>SET</code> Member</th>
<th>Decimal Value</th>
<th>Binary Value</th>
</tr></thead><tbody><tr>
<th><code>'a'</code></th>
...
[`FIND_IN_SET()`](string-functions.html#function_find-in-set) function or the

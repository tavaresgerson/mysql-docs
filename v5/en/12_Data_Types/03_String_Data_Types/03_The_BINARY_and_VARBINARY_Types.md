...
types are similar to [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") and
[`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"), except that they store
...
is for [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types") and
[`VARCHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"), except that the length
...
`latin1`, `CHAR(5) BINARY` is
treated as `CHAR(5) CHARACTER SET latin1 COLLATE
latin1_bin`. This differs from
...
see [Section 10.8.5, “The binary Collation Compared to \_bin Collations”](charset-binary-collations.html "10.8.5 The binary Collation Compared to _bin Collations").
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") data types instead.

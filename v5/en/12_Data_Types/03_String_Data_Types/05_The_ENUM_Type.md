...
See [Section 11.3.1, “String Data Type Syntax”](string-type-syntax.html "11.3.1 String Data Type Syntax") for
[`ENUM`](enum.html "11.3.5 The ENUM Type") type syntax and length
limits.

The [`ENUM`](enum.html "11.3.5 The ENUM Type") type has these
advantages:
...
* Compact data storage in situations where a column has a
  ...
  [Section 11.7, “Data Type Storage Requirements”](storage-requirements.html "11.7 Data Type Storage Requirements") for storage
...
* If you make enumeration values that look like numbers, it is
  ...
  numbers, as explained in [Enumeration Limitations](enum.html#enum-limits "Enumeration Limitations").

* Using `ENUM` columns in `ORDER
  BY` clauses requires extra care, as explained in
  [Enumeration Sorting](enum.html#enum-sorting "Enumeration Sorting").

* [Creating and Using ENUM Columns](enum.html#enum-using "Creating and Using ENUM Columns")
* [Index Values for Enumeration Literals](enum.html#enum-indexes "Index Values for Enumeration Literals")
* [Handling of Enumeration Literals](enum.html#enum-literals "Handling of Enumeration Literals")
* [Empty or NULL Enumeration Values](enum.html#enum-nulls "Empty or NULL Enumeration Values")
* [Enumeration Sorting](enum.html#enum-sorting "Enumeration Sorting")
* [Enumeration Limitations](enum.html#enum-limits "Enumeration Limitations")
...
* The index value of the empty string error value is 0. This
  ...
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement to find
...
<table summary="Possible values for a column specified as ENUM('Mercury', 'Venus', 'Earth'). The table also shows the index of each value."><col style="width: 15%"/><col style="width: 15%"/><thead><tr>
<th>Value</th>
<th>Index</th>
</tr></thead><tbody><tr>
...
[`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement"), which treats all
...
[`SHOW COLUMNS
FROM tbl_name LIKE
'enum_col'`](show-columns.html "13.7.5.5 SHOW COLUMNS Statement") and parse the
...
[C API Basic Data Structures](/doc/c-api/5.7/en/c-api-data-structures.html).
...
* If you insert an invalid value into an
  ...
  [Index Values for Enumeration Literals](enum.html#enum-indexes "Index Values for Enumeration Literals") for details about the
...
For example, this [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement")
...
[`TINYINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") or
[`SMALLINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") type, and it is easy
...
regarded as an index. See [Handling of Enumeration Literals](enum.html#enum-literals "Handling of Enumeration Literals") to

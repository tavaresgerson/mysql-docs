...
[`YEAR`](year.html "11.2.4 The YEAR Type"). Each temporal type has a
range of valid values, as well as a “zero” value that
may be used when you specify an invalid value that MySQL cannot
represent. The [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") and
[`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") types have special
...
* MySQL retrieves values for a given date or time type in a
  ...
  [Section 9.1.3, “Date and Time Literals”](date-and-time-literals.html "9.1.3 Date and Time Literals"). It is expected that
...
* By default, when MySQL encounters a value for a date or time
  ...
  [`TIME`](time.html "11.2.3 The TIME Type") values are clipped to the
  appropriate endpoint of the
  [`TIME`](time.html "11.2.3 The TIME Type") range.

* By setting the SQL mode to the appropriate value, you can
  specify more exactly what kind of dates you want MySQL to
  support. (See [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").) You can get MySQL
...
* MySQL permits you to store dates where the day or month and
  day are zero in a [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") or
  [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") column. This is useful
...
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types")), use of these values may
...
enabled; see [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").

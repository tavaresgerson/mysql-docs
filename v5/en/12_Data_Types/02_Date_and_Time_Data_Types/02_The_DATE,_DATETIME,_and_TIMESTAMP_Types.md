...
[Section 9.1.3, “Date and Time Literals”](date-and-time-literals.html "9.1.3 Date and Time Literals"). For the
...
are enabled; see [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").
...
* The server requires that month and day values be valid, and
  ...
  [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes"), for more information.
...
time. See [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").

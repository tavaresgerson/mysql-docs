...
* Inserting a [`TIME`](time.html "11.2.3 The TIME Type"),
  [`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), or
  [`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") value with a
  ...
  the server [`sql_mode`](server-system-variables.html#sysvar_sql_mode)
  setting.
...
* Functions that take temporal arguments accept values with
  ...
  [`NOW()`](date-and-time-functions.html#function_now) with no argument

...
For [`DATETIME`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"),
[`DATE`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types"), and
[`TIMESTAMP`](datetime.html "11.2.2 The DATE, DATETIME, and TIMESTAMP Types") types, MySQL interprets
...
[`YEAR`](year.html "11.2.4 The YEAR Type") values that have 2-digit
years.

Some functions like [`MIN()`](aggregate-functions.html#function_min) and
[`MAX()`](aggregate-functions.html#function_max) convert a
[`YEAR`](year.html "11.2.4 The YEAR Type") to a number. This means that
a value with a 2-digit year does not work properly with these
functions. The fix in this case is to convert the
[`YEAR`](year.html "11.2.4 The YEAR Type") to 4-digit year format.
...
use the [`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement") statement
to define the server connection parameters, just as you would
with the `CONNECTION` string.

The format of the [`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement")
statement is:
...
[`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement") statement.
...
SERVER`](create-server.html "13.1.17 CREATE SERVER Statement"), see [Section 13.1.17, “CREATE SERVER Statement”](create-server.html "13.1.17 CREATE SERVER Statement").

The [`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement") statement
accepts the same arguments as the `CONNECTION`
string. The [`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement")
...
SERVER`](create-server.html "13.1.17 CREATE SERVER Statement") statement, and the columns in the
...
<th><code>CREATE SERVER</code> option</th>

...
[15.8.2.1 Creating a FEDERATED Table Using CONNECTION](federated-create-connection.html)

[15.8.2.2 Creating a FEDERATED Table Using CREATE SERVER](federated-create-server.html)
...
For creating the local table to be federated to the remote table,
...
`WHERE` clause, and is sent to the remote

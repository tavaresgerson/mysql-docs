...
[15.1 Setting the Storage Engine](storage-engine-setting.html)

[15.2 The MyISAM Storage Engine](myisam-storage-engine.html)
...
[15.3 The MEMORY Storage Engine](memory-storage-engine.html)

[15.4 The CSV Storage Engine](csv-storage-engine.html)
:   [15.4.1 Repairing and Checking CSV Tables](se-csv-repair.html)

    [15.4.2 CSV Limitations](se-csv-limitations.html)

[15.5 The ARCHIVE Storage Engine](archive-storage-engine.html)

[15.6 The BLACKHOLE Storage Engine](blackhole-storage-engine.html)

[15.7 The MERGE Storage Engine](merge-storage-engine.html)
:   [15.7.1 MERGE Table Advantages and Disadvantages](merge-table-advantages.html)

    [15.7.2 MERGE Table Problems](merge-table-problems.html)

[15.8 The FEDERATED Storage Engine](federated-storage-engine.html)
...
[15.9 The EXAMPLE Storage Engine](example-storage-engine.html)

[15.10 Other Storage Engines](storage-engines-other.html)

[15.11 Overview of MySQL Storage Engine Architecture](pluggable-storage-overview.html)
:   [15.11.1 Pluggable Storage Engine Architecture](pluggable-storage.html)

    [15.11.2 The Common Database Server Layer](pluggable-storage-common-layer.html)

Storage engines are MySQL components that handle the SQL operations
for different table types. [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") is
...
(The [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement in MySQL
...
[`SHOW ENGINES`](show-engines.html "13.7.5.16 SHOW ENGINES Statement") statement. The value in
...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") storage engine or the
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine which are covered in
[Chapter 14, *The InnoDB Storage Engine*](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine"), and
[Chapter 21, *MySQL NDB Cluster 7.5 and NDB Cluster 7.6*](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6"). For advanced users, this chapter
also contains a description of the pluggable storage engine
architecture (see [Section 15.11, “Overview of MySQL Storage Engine Architecture”](pluggable-storage-overview.html "15.11 Overview of MySQL Storage Engine Architecture")).
...
see [Section A.2, “MySQL 5.7 FAQ: Storage Engines”](faqs-storage-engines.html "A.2 MySQL 5.7 FAQ: Storage Engines").
...
* [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine"):
  ...
  [Chapter 14, *The InnoDB Storage Engine*](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine").
...
* [`CSV`](csv-storage-engine.html "15.4 The CSV Storage Engine"):
...
* [`Archive`](archive-storage-engine.html "15.5 The ARCHIVE Storage Engine"):
...
* [`Blackhole`](blackhole-storage-engine.html "15.6 The BLACKHOLE Storage Engine"):
...
* [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") (also known as
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")): This clustered
...
* [`Merge`](merge-storage-engine.html "15.7 The MERGE Storage Engine"):
...
* [`Federated`](federated-storage-engine.html "15.8 The FEDERATED Storage Engine"):
...
* [`Example`](example-storage-engine.html "15.9 The EXAMPLE Storage Engine"):
...
<table frame="box" rules="all" summary="Summary of features supported per storage engine."><col style="width: 10%"/><col style="width: 16%"/><col style="width: 16%"/><col style="width: 16%"/><col style="width: 16%"/><col style="width: 16%"/><thead><tr><th>Feature</th>
<th>MyISAM</th>
<th>Memory</th>
<th>InnoDB</th>
<th>Archive</th>
<th>NDB</th>
</tr></thead><tbody><tr><th>B-tree indexes</th>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
<td>No</td>
<td>No</td>
</tr><tr><th>Backup/point-in-time recovery (note 1)</th>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
</tr><tr><th>Cluster database support</th>
<td>No</td>
<td>No</td>
<td>No</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Clustered indexes</th>
<td>No</td>
<td>No</td>
<td>Yes</td>
<td>No</td>
<td>No</td>
</tr><tr><th>Compressed data</th>
<td>Yes (note 2)</td>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
<td>No</td>
</tr><tr><th>Data caches</th>
<td>No</td>
<td>N/A</td>
<td>Yes</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Encrypted data</th>
<td>Yes (note 3)</td>
<td>Yes (note 3)</td>
<td>Yes (note 4)</td>
<td>Yes (note 3)</td>
<td>Yes (note 5)</td>
</tr><tr><th>Foreign key support</th>
<td>No</td>
<td>No</td>
<td>Yes</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Full-text search indexes</th>
<td>Yes</td>
<td>No</td>
<td>Yes (note 6)</td>
<td>No</td>
<td>No</td>
</tr><tr><th>Geospatial data type support</th>
<td>Yes</td>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
</tr><tr><th>Geospatial indexing support</th>
<td>Yes</td>
<td>No</td>
<td>Yes (note 7)</td>
<td>No</td>
<td>No</td>
</tr><tr><th>Hash indexes</th>
<td>No</td>
<td>Yes</td>
<td>No (note 8)</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Index caches</th>
<td>Yes</td>
<td>N/A</td>
<td>Yes</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Locking granularity</th>
<td>Table</td>
<td>Table</td>
<td>Row</td>
<td>Row</td>
...
<td>No</td>
<td>No</td>
</tr><tr><th>Replication support (note 1)</th>
<td>Yes</td>
<td>Limited (note 9)</td>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
</tr><tr><th>Storage limits</th>
<td>256TB</td>
<td>RAM</td>
<td>64TB</td>
<td>None</td>
<td>384EB</td>
</tr><tr><th>T-tree indexes</th>
<td>No</td>
<td>No</td>
<td>No</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Transactions</th>
<td>No</td>
<td>No</td>
<td>Yes</td>
<td>No</td>
<td>Yes</td>
</tr><tr><th>Update statistics for data dictionary</th>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>
<td>Yes</td>

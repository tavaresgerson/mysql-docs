...
compressed with [**myisampack**](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"). See
[Section 4.6.5, “myisampack — Generate Compressed, Read-Only MyISAM Tables”](myisampack.html "4.6.5 myisampack — Generate Compressed, Read-Only MyISAM Tables"). Differences between tables such as
these do not matter:
...
You can use [`SELECT`](select.html "13.2.9 SELECT Statement"),
[`DELETE`](delete.html "13.2.2 DELETE Statement"),
[`UPDATE`](update.html "13.2.11 UPDATE Statement"), and
[`INSERT`](insert.html "13.2.5 INSERT Statement") on `MERGE`
tables. You must have [`SELECT`](privileges-provided.html#priv_select),
[`DELETE`](privileges-provided.html#priv_delete), and
[`UPDATE`](privileges-provided.html#priv_update) privileges on the
...
Use of [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") with a
...
* Use `ALTER TABLE tbl_name
  ...
  [`UNION`](union.html "13.2.9.3 UNION Clause") clause) to remove all of
  ...
  with [`CREATE
  TABLE ... LIKE`](create-table-like.html "13.1.18.3 CREATE TABLE ... LIKE Statement").
...
TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") displays information about which table caused the
problem.

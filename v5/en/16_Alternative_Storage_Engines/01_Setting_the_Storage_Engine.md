...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") in MySQL 5.7. You
...
with [`CREATE
TEMPORARY TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") can be set separately from the engine
...
See [Section 13.1.18, “CREATE TABLE Statement”](create-table.html "13.1.18 CREATE TABLE Statement"), and
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") cannot use the default
...
altered. See [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").

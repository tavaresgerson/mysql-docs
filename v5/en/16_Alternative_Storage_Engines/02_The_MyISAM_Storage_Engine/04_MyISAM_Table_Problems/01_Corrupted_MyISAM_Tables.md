...
* The [`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") process is killed in the
  middle of a write.
...
* You are using an external program (such as
  [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility")) to modify a table that is
...
using the [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") statement,
and repair a corrupted `MyISAM` table with
[`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement"). When
[`mysqld`](mysqld.html "4.3.1 mysqld — The MySQL Server") is not running, you can also check or
repair a table with the [**myisamchk**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") command.
See [Section 13.7.2.2, “CHECK TABLE Statement”](check-table.html "13.7.2.2 CHECK TABLE Statement"),
[Section 13.7.2.5, “REPAIR TABLE Statement”](repair-table.html "13.7.2.5 REPAIR TABLE Statement"), and [Section 4.6.3, “myisamchk — MyISAM Table-Maintenance Utility”](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility").
...
demonstrates the problem. See [Section B.3.3.3, “What to Do If MySQL Keeps Crashing”](crashing.html "B.3.3.3 What to Do If MySQL Keeps Crashing"), and

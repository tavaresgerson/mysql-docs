...
[`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types")), or if the table was
...
You can use [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") or
[**myisamchk -r**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to defragment a table. If you
...
* Each row uses only as much space as is required. However, if
  ...
  have to run [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") or
  [**myisamchk -r**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") from time to time to improve
  performance. Use [**myisamchk -ei**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility") to obtain
  table statistics.
...
* The expected row length for dynamic-sized rows is calculated
  ...
  [**myisamchk -ed**](myisamchk.html "4.6.3 myisamchk — MyISAM Table-Maintenance Utility"). All links may be removed
  with [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") or

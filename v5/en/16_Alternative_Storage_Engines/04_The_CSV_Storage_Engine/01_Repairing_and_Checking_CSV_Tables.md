...
[`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement") statements to verify
and, if possible, repair a damaged `CSV` table.

When running the [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement")
...
row discovered reports an error. Checking a valid table produces
...
TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement"), which copies as many valid rows from the existing

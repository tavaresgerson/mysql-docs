...
The [`DECLARE
... CONDITION`](declare-condition.html "13.6.7.1 DECLARE ... CONDITION Statement") statement declares a named error
...
[`DECLARE ...
CONDITION`](declare-condition.html "13.6.7.1 DECLARE ... CONDITION Statement") indicates the specific condition or class of
...
[`SIGNAL`](signal.html "13.6.7.5 SIGNAL Statement") or use
[`RESIGNAL`](resignal.html "13.6.7.4 RESIGNAL Statement") statements must be

...
* A handler declared in a
  [`BEGIN ...
  END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block is in scope only for the SQL statements
...
[`BEGIN ...
END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block). If there are no applicable handlers, the
...
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") statement raises a
...
the [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") statement and
...
TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") statement:
...
to the scope of the [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement")
statement:
...
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement"). The condition raised

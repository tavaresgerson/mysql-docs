...
The [`DECLARE ...
HANDLER`](declare-handler.html "13.6.7.2 DECLARE ... HANDLER Statement") statement specifies a handler that deals with
...
`END` (see [Section 13.6.1, “BEGIN ... END Compound Statement”](begin-end.html "13.6.1 BEGIN ... END Compound Statement")).
...
* `EXIT`: Execution terminates for the
  [`BEGIN ...
  END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") compound statement in which the handler is
...
[`DECLARE ...
HANDLER`](declare-handler.html "13.6.7.2 DECLARE ... HANDLER Statement") indicates the specific condition or class of
...
* *`mysql_error_code`*: An integer
  ...
  codes, see [Server Error Message Reference](/doc/mysql-errors/5.7/en/server-error-reference.html).
...
* SQLSTATE [VALUE] *`sqlstate_value`*:
  ...
  values, see [Server Error Message Reference](/doc/mysql-errors/5.7/en/server-error-reference.html).

* *`condition_name`*: A condition name
  previously specified with
  [`DECLARE
  ... CONDITION`](declare-condition.html "13.6.7.1 DECLARE ... CONDITION Statement"). A condition name can be associated
...
* `NOT FOUND`: Shorthand for the class of
  ...
  For another example, see [Section 13.6.6, “Cursors”](cursors.html "13.6.6 Cursors"). The
...
* For `NOT FOUND` conditions, if the
  ...
  [`RESIGNAL`](resignal.html "13.6.7.4 RESIGNAL Statement"), the action is
  `EXIT`.
...
[`DECLARE ...
HANDLER`](declare-handler.html "13.6.7.2 DECLARE ... HANDLER Statement") statement had not been present, MySQL would
have taken the default action (`EXIT`) after
the second [`INSERT`](insert.html "13.2.5 INSERT Statement") failed due to
...
[`ITERATE`](iterate.html "13.6.5.3 ITERATE Statement") or
[`LEAVE`](leave.html "13.6.5.4 LEAVE Statement") to refer to labels for
blocks that enclose the handler declaration. Consider the
following example, where the
[`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement") block has a label of
`retry`:
...
[`IF`](if.html "13.6.5.2 IF Statement") statement within the block. It
...
* To leave the block, use an `EXIT` handler.
  ...
  [`BEGIN ...
  END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") handler body can be empty:

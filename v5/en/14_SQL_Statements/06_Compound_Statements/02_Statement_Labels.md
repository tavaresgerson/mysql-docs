...
blocks and for the [`LOOP`](loop.html "13.6.5.5 LOOP Statement"),
[`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement"), and
[`WHILE`](while.html "13.6.5.8 WHILE Statement") statements. Label use for
...
[`LEAVE`](leave.html "13.6.5.4 LEAVE Statement") statement. The following

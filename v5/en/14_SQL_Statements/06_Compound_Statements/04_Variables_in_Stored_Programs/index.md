...
* To declare local variables, use the
  [`DECLARE`](declare-local-variable.html "13.6.4.1 Local Variable DECLARE Statement")
...
* Results from queries can be retrieved into local variables
  using [`SELECT ...
  INTO var_list`](select-into.html "13.2.9.1 SELECT ... INTO Statement") or by
  opening a cursor and using
  [`FETCH ... INTO
  var_list`](fetch.html "13.6.6.3 Cursor FETCH Statement"). See
  [Section 13.2.9.1, “SELECT ... INTO Statement”](select-into.html "13.2.9.1 SELECT ... INTO Statement"), and [Section 13.6.6, “Cursors”](cursors.html "13.6.6 Cursors").

...
[`BEGIN ...
END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block within which it is declared. The variable
...
[`SELECT ...
INTO`](select.html "13.2.9 SELECT Statement") statement, contains a reference to a column and a
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement as a reference
...
contains a [`SELECT`](select.html "13.2.9 SELECT Statement") statement that

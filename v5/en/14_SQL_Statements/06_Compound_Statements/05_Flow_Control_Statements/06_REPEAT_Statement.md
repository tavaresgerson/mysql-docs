...
[`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement") statement is repeated
until the *`search_condition`* expression
is true. Thus, a [`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement") always
enters the loop at least once.
*`statement_list`* consists of one or
more statements, each terminated by a semicolon
(`;`) statement delimiter.

A [`REPEAT`](repeat.html "13.6.5.6 REPEAT Statement") statement can be

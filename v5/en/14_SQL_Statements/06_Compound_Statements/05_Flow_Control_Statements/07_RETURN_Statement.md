...
The [`RETURN`](return.html "13.6.5.7 RETURN Statement") statement terminates
execution of a stored function and returns the value
*`expr`* to the function caller. There
must be at least one [`RETURN`](return.html "13.6.5.7 RETURN Statement")
...
events. The [`LEAVE`](leave.html "13.6.5.4 LEAVE Statement") statement can

...
[`LOOP`](loop.html "13.6.5.5 LOOP Statement") implements a simple loop
...
[`LEAVE`](leave.html "13.6.5.4 LEAVE Statement") statement. Within a stored
function, [`RETURN`](return.html "13.6.5.7 RETURN Statement") can also be
used, which exits the function entirely.

Neglecting to include a loop-termination statement results in an
infinite loop.

A [`LOOP`](loop.html "13.6.5.5 LOOP Statement") statement can be labeled.

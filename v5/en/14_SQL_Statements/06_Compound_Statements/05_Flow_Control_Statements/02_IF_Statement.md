...
The [`IF`](if.html "13.6.5.2 IF Statement") statement for stored
...
[`IF`](if.html "13.6.5.2 IF Statement") statement can have
`THEN`, `ELSE`, and
...
constructs, including other [`IF`](if.html "13.6.5.2 IF Statement")
statements. Each [`IF`](if.html "13.6.5.2 IF Statement") must be
...
In this example, the inner [`IF`](if.html "13.6.5.2 IF Statement") is

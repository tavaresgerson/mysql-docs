...
The [`CASE`](case.html "13.6.5.1 CASE Statement") statement for stored
...
[Section 12.5, “Flow Control Functions”](flow-control-functions.html "12.5 Flow Control Functions"). The
...
is false. See [Section 3.3.4.6, “Working with NULL Values”](working-with-null.html "3.3.4.6 Working with NULL Values").
...
tested and the [`CASE`](case.html "13.6.5.1 CASE Statement") statement
...
containing an empty
[`BEGIN ...
END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block, as shown in this example. (The indentation

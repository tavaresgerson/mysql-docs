...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement associated with
...
[`BEGIN ...
END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") block so that it can be associated with its own
handler.
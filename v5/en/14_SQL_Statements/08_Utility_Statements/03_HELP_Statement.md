...
The [`HELP`](help.html "13.8.3 HELP Statement") statement returns online
...
The [`HELP`](help.html "13.8.3 HELP Statement") statement searches the
...
* For help on a specific help topic, such as the
  ...
  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement, use the

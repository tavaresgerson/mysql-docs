...
The [`USE`](use.html "13.8.4 USE Statement") statement tells MySQL to
...
session or another [`USE`](use.html "13.8.4 USE Statement") statement is
issued:
...
[`USE`](use.html "13.8.4 USE Statement") statement does not preclude

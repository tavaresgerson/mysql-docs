...
[`DO`](do.html "13.2.3 DO Statement") executes the expressions but
does not return any results. In most respects,
[`DO`](do.html "13.2.3 DO Statement") is shorthand for `SELECT
expr, ...`, but has the
advantage that it is slightly faster when you do not care about
the result.

[`DO`](do.html "13.2.3 DO Statement") is useful primarily with
functions that have side effects, such as
[`RELEASE_LOCK()`](locking-functions.html#function_release-lock).

Example: This [`SELECT`](select.html "13.2.9 SELECT Statement") statement
...
[`DO`](do.html "13.2.3 DO Statement"), on the other hand, pauses
...
[`DO`](do.html "13.2.3 DO Statement") only executes expressions. It

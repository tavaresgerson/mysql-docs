...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") is a DML statement that
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") statement updates columns of
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") updates rows in each table
...
[`REPLACE`](replace.html "13.2.8 REPLACE Statement") statement, an otherwise
...
syntax, see [Section 9.5, “Expressions”](expressions.html "9.5 Expressions").
...
for columns referenced in an [`UPDATE`](update.html "13.2.11 UPDATE Statement")
...
The [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement supports the
following modifiers:

* With the `LOW_PRIORITY` modifier, execution
  of the [`UPDATE`](update.html "13.2.11 UPDATE Statement") is delayed until
...
[`UPDATE IGNORE`](update.html "13.2.11 UPDATE Statement")
...
[Section 16.2.1.3, “Determination of Safe and Unsafe Statements in Binary Logging”](replication-rbr-safe-unsafe.html "16.2.1.3 Determination of Safe and Unsafe Statements in Binary Logging"), for more
information.

If you access a column from the table to be updated in an
expression, [`UPDATE`](update.html "13.2.11 UPDATE Statement") uses the current
...
Single-table [`UPDATE`](update.html "13.2.11 UPDATE Statement") assignments are
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") returns the number of rows
...
scope of the [`UPDATE`](update.html "13.2.11 UPDATE Statement"). A
...
If an [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement includes an
...
You can also perform [`UPDATE`](update.html "13.2.11 UPDATE Statement")
operations covering multiple tables. However, you cannot use
`ORDER BY` or `LIMIT` with a
multiple-table [`UPDATE`](update.html "13.2.11 UPDATE Statement"). The
*`table_references`* clause lists the
tables involved in the join. Its syntax is described in
[Section 13.2.9.2, “JOIN Clause”](join.html "13.2.9.2 JOIN Clause"). Here is an example:
...
operator, but multiple-table [`UPDATE`](update.html "13.2.11 UPDATE Statement")
statements can use any type of join permitted in
[`SELECT`](select.html "13.2.9 SELECT Statement") statements, such as
`LEFT JOIN`.

If you use a multiple-table [`UPDATE`](update.html "13.2.11 UPDATE Statement")

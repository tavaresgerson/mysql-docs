...
The subquery in this [`SELECT`](select.html "13.2.9 SELECT Statement")
returns a single value (`'abcde'`) that has a
data type of [`CHAR`](char.html "11.3.2 The CHAR and VARCHAR Types"), a length of 5,
a character set and collation equal to the defaults in effect at
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") time, and an
...
DATA`](load-data.html "13.2.6 LOAD DATA Statement") requires a literal string file name. You cannot

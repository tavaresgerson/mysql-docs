...
A subquery is a [`SELECT`](select.html "13.2.9 SELECT Statement") statement
...
[`SELECT`](select.html "13.2.9 SELECT Statement") can contain:
`DISTINCT`, `GROUP BY`,
`ORDER BY`, `LIMIT`, joins,
index hints, [`UNION`](union.html "13.2.9.3 UNION Clause") constructs,
...
[`SET`](set-variable.html "13.7.4.1 SET Syntax for Variable Assignment"), or
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement"), and (because subqueries can
...
[Section 8.2.2, “Optimizing Subqueries, Derived Tables, and View References”](subquery-optimization.html "8.2.2 Optimizing Subqueries, Derived Tables, and View References"). For a discussion of

...
example, a subquery in a [`SELECT`](select.html "13.2.9 SELECT Statement")
...
* A derived table cannot contain references to other tables of
  the same [`SELECT`](select.html "13.2.9 SELECT Statement").
...
such a way that [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") does not
...
[`EXPLAIN
SELECT`](explain.html "13.8.2 EXPLAIN Statement") modifies table data. This can occur if the
...
[`EXPLAIN
SELECT`](explain.html "13.8.2 EXPLAIN Statement") has no effect on `t2`, as
shown here:
...
This is because the [`SELECT`](select.html "13.2.9 SELECT Statement")
...
However, if the outer [`SELECT`](select.html "13.2.9 SELECT Statement")

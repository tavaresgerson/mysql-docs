...
[`BENCHMARK()`](information-functions.html#function_benchmark) function, you can get
...
* MySQL executes uncorrelated subqueries only once. Use
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") to make sure that a
...
* MySQL replaces subqueries of the following form with an
  ...
  [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") describes as a
  special join type
...
* MySQL enhances expressions of the following form with an
  expression involving [`MIN()`](aggregate-functions.html#function_min) or
  [`MAX()`](aggregate-functions.html#function_max), unless
...
See also
[MySQL
Internals: How MySQL Transforms Subqueries](/doc/internals/en/transformations.html).
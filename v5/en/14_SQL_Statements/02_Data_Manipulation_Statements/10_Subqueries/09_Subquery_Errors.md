...
* Incorrectly used table in subquery:
  ...
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") statement because
  subqueries are legal in
  [`UPDATE`](update.html "13.2.11 UPDATE Statement") and
  [`DELETE`](delete.html "13.2.2 DELETE Statement") statements as well as
  in [`SELECT`](select.html "13.2.9 SELECT Statement") statements.

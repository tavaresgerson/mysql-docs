...
[`DELETE`](delete.html "13.2.2 DELETE Statement") statements that can be
...
[`UPDATE`](update.html "13.2.11 UPDATE Statement") statements are also
supported. See [Section 13.2.2, “DELETE Statement”](delete.html "13.2.2 DELETE Statement"), and

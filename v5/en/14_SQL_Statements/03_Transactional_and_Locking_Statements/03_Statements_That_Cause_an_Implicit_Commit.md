...
if you had done a [`COMMIT`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") before
...
* **Data definition language (DDL)
  ...
  [`ALTER DATABASE
  ... UPGRADE DATA DIRECTORY NAME`](alter-database.html "13.1.1 ALTER DATABASE Statement"),
  ...
  [`ALTER SERVER`](alter-server.html "13.1.7 ALTER SERVER Statement"),
  ...
  [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement"),
  ...
  [`CREATE SERVER`](create-server.html "13.1.17 CREATE SERVER Statement"),
  ...
  [`DROP SERVER`](drop-server.html "13.1.28 DROP SERVER Statement"),
  ...
  [`DROP VIEW`](drop-view.html "13.1.32 DROP VIEW Statement"),
  ...
  [`CREATE FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement") and
  [`DROP FUNCTION`](drop-function.html "13.1.24 DROP FUNCTION Statement") also cause an
  implicit commit when used with stored functions, but not with
  loadable functions. ([`ALTER
  FUNCTION`](alter-function.html "13.1.3 ALTER FUNCTION Statement") can only be used with stored functions.)

  [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") and
  [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") statements do not
  ...
  INDEX`](create-index.html "13.1.14 CREATE INDEX Statement"), which do cause a commit.) However, although
  ...
  use [`CREATE
  TEMPORARY TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") and then roll back the transaction,
  the table remains in existence.

  The [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement in
  ...
  TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statements the user made during that
  transaction.

  [`CREATE TABLE ...
  SELECT`](create-table.html "13.1.18 CREATE TABLE Statement") causes an implicit commit before and after
...
* **Transaction-control and locking
  ...
  [`LOCK TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements"), `SET
  ...
  [`UNLOCK
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") commits a transaction only if any tables
  currently have been locked with [`LOCK
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") to acquire nontransactional table locks. A
  commit does not occur for
  [`UNLOCK
  TABLES`](lock-tables.html "13.3.5 LOCK TABLES and UNLOCK TABLES Statements") following [`FLUSH TABLES
  ...
  issue a [`START
  TRANSACTION`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") statement or one of its synonyms.

  Statements that cause an implicit commit cannot be used in an
  XA transaction while the transaction is in an
  `ACTIVE` state.

  The [`BEGIN`](commit.html "13.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
  statement differs from the use of the `BEGIN`
  keyword that starts a
  [`BEGIN ...
  END`](begin-end.html "13.6.1 BEGIN ... END Compound Statement") compound statement. The latter does not cause an
  implicit commit. See [Section 13.6.1, “BEGIN ... END Compound Statement”](begin-end.html "13.6.1 BEGIN ... END Compound Statement").

* **Data loading statements.**
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement").
  [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement") causes an implicit
...
* **Administrative statements.**
  ...
  [`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement"),
  [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement"),
  [`FLUSH`](flush.html "13.7.6.3 FLUSH Statement"),
  [`LOAD INDEX INTO
  CACHE`](load-index.html "13.7.6.5 LOAD INDEX INTO CACHE Statement"), [`OPTIMIZE
  TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement"), [`REPAIR TABLE`](repair-table.html "13.7.2.5 REPAIR TABLE Statement"),
  [`RESET`](reset.html "13.7.6.6 RESET Statement").

* **Replication control
  statements**. [`START
  SLAVE`](start-slave.html "13.4.2.5 START SLAVE Statement"), [`STOP SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement"),

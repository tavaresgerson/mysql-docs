...
[`GROUP_REPLICATION_ADMIN`](/doc/refman/8.0/en/privileges-provided.html#priv_group-replication-admin) or
[`SUPER`](privileges-provided.html#priv_super) privilege. As soon as you
issue [`STOP GROUP_REPLICATION`](stop-group-replication.html "13.4.3.2 STOP GROUP_REPLICATION Statement") the
member is set to

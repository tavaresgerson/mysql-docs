...
requires the [`SUPER`](privileges-provided.html#priv_super) privilege. If
[`super_read_only=ON`](server-system-variables.html#sysvar_super_read_only) and the
...
should use
[`skip_replica_start=ON`](/doc/refman/8.0/en/replication-options-replica.html#sysvar_skip_replica_start).

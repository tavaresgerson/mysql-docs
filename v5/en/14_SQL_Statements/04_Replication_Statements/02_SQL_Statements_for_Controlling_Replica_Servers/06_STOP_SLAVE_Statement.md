...
SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") requires the
[`SUPER`](privileges-provided.html#priv_super) privilege. Recommended best
practice is to execute `STOP SLAVE` on the
replica before stopping the replica server (see
[Section 5.1.16, “The Server Shutdown Process”](server-shutdown.html "5.1.16 The Server Shutdown Process"), for more information).
...
Like [`START SLAVE`](start-slave.html "13.4.2.5 START SLAVE Statement"), this statement
...
[`rpl_stop_slave_timeout`](replication-options-replica.html#sysvar_rpl_stop_slave_timeout) system
...
supported. See [Section 13.4.2.1, “CHANGE MASTER TO Statement”](change-master-to.html "13.4.2.1 CHANGE MASTER TO Statement"), and
[Section 16.3.7, “Switching Sources During Failover”](replication-solutions-switch.html "16.3.7 Switching Sources During Failover"), for more
information.
...
channel. See [Section 16.2.2, “Replication Channels”](replication-channels.html "16.2.2 Replication Channels") for more
information.
...
issuing [`KILL`](kill.html "13.7.6.4 KILL Statement")) while a
[`STOP SLAVE`](stop-slave.html "13.4.2.6 STOP SLAVE Statement") statement is
...
[`KILL QUERY`](kill.html "13.7.6.4 KILL Statement") or
[`KILL CONNECTION`](kill.html "13.7.6.4 KILL Statement")

...
The [`sql_log_bin`](replication-options-binary-log.html#sysvar_sql_log_bin) variable
...
session [`sql_log_bin`](replication-options-binary-log.html#sysvar_sql_log_bin) variable to
`OFF` or `ON`.
...
log*. If you are using GTIDs for replication, this
...
The global [`sql_log_bin`](replication-options-binary-log.html#sysvar_sql_log_bin) variable

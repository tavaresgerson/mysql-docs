...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") reorganizes the
...
Use [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") in these
...
* After deleting a large part of a `MyISAM`
  ...
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns). Deleted rows
  are maintained in a linked list and subsequent
  [`INSERT`](insert.html "13.2.5 INSERT Statement") operations reuse old
  row positions. You can use [`OPTIMIZE
  TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") to reclaim the unused space and to
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") works for
...
[`ARCHIVE`](archive-storage-engine.html "15.5 The ARCHIVE Storage Engine") tables.
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is also supported
for dynamic columns of in-memory
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables. It does not work for
...
of rows by [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement"). For
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") can be interrupted by (for example) killing the
SQL thread performing the `OPTIMIZE` operation.

By default, [`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") does
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") work for other storage engines by starting
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is just mapped to
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement").

This statement does not work with views.

[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is supported for
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") statements to the binary log so that they
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") returns a result
...
<td><code>Op</code></td>
<td>Always <code>optimize</code></td>
</tr><tr>
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") table catches
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") generates a
...
For `InnoDB` tables,
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is mapped to
[`ALTER TABLE ...
FORCE`](alter-table.html "13.1.8 ALTER TABLE Statement"), which rebuilds the table to update index
statistics and free unused space in the clustered index. This
is displayed in the output of [`OPTIMIZE
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") when you run it on an
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") uses
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is completed in place. An exclusive table lock
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") rebuilds the
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") using
[online DDL](innodb-online-ddl.html "14.13 InnoDB and Online DDL") is not
...
* Updates to rows usually rewrite the data within the same
  ...
  [Section 14.9.1.5, “How Compression Works for InnoDB Tables”](innodb-compression-internals.html "14.9.1.5 How Compression Works for InnoDB Tables") and
...
For `MyISAM` tables,
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") works as
follows:
...
[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is performed
...
TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") is running.

[`OPTIMIZE TABLE`](optimize-table.html "13.7.2.4 OPTIMIZE TABLE Statement") does not sort

...
The [`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") statement removes
...
enabled, [`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") additionally
...
[`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") does not
...
[`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") does not automatically

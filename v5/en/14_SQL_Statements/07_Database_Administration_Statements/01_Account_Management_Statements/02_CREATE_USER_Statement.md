...
The [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement creates
...
enabled, [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") additionally
...
exists. If the `IF NOT EXISTS` clause is given,
...
USER`](create-user.html "13.7.1.2 CREATE USER Statement") may be recorded in server logs or on the client
...
it, see [Section 6.1.2.3, “Passwords and Logging”](password-logging.html "6.1.2.3 Passwords and Logging"). For similar
...
USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement, described under the following topics:
...
For each account, [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement")
...
* Password management: `PASSWORD EXPIRE
  DEFAULT`
...
[`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") permits these
...
* `IDENTIFIED BY PASSWORD
  ...
  `IDENTIFIED BY PASSWORD` syntax is
...
[Section 6.2.10, “Assigning Account Passwords”](assigning-passwords.html "6.2.10 Assigning Account Passwords"), and
...
with MySQL, see [Section 6.3, “Using Encrypted Connections”](encrypted-connections.html "6.3 Using Encrypted Connections").
...
[`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") supports several

...
The [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement grants
privileges to MySQL user accounts. There are several aspects to
the [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement, described
...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement"), you must have the
...
enabled, [`GRANT`](grant.html "13.7.1.4 GRANT Statement") additionally
requires the [`SUPER`](privileges-provided.html#priv_super) privilege.

The [`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement") statement is related
to [`GRANT`](grant.html "13.7.1.4 GRANT Statement") and enables
...
[Section 6.2.4, “Specifying Account Names”](account-names.html "6.2.4 Specifying Account Names"). For example:
...
[`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") to create an
...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") to define its privileges.
[`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement") may be used to
...
[`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") at
account-creation time to avoid creating insecure accounts.

Note

If an account named in a
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement does not
already exist, [`GRANT`](grant.html "13.7.1.4 GRANT Statement") may
create it under the conditions described later in the
discussion of the
[`NO_AUTO_CREATE_USER`](sql-mode.html#sqlmode_no_auto_create_user) SQL
mode. It is also possible to use
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") to specify nonprivilege
account characteristics such as whether it uses secure
connections and limits on access to server resources.

However, use of [`GRANT`](grant.html "13.7.1.4 GRANT Statement") to
create accounts or define nonprivilege characteristics is
deprecated in MySQL 5.7. Instead, perform these
tasks using [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") or
[`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement").

From the [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") program,
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") responds with
`Query OK, 0 rows affected` when executed
successfully. To determine what privileges result from the
operation, use [`SHOW GRANTS`](show-grants.html "13.7.5.21 SHOW GRANTS Statement"). See
[Section 13.7.5.21, “SHOW GRANTS Statement”](show-grants.html "13.7.5.21 SHOW GRANTS Statement").

Important

Under some circumstances,
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") may be recorded in
...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") supports host names up to
...
Several objects within [`GRANT`](grant.html "13.7.1.4 GRANT Statement")
...
[Section 9.1.1, “String Literals”](string-literals.html "9.1.1 String Literals"), and
[Section 9.2, “Schema Object Names”](identifiers.html "9.2 Schema Object Names").

The `_` and `%` wildcards
are permitted when specifying database names in
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements that grant
...
in the [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement, to
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") client, this time as
...
be specified for the [`GRANT`](grant.html "13.7.1.4 GRANT Statement") and
[`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement") statements, and the
...
<td>Grant all privileges at specified access level except
                <code>GRANT OPTION</code> and
                <code>PROXY</code>.</td>
</tr><tr>
<td><code>ALTER</code></td>
<td>Enable use of <code>ALTER TABLE</code>. Levels:
...
<td>Enable use of <a class="link" href="create-table.html" title="13.1.18 CREATE TABLE Statement"><code>CREATE
                TEMPORARY TABLE</code></a>. Levels: Global, database.</td>
</tr><tr>
<td><code>CREATE USER</code></td>
<td>Enable use of <code>CREATE USER</code>,
                <code>DROP USER</code>,
                <code>RENAME USER</code>, and
                <a class="link" href="revoke.html" title="13.7.1.6 REVOKE Statement"><code>REVOKE ALL
...
<td>Enable use of <code>DELETE</code>. Level: Global,
                database, table.</td>
</tr><tr>
...
<td>Enable use of <code>INSERT</code>. Levels: Global,
                database, table, column.</td>
</tr><tr>
<td><code>LOCK TABLES</code></td>
<td>Enable use of <code>LOCK TABLES</code> on tables for
                which you have the <code>SELECT</code>
                privilege. Levels: Global, database.</td>
</tr><tr>
<td><code>PROCESS</code></td>
<td>Enable the user to see all processes with <a class="link" href="show-processlist.html" title="13.7.5.29 SHOW PROCESSLIST Statement"><code>SHOW
...
<td>Enable use of <code>FLUSH</code> operations. Level:
                Global.</td>
</tr><tr>
...
<td>Enable use of <code>SELECT</code>. Levels: Global,
                database, table, column.</td>
</tr><tr>
<td><code>SHOW DATABASES</code></td>
<td>Enable <code>SHOW DATABASES</code> to show all
                databases. Level: Global.</td>
</tr><tr>
<td><code>SHOW VIEW</code></td>
<td>Enable use of <code>SHOW CREATE VIEW</code>. Levels:
                Global, database, table.</td>
</tr><tr>
<td><code>SHUTDOWN</code></td>
<td>Enable use of <strong>mysqladmin shutdown</strong>. Level: Global.</td>
</tr><tr>
...
<td>Enable use of other administrative operations such as
                ...
                GLOBAL</code></a>, and <a class="link" href="mysqladmin.html" title="4.5.2 mysqladmin — A MySQL Server Administration Program"><span class="command"><strong>mysqladmin
...
<td>Enable use of <code>UPDATE</code>. Levels: Global,
                database, table, column.</td>
</tr><tr>
...
In [`GRANT`](grant.html "13.7.1.4 GRANT Statement") statements, the
[`ALL
...
[`USAGE`](privileges-provided.html#priv_usage) can be specified to
...
details, consult [Section 6.2, “Access Control and Account Management”](access-control.html "6.2 Access Control and Account Management"), which
...
[`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement") cannot be used to revoke
these privileges. It is necessary to manipulate the grant
tables directly. ([`GRANT`](grant.html "13.7.1.4 GRANT Statement") does
...
[`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement"), the same
`ON` syntax specifies which privileges to
remove.

For the global, database, table, and routine levels,
[`GRANT ALL`](grant.html "13.7.1.4 GRANT Statement")
...
A *`user`* value in a
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement indicates a
...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement:
...
values in account names, see [Section 6.2.4, “Specifying Account Names”](account-names.html "6.2.4 Specifying Account Names").
...
For [`GRANT`](grant.html "13.7.1.4 GRANT Statement") syntax that permits
...
for the [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement.
For details, see [Section 13.7.1.2, “CREATE USER Statement”](create-user.html "13.7.1.2 CREATE USER Statement").

Note

Use of [`GRANT`](grant.html "13.7.1.4 GRANT Statement") to define
...
[`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement"). Expect this
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") capability to be
removed in a future MySQL release.

When `IDENTIFIED` is present and you have the
global grant privilege ([`GRANT
OPTION`](privileges-provided.html#priv_grant-option)), any password specified becomes the new
...
[`SUPER`](privileges-provided.html#priv_super) privileges are
administrative and can only be granted globally.

Other privileges can be granted globally or at more specific
levels.

[`GRANT OPTION`](privileges-provided.html#priv_grant-option) granted at the
...
TEMPORARY TABLE`](create-temporary-table.html "13.1.18.2 CREATE TEMPORARY TABLE Statement"), even if the table names match. For
information about `TEMPORARY` table
privileges, see [Section 13.1.18.2, “CREATE TEMPORARY TABLE Statement”](create-temporary-table.html "13.1.18.2 CREATE TEMPORARY TABLE Statement").
...
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") statement, the
...
details and examples, see [Section 6.2.14, “Proxy Users”](proxy-users.html "6.2.14 Proxy Users").
...
If an account named in a [`GRANT`](grant.html "13.7.1.4 GRANT Statement")
statement does not exist, the action taken depends on the
[`NO_AUTO_CREATE_USER`](sql-mode.html#sqlmode_no_auto_create_user) SQL
mode:

* If [`NO_AUTO_CREATE_USER`](sql-mode.html#sqlmode_no_auto_create_user)
  is not enabled, [`GRANT`](grant.html "13.7.1.4 GRANT Statement")
  creates the account. *This is very
  insecure* unless you specify a nonempty password
  using `IDENTIFIED BY`.

* If [`NO_AUTO_CREATE_USER`](sql-mode.html#sqlmode_no_auto_create_user)
  is enabled, [`GRANT`](grant.html "13.7.1.4 GRANT Statement") fails and
...
MySQL, see [Section 6.3, “Using Encrypted Connections”](encrypted-connections.html "6.3 Using Encrypted Connections").

The optional `REQUIRE` clause specifies
SSL-related options for a MySQL account. The syntax is the
same as for the [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement")
statement. For details, see [Section 13.7.1.2, “CREATE USER Statement”](create-user.html "13.7.1.2 CREATE USER Statement").
...
USER`](create-user.html "13.7.1.2 CREATE USER Statement") or [`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement").
Expect this [`GRANT`](grant.html "13.7.1.4 GRANT Statement") capability
...
an account, as discussed in [Section 6.2.16, “Setting Account Resource Limits”](user-resources.html "6.2.16 Setting Account Resource Limits").
...
USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement. For details, see
...
limits using [`CREATE USER`](create-user.html "13.7.1.2 CREATE USER Statement") or
[`ALTER USER`](alter-user.html "13.7.1.1 ALTER USER Statement"). Expect this
[`GRANT`](grant.html "13.7.1.4 GRANT Statement") capability to be
removed in a future MySQL release.
...
versions of [`GRANT`](grant.html "13.7.1.4 GRANT Statement") are:
...
* Standard SQL privileges are structured in a hierarchical
  ...
  you use [`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement"). See
...
* In standard SQL, when you drop a table, all privileges for
  ...
  dropped with [`DROP USER`](drop-user.html "13.7.1.3 DROP USER Statement") or
  [`REVOKE`](revoke.html "13.7.1.6 REVOKE Statement") statements.
...
* In MySQL, it is possible to have the
  ...
  still execute [`INSERT`](insert.html "13.2.5 INSERT Statement")
  ...
  implicit default values, see [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes"),
  and [Section 11.6, “Data Type Default Values”](data-type-defaults.html "11.6 Data Type Default Values").
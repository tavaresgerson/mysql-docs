...
`mysql` system database. This database and the
access control system are discussed extensively in
[Chapter 5, *MySQL Server Administration*](server-administration.html "Chapter 5 MySQL Server Administration"), which you should consult
...
[`SUPER`](privileges-provided.html#priv_super) privilege, in addition to any

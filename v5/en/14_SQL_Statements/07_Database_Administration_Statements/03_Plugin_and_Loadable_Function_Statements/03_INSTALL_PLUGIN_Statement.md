...
library file (see [Plugin Data Structures](/doc/extending-mysql/5.7/en/plugin-data-structures.html)).
...
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") loads and
...
[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") also registers the
...
installed with [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement")
...
PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") statement. Each statement names a different
plugin, but all of them specify the same library name.

[`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") causes the server
...
startup, see [Section 5.5.1, “Installing and Uninstalling Plugins”](plugin-loading.html "5.5.1 Installing and Uninstalling Plugins"). If you need to
...
PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement") statement.
...
* Use [`UNINSTALL PLUGIN`](uninstall-plugin.html "13.7.3.4 UNINSTALL PLUGIN Statement") to
  uninstall all plugins in the library, install the new plugin
  library file in the plugin directory, and then use
  [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") to install all
  ...
  many [`INSTALL PLUGIN`](install-plugin.html "13.7.3.3 INSTALL PLUGIN Statement") and

...
[**mysqladmin shutdown**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program") command or the
[`mysql_shutdown()`](/doc/c-api/5.7/en/mysql-shutdown.html) C API function.
A successful [`SHUTDOWN`](shutdown.html "13.7.6.7 SHUTDOWN Statement") sequence
...
[`SHUTDOWN`](shutdown.html "13.7.6.7 SHUTDOWN Statement") statements. Because
...
[`SHUTDOWN`](shutdown.html "13.7.6.7 SHUTDOWN Statement") statements were executed
but failed.

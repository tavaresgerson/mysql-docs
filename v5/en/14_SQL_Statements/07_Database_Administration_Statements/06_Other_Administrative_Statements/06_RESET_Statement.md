...
The [`RESET`](reset.html "13.7.6.6 RESET Statement") statement is used to
...
[`RESET`](reset.html "13.7.6.6 RESET Statement") acts as a stronger version
of the [`FLUSH`](flush.html "13.7.6.3 FLUSH Statement") statement. See
[Section 13.7.6.3, “FLUSH Statement”](flush.html "13.7.6.3 FLUSH Statement").

The [`RESET`](reset.html "13.7.6.6 RESET Statement") statement causes an
...
[`RESET`](reset.html "13.7.6.6 RESET Statement") statement
*`reset_option`* values:
...
* `RESET QUERY CACHE`
  ...
  [`RESET QUERY
  CACHE`](reset.html "13.7.6.6 RESET Statement").

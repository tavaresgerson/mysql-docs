...
The [`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") statement assigns
...
[`LOAD INDEX INTO
CACHE`](load-index.html "13.7.6.5 LOAD INDEX INTO CACHE Statement").
...
The syntax of [`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") enables
...
[`CACHE INDEX`](cache-index.html "13.7.6.2 CACHE INDEX Statement") is supported for

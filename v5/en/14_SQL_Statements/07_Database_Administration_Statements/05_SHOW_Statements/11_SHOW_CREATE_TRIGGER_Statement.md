...
TRIGGER`](create-trigger.html "13.1.20 CREATE TRIGGER Statement") statement that creates the named trigger. This
...
[`SHOW CREATE TRIGGER`](show-create-trigger.html "13.7.5.11 SHOW CREATE TRIGGER Statement") output has
these columns:
...
* `SQL Original Statement`: The
  [`CREATE TRIGGER`](create-trigger.html "13.1.20 CREATE TRIGGER Statement") statement that
  defines the trigger.
...
`INFORMATION_SCHEMA`
[`TRIGGERS`](information-schema-triggers-table.html "24.3.29 The INFORMATION_SCHEMA TRIGGERS Table") table. See

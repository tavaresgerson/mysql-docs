...
COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement") includes all available collations. The
...
conditions, as discussed in [Section 24.8, “Extensions to SHOW Statements”](extended-show.html "24.8 Extensions to SHOW Statements"). For
example:
...
[`SHOW COLLATION`](show-collation.html "13.7.5.4 SHOW COLLATION Statement") output has these
columns:
...
`INFORMATION_SCHEMA`
[`COLLATIONS`](information-schema-collations-table.html "24.3.3 The INFORMATION_SCHEMA COLLATIONS Table") table. See

...
Shows the [`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement
...
[`SHOW CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") quotes table
...
`ROW_FORMAT=COMPACT` are retained.
...
STATUS`](show-table-status.html "13.7.5.36 SHOW TABLE STATUS Statement"). [`SHOW CREATE
TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement") shows the row format that was specified in the

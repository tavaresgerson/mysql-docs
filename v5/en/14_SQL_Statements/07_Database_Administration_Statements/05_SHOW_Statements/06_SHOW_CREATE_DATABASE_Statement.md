...
Shows the [`CREATE DATABASE`](create-database.html "13.1.11 CREATE DATABASE Statement")
...
[`SHOW
CREATE SCHEMA`](show-create-database.html "13.7.5.6 SHOW CREATE DATABASE Statement") is a synonym for
...
[`SHOW CREATE DATABASE`](show-create-database.html "13.7.5.6 SHOW CREATE DATABASE Statement") quotes table

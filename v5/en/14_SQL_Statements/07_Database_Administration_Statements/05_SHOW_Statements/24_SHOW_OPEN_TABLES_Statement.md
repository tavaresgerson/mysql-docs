...
[`SHOW OPEN TABLES`](show-open-tables.html "13.7.5.24 SHOW OPEN TABLES Statement") lists the
non-`TEMPORARY` tables that are currently open
in the table cache. See [Section 8.4.3.1, “How MySQL Opens and Closes Tables”](table-cache.html "8.4.3.1 How MySQL Opens and Closes Tables"). The
...
[`SHOW OPEN TABLES`](show-open-tables.html "13.7.5.24 SHOW OPEN TABLES Statement") output has these
columns:
...
* `In_use`
  ...
  the [`HANDLER ...
  OPEN`](handler.html "13.2.4 HANDLER Statement") statement and decreased by
  [`HANDLER ...
  CLOSE`](handler.html "13.2.4 HANDLER Statement").
...
the output from [`SHOW OPEN TABLES`](show-open-tables.html "13.7.5.24 SHOW OPEN TABLES Statement").
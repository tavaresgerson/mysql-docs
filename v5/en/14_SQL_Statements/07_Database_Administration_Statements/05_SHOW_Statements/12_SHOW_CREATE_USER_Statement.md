...
USER`](create-user.html "13.7.1.2 CREATE USER Statement") statement that creates the named user. An error
...
[`SHOW GRANTS`](show-grants.html "13.7.5.21 SHOW GRANTS Statement") statement. See

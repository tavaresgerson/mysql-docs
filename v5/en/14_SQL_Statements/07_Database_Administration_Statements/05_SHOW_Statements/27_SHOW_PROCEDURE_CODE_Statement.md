...
FUNCTION CODE`](show-function-code.html "13.7.5.19 SHOW FUNCTION CODE Statement"), displays information about stored
functions (see [Section 13.7.5.19, “SHOW FUNCTION CODE Statement”](show-function-code.html "13.7.5.19 SHOW FUNCTION CODE Statement")).
...
means `DROP`, 5 means
[`INSERT`](insert.html "13.2.5 INSERT Statement"), and so on). The final row

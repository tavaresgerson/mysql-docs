...
EVENT`](create-event.html "13.1.12 CREATE EVENT Statement") statement needed to re-create a given event. It
...
then altered in [Section 13.7.5.18, “SHOW EVENTS Statement”](show-events.html "13.7.5.18 SHOW EVENTS Statement")):

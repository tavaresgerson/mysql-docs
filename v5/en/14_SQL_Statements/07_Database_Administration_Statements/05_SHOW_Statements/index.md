...
[`SHOW`](show.html "13.7.5 SHOW Statements") has many forms that provide
...
If the syntax for a given [`SHOW`](show.html "13.7.5 SHOW Statements")
...
Several [`SHOW`](show.html "13.7.5 SHOW Statements") statements also accept
...
returned from a [`SHOW`](show.html "13.7.5 SHOW Statements") statement as
you would a result set from a
[`SELECT`](select.html "13.2.9 SELECT Statement"); see
[Chapter 27, *Connectors and APIs*](connectors-apis.html "Chapter 27 Connectors and APIs"), or your API documentation for
...
easily do with results from [`SHOW`](show.html "13.7.5 SHOW Statements")
statements. See [Chapter 24, *INFORMATION\_SCHEMA Tables*](information-schema.html "Chapter 24 INFORMATION_SCHEMA Tables").
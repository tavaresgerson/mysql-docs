...
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statement that creates the named view.
...
Use of [`SHOW CREATE VIEW`](show-create-view.html "13.7.5.13 SHOW CREATE VIEW Statement") requires
...
`INFORMATION_SCHEMA`
[`VIEWS`](information-schema-views-table.html "24.3.31 The INFORMATION_SCHEMA VIEWS Table") table. See
...
[`sql_mode`](server-system-variables.html#sysvar_sql_mode) does not affect the

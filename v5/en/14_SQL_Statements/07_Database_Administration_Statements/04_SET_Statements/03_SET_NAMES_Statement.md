...
[`character_set_results`](server-system-variables.html#sysvar_character_set_results) to the
...
NAMES`](set-names.html "13.7.4.3 SET NAMES Statement") produces an error. See

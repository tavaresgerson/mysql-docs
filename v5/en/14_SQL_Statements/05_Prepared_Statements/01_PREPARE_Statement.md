...
The [`PREPARE`](prepare.html "13.5.1 PREPARE Statement") statement prepares a
...
[`EXECUTE`](execute.html "13.5.2 EXECUTE Statement") and released with
[`DEALLOCATE PREPARE`](deallocate-prepare.html "13.5.3 DEALLOCATE PREPARE Statement"). For examples,
see [Section 13.5, “Prepared Statements”](sql-prepared-statements.html "13.5 Prepared Statements").
...
* When a session ends, whether normally or abnormally, its
  ...
  auto-reconnect. See [Automatic Reconnection Control](/doc/c-api/5.7/en/c-api-auto-reconnect.html).

...
[`RENAME TABLE`](rename-table.html "13.1.33 RENAME TABLE Statement") renames one or more
...
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"), can rename multiple tables within a single
statement:
...
To execute `RENAME TABLE`, there must be no
active transactions or tables locked with `LOCK
TABLES`. With the transaction table locking conditions
...
schema
([`ER_TRG_IN_WRONG_SCHEMA`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_trg_in_wrong_schema)) error.

To rename `TEMPORARY` tables, `RENAME
TABLE` does not work. Use [`ALTER
TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") instead.

...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement includes
the following:
...
* Corresponding columns in the foreign key and the
  ...
  [`INTEGER`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") and
  [`DECIMAL`](fixed-point-types.html "11.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") must be the
...
* `InnoDB` permits a foreign key to
  ...
  considered (see [Section 14.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "14.6.2.1 Clustered and Secondary Indexes")).
...
* Index prefixes on foreign key columns are not supported.
  Consequently, [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") and
  [`TEXT`](blob.html "11.3.4 The BLOB and TEXT Types") columns cannot be
  included in a foreign key because indexes on those columns
  must always include a prefix length.

* [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") does not currently
  ...
  [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables that are
...
* Prior to 5.7.16, a foreign key constraint cannot reference
  a secondary index defined on a virtual generated column.
...
When an [`UPDATE`](update.html "13.2.11 UPDATE Statement") or
[`DELETE`](delete.html "13.2.2 DELETE Statement") operation affects a key
...
* `NO ACTION`: A keyword from standard SQL.
  For [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine"), this is
  ...
  referenced table. [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6")
...
* `SET DEFAULT`: This action is recognized
  ...
  [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") reject table definitions
...
any [`INSERT`](insert.html "13.2.5 INSERT Statement") or
[`UPDATE`](update.html "13.2.11 UPDATE Statement") operation that attempts
...
For [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables, `ON
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables, `ON DELETE
...
[`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") types. (Bug #89511, Bug
#27484882)
...
[base column](glossary.html#glos_base_column "base column") of an
...
in a [virtual index](glossary.html#glos_virtual_index "virtual index").
...
using the following [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
syntax:
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement"), *remember
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") syntax:
...
CREATE TABLE`](show-create-table.html "13.7.5.10 SHOW CREATE TABLE Statement"):
...
[`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement is
supported for
[`ALTER TABLE ...
ALGORITHM=INPLACE`](alter-table.html "13.1.8 ALTER TABLE Statement"). It is not supported for
[`ALTER TABLE ...
...
[`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks) variable
has the same effect on [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables
as it does for [`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tables.
...
* Reloading tables in different order than required by their
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") produces correct definitions
  ...
  [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") automatically includes a
...
* Executing [`LOAD DATA`](load-data.html "13.2.6 LOAD DATA Statement")
  operations, to avoid foreign key checking.

* Performing an [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement")
...
Information Schema
[`KEY_COLUMN_USAGE`](information-schema-key-column-usage-table.html "24.3.12 The INFORMATION_SCHEMA KEY_COLUMN_USAGE Table") table. An
...
[`ER_NO_REFERENCED_ROW_2`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_no_referenced_row_2) and
[`ER_ROW_IS_REFERENCED_2`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_row_is_referenced_2) error

...
[`CREATE TABLE ...
LIKE`](create-table.html "13.1.18 CREATE TABLE Statement") makes the same checks as
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") and does not just

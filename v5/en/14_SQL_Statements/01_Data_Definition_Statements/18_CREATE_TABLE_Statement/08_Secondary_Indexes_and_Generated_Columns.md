...
[covering index](glossary.html#glos_covering_index "covering index") (one
...
records during [`INSERT`](insert.html "13.2.5 INSERT Statement") and
[`UPDATE`](update.html "13.2.11 UPDATE Statement") operations. Even with
...
As noted elsewhere, [`JSON`](json.html "11.5 The JSON Data Type")
...
When you use [`EXPLAIN`](explain.html "13.8.2 EXPLAIN Statement") on a
[`SELECT`](select.html "13.2.9 SELECT Statement") or other SQL statement
...
WARNINGS`](show-warnings.html "13.7.5.40 SHOW WARNINGS Statement") immediately following this
`EXPLAIN` statement:
...
[`JSON_EXTRACT()`](json-search-functions.html#function_json-extract) and
[`JSON_UNQUOTE()`](json-modification-functions.html#function_json-unquote) functions, for
...
1. [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") handles a
   [`JSON`](json.html "11.5 The JSON Data Type") column value
   internally as a [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types"). This
...
2. The [`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine does

...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") causes an implicit
...
[`CREATE TEMPORARY
TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") is deprecated as of MySQL 5.7.24; expect it to

...
enabled, that privilege and [`EXECUTE`](privileges-provided.html#priv_execute)
...
dropped. See [Section 23.2.2, “Stored Routines and MySQL Privileges”](stored-routines-privileges.html "23.2.2 Stored Routines and MySQL Privileges").)
...
[`DROP FUNCTION`](drop-function.html "13.1.24 DROP FUNCTION Statement") is also used to drop
loadable functions (see [Section 13.7.3.2, “DROP FUNCTION Statement for Loadable Functions”](drop-function-loadable.html "13.7.3.2 DROP FUNCTION Statement for Loadable Functions")).
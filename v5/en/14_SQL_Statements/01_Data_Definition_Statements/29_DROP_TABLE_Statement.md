...
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") removes one or more
...
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") causes an implicit
commit, except when used with the `TEMPORARY`
keyword. See [Section 13.3.3, “Statements That Cause an Implicit Commit”](implicit-commit.html "13.3.3 Statements That Cause an Implicit Commit").

Important

When a table is dropped, privileges granted specifically for the
table are *not* automatically dropped. They
must be dropped manually. See [Section 13.7.1.4, “GRANT Statement”](grant.html "13.7.1.4 GRANT Statement").

If any tables named in the argument list do not exist,
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") behavior depends on
whether the `IF EXISTS` clause is given:

* Without `IF EXISTS`, the statement drops all
...
[`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") is not supported with
all [`innodb_force_recovery`](innodb-parameters.html#sysvar_innodb_force_recovery)
settings. See [Section 14.22.2, “Forcing InnoDB Recovery”](forcing-innodb-recovery.html "14.22.2 Forcing InnoDB Recovery").
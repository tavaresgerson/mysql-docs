...
[`ALTER DATABASE`](alter-database.html "13.1.1 ALTER DATABASE Statement") enables you to
...
[`ALTER`](privileges-provided.html#priv_alter) privilege on the database.
[`ALTER
SCHEMA`](alter-database.html "13.1.1 ALTER DATABASE Statement") is a synonym for [`ALTER
DATABASE`](alter-database.html "13.1.1 ALTER DATABASE Statement").
...
specified explicitly. See [Section 13.1.16, “CREATE PROCEDURE and CREATE FUNCTION Statements”](create-procedure.html "13.1.16 CREATE PROCEDURE and CREATE FUNCTION Statements").) If
...
[Section 9.2.4, “Mapping of Identifiers to File Names”](identifier-mapping.html "9.2.4 Mapping of Identifiers to File Names")). This clause is for use
...
* The statement is used by [**mysqlcheck**](mysqlcheck.html "4.5.3 mysqlcheck — A Table Maintenance Program") (as
  invoked by [`mysqld_upgrade`](mysql-upgrade.html "4.4.7 mysql_upgrade — Check and Upgrade MySQL Tables")).

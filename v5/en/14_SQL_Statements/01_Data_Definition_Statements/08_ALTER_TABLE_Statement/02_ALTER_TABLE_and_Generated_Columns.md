...
* For non-partitioned tables, `ADD COLUMN`
  ...
  other [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") operations.
...
* When a `VIRTUAL` generated column is added
  ...
  [`ER_WRONG_USAGE`](/doc/mysql-errors/5.7/en/server-error-reference.html#error_er_wrong_usage) error occurs.

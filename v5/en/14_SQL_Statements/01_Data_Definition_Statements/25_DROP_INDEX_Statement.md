...
[`DROP INDEX`](drop-index.html "13.1.25 DROP INDEX Statement") drops the index named
*`index_name`* from the table
*`tbl_name`*. This statement is mapped to
an [`ALTER TABLE`](alter-table.html "13.1.8 ALTER TABLE Statement") statement to drop
the index. See [Section 13.1.8, “ALTER TABLE Statement”](alter-table.html "13.1.8 ALTER TABLE Statement").
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") tables are dropped online; that

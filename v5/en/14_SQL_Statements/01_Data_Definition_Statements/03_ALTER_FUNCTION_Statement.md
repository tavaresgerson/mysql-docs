...
[`ALTER FUNCTION`](alter-function.html "13.1.3 ALTER FUNCTION Statement") statement. However,
...
FUNCTION`](drop-function.html "13.1.24 DROP FUNCTION Statement") and [`CREATE
FUNCTION`](create-function.html "13.1.13 CREATE FUNCTION Statement").
...
enabled, the [`ALTER FUNCTION`](alter-function.html "13.1.3 ALTER FUNCTION Statement")

...
[`InnoDB`](innodb-storage-engine.html "Chapter 14 The InnoDB Storage Engine") tablespace. MySQL NDB Cluster
7.5 also supports tablespaces using the
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") storage engine in addition to
those using `InnoDB`.
...
[`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") syntax is used to
...
[`ALTER TABLE
tbl_name TABLESPACE [=]
tablespace_name`](alter-table.html "13.1.8 ALTER TABLE Statement") to add tables
...
Disk Data tables (see [Section 21.6.11, “NDB Cluster Disk Data Tables”](mysql-cluster-disk-data.html "21.6.11 NDB Cluster Disk Data Tables")).
...
using the [`ALTER TABLESPACE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement")
statement (see [Section 13.1.9, “ALTER TABLESPACE Statement”](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement")).
...
GROUP`](create-logfile-group.html "13.1.15 CREATE LOGFILE GROUP Statement") (see [Section 13.1.15, “CREATE LOGFILE GROUP Statement”](create-logfile-group.html "13.1.15 CREATE LOGFILE GROUP Statement")).
...
[`NDB`](mysql-cluster.html "Chapter 21 MySQL NDB Cluster 7.5 and NDB Cluster 7.6") reserves 4% of a tablespace for
...
Information Schema [`FILES`](information-schema-files-table.html "24.3.9 The INFORMATION_SCHEMA FILES Table") column
...
When [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") is used with
...
[`FILES`](information-schema-files-table.html "24.3.9 The INFORMATION_SCHEMA FILES Table") table. (See the example later
in this section.)
...
* `ADD DATAFILE`: Defines the name of a
  ...
  **InnoDB data files.**
  ...
  In MySQL 5.7, `ALTER
  TABLESPACE` is not supported by
  `InnoDB`.
  ...
  **NDB data files.**
  ...
  TABLESPACE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement") statement.
...
* `FILE_BLOCK_SIZE`: This option—which is
  ...
  `FILE_BLOCK_SIZE` defaults to the
  ...
  more information, see [Section 14.6.3.3, “General Tablespaces”](general-tablespaces.html "14.6.3.3 General Tablespaces").

* `USE LOGFILE GROUP`: Required for
  `NDB`, this is the name of a log file group
  previously created using [`CREATE LOGFILE
  GROUP`](create-logfile-group.html "13.1.15 CREATE LOGFILE GROUP Statement"). Not supported for `InnoDB`,
...
* `EXTENT_SIZE`: This option is specific to
  ...
  by querying the Information Schema
  [`FILES`](information-schema-files-table.html "24.3.9 The INFORMATION_SCHEMA FILES Table") table, and so derive an
...
* `INITIAL_SIZE`: This option is specific to
  ...
  [`ALTER
  TABLESPACE ... ADD DATAFILE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement").
...
* For the rules covering the naming of MySQL tablespaces, see
  [Section 9.2, “Schema Object Names”](identifiers.html "9.2 Schema Object Names"). In addition to these rules, the
...
* [`innodb_file_per_table`](innodb-parameters.html#sysvar_innodb_file_per_table),
  ...
  format using
  [`CREATE TABLE ...
  TABLESPACE`](create-table.html "13.1.18 CREATE TABLE Statement"), regardless of file format settings.
...
* [`innodb_strict_mode`](innodb-parameters.html#sysvar_innodb_strict_mode) is not
  ...
  [`CREATE TABLE ...
  TABLESPACE`](create-table.html "13.1.18 CREATE TABLE Statement") or
  [`ALTER TABLE ...
  TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement"),
...
* Use `DROP TABLESPACE` to remove a tablespace.
  ...
  [`DROP TABLE`](drop-table.html "13.1.29 DROP TABLE Statement") prior to dropping
  the tablespace. Before dropping an NDB Cluster tablespace you
  must also remove all its data files using one or more
  [`ALTER
  TABLESPACE ... DROP DATATFILE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement") statements. See
...
* All parts of an `InnoDB` table added to an
  ...
  [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") pages.
...
* [`ALTER TABLE ...
  ...
  [`ALTER TABLE
  ...IMPORT TABLESPACE`](alter-table.html "13.1.8 ALTER TABLE Statement") are not supported for tables
...
* [**mysqldump**](mysqldump.html "4.5.4 mysqldump — A Database Backup Program") and [**mysqlpump**](mysqlpump.html "4.5.6 mysqlpump — A Database Backup Program")
  do not dump `InnoDB`
  [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement") statements.
...
[`CREATE LOGFILE GROUP`](create-logfile-group.html "13.1.15 CREATE LOGFILE GROUP Statement") statement
shown here:
...
[`CREATE TABLE`](create-table.html "13.1.18 CREATE TABLE Statement") statement with the
...
[`FILES`](information-schema-files-table.html "24.3.9 The INFORMATION_SCHEMA FILES Table") table, as shown here:

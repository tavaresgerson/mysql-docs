...
[`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") drops all tables in
the database and deletes the database. Be
*very* careful with this statement! To use
[`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement"), you need the
[`DROP`](privileges-provided.html#priv_drop) privilege on the database.
[`DROP
SCHEMA`](drop-database.html "13.1.22 DROP DATABASE Statement") is a synonym for [`DROP
DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement").

Important

When a database is dropped, privileges granted specifically for
the database are *not* automatically dropped.
They must be dropped manually. See [Section 13.7.1.4, “GRANT Statement”](grant.html "13.7.1.4 GRANT Statement").
...
If you use [`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") on a
symbolically linked database, both the link and the original
database are deleted.

[`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") returns the number of
tables that were removed. This corresponds to the number of
`.frm` files removed.

The [`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") statement removes
...
[`DROP DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") statement again.
...
You can also drop databases with [**mysqladmin**](mysqladmin.html "4.5.2 mysqladmin — A MySQL Server Administration Program").

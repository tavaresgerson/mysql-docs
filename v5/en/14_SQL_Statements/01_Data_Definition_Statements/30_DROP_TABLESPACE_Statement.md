...
using [`CREATE TABLESPACE`](create-tablespace.html "13.1.19 CREATE TABLESPACE Statement"). It is
...
data files using
[`ALTER TABLESPACE
... DROP DATAFILE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement").
...
* Tablespaces are not deleted automatically. A tablespace must
  ...
  TABLESPACE`. [`DROP
  DATABASE`](drop-database.html "13.1.22 DROP DATABASE Statement") has no effect in this regard, even if the
...
[`ALTER TABLESPACE`](alter-tablespace.html "13.1.9 ALTER TABLESPACE Statement"), as shown here,

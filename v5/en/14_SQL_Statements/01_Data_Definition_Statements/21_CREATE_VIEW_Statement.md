...
[`CREATE OR REPLACE
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") is the same as [`CREATE
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement"). If the view does exist,
[`CREATE OR REPLACE
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") replaces it.
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement that provides the
definition of the view. (Selecting from the view selects, in
effect, using the [`SELECT`](select.html "13.2.9 SELECT Statement")
statement.) The *`select_statement`* can
select from base tables or from other views.
...
The [`CREATE VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statement requires
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement. For columns used
elsewhere in the [`SELECT`](select.html "13.2.9 SELECT Statement") statement,
...
value, as discussed in [Section 23.6, “Stored Object Access Control”](stored-objects-security.html "23.6 Stored Object Access Control").
...
[`SELECT`](select.html "13.2.9 SELECT Statement") statement are also
...
Columns retrieved by the [`SELECT`](select.html "13.2.9 SELECT Statement")
...
the [`SELECT`](select.html "13.2.9 SELECT Statement") statement are used for
...
* The [`SELECT`](select.html "13.2.9 SELECT Statement") statement cannot
  refer to system variables or user-defined variables.

* Within a stored program, the
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement cannot refer
...
* Any table or view referred to in the definition must exist.
  ...
  use the [`CHECK TABLE`](check-table.html "13.7.2.2 CHECK TABLE Statement") statement.
...
* Aliases for column names in the
  [`SELECT`](select.html "13.2.9 SELECT Statement") statement are checked
...
[`SELECT`](select.html "13.2.9 SELECT Statement") keyword, and to clauses such
as `INTO`, `FOR UPDATE`,
...
VIEW`](create-view.html "13.1.21 CREATE VIEW Statement") statement. This is the same as specifying
...
[Section 23.5.2, “View Processing Algorithms”](view-algorithms.html "23.5.2 View Processing Algorithms"), as well as
...
such as [`UPDATE`](update.html "13.2.11 UPDATE Statement"),
[`DELETE`](delete.html "13.2.2 DELETE Statement"), or
[`INSERT`](insert.html "13.2.5 INSERT Statement") to update the contents of
...
columns, see [Section 13.1.18.7, “CREATE TABLE and Generated Columns”](create-table-generated-columns.html "13.1.18.7 CREATE TABLE and Generated Columns").
...
[Section 23.5.3, “Updatable and Insertable Views”](view-updatability.html "23.5.3 Updatable and Insertable Views"), and
[Section 23.5.4, “The View WITH CHECK OPTION Clause”](view-check-option.html "23.5.4 The View WITH CHECK OPTION Clause").

Views created before MySQL 5.7.3 containing `ORDER BY
integer` can result in errors
at view evaluation time. Consider these view definitions, which
use `ORDER BY` with an ordinal number:
...
with [`SHOW CREATE VIEW`](show-create-view.html "13.7.5.13 SHOW CREATE VIEW Statement"). Previously,

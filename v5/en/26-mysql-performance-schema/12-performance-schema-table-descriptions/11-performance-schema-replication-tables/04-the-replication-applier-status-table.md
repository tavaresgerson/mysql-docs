...
<table summary="Correspondence between replication_applier_status columns and SHOW SLAVE STATUS columns"><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th><code class="literal">replication_applier_status</code> Column</th> <th><code class="literal">SHOW SLAVE STATUS</code> Column</th> </tr></thead><tbody><tr> <td><code class="literal">SERVICE_STATE</code></td> <td>None</td> </tr><tr> <td><code class="literal">REMAINING_DELAY</code></td> <td><code class="literal">SQL_Remaining_Delay</code></td> </tr></tbody></table>

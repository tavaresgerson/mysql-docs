...
<table summary="Correspondence between replication_connection_status columns and SHOW SLAVE STATUS columns"><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th><code class="literal">replication_connection_status</code> Column</th> <th><code class="literal">SHOW SLAVE STATUS</code> Column</th> </tr></thead><tbody><tr> <td><code class="literal">SOURCE_UUID</code></td> <td><code class="literal">Master_UUID</code></td> </tr><tr> <td><code class="literal">THREAD_ID</code></td> <td>None</td> </tr><tr> <td><code class="literal">SERVICE_STATE</code></td> <td><code class="literal">Slave_IO_Running</code></td> </tr><tr> <td><code class="literal">RECEIVED_TRANSACTION_SET</code></td> <td><code class="literal">Retrieved_Gtid_Set</code></td> </tr><tr> <td><code class="literal">LAST_ERROR_NUMBER</code></td> <td><code class="literal">Last_IO_Errno</code></td> </tr><tr> <td><code class="literal">LAST_ERROR_MESSAGE</code></td> <td><code class="literal">Last_IO_Error</code></td> </tr><tr> <td><code class="literal">LAST_ERROR_TIMESTAMP</code></td> <td><code class="literal">Last_IO_Error_Timestamp</code></td> </tr></tbody></table>

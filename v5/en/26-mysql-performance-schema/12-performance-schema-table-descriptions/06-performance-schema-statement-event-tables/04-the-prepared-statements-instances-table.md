...
* The text protocol. This is accessed using SQL statements and maps onto underlying server commands as shown in the following table.
  ...
  <table summary="How the text protocol accessed using SQL statements maps onto underlying server commands."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>SQL Statement</th> <th>Corresponding Server Command</th> </tr></thead><tbody><tr> <td><a class="link" href="prepare.html" title="13.5.1 PREPARE Statement"><code class="literal">PREPARE</code></a></td> <td><code class="literal">SQLCOM_PREPARE</code></td> </tr><tr> <td><a class="link" href="execute.html" title="13.5.2 EXECUTE Statement"><code class="literal">EXECUTE</code></a></td> <td><code class="literal">SQLCOM_EXECUTE</code></td> </tr><tr> <td><a class="link" href="deallocate-prepare.html" title="13.5.3 DEALLOCATE PREPARE Statement"><code class="literal">DEALLOCATE PREPARE</code></a>, <a class="link" href="deallocate-prepare.html" title="13.5.3 DEALLOCATE PREPARE Statement"><code class="literal">DROP PREPARE</code></a></td> <td><code class="literal">SQLCOM_DEALLOCATE PREPARE</code></td> </tr></tbody></table>

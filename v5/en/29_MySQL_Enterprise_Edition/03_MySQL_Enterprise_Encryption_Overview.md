...
For more information, see [Section 6.6, “MySQL Enterprise Encryption”](enterprise-encryption.html "6.6 MySQL Enterprise Encryption").

For other related Enterprise security features, see
[Section 28.2, “MySQL Enterprise Security Overview”](mysql-enterprise-security.html "28.2 MySQL Enterprise Security Overview").
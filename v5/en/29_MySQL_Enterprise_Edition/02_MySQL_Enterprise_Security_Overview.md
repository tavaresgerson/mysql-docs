...
* MySQL Enterprise Edition includes an authentication plugin that enables MySQL
  ...
  [Kerberos Pluggable Authentication](/doc/refman/8.0/en/kerberos-pluggable-authentication.html).
...
* MySQL Enterprise Edition includes a suite of masking and de-identification
  ...
  For more information, see [Section 6.5, “MySQL Enterprise Data Masking and De-Identification”](data-masking.html "6.5 MySQL Enterprise Data Masking and De-Identification").
...
* MySQL Enterprise Edition includes a set of encryption functions based on the
  ...
  [Section 28.3, “MySQL Enterprise Encryption Overview”](mysql-enterprise-encryption.html "28.3 MySQL Enterprise Encryption Overview").
...
* MySQL Transparent Data Encryption (TDE) provides at-rest
  ...
  [Encrypting Binary Log Files and Relay Log Files](/doc/refman/8.0/en/replication-binlog-encryption.html), and

...
You can also get strange problems with large packets if you are using large [`BLOB`](blob.html "11.3.4 The BLOB and TEXT Types") values but have not given [**mysqld**](mysqld.html "4.3.1 mysqld — The MySQL Server") access to enough memory to handle the query. If you suspect this is the case, try adding **ulimit -d 256000** to the beginning of the [**mysqld\_safe**](mysqld-safe.html "4.3.2 mysqld_safe — MySQL Server Startup Script") script and restarting [**mysqld**](mysqld.html "4.3.1 mysqld — The MySQL Server").

...
A.9.2. [What is the default authentication plugin in MySQL 5.7?](faqs-security.html#faq-mysql-default-authentication-plugin)
...
<table border="0" style="width: 100%;"><colgroup><col align="left" width="1%"/><col/></colgroup><tbody><tr class="question"><td align="left" valign="top"><p><b>A.9.1.</b></p></td><td align="left" valign="top"><p>
        ...
        The best place to start is Chapter 6, <i>Security</i>.
      </p><p>
...
<p>
        ...
        <code>mysql_native_password</code>. For information about
        this plugin, see
        Section 6.4.1.1, “Native Pluggable Authentication”. For general
        ...
        client and server. See Section 6.3, “Using Encrypted Connections”.
      </p><p>
...
<span class="emphasis"><em>Do all MySQL Connectors (5.7 and 8.0) support TLS 1.2
        ...
        <code>libmysql</code>?</em></span> For C and C++
        applications using the community
        <code>libmysqlclient</code> library, use an OpenSSL-based
        library (that is, do <em>not</em> use YaSSL). Usage

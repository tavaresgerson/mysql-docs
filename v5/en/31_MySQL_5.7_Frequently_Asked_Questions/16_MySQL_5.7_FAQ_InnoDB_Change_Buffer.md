...
<code>INSERT</code>, <code>UPDATE</code>, and
        ...
        <code>InnoDB</code> buffer pool size.
      </p><p>
...
<code>InnoDB</code> does not buffer an operation if it
        ...
        <code>SHOW ENGINE INNODB STATUS \G</code>, under the
...
<code>size</code>: The number of pages used within the
            change buffer. Change buffer size is equal to <code>seg
            size - (1 + free list len)</code>. The <code>1
            +</code> value represents the change buffer header page.
          </p></li><li class="listitem"><p>
<code>seg size</code>: The size of the change buffer,
            in pages.
</p></li></ul>
</div>
<p>
...
<ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>
            ...
            by <code>InnoDB</code> background tasks such as
        ...
        the <code>InnoDB</code> buffer pool. Generally, the change
        ...
        data set fits within the <code>InnoDB</code> buffer pool,

...
[`REGEXP`](regexp.html#operator_regexp) and [`NOT
REGEXP`](regexp.html#operator_not-regexp) operators (or
[`RLIKE`](regexp.html#operator_regexp) and
[`NOT RLIKE`](regexp.html#operator_not-regexp),
which are synonyms).
...
rewritten here to use [`REGEXP`](regexp.html#operator_regexp).
...
To force a [`REGEXP`](regexp.html#operator_regexp) comparison to
be case-sensitive, use the [`BINARY`](cast-functions.html#operator_binary)
keyword to make one of the strings a binary string. This query
matches only lowercase `b` at the beginning
of a name:
...
see [Section 12.8.2, “Regular Expressions”](regexp.html "12.8.2 Regular Expressions").
...
The simplest form of [`SELECT`](select.html "13.2.9 SELECT Statement")
...
This form of [`SELECT`](select.html "13.2.9 SELECT Statement") uses
...
* Fix only the erroneous record with an
  ...
  The [`UPDATE`](update.html "13.2.11 UPDATE Statement") changes only the

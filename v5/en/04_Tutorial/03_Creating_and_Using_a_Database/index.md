...
Use the [`SHOW`](show.html "13.7.5 SHOW Statements") statement to find out
...
on your machine; [`SHOW DATABASES`](show-databases.html "13.7.5.14 SHOW DATABASES Statement")
does not show databases that you have no privileges for if you do
not have the [`SHOW DATABASES`](show-databases.html "13.7.5.14 SHOW DATABASES Statement")
privilege. See [Section 13.7.5.14, “SHOW DATABASES Statement”](show-databases.html "13.7.5.14 SHOW DATABASES Statement").

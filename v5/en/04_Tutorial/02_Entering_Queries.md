...
out to familiarize yourself with how [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
works.
...
* When you issue a query, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") sends it to
...
* [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") displays query output in tabular form
  ...
  shown), [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") labels the column using the
  expression itself.

* [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") shows how many rows were returned and
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") as a simple calculator:
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") determines where your statement ends by
looking for the terminating semicolon, not by looking for the end
of the input line. (In other words, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") indicates that it has not yet seen a
...
feedback, you can always be aware of what [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
is waiting for.
...
providing feedback to indicate that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is in.

<table summary="MySQL prompts and the meaning of each prompt."><col style="width: 10%"/><col style="width: 80%"/><thead><tr>
<th>Prompt</th>
<th>Meaning</th>
</tr></thead><tbody><tr>
...
<td>Waiting for next line, waiting for completion of a string that began
            with a single quote (<code>'</code>)</td>
</tr><tr>
<td><code>"&gt;</code></td>
<td>Waiting for next line, waiting for completion of a string that began
            with a double quote (<code>"</code>)</td>
</tr><tr>
<td><code>`&gt;</code></td>
<td>Waiting for next line, waiting for completion of an identifier that
            began with a backtick (<code>`</code>)</td>
</tr><tr>
<td><code>/*&gt;</code></td>
...
terminating semicolon. In this case, [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
...
likely [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is waiting for the semicolon. If
...
semicolon to complete the statement, and [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")
executes it:
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") lets you enter strings that span multiple
...
If you enter this [`SELECT`](select.html "13.2.9 SELECT Statement") statement,
...
you that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") expects to see the rest of an
...
case, because [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") interprets it as part of
the string that it is collecting. Instead, enter the closing quote
character (so [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") knows you've finished the
string), then type `\c`:
...
indicating that [**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client") is ready for a new query.
...
[**mysql**](mysql.html "4.5.1 mysql — The MySQL Command-Line Client")—including a line containing

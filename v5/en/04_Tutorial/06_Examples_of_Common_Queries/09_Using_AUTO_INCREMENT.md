...
value in an `InnoDB` table does not reset the
...
the [`mysql_insert_id()`](/doc/c-api/5.7/en/mysql-insert-id.html) C API
...
[`TINYINT`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), the maximum permissible
sequence number is 127. For
[`TINYINT
UNSIGNED`](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT"), the maximum is 255. See
[Section 11.1.2, “Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT,
MEDIUMINT, BIGINT”](integer-types.html "11.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") for the ranges of all the
integer types.
...
[`mysql_insert_id()`](/doc/c-api/5.7/en/mysql-insert-id.html) actually
...
* How to assign the `AUTO_INCREMENT`
  attribute to a column: [Section 13.1.18, “CREATE TABLE Statement”](create-table.html "13.1.18 CREATE TABLE Statement"), and
...
* How `AUTO_INCREMENT` behaves depending on
  ...
  SQL mode: [Section 5.1.10, “Server SQL Modes”](sql-mode.html "5.1.10 Server SQL Modes").
...
* Setting the `AUTO_INCREMENT` value to be
  used: [Section 5.1.7, “Server System Variables”](server-system-variables.html "5.1.7 Server System Variables").

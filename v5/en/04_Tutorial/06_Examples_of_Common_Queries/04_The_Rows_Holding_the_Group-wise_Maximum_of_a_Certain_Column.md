...
inefficient (see [Section 13.2.10.7, “Correlated Subqueries”](correlated-subqueries.html "13.2.10.7 Correlated Subqueries")). Other
...
`NULL`. See [Section 13.2.9.2, “JOIN Clause”](join.html "13.2.9.2 JOIN Clause").
...
Esta seção fornece informações sobre a compatibilidade entre diferentes releases do NDB Cluster 7.6 em relação à realização de upgrades e downgrades, bem como matrizes e notas de compatibilidade. Informações adicionais também podem ser encontradas aqui sobre downgrades do NDB 7.6 para séries de releases NDB anteriores. Você já deve estar familiarizado com a instalação e configuração do NDB Cluster antes de tentar um upgrade ou downgrade. Consulte Seção 21.4, “Configuração do NDB Cluster”.

...
- No nó de gerenciamento, use o cliente **ndb\_mgm** para verificar se o nó de gerenciamento e ambos os nós de dados iniciaram com sucesso (consulte Seção 21.3.2.3, “Início Inicial do NDB Cluster no Windows”).

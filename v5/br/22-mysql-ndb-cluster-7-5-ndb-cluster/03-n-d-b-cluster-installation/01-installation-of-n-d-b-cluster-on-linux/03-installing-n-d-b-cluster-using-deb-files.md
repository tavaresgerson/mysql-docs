...
Para o NDB Cluster 7.5.6 e superior, a Oracle também fornece um APT repository para Debian e outras distribuições. Consulte *Instalando o MySQL NDB Cluster Usando o APT Repository* para instruções e informações adicionais.

### 21.5.21 ndb\_print\_schema\_file — Imprimir o conteúdo do arquivo de esquema do NDB

**ndb\_print\_schema\_file** obtém informações de diagnóstico de um arquivo de esquema de cluster.

...
- `--execute=command`, `-e command`
  ...
  <table frame="box" rules="all" summary="Propriedades para executar"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--execute=command</code>]]</td> </tr></tbody></table>

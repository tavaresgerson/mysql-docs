### 21.5.22 ndb\_print\_sys\_file — Imprimir o conteúdo do arquivo do sistema NDB

**ndb\_print\_sys\_file** obtém informações de diagnóstico de um arquivo de sistema do NDB Cluster.

...
Assim como `cpustat_50ms` e `cpustat_20sec`, esta tabela exibe 20 conjuntos de medição por Thread, cada um referenciando um período da duração nomeada. Assim, `cpsustat_1sec` fornece 20 segundos de histórico.

...
A coluna `block_instance` fornece o número da instância de bloco do kernel `DBTC`. Você pode usar isso para obter informações sobre threads específicas da tabela `threadblocks`.

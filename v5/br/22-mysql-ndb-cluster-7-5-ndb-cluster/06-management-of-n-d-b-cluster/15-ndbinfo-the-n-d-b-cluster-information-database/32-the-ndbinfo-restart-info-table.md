...
* `secs_until_wait_for_ndbcntr_master`
  ...
  Tempo em segundos desde a inclusão no protocolo heartbeat até o início da espera pelo master `NDBCNTR`

* `secs_wait_for_ndbcntr_master`

  Tempo em segundos gasto esperando para ser aceito pelo master `NDBCNTR` para iniciar
...
Veja também Section 21.6.4, “Summary of NDB Cluster Start Phases”.
...
A tabela `arbitrator_validity_detail` mostra a visão que cada data node no cluster tem do arbitrator. Ela é um subconjunto da tabela `membership`.
...
O Node ID é o mesmo reportado por **ndb_mgm -e "SHOW"**.

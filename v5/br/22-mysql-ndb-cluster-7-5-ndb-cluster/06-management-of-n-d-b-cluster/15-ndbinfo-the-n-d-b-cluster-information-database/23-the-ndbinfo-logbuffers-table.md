...
* `log_id`
  ...
  O log ID; para arquivos Disk Data undo log, este é o mesmo valor mostrado na coluna `LOGFILE_GROUP_NUMBER` da tabela Information Schema `FILES`, bem como o valor mostrado para a coluna `log_id` da tabela `ndbinfo` `logspaces`

...
`error_code` é um código de erro NDB numérico. Este é o mesmo código de erro que pode ser fornecido a **ndb_perror** ou **perror** `--ndb`.
...
A coluna `error_classification` mostra a classificação do erro. Consulte NDB Error Classifications para obter informações sobre os códigos de classificação e seus significados.

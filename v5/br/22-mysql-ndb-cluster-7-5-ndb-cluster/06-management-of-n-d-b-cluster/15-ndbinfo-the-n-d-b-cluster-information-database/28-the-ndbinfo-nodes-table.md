...
Se você desligar um dos nós, apenas os nós que ainda estão em execução são representados na saída desta instrução `SELECT`, conforme mostrado aqui:

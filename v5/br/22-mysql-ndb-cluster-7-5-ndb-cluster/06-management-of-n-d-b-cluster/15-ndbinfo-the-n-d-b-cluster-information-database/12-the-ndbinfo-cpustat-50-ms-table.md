...
Assim como `cpustat_1sec` e `cpustat_20sec`, esta tabela exibe 20 conjuntos de medição por Thread, cada um referenciando um período com a duração especificada. Portanto, `cpsustat_50ms` fornece 1 segundo de histórico.

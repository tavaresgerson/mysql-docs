...
Embora seja possível fazer isso em teoria, **não** é recomendado usar **ndb_mgm** para gerenciar um Cluster diretamente de fora da rede local em que o Cluster está sendo executado. Como nem a autenticação nem a criptografia ocorrem entre o cliente de gerenciamento e o servidor de gerenciamento, isso representa um meio extremamente inseguro de gerenciar o cluster, e é quase certo que seja comprometido mais cedo ou mais tarde.

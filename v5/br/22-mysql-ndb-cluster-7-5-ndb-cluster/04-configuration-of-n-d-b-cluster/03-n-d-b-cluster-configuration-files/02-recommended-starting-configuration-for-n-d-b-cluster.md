...
**Opções my.cnf obrigatórias para SQL nodes.** Servidores MySQL atuando como SQL nodes do NDB Cluster devem ser sempre iniciados com as opções `--ndbcluster` e `--ndb-connectstring`, seja na linha de comando ou em `my.cnf`.
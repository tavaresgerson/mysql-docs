...
Esses parâmetros também se aplicam ao **ndbmtd**"), a versão multi-threaded do **ndbd**. Uma listagem separada de parâmetros específicos ao **ndbmtd**") segue abaixo.
...
Os seguintes parâmetros são específicos do **ndbmtd**"):

...
21.2.7.2 Limites e Diferenças do NDB Cluster em Relação aos Limites Padrão do MySQL

21.2.7.3 Limites Relacionados ao Tratamento de Transaction no NDB Cluster

21.2.7.4 Tratamento de Erros no NDB Cluster

21.2.7.5 Limites Associados a Database Objects no NDB Cluster

21.2.7.6 Recursos Não Suportados ou Ausentes no NDB Cluster

21.2.7.7 Limitações Relacionadas à Performance no NDB Cluster

21.2.7.8 Questões Exclusivas do NDB Cluster

21.2.7.9 Limitações Relacionadas ao Armazenamento de Disk Data do NDB Cluster

21.2.7.10 Limitações Relacionadas a Múltiplos Nodes do NDB Cluster
...
Limitações e outras questões específicas da NDB Cluster Replication são descritas na Seção 21.7.3, “Questões Conhecidas na NDB Cluster Replication”.
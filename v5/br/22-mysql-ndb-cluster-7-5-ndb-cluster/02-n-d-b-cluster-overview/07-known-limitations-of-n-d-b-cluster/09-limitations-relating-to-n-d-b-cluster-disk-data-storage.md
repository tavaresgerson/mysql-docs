...
* Os tamanhos mínimo e máximo possíveis de extents para arquivos de dados de tablespace são 32K e 2G, respectivamente. Consulte Seção 13.1.19, “Instrução CREATE TABLESPACE”, para mais informações.
...
* Arquivos de dados usam `DataMemory`. O uso é o mesmo que para dados em memória (*in-memory*).

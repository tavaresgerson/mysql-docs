...
As próximas seções contêm informações sobre os **parameters** de configuração de **node** do `NDB` e **options** e **variables** específicas do NDB para o **mysqld** que foram adicionados, tornados obsoletos ou removidos no NDB 7.6.

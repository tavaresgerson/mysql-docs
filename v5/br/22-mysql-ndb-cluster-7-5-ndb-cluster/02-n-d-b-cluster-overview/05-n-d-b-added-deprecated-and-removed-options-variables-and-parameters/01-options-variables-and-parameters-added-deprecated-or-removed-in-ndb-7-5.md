...
As próximas seções contêm informações sobre parâmetros de configuração de node do `NDB` e opções e variáveis específicas do NDB para **mysqld** que foram adicionados, descontinuados ou removidos do NDB 7.5.

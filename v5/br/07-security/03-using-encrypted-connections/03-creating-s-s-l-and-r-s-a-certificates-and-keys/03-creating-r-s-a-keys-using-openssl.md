...
::: info Nota
Existem alternativas mais fáceis para gerar os arquivos necessários para o RSA do que o procedimento descrito aqui: deixe o servidor gerar automaticamente ou use o programa **mysql_ssl_rsa_setup**. Veja Seção 6.3.3.1, “Criando Certificados e Chaves SSL e RSA Usando o MySQL”.
:::

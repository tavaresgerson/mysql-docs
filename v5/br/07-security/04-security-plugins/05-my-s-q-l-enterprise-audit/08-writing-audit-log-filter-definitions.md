...
<table summary="Combinações permitidas de valores de classe e subclasse de evento."><col style="width: 20%"/><col style="width: 20%"/><col style="width: 60%"/><thead><tr> <th scope="col">Classe de evento</th> <th scope="col">Subclasse de evento</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">SELECT</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">SELECT</code>]</td> <td>Início da conexão (sucesso ou falha)</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">table_access</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">delete</code>]</td> <td>Reauthenticação do usuário com diferentes usuário/senha durante a sessão</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">DELETE</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">TRUNCATE TABLE</code>]</td> <td>Termina��o da conex�o</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">table_access</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">insert</code>]</td> <td>Informações gerais sobre o funcionamento</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">INSERT</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">REPLACE</code>]</td> <td>Declarações de leitura de tabela, como<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">SELECT</code>]]</a>ou<a class="link" href="insert-select.html" title="13.2.5.1 Inserir ... Instrução SELECT">[[<code class="literal">connect</code><code class="literal">SELECT</code>]</a></td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">delete</code>]]</td> <td>Declarações de exclusão de tabela, como<a class="link" href="delete.html" title="13.2.2 Declaração DELETE">[[<code class="literal">DELETE</code>]]</a>ou<a class="link" href="truncate-table.html" title="13.1.34 Declaração [[PH_BACKTICK_2<code class="literal">delete</code>]">[[<code class="literal">TRUNCATE TABLE</code>]]</a></td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">insert</code>]]</td> <td>As declarações de inserção de tabela, como<a class="link" href="insert.html" title="13.2.5 Instrução INSERT">[[<code class="literal">INSERT</code>]]</a>ou<a class="link" href="replace.html" title="13.2.8 Declaração REPLACE">[[<code class="literal">REPLACE</code>]]</a></td> </tr><tr> <th scope="row">[[<code class="literal">connection</code><code class="literal">SELECT</code>]</th> <td>[[<code class="literal">connection</code><code class="literal">SELECT</code>]</td> <td>Declarações de atualização de tabela, como<a class="link" href="update.html" title="13.2.11 Declaração de atualização">[[<code class="literal">connection</code><code class="literal">table_access</code>]</a></td> </tr></tbody></table>
...
<table summary="Características de registro e interrupção para combinações de classe e subclasse de eventos."><col style="width: 20%"/><col style="width: 20%"/><col style="width: 30%"/><col style="width: 30%"/><thead><tr> <th scope="col">Classe de evento</th> <th scope="col">Subclasse de evento</th> <th scope="col">Pode ser registrado</th> <th scope="col">Pode ser interrompido</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">table_access</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">table_access</code>]</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">table_access</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">insert</code>]</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">table_access</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">update</code>]</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">[[<code class="literal">general</code>]]</th> <td>[[<code class="literal">status</code>]]</td> <td>Sim</td> <td>Não</td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">read</code>]]</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">connect</code><code class="literal">table_access</code>]</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">insert</code>]]</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th scope="row">[[<code class="literal">table_access</code>]]</th> <td>[[<code class="literal">update</code>]]</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Campos permitidos para eventos de conexão."><col style="width: 35%"/><col style="width: 20%"/><col style="width: 45%"/><thead><tr> <th scope="col">Nome do campo</th> <th scope="col">Tipo de campo</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">host.str</code>]</th> <td>inteiro</td> <td><p class="valid-value">Status do evento:</p><p class="valid-value">0: OK</p><p class="valid-value">Caso contrário: Falha</p></td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">host.str</code>]</th> <td>inteiro não assinado</td> <td>ID de conexão</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">ip.str</code>]</th> <td>string</td> <td>Nome do usuário especificado durante a autenticação</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">ip.length</code>]</th> <td>inteiro não assinado</td> <td>Comprimento do nome do usuário</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">database.str</code>]</th> <td>string</td> <td>Nome de usuário autenticado (nome do usuário da conta)</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">database.length</code>]</th> <td>inteiro não assinado</td> <td>Nome de usuário autenticado com comprimento</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">connection_type</code>]</th> <td>string</td> <td>Nome do usuário externo (fornecido pelo plugin de autenticação de terceiros)</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">"::undefined"</code>]</th> <td>inteiro não assinado</td> <td>Nome do usuário externo de comprimento</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">"::tcp/ip"</code>]</th> <td>string</td> <td>Nome de usuário do proxy</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">"::socket"</code>]</th> <td>inteiro não assinado</td> <td>Nome de usuário do proxy comprimento</td> </tr><tr> <th scope="row">[[<code class="literal">host.str</code>]]</th> <td>string</td> <td>Hospedeiro de usuário conectado</td> </tr><tr> <th scope="row">[[<code class="literal">connection_id</code><code class="literal">host.str</code>]</th> <td>inteiro não assinado</td> <td>Comprimento do host do usuário conectado</td> </tr><tr> <th scope="row">[[<code class="literal">ip.str</code>]]</th> <td>string</td> <td>Endereço IP do usuário conectado</td> </tr><tr> <th scope="row">[[<code class="literal">ip.length</code>]]</th> <td>inteiro não assinado</td> <td>Tamanho do endereço IP do usuário conectado</td> </tr><tr> <th scope="row">[[<code class="literal">database.str</code>]]</th> <td>string</td> <td>Nome do banco de dados especificado no momento da conexão</td> </tr><tr> <th scope="row">[[<code class="literal">database.length</code>]]</th> <td>inteiro não assinado</td> <td>Nome do banco de dados</td> </tr><tr> <th scope="row">[[<code class="literal">connection_type</code>]]</th> <td>inteiro</td> <td><p class="valid-value">Tipo de conexão:</p><p class="valid-value">0 ou [[<code class="literal">"::undefined"</code>]]: Indefinido</p><p class="valid-value">1 ou [[<code class="literal">"::tcp/ip"</code>]]: TCP/IP</p><p class="valid-value">2 ou [[<code class="literal">"::socket"</code>]]: Soquete</p><p class="valid-value">3 ou [[<code class="literal">user.str</code><code class="literal">host.str</code>]: Pipe nomeado</p><p class="valid-value">4 ou [[<code class="literal">user.str</code><code class="literal">host.str</code>]: TCP/IP com criptografia</p><p class="valid-value">5 ou [[<code class="literal">user.str</code><code class="literal">ip.str</code>]: Memória compartilhada</p></td> </tr></tbody></table>
...
<table summary="Tipos de campos permitidos para eventos gerais."><col style="width: 35%"/><col style="width: 20%"/><col style="width: 45%"/><thead><tr> <th scope="col">Nome do campo</th> <th scope="col">Tipo de campo</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_sql_command.str</code>]</th> <td>inteiro</td> <td><p class="valid-value">Status do evento:</p><p class="valid-value">0: OK</p><p class="valid-value">Caso contrário: Falha</p></td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_sql_command.str</code>]</th> <td>inteiro não assinado</td> <td>ID de conexão/fio</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_external_user.str</code>]</th> <td>string</td> <td>Nome do usuário especificado durante a autenticação</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_external_user.length</code>]</th> <td>inteiro não assinado</td> <td>Comprimento do nome do usuário</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_ip.str</code>]</th> <td>string</td> <td>Nome do comando</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">general_ip.length</code>]</th> <td>inteiro não assinado</td> <td>Nome do comando de comprimento</td> </tr><tr> <th scope="row">[[<code class="literal">general_query.str</code>]]</th> <td>string</td> <td>Texto da instrução SQL</td> </tr><tr> <th scope="row">[[<code class="literal">general_query.length</code>]]</th> <td>inteiro não assinado</td> <td>Texto do comando SQL</td> </tr><tr> <th scope="row">[[<code class="literal">general_host.str</code>]]</th> <td>string</td> <td>Nome do host</td> </tr><tr> <th scope="row">[[<code class="literal">general_host.length</code>]]</th> <td>inteiro não assinado</td> <td>Nome do host de comprimento</td> </tr><tr> <th scope="row">[[<code class="literal">general_sql_command.str</code>]]</th> <td>string</td> <td>Nome do tipo de comando SQL</td> </tr><tr> <th scope="row">[[<code class="literal">general_thread_id</code><code class="literal">general_sql_command.str</code>]</th> <td>inteiro não assinado</td> <td>Nome do tipo de comando SQL comprimento</td> </tr><tr> <th scope="row">[[<code class="literal">general_external_user.str</code>]]</th> <td>string</td> <td>Nome do usuário externo (fornecido pelo plugin de autenticação de terceiros)</td> </tr><tr> <th scope="row">[[<code class="literal">general_external_user.length</code>]]</th> <td>inteiro não assinado</td> <td>Nome do usuário externo de comprimento</td> </tr><tr> <th scope="row">[[<code class="literal">general_ip.str</code>]]</th> <td>string</td> <td>Endereço IP do usuário conectado</td> </tr><tr> <th scope="row">[[<code class="literal">general_ip.length</code>]]</th> <td>inteiro não assinado</td> <td>Comprimento do endereço IP do usuário de conexão</td> </tr></tbody></table>
...
<table summary="Campos permitidos para eventos de acesso à tabela."><col style="width: 35%"/><col style="width: 20%"/><col style="width: 45%"/><thead><tr> <th scope="col">Nome do campo</th> <th scope="col">Tipo de campo</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <th scope="row">[[<code class="literal">connection_id</code>]]</th> <td>inteiro não assinado</td> <td>ID de conexão do evento</td> </tr><tr> <th scope="row">[[<code class="literal">sql_command_id</code>]]</th> <td>inteiro</td> <td>ID do comando SQL</td> </tr><tr> <th scope="row">[[<code class="literal">query.str</code>]]</th> <td>string</td> <td>Texto da instrução SQL</td> </tr><tr> <th scope="row">[[<code class="literal">query.length</code>]]</th> <td>inteiro não assinado</td> <td>Texto do comando SQL</td> </tr><tr> <th scope="row">[[<code class="literal">table_database.str</code>]]</th> <td>string</td> <td>Nome do banco de dados associado ao evento</td> </tr><tr> <th scope="row">[[<code class="literal">table_database.length</code>]]</th> <td>inteiro não assinado</td> <td>Nome do banco de dados</td> </tr><tr> <th scope="row">[[<code class="literal">table_name.str</code>]]</th> <td>string</td> <td>Nome da tabela associado ao evento</td> </tr><tr> <th scope="row">[[<code class="literal">table_name.length</code>]]</th> <td>inteiro não assinado</td> <td>Nome da tabela</td> </tr></tbody></table>
...
- `audit_log_policy_value`
  ...
  **Tabela 6.32 audit\_log\_policy\_value Valores**
  ...
  <table summary="Valores permitidos de audit_log_policy_value e os valores correspondentes de audit_log_policy."><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Valor</th> <th>Valor correspondente a audit_log_policy</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CÓDIGO_<code class="literal">"::queries"</code>] ou [[PH_HTML_CÓDIGO_<code class="literal">"::queries"</code>]</td> <td>[[<code class="literal">NONE</code>]]</td> </tr><tr> <td>[[<code class="literal">1</code>]] ou [[<code class="literal">"::logins"</code>]]</td> <td>[[<code class="literal">LOGINS</code>]]</td> </tr><tr> <td>[[<code class="literal">2</code>]] ou [[<code class="literal">"::all"</code>]]</td> <td>[[<code class="literal">ALL</code>]]</td> </tr><tr> <td>[[<code class="literal">3</code>]] ou [[<code class="literal">"::queries"</code>]]</td> <td>[[<code class="literal">"::none"</code><code class="literal">"::queries"</code>]</td> </tr></tbody></table>
...
- `audit_log_statement_policy_value`
  ...
  **Tabela 6.33 política\_valor\_declaração\_audit\_log\_statement Valores**

  <table summary="Valores permitidos de audit_log_statement_policy_value e os valores correspondentes de audit_log_statement_policy."><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Valor</th> <th>Política de declaração de audit_log_statement correspondente Valor</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CÓDIGO_<code class="literal">0</code>] ou [[PH_HTML_CÓDIGO_<code class="literal">"::none"</code>]</td> <td>[[<code class="literal">NONE</code>]]</td> </tr><tr> <td>[[<code class="literal">1</code>]] ou [[<code class="literal">"::errors"</code>]]</td> <td>[[<code class="literal">ERRORS</code>]]</td> </tr><tr> <td>[[<code class="literal">2</code>]] ou [[<code class="literal">"::all"</code>]]</td> <td>[[<code class="literal">ALL</code>]]</td> </tr></tbody></table>

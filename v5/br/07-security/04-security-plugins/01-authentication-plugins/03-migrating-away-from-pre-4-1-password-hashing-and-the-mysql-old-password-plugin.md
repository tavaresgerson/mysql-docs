...
<table summary="Características das contas do MySQL e o que deve ser feito para atualizá-las."><col style="width: 30%"/><col style="width: 20%"/><col style="width: 30%"/><col style="width: 20%"/><thead><tr> <th scope="col">[[PH_HTML_CODE_<code class="literal">mysql_old_password</code>] Coluna</th> <th scope="col">[[PH_HTML_CODE_<code class="literal">mysql_old_password</code>] Coluna</th> <th scope="col">Resultado de autenticação</th> <th scope="col">Ação de atualização</th> </tr></thead><tbody><tr> <th scope="row">Vazio</th> <td>Vazio</td> <td>Usa implicitamente [[PH_HTML_CODE_<code class="literal">mysql_old_password</code>]</td> <td>Atribuir plugin</td> </tr><tr> <th scope="row">Vazio</th> <td>4.1 hash</td> <td>Usa implicitamente [[<code class="literal">mysql_native_password</code>]]</td> <td>Atribuir plugin</td> </tr><tr> <th scope="row">Vazio</th> <td>Hash pré-4.1</td> <td>Usa implicitamente [[<code class="literal">mysql_old_password</code>]]</td> <td>Atribuir plugin, refazer senha</td> </tr><tr> <th scope="row">[[<code class="literal">mysql_native_password</code>]]</th> <td>Vazio</td> <td>Usa explicitamente [[<code class="literal">mysql_native_password</code>]]</td> <td>Nenhum</td> </tr><tr> <th scope="row">[[<code class="literal">mysql_native_password</code>]]</th> <td>4.1 hash</td> <td>Usa explicitamente [[<code class="literal">mysql_native_password</code>]]</td> <td>Nenhum</td> </tr><tr> <th scope="row">[[<code class="literal">mysql_old_password</code>]]</th> <td>Vazio</td> <td>Usa explicitamente [[<code class="literal">mysql_old_password</code>]]</td> <td>Atualize o plugin</td> </tr><tr> <th scope="row">[[<code class="literal">Password</code><code class="literal">mysql_old_password</code>]</th> <td>Hash pré-4.1</td> <td>Usa explicitamente [[<code class="literal">mysql_old_password</code>]]</td> <td>Atualize o plugin, refaça a senha</td> </tr></tbody></table>

...
<table summary="Nomes para os plugins e o arquivo de biblioteca usados para autenticação de senha LDAP simples."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Plugin ou arquivo</th> <th>Nome do Plugin ou do Arquivo</th> </tr></thead><tbody><tr> <td>Nome do plugin no lado do servidor</td> <td>[[<code class="literal">authentication_ldap_simple</code>]]</td> </tr><tr> <td>Nome do plugin no lado do cliente</td> <td>[[<code class="literal">mysql_clear_password</code>]]</td> </tr><tr> <td>Nome do arquivo da biblioteca</td> <td>[[<code class="filename">authentication_ldap_simple.so</code>]]</td> </tr></tbody></table>

**Tabela 6.16 Nomes de plugins e bibliotecas para autenticação LDAP baseada em SASL**

<table summary="Nomes para os plugins e o arquivo de biblioteca usados para autenticação de senha com base em SASL-LDAP."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Plugin ou arquivo</th> <th>Nome do Plugin ou do Arquivo</th> </tr></thead><tbody><tr> <td>Nome do plugin no lado do servidor</td> <td>[[<code class="literal">authentication_ldap_sasl</code>]]</td> </tr><tr> <td>Nome do plugin no lado do cliente</td> <td>[[<code class="literal">authentication_ldap_sasl_client</code>]]</td> </tr><tr> <td>Nomes de arquivos da biblioteca</td> <td>[[<code class="filename">authentication_ldap_sasl.so</code>]], [[<code class="filename">authentication_ldap_sasl_client.so</code>]]</td> </tr></tbody></table>

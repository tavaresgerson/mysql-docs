...
<table summary="Como as várias combinações de valores de Usuário e Host na tabela de usuários se aplicam às conexões recebidas em um servidor MySQL."><col style="width: 15%"/><col style="width: 35%"/><col style="width: 50%"/><thead><tr> <th scope="col">[[PH_HTML_CODE_<code class="literal">'%'</code>] Valor</th> <th scope="col">[[PH_HTML_CODE_<code class="literal">'%'</code>] Valor</th> <th scope="col">Conexões Permitidas</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">''</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">'%'</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">'fred'</code>], conectando-se a partir de [[PH_HTML_CODE_<code class="literal">'%.example.net'</code>]</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">fred</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">example.net</code>]</td> <td>Qualquer usuário, conectando-se a partir de [[PH_HTML_CODE_<code class="literal">'fred'</code>]</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">'x.example.%'</code>]</th> <td>[[<code class="literal">'%'</code>]]</td> <td>[[<code class="literal">Host</code><code class="literal">'%'</code>], conectando-se a partir de qualquer host</td> </tr><tr> <th scope="row">[[<code class="literal">''</code>]]</th> <td>[[<code class="literal">'%'</code>]]</td> <td>Qualquer usuário, conectando-se a partir de qualquer host</td> </tr><tr> <th scope="row">[[<code class="literal">'fred'</code>]]</th> <td>[[<code class="literal">'%.example.net'</code>]]</td> <td>[[<code class="literal">fred</code>]], conectando-se a partir de qualquer host no domínio [[<code class="literal">example.net</code>]]</td> </tr><tr> <th scope="row">[[<code class="literal">'fred'</code>]]</th> <td>[[<code class="literal">'x.example.%'</code>]]</td> <td>[[<code class="literal">'fred'</code><code class="literal">'%'</code>], conectando-se a partir de [[<code class="literal">'fred'</code><code class="literal">'%'</code>], [[<code class="literal">'fred'</code><code class="literal">''</code>], [[<code class="literal">'fred'</code><code class="literal">'%'</code>], e assim por diante; isso provavelmente não é útil</td> </tr><tr> <th scope="row">[[<code class="literal">'fred'</code><code class="literal">'fred'</code>]</th> <td>[[<code class="literal">'fred'</code><code class="literal">'%.example.net'</code>]</td> <td>[[<code class="literal">'fred'</code><code class="literal">fred</code>], conectando-se do host com o endereço IP [[<code class="literal">'fred'</code><code class="literal">example.net</code>]</td> </tr><tr> <th scope="row">[[<code class="literal">'fred'</code><code class="literal">'fred'</code>]</th> <td>[[<code class="literal">'fred'</code><code class="literal">'x.example.%'</code>]</td> <td>[[<code class="literal">'h1.example.net'</code><code class="literal">'%'</code>], conectando-se a partir de qualquer host na sub-rede classe C [[<code class="literal">'h1.example.net'</code><code class="literal">'%'</code>]</td> </tr><tr> <th scope="row">[[<code class="literal">'h1.example.net'</code><code class="literal">''</code>]</th> <td>[[<code class="literal">'h1.example.net'</code><code class="literal">'%'</code>]</td> <td>O mesmo que no exemplo anterior</td> </tr></tbody></table>

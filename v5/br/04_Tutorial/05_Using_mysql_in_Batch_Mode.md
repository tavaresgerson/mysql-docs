## 3.5 Usando o mysql em Modo de Batch
...
Se você precisar especificar os parâmetros de conexão na string de comando, o comando pode parecer assim:
...
Se você deseja que o script continue mesmo que algumas das declarações produzam erros, você deve usar a opção de string de comando `--force`.
...
Consulte a Seção 4.5.1.5, “Executar declarações SQL a partir de um arquivo de texto”, para obter mais informações.
...
<table frame="box" rules="all" summary="Uma referência que lista funções agregadas."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Nome</th> <th>Descrição</th> <th>Introduzido</th> </tr></thead><tbody><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_avg">[[PH_HTML_CODE_<code>MIN()</code>]</a></th> <td>Retorne o valor médio do argumento</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-and">[[PH_HTML_CODE_<code>MIN()</code>]</a></th> <td>Retorno bit a bit e</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-or">[[PH_HTML_CODE_<code>STDDEV()</code>]</a></th> <td>Bitwise OR</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-xor">[[PH_HTML_CODE_<code>STDDEV_POP()</code>]</a></th> <td>XOR bit a bit</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_count">[[PH_HTML_CODE_<code>STDDEV_SAMP()</code>]</a></th> <td>Retorne um contagem do número de linhas retornadas</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_count-distinct">[[PH_HTML_CODE_<code>SUM()</code>]</a></th> <td>Retorne o número de valores diferentes</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_group-concat">[[PH_HTML_CODE_<code>VAR_POP()</code>]</a></th> <td>Retorne uma string concatenada</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_json-arrayagg">[[PH_HTML_CODE_<code>VAR_SAMP()</code>]</a></th> <td>Retorne o conjunto de resultados como um único array JSON</td> <td>5.7.22</td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_json-objectagg">[[PH_HTML_CODE_<code>VARIANCE()</code>]</a></th> <td>Retorne o conjunto de resultados como um único objeto JSON</td> <td>5.7.22</td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_max">[[<code>MAX()</code>]]</a></th> <td>Retorne o valor máximo</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_min">[[<code>MIN()</code>]]</a></th> <td>Retorne o valor mínimo</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_std">[[<code>BIT_AND()</code><code>MIN()</code>]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev">[[<code>STDDEV()</code>]]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev-pop">[[<code>STDDEV_POP()</code>]]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev-samp">[[<code>STDDEV_SAMP()</code>]]</a></th> <td>Retorne a desvio padrão da amostra</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_sum">[[<code>SUM()</code>]]</a></th> <td>Devolva a soma</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_var-pop">[[<code>VAR_POP()</code>]]</a></th> <td>Retorne a variância padrão da população</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_var-samp">[[<code>VAR_SAMP()</code>]]</a></th> <td>Retorne a variância da amostra</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_variance">[[<code>VARIANCE()</code>]]</a></th> <td>Retorne a variância padrão da população</td> <td></td> </tr></tbody></table>

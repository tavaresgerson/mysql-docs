...
<table frame="box" rules="all" summary="Uma referência que lista funções agregadas."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Nome</th> <th>Descrição</th> <th>Introduzido</th> </tr></thead><tbody><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_avg">[[PH_HTML_CODE_<code class="literal">MIN()</code>]</a></th> <td>Retorne o valor médio do argumento</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-and">[[PH_HTML_CODE_<code class="literal">MIN()</code>]</a></th> <td>Retorno bit a bit e</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-or">[[PH_HTML_CODE_<code class="literal">STDDEV()</code>]</a></th> <td>Bitwise OR</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_bit-xor">[[PH_HTML_CODE_<code class="literal">STDDEV_POP()</code>]</a></th> <td>XOR bit a bit</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_count">[[PH_HTML_CODE_<code class="literal">STDDEV_SAMP()</code>]</a></th> <td>Retorne um contagem do número de linhas retornadas</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_count-distinct">[[PH_HTML_CODE_<code class="literal">SUM()</code>]</a></th> <td>Retorne o número de valores diferentes</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_group-concat">[[PH_HTML_CODE_<code class="literal">VAR_POP()</code>]</a></th> <td>Retorne uma string concatenada</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_json-arrayagg">[[PH_HTML_CODE_<code class="literal">VAR_SAMP()</code>]</a></th> <td>Retorne o conjunto de resultados como um único array JSON</td> <td>5.7.22</td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_json-objectagg">[[PH_HTML_CODE_<code class="literal">VARIANCE()</code>]</a></th> <td>Retorne o conjunto de resultados como um único objeto JSON</td> <td>5.7.22</td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_max">[[<code class="literal">MAX()</code>]]</a></th> <td>Retorne o valor máximo</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_min">[[<code class="literal">MIN()</code>]]</a></th> <td>Retorne o valor mínimo</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_std">[[<code class="literal">BIT_AND()</code><code class="literal">MIN()</code>]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev">[[<code class="literal">STDDEV()</code>]]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev-pop">[[<code class="literal">STDDEV_POP()</code>]]</a></th> <td>Retorne a desvio padrão populacional</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_stddev-samp">[[<code class="literal">STDDEV_SAMP()</code>]]</a></th> <td>Retorne a desvio padrão da amostra</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_sum">[[<code class="literal">SUM()</code>]]</a></th> <td>Devolva a soma</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_var-pop">[[<code class="literal">VAR_POP()</code>]]</a></th> <td>Retorne a variância padrão da população</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_var-samp">[[<code class="literal">VAR_SAMP()</code>]]</a></th> <td>Retorne a variância da amostra</td> <td></td> </tr><tr><th scope="row"><a class="link" href="aggregate-functions.html#function_variance">[[<code class="literal">VARIANCE()</code>]]</a></th> <td>Retorne a variância padrão da população</td> <td></td> </tr></tbody></table>

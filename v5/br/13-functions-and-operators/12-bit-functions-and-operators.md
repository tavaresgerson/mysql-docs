...
<table frame="box" rules="all" summary="Uma referência que lista funções e operadores de bits."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="bit-functions.html#operator_bitwise-and">[[<code class="literal">&amp;</code>]]</a></td> <td>E AND bit a bit</td> </tr><tr><td><a class="link" href="bit-functions.html#operator_right-shift">[[<code class="literal">&gt;&gt;</code>]]</a></td> <td>Deslocamento para a direita</td> </tr><tr><td><a class="link" href="bit-functions.html#operator_left-shift">[[<code class="literal">&lt;&lt;</code>]]</a></td> <td>Deslocamento para a esquerda</td> </tr><tr><td><a class="link" href="bit-functions.html#operator_bitwise-xor">[[<code class="literal">^</code>]]</a></td> <td>XOR bit a bit</td> </tr><tr><td><a class="link" href="bit-functions.html#function_bit-count">[[<code class="literal">BIT_COUNT()</code>]]</a></td> <td>Retorne o número de bits definidos</td> </tr><tr><td><a class="link" href="bit-functions.html#operator_bitwise-or">[[<code class="literal">|</code>]]</a></td> <td>Bitwise OU</td> </tr><tr><td><a class="link" href="bit-functions.html#operator_bitwise-invert">[[<code class="literal">~</code>]]</a></td> <td>Inversão bit a bit</td> </tr></tbody></table>

...
<table frame="box" rules="all" summary="Uma referência que lista funções de data e hora."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="date-and-time-functions.html#function_adddate">[[PH_HTML_CODE_<code>CURTIME()</code>]</a></td> <td>Adicione valores de tempo (intervalos) a um valor de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_addtime">[[PH_HTML_CODE_<code>CURTIME()</code>]</a></td> <td>Adicione tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_convert-tz">[[PH_HTML_CODE_<code>DATE_ADD()</code>]</a></td> <td>Converter de um fuso horário para outro</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_curdate">[[PH_HTML_CODE_<code>DATE_FORMAT()</code>]</a></td> <td>Retorne a data atual</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-date">[[PH_HTML_CODE_<code>DATE_SUB()</code>], [[PH_HTML_CODE_<code>DATEDIFF()</code>]</a></td> <td>Sinônimos para CURDATE()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-time">[[PH_HTML_CODE_<code>DAY()</code>], [[PH_HTML_CODE_<code>DAYNAME()</code>]</a></td> <td>Sinônimos para CURTIME()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-timestamp">[[PH_HTML_CODE_<code>DAYOFMONTH()</code>], [[PH_HTML_CODE_<code>DAYOFWEEK()</code>]</a></td> <td>Sinônimos para NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_curtime">[[<code>CURTIME()</code>]]</a></td> <td>Retorne a hora atual</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date">[[<code>ADDTIME()</code><code>CURTIME()</code>]</a></td> <td>Extrair a parte da data de uma expressão de data ou datetime</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-add">[[<code>DATE_ADD()</code>]]</a></td> <td>Adicione valores de tempo (intervalos) a um valor de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-format">[[<code>DATE_FORMAT()</code>]]</a></td> <td>Formatar a data conforme especificado</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-sub">[[<code>DATE_SUB()</code>]]</a></td> <td>Subtraia um valor de tempo (intervalo) de uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_datediff">[[<code>DATEDIFF()</code>]]</a></td> <td>Subtraia duas datas</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_day">[[<code>DAY()</code>]]</a></td> <td>Sinônimo de DAYOFMONTH()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayname">[[<code>DAYNAME()</code>]]</a></td> <td>Retorne o nome do dia da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofmonth">[[<code>DAYOFMONTH()</code>]]</a></td> <td>Retorne o dia do mês (0-31)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofweek">[[<code>DAYOFWEEK()</code>]]</a></td> <td>Retorne o índice de dia da semana do argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofyear">[[<code>CONVERT_TZ()</code><code>CURTIME()</code>]</a></td> <td>Retorne o dia do ano (1-366)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_extract">[[<code>CONVERT_TZ()</code><code>CURTIME()</code>]</a></td> <td>Extrair parte de uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_from-days">[[<code>CONVERT_TZ()</code><code>DATE_ADD()</code>]</a></td> <td>Converter um número de dia em uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_from-unixtime">[[<code>CONVERT_TZ()</code><code>DATE_FORMAT()</code>]</a></td> <td>Formatar o timestamp Unix como uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>CONVERT_TZ()</code><code>DATE_SUB()</code>]</a></td> <td>Retorne uma string de formato de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_hour">[[<code>CONVERT_TZ()</code><code>DATEDIFF()</code>]</a></td> <td>Extraia a hora</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_last-day">[[<code>CONVERT_TZ()</code><code>DAY()</code>]</a></td> <td>Retorne o último dia do mês para o argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_localtime">[[<code>CONVERT_TZ()</code><code>DAYNAME()</code>], [[<code>CONVERT_TZ()</code><code>DAYOFMONTH()</code>]</a></td> <td>Sinônimo de NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_localtimestamp">[[<code>CONVERT_TZ()</code><code>DAYOFWEEK()</code>], [[<code>CURDATE()</code><code>CURTIME()</code>]</a></td> <td>Sinônimo de NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_makedate">[[<code>CURDATE()</code><code>CURTIME()</code>]</a></td> <td>Crie uma data a partir do ano e do dia do ano</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_maketime">[[<code>CURDATE()</code><code>DATE_ADD()</code>]</a></td> <td>Crie tempo a partir de hora, minuto e segundo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_microsecond">[[<code>CURDATE()</code><code>DATE_FORMAT()</code>]</a></td> <td>Retorne os microsegundos do argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_minute">[[<code>CURDATE()</code><code>DATE_SUB()</code>]</a></td> <td>Devolva o minuto da discussão</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_month">[[<code>CURDATE()</code><code>DATEDIFF()</code>]</a></td> <td>Retorne o mês da data passada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_monthname">[[<code>CURDATE()</code><code>DAY()</code>]</a></td> <td>Retorne o nome do mês</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_now">[[<code>CURDATE()</code><code>DAYNAME()</code>]</a></td> <td>Retorne a data e hora atuais</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_period-add">[[<code>CURDATE()</code><code>DAYOFMONTH()</code>]</a></td> <td>Adicione um ponto final a um ano-mês</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_period-diff">[[<code>CURDATE()</code><code>DAYOFWEEK()</code>]</a></td> <td>Retorne o número de meses entre os períodos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_quarter">[[<code>CURRENT_DATE()</code><code>CURTIME()</code>]</a></td> <td>Retorne o quarto de um argumento de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_sec-to-time">[[<code>CURRENT_DATE()</code><code>CURTIME()</code>]</a></td> <td>Converte segundos para o formato 'hh:mm:ss'</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_second">[[<code>CURRENT_DATE()</code><code>DATE_ADD()</code>]</a></td> <td>Retorne o segundo (0-59)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_str-to-date">[[<code>CURRENT_DATE()</code><code>DATE_FORMAT()</code>]</a></td> <td>Converter uma string em uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_subdate">[[<code>CURRENT_DATE()</code><code>DATE_SUB()</code>]</a></td> <td>Sinônimo de DATE_SUB() quando invocado com três argumentos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_subtime">[[<code>CURRENT_DATE()</code><code>DATEDIFF()</code>]</a></td> <td>Subtraia vezes</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_sysdate">[[<code>CURRENT_DATE()</code><code>DAY()</code>]</a></td> <td>Retorne o momento em que a função é executada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time">[[<code>CURRENT_DATE()</code><code>DAYNAME()</code>]</a></td> <td>Extraia a porção de tempo da expressão passada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time-format">[[<code>CURRENT_DATE()</code><code>DAYOFMONTH()</code>]</a></td> <td>Formato como tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time-to-sec">[[<code>CURRENT_DATE()</code><code>DAYOFWEEK()</code>]</a></td> <td>Retorne o argumento convertido em segundos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timediff">[[<code>CURRENT_DATE</code><code>CURTIME()</code>]</a></td> <td>Subtraia o tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestamp">[[<code>CURRENT_DATE</code><code>CURTIME()</code>]</a></td> <td>Com um único argumento, essa função retorna a expressão de data ou datetime; com dois argumentos, a soma dos argumentos.</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestampadd">[[<code>CURRENT_DATE</code><code>DATE_ADD()</code>]</a></td> <td>Adicione um intervalo a uma expressão de data e hora</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestampdiff">[[<code>CURRENT_DATE</code><code>DATE_FORMAT()</code>]</a></td> <td>Retorne a diferença entre duas expressões de data e hora, usando as unidades especificadas</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_to-days">[[<code>CURRENT_DATE</code><code>DATE_SUB()</code>]</a></td> <td>Retorne o argumento de data convertido em dias</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_to-seconds">[[<code>CURRENT_DATE</code><code>DATEDIFF()</code>]</a></td> <td>Retorne o argumento de data ou datetime convertido em segundos desde o ano 0</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_unix-timestamp">[[<code>CURRENT_DATE</code><code>DAY()</code>]</a></td> <td>Retorne um timestamp Unix</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-date">[[<code>CURRENT_DATE</code><code>DAYNAME()</code>]</a></td> <td>Retorne a data atual UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-time">[[<code>CURRENT_DATE</code><code>DAYOFMONTH()</code>]</a></td> <td>Retorne a hora atual UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-timestamp">[[<code>CURRENT_DATE</code><code>DAYOFWEEK()</code>]</a></td> <td>Retorne a data e hora atuais em UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_week">[[<code>CURRENT_TIME()</code><code>CURTIME()</code>]</a></td> <td>Retorne o número da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_weekday">[[<code>CURRENT_TIME()</code><code>CURTIME()</code>]</a></td> <td>Retorne o índice do dia da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_weekofyear">[[<code>CURRENT_TIME()</code><code>DATE_ADD()</code>]</a></td> <td>Retorne a semana do calendário da data (1-53)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_year">[[<code>CURRENT_TIME()</code><code>DATE_FORMAT()</code>]</a></td> <td>Retorne o ano</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_yearweek">[[<code>CURRENT_TIME()</code><code>DATE_SUB()</code>]</a></td> <td>Retorne o ano e a semana</td> </tr></tbody></table>
...
- `GET_FORMAT({DATA|HORA|DATA_HORÁRIA}, {'EUR'|'EUA'|'JIS'|'ISO'|'INTERNO'})`
  ...
  <table summary="As funções solicitam a função GET_FORMAT, juntamente com os resultados de cada chamada de função."><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th>Chamada de função</th> <th>Resultado</th> </tr></thead><tbody><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'USA')</code>]</a></td> <td>[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'JIS')</code>]</a></td> <td>[[PH_HTML_CODE_<code>'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'ISO')</code>]</a></td> <td>[[PH_HTML_CODE_<code>'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'EUR')</code>]</a></td> <td>[[PH_HTML_CODE_<code>'%Y-%m-%d %H.%i.%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code>GET_FORMAT(DATETIME,'INTERNAL')</code>]</a></td> <td>[[PH_HTML_CODE_<code>'%Y%m%d%H%i%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATETIME,'USA')</code>]]</a></td> <td>[[<code>'%m.%d.%Y'</code><code>GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATETIME,'JIS')</code>]]</a></td> <td>[[<code>'%Y-%m-%d %H:%i:%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATETIME,'ISO')</code>]]</a></td> <td>[[<code>'%Y-%m-%d %H:%i:%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATETIME,'EUR')</code>]]</a></td> <td>[[<code>'%Y-%m-%d %H.%i.%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATETIME,'INTERNAL')</code>]]</a></td> <td>[[<code>'%Y%m%d%H%i%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'USA')</code>]</a></td> <td>[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'JIS')</code>]</a></td> <td>[[<code>GET_FORMAT(DATE,'JIS')</code><code>'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'ISO')</code>]</a></td> <td>[[<code>GET_FORMAT(DATE,'JIS')</code><code>'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'EUR')</code>]</a></td> <td>[[<code>GET_FORMAT(DATE,'JIS')</code><code>'%Y-%m-%d %H.%i.%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code>GET_FORMAT(DATE,'JIS')</code><code>GET_FORMAT(DATETIME,'INTERNAL')</code>]</a></td> <td>[[<code>GET_FORMAT(DATE,'JIS')</code><code>'%Y%m%d%H%i%s'</code>]</td> </tr></tbody></table>

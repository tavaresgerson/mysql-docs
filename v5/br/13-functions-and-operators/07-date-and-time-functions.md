...
<table frame="box" rules="all" summary="Uma referência que lista funções de data e hora."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="date-and-time-functions.html#function_adddate">[[PH_HTML_CODE_<code class="literal">CURTIME()</code>]</a></td> <td>Adicione valores de tempo (intervalos) a um valor de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_addtime">[[PH_HTML_CODE_<code class="literal">CURTIME()</code>]</a></td> <td>Adicione tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_convert-tz">[[PH_HTML_CODE_<code class="literal">DATE_ADD()</code>]</a></td> <td>Converter de um fuso horário para outro</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_curdate">[[PH_HTML_CODE_<code class="literal">DATE_FORMAT()</code>]</a></td> <td>Retorne a data atual</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-date">[[PH_HTML_CODE_<code class="literal">DATE_SUB()</code>], [[PH_HTML_CODE_<code class="literal">DATEDIFF()</code>]</a></td> <td>Sinônimos para CURDATE()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-time">[[PH_HTML_CODE_<code class="literal">DAY()</code>], [[PH_HTML_CODE_<code class="literal">DAYNAME()</code>]</a></td> <td>Sinônimos para CURTIME()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_current-timestamp">[[PH_HTML_CODE_<code class="literal">DAYOFMONTH()</code>], [[PH_HTML_CODE_<code class="literal">DAYOFWEEK()</code>]</a></td> <td>Sinônimos para NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_curtime">[[<code class="literal">CURTIME()</code>]]</a></td> <td>Retorne a hora atual</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date">[[<code class="literal">ADDTIME()</code><code class="literal">CURTIME()</code>]</a></td> <td>Extrair a parte da data de uma expressão de data ou datetime</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-add">[[<code class="literal">DATE_ADD()</code>]]</a></td> <td>Adicione valores de tempo (intervalos) a um valor de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-format">[[<code class="literal">DATE_FORMAT()</code>]]</a></td> <td>Formatar a data conforme especificado</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_date-sub">[[<code class="literal">DATE_SUB()</code>]]</a></td> <td>Subtraia um valor de tempo (intervalo) de uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_datediff">[[<code class="literal">DATEDIFF()</code>]]</a></td> <td>Subtraia duas datas</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_day">[[<code class="literal">DAY()</code>]]</a></td> <td>Sinônimo de DAYOFMONTH()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayname">[[<code class="literal">DAYNAME()</code>]]</a></td> <td>Retorne o nome do dia da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofmonth">[[<code class="literal">DAYOFMONTH()</code>]]</a></td> <td>Retorne o dia do mês (0-31)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofweek">[[<code class="literal">DAYOFWEEK()</code>]]</a></td> <td>Retorne o índice de dia da semana do argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_dayofyear">[[<code class="literal">CONVERT_TZ()</code><code class="literal">CURTIME()</code>]</a></td> <td>Retorne o dia do ano (1-366)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_extract">[[<code class="literal">CONVERT_TZ()</code><code class="literal">CURTIME()</code>]</a></td> <td>Extrair parte de uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_from-days">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DATE_ADD()</code>]</a></td> <td>Converter um número de dia em uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_from-unixtime">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DATE_FORMAT()</code>]</a></td> <td>Formatar o timestamp Unix como uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DATE_SUB()</code>]</a></td> <td>Retorne uma string de formato de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_hour">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DATEDIFF()</code>]</a></td> <td>Extraia a hora</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_last-day">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DAY()</code>]</a></td> <td>Retorne o último dia do mês para o argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_localtime">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DAYNAME()</code>], [[<code class="literal">CONVERT_TZ()</code><code class="literal">DAYOFMONTH()</code>]</a></td> <td>Sinônimo de NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_localtimestamp">[[<code class="literal">CONVERT_TZ()</code><code class="literal">DAYOFWEEK()</code>], [[<code class="literal">CURDATE()</code><code class="literal">CURTIME()</code>]</a></td> <td>Sinônimo de NOW()</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_makedate">[[<code class="literal">CURDATE()</code><code class="literal">CURTIME()</code>]</a></td> <td>Crie uma data a partir do ano e do dia do ano</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_maketime">[[<code class="literal">CURDATE()</code><code class="literal">DATE_ADD()</code>]</a></td> <td>Crie tempo a partir de hora, minuto e segundo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_microsecond">[[<code class="literal">CURDATE()</code><code class="literal">DATE_FORMAT()</code>]</a></td> <td>Retorne os microsegundos do argumento</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_minute">[[<code class="literal">CURDATE()</code><code class="literal">DATE_SUB()</code>]</a></td> <td>Devolva o minuto da discussão</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_month">[[<code class="literal">CURDATE()</code><code class="literal">DATEDIFF()</code>]</a></td> <td>Retorne o mês da data passada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_monthname">[[<code class="literal">CURDATE()</code><code class="literal">DAY()</code>]</a></td> <td>Retorne o nome do mês</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_now">[[<code class="literal">CURDATE()</code><code class="literal">DAYNAME()</code>]</a></td> <td>Retorne a data e hora atuais</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_period-add">[[<code class="literal">CURDATE()</code><code class="literal">DAYOFMONTH()</code>]</a></td> <td>Adicione um ponto final a um ano-mês</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_period-diff">[[<code class="literal">CURDATE()</code><code class="literal">DAYOFWEEK()</code>]</a></td> <td>Retorne o número de meses entre os períodos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_quarter">[[<code class="literal">CURRENT_DATE()</code><code class="literal">CURTIME()</code>]</a></td> <td>Retorne o quarto de um argumento de data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_sec-to-time">[[<code class="literal">CURRENT_DATE()</code><code class="literal">CURTIME()</code>]</a></td> <td>Converte segundos para o formato 'hh:mm:ss'</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_second">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DATE_ADD()</code>]</a></td> <td>Retorne o segundo (0-59)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_str-to-date">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DATE_FORMAT()</code>]</a></td> <td>Converter uma string em uma data</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_subdate">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DATE_SUB()</code>]</a></td> <td>Sinônimo de DATE_SUB() quando invocado com três argumentos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_subtime">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DATEDIFF()</code>]</a></td> <td>Subtraia vezes</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_sysdate">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DAY()</code>]</a></td> <td>Retorne o momento em que a função é executada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DAYNAME()</code>]</a></td> <td>Extraia a porção de tempo da expressão passada</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time-format">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DAYOFMONTH()</code>]</a></td> <td>Formato como tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_time-to-sec">[[<code class="literal">CURRENT_DATE()</code><code class="literal">DAYOFWEEK()</code>]</a></td> <td>Retorne o argumento convertido em segundos</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timediff">[[<code class="literal">CURRENT_DATE</code><code class="literal">CURTIME()</code>]</a></td> <td>Subtraia o tempo</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestamp">[[<code class="literal">CURRENT_DATE</code><code class="literal">CURTIME()</code>]</a></td> <td>Com um único argumento, essa função retorna a expressão de data ou datetime; com dois argumentos, a soma dos argumentos.</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestampadd">[[<code class="literal">CURRENT_DATE</code><code class="literal">DATE_ADD()</code>]</a></td> <td>Adicione um intervalo a uma expressão de data e hora</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_timestampdiff">[[<code class="literal">CURRENT_DATE</code><code class="literal">DATE_FORMAT()</code>]</a></td> <td>Retorne a diferença entre duas expressões de data e hora, usando as unidades especificadas</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_to-days">[[<code class="literal">CURRENT_DATE</code><code class="literal">DATE_SUB()</code>]</a></td> <td>Retorne o argumento de data convertido em dias</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_to-seconds">[[<code class="literal">CURRENT_DATE</code><code class="literal">DATEDIFF()</code>]</a></td> <td>Retorne o argumento de data ou datetime convertido em segundos desde o ano 0</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_unix-timestamp">[[<code class="literal">CURRENT_DATE</code><code class="literal">DAY()</code>]</a></td> <td>Retorne um timestamp Unix</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-date">[[<code class="literal">CURRENT_DATE</code><code class="literal">DAYNAME()</code>]</a></td> <td>Retorne a data atual UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-time">[[<code class="literal">CURRENT_DATE</code><code class="literal">DAYOFMONTH()</code>]</a></td> <td>Retorne a hora atual UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_utc-timestamp">[[<code class="literal">CURRENT_DATE</code><code class="literal">DAYOFWEEK()</code>]</a></td> <td>Retorne a data e hora atuais em UTC</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_week">[[<code class="literal">CURRENT_TIME()</code><code class="literal">CURTIME()</code>]</a></td> <td>Retorne o número da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_weekday">[[<code class="literal">CURRENT_TIME()</code><code class="literal">CURTIME()</code>]</a></td> <td>Retorne o índice do dia da semana</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_weekofyear">[[<code class="literal">CURRENT_TIME()</code><code class="literal">DATE_ADD()</code>]</a></td> <td>Retorne a semana do calendário da data (1-53)</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_year">[[<code class="literal">CURRENT_TIME()</code><code class="literal">DATE_FORMAT()</code>]</a></td> <td>Retorne o ano</td> </tr><tr><td><a class="link" href="date-and-time-functions.html#function_yearweek">[[<code class="literal">CURRENT_TIME()</code><code class="literal">DATE_SUB()</code>]</a></td> <td>Retorne o ano e a semana</td> </tr></tbody></table>
...
- `DATE_FORMAT(data, formato)`
  ...
  <table summary="Caracteres especificadores para a função DATE_FORMAT que podem ser usados na string de formato e fornece uma descrição de cada caractere especificador."><col style="width: 20%"/><col style="width: 70%"/><thead><tr> <th>Especificador</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">0th</code>]</td> <td>Nome abreviado do dia da semana ([[PH_HTML_CODE_<code class="literal">0th</code>]..[[PH_HTML_CODE_<code class="literal">2nd</code>])</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">3rd</code>]</td> <td>Nome do mês abreviado ([[PH_HTML_CODE_<code class="literal">%d</code>]..[[PH_HTML_CODE_<code class="literal">00</code>])</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">31</code>]</td> <td>Mês, numérico ([[PH_HTML_CODE_<code class="literal">%e</code>]..[[PH_HTML_CODE_<code class="literal">0</code>])</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">31</code>]</td> <td>Dia do mês com sufixo em inglês ([[<code class="literal">0th</code>]], [[<code class="literal">Sun</code><code class="literal">0th</code>], [[<code class="literal">2nd</code>]], [[<code class="literal">3rd</code>]], …)</td> </tr><tr> <td>[[<code class="literal">%d</code>]]</td> <td>Dia do mês, numérico ([[<code class="literal">00</code>]]..[[<code class="literal">31</code>]])</td> </tr><tr> <td>[[<code class="literal">%e</code>]]</td> <td>Dia do mês, numérico ([[<code class="literal">0</code>]]..[[<code class="literal">31</code>]])</td> </tr><tr> <td>[[<code class="literal">Sat</code><code class="literal">0th</code>]</td> <td>Microssegundos ([[<code class="literal">Sat</code><code class="literal">0th</code>]..[[<code class="literal">Sat</code><code class="literal">2nd</code>])</td> </tr><tr> <td>[[<code class="literal">Sat</code><code class="literal">3rd</code>]</td> <td>Hora ([[<code class="literal">Sat</code><code class="literal">%d</code>]..[[<code class="literal">Sat</code><code class="literal">00</code>])</td> </tr><tr> <td>[[<code class="literal">Sat</code><code class="literal">31</code>]</td> <td>Hora ([[<code class="literal">Sat</code><code class="literal">%e</code>]..[[<code class="literal">Sat</code><code class="literal">0</code>])</td> </tr><tr> <td>[[<code class="literal">Sat</code><code class="literal">31</code>]</td> <td>Hora ([[<code class="literal">%b</code><code class="literal">0th</code>]..[[<code class="literal">%b</code><code class="literal">0th</code>])</td> </tr><tr> <td>[[<code class="literal">%b</code><code class="literal">2nd</code>]</td> <td>Minutos, numéricos ([[<code class="literal">%b</code><code class="literal">3rd</code>]..[[<code class="literal">%b</code><code class="literal">%d</code>])</td> </tr><tr> <td>[[<code class="literal">%b</code><code class="literal">00</code>]</td> <td>Dia do ano ([[<code class="literal">%b</code><code class="literal">31</code>]..[[<code class="literal">%b</code><code class="literal">%e</code>])</td> </tr><tr> <td>[[<code class="literal">%b</code><code class="literal">0</code>]</td> <td>Hora ([[<code class="literal">%b</code><code class="literal">31</code>]..[[<code class="literal">Jan</code><code class="literal">0th</code>])</td> </tr><tr> <td>[[<code class="literal">Jan</code><code class="literal">0th</code>]</td> <td>Hora ([[<code class="literal">Jan</code><code class="literal">2nd</code>]..[[<code class="literal">Jan</code><code class="literal">3rd</code>])</td> </tr><tr> <td>[[<code class="literal">Jan</code><code class="literal">%d</code>]</td> <td>Nome do mês ([[<code class="literal">Jan</code><code class="literal">00</code>]..[[<code class="literal">Jan</code><code class="literal">31</code>])</td> </tr><tr> <td>[[<code class="literal">Jan</code><code class="literal">%e</code>]</td> <td>Mês, numérico ([[<code class="literal">Jan</code><code class="literal">0</code>]..[[<code class="literal">Jan</code><code class="literal">31</code>])</td> </tr><tr> <td>[[<code class="literal">Dec</code><code class="literal">0th</code>]</td> <td>[[<code class="literal">Dec</code><code class="literal">0th</code>] ou [[<code class="literal">Dec</code><code class="literal">2nd</code>]</td> </tr><tr> <td>[[<code class="literal">Dec</code><code class="literal">3rd</code>]</td> <td>Hora, 12 horas (<em class="replaceable">[[<code class="literal">Dec</code><code class="literal">%d</code>]</em>seguido por [[<code class="literal">Dec</code><code class="literal">00</code>] ou [[<code class="literal">Dec</code><code class="literal">31</code>])</td> </tr><tr> <td>[[<code class="literal">Dec</code><code class="literal">%e</code>]</td> <td>Segundos ([[<code class="literal">Dec</code><code class="literal">0</code>]..[[<code class="literal">Dec</code><code class="literal">31</code>])</td> </tr><tr> <td>[[<code class="literal">%c</code><code class="literal">0th</code>]</td> <td>Segundos ([[<code class="literal">%c</code><code class="literal">0th</code>]..[[<code class="literal">%c</code><code class="literal">2nd</code>])</td> </tr><tr> <td>[[<code class="literal">%c</code><code class="literal">3rd</code>]</td> <td>Tempo, 24 horas (<em class="replaceable">[[<code class="literal">%c</code><code class="literal">%d</code>]</em>)</td> </tr><tr> <td>[[<code class="literal">%c</code><code class="literal">00</code>]</td> <td>Semana ([[<code class="literal">%c</code><code class="literal">31</code>]..[[<code class="literal">%c</code><code class="literal">%e</code>]), onde o domingo é o primeiro dia da semana;<a class="link" href="date-and-time-functions.html#function_week">[[<code class="literal">%c</code><code class="literal">0</code>]</a>modo 0</td> </tr><tr> <td>[[<code class="literal">%c</code><code class="literal">31</code>]</td> <td>Semana ([[<code class="literal">0</code><code class="literal">0th</code>]..[[<code class="literal">0</code><code class="literal">0th</code>]), onde segunda-feira é o primeiro dia da semana;<a class="link" href="date-and-time-functions.html#function_week">[[<code class="literal">0</code><code class="literal">2nd</code>]</a>modo 1</td> </tr><tr> <td>[[<code class="literal">0</code><code class="literal">3rd</code>]</td> <td>Semana ([[<code class="literal">0</code><code class="literal">%d</code>]..[[<code class="literal">0</code><code class="literal">00</code>]), onde o domingo é o primeiro dia da semana;<a class="link" href="date-and-time-functions.html#function_week">[[<code class="literal">0</code><code class="literal">31</code>]</a>modo 2; usado com [[<code class="literal">0</code><code class="literal">%e</code>]</td> </tr><tr> <td>[[<code class="literal">0</code><code class="literal">0</code>]</td> <td>Semana ([[<code class="literal">0</code><code class="literal">31</code>]..[[<code class="literal">12</code><code class="literal">0th</code>]), onde segunda-feira é o primeiro dia da semana;<a class="link" href="date-and-time-functions.html#function_week">[[<code class="literal">12</code><code class="literal">0th</code>]</a>modo 3; usado com [[<code class="literal">12</code><code class="literal">2nd</code>]</td> </tr><tr> <td>[[<code class="literal">12</code><code class="literal">3rd</code>]</td> <td>Nome do dia da semana ([[<code class="literal">12</code><code class="literal">%d</code>]..[[<code class="literal">12</code><code class="literal">00</code>])</td> </tr><tr> <td>[[<code class="literal">12</code><code class="literal">31</code>]</td> <td>Dia da semana ([[<code class="literal">12</code><code class="literal">%e</code>]=Domingo..[[<code class="literal">12</code><code class="literal">0</code>]=Sábado)</td> </tr><tr> <td>[[<code class="literal">12</code><code class="literal">31</code>]</td> <td>Ano da semana em que o domingo é o primeiro dia da semana, numérico, quatro dígitos; usado com [[<code class="literal">%D</code><code class="literal">0th</code>]</td> </tr><tr> <td>[[<code class="literal">%D</code><code class="literal">0th</code>]</td> <td>Ano da semana, onde segunda-feira é o primeiro dia da semana, numérico, quatro dígitos; usado com [[<code class="literal">%D</code><code class="literal">2nd</code>]</td> </tr><tr> <td>[[<code class="literal">%D</code><code class="literal">3rd</code>]</td> <td>Ano, número, quatro dígitos</td> </tr><tr> <td>[[<code class="literal">%D</code><code class="literal">%d</code>]</td> <td>Ano, numérico (dois dígitos)</td> </tr><tr> <td>[[<code class="literal">%D</code><code class="literal">00</code>]</td> <td>Um caractere literal [[<code class="literal">%D</code><code class="literal">31</code>]</td> </tr><tr> <td>[[<code class="literal">%D</code><code class="literal">%e</code>]</em></code></td> <td><em class="replaceable">[[<code class="literal">%D</code><code class="literal">0</code>]</em>, para qualquer<span class="quote">“<span class="quote"><em class="replaceable">[[<code class="literal">%D</code><code class="literal">31</code>]</em></span>”</span>não listado acima</td> </tr></tbody></table>
...
- `GET_FORMAT({DATA|HORA|DATA_HORÁRIA}, {'EUR'|'EUA'|'JIS'|'ISO'|'INTERNO'})`
  ...
  <table summary="As funções solicitam a função GET_FORMAT, juntamente com os resultados de cada chamada de função."><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th>Chamada de função</th> <th>Resultado</th> </tr></thead><tbody><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'USA')</code>]</a></td> <td>[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'JIS')</code>]</a></td> <td>[[PH_HTML_CODE_<code class="literal">'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'ISO')</code>]</a></td> <td>[[PH_HTML_CODE_<code class="literal">'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'EUR')</code>]</a></td> <td>[[PH_HTML_CODE_<code class="literal">'%Y-%m-%d %H.%i.%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[PH_HTML_CODE_<code class="literal">GET_FORMAT(DATETIME,'INTERNAL')</code>]</a></td> <td>[[PH_HTML_CODE_<code class="literal">'%Y%m%d%H%i%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATETIME,'USA')</code>]]</a></td> <td>[[<code class="literal">'%m.%d.%Y'</code><code class="literal">GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATETIME,'JIS')</code>]]</a></td> <td>[[<code class="literal">'%Y-%m-%d %H:%i:%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATETIME,'ISO')</code>]]</a></td> <td>[[<code class="literal">'%Y-%m-%d %H:%i:%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATETIME,'EUR')</code>]]</a></td> <td>[[<code class="literal">'%Y-%m-%d %H.%i.%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATETIME,'INTERNAL')</code>]]</a></td> <td>[[<code class="literal">'%Y%m%d%H%i%s'</code>]]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'USA')</code>]</a></td> <td>[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'USA')</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'JIS')</code>]</a></td> <td>[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'ISO')</code>]</a></td> <td>[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">'%Y-%m-%d %H:%i:%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'EUR')</code>]</a></td> <td>[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">'%Y-%m-%d %H.%i.%s'</code>]</td> </tr><tr> <td><a class="link" href="date-and-time-functions.html#function_get-format">[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">GET_FORMAT(DATETIME,'INTERNAL')</code>]</a></td> <td>[[<code class="literal">GET_FORMAT(DATE,'JIS')</code><code class="literal">'%Y%m%d%H%i%s'</code>]</td> </tr></tbody></table>
...
- `SUBDATE(data, INTERVAL expr unit)`, `SUBDATE(expr, dias)`
  ...
  Quando invocado com a forma `INTERVAL` do segundo argumento, `SUBDATE()` é sinônimo de `DATE_SUB()`. Para informações sobre o argumento `INTERVAL *`unidade`, consulte a discussão sobre `DATE\_ADD()\`.
...
- `WEEK(data[, modo])`
  ...
  <table summary="Agora o argumento de modo da função WEEK funciona. Para cada valor de modo, a tabela lista o primeiro dia da semana, a faixa e uma descrição da semana 1."><col style="width: 10%"/><col style="width: 20%"/><col style="width: 20%"/><col style="width: 50%"/><thead><tr> <th scope="col">Modo</th> <th scope="col">Primeiro dia da semana</th> <th scope="col">Gama</th> <th scope="col">A primeira semana é a primeira semana...</th> </tr></thead><tbody><tr> <th scope="row">0</th> <td>Domingo</td> <td>0-53</td> <td>com um domingo neste ano</td> </tr><tr> <th scope="row">1</th> <td>Segunda-feira</td> <td>0-53</td> <td>com 4 ou mais dias este ano</td> </tr><tr> <th scope="row">2</th> <td>Domingo</td> <td>1-53</td> <td>com um domingo neste ano</td> </tr><tr> <th scope="row">3</th> <td>Segunda-feira</td> <td>1-53</td> <td>com 4 ou mais dias este ano</td> </tr><tr> <th scope="row">4</th> <td>Domingo</td> <td>0-53</td> <td>com 4 ou mais dias este ano</td> </tr><tr> <th scope="row">5</th> <td>Segunda-feira</td> <td>0-53</td> <td>com um domingo neste ano</td> </tr><tr> <th scope="row">6</th> <td>Domingo</td> <td>1-53</td> <td>com 4 ou mais dias este ano</td> </tr><tr> <th scope="row">7</th> <td>Segunda-feira</td> <td>1-53</td> <td>com um domingo neste ano</td> </tr></tbody></table>

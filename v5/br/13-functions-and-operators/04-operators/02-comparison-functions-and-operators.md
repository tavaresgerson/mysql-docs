...
<table frame="box" rules="all" summary="Uma referência que lista operadores de comparação."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="comparison-operators.html#operator_greater-than">[[PH_HTML_CODE_<code class="literal">EXISTS()</code>]</a></td> <td>Operador maior que</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_greater-than-or-equal">[[PH_HTML_CODE_<code class="literal">EXISTS()</code>]</a></td> <td>Operador maior que ou igual a</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_less-than">[[PH_HTML_CODE_<code class="literal">IN()</code>]</a></td> <td>Menos que o operador</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_not-equal">[[PH_HTML_CODE_<code class="literal">INTERVAL()</code>], [[PH_HTML_CODE_<code class="literal">IS</code>]</a></td> <td>Operador não igual</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_less-than-or-equal">[[PH_HTML_CODE_<code class="literal">IS NOT</code>]</a></td> <td>Operador menor ou igual</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_equal-to">[[PH_HTML_CODE_<code class="literal">IS NOT NULL</code>]</a></td> <td>Igual a operador seguro para valores nulos</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_equal">[[PH_HTML_CODE_<code class="literal">IS NULL</code>]</a></td> <td>Operador igual</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_between">[[PH_HTML_CODE_<code class="literal">ISNULL()</code>]</a></td> <td>Se um valor estiver dentro de uma faixa de valores</td> </tr><tr><td><a class="link" href="comparison-operators.html#function_coalesce">[[PH_HTML_CODE_<code class="literal">LEAST()</code>]</a></td> <td>Retorne o primeiro argumento que não é NULL</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_exists">[[<code class="literal">EXISTS()</code>]]</a></td> <td>Se o resultado de uma consulta contiver alguma linha</td> </tr><tr><td><a class="link" href="comparison-operators.html#function_greatest">[[<code class="literal">&gt;=</code><code class="literal">EXISTS()</code>]</a></td> <td>Retorne o maior argumento</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_in">[[<code class="literal">IN()</code>]]</a></td> <td>Se um valor está dentro de um conjunto de valores</td> </tr><tr><td><a class="link" href="comparison-operators.html#function_interval">[[<code class="literal">INTERVAL()</code>]]</a></td> <td>Retorne o índice do argumento que é menor que o primeiro argumento</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_is">[[<code class="literal">IS</code>]]</a></td> <td>Teste um valor contra um booleano</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_is-not">[[<code class="literal">IS NOT</code>]]</a></td> <td>Teste um valor contra um booleano</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_is-not-null">[[<code class="literal">IS NOT NULL</code>]]</a></td> <td>Teste de valor NOT NULL</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_is-null">[[<code class="literal">IS NULL</code>]]</a></td> <td>Teste de valor nulo</td> </tr><tr><td><a class="link" href="comparison-operators.html#function_isnull">[[<code class="literal">ISNULL()</code>]]</a></td> <td>Teste se o argumento é NULL</td> </tr><tr><td><a class="link" href="comparison-operators.html#function_least">[[<code class="literal">LEAST()</code>]]</a></td> <td>Retorne o menor argumento</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#operator_like">[[<code class="literal">&lt;</code><code class="literal">EXISTS()</code>]</a></td> <td>Encontre padrões simples</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_not-between">[[<code class="literal">&lt;</code><code class="literal">EXISTS()</code>]</a></td> <td>Se um valor não estiver dentro de uma faixa de valores</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_not-exists">[[<code class="literal">&lt;</code><code class="literal">IN()</code>]</a></td> <td>Se o resultado de uma consulta não contiver nenhuma linha</td> </tr><tr><td><a class="link" href="comparison-operators.html#operator_not-in">[[<code class="literal">&lt;</code><code class="literal">INTERVAL()</code>]</a></td> <td>Se um valor não estiver dentro de um conjunto de valores</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#operator_not-like">[[<code class="literal">&lt;</code><code class="literal">IS</code>]</a></td> <td>Negação de correspondência de padrão simples</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#function_strcmp">[[<code class="literal">&lt;</code><code class="literal">IS NOT</code>]</a></td> <td>Compare duas strings</td> </tr></tbody></table>

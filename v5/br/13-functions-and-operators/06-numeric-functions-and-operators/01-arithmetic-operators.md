...
<table frame="box" rules="all" summary="Uma referência que lista operadores aritméticos."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="arithmetic-functions.html#operator_mod">[[<code class="literal">%</code>]], [[<code class="literal">MOD</code>]]</a></td> <td>Operador módulo</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_times">[[<code class="literal">*</code>]]</a></td> <td>Operador de multiplicação</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_plus">[[<code class="literal">+</code>]]</a></td> <td>Operador de adição</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_minus">[[<code class="literal">-</code>]]</a></td> <td>Operador de menos</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_unary-minus">[[<code class="literal">-</code>]]</a></td> <td>Troque o sinal do argumento</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_divide">[[<code class="literal">/</code>]]</a></td> <td>Operador de divisão</td> </tr><tr><td><a class="link" href="arithmetic-functions.html#operator_div">[[<code class="literal">DIV</code>]]</a></td> <td>Divisão inteira</td> </tr></tbody></table>

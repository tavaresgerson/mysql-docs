...
<table frame="box" rules="all" summary="Uma referência que lista funções matemáticas."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="mathematical-functions.html#function_abs">[[PH_HTML_CODE_<code class="literal">COT()</code>]</a></td> <td>Retorne o valor absoluto</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_acos">[[PH_HTML_CODE_<code class="literal">COT()</code>]</a></td> <td>Retorne o cosseno do arco</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_asin">[[PH_HTML_CODE_<code class="literal">DEGREES()</code>]</a></td> <td>Retorne o arco seno</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_atan">[[PH_HTML_CODE_<code class="literal">EXP()</code>]</a></td> <td>Retorne a tangente do arco</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_atan2">[[PH_HTML_CODE_<code class="literal">FLOOR()</code>], [[PH_HTML_CODE_<code class="literal">LN()</code>]</a></td> <td>Retorne o arco tangente dos dois argumentos</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_ceil">[[PH_HTML_CODE_<code class="literal">LOG()</code>]</a></td> <td>Retorne o menor valor inteiro não menor que o argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_ceiling">[[PH_HTML_CODE_<code class="literal">LOG10()</code>]</a></td> <td>Retorne o menor valor inteiro não menor que o argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_conv">[[PH_HTML_CODE_<code class="literal">LOG2()</code>]</a></td> <td>Converter números entre diferentes bases numéricas</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_cos">[[PH_HTML_CODE_<code class="literal">MOD()</code>]</a></td> <td>Retorne o cosseno</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_cot">[[<code class="literal">COT()</code>]]</a></td> <td>Retorne a co-tangente</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_crc32">[[<code class="literal">ACOS()</code><code class="literal">COT()</code>]</a></td> <td>Calcule o valor de verificação de redundância cíclica</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_degrees">[[<code class="literal">DEGREES()</code>]]</a></td> <td>Converter radianos em graus</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_exp">[[<code class="literal">EXP()</code>]]</a></td> <td>Eleve à potência de</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_floor">[[<code class="literal">FLOOR()</code>]]</a></td> <td>Retorne o maior valor inteiro que não seja maior que o argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_ln">[[<code class="literal">LN()</code>]]</a></td> <td>Retorne o logaritmo natural do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_log">[[<code class="literal">LOG()</code>]]</a></td> <td>Retorne o logaritmo natural do primeiro argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_log10">[[<code class="literal">LOG10()</code>]]</a></td> <td>Retorne o logaritmo decimal do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_log2">[[<code class="literal">LOG2()</code>]]</a></td> <td>Retorne o logaritmo em base 2 do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_mod">[[<code class="literal">MOD()</code>]]</a></td> <td>Devolva o restante</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_pi">[[<code class="literal">ASIN()</code><code class="literal">COT()</code>]</a></td> <td>Retorne o valor de pi</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_pow">[[<code class="literal">ASIN()</code><code class="literal">COT()</code>]</a></td> <td>Retorne o argumento elevado à potência especificada</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_power">[[<code class="literal">ASIN()</code><code class="literal">DEGREES()</code>]</a></td> <td>Retorne o argumento elevado à potência especificada</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_radians">[[<code class="literal">ASIN()</code><code class="literal">EXP()</code>]</a></td> <td>Argumento de retorno convertido para radianos</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_rand">[[<code class="literal">ASIN()</code><code class="literal">FLOOR()</code>]</a></td> <td>Retorne um valor aleatório de ponto flutuante</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_round">[[<code class="literal">ASIN()</code><code class="literal">LN()</code>]</a></td> <td>Em torno do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_sign">[[<code class="literal">ASIN()</code><code class="literal">LOG()</code>]</a></td> <td>Retorne o sinal do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_sin">[[<code class="literal">ASIN()</code><code class="literal">LOG10()</code>]</a></td> <td>Retorne o seno do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_sqrt">[[<code class="literal">ASIN()</code><code class="literal">LOG2()</code>]</a></td> <td>Retorne a raiz quadrada do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_tan">[[<code class="literal">ASIN()</code><code class="literal">MOD()</code>]</a></td> <td>Retorne a tangente do argumento</td> </tr><tr><td><a class="link" href="mathematical-functions.html#function_truncate">[[<code class="literal">ATAN()</code><code class="literal">COT()</code>]</a></td> <td>Reduzir para o número especificado de casas decimais</td> </tr></tbody></table>

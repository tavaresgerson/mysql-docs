...
<table frame="box" rules="all" summary="Uma referência que lista as funções de criptografia."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Nome</th> <th>Descrição</th> <th>Desatualizado</th> </tr></thead><tbody><tr><th scope="row"><a class="link" href="encryption-functions.html#function_aes-decrypt">[[PH_HTML_CODE_<code class="literal">RANDOM_BYTES()</code>]</a></th> <td>Descifre usando AES</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_aes-encrypt">[[PH_HTML_CODE_<code class="literal">RANDOM_BYTES()</code>]</a></th> <td>Criptografar usando AES</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_compress">[[PH_HTML_CODE_<code class="literal">SHA()</code>]</a></th> <td>Retorne o resultado como uma string binária</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_decode">[[PH_HTML_CODE_<code class="literal">SHA2()</code>]</a></th> <td>Decodificar uma string criptografada usando ENCODE()</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_des-decrypt">[[PH_HTML_CODE_<code class="literal">UNCOMPRESS()</code>]</a></th> <td>Descifrar uma string</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_des-encrypt">[[PH_HTML_CODE_<code class="literal">UNCOMPRESSED_LENGTH()</code>]</a></th> <td>Criptografar uma string</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_encode">[[PH_HTML_CODE_<code class="literal">VALIDATE_PASSWORD_STRENGTH()</code>]</a></th> <td>Codificar uma string</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_encrypt">[[<code class="literal">ENCRYPT()</code>]]</a></th> <td>Criptografar uma string</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_md5">[[<code class="literal">MD5()</code>]]</a></th> <td>Calcular o checksum MD5</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_password">[[<code class="literal">PASSWORD()</code>]]</a></th> <td>Calcule e retorne uma string de senha</td> <td>Sim</td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_random-bytes">[[<code class="literal">RANDOM_BYTES()</code>]]</a></th> <td>Retorne um vetor de bytes aleatório</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_sha1">[[<code class="literal">AES_ENCRYPT()</code><code class="literal">RANDOM_BYTES()</code>], [[<code class="literal">SHA()</code>]]</a></th> <td>Calcule um checksum de 160 bits SHA-1</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_sha2">[[<code class="literal">SHA2()</code>]]</a></th> <td>Calcule um checksum SHA-2</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_uncompress">[[<code class="literal">UNCOMPRESS()</code>]]</a></th> <td>Descompactar uma string compactada</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_uncompressed-length">[[<code class="literal">UNCOMPRESSED_LENGTH()</code>]]</a></th> <td>Retorne o comprimento de uma string antes da compressão</td> <td></td> </tr><tr><th scope="row"><a class="link" href="encryption-functions.html#function_validate-password-strength">[[<code class="literal">VALIDATE_PASSWORD_STRENGTH()</code>]]</a></th> <td>Determine a força da senha</td> <td></td> </tr></tbody></table>
...
- `PASSWORD(str)`
  ...
  <table summary="Para cada método de hashing de senha, o valor permitido de old_passwords e quais plugins de autenticação usam o método de hashing"><col style="width: 40%"/><col style="width: 20%"/><col style="width: 40%"/><thead><tr> <th scope="col">Método de Hashing de Senha</th> <th scope="col">senhas antigas Valor</th> <th scope="col">Plugin de Autenticação Associada</th> </tr></thead><tbody><tr> <th scope="row">Hashing nativo do MySQL 4.1</th> <td>0</td> <td>[[<code class="literal">mysql_native_password</code>]]</td> </tr><tr> <th scope="row">Hashing SHA-256</th> <td>2</td> <td>[[<code class="literal">sha256_password</code>]]</td> </tr></tbody></table>
...
- `VALIDATE_PASSWORD_STRENGTH(str)`
  ...
  <table summary="Testes de senha da função VALIDATE_PASSWORD_STRENGTH() e os valores retornados por cada teste de senha."><col style="width: 60%"/><col style="width: 20%"/><thead><tr> <th>Teste de senha</th> <th>Valor de retorno</th> </tr></thead><tbody><tr> <td>Comprimento < 4</td> <td>0</td> </tr><tr> <td>Comprimento ≥ 4 e &lt;<a class="link" href="validate-password-options-variables.html#sysvar_validate_password_length">[[<code class="literal">validate_password_length</code>]]</a></td> <td>25</td> </tr><tr> <td>Cumpre a política 1 ([[<code class="literal">LOW</code>]])</td> <td>50</td> </tr><tr> <td>Cumpre a política 2 ([[<code class="literal">MEDIUM</code>]])</td> <td>75</td> </tr><tr> <td>Cumpre a política 3 ([[<code class="literal">STRONG</code>]])</td> <td>100</td> </tr></tbody></table>

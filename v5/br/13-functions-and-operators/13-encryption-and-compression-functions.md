...
<table frame="box" rules="all" summary="Uma referência que lista as funções de criptografia."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Nome</th> <th>Descrição</th> <th>Desatualizado</th> </tr></thead><tbody><tr><th><a class="link" href="encryption-functions.html#function_aes-decrypt">[[PH_HTML_CODE_<code>RANDOM_BYTES()</code>]</a></th> <td>Descifre usando AES</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_aes-encrypt">[[PH_HTML_CODE_<code>RANDOM_BYTES()</code>]</a></th> <td>Criptografar usando AES</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_compress">[[PH_HTML_CODE_<code>SHA()</code>]</a></th> <td>Retorne o resultado como uma string binária</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_decode">[[PH_HTML_CODE_<code>SHA2()</code>]</a></th> <td>Decodificar uma string criptografada usando ENCODE()</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_des-decrypt">[[PH_HTML_CODE_<code>UNCOMPRESS()</code>]</a></th> <td>Descifrar uma string</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_des-encrypt">[[PH_HTML_CODE_<code>UNCOMPRESSED_LENGTH()</code>]</a></th> <td>Criptografar uma string</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_encode">[[PH_HTML_CODE_<code>VALIDATE_PASSWORD_STRENGTH()</code>]</a></th> <td>Codificar uma string</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_encrypt">[[<code>ENCRYPT()</code>]]</a></th> <td>Criptografar uma string</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_md5">[[<code>MD5()</code>]]</a></th> <td>Calcular o checksum MD5</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_password">[[<code>PASSWORD()</code>]]</a></th> <td>Calcule e retorne uma string de senha</td> <td>Sim</td> </tr><tr><th><a class="link" href="encryption-functions.html#function_random-bytes">[[<code>RANDOM_BYTES()</code>]]</a></th> <td>Retorne um vetor de bytes aleatório</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_sha1">[[<code>AES_ENCRYPT()</code><code>RANDOM_BYTES()</code>], [[<code>SHA()</code>]]</a></th> <td>Calcule um checksum de 160 bits SHA-1</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_sha2">[[<code>SHA2()</code>]]</a></th> <td>Calcule um checksum SHA-2</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_uncompress">[[<code>UNCOMPRESS()</code>]]</a></th> <td>Descompactar uma string compactada</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_uncompressed-length">[[<code>UNCOMPRESSED_LENGTH()</code>]]</a></th> <td>Retorne o comprimento de uma string antes da compressão</td> <td></td> </tr><tr><th><a class="link" href="encryption-functions.html#function_validate-password-strength">[[<code>VALIDATE_PASSWORD_STRENGTH()</code>]]</a></th> <td>Determine a força da senha</td> <td></td> </tr></tbody></table>

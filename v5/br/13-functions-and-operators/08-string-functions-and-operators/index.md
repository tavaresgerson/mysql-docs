...
<table frame="box" rules="all" summary="Uma referência que lista funções e operadores de string."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="string-functions.html#function_ascii">[[PH_HTML_CODE_<code class="literal">FIELD()</code>]</a></td> <td>Retorne o valor numérico do caractere mais à esquerda</td> </tr><tr><td><a class="link" href="string-functions.html#function_bin">[[PH_HTML_CODE_<code class="literal">FIELD()</code>]</a></td> <td>Retorne uma string contendo a representação binária de um número</td> </tr><tr><td><a class="link" href="string-functions.html#function_bit-length">[[PH_HTML_CODE_<code class="literal">FORMAT()</code>]</a></td> <td>Comprimento de retorno do argumento em bits</td> </tr><tr><td><a class="link" href="string-functions.html#function_char">[[PH_HTML_CODE_<code class="literal">FROM_BASE64()</code>]</a></td> <td>Retorne o caractere para cada inteiro passado</td> </tr><tr><td><a class="link" href="string-functions.html#function_char-length">[[PH_HTML_CODE_<code class="literal">HEX()</code>]</a></td> <td>Número de caracteres de retorno no argumento</td> </tr><tr><td><a class="link" href="string-functions.html#function_character-length">[[PH_HTML_CODE_<code class="literal">INSERT()</code>]</a></td> <td>Sinônimo de CHAR_LENGTH()</td> </tr><tr><td><a class="link" href="string-functions.html#function_concat">[[PH_HTML_CODE_<code class="literal">INSTR()</code>]</a></td> <td>Retorne a string concatenada</td> </tr><tr><td><a class="link" href="string-functions.html#function_concat-ws">[[PH_HTML_CODE_<code class="literal">LCASE()</code>]</a></td> <td>Concatenar e retornar com separador</td> </tr><tr><td><a class="link" href="string-functions.html#function_elt">[[PH_HTML_CODE_<code class="literal">LEFT()</code>]</a></td> <td>Retorne a string no número de índice</td> </tr><tr><td><a class="link" href="string-functions.html#function_export-set">[[PH_HTML_CODE_<code class="literal">LENGTH()</code>]</a></td> <td>Retorne uma string onde, para cada bit definido no valor bits, você recebe uma string "on" e, para cada bit não definido, você recebe uma string "off".</td> </tr><tr><td><a class="link" href="string-functions.html#function_field">[[<code class="literal">FIELD()</code>]]</a></td> <td>Índice (posição) do primeiro argumento nos argumentos subsequentes</td> </tr><tr><td><a class="link" href="string-functions.html#function_find-in-set">[[<code class="literal">BIN()</code><code class="literal">FIELD()</code>]</a></td> <td>Índice (posição) do primeiro argumento dentro do segundo argumento</td> </tr><tr><td><a class="link" href="string-functions.html#function_format">[[<code class="literal">FORMAT()</code>]]</a></td> <td>Retorne um número formatado para o número especificado de casas decimais</td> </tr><tr><td><a class="link" href="string-functions.html#function_from-base64">[[<code class="literal">FROM_BASE64()</code>]]</a></td> <td>Decodificar a string codificada em base64 e retornar o resultado</td> </tr><tr><td><a class="link" href="string-functions.html#function_hex">[[<code class="literal">HEX()</code>]]</a></td> <td>Representação hexadecimal de valor decimal ou de cadeia</td> </tr><tr><td><a class="link" href="string-functions.html#function_insert">[[<code class="literal">INSERT()</code>]]</a></td> <td>Insira a subcadeia na posição especificada até o número especificado de caracteres</td> </tr><tr><td><a class="link" href="string-functions.html#function_instr">[[<code class="literal">INSTR()</code>]]</a></td> <td>Retorne o índice da primeira ocorrência da subcadeia</td> </tr><tr><td><a class="link" href="string-functions.html#function_lcase">[[<code class="literal">LCASE()</code>]]</a></td> <td>Sinônimo de LOWER()</td> </tr><tr><td><a class="link" href="string-functions.html#function_left">[[<code class="literal">LEFT()</code>]]</a></td> <td>Retorne o número de caracteres mais à esquerda conforme especificado</td> </tr><tr><td><a class="link" href="string-functions.html#function_length">[[<code class="literal">LENGTH()</code>]]</a></td> <td>Retorne o comprimento de uma string em bytes</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#operator_like">[[<code class="literal">BIT_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Encontre padrões simples</td> </tr><tr><td><a class="link" href="string-functions.html#function_load-file">[[<code class="literal">BIT_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Carregue o arquivo nomeado</td> </tr><tr><td><a class="link" href="string-functions.html#function_locate">[[<code class="literal">BIT_LENGTH()</code><code class="literal">FORMAT()</code>]</a></td> <td>Retorne a posição da primeira ocorrência da subcadeia</td> </tr><tr><td><a class="link" href="string-functions.html#function_lower">[[<code class="literal">BIT_LENGTH()</code><code class="literal">FROM_BASE64()</code>]</a></td> <td>Devolva o argumento em minúsculas</td> </tr><tr><td><a class="link" href="string-functions.html#function_lpad">[[<code class="literal">BIT_LENGTH()</code><code class="literal">HEX()</code>]</a></td> <td>Retorne o argumento de string, preenchido à esquerda com a string especificada</td> </tr><tr><td><a class="link" href="string-functions.html#function_ltrim">[[<code class="literal">BIT_LENGTH()</code><code class="literal">INSERT()</code>]</a></td> <td>Remova espaços em branco iniciais</td> </tr><tr><td><a class="link" href="string-functions.html#function_make-set">[[<code class="literal">BIT_LENGTH()</code><code class="literal">INSTR()</code>]</a></td> <td>Retorne um conjunto de strings separadas por vírgula que tenham o bit correspondente definido em bits</td> </tr><tr><td><a class="link" href="fulltext-search.html#function_match">[[<code class="literal">BIT_LENGTH()</code><code class="literal">LCASE()</code>]</a></td> <td>Realize uma pesquisa de texto completo</td> </tr><tr><td><a class="link" href="string-functions.html#function_mid">[[<code class="literal">BIT_LENGTH()</code><code class="literal">LEFT()</code>]</a></td> <td>Retorne uma subcadeia a partir da posição especificada</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#operator_not-like">[[<code class="literal">BIT_LENGTH()</code><code class="literal">LENGTH()</code>]</a></td> <td>Negação de correspondência de padrão simples</td> </tr><tr><td><a class="link" href="regexp.html#operator_not-regexp">[[<code class="literal">CHAR()</code><code class="literal">FIELD()</code>]</a></td> <td>Negação de REGEXP</td> </tr><tr><td><a class="link" href="string-functions.html#function_oct">[[<code class="literal">CHAR()</code><code class="literal">FIELD()</code>]</a></td> <td>Retorne uma string contendo a representação octal de um número</td> </tr><tr><td><a class="link" href="string-functions.html#function_octet-length">[[<code class="literal">CHAR()</code><code class="literal">FORMAT()</code>]</a></td> <td>Sinônimo de LENGTH()</td> </tr><tr><td><a class="link" href="string-functions.html#function_ord">[[<code class="literal">CHAR()</code><code class="literal">FROM_BASE64()</code>]</a></td> <td>Código de caractere de retorno para o caractere mais à esquerda do argumento</td> </tr><tr><td><a class="link" href="string-functions.html#function_position">[[<code class="literal">CHAR()</code><code class="literal">HEX()</code>]</a></td> <td>Sinônimo de LOCATE()</td> </tr><tr><td><a class="link" href="string-functions.html#function_quote">[[<code class="literal">CHAR()</code><code class="literal">INSERT()</code>]</a></td> <td>Escape o argumento para uso em uma declaração SQL</td> </tr><tr><td><a class="link" href="regexp.html#operator_regexp">[[<code class="literal">CHAR()</code><code class="literal">INSTR()</code>]</a></td> <td>Se a cadeia corresponde à expressão regular</td> </tr><tr><td><a class="link" href="string-functions.html#function_repeat">[[<code class="literal">CHAR()</code><code class="literal">LCASE()</code>]</a></td> <td>Repita uma string o número especificado de vezes</td> </tr><tr><td><a class="link" href="string-functions.html#function_replace">[[<code class="literal">CHAR()</code><code class="literal">LEFT()</code>]</a></td> <td>Substitua as ocorrências de uma string especificada</td> </tr><tr><td><a class="link" href="string-functions.html#function_reverse">[[<code class="literal">CHAR()</code><code class="literal">LENGTH()</code>]</a></td> <td>Inverter os caracteres de uma string</td> </tr><tr><td><a class="link" href="string-functions.html#function_right">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Retorne o número especificado de caracteres à direita</td> </tr><tr><td><a class="link" href="regexp.html#operator_regexp">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Se a cadeia corresponde à expressão regular</td> </tr><tr><td><a class="link" href="string-functions.html#function_rpad">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">FORMAT()</code>]</a></td> <td>Adicione a string o número especificado de vezes</td> </tr><tr><td><a class="link" href="string-functions.html#function_rtrim">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">FROM_BASE64()</code>]</a></td> <td>Remova espaços em branco finais</td> </tr><tr><td><a class="link" href="string-functions.html#function_soundex">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">HEX()</code>]</a></td> <td>Retorne uma string soundex</td> </tr><tr><td><a class="link" href="string-functions.html#operator_sounds-like">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">INSERT()</code>]</a></td> <td>Compare os sons</td> </tr><tr><td><a class="link" href="string-functions.html#function_space">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">INSTR()</code>]</a></td> <td>Retorne uma string com o número especificado de espaços</td> </tr><tr><td><a class="link" href="string-comparison-functions.html#function_strcmp">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">LCASE()</code>]</a></td> <td>Compare duas strings</td> </tr><tr><td><a class="link" href="string-functions.html#function_substr">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">LEFT()</code>]</a></td> <td>Retorne a subcadeia especificada</td> </tr><tr><td><a class="link" href="string-functions.html#function_substring">[[<code class="literal">CHAR_LENGTH()</code><code class="literal">LENGTH()</code>]</a></td> <td>Retorne a subcadeia especificada</td> </tr><tr><td><a class="link" href="string-functions.html#function_substring-index">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Retorne uma subcadeia de uma string antes do número especificado de ocorrências do delimitador</td> </tr><tr><td><a class="link" href="string-functions.html#function_to-base64">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">FIELD()</code>]</a></td> <td>Retorne o argumento convertido em uma string base-64</td> </tr><tr><td><a class="link" href="string-functions.html#function_trim">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">FORMAT()</code>]</a></td> <td>Remova espaços em branco no início e no final</td> </tr><tr><td><a class="link" href="string-functions.html#function_ucase">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">FROM_BASE64()</code>]</a></td> <td>Sinônimo de UPPER()</td> </tr><tr><td><a class="link" href="string-functions.html#function_unhex">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">HEX()</code>]</a></td> <td>Retorne uma string contendo a representação hexadecimal de um número</td> </tr><tr><td><a class="link" href="string-functions.html#function_upper">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">INSERT()</code>]</a></td> <td>Converta para maiúsculas</td> </tr><tr><td><a class="link" href="string-functions.html#function_weight-string">[[<code class="literal">CHARACTER_LENGTH()</code><code class="literal">INSTR()</code>]</a></td> <td>Retorne a string de peso para uma string</td> </tr></tbody></table>

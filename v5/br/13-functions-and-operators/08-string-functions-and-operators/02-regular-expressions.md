...
*  `[.characters.]`
  ...
  <table summary="Nomes de caracteres permitidos e caracteres aos quais eles correspondem. Para economizar espaço, o emparelhamento de colunas Nome e Caractere são apresentados em um formato de tabela de quatro colunas nesta ordem: Nome, Caractere, Nome, Caractere. Para caracteres fornecidos como valores numéricos, os valores são representados em octal.">
  <thead>
    <tr>
      <th>Nome</th>
      <th>Caractere</th>

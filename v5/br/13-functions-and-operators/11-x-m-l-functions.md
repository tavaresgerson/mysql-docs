...
<table frame="box" rules="all" summary="Uma referência que lista as funções XML."><col style="width: 28%"/><col style="width: 71%"/><thead><tr><th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr><td><a class="link" href="xml-functions.html#function_extractvalue">[[<code class="literal">ExtractValue()</code>]]</a></td> <td>Extrair um valor de uma string XML usando a notação XPath</td> </tr><tr><td><a class="link" href="xml-functions.html#function_updatexml">[[<code class="literal">UpdateXML()</code>]]</a></td> <td>Retorno substituiu o fragmento XML</td> </tr></tbody></table>

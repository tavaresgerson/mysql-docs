...
O esquema MySQL `sys` é um conjunto de objetos que oferece acesso conveniente aos dados coletados pelo Gerador de Desempenho. O esquema `sys` é instalado por padrão. Para instruções de uso, consulte o Capítulo 26, *Esquema sys MySQL*.
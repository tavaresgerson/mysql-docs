...
Nomes de strings de instrumentos mais longos têm precedência sobre nomes de padrões mais curtos, independentemente da ordem. Para obter informações sobre a especificação de padrões para selecionar instrumentos, consulte a Seção 25.4.9, “Nomeando instrumentos ou consumidores para operações de filtragem”.

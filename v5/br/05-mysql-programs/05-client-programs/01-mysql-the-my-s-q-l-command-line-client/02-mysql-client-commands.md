...
<table summary="opções de comando de prompt que são usadas para configurar o prompt mysql&gt;"><col style="width: 15%"/><col style="width: 75%"/><thead><tr> <th>Opção</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">\P</code>]</td> <td>O identificador de conexão atual</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\P</code>]</td> <td>Um contador que aumenta para cada declaração que você emite</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\R</code>]</td> <td>A data atual completa</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\r</code>]</td> <td>O banco de dados padrão</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\S</code>]</td> <td>O anfitrião do servidor</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\s</code>]</td> <td>O delimitador atual</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\t</code>]</td> <td>Minutos da hora atual</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">\U</code>]</td> <td>Um caractere de nova linha</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal"><em class="replaceable"><code>user_name</code>]</td> <td>O mês atual no formato de três letras (Jan, Feb, …)</td> </tr><tr> <td>[[PH_HTML_CODE_<code>host_name</code>]</td> <td>O mês atual no formato numérico</td> </tr><tr> <td>[[<code class="literal">\P</code>]]</td> <td>am/pm</td> </tr><tr> <td>[[<code class="literal">\c</code><code class="literal">\P</code>]</td> <td>A porta TCP/IP atual ou o arquivo de soquete</td> </tr><tr> <td>[[<code class="literal">\R</code>]]</td> <td>A hora atual, em hora militar de 24 horas (0–23)</td> </tr><tr> <td>[[<code class="literal">\r</code>]]</td> <td>A hora atual, horário padrão de 12 horas (1–12)</td> </tr><tr> <td>[[<code class="literal">\S</code>]]</td> <td>Ponto e vírgula</td> </tr><tr> <td>[[<code class="literal">\s</code>]]</td> <td>Segundos do horário atual</td> </tr><tr> <td>[[<code class="literal">\t</code>]]</td> <td>Um caractere de tabulação</td> </tr><tr> <td>[[<code class="literal">\U</code>]]</td> <td><p>Seu código completo [[<code class="literal"><em class="replaceable"><code>user_name</code>]]</em>@<em class="replaceable">[[<code>host_name</code>]]</em></code>nome da conta</p></td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\P</code>]</td> <td>Seu nome de usuário</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\P</code>]</td> <td>A versão do servidor</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\R</code>]</td> <td>O dia atual da semana no formato de três letras (Seg, Ter, …)</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\r</code>]</td> <td>O ano atual, quatro dígitos</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\S</code>]</td> <td>O ano atual, com dois dígitos</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\s</code>]</td> <td>Um espaço</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\t</code>]</td> <td>Um espaço (um espaço segue o backslash)</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal">\U</code>]</td> <td>Citação única</td> </tr><tr> <td>[[<code class="literal">\D</code><code class="literal"><em class="replaceable"><code>user_name</code>]</td> <td>"Dois aspas"</td> </tr><tr> <td>[[<code class="literal">\D</code><code>host_name</code>]</td> <td>Um caractere literal de barra invertida [[<code class="literal">\d</code><code class="literal">\P</code>]</td> </tr><tr> <td>[[<code class="literal">\d</code><code class="literal">\P</code>]</em></code></td> <td><p> <em class="replaceable">[[<code class="literal">\d</code><code class="literal">\R</code>]</em>, para qualquer<span class="quote">“<span class="quote"><em class="replaceable">[[<code class="literal">\d</code><code class="literal">\r</code>]</em></span>”</span>não listado acima</p></td> </tr></tbody></table>

...
- `--defaults-file=nome_do_arquivo`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>0
...
- `--defaults-group-suffix=str`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>1
...
- `--defer-table-indexes`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>2
...
- `--eventos`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>3
...
- `--exclude-databases=db_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>4
...
- `--exclude-events=lista_eventos`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>5
...
- `--exclude-routines=routine_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>6
...
- `--exclude-tables=lista_de_tabelas`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>7
...
- `--exclude-triggers=trigger_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>8
...
- `--exclude-users=user_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover banco de dados"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-database</code>]]</td> </tr></tbody></table>9
...
- `--extended-insert=N`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>0
...
- `--get-server-public-key`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>1
...
- `--hex-blob`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>2
...
- `--host=host_name`, `-h host_name`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>3

  Arraste os dados do servidor MySQL para o host fornecido.

- `--include-databases=db_list`

  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>4
...
- `--include-events=event_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>5
...
- `--include-routines=lista_rotinas`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>6
...
- `--include-tables=lista_de_tabelas`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>7
...
- `--include-triggers=lista_de_triggers`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>8
...
- `--include-users=user_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover tabela"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-table</code>]]</td> </tr></tbody></table>9
...
- `--insert-ignore`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>0

  Escreva instruções `INSERT IGNORE` em vez de instruções `INSERT`.

- `--log-error-file=nome_arquivo`

  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>1
...
- `--login-path=nome`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>2
...
- `--max-allowed-packet=N`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>3

  O tamanho máximo do buffer para a comunicação cliente/servidor. O padrão é de 24 MB, e o máximo é de 1 GB.

- `--net-buffer-length=N`

  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>4
...
- `--no-create-db`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>5

  Suprima quaisquer declarações `CREATE DATABASE` que possam estar incluídas na saída.

- `--no-create-info`, `-t`

  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>6

  Não escreva declarações `CREATE TABLE` que criem cada tabela descarregada.

- `--no-defaults`

  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>7
...
- `--parallel-schemas=[N:]db_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>8
...
- `--password[=password]`, `-p[password]`
  ...
  <table frame="box" rules="all" summary="Propriedades para adicionar ou remover usuários"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-drop-user</code>]]</td> </tr></tbody></table>9
...
- `--plugin-dir=dir_name`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>0
...
- `--port=port_num`, `-P port_num`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>1

  Para conexões TCP/IP, o número de porta a ser usado.

- `--print-defaults`

  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>2
...
- `--protocol={TCP|SOCKET|PIPE|MEMORY}`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>3
...
- `--replace`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>4

  Escreva declarações `REPLACE` em vez de declarações `INSERT`.

- `--result-file=nome_do_arquivo`

  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>5
...
- `--routines`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>6
...
- `--secure-auth`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>7
...
- `--server-public-key-path=nome_do_arquivo`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>8
...
- `--set-charset`
  ...
  <table frame="box" rules="all" summary="Propriedades para bloqueios adicionais"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--add-locks</code>]]</td> </tr></tbody></table>9

...
- `--columns=column_list`, `-c column_list`
  ...
  <table frame="box" rules="all" summary="Propriedades para colunas"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--columns=column_list</code>]]</td> </tr></tbody></table>
...
- `--shared-memory-base-name=nome`
  ...
  <table frame="box" rules="all" summary="Propriedades para colunas"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--columns=column_list</code>]]</td> </tr></tbody></table>0
...
- `--version`, `-V`
  ...
  <table frame="box" rules="all" summary="Propriedades para colunas"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--columns=column_list</code>]]</td> </tr></tbody></table>7

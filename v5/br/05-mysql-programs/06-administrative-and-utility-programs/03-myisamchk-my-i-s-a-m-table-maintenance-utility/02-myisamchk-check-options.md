...
- `--check-only-changed`, `-C`
  ...
  <table frame="box" rules="all" summary="Propriedades para verificação apenas de alterações"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--check-only-changed</code>]]</td> </tr></tbody></table>
...
- `--fast`, `-F`
  ...
  <table frame="box" rules="all" summary="Propriedades para rápido"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--fast</code>]]</td> </tr></tbody></table>
...
- `--informação`, `-i`
  ...
  <table frame="box" rules="all" summary="Propriedades para informações"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--information</code>]]</td> </tr></tbody></table>

  Imprima estatísticas informativas sobre a tabela que está sendo verificada.

- `--medium-check`, `-m`

  <table frame="box" rules="all" summary="Propriedades para médio-controle"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--medium-check</code>]]</td> </tr></tbody></table>
...
- `--read-only`, `-T`
  ...
  <table frame="box" rules="all" summary="Propriedades para leitura somente"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--read-only</code>]]</td> </tr></tbody></table>
...
- `--update-state`, `-U`
  ...
  <table frame="box" rules="all" summary="Propriedades para atualização de estado"><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Formato de linha de comando</th> <td>[[<code class="literal">--update-state</code>]]</td> </tr></tbody></table>

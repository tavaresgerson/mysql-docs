...
- `--block-search=offset`, `-b offset`
  ...
  <table frame="box" rules="all" summary="Propriedades para pesquisa por bloco"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--block-search=offset</code>]]</td> </tr><tr><th>Tipo</th> <td>Numérico</td> </tr></tbody></table>
...
- `--sort-index`, `-S`
  ...
  <table frame="box" rules="all" summary="Propriedades para índice de classificação"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--sort-index</code>]]</td> </tr></tbody></table>
...
- `--sort-records=N`, `-R N`
  ...
  <table frame="box" rules="all" summary="Propriedades para registros de classificação"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--sort-records=#</code>]]</td> </tr><tr><th>Tipo</th> <td>Numérico</td> </tr></tbody></table>

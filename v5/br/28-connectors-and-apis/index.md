...
<table summary="Resumo das APIs e interfaces do MySQL, mostrando o ambiente, a API, o tipo e as notas relacionadas."><col style="width: 10%"/><col style="width: 35%"/><col style="width: 15%"/><col style="width: 40%"/><thead><tr> <th scope="col">Meio Ambiente</th> <th scope="col">API</th> <th scope="col">Tipo</th> <th scope="col">Notas</th> </tr></thead><tbody><tr> <th scope="row">Ada</th> <td>GNU Ada MySQL Bindings</td> <td>[[PH_HTML_CODE_<code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="ulink" href="http://gnade.sourceforge.net/" target="_blank">Ligações MySQL para GNU Ada</a></td> </tr><tr> <th scope="row">C</th> <td>C API</td> <td>[[PH_HTML_CODE_<code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="ulink" href="/doc/c-api/5.7/en/" target="_top">Guia do desenvolvedor da API C para MySQL 5.7</a>.</td> </tr><tr> <th scope="row">C++</th> <td>Conector/C++</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="/doc/connector-cpp/9.4/en/" target="_top">Guia do desenvolvedor do MySQL Connector/C++ 9.5</a>.</td> </tr><tr> <th scope="row"></th> <td>MySQL++</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="http://tangentsoft.net/mysql++/doc/" target="_blank">Site do MySQL++</a>.</td> </tr><tr> <th scope="row"></th> <td>MySQL envolto</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="http://www.alhem.net/project/mysql/" target="_blank">MySQL envolto</a>.</td> </tr><tr> <th scope="row">Cacao</th> <td>MySQL-Cocoa</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Compatível com o ambiente Cocoa do Objective-C. Veja<a class="ulink" href="http://mysql-cocoa.sourceforge.net/" target="_blank">http://mysql-cocoa.sourceforge.net/</a></td> </tr><tr> <th scope="row">D</th> <td>MySQL para D</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="http://www.steinmole.de/d/" target="_blank">MySQL para D</a>.</td> </tr><tr> <th scope="row">Eiffel</th> <td>Eiffel MySQL</td> <td>[[PH_HTML_CODE_<code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="xref" href="apis-eiffel.html" title="27.13 MySQL Eiffel Wrapper">Seção 27.13, “MySQL Eiffel Wrapper”</a>.</td> </tr><tr> <th scope="row">Erlang</th> <td>[[PH_HTML_CODE_<code class="literal">DBI</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">DBD::mysql</code>]</td> <td>Veja<a class="ulink" href="http://code.google.com/p/erlang-mysql-driver/" target="_blank">[[<code class="literal">erlang-mysql-driver</code>]].</a></td> </tr><tr> <th scope="row">Haskell</th> <td>Ligações Haskell MySQL</td> <td>Driver nativo</td> <td>Veja<a class="ulink" href="http://www.serpentine.com/blog/software/mysql/" target="_blank">Ligações puras de Haskell para MySQL de Brian O'Sullivan</a>.</td> </tr><tr> <th scope="row"></th> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="http://hackage.haskell.org/cgi-bin/hackage-scripts/package/hsql-mysql-1.7" target="_blank">Driver MySQL para Haskell</a>.</td> </tr><tr> <th scope="row">Java/JDBC</th> <td>Conector/J</td> <td>Driver nativo</td> <td>Veja<a class="ulink" href="/doc/connector-j/en/" target="_top">Guia do desenvolvedor do MySQL Connector/J</a>.</td> </tr><tr> <th scope="row">Kaya</th> <td>MyDB</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="http://kayalang.org/library/latest/MyDB" target="_blank">MyDB</a>.</td> </tr><tr> <th scope="row">Lua</th> <td>LuaSQL</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="http://keplerproject.github.io/luasql/doc/us/" target="_blank">LuaSQL</a>.</td> </tr><tr> <th scope="row">.NET/Mono</th> <td>Conector/NET</td> <td>Driver nativo</td> <td>Veja<a class="ulink" href="/doc/connector-net/en/" target="_top">Guia do desenvolvedor do MySQL Connector/NET</a>.</td> </tr><tr> <th scope="row">Objetivo Caml</th> <td>Ligações Objetivo Caml MySQL</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="http://raevnos.pennmush.org/code/ocaml-mysql/" target="_blank">Ligações MySQL para Objective Caml</a>.</td> </tr><tr> <th scope="row">Octave</th> <td>Ligações de banco de dados para GNU Octave</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="http://octave.sourceforge.net/database/index.html" target="_blank">Ligações de banco de dados para GNU Octave</a>.</td> </tr><tr> <th scope="row">ODBC</th> <td>Conector/ODBC</td> <td>[[<code class="literal">libmysqlclient</code>]]</td> <td>Veja<a class="ulink" href="/doc/connector-odbc/en/" target="_top">Guia do desenvolvedor do MySQL Connector/ODBC</a>.</td> </tr><tr> <th scope="row">Perl</th> <td>[[<code class="literal">DBI</code>]]/[[<code class="literal">DBD::mysql</code>]]</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="xref" href="apis-perl.html" title="27.9 API MySQL Perl">Seção 27.9, “API MySQL Perl”</a>.</td> </tr><tr> <th scope="row"></th> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>Driver nativo</td> <td>Veja<a class="ulink" href="http://search.cpan.org/dist/Net-MySQL/MySQL.pm" target="_blank">[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</a>na CPAN</td> </tr><tr> <th scope="row">PHP</th> <td>interface [[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>], [[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>] (desatualizada)</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="/doc/apis-php/en/" target="_top">MySQL e PHP</a>.</td> </tr><tr> <th scope="row"></th> <td>interface [[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>], [[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">DBI</code>]</td> <td>Veja<a class="ulink" href="/doc/apis-php/en/" target="_top">MySQL e PHP</a>.</td> </tr><tr> <th scope="row"></th> <td>[[<code class="literal">libmysqlclient</code><code class="literal">DBD::mysql</code>]</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="ulink" href="/doc/apis-php/en/" target="_top">MySQL e PHP</a>.</td> </tr><tr> <th scope="row"></th> <td>PDO mysqlnd</td> <td>Driver nativo</td> <td></td> </tr><tr> <th scope="row">Python</th> <td>Conector/Python</td> <td>Driver nativo</td> <td>Veja<a class="ulink" href="/doc/connector-python/en/" target="_top">Guia do desenvolvedor do MySQL Connector/Python</a>.</td> </tr><tr> <th scope="row">Python</th> <td>Extensão C para Python/Conector</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="ulink" href="/doc/connector-python/en/" target="_top">Guia do desenvolvedor do MySQL Connector/Python</a>.</td> </tr><tr> <th scope="row"></th> <td>MySQLdb</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="xref" href="apis-python.html" title="27.10 API Python do MySQL">Seção 27.10, “API Python MySQL”</a>.</td> </tr><tr> <th scope="row">Rubi</th> <td>mysql2</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>Usa [[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]. Veja<a class="xref" href="apis-ruby.html" title="27.11 APIs Ruby do MySQL">Seção 27.11, “APIs Ruby do MySQL”</a>.</td> </tr><tr> <th scope="row">Sistema</th> <td>[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</td> <td>Veja<a class="ulink" href="https://github.com/aehrisch/myscsh" target="_blank">[[<code class="literal">libmysqlclient</code><code class="literal">libmysqlclient</code>]</a>.</td> </tr><tr> <th scope="row">SPL</th> <td>[[<code class="literal">libmysqlclient</code><code class="literal">DBI</code>]</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">DBD::mysql</code>]</td> <td>Veja<a class="ulink" href="http://www.clifford.at/spl/spldoc/sql_mysql.html" target="_blank">[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>] para SPL</a>.</td> </tr><tr> <th scope="row">Tcl</th> <td>MySQLtcl</td> <td>[[<code class="literal">libmysqlclient</code><code class="literal">erlang-mysql-driver</code>]</td> <td>Veja<a class="xref" href="apis-tcl.html" title="27.12 API Tcl para MySQL">Seção 27.12, “API MySQL Tcl”</a>.</td> </tr></tbody></table>

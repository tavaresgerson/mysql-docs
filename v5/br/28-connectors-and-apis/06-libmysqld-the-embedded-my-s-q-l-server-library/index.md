...
27.6.3 Opções com o Server Embarcado

27.6.4 Exemplos de Server Embarcado
...
Como as funções `mysql_library_xxx()` também estão incluídas em `libmysqlclient.a`, você pode alternar entre a versão embarcada e a versão cliente/server simplesmente linkando sua aplicação com a biblioteca correta. Veja mysql_library_init().

...
<table summary="Funções da biblioteca do servidor integrado MySQL e descrições de quando as funções devem ser chamadas."><thead><tr> <th><p>Função</p></th> <th><p>Quando ligar</p></th> </tr></thead><tbody><tr> <td><p> <a class="ulink" href="/doc/c-api/5.7/en/mysql-library-init.html" target="_top">[[<code>mysql_library_init()</code>]]</a> </p></td> <td><p>Chame antes de qualquer outra função MySQL ser chamada, de preferência no início da função [[<code>main()</code>]].</p></td> </tr><tr> <td><p> <a class="ulink" href="/doc/c-api/5.7/en/mysql-library-end.html" target="_top">[[<code>mysql_library_end()</code>]]</a> </p></td> <td><p>Chame antes de o seu programa sair.</p></td> </tr><tr> <td><p> <a class="ulink" href="/doc/c-api/5.7/en/mysql-thread-init.html" target="_top">[[<code>mysql_thread_init()</code>]]</a> </p></td> <td><p>Chame-o em cada thread que você criar e que acesse o MySQL.</p></td> </tr><tr> <td><a class="ulink" href="/doc/c-api/5.7/en/mysql-thread-end.html" target="_top">[[<code>mysql_thread_end()</code>]]</a></td> <td>Chame antes de chamar [[<code>pthread_exit()</code>]].</td> </tr></tbody></table>

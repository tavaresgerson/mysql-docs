...
<table summary="Tabelas do INFORMATION_SCHEMA e colunas de tabelas para as quais um valor de consulta constante permite que o servidor evite varreduras de diretório."><col style="width: 34%"/><col style="width: 33%"/><col style="width: 33%"/><thead><tr> <th scope="col">Tabela</th> <th scope="col">Coluna para especificar para evitar a varredura do diretório de dados</th> <th scope="col">Coluna para especificar para evitar a varredura do diretório do banco de dados</th> </tr></thead><tbody><tr> <th scope="row"><a class="link" href="information-schema-columns-table.html" title="24.3.5 A tabela INFORMATION_SCHEMA COLUMNS">[[PH_HTML_CODE_<code class="literal">CONSTRAINT_SCHEMA</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">CONSTRAINT_SCHEMA</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">STATISTICS</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-key-column-usage-table.html" title="24.3.12 A tabela INFORMATION_SCHEMA KEY_COLUMN_USAGE">[[PH_HTML_CODE_<code class="literal">TABLE_SCHEMA</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">TABLE_NAME</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">TABLES</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-partitions-table.html" title="24.3.16 A tabela INFORMATION_SCHEMA PARTITIONS">[[PH_HTML_CODE_<code class="literal">TABLE_SCHEMA</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">TABLE_NAME</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">TABLE_CONSTRAINTS</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-referential-constraints-table.html" title="24.3.20 Tabela INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS">[[PH_HTML_CODE_<code class="literal">TABLE_SCHEMA</code>]</a></th> <td>[[<code class="literal">CONSTRAINT_SCHEMA</code>]]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">CONSTRAINT_SCHEMA</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-statistics-table.html" title="24.3.24 A tabela INFORMATION_SCHEMA STATISTICS">[[<code class="literal">STATISTICS</code>]]</a></th> <td>[[<code class="literal">TABLE_SCHEMA</code>]]</td> <td>[[<code class="literal">TABLE_NAME</code>]]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-tables-table.html" title="24.3.25 A tabela INFORMATION_SCHEMA TABLES">[[<code class="literal">TABLES</code>]]</a></th> <td>[[<code class="literal">TABLE_SCHEMA</code>]]</td> <td>[[<code class="literal">TABLE_NAME</code>]]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-table-constraints-table.html" title="24.3.27 A tabela INFORMATION_SCHEMA TABLE_CONSTRAINTS">[[<code class="literal">TABLE_CONSTRAINTS</code>]]</a></th> <td>[[<code class="literal">TABLE_SCHEMA</code>]]</td> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">CONSTRAINT_SCHEMA</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-triggers-table.html" title="24.3.29 A tabela INFORMATION_SCHEMA TRIGGERS">[[<code class="literal">TABLE_NAME</code><code class="literal">CONSTRAINT_SCHEMA</code>]</a></th> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">STATISTICS</code>]</td> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">TABLE_SCHEMA</code>]</td> </tr><tr> <th scope="row"><a class="link" href="information-schema-views-table.html" title="24.3.31 A tabela INFORMATION_SCHEMA VIEWS">[[<code class="literal">TABLE_NAME</code><code class="literal">TABLE_NAME</code>]</a></th> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">TABLES</code>]</td> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">TABLE_SCHEMA</code>]</td> </tr></tbody></table>
...
- `ESTATÍSTICAS`:
  ...
  <table summary="Tipos de otimização que se aplicam às colunas da tabela INFORMATION_SCHEMA STATISTICS."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Coluna</th> <th>Tipo de otimização</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">INDEX_NAME</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">INDEX_NAME</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SEQ_IN_INDEX</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">COLUMN_NAME</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">COLLATION</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">CARDINALITY</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">INDEX_NAME</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code><code class="literal">INDEX_NAME</code>]</td> </tr><tr> <td>[[<code class="literal">SEQ_IN_INDEX</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">COLUMN_NAME</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">COLLATION</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">CARDINALITY</code>]]</td> <td>[[<code class="literal">OPEN_FULL_TABLE</code>]]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">INDEX_NAME</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">INDEX_NAME</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">SEQ_IN_INDEX</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">COLUMN_NAME</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">COLLATION</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">CARDINALITY</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr></tbody></table>

- `TABELAS`:

  <table summary="Tipos de otimização que se aplicam às colunas da tabela INFORMATION_SCHEMA TABLES."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Coluna</th> <th>Tipo de otimização</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">VERSION</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">VERSION</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">ROW_FORMAT</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">TABLE_ROWS</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">AVG_ROW_LENGTH</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">DATA_LENGTH</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">VERSION</code>]]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">VERSION</code>]</td> </tr><tr> <td>[[<code class="literal">ROW_FORMAT</code>]]</td> <td>[[<code class="literal">OPEN_FULL_TABLE</code>]]</td> </tr><tr> <td>[[<code class="literal">TABLE_ROWS</code>]]</td> <td>[[<code class="literal">OPEN_FULL_TABLE</code>]]</td> </tr><tr> <td>[[<code class="literal">AVG_ROW_LENGTH</code>]]</td> <td>[[<code class="literal">OPEN_FULL_TABLE</code>]]</td> </tr><tr> <td>[[<code class="literal">DATA_LENGTH</code>]]</td> <td>[[<code class="literal">OPEN_FULL_TABLE</code>]]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">VERSION</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">VERSION</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">ROW_FORMAT</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">TABLE_ROWS</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">AVG_ROW_LENGTH</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">DATA_LENGTH</code>]</td> <td>[[<code class="literal">TABLE_SCHEMA</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">VERSION</code>]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">VERSION</code>]</td> </tr><tr> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">ROW_FORMAT</code>]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">TABLE_ROWS</code>]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">AVG_ROW_LENGTH</code>]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">DATA_LENGTH</code>]</td> <td>[[<code class="literal">SKIP_OPEN_TABLE</code><code class="literal">OPEN_FULL_TABLE</code>]</td> </tr><tr> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">VERSION</code>]</td> <td>[[<code class="literal">TABLE_NAME</code><code class="literal">VERSION</code>]</td> </tr></tbody></table>
...
- `VISTAS`:
  ...
  <table summary="Tipos de otimização que se aplicam às colunas da tabela INFORMATION_SCHEMA VIEWS."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Coluna</th> <th>Tipo de otimização</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">IS_UPDATABLE</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">IS_UPDATABLE</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">DEFINER</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SECURITY_TYPE</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">CHARACTER_SET_CLIENT</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">COLLATION_CONNECTION</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">OPEN_FRM_ONLY</code>]</td> </tr><tr> <td>[[<code class="literal">IS_UPDATABLE</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code><code class="literal">IS_UPDATABLE</code>]</td> </tr><tr> <td>[[<code class="literal">DEFINER</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">SECURITY_TYPE</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">CHARACTER_SET_CLIENT</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr><tr> <td>[[<code class="literal">COLLATION_CONNECTION</code>]]</td> <td>[[<code class="literal">OPEN_FRM_ONLY</code>]]</td> </tr></tbody></table>

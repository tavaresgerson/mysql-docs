...
<table summary="A sintaxe do valor do comando para os comandos SET optimizer_switch."><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>Sintaxe de comando</th> <th>Significado</th> </tr></thead><tbody><tr> <td>[[<code class="literal">default</code>]]</td> <td>Reinicie todas as otimizações para o valor padrão</td> </tr><tr> <td>[[<code class="literal"><em class="replaceable"><code>opt_name</code>]]</em>=default</code></td> <td>Defina a otimização nomeada para o valor padrão</td> </tr><tr> <td>[[<code class="literal"><em class="replaceable"><code>opt_name</code>]]</em>=off</code></td> <td>Desative a otimização nomeada</td> </tr><tr> <td>[[<code class="literal"><em class="replaceable"><code>opt_name</code>]]</em>=on</code></td> <td>Ative a otimização nomeada</td> </tr></tbody></table>

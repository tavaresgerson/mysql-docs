...
<table summary="Colunas de saída produzidas pelo comando EXPLAIN."><col style="width: 25%"/><col style="width: 25%"/><col style="width: 50%"/><thead><tr> <th scope="col">Coluna</th> <th scope="col">Nome JSON</th> <th scope="col">Significado</th> </tr></thead><tbody><tr> <th scope="row"><a class="link" href="explain-output.html#explain_id">[[PH_HTML_CODE_<code class="literal">access_type</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">access_type</code>]</td> <td>O identificador [[PH_HTML_CODE_<code class="literal">possible_keys</code>]</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_select_type">[[PH_HTML_CODE_<code class="literal">key</code>]</a></th> <td>Nenhum</td> <td>O tipo [[PH_HTML_CODE_<code class="literal">key</code>]</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_table">[[PH_HTML_CODE_<code class="literal">key_len</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">key_length</code>]</td> <td>A tabela para a linha de saída</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_partitions">[[PH_HTML_CODE_<code class="literal">ref</code>]</a></th> <td>[[PH_HTML_CODE_<code class="literal">ref</code>]</td> <td>As divisórias correspondentes</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_type">[[PH_HTML_CODE_<code class="literal">rows</code>]</a></th> <td>[[<code class="literal">access_type</code>]]</td> <td>O tipo de conexão</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_possible_keys">[[<code class="literal">select_id</code><code class="literal">access_type</code>]</a></th> <td>[[<code class="literal">possible_keys</code>]]</td> <td>Os possíveis índices para escolher</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_key">[[<code class="literal">key</code>]]</a></th> <td>[[<code class="literal">key</code>]]</td> <td>O índice escolhido na verdade</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_key_len">[[<code class="literal">key_len</code>]]</a></th> <td>[[<code class="literal">key_length</code>]]</td> <td>O comprimento da chave escolhida</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_ref">[[<code class="literal">ref</code>]]</a></th> <td>[[<code class="literal">ref</code>]]</td> <td>As colunas em comparação com o índice</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_rows">[[<code class="literal">rows</code>]]</a></th> <td>[[<code class="literal">SELECT</code><code class="literal">access_type</code>]</td> <td>Estimativa de linhas a serem examinadas</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_filtered">[[<code class="literal">SELECT</code><code class="literal">access_type</code>]</a></th> <td>[[<code class="literal">SELECT</code><code class="literal">possible_keys</code>]</td> <td>Porcentagem de linhas filtradas por condição da tabela</td> </tr><tr> <th scope="row"><a class="link" href="explain-output.html#explain_extra">[[<code class="literal">SELECT</code><code class="literal">key</code>]</a></th> <td>Nenhum</td> <td>Informações adicionais</td> </tr></tbody></table>
...
- `select_type` (nome JSON: none)
  ...
  <table summary="valores de select_type e o significado de cada valor."><col style="width: 25%"/><col style="width: 25%"/><col style="width: 50%"/><thead><tr> <th scope="col">[[PH_HTML_CODE_<code class="literal">dependent</code>] Valor</th> <th scope="col">Nome JSON</th> <th scope="col">Significado</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">dependent</code>]</th> <td>Nenhum</td> <td>Simples<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[PH_HTML_CODE_<code class="literal">SELECT</code>]</a>(não usando<a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[PH_HTML_CODE_<code class="literal">UNION</code>]</a>ou subconsultas)</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">UNION RESULT</code>]</th> <td>Nenhum</td> <td>Mais distante<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[PH_HTML_CODE_<code class="literal">union_result</code>]</a></td> </tr><tr> <th scope="row"><a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[PH_HTML_CODE_<code class="literal">UNION</code>]</a></th> <td>Nenhum</td> <td>Segunda ou posterior<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[PH_HTML_CODE_<code class="literal">SUBQUERY</code>]</a>declaração em um<a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[PH_HTML_CODE_<code class="literal">SELECT</code>]</a></td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">DEPENDENT SUBQUERY</code>]</th> <td>[[<code class="literal">dependent</code>]] ([[<code class="literal">SIMPLE</code><code class="literal">dependent</code>])</td> <td>Segunda ou posterior<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">SELECT</code>]]</a>declaração em um<a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[<code class="literal">UNION</code>]]</a>, dependente da consulta externa</td> </tr><tr> <th scope="row">[[<code class="literal">UNION RESULT</code>]]</th> <td>[[<code class="literal">union_result</code>]]</td> <td>Resultado de um<a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[<code class="literal">UNION</code>]]</a>.</td> </tr><tr> <th scope="row"><a class="link" href="optimizer-hints.html#optimizer-hints-subquery" title="Dicas de otimização de subconsultas">[[<code class="literal">SUBQUERY</code>]]</a></th> <td>Nenhum</td> <td>Primeiro<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">SELECT</code>]]</a>em subconsulta</td> </tr><tr> <th scope="row">[[<code class="literal">DEPENDENT SUBQUERY</code>]]</th> <td>[[<code class="literal">SELECT</code><code class="literal">dependent</code>] ([[<code class="literal">SELECT</code><code class="literal">dependent</code>])</td> <td>Primeiro<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">SELECT</code><code class="literal">SELECT</code>]</a>em subconsulta, dependente da consulta externa</td> </tr><tr> <th scope="row">[[<code class="literal">SELECT</code><code class="literal">UNION</code>]</th> <td>Nenhum</td> <td>Tabela derivada</td> </tr><tr> <th scope="row">[[<code class="literal">SELECT</code><code class="literal">UNION RESULT</code>]</th> <td>[[<code class="literal">SELECT</code><code class="literal">union_result</code>]</td> <td>Subconsulta materializada</td> </tr><tr> <th scope="row">[[<code class="literal">SELECT</code><code class="literal">UNION</code>]</th> <td>[[<code class="literal">SELECT</code><code class="literal">SUBQUERY</code>] ([[<code class="literal">SELECT</code><code class="literal">SELECT</code>])</td> <td>Uma subconsulta para a qual o resultado não pode ser armazenado em cache e deve ser reavaliado para cada linha da consulta externa</td> </tr><tr> <th scope="row">[[<code class="literal">SELECT</code><code class="literal">DEPENDENT SUBQUERY</code>]</th> <td>[[<code class="literal">UNION</code><code class="literal">dependent</code>] ([[<code class="literal">UNION</code><code class="literal">dependent</code>])</td> <td>A segunda ou a posterior seleção em uma<a class="link" href="union.html" title="13.2.9.3 Cláusula de UNIÃO">[[<code class="literal">UNION</code><code class="literal">SELECT</code>]</a>que pertence a uma subconsulta não cacheável (veja [[<code class="literal">UNION</code><code class="literal">UNION</code>])</td> </tr></tbody></table>

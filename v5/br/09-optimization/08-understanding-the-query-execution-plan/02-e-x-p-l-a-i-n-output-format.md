...
- `Skip_open_table`, `Open_frm_only`, `Open_full_table` (propriedade JSON: `message`)
  ...
  Esses valores indicam otimizações de abertura de arquivos que se aplicam a consultas para tabelas do `INFORMATION_SCHEMA`, conforme descrito na Seção 8.2.3, “Otimizando consultas do INFORMATION_SCHEMA”.

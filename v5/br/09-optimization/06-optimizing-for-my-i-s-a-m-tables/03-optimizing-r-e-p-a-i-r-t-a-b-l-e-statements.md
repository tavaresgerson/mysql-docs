...
<table summary="variáveis myisamchk e as variáveis do sistema do servidor correspondentes."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th><a class="link" href="myisamchk.html" title="4.6.3 myisamchk — Ferramenta de manutenção de tabelas MyISAM"><span class="command"><strong>myisamchk</strong></span></a>Variável</th> <th>Variável do sistema</th> </tr></thead><tbody><tr> <td>[[<code class="literal">key_buffer_size</code>]]</td> <td><a class="link" href="server-system-variables.html#sysvar_key_buffer_size">[[<code class="literal">key_buffer_size</code>]]</a></td> </tr><tr> <td>[[<code class="literal">myisam_sort_buffer_size</code>]]</td> <td><a class="link" href="server-system-variables.html#sysvar_myisam_sort_buffer_size">[[<code class="literal">myisam_sort_buffer_size</code>]]</a></td> </tr><tr> <td>[[<code class="literal">read_buffer_size</code>]]</td> <td><a class="link" href="server-system-variables.html#sysvar_read_buffer_size">[[<code class="literal">read_buffer_size</code>]]</a></td> </tr><tr> <td>[[<code class="literal">write_buffer_size</code>]]</td> <td>nenhum</td> </tr></tbody></table>

...
Para obter informações sobre como usar essas variáveis para verificar o status do Performance Schema, consulte Seção 25.7, “Monitoramento de Status do Performance Schema”.
...
* `Performance_schema_session_connect_attrs_lost`
  ...
  Para mais informações sobre atributos de conexão, consulte Seção 25.12.9, “Tabelas de Atributos de Conexão do Performance Schema”.

...
25.4.1 Tempo de Eventos do Performance Schema (Performance Schema Event Timing)

25.4.2 Filtragem de Eventos do Performance Schema (Performance Schema Event Filtering)

25.4.3 Pré-filtragem de Eventos (Event Pre-Filtering)

25.4.4 Pré-filtragem por Instrument (Pre-Filtering by Instrument)

25.4.5 Pré-filtragem por Object (Pre-Filtering by Object)

25.4.6 Pré-filtragem por Thread (Pre-Filtering by Thread)

25.4.7 Pré-filtragem por Consumer (Pre-Filtering by Consumer)

25.4.8 Exemplos de Configurações de Consumer (Example Consumer Configurations)

25.4.9 Nomenclatura de Instruments ou Consumers para Operações de Filtragem (Naming Instruments or Consumers for Filtering Operations)

25.4.10 Determinando o que é Instrumented (Determining What Is Instrumented)
...
Você pode examinar o conteúdo dessas tabelas para obter informações sobre as características de monitoramento do Performance Schema. Se você tiver o privilégio `UPDATE`, você pode alterar a operação do Performance Schema modificando as tabelas de *setup* para afetar como o monitoramento ocorre. Para detalhes adicionais sobre essas tabelas, consulte Section 25.12.2, “Performance Schema Setup Tables”.
...
Para discussão sobre *timers*, consulte Section 25.4.1, “Performance Schema Event Timing”.

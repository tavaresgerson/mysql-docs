...
* `TRANSACTIONS_COMMITTED_ALL_MEMBERS`
  ...
  As Transactions que foram confirmadas (committed) com sucesso em todos os membros do grupo de replicação, mostradas como GTID Sets. Isso é atualizado em um intervalo de tempo fixo.

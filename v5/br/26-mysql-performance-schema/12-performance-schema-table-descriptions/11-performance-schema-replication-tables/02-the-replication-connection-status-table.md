#### 25.12.11.2 Tabela replication\_connection\_status
...
<table summary="Correspondência entre as colunas replication_connection_status e SHOW SLAVE STATUS"><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th>[[PH_HTML_CODE_<code class="literal">Last_IO_Errno</code>] Coluna</th> <th>[[PH_HTML_CODE_<code class="literal">Last_IO_Errno</code>] Coluna</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">Last_IO_Error</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">LAST_ERROR_TIMESTAMP</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">Last_IO_Error_Timestamp</code>]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">SERVICE_STATE</code>]]</td> <td>[[<code class="literal">Slave_IO_Running</code>]]</td> </tr><tr> <td>[[<code class="literal">RECEIVED_TRANSACTION_SET</code>]]</td> <td>[[<code class="literal">Retrieved_Gtid_Set</code>]]</td> </tr><tr> <td>[[<code class="literal">LAST_ERROR_NUMBER</code>]]</td> <td>[[<code class="literal">Last_IO_Errno</code>]]</td> </tr><tr> <td>[[<code class="literal">SHOW SLAVE STATUS</code><code class="literal">Last_IO_Errno</code>]</td> <td>[[<code class="literal">Last_IO_Error</code>]]</td> </tr><tr> <td>[[<code class="literal">LAST_ERROR_TIMESTAMP</code>]]</td> <td>[[<code class="literal">Last_IO_Error_Timestamp</code>]]</td> </tr></tbody></table>

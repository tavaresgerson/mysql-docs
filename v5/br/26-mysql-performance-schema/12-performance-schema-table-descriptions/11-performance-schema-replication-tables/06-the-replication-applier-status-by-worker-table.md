...
<table summary="Correspondência entre as colunas replication_applier_status_by_worker e as colunas SHOW SLAVE STATUS"><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th>[[PH_HTML_CODE_<code class="literal">LAST_ERROR_TIMESTAMP</code>] Coluna</th> <th>[[PH_HTML_CODE_<code class="literal">LAST_ERROR_TIMESTAMP</code>] Coluna</th> </tr></thead><tbody><tr> <td>[[<code class="literal">WORKER_ID</code>]]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">THREAD_ID</code>]]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">SERVICE_STATE</code>]]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">LAST_SEEN_TRANSACTION</code>]]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">LAST_ERROR_NUMBER</code>]]</td> <td>[[<code class="literal">Last_SQL_Errno</code>]]</td> </tr><tr> <td>[[<code class="literal">LAST_ERROR_MESSAGE</code>]]</td> <td>[[<code class="literal">Last_SQL_Error</code>]]</td> </tr><tr> <td>[[<code class="literal">LAST_ERROR_TIMESTAMP</code>]]</td> <td>[[<code class="literal">SHOW SLAVE STATUS</code><code class="literal">LAST_ERROR_TIMESTAMP</code>]</td> </tr></tbody></table>

...
<table summary="Correspondência entre as colunas replication_connection_configuration e SHOW SLAVE STATUS"><col style="width: 60%"/><col style="width: 40%"/><thead><tr> <th>[[PH_HTML_CODE_<code class="literal">NETWORK_INTERFACE</code>] Coluna</th> <th>[[PH_HTML_CODE_<code class="literal">NETWORK_INTERFACE</code>] Coluna</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">AUTO_POSITION</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">Auto_Position</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SSL_ALLOWED</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">Master_SSL_Allowed</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SSL_CA_FILE</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">Master_SSL_CA_File</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SSL_CA_PATH</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">Master_SSL_CA_Path</code>]</td> </tr><tr> <td>[[<code class="literal">NETWORK_INTERFACE</code>]]</td> <td>[[<code class="literal">SHOW SLAVE STATUS</code><code class="literal">NETWORK_INTERFACE</code>]</td> </tr><tr> <td>[[<code class="literal">AUTO_POSITION</code>]]</td> <td>[[<code class="literal">Auto_Position</code>]]</td> </tr><tr> <td>[[<code class="literal">SSL_ALLOWED</code>]]</td> <td>[[<code class="literal">Master_SSL_Allowed</code>]]</td> </tr><tr> <td>[[<code class="literal">SSL_CA_FILE</code>]]</td> <td>[[<code class="literal">Master_SSL_CA_File</code>]]</td> </tr><tr> <td>[[<code class="literal">SSL_CA_PATH</code>]]</td> <td>[[<code class="literal">Master_SSL_CA_Path</code>]]</td> </tr><tr> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">NETWORK_INTERFACE</code>]</td> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">NETWORK_INTERFACE</code>]</td> </tr><tr> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">AUTO_POSITION</code>]</td> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">Auto_Position</code>]</td> </tr><tr> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">SSL_ALLOWED</code>]</td> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">Master_SSL_Allowed</code>]</td> </tr><tr> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">SSL_CA_FILE</code>]</td> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">Master_SSL_CA_File</code>]</td> </tr><tr> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">SSL_CA_PATH</code>]</td> <td>[[<code class="literal">CHANNEL_NAME</code><code class="literal">Master_SSL_CA_Path</code>]</td> </tr><tr> <td>[[<code class="literal">Channel_name</code><code class="literal">NETWORK_INTERFACE</code>]</td> <td>[[<code class="literal">Channel_name</code><code class="literal">NETWORK_INTERFACE</code>]</td> </tr><tr> <td>[[<code class="literal">Channel_name</code><code class="literal">AUTO_POSITION</code>]</td> <td>[[<code class="literal">Channel_name</code><code class="literal">Auto_Position</code>]</td> </tr><tr> <td>[[<code class="literal">Channel_name</code><code class="literal">SSL_ALLOWED</code>]</td> <td>[[<code class="literal">Channel_name</code><code class="literal">Master_SSL_Allowed</code>]</td> </tr><tr> <td>[[<code class="literal">Channel_name</code><code class="literal">SSL_CA_FILE</code>]</td> <td>Nenhum</td> </tr><tr> <td>[[<code class="literal">Channel_name</code><code class="literal">Master_SSL_CA_File</code>]</td> <td>[[<code class="literal">Channel_name</code><code class="literal">SSL_CA_PATH</code>]</td> </tr></tbody></table>

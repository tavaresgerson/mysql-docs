...
25.2 Configuração de Compilação (Build) do Performance Schema

25.3 Configuração de Inicialização (Startup) do Performance Schema

25.4 Configuração em Tempo de Execução (Runtime) do Performance Schema :   25.4.1 Temporização de Eventos (Event Timing) do Performance Schema

    25.4.2 Filtragem de Eventos (Event Filtering) do Performance Schema

    25.4.3 Pré-Filtragem de Eventos (Event Pre-Filtering)

    25.4.4 Pré-Filtragem por Instrument
    ...
    25.4.8 Exemplos de Configurações de Consumer

    25.4.9 Nomeando Instruments ou Consumers para Operações de Filtragem

    25.4.10 Determinando o que Está Instrumented
...
25.8 Eventos Atom e Molecule do Performance Schema

25.9 Tabelas do Performance Schema para Eventos Atuais e Históricos

25.10 Digests de Statement do Performance Schema

25.11 Características Gerais das Tabelas do Performance Schema

25.12 Descrições das Tabelas do Performance Schema :   25.12.1 Referência de Tabelas do Performance Schema

    25.12.2 Tabelas de Configuração (Setup) do Performance Schema

    25.12.3 Tabelas de Instância do Performance Schema
    ...
    25.12.7 Tabelas de Transação do Performance Schema
    ...
    25.12.16 Tabelas Diversas (Miscellaneous) do Performance Schema
...
25.17 O Modelo de Alocação de Memória do Performance Schema

25.18 Performance Schema e Plugins

25.19 Usando o Performance Schema para Diagnosticar Problemas :   25.19.1 Geração de Perfil de Query (Query Profiling) Usando Performance Schema

25.20 Migrando para as Tabelas de Variáveis de Sistema e Status do Performance Schema
...
O schema `sys` do MySQL é um conjunto de objetos que fornece acesso conveniente aos dados coletados pelo Performance Schema. O schema `sys` é instalado por padrão. Para instruções de uso, veja Capítulo 26, *MySQL sys Schema*.
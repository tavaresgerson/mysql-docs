...
25.19.1 Geração de Perfil de Query Usando Performance Schema
...
4. Repita o processo na etapa 1.
   ...
   A cada iteração, a saída do Performance Schema, particularmente a tabela `events_waits_history_long`, contém cada vez menos "ruído" causado por instrumentos não significativos e, dado que esta tabela tem um tamanho fixo, contém cada vez mais dados relevantes para a análise do problema em questão.

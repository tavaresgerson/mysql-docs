...
<table summary="Como o plugin Rewriter compara declarações preparadas com o padrão SELECT ?,3."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Declaração preparada</th> <th>Se a declaração corresponde ao padrão</th> </tr></thead><tbody><tr> <td>[[<code class="literal">PREPARE s AS 'SELECT 3, 3'</code>]]</td> <td>Sim</td> </tr><tr> <td>[[<code class="literal">PREPARE s AS 'SELECT ?, 3'</code>]]</td> <td>Sim</td> </tr><tr> <td>[[<code class="literal">PREPARE s AS 'SELECT 3, ?'</code>]]</td> <td>Não</td> </tr><tr> <td>[[<code class="literal">PREPARE s AS 'SELECT ?, ?'</code>]]</td> <td>Não</td> </tr></tbody></table>

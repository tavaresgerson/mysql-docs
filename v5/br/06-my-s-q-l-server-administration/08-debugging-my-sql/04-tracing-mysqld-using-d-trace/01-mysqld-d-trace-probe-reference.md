...
<table><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Grupo</th> <th>Sondas</th> </tr></thead><tbody><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-connection" title="5.8.4.1.1 Sondas de Conexão">Conexão</a></td> <td>[[PH_HTML_CODE_<code class="literal">query-exec-start</code>], [[PH_HTML_CODE_<code class="literal">query-exec-start</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-command" title="5.8.4.1.2 Provas de comando">Comando</a></td> <td>[[PH_HTML_CODE_<code class="literal">insert-row-start</code>], [[PH_HTML_CODE_<code class="literal">insert-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-query" title="5.8.4.1.3 Sondas de Consulta">Consulta</a></td> <td>[[PH_HTML_CODE_<code class="literal">update-row-start</code>], [[PH_HTML_CODE_<code class="literal">update-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-query-parsing" title="5.8.4.1.4 Análises de Particionamento de Consulta">Análise de consultas</a></td> <td>[[PH_HTML_CODE_<code class="literal">delete-row-start</code>], [[PH_HTML_CODE_<code class="literal">delete-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-querycache" title="5.8.4.1.5 Provas do Cache de Consulta">Cache de consulta</a></td> <td>[[PH_HTML_CODE_<code class="literal">read-row-start</code>], [[PH_HTML_CODE_<code class="literal">read-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-queryexec" title="5.8.4.1.6 Análises de execução de consultas">Execução de consulta</a></td> <td>[[<code class="literal">query-exec-start</code>]], [[<code class="literal">connection-done</code><code class="literal">query-exec-start</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-rowlevel" title="5.8.4.1.7 Sondas de nível de linha">Nível de linha</a></td> <td>[[<code class="literal">insert-row-start</code>]], [[<code class="literal">insert-row-done</code>]]</td> </tr><tr> <td></td> <td>[[<code class="literal">update-row-start</code>]], [[<code class="literal">update-row-done</code>]]</td> </tr><tr> <td></td> <td>[[<code class="literal">delete-row-start</code>]], [[<code class="literal">delete-row-done</code>]]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-readrow" title="5.8.4.1.8 Leitura de sondagens de linha">Leitura em linha</a></td> <td>[[<code class="literal">read-row-start</code>]], [[<code class="literal">read-row-done</code>]]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-index" title="5.8.4.1.9 Sondas de índice">Leitura do índice</a></td> <td>[[<code class="literal">command-start</code><code class="literal">query-exec-start</code>], [[<code class="literal">command-start</code><code class="literal">query-exec-start</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-lock" title="5.8.4.1.10 Sondas de bloqueio">Bloquear</a></td> <td>[[<code class="literal">command-start</code><code class="literal">insert-row-start</code>], [[<code class="literal">command-start</code><code class="literal">insert-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-start</code><code class="literal">update-row-start</code>], [[<code class="literal">command-start</code><code class="literal">update-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-start</code><code class="literal">delete-row-start</code>], [[<code class="literal">command-start</code><code class="literal">delete-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-filesort" title="5.8.4.1.11 Provas de Filesort">Filesort</a></td> <td>[[<code class="literal">command-start</code><code class="literal">read-row-start</code>], [[<code class="literal">command-start</code><code class="literal">read-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-statement" title="5.8.4.1.12 Provas de declaração">Declaração</a></td> <td>[[<code class="literal">command-done</code><code class="literal">query-exec-start</code>], [[<code class="literal">command-done</code><code class="literal">query-exec-start</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-done</code><code class="literal">insert-row-start</code>], [[<code class="literal">command-done</code><code class="literal">insert-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-done</code><code class="literal">update-row-start</code>], [[<code class="literal">command-done</code><code class="literal">update-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-done</code><code class="literal">delete-row-start</code>], [[<code class="literal">command-done</code><code class="literal">delete-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">command-done</code><code class="literal">read-row-start</code>], [[<code class="literal">command-done</code><code class="literal">read-row-done</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">query-start</code><code class="literal">query-exec-start</code>], [[<code class="literal">query-start</code><code class="literal">query-exec-start</code>]</td> </tr><tr> <td></td> <td>[[<code class="literal">query-start</code><code class="literal">insert-row-start</code>], [[<code class="literal">query-start</code><code class="literal">insert-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-network" title="5.8.4.1.13 Provas de rede">Rede</a></td> <td>[[<code class="literal">query-start</code><code class="literal">update-row-start</code>], [[<code class="literal">query-start</code><code class="literal">update-row-done</code>], [[<code class="literal">query-start</code><code class="literal">delete-row-start</code>], [[<code class="literal">query-start</code><code class="literal">delete-row-done</code>]</td> </tr><tr> <td><a class="link" href="dba-dtrace-mysqld-ref.html#dba-dtrace-ref-keycache" title="5.8.4.1.14 Provas do Keycache">Keycache</a></td> <td>[[<code class="literal">query-start</code><code class="literal">read-row-start</code>], [[<code class="literal">query-start</code><code class="literal">read-row-done</code>], [[<code class="literal">query-done</code><code class="literal">query-exec-start</code>], [[<code class="literal">query-done</code><code class="literal">query-exec-start</code>], [[<code class="literal">query-done</code><code class="literal">insert-row-start</code>], [[<code class="literal">query-done</code><code class="literal">insert-row-done</code>], [[<code class="literal">query-done</code><code class="literal">update-row-start</code>], [[<code class="literal">query-done</code><code class="literal">update-row-done</code>]</td> </tr></tbody></table>

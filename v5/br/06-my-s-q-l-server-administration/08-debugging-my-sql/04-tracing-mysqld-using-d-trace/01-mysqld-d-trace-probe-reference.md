...
<table><col style="width: 20%"/><col style="width: 80%"/><thead><tr> <th>Grupo</th> <th>Sondas</th> </tr></thead><tbody><tr> <td>Conexão</td> <td>PH_HTML_CODE_<code>query-exec-start</code>], PH_HTML_CODE_<code>query-exec-start</code>]</td> </tr><tr> <td>Comando</td> <td>PH_HTML_CODE_<code>insert-row-start</code>], PH_HTML_CODE_<code>insert-row-done</code>]</td> </tr><tr> <td>Consulta</td> <td>PH_HTML_CODE_<code>update-row-start</code>], PH_HTML_CODE_<code>update-row-done</code>]</td> </tr><tr> <td>Análise de consultas</td> <td>PH_HTML_CODE_<code>delete-row-start</code>], PH_HTML_CODE_<code>delete-row-done</code>]</td> </tr><tr> <td>Cache de consulta</td> <td>PH_HTML_CODE_<code>read-row-start</code>], PH_HTML_CODE_<code>read-row-done</code>]</td> </tr><tr> <td>Execução de consulta</td> <td><code>query-exec-start</code>, <code>connection-done</code><code>query-exec-start</code>]</td> </tr><tr> <td>Nível de linha</td> <td><code>insert-row-start</code>, <code>insert-row-done</code></td> </tr><tr> <td></td> <td><code>update-row-start</code>, <code>update-row-done</code></td> </tr><tr> <td></td> <td><code>delete-row-start</code>, <code>delete-row-done</code></td> </tr><tr> <td>Leitura em linha</td> <td><code>read-row-start</code>, <code>read-row-done</code></td> </tr><tr> <td>Leitura do índice</td> <td><code>command-start</code><code>query-exec-start</code>], <code>command-start</code><code>query-exec-start</code>]</td> </tr><tr> <td>Bloquear</td> <td><code>command-start</code><code>insert-row-start</code>], <code>command-start</code><code>insert-row-done</code>]</td> </tr><tr> <td></td> <td><code>command-start</code><code>update-row-start</code>], <code>command-start</code><code>update-row-done</code>]</td> </tr><tr> <td></td> <td><code>command-start</code><code>delete-row-start</code>], <code>command-start</code><code>delete-row-done</code>]</td> </tr><tr> <td>Filesort</td> <td><code>command-start</code><code>read-row-start</code>], <code>command-start</code><code>read-row-done</code>]</td> </tr><tr> <td>Declaração</td> <td><code>command-done</code><code>query-exec-start</code>], <code>command-done</code><code>query-exec-start</code>]</td> </tr><tr> <td></td> <td><code>command-done</code><code>insert-row-start</code>], <code>command-done</code><code>insert-row-done</code>]</td> </tr><tr> <td></td> <td><code>command-done</code><code>update-row-start</code>], <code>command-done</code><code>update-row-done</code>]</td> </tr><tr> <td></td> <td><code>command-done</code><code>delete-row-start</code>], <code>command-done</code><code>delete-row-done</code>]</td> </tr><tr> <td></td> <td><code>command-done</code><code>read-row-start</code>], <code>command-done</code><code>read-row-done</code>]</td> </tr><tr> <td></td> <td><code>query-start</code><code>query-exec-start</code>], <code>query-start</code><code>query-exec-start</code>]</td> </tr><tr> <td></td> <td><code>query-start</code><code>insert-row-start</code>], <code>query-start</code><code>insert-row-done</code>]</td> </tr><tr> <td>Rede</td> <td><code>query-start</code><code>update-row-start</code>], <code>query-start</code><code>update-row-done</code>], <code>query-start</code><code>delete-row-start</code>], <code>query-start</code><code>delete-row-done</code>]</td> </tr><tr> <td>Keycache</td> <td><code>query-start</code><code>read-row-start</code>], <code>query-start</code><code>read-row-done</code>], <code>query-done</code><code>query-exec-start</code>], <code>query-done</code><code>query-exec-start</code>], <code>query-done</code><code>insert-row-start</code>], <code>query-done</code><code>insert-row-done</code>], <code>query-done</code><code>update-row-start</code>], <code>query-done</code><code>update-row-done</code>]</td> </tr></tbody></table>
...
- `command-start`: Acionado quando um comando é enviado ao servidor.
  ...
  - `command`: Um número inteiro que representa o comando executado. Os valores possíveis estão mostrados na tabela a seguir.
    ...
    <table summary="Possíveis valores de comando de início e um nome e descrição para cada um."><col style="width: 10%"/><col style="width: 20%"/><col style="width: 70%"/><thead><tr> <th>Valor</th> <th>Nome</th> <th>Descrição</th> </tr></thead><tbody><tr> <th>00</th> <td>COM_SLEEP</td> <td>Estado do furo interno</td> </tr><tr> <th>01</th> <td>COM_QUIT</td> <td>Conexão próxima</td> </tr><tr> <th>02</th> <td>COM_INIT_DB</td> <td>Selecionar banco de dados (<code>USE ...</code>)</td> </tr><tr> <th>03</th> <td>COM_QUERY</td> <td>Executar uma consulta</td> </tr><tr> <th>04</th> <td>COM_FIELD_LIST</td> <td>Obtenha uma lista de campos</td> </tr><tr> <th>05</th> <td>COM_CREATE_DB</td> <td>Crie um banco de dados (desatualizado)</td> </tr><tr> <th>06</th> <td>COM_DROP_DB</td> <td>Deixe um banco de dados (desatualizado)</td> </tr><tr> <th>07</th> <td>COM_REFRESH</td> <td>Atualizar a conexão</td> </tr><tr> <th>08</th> <td>COM_SHUTDOWN</td> <td>Desligar o servidor</td> </tr><tr> <th>09</th> <td>COM_STATÍSTICAS</td> <td>Obtenha estatísticas</td> </tr><tr> <th>10</th> <td>COM_PROCESS_INFO</td> <td>Obtenha processos (<code>SHOW PROCESSLIST</code>)</td> </tr><tr> <th>11</th> <td>COM_CONNECT</td> <td>Inicializar a conexão</td> </tr><tr> <th>12</th> <td>COM_PROCESS_KILL</td> <td>Processo de eliminação</td> </tr><tr> <th>13</th> <td>COM_DEBUG</td> <td>Obter informações de depuração</td> </tr><tr> <th>14</th> <td>COM_PING</td> <td>Ping</td> </tr><tr> <th>15</th> <td>COM_TIME</td> <td>Estado do furo interno</td> </tr><tr> <th>16</th> <td>COM_DELAYED_INSERT</td> <td>Estado do furo interno</td> </tr><tr> <th>17</th> <td>COM_CHANGE_USER</td> <td>Alterar usuário</td> </tr><tr> <th>18</th> <td>COM_BINLOG_DUMP</td> <td>Utilizado por uma réplica ou<span><strong>mysqlbinlog</strong></span>para iniciar uma leitura de log binário</td> </tr><tr> <th>19</th> <td>COM_TABLE_DUMP</td> <td>Utilizado por uma réplica para obter as informações da tabela de origem</td> </tr><tr> <th>20</th> <td>COM_CONNECT_OUT</td> <td>Utilizado por uma réplica para registrar uma conexão com o servidor</td> </tr><tr> <th>21</th> <td>COM_REGISTER_SLAVE</td> <td>Utilizado por uma réplica durante o registro</td> </tr><tr> <th>22</th> <td>COM_STMT_PREPARE</td> <td>Prepare uma declaração</td> </tr><tr> <th>23</th> <td>COM_STMT_EXECUTE</td> <td>Executar uma declaração</td> </tr><tr> <th>24</th> <td>COM_STMT_SEND_LONG_DATA</td> <td>Utilizado por um cliente ao solicitar dados estendidos</td> </tr><tr> <th>25</th> <td>COM_STMT_CLOSE</td> <td>Fechar uma declaração preparada</td> </tr><tr> <th>26</th> <td>COM_STMT_RESET</td> <td>Reinicie uma declaração preparada</td> </tr><tr> <th>27</th> <td>COM_SET_OPTION</td> <td>Definir uma opção de servidor</td> </tr><tr> <th>28</th> <td>COM_STMT_FETCH</td> <td>Peça uma declaração preparada</td> </tr></tbody></table>

...
Para **mysqld**, também é possível alterar as configurações `DBUG` em runtime, definindo a *system variable* `debug`. Esta variável possui valores global e de session:
...
Alterar o valor global de [`debug`] requer privilégios suficientes para definir *system variables* globais. Alterar o valor de session de [`debug`] requer privilégios suficientes para definir *system variables* de session restritas. Consulte Seção 5.1.8.1, “Privilégios de System Variable”.

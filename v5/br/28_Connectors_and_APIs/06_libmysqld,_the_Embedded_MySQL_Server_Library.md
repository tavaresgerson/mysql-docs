...
A API é idêntica para a versão MySQL embutida e para a versão cliente/servidor. Para alterar uma aplicação com suporte a múltiplos threads para usar a biblioteca embutida, normalmente você só precisa adicionar chamadas às seguintes funções.
...
Aqui está o comando de string para compilar o programa acima:

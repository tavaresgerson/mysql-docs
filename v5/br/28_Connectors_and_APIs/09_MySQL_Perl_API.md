...
* Para instruções de instalação do suporte Perl DBI, consulte a Seção 2.12, “Notas de Instalação do Perl”.

* Para um exemplo de opções de leitura a partir de arquivos de opções, consulte a Seção 5.7.4, “Usando programas de cliente em um ambiente de múltiplos servidores”.

* Para dicas de codificação segura, consulte a Seção 6.1.1, “Diretrizes de Segurança”.

* Para dicas de depuração, consulte a Seção 5.8.1.4, “Depuração do mysqld sob o gdb”.
* Para algumas variáveis de ambiente específicas do Perl, consulte a Seção 4.9, “Variáveis de ambiente”.

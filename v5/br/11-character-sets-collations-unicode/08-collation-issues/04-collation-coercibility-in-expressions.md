...
<table summary="Comparativos e a comparação utilizada para cada comparação."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th>Comparação</th> <th>Collation Used</th> </tr></thead><tbody><tr> <td>[[<code class="literal">column1 = 'A'</code>]]</td> <td>Utilize a colagem de [[<code class="literal">column1</code>]]</td> </tr><tr> <td>[[<code class="literal">column1 = 'A' COLLATE x</code>]]</td> <td>Utilize a colagem de [[<code class="literal">'A' COLLATE x</code>]]</td> </tr><tr> <td>[[<code class="literal">column1 COLLATE x = 'A' COLLATE y</code>]]</td> <td>Erro</td> </tr></tbody></table>

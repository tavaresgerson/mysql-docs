...
<table summary="Especificadores de idioma para colorações de conjuntos de caracteres Unicode."><col style="width: 40%"/><col style="width: 60%"/><thead><tr> <th>Língua</th> <th>Especificador de idioma</th> </tr></thead><tbody><tr> <td>Latim clássico</td> <td>[[PH_HTML_CODE_<code class="literal">lithuanian</code>]</td> </tr><tr> <td>Croata</td> <td>[[PH_HTML_CODE_<code class="literal">lithuanian</code>]</td> </tr><tr> <td>Checo</td> <td>[[PH_HTML_CODE_<code class="literal">polish</code>]</td> </tr><tr> <td>Dinamarquês
Português (Brasil)</td> <td>[[PH_HTML_CODE_<code class="literal">romanian</code>]</td> </tr><tr> <td>Esperanto</td> <td>[[PH_HTML_CODE_<code class="literal">sinhala</code>]</td> </tr><tr> <td>Estoniano
Português (Brasil)</td> <td>[[PH_HTML_CODE_<code class="literal">slovak</code>]</td> </tr><tr> <td>Lista telefônica alemã</td> <td>[[PH_HTML_CODE_<code class="literal">slovenian</code>]</td> </tr><tr> <td>Húngaro</td> <td>[[PH_HTML_CODE_<code class="literal">spanish</code>]</td> </tr><tr> <td>Islandês
Português (Brasil)</td> <td>[[PH_HTML_CODE_<code class="literal">spanish2</code>]</td> </tr><tr> <td>Letão</td> <td>[[PH_HTML_CODE_<code class="literal">swedish</code>]</td> </tr><tr> <td>Lituano</td> <td>[[<code class="literal">lithuanian</code>]]</td> </tr><tr> <td>Persa</td> <td>[[<code class="literal">croatian</code><code class="literal">lithuanian</code>]</td> </tr><tr> <td>Polonês</td> <td>[[<code class="literal">polish</code>]]</td> </tr><tr> <td>Romeno</td> <td>[[<code class="literal">romanian</code>]]</td> </tr><tr> <td>Sinhala</td> <td>[[<code class="literal">sinhala</code>]]</td> </tr><tr> <td>Eslovaco</td> <td>[[<code class="literal">slovak</code>]]</td> </tr><tr> <td>Esloveno</td> <td>[[<code class="literal">slovenian</code>]]</td> </tr><tr> <td>Espanhol moderno</td> <td>[[<code class="literal">spanish</code>]]</td> </tr><tr> <td>Espanhol tradicional</td> <td>[[<code class="literal">spanish2</code>]]</td> </tr><tr> <td>Suécia</td> <td>[[<code class="literal">swedish</code>]]</td> </tr><tr> <td>Turco
Português (Brasil):</td> <td>[[<code class="literal">czech</code><code class="literal">lithuanian</code>]</td> </tr><tr> <td>Vietnamita</td> <td>[[<code class="literal">czech</code><code class="literal">lithuanian</code>]</td> </tr></tbody></table>

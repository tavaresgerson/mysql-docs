...
A `LIMIT` clause possui a mesma sintaxe que para a instrução `SELECT`. Veja Seção 13.2.9, “Instrução SELECT”.
...
Para mais informações, veja Seção 13.7.5.40, “Instrução SHOW WARNINGS”.
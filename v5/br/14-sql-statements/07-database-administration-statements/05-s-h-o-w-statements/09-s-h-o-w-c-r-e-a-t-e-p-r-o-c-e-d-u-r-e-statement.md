...
Esta instrução é uma extensão do MySQL. Ela retorna a string exata que pode ser usada para recriar o procedimento armazenado nomeado. Uma instrução similar, `SHOW CREATE FUNCTION`, exibe informações sobre funções armazenadas (veja Seção 13.7.5.8, “SHOW CREATE FUNCTION Statement”).

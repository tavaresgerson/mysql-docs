...
No programa **mysql**, o comando `GRANT` responde com `Query OK, 0 rows affected` quando executado com sucesso. Para determinar quais privilégios resultam da operação, use o comando `SHOW GRANTS` (exibir\_permissões). Consulte Seção 13.7.5.21, “Instrução SHOW GRANTS”.
...
Vários objetos nas declarações ``GRANT` estão sujeitos à citação, embora a citação seja opcional em muitos casos: nomes de conta, banco de dados, tabela, coluna e rotinas. Por exemplo, se um valor de *`user\_name`* ou *`host\_name`* em um nome de conta for legal como um identificador não citado, você não precisa citar. No entanto, as aspas são necessárias para especificar uma string de *`user\_name`* contendo caracteres especiais (como `-`) ou uma string de *`host\_name`* contendo caracteres especiais ou caracteres curinga, como `%`(por exemplo,`'test-user'@'%.com'\`). Cite o nome de usuário e o nome do host separadamente.
...
Os caracteres curingas `_` e `%` são permitidos ao especificar nomes de banco de dados em declarações de `GRANT` (concessão de privilégios) que concedem privilégios ao nível do banco de dados (`GRANT ... ON db_name.*`). Isso significa, por exemplo, que, para usar um caractere `_` como parte de um nome de banco de dados, especifique-o usando o caractere de escape `\` como `\_` na declaração de `GRANT`, para evitar que o usuário possa acessar bancos de dados adicionais que correspondam ao padrão de curinga (por exemplo, `GRANT ... ON `foo\_bar`.* TO ...`).
...
<table><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Privilégio</th> <th>Significado e Níveis de Financiamento</th> </tr></thead><tbody><tr> <td><a class="link" href="privileges-provided.html#priv_all">[[PH_HTML_CODE_<code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Concede todos os privilégios no nível de acesso especificado, exceto<a class="link" href="privileges-provided.html#priv_grant-option">[[PH_HTML_CODE_<code class="literal">CREATE TEMPORARY TABLE</code>]</a>e<a class="link" href="privileges-provided.html#priv_proxy">[[PH_HTML_CODE_<code class="literal">CREATE USER</code>]</a>.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter">[[PH_HTML_CODE_<code class="literal">DROP USER</code>]</a></td> <td>Ative o uso de<a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[PH_HTML_CODE_<code class="literal">RENAME USER</code>]</a>Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter-routine">[[PH_HTML_CODE_<code class="literal">REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative a alteração ou a eliminação de rotinas armazenadas. Níveis: Global, banco de dados, rotina.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create">[[PH_HTML_CODE_<code class="literal">CREATE VIEW</code>]</a></td> <td>Ative a criação de bancos de dados e tabelas. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-routine">[[PH_HTML_CODE_<code class="literal">DELETE</code>]</a></td> <td>Ative a criação de rotinas armazenadas. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-tablespace">[[PH_HTML_CODE_<code class="literal">DELETE</code>]</a></td> <td>Ative a criação, alteração ou eliminação de espaços de tabela e grupos de arquivos de log. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-temporary-tables">[[PH_HTML_CODE_<code class="literal">DROP</code>]</a></td> <td>Ative o uso de<a class="link" href="create-table.html" title="13.1.18 Declaração CREATE TABLE">[[<code class="literal">CREATE TEMPORARY TABLE</code>]]</a>Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-user">[[<code class="literal">GRANT OPTION</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de<a class="link" href="create-user.html" title="13.7.1.2 Declaração CREATE USER">[[<code class="literal">CREATE USER</code>]]</a>,<a class="link" href="drop-user.html" title="13.7.1.3 Declaração DROP USER">[[<code class="literal">DROP USER</code>]]</a>,<a class="link" href="rename-user.html" title="13.7.1.5 Declaração de RENOMEAR USUÁRIO">[[<code class="literal">RENAME USER</code>]]</a>, e<a class="link" href="revoke.html" title="13.7.1.6 Declaração de REVOGAÇÃO">[[<code class="literal">REVOKE ALL PRIVILEGES</code>]]</a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-view">[[<code class="literal">CREATE VIEW</code>]]</a></td> <td>Ative a criação ou alteração de visualizações. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_delete">[[<code class="literal">DELETE</code>]]</a></td> <td>Ative o uso de<a class="link" href="delete.html" title="13.2.2 Declaração DELETE">[[<code class="literal">DELETE</code>]]</a>Nível: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_drop">[[<code class="literal">DROP</code>]]</a></td> <td>Ative a possibilidade de excluir bancos de dados, tabelas e visualizações. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_event">[[<code class="literal">PROXY</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de eventos para o Agendamento de Eventos. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_execute">[[<code class="literal">PROXY</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Permitir que o usuário execute rotinas armazenadas. Níveis: Global, banco de dados, rotina.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_file">[[<code class="literal">PROXY</code><code class="literal">CREATE USER</code>]</a></td> <td>Permitir que o usuário faça com que o servidor leia ou escreva arquivos. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_grant-option">[[<code class="literal">PROXY</code><code class="literal">DROP USER</code>]</a></td> <td>Ative ou desative privilégios para serem concedidos ou removidos de outras contas. Níveis: Global, banco de dados, tabela, rotina, proxy.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_index">[[<code class="literal">PROXY</code><code class="literal">RENAME USER</code>]</a></td> <td>Ative a criação ou remoção de índices. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_insert">[[<code class="literal">PROXY</code><code class="literal">REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative o uso de<a class="link" href="insert.html" title="13.2.5 Instrução INSERT">[[<code class="literal">PROXY</code><code class="literal">CREATE VIEW</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_lock-tables">[[<code class="literal">PROXY</code><code class="literal">DELETE</code>]</a></td> <td>Ative o uso de<a class="link" href="lock-tables.html" title="13.3.5 Declarações LOCK TABLES e UNLOCK TABLES">[[<code class="literal">PROXY</code><code class="literal">DELETE</code>]</a>nas mesas para as quais você tem<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">PROXY</code><code class="literal">DROP</code>]</a>privilégio. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_process">[[<code class="literal">ALTER</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Permitir que o usuário veja todos os processos com<a class="link" href="show-processlist.html" title="13.7.5.29 Declaração PROCESSLIST">[[<code class="literal">ALTER</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_proxy">[[<code class="literal">ALTER</code><code class="literal">CREATE USER</code>]</a></td> <td>Ative o encaminhamento de proxy do usuário. Nível: De usuário para usuário.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_references">[[<code class="literal">ALTER</code><code class="literal">DROP USER</code>]</a></td> <td>Ative a criação de chaves estrangeiras. Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_reload">[[<code class="literal">ALTER</code><code class="literal">RENAME USER</code>]</a></td> <td>Ative o uso de<a class="link" href="flush.html" title="13.7.6.3 Declaração FLUSH">[[<code class="literal">ALTER</code><code class="literal">REVOKE ALL PRIVILEGES</code>]</a>operações. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_replication-client">[[<code class="literal">ALTER</code><code class="literal">CREATE VIEW</code>]</a></td> <td>Permitir que o usuário pergunte onde estão os servidores de origem ou replicação. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_replication-slave">[[<code class="literal">ALTER</code><code class="literal">DELETE</code>]</a></td> <td>Ative as réplicas para ler eventos de log binário da fonte. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_select">[[<code class="literal">ALTER</code><code class="literal">DELETE</code>]</a></td> <td>Ative o uso de<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code class="literal">ALTER</code><code class="literal">DROP</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_show-databases">[[<code class="literal">ALTER TABLE</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative<a class="link" href="show-databases.html" title="13.7.5.14 Mostrar bancos de dados Statement">[[<code class="literal">ALTER TABLE</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a>para mostrar todos os bancos de dados. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_show-view">[[<code class="literal">ALTER TABLE</code><code class="literal">CREATE USER</code>]</a></td> <td>Ative o uso de<a class="link" href="show-create-view.html" title="13.7.5.13 Declaração [[PH_BACKTICK_5<code class="literal">RENAME USER</code>]">[[<code class="literal">ALTER TABLE</code><code class="literal">DROP USER</code>]</a>Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_shutdown">[[<code class="literal">ALTER TABLE</code><code class="literal">RENAME USER</code>]</a></td> <td>Ative o uso de<a class="link" href="mysqladmin.html" title="4.5.2 mysqladmin — Um programa de administração do servidor MySQL"><span class="command"><strong>mysqladmin shutdown</strong></span></a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_super">[[<code class="literal">ALTER TABLE</code><code class="literal">REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative o uso de outras operações administrativas, como<a class="link" href="change-master-to.html" title="13.4.2.1 ALTERAR MASTER PARA Declaração">[[<code class="literal">ALTER TABLE</code><code class="literal">CREATE VIEW</code>]</a>,<a class="link" href="kill.html" title="13.7.6.4 Declaração de eliminação">[[<code class="literal">ALTER TABLE</code><code class="literal">DELETE</code>]</a>,<a class="link" href="purge-binary-logs.html" title="13.4.1.1 Declaração de PURGE BINARY LOGS">[[<code class="literal">ALTER TABLE</code><code class="literal">DELETE</code>]</a>,<a class="link" href="set-variable.html" title="13.7.4.1 Sintaxe de definição de variáveis para atribuição">[[<code class="literal">ALTER TABLE</code><code class="literal">DROP</code>]</a>, e<a class="link" href="mysqladmin.html" title="4.5.2 mysqladmin — Um programa de administração do servidor MySQL"><span class="command"><strong>mysqladmin debug</strong></span></a>comando. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_trigger">[[<code class="literal">ALTER ROUTINE</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative as operações de gatilho. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_update">[[<code class="literal">ALTER ROUTINE</code><code class="literal">CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de<a class="link" href="update.html" title="13.2.11 Declaração de atualização">[[<code class="literal">ALTER ROUTINE</code><code class="literal">CREATE USER</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_usage">[[<code class="literal">ALTER ROUTINE</code><code class="literal">DROP USER</code>]</a></td> <td>Sinônimo de<span class="quote">“<span class="quote">sem privilégios</span>”</span></td> </tr></tbody></table>
...
Os privilégios que um usuário possui para uma base de dados, tabela, coluna ou rotina são formados aditivamente como a lógica \[`OR`]\(operadores lógicos.html#operador\_ou) dos privilégios da conta em cada um dos níveis de privilégio, incluindo o nível global. Não é possível negar um privilégio concedido em um nível superior pela ausência desse privilégio em um nível inferior. Por exemplo, esta declaração concede os privilégios de consulta `SELECT` e de inserção `INSERT` globalmente:
...
A opção de privilégio (`GRANT OPTION`)(privileges-provided.html#priv\_grant-option) concedida em nível global para qualquer privilégio global aplica-se a todos os privilégios globais.

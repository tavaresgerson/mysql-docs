...
<table><thead><tr> <th>Privilégio</th> <th>Significado e Níveis de Financiamento</th> </tr></thead><tbody><tr> <td><a class="link" href="privileges-provided.html#priv_all">[[PH_HTML_CODE_<code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Concede todos os privilégios no nível de acesso especificado, exceto<a class="link" href="privileges-provided.html#priv_grant-option">[[PH_HTML_CODE_<code>CREATE TEMPORARY TABLE</code>]</a>e<a class="link" href="privileges-provided.html#priv_proxy">[[PH_HTML_CODE_<code>CREATE USER</code>]</a>.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter">[[PH_HTML_CODE_<code>DROP USER</code>]</a></td> <td>Ative o uso de<a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[PH_HTML_CODE_<code>RENAME USER</code>]</a>Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_alter-routine">[[PH_HTML_CODE_<code>REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative a alteração ou a eliminação de rotinas armazenadas. Níveis: Global, banco de dados, rotina.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create">[[PH_HTML_CODE_<code>CREATE VIEW</code>]</a></td> <td>Ative a criação de bancos de dados e tabelas. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-routine">[[PH_HTML_CODE_<code>DELETE</code>]</a></td> <td>Ative a criação de rotinas armazenadas. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-tablespace">[[PH_HTML_CODE_<code>DELETE</code>]</a></td> <td>Ative a criação, alteração ou eliminação de espaços de tabela e grupos de arquivos de log. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-temporary-tables">[[PH_HTML_CODE_<code>DROP</code>]</a></td> <td>Ative o uso de<a class="link" href="create-table.html" title="13.1.18 Declaração CREATE TABLE">[[<code>CREATE TEMPORARY TABLE</code>]]</a>Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-user">[[<code>GRANT OPTION</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de<a class="link" href="create-user.html" title="13.7.1.2 Declaração CREATE USER">[[<code>CREATE USER</code>]]</a>,<a class="link" href="drop-user.html" title="13.7.1.3 Declaração DROP USER">[[<code>DROP USER</code>]]</a>,<a class="link" href="rename-user.html" title="13.7.1.5 Declaração de RENOMEAR USUÁRIO">[[<code>RENAME USER</code>]]</a>, e<a class="link" href="revoke.html" title="13.7.1.6 Declaração de REVOGAÇÃO">[[<code>REVOKE ALL PRIVILEGES</code>]]</a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_create-view">[[<code>CREATE VIEW</code>]]</a></td> <td>Ative a criação ou alteração de visualizações. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_delete">[[<code>DELETE</code>]]</a></td> <td>Ative o uso de<a class="link" href="delete.html" title="13.2.2 Declaração DELETE">[[<code>DELETE</code>]]</a>Nível: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_drop">[[<code>DROP</code>]]</a></td> <td>Ative a possibilidade de excluir bancos de dados, tabelas e visualizações. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_event">[[<code>PROXY</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de eventos para o Agendamento de Eventos. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_execute">[[<code>PROXY</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Permitir que o usuário execute rotinas armazenadas. Níveis: Global, banco de dados, rotina.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_file">[[<code>PROXY</code><code>CREATE USER</code>]</a></td> <td>Permitir que o usuário faça com que o servidor leia ou escreva arquivos. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_grant-option">[[<code>PROXY</code><code>DROP USER</code>]</a></td> <td>Ative ou desative privilégios para serem concedidos ou removidos de outras contas. Níveis: Global, banco de dados, tabela, rotina, proxy.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_index">[[<code>PROXY</code><code>RENAME USER</code>]</a></td> <td>Ative a criação ou remoção de índices. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_insert">[[<code>PROXY</code><code>REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative o uso de<a class="link" href="insert.html" title="13.2.5 Instrução INSERT">[[<code>PROXY</code><code>CREATE VIEW</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_lock-tables">[[<code>PROXY</code><code>DELETE</code>]</a></td> <td>Ative o uso de<a class="link" href="lock-tables.html" title="13.3.5 Declarações LOCK TABLES e UNLOCK TABLES">[[<code>PROXY</code><code>DELETE</code>]</a>nas mesas para as quais você tem<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code>PROXY</code><code>DROP</code>]</a>privilégio. Níveis: Global, banco de dados.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_process">[[<code>ALTER</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Permitir que o usuário veja todos os processos com<a class="link" href="show-processlist.html" title="13.7.5.29 Declaração PROCESSLIST">[[<code>ALTER</code><code>CREATE TEMPORARY TABLE</code>]</a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_proxy">[[<code>ALTER</code><code>CREATE USER</code>]</a></td> <td>Ative o encaminhamento de proxy do usuário. Nível: De usuário para usuário.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_references">[[<code>ALTER</code><code>DROP USER</code>]</a></td> <td>Ative a criação de chaves estrangeiras. Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_reload">[[<code>ALTER</code><code>RENAME USER</code>]</a></td> <td>Ative o uso de<a class="link" href="flush.html" title="13.7.6.3 Declaração FLUSH">[[<code>ALTER</code><code>REVOKE ALL PRIVILEGES</code>]</a>operações. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_replication-client">[[<code>ALTER</code><code>CREATE VIEW</code>]</a></td> <td>Permitir que o usuário pergunte onde estão os servidores de origem ou replicação. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_replication-slave">[[<code>ALTER</code><code>DELETE</code>]</a></td> <td>Ative as réplicas para ler eventos de log binário da fonte. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_select">[[<code>ALTER</code><code>DELETE</code>]</a></td> <td>Ative o uso de<a class="link" href="select.html" title="13.2.9 Instrução SELECT">[[<code>ALTER</code><code>DROP</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_show-databases">[[<code>ALTER TABLE</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative<a class="link" href="show-databases.html" title="13.7.5.14 Mostrar bancos de dados Statement">[[<code>ALTER TABLE</code><code>CREATE TEMPORARY TABLE</code>]</a>para mostrar todos os bancos de dados. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_show-view">[[<code>ALTER TABLE</code><code>CREATE USER</code>]</a></td> <td>Ative o uso de<a class="link" href="show-create-view.html" title="13.7.5.13 Declaração [[PH_BACKTICK_5<code>RENAME USER</code>]">[[<code>ALTER TABLE</code><code>DROP USER</code>]</a>Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_shutdown">[[<code>ALTER TABLE</code><code>RENAME USER</code>]</a></td> <td>Ative o uso de<a class="link" href="mysqladmin.html" title="4.5.2 mysqladmin — Um programa de administração do servidor MySQL"><span class="command"><strong>mysqladmin shutdown</strong></span></a>Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_super">[[<code>ALTER TABLE</code><code>REVOKE ALL PRIVILEGES</code>]</a></td> <td>Ative o uso de outras operações administrativas, como<a class="link" href="change-master-to.html" title="13.4.2.1 ALTERAR MASTER PARA Declaração">[[<code>ALTER TABLE</code><code>CREATE VIEW</code>]</a>,<a class="link" href="kill.html" title="13.7.6.4 Declaração de eliminação">[[<code>ALTER TABLE</code><code>DELETE</code>]</a>,<a class="link" href="purge-binary-logs.html" title="13.4.1.1 Declaração de PURGE BINARY LOGS">[[<code>ALTER TABLE</code><code>DELETE</code>]</a>,<a class="link" href="set-variable.html" title="13.7.4.1 Sintaxe de definição de variáveis para atribuição">[[<code>ALTER TABLE</code><code>DROP</code>]</a>, e<a class="link" href="mysqladmin.html" title="4.5.2 mysqladmin — Um programa de administração do servidor MySQL"><span class="command"><strong>mysqladmin debug</strong></span></a>comando. Nível: Global.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_trigger">[[<code>ALTER ROUTINE</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative as operações de gatilho. Níveis: Global, banco de dados, tabela.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_update">[[<code>ALTER ROUTINE</code><code>CREATE TEMPORARY TABLE</code>]</a></td> <td>Ative o uso de<a class="link" href="update.html" title="13.2.11 Declaração de atualização">[[<code>ALTER ROUTINE</code><code>CREATE USER</code>]</a>Níveis: Global, banco de dados, tabela, coluna.</td> </tr><tr> <td><a class="link" href="privileges-provided.html#priv_usage">[[<code>ALTER ROUTINE</code><code>DROP USER</code>]</a></td> <td>Sinônimo de<span class="quote">“<span class="quote">sem privilégios</span>”</span></td> </tr></tbody></table>

...
Quando você usa `SET GLOBAL sql_slave_skip_counter` para ignorar events e o resultado está no meio de um grupo, o slave continua a ignorar events até atingir o final do grupo. A execução então começa com o próximo event group.
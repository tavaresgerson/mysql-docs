...
Exemplo de mensagem de erro do lado do servidor enviada a programas cliente, conforme exibida pelo cliente **mysql**:
...
Exemplo de mensagem de erro do lado do cliente originada na client library, conforme exibida pelo cliente **mysql**:

...
17.5.1.3 Localizando o Primary
...
Essas verificações podem ser desativadas configurando a opção `group_replication_enforce_update_everywhere_checks` para `FALSE`. Ao implantar no modo single-primary, esta opção *deve* ser configurada como `FALSE`.
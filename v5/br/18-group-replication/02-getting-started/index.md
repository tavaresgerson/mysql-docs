...
Uma maneira alternativa de implantar múltiplas instâncias do MySQL é usando o InnoDB Cluster, que utiliza o Group Replication e o envolve em um ambiente programático que permite trabalhar facilmente com grupos de instâncias do servidor MySQL no MySQL Shell 8.0. Além disso, o InnoDB Cluster se integra perfeitamente ao MySQL Router e simplifica a implantação do MySQL com alta disponibilidade. Consulte MySQL AdminAPI.

export default [
	...
	{
		text: 'Capítulo 20 InnoDB Cluster',
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: '8.2.1.11 Blocos de Loop Aninhado e Junções de Acesso a Chaves em Lote',
							...
							{
								text: '8.2.1.15 Otimização de GROUP BY',
							...
							{
								text: '8.2.1.16 Otimização de DISTINCT',
							...
							{
								text: '8.2.1.18 Otimização das Chamadas de Função',
							...
							{
								text: '8.2.1.19 Otimização de Expressões do Construtor de Linhas',
	...
	{
		text: 'Capítulo 9 Estrutura da Linguagem',
		collapsed: true,
		items: [
			{
	...
	},
	{
		...
		items: [
			...
			{
				text: '10.3 Especificando Character Sets e Collations',
				collapsed: true,
				items: [
					{
						text: '10.3.1 Convenções de Nomenclatura de Collation',
						link: '/11-character-sets-collations-unicode/03-specifying-character-sets-and-collations/01-collation-naming-conventions.md',
					},
					{
						text: '10.3.2 Conjunto de Caracteres e Collation do Server',
					...
					{
						text: '10.3.3 Character Set e Collation do Database',
					...
					{
						text: '10.3.4 Character Set e Collation de Tabela',
					...
					{
						text: '10.3.5 Character Set e Collation de Coluna',
					...
					{
						text: '10.3.6 Character Set e Collation de Literals de String de Caracteres',
					...
					{
						text: '10.3.10 Compatibilidade com Outros DBMSs',
			...
			},
			{
				...
				items: [
					{
						text: '10.9.1 O Conjunto de Caracteres utf8mb4 (Codificação Unicode UTF-8 de 4 Bytes)',
					...
					{
						text: '10.9.2 O Character Set utf8mb3 (Codificação Unicode UTF-8 de 3 Bytes)',
					...
					{
						text: '10.9.3 O Character Set utf8 (Alias para utf8mb3)',
					...
					{
						text: '10.9.6 O Character Set utf16le (Codificação Unicode UTF-16LE)',
					...
					{
						text: '10.9.8 Convertendo Entre Character Sets Unicode de 3 Bytes e 4 Bytes',
			...
			{
				text: '10.10 Character Sets e Collations Suportados',
				collapsed: true,
				items: [
					{
					...
					{
						text: '10.10.4 Conjuntos de Caracteres do Sul da Europa e Oriente Médio',
					...
					{
						text: '10.10.8 O Conjunto de Caracteres `binary`',
					...
					},
					{
						...
						items: [
							{
								text: '10.10.7.1 O Character Set cp932',
							...
							{
								text: '10.10.7.2 O Conjunto de Caracteres gb18030',
			...
			{
				text: '10.13 Adicionando um Character Set',
				collapsed: true,
				items: [
					{
						text: '10.13.1 Arrays de Definição de Caracteres',
						link: '/11-character-sets-collations-unicode/13-adding-a-character-set/01-character-definition-arrays.md',
					},
					{
						text: '10.13.2 Suporte a String Collating para Character Sets Complexos',
					...
					{
						text: '10.13.3 Suporte a Caracteres Multi-Byte para Conjuntos de Caracteres Complexos',
			...
			},
			{
				...
				items: [
					...
					{
						text: '10.14.4 Adicionando uma Collation UCA a um Unicode Character Set',
						collapsed: true,
						items: [
							{
								text: '10.14.4.1 Definindo uma Collation UCA Usando a Sintaxe LDML',
							...
							{
								text: '10.14.4.3 Diagnóstico Durante a Análise de Index.xml',
	...
	},
	{
		...
		items: [
			{
				text: '11.5 O Tipo de Dados JSON',
				link: '/12-data-types/05-the-j-s-o-n-data-type.md',
			},
			{
				text: '11.6 Valores Padrão de Tipos de Dados',
			...
			},
			{
				...
				items: [
					{
						text: '11.1.1 Sintaxe de Tipos de Dados Numéricos',
					...
					{
						text: '11.1.6 Atributos de Tipos Numéricos',
						link: '/12-data-types/01-numeric-data-types/06-numeric-type-attributes.md',
					},
					{
						text: '11.1.7 Tratamento de Valores Fora do Intervalo (Out-of-Range) e Overflow',
			...
			},
			{
				...
				items: [
					{
						text: '11.2.1 Sintaxe dos Tipos de Dados de Data e Hora',
						link: '/12-data-types/02-date-and-time-data-types/01-date-and-time-data-type-syntax.md',
					},
					{
						text: '11.2.2 Os Tipos DATE, DATETIME e TIMESTAMP',
					...
					{
						text: '11.2.4 O Tipo YEAR',
						link: '/12-data-types/02-date-and-time-data-types/04-the-y-e-a-r-type.md',
					},
					{
						text: '11.2.5 Limitações de YEAR(2) de 2 Dígitos e Migração para YEAR de 4 Dígitos',
						link: '/12-data-types/02-date-and-time-data-types/05-2-digit-year-2-limitations-and-migrating-to-4-digit-year.md',
					},
					{
						text: '11.2.6 Inicialização e Atualização Automática para TIMESTAMP e DATETIME',
					...
					{
						text: '11.2.10 Anos de 2 Dígitos em Datas',
			...
			{
				text: '11.3 Tipos de Dados String',
				collapsed: true,
				items: [
					{
						text: '11.3.1 Sintaxe dos Tipos de Dados String',
						link: '/12-data-types/03-string-data-types/01-string-data-type-syntax.md',
					},
					{
						text: '11.3.2 Os Tipos CHAR e VARCHAR',
					...
					{
						text: '11.3.4 Os Tipos BLOB e TEXT',
			...
			{
				text: '11.4 Tipos de Dados Spatial',
				collapsed: true,
				items: [
					{
	...
	},
	{
		...
		items: [
			{
				text: '12.1 Referência de Funções e Operadores Integrados',
				link: '/13-functions-and-operators/01-built-in-function-and-operator-reference.md',
			},
			{
				text: '12.2 Referência de Funções Carregáveis',
				link: '/13-functions-and-operators/02-loadable-function-reference.md',
			},
			{
				text: '12.3 Conversão de Tipos na Avaliação de Expressões',
			...
			{
				text: '12.12 Funções e Operadores de Bit',
			...
			{
				text: '12.18 Funções Usadas com Identificadores Globais de Transação (GTIDs)',
			...
			},
			{
				...
				items: [
					{
						text: '12.4.1 Precedência de Operadores',
			...
			{
				text: '12.8 Funções e Operadores de String',
				collapsed: true,
				items: [
					{
						text: '12.8.1 Funções e Operadores de Comparação de String',
					...
					{
						text: '12.8.3 Character Set e Collation de Resultados de Função',
			...
			},
			{
				...
				items: [
					...
					{
						text: '12.16.4 Funções Que Criam Valores Geometry a partir de Valores WKB',
					...
					{
						text: '12.16.6 Funções de Conversão de Formato Geometry',
					...
					},
					{
						...
						items: [
							{
								text: '12.16.7.1 Funções de Propriedades Gerais de Geometry',
							...
							{
								text: '12.16.7.2 Funções de Propriedade de Point',
							...
							{
								text: '12.16.7.4 Funções de Propriedade de Polygon e MultiPolygon',
					...
					{
						text: '12.16.9 Funções Que Testam Relações Espaciais Entre Objetos Geometry',
						collapsed: true,
						items: [
							{
								text: '12.16.9.1 Funções de Relação Espacial que Usam Formas de Objeto',
							...
							{
								text: '12.16.9.2 Funções de Relação Espacial Que Usam Retângulos Delimitadores Mínimos',
			...
			},
			{
				...
				items: [
					{
						text: '12.17.1 Referência de Funções JSON',
					...
					{
						text: '12.17.3 Funções que Pesquisam Valores JSON',
	...
	{
		text: 'Capítulo 13 Instruções SQL',
		collapsed: true,
		items: [
			{
				text: '13.1 Instruções de Definição de Dados',
				collapsed: true,
				items: [
					{
						text: '13.1.1 Comando ALTER DATABASE',
						link: '/14-sql-statements/01-data-definition-statements/01-a-l-t-e-r-d-a-t-a-b-a-s-e-statement.md',
					},
					{
						text: '13.1.2 Declaração ALTER EVENT',
					...
					{
						text: '13.1.8 Instrução ALTER TABLE',
						collapsed: true,
						items: [
							{
								text: '13.1.8.1 Operações de Particionamento ALTER TABLE',
					...
					{
						text: '13.1.18 Instrução CREATE TABLE',
						collapsed: true,
						items: [
							{
							...
							{
								text: '13.1.18.2 Instrução CREATE TEMPORARY TABLE',
							...
							{
								text: '13.1.18.3 Instrução CREATE TABLE ... LIKE',
							...
							{
								text: '13.1.18.4 Instrução CREATE TABLE ... SELECT',
							...
							{
								text: '13.1.18.5 FOREIGN KEY Constraints',
							...
							{
								text: '13.1.18.6 Alterações Silenciosas na Especificação de Colunas',
							...
							{
								text: '13.1.18.7 CREATE TABLE e Colunas Geradas',
							...
							{
								text: '13.1.18.8 Secondary Indexes e Colunas Geradas',
							...
							{
								text: '13.1.18.9 Configurando Opções de Comentário NDB',
			...
			{
				text: '13.2 Instruções de Manipulação de Dados (Data Manipulation Statements)',
				collapsed: true,
				items: [
					{
						text: '13.2.1 Statement CALL',
					...
					},
					{
						...
						items: [
							...
							{
								text: '13.2.5.3 Instrução INSERT DELAYED',
			...
			{
				text: '13.3 Instruções Transacionais e de Bloqueio',
				collapsed: true,
				items: [
					{
					...
					{
						text: '13.3.5 Instruções LOCK TABLES e UNLOCK TABLES',
					...
					{
						text: '13.3.6 Instrução SET TRANSACTION',
			...
			{
				text: '13.4 Instruções de Replication',
				collapsed: true,
				items: [
					{
						text: '13.4.1 Instruções SQL para Controlar Servidores Source de Replicação',
						collapsed: true,
						items: [
							{
								text: '13.4.1.1 Instrução PURGE BINARY LOGS',
							...
							{
								text: '13.4.1.2 Instrução RESET MASTER',
							...
							{
								text: '13.4.1.3 Declaração SET sql_log_bin',
					...
					{
						text: '13.4.2 SQL Statements para Controle de Servidores Replica',
						collapsed: true,
						items: [
							{
								text: '13.4.2.1 Declaração CHANGE MASTER TO',
							...
							{
								text: '13.4.2.2 Instrução CHANGE REPLICATION FILTER',
							...
							{
								text: '13.4.2.3 Declaração RESET SLAVE',
							...
							{
								text: '13.4.2.4 Sintaxe de SET GLOBAL sql_slave_skip_counter',
							...
							{
								text: '13.4.2.5 Instrução START SLAVE',
							...
							{
								text: '13.4.2.6 Declaração STOP SLAVE',
					...
					{
						text: '13.4.3 SQL Statements para Controle de Group Replication',
						collapsed: true,
						items: [
							{
								text: '13.4.3.1 Instrução START GROUP_REPLICATION',
							...
							{
								text: '13.4.3.2 Instrução STOP GROUP_REPLICATION',
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								text: '13.6.4.1 Instrução DECLARE de Variável Local',
							...
							{
								text: '13.6.4.2 Escopo e Resolução de Variáveis Locais',
					...
					},
					{
						...
						items: [
							...
							{
								text: '13.6.7.9 Restrições no Tratamento de Condições',
			...
			{
				text: '13.7 Declarações de Administração de Database',
				collapsed: true,
				items: [
					{
						text: '13.7.1 Declarações de Gerenciamento de Contas',
						collapsed: true,
						items: [
							{
								text: '13.7.1.1 Instrução ALTER USER',
							...
							{
								text: '13.7.1.2 Instrução CREATE USER',
							...
							{
								text: '13.7.1.6 Declaração REVOKE',
							...
							{
								text: '13.7.1.7 Instrução SET PASSWORD',
					...
					{
						text: '13.7.2 Instruções de Manutenção de Tabela',
						collapsed: true,
						items: [
							{
								text: '13.7.2.1 Instrução ANALYZE TABLE',
							...
							{
								text: '13.7.2.2 Instrução CHECK TABLE',
							...
							{
								text: '13.7.2.3 Instrução CHECKSUM TABLE',
							...
							{
								text: '13.7.2.4 Instrução OPTIMIZE TABLE',
							...
							{
								text: '13.7.2.5 Instrução REPAIR TABLE',
					...
					{
						text: '13.7.3 Comandos para Plugin e Função Carregável',
						collapsed: true,
						items: [
							{
								text: '13.7.3.1 Instrução CREATE FUNCTION para Funções Carregáveis',
							...
							{
								text: '13.7.3.2 Declaração DROP FUNCTION para Funções Carregáveis (Loadable Functions)',
							...
							{
								text: '13.7.3.3 Instrução INSTALL PLUGIN',
							...
							{
								text: '13.7.3.4 Instrução UNINSTALL PLUGIN',
					...
					{
						text: '13.7.4 Instruções SET',
						collapsed: true,
						items: [
							{
								text: '13.7.4.1 Sintaxe SET para Atribuição de Variáveis',
							...
							{
								text: '13.7.4.2 Instrução SET CHARACTER SET',
							...
							{
								text: '13.7.4.3 SET NAMES Statement',
					...
					{
						text: '13.7.5 Instruções SHOW',
						collapsed: true,
						items: [
							{
								text: '13.7.5.1 Instrução SHOW BINARY LOGS',
							...
							{
								text: '13.7.5.2 Instrução SHOW BINLOG EVENTS',
							...
							{
								text: '13.7.5.3 Instrução SHOW CHARACTER SET',
							...
							{
								text: '13.7.5.4 Instrução SHOW COLLATION',
							...
							{
								text: '13.7.5.7 Instrução SHOW CREATE EVENT',
							...
							{
								text: '13.7.5.8 Instrução SHOW CREATE FUNCTION',
							...
							{
								text: '13.7.5.9 Instrução SHOW CREATE PROCEDURE',
							...
							{
								text: '13.7.5.10 Instrução SHOW CREATE TABLE',
							...
							{
								text: '13.7.5.11 Instrução SHOW CREATE TRIGGER',
							...
							{
								text: '13.7.5.12 SHOW CREATE USER Statement',
							...
							{
								text: '13.7.5.14 Instrução SHOW DATABASES',
							...
							{
								text: '13.7.5.20 Instrução SHOW FUNCTION STATUS',
							...
							{
								text: '13.7.5.24 Instrução SHOW OPEN TABLES',
							...
							{
								text: '13.7.5.27 Instrução SHOW PROCEDURE CODE',
							...
							{
								text: '13.7.5.28 Instrução SHOW PROCEDURE STATUS',
							...
							{
								text: '13.7.5.29 Instrução SHOW PROCESSLIST',
							...
							{
								text: '13.7.5.32 Instrução SHOW RELAYLOG EVENTS',
							...
							{
								text: '13.7.5.33 Instrução SHOW SLAVE HOSTS',
							...
							{
								text: '13.7.5.34 Instrução SHOW SLAVE STATUS',
							...
							{
								text: '13.7.5.39 Instrução SHOW VARIABLES',
							...
							{
								text: '13.7.5.40 Instrução SHOW WARNINGS',
					...
					{
						text: '13.7.6 Outras Instruções Administrativas',
						collapsed: true,
						items: [
							{
								text: '13.7.6.1 Instrução BINLOG',
							...
							{
								text: '13.7.6.2 Instrução CACHE INDEX',
							...
							{
								text: '13.7.6.7 Instrução SHUTDOWN',
			...
			{
				text: '13.8 Instruções de Utilitário',
				collapsed: true,
				items: [
					{
						text: '13.8.1 Instrução DESCRIBE',
	...
	{
		text: 'Capítulo 14 O Mecanismo de Armazenamento InnoDB',
		collapsed: true,
		items: [
			{
			...
			{
				text: '14.3 Multi-Versioning do InnoDB',
			...
			{
				text: '14.11 Formatos de Linha do InnoDB',
				link: '/15-the-innodb-storage-engine/11-inno-d-b-row-formats.md',
			},
			{
				text: '14.14 Criptografia de Dados em Repouso do InnoDB (`Data-at-Rest Encryption`)',
				link: '/15-the-innodb-storage-engine/14-inno-d-b-data-at-rest-encryption.md',
			},
			{
				text: '14.15 Opções de Inicialização e Variáveis de Sistema do InnoDB',
				link: '/15-the-innodb-storage-engine/15-inno-d-b-startup-options-and-system-variables.md',
			},
			{
				text: '14.20 InnoDB e Replicação MySQL',
			...
			},
			{
				...
				items: [
					{
						text: '14.1.1 Benefícios do Uso de Tabelas InnoDB',
					...
					{
						text: '14.1.3 Verificando se InnoDB é o Storage Engine Padrão',
					...
					{
						text: '14.1.5 Desativando o InnoDB',
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: '14.6.1.6 Manuseio do AUTO_INCREMENT no InnoDB',
			...
			{
				text: '14.7 InnoDB Locking e Modelo de Transaction',
				collapsed: true,
				items: [
					{
					...
					{
						text: '14.7.3 Locks Definidos por Diferentes Instruções SQL no InnoDB',
					...
					{
						text: '14.7.4 Linhas Fantasma',
						link: '/15-the-innodb-storage-engine/07-inno-d-b-locking-and-transaction-model/04-phantom-rows.md',
					},
					{
						text: '14.7.2 Modelo de Transação do InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.7.2.1 Níveis de Isolation de Transaction',
							...
							{
								text: '14.7.2.3 Leituras Consistentes Sem Lock (Nonlocking Reads)',
					...
					{
						text: '14.7.5 Deadlocks no InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.7.5.1 Um Exemplo de Deadlock do InnoDB',
							...
							{
								text: '14.7.5.2 Detecção de Deadlock',
							...
							{
								text: '14.7.5.3 Como Minimizar e Lidar com Deadlocks',
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: '14.8.3.2 Configurando Múltiplas Instâncias do Buffer Pool',
							...
							{
								text: '14.8.3.3 Tornando o Buffer Pool Resistente a Scans',
							...
							{
								text: '14.8.3.4 Configurando o Prefetching do Buffer Pool do InnoDB (Read-Ahead)',
							...
							{
								text: '14.8.3.5 Configurando o Buffer Pool Flushing',
							...
							{
								text: '14.8.3.6 Salvando e Restaurando o Estado do Buffer Pool',
					...
					{
						text: '14.8.11 Configurando as Estatísticas do Otimizador para InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.8.11.1 Configurando Parâmetros de Estatísticas Persistentes do Optimizer',
							...
							{
								text: '14.8.11.2 Configurando Parâmetros de Estatísticas do Optimizer Não Persistentes',
							...
							{
								text: '14.8.11.3 Estimando a Complexidade de ANALYZE TABLE para Tabelas InnoDB',
			...
			{
				text: '14.9 InnoDB Table e Page Compression',
				collapsed: true,
				items: [
					{
						text: '14.9.2 Compressão de Página do InnoDB',
						link: '/15-the-innodb-storage-engine/09-inno-d-b-table-and-page-compression/02-inno-d-b-page-compression.md',
					},
					{
						text: '14.9.1 Compressão de Tabela InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.9.1.1 Visão Geral da Compressão de Tabela',
							...
							{
								text: '14.9.1.2 Criação de Tabelas Comprimidas',
							...
							{
								text: '14.9.1.3 Ajustando a Compressão para Tabelas InnoDB',
							...
							{
								text: '14.9.1.4 Monitoramento da Compressão de Tabelas InnoDB em Tempo de Execução',
							...
							{
								text: '14.9.1.6 Compressão para Workloads OLTP',
							...
							{
								text: '14.9.1.7 Advertências e Erros de Sintaxe de Compressão SQL',
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: '14.10.2.2 Check de Compatibilidade Quando uma Tabela é Aberta',
			...
			},
			{
				...
				items: [
					...
					{
						text: '14.13.4 Simplificando Instruções DDL com DDL Online',
			...
			{
				text: '14.16 Tabelas INFORMATION\_SCHEMA do InnoDB',
				collapsed: true,
				items: [
					{
						text: '14.16.3 Tabelas de Sistema INFORMATION_SCHEMA do InnoDB',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/03-inno-d-b-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-system-tables.md',
					},
					{
						text: '14.16.4 Tabelas de FULLTEXT Index do InnoDB no INFORMATION_SCHEMA',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/04-inno-d-b-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-f-u-l-l-t-e-x-t-index-tables.md',
					},
					{
						text: '14.16.5 Tabelas INFORMATION_SCHEMA do Buffer Pool do InnoDB',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/05-inno-d-b-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-buffer-pool-tables.md',
					},
					{
						text: '14.16.6 Tabela de Métricas INFORMATION_SCHEMA do InnoDB',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/06-inno-d-b-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-metrics-table.md',
					},
					{
						text: '14.16.7 Tabela de Informações de Tabelas Temporárias InnoDB no INFORMATION_SCHEMA',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/07-inno-d-b-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-temporary-table-info-table.md',
					},
					{
						text: '14.16.8 Recuperando Metadados de Tablespace InnoDB de INFORMATION_SCHEMA.FILES',
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/08-retrieving-inno-d-b-tablespace-metadata-from-i-n-f-o-r-m-a-t-i-o-n-schema-files.md',
					},
					{
						text: '14.16.1 Tabelas INFORMATION_SCHEMA do InnoDB sobre Compressão',
						collapsed: true,
						items: [
							{
								text: '14.16.1.1 INNODB_CMP e INNODB_CMP_RESET',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/01-innodb-information-schema-tables-about-compression/01-i-n-n-o-d-b-c-m-p-and-i-n-n-o-d-b-c-m-p-reset.md',
							},
							{
								text: '14.16.1.2 INNODB_CMPMEM e INNODB_CMPMEM_RESET',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/01-innodb-information-schema-tables-about-compression/02-i-n-n-o-d-b-c-m-p-m-e-m-and-i-n-n-o-d-b-c-m-p-m-e-m-reset.md',
							},
							{
								text: '14.16.1.3 Usando as Tabelas do Schema de Informações de Compressão',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/01-innodb-information-schema-tables-about-compression/03-using-the-compression-information-schema-tables.md',
							},
						],
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/01-innodb-information-schema-tables-about-compression/index.md',
					},
					{
						text: '14.16.2 Informações de Transação e Locking do INFORMATION_SCHEMA do InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.16.2.1 Usando Informações de Transação e Locking do InnoDB',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/02-innodb-information-schema-transaction-and-locking-information/01-using-inno-d-b-transaction-and-locking-information.md',
							},
							{
								text: '14.16.2.2 Informações sobre Lock e Lock-Wait do InnoDB',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/02-innodb-information-schema-transaction-and-locking-information/02-inno-d-b-lock-and-lock-wait-information.md',
							},
							{
								text: '14.16.2.3 Persistência e Consistência das Informações de Transação e Locking do InnoDB',
								link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/02-innodb-information-schema-transaction-and-locking-information/03-persistence-and-consistency-of-inno-d-b-transaction-and-locking-information.md',
							},
						],
						link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/02-innodb-information-schema-transaction-and-locking-information/index.md',
					},
				],
				link: '/15-the-innodb-storage-engine/16-innodb-information-schema-tables/index.md',
			},
			{
				text: '14.17 Integração do InnoDB com o Performance Schema do MySQL',
				collapsed: true,
				items: [
					{
						text: '14.17.1 Monitoramento do Progresso de ALTER TABLE para Tabelas InnoDB Usando o Performance Schema',
					...
					{
						text: '14.17.2 Monitorando Esperas de Mutex InnoDB Usando o Performance Schema',
			...
			{
				text: '14.18 Monitores do InnoDB',
				collapsed: true,
				items: [
					{
					...
					{
						text: '14.18.2 Habilitando os Monitores InnoDB',
						link: '/15-the-innodb-storage-engine/18-inno-d-b-monitors/02-enabling-inno-d-b-monitors.md',
					},
					{
						text: '14.18.3 Saída do Monitor Padrão do InnoDB e do Monitor de Lock',
			...
			{
				text: '14.19 InnoDB Backup e Recovery',
				collapsed: true,
				items: [
					{
						text: '14.19.1 InnoDB Backup',
			...
			{
				text: '14.21 Plugin memcached do InnoDB',
				collapsed: true,
				items: [
					{
						text: '14.21.1 Benefícios do Plugin InnoDB memcached',
						link: '/15-the-innodb-storage-engine/21-inno-d-b-memcached-plugin/01-benefits-of-the-inno-d-b-memcached-plugin.md',
					},
					{
						text: '14.21.2 Arquitetura memcached do InnoDB',
					...
					{
						text: '14.21.4 Considerações de Segurança para o Plugin `memcached` do InnoDB',
					...
					{
						text: '14.21.6 O Plugin memcached do InnoDB e a Replication',
						link: '/15-the-innodb-storage-engine/21-inno-d-b-memcached-plugin/06-the-inno-d-b-memcached-plugin-and-replication.md',
					},
					{
						text: '14.21.7 Detalhes Internos do Plugin memcached do InnoDB',
					...
					{
						text: '14.21.5 Escrevendo Aplicações para o Plugin memcached do InnoDB',
						collapsed: true,
						items: [
							{
								text: '14.21.5.1 Adaptando um Schema MySQL Existente para o Plugin memcached do InnoDB',
							...
							{
								text: '14.21.5.3 Otimizando o Desempenho do Plugin InnoDB memcached',
							...
							{
								text: '14.21.5.4 Controlando o Comportamento Transacional do Plugin memcached do InnoDB',
							...
							{
								text: '14.21.5.5 Adaptando Instruções DML para Operações memcached',
							...
							{
								text: '14.21.5.6 Executando DML e DDL Statements na InnoDB Table Subjacente',
	...
	},
	{
		...
		items: [
				...
				items: [
					...
					},
					{
						...
						items: [
							...
							{
								text: '15.2.3.2 Características de Tabelas Dinâmicas',
							...
							{
								text: '15.2.3.3 Características de Tabelas Comprimidas',
					...
					{
						text: '15.2.4 Problemas em Tabelas MyISAM',
						collapsed: true,
						items: [
							{
								text: '15.2.4.1 Tabelas MyISAM Corrompidas',
							...
							{
								text: '15.2.4.2 Problemas Causados por Tabelas Não Fechadas Corretamente',
			...
			{
				text: '15.4 A Storage Engine CSV',
				collapsed: true,
				items: [
					{
			...
			{
				text: '15.7 O Storage Engine MERGE',
				collapsed: true,
				items: [
					{
					...
					{
						text: '15.7.2 Problemas com Tabelas MERGE',
			...
			{
				text: '15.8 O Storage Engine FEDERATED',
				collapsed: true,
				items: [
					{
						text: '15.8.1 Visão Geral do Storage Engine FEDERATED',
					...
					{
						text: '15.8.3 Notas e Dicas sobre o Storage Engine FEDERATED',
					...
					{
						text: '15.8.4 Recursos do Storage Engine FEDERATED',
					...
					},
					{
						...
						items: [
							{
								text: '15.8.2.1 Criando uma Tabela FEDERATED Usando CONNECTION',
			...
			{
				text: '15.11 Visão Geral da Arquitetura do Storage Engine do MySQL',
				collapsed: true,
				items: [
					{
						text: '15.11.1 Arquitetura Pluggable de Storage Engine',
					...
					{
						text: '15.11.2 A Camada Comum do Servidor de Database',
	...
	},
	{
		...
		items: [
			{
				text: '16.1 Configurando Replication',
				collapsed: true,
				items: [
					{
						text: '16.1.1 Visão Geral da Configuração da Replicação Baseada na Posição do Arquivo Binary Log',
						link: '/17-replication/01-configuring-replication/01-binary-log-file-position-based-replication-configuration-overview.md',
					},
					{
						text: '16.1.2 Configurando a Replication Baseada na Posição do Arquivo de Binary Log',
						collapsed: true,
						items: [
							{
								text: '16.1.2.1 Configurando o Source de Replication',
							...
							{
								text: '16.1.2.2 Criação de um Usuário para Replicação',
							...
							{
								text: '16.1.2.3 Obtendo as Coordenadas do Binary Log da Origem da Replication',
							...
							{
								text: '16.1.2.4 Escolhendo um Método para Data Snapshots',
							...
							{
								text: '16.1.2.6 Adicionando Replicas a uma Topologia de Replication',
					...
					{
						text: '16.1.3 Replicação com Global Transaction Identifiers (GTIDs)',
						collapsed: true,
						items: [
							{
								text: '16.1.3.1 Formato e Armazenamento de GTID',
							...
							{
								text: '16.1.3.3 Posicionamento Automático (Auto-Positioning) de GTID',
							...
							{
								text: '16.1.3.4 Configurando a Replication Usando GTIDs',
							...
							{
								text: '16.1.3.5 Usando GTIDs para Failover e Scaleout',
							...
							{
								text: '16.1.3.6 Restrições na Replication com GTIDs',
							...
							{
								text: '16.1.3.7 Exemplos de Stored Functions para Manipular GTIDs',
					...
					{
						text: '16.1.4 Alterando Modos de Replication em Servers Online',
						collapsed: true,
						items: [
							{
								text: '16.1.4.1 Conceitos de Modo de Replicação',
							...
							{
								text: '16.1.4.2 Habilitando GTID Transactions Online',
							...
							{
								text: '16.1.4.3 Desabilitando Transações GTID Online',
							...
							{
								text: '16.1.4.4 Verificando a Replicação de Anonymous Transactions',
					...
					{
						text: '16.1.5 Replicação Multi-Source MySQL',
						collapsed: true,
						items: [
							{
								text: '16.1.5.1 Configurando Replicação Multi-Source',
							...
							{
								text: '16.1.5.2 Provisionamento de uma Replica Multi-Source para Replication Baseada em GTID',
							...
							{
								text: '16.1.5.3 Adicionando Sources Baseados em GTID a uma Multi-Source Replica',
							...
							{
								text: '16.1.5.4 Adicionando uma Fonte Baseada em Binary Log a uma Replica Multi-Source',
							...
							{
								text: '16.1.5.8 Monitoramento de Replicação Multi-Source',
					...
					{
						text: '16.1.6 Opções e Variáveis de Replication e Binary Logging',
						collapsed: true,
						items: [
							{
								text: '16.1.6.1 Referência de Opções e Variáveis de Replication e Binary Logging',
							...
							{
								text: '16.1.6.2 Opções e Variáveis do Source de Replication',
							...
							{
								text: '16.1.6.3 Opções e Variáveis do Servidor Replica',
							...
							{
								text: '16.1.6.4 Opções e Variáveis de Binary Logging',
							...
							{
								text: '16.1.6.5 Variáveis de Sistema de ID de Transação Global',
					...
					},
					{
						...
						items: [
							{
								text: '16.1.7.1 Verificando o Status da Replicação',
							...
							{
								text: '16.1.7.2 Pausando a Replication na Replica',
							...
							{
								text: '16.1.7.3 Ignorando Transações',
			...
			},
			{
				...
				items: [
					{
						text: '16.2.1 Formatos de Replication',
						collapsed: true,
						items: [
							{
								text: '16.2.1.1 Vantagens e Desvantagens da Replication Baseada em Statement e Baseada em Row',
							...
							{
								text: '16.2.1.2 Uso de Row-Based Logging e Replication',
							...
							{
								text: '16.2.1.3 Determinação de Statements Seguros e Não Seguros no Binary Logging',
					...
					},
					{
						...
						items: [
							{
								text: '16.2.2.1 Comandos para Operações em um Único Channel',
							...
							{
								text: '16.2.2.2 Compatibilidade com Declarações de Replication Anteriores',
							...
							{
								text: '16.2.2.4 Convenções de Nomenclatura para Canais de Replicação',
					...
					{
						text: '16.2.3 Threads de Replication',
						collapsed: true,
						items: [
							{
								text: '16.2.3.1 Monitoramento dos Threads Principais de Replicação',
								link: '/17-replication/02-replication-implementation/03-replication-threads/01-monitoring-replication-main-threads.md',
							},
							{
								text: '16.2.3.2 Monitoramento das Replication Applier Worker Threads',
					...
					{
						text: '16.2.4 Relay Log e Repositórios de Metadata de Replication',
						collapsed: true,
						items: [
							{
								text: '16.2.4.1 O Relay Log',
								link: '/17-replication/02-replication-implementation/04-relay-log-and-replication-metadata-repositories/01-the-relay-log.md',
							},
							{
								text: '16.2.4.2 Repositórios de Metadados de Replication',
					...
					{
						text: '16.2.5 Como Servidores Avaliam as Regras de Filtering de Replication',
						collapsed: true,
						items: [
							{
								text: '16.2.5.1 Avaliação das Opções de Replication e Binary Logging em Nível de Database',
							...
							{
								text: '16.2.5.2 Avaliação de Opções de Replication em Nível de Tabela',
							...
							{
								text: '16.2.5.3 Interações Entre Opções de Replication Filtering',
			...
			},
			{
				...
				items: [
					...
					{
						text: '16.3.9 Replicação Semissíncrona',
						collapsed: true,
						items: [
							{
								text: '16.3.9.1 Interface Administrativa da Replicação Semisynchronous',
							...
							{
								text: '16.3.9.2 Instalação e Configuração da Replicação Semissíncrona',
							...
							{
								text: '16.3.9.3 Monitoramento da Replicação Semissíncrona',
			...
			{
				text: '16.4 Notas e Dicas sobre Replicação',
				collapsed: true,
				items: [
					{
						text: '16.4.2 Compatibilidade de Replication Entre Versões do MySQL',
						link: '/17-replication/04-replication-notes-and-tips/02-replication-compatibility-between-my-s-q-l-versions.md',
					},
					{
						text: '16.4.3 Atualizando uma Topologia de Replication',
					...
					{
						text: '16.4.5 Como Reportar Bugs ou Problemas de Replication',
						link: '/17-replication/04-replication-notes-and-tips/05-how-to-report-replication-bugs-or-problems.md',
					},
					{
						text: '16.4.1 Recursos e Problemas da Replication',
						collapsed: true,
						items: [
							{
								text: '16.4.1.1 Replication e AUTO_INCREMENT',
							...
							{
								text: '16.4.1.3 Replicação e Character Sets',
							...
							{
								text: '16.4.1.5 Replicação de Instruções CREATE ... IF NOT EXISTS',
							...
							{
								text: '16.4.1.6 Replicação de Comandos CREATE TABLE ... SELECT',
							...
							{
								text: '16.4.1.10 Replicação com Definições de Tabela Diferentes na Source e na Replica',
							...
							{
								text: '16.4.1.11 Replicação e Opções de Tabela DIRECTORY',
							...
							{
								text: '16.4.1.16 Replicação de Recursos Invocados',
							...
							{
								text: '16.4.1.17 Replication e LIMIT',
							...
							{
								text: '16.4.1.19 Replication e max_allowed_packet',
							...
							{
								text: '16.4.1.20 Replicação e Tabelas MEMORY',
							...
							{
								text: '16.4.1.21 Replicação do Banco de Dados de Sistema mysql',
							...
							{
								text: '16.4.1.22 Replicação e o Query Optimizer',
							...
							{
								text: '16.4.1.26 Replication e Desligamentos do Source ou Replica',
							...
							{
								text: '16.4.1.27 Erros da Replica Durante a Replication',
							...
							{
								text: '16.4.1.28 Replication e SQL Mode do Servidor',
							...
							{
								text: '16.4.1.29 Replication e Tabelas Temporárias',
							...
							{
								text: '16.4.1.30 Repetições e Timeouts na Replicação',
							...
							{
								text: '16.4.1.36 Comprimento de User Name e Replication',
	...
	{
		text: 'Capítulo 17 Group Replication',
		collapsed: true,
		items: [
			{
			...
			{
				text: '17.1 Fundamentos do Group Replication',
				collapsed: true,
				items: [
					{
						text: '17.1.1 Tecnologias de Replication',
						collapsed: true,
						items: [
							{
								text: '17.1.1.1 Replication Primary-Secondary',
							...
							{
								text: '17.1.1.2 Group Replication',
					...
					{
						text: '17.1.2 Casos de Uso do Group Replication',
						collapsed: true,
						items: [
							{
								text: '17.1.2.1 Exemplos de Cenários de Caso de Uso',
					...
					{
						text: '17.1.3 Detalhes da Group Replication',
						collapsed: true,
						items: [
							{
								text: '17.1.3.1 Adesão ao Grupo',
			...
			{
				text: '17.2 Primeiros Passos',
				collapsed: true,
				items: [
					{
						text: '17.2.2 Implantando o Group Replication Localmente',
						link: '/18-group-replication/02-getting-started/02-deploying-group-replication-locally.md',
					},
					{
						text: '17.2.1 Implantando o Group Replication no Modo Single-Primary',
						collapsed: true,
						items: [
							{
								text: '17.2.1.1 Deploying Instances for Group Replication',
							...
							{
								text: '17.2.1.2 Configurando uma Instância para Group Replication',
							...
							{
								text: '17.2.1.4 Iniciando o Group Replication',
							...
							{
								text: '17.2.1.5 Bootstrapping do Grupo',
							...
							{
								text: '17.2.1.6 Adicionando Instâncias ao Grupo',
			...
			{
				text: '17.4 Monitoramento do Group Replication',
				collapsed: true,
				items: [
					{
						text: '17.4.1 Estados do Server no Group Replication',
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								text: '17.5.1.1 Modo Single-Primary',
							...
							{
								text: '17.5.1.2 Modo Multi-Primary',
							...
							{
								text: '17.5.1.3 Encontrando o Primary',
			...
			{
				text: '17.6 Segurança da Group Replication',
				collapsed: true,
				items: [
					{
						text: '17.6.1 Allowlisting de Endereços IP no Group Replication',
						link: '/18-group-replication/06-group-replication-security/01-group-replication-i-p-address-allowlisting.md',
					},
					{
						text: '17.6.2 Suporte a Secure Socket Layer (SSL) para Group Replication',
						link: '/18-group-replication/06-group-replication-security/02-group-replication-secure-socket-layer-ssl-support.md',
					},
					{
						text: '17.6.3 Group Replication e Virtual Private Networks (VPNs)',
			...
			{
				text: '17.7 Variáveis de Group Replication',
				collapsed: true,
				items: [
					{
						text: '17.7.1 Variáveis de Sistema do Group Replication',
						link: '/18-group-replication/07-group-replication-variables/01-group-replication-system-variables.md',
					},
					{
						text: '17.7.2 Variáveis de Status do Group Replication',
			...
			{
				text: '17.9 Detalhes Técnicos do Group Replication',
				collapsed: true,
				items: [
					{
						text: '17.9.1 Arquitetura do Plugin Group Replication',
					...
					{
						text: '17.9.3 Instruções de Manipulação de Dados',
					...
					},
					{
						...
						items: [
							{
								text: '17.9.5.1 Conceitos Básicos de Recuperação Distribuída',
							...
							{
								text: '17.9.5.2 Recuperação a Partir de um Ponto Específico no Tempo',
					...
					{
						text: '17.9.7 Desempenho do Group Replication',
						collapsed: true,
						items: [
							{
								text: '17.9.7.1 Ajuste Fino da Thread de Comunicação do Grupo',
	...
	{
		text: 'Capítulo 19 Usando MySQL como um Document Store',
		collapsed: true,
		items: [
			{
			...
			{
				text: '19.2 Configurando o MySQL como um Document Store',
				collapsed: true,
				items: [
					{
						text: '19.2.2 Iniciando o MySQL Shell',
						link: '/20-using-mysql-as-a-document-store/02-setting-up-my-s-q-l-as-a-document-store/02-starting-my-s-q-l-shell.md',
					},
					{
						text: '19.2.1 Instalando o MySQL Shell',
						collapsed: true,
						items: [
							{
								text: '19.2.1.1 Instalando o MySQL Shell no Microsoft Windows',
							...
							{
								text: '19.2.1.2 Instalando o MySQL Shell no Linux',
							...
							{
								text: '19.2.1.3 Instalando o MySQL Shell no macOS',
			...
			},
			{
				...
				items: [
					{
						text: '19.4.1 Usando Conexões Criptografadas com o X Plugin',
						link: '/20-using-mysql-as-a-document-store/04-x-plugin/01-using-encrypted-connections-with-x-plugin.md',
					},
					{
						text: '19.4.3 Monitorando o X Plugin',
						link: '/20-using-mysql-as-a-document-store/04-x-plugin/03-monitoring-x-plugin.md',
					},
					{
						text: '19.4.2 Opções e Variáveis do X Plugin',
						collapsed: true,
						items: [
							{
								text: '19.4.2.1 Referência de Opções e Variáveis do X Plugin',
							...
							{
								text: '19.4.2.2 Opções e Variáveis de Sistema do X Plugin',
							...
							{
								text: '19.4.2.3 Variáveis de Status do X Plugin',
	...
	},
	{
		...
		items: [
			...
			{
				text: '21.8 Notas de Lançamento do NDB Cluster',
				link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/08-n-d-b-cluster-release-notes.md',
			},
			{
				text: '21.2 Visão Geral do NDB Cluster',
				collapsed: true,
				items: [
					{
						text: '21.2.1 Conceitos Centrais do NDB Cluster',
						link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/02-n-d-b-cluster-overview/01-n-d-b-cluster-core-concepts.md',
					},
					{
						text: '21.2.2 Nodes, Node Groups, Fragment Replicas e Partitions do NDB Cluster',
					...
					{
						text: '21.2.3 Requisitos de Hardware, Software e Rede do NDB Cluster',
					...
					{
						text: '21.2.4 Novidades no MySQL NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.2.4.1 Novidades no NDB Cluster 7.5',
					...
					{
						text: '21.2.5 NDB: Options, Variables e Parameters Adicionadas, Descontinuadas e Removidas',
						collapsed: true,
						items: [
							{
							...
							{
								text: '21.2.5.2 Opções, Variáveis e Parâmetros Adicionados, Obsoletos ou Removidos no NDB 7.6',
					...
					},
					{
						...
						items: [
							...
							{
								text: '21.2.6.2 Cargas de Trabalho (Workloads) NDB e InnoDB',
							...
							{
								text: '21.2.6.3 Resumo do Uso de Funcionalidades do NDB e InnoDB',
					...
					},
					{
						...
						items: [
							...
							{
								text: '21.2.7.2 Limites e Diferenças do NDB Cluster em Relação aos Limites do MySQL Padrão',
							...
							{
								text: '21.2.7.3 Limitações Relacionadas ao Gerenciamento de Transactions no NDB Cluster',
							...
							{
								text: '21.2.7.4 Tratamento de Erros no NDB Cluster',
							...
							{
								text: '21.2.7.5 Limites Associados a Objetos de Database no NDB Cluster',
							...
							{
								text: '21.2.7.7 Limitações Relacionadas ao Desempenho no NDB Cluster',
							...
							{
								text: '21.2.7.8 Problemas Exclusivos do NDB Cluster',
							...
							{
								text: '21.2.7.9 Limitações Relacionadas ao Armazenamento Disk Data do NDB Cluster',
							...
							{
								text: '21.2.7.10 Limitações Relacionadas a Múltiplos Nós (Nodes) do NDB Cluster',
			...
			{
				text: '21.3 Instalação do NDB Cluster',
				collapsed: true,
				items: [
					{
					...
					{
						text: '21.3.9 O Auto-Installer do NDB Cluster (NÃO MAIS SUPORTADO)',
					...
					},
					{
						...
						items: [
							{
								text: '21.3.1.1 Instalando uma Release Binária do NDB Cluster no Linux',
							...
							{
								text: '21.3.1.2 Instalando o NDB Cluster a partir de RPM',
							...
							{
								text: '21.3.1.3 Instalando o NDB Cluster Usando Arquivos .deb',
							...
							{
								text: '21.3.1.4 Compilando o NDB Cluster a partir do Código Fonte no Linux',
					...
					{
						text: '21.3.2 Instalando o NDB Cluster no Windows',
						collapsed: true,
						items: [
							{
								text: '21.3.2.1 Instalando o NDB Cluster no Windows a partir de um Lançamento Binário',
							...
							{
								text: '21.3.2.2 Compilando e Instalando o NDB Cluster a partir do Código Fonte no Windows',
							...
							{
								text: '21.3.2.4 Instalando Processos NDB Cluster como Windows Services',
					...
					{
						text: '21.3.7 Upgrade e Downgrade do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.3.7.1 Atualizando e Rebaixando NDB 7.5',
							...
							{
								text: '21.3.7.2 Upgrade e Downgrade do NDB 7.6',
			...
			},
			{
				...
				items: [
					{
						text: '21.4.1 Configuração Rápida de Teste do NDB Cluster',
						link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/04-configuration-of-n-d-b-cluster/01-quick-test-setup-of-n-d-b-cluster.md',
					},
					{
						text: '21.4.4 Usando Interconexões de Alta Velocidade com NDB Cluster',
					...
					{
						text: '21.4.2 Visão Geral dos Parâmetros, Opções e Variáveis de Configuração do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.4.2.1 Parâmetros de Configuração do Node de Dados do NDB Cluster',
							...
							{
								text: '21.4.2.2 Parâmetros de Configuração do Node de Gerenciamento do NDB Cluster',
							...
							{
								text: '21.4.2.3 Parâmetros de Configuração de Nó SQL e Nó API do NDB Cluster',
							...
							{
								text: '21.4.2.4 Outros Parâmetros de Configuração do NDB Cluster',
							...
							{
								text: '21.4.2.5 Referência de Opções e Variáveis do mysqld para NDB Cluster',
					...
					{
						text: '21.4.3 Arquivos de Configuração do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.4.3.1 Configuração do NDB Cluster: Exemplo Básico',
							...
							{
								text: '21.4.3.2 Configuração Inicial Recomendada para NDB Cluster',
							...
							{
								text: '21.4.3.3 Connection Strings do NDB Cluster',
							...
							{
								text: '21.4.3.4 Definindo Computadores em um NDB Cluster',
							...
							{
								text: '21.4.3.5 Definindo um Servidor de Gerenciamento NDB Cluster',
							...
							{
								text: '21.4.3.6 Definindo Data Nodes do NDB Cluster',
							...
							{
								text: '21.4.3.7 Definindo SQL e Outros API Nodes em um NDB Cluster',
							...
							{
								text: '21.4.3.8 Definição do Sistema',
							...
							{
								text: '21.4.3.9 MySQL Server Options and Variables for NDB Cluster',
							...
							{
								text: '21.4.3.10 Conexões TCP/IP do NDB Cluster',
							...
							{
								text: '21.4.3.11 Conexões TCP/IP do NDB Cluster Usando Conexões Diretas',
							...
							{
								text: '21.4.3.13 Configurando Parâmetros do Send Buffer do NDB Cluster',
			...
			},
			{
				...
				items: [
					...
					{
						text: '21.5.4 ndb_mgmd — O Daemon do Servidor de Gerenciamento do NDB Cluster',
					...
					{
						text: '21.5.5 ndb_mgm — O Client de Gerenciamento do NDB Cluster',
						link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/05-n-d-b-cluster-programs/05-ndb-mgm-the-n-d-b-cluster-management-client.md',
					},
					{
						text: '21.5.6 ndb_blob_tool — Verificar e Reparar colunas BLOB e TEXT de Tabelas do NDB Cluster',
					...
					{
						text: '21.5.7 ndb_config — Extrair Informações de Configuração do NDB Cluster',
					...
					{
						text: '21.5.8 ndb_cpcd — Automatização de Testes para Desenvolvimento NDB',
					...
					{
						text: '21.5.18 ndb_print_backup_file — Imprimir Conteúdo de Arquivo de Backup NDB',
					...
					{
						text: '21.5.19 ndb_print_file — Imprimir Conteúdo de Arquivo Disk Data do NDB',
					...
					{
						text: '21.5.20 ndb_print_frag_file — Imprimir Conteúdo do Arquivo de Lista de Fragmentos NDB',
					...
					{
						text: '21.5.21 ndb_print_schema_file — Imprimir Conteúdo do Arquivo Schema NDB',
					...
					{
						text: '21.5.22 ndb_print_sys_file — Imprimir Conteúdo de Arquivo de Sistema NDB',
					...
					{
						text: '21.5.23 ndb_redo_log_reader — Verificar e Imprimir Conteúdo do Redo Log do Cluster',
					...
					{
						text: '21.5.26 ndb_select_count — Imprime Contagem de Linhas para Tabelas NDB',
					...
					{
						text: '21.5.27 ndb_show_tables — Exibir Lista de Tabelas NDB',
						link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/05-n-d-b-cluster-programs/27-ndb-show-tables-display-list-of-n-d-b-tables.md',
					},
					{
						text: '21.5.28 ndb_size.pl — Estimador de Requisitos de Tamanho do NDBCLUSTER',
					...
					{
						text: '21.5.29 ndb_top — Visualizar informações de uso de CPU para NDB threads',
					...
					{
						text: '21.5.30 ndb_waiter — Aguardar que o NDB Cluster Alcance um Status Determinado',
					...
					{
						text: '21.5.24 ndb_restore — Restauração de um Backup do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.5.24.1 Restaurando um Backup NDB para uma Versão Diferente do NDB Cluster',
							...
							{
								text: '21.5.24.2 Restaurando para um número diferente de data nodes',
			...
			},
			{
				...
				items: [
					{
						text: '21.6.1 Comandos no Client de Gerenciamento do NDB Cluster',
					...
					{
						text: '21.6.4 Sumário das Fases de Inicialização do NDB Cluster',
						link: '/22-mysql-ndb-cluster-7-5-ndb-cluster/06-management-of-n-d-b-cluster/04-summary-of-n-d-b-cluster-start-phases.md',
					},
					{
						text: '21.6.5 Realizando um Rolling Restart em um NDB Cluster',
					...
					{
						text: '21.6.6 Modo de Usuário Único do NDB Cluster',
					...
					{
						text: '21.6.10 Uso do MySQL Server para NDB Cluster',
					...
					{
						text: '21.6.13 Privilégios Distribuídos Usando Shared Grant Tables',
					...
					{
						text: '21.6.14 Contadores e Variáveis de Estatísticas da API NDB',
					...
					{
						text: '21.6.16 Tabelas INFORMATION_SCHEMA para NDB Cluster',
					...
					{
						text: '21.6.17 Referência Rápida: SQL Statements do NDB Cluster',
					...
					{
						text: '21.6.2 Mensagens de Log do NDB Cluster',
						collapsed: true,
						items: [
							{
							...
							{
								text: '21.6.2.2 Mensagens de Inicialização do Log do NDB Cluster',
							...
							{
								text: '21.6.2.3 Relatórios do Event Buffer no Cluster Log',
							...
							{
								text: '21.6.2.4 NDB Cluster: Erros do Transporter NDB',
					...
					},
					{
						...
						items: [
							{
								text: '21.6.3.1 Comandos de Gerenciamento de Logging do NDB Cluster',
							...
							{
								text: '21.6.3.2 Eventos de Log do NDB Cluster',
							...
							{
								text: '21.6.3.3 Usando CLUSTERLOG STATISTICS no Cliente de Gerenciamento do NDB Cluster',
					...
					{
						text: '21.6.7 Adicionando NDB Cluster Data Nodes Online',
						collapsed: true,
						items: [
							{
								text: '21.6.7.1 Adicionando NDB Cluster Data Nodes Online: Problemas Gerais',
							...
							{
								text: '21.6.7.2 Adicionando Data Nodes NDB Cluster Online: Procedimento Básico',
							...
							{
								text: '21.6.7.3 Adicionando Data Nodes do NDB Cluster Online: Exemplo Detalhado',
					...
					},
					{
						...
						items: [
							{
								text: '21.6.8.1 Conceitos de Backup do NDB Cluster',
							...
							{
								text: '21.6.8.2 Usando o NDB Cluster Management Client para Criar um Backup',
							...
							{
								text: '21.6.8.4 Solução de Problemas de Backup do NDB Cluster',
					...
					{
						text: '21.6.11 Tabelas de Dados em Disco (Disk Data) do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.6.11.1 Objetos Disk Data do NDB Cluster',
							...
							{
								text: '21.6.11.2 Usando Links Simbólicos com Objetos Disk Data',
							...
							{
								text: '21.6.11.3 Requisitos de Armazenamento de Dados em Disco do NDB Cluster (Disk Data)',
					...
					{
						text: '21.6.15 ndbinfo: O Database de Informações do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.6.15.1 A Tabela ndbinfo arbitrator_validity_detail',
							...
							{
								text: '21.6.15.3 A Tabela ndbinfo blocks',
							...
							{
								text: '21.6.15.7 A Tabela ndbinfo config_nodes',
							...
							{
								text: '21.6.15.8 A Tabela ndbinfo config_params',
							...
							{
								text: '21.6.15.10 A Tabela ndbinfo counters',
							...
							{
								text: '21.6.15.11 A Tabela ndbinfo cpustat',
							...
							{
								text: '21.6.15.12 A Tabela ndbinfo cpustat_50ms',
							...
							{
								text: '21.6.15.13 A Tabela ndbinfo cpustat_1sec',
							...
							{
								text: '21.6.15.14 A Tabela ndbinfo cpustat_20sec',
							...
							{
								text: '21.6.15.15 A Tabela ndbinfo dict_obj_info',
							...
							{
								text: '21.6.15.16 A Tabela ndbinfo dict_obj_types',
							...
							{
								text: '21.6.15.17 A Tabela ndbinfo disk_write_speed_base',
							...
							{
								text: '21.6.15.18 A Tabela ndbinfo disk_write_speed_aggregate',
							...
							{
								text: '21.6.15.19 A Tabela ndbinfo disk_write_speed_aggregate_node',
							...
							{
								text: '21.6.15.21 A Tabela ndbinfo error_messages',
							...
							{
								text: '21.6.15.22 A Tabela ndbinfo locks_per_fragment',
							...
							{
								text: '21.6.15.24 A Tabela ndbinfo logspaces',
							...
							{
								text: '21.6.15.25 A Tabela ndbinfo membership',
							...
							{
								text: '21.6.15.26 A Tabela ndbinfo memoryusage',
							...
							{
								text: '21.6.15.27 A Tabela ndbinfo memory_per_fragment',
							...
							{
								text: '21.6.15.28 A Tabela ndbinfo nodes',
							...
							{
								text: '21.6.15.29 A Tabela ndbinfo operations_per_fragment',
							...
							{
								text: '21.6.15.30 A Tabela ndbinfo processes',
							...
							{
								text: '21.6.15.31 A Tabela ndbinfo resources',
							...
							{
								text: '21.6.15.32 A Tabela ndbinfo restart_info',
							...
							{
								text: '21.6.15.33 A Tabela ndbinfo server\_locks',
							...
							{
								text: '21.6.15.34 A Tabela ndbinfo server_operations',
							...
							{
								text: '21.6.15.41 A Tabela ndbinfo threadblocks',
							...
							{
								text: '21.6.15.42 A Tabela ndbinfo threads',
							...
							{
								text: '21.6.15.43 A Tabela ndbinfo threadstat',
							...
							{
								text: '21.6.15.44 A Tabela ndbinfo transporters',
					...
					{
						text: '21.6.18 Questões de Segurança no NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.6.18.1 Questões de Segurança e Rede do NDB Cluster',
							...
							{
								text: '21.6.18.2 NDB Cluster e Privilégios MySQL',
			...
			{
				text: '21.7 Replicação de NDB Cluster',
				collapsed: true,
				items: [
					{
						text: '21.7.1 Replicação de NDB Cluster: Abreviaturas e Símbolos',
					...
					{
						text: '21.7.2 Requisitos Gerais para Replication de NDB Cluster',
					...
					{
						text: '21.7.7 Usando Dois Canais de Replicação para Replicação do Cluster NDB',
					...
					{
						text: '21.7.8 Implementando Failover com Replicação NDB Cluster',
					...
					{
						text: '21.7.10 Replicação do NDB Cluster: Replicação Bidirecional e Circular',
					...
					{
						text: '21.7.11 Resolução de Conflitos na Replicação do NDB Cluster',
					...
					{
						text: '21.7.9 Backups do NDB Cluster com Replication do NDB Cluster',
						collapsed: true,
						items: [
							{
								text: '21.7.9.1 NDB Cluster Replication: Automatizando a Sincronização da Replica com o Binary Log da Source',
							...
							{
								text: '21.7.9.2 Point-In-Time Recovery Usando NDB Cluster Replication',
		...
		items: [
			...
			},
			{
				...
				items: [
					...
					{
						text: '22.2.4 HASH Partitioning',
						collapsed: true,
						items: [
							{
								text: '22.2.4.1 LINEAR HASH Partitioning',
			...
			},
			{
				...
				items: [
					{
						text: '22.3.1 Gerenciamento de Partições RANGE e LIST',
						link: '/23-partitioning/03-partition-management/01-management-of-r-a-n-g-e-and-l-i-s-t-partitions.md',
					},
					{
						text: '22.3.2 Gerenciamento de Partições HASH e KEY',
					...
					{
						text: '22.3.4 Manutenção de Partitions',
						link: '/23-partitioning/03-partition-management/04-maintenance-of-partitions.md',
					},
					{
						text: '22.3.5 Obtendo Informações Sobre Partitions',
			...
			{
				text: '22.6 Restrições e Limitações no Partitioning',
				collapsed: true,
				items: [
					{
						text: '22.6.1 Chaves de Partitioning, Primary Keys e Unique Keys',
					...
					{
						text: '22.6.2 Limitações de Partitioning Relacionadas a Storage Engines',
					...
					{
						text: '22.6.3 Limitações de Partitioning Relacionadas a Funções',
					...
					{
						text: '22.6.4 Particionamento e Locking',
	...
	},
	{
		...
		items: [
			{
				text: '23.1 Definindo Stored Programs',
			...
			{
				text: '23.3 Usando Triggers',
				collapsed: true,
				items: [
					{
						text: '23.3.1 Sintaxe e Exemplos de Trigger',
						link: '/24-stored-objects/03-using-triggers/01-trigger-syntax-and-examples.md',
					},
					{
						text: '23.3.2 Metadados de Trigger',
	...
	{
		text: 'Capítulo 24 Tabelas INFORMATION_SCHEMA',
		collapsed: true,
		items: [
			{
			...
			{
				text: '24.2 Referência de Tabelas INFORMATION_SCHEMA',
				link: '/25-informationschema-tables/02-i-n-f-o-r-m-a-t-i-o-n-s-c-h-e-m-a-table-reference.md',
			},
			{
				text: '24.8 Extensões às Instruções SHOW',
				link: '/25-informationschema-tables/08-extensions-to-s-h-o-w-statements.md',
			},
			{
				text: '24.3 Tabelas Gerais do INFORMATION_SCHEMA',
				collapsed: true,
				items: [
					{
						text: '24.3.1 Referência Geral das Tabelas INFORMATION_SCHEMA',
					...
					{
						text: '24.3.2 A Tabela CHARACTER_SETS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.3 A Tabela COLLATIONS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.4 A Tabela COLLATION_CHARACTER_SET_APPLICABILITY do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.5 A Tabela COLUMNS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.6 A Tabela COLUMN_PRIVILEGES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.7 A Tabela ENGINES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.8 A Tabela EVENTS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.9 A Tabela FILES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.10 As Tabelas INFORMATION_SCHEMA GLOBAL_STATUS e SESSION_STATUS',
					...
					{
						text: '24.3.11 As Tabelas GLOBAL_VARIABLES e SESSION_VARIABLES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.14 A Tabela OPTIMIZER_TRACE do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.15 A Tabela PARAMETERS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.17 A Tabela PLUGINS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.18 A Tabela PROCESSLIST do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.19 A Tabela PROFILING do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.20 A Tabela REFERENTIAL_CONSTRAINTS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.21 A Tabela ROUTINES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.22 A Tabela SCHEMATA do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.23 A Tabela SCHEMA_PRIVILEGES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.24 A Tabela STATISTICS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.26 A Tabela TABLESPACES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.28 A Tabela TABLE_PRIVILEGES do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.29 A Tabela TRIGGERS do INFORMATION_SCHEMA',
					...
					{
						text: '24.3.31 A Tabela VIEWS do INFORMATION_SCHEMA',
			...
			{
				text: '24.4 Tabelas InnoDB do INFORMATION_SCHEMA',
				collapsed: true,
				items: [
					{
						text: '24.4.1 Referência de Tabelas InnoDB do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.2 A Tabela INNODB_BUFFER_PAGE do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.6 As Tabelas INNODB_CMPMEM e INNODB_CMPMEM_RESET do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.7 As Tabelas INNODB_CMP_PER_INDEX e INNODB_CMP_PER_INDEX_RESET do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.11 A Tabela INNODB_FT_DELETED do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.13 A Tabela INNODB_FT_INDEX_TABLE do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.14 A Tabela INNODB_LOCKS do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.16 A Tabela INNODB_METRICS do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.20 A Tabela INNODB_SYS_FOREIGN do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.21 A Tabela INNODB_SYS_FOREIGN_COLS do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.22 A Tabela INNODB_SYS_INDEXES do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.23 A Tabela INNODB_SYS_TABLES do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.25 A View INNODB_SYS_TABLESTATS do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.26 A Tabela INNODB_SYS_VIRTUAL do INFORMATION_SCHEMA',
					...
					{
						text: '24.4.28 A Tabela INNODB_TRX do INFORMATION_SCHEMA',
			...
			{
				text: '24.5 Tabelas Thread Pool do INFORMATION_SCHEMA',
				collapsed: true,
				items: [
					{
						text: '24.5.1 Referência das Tabelas Thread Pool do INFORMATION_SCHEMA',
					...
					{
						text: '24.5.2 A Tabela TP_THREAD_GROUP_STATE do INFORMATION_SCHEMA',
					...
					{
						text: '24.5.4 A Tabela TP_THREAD_STATE do INFORMATION_SCHEMA',
			...
			{
				text: '24.6 Tabelas de Controle de Conexão do INFORMATION_SCHEMA',
				collapsed: true,
				items: [
					{
						text: '24.6.1 Referência da Tabela de Controle de Conexão do INFORMATION_SCHEMA',
			...
			{
				text: '24.7 Tabelas INFORMATION_SCHEMA do MySQL Enterprise Firewall',
				collapsed: true,
				items: [
					{
						text: '24.7.1 Referência das Tabelas Firewall do INFORMATION_SCHEMA',
					...
					{
						text: '24.7.3 A Tabela MYSQL_FIREWALL_WHITELIST do INFORMATION_SCHEMA',
		...
		items: [
			...
			},
			{
				...
				items: [
					...
					{
						text: '25.4.10 Determinando O Que É Instrumentado',
			...
			{
				text: '25.12 Descrições de Tabelas do Performance Schema',
				collapsed: true,
				items: [
					{
						text: '25.12.1 Referência de Tabelas do Performance Schema',
						link: '/26-mysql-performance-schema/12-performance-schema-table-descriptions/01-performance-schema-table-reference.md',
					},
					{
						text: '25.12.10 Tabelas de Variáveis Definidas pelo Usuário do Performance Schema',
					...
					{
						text: '25.12.13 Tabelas de Variáveis de Sistema do Performance Schema',
					...
					{
						text: '25.12.14 Tabelas de Variáveis de Status do Performance Schema',
					...
					{
						text: '25.12.2 Tabelas de Configuração do Performance Schema',
						collapsed: true,
						items: [
							{
					...
					{
						text: '25.12.3 Tabelas de Instâncias do Performance Schema',
						collapsed: true,
						items: [
							{
					...
					{
						text: '25.12.4 Tabelas de Eventos Wait do Performance Schema',
						collapsed: true,
						items: [
							{
					...
					{
						text: '25.12.5 Tabelas de Eventos de Estágio (Stage Event Tables) do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.5.1 A Tabela events_stages_current',
					...
					{
						text: '25.12.6 Tabelas de Eventos de Statement do Performance Schema',
						collapsed: true,
						items: [
							{
					...
					{
						text: '25.12.7 Tabelas de Transaction do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.7.1 A Tabela events_transactions_current',
					...
					{
						text: '25.12.8 Tabelas de Connection do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.8.1 A Table `accounts`',
					...
					{
						text: '25.12.9 Tabelas de Atributos de Conexão do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.9.1 A Tabela session_account_connect_attrs',
							...
							{
								text: '25.12.9.2 A Tabela session_connect_attrs',
					...
					{
						text: '25.12.11 Tabelas de Replication do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.11.1 A Tabela replication_connection_configuration',
							...
							{
								text: '25.12.11.2 A Tabela replication_connection_status',
							...
							{
								text: '25.12.11.5 A Tabela replication_applier_status_by_coordinator',
							...
							{
								text: '25.12.11.6 A Tabela replication_applier_status_by_worker',
							...
							{
								text: '25.12.11.7 A Tabela replication_group_member_stats',
					...
					{
						text: '25.12.12 Tabelas de Lock do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.12.1 A Tabela metadata_locks',
							...
							{
								text: '25.12.12.2 A Tabela table_handles',
					...
					{
						text: '25.12.15 Tabelas de Resumo do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.15.1 Tabelas de Resumo de Eventos de Espera',
							...
							{
								text: '25.12.15.2 Tabelas de Resumo de Stage',
							...
							{
								text: '25.12.15.3 Tabelas de Resumo de Statement (Statement Summary Tables)',
							...
							{
								text: '25.12.15.5 Tabela de Resumo de Espera de Objetos',
							...
							{
								text: '25.12.15.6 Tabelas de Resumo de I/O de Arquivo',
							...
							{
								text: '25.12.15.7 Tabelas de Resumo de I/O de Tabela e Wait de Lock',
							...
							{
								text: '25.12.15.8 Tabelas de Resumo de Socket',
							...
							{
								text: '25.12.15.10 Tabelas de Resumo de Status Variable',
					...
					{
						text: '25.12.16 Tabelas Diversas do Performance Schema',
						collapsed: true,
						items: [
							{
								text: '25.12.16.1 A Tabela host_cache',
							...
							{
								text: '25.12.16.2 A Tabela performance_timers',
							...
							{
								text: '25.12.16.3 A Tabela processlist',
							...
							{
								text: '25.12.16.4 A Tabela threads',
			...
			{
				text: '25.19 Usando o Performance Schema para Diagnosticar Problemas',
				collapsed: true,
				items: [
					{
						text: '25.19.1 Profiling de Query Usando Performance Schema',
	...
	{
		text: 'Capítulo 26 Schema sys do MySQL',
		collapsed: true,
		items: [
			{
				text: '26.1 Pré-requisitos para Usar o Schema sys',
				link: '/27-mysql-sys-schema/01-prerequisites-for-using-the-sys-schema.md',
			},
			{
				text: '26.2 Usando o Schema sys',
				link: '/27-mysql-sys-schema/02-using-the-sys-schema.md',
			},
			{
				text: '26.3 Relatório de Progresso do Schema sys',
				link: '/27-mysql-sys-schema/03-sys-schema-progress-reporting.md',
			},
			{
				text: '26.4 Referência de Objetos do sys Schema',
				collapsed: true,
				items: [
					{
						text: '26.4.1 Índice de Objetos do Schema sys',
						link: '/27-mysql-sys-schema/04-sys-schema-object-reference/01-sys-schema-object-index.md',
					},
					{
						text: '26.4.2 Tabelas e Triggers do Schema sys',
						collapsed: true,
						items: [
							{
							...
							{
								text: '26.4.2.2 O Trigger sys_config_insert_set_user',
							...
							{
								text: '26.4.2.3 O Trigger sys_config_update_set_user',
					...
					{
						text: '26.4.3 Views do Schema sys',
						collapsed: true,
						items: [
							{
								text: '26.4.3.1 As Views host_summary e x$host_summary',
							...
							{
								text: '26.4.3.2 As Views host_summary_by_file_io e x$host_summary_by_file_io',
							...
							{
								text: '26.4.3.3 As Views host_summary_by_file_io_type e x$host_summary_by_file_io_type',
							...
							{
								text: '26.4.3.4 As Views host_summary_by_stages e x$host_summary_by_stages',
							...
							{
								text: '26.4.3.5 As Views host_summary_by_statement_latency e x$host_summary_by_statement_latency',
							...
							{
								text: '26.4.3.6 As Views host_summary_by_statement_type e x$host_summary_by_statement_type',
							...
							{
								text: '26.4.3.7 As Views innodb_buffer_stats_by_schema e x$innodb_buffer_stats_by_schema',
							...
							{
								text: '26.4.3.9 As Views innodb_lock_waits e x$innodb_lock_waits',
							...
							{
								text: '26.4.3.10 As Views io_by_thread_by_latency e x$io_by_thread_by_latency',
							...
							{
								text: '26.4.3.11 As Views io_global_by_file_by_bytes e x$io_global_by_file_by_bytes',
							...
							{
								text: '26.4.3.12 As Views io_global_by_file_by_latency e x$io_global_by_file_by_latency',
							...
							{
								text: '26.4.3.13 As Views io_global_by_wait_by_bytes e x$io_global_by_wait_by_bytes',
							...
							{
								text: '26.4.3.14 As Views io_global_by_wait_by_latency e x$io_global_by_wait_by_latency',
							...
							{
								text: '26.4.3.15 As Views latest_file_io e x$latest_file_io',
							...
							{
								text: '26.4.3.16 As Views memory_by_host_by_current_bytes e x$memory_by_host_by_current_bytes',
							...
							{
								text: '26.4.3.17 As Views memory_by_thread_by_current_bytes e x$memory_by_thread_by_current_bytes',
							...
							{
								text: '26.4.3.18 As Views memory_by_user_by_current_bytes e x$memory_by_user_by_current_bytes',
							...
							{
								text: '26.4.3.19 As Views memory_global_by_current_bytes e x$memory_global_by_current_bytes',
							...
							{
								text: '26.4.3.20 As Views memory_global_total e x$memory_global_total',
							...
							{
								text: '26.4.3.26 A View schema_object_overview',
								link: '/27-mysql-sys-schema/04-sys-schema-object-reference/03-sys-schema-views/26-the-schema-object-overview-view.md',
							},
							{
								text: '26.4.3.27 As Views schema_redundant_indexes e x$schema_flattened_keys',
							...
							{
								text: '26.4.3.28 As Views schema_table_lock_waits e x$schema_table_lock_waits',
							...
							{
								text: '26.4.3.29 As Views schema_table_statistics e x$schema_table_statistics',
							...
							{
								text: '26.4.3.30 As Views schema_table_statistics_with_buffer e x$schema_table_statistics_with_buffer',
							...
							{
								text: '26.4.3.31 As Views schema_tables_with_full_table_scans e x$schema_tables_with_full_table_scans',
							...
							{
								text: '26.4.3.36 As Views statements_with_errors_or_warnings e x$statements_with_errors_or_warnings',
							...
							{
								text: '26.4.3.37 As Views statements_with_full_table_scans e x$statements_with_full_table_scans',
							...
							{
								text: '26.4.3.38 As Views statements_with_runtimes_in_95th_percentile e x$statements_with_runtimes_in_95th_percentile',
							...
							{
								text: '26.4.3.39 As Views statements_with_sorting e x$statements_with_sorting',
							...
							{
								text: '26.4.3.40 As Views statements_with_temp_tables e x$statements_with_temp_tables',
							...
							{
								text: '26.4.3.41 As Views user_summary e x$user_summary',
							...
							{
								text: '26.4.3.42 As Views user_summary_by_file_io e x$user_summary_by_file_io',
							...
							{
								text: '26.4.3.43 As Views user_summary_by_file_io_type e x$user_summary_by_file_io_type',
							...
							{
								text: '26.4.3.44 As Views user_summary_by_stages e x$user_summary_by_stages',
							...
							{
								text: '26.4.3.45 As Views user_summary_by_statement_latency e x$user_summary_by_statement_latency',
							...
							{
								text: '26.4.3.46 As Views user_summary_by_statement_type e x$user_summary_by_statement_type',
							...
							{
								text: '26.4.3.47 A View version',
								link: '/27-mysql-sys-schema/04-sys-schema-object-reference/03-sys-schema-views/47-the-version-view.md',
							},
							{
								text: '26.4.3.48 As Views wait_classes_global_by_avg_latency e x$wait_classes_global_by_avg_latency',
							...
							{
								text: '26.4.3.49 As Views wait_classes_global_by_latency e x$wait_classes_global_by_latency',
							...
							{
								text: '26.4.3.50 As Views waits_by_host_by_latency e x$waits_by_host_by_latency',
							...
							{
								text: '26.4.3.51 As Views waits_by_user_by_latency e x$waits_by_user_by_latency',
							...
							{
								text: '26.4.3.52 As Views waits_global_by_latency e x$waits_global_by_latency',
					...
					{
						text: '26.4.4 Procedimentos Armazenados do Schema sys',
						collapsed: true,
						items: [
							{
								text: '26.4.4.1 O Procedure create_synonym_db()',
							...
							{
								text: '26.4.4.2 O Procedure diagnostics()',
							...
							{
								text: '26.4.4.4 O Procedure ps_setup_disable_background_threads()',
							...
							{
								text: '26.4.4.5 O Procedure ps_setup_disable_consumer()',
							...
							{
								text: '26.4.4.6 O Procedure ps_setup_disable_instrument()',
							...
							{
								text: '26.4.4.7 O Procedure ps_setup_disable_thread()',
							...
							{
								text: '26.4.4.8 O Procedure ps_setup_enable_background_threads()',
							...
							{
								text: '26.4.4.9 O Procedure ps_setup_enable_consumer()',
							...
							{
								text: '26.4.4.11 O Procedure ps_setup_enable_thread()',
							...
							{
								text: '26.4.4.12 O Procedure ps_setup_reload_saved()',
							...
							{
								text: '26.4.4.14 O Procedure ps_setup_save()',
							...
							{
								text: '26.4.4.16 O Procedure ps_setup_show_disabled_consumers()',
							...
							{
								text: '26.4.4.18 O Procedure ps_setup_show_enabled()',
							...
							{
								text: '26.4.4.19 A Procedure ps_setup_show_enabled_consumers()',
							...
							{
								text: '26.4.4.20 A Procedure ps_setup_show_enabled_instruments()',
							...
							{
								text: '26.4.4.21 O Procedure ps_statement_avg_latency_histogram()',
							...
							{
								text: '26.4.4.23 O Procedure ps_trace_thread()',
							...
							{
								text: '26.4.4.25 O Procedimento statement_performance_analyzer()',
							...
							{
								text: '26.4.4.26 O Procedure table_exists()',
					...
					{
						text: '26.4.5 Funções Armazenadas do Schema sys',
						collapsed: true,
						items: [
							{
	...
	},
	{
		...
		items: [
			...
			{
				text: '27.11 APIs Ruby para MySQL',
				collapsed: true,
				items: [
					{
						text: '27.11.1 A API MySQL/Ruby',
						link: '/28-connectors-and-apis/11-my-s-q-l-ruby-ap-is/01-the-my-sql-ruby-api.md',
					},
					{
						text: '27.11.2 A API Ruby/MySQL',
	...
	},
	{
		...
		items: [
			{
				text: 'B.1 Fontes e Elementos de Mensagens de Erro',
			...
			},
			{
				...
				items: [
					{
						text: 'B.3.1 Como Determinar a Causa de um Problema',
					...
					{
						text: 'B.3.5 Problemas Relacionados ao Optimizer',
					...
					},
					{
						...
						items: [
							...
							{
								text: 'B.3.2.2 Não é possível conectar ao MySQL server [local]',
							...
							{
								text: 'B.3.2.3 Lost connection to MySQL server',
							...
							{
								text: 'B.3.2.4 Falha no Password Quando Inserido Interativamente',
							...
							{
								text: 'B.3.2.5 Too many connections',
							...
							{
								text: 'B.3.2.7 MySQL server has gone away',
							...
							{
								text: 'B.3.2.9 Erros de Comunicação e Conexões Abortadas',
							...
							{
								text: 'B.3.2.10 A table está cheia',
							...
							{
								text: 'B.3.2.12 Commands out of sync',
							...
							{
								text: 'B.3.2.13 Ignorando usuário',
							...
							{
								text: 'B.3.2.14 Tabela \'tbl_name\' não existe',
							...
							{
								text: 'B.3.2.15 Não é possível inicializar o character set',
							...
							{
								text: 'B.3.2.16 File Not Found e Erros Semelhantes',
					...
					{
						text: 'B.3.3 Problemas Relacionados à Administração',
						collapsed: true,
						items: [
							{
							...
							{
								text: 'B.3.3.2 Como Redefinir a Senha do Root',
							...
							{
								text: 'B.3.3.3 O que Fazer Se o MySQL Continuar Crashando',
							...
							{
								text: 'B.3.3.4 Como o MySQL Lida com um Disco Cheio',
							...
							{
								text: 'B.3.3.6 Como Proteger ou Alterar o Arquivo Unix Socket do MySQL',
							...
							{
								text: 'B.3.3.7 Problemas de Time Zone',
					...
					{
						text: 'B.3.4 Problemas Relacionados a Querys',
						collapsed: true,
						items: [
							{
								text: 'B.3.4.1 Sensibilidade a Maiúsculas e Minúsculas em Buscas de Strings',
							...
							{
								text: 'B.3.4.3 Problemas com Valores NULL',
							...
							{
								text: 'B.3.4.4 Problemas com Aliases de Coluna',
							...
							{
								text: 'B.3.4.5 Falha de ROLLBACK para Tabelas Não Transacionais',
							...
							{
								text: 'B.3.4.7 Solucionando Problemas com Nenhuma Linha Correspondente',
					...
					{
						text: 'B.3.6 Problemas Relacionados à Definição de Tabela',
						collapsed: true,
						items: [
							{
							...
							{
								text: 'B.3.6.2 Problemas com Tabelas TEMPORARY',
	...
	},
	{
		...
		items: [
			...
			{
				text: 'Índice de SQL Modes',
				link: '/33-indexes/10-modes-index.md',
			},
			{
				text: 'Índice de Declaração/Sintaxe',
				link: '/33-indexes/11-statement-syntax-index.md',
			},
			{
				text: 'Índice de Variáveis de Status',
				link: '/33-indexes/12-status-variable-index.md',
			},
			{
				text: 'Índice de Variáveis de Sistema',
				link: '/33-indexes/13-system-variable-index.md',
			},
			{
				text: 'Índice de Transaction Isolation Level',

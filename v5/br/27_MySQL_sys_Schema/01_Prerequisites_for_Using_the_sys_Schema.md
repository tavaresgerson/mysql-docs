## 26.1 Pré-requisitos para o uso do esquema sys

Antes de usar o esquema `sys`, os pré-requisitos descritos nesta seção devem ser atendidos.

Como o esquema `sys` fornece um meio alternativo de acesso ao Schema de Desempenho, o Schema de Desempenho deve ser habilitado para que o esquema `sys` funcione. Veja a Seção 25.3, “Configuração de Inicialização do Schema de Desempenho”.

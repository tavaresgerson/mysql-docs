...
- Um nome de coluna pode receber vários qualificadores para indicar o contexto em declarações que a referenciam, conforme mostrado na tabela a seguir.
  ...
  <table summary="Formatos de referência de colunas que podem ser usados para se referir às colunas da tabela."><col style="width: 35%"/><col style="width: 65%"/><thead><tr> <th>Referência da coluna</th> <th>Significado</th> </tr></thead><tbody><tr> <td><em>[[<code>col_name</code>]]</em></td> <td>Coluna<em>[[<code>col_name</code>]]</em>de qualquer tabela usada na declaração que contenha uma coluna com esse nome</td> </tr><tr> <td><em>[[<code>tbl_name.col_name</code>]]</em></td> <td>Coluna<em>[[<code>col_name</code>]]</em>da mesa<em>[[<code>tbl_name</code>]]</em>do banco de dados padrão</td> </tr><tr> <td><em>[[<code>db_name.tbl_name.col_name</code>]]</em></td> <td>Coluna<em>[[<code>col_name</code>]]</em>da mesa<em>[[<code>tbl_name</code>]]</em>do banco de dados<em>[[<code>db_name</code>]]</em></td> </tr></tbody></table>

...
<table summary="valores unitários e o argumento expr esperado para cada valor unitário.">
  <thead>
    <tr>
      <th><em><code>unit</code></em> Value</th>
      <th>Formato <em><code>expr</code></em> esperado</th>
    </tr>
  </thead>
  <tbody>
    <tr>

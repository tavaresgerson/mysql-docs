...
<table summary="valores de unidade e o argumento esperado expr para cada valor de unidade."><col style="width: 50%"/><col style="width: 50%"/><thead><tr> <th><em class="replaceable">[[PH_HTML_CODE_<code class="literal">DAY</code>]</em>Valor</th> <th>Esperado<em class="replaceable">[[PH_HTML_CODE_<code class="literal">DAY</code>]</em>Formato</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">WEEK</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">WEEKS</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">MONTH</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">MONTHS</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">QUARTER</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">QUARTERS</code>]</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">YEAR</code>]</td> <td>[[PH_HTML_CODE_<code class="literal">YEARS</code>]</td> </tr><tr> <td>[[<code class="literal">DAY</code>]]</td> <td>[[<code>expr</code><code class="literal">DAY</code>]</td> </tr><tr> <td>[[<code class="literal">WEEK</code>]]</td> <td>[[<code class="literal">WEEKS</code>]]</td> </tr><tr> <td>[[<code class="literal">MONTH</code>]]</td> <td>[[<code class="literal">MONTHS</code>]]</td> </tr><tr> <td>[[<code class="literal">QUARTER</code>]]</td> <td>[[<code class="literal">QUARTERS</code>]]</td> </tr><tr> <td>[[<code class="literal">YEAR</code>]]</td> <td>[[<code class="literal">YEARS</code>]]</td> </tr><tr> <td>[[<code class="literal">MICROSECOND</code><code class="literal">DAY</code>]</td> <td>[[<code class="literal">MICROSECOND</code><code class="literal">DAY</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECOND</code><code class="literal">WEEK</code>]</td> <td>[[<code class="literal">MICROSECOND</code><code class="literal">WEEKS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECOND</code><code class="literal">MONTH</code>]</td> <td>[[<code class="literal">MICROSECOND</code><code class="literal">MONTHS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECOND</code><code class="literal">QUARTER</code>]</td> <td>[[<code class="literal">MICROSECOND</code><code class="literal">QUARTERS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECOND</code><code class="literal">YEAR</code>]</td> <td>[[<code class="literal">MICROSECOND</code><code class="literal">YEARS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">DAY</code>]</td> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">DAY</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">WEEK</code>]</td> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">WEEKS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">MONTH</code>]</td> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">MONTHS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">QUARTER</code>]</td> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">QUARTERS</code>]</td> </tr><tr> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">YEAR</code>]</td> <td>[[<code class="literal">MICROSECONDS</code><code class="literal">YEARS</code>]</td> </tr><tr> <td>[[<code class="literal">SECOND</code><code class="literal">DAY</code>]</td> <td>[[<code class="literal">SECOND</code><code class="literal">DAY</code>]</td> </tr></tbody></table>

...
16.2.5.1 Avaliação das Options de Replication e Binary Logging em Nível de Database

16.2.5.2 Avaliação das Options de Replication em Nível de Table

16.2.5.3 Interações entre Options de Replication Filtering

...
* **Alterações no formato do Binary Log.** O formato do Binary Log pode mudar entre releases principais. Embora tentemos manter a compatibilidade retroativa, isso nem sempre é possível.
  ...
  Isso também tem implicações significativas para o upgrade de servidores de replication; consulte Seção 16.4.3, “Upgrading de uma Replication Topology”, para mais informações.

* Para mais informações sobre row-based replication, consulte Seção 16.2.1, “Replication Formats”.
...
Para mais informações sobre potenciais problemas de replication, consulte Seção 16.4.1, “Recursos e Problemas de Replication”.
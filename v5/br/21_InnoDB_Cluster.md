...
O InnoDB Cluster não oferece suporte para MySQL NDB Cluster. Para mais informações sobre o MySQL NDB Cluster, consulte o Capítulo 21, *MySQL NDB Cluster 7.5 e NDB Cluster 7.6* e a Seção 21.2.6, “MySQL Server Usando InnoDB Comparado com NDB Cluster”.
...
O AdminAPI é compatível com instâncias que executam MySQL 5.7, mas com um conjunto de recursos reduzido. Para mais informações, consulte o uso de instâncias que executam MySQL 5.7. Para obter a melhor experiência ao usar o AdminAPI e o InnoDB Cluster, atualize para o MySQL 8.0.

...
<table summary="A correspondência entre os parâmetros em uma cadeia de conexão, as opções na instrução CREATE SERVER e as colunas na tabela mysql.servers."><col style="width: 25%"/><col style="width: 25%"/><col style="width: 25%"/><col style="width: 25%"/><thead><tr> <th scope="col">Descrição</th> <th scope="col">[[PH_HTML_CODE_<code class="literal">PASSWORD</code>] string</th> <th scope="col"><a class="link" href="create-server.html" title="13.1.17 Declaração CREATE SERVER">[[PH_HTML_CODE_<code class="literal">PASSWORD</code>]</a>opção</th> <th scope="col">coluna [[PH_HTML_CODE_<code>host_name</code>]</th> </tr></thead><tbody><tr> <th scope="row">Esquema de conexão</th> <td><em class="replaceable">[[PH_HTML_CODE_<code class="literal">HOST</code>]</em></td> <td>[[PH_HTML_CODE_<code class="literal">Host</code>]</td> <td>[[PH_HTML_CODE_<code>port_num</code>]</td> </tr><tr> <th scope="row">Usuário remoto</th> <td><em class="replaceable">[[PH_HTML_CODE_<code class="literal">PORT</code>]</em></td> <td>[[PH_HTML_CODE_<code class="literal">Port</code>]</td> <td>[[PH_HTML_CODE_<code>db_name</code>]</td> </tr><tr> <th scope="row">Senha remota</th> <td><em class="replaceable">[[PH_HTML_CODE_<code class="literal">DATABASE</code>]</em></td> <td>[[<code class="literal">PASSWORD</code>]]</td> <td>[[<code class="literal">CREATE SERVER</code><code class="literal">PASSWORD</code>]</td> </tr><tr> <th scope="row">Anfitrião remoto</th> <td><em class="replaceable">[[<code>host_name</code>]]</em></td> <td>[[<code class="literal">HOST</code>]]</td> <td>[[<code class="literal">Host</code>]]</td> </tr><tr> <th scope="row">Porto remoto</th> <td><em class="replaceable">[[<code>port_num</code>]]</em></td> <td>[[<code class="literal">PORT</code>]]</td> <td>[[<code class="literal">Port</code>]]</td> </tr><tr> <th scope="row">Banco de dados remoto</th> <td><em class="replaceable">[[<code>db_name</code>]]</em></td> <td>[[<code class="literal">DATABASE</code>]]</td> <td>[[<code class="literal">mysql.servers</code><code class="literal">PASSWORD</code>]</td> </tr></tbody></table>

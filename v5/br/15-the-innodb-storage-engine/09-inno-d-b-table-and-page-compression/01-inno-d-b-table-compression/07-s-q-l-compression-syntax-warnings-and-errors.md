...
<table summary="Observações e descrições sobre o uso das opções ROW_FORMAT e KEY_BLOCK_SIZE."><col style="width: 20%"/><col style="width: 40%"/><col style="width: 40%"/><thead><tr> <th scope="col">Opção</th> <th scope="col">Observações de uso</th> <th scope="col">Descrição</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>]</th> <td>Formato de armazenamento usado antes do MySQL 5.0.3</td> <td>Menos eficiente que [[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>]; para compatibilidade reversa</td> </tr><tr> <th scope="row">[[<code>ROW_FORMAT=​COMPACT</code>]]</th> <td>Formato de armazenamento padrão desde o MySQL 5.0.3</td> <td>Armazena um prefixo de 768 bytes de valores de coluna longa na página do índice agrupado, com os bytes restantes armazenados em uma página de sobreposição</td> </tr><tr> <th scope="row">[[<code>ROW_FORMAT=​DYNAMIC</code>]]</th> <td>Os espaços de tabela por arquivo exigem [[<code>innodb_file​_format=Barracuda</code>]]</td> <td>Armazene os valores dentro da página do índice agrupado se eles se encaixarem; caso contrário, armazene apenas um ponteiro de 20 bytes para uma página de sobreposição (sem prefixo)</td> </tr><tr> <th scope="row">[[<code>ROW_FORMAT=​COMPRESSED</code>]]</th> <td>Os espaços de tabela por arquivo exigem [[<code>innodb_file​_format=Barracuda</code>]]</td> <td>Compreende a tabela e os índices usando zlib</td> </tr><tr> <th scope="row">[[<code>KEY_BLOCK_​SIZE=<em class="replaceable"><code>n</code>]]</em></code></th> <td>Os espaços de tabela por arquivo exigem [[<code>innodb_file​_format=Barracuda</code>]]</td> <td>Especifica o tamanho de página compactada de 1, 2, 4, 8 ou 16 kilobytes; implica em [[<code>ROW_FORMAT=COMPRESSED</code>]]. Para espaços de tabelas gerais, um valor [[<code>KEY_BLOCK_SIZE</code>]] igual ao tamanho de página [[<code>ROW_FORMAT=COMPACT</code><code>KEY_BLOCK_SIZE</code>] não é permitido.</td> </tr></tbody></table>
...
<table summary="Criar e alterar avisos e erros de tabela quando o modo rigoroso do InnoDB está desativado."><col style="width: 33%"/><col style="width: 33%"/><col style="width: 33%"/><thead><tr> <th scope="col">Sintaxe</th> <th scope="col">Condição de Aviso ou Erro</th> <th scope="col">Resultado [[PH_HTML_CODE_<code>=Barracuda</code>], conforme mostrado em [[PH_HTML_CODE_<code>=Barracuda</code>]</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code>innodb_file_format</code>]</th> <td>Nenhum</td> <td>[[PH_HTML_CODE_<code>innodb_file_per_table</code>]</td> </tr><tr> <th scope="row">[[PH_HTML_CODE_<code>the default row format for file-per-table tablespaces; the specified row format for general tablespaces</code>]</th> <td>Nenhum</td> <td>[[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>]</td> </tr><tr> <th scope="row">É especificado [[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>] ou [[PH_HTML_CODE_<code>ROW_FORMAT=COMPRESSED</code>] ou [[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>]</th> <td>Ignorado para tabelas de espaços de arquivo por tabela, a menos que ambos<a class="link" href="innodb-parameters.html#sysvar_innodb_file_format">[[PH_HTML_CODE_<code>KEY_BLOCK_SIZE</code>]</a>[[<code>=Barracuda</code>]] e<a class="link" href="innodb-parameters.html#sysvar_innodb_file_per_table">[[<code>SHOW TABLE STATUS</code><code>=Barracuda</code>]</a>As tabelas gerais suportam todos os formatos de linha (com algumas restrições), independentemente<a class="link" href="innodb-parameters.html#sysvar_innodb_file_format">[[<code>innodb_file_format</code>]]</a>e<a class="link" href="innodb-parameters.html#sysvar_innodb_file_per_table">[[<code>innodb_file_per_table</code>]]</a>configurações. Veja<a class="xref" href="general-tablespaces.html" title="14.6.3.3 Tabelaspaces Gerais">Seção 14.6.3.3, “Tabelas gerais”</a>.</td> <td>[[<code>the default row format for file-per-table tablespaces; the specified row format for general tablespaces</code>]]</td> </tr><tr> <th scope="row">O código [[<code>KEY_BLOCK_SIZE</code>]] inválido foi especificado (não 1, 2, 4, 8 ou 16)</th> <td>[[<code>KEY_BLOCK_SIZE</code>]] é ignorado</td> <td>o formato de linha especificado ou o formato de linha padrão</td> </tr><tr> <th scope="row">[[<code>ROW_FORMAT=COMPRESSED</code>]] e [[<code>KEY_BLOCK_SIZE</code>]] válidos são especificados</th> <td>Nenhum; [[<code>KEY_BLOCK_SIZE</code>]] especificado é usado</td> <td>[[<code>ROW_FORMAT=REDUNDANT</code><code>=Barracuda</code>]</td> </tr><tr> <th scope="row">O formato de linha [[<code>ROW_FORMAT=REDUNDANT</code><code>=Barracuda</code>] é especificado com os formatos de linha [[<code>ROW_FORMAT=REDUNDANT</code><code>innodb_file_format</code>], [[<code>ROW_FORMAT=REDUNDANT</code><code>innodb_file_per_table</code>] ou [[<code>ROW_FORMAT=REDUNDANT</code><code>the default row format for file-per-table tablespaces; the specified row format for general tablespaces</code>]</th> <td>[[<code>ROW_FORMAT=REDUNDANT</code><code>KEY_BLOCK_SIZE</code>] é ignorado</td> <td>[[<code>ROW_FORMAT=REDUNDANT</code><code>KEY_BLOCK_SIZE</code>], [[<code>ROW_FORMAT=REDUNDANT</code><code>ROW_FORMAT=COMPRESSED</code>] ou [[<code>ROW_FORMAT=REDUNDANT</code><code>KEY_BLOCK_SIZE</code>]</td> </tr><tr> <th scope="row">[[<code>ROW_FORMAT=REDUNDANT</code><code>KEY_BLOCK_SIZE</code>] não é um dos [[<code>REDUNDANT</code><code>=Barracuda</code>], [[<code>REDUNDANT</code><code>=Barracuda</code>], [[<code>REDUNDANT</code><code>innodb_file_format</code>] ou [[<code>REDUNDANT</code><code>innodb_file_per_table</code>]</th> <td>Ignorado se reconhecido pelo analisador MySQL. Caso contrário, um erro é emitido.</td> <td>o formato padrão da linha ou N/A</td> </tr></tbody></table>

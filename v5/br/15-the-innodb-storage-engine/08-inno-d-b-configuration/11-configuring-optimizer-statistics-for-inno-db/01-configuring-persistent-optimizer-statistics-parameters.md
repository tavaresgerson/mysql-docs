...
<table summary="Colunas da tabela mysql.innodb_table_stats."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Nome da coluna</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[<code class="literal">database_name</code>]]</td> <td>Nome do banco de dados</td> </tr><tr> <td>[[<code class="literal">table_name</code>]]</td> <td>Nome da tabela, nome da partição ou nome da subpartição</td> </tr><tr> <td>[[<code class="literal">last_update</code>]]</td> <td>Um marcador de tempo que indica a última vez que a linha foi atualizada</td> </tr><tr> <td>[[<code class="literal">n_rows</code>]]</td> <td>O número de linhas na tabela</td> </tr><tr> <td>[[<code class="literal">clustered_index_size</code>]]</td> <td>O tamanho do índice principal, em páginas</td> </tr><tr> <td>[[<code class="literal">sum_of_other_index_sizes</code>]]</td> <td>O tamanho total de outros índices (não primários), em páginas</td> </tr></tbody></table>

**Tabela 14.5 Colunas de innodb\_index\_stats**

<table summary="Colunas da tabela mysql.innodb_index_stats."><col style="width: 30%"/><col style="width: 70%"/><thead><tr> <th>Nome da coluna</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">stat_value</code>]</td> <td>Nome do banco de dados</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">stat_value</code>]</td> <td>Nome da tabela, nome da partição ou nome da subpartição</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">stat_name</code>]</td> <td>Nome do índice</td> </tr><tr> <td>[[<code class="literal">last_update</code>]]</td> <td>Um marcador de tempo que indica a última vez que [[<code class="literal">InnoDB</code>]] atualizou esta linha</td> </tr><tr> <td>[[<code class="literal">stat_name</code>]]</td> <td>O nome da estatística, cujo valor é reportado na coluna [[<code class="literal">stat_value</code>]]</td> </tr><tr> <td>[[<code class="literal">stat_value</code>]]</td> <td>O valor da estatística que está nomeada na coluna [[<code class="literal">stat_name</code>]]</td> </tr><tr> <td>[[<code class="literal">sample_size</code>]]</td> <td>O número de páginas amostradas para a estimativa fornecida na coluna [[<code class="literal">stat_value</code>]]</td> </tr><tr> <td>[[<code class="literal">table_name</code><code class="literal">stat_value</code>]</td> <td>Descrição da estatística que é nomeada na coluna [[<code class="literal">stat_name</code>]]</td> </tr></tbody></table>

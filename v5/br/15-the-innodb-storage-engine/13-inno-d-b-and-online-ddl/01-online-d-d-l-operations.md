...
<table summary="Suporte online para DDL de operações de chave primária, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><thead><tr> <th>Operação</th> <th>No lugar</th> <th>Reestruturar a tabela</th> <th>Permissões DML concorrentes</th> <th>Apenas modifica metadados</th> </tr></thead><tbody><tr> <th>Adicionar uma chave primária</th> <td>Sim*</td> <td>Sim*</td> <td>Sim</td> <td>Não</td> </tr><tr> <th>Remover uma chave primária</th> <td>Não</td> <td>Sim</td> <td>Não</td> <td>Não</td> </tr><tr> <th>Excluir uma chave primária e adicionar outra</th> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> </tr></tbody></table>
...
<table summary="Suporte online para DDL de operações de chave estrangeira, indicando se a operação é realizada no local, reconstrui a tabela, permite DML concorrente ou apenas modifica metadados."><col align="left" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><col align="center" style="width: 20%"/><thead><tr> <th>Operação</th> <th>No lugar</th> <th>Reestruturar a tabela</th> <th>Permissões DML concorrentes</th> <th>Apenas modifica metadados</th> </tr></thead><tbody><tr> <th>Adicionar uma restrição de chave estrangeira</th> <td>Sim*</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr><tr> <th>Excluir uma restrição de chave estrangeira</th> <td>Sim</td> <td>Não</td> <td>Sim</td> <td>Sim</td> </tr></tbody></table>
...
<table summary="Suporte online para DDL de particionamento que indica se a operação é realizada no local e permite DML concorrente."><col align="left" style="width: 24%"/><col align="center" style="width: 8%"/><col align="center" style="width: 12%"/><col align="left" style="width: 32%"/><thead><tr> <th>Cláusula de Partição</th> <th>No lugar</th> <th>Permissões DML</th> <th>Notas</th> </tr></thead><tbody><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[PH_HTML_CODE_<code>DROP PARTITION</code>]</a></th> <td>Não</td> <td>Não</td> <td>Permissões [[PH_HTML_CODE_<code>DROP PARTITION</code>], [[PH_HTML_CODE_<code>LOCK=DEFAULT</code>]</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[PH_HTML_CODE_<code>RANGE</code>]</a></th> <td>Não</td> <td>Não</td> <td>Apenas permite permissões [[PH_HTML_CODE_<code>LIST</code>], [[PH_HTML_CODE_<code>DISCARD PARTITION</code>]. Não copia dados existentes para tabelas particionadas por [[PH_HTML_CODE_<code>ALGORITHM=DEFAULT</code>] ou [[PH_HTML_CODE_<code>LOCK=DEFAULT</code>]. Consultas concorrentes são permitidas para tabelas particionadas por [[PH_HTML_CODE_<code>IMPORT PARTITION</code>] ou [[PH_HTML_CODE_<code>ALGORITHM=DEFAULT</code>]. O MySQL copia os dados enquanto mantém um bloqueio compartilhado.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>DROP PARTITION</code>]]</a></th> <td>Não</td> <td>Não</td> <td>Apenas permite permissões [[<code>ALGORITHM=COPY</code><code>DROP PARTITION</code>], [[<code>LOCK=DEFAULT</code>]]. Não copia dados existentes para tabelas particionadas por [[<code>RANGE</code>]] ou [[<code>LIST</code>]].</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>DISCARD PARTITION</code>]]</a></th> <td>Não</td> <td>Não</td> <td>Apenas autorizações [[<code>ALGORITHM=DEFAULT</code>]], [[<code>LOCK=DEFAULT</code>]]</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>IMPORT PARTITION</code>]]</a></th> <td>Não</td> <td>Não</td> <td>Apenas autorizações [[<code>ALGORITHM=DEFAULT</code>]], [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>DROP PARTITION</code>]</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>DROP PARTITION</code>]</a></th> <td>Sim</td> <td>Sim</td> <td>Não copia dados existentes. Ele apenas exclui linhas; ele não altera a definição da própria tabela ou de qualquer uma de suas partições.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>LOCK=DEFAULT</code>]</a></th> <td>Não</td> <td>Não</td> <td>Apenas permitem-se as permissões [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>RANGE</code>], [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>LIST</code>]. Consultas concorrentes são permitidas para tabelas particionadas por [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>DISCARD PARTITION</code>] ou [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>ALGORITHM=DEFAULT</code>], pois o MySQL copia os dados enquanto mantém um bloqueio compartilhado.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>LOCK=DEFAULT</code>]</a></th> <td>Não</td> <td>Não</td> <td>Apenas os permissões [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>IMPORT PARTITION</code>], [[<code>LOCK={DEFAULT|SHARED|EXCLUSIVE}</code><code>ALGORITHM=DEFAULT</code>] são permitidas. Consultas concorrentes são permitidas para tabelas particionadas por [[<code>ADD PARTITION</code><code>DROP PARTITION</code>] ou [[<code>ADD PARTITION</code><code>DROP PARTITION</code>]. O MySQL copia os dados das partições afetadas enquanto mantém uma trava de metadados compartilhada.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ADD PARTITION</code><code>LOCK=DEFAULT</code>]</a></th> <td>Sim</td> <td>Sim</td> <td></td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ADD PARTITION</code><code>RANGE</code>]</a></th> <td>Sim</td> <td>Sim</td> <td></td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ADD PARTITION</code><code>LIST</code>]</a></th> <td>Sim</td> <td>Sim</td> <td></td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ADD PARTITION</code><code>DISCARD PARTITION</code>]</a></th> <td>Não</td> <td>Não</td> <td>As cláusulas [[<code>ADD PARTITION</code><code>ALGORITHM=DEFAULT</code>] e [[<code>ADD PARTITION</code><code>LOCK=DEFAULT</code>] são ignoradas. Reconstrói toda a tabela. Veja<a class="xref" href="partitioning-maintenance.html" title="22.3.4 Manutenção de Partições">Seção 22.3.4, “Manutenção de Partições”</a>.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ADD PARTITION</code><code>IMPORT PARTITION</code>]</a></th> <td>Não</td> <td>Não</td> <td>Apenas permitem-se permissões [[<code>ADD PARTITION</code><code>ALGORITHM=DEFAULT</code>], [[<code>ALGORITHM=DEFAULT</code><code>DROP PARTITION</code>]. Consultas concorrentes são permitidas para tabelas particionadas por [[<code>ALGORITHM=DEFAULT</code><code>DROP PARTITION</code>] ou [[<code>ALGORITHM=DEFAULT</code><code>LOCK=DEFAULT</code>]. O MySQL copia os dados das partições afetadas enquanto mantém uma trava de metadados compartilhada.</td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ALGORITHM=DEFAULT</code><code>RANGE</code>]</a></th> <td>Sim</td> <td>Sim</td> <td></td> </tr><tr> <th><a class="link" href="alter-table.html" title="13.1.8 Declaração ALTER TABLE">[[<code>ALGORITHM=DEFAULT</code><code>LIST</code>]</a></th> <td>Não</td> <td>Não</td> <td>Permissões [[<code>ALGORITHM=DEFAULT</code><code>DISCARD PARTITION</code>], [[<code>ALGORITHM=DEFAULT</code><code>ALGORITHM=DEFAULT</code>]</td> </tr></tbody></table>

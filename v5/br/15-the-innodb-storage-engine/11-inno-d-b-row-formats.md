...
<table summary="Visão geral dos formatos de linha do InnoDB, incluindo uma descrição, recursos suportados e tipos de espaço de tabela suportados."><col style="width: 10%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><thead><tr> <th scope="col">Formato de linha</th> <th scope="col">Características de Armazenamento Compacto</th> <th scope="col">Armazenamento de Colunas com Variável Comprimento Aprimorado</th> <th scope="col">Suporte a prefixo de chave de índice grande</th> <th scope="col">Suporte de compressão</th> <th scope="col">Tipos de Espaço de Tabela suportados</th> <th scope="col">Formato de arquivo exigido</th> </tr></thead><tbody><tr> <th scope="row">[[<code class="literal">REDUNDANT</code>]]</th> <td>Não</td> <td>Não</td> <td>Não</td> <td>Não</td> <td>sistema, arquivo por tabela, geral</td> <td>Antílope ou Barracuda</td> </tr><tr> <th scope="row">[[<code class="literal">COMPACT</code>]]</th> <td>Sim</td> <td>Não</td> <td>Não</td> <td>Não</td> <td>sistema, arquivo por tabela, geral</td> <td>Antílope ou Barracuda</td> </tr><tr> <th scope="row">[[<code class="literal">DYNAMIC</code>]]</th> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Não</td> <td>sistema, arquivo por tabela, geral</td> <td>Barracuda</td> </tr><tr> <th scope="row">[[<code class="literal">COMPRESSED</code>]]</th> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>Sim</td> <td>arquivo por tabela, geral</td> <td>Barracuda</td> </tr></tbody></table>

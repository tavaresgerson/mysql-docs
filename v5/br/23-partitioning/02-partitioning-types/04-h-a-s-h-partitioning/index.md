...
O MySQL 5.7 também suporta uma variante de `HASH` partitioning conhecida como linear hashing, que emprega um algoritmo mais complexo para determinar o posicionamento de novas rows inseridas na tabela particionada. Consulte Seção 22.2.4.1, “LINEAR HASH Partitioning”, para obter uma descrição deste algoritmo.

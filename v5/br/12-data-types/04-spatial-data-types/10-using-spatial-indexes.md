...
Executar a instrução `SELECT` sem o índice espacial produz o mesmo resultado, mas faz com que o tempo de execução aumente de 0,00 segundos para 0,46 segundos:

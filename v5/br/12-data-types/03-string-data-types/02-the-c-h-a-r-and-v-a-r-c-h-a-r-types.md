...
<table summary="Ilustração da diferença entre os requisitos de armazenamento de CHAR e VARCHAR, mostrando o armazenamento necessário para vários valores de string nas colunas CHAR(4) e VARCHAR(4)."><col style="width: 15%"/><col style="width: 15%"/><col style="width: 20%"/><col style="width: 15%"/><col style="width: 20%"/><thead><tr> <th scope="col">Valor</th> <th scope="col">[[PH_HTML_CODE_<code class="literal">'abcd'</code>]</th> <th scope="col">Armazenamento necessário</th> <th scope="col">[[PH_HTML_CODE_<code class="literal">'abcd'</code>]</th> <th scope="col">Armazenamento necessário</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">'abcd'</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">'abcd'</code>]</td> <td>4 bytes</td> <td>[[<code class="literal">''</code>]]</td> <td>1 byte</td> </tr><tr> <th scope="row">[[<code class="literal">'ab'</code>]]</th> <td>[[<code class="literal">'ab  '</code>]]</td> <td>4 bytes</td> <td>[[<code class="literal">'ab'</code>]]</td> <td>3 bytes</td> </tr><tr> <th scope="row">[[<code class="literal">'abcd'</code>]]</th> <td>[[<code class="literal">'abcd'</code>]]</td> <td>4 bytes</td> <td>[[<code class="literal">'abcd'</code>]]</td> <td>5 bytes</td> </tr><tr> <th scope="row">[[<code class="literal">VARCHAR(4)</code><code class="literal">'abcd'</code>]</th> <td>[[<code class="literal">'abcd'</code>]]</td> <td>4 bytes</td> <td>[[<code class="literal">'abcd'</code>]]</td> <td>5 bytes</td> </tr></tbody></table>

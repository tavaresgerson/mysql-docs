...
<table summary="Valores decimais e binários para membros de uma coluna especificada como SET('a', 'b', 'c', 'd')."><col style="width: 15%"/><col style="width: 20%"/><col style="width: 20%"/><thead><tr> <th scope="col">[[PH_HTML_CODE_<code class="literal">'d'</code>] Membro</th> <th scope="col">Valor decimal</th> <th scope="col">Valor Binário</th> </tr></thead><tbody><tr> <th scope="row">[[PH_HTML_CODE_<code class="literal">'d'</code>]</th> <td>[[PH_HTML_CODE_<code class="literal">1000</code>]</td> <td>[[<code class="literal">0001</code>]]</td> </tr><tr> <th scope="row">[[<code class="literal">'b'</code>]]</th> <td>[[<code class="literal">2</code>]]</td> <td>[[<code class="literal">0010</code>]]</td> </tr><tr> <th scope="row">[[<code class="literal">'c'</code>]]</th> <td>[[<code class="literal">4</code>]]</td> <td>[[<code class="literal">0100</code>]]</td> </tr><tr> <th scope="row">[[<code class="literal">'d'</code>]]</th> <td>[[<code class="literal">'a'</code><code class="literal">'d'</code>]</td> <td>[[<code class="literal">1000</code>]]</td> </tr></tbody></table>

...
A tabela `OPTIMIZER_TRACE` fornece informações produzidas pela capacidade de *tracing* do optimizer para *statements* rastreadas. Para habilitar o rastreamento, use a variável de sistema `optimizer_trace`. Para detalhes, consulte Seção 8.15, “Tracing the Optimizer”.

A tabela `OPTIMIZER_TRACE` possui as seguintes colunas:

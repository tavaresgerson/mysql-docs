...
- `PAGE_TYPE`
  ...
  **Tabela 24.4 Valores de INNODB\_BUFFER\_PAGE.PAGE\_TYPE**
  ...
  <table summary="Mapeamento para a interpretação dos valores de INNODB_BUFFER_PAGE.PAGE_TYPE."><col style="width: 30%"/><col style="width: 30%"/><thead><tr> <th>Tipo de página</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[PH_HTML_CODE_<code class="literal">INODE</code>]</td> <td>Página recém-atribuída</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">INODE</code>]</td> <td>Página BLOB não compactada</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">SYSTEM</code>]</td> <td>Página de comp BLOB subsequente</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">TRX_SYSTEM</code>]</td> <td>Primeira página compactada BLOB</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">UNDO_LOG</code>]</td> <td>Página de descrição do alcance</td> </tr><tr> <td>[[PH_HTML_CODE_<code class="literal">UNKNOWN</code>]</td> <td>Cabeçalho de espaço de arquivo</td> </tr><tr> <td>[[<code class="literal">IBUF_BITMAP</code>]]</td> <td>Insira a bitmap de buffer</td> </tr><tr> <td>[[<code class="literal">IBUF_FREE_LIST</code>]]</td> <td>Insira a lista de buffers livres</td> </tr><tr> <td>[[<code class="literal">IBUF_INDEX</code>]]</td> <td>Insira o índice do buffer</td> </tr><tr> <td>[[<code class="literal">INDEX</code>]]</td> <td>nó de árvore B</td> </tr><tr> <td>[[<code class="literal">INODE</code>]]</td> <td>Nó do índice</td> </tr><tr> <td>[[<code class="literal">BLOB</code><code class="literal">INODE</code>]</td> <td>Índice R-tree</td> </tr><tr> <td>[[<code class="literal">SYSTEM</code>]]</td> <td>Página do sistema</td> </tr><tr> <td>[[<code class="literal">TRX_SYSTEM</code>]]</td> <td>Dados do sistema de transações</td> </tr><tr> <td>[[<code class="literal">UNDO_LOG</code>]]</td> <td>Desfazer página de log</td> </tr><tr> <td>[[<code class="literal">UNKNOWN</code>]]</td> <td>Desconhecido</td> </tr></tbody></table>
...
- `PAGE_STATE`
  ...
  **Tabela 24.5 Valores de INNODB\_BUFFER\_PAGE.PAGE\_STATE**
  ...
  <table summary="Mapeamento para a interpretação dos valores de INNODB_BUFFER_PAGE.PAGE_STATE."><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>Estado de Page</th> <th>Descrição</th> </tr></thead><tbody><tr> <td>[[<code class="literal">FILE_PAGE</code>]]</td> <td>Uma página de arquivo com buffer</td> </tr><tr> <td>[[<code class="literal">MEMORY</code>]]</td> <td>Contém um objeto de memória principal</td> </tr><tr> <td>[[<code class="literal">NOT_USED</code>]]</td> <td>Na lista gratuita</td> </tr><tr> <td>[[<code class="literal">NULL</code>]]</td> <td>Páginas compactadas limpas, páginas compactadas na lista de limpeza, páginas usadas como sentinelas de monitoramento do pool de buffer</td> </tr><tr> <td>[[<code class="literal">READY_FOR_USE</code>]]</td> <td>Uma página gratuita</td> </tr><tr> <td>[[<code class="literal">REMOVE_HASH</code>]]</td> <td>O índice de hash deve ser removido antes de ser colocado na lista gratuita</td> </tr></tbody></table>

...
* Fatores gerais que afetam a segurança. Esses incluem a escolha de senhas boas, não conceder privilégios desnecessários aos usuários, garantir a segurança dos aplicativos, prevenindo injeções SQL e corrupção de dados, entre outros. Veja a Seção 6.1, “Problemas Gerais de Segurança”.

...
Além disso, `MAX_ROWS` e `MIN_ROWS` podem ser usados para determinar o número máximo e mínimo de linhas, respectivamente, que podem ser armazenadas em cada partição. Consulte a Seção 22.3, “Gestão de Partições”, para obter mais informações sobre essas opções.

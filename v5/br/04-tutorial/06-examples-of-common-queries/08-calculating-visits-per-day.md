### 3.6.8 Cálculo de visitas por dia

O exemplo a seguir mostra como você pode usar as funções do grupo de bits para calcular o número de dias por mês em que um usuário visitou uma página da Web.

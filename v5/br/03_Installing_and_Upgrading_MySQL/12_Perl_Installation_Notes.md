...
A interface `DBI`/`DBD` requer o Perl 5.6.0, e o 5.6.1 ou posterior é preferido. O DBI *não funciona* se você tiver uma versão mais antiga do Perl. Você deve usar `DBD::mysql` 4.009 ou superior. Embora versões anteriores estejam disponíveis, elas não suportam a funcionalidade completa do MySQL 5.7.

### 2.12.1 Instalar Perl em Unix
...
### 2.12.2 Instalar o ActiveState Perl no Windows

...
A cláusula `WHERE`, se presente, é avaliada em relação aos nomes de coluna exibidos pela declaração `SHOW`. Por exemplo, a declaração `SHOW CHARACTER SET` produz essas colunas de saída:

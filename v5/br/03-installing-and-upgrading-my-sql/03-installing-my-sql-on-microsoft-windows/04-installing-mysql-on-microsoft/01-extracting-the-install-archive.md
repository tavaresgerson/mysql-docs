...
1. Se você estiver atualizando de uma versão anterior, consulte a Seção 2.10.8, “Atualizando o MySQL no Windows”, antes de iniciar o processo de atualização.
2. Certifique-se de que você está logado como um usuário com privilégios de administrador.
3. Escolha um local de instalação. Tradicionalmente, o servidor MySQL é instalado em `C:\mysql`. Se você não instalar o MySQL em `C:\mysql`, você deve especificar o caminho para o diretório de instalação durante a inicialização ou em um arquivo de opção. Veja a Seção 2.3.4.2, “Criando um arquivo de opção”.

...
<table frame="all"><col style="width: 35%"/><col style="width: 25%"/><thead><tr> <th>Nome do pacote</th> <th>Resumo</th> </tr></thead><tbody><tr> <td>[[<code class="literal">mysql-community-server</code>]]</td> <td>Servidor de banco de dados e ferramentas relacionadas</td> </tr><tr> <td>[[<code class="literal">mysql-community-client</code>]]</td> <td>Aplicativos e ferramentas de cliente MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-community-common</code>]]</td> <td>Arquivos comuns para bibliotecas de servidor e cliente</td> </tr><tr> <td>[[<code class="literal">mysql-community-devel</code>]]</td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para aplicações cliente de banco de dados MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-community-libs</code>]]</td> <td>Bibliotecas compartilhadas para aplicações de clientes de banco de dados MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-community-libs-compat</code>]]</td> <td>Bibliotecas de compatibilidade compartilhadas para instalações anteriores do MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-community-embedded</code>]]</td> <td>Biblioteca integrada MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-community-embedded-devel</code>]]</td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para MySQL como uma biblioteca incorporável</td> </tr><tr> <td>[[<code class="literal">mysql-community-test</code>]]</td> <td>Conjunto de testes para o servidor MySQL</td> </tr></tbody></table>

**Tabela 2.10 Pacotes RPM para a Edição Empresarial do MySQL**

<table frame="all"><col style="width: 35%"/><col style="width: 25%"/><thead><tr> <th>Nome do pacote</th> <th>Resumo</th> </tr></thead><tbody><tr> <td>[[<code class="literal">mysql-commercial-server</code>]]</td> <td>Servidor de banco de dados e ferramentas relacionadas</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-client</code>]]</td> <td>Aplicativos e ferramentas de cliente MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-common</code>]]</td> <td>Arquivos comuns para bibliotecas de servidor e cliente</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-devel</code>]]</td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para aplicações cliente de banco de dados MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-libs</code>]]</td> <td>Bibliotecas compartilhadas para aplicações de clientes de banco de dados MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-libs-compat</code>]]</td> <td>Bibliotecas de compatibilidade compartilhadas para instalações anteriores do MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-embedded</code>]]</td> <td>Biblioteca integrada MySQL</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-embedded-devel</code>]]</td> <td>Arquivos de cabeçalho e bibliotecas de desenvolvimento para MySQL como uma biblioteca incorporável</td> </tr><tr> <td>[[<code class="literal">mysql-commercial-test</code>]]</td> <td>Conjunto de testes para o servidor MySQL</td> </tr></tbody></table>
...
<table><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>distribuição Valor</th> <th>Uso pretendido</th> </tr></thead><tbody><tr> <td>el<em class="replaceable">[[<code>{version}</code>]]</em>onde<em class="replaceable">[[<code>{version}</code>]]</em>é a principal versão do Enterprise Linux, como [[<code class="literal">el8</code>]]</td> <td>Plataformas baseadas no EL6 (8.0), EL7, EL8, EL9 e EL10 (por exemplo, as versões correspondentes do Oracle Linux, Red Hat Enterprise Linux e CentOS)</td> </tr><tr> <td>[[<code class="literal">sles12</code>]]</td> <td>SUSE Linux Enterprise Server 12</td> </tr></tbody></table>
...
<table><col style="width: 55%"/><col style="width: 45%"/><thead><tr> <th>Arquivos ou Recursos</th> <th>Localização</th> </tr></thead><tbody><tr> <td>Programas e scripts para clientes</td> <td>[[PH_HTML_CODE_<code class="filename">mysqld</code>]</td> </tr><tr> <td><a class="link" href="mysqld.html" title="4.3.1 mysqld — O Servidor MySQL"><span class="command"><strong>mysqld</strong></span></a>servidor</td> <td>[[PH_HTML_CODE_<code class="filename">mysqld</code>]</td> </tr><tr> <td>Arquivo de configuração</td> <td>[[PH_HTML_CODE_<code class="filename"> /var/run/mysql/mysqld.pid</code>]</td> </tr><tr> <td>Diretório de dados</td> <td>[[PH_HTML_CODE_<code class="filename">/var/lib/mysql/mysql.sock</code>]</td> </tr><tr> <td>Arquivo de registro de erros</td> <td><p>Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: [[PH_HTML_CODE_<code class="filename">/var/lib/mysql-keyring</code>]</p><p>Para SLES: [[PH_HTML_CODE_<code class="filename">/usr/share/man</code>]</p></td> </tr><tr> <td>Valor de<a class="link" href="server-system-variables.html#sysvar_secure_file_priv">[[PH_HTML_CODE_<code class="filename">/usr/include/mysql</code>]</a></td> <td>[[PH_HTML_CODE_<code class="filename">/usr/lib/mysql</code>]</td> </tr><tr> <td>Roteiro de inicialização do Sistema V</td> <td><p>Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: [[PH_HTML_CODE_<code class="filename">/usr/share/mysql</code>]</p><p>Para SLES: [[<code class="filename">/etc/init.d/mysql</code>]]</p></td> </tr><tr> <td>Serviço Systemd</td> <td><p>Para plataformas RHEL, Oracle Linux, CentOS ou Fedora: [[<code class="filename">mysqld</code>]]</p><p>Para SLES: [[<code class="filename">/usr/sbin</code><code class="filename">mysqld</code>]</p></td> </tr><tr> <td>Arquivo Pid</td> <td>[[<code class="filename"> /var/run/mysql/mysqld.pid</code>]]</td> </tr><tr> <td>Soquete</td> <td>[[<code class="filename">/var/lib/mysql/mysql.sock</code>]]</td> </tr><tr> <td>Diretório de carteiras de identificação</td> <td>[[<code class="filename">/var/lib/mysql-keyring</code>]]</td> </tr><tr> <td>Páginas de manual do Unix</td> <td>[[<code class="filename">/usr/share/man</code>]]</td> </tr><tr> <td>Incluir arquivos (cabeçalho)</td> <td>[[<code class="filename">/usr/include/mysql</code>]]</td> </tr><tr> <td>Livrarias</td> <td>[[<code class="filename">/usr/lib/mysql</code>]]</td> </tr><tr> <td>Arquivos de suporte variados (por exemplo, mensagens de erro e arquivos de conjunto de caracteres)</td> <td>[[<code class="filename">/usr/share/mysql</code>]]</td> </tr></tbody></table>

...
A seguinte chave de compilação pública do GPG (keyID `5072E1F5`) pode ser usada para verificar a autenticidade e a integridade dos pacotes do MySQL 5.7.36 e anteriores. Para instruções de verificação de assinatura, consulte a Seção 2.1.4.2, “Verificação de Assinatura Usando o GnuPG”.

##### Chave de construção pública do GPG para pacotes do MySQL 5.7.36 e versões anteriores

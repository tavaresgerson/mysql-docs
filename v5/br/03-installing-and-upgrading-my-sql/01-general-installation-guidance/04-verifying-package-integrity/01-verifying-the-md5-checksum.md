...
Certifique-se de verificar o checksum do *arquivo de arquivo* (por exemplo, o arquivo `.zip`, `.tar.gz` ou `.msi`) e não dos arquivos contidos dentro do arquivo. Em outras palavras, verifique o arquivo antes de extrair seu conteúdo.

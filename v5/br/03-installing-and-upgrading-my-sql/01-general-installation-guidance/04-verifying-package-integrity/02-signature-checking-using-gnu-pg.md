...
<table><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>Tipo de arquivo</th> <th>Nome do arquivo</th> </tr></thead><tbody><tr> <td>Arquivo de distribuição</td> <td>[[<code class="literal">mysql-standard-5.7.44-linux-i686.tar.gz</code>]]</td> </tr><tr> <td>Arquivo de assinatura</td> <td>[[<code class="literal">mysql-standard-5.7.44-linux-i686.tar.gz.asc</code>]]</td> </tr></tbody></table>

...
<table><col style="width: 25%"/><col style="width: 75%"/><thead><tr> <th>Tipo de arquivo</th> <th>Nome do arquivo</th> </tr></thead><tbody><tr> <td>Arquivo de distribuição</td> <td>[[<code class="literal">mysql-installer-community-5.7.44.msi</code>]]</td> </tr><tr> <td>Arquivo de assinatura</td> <td>[[<code class="literal">mysql-installer-community-5.7.44.msi.asc</code>]]</td> </tr></tbody></table>

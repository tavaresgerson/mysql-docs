...
5. Como administrador, execute o **mysql\_upgrade** para verificar suas tabelas, tente repará-las, se necessário, e atualize suas tabelas de concessão se elas tiverem sido alteradas, para que você possa aproveitar quaisquer novas funcionalidades. Veja a Seção 4.4.7, “mysql\_upgrade — Verificar e Atualizar Tabelas MySQL”.

...
O privilégio RELOAD ou FLUSH_TABLES é necessário com `--single-transaction` se ambos gtid_mode=ON e --set-gtid=purged=ON|AUTO. Esse requisito foi adicionado no MySQL 8.0.32.

...
1. Find the next power of 2 greater than
   ...
   *`V`*; it can be calculated as:
   ...
   [`LOG(2,13)`](mathematical-functions.html#function_log) is
   3.7004397181411.
   [`CEILING(3.7004397181411)`](mathematical-functions.html#function_ceiling) is
   4, and *`V`* =
   [`POWER(2,4)`](mathematical-functions.html#function_power), which is 16.)

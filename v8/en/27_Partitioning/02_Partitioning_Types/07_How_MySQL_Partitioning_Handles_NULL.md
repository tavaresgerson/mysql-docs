...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements using the
following query against the
[`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table in the
...
[Section 28.3.21, “The INFORMATION\_SCHEMA PARTITIONS Table”](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table").) Now let
...
[`INFORMATION_SCHEMA.PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") and
...
PARTITION`, see [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement").)
...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement such as this one:
...
[`INFORMATION_SCHEMA.PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table"), you
...
[`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table once again, we can

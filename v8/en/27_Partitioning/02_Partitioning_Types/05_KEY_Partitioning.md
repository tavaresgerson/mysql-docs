...
* `KEY` takes only a list of zero or more
  ...
  TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") or in the
  ...
  [Column index prefixes not supported for key partitioning](partitioning-limitations.html#partitioning-limitations-prefixes "Column index prefixes not supported for key partitioning"), for
  more information and examples.

  Note

  Tables using the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
  ...
  key generated by the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
  storage engine for each NDB Cluster table is used as the
  partitioning key.

  If you define an explicit partitioning scheme for an
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table, the table must
  ...
  partitioning key. See [Chapter 25, *MySQL NDB Cluster 8.0*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0").

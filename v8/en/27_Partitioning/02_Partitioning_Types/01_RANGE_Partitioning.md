...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement that provides for all values greater
...
[`ALTER
TABLE`](alter-table-partition-operations.html "15.1.9.1 ALTER TABLE Partition Operations") statement to add new partitions for stores
...
* You want or need to delete “old” data. If you
  ...
  [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement"), and

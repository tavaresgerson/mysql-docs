...
You can make the [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema the
...
(The [`version`](sys-version.html "30.4.3.47 The version View") view shows the
[`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema and MySQL server
versions.)

To access [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema objects while a
...
example, the [`host_summary_by_file_io`](sys-host-summary-by-file-io.html "30.4.3.2 The host_summary_by_file_io and x$host_summary_by_file_io Views")
...
[Section 30.4.3, “sys Schema Views”](sys-schema-views.html "30.4.3 sys Schema Views").

To examine [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema object
definitions, use the appropriate
[`SHOW`](show.html "15.7.7 SHOW Statements") statement or
[`INFORMATION_SCHEMA`](information-schema.html "Chapter 28 INFORMATION_SCHEMA Tables") query. For
example, to examine the definitions of the
[`session`](sys-session.html "30.4.3.33 The session and x$session Views") view and
[`format_bytes()`](sys-format-bytes.html "30.4.5.3 The format_bytes() Function") function, use these
statements:
...
[`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema development website at
<https://github.com/mysql/mysql-sys>.

Neither [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") nor
[**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program") dump the
[`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema by default. To generate a
dump file, name the [`sys`](sys-schema.html "Chapter 30 MySQL sys Schema") schema

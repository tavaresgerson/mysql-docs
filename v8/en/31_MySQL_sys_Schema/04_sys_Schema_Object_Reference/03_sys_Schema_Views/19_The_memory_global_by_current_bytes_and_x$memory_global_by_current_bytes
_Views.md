...
and
[`x$memory_global_by_current_bytes`](sys-memory-global-by-current-bytes.html "30.4.3.19 The memory_global_by_current_bytes and x$memory_global_by_current_bytes Views")

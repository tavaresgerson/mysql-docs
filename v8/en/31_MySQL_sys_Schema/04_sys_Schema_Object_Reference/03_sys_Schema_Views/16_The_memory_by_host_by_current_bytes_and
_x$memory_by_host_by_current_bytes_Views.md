...
The
[`memory_by_host_by_current_bytes`](sys-memory-by-host-by-current-bytes.html "30.4.3.16 The memory_by_host_by_current_bytes and x$memory_by_host_by_current_bytes Views")
and
[`x$memory_by_host_by_current_bytes`](sys-memory-by-host-by-current-bytes.html "30.4.3.16 The memory_by_host_by_current_bytes and x$memory_by_host_by_current_bytes Views")

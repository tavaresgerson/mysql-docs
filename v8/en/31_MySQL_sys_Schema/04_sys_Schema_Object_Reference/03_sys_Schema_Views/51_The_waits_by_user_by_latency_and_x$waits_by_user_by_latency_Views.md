...
The [`waits_by_user_by_latency`](sys-waits-by-user-by-latency.html "30.4.3.51 The waits_by_user_by_latency and x$waits_by_user_by_latency Views") and
[`x$waits_by_user_by_latency`](sys-waits-by-user-by-latency.html "30.4.3.51 The waits_by_user_by_latency and x$waits_by_user_by_latency Views") views
have these columns:

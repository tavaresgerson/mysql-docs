...
* `diagnostics.allow_i_s_tables`,
  ...
  [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table") table. This can be
...
* `statement_performance_analyzer.view`,
  ...
  [`statement_performance_analyzer()`](sys-statement-performance-analyzer.html "30.4.4.25 The statement_performance_analyzer() Procedure")

...
As of MySQL 8.0.16,
[`format_time()`](sys-format-time.html "30.4.5.6 The format_time() Function") is deprecated
and subject to removal in a future MySQL version.
Applications that use it should be migrated to use the
built-in [`FORMAT_PICO_TIME()`](performance-schema-functions.html#function_format-pico-time)

...
1. On the management host, issue the following command from the
   ...
   The first time that it is started, [**ndb\_mgmd**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon")
   ...
   see [Section 25.5.4, “ndb\_mgmd — The NDB Cluster Management Server Daemon”](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon"), for
   details.

2. On each of the data node hosts, run this command to start the
   [**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") process:
...
invoking the [**ndb\_mgm**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client") management node client.
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is acting as an NDB Cluster API
node.
...
in NDB Cluster. See
[Section 25.3.5, “NDB Cluster Example with Tables and Data”](mysql-cluster-install-example-data.html "25.3.5 NDB Cluster Example with Tables and Data"), for a brief
discussion.
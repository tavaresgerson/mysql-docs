...
[**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") from the command line on the
...
for [**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon"). However, it is preferable
...
the output of [**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon")
...
Alternatively, invoke [**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") with the
...
[**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon")
...
Alternatively, invoke [**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") with the
...
As with [**ndb\_mgmd.exe**](mysql-cluster-programs-ndb-mgmd.html "25.5.4 ndb_mgmd — The NDB Cluster Management Server Daemon") (and
[**mysqld.exe**](mysqld.html "6.3.1 mysqld — The MySQL Server")), when installing
[**ndbd.exe**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") as a Windows service, you can also
...
in a similar fashion, using [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
`--install`, **SC START**,

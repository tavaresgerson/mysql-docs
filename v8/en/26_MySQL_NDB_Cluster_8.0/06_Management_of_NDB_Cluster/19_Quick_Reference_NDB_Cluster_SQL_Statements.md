...
* [`SHOW ENGINE NDB
  ...
  See [Section 15.7.7.15, “SHOW ENGINE Statement”](show-engine.html "15.7.7.15 SHOW ENGINE Statement"), for a usage example and
  more detailed information.

* [`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement")

  This statement can be used to determine whether or not
  clustering support is enabled in the MySQL server, and if so,
  whether it is active.

  See [Section 15.7.7.16, “SHOW ENGINES Statement”](show-engines.html "15.7.7.16 SHOW ENGINES Statement"), for more detailed
  information.
...
* `SELECT * FROM INFORMATION_SCHEMA.ENGINES [WHERE
  ...
  ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement"), but uses the
  ...
  case with the [`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement")
  ...
  server was built with [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") support
...
* `SHOW VARIABLES LIKE 'NDB%'`
  ...
  relating to the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
...
* `SELECT * FROM performance_schema.global_variables
  ...
  VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") statement, it is possible to select
...
* `SHOW STATUS LIKE 'NDB%'`
  ...
  See also [Section 15.7.7.37, “SHOW STATUS Statement”](show-status.html "15.7.7.37 SHOW STATUS Statement").

* `SELECT * FROM performance_schema.global_status WHERE
  VARIABLE_NAME LIKE 'NDB%'`

  This statement provides similar output to the
  [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") statement discussed
  in the previous item. Unlike the case with
  [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), it is possible
...
* `SELECT * FROM INFORMATION_SCHEMA.PLUGINS WHERE
  ...
  Schema [`PLUGINS`](information-schema-plugins-table.html "28.3.22 The INFORMATION_SCHEMA PLUGINS Table") table about
  ...
  *************************** 3. row ***************************
  ...
  PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") statement to display this information, but
  the output from that statement cannot easily be filtered. See
  also [The MySQL Plugin API](/doc/extending-mysql/8.0/en/plugin-api.html), which describes where and
  how the information in the
  [`PLUGINS`](information-schema-plugins-table.html "28.3.22 The INFORMATION_SCHEMA PLUGINS Table") table is obtained.

You can also query the tables in the
[`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.16 ndbinfo: The NDB Cluster Information Database") information database for

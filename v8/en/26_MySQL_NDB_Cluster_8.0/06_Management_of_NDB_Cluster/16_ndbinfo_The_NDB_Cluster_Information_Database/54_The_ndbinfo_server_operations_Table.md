...
for all ongoing [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") operations that
the current SQL node (MySQL Server) is currently involved in. It
effectively is a subset of the
[`cluster_operations`](mysql-cluster-ndbinfo-cluster-operations.html "25.6.16.7 The ndbinfo cluster_operations Table") table, in
...
[`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement"). It is obtained
...
[`getTransactionId()`](/doc/ndbapi/en/ndb-ndbtransaction.html#ndb-ndbtransaction-gettransactionid)
...
running with
[`ndbinfo_show_hidden`](mysql-cluster-options-variables.html#sysvar_ndbinfo_show_hidden) enabled,
...
number seen in the output of [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables")
[`--extra-partition-info`](mysql-cluster-programs-ndb-desc.html#option_ndb_desc_extra-partition-info) (short
form `-p`).

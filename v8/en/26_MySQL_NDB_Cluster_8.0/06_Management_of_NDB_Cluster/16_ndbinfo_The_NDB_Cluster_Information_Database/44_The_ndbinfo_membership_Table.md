...
[**ndb\_mgm -e "SHOW"**](mysql-cluster-programs-ndb-mgm.html "25.5.5 ndb_mgm — The NDB Cluster Management Client").
...
[NDB Cluster Start Phases](/doc/ndb-internals/en/ndb-internals-start-phases.html)). If the president
...
[`ArbitrationRank`](mysql-cluster-mgm-definition.html#ndbparam-mgmd-arbitrationrank) equal to

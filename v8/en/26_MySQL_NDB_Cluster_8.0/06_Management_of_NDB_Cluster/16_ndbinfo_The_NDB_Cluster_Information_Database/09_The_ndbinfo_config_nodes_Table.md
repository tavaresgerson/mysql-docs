...
obtained from the [`nodes`](mysql-cluster-ndbinfo-nodes.html "25.6.16.47 The ndbinfo nodes Table") and
[`processes`](mysql-cluster-ndbinfo-processes.html "25.6.16.50 The ndbinfo processes Table") table.

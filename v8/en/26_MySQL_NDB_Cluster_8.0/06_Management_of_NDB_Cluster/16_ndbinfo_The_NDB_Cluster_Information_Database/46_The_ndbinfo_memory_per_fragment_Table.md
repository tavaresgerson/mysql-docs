...
* `type`
  ...
  [`ndbinfo.dict_obj_types`](mysql-cluster-ndbinfo-dict-obj-types.html "25.6.16.26 The ndbinfo dict_obj_types Table") in
...
* `block_instance`
  ...
  [`threadblocks`](mysql-cluster-ndbinfo-threadblocks.html "25.6.16.61 The ndbinfo threadblocks Table") table.

...
the [`cluster_transactions`](mysql-cluster-ndbinfo-cluster-transactions.html "25.6.16.8 The ndbinfo cluster_transactions Table")
...
[`DBTC`](/doc/ndb-internals/en/ndb-internals-kernel-blocks-dbtc.html) kernel block instance
number. You can use this to obtain information about specific
threads from the [`threadblocks`](mysql-cluster-ndbinfo-threadblocks.html "25.6.16.61 The ndbinfo threadblocks Table")
table.
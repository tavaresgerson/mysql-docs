...
column of the [`ndbinfo.nodes`](mysql-cluster-ndbinfo-nodes.html "25.6.16.47 The ndbinfo nodes Table")
table.
...
* **Phase 1.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") kernel blocks are started.

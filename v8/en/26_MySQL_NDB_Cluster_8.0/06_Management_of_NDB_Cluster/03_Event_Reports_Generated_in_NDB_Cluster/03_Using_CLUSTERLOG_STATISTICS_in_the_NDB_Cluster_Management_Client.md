...
The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") management client's
[`CLUSTERLOG STATISTICS`](mysql-cluster-logging-management-commands.html "25.6.3.1 NDB Cluster Logging Management Commands")
...
[**ndbd**](mysql-cluster-programs-ndbd.html "25.5.1 ndbd — The NDB Cluster Data Node Daemon") process has a scheduler which also
...
the following command in the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
management client:

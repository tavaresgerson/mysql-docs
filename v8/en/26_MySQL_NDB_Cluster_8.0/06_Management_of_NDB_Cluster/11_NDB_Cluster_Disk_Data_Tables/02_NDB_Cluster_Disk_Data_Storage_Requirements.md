...
* Variable-length columns of Disk Data tables take up a fixed
  ...
  Schema [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table. For more
  ...
  The [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement")
...
* In a Disk Data table, the first 256 bytes of a
  ...
  [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") column are stored in
...
* Each row in a Disk Data table uses 8 bytes in memory to
  ...
  [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) used per
...
[`diskpagebuffer`](mysql-cluster-ndbinfo-diskpagebuffer.html "25.6.16.30 The ndbinfo diskpagebuffer Table") table to help

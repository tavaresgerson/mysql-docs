...
1. We create a log file group named `lg_1`
   using [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement").
   ...
   `undo_1.log` to `lg_1`
   in this [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement")
   statement:
   ...
   * Every [`CREATE LOGFILE
     GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement") and [`ALTER LOGFILE
     GROUP`](alter-logfile-group.html "15.1.6 ALTER LOGFILE GROUP Statement") statement must include an
     `ENGINE` option. The only permitted
     values for this option are
     [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") and
   ...
   * When you add an undo log file to a log file group using
     ...
     *`node_id`* is the node ID of the
     ...
     LOGFILE GROUP`](alter-logfile-group.html "15.1.6 ALTER LOGFILE GROUP Statement") statement just shown creates 4
   ...
   * See [Section 15.1.16, “CREATE LOGFILE GROUP Statement”](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement"), and
     [Section 15.1.6, “ALTER LOGFILE GROUP Statement”](alter-logfile-group.html "15.1.6 ALTER LOGFILE GROUP Statement"), for more
...
2. Now we can create a tablespace—an abstract container
   ...
   The [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement")
   statement creates a tablespace `ts_1` with
   the data file `data_1.dat`, and
   associates `ts_1` with log file group
   `lg_1`. The [`ALTER
   TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") adds the second data file
   (`data_2.dat`).
   ...
   * When you add a data file to a tablespace using
     ...
     *`node_id`* is the node ID of the
     ...
     TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") statement just shown creates 4 data
   ...
   * [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement")
     ...
     [`ALTER TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement"), an
   ...
   * For more information about the
     ...
     statements, see [Section 15.1.21, “CREATE TABLESPACE Statement”](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement"), and
...
3. Now it is possible to create a table whose unindexed columns
   ...
   [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine to use
   ...
   [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"), for more information.
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") confirms that

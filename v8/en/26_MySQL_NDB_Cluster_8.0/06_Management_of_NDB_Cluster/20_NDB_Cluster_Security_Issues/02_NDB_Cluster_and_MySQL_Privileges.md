...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, databases containing
...
* Execute metadata statements such as
  [`SHOW DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") statement (to
  obtain a list of all [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables in a given database
...
3. Once a MySQL user is granted privileges on an
   [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table from one SQL node in

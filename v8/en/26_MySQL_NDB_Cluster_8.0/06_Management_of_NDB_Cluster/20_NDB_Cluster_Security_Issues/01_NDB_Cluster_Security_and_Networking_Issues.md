...
* SQL or API nodes using “free slots” created by
  ...
  [elsewhere in this
  chapter](mysql-cluster-api-definition.html#ndbparam-api-hostname) about the `HostName`
  parameter. Also see [Section 25.4.1, “Quick Test Setup of NDB Cluster”](mysql-cluster-quick.html "25.4.1 Quick Test Setup of NDB Cluster"),

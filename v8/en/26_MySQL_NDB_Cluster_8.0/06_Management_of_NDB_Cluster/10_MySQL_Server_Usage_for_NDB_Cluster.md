...
built with support for the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
Cluster support, the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine enabled is
to issue the [`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement") statement
...
value in the row for [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"). If
you see `NO` in this row or if there is no such
row displayed in the output, you are not running an
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")-enabled version of MySQL. If you
...
PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement"). If the MySQL server is connected to the
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, *nor is it
...
as [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables while the SQL node is

...
* An SQL dump file such as produced by
  ...
  This can be imported using the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
...
TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statements, [`DROP
DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") statements, or both. Failing to do so may leave

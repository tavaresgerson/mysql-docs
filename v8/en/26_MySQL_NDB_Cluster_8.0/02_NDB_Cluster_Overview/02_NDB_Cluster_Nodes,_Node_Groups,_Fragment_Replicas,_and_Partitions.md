...
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables automatically.
However, it is also possible to employ user-defined partitioning
with [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. This is
...
2. The maximum number of partitions that may be defined
   explicitly for any [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table is
   `8 * [number of LDM

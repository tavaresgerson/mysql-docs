...
* **Range scans.**
  ...
  access to the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
...
* **Reliability of Records in range.**
  ...
  the execution plan. See [Section 10.9.4, “Index Hints”](index-hints.html "10.9.4 Index Hints"), for

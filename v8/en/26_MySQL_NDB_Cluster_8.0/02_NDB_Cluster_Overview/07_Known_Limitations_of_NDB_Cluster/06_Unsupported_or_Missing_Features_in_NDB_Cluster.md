...
supported for [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. Trying to
...
* **Index prefixes.**
  ...
  [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"), the prefix is
  not created by `NDB`.
...
handling in [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0").
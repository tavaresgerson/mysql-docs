...
* **Transactions and BLOB or TEXT columns.**
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") stores only part
  ...
  2. For any [`SELECT`](select.html "15.2.13 SELECT Statement") which uses
     ...
     [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables having
     [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") or
...
* **Transactions and memory usage.**
  ...
  + [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") is not
    transactional when used on
    [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. If a
    [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") fails to
  ...
  + `DELETE FROM` (even with no
    ...
    TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") instead.
  ...
  + **LOAD DATA statements.**
    ...
    [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") engine performs
  ...
  + **ALTER TABLE and transactions.**
    When copying an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table
    as part of an [`ALTER
    TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), the creation of the copy is
...
* **Transactions and the COUNT() function.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. (See Bug

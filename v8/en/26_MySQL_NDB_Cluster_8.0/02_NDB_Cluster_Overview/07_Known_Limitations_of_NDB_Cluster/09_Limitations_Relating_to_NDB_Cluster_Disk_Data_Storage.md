...
* The minimum and maximum possible sizes of extents for
  ...
  [Section 15.1.21, “CREATE TABLESPACE Statement”](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement"), for more information.
...
* Data files use
  [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory). Usage is

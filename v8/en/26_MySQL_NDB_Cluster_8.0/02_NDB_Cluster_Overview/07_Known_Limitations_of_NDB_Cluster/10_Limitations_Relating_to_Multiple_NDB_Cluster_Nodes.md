...
* **Stored programs not distributed.**
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine, but these
...
* **No distributed table locks.**
  A [`LOCK TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") statement or
...
* **ALTER TABLE operations.**
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") is not fully
...
`config.ini` file. See
[Section 25.4.3.10, “NDB Cluster TCP/IP Connections”](mysql-cluster-tcp-definition.html "25.4.3.10 NDB Cluster TCP/IP Connections"), for more
information.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table is not automatically
recovered when deleted, as it is with other storage engines.
Instead, the following rules hold true:

* A [`DELETE`](delete.html "15.2.2 DELETE Statement") statement on an
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table makes the memory
...
* A [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") or
  [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") operation on
  an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table frees the memory
  that was used by this table for re-use by any
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table, either by the same
  table or by another [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table.

  Note

  Recall that [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement")
...
* **Limits imposed by the cluster's configuration.**
  ...
  [Section 25.4.3, “NDB Cluster Configuration Files”](mysql-cluster-config-file.html "25.4.3 NDB Cluster Configuration Files"). Most
  ...
  + Database memory size and index memory size
    ...
    [`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) page
    is used, it is assigned to a specific table; once
    allocated, this memory cannot be freed except by
    dropping the table.

    See [Section 25.4.3.6, “Defining NDB Cluster Data Nodes”](mysql-cluster-ndbd-definition.html "25.4.3.6 Defining NDB Cluster Data Nodes"), for
    more information.
  ...
  + The maximum number of operations that can be performed
    ...
    TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"), and [`ALTER
    TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") are handled as special cases by
...
* **Node and data object maximums.**
  ...
  See [Section 25.2.7.11, “Previous NDB Cluster Issues Resolved in NDB Cluster 8.0”](mysql-cluster-limitations-resolved.html "25.2.7.11 Previous NDB Cluster Issues Resolved in NDB Cluster 8.0"),

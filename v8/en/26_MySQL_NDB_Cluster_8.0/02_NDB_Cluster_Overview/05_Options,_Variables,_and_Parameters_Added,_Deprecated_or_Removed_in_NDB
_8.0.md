...
* [Parameters Introduced in NDB 8.0](mysql-cluster-added-deprecated-removed.html#params-added-ndb-8.0 "Parameters Introduced in NDB 8.0")
* [Parameters Deprecated in NDB 8.0](mysql-cluster-added-deprecated-removed.html#params-deprecated-ndb-8.0 "Parameters Deprecated in NDB 8.0")
* [Parameters Removed in NDB 8.0](mysql-cluster-added-deprecated-removed.html#params-removed-ndb-8.0 "Parameters Removed in NDB 8.0")
* [Options and Variables Introduced in NDB 8.0](mysql-cluster-added-deprecated-removed.html#optvars-added-ndb-8.0 "Options and Variables Introduced in NDB 8.0")
* [Options and Variables Deprecated in NDB 8.0](mysql-cluster-added-deprecated-removed.html#optvars-deprecated-ndb-8.0 "Options and Variables Deprecated in NDB 8.0")
* [Options and Variables Removed in NDB 8.0](mysql-cluster-added-deprecated-removed.html#optvars-removed-ndb-8.0 "Options and Variables Removed in NDB 8.0")

The next few sections contain information about
`NDB` node configuration parameters and
NDB-specific [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") options and variables that

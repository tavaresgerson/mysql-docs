...
employs the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. This
engine is also referred to sometimes as
[`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"), although
`NDB` is preferred.

To avoid unnecessary allocation of resources, the server is
configured by default with the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
storage engine disabled. To enable [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"),
...
client. Before the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine

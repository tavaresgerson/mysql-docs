...
<span class="bold"><strong>Node Restart:
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") is configurable using this
...
STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") in the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, as
shown here:

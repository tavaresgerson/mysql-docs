...
<td><p class="valid-value"><code class="literal">OFF</code></p><p class="valid-value"><code class="literal">FORCE</code></p></td>
  ...
  The [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine is
  necessary for using NDB Cluster. If a
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") binary includes support for the
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine, the
...
<td><code class="literal">ON</code></td>
  ...
  Let [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") and other DDL
...
<td>No</td>
  ...
  Use together with
  [`--slave-skip-errors`](replication-options-replica.html#option_mysqld_slave-skip-errors) to cause
...
</tr><tr><th>Maximum Value (≥ 8.0.29-ndb-8.0.29)</th>
<td><code class="literal">2147483648</code></td>
</tr><tr><th>Maximum Value</th>
<td><code class="literal">2147483648</code></td>
</tr><tr><th>Maximum Value</th>
<td><code class="literal">2147483648</code></td>
</tr><tr><th>Maximum Value (≤ 8.0.28-ndb-8.0.28)</th>
...
<td>String</td>
  ...
  When using the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement")). The default is
  `FIXED`.
...
<td><code class="literal">ON</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. Can be set to either
...
<td><code class="literal">ON</code></td>
  ...
  [`log_replica_updates`](replication-options-binary-log.html#sysvar_log_replica_updates) or
  [`log_slave_updates`](replication-options-binary-log.html#sysvar_log_slave_updates) is enabled.
...
<td>No</td>
  ...
  [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), and as
  `cluster_node_id` in the
  `connection` row of the output of
  [`SHOW ENGINE
  NDBCLUSTER STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement").
...
<td>No</td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. The default is 10.
...
<td>No</td>
  ...
  [`ndb_transid_mysql_connection_map`](information-schema-ndb-transid-mysql-connection-map-table.html "28.3.18 The INFORMATION_SCHEMA ndb_transid_mysql_connection_map Table")
  ...
  [`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement").
...
<td>bytes</td>
  ...
  waits for the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine
  to complete setup before timing out and treating
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") as unavailable. The time is
...
<td>bytes</td>
  ...
  Disable the [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
  engine. This is the default for binaries that were built with
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. For system
...
<td>bytes</td>
  ...
  SLAVE`](reset-slave.html "15.4.2.5 RESET SLAVE Statement") causes an NDB Cluster replica to purge all
...
<td>bytes</td>
  ...
  [`SET
  @@GLOBAL.ndb_slave_conflict_role = 'NONE'`](set-statement.html "15.7.6 SET Statements") first.
...
<td>bytes</td>
  ...
  See [Section 15.1.20.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.20.12 Setting NDB Comment Options"), for
  further information.
...
<td><code class="literal">63</code></td>
  ...
  information specific to the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
  storage engine.
...
<td><code class="literal">63</code></td>
  ...
  Forces sending of buffers to [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
<td><code class="literal">63</code></td>
  ...
  a [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement; see
  [Section 15.1.20.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.20.12 Setting NDB Comment Options"), for syntax
...
<td><code class="literal">63</code></td>
  ...
  Use [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") index statistics in query
...
<td><code class="literal">63</code></td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables are pushed down to the
  NDB kernel (data nodes). Previously, a join was handled using
  multiple accesses of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") by the
  ...
  **Conditions for NDB pushdown joins.**
  ...
  3. Explicit locking is not supported; however, the
     [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine's
  ...
  *and* the result is ordered or grouped by
  ...
  2. The counters in the
     [`ndbinfo.counters`](mysql-cluster-ndbinfo-counters.html "25.6.16.12 The ndbinfo counters Table") table
     that belong to the
...
<td><code class="literal"></code></td>
  ...
  [`log_bin`](replication-options-binary-log.html#sysvar_log_bin). In NDB 8.0,
...
<td><code class="literal">4294967295</code></td>
  ...
  accordingly, in a [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
  or [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement; see
  [Section 15.1.20.12, “Setting NDB Comment Options”](create-table-ndb-comment-options.html "15.1.20.12 Setting NDB Comment Options"), for more
  information.
...
<td>bytes</td>
  ...
  release. Use
  [`ndb_conflict_role`](mysql-cluster-options-variables.html#sysvar_ndb_conflict_role) instead.
...
<td>bytes</td>
  ...
  effect on the creation of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
<td>bytes</td>
  ...
  When set to `ON` or `1`,
  this variable causes [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables
...
<td>bytes</td>
  ...
  Forces [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") to use copying of
  tables in the event of problems with online
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations. The
...
<td>bytes</td>
  ...
  Forces [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") to use a count of
...
<td>String</td>
  ...
  [`slave_allow_batching`](mysql-cluster-options-variables.html#sysvar_slave_allow_batching), which
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  Place the [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.16 ndbinfo: The NDB Cluster Information Database") database
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"). No rows are returned from
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  Whether or not the [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.16 ndbinfo: The NDB Cluster Information Database")
  ...
  [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table") or other
...
<td><p class="valid-value"><code class="literal">FIXED</code></p><p class="valid-value"><code class="literal">DYNAMIC</code></p></td>
  ...
  [`ndbinfo`](mysql-cluster-ndbinfo.html "25.6.16 ndbinfo: The NDB Cluster Information Database") engine in use;
  read-only.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. For status
...
* [`Handler_discover`](mysql-cluster-options-variables.html#statvar_Handler_discover)
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine if it
...
* [`Ndb_api_bytes_sent_count_session`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count_session)
  ...
  [`SHOW GLOBAL
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), it relates to the current session only, and
...
* [`Ndb_api_bytes_sent_count_replica`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count_replica)
  ...
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), it is effectively global in scope. If this
...
* [`Ndb_api_bytes_sent_count`](mysql-cluster-options-variables.html#statvar_Ndb_api_bytes_sent_count)
  ...
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") or
  [`SHOW SESSION
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), it is effectively global in scope.
...
* [`Ndb_execute_count`](mysql-cluster-options-variables.html#statvar_Ndb_execute_count)
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") kernel made by operations.
...
* [`Ndb_pushed_queries_executed`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_queries_executed)
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") and executed there.
...
* [`Ndb_pushed_reads`](mysql-cluster-options-variables.html#statvar_Ndb_pushed_reads)
  ...
  that can be pushed down to [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
* [`Ndb_pruned_scan_count`](mysql-cluster-options-variables.html#statvar_Ndb_pruned_scan_count)
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") since the NDB Cluster
  was last started where [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
* [`Ndb_scan_count`](mysql-cluster-options-variables.html#statvar_Ndb_scan_count)
  ...
  executed by [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") since the

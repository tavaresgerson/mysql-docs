...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") can be used for
...
The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") memory manager, which
...
[`DataMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-datamemory) configuration
...
controlled by the
[`RedoBuffer`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-redobuffer) configuration
...
calculated by [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"), based on the
...
1. Use the value of the
   ...
   [`SendBufferMemory`](mysql-cluster-tcp-definition.html#ndbparam-tcp-sendbuffermemory) for
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")); transaction memory can also
...
single [`TransactionMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-transactionmemory)
...
part of a [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement")
...
If [`TransactionMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-transactionmemory) is
...
When [`TransactionMemory`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-transactionmemory)
...
of [`MaxNoOfLocalScans`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-maxnooflocalscans).
...
[Section 25.6.5, “Performing a Rolling Restart of an NDB Cluster”](mysql-cluster-rolling-restart.html "25.6.5 Performing a Rolling Restart of an NDB Cluster")), decreasing it

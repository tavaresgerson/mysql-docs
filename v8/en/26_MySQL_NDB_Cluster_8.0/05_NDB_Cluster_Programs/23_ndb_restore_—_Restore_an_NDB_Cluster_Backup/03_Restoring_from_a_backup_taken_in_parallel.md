...
using [**ndbmtd**](mysql-cluster-programs-ndbmtd.html "25.5.3 ndbmtd — The NDB Cluster Data Node Daemon (Multi-Threaded)") with multiple LDMs (see
...
[**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") binary from an NDB 8.0
distribution. The process is not substantially different
from that outlined in the general usage section under the
description of the [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") program,
and consists of executing [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup")
...
arguments are required; [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup")
always checks for the existence of parallel subdirectories
under the directory indicated by the
[`--backup-path`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_backup-path) option and
...
invoke [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") with
[`--backup-path`](mysql-cluster-programs-ndb-restore.html#option_ndb_restore_backup-path) pointing
...
[`BackupDataDir`](mysql-cluster-ndbd-definition.html#ndbparam-ndbd-backupdatadir) is
`/opt`. To restore the metadata in this
case, we can invoke [**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") like
this:
...
[**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") four times, each time using
...
[**ndb\_restore**](mysql-cluster-programs-ndb-restore.html "25.5.23 ndb_restore — Restore an NDB Cluster Backup") binary supplied with the

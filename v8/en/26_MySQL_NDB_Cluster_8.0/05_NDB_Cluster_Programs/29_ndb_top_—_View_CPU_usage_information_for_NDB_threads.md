...
[**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") displays running information in the
...
[**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") is available beginning with MySQL NDB
Cluster 7.6.3.
...
[**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") connects to a MySQL Server running as
...
([**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") uses information from
[`ndbinfo.cpustat`](mysql-cluster-ndbinfo-cpustat.html "25.6.16.18 The ndbinfo cpustat Table") and related
tables).
...
option; if unspecified, this is 1. [**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads")
...
Once started, [**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") runs continuously until
...
[**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") is available on macOS, Linux, and
Solaris. It is not currently supported on Windows platforms.

The following table includes all options that are specific to
the NDB Cluster program [**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads"). Additional
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_color">--color</a></code>,
              </p><p>
<code class="option"> <a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_color">-c</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_defaults-extra-file">--defaults-extra-file=path</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_defaults-file">--defaults-file=path</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_defaults-group-suffix">--defaults-group-suffix=string</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_graph">--graph</a></code>,
              </p><p>
<code class="option"> <a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_graph">-g</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_help">--help</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_host">--host=string</a></code>,
              </p><p>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_login-path">--login-path=path</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_measured-load">--measured-load</a></code>,
              </p><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_measured-load">-m</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_no-defaults">--no-defaults</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_node-id">--node-id=#</a></code>,
              </p><p>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_os-load">--os-load</a></code>,
              </p><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_os-load">-o</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_password">--password=password</a></code>,
              </p><p>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_port">--port=#</a></code>,
              </p><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_port">-P
                #</a></code> (&gt;=7.6.6)
              </p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_print-defaults">--print-defaults</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_sleep-time">--sleep-time=#</a></code>,
              </p><p>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_socket">--socket=path</a></code>,
              </p><p>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_sort">--sort</a></code>,
              </p><p>
<code class="option"> <a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_sort">-r</a>
</code>
</p></th>
...
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_text">--text</a></code>,
              </p><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_text">-t</a></code>
                (&gt;=7.6.6)
              </p></th>
...
<th scope="row"><p>
<code class="option">
<a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_usage">--usage</a>
</code>
</p></th>
<td>Show program usage information; same as --help</td>
<td><p>
                (Supported in all NDB releases based on MySQL 8.0)
              </p></td>
</tr></tbody><tbody><tr>
<th scope="row"><p>
<code class="option"><a class="link" href="mysql-cluster-programs-ndb-top.html#option_ndb_top_user">--user=name</a></code>,
              </p><p>
...
**Sample Output.**
The next figure shows [**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") running in a
...
[**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads")
...
Beginning with NDB 8.0.20, [**ndb\_top**](mysql-cluster-programs-ndb-top.html "25.5.29 ndb_top — View CPU usage information for NDB threads") also shows

...
1. Obtain the time of the most recent global checkpoint (GCP).
   ...
   [`ndb_log_apply_status=1`](mysql-cluster-options-variables.html#sysvar_ndb_log_apply_status), NDB
   ...
   [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement used
   ...
   of [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). We
...
2. Using the information obtained from the query shown in Step 1,
   ...
   REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement"). Otherwise, replication may stop with

...
REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statement on each of the replicas. The commands
...
5. Finally, initiate replication on the primary channel by
   executing the [`START REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement")

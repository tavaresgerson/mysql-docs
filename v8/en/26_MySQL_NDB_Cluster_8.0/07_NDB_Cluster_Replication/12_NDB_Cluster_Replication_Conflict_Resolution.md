...
[`ndb_slave_conflict_role`](mysql-cluster-options-variables.html#sysvar_ndb_slave_conflict_role) system
...
corresponding to each [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table for
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. (An example
...
[`Ndb_conflict_fn_max_ins`](mysql-cluster-options-variables.html#statvar_Ndb_conflict_fn_max_ins) for
...
**NDB$OLD() example.**
Suppose an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table such as the

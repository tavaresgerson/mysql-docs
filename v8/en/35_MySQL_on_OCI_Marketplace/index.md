...
For more information on OCI marketplace, see [Overview of Marketplace](https://docs.cloud.oracle.com/iaas/Content/Marketplace/Concepts/marketoverview.htm).
...
For more information on MySQL advanced configuration, see [Secure Deployment Guide](/doc/mysql-secure-deployment-guide/8.0/en/).

For more information on Oracle Linux 7, see [Oracle Linux Documentation](https://docs.oracle.com/en/operating-systems/oracle-linux/7/)

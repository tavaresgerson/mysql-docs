...
<table summary="A reference that lists functions used with global transaction identifiers (GTIDs)."><thead><tr><th>Name</th> <th>Description</th> <th>Deprecated</th> </tr></thead><tbody><tr><th><code>GTID_SUBSET()</code></th> <td> Return true if all GTIDs in subset are also in set; otherwise false. </td> <td></td> </tr><tr><th><code>GTID_SUBTRACT()</code></th> <td> Return all GTIDs in set that are not in subset. </td> <td></td> </tr><tr><th><code>WAIT_FOR_EXECUTED_GTID_SET()</code></th> <td> Wait until the given GTIDs have executed on the replica. </td> <td></td> </tr><tr><th><code>WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS()</code></th> <td> Use <code>WAIT_FOR_EXECUTED_GTID_SET()</code>. </td> <td>8.0.18</td> </tr></tbody></table>

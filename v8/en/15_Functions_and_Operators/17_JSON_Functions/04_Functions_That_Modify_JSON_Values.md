...
* [`JSON_ARRAY_APPEND(json_doc,
  ...
  val[,
  path,
  val] ...)`](json-modification-functions.html#function_json-array-append)
...
* [`JSON_ARRAY_INSERT(json_doc,
  ...
  val[,
  path,
  val] ...)`](json-modification-functions.html#function_json-array-insert)
  ...
  *`json_doc`* argument is not a valid
  ...
  [`JSON_ARRAY_INSERT()`](json-modification-functions.html#function_json-array-insert) call should
...
* [`JSON_INSERT(json_doc,
  ...
  val[,
  path,
  val] ...)`](json-modification-functions.html#function_json-insert)
  ...
  *`json_doc`* argument is not a valid
  ...
  For a comparison of
  [`JSON_INSERT()`](json-modification-functions.html#function_json-insert),
...
* [`JSON_MERGE(json_doc,
  json_doc[,
  json_doc] ...)`](json-modification-functions.html#function_json-merge)
...
* [`JSON_MERGE_PATCH(json_doc,
  json_doc[,
  json_doc] ...)`](json-modification-functions.html#function_json-merge-patch)
  ...
  **JSON\_MERGE\_PATCH() compared with JSON\_MERGE\_PRESERVE().**
  ...
  same as that of
  [`JSON_MERGE_PRESERVE()`](json-modification-functions.html#function_json-merge-preserve), with
...
* [`JSON_MERGE_PRESERVE(json_doc,
  json_doc[,
  json_doc] ...)`](json-modification-functions.html#function_json-merge-preserve)
  ...
  [`JSON_MERGE()`](json-modification-functions.html#function_json-merge). The
  ...
  [`JSON_MERGE_PATCH()`](json-modification-functions.html#function_json-merge-patch) in
...
* [`JSON_REMOVE(json_doc,
  path[,
  path] ...)`](json-modification-functions.html#function_json-remove)
...
* [`JSON_REPLACE(json_doc,
  ...
  val[,
  path,
  val] ...)`](json-modification-functions.html#function_json-replace)
  ...
  *`json_doc`* argument is not a valid
  ...
  [`JSON_REPLACE()`](json-modification-functions.html#function_json-replace) function and
  meets the conditions outlined in
  [Partial Updates of JSON Values](json.html#json-partial-updates "Partial Updates of JSON Values").
...
* [`JSON_SET(json_doc,
  ...
  val[,
  path,
  val] ...)`](json-modification-functions.html#function_json-set)
  ...
  *`json_doc`* argument is not a valid
  ...
  to the column. This optimization can be performed for an
  update statement that uses the
  [`JSON_SET()`](json-modification-functions.html#function_json-set) function and meets
  the conditions outlined in
  [Partial Updates of JSON Values](json.html#json-partial-updates "Partial Updates of JSON Values").

  The [`JSON_SET()`](json-modification-functions.html#function_json-set),
  [`JSON_INSERT()`](json-modification-functions.html#function_json-insert), and
  [`JSON_REPLACE()`](json-modification-functions.html#function_json-replace) functions are
  related:

  + [`JSON_SET()`](json-modification-functions.html#function_json-set) replaces
    existing values and adds nonexisting values.

  + [`JSON_INSERT()`](json-modification-functions.html#function_json-insert) inserts
    values without replacing existing values.

  + [`JSON_REPLACE()`](json-modification-functions.html#function_json-replace) replaces
...
* [`JSON_UNQUOTE(json_val)`](json-modification-functions.html#function_json-unquote)
  ...
  the [`NO_BACKSLASH_ESCAPES`](sql-mode.html#sqlmode_no_backslash_escapes) SQL
  ...
  *escape character*. MySQL recognizes the
  ...
  [Table 14.23, “JSON\_UNQUOTE() Special Character Escape Sequences”](json-modification-functions.html#json-unquote-character-escape-sequences "Table 14.23 JSON_UNQUOTE() Special Character Escape Sequences"). For
  ...
  **Table 14.23 JSON\_UNQUOTE() Special Character Escape Sequences**
  ...
  <table><col style="width: 15%"/><col style="width: 85%"/><thead><tr>
<th>Escape Sequence</th>
<th>Character Represented by Sequence</th>
</tr></thead><tbody><tr>
<td><code class="literal">\"</code><a class="indexterm" name="id247342"></a><a class="indexterm" name="id247344"></a></td>
<td>A double quote (<code class="literal">"</code>) character</td>
</tr><tr>
<td><code class="literal">\b</code><a class="indexterm" name="id247351"></a><a class="indexterm" name="id247353"></a></td>
<td>A backspace character</td>
</tr><tr>
<td><code class="literal">\f</code><a class="indexterm" name="id247359"></a><a class="indexterm" name="id247361"></a></td>
<td>A formfeed character</td>
</tr><tr>
<td><code class="literal">\n</code><a class="indexterm" name="id247367"></a><a class="indexterm" name="id247369"></a><a class="indexterm" name="id247371"></a><a class="indexterm" name="id247373"></a></td>
<td>A newline (linefeed) character</td>
</tr><tr>
<td><code class="literal">\r</code><a class="indexterm" name="id247379"></a><a class="indexterm" name="id247381"></a><a class="indexterm" name="id247383"></a></td>
<td>A carriage return character</td>
</tr><tr>
<td><code class="literal">\t</code><a class="indexterm" name="id247389"></a><a class="indexterm" name="id247391"></a></td>
<td>A tab character</td>
</tr><tr>
<td><code class="literal">\\</code><a class="indexterm" name="id247397"></a><a class="indexterm" name="id247399"></a></td>
<td>A backslash (<code class="literal">\</code>) character</td>
</tr><tr>
<td><code class="literal">\u<em class="replaceable"><code>XXXX</code></em></code><a class="indexterm" name="id247407"></a><a class="indexterm" name="id247409"></a></td>

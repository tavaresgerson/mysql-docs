...
[`ONLY_FULL_GROUP_BY`](sql-mode.html#sqlmode_only_full_group_by) mode is
...
the [`SELECT`](select.html "15.2.13 SELECT Statement") list when employing
...
queries, see [Section 14.19.4, “Detection of Functional Dependence”](group-by-functional-dependence.html "14.19.4 Detection of Functional Dependence").

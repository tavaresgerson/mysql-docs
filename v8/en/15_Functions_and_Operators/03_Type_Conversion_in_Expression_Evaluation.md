...
statement such as
[`CREATE TABLE
... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"); in strict mode, the statement fails due to
...
[C API Basic Data Structures](/doc/c-api/8.0/en/c-api-data-structures.html)). This means that you can

...
* [`ST_Collect([DISTINCT]
  ...
  *`over_clause`* together with
  ...
  + If any geometry argument is a syntactically well-formed
    ...
    an [`ER_SRS_NOT_FOUND`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_srs_not_found) error
    occurs.
  ...
  + If there are multiple geometry arguments and those
    ...
    [`ER_GIS_DIFFERENT_SRIDS_AGGREGATION`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_gis_different_srids_aggregation)
    error occurs.

...
described in [Section 14.24.3, “Expression Handling”](precision-math-expressions.html "14.24.3 Expression Handling"), and
...
[`ROUND()`](mathematical-functions.html#function_round) function) is independent of
...
* Rounding for exact-value columns
  ([`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") and integer) and
...
with [`ERROR_FOR_DIVISION_BY_ZERO`](sql-mode.html#sqlmode_error_for_division_by_zero)

...
for [`INSERT`](insert.html "15.2.7 INSERT Statement") into a column with an
exact data type ([`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") or
...
truncation for [`INSERT`](insert.html "15.2.7 INSERT Statement") is
permissible.)
...
* If no approximate values are present, the expression contains
  ...
  evaluated using [`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") exact
...
* Otherwise, the expression contains only integer values. The
  ...
  [`BIGINT`](integer-types.html "13.1.2 Integer Types (Exact Value) - INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT") (64 bits).
...
system variable. (See [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").) The following
...
([`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") or integer), it is
...
[Section 14.24.4, “Rounding Behavior”](precision-math-rounding.html "14.24.4 Rounding Behavior"). Truncation due to
...
Prior to MySQL 8.0.31, for [`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC")

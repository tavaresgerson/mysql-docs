...
* A `FULLTEXT` index definition can be given in
  the [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement when
...
is rejected with
[`ER_FULLTEXT_WITH_ROLLUP`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_fulltext_with_rollup):

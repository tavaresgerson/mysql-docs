...
See also [Section 5.3.4.7, “Pattern Matching”](pattern-matching.html "5.3.4.7 Pattern Matching").
...
change, see [Regular Expression Compatibility Considerations](regexp.html#regexp-compatibility "Regular Expression Compatibility Considerations").)
...
[`ER_CHARACTER_SET_MISMATCH`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_character_set_mismatch).
...
* [Regular Expression Resource Control](regexp.html#regexp-resource-control "Regular Expression Resource Control")
...
* [`expr
  ...
  *`pat`* is `NULL`,
  ...
  [`RLIKE`](regexp.html#operator_regexp) are
  synonyms for [`REGEXP_LIKE()`](regexp.html#function_regexp-like).
...
* [`REGEXP_INSTR(expr,
  ...
  *`pat`* is `NULL`,
  ...
  [`REGEXP_INSTR()`](regexp.html#function_regexp-instr) takes these
  optional arguments:
  ...
  + *`return_option`*: Which type
    ...
    [`REGEXP_INSTR()`](regexp.html#function_regexp-instr) returns
...
* [`REGEXP_LIKE(expr,
  pat[,
  match_type])`](regexp.html#function_regexp-like)
...
* [`REGEXP_REPLACE(expr,
  ...
  pos[,
  occurrence[,
  match_type]]])`](regexp.html#function_regexp-replace)
  ...
  *`repl`* is
  ...
  [`REGEXP_REPLACE()`](regexp.html#function_regexp-replace) takes
...
* [`REGEXP_SUBSTR(expr,
  ...
  pos[,
  occurrence[,
  match_type]]])`](regexp.html#function_regexp-substr)
  ...
  *`pat`* is `NULL`,
  ...
  [`REGEXP_SUBSTR()`](regexp.html#function_regexp-substr) takes these
  optional arguments:
...
* The match engine uses memory for its internal stack. To
  ...
  bytes, set the
  [`regexp_stack_limit`](server-system-variables.html#sysvar_regexp_stack_limit) system
  variable.
...
* With the Spencer library, the
  ...
  [`REGEXP_SUBSTR()`](regexp.html#function_regexp-substr) or a

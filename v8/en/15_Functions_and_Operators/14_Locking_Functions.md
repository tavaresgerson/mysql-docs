...
* [`GET_LOCK(str,timeout)`](locking-functions.html#function_get-lock)
  ...
  *same* name, only the first lock for the
  ...
  request with an
  [`ER_USER_LOCK_DEADLOCK`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_user_lock_deadlock) error.
  ...
  *`app_name.str`*.
  ...
  functions. For details, see [Section 7.6.9.1, “The Locking Service”](locking-service.html "7.6.9.1 The Locking Service").

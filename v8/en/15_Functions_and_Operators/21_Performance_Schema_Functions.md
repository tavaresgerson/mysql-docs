...
<table frame="box" rules="all" summary="A reference that lists Performance Schema functions."><col style="width: 25%"/><col style="width: 62%"/><col style="width: 12%"/><thead><tr><th>Name</th>
<th>Description</th>
<th>Introduced</th>
...
<td>EiB</td>
  ...
  [`FORMAT_BYTES()`](performance-schema-functions.html#function_format-bytes) was added in
...
<td>d</td>
  ...
  [`FORMAT_PICO_TIME()`](performance-schema-functions.html#function_format-pico-time) was added in
  MySQL 8.0.16. It may be used instead of the
  `sys` schema
...
* [`PS_CURRENT_THREAD_ID()`](performance-schema-functions.html#function_ps-current-thread-id)
  ...
  [`PS_CURRENT_THREAD_ID()`](performance-schema-functions.html#function_ps-current-thread-id) was
  added in MySQL 8.0.16. It may be used as a shortcut for
  invoking the `sys` schema
  [`ps_thread_id()`](sys-ps-thread-id.html "30.4.5.15 The ps_thread_id() Function") function with an
  argument of `NULL` or
...
* [`PS_THREAD_ID(connection_id)`](performance-schema-functions.html#function_ps-thread-id)
  ...
  Schema [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table or the
  `Id` column of [`SHOW
  PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") output.
  ...
  [`PS_THREAD_ID()`](performance-schema-functions.html#function_ps-thread-id) was added in
  MySQL 8.0.16. It may be used instead of the
  `sys` schema

...
The version number should be followed by at least one whitespace character (or the end of the comment). Beginning with MySQL 8.0.34, if this condition is not met, the statement triggers a warning ; you should expect this requirement to become strictly enforced in a future version of MySQL.

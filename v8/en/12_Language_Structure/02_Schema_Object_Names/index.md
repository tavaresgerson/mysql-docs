...
MySQL. [Section 11.2.1, “Identifier Length Limits”](identifier-length.html "11.2.1 Identifier Length Limits"), indicates the maximum
length of each type of identifier.
[Section 11.2.3, “Identifier Case Sensitivity”](identifier-case-sensitivity.html "11.2.3 Identifier Case Sensitivity"), describes which
...
words are listed at [Section 11.3, “Keywords and Reserved Words”](keywords.html "11.3 Keywords and Reserved Words").
...
* Beginning with MySQL 8.0.32, use of the dollar sign as the
  ...
  qualifiers (see [Section 11.2.2, “Identifier Qualifiers”](identifier-qualifiers.html "11.2.2 Identifier Qualifiers")). The
...
as described in [Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes").
...
[Section 11.4, “User-Defined Variables”](user-variables.html "11.4 User-Defined Variables"), for more information and

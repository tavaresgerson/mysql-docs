...
* [Expression Syntax](expressions.html#expression-syntax "Expression Syntax")
* [Expression Term Notes](expressions.html#expression-term-notes "Expression Term Notes")
...
expression terms, see [Expression Term Notes](expressions.html#expression-term-notes "Expression Term Notes").
...
[Section 14.4.1, “Operator Precedence”](operator-precedence.html "14.4.1 Operator Precedence"). The precedence and
meaning of some operators depends on the SQL mode:

* By default, [`||`](logical-operators.html#operator_or)
  is a logical [`OR`](logical-operators.html#operator_or) operator. With
  [`PIPES_AS_CONCAT`](sql-mode.html#sqlmode_pipes_as_concat) enabled,
  [`||`](logical-operators.html#operator_or) is string
  concatenation, with a precedence between
  [`^`](bit-functions.html#operator_bitwise-xor) and
  the unary operators.

* By default, [`!`](logical-operators.html#operator_not)
  has a higher precedence than `NOT`. With
  [`HIGH_NOT_PRECEDENCE`](sql-mode.html#sqlmode_high_not_precedence)
  enabled, [`!`](logical-operators.html#operator_not) and
...
For literal value syntax, see [Section 11.1, “Literal Values”](literals.html "11.1 Literal Values").

For identifier syntax, see [Section 11.2, “Schema Object Names”](identifiers.html "11.2 Schema Object Names").

Variables can be user variables, system variables, or stored
program local variables or parameters:

* User variables: [Section 11.4, “User-Defined Variables”](user-variables.html "11.4 User-Defined Variables")
* System variables: [Section 7.1.9, “Using System Variables”](using-system-variables.html "7.1.9 Using System Variables")
...
scalar subquery. See [Section 15.2.15.1, “The Subquery as Scalar Operand”](scalar-subqueries.html "15.2.15.1 The Subquery as Scalar Operand").
...
[`MATCH`](fulltext-search.html#function_match) expression. See
[Section 14.9, “Full-Text Search Functions”](fulltext-search.html "14.9 Full-Text Search Functions").

*`case_expr`* indicates a
[`CASE`](flow-control-functions.html#operator_case) expression. See
...
interval. See [Temporal Intervals](expressions.html#temporal-intervals "Temporal Intervals").
...
[`DATE_ADD()`](date-and-time-functions.html#function_date-add) and
...
[`-`](arithmetic-functions.html#operator_minus) operator:
...
side of the [`+`](arithmetic-functions.html#operator_plus)
...
EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statements:
...
[`TIME`](time.html "13.2.3 The TIME Type") values as representing
...
[`CAST()`](cast-functions.html#function_cast) operation may be used. To
treat `6/4` as 1 hour, 5 minutes, cast it to a
[`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") value with a single
fractional digit:

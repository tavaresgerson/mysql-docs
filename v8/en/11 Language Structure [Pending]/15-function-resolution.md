--- title: MySQL 8.4 Reference Manual :: 11.2.5 Function Name Parsing and Resolution url: https://dev.mysql.com/doc/refman/8.4/en/function-resolution.html order: 15 ---
...
* Loadable functions and stored functions
  ...
  MySQL 8.4 supports `IF NOT EXISTS` with [`CREATE FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") statements, but it has no effect in such cases.

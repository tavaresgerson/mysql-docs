...
* As of MySQL 8.0.19, `SIGUSR1` causes the
  ...
  rotation, see [Section 7.4.6, “Server Log Maintenance”](log-file-maintenance.html "7.4.6 Server Log Maintenance").
...
* Client programs that use the MySQL client library block
  ...
  + Client can install their own `SIGPIPE`
    ...
    [Writing C API Threaded Client Programs](/doc/c-api/8.0/en/c-api-threaded-clients.html).
  ...
  + Clients can prevent installation of
    ...
    connect time. See [mysql\_real\_connect()](/doc/c-api/8.0/en/mysql-real-connect.html).
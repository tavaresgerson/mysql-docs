...
[Section 25.5, “NDB Cluster Programs”](mysql-cluster-programs.html "25.5 NDB Cluster Programs"), describes programs
...
[Chapter 2, *Installing MySQL*](installing.html "Chapter 2 Installing MySQL"), for information on types of
...
[**mysql --help**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client").
...
[Section 6.2, “Using MySQL Programs”](programs-using.html "6.2 Using MySQL Programs"), for general information on
invoking programs and specifying program options.

The MySQL server, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), is the main program
...
* [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
  ...
  programs, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") must be running, because
  clients gain access to databases by connecting to the server.
  See [Section 6.3.1, “mysqld — The MySQL Server”](mysqld.html "6.3.1 mysqld — The MySQL Server").

* [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")

  A server startup script. [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")
  attempts to start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). See
  [Section 6.3.2, “mysqld\_safe — MySQL Server Startup Script”](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script").

* [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script")
  ...
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") to start the MySQL server. See
  [Section 6.3.3, “mysql.server — MySQL Server Startup Script”](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script").

* [**mysqld\_multi**](mysqld-multi.html "6.3.4 mysqld_multi — Manage Multiple MySQL Servers")
...
* [**comp\_err**](comp-err.html "6.4.1 comp_err — Compile MySQL Error Message File")

  This program is used during the MySQL build/installation
  process. It compiles error message files from the error source
  files. See [Section 6.4.1, “comp\_err — Compile MySQL Error Message File”](comp-err.html "6.4.1 comp_err — Compile MySQL Error Message File").
...
* [**mysql\_secure\_installation**](mysql-secure-installation.html "6.4.2 mysql_secure_installation — Improve MySQL Installation Security")
  ...
  installation. See [Section 6.4.2, “mysql\_secure\_installation — Improve MySQL Installation Security”](mysql-secure-installation.html "6.4.2 mysql_secure_installation — Improve MySQL Installation Security").

* [**mysql\_ssl\_rsa\_setup**](mysql-ssl-rsa-setup.html "6.4.3 mysql_ssl_rsa_setup — Create SSL/RSA Files")

  Note

  [**mysql\_ssl\_rsa\_setup**](mysql-ssl-rsa-setup.html "6.4.3 mysql_ssl_rsa_setup — Create SSL/RSA Files") is deprecated as of
  MySQL 8.0.34.
  ...
  [**mysql\_ssl\_rsa\_setup**](mysql-ssl-rsa-setup.html "6.4.3 mysql_ssl_rsa_setup — Create SSL/RSA Files") can be used for secure
...
* [**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables")
...
* [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables")
  ...
  necessary. See [Section 6.4.5, “mysql\_upgrade — Check and Upgrade MySQL Tables”](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables").
...
* [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program")
  ...
  [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") can also be used to retrieve
...
* [**mysqlcheck**](mysqlcheck.html "6.5.3 mysqlcheck — A Table Maintenance Program")
  ...
  optimizes tables. See [Section 6.5.3, “mysqlcheck — A Table Maintenance Program”](mysqlcheck.html "6.5.3 mysqlcheck — A Table Maintenance Program").
...
* [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
  ...
  or XML. See [Section 6.5.4, “mysqldump — A Database Backup Program”](mysqldump.html "6.5.4 mysqldump — A Database Backup Program").
...
* [**mysqlimport**](mysqlimport.html "6.5.5 mysqlimport — A Data Import Program")
  ...
  using [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement"). See
...
* **mysqlsh**
  ...
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), MySQL Shell provides scripting
  ...
  [Chapter 22, *Using MySQL as a Document Store*](document-store.html "Chapter 22 Using MySQL as a Document Store"). AdminAPI enables you to
  work with InnoDB Cluster, see
  [MySQL AdminAPI](/doc/mysql-shell/8.0/en/admin-api-userguide.html).

* [**mysqlshow**](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information")

  A client that displays information about databases, tables,
  columns, and indexes. See [Section 6.5.7, “mysqlshow — Display Database, Table, and Column Information”](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information").

* [**mysqlslap**](mysqlslap.html "6.5.8 mysqlslap — A Load Emulation Client")
...
* [**innochecksum**](innochecksum.html "6.6.2 innochecksum — Offline InnoDB File Checksum Utility")

  An offline `InnoDB` offline file checksum
  utility. See [Section 6.6.2, “innochecksum — Offline InnoDB File Checksum Utility”](innochecksum.html "6.6.2 innochecksum — Offline InnoDB File Checksum Utility").

* [**myisam\_ftdump**](myisam-ftdump.html "6.6.3 myisam_ftdump — Display Full-Text Index information")
...
* [**myisamlog**](myisamlog.html "6.6.5 myisamlog — Display MyISAM Log File Contents")
...
* [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility")
...
* [**mysql\_migrate\_keyring**](mysql-migrate-keyring.html "6.6.8 mysql_migrate_keyring — Keyring Key Migration Utility")

  A utility for migrating keys between one keyring component and
  another. See [Section 6.6.8, “mysql\_migrate\_keyring — Keyring Key Migration Utility”](mysql-migrate-keyring.html "6.6.8 mysql_migrate_keyring — Keyring Key Migration Utility").

* [**mysqlbinlog**](mysqlbinlog.html "6.6.9 mysqlbinlog — Utility for Processing Binary Log Files")
...
* [**mysqldumpslow**](mysqldumpslow.html "6.6.10 mysqldumpslow — Summarize Slow Query Log Files")

  A utility to read and summarize the contents of a slow query
  log. See [Section 6.6.10, “mysqldumpslow — Summarize Slow Query Log Files”](mysqldumpslow.html "6.6.10 mysqldumpslow — Summarize Slow Query Log Files").

MySQL program-development utilities:

* [**mysql\_config**](mysql-config.html "6.7.1 mysql_config — Display Options for Compiling Clients")

  A shell script that produces the option values needed when
  compiling MySQL programs. See [Section 6.7.1, “mysql\_config — Display Options for Compiling Clients”](mysql-config.html "6.7.1 mysql_config — Display Options for Compiling Clients").

* [**my\_print\_defaults**](my-print-defaults.html "6.7.2 my_print_defaults — Display Options from Option Files")
...
* [**lz4\_decompress**](lz4-decompress.html "6.8.1 lz4_decompress — Decompress mysqlpump LZ4-Compressed Output")

  A utility that decompresses [**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program")
...
* [**perror**](perror.html "6.8.2 perror — Display MySQL Error Message Information")
  ...
  codes. See [Section 6.8.2, “perror — Display MySQL Error Message Information”](perror.html "6.8.2 perror — Display MySQL Error Message Information").

* [**zlib\_decompress**](zlib-decompress.html "6.8.3 zlib_decompress — Decompress mysqlpump ZLIB-Compressed Output")
...
[MySQL Workbench](workbench.html "Chapter 33 MySQL Workbench") GUI tool, which
...
see [Section 6.9, “Environment Variables”](environment-variables.html "6.9 Environment Variables").
...
* `--length`, `-l`
  ...
  <table summary="Properties for length"><tbody><tr><th>Command-Line Format</th> <td><code>--length</code></td> </tr></tbody></table>

  Report the length distribution.

* `--stats`, `-s`

  <table summary="Properties for stats"><tbody><tr><th>Command-Line Format</th> <td><code>--stats</code></td> </tr></tbody></table>

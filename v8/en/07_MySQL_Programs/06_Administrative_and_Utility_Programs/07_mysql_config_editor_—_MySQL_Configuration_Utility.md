...
The [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") utility enables you
...
option files are used, see [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files").
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility"), by standard MySQL
clients ([**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"),
[**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program"), and so forth), and by the
**mysql-test-run.pl** testing utility.

Programs use groups in the login path file as follows:

* [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") operates on the
  `client` login path by default if you
  specify no
  [`--login-path=name`](option-file-options.html#option_general_login-path)
  option to indicate explicitly which login path to use.

* Without a [`--login-path`](option-file-options.html#option_general_login-path)
  ...
  By default, the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client reads the
  `[client]` and `[mysql]`
  groups from other option files, so it reads them from the
  login path file as well.

* With a [`--login-path`](option-file-options.html#option_general_login-path) option,
  ...
  The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client reads
  `[client]` and `[mysql]`
...
* Client programs read the login path file even when the
  [`--no-defaults`](option-file-options.html#option_general_no-defaults) option is
  used, unless
  [`--no-login-paths`](/doc/refman/8.4/en/option-file-options.html#option_general_no-login-paths) is set.
  This permits passwords to be specified in a safer way than
  on the command line even if
  [`--no-defaults`](option-file-options.html#option_general_no-defaults) is present.

[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") obfuscates the
...
variable. [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") provides a
...
The obfuscation used by [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility")
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") ignores it, and client
programs do not use it, either.

Invoke [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") like this:
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") creates it.

Command arguments are given as follows:

* *`program_options`* consists of
  general [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") options.
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") help message, and ignores
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") uses the
...
To see what [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") writes to the
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") makes it easy to set up
...
Here, [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") reads the
`[client]` and `[mysql]`
...
Because [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") reads the
`client` and `mysql` login
paths by default, the
[`--login-path`](option-file-options.html#option_general_login-path) option does not add
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") adds login paths to the
...
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"). Options specified later override
options specified earlier, so putting the login paths in the
order `client`, `mysqldump`
enables [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")-specific options to
override `client` options.

When you use the `set` command with
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") to create a login path,
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") supports the following
general options, which may be used preceding any command named
on the command line. For descriptions of command-specific
options, see [mysql\_config\_editor Commands and Command-Specific Options](mysql-config-editor.html#mysql-config-editor-commands "mysql_config_editor Commands and Command-Specific Options").

**Table 6.21 mysql\_config\_editor General Options**

<table frame="box" rules="all" summary="General Command-line options available for mysql_config_editor."><col style="width: 35%"/><col style="width: 64%"/><thead><tr><th>Option Name</th>
<th>Description</th>
</tr></thead><tbody><tr><td><a class="link" href="mysql-config-editor.html#option_mysql_config_editor_debug">--debug</a></td>
<td>Write debugging log</td>
</tr><tr><td><a class="link" href="mysql-config-editor.html#option_mysql_config_editor_help">--help</a></td>
<td>Display help message and exit</td>
</tr><tr><td><a class="link" href="mysql-config-editor.html#option_mysql_config_editor_verbose">--verbose</a></td>
<td>Verbose mode</td>
</tr><tr><td><a class="link" href="mysql-config-editor.html#option_mysql_config_editor_version">--version</a></td>
<td>Display version information and exit</td>
</tr></tbody></table>

* [`--help`](mysql-config-editor.html#option_mysql_config_editor_help),
  `-?`
...
<td><code class="literal">--help</code></td>
  ...
  [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") as follows, where
...
* [`--debug[=debug_options]`](mysql-config-editor.html#option_mysql_config_editor_debug),
  `-# debug_options`
...
* [`--verbose`](mysql-config-editor.html#option_mysql_config_editor_verbose),
  `-v`
...
* [`--version`](mysql-config-editor.html#option_mysql_config_editor_version),
  `-V`
...
[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") commands, and, for each
one, the command-specific options permitted following the
command name on the command line.

In addition, [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") supports
general options that can be used preceding any command. For
descriptions of these options, see
[mysql\_config\_editor General Options](mysql-config-editor.html#mysql-config-editor-command-options "mysql_config_editor General Options").

[**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") supports these commands:
...
* `print
  ...
  + `--help`, `-?`
    ...
    [**mysql\_config\_editor --help**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility").
...
* `set [options]`
  ...
  `--socket`, and `--user`
  options. If none of those options are given,
  [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") writes the login path
  as an empty group.
  ...
  + `--password`, `-p`
    ...
    [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") displays the
    prompt, type the password and press Enter. To prevent
    other users from seeing the password,
    [**mysql\_config\_editor**](mysql-config-editor.html "6.6.7 mysql_config_editor — MySQL Configuration Utility") does not echo it.

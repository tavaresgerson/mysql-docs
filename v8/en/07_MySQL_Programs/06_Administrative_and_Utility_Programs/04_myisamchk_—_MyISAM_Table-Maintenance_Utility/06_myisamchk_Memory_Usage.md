...
[**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility"). [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") uses
no more memory than its memory-related variables are set to. If
you are going to use [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") on very large
...
using larger values, you can get [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") to
...
Be aware that [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") uses temporary files
in `TMPDIR`. If `TMPDIR`
points to a memory file system, out of memory errors can easily
occur. If this happens, run [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") with
the
...
When performing repair operations, [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility")
...
* Twice the size of the data file (the original file and a
  ...
  [`--quick`](myisamchk-repair-options.html#option_myisamchk_quick); in this case,
...
* When using [`--recover`](myisamchk-repair-options.html#option_myisamchk_recover) or
  [`--sort-recover`](myisamchk-repair-options.html#option_myisamchk_sort-recover) (but not
  when using
  [`--safe-recover`](myisamchk-repair-options.html#option_myisamchk_safe-recover)), you need
  ...
  *`row_pointer_length`* with
  [**myisamchk -dv
  *`tbl_name`***](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") (see
  [Section 6.6.4.5, “Obtaining Table Information with myisamchk”](myisamchk-table-info.html "6.6.4.5 Obtaining Table Information with myisamchk")). The
...
[`--safe-recover`](myisamchk-repair-options.html#option_myisamchk_safe-recover) instead of

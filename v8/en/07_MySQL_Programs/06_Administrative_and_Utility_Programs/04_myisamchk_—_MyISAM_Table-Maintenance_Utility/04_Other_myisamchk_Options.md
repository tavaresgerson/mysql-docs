...
* `--block-search=offset`, `-b offset`
  ...
  <table summary="Properties for block-search"><tbody><tr><th>Command-Line Format</th> <td><code>--block-search=offset</code></td> </tr><tr><th>Type</th> <td>Numeric</td> </tr></tbody></table>

  Find the record that a block at the given offset belongs to.

* `--description`, `-d`

  <table summary="Properties for description"><tbody><tr><th>Command-Line Format</th> <td><code>--description</code></td> </tr></tbody></table>
...
* `--sort-index`, `-S`
  ...
  <table summary="Properties for sort-index"><tbody><tr><th>Command-Line Format</th> <td><code>--sort-index</code></td> </tr></tbody></table>

  Sort the index tree blocks in high-low order. This optimizes seeks and makes table scans that use indexes faster.

* `--sort-records=N`, `-R N`

  <table summary="Properties for sort-records"><tbody><tr><th>Command-Line Format</th> <td><code>--sort-records=#</code></td> </tr><tr><th>Type</th> <td>Numeric</td> </tr></tbody></table>

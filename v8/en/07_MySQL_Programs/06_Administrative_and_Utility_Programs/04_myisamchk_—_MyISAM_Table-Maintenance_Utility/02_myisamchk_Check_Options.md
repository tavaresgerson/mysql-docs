...
* `--check-only-changed`, `-C`
  ...
  <table summary="Properties for check-only-changed"><tbody><tr><th>Command-Line Format</th> <td><code>--check-only-changed</code></td> </tr></tbody></table>
...
* `--fast`, `-F`
  ...
  <table summary="Properties for fast"><tbody><tr><th>Command-Line Format</th> <td><code>--fast</code></td> </tr></tbody></table>
...
* `--information`, `-i`
  ...
  <table summary="Properties for information"><tbody><tr><th>Command-Line Format</th> <td><code>--information</code></td> </tr></tbody></table>

  Print informational statistics about the table that is checked.

* `--medium-check`, `-m`

  <table summary="Properties for medium-check"><tbody><tr><th>Command-Line Format</th> <td><code>--medium-check</code></td> </tr></tbody></table>
...
* `--read-only`, `-T`
  ...
  <table summary="Properties for read-only"><tbody><tr><th>Command-Line Format</th> <td><code>--read-only</code></td> </tr></tbody></table>
...
* `--update-state`, `-U`
  ...
  <table summary="Properties for update-state"><tbody><tr><th>Command-Line Format</th> <td><code>--update-state</code></td> </tr></tbody></table>

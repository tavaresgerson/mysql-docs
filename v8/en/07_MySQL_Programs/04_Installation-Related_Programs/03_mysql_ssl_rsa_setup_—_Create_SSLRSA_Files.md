...
* `--suffix=str`
  ...
  <table summary="Properties for suffix"><tbody><tr><th>Command-Line Format</th> <td><code>--suffix=str</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>
...
* `--uid=name`, `-v`
  ...
  <table summary="Properties for uid"><tbody><tr><th>Command-Line Format</th> <td><code>--uid=name</code></td> </tr></tbody></table>

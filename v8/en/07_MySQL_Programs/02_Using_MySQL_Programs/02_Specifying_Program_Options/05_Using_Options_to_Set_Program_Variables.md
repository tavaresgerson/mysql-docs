...
statement. See [Section 15.7.6.1, “SET Syntax for Variable Assignment”](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"), and
...
program options. For example, [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") has a
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") to a value of 16MB, use either of the
following commands:
...
the value with
[`SET`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment") at

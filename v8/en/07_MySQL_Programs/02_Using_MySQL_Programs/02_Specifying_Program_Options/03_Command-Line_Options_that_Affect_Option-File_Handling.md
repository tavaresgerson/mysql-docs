...
* [`--print-defaults`](option-file-options.html#option_general_print-defaults) may be used
  ...
  [`--defaults-extra-file`](option-file-options.html#option_general_defaults-extra-file), or
  [`--login-path`](option-file-options.html#option_general_login-path).
...
<td><code class="literal">false</code></td>
  ...
  exists, even when
  [`--no-defaults`](option-file-options.html#option_general_no-defaults) is used. This

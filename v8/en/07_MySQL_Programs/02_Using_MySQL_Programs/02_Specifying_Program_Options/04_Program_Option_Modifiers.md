...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client supports a
[`--column-names`](mysql-command-options.html#option_mysql_column-names) option that
...
such as when sending the output of [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") into
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") only and permits a limit to be placed

...
* [Configuring Connection Compression](connection-compression-control.html#connection-compression-configuration "Configuring Connection Compression")
...
* [Monitoring Connection Compression](connection-compression-control.html#connection-compression-monitoring "Monitoring Connection Compression")
...
* The [`--compression-algorithms`](connection-options.html#option_general_compression-algorithms)
  ...
  these client programs: [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"),
  ...
  [**mysqlcheck**](mysqlcheck.html "6.5.3 mysqlcheck — A Table Maintenance Program"), [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"),
  [**mysqlimport**](mysqlimport.html "6.5.5 mysqlimport — A Data Import Program"),
  [**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program"), [**mysqlshow**](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information"),
  [**mysqlslap**](mysqlslap.html "6.5.8 mysqlslap — A Load Emulation Client"), and
  **mysqltest**, and
  [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables"). MySQL Shell also offers
...
* The `MYSQL_OPT_COMPRESSION_ALGORITHMS` and
  ...
  for the [`mysql_options()`](/doc/c-api/8.0/en/mysql-options.html)
...
* The `MASTER_COMPRESSION_ALGORITHMS` and
  ...
  the [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement")
  ...
  REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") and the options
...
* To permit the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to initiate
...
* Client programs support a
  [`--compress`](connection-options.html#option_general_compress) command-line
...
[Configuring Connection Compression](connection-compression-control.html#connection-compression-configuration "Configuring Connection Compression"). An
exception is MySQL Shell, where the
[`--compress`](/doc/mysql-shell/8.0/en/mysqlsh.html#option_mysqlsh_compress) command-line option
...
[Using Compressed Connections](/doc/mysql-shell/8.0/en/mysql-shell-compressed-connections.html).
...
* The meaning of the legacy
  [`--compress`](connection-options.html#option_general_compress) option depends on
  whether
  [`--compression-algorithms`](connection-options.html#option_general_compression-algorithms) is
  specified:

  + When
    [`--compression-algorithms`](connection-options.html#option_general_compression-algorithms)
    is not specified,
    [`--compress`](connection-options.html#option_general_compress) is equivalent
  ...
  + When
    ...
    [`--compress`](connection-options.html#option_general_compress) and
    [`--compression-algorithms=zlib,zstd`](connection-options.html#option_general_compression-algorithms),
...
* The same type of interaction occurs between the legacy
  ...
  for the [`mysql_options()`](/doc/c-api/8.0/en/mysql-options.html) C
  API function.
...
The [`Compression`](server-status-variables.html#statvar_Compression) status
variable is `ON` or `OFF` to
indicate whether the current connection uses compression.

The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client `\status`
...
* To monitor compression in use for client connections, use
  the [`Compression_algorithm`](server-status-variables.html#statvar_Compression_algorithm)

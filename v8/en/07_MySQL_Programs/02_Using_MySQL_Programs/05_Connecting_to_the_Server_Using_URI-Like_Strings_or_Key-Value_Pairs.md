...
* `ssh`: The URI for connection to an SSH
  ...
  [Using an SSH Tunnel](/doc/mysql-shell/8.0/en/mysql-shell-connection-ssh.html).
...
[`--uri`](/doc/mysql-shell/8.0/en/mysqlsh.html#option_mysqlsh_uri) command option, the

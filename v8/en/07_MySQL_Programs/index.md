...
:   [6.4.1 comp\_err — Compile MySQL Error Message File](comp-err.html)
    ...
    [6.4.3 mysql\_ssl\_rsa\_setup — Create SSL/RSA Files](mysql-ssl-rsa-setup.html)

    [6.4.4 mysql\_tzinfo\_to\_sql — Load the Time Zone Tables](mysql-tzinfo-to-sql.html)

    [6.4.5 mysql\_upgrade — Check and Upgrade MySQL Tables](mysql-upgrade.html)
...
:   [6.5.1 mysql — The MySQL Command-Line Client](mysql.html)
    ...
    [6.5.6 mysqlpump — A Database Backup Program](mysqlpump.html)

    [6.5.7 mysqlshow — Display Database, Table, and Column Information](mysqlshow.html)

    [6.5.8 mysqlslap — A Load Emulation Client](mysqlslap.html)
...
:   [6.8.1 lz4\_decompress — Decompress mysqlpump LZ4-Compressed Output](lz4-decompress.html)

    [6.8.2 perror — Display MySQL Error Message Information](perror.html)

    [6.8.3 zlib\_decompress — Decompress mysqlpump ZLIB-Compressed Output](zlib-decompress.html)

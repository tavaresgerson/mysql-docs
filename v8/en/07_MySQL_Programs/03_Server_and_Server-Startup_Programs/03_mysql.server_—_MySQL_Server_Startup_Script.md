...
script named [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script"), which starts the
MySQL server using [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). It can be
...
[**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") is the script name as used
within the MySQL source tree. The installed name might be
different (for example, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") or
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")). In the following discussion, adjust
the name [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") as appropriate for your
system.
...
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") are not installed because they
...
[**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") script, invoke it from the
...
[**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") changes location to the MySQL
installation directory, then invokes
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). To run the server as some
...
[**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") if you've installed a binary
distribution of MySQL in a nonstandard location. Modify it to
change location into the proper directory before it runs
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script"). If you do this, your modified
version of [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") may be overwritten if
you upgrade MySQL in the future; make a copy of your edited
version that you can reinstall.)

[**mysql.server stop**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") stops the server by sending
a signal to it. You can also stop the server manually by
executing [**mysqladmin shutdown**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program").
...
* If you use the Linux server RPM package
  ...
  [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") script may be installed in
  the `/etc/init.d` directory with the name
  `mysqld` or `mysql`.
  See [Section 2.5.4, “Installing MySQL on Linux Using RPM Packages from Oracle”](linux-installation-rpm.html "2.5.4 Installing MySQL on Linux Using RPM Packages from Oracle"), for more
...
* If you install MySQL from a source distribution or using a
  ...
  [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") automatically, you can
  ...
  with the name [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and make it
  executable:
  ...
  be necessary to fully enable the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
  script:
...
You can add options for [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") in a
...
The [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") script supports the options
shown in the following table. If specified, they
*must* be placed in an option file, not on
the command line. [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") supports only
`start` and `stop` as
command-line arguments.

**Table 6.8 mysql.server Option-File Options**

<table frame="box" rules="all" summary="Option-file options available for mysql.server."><col align="left" style="width: 20%"/><col align="left" style="width: 70%"/><col align="left" style="width: 10%"/><thead><tr><th scope="col">Option Name</th>
...
* [`pid-file=file_name`](mysql-server.html#option_mysql_server_pid-file)
  ...
  If this option is not given, [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script")
  uses a default value of
  `host_name.pid`.
  The PID file value passed to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script")
  overrides any value specified in the
  `[mysqld_safe]` option file group. Because
  [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") reads the
  `[mysqld]` option file group but not the
  `[mysqld_safe]` group, you can ensure that
  [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") gets the same value when
  invoked from [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") as when invoked
...
* [`service-startup-timeout=seconds`](mysql-server.html#option_mysql_server_service-startup-timeout)
  ...
  [**mysql.server**](mysql-server.html "6.3.3 mysql.server — MySQL Server Startup Script") exits with an error. The

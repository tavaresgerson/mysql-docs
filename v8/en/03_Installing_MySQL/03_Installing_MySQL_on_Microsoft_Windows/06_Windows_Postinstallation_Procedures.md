...
* [MySQL Installer](mysql-installer.html "2.3.3 MySQL Installer for Windows"): Used to install
...
at [Section 2.9.1, “Initializing the Data Directory”](data-directory-initialization.html "2.9.1 Initializing the Data Directory").
...
`root` account. (See
[Section 2.3.3, “MySQL Installer for Windows”](mysql-installer.html "2.3.3 MySQL Installer for Windows").) Otherwise, use the
...
running (see [Section 2.3.4.5, “Starting the Server for the First Time”](windows-server-first-start.html "2.3.4.5 Starting the Server for the First Time")). You
can also set up a MySQL service that runs automatically when
Windows starts (see [Section 2.3.4.8, “Starting MySQL as a Windows Service”](windows-start-service.html "2.3.4.8 Starting MySQL as a Windows Service")).
...
[Section 2.3.3, “MySQL Installer for Windows”](mysql-installer.html "2.3.3 MySQL Installer for Windows")), the default installation
...
See [Section 2.3.4.7, “Customizing the PATH for MySQL Tools”](mysql-installation-windows-path.html "2.3.4.7 Customizing the PATH for MySQL Tools").
...
[**mysqlshow**](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information"), see [Section 6.5.1, “mysql — The MySQL Command-Line Client”](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), and

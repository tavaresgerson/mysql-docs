...
3. Install the server instance (and products) and then begin the
   ...
   [Section 2.3.3.3.1, “MySQL Server Configuration with MySQL Installer”](mysql-installer-workflow.html#mysql-installer-workflow-server "2.3.3.3.1 MySQL Server Configuration with MySQL Installer").
...
platform, see [Section 2.3.7, “Windows Platform Restrictions”](windows-restrictions.html "2.3.7 Windows Platform Restrictions").
...
[Section 2.3.2, “Choosing an Installation Package”](windows-choosing-package.html "2.3.2 Choosing an Installation Package").
...
* **MySQL and Virus Checking
  ...
  information, see [Section 2.3.4.2, “Creating an Option File”](windows-create-option-file.html "2.3.4.2 Creating an Option File").
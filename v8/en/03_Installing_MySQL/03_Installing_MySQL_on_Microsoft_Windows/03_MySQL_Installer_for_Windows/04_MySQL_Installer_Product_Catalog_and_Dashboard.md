...
* [Product Catalog](mysql-installer-catalog-dashboard.html#windows-product-catalog "Product Catalog")
* [MySQL Installer Dashboard](mysql-installer-catalog-dashboard.html#windows-product-dashboard "MySQL Installer Dashboard")
* [Locating Products to Install](mysql-installer-catalog-dashboard.html#locate-products "Locating Products to Install")
* [Upgrading MySQL Server](mysql-installer-catalog-dashboard.html#mysql-installer-upgrade-server "Upgrading MySQL Server")
* [Removing MySQL Server](mysql-installer-catalog-dashboard.html#mysql-installer-remove-server "Removing MySQL Server")
* [Upgrading MySQL Installer](mysql-installer-catalog-dashboard.html#upgrade-mysql-installer "Upgrading MySQL Installer")
...
* Populates the Available Products pane
  ...
  + The `Custom` setup type during the
    [initial
    setup](mysql-installer-setup.html "2.3.3.1 MySQL Installer Initial Setup").
...
[initial setup](mysql-installer-setup.html "2.3.3.1 MySQL Installer Initial Setup")
...
1. MySQL Installer dashboard operations provide a variety of actions that
   ...
   * Add: This operation opens the
     ...
     using the filter, see [Locating Products to Install](mysql-installer-catalog-dashboard.html#locate-products "Locating Products to Install").
...
2. The Reconfigure link in the Quick
   ...
   [Section 2.3.3.3.1, “MySQL Server Configuration with MySQL Installer”](mysql-installer-workflow.html#mysql-installer-workflow-server "2.3.3.3.1 MySQL Server Configuration with MySQL Installer"). Installed
...
* For upgrades, a check box enables you to skip the upgrade
  ...
  [Section 3.4, “What the MySQL Upgrade Process Upgrades”](upgrading-what-is-upgraded.html "3.4 What the MySQL Upgrade Process Upgrades")) and it alters
  ...
  [`--upgrade=MINIMAL`](server-options.html#option_mysqld_upgrade) server
  option, which upgrades the data dictionary only. If you stop
  and then restart the server without the
  [`--upgrade=MINIMAL`](server-options.html#option_mysqld_upgrade) option, the
...
1. Click Upgrade. Confirm that the check
   ...
   release, see [Logical Upgrade](upgrade-binary-package.html#upgrade-procedure-logical "Logical Upgrade").

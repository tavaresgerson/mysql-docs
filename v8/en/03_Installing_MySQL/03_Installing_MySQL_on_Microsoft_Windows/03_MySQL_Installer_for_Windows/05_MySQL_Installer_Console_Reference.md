...
[**MySQLInstallerConsole.exe**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") provides command-line
functionality that is similar to MySQL Installer. This reference includes:

* [MySQL Product Names](MySQLInstallerConsole.html#mi-console-product-names "MySQL Product Names")
* [Command Syntax](MySQLInstallerConsole.html#mi-console-command-syntax "Command Syntax")
* [Command Actions](MySQLInstallerConsole.html#mi-console-actions "Command Actions")
...
2. From the command line, optionally change the directory to
   where the [**MySQLInstallerConsole.exe**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") command
...
Many of the [**MySQLInstallerConsole**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") command
...
The [**MySQLInstallerConsole.exe**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") command can be
...
:   Zero or more options with possible values separated by
    spaces. See [Command Actions](MySQLInstallerConsole.html#mi-console-actions "Command Actions") to
...
[**MySQLInstallerConsole.exe**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") supports the
...
* `[--]install
  ...
  :   Each product can be specified by a
      [product
      phrase](MySQLInstallerConsole.html#mi-console-product-phrase "Table 2.6 MySQL Product Phrases for use with the MySQLInstallerConsole.exe command") with or without a semicolon-separated
...
* `[--]list`
  ...
  :   Lists products that contain the specified name (see
      [product
      phrase](MySQLInstallerConsole.html#mi-console-product-phrase "Table 2.6 MySQL Product Phrases for use with the MySQLInstallerConsole.exe command")), This option can be combined with the
      `--version` and
      `--arch` options.
...
* `[--]update`
  ...
  `MySQLInstaller` or
  [**MySQLInstallerConsole.exe**](MySQLInstallerConsole.html "2.3.3.5 MySQL Installer Console Reference") is executed.

...
* **Select Products.**
  ...
  dashboard](mysql-installer-catalog-dashboard.html#windows-product-dashboard "MySQL Installer Dashboard"), MySQL Installer includes this action in the sidebar.
...
* Provides default installation and data paths for MySQL
  ...
  see [Section 2.3.3.2, “Setting Alternative Server Paths with MySQL Installer”](mysql-installer-change-path-proc.html "2.3.3.2 Setting Alternative Server Paths with MySQL Installer").
...
* [Bin Log](binary-log.html "7.4.4 The Binary Log")
...
During the [initial
setup](mysql-installer-setup.html "2.3.3.1 MySQL Installer Initial Setup"), choose any predetermined setup type, except

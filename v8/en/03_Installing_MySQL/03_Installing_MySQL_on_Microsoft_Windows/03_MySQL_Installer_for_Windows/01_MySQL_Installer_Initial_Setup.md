...
* [Choosing a Setup Type](mysql-installer-setup.html#setup-type "Choosing a Setup Type")
* [Path Conflicts](mysql-installer-setup.html#setup-conflicts "Path Conflicts")
* [Check Requirements](mysql-installer-setup.html#setup-requirements "Check Requirements")
* [MySQL Installer Configuration Files](mysql-installer-setup.html#setup-layout "MySQL Installer Configuration Files")
...
[MySQL Installer Commercial Release](mysql-installer.html#mysql-installer-commercial-edition "MySQL Installer Commercial Release")).
...
* **Client only**: Only install
  ...
  server, such as [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") or
...
* **Custom**: The custom setup
  ...
  products from the
  [MySQL Installer catalog](mysql-installer-catalog-dashboard.html#windows-product-catalog "Product Catalog").
  ...
  + An instance of MySQL server using an alternative
    ...
    [Section 2.3.3.2, “Setting Alternative Server Paths with MySQL Installer”](mysql-installer-change-path-proc.html "2.3.3.2 Setting Alternative Server Paths with MySQL Installer").
...
* Delete the existing product. Click
  ...
  operation from the
  [MySQL Installer
  dashboard](mysql-installer-catalog-dashboard.html#windows-product-dashboard "MySQL Installer Dashboard").
...
<td>This folder contains all of the files needed to run MySQL Installer and
              <a class="link" href="MySQLInstallerConsole.html" title="2.3.3.5 MySQL Installer Console Reference"><span class="command"><strong>MySQLInstallerConsole.exe</strong></span></a>, a

...
* Place your cursor at the end of the text appearing in the
  ...
  **End** key to ensure that your cursor is
  ...
  [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, and all MySQL command-line
  utilities such as [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") and

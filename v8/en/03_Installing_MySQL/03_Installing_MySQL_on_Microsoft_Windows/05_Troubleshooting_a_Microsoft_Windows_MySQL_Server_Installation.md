...
[error log](glossary.html#glos_error_log "error log"). The MySQL server
...
in the [data directory](glossary.html#glos_data_directory "data directory")
...
and understanding the content, see [Section 7.4.2, “The Error Log”](error-log.html "7.4.2 The Error Log").
...
from the command line after installing [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
...
* If the MySQL server cannot find the `mysql`
  ...
  in [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files").
  ...
  See [Section 2.3.4.2, “Creating an Option File”](windows-create-option-file.html "2.3.4.2 Creating an Option File").

...
[Secure
Deployment Guide](/doc/mysql-secure-deployment-guide/8.0/en/). For other platform-specific binary package
...
* If you have previously installed MySQL using your operating
  ...
  [APT
  guide](/doc/mysql-apt-repo-quick-guide/en/) or [Yum
  guide](/doc/refman/5.7/en/replace-third-party-yum.html).

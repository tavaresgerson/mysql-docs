...
* Start the server and make sure that it can be accessed. For
  instructions, see [Section 2.9.2, “Starting the Server”](starting-server.html "2.9.2 Starting the Server"), and
...
* Optionally, arrange for the server to start and stop
  ...
  instructions, see [Section 2.9.5, “Starting and Stopping MySQL Automatically”](automatic-start.html "2.9.5 Starting and Stopping MySQL Automatically").
...
management in [Section 8.2, “Access Control and Account Management”](access-control.html "8.2 Access Control and Account Management").
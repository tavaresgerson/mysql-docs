...
distributions. See [Table 2.3, “MySQL Installation Layout for Generic Unix/Linux Binary Package”](binary-installation.html#binary-installation-layout "Table 2.3 MySQL Installation Layout for Generic Unix/Linux Binary Package"),
and [Section 2.3.1, “MySQL Installation Layout on Microsoft Windows”](windows-installation-layout.html "2.3.1 MySQL Installation Layout on Microsoft Windows"). To configure

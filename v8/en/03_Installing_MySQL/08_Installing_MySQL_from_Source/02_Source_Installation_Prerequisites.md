...
* The Boost C++ libraries are required to build MySQL (but not
  ...
  for the [`WITH_BOOST`](source-configuration-options.html#option_cmake_with_boost) option when
...
the instructions in [Section 1.5, “How to Report Bugs or Problems”](bug-reports.html "1.5 How to Report Bugs or Problems").
...
* **Aliases**: You might want to
  ...
  access commonly used programs such as [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
  and [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") from the command line. The
  syntax for **bash** is:
  ...
  For more information, see [Section 6.2.1, “Invoking MySQL Programs”](invoking-programs.html "6.2.1 Invoking MySQL Programs").

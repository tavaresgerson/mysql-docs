...
covered in [Section 2.5, “Installing MySQL on Linux”](linux-installation.html "2.5 Installing MySQL on Linux"). One of the methods,
...
[Section 2.5.7, “Installing MySQL on Linux from the Native Software Repositories”](linux-installation-native.html "2.5.7 Installing MySQL on Linux from the Native Software Repositories"), particularly under
...
([**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") or [**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program") or
from
[MySQL
Shell's backup utility](/doc/mysql-shell/8.0/en/mysql-shell-utilities-dump-instance-schema.html)) just in case you need to rebuild your

...
:   A Kerberos authentication server. AS can also refer to the
    ...
    See Also [authentication server](glossary.html#glos_authentication_server).
...
:   In Kerberos, a service that provides the initial ticket needed
    ...
    See Also [key distribution center](glossary.html#glos_key_distribution_center), [ticket-granting server](glossary.html#glos_ticket_granting_server).
...
:   A special data structure that records changes to
    ...
    **system tablespace**, so that the
    ...
    [`SHOW ENGINE INNODB
    STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") command.
...
:   A **row format** for InnoDB tables.
    ...
    **COMPACT** row format provides a
    ...
    See Also [dynamic row format](glossary.html#glos_dynamic_row_format), [file format](glossary.html#glos_file_format), [redundant row format](glossary.html#glos_redundant_row_format), [row format](glossary.html#glos_row_format).
...
:   A **row format** that enables data
    ...
    **dynamic row format**. Both index
    ...
    used. See [Section 17.9, “InnoDB Table and Page Compression”](innodb-compression.html "17.9 InnoDB Table and Page Compression") for usage
    details.
    ...
    See Also [compression](glossary.html#glos_compression), [dynamic row format](glossary.html#glos_dynamic_row_format), [row format](glossary.html#glos_row_format).
...
:   A feature with wide-ranging benefits from using less disk space,
    ...
    **transparent page compression**.
    ...
    compression, see [Section 17.9, “InnoDB Table and Page Compression”](innodb-compression.html "17.9 InnoDB Table and Page Compression").

    Another type of compression is the
    **compressed backup** feature of
    the **MySQL Enterprise Backup** product.

    See Also [buffer pool](glossary.html#glos_buffer_pool), [compressed backup](glossary.html#glos_compressed_backup), [compressed row format](glossary.html#glos_compressed_row_format), [DML](glossary.html#glos_dml), [transparent page compression](glossary.html#glos_transparent_page_compression).
...
:   A **JDBC** driver that provides
    ...
    **Java** programming language.
    ...
    full details, see [MySQL Connector/J Developer Guide](/doc/connector-j/en/).
...
:   Data definition language, a set of
    ...
    **rolled back**.
    ...
    INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"), [`DROP INDEX`](drop-index.html "15.1.27 DROP INDEX Statement"), and
    ...
    TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") and [`TRUNCATE
...
:   The dictionary object cache stores previously accessed
    ...
    **LRU**-based eviction strategy is
    ...
    See Also [data dictionary](glossary.html#glos_data_dictionary), [LRU](glossary.html#glos_lru).
...
:   A kind of **DDL** operation that
    ...
    [`DROP INDEX`](drop-index.html "15.1.27 DROP INDEX Statement"). It maps internally to
    an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. From an
    ...
    **truncate** operation
    ([`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") statement).
...
:   An `InnoDB` row format. Because long
    ...
    See Also [buffer pool](glossary.html#glos_buffer_pool), [file format](glossary.html#glos_file_format), [row format](glossary.html#glos_row_format).
...
:   A capability first introduced in the InnoDB Plugin, now part of
    ...
    more kinds of [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
:   The file format for `InnoDB` tables.
    ...
    See Also [file-per-table](glossary.html#glos_file_per_table), [.ibd file](glossary.html#glos_ibd_file), [ibdata file](glossary.html#glos_ibdata_file), [row format](glossary.html#glos_row_format).
...
:   A shared `InnoDB`
    **tablespace** created using
    [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax. General
    ...
    **tables**, and support tables of
    ...
    [`CREATE TABLE
    tbl_name ... TABLESPACE [=]
    tablespace_name`](create-table.html "15.1.20 CREATE TABLE Statement") or
    [`ALTER TABLE
    tbl_name TABLESPACE [=]
    tablespace_name`](alter-table.html "15.1.9 ALTER TABLE Statement") syntax.
...
:   A *temporary tablespace* that stores
    *rollback segments* for changes made to
    ...
    See Also [temporary tablespace](glossary.html#glos_temporary_tablespace).
...
KDC
:   See [key distribution center](glossary.html#glos_key_distribution_center).

key distribution center
:   In Kerberos, the key distribution center comprises an
    authentication server (AS) and a ticket-granting server (TGS).

    See Also [authentication server](glossary.html#glos_authentication_server), [ticket-granting ticket](glossary.html#glos_ticket_granting_ticket).
...
:   A **backup** that reproduces table
    ...
    **`mysqldump`**
    ...
    statements such as [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
...
:   A type of **lock** that prevents
    ...
    **transaction**. For details, see
    ...
    [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") and
    [`DROP INDEX`](drop-index.html "15.1.27 DROP INDEX Statement") for
...
:   The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") program is the command-line
    ...
    **SQL** statements, and also
    ...
    TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement"), by passing requests to the
...
:   A feature that improves the performance, concurrency, and
    ...
    **DDL** (primarily
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")) operations. See
    ...
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") is in progress. The
...
:   The Kerberos term for a named entity, such as a user or server.
    ...
    See Also [service principal name](glossary.html#glos_service_principal_name), [user principal name](glossary.html#glos_user_principal_name).
...
:   A type of garbage collection performed by one or more separate
    ...
    **history list** for the purpose of
    ...
    for deletion (by previous [`DELETE`](delete.html "15.2.2 DELETE Statement")
...
:   To reduce the amount of database activity, often in preparation
    ...
    TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), a **backup**, or a
...
:   The storage area containing the **undo
    ...
    *global temporary tablespace*.
    ...
    See Also [global temporary tablespace](glossary.html#glos_global_temporary_tablespace), [system tablespace](glossary.html#glos_system_tablespace), [undo log](glossary.html#glos_undo_log), [undo tablespace](glossary.html#glos_undo_tablespace).
...
:   The disk storage format for
    ...
    **compression**, new row formats
    ...
    [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.38 SHOW TABLE STATUS Statement") statement or
...
:   Acronym for “serialized dictionary information”.
    ...
    See Also [serialized dictionary information (SDI)](glossary.html#glos_serialized_dictionary_information).
...
:   Dictionary object metadata in serialized form. SDI is stored in
    ...
    files using the [**ibd2sdi**](ibd2sdi.html "6.6.1 ibd2sdi — InnoDB Tablespace SDI Extraction Utility") utility if the data
    ...
    [`IMPORT TABLE`](import-table.html "15.2.6 IMPORT TABLE Statement") operation.

    See Also [file-per-table](glossary.html#glos_file_per_table), [general tablespace](glossary.html#glos_general_tablespace), [system tablespace](glossary.html#glos_system_tablespace), [tablespace](glossary.html#glos_tablespace).
...
:   The name for a Kerberos named entity that represents a service.
    ...
    See Also [principal](glossary.html#glos_principal).
...
:   A *temporary tablespace* that stores
    ...
    See Also [optimizer](glossary.html#glos_optimizer), [temporary table](glossary.html#glos_temporary_table), [temporary tablespace](glossary.html#glos_temporary_tablespace).
...
SPN
:   See [service principal name](glossary.html#glos_service_principal_name).
...
ST
:   See [service ticket](glossary.html#glos_service_ticket).
...
:   A data file that can hold data for one or more
    ...
    **off-page columns**, table
    ...
    using [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax.
...
:   `InnoDB` uses two types of temporary
    ...
    See Also [global temporary tablespace](glossary.html#glos_global_temporary_tablespace), [session temporary tablespace](glossary.html#glos_session_temporary_tablespace), [temporary table](glossary.html#glos_temporary_table).
...
:   A Kerberos ticket-granting server. TGS can also refer to the
    ...
    See Also [ticket-granting server](glossary.html#glos_ticket_granting_server).

TGT
:   See [ticket-granting ticket](glossary.html#glos_ticket_granting_ticket).
...
:   In Kerberos, a server that provides tickets. The ticket-granting
    ...
    See Also [authentication server](glossary.html#glos_authentication_server), [key distribution center](glossary.html#glos_key_distribution_center).
...
:   A feature added in MySQL 5.7.8 that permits page-level
    ...
    **file-per-table** tablespaces.
    ...
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"). For more
...
:   A feature that allows a
    **tablespace** to be moved from one
    ...
    running [`ALTER TABLE
    ... DISCARD TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") and
    [`ALTER TABLE ...
    IMPORT TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") on the other server brings the
...
UPN
:   See [user principal name](glossary.html#glos_user_principal_name).
...
:   A standard interface for coordinating distributed
    ...
    **ACID** compliance. For full
    details, see [Section 15.3.8, “XA Transactions”](xa.html "15.3.8 XA Transactions").

...
* To create or alter a stored function, you must have the
  ...
  [`SET_USER_ID`](privileges-provided.html#priv_set-user-id) or
...
* When you create a stored function, you must declare either
  ...
  FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") statement to be accepted, at least one of
...
exception: [`CREATE TRIGGER`](create-trigger.html "15.1.22 CREATE TRIGGER Statement") does not
...
TRIGGER`](create-trigger.html "15.1.22 CREATE TRIGGER Statement") if you do not have the required privileges. On
...
* The server writes [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement"),
  ...
  [`DROP PROCEDURE`](drop-procedure.html "15.1.29 DROP PROCEDURE and DROP FUNCTION Statements"), and
  [`DROP FUNCTION`](drop-function.html "15.1.26 DROP FUNCTION Statement") statements to the
  binary log.
...
* Logging stored function invocations rather than the statements
  ...
  + Statements executed on a replica are processed by the
    ...
    (see [Section 19.3.3, “Replication Privilege Checks”](replication-privilege-checks.html "19.3.3 Replication Privilege Checks")), the
  ...
  The [`CREATE FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") and
...
* Stored procedure calls are logged at the statement level
  ...
  + A statement to be logged might contain references to local
    ...
    *`var_name`*. Thus, if you invoke
    ...
    [`CREATE TABLE
    ... SELECT`](create-table.html "15.1.20 CREATE TABLE Statement") statements when the source column

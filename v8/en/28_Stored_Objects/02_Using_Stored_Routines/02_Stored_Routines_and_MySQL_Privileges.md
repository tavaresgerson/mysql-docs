...
* The account named as a routine `DEFINER` can
  ...
  + The [`SHOW FUNCTION CODE`](show-function-code.html "15.7.7.19 SHOW FUNCTION CODE Statement") and
    [`SHOW PROCEDURE CODE`](show-procedure-code.html "15.7.7.27 SHOW PROCEDURE CODE Statement")
    statements.

...
[27.3 Using Triggers](triggers.html)
:   [27.3.1 Trigger Syntax and Examples](trigger-syntax.html)

    [27.3.2 Trigger Metadata](trigger-metadata.html)

[27.4 Using the Event Scheduler](event-scheduler.html)
:   [27.4.1 Event Scheduler Overview](events-overview.html)

    [27.4.2 Event Scheduler Configuration](events-configuration.html)

    [27.4.3 Event Syntax](events-syntax.html)

    [27.4.4 Event Metadata](events-metadata.html)

    [27.4.5 Event Scheduler Status](events-status-info.html)

    [27.4.6 The Event Scheduler and MySQL Privileges](events-privileges.html)

[27.5 Using Views](views.html)
:   [27.5.1 View Syntax](view-syntax.html)

    [27.5.2 View Processing Algorithms](view-algorithms.html)

    [27.5.3 Updatable and Insertable Views](view-updatability.html)

    [27.5.4 The View WITH CHECK OPTION Clause](view-check-option.html)

    [27.5.5 View Metadata](view-metadata.html)

[27.6 Stored Object Access Control](stored-objects-security.html)

[27.7 Stored Program Binary Logging](stored-programs-logging.html)

[27.8 Restrictions on Stored Programs](stored-program-restrictions.html)

[27.9 Restrictions on Views](view-restrictions.html)
...
* Stored procedure: An object created with
  [`CREATE PROCEDURE`](create-procedure.html "15.1.17 CREATE PROCEDURE and CREATE FUNCTION Statements") and invoked
...
* Stored function: An object created with
  [`CREATE FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") and used much
  like a built-in function. You invoke it in an expression and it
  returns a value during expression evaluation.

* Trigger: An object created with [`CREATE
  TRIGGER`](create-trigger.html "15.1.22 CREATE TRIGGER Statement") that is associated with a table. A trigger is
  activated when a particular event occurs for the table, such as
  an insert or update.

* Event: An object created with [`CREATE
  EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") and invoked by the server according to schedule.

* View: An object created with [`CREATE
  VIEW`](create-view.html "15.1.23 CREATE VIEW Statement") that when referenced produces a result set. A

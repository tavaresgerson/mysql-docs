...
[`INSERT`](insert.html "15.2.7 INSERT Statement") or [`LOAD
DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements, and an insert trigger activates for each
...
* For answers to commonly asked questions regarding triggers in
  MySQL, see [Section A.5, “MySQL 8.0 FAQ: Triggers”](faqs-triggers.html "A.5 MySQL 8.0 FAQ: Triggers").

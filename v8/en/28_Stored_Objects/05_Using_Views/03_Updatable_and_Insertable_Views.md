...
[`DELETE`](delete.html "15.2.2 DELETE Statement") statements, but can only be
...
* Subquery in the select list
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement"), but are okay for
  [`UPDATE`](update.html "15.2.17 UPDATE Statement"),
  [`DELETE`](delete.html "15.2.2 DELETE Statement"). For dependent
...
* Multiple references to any column of a base table (fails for
  [`INSERT`](insert.html "15.2.7 INSERT Statement"), okay for
  [`UPDATE`](update.html "15.2.17 UPDATE Statement"),
...
[`UNION`](union.html "15.2.18 UNION Clause")). Also, only a single table
...
[`UNION ALL`](union.html "15.2.18 UNION Clause") are not
permitted even though they might be theoretically updatable.

With respect to insertability (being updatable with
[`INSERT`](insert.html "15.2.7 INSERT Statement") statements), an updatable
...
[`CREATE VIEW`](create-view.html "15.1.23 CREATE VIEW Statement") time. The flag is set
to `YES` (true) if
[`UPDATE`](update.html "15.2.17 UPDATE Statement") and
[`DELETE`](delete.html "15.2.2 DELETE Statement") (and similar operations) are
legal for the view. Otherwise, the flag is set to
`NO` (false). The `IS_UPDATABLE`
column in the Information Schema
[`VIEWS`](information-schema-views-table.html "28.3.48 The INFORMATION_SCHEMA VIEWS Table") table displays the status of
...
variable. See [Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables").
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement"), and
[`DELETE`](delete.html "15.2.2 DELETE Statement") statements are permitted as
follows:

* [`INSERT`](insert.html "15.2.7 INSERT Statement"): The insert table of an
  [`INSERT`](insert.html "15.2.7 INSERT Statement") statement may be a view
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement") can work if it inserts
  into a single table.
...
* [`UPDATE`](update.html "15.2.17 UPDATE Statement"): The table or tables to
  be updated in an [`UPDATE`](update.html "15.2.17 UPDATE Statement")
  ...
  In a multiple-table [`UPDATE`](update.html "15.2.17 UPDATE Statement")
  ...
  multiple-table [`UPDATE`](update.html "15.2.17 UPDATE Statement") is an
  updatable view (`vup`):
...
* [`DELETE`](delete.html "15.2.2 DELETE Statement"): The table or tables to
  be deleted from in a [`DELETE`](delete.html "15.2.2 DELETE Statement")
  statement must be merged views. Join views are not allowed
  (this differs from [`INSERT`](insert.html "15.2.7 INSERT Statement") and
  [`UPDATE`](update.html "15.2.17 UPDATE Statement")).

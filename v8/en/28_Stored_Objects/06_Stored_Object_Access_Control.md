...
* If you have the [`SET_USER_ID`](privileges-provided.html#priv_set-user-id)
  ...
  you must have the [`SYSTEM_USER`](privileges-provided.html#priv_system-user)
  privilege.
...
[`SET_USER_ID`](privileges-provided.html#priv_set-user-id) privilege, that
...
* To identify which `DEFINER` values exist in
  ...
  [`ALTER VIEW`](alter-view.html "15.1.11 ALTER VIEW Statement") to directly modify
...
* To identify which objects have a given
  ...
  For the [`ROUTINES`](information-schema-routines-table.html "28.3.30 The INFORMATION_SCHEMA ROUTINES Table") table, the
...
* By default, when a routine with the `SQL SECURITY
  ...
  [`CREATE
  FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") statement is issued. For stored programs,

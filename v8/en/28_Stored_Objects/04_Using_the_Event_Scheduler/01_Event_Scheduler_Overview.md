...
the type discussed in [Section 27.3, “Using Triggers”](triggers.html "27.3 Using Triggers"). Events should
...
* An event performs a specific action according to a schedule.
  ...
  [`BEGIN ...
  END`](begin-end.html "15.6.1 BEGIN ... END Compound Statement") block if desired (see
  [Section 15.6, “Compound Statement Syntax”](sql-compound-statements.html "15.6 Compound Statement Syntax")). An event's timing
...
* Users can create, modify, and drop scheduled events using SQL
  ...
  fails. See [Section 27.4.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "27.4.6 The Event Scheduler and MySQL Privileges") for details.
...
* Many of the properties of an event can be set or modified
  ...
  is assigned. See [Section 15.1.3, “ALTER EVENT Statement”](alter-event.html "15.1.3 ALTER EVENT Statement").
  ...
  [`EVENT`](privileges-provided.html#priv_event) privilege on the database

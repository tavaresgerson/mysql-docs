...
see [Section 27.8, “Restrictions on Stored Programs”](stored-program-restrictions.html "27.8 Restrictions on Stored Programs")). These are:

* `Com_create_event`: The number of
  [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statements
...
* `Com_drop_event`: The number of
  [`DROP EVENT`](drop-event.html "15.1.25 DROP EVENT Statement") statements executed
  since the last server restart.

* `Com_show_create_event`: The number of
  [`SHOW CREATE EVENT`](show-create-event.html "15.7.7.7 SHOW CREATE EVENT Statement") statements
  executed since the last server restart.

* `Com_show_events`: The number of
  [`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement") statements executed
  since the last server restart.

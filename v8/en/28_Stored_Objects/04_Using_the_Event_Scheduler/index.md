...
* [Section 27.4.1, “Event Scheduler Overview”](events-overview.html "27.4.1 Event Scheduler Overview"), provides an introduction to
  and conceptual overview of MySQL Events.

* [Section 27.4.3, “Event Syntax”](events-syntax.html "27.4.3 Event Syntax"), discusses the SQL statements
  for creating, altering, and dropping MySQL Events.

* [Section 27.4.4, “Event Metadata”](events-metadata.html "27.4.4 Event Metadata"), shows how to obtain
  information about events and how this information is stored by
  the MySQL Server.

* [Section 27.4.6, “The Event Scheduler and MySQL Privileges”](events-privileges.html "27.4.6 The Event Scheduler and MySQL Privileges"), discusses the privileges

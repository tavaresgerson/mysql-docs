...
* The [MySQL Reference
  Manual](json.html#json-paths "Searching and Modifying JSON Values") provides instructions to help you search for
  and modify JSON values.

* See [CollectionModifyFunction](/doc/x-devapi-userguide/en/crud-ebnf-collection-crud-functions.html#crud-ebnf-collectionmodifyfunction)

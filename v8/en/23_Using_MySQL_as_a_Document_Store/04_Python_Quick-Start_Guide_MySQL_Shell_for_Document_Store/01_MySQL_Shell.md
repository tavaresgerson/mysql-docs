...
* See [Interactive Code Execution](/doc/mysql-shell/8.0/en/mysql-shell-interactive-code-execution.html)
  for an explanation of how interactive code execution works
  in MySQL Shell.

* See [Getting Started with MySQL Shell](/doc/mysql-shell/8.0/en/mysql-shell-getting-started.html) to learn

...
* MySQL Shell is an interactive interface to MySQL supporting
  ...
  [Installing MySQL Shell](/doc/mysql-shell/8.0/en/mysql-shell-install.html) has instructions to
...
* The *MySQL Shell User Guide* at
  [MySQL Shell 8.0](/doc/mysql-shell/8.0/en/) provides detailed information

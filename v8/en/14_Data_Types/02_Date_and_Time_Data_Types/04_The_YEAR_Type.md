...
As of MySQL 8.0.19, the [`YEAR(4)`](year.html "13.2.4 The YEAR Type")
...
of MySQL. Instead, use [`YEAR`](year.html "13.2.4 The YEAR Type")
without a display width, which has the same meaning.

MySQL 8.0 does not support the 2-digit
[`YEAR(2)`](year.html "13.2.4 The YEAR Type") data type permitted in
older versions of MySQL. For instructions on converting to
4-digit [`YEAR`](year.html "13.2.4 The YEAR Type"), see

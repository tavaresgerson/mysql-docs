...
[`ENUM`](enum.html "13.3.5 The ENUM Type") type syntax and length
limits.

The [`ENUM`](enum.html "13.3.5 The ENUM Type") type has these
advantages:
...
[`SHOW COLUMNS
FROM tbl_name LIKE
'enum_col'`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement") and parse the
...
[C API Basic Data Structures](/doc/c-api/8.0/en/c-api-data-structures.html).
...
For example, this [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")

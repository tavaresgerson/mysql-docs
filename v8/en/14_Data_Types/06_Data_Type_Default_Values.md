...
For a given table, the [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") statement displays which columns have an explicit `DEFAULT` clause.

...
* [Connector/C++](/doc/connector-cpp/9.4/en/) enables C++
  applications to connect to MySQL.

* [Connector/J](/doc/connector-j/en/) provides
...
the [C API](/doc/c-api/8.0/en/) provides low-level access to
...
See also [MySQL C API Implementations](/doc/c-api/8.0/en/c-api-implementations.html).
...
chapter, the [C API](/doc/c-api/8.0/en/) is where to start. A
...
<td>C API</td>
<td><code class="literal">libmysqlclient</code></td>
<td>See <a class="ulink" href="/doc/c-api/8.0/en/" target="_top">MySQL 8.0 C API Developer Guide</a>.</td>
</tr><tr>
<th scope="row">C++</th>
<td>Connector/C++</td>
<td><code class="literal">libmysqlclient</code></td>
<td>See <a class="ulink" href="/doc/connector-cpp/9.4/en/" target="_top">MySQL Connector/C++ 9.5 Developer Guide</a>.</td>
</tr><tr>
<th scope="row"></th>
<td>MySQL++</td>
<td><code class="literal">libmysqlclient</code></td>

...
* Use [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") to empty a
  ...
  [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") might be
  fastest.
...
* Because the primary key is integral to the storage layout of
  ...
  [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement, and

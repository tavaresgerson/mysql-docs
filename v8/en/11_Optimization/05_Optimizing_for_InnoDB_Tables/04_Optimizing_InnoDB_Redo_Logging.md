...
* Increase the size of your redo log files. When
  ...
  disk in a [checkpoint](glossary.html#glos_checkpoint "checkpoint").
  ...
  configuration, see [Section 17.6.5, “Redo Log”](innodb-redo-log.html "17.6.5 Redo Log").

* Consider increasing the size of the
  [log buffer](glossary.html#glos_log_buffer "log buffer"). A large
  ...
  transactions [commit](glossary.html#glos_commit "commit").
...
* Optimize the use of spin delay by user threads waiting for
  ...
  + [`innodb_log_spin_cpu_pct_hwm`](innodb-parameters.html#sysvar_innodb_log_spin_cpu_pct_hwm):
    ...
    [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is pinned to only four

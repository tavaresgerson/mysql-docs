...
[Section 10.3.1, “How MySQL Uses Indexes”](mysql-indexes.html "10.3.1 How MySQL Uses Indexes") for details. Follow these
guidelines for `InnoDB` indexes:

* Because each `InnoDB` table has a
  [primary key](glossary.html#glos_primary_key "primary key") (whether
...
* Do not create a separate
  [secondary index](glossary.html#glos_secondary_index "secondary index")
  ...
  number of
  [concatenated
  indexes](glossary.html#glos_concatenated_index "concatenated index") rather than a large number of single-column

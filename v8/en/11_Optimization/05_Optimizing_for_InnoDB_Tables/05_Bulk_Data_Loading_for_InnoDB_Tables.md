...
* For optimal performance when loading data into an
  ...
  next [`CREATE
  FULLTEXT INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") call. This approach, however,
...
* Use MySQL Shell to import data. MySQL Shell's parallel
  ...
  capabilities. See [MySQL Shell Utilities](/doc/mysql-shell/8.0/en/mysql-shell-utilities.html).
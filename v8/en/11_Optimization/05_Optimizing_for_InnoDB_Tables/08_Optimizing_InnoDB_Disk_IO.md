...
* Consider non-rotational storage
  ...
  files, and
  [temporary
  tablespace](glossary.html#glos_temporary_tablespace "temporary tablespace") files. Sequential I/O-oriented files
  include `InnoDB`
  [system
  tablespace](glossary.html#glos_system_tablespace "system tablespace") files (due to
  [doublewrite
  buffering](glossary.html#glos_doublewrite_buffer "doublewrite buffer") prior to MySQL 8.0.20 and
  [change buffering](glossary.html#glos_change_buffer "change buffer")),
...
* Lower I/O capacity if flushing does not fall behind
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement"):
...
* Disable logging of compressed pages
  ...
  [compression](glossary.html#glos_compression "compression") feature,

...
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine"), to allocate memory for
...
6. Large page support in the MySQL server is disabled by
   ...
   [`--large-pages`](server-options.html#option_mysqld_large-pages). You can also
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), like this:

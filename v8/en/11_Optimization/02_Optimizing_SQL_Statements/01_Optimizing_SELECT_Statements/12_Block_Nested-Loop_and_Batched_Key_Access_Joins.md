...
In MySQL 8.0, the
[`block_nested_loop`](switchable-optimizations.html#optflag_block-nested-loop) flag of
...
* The second scenario is used for remote storage engines
  such as [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"). A package of

...
In [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") output, the
...
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") produces output like
this:
...
effect of 16.31% for the [`BETWEEN`](comparison-operators.html#operator_between)
condition on `employee.hire_date`. As a
result, [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") produces output
like this:
...
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement"): To provide more
...
system variable (see
[Section 10.9.2, “Switchable Optimizations”](switchable-optimizations.html "10.9.2 Switchable Optimizations")). This flag is

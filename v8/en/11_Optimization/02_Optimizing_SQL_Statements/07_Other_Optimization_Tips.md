...
* If your application makes several database requests to
  ...
  [Adding Functions to MySQL](/doc/extending-mysql/8.0/en/adding-functions.html) for more information.
...
* If you need really high speed, look at the low-level MySQL
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine, you

...
definition for [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"),
...
[`STATISTICS`](information-schema-statistics-table.html "28.3.34 The INFORMATION_SCHEMA STATISTICS Table") table or
[`SHOW INDEX`](show-index.html "15.7.7.22 SHOW INDEX Statement") output. For example:

...
[`end_markers_in_json=ON`](server-system-variables.html#sysvar_end_markers_in_json) repeats
...
If [`end_markers_in_json`](server-system-variables.html#sysvar_end_markers_in_json) is

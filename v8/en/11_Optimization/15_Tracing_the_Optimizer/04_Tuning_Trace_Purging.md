...
[`SET`](set.html "13.3.6 The SET Type") statement has the following
effects:

* All traces previously stored are cleared from memory.
* A subsequent [`SELECT`](select.html "15.2.13 SELECT Statement") from the
  [`OPTIMIZER_TRACE`](information-schema-optimizer-trace-table.html "28.3.19 The INFORMATION_SCHEMA OPTIMIZER_TRACE Table") table returns the

...
For example, [`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") is a
DDL statement that acquires locks in name order:

* This [`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") statement
...
[`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") executing before
...
[`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement"). The
...
until an [`XA
COMMIT`](xa.html "15.3.8 XA Transactions") or [`XA
ROLLBACK`](xa.html "15.3.8 XA Transactions") is executed.
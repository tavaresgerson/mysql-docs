...
* The [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")
  statement: [Section 15.7.7.29, “SHOW PROCESSLIST Statement”](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")
...
* The Performance Schema
  [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table:
  [Section 29.12.21.7, “The processlist Table”](performance-schema-processlist-table.html "29.12.21.7 The processlist Table")

* The Performance Schema
  [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table columns with
...
The [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table compares to
...
* Access to the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table
  ...
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") is
  available based on the Performance Schema
  [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table, which,
  like the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table,
  does not require a mutex and has better performance
  characteristics. For details, see
  [Section 29.12.21.7, “The processlist Table”](performance-schema-processlist-table.html "29.12.21.7 The processlist Table").

* The [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table displays
  ...
  [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table can be used to
...
monitor using the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table
instead.
...
[`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table in a more
...
The Performance Schema [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
...
labels from [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")
...
* `Info` indicates the statement the thread
  ...
  PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement"), this value contains only the first
  100 characters of the statement. To see complete
  statements, use
  [`SHOW
  FULL PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") (or query a different process
  information source).
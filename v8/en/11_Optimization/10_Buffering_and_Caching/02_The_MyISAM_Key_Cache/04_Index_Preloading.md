...
[`LOAD INDEX INTO
CACHE`](load-index.html "15.7.8.5 LOAD INDEX INTO CACHE Statement") statement. For example, the following
...
[`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") statement,

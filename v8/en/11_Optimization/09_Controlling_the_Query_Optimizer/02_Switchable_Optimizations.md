...
* Subquery Transformation Flags
  ...
  + [`subquery_to_derived`](switchable-optimizations.html#optflag_subquery-to-derived)
    ...
    - The subquery is not an `ANY` or
      ...
      rewritten to use
      [`MIN()`](aggregate-functions.html#function_min) or
    ...
    *************************** 3. row ***************************
    ...
    WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") immediately following the second
    ...
    *************************** 3. row ***************************
    ...
    [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") after
    ...
    *************************** 3. row ***************************
    ...
    If we execute [`SHOW
    WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") after running

...
* Presence of a [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types") or
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") column in the table.
...
* The [`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement") and
...
* [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size): From
  MySQL 8.0.28,
  ...
  When the [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size)
  ...
  table. The default
  [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) setting is
  ...
  If the [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size)
  ...
  [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) limit. If
  the [`tmp_table_size`](server-system-variables.html#sysvar_tmp_table_size) limit
...
* [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram):
  ...
  [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram) setting
  is 1073741824 bytes (1GiB).

  Note

  The [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram)
...
* [`temptable_use_mmap`](server-system-variables.html#sysvar_temptable_use_mmap):
  ...
  [`temptable_use_mmap=ON`](server-system-variables.html#sysvar_temptable_use_mmap).
  ...
  [`temptable_max_mmap=0`](server-system-variables.html#sysvar_temptable_max_mmap) is
  equivalent to setting
  [`temptable_use_mmap=OFF`](server-system-variables.html#sysvar_temptable_use_mmap).
...
* [`temptable_max_mmap`](server-system-variables.html#sysvar_temptable_max_mmap):
  ...
  ([`tmpdir`](server-system-variables.html#sysvar_tmpdir)). A
  [`temptable_max_mmap=0`](server-system-variables.html#sysvar_temptable_max_mmap)
...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"). For such tables,
...
* For common table expressions (CTEs), the storage engine
  ...
  `MyISAM`. If
  [`internal_tmp_disk_storage_engine=MYISAM`](server-system-variables.html#sysvar_internal_tmp_disk_storage_engine),

...
* For `MyISAM` tables, if you do not have
  ...
  the [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") option
  `ROW_FORMAT=FIXED`.
...
* If it is very likely that a long string column has a
  ...
  column (see [Section 15.1.15, “CREATE INDEX Statement”](create-index.html "15.1.15 CREATE INDEX Statement")). Shorter

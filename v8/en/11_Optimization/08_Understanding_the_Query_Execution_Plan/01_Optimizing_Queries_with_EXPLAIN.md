...
[Section 15.2.13, “SELECT Statement”](select.html "15.2.13 SELECT Statement").) However,
...
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") can also be used to
obtain information about the columns in a table.
[`EXPLAIN
tbl_name`](explain.html "15.8.2 EXPLAIN Statement") is synonymous
with `DESCRIBE
tbl_name` and
`SHOW COLUMNS FROM
tbl_name`. For more
information, see [Section 15.8.1, “DESCRIBE Statement”](describe.html "15.8.1 DESCRIBE Statement"), and

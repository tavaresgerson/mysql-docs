...
by issuing a [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement")
statement following [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement"). As
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") statements. Prior to
...
[`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") output displays how
...
[`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") statement following
[`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") is produced only for
[`SELECT`](select.html "15.2.13 SELECT Statement") statements.
[`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") displays an empty
...
WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") may contain special markers to provide

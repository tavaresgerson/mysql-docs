...
* **Binary log dump thread.**
  ...
  PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") on the source as the `Binlog
  Dump` thread.

* **Replication I/O receiver thread.**
  When a [`START REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement")

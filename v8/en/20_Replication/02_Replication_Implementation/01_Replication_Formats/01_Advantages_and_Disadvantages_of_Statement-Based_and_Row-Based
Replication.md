...
* [`INSERT ...
  SELECT`](insert-select.html "15.2.7.1 INSERT ... SELECT Statement") requires a greater number of row-level
...
* All changes can be replicated. This is the safest form of
  ...
  [`CREATE TABLE
  ... SELECT`](create-table.html "15.1.20 CREATE TABLE Statement"), a `CREATE`

...
:   [19.5.1 Replication Features and Issues](replication-features.html)
    ...
    [19.5.3 Upgrading a Replication Topology](replication-upgrade.html)
...
characteristic of NDB Cluster (see [Chapter 25, *MySQL NDB Cluster 8.0*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")).
...
[Section 19.4.10, “Semisynchronous Replication”](replication-semisync.html "19.4.10 Semisynchronous Replication"). MySQL 8.0 also
...
Cluster (see [Chapter 25, *MySQL NDB Cluster 8.0*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")).
...
Replication, see [Section A.14, “MySQL 8.0 FAQ: Replication”](faqs-replication.html "A.14 MySQL 8.0 FAQ: Replication").

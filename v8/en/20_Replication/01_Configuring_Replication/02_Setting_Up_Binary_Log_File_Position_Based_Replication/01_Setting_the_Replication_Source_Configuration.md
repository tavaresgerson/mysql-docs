...
[`server_id`](replication-options.html#sysvar_server_id) value from MySQL 8.0
...
[`log_bin`](replication-options-binary-log.html#sysvar_log_bin) system variable is set
to ON). The [`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin) option
...
names (see [Section B.3.7, “Known Issues in MySQL”](known-issues.html "B.3.7 Known Issues in MySQL")). If binary logging
...
* For the greatest possible durability and consistency in a
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") with transactions, you
  should use

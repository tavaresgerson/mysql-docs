...
2. Execute a `CHANGE REPLICATION SOURCE TO` | `CHANGE MASTER TO` statement on the replica to set the source configuration. See Section 19.1.2.7, “Setting the Source Configuration on the Replica”.

...
2. In a different session on the source, use the
   ...
   *************************** 1. row ***************************
   ...
   STATUS`](show-master-status.html "15.7.7.23 SHOW MASTER STATUS Statement") or [**mysqldump
   --master-data**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") are empty. In that case, the values

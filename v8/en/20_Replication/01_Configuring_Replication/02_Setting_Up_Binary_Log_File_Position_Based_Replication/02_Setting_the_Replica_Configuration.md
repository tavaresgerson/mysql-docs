...
The default [`server_id`](replication-options.html#sysvar_server_id) value is

1. You can change the [`server_id`](replication-options.html#sysvar_server_id)
...
[`log_slave_updates`](replication-options-binary-log.html#sysvar_log_slave_updates) system
...
[`--log-slave-updates=OFF`](replication-options-binary-log.html#sysvar_log_slave_updates) options

...
MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement (before MySQL 8.0.23). The
...
GTIDs in the [`gtid_purged`](replication-options-gtids.html#sysvar_gtid_purged) system
...
[`ER_FOUND_MISSING_GTIDS`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_found_missing_gtids). The
...
[`ER_FOUND_MISSING_GTIDS`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_found_missing_gtids) message

...
The [`RESET REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") statement can be
used to reset a multi-source replica. By default, if you use the
[`RESET REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") statement on a
...
REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") has no effect on the replica's GTID execution
history. If you want to clear this, issue
[`RESET MASTER`](reset-master.html "15.4.1.2 RESET MASTER Statement") on the replica.

[`RESET REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") makes the replica
...
[`RESET REPLICA
ALL`](reset-replica.html "15.4.2.4 RESET REPLICA Statement").

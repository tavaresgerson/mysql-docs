...
sources using [`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode),
...
on the replica (see [Section 19.2.2, “Replication Channels”](replication-channels.html "19.2.2 Replication Channels")). The
...
[Section 19.1.3.3, “GTID Auto-Positioning”](replication-gtids-auto-positioning.html "19.1.3.3 GTID Auto-Positioning")). The
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to issue the statement twice on
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client to issue the
[`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.2 CHANGE REPLICATION FILTER Statement") statement
...
FILTER`](change-replication-filter.html "15.4.2.2 CHANGE REPLICATION FILTER Statement") statement and other available options, see

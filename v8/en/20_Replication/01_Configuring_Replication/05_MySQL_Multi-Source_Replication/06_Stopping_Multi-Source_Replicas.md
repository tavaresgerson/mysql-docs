...
The [`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement can be
used to stop a multi-source replica. By default, if you use the
[`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement on a
...
REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") command and other available options, see

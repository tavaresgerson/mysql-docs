...
[`START REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statements. From
MySQL 8.0.22, [`STOP SLAVE`](stop-slave.html "15.4.2.9 STOP SLAVE Statement") and
[`START SLAVE`](start-slave.html "15.4.2.7 START SLAVE Statement") are deprecated, and
[`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") and
[`START REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") are available to
use instead.

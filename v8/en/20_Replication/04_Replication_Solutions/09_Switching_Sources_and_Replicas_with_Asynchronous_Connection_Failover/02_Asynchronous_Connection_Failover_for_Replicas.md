...
[`SOURCE_CONNECTION_AUTO_FAILOVER=1`](change-replication-source-to.html#crs-opt-source_connection_auto_failover)
in the [`CHANGE REPLICATION SOURCE
TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement for the channel. The feature is designed
...
[`SOURCE_RETRY_COUNT`](change-replication-source-to.html#crs-opt-source_retry_count) and
[`SOURCE_CONNECT_RETRY`](change-replication-source-to.html#crs-opt-source_connect_retry) are set to

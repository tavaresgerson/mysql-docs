...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement. The
...
REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statement to attempt to connect to a new
...
stopped by a [`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement")
statement.

...
[Figure 19.2, “Replicating Databases to Separate Replicas”](replication-solutions-partitioning.html#figure_replication-multi-db "Figure 19.2 Replicating Databases to Separate Replicas").
...
[Figure 19.2, “Replicating Databases to Separate Replicas”](replication-solutions-partitioning.html#figure_replication-multi-db "Figure 19.2 Replicating Databases to Separate Replicas"), you should
...
* Use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to create a separate dump
...
* Use a raw data file dump and include only the specific files
  ...
  This does not work with [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine")

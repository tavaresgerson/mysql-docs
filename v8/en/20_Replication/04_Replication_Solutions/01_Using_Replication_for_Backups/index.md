...
* If you are using replication as a solution to enable you to
  ...
  is not too large, the [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") tool may be
  suitable. See
...
* For larger databases, where [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") would

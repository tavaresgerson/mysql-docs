...
as an [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table named
...
* When GTID-based replication is in use
  ...
  see [Section 19.1.3.3, “GTID Auto-Positioning”](replication-gtids-auto-positioning.html "19.1.3.3 GTID Auto-Positioning"). When
...
method as the [`START
REPLICA UNTIL SQL_AFTER_MTS_GAPS`](start-replica.html "15.4.2.6 START REPLICA Statement") (or before MySQL

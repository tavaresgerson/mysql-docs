...
[`SET
GLOBAL`](set-variable.html "15.7.6.1 SET Syntax for Variable Assignment"), [`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement"),
and [`START REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statements

...
[`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"):
...
[Section 7.1.10, “Server Status Variables”](server-status-variables.html "7.1.10 Server Status Variables"). Some examples are:
...
[`Rpl_semi_sync_source_status`](server-status-variables.html#statvar_Rpl_semi_sync_source_status) or
[`Rpl_semi_sync_master_status`](server-status-variables.html#statvar_Rpl_semi_sync_master_status)
...
[`rpl_semi_sync_source_enabled`](replication-options-source.html#sysvar_rpl_semi_sync_source_enabled) or

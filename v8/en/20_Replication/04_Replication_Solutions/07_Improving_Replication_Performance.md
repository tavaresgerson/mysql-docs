...
[Figure 19.3, “Using an Additional Replication Source to Improve Performance”](replication-solutions-performance.html#figure_replication-performance "Figure 19.3 Using an Additional Replication Source to Improve Performance").
...
* Source 2 is the replica to the server Source 1 that provides
  ...
  [`--log-slave-updates`](replication-options-binary-log.html#sysvar_log_slave_updates) option
...
* If possible, put the relay logs and the data files on
  ...
  [`relay_log`](replication-options-replica.html#sysvar_relay_log) system variable to
...
* If heavy disk I/O activity for reads of the binary log file
  ...
  of the [`rpl_read_size`](replication-options-replica.html#sysvar_rpl_read_size) system
...
* If your replicas are not acting as sources, and you have a
  ...
  system variable
  [`log_replica_updates`](replication-options-binary-log.html#sysvar_log_replica_updates) (from
  MySQL 8.0.26) or
  [`log_slave_updates`](replication-options-binary-log.html#sysvar_log_slave_updates) (before

...
* **Binary log format changes.**
  ...
  [Section 19.5.3, “Upgrading a Replication Topology”](replication-upgrade.html "19.5.3 Upgrading a Replication Topology"), for more information.
...
set the [`terminology_use_previous`](replication-options-replica.html#sysvar_terminology_use_previous)

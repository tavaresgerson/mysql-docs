...
The [`BLACKHOLE`](blackhole-storage-engine.html "18.6 The BLACKHOLE Storage Engine") storage engine
...
the [`BLACKHOLE`](blackhole-storage-engine.html "18.6 The BLACKHOLE Storage Engine") storage engine that
you have the [`binlog_format`](replication-options-binary-log.html#sysvar_binlog_format)

...
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") statements are replicated:

* [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") always performs an implicit
...
* If the destination table does not exist, logging occurs as
  ...
  + `ROW` format: The statement is logged
    as a [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
...
* If the
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") statement fails, nothing is
...
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") statement to make any changes in

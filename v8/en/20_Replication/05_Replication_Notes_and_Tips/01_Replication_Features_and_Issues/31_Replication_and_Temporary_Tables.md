...
[`DROP TEMPORARY
TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statements cannot be used inside a transaction,
...
2. Use [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") to check the
   value of the

...
* Adding an `AUTO_INCREMENT` column to a
  table with [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") might
  ...
  *all* columns of `t1`.
  ...
  of [`CREATE
  TABLE ... LIKE`](create-table-like.html "15.1.20.3 CREATE TABLE ... LIKE Statement"): Foreign key definitions are
  ...
  `t2` using a [`CREATE
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement that is identical to the one used

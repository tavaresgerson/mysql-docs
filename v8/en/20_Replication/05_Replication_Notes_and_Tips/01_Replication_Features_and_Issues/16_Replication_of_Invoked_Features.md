...
* In the case of [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement")
  ...
  + The status of the event is set to
    ...
    to [`DROP EVENT`](drop-event.html "15.1.25 DROP EVENT Statement")).

  + The source on which the event was created is identified
    on the replica by its server ID. The
    `ORIGINATOR` column in
    [`INFORMATION_SCHEMA.EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table")
    stores this information. See
    [Section 15.7.7.18, “SHOW EVENTS Statement”](show-events.html "15.7.7.18 SHOW EVENTS Statement"), for more information.
...
[`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table in a manner similar to
what is shown here:
...
EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement") statement, like this:
...
[`ALTER EVENT
event_name ENABLE`](alter-event.html "15.1.3 ALTER EVENT Statement"), where
...
on the [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table to include the
...
[`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement") statement in a
similar fashion:
...
EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statements, restart the server, then re-enable
...
[`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statements. You can
do this by storing in a separate table the event names from the
[`SELECT`](select.html "15.2.13 SELECT Statement") statement shown
previously, or using [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement")
...
[`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table, as shown here:

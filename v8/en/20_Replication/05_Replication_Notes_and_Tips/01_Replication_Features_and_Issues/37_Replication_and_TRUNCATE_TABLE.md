...
[`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") is normally
...
storage engines such as [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") when
...
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") and other transactional
tables on replicas still follow the rules described in
[Section 15.1.37, “TRUNCATE TABLE Statement”](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") governing such tables. (Bug
#36763)
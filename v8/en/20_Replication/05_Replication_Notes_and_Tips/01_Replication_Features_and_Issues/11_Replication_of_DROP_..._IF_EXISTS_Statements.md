...
The [`DROP DATABASE
IF EXISTS`](drop-database.html "15.1.24 DROP DATABASE Statement"),
[`DROP TABLE IF
EXISTS`](drop-table.html "15.1.32 DROP TABLE Statement"), and
[`DROP VIEW IF
EXISTS`](drop-view.html "15.1.35 DROP VIEW Statement") statements are always replicated, even if the

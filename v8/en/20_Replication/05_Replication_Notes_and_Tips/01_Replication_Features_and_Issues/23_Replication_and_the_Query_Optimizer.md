...
include [`DELETE`](delete.html "15.2.2 DELETE Statement") or
[`UPDATE`](update.html "15.2.17 UPDATE Statement") statements that use
`LIMIT` with no `ORDER BY`
clause; see [Section 19.5.1.18, “Replication and LIMIT”](replication-features-limit.html "19.5.1.18 Replication and LIMIT"), for a

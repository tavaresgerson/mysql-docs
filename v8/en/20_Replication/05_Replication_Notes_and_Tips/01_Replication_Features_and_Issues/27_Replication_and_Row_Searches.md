...
[`DELETE`](delete.html "15.2.2 DELETE Statement") operation, it must search
...
rows in the [`UPDATE`](update.html "15.2.17 UPDATE Statement") or
[`DELETE`](delete.html "15.2.2 DELETE Statement") operation. For each row in
...
in the [`UPDATE`](update.html "15.2.17 UPDATE Statement") or
[`DELETE`](delete.html "15.2.2 DELETE Statement") operation, with the key as

...
* Columns common to both versions of the table must be
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement on the replica where a new
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement shown here is executed on the
  replica:
  ...
  The previous [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") is
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement cannot be executed on the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement just
...
* Between any of the decimal types
  ...
  [Section 14.24.4, “Rounding Behavior”](precision-math-rounding.html "14.24.4 Rounding Behavior"), for information

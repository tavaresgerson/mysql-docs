--- title: MySQL 8.4 Reference Manual :: 14.5 Flow Control Functions url: https://dev.mysql.com/doc/refman/8.4/en/flow-control-functions.html order: 10 ---
...
*  `NULLIF(expr1,expr2)`
  ...
  Returns `NULL` if `expr1 = expr2` is true, otherwise returns *`expr1`*. This is the same as [`CASE WHEN expr1 = expr2 THEN NULL ELSE expr1 END`](flow-control-functions.html#operator_case).

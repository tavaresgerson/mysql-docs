--- title: MySQL 8.4 Reference Manual :: 14.21 Performance Schema Functions url: https://dev.mysql.com/doc/refman/8.4/en/performance-schema-functions.html order: 86 ---
...
*  `PS_THREAD_ID(connection_id)`
  ...
  The connection ID argument is a value of the type given in the `PROCESSLIST_ID` column of the Performance Schema  `threads` table or the `Id` column of [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.31 SHOW PROCESSLIST Statement") output.

--- title: MySQL 8.4 Reference Manual :: 14.17.5 Functions That Return JSON Value Attributes url: https://dev.mysql.com/doc/refman/8.4/en/json-attribute-functions.html order: 61 ---

--- title: MySQL 8.4 Reference Manual :: 14.18.1.3 Functions to Inspect and Configure the Maximum Consensus Instances of a Group url: https://dev.mysql.com/doc/refman/8.4/en/group-replication-functions-for-maximum-consensus.html order: 69 ---

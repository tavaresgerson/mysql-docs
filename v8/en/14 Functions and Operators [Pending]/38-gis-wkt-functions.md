--- title: MySQL 8.4 Reference Manual :: 14.16.3 Functions That Create Geometry Values from WKT Values url: https://dev.mysql.com/doc/refman/8.4/en/gis-wkt-functions.html order: 38 ---

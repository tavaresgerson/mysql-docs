--- title: MySQL 8.4 Reference Manual :: 14.16.9.1 Spatial Relation Functions That Use Object Shapes url: https://dev.mysql.com/doc/refman/8.4/en/spatial-relation-functions-object-shapes.html order: 50 ---
...
* A unit is supported if it is found in the `INFORMATION_SCHEMA` `ST_UNITS_OF_MEASURE` table. See Section 28.3.37, “The INFORMATION\_SCHEMA ST\_UNITS\_OF\_MEASURE Table”.

--- title: MySQL 8.4 Reference Manual :: 14.18.3 Asynchronous Replication Channel Failover Functions url: https://dev.mysql.com/doc/refman/8.4/en/replication-functions-async-failover.html order: 73 ---

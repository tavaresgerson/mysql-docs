--- title: MySQL 8.4 Reference Manual :: 14.18.2 Functions Used with Global Transaction Identifiers (GTIDs) url: https://dev.mysql.com/doc/refman/8.4/en/gtid-functions.html order: 72 ---

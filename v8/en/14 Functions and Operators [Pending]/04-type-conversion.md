--- title: MySQL 8.4 Reference Manual :: 14.3 Type Conversion in Expression Evaluation url: https://dev.mysql.com/doc/refman/8.4/en/type-conversion.html order: 4 ---
...
This does *not* occur when `SELECT` is part of a data definition statement such as [`CREATE TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"); in strict mode, the statement fails due to the invalid comparison:

--- title: MySQL 8.4 Reference Manual :: 14.18.1.5 Functions to Set and Reset Group Replication Member Actions url: https://dev.mysql.com/doc/refman/8.4/en/group-replication-functions-for-member-actions.html order: 71 ---

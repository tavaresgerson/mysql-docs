--- title: MySQL 8.4 Reference Manual :: 12.9.8 Converting Between 3-Byte and 4-Byte Unicode Character Sets url: https://dev.mysql.com/doc/refman/8.4/en/charset-unicode-conversion.html order: 37 ---
...
* `utf8mb3` uses a maximum of three bytes per character. `utf8mb4` uses a maximum of four bytes per character. ::: info Note

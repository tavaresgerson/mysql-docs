...
time to create a bug report, see [Section 1.5, “How to Report Bugs or Problems”](bug-reports.html "1.5 How to Report Bugs or Problems").
...
* If the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server is causing problems,
  can you get any response from it with [**mysqladmin -u
  root ping**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") or [**mysqladmin -u root
  processlist**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program")?

* What does a client program say when you try to connect to
  the MySQL server? (Try with [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client"), for
  example.) Does the client jam? Do you get any output from
  the program?

When sending a bug report, you should follow the outline
described in [Section 1.5, “How to Report Bugs or Problems”](bug-reports.html "1.5 How to Report Bugs or Problems").
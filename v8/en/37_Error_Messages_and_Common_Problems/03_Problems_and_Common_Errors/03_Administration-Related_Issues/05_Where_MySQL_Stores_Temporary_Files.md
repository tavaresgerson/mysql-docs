...
too small, you can use the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
[`--tmpdir`](server-options.html#option_mysqld_tmpdir) option to specify a
directory in a file system where you have enough space.

The [`--tmpdir`](server-options.html#option_mysqld_tmpdir) option can be set
...
system variable
[`replica_load_tmpdir`](replication-options-replica.html#sysvar_replica_load_tmpdir) (from
MySQL 8.0.26) or
[`slave_load_tmpdir`](replication-options-replica.html#sysvar_slave_load_tmpdir) (before
MySQL 8.0.26) to specify a separate directory for holding
temporary files when replicating [`LOAD
DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements. This directory should be in a
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is terminated. On platforms that
...
large files associated with [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").)
...
Some [`SELECT`](select.html "15.2.13 SELECT Statement") queries creates
...
[`SHOW TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement") to list hidden
tables created by failed [`ALTER
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statements. See [Section 15.7.7.39, “SHOW TABLES Statement”](show-tables.html "15.7.7.39 SHOW TABLES Statement").
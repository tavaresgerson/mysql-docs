...
* Specify a [`--socket`](connection-options.html#option_general_socket) option
  on the command line to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") and
...
* Recompile MySQL from source to use a different default
  ...
  with the [`MYSQL_UNIX_ADDR`](source-configuration-options.html#option_cmake_mysql_unix_addr)

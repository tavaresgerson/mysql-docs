...
You can use the [**perror**](perror.html "6.8.2 perror — Display MySQL Error Message Information") utility to get a
...
The problem here is that [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is trying
to keep open too many files simultaneously. You can either
tell [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") not to open so many files at
once or increase the number of file descriptors available to
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").

To tell [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") to keep open fewer files at
...
[Section 10.4.3.1, “How MySQL Opens and Closes Tables”](table-cache.html "10.4.3.1 How MySQL Opens and Closes Tables"). Reducing the value of
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), you can use the
[`--open-files-limit`](mysqld-safe.html#option_mysqld_safe_open-files-limit) option
to [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") or set the
...
option file. See [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files"). If you have
an old version of [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") that does not
support setting the open files limit, you can edit the
[**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") script. There is a
...
to be made available to [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
...
overridden only if you start [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") or
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") as `root` (just
...
start [**mysqld\_safe**](mysqld-safe.html "6.3.2 mysqld_safe — MySQL Server Startup Script") using
**sh**.
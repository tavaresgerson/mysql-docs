...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server in two different ways: By
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"), a MySQL client first tries to
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") running on your server host. (Use
...
If a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is running, you can
...
[**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command. If you have no
...
* [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is not running on the local
  host. Check your operating system's process list to ensure
  the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process is present.
...
* Someone has removed the Unix socket file that
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") uses
  ...
  version**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") to check whether the Unix socket file
  that [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") is trying to use really
...
* You have started the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server with
  the
...
* You are using Linux and one server thread has died (dumped
  ...
  [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") threads (for example, with
  [**kill**](kill.html "15.7.8.4 KILL Statement")) before you can restart the MySQL
...
* The server or client program might not have the proper
  ...
  them, or restart [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with a
...
* If the server is running on the local host, try using
  [**mysqladmin -h localhost variables**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") to
...
* If you are running under Linux and Security-Enhanced Linux
  (SELinux) is enabled, see [Section 8.7, “SELinux”](selinux.html "8.7 SELinux").

...
<td><a class="ulink" href="/doc/mysql-errors/8.0/en/client-error-reference.html#error_cr_server_gone_error" target="_top"><code class="literal">CR_SERVER_GONE_ERROR</code></a></td>
<td>The client couldn't send a question to the server.</td>
</tr><tr>
<td><a class="ulink" href="/doc/mysql-errors/8.0/en/client-error-reference.html#error_cr_server_lost" target="_top"><code class="literal">CR_SERVER_LOST</code></a></td>
...
* You got a timeout from the TCP/IP connection on the client
  ...
  [`mysql_options(...,
  MYSQL_OPT_READ_TIMEOUT,...)`](/doc/c-api/8.0/en/mysql-options.html) or
  [`mysql_options(...,
  MYSQL_OPT_WRITE_TIMEOUT,...)`](/doc/c-api/8.0/en/mysql-options.html). In this case
...
* You are using a Windows client and the server had dropped
  ...
  [`mysql_ping()`](/doc/c-api/8.0/en/mysql-ping.html) on the

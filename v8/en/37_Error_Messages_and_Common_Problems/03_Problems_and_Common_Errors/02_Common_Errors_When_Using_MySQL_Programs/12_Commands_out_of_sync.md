...
[`mysql_use_result()`](/doc/c-api/8.0/en/mysql-use-result.html) and try to
execute a new query before you have called
[`mysql_free_result()`](/doc/c-api/8.0/en/mysql-free-result.html). It can
also happen if you try to execute two queries that return data
without calling
[`mysql_use_result()`](/doc/c-api/8.0/en/mysql-use-result.html) or
[`mysql_store_result()`](/doc/c-api/8.0/en/mysql-store-result.html) in
between.
...
* The host cache, which is accessible using the Performance
  Schema [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table. See
...
* The client program did not call
  [`mysql_close()`](/doc/c-api/8.0/en/mysql-close.html) before
  exiting.

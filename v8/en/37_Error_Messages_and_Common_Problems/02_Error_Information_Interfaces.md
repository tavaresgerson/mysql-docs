...
* [`SHOW ENGINE INNODB STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") statement output includes information about the most recent foreign key error if a `CREATE TABLE` statement for an `InnoDB` table fails.
...
The **perror** program provides information from the command line about error numbers. See Section 6.8.2, “perror — Display MySQL Error Message Information”.

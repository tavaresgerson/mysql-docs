...
plugin, see [Section 7.6.7, “The Clone Plugin”](clone-plugin.html "7.6.7 The Clone Plugin") . Detailed
prerequisites for a remote cloning operation are covered in
[Section 7.6.7.3, “Cloning Remote Data”](clone-plugin-remote.html "7.6.7.3 Cloning Remote Data") . For Group Replication,
...
* If you use [`START
  ...
  [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"), ensure
...
[Section 7.6.7.10, “Monitoring Cloning Operations”](clone-plugin-monitoring.html "7.6.7.10 Monitoring Cloning Operations") for information on
...
TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement, they are transferred to and used by
...
[Section 19.3.3.2, “Privilege Checks For Group Replication Channels”](replication-privilege-checks-gr.html "19.3.3.2 Privilege Checks For Group Replication Channels")), from MySQL

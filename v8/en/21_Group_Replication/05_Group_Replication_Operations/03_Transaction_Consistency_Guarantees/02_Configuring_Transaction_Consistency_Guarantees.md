...
reached an
[`ER_GR_HOLD_WAIT_TIMEOUT`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_gr_hold_wait_timeout) error
is thrown.
...
* [`SHOW`](show.html "15.7.7 SHOW Statements") statements: In MySQL
...
* [`SET`](set.html "13.3.6 The SET Type") statements
* 1 [`DO`](do.html "15.2.3 DO Statement") statements that do not

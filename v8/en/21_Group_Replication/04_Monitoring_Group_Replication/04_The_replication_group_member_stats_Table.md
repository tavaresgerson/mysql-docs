...
The
[`performance_schema.replication_group_member_stats`](performance-schema-replication-group-member-stats-table.html "29.12.11.15 The replication_group_member_stats Table")
...
[Section 20.7.2, “Flow Control”](group-replication-flow-control.html "20.7.2 Flow Control").
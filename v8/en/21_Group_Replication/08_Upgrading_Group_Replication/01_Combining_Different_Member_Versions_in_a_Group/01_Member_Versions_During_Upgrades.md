...
[Section 20.1.3.1, “Single-Primary Mode”](group-replication-single-primary-mode.html "20.1.3.1 Single-Primary Mode"). Note
...
must set [`super_read_only`](server-system-variables.html#sysvar_super_read_only) to

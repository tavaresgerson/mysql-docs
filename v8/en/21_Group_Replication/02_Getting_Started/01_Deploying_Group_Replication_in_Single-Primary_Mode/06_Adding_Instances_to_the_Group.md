...
as part of [`START
GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") (MySQL 8.0.21 or later), you can
do so like this:
...
2. Start the server and connect to it. Create the replication
   ...
   TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement, issue the following statement
   after that:
...
4. Start Group Replication:
   ...
   GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement (MySQL 8.0.21 or

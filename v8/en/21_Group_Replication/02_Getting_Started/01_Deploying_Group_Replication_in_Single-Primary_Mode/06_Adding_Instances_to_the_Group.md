...
If you are providing user credentials for distributed recovery as part of `START GROUP_REPLICATION` (MySQL 8.0.21 or later), you can do so like this:
...
4. Start Group Replication:
   ...
   If you are providing user credentials for distributed recovery in the `START GROUP_REPLICATION` statement (MySQL 8.0.21 or later), you can do so like this:

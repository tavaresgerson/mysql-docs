...
server using the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client, and issue the
...
(see [Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL")). If the upgrade is not run,

...
5. When you have created the replication user, you must supply
   ...
   TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement (MySQL 8.0.23 or later) or
   ...
   * User credentials set using [`CHANGE
     ...
     [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") are

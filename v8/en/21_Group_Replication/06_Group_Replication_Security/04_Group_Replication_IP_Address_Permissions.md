...
system variable
[`group_replication_ip_allowlist`](group-replication-system-variables.html#sysvar_group_replication_ip_allowlist) is
used to specify the allowlist, and for releases before MySQL
8.0.22, the system variable
[`group_replication_ip_whitelist`](group-replication-system-variables.html#sysvar_group_replication_ip_whitelist) is
...
[`STOP GROUP_REPLICATION`](stop-group-replication.html "15.4.3.2 STOP GROUP_REPLICATION Statement") before
changing the allowlist, and [`START
GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") afterwards. From MySQL 8.0.24, you can
...
[`bind_address`](server-system-variables.html#sysvar_bind_address) system variable for

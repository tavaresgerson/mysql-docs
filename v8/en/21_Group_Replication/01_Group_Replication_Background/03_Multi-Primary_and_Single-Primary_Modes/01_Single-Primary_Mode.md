...
([`group_replication_single_primary_mode=ON`](group-replication-system-variables.html#sysvar_group_replication_single_primary_mode))
...
mode (with [`super_read_only=ON`](server-system-variables.html#sysvar_super_read_only)).
...
[Section 20.5.3, “Transaction Consistency Guarantees”](group-replication-consistency-guarantees.html "20.5.3 Transaction Consistency Guarantees"). If
...
3. If more than one member is running the lowest MySQL
   ...
   [`server_uuid`](replication-options.html#sysvar_server_uuid) system
...
[`group_replication_primary_member`](group-replication-status-variables.html#statvar_group_replication_primary_member)

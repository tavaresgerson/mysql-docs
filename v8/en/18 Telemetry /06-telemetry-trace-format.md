...
A span represents an operation within a trace. For more information, see  OpenTelemetry Span. The following span types are emitted by the telemetry component:

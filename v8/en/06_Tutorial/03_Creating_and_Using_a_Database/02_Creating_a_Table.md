...
empty, as [`SHOW TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement") tells you:
...
Use a [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement to
...
TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement") should produce some output:

...
the [`mysql_insert_id()`](/doc/c-api/8.0/en/mysql-insert-id.html) C API
...
[`mysql_insert_id()`](/doc/c-api/8.0/en/mysql-insert-id.html) actually
...
* How to assign the `AUTO_INCREMENT`
  attribute to a column: [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"), and

...
DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement"), which lists the databases managed by the
...
database. See [Section 15.7.7.39, “SHOW TABLES Statement”](show-tables.html "15.7.7.39 SHOW TABLES Statement"), for more information.
...
You can obtain the [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
statement necessary to create an existing table using the
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") statement. See
...
about them. See [Section 15.7.7.22, “SHOW INDEX Statement”](show-index.html "15.7.7.22 SHOW INDEX Statement"), for more about this
statement.
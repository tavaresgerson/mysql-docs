...
name when you invoke [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") and, most likely, a
...
when [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") displays the `Enter
password:` prompt.
...
[**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") is ready for you to enter SQL statements.
...
[Chapter 2, *Installing MySQL*](installing.html "Chapter 2 Installing MySQL") that is appropriate to your operating
system.
...
server by invoking [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") without any options:

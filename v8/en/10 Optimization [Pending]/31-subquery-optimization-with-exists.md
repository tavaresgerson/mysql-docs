--- title: MySQL 8.4 Reference Manual :: 10.2.2.3 Optimizing Subqueries with the EXISTS Strategy url: https://dev.mysql.com/doc/refman/8.4/en/subquery-optimization-with-exists.html order: 31 ---
...
* `TRUE` when the “linked” outer expression *`oe_i`* is `NULL` ::: info Note

--- title: MySQL 8.4 Reference Manual :: 10.2.2.4 Optimizing Derived Tables, View References, and Common Table Expressions with Merging or Materialization url: https://dev.mysql.com/doc/refman/8.4/en/derived-table-optimization.html order: 32 ---

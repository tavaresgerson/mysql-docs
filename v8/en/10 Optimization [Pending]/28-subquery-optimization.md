--- title: MySQL 8.4 Reference Manual :: 10.2.2 Optimizing Subqueries, Derived Tables, View References, and Common Table Expressions url: https://dev.mysql.com/doc/refman/8.4/en/subquery-optimization.html order: 28 ---

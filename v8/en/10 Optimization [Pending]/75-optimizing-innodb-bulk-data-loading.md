--- title: MySQL 8.4 Reference Manual :: 10.5.5 Bulk Data Loading for InnoDB Tables url: https://dev.mysql.com/doc/refman/8.4/en/optimizing-innodb-bulk-data-loading.html order: 75 ---
...
* For optimal performance when loading data into an `InnoDB` `FULLTEXT` index, follow this set of steps:
  ...
  3. Create the `FULLTEXT` index after the data is loaded. ::: info Note

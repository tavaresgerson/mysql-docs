--- title: MySQL 8.4 Reference Manual :: 10.2.3 Optimizing INFORMATION_SCHEMA Queries url: https://dev.mysql.com/doc/refman/8.4/en/information-schema-optimization.html order: 34 ---
...
* Try to query only for static metadata. Selecting columns or using retrieval conditions for dynamic metadata along with static metadata adds overhead to process the dynamic metadata. ::: info Note

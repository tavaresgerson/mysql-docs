--- title: MySQL 8.4 Reference Manual :: 10.9.3 Optimizer Hints url: https://dev.mysql.com/doc/refman/8.4/en/optimizer-hints.html order: 95 ---
...
* *`hint_name`*: These hint names are permitted:
  ...
  +  `MERGE`, `NO_MERGE`: Enable merging for the specified tables, view references or common table expressions; or disable merging and use materialization instead. ::: info Note

--- title: MySQL 8.4 Reference Manual :: 10.5.9 Optimizing InnoDB Configuration Variables url: https://dev.mysql.com/doc/refman/8.4/en/optimizing-innodb-configuration-variables.html order: 79 ---

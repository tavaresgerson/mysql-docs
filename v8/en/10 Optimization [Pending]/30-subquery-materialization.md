--- title: MySQL 8.4 Reference Manual :: 10.2.2.2 Optimizing Subqueries with Materialization url: https://dev.mysql.com/doc/refman/8.4/en/subquery-materialization.html order: 30 ---

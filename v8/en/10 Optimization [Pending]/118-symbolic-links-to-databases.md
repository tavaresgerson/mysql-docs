--- title: MySQL 8.4 Reference Manual :: 10.12.2.1 Using Symbolic Links for Databases on Unix url: https://dev.mysql.com/doc/refman/8.4/en/symbolic-links-to-databases.html order: 118 ---
...
1. Create the database using [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement"):

...
[`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") statement preceding
each [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement") statement.
...
DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement") or [`USE`](use.html "15.8.4 USE Statement")
...
* Because the output contains no [`CREATE
  DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement") statement, the
  [`--add-drop-database`](mysqldump.html#option_mysqldump_add-drop-database) option
  has no effect. If you use it, it produces no
  [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") statement.

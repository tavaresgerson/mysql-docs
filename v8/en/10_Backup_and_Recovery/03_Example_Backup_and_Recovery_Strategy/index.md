...
[`--user`](connection-options.html#option_general_user) and
[`--password`](connection-options.html#option_general_password) for the
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client

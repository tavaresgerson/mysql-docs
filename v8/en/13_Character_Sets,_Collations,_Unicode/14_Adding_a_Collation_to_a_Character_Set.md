...
* Problems with collations generate warnings that clients can display with [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement"). Suppose that a reset rule contains an expansion longer than the maximum supported length of 6 characters:

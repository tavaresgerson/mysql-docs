...
options that you use when you start [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
You can use
...
same as saying
[`--character-set-server=utf8mb4`](server-system-variables.html#sysvar_character_set_server).
...
Both [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") and **CMake**
...
specified in [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement")

...
collation. The [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement")
and [`ALTER DATABASE`](alter-database.html "15.1.2 ALTER DATABASE Statement") statements
...
* For [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements,
...
* For [`LOAD DATA`](load-data.html "15.2.9 LOAD DATA Statement") statements that

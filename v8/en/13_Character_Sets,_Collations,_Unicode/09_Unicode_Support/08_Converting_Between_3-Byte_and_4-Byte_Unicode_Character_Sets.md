...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"). Suppose that a table has this definition:
...
* `InnoDB` has a maximum index length of 767
  ...
  related information, see [Section 17.22, “InnoDB Limits”](innodb-limits.html "17.22 InnoDB Limits"),
...
problems, using [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") as

...
* The SQL mode in effect when the problem occurred can be
  ...
  PROCEDURE`](show-create-procedure.html "15.7.7.9 SHOW CREATE PROCEDURE Statement") or [`SHOW CREATE
  FUNCTION`](show-create-function.html "15.7.7.8 SHOW CREATE FUNCTION Statement") statement shows the relevant SQL mode, or you

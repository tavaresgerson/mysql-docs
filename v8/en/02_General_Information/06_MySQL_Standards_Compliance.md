...
* SQL statement syntax
  ...
  + Use of index names, indexes on a prefix of a column, and use of `INDEX` or `KEY` in [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements. See Section 15.1.20, “CREATE TABLE Statement”.

  + Use of `TEMPORARY` or `IF NOT EXISTS` with [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement").
...
Alternatively, you can use [`SELECT ... INTO OUTFILE`](select-into.html "15.2.13.1 SELECT ... INTO Statement") or [`CREATE TABLE ... SELECT`](create-table.html "15.1.20 CREATE TABLE Statement").
...
* MySQL parses but ignores “inline `REFERENCES` specifications” (as defined in the SQL standard) where the references are defined as part of the column specification. MySQL accepts `REFERENCES` clauses only when specified as part of a separate `FOREIGN KEY` specification.
  ...
  When used in this fashion, the `REFERENCES` clause is not displayed in the output of [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") or `DESCRIBE`:
...
You can get information about the number of rows actually inserted or updated with the `mysql_info()` C API function. You can also use the [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") statement. See mysql_info(), and Section 15.7.7.42, “SHOW WARNINGS Statement”.

...
systems as well as for embedding into mass-deployed software. Oracle
...
affiliates, and shall not be used by Customer without Oracle's
express written authorization. Other names may be trademarks of
...
* For an overview of new MySQL features, see
  [Section 1.3, “What Is New in MySQL 8.0”](mysql-nutshell.html "1.3 What Is New in MySQL 8.0"). For information about the
  changes in each version, see the
  [Release
  Notes](/doc/relnotes/mysql/8.0/en/).

* For installation instructions, see [Chapter 2, *Installing MySQL*](installing.html "Chapter 2 Installing MySQL").
...
* For information about configuring and administering MySQL
  Server, see [Chapter 7, *MySQL Server Administration*](server-administration.html "Chapter 7 MySQL Server Administration").
...
* For answers to a number of questions that are often asked
  ...
  [Appendix A, *MySQL 8.0 Frequently Asked Questions*](faqs.html "Appendix A MySQL 8.0 Frequently Asked Questions").
...
[Section 1.5, “How to Report Bugs or Problems”](bug-reports.html "1.5 How to Report Bugs or Problems"). If you find a security bug in MySQL
Server, please let us know immediately by sending an email message
to `<secalert_us@oracle.com>`. Exception: Support

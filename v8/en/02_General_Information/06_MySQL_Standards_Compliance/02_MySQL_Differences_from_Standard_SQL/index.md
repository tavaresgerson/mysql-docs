...
[1.6.2.1 SELECT INTO TABLE Differences](ansi-diff-select-into-table.html)

[1.6.2.2 UPDATE Differences](ansi-diff-update.html)

[1.6.2.3 FOREIGN KEY Constraint Differences](ansi-diff-foreign-keys.html)

[1.6.2.4 '--' as the Start of a Comment](ansi-diff-comments.html)

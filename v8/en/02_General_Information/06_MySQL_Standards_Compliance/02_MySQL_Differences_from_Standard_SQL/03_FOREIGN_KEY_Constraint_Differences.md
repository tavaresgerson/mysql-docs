...
* MySQL requires that the referenced columns be indexed for
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") extension. The
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine, on the
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") or `DELETE
...
* MySQL parses but ignores “inline
  ...
  TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") or
  [`DESCRIBE`](describe.html "15.8.1 DESCRIBE Statement"):

...
[1.6.3.1 PRIMARY KEY and UNIQUE Index Constraints](constraint-primary-key.html)

[1.6.3.2 FOREIGN KEY Constraints](constraint-foreign-key.html)

[1.6.3.3 Enforced Constraints on Invalid Data](constraint-invalid-data.html)

[1.6.3.4 ENUM and SET Constraints](constraint-enum.html)

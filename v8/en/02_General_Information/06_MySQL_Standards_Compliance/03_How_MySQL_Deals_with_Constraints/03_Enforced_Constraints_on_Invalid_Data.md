...
[Section 7.1.11, “Server SQL Modes”](sql-mode.html "7.1.11 Server SQL Modes")), but this is not recommended.

Older versions of MySQL employed the forgiving behavior by
default; for a description of this behavior, see
[Constraints on Invalid Data](/doc/refman/5.7/en/constraint-invalid-data.html).
...
[`INFORMATION_SCHEMA`](information-schema.html "Chapter 28 INFORMATION_SCHEMA Tables") tables and
[`SHOW`](show.html "15.7.7 SHOW Statements") statements. For an overview of
...
be viewed by issuing a [`SHOW TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement")
...
See [How the Data Dictionary is Upgraded](data-dictionary-schema.html#data-dictionary-upgrade "How the Data Dictionary is Upgraded"). Upgrading MySQL
...
The [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")
[`--no-dd-upgrade`](server-options.html#option_mysqld_no-dd-upgrade) option can be
used to prevent automatic upgrade of data dictionary tables at
startup. When [`--no-dd-upgrade`](server-options.html#option_mysqld_no-dd-upgrade) is
...
[`debug`](server-options.html#option_mysqld_debug) option and modifier. For
...
[`SET`](set.html "13.3.6 The SET Type") statement to make data
dictionary tables visible to the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client
session:
...
Use [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to view

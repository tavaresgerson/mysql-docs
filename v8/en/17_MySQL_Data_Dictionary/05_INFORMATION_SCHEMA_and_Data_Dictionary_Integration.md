...
* `KEYWORDS`
* [`PARAMETERS`](information-schema-parameters-table.html "28.3.20 The INFORMATION_SCHEMA PARAMETERS Table")
* [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table")
* [`REFERENTIAL_CONSTRAINTS`](information-schema-referential-constraints-table.html "28.3.25 The INFORMATION_SCHEMA REFERENTIAL_CONSTRAINTS Table")
* [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.26 The INFORMATION_SCHEMA RESOURCE_GROUPS Table")
* [`ROUTINES`](information-schema-routines-table.html "28.3.30 The INFORMATION_SCHEMA ROUTINES Table")
* [`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table")
* [`STATISTICS`](information-schema-statistics-table.html "28.3.34 The INFORMATION_SCHEMA STATISTICS Table")
* [`ST_GEOMETRY_COLUMNS`](information-schema-st-geometry-columns-table.html "28.3.35 The INFORMATION_SCHEMA ST_GEOMETRY_COLUMNS Table")
* [`ST_SPATIAL_REFERENCE_SYSTEMS`](information-schema-st-spatial-reference-systems-table.html "28.3.36 The INFORMATION_SCHEMA ST_SPATIAL_REFERENCE_SYSTEMS Table")
* [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table")
* [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "28.3.42 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table")
* [`TRIGGERS`](information-schema-triggers-table.html "28.3.45 The INFORMATION_SCHEMA TRIGGERS Table")
* [`VIEWS`](information-schema-views-table.html "28.3.48 The INFORMATION_SCHEMA VIEWS Table")
* [`VIEW_ROUTINE_USAGE`](information-schema-view-routine-usage-table.html "28.3.49 The INFORMATION_SCHEMA VIEW_ROUTINE_USAGE Table")
* [`VIEW_TABLE_USAGE`](information-schema-view-table-usage-table.html "28.3.50 The INFORMATION_SCHEMA VIEW_TABLE_USAGE Table")
...
DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") displays the same information as the
[`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table") table.

In addition to the introduction of views on data dictionary
tables, table statistics contained in the
[`STATISTICS`](information-schema-statistics-table.html "28.3.34 The INFORMATION_SCHEMA STATISTICS Table") and
[`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table") tables is now cached to

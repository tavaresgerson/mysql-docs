...
* `.frm` files: Table metadata files. With
  ...
  + The Information Schema [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table")
...
* `ddl_log.log` file: The file contained
  ...
  statements such as [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement")

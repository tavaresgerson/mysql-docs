...
files. [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") stores SDI data in
...
[`CHECK TABLE FOR
UPGRADE`](check-table.html "15.7.3.2 CHECK TABLE Statement"). SDI data is not updated when the MySQL server
...
tablespace files using the [**ibd2sdi**](ibd2sdi.html "6.6.1 ibd2sdi — InnoDB Tablespace SDI Extraction Utility") tool.
...
[DDL](glossary.html#glos_ddl "DDL") operations to create and

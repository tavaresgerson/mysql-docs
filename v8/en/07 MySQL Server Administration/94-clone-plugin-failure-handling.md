...
2. Concurrent DDL on the donor is blocked only if the `clone_block_ddl` variable is set to `ON` (the default setting is `OFF`). See Section 7.6.7.4, “Cloning and Concurrent DDL”.

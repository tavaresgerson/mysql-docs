...
The [ACID](glossary.html#glos_acid "ACID") model is a set of database
...
[transactions](glossary.html#glos_transaction "transaction"). Related MySQL
features include:

* The [`autocommit`](server-system-variables.html#sysvar_autocommit) setting.
* The [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") statement.
* The [`ROLLBACK`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
  statement.
...
model mainly involves `InnoDB`
[transactions](glossary.html#glos_transaction "transaction"), in particular
the [isolation level](glossary.html#glos_isolation_level "isolation level") that
applies to each transaction. Related MySQL features include:

* The [`autocommit`](server-system-variables.html#sysvar_autocommit) setting.
* Transaction isolation levels and the [`SET
  TRANSACTION`](set-transaction.html "15.3.7 SET TRANSACTION Statement") statement. See
...
* The low-level details of `InnoDB`
  [locking](glossary.html#glos_locking "locking"). Details can be
  viewed in the `INFORMATION_SCHEMA` tables (see
  [Section 17.15.2, “InnoDB INFORMATION\_SCHEMA Transaction and Locking Information”](innodb-information-schema-transactions.html "17.15.2 InnoDB INFORMATION_SCHEMA Transaction and Locking Information")) and
...
* The [`sync_binlog`](replication-options-binary-log.html#sysvar_sync_binlog) variable.

...
* For limitations associated with importing tables using the *Transportable Tablespaces* feature, see [Table Import Limitations](innodb-statistics-estimation.html "17.8.10.2 Configuring Non-Persistent Optimizer Statistics Parameters").

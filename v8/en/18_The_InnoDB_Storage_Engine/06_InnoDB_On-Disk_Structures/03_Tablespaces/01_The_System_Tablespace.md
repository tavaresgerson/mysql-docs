...
MySQL data dictionary. See [Chapter 16, *MySQL Data Dictionary*](data-dictionary.html "Chapter 16 MySQL Data Dictionary"). In
...
the [`innodb_data_file_path`](innodb-parameters.html#sysvar_innodb_data_file_path) startup
...
in the [`innodb_data_file_path`](innodb-parameters.html#sysvar_innodb_data_file_path)
...
changing the
[`innodb_data_file_path`](innodb-parameters.html#sysvar_innodb_data_file_path) setting
...
[Section 17.6.3.2, “File-Per-Table Tablespaces”](innodb-file-per-table-tablespaces.html "17.6.3.2 File-Per-Table Tablespaces"). General
...
with the [`--memlock`](server-options.html#option_mysqld_memlock) option, the
...
For additional information, see [Section 6.2.2.2, “Using Option Files”](option-files.html "6.2.2.2 Using Option Files").
...
1. To use a raw device for a new server instance, first prepare
   ...
   [`innodb_data_file_path`](innodb-parameters.html#sysvar_innodb_data_file_path) with
...
2. Then initialize the server for the first time by using
   ...
   [`--initialize-insecure`](server-options.html#option_mysqld_initialize-insecure). InnoDB

...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement to
...
* A table-copying [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
* [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") performance is
...
* Tables created in file-per-table tablespaces can be backed
  ...
  [Making a Partial Backup](/doc/mysql-enterprise-backup/8.0/en/partial.html) for details.
...
* There is potential for more fragmentation, which can impede
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") and table scan

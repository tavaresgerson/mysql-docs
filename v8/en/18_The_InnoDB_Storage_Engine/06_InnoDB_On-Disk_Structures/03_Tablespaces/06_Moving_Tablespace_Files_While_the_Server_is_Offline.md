...
The [`innodb_directories`](innodb-parameters.html#sysvar_innodb_directories) variable,
...
whether an [`innodb_directories`](innodb-parameters.html#sysvar_innodb_directories)
...
[`--datadir`](server-system-variables.html#sysvar_datadir) setting before
...
[file-per-table](glossary.html#glos_file_per_table "file-per-table") and
[general tablespace](glossary.html#glos_general_tablespace "general tablespace")
files, [system
tablespace](glossary.html#glos_system_tablespace "system tablespace") files, [undo
tablespace](glossary.html#glos_undo_tablespace "undo tablespace") files, or the data directory. Before moving
...
3. Make the new directory known to `InnoDB`.
   ...
   * If moving individual
     ...
     or [general
     tablespace](glossary.html#glos_general_tablespace "general tablespace") files, add unknown directories to the
     ...
     + The directories defined by the
       ...
       and [`datadir`](server-system-variables.html#sysvar_datadir) variables
   ...
   * If moving system tablespace files, undo tablespaces, or
     ...
     [`innodb_data_home_dir`](innodb-parameters.html#sysvar_innodb_data_home_dir),
     [`innodb_undo_directory`](innodb-parameters.html#sysvar_innodb_undo_directory),
     and [`datadir`](server-system-variables.html#sysvar_datadir) settings, as
     necessary.
...
* [`innodb_directories`](innodb-parameters.html#sysvar_innodb_directories) supports
...
* When moving a data directory from a Windows operating system
  ...
  [`--log-bin`](replication-options-binary-log.html#option_mysqld_log-bin). The default location
...
* If moving tablespace files to a different operating system
  ...
  [`CREATE TABLE ...
  DATA DIRECTORY`](create-table.html "15.1.20 CREATE TABLE Statement") and
  [`CREATE
  TABLESPACE ... ADD DATAFILE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement").
...
* Add the directories of file-per-table and general tablespaces
  ...
  Schema [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table:

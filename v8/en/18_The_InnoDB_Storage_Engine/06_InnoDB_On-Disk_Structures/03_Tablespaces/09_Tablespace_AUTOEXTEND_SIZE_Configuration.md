...
[`ALTER TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") cannot be used to
configure the `AUTOEXTEND_SIZE` of a
file-per-table tablespace. [`ALTER
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") must be used.

For tables created in file-per-table tablespaces,
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") shows the

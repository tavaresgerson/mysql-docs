...
* [Undo Tablespace Status Variables](innodb-undo-tablespaces.html#innodb-undo-tablespace-status-variables "Undo Tablespace Status Variables")
...
depends on the [`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size)
...
[`DROP UNDO
TABALESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") syntax. See
[Dropping Undo Tablespaces](innodb-undo-tablespaces.html#innodb-drop-undo-tablespaces "Dropping Undo Tablespaces").
...
[`CREATE UNDO
TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax can be dropped at runtime using
[`DROP UNDO
TABALESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") syntax.
...
[`ALTER UNDO
TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") syntax so that the tablespace is no longer
...
[`ALTER UNDO
TABLESPACE tablespace_name SET
ACTIVE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") statement. Attempting to drop an undo
...
[`ALTER UNDO
TABLESPACE tablespace_name SET
INACTIVE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") statement. Before a default undo tablespace
...
[`CREATE UNDO
TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax can be moved while the server is
...
3. The [purge](glossary.html#glos_purge "purge") system empties
...
4. After all rollback segments in the undo tablespace are
   ...
   [`CREATE
   UNDO TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax can be determined by
...
Information Schema [`INNODB_METRICS`](information-schema-innodb-metrics-table.html "28.4.21 The INFORMATION_SCHEMA INNODB_METRICS Table")
table.

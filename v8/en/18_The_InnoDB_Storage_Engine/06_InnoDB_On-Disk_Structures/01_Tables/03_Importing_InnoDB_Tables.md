...
* [Prerequisites](innodb-table-import.html#innodb-table-import-prerequsites "Prerequisites")
* [Importing Tables](innodb-table-import.html#innodb-table-import-example "Importing Tables")
* [Importing Partitioned Tables](innodb-table-import.html#innodb-table-import-partitioned-table "Importing Partitioned Tables")
* [Importing Table Partitions](innodb-table-import.html#innodb-table-import-partitions "Importing Table Partitions")
* [Limitations](innodb-table-import.html#innodb-table-import-limitations "Limitations")
* [Usage Notes](innodb-table-import.html#innodb-table-import-usage-notes "Usage Notes")
* [Internals](innodb-table-import.html#innodb-table-import-internals "Internals")
...
* The page size of the tablespace must match the page size of
  ...
  [`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size) variable,
  which is configured when initializing a MySQL server
  instance.

* If the table has a foreign key relationship,
  [`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks) must be
  ...
  [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") does not enforce foreign key
...
* If the table was created in an external directory by
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to view the
...
* If a `ROW_FORMAT` option is not defined
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to check
  the table definition. Use [`SHOW
  VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") to check the
  [`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
1. On the destination instance, create a table with the same
   ...
   CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") syntax.) If the table definition does
...
3. On the source instance, run
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) to quiesce the table you
   ...
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) ensures that changes to the
   named table are flushed to disk so that a binary table copy
   can be made while the server is running. When
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) is run,
   `InnoDB` generates a
   ...
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) must remain open while the
...
5. On the source instance, use
   [`UNLOCK
   TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") to release the locks acquired by the
   [`FLUSH
   ...
   The [`UNLOCK
   TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") operation also removes the
   `.cfg` file.
...
1. On the destination instance, create a partitioned table with
   ...
   [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") syntax.) If
...
3. On the source instance, run
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) to quiesce the partitioned
   ...
   [`FLUSH
   TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) can only be run on the
...
5. On the source instance, use
   [`UNLOCK
   TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") to release the locks acquired by
   [`FLUSH
...
1. On the destination instance, create a partitioned table with
   ...
   TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") syntax.) If the table definition does not
...
2. On the destination instance, discard the partitions that you
   ...
   When [`ALTER
   TABLE ... DISCARD PARTITION ... TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") is
...
6. On the destination instance, import table partitions
   ...
   When [`ALTER
   TABLE ... IMPORT PARTITION ... TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") is run
...
* [`FLUSH
  TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) is not supported on tables
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") to rebuild the
...
* Prior to MySQL 8.0.19, index key part sort order information
  ...
  part sort order, see [Section 15.1.15, “CREATE INDEX Statement”](create-index.html "15.1.15 CREATE INDEX Statement").
...
* With the exception of tables that contain instantly added or
  dropped columns,
  [`ALTER TABLE ...
  IMPORT TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") does not require a
...
* On Windows, `InnoDB` stores database,
  ...
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) to 1
...
* When running
  [`ALTER TABLE ...
  DISCARD PARTITION ... TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") and
  [`ALTER TABLE ...
  IMPORT PARTITION ... TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") on subpartitioned
...
When [`ALTER TABLE
... DISCARD TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") is run on the destination
instance:
...
When
[`FLUSH
TABLES ... FOR EXPORT`](flush.html#flush-tables-for-export-with-list) is run on the source instance:
...
When [`UNLOCK
TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") is run on the source instance:
...
When [`ALTER TABLE
... IMPORT TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") is run on the destination

...
* When loading large volumes of data with a sequence of
  ...
  TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement")) and start over from the beginning rather than
  doing a
  [`ROLLBACK`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements").
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement"). A [deadlock](glossary.html#glos_deadlock "deadlock")
...
[deadlock detection](glossary.html#glos_deadlock_detection "deadlock detection")
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output.
...
[DYNAMIC](glossary.html#glos_dynamic_row_format "dynamic row format") and
[COMPRESSED](glossary.html#glos_compressed_row_format "compressed row format") row
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to perform conversion, to test the old and new
...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement to use.
...
If an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation runs
...
* Declare the `PRIMARY KEY` clause in the
  original [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")

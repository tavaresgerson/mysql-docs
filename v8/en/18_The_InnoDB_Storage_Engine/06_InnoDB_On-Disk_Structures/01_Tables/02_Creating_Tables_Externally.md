...
(see [Tablespace Discovery During Crash Recovery](innodb-recovery.html#innodb-recovery-tablespace-discovery "Tablespace Discovery During Crash Recovery")).
...
[`CREATE TABLE ...
TABLESPACE`](create-table.html "15.1.20 CREATE TABLE Statement") syntax can be used in combination with the

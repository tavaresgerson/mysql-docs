...
TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") statement:
...
2. Issue this [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement
...
4. Issue this [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement
   ...
   The [`ALTER TABLE
   ... IMPORT TABLESPACE`](alter-table.html "15.1.9 ALTER TABLE Statement") feature does not enforce
...
2. Wait until [`SHOW
   ENGINE INNODB STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") shows that there are no active

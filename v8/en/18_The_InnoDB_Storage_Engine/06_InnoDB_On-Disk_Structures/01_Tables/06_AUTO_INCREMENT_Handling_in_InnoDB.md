...
* Modifying `AUTO_INCREMENT` column values in
  ...
  of a sequence of [`INSERT`](insert.html "15.2.7 INSERT Statement")
  statements could lead to “Duplicate entry”
  errors. For example, if you performed an
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") operation that changed
  ...
  [`INSERT`](insert.html "15.2.7 INSERT Statement") operations allocate
...
[`ALTER TABLE ...
AUTO_INCREMENT = N`](alter-table.html "15.1.9 ALTER TABLE Statement") can only change the
auto-increment counter value to a value larger than the
current maximum.

In MySQL 5.7 and earlier, a server restart immediately following
a [`ROLLBACK`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
...
If a [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.38 SHOW TABLE STATUS Statement") statement

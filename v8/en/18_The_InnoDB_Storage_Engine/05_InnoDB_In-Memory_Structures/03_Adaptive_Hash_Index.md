...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output. If there are numerous threads waiting on
...
indexes, see [Section 10.3.9, “Comparison of B-Tree and Hash Indexes”](index-btree-hash.html "10.3.9 Comparison of B-Tree and Hash Indexes").
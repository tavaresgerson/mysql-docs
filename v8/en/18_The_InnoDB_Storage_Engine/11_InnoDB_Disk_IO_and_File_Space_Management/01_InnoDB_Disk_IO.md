...
[doublewrite
buffer](glossary.html#glos_doublewrite_buffer "doublewrite buffer"), which is enabled by default in most cases
([`innodb_doublewrite=ON`](innodb-parameters.html#sysvar_innodb_doublewrite)). It
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") process exit in the middle of a page
write (causing a [torn page](glossary.html#glos_torn_page "torn page")

...
created using [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement")
...
issuing a [`SHOW TABLE STATUS`](show-table-status.html "15.7.7.38 SHOW TABLE STATUS Statement")
...
[purge](glossary.html#glos_purge "purge") operation, which happens

...
* Consistent read does not work over [`DROP
  TABLE`](drop-table.html "15.1.32 DROP TABLE Statement"), because MySQL cannot use a table that has
...
[`CREATE TABLE ...
SELECT`](create-table.html "15.1.20 CREATE TABLE Statement") that do not specify `FOR
UPDATE` or `FOR SHARE`:

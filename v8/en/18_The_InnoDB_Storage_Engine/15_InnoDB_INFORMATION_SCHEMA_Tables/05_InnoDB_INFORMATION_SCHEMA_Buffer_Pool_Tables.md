...
* [`INNODB_BUFFER_POOL_STATS`](information-schema-innodb-buffer-pool-stats-table.html "28.4.4 The INFORMATION_SCHEMA INNODB_BUFFER_POOL_STATS Table"):
  ...
  [`SHOW ENGINE
  INNODB STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output, or may be obtained using
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") and `InnoDB` buffer pool
status variables.
...
For comparison,
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output and `InnoDB` buffer
pool status variable output is shown below, based on the same
data set.

For more information about
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output, see

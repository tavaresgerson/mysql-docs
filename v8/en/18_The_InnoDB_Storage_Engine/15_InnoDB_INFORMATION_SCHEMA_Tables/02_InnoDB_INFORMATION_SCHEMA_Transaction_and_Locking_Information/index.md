...
[InnoDB INFORMATION\_SCHEMA Transaction and Locking Information](/doc/refman/5.7/en/innodb-information-schema-transactions.html),
...
* [`INNODB_TRX`](information-schema-innodb-trx-table.html "28.4.28 The INFORMATION_SCHEMA INNODB_TRX Table"): This
...
* [`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table"): This Performance
  ...
  + Each transaction in InnoDB that is waiting for another
    ...
    [`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table") contains one row
    that describes each lock the transaction has requested,
    and for which it is waiting.

* [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table"): This Performance
  ...
  [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") have the same
...
[Section 29.12.13.1, “The data\_locks Table”](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table"), and

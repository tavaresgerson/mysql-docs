...
[Persistence and Consistency of InnoDB Transaction and Locking Information](/doc/refman/5.7/en/innodb-information-schema-internal-data.html),
...
* Data in the transaction and locking tables might not be
  ...
  `INFORMATION_SCHEMA`
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table") table or
  ...
  with data in the [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table")
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table"), for example), the
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table") or for the

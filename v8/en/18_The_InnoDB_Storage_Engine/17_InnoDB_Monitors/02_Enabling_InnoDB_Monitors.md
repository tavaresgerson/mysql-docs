...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server standard error output
...
[`--console`](server-options.html#option_mysqld_console) option. For more
information, see
...
The [`innodb_status_output`](innodb-parameters.html#sysvar_innodb_status_output) and
[`innodb_status_output_locks`](innodb-parameters.html#sysvar_innodb_status_output_locks) system
variables are used to enable the standard
`InnoDB` Monitor and `InnoDB`
Lock Monitor.

The [`PROCESS`](privileges-provided.html#priv_process) privilege is required
to enable or disable `InnoDB` Monitors.

#### Enabling the Standard InnoDB Monitor

Enable the standard `InnoDB` Monitor by setting
the [`innodb_status_output`](innodb-parameters.html#sysvar_innodb_status_output) system
variable to `ON`.
...
[`innodb_status_output`](innodb-parameters.html#sysvar_innodb_status_output) to
`OFF`.

When you shut down the server, the
[`innodb_status_output`](innodb-parameters.html#sysvar_innodb_status_output) variable is
...
When you shut down the server, the
[`innodb_status_output`](innodb-parameters.html#sysvar_innodb_status_output) and
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output, you are only required to enable
[`innodb_status_output_locks`](innodb-parameters.html#sysvar_innodb_status_output_locks).
...
INNODB STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") SQL statement, which fetches the output to
your client program. If you are using the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client")
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output also includes `InnoDB`

...
plugin, consult [Section 17.20.5, “Security Considerations for the InnoDB memcached Plugin”](innodb-memcached-security.html "17.20.5 Security Considerations for the InnoDB memcached Plugin") to
...
2. Activate the `daemon_memcached` plugin by
   running the [`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement")
   statement:
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") startup string, encoded in the
argument of the
...
in a [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") startup string. They take effect

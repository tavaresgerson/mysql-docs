...
plugin speeds up [DML](glossary.html#glos_dml "DML") operations
...
The following [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") and
[`DELETE`](delete.html "15.2.2 DELETE Statement") statements, which remove

...
* [`innodb_log_file_size`](innodb-parameters.html#sysvar_innodb_log_file_size) (prior
  to MySQL 8.0.30)
...
* [`innodb_buffer_pool_size`](innodb-parameters.html#sysvar_innodb_buffer_pool_size)
  ...
  **Table 17.8 Automatically Configured Buffer Pool Size**
  ...
  <table summary="The first column           shows the amount of server memory detected. The second column shows           the buffer pool size which is automatically determined."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
...
* [`innodb_redo_log_capacity`](innodb-parameters.html#sysvar_innodb_redo_log_capacity)
  ...
  **Table 17.9 Automatically Configured Log File Size**
  ...
  <table summary="The first column shows the buffer pool size. The second column shows the automatically configured redo log capacity."><col style="width: 33%"/><col style="width: 33%"/><col style="width: 34%"/><thead><tr>
<th>Detected Server Memory</th>
<th>Buffer Pool Size</th>
...
* [`innodb_log_file_size`](innodb-parameters.html#sysvar_innodb_log_file_size)
  ...
  **Table 17.10 Automatically Configured Log File Size**
  ...
  <table summary="The first column           shows the buffer pool size. The second column shows the log file size           which is automatically determined."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Buffer Pool Size</th>
<th>Log File Size</th>
</tr></thead><tbody><tr>
<td>Less than 8GB</td>
...
* [`innodb_log_files_in_group`](innodb-parameters.html#sysvar_innodb_log_files_in_group)
  ...
  **Table 17.11 Automatically Configured Number of Log Files**
  ...
  <table summary="The first column shows           the buffer pool size. The second column shows the number of log files           which is automatically determined."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Buffer Pool Size</th>

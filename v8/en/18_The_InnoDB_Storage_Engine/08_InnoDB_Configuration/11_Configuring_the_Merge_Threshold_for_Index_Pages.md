...
clause with [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"):
...
clause with [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"),
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), or
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"), as shown in the
following examples:

* Setting `MERGE_THRESHOLD` for an individual
  index using [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"):
...
* Setting `MERGE_THRESHOLD` for an individual
  index using [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"):
...
* Setting `MERGE_THRESHOLD` for an individual
  index using [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"):
...
You can use [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to
...
Likewise, you can use [`SHOW INDEX`](show-index.html "15.7.7.22 SHOW INDEX Statement") to

...
[`--innodb-buffer-pool-in-core-file=OFF`](innodb-parameters.html#sysvar_innodb_buffer_pool_in_core_file)
...
The [`core_file`](server-system-variables.html#sysvar_core_file) variable is read
only and disabled by default. It is enabled by specifying the
[`--core-file`](server-options.html#option_mysqld_core-file) option at startup.
The
[`innodb_buffer_pool_in_core_file`](innodb-parameters.html#sysvar_innodb_buffer_pool_in_core_file)

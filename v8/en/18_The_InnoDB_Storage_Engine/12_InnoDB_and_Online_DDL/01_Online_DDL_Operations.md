...
* Creating or adding a secondary index
  ...
  [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") statement only
  ...
  [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") or
...
* Dropping an index
  ...
  [`DROP INDEX`](drop-index.html "15.1.27 DROP INDEX Statement") statement only
  finishes after all transactions that are accessing the table
  are completed, so that the initial state of the index
  reflects the most recent contents of the table.
...
* Adding a column
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. For
  example:
  ...
  [`ALTER TABLE ...
  ALGORITHM=INSTANT`](alter-table.html "15.1.9 ALTER TABLE Statement") operation that adds one or more
  ...
  rebuilt by table-rebuilding [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") or [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement")
...
* Extending `VARCHAR` column size
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") only supports increasing
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") does not support
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") returns this error:
...
* Making a column `NOT NULL`
  ...
  referential integrity. See [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement").
  Data is reorganized substantially, making it an expensive
  operation.
...
* Modifying the definition of an `ENUM` or
  ...
  [`SET`](set.html "13.3.6 The SET Type") column that has 8 members
...
* Dropping a foreign key constraint
  ...
  [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "28.3.42 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table") table and use
...
* An [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") on the child
...
* In the same way, if a table is the
  ...
  for the [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to
...
* Renaming a general tablespace
  ...
  [`ALTER
  TABLESPACE ... RENAME TO`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") uses the
...
* Enabling or disabling general tablespace encryption
  ...
  [`ALTER
  TABLESPACE ... ENCRYPTION`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") uses the
  `INPLACE` algorithm but does not support
  the `ALGORITHM` clause.
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") partitioning clauses, online DDL operations for
partitioned `InnoDB` tables follow the same
rules that apply to regular `InnoDB` tables.

Some [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") partitioning
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") partitioning clauses varies.
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") partitioning options
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement, and table
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">PARTITION BY</code></a></th>
<td>No</td>
<td>No</td>
<td>No</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">ADD PARTITION</code></a></th>
<td>No</td>
<td>Yes*</td>
<td>Yes*</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">DROP PARTITION</code></a></th>
<td>No</td>
<td>Yes*</td>
<td>Yes*</td>
<td><p>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">DISCARD PARTITION</code></a></th>
<td>No</td>
<td>No</td>
<td>No</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">IMPORT PARTITION</code></a></th>
<td>No</td>
<td>No</td>
<td>No</td>
<td>Only permits <code class="literal">ALGORITHM=DEFAULT</code>,
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">TRUNCATE
              PARTITION</code></a></th>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">COALESCE
              PARTITION</code></a></th>
<td>No</td>
<td>Yes*</td>
<td>No</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">REORGANIZE
              PARTITION</code></a></th>
<td>No</td>
<td>Yes*</td>
<td>No</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">EXCHANGE
              PARTITION</code></a></th>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">ANALYZE PARTITION</code></a></th>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
<td></td>
</tr><tr>
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">CHECK PARTITION</code></a></th>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
<td></td>
</tr><tr>
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">OPTIMIZE
              PARTITION</code></a></th>
<td>No</td>
<td>No</td>
<td>No</td>
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">REBUILD PARTITION</code></a></th>
<td>No</td>
<td>Yes*</td>
<td>No</td>
<td><code class="literal">ALGORITHM=INPLACE, LOCK={DEFAULT|SHARED|EXCLUSIVE}</code> is
...
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">REPAIR PARTITION</code></a></th>
<td>No</td>
<td>Yes</td>
<td>Yes</td>
<td></td>
</tr><tr>
<th scope="row"><a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">REMOVE
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations on partitioned tables follow the same
rules that apply to regular tables. However,
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") performs online
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") partitioning clauses, see

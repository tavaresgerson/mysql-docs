...
requested by the [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
operation in session 2 to be granted.

You can use
[`SHOW FULL
PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") to determine if transactions are waiting
for a metadata lock.
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") progress. See

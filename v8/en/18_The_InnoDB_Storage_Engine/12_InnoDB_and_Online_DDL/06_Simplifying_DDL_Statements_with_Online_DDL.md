...
into a single [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
statement. Because each [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") for each slightly different scenario.

For DDL operations that can be done online, you can separate them
into individual [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statements for:

...
* The [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") clause
...
* When running an in-place online DDL operation, the thread that
  runs the [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement
...
* [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") for an
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation to
...
* Tables created before MySQL 5.6 that include temporal columns
  ...
  [`ALTER TABLE ...
  ALGORITHM=INPLACE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation returns the following
  error:

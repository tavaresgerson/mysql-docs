...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. For example:
...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. Attempting
to set the
[`innodb_default_row_format`](innodb-parameters.html#sysvar_innodb_default_row_format)
...
following [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations that use
`ALGORITHM=COPY` or
...
* The `REDUNDANT` and
  ...
  For related information, see [Section 17.22, “InnoDB Limits”](innodb-limits.html "17.22 InnoDB Limits").

...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"). Supported compression
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. However,
[`ALTER TABLE ...
COMPRESSION`](alter-table.html "15.1.9 ALTER TABLE Statement") only updates the tablespace compression
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"). Writes to the
...
Use [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to view the
...
check the Information Schema [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table")
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") also shows the
...
* Before downgrading to an earlier version of MySQL that does
  ...
  [`ALTER TABLE ...
  COMPRESSION=None`](alter-table.html "15.1.9 ALTER TABLE Statement") and [`OPTIMIZE

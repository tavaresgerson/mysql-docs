...
[Table 17.12, “ROW\_FORMAT and KEY\_BLOCK\_SIZE Options”](innodb-compression-syntax-warnings.html#innodb-compression-create-and-alter-options-table "Table 17.12 ROW_FORMAT and KEY_BLOCK_SIZE Options")
...
[Table 17.13, “CREATE/ALTER TABLE Warnings and Errors when InnoDB Strict Mode is OFF”](innodb-compression-syntax-warnings.html#innodb-compression-create-and-alter-errors-table "Table 17.13 CREATE/ALTER TABLE Warnings and Errors when InnoDB Strict Mode is OFF")
summarizes error conditions that occur with certain combinations
of configuration parameters and options on the
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statements, and how

...
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"). If the row does not
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") and select a larger
...
information, see [Section 15.1.21, “CREATE TABLESPACE Statement”](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement").

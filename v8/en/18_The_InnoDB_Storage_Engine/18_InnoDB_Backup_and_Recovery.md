...
* Change buffer merge
  ...
  Applying changes from the change buffer (part of the [system tablespace](glossary.html#glos_system_tablespace "system tablespace")) to leaf pages of secondary indexes, as the index pages are read to the buffer pool.

...
You can monitor [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"). Each stage event
reports a running total of `WORK_COMPLETED` and
`WORK_ESTIMATED` for the overall
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation as it
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") performs, and may be
...
In order of occurrence, [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
stage events include:

* `stage/innodb/alter table (read PK and internal
  sort)`: This stage is active when
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") is in the
...
* `stage/innodb/alter table (merge sort)`: This
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation.
...
* `stage/innodb/alter table (log apply table)`:
  ...
  generated while [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") was
...
`InnoDB` [`ALTER
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") stage events do not currently account for the
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") progress. For
...
3. Run an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation.
...
4. Check the progress of the [`ALTER
   TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation by querying the Performance Schema
   ...
   [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") phase is currently
   ...
   TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation has completed. In this case, you can

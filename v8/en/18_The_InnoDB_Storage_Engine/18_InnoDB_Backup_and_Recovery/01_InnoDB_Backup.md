...
[cold backup](glossary.html#glos_cold_backup "cold backup") by copying
files while the MySQL server is shut down;
[logical backup](glossary.html#glos_logical_backup "logical backup") with
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") for smaller data volumes or to record
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") server for faster restore.
...
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"). A binary file might be corrupted
...
serious data corruption is smaller. [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")
...
clients. See [Section 9.3.1, “Establishing a Backup Policy”](backup-policy.html "9.3.1 Establishing a Backup Policy").

Replication works with [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") tables,

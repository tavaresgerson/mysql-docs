...
*  `--basedir=dir_name`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--basedir=dir_name</code></td> </tr><tr><th>Type</th> <td>Directory name</td> </tr></tbody></table>
...
*  `--datadir=dir_name`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--datadir=dir_name</code></td> </tr><tr><th>Type</th> <td>Directory name</td> </tr></tbody></table>
...
*  `--ledir=dir_name`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--ledir=dir_name</code></td> </tr><tr><th>Type</th> <td>Directory name</td> </tr></tbody></table>
...
*  `--malloc-lib=[lib_name]`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--malloc-lib=[lib-name]</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>
...
*  `--mysqld=prog_name`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--mysqld=file_name</code></td> </tr><tr><th>Type</th> <td>File name</td> </tr></tbody></table>
...
*  `--nice=priority`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--nice=priority</code></td> </tr><tr><th>Type</th> <td>Numeric</td> </tr></tbody></table>

  Use the `nice` program to set the server's scheduling priority to the given value.
*  `--no-defaults`

  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--no-defaults</code></td> </tr><tr><th>Type</th> <td>String</td> </tr></tbody></table>
...
*  `--port=port_num`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--port=number</code></td> </tr><tr><th>Type</th> <td>Numeric</td> </tr></tbody></table>
...
*  `--syslog`, `--skip-syslog`
  ...
  <table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--syslog</code></td> </tr><tr><th>Deprecated</th> <td>Yes</td> </tr></tbody></table><table><col style="width: 30%"/><col style="width: 70%"/><tbody><tr><th>Command-Line Format</th> <td><code>--skip-syslog</code></td> </tr><tr><th>Deprecated</th> <td>Yes</td> </tr></tbody></table>

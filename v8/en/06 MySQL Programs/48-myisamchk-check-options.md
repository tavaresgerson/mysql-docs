...
*  `--information`, `-i`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--information</code></td> </tr></tbody></table>
...
*  `--read-only`, `-T`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--read-only</code></td> </tr></tbody></table>
...
*  `--update-state`, `-U`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--update-state</code></td> </tr></tbody></table>

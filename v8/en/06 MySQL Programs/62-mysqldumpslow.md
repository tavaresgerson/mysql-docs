...
*  `--debug`, `-d`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--debug</code></td> </tr></tbody></table>
...
* `-g pattern`
  ...
  <table><tbody><tr><th>Type</th> <td>String</td> </tr></tbody></table>

  Consider only queries that match the (`grep`-style) pattern.
* `-h host_name`

  <table><tbody><tr><th>Type</th> <td>String</td> </tr><tr><th>Default Value</th> <td><code>*</code></td> </tr></tbody></table>
...
* `-n N`
  ...
  <table><tbody><tr><th>Type</th> <td>Numeric</td> </tr></tbody></table>
...
* `-s sort_type`
  ...
  <table><tbody><tr><th>Type</th> <td>String</td> </tr><tr><th>Default Value</th> <td><code>at</code></td> </tr></tbody></table>

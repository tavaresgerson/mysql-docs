...
*  `--keys`, `-k`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--keys</code></td> </tr></tbody></table>
...
*  `--show-table-type`, `-t`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--show-table-type</code></td> </tr></tbody></table>
...
*  `--status`, `-i`
  ...
  <table><tbody><tr><th>Command-Line Format</th> <td><code>--status</code></td> </tr></tbody></table>

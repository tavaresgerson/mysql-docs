...
1. ### Selecting a Target Series
   ...
   For important information about upgrading from MySQL 5.7 to 8.0, see [Upgrading from MySQL 5.7 to 8.0](upgrading-from-previous-series.html "3.5 Changes in MySQL 8.0").

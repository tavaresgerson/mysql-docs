...
* The following instructions assume you have installed MySQL
  ...
  [Replacing a Third-Party Distribution of MySQL Using the MySQL Yum Repository](/doc/refman/5.7/en/replace-third-party-yum.html).
...
1. ### Selecting a Target Series
   ...
   [Selecting a Release Series](linux-installation-yum-repo.html#yum-repo-select-series "Selecting a Release Series"). For upgrading from
   MySQL 5.7 to 8.0, perform the
   *reverse* of the steps illustrated in
   [Selecting a Release Series](linux-installation-yum-repo.html#yum-repo-select-series "Selecting a Release Series"), disabling the
   ...
   5.7 to 8.0, see
   [Upgrading
   from MySQL 5.7 to 8.0](upgrading-from-previous-series.html "3.5 Changes in MySQL 8.0").
...
3. ### Restarting MySQL
   ...
   to MySQL 8.0.16, run [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables") after
   the server restarts to check and possibly resolve any
   incompatibilities between the old data and the upgraded
   software. [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables") also performs other
   functions; for details, see [Section 6.4.5, “mysql\_upgrade — Check and Upgrade MySQL Tables”](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables").

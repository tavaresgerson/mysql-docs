...
* [A replication topology
  upgrade](replication-upgrade.html "19.5.3 Upgrading a Replication Topology"): account for each server's topology role.
...
See: [Section 3.5, “Changes in MySQL 8.0”](upgrading-from-previous-series.html "3.5 Changes in MySQL 8.0").

### Run Upgrade Checker and Fix Incompatibilities

MySQL Shell's [Upgrade Checker Utility](/doc/mysql-shell/8.0/en/mysql-shell-utilities-upgrade.html)

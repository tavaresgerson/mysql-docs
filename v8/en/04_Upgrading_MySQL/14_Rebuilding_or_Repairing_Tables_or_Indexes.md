...
* Required table repairs or upgrades reported by
  ...
  [**mysqlcheck**](mysqlcheck.html "6.5.3 mysqlcheck — A Table Maintenance Program"), or
...
to fail, refer to [Section 17.21.3, “Forcing InnoDB Recovery”](forcing-innodb-recovery.html "17.21.3 Forcing InnoDB Recovery") for
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), use a “null” alteration; that is,
an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement that
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement, use
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to display the
table definition.

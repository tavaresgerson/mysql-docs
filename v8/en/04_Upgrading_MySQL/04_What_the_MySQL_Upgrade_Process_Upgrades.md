...
* Perform only step 1 as necessary:
  ...
  + As of MySQL 8.0.16: [**mysqld --upgrade=MINIMAL**](mysqld.html "6.3.1 mysqld — The MySQL Server")

* Perform step 1 as necessary, and force step 2:

  + Prior to MySQL 8.0.16: **mysqld** followed by **mysql_upgrade --force**

  + As of MySQL 8.0.16: [**mysqld --upgrade=FORCE**](mysqld.html "6.3.1 mysqld — The MySQL Server")

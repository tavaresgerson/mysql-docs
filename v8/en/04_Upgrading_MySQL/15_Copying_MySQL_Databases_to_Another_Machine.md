...
architectures, you can use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to create
...
Use [**mysqldump --help**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") to see what options are
available.

Note

If GTIDs are in use on the server where you create the dump
([`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode)), by default,
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") includes the contents of the
[`gtid_executed`](replication-options-gtids.html#sysvar_gtid_executed) set in the dump
...
You can also use [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and
[**mysqlimport**](mysqlimport.html "6.5.5 mysqlimport — A Data Import Program") to transfer the database. For large
tables, this is much faster than simply using
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program"). In the following commands,
...
machine, execute [**mysqladmin flush-privileges**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") so

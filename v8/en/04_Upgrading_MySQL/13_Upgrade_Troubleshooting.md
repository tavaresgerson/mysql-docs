...
* If you have created a loadable function with a given name and
  ...
  FUNCTION`](drop-function.html "15.1.26 DROP FUNCTION Statement") to drop the loadable function, and then use
  [`CREATE FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") to re-create

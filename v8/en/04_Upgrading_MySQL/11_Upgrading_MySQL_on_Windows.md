...
* [Using MySQL Installer](windows-upgrading.html#windows-upgrading-installer "Upgrading MySQL with MySQL Installer")
* [Using the
  Windows ZIP archive distribution](windows-upgrading.html#windows-upgrading-zip-distribution "Upgrading MySQL Using the Windows ZIP Distribution")

The approach you select depends on how the existing installation
was performed. Before proceeding, review
[Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL") for additional information on
...
[ZIP
archive](windows-upgrading.html#windows-upgrading-zip-distribution "Upgrading MySQL Using the Windows ZIP Distribution") approach.
...
[Upgrading MySQL Using the Windows ZIP Distribution](windows-upgrading.html#windows-upgrading-zip-distribution "Upgrading MySQL Using the Windows ZIP Distribution").
...
2. If the server is running, stop it. If the server is
   ...
   *`mysqld_service_name`*** .
   ...
   [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") to stop it. For example,
   before upgrading from MySQL 5.7 to
   8.0, use [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") from
   ...
   password, invoke [**mysqladmin**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") with the
...
4. Restart the server. For example, use the **SC START
   ...
   *`mysqld_service_name`***
   ...
   [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") directly otherwise.

5. Prior to MySQL 8.0.16, run [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables")
   ...
   capabilities. See [Section 6.4.5, “mysql\_upgrade — Check and Upgrade MySQL Tables”](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables"). As of

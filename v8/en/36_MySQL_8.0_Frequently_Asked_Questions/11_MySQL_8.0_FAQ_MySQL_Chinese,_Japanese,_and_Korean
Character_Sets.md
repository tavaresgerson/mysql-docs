...
A.11.10. [I've upgraded to MySQL 8.0. How can I revert to behavior like that in MySQL 4.0 with regard to character sets?](faqs-cjk.html#faq-cjk-how-use-4-0-charset)
...
<table border="0" style="width: 100%;"><colgroup><col align="left" width="1%"/><col/></colgroup><tbody><tr class="question"><td align="left" valign="top"><a name="faq-cjk-what-cjk-avail"></a><a name="id482223"></a><p><b>A.11.1.</b></p></td><td align="left" valign="top"><p>
...
<p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-cjk-question-marks"></a><a name="id482304"></a><p><b>A.11.2.</b></p></td><td align="left" valign="top"><p>
...
<span class="emphasis"><em>Make sure that the problem is not with the browser
            ...
            <a class="link" href="show-variables.html" title="15.7.7.41 SHOW VARIABLES Statement"><code class="literal">SHOW VARIABLES</code></a> statement,
...
default-character-set=big5</code></pre><p>
...
</td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-what-problems-big5"></a><a name="id482394"></a><p><b>A.11.3.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-what-japanese-chars-fail"></a><a name="id482403"></a><p><b>A.11.4.</b></p></td><td align="left" valign="top"><p>
...
<p>
        ...
        performed.)
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-convert-81ca-cp932"></a><a name="id482630"></a><p><b>A.11.5.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-represent-yen"></a><a name="id482643"></a><p><b>A.11.6.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-what-problems-korean"></a><a name="id482659"></a><p><b>A.11.7.</b></p></td><td align="left" valign="top"><p>
...
+-------+----------+
| ?     | 3F       |
+-------+----------+</code></pre></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-incorrect-string-value"></a><a name="id482679"></a><p><b>A.11.8.</b></p></td><td align="left" valign="top"><p>
...
</td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-gui-not-display-cjk"></a><a name="id482717"></a><p><b>A.11.9.</b></p></td><td align="left" valign="top"><p>
...
?&gt;</code></pre><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-use-4-0-charset"></a><a name="id482761"></a><p><b>A.11.10.</b></p></td><td align="left" valign="top"><p>
...
<p>
        ...
        <a class="link" href="show-variables.html" title="15.7.7.41 SHOW VARIABLES Statement"><code class="literal">SHOW VARIABLES</code></a>:
      </p><pre class="programlisting copytoclipboard language-sql"><code class="language-sql">mysql&gt; SHOW VARIABLES LIKE 'char%';
+--------------------------+----------------------------------------+
| Variable_name            | Value                                  |
+--------------------------+----------------------------------------+
...
+--------------------------+----------------------------------------+</code></pre><p>
        ...
        <a class="link" href="show-variables.html" title="15.7.7.41 SHOW VARIABLES Statement"><code class="literal">SHOW VARIABLES</code></a>, the server
        ignores the client's initial settings if the
        <a class="link" href="server-options.html#option_mysqld_character-set-client-handshake"><code class="option">--skip-character-set-client-handshake</code></a>
        option is used.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-cjk-fail-searches"></a><a name="id482821"></a><p><b>A.11.11.</b></p></td><td align="left" valign="top"><p>
...
+-------------------------+---------------------------+</code></pre><p>
        ...
        feasible.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-know-avail-characters"></a><a name="id482846"></a><p><b>A.11.12.</b></p></td><td align="left" valign="top"><p>
...
+------+--------+------+-------+---------+-------+--------+------+------+------+</code></pre><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-cjk-sort-unicode-1"></a><a name="id482866"></a><p><b>A.11.13.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-cjk-sort-unicode-2"></a><a name="id482873"></a><p><b>A.11.14.</b></p></td><td align="left" valign="top"><p>
        ...
        <code class="literal">utf8mb4</code> character set and the
        <code class="literal">utf8mb4_ja_0900_as_cs</code> collation.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-supplement-char-rejected"></a><a name="id482880"></a><p><b>A.11.15.</b></p></td><td align="left" valign="top"><p>
...
<ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem"><p>
...
</td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-why-cjk-not-cjkv"></a><a name="id482915"></a><p><b>A.11.16.</b></p></td><td align="left" valign="top"><p>
        ...
        <a class="xref" href="charset-unicode-sets.html" title="12.10.1 Unicode Character Sets">Section 12.10.1, “Unicode Character Sets”</a>.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-how-cjk-db-table-names"></a><a name="id482926"></a><p><b>A.11.17.</b></p></td><td align="left" valign="top"><p>
        Does MySQL permit CJK characters to be used in database and
        table names?
      </p></td></tr><tr class="answer"><td align="left" valign="top"></td><td align="left" valign="top"><p>
        Yes.
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-where-doc-translations"></a><a name="id482931"></a><p><b>A.11.18.</b></p></td><td align="left" valign="top"><p>
      ...
      </p></td></tr><tr class="question"><td align="left" valign="top"><a name="faq-cjk-help-with-cjk"></a><a name="id482937"></a><p><b>A.11.19.</b></p></td><td align="left" valign="top"><p>

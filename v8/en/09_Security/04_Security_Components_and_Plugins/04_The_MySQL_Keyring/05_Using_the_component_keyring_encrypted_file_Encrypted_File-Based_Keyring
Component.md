...
added to the same directory where [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is
...
After adding the two files, restart [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
Verify component installation by examining the Performance
Schema [`keyring_component_status`](performance-schema-keyring-component-status-table.html "29.12.18.1 The keyring_component_status Table")
table:
...
[Configuration Notes](keyring-encrypted-file-component.html#keyring-encrypted-file-component-configuration-notes "Configuration Notes").

* [Configuration Notes](keyring-encrypted-file-component.html#keyring-encrypted-file-component-configuration-notes "Configuration Notes")
* [Encrypted Keyring Component Usage](keyring-encrypted-file-component.html#keyring-encrypted-file-component-usage "Encrypted Keyring Component Usage")

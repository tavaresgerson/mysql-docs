...
functions, see [Section 7.6.9.2, “The Keyring Service”](keyring-service.html "7.6.9.2 The Keyring Service"). For general
keyring information, see [Section 8.4.4, “The MySQL Keyring”](keyring.html "8.4.4 The MySQL Keyring").
...
and loadable functions, see [Section 7.6.1, “Installing and Uninstalling Plugins”](plugin-loading.html "7.6.1 Installing and Uninstalling Plugins"),
and [Section 7.7.1, “Installing and Uninstalling Loadable Functions”](function-loading.html "7.7.1 Installing and Uninstalling Loadable Functions").
...
FUNCTION`](create-function.html "15.1.14 CREATE FUNCTION Statement") statements, adjusting the
...
[`UNINSTALL PLUGIN`](uninstall-plugin.html "15.7.4.6 UNINSTALL PLUGIN Statement") and
[`DROP FUNCTION`](drop-function.html "15.1.26 DROP FUNCTION Statement") statements:
...
* The keyring functions invoke keyring service functions
  (see [Section 7.6.9.2, “The Keyring Service”](keyring-service.html "7.6.9.2 The Keyring Service")). The service
...
* A user must possess the global
  [`EXECUTE`](privileges-provided.html#priv_execute) privilege to use
  ...
  To grant the global [`EXECUTE`](privileges-provided.html#priv_execute)
  ...
  global [`EXECUTE`](privileges-provided.html#priv_execute) privilege
...
* A key stored in the keyring by a given user can be
  ...
  value of the [`CURRENT_USER()`](information-functions.html#function_current-user)
...
* Keyring functions support the key types and lengths
  ...
  plugin, see [Section 8.4.4.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.4.13 Supported Keyring Key Types and Lengths").

To create a new random key and store it in the keyring, call
[`keyring_key_generate()`](keyring-functions-general-purpose.html#function_keyring-key-generate), passing
...
[Section 8.4.4.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.4.13 Supported Keyring Key Types and Lengths").
...
The ID passed to
[`keyring_key_generate()`](keyring-functions-general-purpose.html#function_keyring-key-generate) provides
...
[`keyring_key_fetch()`](keyring-functions-general-purpose.html#function_keyring-key-fetch). The
following example uses [`HEX()`](string-functions.html#function_hex) to
...
[`keyring_key_remove()`](keyring-functions-general-purpose.html#function_keyring-key-remove):
...
[`keyring_key_store()`](keyring-functions-general-purpose.html#function_keyring-key-store):
...
[`EXECUTE`](privileges-provided.html#priv_execute) privilege to call
...
[`CURRENT_USER()`](information-functions.html#function_current-user) value in effect
for each function call. To permit key operations to users who
do not have the global [`EXECUTE`](privileges-provided.html#priv_execute)
...
2. Grant the [`EXECUTE`](privileges-provided.html#priv_execute) privilege
...
[`EXECUTE`](privileges-provided.html#priv_execute) privilege for that
...
without the proper [`EXECUTE`](privileges-provided.html#priv_execute)
...
[`EXECUTE`](privileges-provided.html#priv_execute) to
...
can be invoked, see [Using General-Purpose Keyring Functions](keyring-functions-general-purpose.html#keyring-function-usage "Using General-Purpose Keyring Functions").
...
* [`keyring_key_fetch(key_id)`](keyring-functions-general-purpose.html#function_keyring-key-fetch)
  ...
  [`keyring_key_fetch()`](keyring-functions-general-purpose.html#function_keyring-key-fetch) are
  subject to the general keyring function limits described
  in [Section 8.4.4.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.4.13 Supported Keyring Key Types and Lengths"). A key value
  longer than that length can be stored using a keyring
  service function (see
  [Section 7.6.9.2, “The Keyring Service”](keyring-service.html "7.6.9.2 The Keyring Service")), but if retrieved
  using [`keyring_key_fetch()`](keyring-functions-general-purpose.html#function_keyring-key-fetch)
  ...
  The example uses [`HEX()`](string-functions.html#function_hex) to
  display the key value because it may contain nonprintable
...
* [`keyring_key_generate(key_id,
  key_type,
  key_length)`](keyring-functions-general-purpose.html#function_keyring-key-generate)
...
* [`keyring_key_length_fetch(key_id)`](keyring-functions-general-purpose.html#function_keyring-key-length-fetch)
  ...
  [`keyring_key_fetch()`](keyring-functions-general-purpose.html#function_keyring-key-fetch).
...
* [`keyring_key_store(key_id,
  key_type,
  key)`](keyring-functions-general-purpose.html#function_keyring-key-store)

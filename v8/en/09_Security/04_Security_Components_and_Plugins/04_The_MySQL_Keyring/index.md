...
[8.4.4.1 Keyring Components Versus Keyring Plugins](keyring-component-plugin-comparison.html)

[8.4.4.2 Keyring Component Installation](keyring-component-installation.html)

[8.4.4.3 Keyring Plugin Installation](keyring-plugin-installation.html)

[8.4.4.4 Using the component\_keyring\_file File-Based Keyring Component](keyring-file-component.html)

[8.4.4.5 Using the component\_keyring\_encrypted\_file Encrypted File-Based Keyring Component](keyring-encrypted-file-component.html)

[8.4.4.6 Using the keyring\_file File-Based Keyring Plugin](keyring-file-plugin.html)

[8.4.4.7 Using the keyring\_encrypted\_file Encrypted File-Based Keyring Plugin](keyring-encrypted-file-plugin.html)

[8.4.4.8 Using the keyring\_okv KMIP Plugin](keyring-okv-plugin.html)

[8.4.4.9 Using the keyring\_aws Amazon Web Services Keyring Plugin](keyring-aws-plugin.html)

[8.4.4.10 Using the HashiCorp Vault Keyring Plugin](keyring-hashicorp-plugin.html)

[8.4.4.11 Using the Oracle Cloud Infrastructure Vault Keyring Component](keyring-oci-component.html)

[8.4.4.12 Using the Oracle Cloud Infrastructure Vault Keyring Plugin](keyring-oci-plugin.html)

[8.4.4.13 Supported Keyring Key Types and Lengths](keyring-key-types.html)

[8.4.4.14 Migrating Keys Between Keyring Keystores](keyring-key-migration.html)

[8.4.4.15 General-Purpose Keyring Key-Management Functions](keyring-functions-general-purpose.html)

[8.4.4.16 Plugin-Specific Keyring Key-Management Functions](keyring-functions-plugin-specific.html)

[8.4.4.17 Keyring Metadata](keyring-metadata.html)

[8.4.4.18 Keyring Command Options](keyring-options.html)

[8.4.4.19 Keyring System Variables](keyring-system-variables.html)
...
* Keyring components and plugins that manage a backing store or
  ...
  + `component_keyring_encrypted_file`:
    ...
    Component”](keyring-encrypted-file-component.html "8.4.4.5 Using the component_keyring_encrypted_file Encrypted File-Based Keyring Component").
...
* A keyring service interface for keyring key management. This
  ...
  + C interface: In C-language code, call the keyring service
    functions described in [Section 7.6.9.2, “The Keyring Service”](keyring-service.html "7.6.9.2 The Keyring Service").

* Key metadata access:

  + The Performance Schema
    [`keyring_keys`](performance-schema-keyring-keys-table.html "29.12.18.2 The keyring_keys table") table exposes
    metadata for keys in the keyring. Key metadata includes
    key IDs, key owners, and backend key IDs. The
    [`keyring_keys`](performance-schema-keyring-keys-table.html "29.12.18.2 The keyring_keys table") table does not
...
* The implementation of keyring plugins is revised as of MySQL
  ...
  [Section 7.6.8, “The Keyring Proxy Bridge Plugin”](daemon-keyring-proxy-plugin.html "7.6.8 The Keyring Proxy Bridge Plugin").
...
[Section 8.4.4.2, “Keyring Component Installation”](keyring-component-installation.html "8.4.4.2 Keyring Component Installation"), and
[Section 8.4.4.3, “Keyring Plugin Installation”](keyring-plugin-installation.html "8.4.4.3 Keyring Plugin Installation"). For installation
...
plugins, see [Section 7.6.9.2, “The Keyring Service”](keyring-service.html "7.6.9.2 The Keyring Service"), and
[Writing Keyring Plugins](/doc/extending-mysql/8.0/en/writing-keyring-plugins.html).
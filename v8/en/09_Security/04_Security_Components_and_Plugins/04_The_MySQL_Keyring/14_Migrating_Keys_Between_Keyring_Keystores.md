...
* Migration from one keyring component to another: The
  ...
  this capability. [**mysql\_migrate\_keyring**](mysql-migrate-keyring.html "6.6.8 mysql_migrate_keyring — Keyring Key Migration Utility") is
...
* Other server options might be required, such as
  ...
  using [`--defaults-file`](option-file-options.html#option_general_defaults-file) to

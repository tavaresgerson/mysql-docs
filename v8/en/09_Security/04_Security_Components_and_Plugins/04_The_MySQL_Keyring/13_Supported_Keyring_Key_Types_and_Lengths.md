...
* The permitted key lengths are subject to multiple factors:
  ...
  + General keyring loadable-function interface limits (for
    ...
    described in
    [Section 8.4.4.15, “General-Purpose Keyring Key-Management Functions”](keyring-functions-general-purpose.html "8.4.4.15 General-Purpose Keyring Key-Management Functions")), or

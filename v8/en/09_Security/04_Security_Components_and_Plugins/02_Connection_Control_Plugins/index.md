...
[8.4.2.1 Connection Control Plugin Installation](connection-control-plugin-installation.html)

[8.4.2.2 Connection Control Plugin System and Status Variables](connection-control-plugin-variables.html)
...
* `CONNECTION_CONTROL` checks incoming
  ...
  [Writing Audit Plugins](/doc/extending-mysql/8.0/en/writing-audit-plugins.html)). To collect

...
[`SHOW VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") displays
`NULL` as an empty string. To display
`NULL` as `NULL`, use
[`SELECT`](select.html "15.2.13 SELECT Statement") instead:
...
The [`audit_log_policy`](audit-log-reference.html#sysvar_audit_log_policy)

...
* [Adding Query Statistics for Outlier Detection](audit-log-logging-configuration.html#audit-log-query-statistics "Adding Query Statistics for Outlier Detection")
...
* [Audit Log File Encryption Prior to MySQL 8.0.17](audit-log-logging-configuration.html#audit-log-file-encryption-old "Audit Log File Encryption Prior to MySQL 8.0.17")
...
[Audit Log Functions](audit-log-reference.html#audit-log-routines "Audit Log Functions"), and
...
[`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) system
...
* If encryption is enabled, the plugin adds a suffix of
  ...
  keyring; see [Encrypting Audit Log Files](audit-log-logging-configuration.html#audit-log-file-encryption "Encrypting Audit Log Files").
...
[`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) value is
`audit.log`, the effective file name is one
of the values shown in the following table.

<table summary="audit_log effective file names for various combinations of the compression and encryption features."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
...
[scheduler](scheduler-component.html "7.5.5 Scheduler Component") component
...
[`audit_log_filter_set_filter()`](audit-log-reference.html#function_audit-log-filter-set-filter)
...
system variable
[`log_slow_extra`](server-system-variables.html#sysvar_log_slow_extra) must be set to
...
[`audit_log_compression`](audit-log-reference.html#sysvar_audit_log_compression) system
...
[`audit_log_encryption`](audit-log-reference.html#sysvar_audit_log_encryption) system
variable at server startup. Permitted values are
...
functions, see [Audit Log Functions](audit-log-reference.html#audit-log-routines "Audit Log Functions").
...
[`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file) is set to
`audit.log`. In that case, an archived
audit log file has one of the names shown in the following
table.

<table summary="audit_log archived file names for various combinations of the compression and encryption features."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>
<th>Enabled Features</th>
...
As discussed in [Naming Conventions for Audit Log Files](audit-log-logging-configuration.html#audit-log-file-name "Naming Conventions for Audit Log Files"),
*`pwd_id`* format is
...
<table summary="Comparison of audit log encryption prior to and as of MySQL 8.0.17."><col style="width: 30%"/><col style="width: 35%"/><col style="width: 35%"/><thead><tr>
...
* During plugin initialization, the plugin checks for an
  ...
  syntax, see [Naming Conventions for Audit Log Files](audit-log-logging-configuration.html#audit-log-file-name "Naming Conventions for Audit Log Files").)
...
* If
  ...
  + To rotate the current file, use one of the following
    ...
    See [Manual Audit Log File Rotation (Before MySQL 8.0.31)](audit-log-logging-configuration.html#audit-log-manual-rotation "Manual Audit Log File Rotation (Before MySQL 8.0.31)").
...
* If
  ...
  + Automatic rotation occurs when a write to the current
    ...
    [Automatic Audit Log File Rotation](audit-log-logging-configuration.html#audit-log-automatic-rotation "Automatic Audit Log File Rotation"). When
  ...
  + Pruning of rotated JSON-format log files occurs if
    [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) or
    [`audit_log_prune_seconds`](audit-log-reference.html#sysvar_audit_log_prune_seconds)
    has a value greater than 0.

  + [`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) has
    no effect.
...
* As of MySQL 8.0.24 (for JSON-format log files): Enable
  ...
  [Audit Log File Pruning](audit-log-logging-configuration.html#audit-log-pruning "Audit Log File Pruning").
...
* [Manual Audit Log File Rotation (Before MySQL 8.0.31)](audit-log-logging-configuration.html#audit-log-manual-rotation "Manual Audit Log File Rotation (Before MySQL 8.0.31)")
* [Manual Audit Log File Rotation (From MySQL 8.0.31)](audit-log-logging-configuration.html#audit-log-manual-rotation-31 "Manual Audit Log File Rotation (From MySQL 8.0.31)")
...
[`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) variable
...
[`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) value changes
...
2. At this point, the plugin is still writing to the current
   ...
   [`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) is
...
[Section 8.4.5.6, “Reading Audit Log Files”](audit-log-file-reading.html "8.4.5.6 Reading Audit Log Files")). Consider setting
[`audit_log_rotate_on_size`](audit-log-reference.html#sysvar_audit_log_rotate_on_size)
...
required to use the
[`audit_log_rotate()`](audit-log-reference.html#function_audit-log-rotate) function.
...
[`audit_log_read()`](audit-log-reference.html#function_audit-log-read) function.

###### Automatic Audit Log File Rotation

If [`audit_log_rotate_on_size`](audit-log-reference.html#sysvar_audit_log_rotate_on_size)
is greater than 0, setting
[`audit_log_flush`](audit-log-reference.html#sysvar_audit_log_flush) has no
...
creation time (see [Naming Conventions for Audit Log Files](audit-log-logging-configuration.html#audit-log-file-name "Naming Conventions for Audit Log Files")). In
...
* Set `audit_log_format` to
  ...
  changing [`audit_log_file`](audit-log-reference.html#sysvar_audit_log_file);
  see [Selecting Audit Log File Format](audit-log-logging-configuration.html#audit-log-file-format "Selecting Audit Log File Format").)
...
* By default, no pruning of automatically rotated
  ...
  + Set
    ...
    [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) is
  ...
  Nonzero values of
  [`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size) take
...
[`audit_log_max_size`](audit-log-reference.html#sysvar_audit_log_max_size), the audit
...
[`audit_log_prune_seconds`](audit-log-reference.html#sysvar_audit_log_prune_seconds). In
...
[`audit_log_strategy`](audit-log-reference.html#sysvar_audit_log_strategy) system
...
[`audit_log_buffer_size`](audit-log-reference.html#sysvar_audit_log_buffer_size) system
...
this risk, set
[`audit_log_strategy`](audit-log-reference.html#sysvar_audit_log_strategy) to use
synchronous logging.

...
elements described in [Section 8.4.5.1, “Elements of MySQL Enterprise Audit”](audit-log-elements.html "8.4.5.1 Elements of MySQL Enterprise Audit"). For
...
[Chapter 3, *Upgrading MySQL*](upgrading.html "Chapter 3 Upgrading MySQL")). If you prefer to run the update
...
[Section 8.4.5.10, “Legacy Mode Audit Log Filtering”](audit-log-legacy-filtering.html "8.4.5.10 Legacy Mode Audit Log Filtering")). Should you wish

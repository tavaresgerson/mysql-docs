...
* `<COMMAND_CLASS>`
  ...
  *`xxx`* is
  `drop_table` and
  `select` for [`DROP
  TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") and [`SELECT`](select.html "15.2.13 SELECT Statement")
...
* `<STATUS>`
  ...
  the value of the
  [`mysql_errno()`](/doc/c-api/8.0/en/mysql-errno.html) C API
...
* `<STATUS_CODE>`
  ...
  the [`mysql_errno()`](/doc/c-api/8.0/en/mysql-errno.html) C API

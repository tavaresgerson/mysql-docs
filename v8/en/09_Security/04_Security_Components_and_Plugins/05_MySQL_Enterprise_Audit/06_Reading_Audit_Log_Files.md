...
contains [`JSON`](json.html "13.5 The JSON Data Type") audit events, and
...
optional [`JSON`](json.html "13.5 The JSON Data Type") string argument,
and the result returned from a successful call to either
function is a [`JSON`](json.html "13.5 The JSON Data Type") string.
...
* A successful call to
  ...
  events returns a [`JSON`](json.html "13.5 The JSON Data Type") string
  ...
  represented as a [`JSON`](json.html "13.5 The JSON Data Type") hash.
  For example:
...
* An [`audit_log_read()`](audit-log-reference.html#function_audit-log-read) call to
  ...
  + The most recent read sequence has been closed by passing
    a [`JSON`](json.html "13.5 The JSON Data Type")
    `null` value to
    [`audit_log_read()`](audit-log-reference.html#function_audit-log-read).
...
[`audit_log_read()`](audit-log-reference.html#function_audit-log-read), include an
argument that indicates where to begin reading. For example,
pass a bookmark, which is a [`JSON`](json.html "13.5 The JSON Data Type")
...
[`JSON`](json.html "13.5 The JSON Data Type") `null`
value to close the read sequence, or a
[`JSON`](json.html "13.5 The JSON Data Type") hash.
...
[`audit_log_read()`](audit-log-reference.html#function_audit-log-read), pass a hash
...
A [`JSON`](json.html "13.5 The JSON Data Type") string returned from
...
that manipulate [`JSON`](json.html "13.5 The JSON Data Type") values),
convert it to a nonbinary string. For example, before passing a
bookmark to [`JSON_SET()`](json-modification-functions.html#function_json-set), convert
...
Each call to [`audit_log_read()`](audit-log-reference.html#function_audit-log-read)
...
* There is a tradeoff between number of calls to
  [`audit_log_read()`](audit-log-reference.html#function_audit-log-read) and events
  returned per call:

...
[8.4.2 Connection Control Plugins](connection-control-plugin.html)

[8.4.3 The Password Validation Component](validate-password.html)

[8.4.4 The MySQL Keyring](keyring.html)

[8.4.5 MySQL Enterprise Audit](audit-log.html)

[8.4.6 The Audit Message Component](audit-api-message-emit.html)

[8.4.7 MySQL Enterprise Firewall](firewall.html)
...
* A password-validation component for implementing password
  ...
  passwords. See [Section 8.4.3, “The Password Validation Component”](validate-password.html "8.4.3 The Password Validation Component").
...
* (MySQL Enterprise Edition only) MySQL Enterprise Audit, implemented using a server plugin, uses
  ...
  See [Section 8.4.5, “MySQL Enterprise Audit”](audit-log.html "8.4.5 MySQL Enterprise Audit").

* A function enables applications to add their own message events
  to the audit log. See [Section 8.4.6, “The Audit Message Component”](audit-api-message-emit.html "8.4.6 The Audit Message Component").
...
* (MySQL Enterprise Edition only) MySQL Enterprise Data Masking and De-Identification, implemented as a plugin library
  ...
  replacement or substitution. See [Section 8.5, “MySQL Enterprise Data Masking and De-Identification”](data-masking.html "8.5 MySQL Enterprise Data Masking and De-Identification").
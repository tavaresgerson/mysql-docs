...
see [Section 8.2.17, “Pluggable Authentication”](pluggable-authentication.html "8.2.17 Pluggable Authentication"). For proxy user
...
[Section 8.2.19, “Proxy Users”](proxy-users.html "8.2.19 Proxy Users")). Suppose that you want Windows
...
2. For proxying to work, the proxied accounts must exist, so
   ...
   [`GRANT`](grant.html "15.7.1.6 GRANT Statement") statements (not
...
proxy accounts, see [Section 8.2.19, “Proxy Users”](proxy-users.html "8.2.19 Proxy Users").

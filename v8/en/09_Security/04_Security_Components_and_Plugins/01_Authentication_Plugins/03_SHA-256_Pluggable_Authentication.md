...
see [Section 8.4.1.2, “Caching SHA-2 Pluggable Authentication”](caching-sha2-pluggable-authentication.html "8.4.1.2 Caching SHA-2 Pluggable Authentication").
...
[`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") syntax can be used.

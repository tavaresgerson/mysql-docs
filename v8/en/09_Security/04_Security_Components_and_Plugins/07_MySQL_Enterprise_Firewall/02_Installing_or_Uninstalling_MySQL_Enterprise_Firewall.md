...
elements described in [Section 8.4.7.1, “Elements of MySQL Enterprise Firewall”](firewall-elements.html "8.4.7.1 Elements of MySQL Enterprise Firewall").
...
For usage instructions, see [Section 8.4.7.3, “Using MySQL Enterprise Firewall”](firewall-usage.html "8.4.7.3 Using MySQL Enterprise Firewall").
...
[Figure 8.2, “MySQL Enterprise Firewall Installation on Windows”](firewall-installation.html#firewall-installation-windows-installer "Figure 8.2 MySQL Enterprise Firewall Installation on Windows").
...
[`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") statements in

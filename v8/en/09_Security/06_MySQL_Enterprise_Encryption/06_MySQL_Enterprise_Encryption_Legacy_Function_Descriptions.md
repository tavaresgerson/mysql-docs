...
* [`asymmetric_derive(pub_key_str,
  priv_key_str)`](enterprise-encryption-functions-legacy.html#function_asymmetric-derive)
  ...
  *`priv_key_str`* are valid PEM encoded
  ...
  [`create_dh_parameters()`](enterprise-encryption-functions-legacy.html#function_create-dh-parameters), then
...
* `create_asymmetric_priv_key(algorithm,
  ...
  *`dh_secret`* is a shared DH secret,
  ...
  [`create_dh_parameters()`](enterprise-encryption-functions-legacy.html#function_create-dh-parameters).
...
* [`create_dh_parameters(key_len)`](enterprise-encryption-functions-legacy.html#function_create-dh-parameters)
  ...
  *`key_len`* is the key length. The
  ...
  [`asymmetric_derive()`](enterprise-encryption-functions-legacy.html#function_asymmetric-derive).

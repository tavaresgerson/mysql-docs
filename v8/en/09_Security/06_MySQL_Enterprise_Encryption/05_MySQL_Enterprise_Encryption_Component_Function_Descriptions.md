...
is [Section 8.6.6, “MySQL Enterprise Encryption Legacy Function Descriptions”](enterprise-encryption-functions-legacy.html "8.6.6 MySQL Enterprise Encryption Legacy Function Descriptions").
...
* [`asymmetric_decrypt(algorithm,
  data_str,
  priv_key_str)`](enterprise-encryption-functions.html#function_asymmetric-decrypt)
  ...
  *`priv_key_str`* is a valid PEM encoded
  ...
  [`asymmetric_encrypt()`](enterprise-encryption-functions.html#function_asymmetric-encrypt) component
...
* [`asymmetric_encrypt(algorithm,
  data_str,
  pub_key_str)`](enterprise-encryption-functions.html#function_asymmetric-encrypt)
...
* [`asymmetric_verify(algorithm,
  ...
  *`text`* is a data string or digest
  ...
  calling [`create_digest()`](enterprise-encryption-functions.html#function_create-digest).
...
* [`create_asymmetric_priv_key(algorithm,
  key_length)`](enterprise-encryption-functions.html#function_create-asymmetric-priv-key)
...
* [`create_digest(digest_type,
  ...
  [`asymmetric_verify()`](enterprise-encryption-functions.html#function_asymmetric-verify). The

...
[8.5 MySQL Enterprise Data Masking and De-Identification](data-masking.html)
:   [8.5.1 Data-Masking Components Versus the Data-Masking Plugin](data-masking-components-vs-plugin.html)

    [8.5.2 MySQL Enterprise Data Masking and De-Identification Components](data-masking-components.html)

    [8.5.3 MySQL Enterprise Data Masking and De-Identification Plugin](data-masking-plugin.html)
...
:   [8.6.1 MySQL Enterprise Encryption Installation and Upgrading](enterprise-encryption-installation.html)
    ...
    [8.6.6 MySQL Enterprise Encryption Legacy Function Descriptions](enterprise-encryption-functions-legacy.html)
...
[Secure
Deployment Guide](/doc/mysql-secure-deployment-guide/8.0/en/), which provides procedures for deploying

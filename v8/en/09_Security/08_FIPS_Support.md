...
* [FIPS Overview](fips-mode.html#fips-overview "FIPS Overview")
* [System Requirements for FIPS Mode in MySQL](fips-mode.html#fips-system-requirements "System Requirements for FIPS Mode in MySQL")
* [Enabling FIPS Mode in MySQL](fips-mode.html#fips-enabling "Enabling FIPS Mode in MySQL")
...
[`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) server system
variable using an SQL statement such as
[`SHOW VARIABLES
LIKE '%fips%'`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") or
[`SELECT
@@ssl_fips_mode`](select.html "15.2.13 SELECT Statement"). If the value of this variable is 1
(`ON`) or 2 (`STRICT`), FIPS
...
[`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement") for specific user
accounts, or set the
...
* Build the OpenSSL library and FIPS object module from
  ...
  (see [FIPS Overview](fips-mode.html#fips-overview "FIPS Overview")).
...
* The [`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) system
  variable controls whether the server operates in FIPS mode.

* The [`--ssl-fips-mode`](connection-options.html#option_general_ssl-fips-mode) client
...
permitted value for
[`ssl_fips_mode`](server-system-variables.html#sysvar_ssl_fips_mode) and

...
* To enable authentication to the MySQL server using accounts
  ...
  [`mysql_options4()`](/doc/c-api/8.0/en/mysql-options4.html) C API
...
described in [Section 8.4.1.7, “LDAP Pluggable Authentication”](ldap-pluggable-authentication.html "8.4.1.7 LDAP Pluggable Authentication"),
...
Use [`SHOW CREATE USER`](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement") to view the

...
* Setting the `DEFINER` attribute for stored
  ...
  ([`SET_USER_ID`](privileges-provided.html#priv_set-user-id) or the
  deprecated [`SUPER`](privileges-provided.html#priv_super) privilege).
...
* Overriding “abort” items in MySQL Enterprise
  ...
  audit misconfiguration. See [Section 8.4.5, “MySQL Enterprise Audit”](audit-log.html "8.4.5 MySQL Enterprise Audit").

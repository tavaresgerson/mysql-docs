...
[`SHOW CREATE USER`](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement") indicates whether
...
account, returns an
[`ER_ACCOUNT_HAS_BEEN_LOCKED`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_account_has_been_locked) error,

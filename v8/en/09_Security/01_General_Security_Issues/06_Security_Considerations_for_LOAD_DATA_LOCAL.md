...
[`mysql_options()`](/doc/c-api/8.0/en/mysql-options.html) C API function
(see [mysql\_options()](/doc/c-api/8.0/en/mysql-options.html)).
...
[`mysql_options()`](/doc/c-api/8.0/en/mysql-options.html) options as
follows:
...
[MySQL Shell Utilities](/doc/mysql-shell/8.0/en/mysql-shell-utilities.html).
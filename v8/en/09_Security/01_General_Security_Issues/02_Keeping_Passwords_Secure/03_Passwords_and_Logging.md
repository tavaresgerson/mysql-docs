...
[`SET PASSWORD`](set-password.html "15.7.1.10 SET PASSWORD Statement"). If such statements
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") statements for the
...
[`--log-raw`](server-options.html#option_mysqld_log-raw) option. For security
...
[Query Rewrite Plugins](/doc/extending-mysql/8.0/en/plugin-types.html#query-rewrite-plugin-type)). In this case, the
[`--log-raw`](server-options.html#option_mysqld_log-raw) option affects
statement logging as follows:

* Without [`--log-raw`](server-options.html#option_mysqld_log-raw), the server
...
[Section 19.2.4, “Relay Log and Replication Metadata Repositories”](replica-logs.html "19.2.4 Relay Log and Replication Metadata Repositories")). Ensure that the connection
...
[`START
SLAVE`](start-slave.html "15.4.2.7 START SLAVE Statement")) or [`START
GROUP_REPLICATION`](start-group-replication.html "15.4.3.1 START GROUP_REPLICATION Statement") statement to specify credentials for

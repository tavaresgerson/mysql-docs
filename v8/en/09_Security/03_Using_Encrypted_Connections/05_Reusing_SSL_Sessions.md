...
[SSL Session Reuse](/doc/c-api/8.0/en/c-api-ssl-session-reuse.html)).
...
Performance Schema
[`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.21.9 The tls_channel_status Table") table, along
...
3. From the prompt of your command interpreter, invoke any
   ...
   and then [**mysqlshow**](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information") client:
...
[**mysqlshow**](mysqlshow.html "6.5.7 mysqlshow — Display Database, Table, and Column Information"), SSL session reuse applies to
...
[**mysqlimport**](mysqlimport.html "6.5.5 mysqlimport — A Data Import Program"), [**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program"),
[**mysqlslap**](mysqlslap.html "6.5.8 mysqlslap — A Load Emulation Client"), **mysqltest**,

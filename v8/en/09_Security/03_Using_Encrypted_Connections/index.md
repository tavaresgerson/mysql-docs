...
with [`WITH_SSL`](source-configuration-options.html#option_cmake_with_ssl) on the path, it
...
API, see [Support for Encrypted Connections](/doc/c-api/8.0/en/c-api-encrypted-connections.html).

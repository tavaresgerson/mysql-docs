...
[`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") statement. For
...
[`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") statement must
have [`INSERT`](privileges-provided.html#priv_insert) privilege for the
`mysql.plugin` table.

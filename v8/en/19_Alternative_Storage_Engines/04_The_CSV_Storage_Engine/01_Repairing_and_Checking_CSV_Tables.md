...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") statements to verify
and, if possible, repair a damaged `CSV` table.

When running the [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement")
...
TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), which copies as many valid rows from the existing

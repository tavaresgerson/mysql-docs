...
(The [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement in MySQL
...
[`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement") statement. The value in
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine which are covered in
[Chapter 17, *The InnoDB Storage Engine*](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") and
[Chapter 25, *MySQL NDB Cluster 8.0*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"). For advanced users, it also
...
see [Section A.2, “MySQL 8.0 FAQ: Storage Engines”](faqs-storage-engines.html "A.2 MySQL 8.0 FAQ: Storage Engines").
...
* [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") (also known as
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")): This clustered

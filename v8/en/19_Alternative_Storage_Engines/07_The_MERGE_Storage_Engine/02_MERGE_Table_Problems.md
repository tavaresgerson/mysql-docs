...
* If you use [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to
...
* You should not use [`ANALYZE
  ...
  `WHERE` clause, or
  [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") on any of the
...
* [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") on a table that is
...
* The order of indexes in the `MERGE` table and
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to add a
  `UNIQUE` index to a table used in a
  `MERGE` table, and then use
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to add a nonunique
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") puts

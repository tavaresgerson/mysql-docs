...
[`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") in MySQL 8.0. You
...
with [`CREATE
TEMPORARY TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") can be set separately from the engine
...
See [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"), and
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") cannot use the default

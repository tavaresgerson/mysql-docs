...
is available with the [`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement")
statement.
...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements to specify
...
[`ER_DUP_KEY`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_dup_key) error.
...
[`SHOW TABLE STATUS`](show-table-status.html "15.7.7.38 SHOW TABLE STATUS Statement") is always accurate.

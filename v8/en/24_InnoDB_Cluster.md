...
[Chapter 25, *MySQL NDB Cluster 8.0*](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") and
...
* MySQL Server, and [Group
  Replication](group-replication.html "Chapter 20 Group Replication"), which enables a set of MySQL instances to
...
Replication](group-replication.html "Chapter 20 Group Replication"), provides features such as automatic membership
...
[multi-primary](group-replication-multi-primary-mode.html "20.1.3.2 Multi-Primary Mode")
...
[installed](installing.html "Chapter 2 Installing MySQL"), and you can also
[install](/doc/mysql-router/8.0/en/mysql-router-installation.html) MySQL Router.

InnoDB Cluster supports [MySQL
Clone](clone-plugin.html "7.6.7 The Clone Plugin"), which enables you to provision instances simply. In

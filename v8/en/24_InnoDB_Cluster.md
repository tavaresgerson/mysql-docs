...
InnoDB Cluster does not provide support for MySQL NDB Cluster. For more information about MySQL NDB Cluster, see Chapter 25, *MySQL NDB Cluster 8.0* and Section 25.2.6, “MySQL Server Using InnoDB Compared with NDB Cluster”.

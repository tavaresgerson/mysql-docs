...
using [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement"). It is
...
[`CREATE UNDO
TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") syntax can be dropped. An undo tablespace
...
[`default_storage_engine`](server-system-variables.html#sysvar_default_storage_engine) is used.
...
data files using
[`ALTER TABLESPACE
... DROP DATAFILE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement").
...
[`ALTER TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement"), as shown here,

...
[`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") drops all tables in
the database and deletes the database. Be
*very* careful with this statement! To use
[`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement"), you need the
[`DROP`](privileges-provided.html#priv_drop) privilege on the database.
[`DROP
SCHEMA`](drop-database.html "15.1.24 DROP DATABASE Statement") is a synonym for [`DROP
...
If you use [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") on a
symbolically linked database, both the link and the original
database are deleted.

[`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") returns the number of
tables that were removed.

The [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") statement removes
...
[`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") statement again.

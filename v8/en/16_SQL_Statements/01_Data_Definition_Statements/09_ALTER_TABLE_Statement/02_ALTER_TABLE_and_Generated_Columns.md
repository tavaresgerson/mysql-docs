...
* For non-partitioned tables, `ADD COLUMN`
  ...
  other [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations.
...
* When a `VIRTUAL` generated column is added
  ...
  [`ER_WRONG_USAGE`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_wrong_usage) error occurs.

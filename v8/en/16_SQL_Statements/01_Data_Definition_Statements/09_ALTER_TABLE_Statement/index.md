...
[15.1.9.1 ALTER TABLE Partition Operations](alter-table-partition-operations.html)

[15.1.9.2 ALTER TABLE and Generated Columns](alter-table-generated-columns.html)

[15.1.9.3 ALTER TABLE Examples](alter-table-examples.html)
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") changes the structure
...
* To use [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), you need
...
* Following the table name, specify the alterations to be made.
  If none are given, [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
  does nothing.

* The syntax for many of the permissible alterations is similar
  to clauses of the [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
  statement. *`column_definition`*
  clauses use the same syntax for `ADD` and
  `CHANGE` as for [`CREATE
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"). For more information, see
...
* Multiple `ADD`, `ALTER`,
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement, separated by commas. This is a
...
* If a storage engine does not support an attempted
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation, a
  warning may result. Such warnings can be displayed with
  [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement"). See
  [Section 15.7.7.42, “SHOW WARNINGS Statement”](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement"). For information on
  troubleshooting [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"),
...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement, such as `ENGINE`,
`AUTO_INCREMENT`,
`AVG_ROW_LENGTH`, `MAX_ROWS`,
`ROW_FORMAT`, or `TABLESPACE`.

For descriptions of all table options, see
[Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"). However,
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") ignores `DATA
DIRECTORY` and `INDEX DIRECTORY` when
given as table options. [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
permits them only as partitioning options, and requires that you
have the `FILE` privilege.

Use of table options with [`ALTER
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") provides a convenient way of altering single table
...
* If `t1` is currently not an
  ...
  + When you specify an `ENGINE` clause,
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") rebuilds the
    table. This is true even if the table already has the
    specified storage engine.

  + Running [`ALTER
    TABLE tbl_name
    ENGINE=INNODB`](alter-table.html "15.1.9 ALTER TABLE Statement") on an existing
    `InnoDB` table performs a
    “null” [`ALTER
    TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation, which can be used to defragment
    ...
    [`ALTER TABLE
    tbl_name FORCE`](alter-table.html "15.1.9 ALTER TABLE Statement") on an
    `InnoDB` table performs the same
    function.

  + [`ALTER TABLE
    tbl_name
    ENGINE=INNODB`](alter-table.html "15.1.9 ALTER TABLE Statement") and
    [`ALTER TABLE
    tbl_name FORCE`](alter-table.html "15.1.9 ALTER TABLE Statement") use
  ...
  + To prevent inadvertent loss of data,
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") cannot be used
...
* Use `ALTER TABLE` with the
  ...
  tablespaces, and the
  [system
  tablespace](glossary.html#glos_system_tablespace "system tablespace"). See
  ...
  + The `DATA DIRECTORY` clause, which is
    supported with
    [`CREATE TABLE
    ... TABLESPACE`](create-table.html "15.1.20 CREATE TABLE Statement"), is not supported with
    `ALTER TABLE ... TABLESPACE`, and is
    ignored if specified.

  + For more information about the capabilities and
    limitations of the `TABLESPACE` option,
    see [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement").
...
* MySQL NDB Cluster 8.0 supports setting
  ...
  for [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"), as shown in
  this example:
  ...
  options for columns of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables
...
* `ENGINE_ATTRIBUTE` and
  ...
  a single [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement.

To verify that the table options were changed as intended, use
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement"), or query the
Information Schema [`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table") table.

#### Performance and Space Requirements

[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations are
...
For tables using the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") clauses that support
...
to perform
[`ALTER
TABLE ... EXCHANGE PARTITION`](alter-table-partition-operations.html "15.1.9.1 ALTER TABLE Partition Operations") on the table.
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations that use the
...
table. While the [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation begins are stalled until the new table
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") blocks reads (not just
...
An [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation that uses
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation that would
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation that uses the
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations that support
...
* Renaming a table. MySQL renames files that correspond to the
  ...
  TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") statement to rename tables. See
  [Section 15.1.36, “RENAME TABLE Statement”](rename-table.html "15.1.36 RENAME TABLE Statement").) Privileges granted
...
* Operations that modify table metadata only. These operations
  ...
  + Modifying the definition of an
    ...
    [`SET`](set.html "13.3.6 The SET Type") column by adding new
    ...
    a member to a [`SET`](set.html "13.3.6 The SET Type") column
...
* Adding or dropping a secondary index, for
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. See
  [Section 17.12.1, “Online DDL Operations”](innodb-online-ddl-operations.html "17.12.1 Online DDL Operations").

* For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, operations that
...
* Modifying the definition of an
  [`ENUM`](enum.html "13.3.5 The ENUM Type") or
  [`SET`](set.html "13.3.6 The SET Type") column. The same
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") upgrades MySQL 5.5
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") performs an in-place
operation for
[virtual generated
column](glossary.html#glos_virtual_generated_column "virtual generated column") modifications. See
[Section 15.1.9.2, “ALTER TABLE and Generated Columns”](alter-table-generated-columns.html "15.1.9.2 ALTER TABLE and Generated Columns").
...
made, [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") rejects the `ALTER
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables); however, these
...
For [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operations that
...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement instead.
...
before using [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") (see
...
* Generated column and partition expressions that refer to the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement as the
...
visibility to be changed. See [Section 15.1.20.10, “Invisible Columns”](invisible-columns.html "15.1.20.10 Invisible Columns").
...
[`DROP INDEX`](drop-index.html "15.1.27 DROP INDEX Statement") removes an index. This
is a MySQL extension to standard SQL. See
[Section 15.1.27, “DROP INDEX Statement”](drop-index.html "15.1.27 DROP INDEX Statement"). To determine index names, use
`SHOW INDEX FROM
tbl_name`.
...
`USING`, see [Section 15.1.15, “CREATE INDEX Statement”](create-index.html "15.1.15 CREATE INDEX Statement"). The
...
If you use [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") on a
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") much faster when you have many indexes.
...
After an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement, it
...
(...)`. See [Section 15.1.20.5, “FOREIGN KEY Constraints”](create-table-foreign-keys.html "15.1.20.5 FOREIGN KEY Constraints").
For other storage engines, the clauses are parsed but ignored.

For [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), unlike
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to drop foreign keys:
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement is supported
for [`ALTER TABLE ...
ALGORITHM=INPLACE`](alter-table.html "15.1.9 ALTER TABLE Statement") but not for
[`ALTER TABLE ...
ALGORITHM=COPY`](alter-table.html "15.1.9 ALTER TABLE Statement").
...
to use [`ALTER TABLE
... DROP FOREIGN KEY`](alter-table.html "15.1.9 ALTER TABLE Statement") before changing the column
definition and [`ALTER
TABLE ... ADD FOREIGN KEY`](alter-table.html "15.1.9 ALTER TABLE Statement") afterward. Examples of
...
Prior to MySQL 8.0.16, [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
As of MySQL 8.0.16, [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
* Add a new `CHECK` constraint:
  ...
  [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"). See
...
As of MySQL 8.0.19, [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
It is possible for an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
[Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"), and
[Section 15.1.9.1, “ALTER TABLE Partition Operations”](alter-table-partition-operations.html "15.1.9.1 ALTER TABLE Partition Operations"). For

...
After an `ALTER TABLE` statement, it may be necessary to run `ANALYZE TABLE` to update index cardinality information. See Section 15.7.7.22, “SHOW INDEX Statement”.

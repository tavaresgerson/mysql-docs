...
For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, it is also possible
to change the storage type used for a table or column. For
example, consider an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table
...
following [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement:
...
referenced by the [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"):
...
columns, using this [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
statement:
...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement). However,
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") or by using the

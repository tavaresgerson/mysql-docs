...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") removes one or more
tables. You must have the [`DROP`](privileges-provided.html#priv_drop)
...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") causes an implicit
commit, except when used with the `TEMPORARY`
keyword. See [Section 15.3.3, “Statements That Cause an Implicit Commit”](implicit-commit.html "15.3.3 Statements That Cause an Implicit Commit").

Important

When a table is dropped, privileges granted specifically for the
table are *not* automatically dropped. They
must be dropped manually. See [Section 15.7.1.6, “GRANT Statement”](grant.html "15.7.1.6 GRANT Statement").

If any tables named in the argument list do not exist,
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") behavior depends on
...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") is not supported with
all [`innodb_force_recovery`](innodb-parameters.html#sysvar_innodb_force_recovery)
settings. See [Section 17.21.3, “Forcing InnoDB Recovery”](forcing-innodb-recovery.html "17.21.3 Forcing InnoDB Recovery").
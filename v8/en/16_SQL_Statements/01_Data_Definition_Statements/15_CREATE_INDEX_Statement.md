...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"). See [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement"). This
...
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") enables you to add
indexes to existing tables.

[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") is mapped to an
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement to create
indexes. See [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement").
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") cannot be used to
create a `PRIMARY KEY`; use
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") instead. For more
...
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") statement:
...
* Prefix *limits* are measured in bytes.
  ...
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"), [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"),
  and [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") statements
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine does not
...
size, [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") handles the
index as follows:
...
For [`CREATE
TABLE ... LIKE`](create-table-like.html "15.1.20.3 CREATE TABLE ... LIKE Statement"), the destination table preserves
...
* Functional key parts inherit all restrictions that apply to
  ...
  [Section 15.1.20.8, “CREATE TABLE and Generated Columns”](create-table-generated-columns.html "15.1.20.8 CREATE TABLE and Generated Columns"), and
...
[`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") statement. This
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0"), and
...
<td><code class="literal">HASH</code>, <code class="literal">BTREE</code> (see note in text)</td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine as T-tree
  indexes.

  Note

  For indexes on [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table
  ...
  primary key on an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table
  ...
  `NULL` columns of an
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table, the hash index can
...
* `WITH PARSER
  ...
  `ALTER TABLE`. See
  [Full-Text Parser Plugins](/doc/extending-mysql/8.0/en/plugin-types.html#full-text-plugin-type) and
...
* `COMMENT
  ...
  [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") statement. For
  example:
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement. For more
information, see [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement")

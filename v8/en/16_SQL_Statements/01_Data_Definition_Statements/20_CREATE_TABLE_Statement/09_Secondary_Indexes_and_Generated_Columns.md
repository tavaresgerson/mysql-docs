...
records during [`INSERT`](insert.html "15.2.7 INSERT Statement") and
[`UPDATE`](update.html "15.2.17 UPDATE Statement") operations. Even with
...
As noted elsewhere, [`JSON`](json.html "13.5 The JSON Data Type")
...
When you use [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") on a
[`SELECT`](select.html "15.2.13 SELECT Statement") or other SQL statement
...
WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") immediately following this
`EXPLAIN` statement:
...
index on a [`JSON`](json.html "13.5 The JSON Data Type") column using
the [`JSON_VALUE()`](json-search-functions.html#function_json-value) function with
...
1. [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") handles a
   [`JSON`](json.html "13.5 The JSON Data Type") column value
   internally as a [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types"). This
...
2. The [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine does

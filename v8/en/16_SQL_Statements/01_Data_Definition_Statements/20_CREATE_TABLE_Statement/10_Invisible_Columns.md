...
definition for [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or
...
[`CREATE
TABLE ... LIKE`](create-table-like.html "15.1.20.3 CREATE TABLE ... LIKE Statement") includes invisible columns, and they
are invisible in the new table.

[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") does not include invisible columns,
...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") part of the
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") statement:
...
or [`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement") output. For
example:
...
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and `mysqlpump`

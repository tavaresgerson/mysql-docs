...
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") permits only the following limited version of
...
As of MySQL 8.0.16, [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
permits the core features of table and column
`CHECK` constraints, for all storage engines.
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") permits the
...
[`LOAD XML`](load-xml.html "15.2.10 LOAD XML Statement") statements and an error
...
[`LOAD DATA ...
IGNORE`](load-data.html "15.2.9 LOAD DATA Statement"), and
[`LOAD XML ...
IGNORE`](load-xml.html "15.2.10 LOAD XML Statement") statements and a warning occurs if a constraint
...
type-conversion rules. See [Section 14.3, “Type Conversion in Expression Evaluation”](type-conversion.html "14.3 Type Conversion in Expression Evaluation"). If
...
[`CHECK_CONSTRAINTS`](information-schema-check-constraints-table.html "28.3.5 The INFORMATION_SCHEMA CHECK_CONSTRAINTS Table") table provides

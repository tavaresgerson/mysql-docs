...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement includes
the following:
...
* If the `CONSTRAINT`
  ...
  *`symbol`* clause was not defined,
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engines would use
  the `FOREIGN_KEY
  index_name` if
...
* NDB Cluster stores foreign names using the same lettercase
  ...
  processing [`SELECT`](select.html "15.2.13 SELECT Statement") and other
  SQL statements, [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") compared
...
* `InnoDB` permits a foreign key to
  ...
  considered (see [Section 17.6.2.1, “Clustered and Secondary Indexes”](innodb-index-types.html "17.6.2.1 Clustered and Secondary Indexes")).
...
* [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") does not currently
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables that are
...
* `NO ACTION`: A keyword from standard SQL.
  ...
  referenced table. [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
...
* `SET DEFAULT`: This action is recognized
  ...
  [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") and
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") reject table definitions
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") output or in
...
CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") output and in tables dumped with
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program").

For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, `ON
UPDATE CASCADE` is not supported where the reference
is to the parent table's primary key.

As of NDB 8.0.16: For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables,
...
using the following [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
syntax:
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), *remember
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") syntax:
...
supported for
[`ALTER TABLE ...
ALGORITHM=INPLACE`](alter-table.html "15.1.9 ALTER TABLE Statement"). It is not supported for
[`ALTER TABLE ...
...
[`foreign_key_checks`](server-system-variables.html#sysvar_foreign_key_checks) variable
has the same effect on [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables
...
* Performing an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
[`ER_NO_REFERENCED_ROW_2`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_no_referenced_row_2) and
[`ER_ROW_IS_REFERENCED_2`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_row_is_referenced_2) error
...
([`ER_NO_REFERENCED_ROW`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_no_referenced_row) and
[`ER_ROW_IS_REFERENCED`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_row_is_referenced)).

...
primary keys for any [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table
...
TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") statements to see the difference in how the
...
You can use an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
...
[`SHOW INDEX`](show-index.html "15.7.7.22 SHOW INDEX Statement"), and are visible in
the Information Schema [`COLUMNS`](information-schema-columns-table.html "28.3.8 The INFORMATION_SCHEMA COLUMNS Table") and
[`STATISTICS`](information-schema-statistics-table.html "28.3.34 The INFORMATION_SCHEMA STATISTICS Table") tables. You can cause
...
[`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"); the information written to the
...
with [**mysqlpump**](mysqlpump.html "6.5.6 mysqlpump — A Database Backup Program") to cause these to be

...
[`SELECT`](privileges-provided.html#priv_select) privilege is required on
the original table.
...
[`CREATE TABLE ...
LIKE`](create-table.html "15.1.20 CREATE TABLE Statement") makes the same checks as
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"). This means that
...
[`CREATE TABLE
... LIKE`](create-table-like.html "15.1.20.3 CREATE TABLE ... LIKE Statement") operations apply all

...
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") supports the
...
[`CURRENT_TIMESTAMP`](date-and-time-functions.html#function_current-timestamp). In MySQL
...
For [`CREATE
TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"), the destination table does not

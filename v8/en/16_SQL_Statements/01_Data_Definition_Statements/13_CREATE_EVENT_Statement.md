...
necessary, see [Section 27.4.2, “Event Scheduler Configuration”](events-configuration.html "27.4.2 Event Scheduler Configuration").

[`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") requires the
...
discussed in [Section 27.6, “Stored Object Access Control”](stored-objects-security.html "27.6 Stored Object Access Control").

The minimum requirements for a valid [`CREATE
EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement are as follows:

* The keywords [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") plus
...
EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement:
...
EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement. This is the same as specifying
...
[`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") as for
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"): If an event named
...
* `AT timestamp` is
  ...
  *************************** 1. row ***************************
  ...
  [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statements which
...
[Section 27.4.4, “Event Metadata”](events-metadata.html "27.4.4 Event Metadata"). See also
[Section 15.7.7.18, “SHOW EVENTS Statement”](show-events.html "15.7.7.18 SHOW EVENTS Statement"), and
...
[Section 27.8, “Restrictions on Stored Programs”](stored-program-restrictions.html "27.8 Restrictions on Stored Programs").) For example, the
...
A [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement that

...
[`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") renames one or more
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), can rename multiple tables within a single
statement:
...
[`LOCK TABLES`](lock-tables.html "15.3.6 LOCK TABLES and UNLOCK TABLES Statements") statement, provided
...
schema
([`ER_TRG_IN_WRONG_SCHEMA`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_trg_in_wrong_schema)) error.
...
TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") instead.

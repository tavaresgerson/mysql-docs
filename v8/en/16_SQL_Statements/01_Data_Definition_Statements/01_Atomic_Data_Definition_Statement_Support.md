...
you had done a [`COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements") before
...
[`START TRANSACTION ...
COMMIT`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements"), or combined with other statements within the
same transaction.
...
* [Supported DDL Statements](atomic-ddl.html#atomic-ddl-supported-statements "Supported DDL Statements")
* [Atomic DDL Characteristics](atomic-ddl.html#atomic-ddl-characteristics "Atomic DDL Characteristics")
* [Changes in DDL Statement Behavior](atomic-ddl.html#atomic-ddl-statement-behavior "Changes in DDL Statement Behavior")
* [Storage Engine Support](atomic-ddl.html#atomic-ddl-storage-engine-support "Storage Engine Support")
...
* Supported non-table DDL statements include:
  ...
  + Account management statements:
    ...
    roles, as well as [`GRANT`](grant.html "15.7.1.6 GRANT Statement")
    and [`REVOKE`](revoke.html "15.7.1.8 REVOKE Statement") statements.
...
* [`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") and
  [`UNINSTALL COMPONENT`](uninstall-component.html "15.7.4.5 UNINSTALL COMPONENT Statement")
  statements.

* [`CREATE SERVER`](create-server.html "15.1.18 CREATE SERVER Statement"),
  [`ALTER SERVER`](alter-server.html "15.1.8 ALTER SERVER Statement"), and
  [`DROP SERVER`](drop-server.html "15.1.30 DROP SERVER Statement") statements.
...
* [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") operations are
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") fails with an
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement fails
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") reports an error
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement on a
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statements to
  prevent errors from occurring for tables that do not
  exist.

* [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") is atomic if
  ...
  [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") transaction is
  not rolled back.
...
* For tables that do not use a storage engine which supports
  ...
  [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") transaction.
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") or
  [`DROP DATABASE`](drop-database.html "15.1.24 DROP DATABASE Statement") operation. For
...
* [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"),
  ...
  [`DROP TABLESPACE`](drop-tablespace.html "15.1.33 DROP TABLESPACE Statement") operations
  ...
  TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") operations are only atomic if all named
...
* As of MySQL 8.0.21, on storage engines that support atomic
  ...
  in
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") statements when row-based
  replication is in use. Foreign key constraints can be added
  later using [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement").

  When
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") is applied as an atomic
  operation, a metadata lock is held on the table while data
  is inserted, which prevents concurrent access to the table
  for the duration of the operation.

* [`DROP VIEW`](drop-view.html "15.1.35 DROP VIEW Statement") fails if a named
  view does not exist, and no changes are made. The change in
  behavior is demonstrated in this example, where the
  [`DROP VIEW`](drop-view.html "15.1.35 DROP VIEW Statement") statement fails
  ...
  Prior to the introduction of atomic DDL,
  [`DROP VIEW`](drop-view.html "15.1.35 DROP VIEW Statement") returns an error
  ...
  Due to this change in behavior, a partially completed
  [`DROP VIEW`](drop-view.html "15.1.35 DROP VIEW Statement") operation on a
  MySQL 5.7 replication source server fails when replicated
  on a MySQL 8.0 replica. To avoid this failure scenario,
  use `IF EXISTS` syntax in
  [`DROP VIEW`](drop-view.html "15.1.35 DROP VIEW Statement") statements to
...
* Partial execution of account management statements is no
  ...
  where the second [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement")
...
[`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") may perform the
*Prepare* and *Perform*
...
4. *Post-DDL*: Replay and remove DDL logs
   ...
   TABLE`](drop-table.html "15.1.32 DROP TABLE Statement"), [`TRUNCATE
   TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"), and other DDL operations that rebuild the
   table.
...
[`innodb_print_ddl_logs`](innodb-parameters.html#sysvar_innodb_print_ddl_logs) to have
...
[Section 16.1, “Data Dictionary Schema”](data-dictionary-schema.html "16.1 Data Dictionary Schema").) The structure of the
...
[`innodb_print_ddl_logs`](innodb-parameters.html#sysvar_innodb_print_ddl_logs) to view

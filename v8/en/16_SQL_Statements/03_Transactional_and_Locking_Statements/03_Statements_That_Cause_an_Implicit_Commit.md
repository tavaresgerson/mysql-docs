...
* **Data definition language (DDL)
  ...
  [`ALTER SERVER`](alter-server.html "15.1.8 ALTER SERVER Statement"),
  ...
  SYSTEM`](create-spatial-reference-system.html "15.1.19 CREATE SPATIAL REFERENCE SYSTEM Statement"), [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"),
  ...
  [`DROP SERVER`](drop-server.html "15.1.30 DROP SERVER Statement"),
  ...
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statements do not
  ...
  INDEX`](create-index.html "15.1.15 CREATE INDEX Statement"), which do cause a commit.) However, although
  ...
  use [`CREATE
  TEMPORARY TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") and then roll back the transaction,
  the table remains in existence.

  The [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement in
  ...
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements the user made during that
  transaction.

  [`CREATE TABLE ...
  SELECT`](create-table.html "15.1.20 CREATE TABLE Statement") causes an implicit commit before and after
...
* **Replication control
  ...
  [`STOP
  REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement"),
  [`RESET
  REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement"), [`CHANGE REPLICATION
  SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement"), [`CHANGE MASTER
  TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"). The SLAVE keyword was replaced with REPLICA in
  MySQL 8.0.22.
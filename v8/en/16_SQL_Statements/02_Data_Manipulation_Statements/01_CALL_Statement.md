...
call [`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html), either
...
[`mysql_query()`](/doc/c-api/8.0/en/mysql-query.html) or
[`mysql_real_query()`](/doc/c-api/8.0/en/mysql-real-query.html), use a loop
that calls [`mysql_next_result()`](/doc/c-api/8.0/en/mysql-next-result.html) to
...
calls [`mysql_stmt_next_result()`](/doc/c-api/8.0/en/mysql-stmt-next-result.html) to
determine whether there are more results. For an example, see
[Prepared CALL Statement Support](/doc/c-api/8.0/en/c-api-prepared-call-statements.html). Languages that

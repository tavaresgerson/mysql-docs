...
[`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") statement is a
...
[`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") cannot be used
within a transaction or if you have a lock on the table. See
[Section 15.1.37, “TRUNCATE TABLE Statement”](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") and
...
as executing [`ALTER
TABLE t TRUNCATE PARTITION (p0)`](alter-table.html "15.1.9 ALTER TABLE Statement"); in both cases, all rows
...
2. Use [`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") to atomically
...
[`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") executes, so the

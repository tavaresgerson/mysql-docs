...
* The recursive [`SELECT`](select.html "15.2.13 SELECT Statement") part
  ...
  only to [`UNION`](union.html "15.2.18 UNION Clause") members;
...
[`SELECT`](select.html "15.2.13 SELECT Statement"), for example:
...
[`CREATE [TEMPORARY]
TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") but need not be defined or dropped explicitly.

...
[`VALUES`](values.html "15.2.19 VALUES Statement") is a DML statement
...
* With [`UNION`](union.html "15.2.18 UNION Clause"), as shown here:
  ...
  [`EXCEPT`](except.html "15.2.4 EXCEPT Clause") and
...
* In place of the source table in
  [`CREATE
  TABLE ... SELECT`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement") and
  [`CREATE VIEW ...

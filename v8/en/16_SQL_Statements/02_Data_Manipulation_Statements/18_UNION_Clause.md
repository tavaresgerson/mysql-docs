...
[`UNION`](union.html "15.2.18 UNION Clause") combines the result from
...
[`UNION`](union.html "15.2.18 UNION Clause") were refactored to be more
consistent (the same [`SELECT`](select.html "15.2.13 SELECT Statement") syntax

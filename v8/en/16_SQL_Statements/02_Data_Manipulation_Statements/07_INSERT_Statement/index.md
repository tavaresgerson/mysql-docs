...
* If strict SQL mode is not enabled, any column not explicitly
  ...
  [Section 13.6, “Data Type Default Values”](data-type-defaults.html "13.6 Data Type Default Values"). See also
  [Section 1.6.3.3, “Enforced Constraints on Invalid Data”](constraint-invalid-data.html "1.6.3.3 Enforced Constraints on Invalid Data").
...
[mysql\_affected\_rows()](/doc/c-api/8.0/en/mysql-affected-rows.html).
...
by invoking the [`mysql_info()`](/doc/c-api/8.0/en/mysql-info.html)
function. See [mysql\_info()](/doc/c-api/8.0/en/mysql-info.html).
...
* If you use the `IGNORE` modifier, ignorable
  ...
  [`mysql_info()`](/doc/c-api/8.0/en/mysql-info.html) C API function
...
* If you specify `ON DUPLICATE KEY UPDATE`, and
  ...
  [`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html) C API

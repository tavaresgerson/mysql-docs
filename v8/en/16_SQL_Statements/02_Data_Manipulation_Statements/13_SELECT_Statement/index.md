...
[`SELECT`](select.html "15.2.13 SELECT Statement") is used to retrieve rows
selected from one or more tables, and can include
[`UNION`](union.html "15.2.18 UNION Clause") operations and subqueries.
Beginning with MySQL 8.0.31,
[`INTERSECT`](intersect.html "15.2.8 INTERSECT Clause") and
[`EXCEPT`](except.html "15.2.4 EXCEPT Clause") operations are also
supported. The `UNION`,
`INTERSECT`, and `EXCEPT`
operators are described in more detail later in this section. See
also [Section 15.2.15, “Subqueries”](subqueries.html "15.2.15 Subqueries").

A [`SELECT`](select.html "15.2.13 SELECT Statement") statement can start with a
[`WITH`](with.html "15.2.20 WITH (Common Table Expressions)") clause to define common table
expressions accessible within the
[`SELECT`](select.html "15.2.13 SELECT Statement"). See [Section 15.2.20, “WITH (Common Table Expressions)”](with.html "15.2.20 WITH (Common Table Expressions)").

The most commonly used clauses of
[`SELECT`](select.html "15.2.13 SELECT Statement") statements are these:
...
* *`table_references`* indicates the
  ...
  described in [Section 15.2.13.2, “JOIN Clause”](join.html "15.2.13.2 JOIN Clause").
...
* `SELECT` supports explicit partition
  ...
  *`table_reference`* (see
  [Section 15.2.13.2, “JOIN Clause”](join.html "15.2.13.2 JOIN Clause")). In this case, rows are selected only
...
* The `WHERE` clause, if given, indicates the
  ...
  *`where_condition`* is an expression
  ...
  [Section 11.5, “Expressions”](expressions.html "11.5 Expressions"), and
  [Chapter 14, *Functions and Operators*](functions.html "Chapter 14 Functions and Operators").

[`SELECT`](select.html "15.2.13 SELECT Statement") can also be used to retrieve
...
who require that all [`SELECT`](select.html "15.2.13 SELECT Statement")
...
`INTO`, see [Section 15.2.13.1, “SELECT ... INTO Statement”](select-into.html "15.2.13.1 SELECT ... INTO Statement").
...
* A *`select_expr`* can be given an alias
  ...
  *`select_expr`* expressions: MySQL
  ...
  clause is executed. See [Section B.3.4.4, “Problems with Column Aliases”](problems-with-alias.html "B.3.4.4 Problems with Column Aliases").
...
* The `FROM
  ...
  information on join syntax, see [Section 15.2.13.2, “JOIN Clause”](join.html "15.2.13.2 JOIN Clause"). For
...
* You can refer to a table within the default database as
  ...
  *`db_name`*.*`tbl_name`*
  ...
  ambiguous. See [Section 11.2.2, “Identifier Qualifiers”](identifier-qualifiers.html "11.2.2 Identifier Qualifiers"), for
...
* When you use `ORDER BY` or `GROUP
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement"), the server sorts values
...
* `GROUP BY` permits a `WITH
  ...
  MySQL 8.0.12. See [Section 14.19.2, “GROUP BY Modifiers”](group-by-modifiers.html "14.19.2 GROUP BY Modifiers").
...
* The `HAVING` clause, like the
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") list and columns in
...
* The `WINDOW` clause, if present, defines
  ...
  details, see [Section 14.20.4, “Named Windows”](window-functions-named-windows.html "14.20.4 Named Windows").
...
* The [`SELECT ...
  INTO`](select-into.html "15.2.13.1 SELECT ... INTO Statement") form of [`SELECT`](select.html "15.2.13 SELECT Statement")
...
* If you use `FOR UPDATE` with a storage engine
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") in a statement such as
  [`CREATE
  TABLE new_table SELECT ... FROM
  old_table ...`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"). (If you
  ...
  `FOR SHARE`, see
  [Section 17.7.2.4, “Locking Reads”](innodb-locking-reads.html "17.7.2.4 Locking Reads"). For additional
...
Following the [`SELECT`](select.html "15.2.13 SELECT Statement") keyword, you
...
* `HIGH_PRIORITY` gives the
  [`SELECT`](select.html "15.2.13 SELECT Statement") higher priority than a
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") statements that are part
  of a [`UNION`](union.html "15.2.18 UNION Clause").
...
* `STRAIGHT_JOIN` forces the optimizer to join
  ...
  *`table_references`* list. See
  ...
  [`const`](explain-output.html#jointype_const) or
  [`system`](explain-output.html#jointype_system) table. Such a table
  ...
  displayed by [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement"). See
  [Section 10.8.1, “Optimizing Queries with EXPLAIN”](using-explain.html "10.8.1 Optimizing Queries with EXPLAIN"). This exception may not apply
  to [`const`](explain-output.html#jointype_const) or
  [`system`](explain-output.html#jointype_system) tables that are used
...
* `SQL_BUFFER_RESULT` forces the result to be
  ...
  only for top-level [`SELECT`](select.html "15.2.13 SELECT Statement")

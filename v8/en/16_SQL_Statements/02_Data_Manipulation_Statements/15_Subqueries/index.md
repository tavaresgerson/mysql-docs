...
Beginning with MySQL 8.0.19, [`TABLE`](table.html "15.2.16 TABLE Statement")
and [`VALUES`](values.html "15.2.19 VALUES Statement") statements can be used
in subqueries. Subqueries using
[`VALUES`](values.html "15.2.19 VALUES Statement") are generally more verbose
versions of subqueries that can be rewritten more compactly using
set notation, or with [`SELECT`](select.html "15.2.13 SELECT Statement") or
[`TABLE`](table.html "15.2.16 TABLE Statement") syntax; assuming that table
`ts` is created using the statement
[`CREATE TABLE
ts VALUES ROW(2), ROW(4), ROW(6)`](create-table-select.html "15.1.20.4 CREATE TABLE ... SELECT Statement"), the statements shown

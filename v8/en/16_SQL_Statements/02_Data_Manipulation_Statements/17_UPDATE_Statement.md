...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") is a DML statement that
modifies rows in a table.

An [`UPDATE`](update.html "15.2.17 UPDATE Statement") statement can start with
a [`WITH`](with.html "15.2.20 WITH (Common Table Expressions)") clause to define common
table expressions accessible within the
[`UPDATE`](update.html "15.2.17 UPDATE Statement"). See [Section 15.2.20, “WITH (Common Table Expressions)”](with.html "15.2.20 WITH (Common Table Expressions)").
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") statement updates columns of
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") updates rows in each table
...
[`REPLACE`](replace.html "15.2.12 REPLACE Statement") statement, an otherwise
...
syntax, see [Section 11.5, “Expressions”](expressions.html "11.5 Expressions").
...
You need the [`UPDATE`](privileges-provided.html#priv_update) privilege only
...
The [`UPDATE`](update.html "15.2.17 UPDATE Statement") statement supports the
following modifiers:

* With the `LOW_PRIORITY` modifier, execution
  of the [`UPDATE`](update.html "15.2.17 UPDATE Statement") is delayed until
...
[`UPDATE IGNORE`](update.html "15.2.17 UPDATE Statement")
...
[Section 19.2.1.3, “Determination of Safe and Unsafe Statements in Binary Logging”](replication-rbr-safe-unsafe.html "19.2.1.3 Determination of Safe and Unsafe Statements in Binary Logging"), for more
information.

If you access a column from the table to be updated in an
expression, [`UPDATE`](update.html "15.2.17 UPDATE Statement") uses the current
...
Single-table [`UPDATE`](update.html "15.2.17 UPDATE Statement") assignments are
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") returns the number of rows
...
scope of the [`UPDATE`](update.html "15.2.17 UPDATE Statement"). A
...
If an [`UPDATE`](update.html "15.2.17 UPDATE Statement") statement includes an
...
You can also perform [`UPDATE`](update.html "15.2.17 UPDATE Statement")
operations covering multiple tables. However, you cannot use
`ORDER BY` or `LIMIT` with a
multiple-table [`UPDATE`](update.html "15.2.17 UPDATE Statement"). The
*`table_references`* clause lists the
tables involved in the join. Its syntax is described in
[Section 15.2.13.2, “JOIN Clause”](join.html "15.2.13.2 JOIN Clause"). Here is an example:
...
operator, but multiple-table [`UPDATE`](update.html "15.2.17 UPDATE Statement")
statements can use any type of join permitted in
[`SELECT`](select.html "15.2.13 SELECT Statement") statements, such as
`LEFT JOIN`.

If you use a multiple-table [`UPDATE`](update.html "15.2.17 UPDATE Statement")
...
[`derived_merge`](switchable-optimizations.html#optflag_derived-merge) flag of the
[`optimizer_switch`](server-system-variables.html#sysvar_optimizer_switch) system variable
to `off` before running the update, or by using
the [`NO_MERGE`](optimizer-hints.html#optimizer-hints-table-level "Table-Level Optimizer Hints") optimizer hint, as
shown here:

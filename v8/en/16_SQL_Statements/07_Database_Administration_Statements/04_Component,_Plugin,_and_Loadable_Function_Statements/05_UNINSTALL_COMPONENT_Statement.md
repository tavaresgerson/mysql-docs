...
[Section 7.5, “MySQL Components”](components.html "7.5 MySQL Components"). [`UNINSTALL
COMPONENT`](uninstall-component.html "15.7.4.5 UNINSTALL COMPONENT Statement") is the complement of
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement"). It requires
the [`DELETE`](privileges-provided.html#priv_delete) privilege for the
`mysql.component` system table because it
removes the row from that table that registers the component.
[`UNINSTALL COMPONENT`](uninstall-component.html "15.7.4.5 UNINSTALL COMPONENT Statement") does not undo

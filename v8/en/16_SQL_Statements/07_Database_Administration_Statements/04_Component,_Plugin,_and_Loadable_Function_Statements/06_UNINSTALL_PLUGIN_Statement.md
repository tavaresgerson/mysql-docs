...
[`UNINSTALL PLUGIN`](uninstall-plugin.html "15.7.4.6 UNINSTALL PLUGIN Statement") is the
complement of [`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement"). It
...
[`UNINSTALL PLUGIN`](uninstall-plugin.html "15.7.4.6 UNINSTALL PLUGIN Statement") does not remove
...
the table with [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and remove the
`WITH PARSER` clause from the dumped
[`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement so that
you can reload the table later. If you do not care about the
table, [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") can be used

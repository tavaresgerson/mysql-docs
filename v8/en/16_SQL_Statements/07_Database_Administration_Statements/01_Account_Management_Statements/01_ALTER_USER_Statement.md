...
* Credentials that are stored internally are stored in the
  ...
  + For syntax that uses `AS
    ...
    [`SHOW CREATE USER`](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement") for
...
As of MySQL 8.0.27, [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement")
has `ADD`, `MODIFY`, and
...
[FIDO Device Unregistration](fido-pluggable-authentication.html#fido-pluggable-authentication-unregistration "FIDO Device Unregistration"),
...
As of MySQL 8.0.19, [`ALTER USER`](alter-user.html "15.7.1.1 ALTER USER Statement")
...
Information Schema
[`USER_ATTRIBUTES`](information-schema-user-attributes-table.html "28.3.46 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table as a JSON
...
[`USER_ATTRIBUTES`](information-schema-user-attributes-table.html "28.3.46 The INFORMATION_SCHEMA USER_ATTRIBUTES Table") table; to remove

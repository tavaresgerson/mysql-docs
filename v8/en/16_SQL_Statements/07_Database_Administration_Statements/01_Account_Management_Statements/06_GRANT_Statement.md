...
operation, use [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement"). See
...
<td>Enable use of <a class="link" href="alter-table.html" title="15.1.9 ALTER TABLE Statement"><code class="literal">ALTER TABLE</code></a>. Levels:
...
<td>Enable use of <a class="link" href="create-table.html" title="15.1.20 CREATE TABLE Statement"><code class="literal">CREATE
...
<td>Enable the user to see all processes with <a class="link" href="show-processlist.html" title="15.7.7.29 SHOW PROCESSLIST Statement"><code class="literal">SHOW
...
<td>Enable <a class="link" href="show-databases.html" title="15.7.7.14 SHOW DATABASES Statement"><code class="literal">SHOW DATABASES</code></a> to show all
...
<td>Enable use of <a class="link" href="show-create-view.html" title="15.7.7.13 SHOW CREATE VIEW Statement"><code class="literal">SHOW CREATE VIEW</code></a>. Levels:
                Global, database, table.</td>
</tr><tr>
...
<td>Enable use of other administrative operations such as
                <a class="link" href="change-replication-source-to.html" title="15.4.2.3 CHANGE REPLICATION SOURCE TO Statement"><code class="literal">CHANGE REPLICATION SOURCE
                TO</code></a>, <a class="link" href="change-master-to.html" title="15.4.2.1 CHANGE MASTER TO Statement"><code class="literal">CHANGE MASTER
...
<td><a class="link" href="privileges-provided.html#priv_set-user-id"><code class="literal">SET_USER_ID</code></a></td>
...
[`SHUTDOWN`](privileges-provided.html#priv_shutdown), and
...
TEMPORARY TABLE`](create-temporary-table.html "15.1.20.2 CREATE TEMPORARY TABLE Statement"), even if the table names match. For
information about `TEMPORARY` table
privileges, see [Section 15.1.20.2, “CREATE TEMPORARY TABLE Statement”](create-temporary-table.html "15.1.20.2 CREATE TEMPORARY TABLE Statement").
...
As of MySQL 8.0.16, [`GRANT`](grant.html "15.7.1.6 GRANT Statement") has
an `AS user [WITH

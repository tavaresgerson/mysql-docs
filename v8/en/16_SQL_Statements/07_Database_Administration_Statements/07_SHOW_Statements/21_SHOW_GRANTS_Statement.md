...
the [`SHOW CREATE USER`](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement") statement.
See [Section 15.7.7.12, “SHOW CREATE USER Statement”](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement").

[`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") requires the
...
GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement"), use the same format as for the
...
are defined. Instead, [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement")
...
GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") output should be adjusted accordingly.
...
privileges. [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") displays
...
[`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") enables you to
...
[`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") without
...
[Section 8.2.12, “Privilege Restriction Using Partial Revokes”](partial-revokes.html "8.2.12 Privilege Restriction Using Partial Revokes")). To indicate which global
...
[`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") does not display
...
privileges, but [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") does
not display them.
...
* [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") without a
  `FOR` clause displays privileges for the
  current user, and includes mandatory roles.

* [`SHOW GRANTS FOR
  user`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") displays
  privileges for the named user, and does not include
  mandatory roles.

This behavior is for the benefit of applications that use the
output of [`SHOW
GRANTS FOR user`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") to
...
GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") or
[`SHOW GRANTS FOR
CURRENT_USER`](show-grants.html "15.7.7.21 SHOW GRANTS Statement"), respectively.
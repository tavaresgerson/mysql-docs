...
[`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") displays information
about server plugins.

Example of [`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") output:
...
[`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") output has these
columns:
...
PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement"), see [The MySQL Plugin API](/doc/extending-mysql/8.0/en/plugin-api.html).

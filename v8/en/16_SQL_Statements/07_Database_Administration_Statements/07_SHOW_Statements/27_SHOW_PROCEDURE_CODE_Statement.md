...
FUNCTION CODE`](show-function-code.html "15.7.7.19 SHOW FUNCTION CODE Statement"), displays information about stored
functions (see [Section 15.7.7.19, “SHOW FUNCTION CODE Statement”](show-function-code.html "15.7.7.19 SHOW FUNCTION CODE Statement")).

To use either statement, you must be the user named as the
routine `DEFINER`, have the
[`SHOW_ROUTINE`](privileges-provided.html#priv_show-routine) privilege, or have
...
means `DROP`, 5 means
[`INSERT`](insert.html "15.2.7 INSERT Statement"), and so on). The final row

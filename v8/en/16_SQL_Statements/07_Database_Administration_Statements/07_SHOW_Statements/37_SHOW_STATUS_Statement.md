...
[`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") provides server
...
For [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement"), a
...
[`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") accepts an optional
...
STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") statement uses an internal temporary table and

...
VIEW`](create-view.html "15.1.23 CREATE VIEW Statement") statement that creates the named view.
...
Use of [`SHOW CREATE VIEW`](show-create-view.html "15.7.7.13 SHOW CREATE VIEW Statement") requires
...
`INFORMATION_SCHEMA`
[`VIEWS`](information-schema-views-table.html "28.3.48 The INFORMATION_SCHEMA VIEWS Table") table. See

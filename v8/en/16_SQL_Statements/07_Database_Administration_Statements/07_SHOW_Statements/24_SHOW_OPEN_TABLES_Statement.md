...
[`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.24 SHOW OPEN TABLES Statement") lists the
non-`TEMPORARY` tables that are currently open
in the table cache. See [Section 10.4.3.1, “How MySQL Opens and Closes Tables”](table-cache.html "10.4.3.1 How MySQL Opens and Closes Tables"). The
`FROM` clause, if present, restricts the tables
shown to those present in the *`db_name`*
database. The [`LIKE`](string-comparison-functions.html#operator_like) clause, if
...
[`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.24 SHOW OPEN TABLES Statement") output has these
columns:
...
* `In_use`
  ...
  the [`HANDLER ...
  OPEN`](handler.html "15.2.5 HANDLER Statement") statement and decreased by
  [`HANDLER ...
  CLOSE`](handler.html "15.2.5 HANDLER Statement").
...
the output from [`SHOW OPEN TABLES`](show-open-tables.html "15.7.7.24 SHOW OPEN TABLES Statement").
...
Shows the [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statement
...
constraints and [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement")
...
[`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") quotes table
...
STATUS`](show-table-status.html "15.7.7.38 SHOW TABLE STATUS Statement"). [`SHOW CREATE
TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") shows the row format that was specified in the

...
The [`SHOW CHARACTER SET`](show-character-set.html "15.7.7.3 SHOW CHARACTER SET Statement") statement
...
[`SHOW CHARACTER SET`](show-character-set.html "15.7.7.3 SHOW CHARACTER SET Statement") output has
these columns:
...
SET`](show-character-set.html "15.7.7.3 SHOW CHARACTER SET Statement") does not display it.

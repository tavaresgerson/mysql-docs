...
which are discussed in [Section 27.4, “Using the Event Scheduler”](event-scheduler.html "27.4 Using the Event Scheduler"). It
requires the [`EVENT`](privileges-provided.html#priv_event) privilege for
the database from which the events are to be shown.

In its simplest form, [`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement")
...
[`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement") output has these
columns:
...
* `Execute At`
  ...
  [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement used
...
Times displayed by [`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement")
...
[`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement"). Use
[`SHOW CREATE EVENT`](show-create-event.html "15.7.7.7 SHOW CREATE EVENT Statement") or the
`INFORMATION_SCHEMA`

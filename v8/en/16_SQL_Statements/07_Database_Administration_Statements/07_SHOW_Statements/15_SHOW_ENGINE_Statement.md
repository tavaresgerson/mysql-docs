...
[`SHOW ENGINE`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") displays operational
...
[`SHOW ENGINE INNODB
STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") displays extensive information from the
...
[`SHOW ENGINE INNODB
MUTEX`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") displays `InnoDB`
...
Schema](performance-schema.html "Chapter 29 MySQL Performance Schema") tables. See
...
[`SHOW ENGINE INNODB
MUTEX`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") can also be enabled by setting
...
[`SHOW ENGINE INNODB
MUTEX`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") output has these columns:
...
Use [`SHOW ENGINE
PERFORMANCE_SCHEMA STATUS`](show-engine.html "15.7.7.15 SHOW ENGINE Statement") to inspect the internal
...
If the server has the [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage
...
<td>The number of times this <a class="link" href="mysqld.html" title="6.3.1 mysqld — The MySQL Server"><span class="command"><strong>mysqld</strong></span></a> has connected or
...
See [Section 25.7, “NDB Cluster Replication”](mysql-cluster-replication.html "25.7 NDB Cluster Replication"), for more
information.
...
* `NdbTransaction`: The number and size of
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")) is performed on
  an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table.
...
* `NdbBlob`: The number and size of
  ...
  operation involving a [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types")
  column in an [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table.
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables have been performed

...
[`character_set_client`](server-system-variables.html#sysvar_character_set_client) and
[`character_set_results`](server-system-variables.html#sysvar_character_set_results) are set
to the given character set, and
[`character_set_connection`](server-system-variables.html#sysvar_character_set_connection) to the
value of
[`character_set_database`](server-system-variables.html#sysvar_character_set_database). See

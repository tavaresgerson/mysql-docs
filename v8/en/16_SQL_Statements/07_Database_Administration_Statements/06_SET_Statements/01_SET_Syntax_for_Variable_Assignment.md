...
* System variables. See
  [Section 7.1.8, “Server System Variables”](server-system-variables.html "7.1.8 Server System Variables"). System variables
...
[`:=`](assignment-operators.html#operator_assign-value)
...
[`user_variables_by_thread`](performance-schema-user-variable-tables.html "29.12.10 Performance Schema User-Defined Variable Tables") table
...
file, see [Section 7.1.9.3, “Persisted System Variables”](persisted-system-variables.html "7.1.9.3 Persisted System Variables").
...
[`max_join_size`](server-system-variables.html#sysvar_max_join_size) to the current
global value:
...
* Use the [`SHOW VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement")
  statement; see [Section 15.7.7.41, “SHOW VARIABLES Statement”](show-variables.html "15.7.7.41 SHOW VARIABLES Statement").
...
sets the [`sort_buffer_size`](server-system-variables.html#sysvar_sort_buffer_size)
...
values in a [`SELECT`](select.html "15.2.13 SELECT Statement") statement
like this:

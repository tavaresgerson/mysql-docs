...
[`SHUTDOWN`](shutdown.html "15.7.8.9 SHUTDOWN Statement") provides an SQL-level
interface to the same functionality available using the
[**mysqladmin shutdown**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command or the
[`mysql_shutdown()`](/doc/c-api/8.0/en/mysql-shutdown.html) C API function.
A successful [`SHUTDOWN`](shutdown.html "15.7.8.9 SHUTDOWN Statement") sequence
...
The
[`Com_shutdown`](server-status-variables.html#statvar_Com_xxx)
status variable tracks the number of
[`SHUTDOWN`](shutdown.html "15.7.8.9 SHUTDOWN Statement") statements. Because
...
[`SHUTDOWN`](shutdown.html "15.7.8.9 SHUTDOWN Statement") statements were executed
but failed.

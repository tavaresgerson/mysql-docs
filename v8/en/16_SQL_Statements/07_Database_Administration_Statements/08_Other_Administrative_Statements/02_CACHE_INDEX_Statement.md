...
The [`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") statement assigns
...
[`LOAD INDEX INTO
CACHE`](load-index.html "15.7.8.5 LOAD INDEX INTO CACHE Statement").
...
The syntax of [`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") enables
...
[`CACHE INDEX`](cache-index.html "15.7.8.2 CACHE INDEX Statement") is supported for

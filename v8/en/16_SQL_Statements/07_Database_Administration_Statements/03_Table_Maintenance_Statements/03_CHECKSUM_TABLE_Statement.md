...
[`CHECKSUM TABLE`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") reports a
[checksum](glossary.html#glos_checksum "checksum") for the contents
...
[`SELECT`](privileges-provided.html#priv_select) privilege for the table.

This statement is not supported for views. If you run
[`CHECKSUM TABLE`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") against a view,
the `Checksum` value is always
`NULL`, and a warning is returned.

For a nonexistent table, [`CHECKSUM
TABLE`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") returns `NULL` and generates a
warning.
...
`CHECKSUM=1` clause,
[`CHECKSUM TABLE`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") or
[`CHECKSUM TABLE
... QUICK`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") returns the “live” table
...
See [Section 15.1.20, “CREATE TABLE Statement”](create-table.html "15.1.20 CREATE TABLE Statement") for the syntax of the
`CHECKSUM` clause.
...
[`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") changed in MySQL 5.6
...
[`CHECKSUM TABLE`](checksum-table.html "15.7.3.3 CHECKSUM TABLE Statement") is not

...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") repairs a possibly
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), if disaster
...
need to use [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"). See
[Section B.3.3.3, “What to Do If MySQL Keeps Crashing”](crashing.html "B.3.3.3 What to Do If MySQL Keeps Crashing"), and
[Section 18.2.4, “MyISAM Table Problems”](myisam-table-problems.html "18.2.4 MyISAM Table Problems").

[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") checks the table to
see whether an upgrade is required. If so, it performs the
upgrade, following the same rules as
[`CHECK TABLE ... FOR
UPGRADE`](check-table.html "15.7.3.2 CHECK TABLE Statement"). See [Section 15.7.3.2, “CHECK TABLE Statement”](check-table.html "15.7.3.2 CHECK TABLE Statement"), for more
information.
...
* If the server exits during a [`REPAIR
  TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") operation, it is essential after
  restarting it that you immediately execute another
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") statement for
...
* In the event that a table on the source becomes corrupted
  and you run [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") on
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") works for
...
[`CSV`](csv-storage-engine.html "18.4 The CSV Storage Engine") tables. For
[`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") tables, it has the same
effect as [**myisamchk --recover
*`tbl_name`***](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") by default. This
statement does not work with views.

[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") is supported for
...
information, see [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement"), and
...
* `NO_WRITE_TO_BINLOG` or
  ...
  TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") statements to the binary log so that they
...
* `QUICK`
  ...
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") tries to
  repair only the index file, and not the data file. This
  type of repair is like that done by [**myisamchk
  --recover --quick**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").
...
* `EXTENDED`
  ...
  done by [**myisamchk --safe-recover**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").
...
* `USE_FRM`
  ...
  *only* if you cannot use regular
  ...
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") does not
  attempt to repair the table. In this case, the result
  set returned by [`REPAIR
  TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") contains a line with a
  `Msg_type` value of
  `error` and a
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") returns a result
...
The [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") statement
...
[**myisamchk --safe-recover**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").
([`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") does not
implement all the options of [**myisamchk**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility").
With [**myisamchk --safe-recover**](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility"), you can also
use options that [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement")
does not support, such as
[`--max-record-length`](myisamchk-repair-options.html#option_myisamchk_max-record-length).)

[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") table catches and
...
process, [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") generates
...
[`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") upgrades a table
...
enabled, [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") ignores
...
executing [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement").

You may be able to increase [`REPAIR
TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement") performance by setting certain system
variables. See [Section 10.6.3, “Optimizing REPAIR TABLE Statements”](repair-table-optimization.html "10.6.3 Optimizing REPAIR TABLE Statements").
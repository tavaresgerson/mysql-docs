...
[`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") checks a table or
tables for errors. [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement")
can also check views for problems, such as tables that are
referenced in the view definition that no longer exist.

To check a table, you must have some privilege for it.

[`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") works for
...
[`ARCHIVE`](archive-storage-engine.html "18.5 The ARCHIVE Storage Engine"), and
[`CSV`](csv-storage-engine.html "18.4 The CSV Storage Engine") tables.

Before running [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") on
`InnoDB` tables, see
[CHECK TABLE Usage Notes for InnoDB Tables](check-table.html#check-table-innodb "CHECK TABLE Usage Notes for InnoDB Tables").

[`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") is supported for
partitioned tables, and you can use `ALTER TABLE ...
CHECK PARTITION` to check one or more partitions; for
more information, see [Section 15.1.9, “ALTER TABLE Statement”](alter-table.html "15.1.9 ALTER TABLE Statement"), and
[Section 26.3.4, “Maintenance of Partitions”](partitioning-maintenance.html "26.3.4 Maintenance of Partitions").

[`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") ignores virtual
...
[`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") returns a result
...
* The indexing order for end-space in
  [`TEXT`](blob.html "13.3.4 The BLOB and TEXT Types") columns for
  `InnoDB` and `MyISAM`
  tables changed between MySQL 4.1 and 5.0.

* The storage method of the new
  [`DECIMAL`](fixed-point-types.html "13.1.3 Fixed-Point Types (Exact Value) - DECIMAL, NUMERIC") data type changed
...
* Changes are sometimes made to character sets or collations
  ...
  [Section 3.5, “Changes in MySQL 8.0”](upgrading-from-previous-series.html "3.5 Changes in MySQL 8.0"). For
...
* MySQL 8.0 does not support the 2-digit
  [`YEAR(2)`](year.html "13.2.4 The YEAR Type") data type permitted
  in older versions of MySQL. For tables containing
  [`YEAR(2)`](year.html "13.2.4 The YEAR Type") columns,
  [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") recommends
  [`REPAIR TABLE`](repair-table.html "15.7.3.5 REPAIR TABLE Statement"), which
  converts 2-digit [`YEAR(2)`](year.html "13.2.4 The YEAR Type")
  columns to 4-digit [`YEAR`](year.html "13.2.4 The YEAR Type")
  columns.
...
* A table is reported as needing a rebuild if it contains
  ...
  before executing
  [`CHECK TABLE
  ... FOR UPGRADE`](check-table.html "15.7.3.2 CHECK TABLE Statement").
...
If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") finds no
problems with a table that is marked as
“corrupted” or “not closed
properly”, [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement")
may remove the mark.
...
Use of [`CHECK
TABLE ... EXTENDED`](check-table.html "15.7.3.2 CHECK TABLE Statement") might influence execution plans
generated by the query optimizer.

Some problems reported by [`CHECK
TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") cannot be corrected automatically:
...
* `Found row where the auto_increment column has the
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") on the table.
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") statement to set the
...
* If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") encounters a
...
* If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") encounters a
  ...
  [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") can cause
  `InnoDB` to access an invalid undo log
  record, resulting in an
  [MVCC](glossary.html#glos_mvcc "MVCC")-related server exit.

* If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") encounters
...
* If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") finds an
...
* [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") surveys the
  index page structure, then surveys each key entry. It does
  not validate the key pointer to a clustered record or
  follow the path for [`BLOB`](blob.html "13.3.4 The BLOB and TEXT Types")
  pointers.
...
* When an `InnoDB` table is stored in its
  ...
  [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") statement does
  not detect inconsistencies that affect only the header
  data. To verify the entire contents of an
  `InnoDB` `.ibd` file,
  use the [**innochecksum**](innochecksum.html "6.6.2 innochecksum — Offline InnoDB File Checksum Utility") command.

* When running [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") on
  large `InnoDB` tables, other threads may
  be blocked during [`CHECK
  TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") execution. To avoid timeouts, the
  ...
  [`CHECK TABLE
  QUICK`](check-table.html "15.7.3.2 CHECK TABLE Statement") instead of [`CHECK
  TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement").

* [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") functionality
  for `InnoDB` `SPATIAL`
  indexes includes an R-tree validity check and a check to
  ensure that the R-tree row count matches the clustered
  index.

* [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") supports
...
* As of MySQL 8.0.14, `InnoDB` supports
  ...
  during a [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement")
...
The following notes apply to
[`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") tables:

* [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") updates key
  statistics for `MyISAM` tables.

* If [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement") output does
...
* If none of the [`CHECK TABLE`](check-table.html "15.7.3.2 CHECK TABLE Statement")
  options `QUICK`,
  `MEDIUM`, or `EXTENDED`
  ...
  *`tbl_name`***](myisamchk.html "6.6.4 myisamchk — MyISAM Table-Maintenance Utility") on the

...
The [`CLONE`](clone.html "15.7.5 CLONE Statement") statement is used to
clone data locally or from a remote MySQL server instance. To use
[`CLONE`](clone.html "15.7.5 CLONE Statement") syntax, the clone plugin must
be installed. See [Section 7.6.7, “The Clone Plugin”](clone-plugin.html "7.6.7 The Clone Plugin").

[`CLONE LOCAL DATA
DIRECTORY`](clone.html "15.7.5 CLONE Statement") syntax clones data from the local MySQL data
...
[`CLONE INSTANCE`](clone.html "15.7.5 CLONE Statement")
...
* `host` is the
  [`hostname`](server-system-variables.html#sysvar_hostname) address of the donor
...
* `port` is the
  ...
  [`mysqlx_port`](x-plugin-options-system-variables.html#sysvar_mysqlx_port) is not supported.
...
server instance, see [Section 7.6.7.3, “Cloning Remote Data”](clone-plugin-remote.html "7.6.7.3 Cloning Remote Data").
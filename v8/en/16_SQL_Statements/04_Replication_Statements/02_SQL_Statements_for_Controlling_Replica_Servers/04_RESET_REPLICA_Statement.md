...
[`RESET REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") in place of
[`RESET SLAVE`](reset-slave.html "15.4.2.5 RESET SLAVE Statement"), which is deprecated
from that release. In releases before MySQL 8.0.22, use
[`RESET SLAVE`](reset-slave.html "15.4.2.5 RESET SLAVE Statement").
...
[`STOP
REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement or if the replica is highly
loaded.)
...
MASTER`](reset-master.html "15.4.1.2 RESET MASTER Statement"), even if the GTID-enabled server is a replica
...
[`STOP
REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") before issuing `RESET
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") |
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"). When
...
issuing [`START
REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement"), retention of the replication connection
...
* When
  ...
  [`START
  REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement"), the replication connection parameters are
...
* If
  ...
  in memory. If the replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") is
...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine and so is

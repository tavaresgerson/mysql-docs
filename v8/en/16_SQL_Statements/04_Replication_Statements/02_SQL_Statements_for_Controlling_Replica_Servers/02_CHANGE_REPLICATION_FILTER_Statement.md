...
starting the replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with replication
...
1. The statement does not require restarting the server to take
   ...
   using [`STOP
   REPLICA SQL_THREAD`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") first (and restarted with
   [`START REPLICA
   SQL_THREAD`](start-replica.html "15.4.2.6 START REPLICA Statement") afterwards).
...
See [Section 19.2.5, “How Servers Evaluate Replication Filtering Rules”](replication-rules.html "19.2.5 How Servers Evaluate Replication Filtering Rules"), for more information.
...
replica [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") with the options
[`--replicate-do-db=d1`](replication-options-replica.html#option_mysqld_replicate-do-db)
...
issuing [`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.2 CHANGE REPLICATION FILTER Statement")
...
see [Section 19.2.5.4, “Replication Channel Based Filters”](replication-rules-channel-based-filters.html "19.2.5.4 Replication Channel Based Filters").
...
The [`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.2 CHANGE REPLICATION FILTER Statement")
...
The [`RESET REPLICA
ALL`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") statement removes channel specific replication

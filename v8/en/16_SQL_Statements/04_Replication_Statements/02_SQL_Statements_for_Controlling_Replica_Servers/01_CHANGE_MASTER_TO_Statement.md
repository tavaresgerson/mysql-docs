...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") changes the
...
[Section 19.2.4, “Relay Log and Replication Metadata Repositories”](replica-logs.html "19.2.4 Relay Log and Replication Metadata Repositories")). From MySQL 8.0.23, use
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") in
place of [`CHANGE MASTER
TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"), which is deprecated from that release. In releases
before MySQL 8.0.23, use [`CHANGE MASTER
TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement").

[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") requires the
...
MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement retain their value, except as
...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement must
...
MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement, you must issue a
[`STOP
SLAVE`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement prior to issuing a
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement (and a
[`START
SLAVE`](start-replica.html "15.4.2.6 START REPLICA Statement") statement afterwards). Sometimes, you only need
...
* When the applier thread is stopped, you can execute
  [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") using any
...
* When the receiver thread is stopped, you can execute
  [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") using any of
...
* Both the receiver thread and the applier thread must be
  ...
  TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement that employs
...
[`SHOW SLAVE
STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). Note that the Group Replication applier
channel (`group_replication_applier`) has no
receiver thread, only an applier thread.

[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statements have
a number of side-effects and interactions that you should be
aware of beforehand:

* [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") causes an
...
* [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") causes the
...
* If you are using statement-based replication and temporary
  ...
  MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement following a
  [`STOP
  SLAVE`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement to leave behind temporary tables
  ...
  a [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement.
...
* When using a multithreaded replica
  ...
  0 or [`slave_parallel_workers`](replication-options-replica.html#sysvar_slave_parallel_workers)
  ...
  [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") fails. The
  ...
  [`CHANGE MASTER
  TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") can still be used.

The following options are available for
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statements:
...
:   Makes the replication channel assign a GTID to replicated
    ...
    `uuid`, the
    replica must have
    [`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode) set, and
...
:   Stops the replication channel persisting file names and
    ...
    ([`gtid_mode =
    ON`](replication-options-gtids.html#sysvar_gtid_mode)), and row-based binary logging must be in use
...
:   Makes the replica ignore events originating from the
    ...
    in a [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement")
    statement.
    ...
    If a [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement")
    ...
    [`RESET
    REPLICA ALL`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") clears
    `IGNORE_SERVER_IDS`.
    ...
    [`SHOW
    REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") statement displays the list of
    ...
    TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") statement containing the
...
:   Makes the replica attempt to connect to the source using
    ...
    [`gtid_purged`](replication-options-gtids.html#sysvar_gtid_purged) system
...
:   Determines which of the replica's network interfaces is
    ...
    output from
    [`SHOW
    REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). In the source metadata
    repository table
...
:   Controls the heartbeat interval, which stops the
    ...
    *`interval`* to 0 disables
    ...
    [`replica_net_timeout`](replication-options-replica.html#sysvar_replica_net_timeout) or
    [`slave_net_timeout`](replication-options-replica.html#sysvar_slave_net_timeout) does
    ...
    MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") to adjust the heartbeat interval to an
...
:   The binary log file name, and the location in that file,
    ...
    *replication SQL (applier) thread*
    before [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") was
...
:   Names a user account that supplies a security context for
    ...
    [Section 8.2.4, “Specifying Account Names”](account-names.html "8.2.4 Specifying Account Names"), and the user must not be
...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") is
...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") to locate the
...
[`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") can also be
...
TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement") or another method, see

...
repositories (see [Section 19.2.4, “Relay Log and Replication Metadata Repositories”](replica-logs.html "19.2.4 Relay Log and Replication Metadata Repositories")). In MySQL
8.0.23 and later, use [`CHANGE REPLICATION
SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") in place of the deprecated
...
REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement retain their value,
...
TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement must name a channel using the
`FOR CHANNEL
channel` clause. See
...
REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement, you must issue a
[`STOP REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement prior to
issuing a [`CHANGE REPLICATION SOURCE
TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement (and a [`START
REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statement afterwards). Sometimes, you only
...
* Both the receiver thread and the applier thread must be
  ...
  REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement that employs
...
[`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). Note that the Group Replication
...
* If you are using statement-based replication and temporary
  ...
  REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement following a
  [`STOP
  REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") statement to leave behind temporary tables
  on the replica. A warning
  ([`ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZERO`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_warn_open_temp_tables_must_be_zero))
...
* When using a multithreaded replica
  ...
  [`START REPLICA
  UNTIL SQL_AFTER_MTS_GAPS`](start-replica.html "15.4.2.6 START REPLICA Statement") which ensures that the
...
* [`GTID_ONLY = {0|1}`](change-replication-source-to.html#crs-opt-gtid_only)
  ...
  STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") statements (where they are shown as being
...
* [`IGNORE_SERVER_IDS =
  ...
  [`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode) is set for
  ...
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") provide the list of servers that
  ...
  TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement is issued without any
  ...
  [`RESET REPLICA
  ALL`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") clears `IGNORE_SERVER_IDS`.
  ...
  [`SHOW REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement")
  ...
  [`gtid_mode=ON`](replication-options-gtids.html#sysvar_gtid_mode) is set by
  issuing a [`CHANGE REPLICATION SOURCE
  TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement containing the
...
* [`REQUIRE_TABLE_PRIMARY_KEY_CHECK =
  ...
  + `ON`: The replica sets
    ...
    TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or [`ALTER
    TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement must result in a table that
  ...
  + `GENERATE`: Added in MySQL 8.0.32, this
    ...
    for any [`InnoDB`](innodb-storage-engine.html "Chapter 17 The InnoDB Storage Engine") table that,
    as replicated, lacks a primary key. See
    [Section 15.1.20.11, “Generated Invisible Primary Keys”](create-table-gipks.html "15.1.20.11 Generated Invisible Primary Keys"), for more
    information.
...
* [`SOURCE_AUTO_POSITION =
  ...
  [`ER_SOURCE_HAS_PURGED_REQUIRED_GTIDS`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_source_has_purged_required_gtids)
  ...
  [`ER_FOUND_MISSING_GTIDS`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_found_missing_gtids).
  ...
  [`ER_REPLICA_HAS_MORE_GTIDS_THAN_SOURCE`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_replica_has_more_gtids_than_source)
  ...
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). Disabling the
...
* [`SOURCE_BIND =
  ...
  output from
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement"). In the source metadata repository
...
* [`SOURCE_CONNECTION_AUTO_FAILOVER =
  ...
  3. When you set `SOURCE_CONNECTION_AUTO_FAILOVER
     ...
     [`CHANGE REPLICATION SOURCE
     TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement with the
     `SOURCE_USER` and
...
* [`SOURCE_HEARTBEAT_PERIOD =
  ...
  The system variable
  [`replica_net_timeout`](replication-options-replica.html#sysvar_replica_net_timeout) (from
  MySQL 8.0.26) or
  [`slave_net_timeout`](replication-options-replica.html#sysvar_slave_net_timeout) (before
  ...
  REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") to adjust the heartbeat
...
* [`SOURCE_PASSWORD =
  ...
  PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") statements.
...
* [`SOURCE_USER =
  ...
  [`START
  REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statement or [`START
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") is
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") to
...
[`CHANGE REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") or
another method, see

...
[`PREPARE`](prepare.html "15.5.1 PREPARE Statement"), use a
[`DEALLOCATE PREPARE`](deallocate-prepare.html "15.5.3 DEALLOCATE PREPARE Statement") statement that
...
by the [`max_prepared_stmt_count`](server-system-variables.html#sysvar_max_prepared_stmt_count)
system variable.

For examples, see [Section 15.5, “Prepared Statements”](sql-prepared-statements.html "15.5 Prepared Statements").
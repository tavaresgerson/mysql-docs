...
API client library](/doc/c-api/8.0/en/) for C programs,
...
[C API Prepared Statement Interface](/doc/c-api/8.0/en/c-api-prepared-statement-interface.html). Other language
...
[`mysql_stmt_prepare()`](/doc/c-api/8.0/en/mysql-stmt-prepare.html) C API function
...
[`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html), either

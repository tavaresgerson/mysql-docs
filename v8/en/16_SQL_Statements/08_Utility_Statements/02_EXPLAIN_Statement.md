...
[`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement"). These statements
also display information for views. The description for
[`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement") provides more
...
* [`EXPLAIN`](explain.html "15.8.2 EXPLAIN Statement") works with
  ...
  [`UPDATE`](update.html "15.2.17 UPDATE Statement") statements. In MySQL
...
[`SELECT`](select.html "15.2.13 SELECT Statement") statements, as well as
with multi-table [`UPDATE`](update.html "15.2.17 UPDATE Statement") and
[`DELETE`](delete.html "15.2.2 DELETE Statement") statements. Beginning with
MySQL 8.0.19, it can also be used with
[`TABLE`](table.html "15.2.16 TABLE Statement") statements.

Beginning with MySQL 8.0.20, you can terminate this statement
using [`KILL QUERY`](kill.html "15.7.8.4 KILL Statement")
or **CTRL-C**.
...
[`explain_format`](server-system-variables.html#sysvar_explain_format) system variable

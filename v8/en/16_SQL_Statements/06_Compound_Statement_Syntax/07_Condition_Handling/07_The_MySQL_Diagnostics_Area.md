...
see [Server Error Message Reference](/doc/mysql-errors/8.0/en/server-error-reference.html).
...
[`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") or
[`SHOW ERRORS`](show-errors.html "15.7.7.17 SHOW ERRORS Statement") to see conditions
or errors.
...
* When the server starts executing a statement after parsing
  ...
  + [`SHOW ERRORS`](show-errors.html "15.7.7.17 SHOW ERRORS Statement")
...
WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") to display information about conditions
stored there.

This [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement

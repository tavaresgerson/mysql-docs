...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement raises a
...
the [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement and
...
TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") statement:
...
to the scope of the [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement")
statement:
...
[`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement"). The condition raised

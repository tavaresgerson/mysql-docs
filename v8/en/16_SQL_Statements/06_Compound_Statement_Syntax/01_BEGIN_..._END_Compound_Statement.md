...
delimiter. In the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") command-line client,
...
A [`BEGIN ...
END`](begin-end.html "15.6.1 BEGIN ... END Compound Statement") block can be labeled. See
...
[`BEGIN [WORK]`](commit.html "15.3.1 START TRANSACTION, COMMIT, and ROLLBACK Statements")
as the beginning of a
[`BEGIN ...
END`](begin-end.html "15.6.1 BEGIN ... END Compound Statement") block. To begin a transaction in this context, use
[`START

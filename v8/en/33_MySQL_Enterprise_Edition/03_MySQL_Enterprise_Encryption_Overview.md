...
For more information, see [Section 8.6, “MySQL Enterprise Encryption”](enterprise-encryption.html "8.6 MySQL Enterprise Encryption").

For other related Enterprise security features, see
[Section 32.2, “MySQL Enterprise Security Overview”](mysql-enterprise-security.html "32.2 MySQL Enterprise Security Overview").
...
[`ST_GEOMETRY_COLUMNS`](information-schema-st-geometry-columns-table.html "28.3.35 The INFORMATION_SCHEMA ST_GEOMETRY_COLUMNS Table") table provides
...
* `ORDINAL_POSITION`
  ...
  COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement"), [`SELECT`](select.html "15.2.13 SELECT Statement") from
...
* In [`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement"), the
...
[`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement") statement. See
[Section 15.7.7.5, “SHOW COLUMNS Statement”](show-columns.html "15.7.7.5 SHOW COLUMNS Statement"). The following statements are
nearly equivalent:

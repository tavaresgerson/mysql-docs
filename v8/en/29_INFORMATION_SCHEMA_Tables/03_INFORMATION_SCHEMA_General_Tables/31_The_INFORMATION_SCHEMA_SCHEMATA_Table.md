...
[`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table") table provides information
about databases.

The [`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table") table has these columns:
...
DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") statement. See
[Section 15.7.7.14, “SHOW DATABASES Statement”](show-databases.html "15.7.7.14 SHOW DATABASES Statement"). The following statements are
equivalent:
...
* The [`SCHEMATA_EXTENSIONS`](information-schema-schemata-extensions-table.html "28.3.32 The INFORMATION_SCHEMA SCHEMATA_EXTENSIONS Table") table
  augments the [`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table") table with

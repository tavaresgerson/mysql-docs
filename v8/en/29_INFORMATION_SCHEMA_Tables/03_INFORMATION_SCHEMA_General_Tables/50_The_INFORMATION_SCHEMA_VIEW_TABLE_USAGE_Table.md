...
The [`VIEW_TABLE_USAGE`](information-schema-view-table-usage-table.html "28.3.50 The INFORMATION_SCHEMA VIEW_TABLE_USAGE Table") table (available
...
The [`VIEW_TABLE_USAGE`](information-schema-view-table-usage-table.html "28.3.50 The INFORMATION_SCHEMA VIEW_TABLE_USAGE Table") table has these
columns:

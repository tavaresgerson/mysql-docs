...
The [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "28.3.42 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table") table describes
which tables have constraints.

The [`TABLE_CONSTRAINTS`](information-schema-table-constraints-table.html "28.3.42 The INFORMATION_SCHEMA TABLE_CONSTRAINTS Table") table has these
columns:
...
* `CONSTRAINT_TYPE`
  ...
  `CHECK`. This is a
  [`CHAR`](char.html "13.3.2 The CHAR and VARCHAR Types") (not
  [`ENUM`](enum.html "13.3.5 The ENUM Type")) column.

  The `UNIQUE` and `PRIMARY
  KEY` information is about the same as what you get
  from the `Key_name` column in the output from
  [`SHOW INDEX`](show-index.html "15.7.7.22 SHOW INDEX Statement") when the

...
The [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table provides information
...
The [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table has these columns:
...
* `EVENT_BODY`
  ...
  [`DO`](do.html "15.2.3 DO Statement") clause. The value is always
  `SQL`.

* `EVENT_DEFINITION`

  The text of the SQL statement making up the event's
  [`DO`](do.html "15.2.3 DO Statement") clause; in other words, the
...
* `EXECUTE_AT`
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value specified in the
  `AT` clause of the
  [`CREATE EVENT`](create-event.html "15.1.13 CREATE EVENT Statement") statement used to
  create the event, or of the last [`ALTER
  EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statement that modified the event. The value
...
* `STARTS`
  ...
  displayed as a [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value,
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. As with the
...
* `ENDS`
  ...
  corresponding [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value.
...
* `STATUS`
  ...
  see [Section 19.5.1.16, “Replication of Invoked Features”](replication-features-invoked.html "19.5.1.16 Replication of Invoked Features").
  information.
...
* `LAST_ALTERED`
  ...
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. If the event
...
* `LAST_EXECUTED`
  ...
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") value. If the event
...
* `ORIGINATOR`
  ...
  [`ALTER EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") to the server ID of
...
* [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") is a nonstandard
  `INFORMATION_SCHEMA` table.

* Times in the [`EVENTS`](information-schema-events-table.html "28.3.14 The INFORMATION_SCHEMA EVENTS Table") table are
...
EVENT`](alter-event.html "15.1.3 ALTER EVENT Statement") statement, as shown here:
...
[`SELECT`](select.html "15.2.13 SELECT Statement") statement, and obtain the
output shown:
...
[`SHOW EVENTS`](show-events.html "15.7.7.18 SHOW EVENTS Statement") statement. See
[Section 15.7.7.18, “SHOW EVENTS Statement”](show-events.html "15.7.7.18 SHOW EVENTS Statement"). The following statements are
equivalent:

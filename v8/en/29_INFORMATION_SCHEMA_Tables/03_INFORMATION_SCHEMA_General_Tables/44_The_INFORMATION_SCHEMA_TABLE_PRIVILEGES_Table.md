...
The [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "28.3.44 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") table provides
information about table privileges. It takes its values from the
`mysql.tables_priv` system table.

The [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "28.3.44 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") table has these
columns:
...
* [`TABLE_PRIVILEGES`](information-schema-table-privileges-table.html "28.3.44 The INFORMATION_SCHEMA TABLE_PRIVILEGES Table") is a nonstandard

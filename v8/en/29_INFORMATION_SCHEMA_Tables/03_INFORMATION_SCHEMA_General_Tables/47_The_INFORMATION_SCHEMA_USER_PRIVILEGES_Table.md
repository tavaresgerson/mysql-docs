...
The [`USER_PRIVILEGES`](information-schema-user-privileges-table.html "28.3.47 The INFORMATION_SCHEMA USER_PRIVILEGES Table") table provides
information about global privileges. It takes its values from the
`mysql.user` system table.

The [`USER_PRIVILEGES`](information-schema-user-privileges-table.html "28.3.47 The INFORMATION_SCHEMA USER_PRIVILEGES Table") table has these
columns:
...
* `PRIVILEGE_TYPE`
  ...
  be granted at the global level; see [Section 15.7.1.6, “GRANT Statement”](grant.html "15.7.1.6 GRANT Statement").
...
* [`USER_PRIVILEGES`](information-schema-user-privileges-table.html "28.3.47 The INFORMATION_SCHEMA USER_PRIVILEGES Table") is a nonstandard

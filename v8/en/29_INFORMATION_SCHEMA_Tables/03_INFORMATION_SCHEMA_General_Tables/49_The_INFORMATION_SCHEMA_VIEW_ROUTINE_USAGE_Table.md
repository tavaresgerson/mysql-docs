...
The [`VIEW_ROUTINE_USAGE`](information-schema-view-routine-usage-table.html "28.3.49 The INFORMATION_SCHEMA VIEW_ROUTINE_USAGE Table") table
...
The [`VIEW_ROUTINE_USAGE`](information-schema-view-routine-usage-table.html "28.3.49 The INFORMATION_SCHEMA VIEW_ROUTINE_USAGE Table") table has
these columns:

...
* `FILE_NAME`
  ...
  created by [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement")
  or [`ALTER LOGFILE GROUP`](alter-logfile-group.html "15.1.6 ALTER LOGFILE GROUP Statement"), or of a
  data file created by [`CREATE
  TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") or [`ALTER
  TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement"). In NDB 8.0, the file name is shown with
...
* `LOGFILE_GROUP_NUMBER`
  ...
  `id` column in the
  [`ndbinfo.dict_obj_info`](mysql-cluster-ndbinfo-dict-obj-info.html "25.6.16.24 The ndbinfo dict_obj_info Table") table
  and the `log_id` column in the
  [`ndbinfo.logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.16.43 The ndbinfo logspaces Table") and
  [`ndbinfo.logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.16.43 The ndbinfo logspaces Table") tables for
  this undo log file.
...
* `EXTENT_SIZE`
  ...
  [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") does not report
  ...
  the [`INNODB_TABLESPACES`](information-schema-innodb-tablespaces-table.html "28.4.24 The INFORMATION_SCHEMA INNODB_TABLESPACES Table") table
  where `FILES.FILE_ID =
...
* `INITIAL_SIZE`
  ...
  [`CREATE LOGFILE GROUP`](create-logfile-group.html "15.1.16 CREATE LOGFILE GROUP Statement"),
  ...
  [`ALTER TABLESPACE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") statement used
  to create the file.
...
* `EXTRA`
  ...
  *NULL*. A more detailed explanation is
  ...
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") stores a copy of each
  ...
  against the [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table:
...
* [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") is a nonstandard
...
* Information reported by `FILES` is obtained
  ...
  files, whereas [`INNODB_DATAFILES`](information-schema-innodb-datafiles-table.html "28.4.10 The INFORMATION_SCHEMA INNODB_DATAFILES Table")
...
* The `FILES` table provides information
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") table having data stored on
...
* Beginning with NDB 8.0.29 much of the information in the
  ...
  [`ndbinfo.files`](mysql-cluster-ndbinfo-files.html "25.6.16.35 The ndbinfo files Table") table.

* The `CREATION_TIME`,
  `LAST_UPDATE_TIME`, and
  `LAST_ACCESSED` values are as reported by
  the operating system, and are not supplied by the
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") storage engine. Where no
...
* The difference between the `TOTAL EXTENTS`
  ...
  TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement") statement. For more information, see
...
* Prior to NDB 8.0.13, an additional row was present in the
  [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table following the
  ...
  the [`ndbinfo.logspaces`](mysql-cluster-ndbinfo-logspaces.html "25.6.16.43 The ndbinfo logspaces Table")
  ...
  query the [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table:
...
* Prior to NDB 8.0.13, an additional row was present in the
  [`FILES`](information-schema-files-table.html "28.3.15 The INFORMATION_SCHEMA FILES Table") table for each NDB
  ...
  `ENGINE` column is always
  [`NDBCLUSTER`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0").

  In NDB 8.0.13 and later, you can obtain information about
  Disk Data tablespaces using the [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables")
  utility. For more information, see
  [Section 25.6.11.1, “NDB Cluster Disk Data Objects”](mysql-cluster-disk-data-objects.html "25.6.11.1 NDB Cluster Disk Data Objects"), as well
  as the description of [**ndb\_desc**](mysql-cluster-programs-ndb-desc.html "25.5.9 ndb_desc — Describe NDB Tables").

* For additional information, and examples of creating,
  dropping, and obtaining information about NDB Cluster Disk
  Data objects, see [Section 25.6.11, “NDB Cluster Disk Data Tables”](mysql-cluster-disk-data.html "25.6.11 NDB Cluster Disk Data Tables").
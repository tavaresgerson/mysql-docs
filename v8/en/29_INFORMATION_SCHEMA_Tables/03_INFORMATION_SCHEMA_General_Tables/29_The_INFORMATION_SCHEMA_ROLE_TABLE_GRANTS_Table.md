...
The [`ROLE_TABLE_GRANTS`](information-schema-role-table-grants-table.html "28.3.29 The INFORMATION_SCHEMA ROLE_TABLE_GRANTS Table") table
...
The [`ROLE_TABLE_GRANTS`](information-schema-role-table-grants-table.html "28.3.29 The INFORMATION_SCHEMA ROLE_TABLE_GRANTS Table") table has these
columns:

...
The [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table provides
...
The [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table has these
columns:
...
* `SUBPARTITION_NAME`
  ...
  If the [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table row
...
* `PARTITION_EXPRESSION`
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement that
  ...
  [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") table row for a
...
* `TABLE_ROWS`
  ...
  For [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables, you can also
...
* `INDEX_LENGTH`
  ...
  For partitions of [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables,
...
* [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table") is a nonstandard
  `INFORMATION_SCHEMA` table.

* A table using any storage engine other than
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") and which is not partitioned
  has one row in the [`PARTITIONS`](information-schema-partitions-table.html "28.3.21 The INFORMATION_SCHEMA PARTITIONS Table")

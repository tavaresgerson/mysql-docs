...
The [`INNODB_TABLESTATS`](information-schema-innodb-tablestats-table.html "28.4.26 The INFORMATION_SCHEMA INNODB_TABLESTATS View") table provides
...
[`UPDATE`](update.html "15.2.17 UPDATE Statement") operations that modify
indexed columns. Statistics are not updated by operations that
modify only nonindexed columns.

[`ANALYZE TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement") clears table
...
The [`INNODB_TABLESTATS`](information-schema-innodb-tablestats-table.html "28.4.26 The INFORMATION_SCHEMA INNODB_TABLESTATS View") table has these
columns:

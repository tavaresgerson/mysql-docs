...
The [`INNODB_FT_INDEX_TABLE`](information-schema-innodb-ft-index-table-table.html "28.4.19 The INFORMATION_SCHEMA INNODB_FT_INDEX_TABLE Table") table
...
of the [`innodb_ft_aux_table`](innodb-parameters.html#sysvar_innodb_ft_aux_table) system
...
The [`INNODB_FT_INDEX_TABLE`](information-schema-innodb-ft-index-table-table.html "28.4.19 The INFORMATION_SCHEMA INNODB_FT_INDEX_TABLE Table") table has
these columns:
...
* This table is empty initially. Before querying it, set the
  ...
  [`OPTIMIZE TABLE`](optimize-table.html "15.7.3.4 OPTIMIZE TABLE Statement") operation on the

...
* The host cache, which is accessible using the Performance Schema  `host_cache` table. See  Section 7.1.12.3, “DNS Lookups and the Host Cache”, and  Section 29.12.22.3, “The `host_cache` Table”.

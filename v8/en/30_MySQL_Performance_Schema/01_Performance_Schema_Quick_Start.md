...
Table structure is also available by selecting from tables such as `INFORMATION_SCHEMA.COLUMNS` or by using statements such as [`SHOW COLUMNS`](show-columns.html "15.7.7.5 SHOW COLUMNS Statement").

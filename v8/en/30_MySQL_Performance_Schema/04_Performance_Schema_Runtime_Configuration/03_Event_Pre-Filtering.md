...
* To configure pre-filtering at the producer stage, several
  ...
  + [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") indicates whether
...
[`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") to empty the
history tables.

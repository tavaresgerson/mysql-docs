...
<td><code class="literal">ON</code></td>
  ...
  [`SHOW VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") and
  [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") statements to be
...
<td><code class="literal">1048576</code></td>
  ...
  controls the size of the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
...
<td><code class="literal">1048576</code></td>
  ...
  + The alternative [`SHOW
    PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") implementation is based on the
    Performance Schema
    [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table. This

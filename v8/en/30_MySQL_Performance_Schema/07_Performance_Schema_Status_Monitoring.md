...
* The server was started with the
  [`--performance_schema_max_mutex_classes=200`](performance-schema-system-variables.html#sysvar_performance_schema_max_mutex_classes)
...
* To save a few bytes of memory, you start the server with
  [`--performance_schema_max_mutex_classes=N`](performance-schema-system-variables.html#sysvar_performance_schema_max_mutex_classes),
...
[`setup_instruments`](performance-schema-setup-instruments-table.html "29.12.2.3 The setup_instruments Table") table. This single
...
[`--performance_schema_max_mutex_instances=N`](performance-schema-system-variables.html#sysvar_performance_schema_max_mutex_instances).

The bottom line is that if
[`SHOW STATUS LIKE
'perf%'`](show-status.html "15.7.7.37 SHOW STATUS Statement") says that nothing was lost (all values are

...
[`performance_timers`](performance-schema-performance-timers-table.html "29.12.21.6 The performance_timers Table") table applies to
...
Schema [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table") table.
...
* `statement/sql`: An instrumented SQL
  ...
  for [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement") and

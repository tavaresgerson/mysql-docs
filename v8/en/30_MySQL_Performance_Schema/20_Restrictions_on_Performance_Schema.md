...
[**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program") and `BACKUP
...
[`performance_timers`](performance-schema-performance-timers-table.html "29.12.21.6 The performance_timers Table") table shows which

...
[29.12.16.1 The tp\_thread\_group\_state Table](performance-schema-tp-thread-group-state-table.html)

[29.12.16.2 The tp\_thread\_group\_stats Table](performance-schema-tp-thread-group-stats-table.html)

[29.12.16.3 The tp\_thread\_state Table](performance-schema-tp-thread-state-table.html)
...
* [`tp_thread_group_state`](performance-schema-tp-thread-group-state-table.html "29.12.16.1 The tp_thread_group_state Table"):
  Information about thread pool thread group states.

* [`tp_thread_group_stats`](performance-schema-tp-thread-group-stats-table.html "29.12.16.2 The tp_thread_group_stats Table"): Thread
  group statistics.

* [`tp_thread_state`](performance-schema-tp-thread-state-table.html "29.12.16.3 The tp_thread_state Table"): Information
  about thread pool thread states.

Rows in these tables represent snapshots in time. In the case of
[`tp_thread_state`](performance-schema-tp-thread-state-table.html "29.12.16.3 The tp_thread_state Table"), all rows for a
...
[`tp_thread_state`](performance-schema-tp-thread-state-table.html "29.12.16.3 The tp_thread_state Table") from blocking the
entire MySQL server.

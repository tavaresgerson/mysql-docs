...
[29.12.11.3 The replication\_applier\_status Table](performance-schema-replication-applier-status-table.html)

[29.12.11.4 The replication\_applier\_status\_by\_coordinator Table](performance-schema-replication-applier-status-by-coordinator-table.html)

[29.12.11.5 The replication\_applier\_status\_by\_worker Table](performance-schema-replication-applier-status-by-worker-table.html)

[29.12.11.6 The replication\_applier\_filters Table](performance-schema-replication-applier-filters-table.html)

[29.12.11.7 The replication\_applier\_global\_filters Table](performance-schema-replication-applier-global-filters-table.html)

[29.12.11.8 The replication\_asynchronous\_connection\_failover Table](performance-schema-replication-asynchronous-connection-failover-table.html)

[29.12.11.9 The replication\_asynchronous\_connection\_failover\_managed Table](performance-schema-replication-asynchronous-connection-failover-managed-table.html)

[29.12.11.10 The replication\_connection\_configuration Table](performance-schema-replication-connection-configuration-table.html)

[29.12.11.11 The replication\_connection\_status Table](performance-schema-replication-connection-status-table.html)

[29.12.11.12 The replication\_group\_communication\_information Table](performance-schema-replication-group-communication-information-table.html)

[29.12.11.13 The replication\_group\_configuration\_version Table](performance-schema-replication-group-configuration-version-table.html)

[29.12.11.14 The replication\_group\_member\_actions Table](performance-schema-replication-group-member-actions-table.html)

[29.12.11.15 The replication\_group\_member\_stats Table](performance-schema-replication-group-member-stats-table.html)

[29.12.11.16 The replication\_group\_members Table](performance-schema-replication-group-members-table.html)
...
the [`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") statement, but representation in table
form is more accessible and has usability benefits:

* [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") output is useful for visual
  ...
  [`SELECT`](select.html "15.2.13 SELECT Statement") queries, including
...
* The replication tables provide better diagnostic
  ...
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") reports all coordinator and worker
...
* Tables that contain information about the connection of the
  ...
  + [`replication_asynchronous_connection_failover`](performance-schema-replication-asynchronous-connection-failover-table.html "29.12.11.8 The replication_asynchronous_connection_failover Table"):
...
* Tables that contain information about specific threads
  ...
  + [`replication_applier_status_by_coordinator`](performance-schema-replication-applier-status-by-coordinator-table.html "29.12.11.4 The replication_applier_status_by_coordinator Table"):
...
* Tables that contain information about channel based
  ...
  + [`replication_applier_filters`](performance-schema-replication-applier-filters-table.html "29.12.11.6 The replication_applier_filters Table"):
    Provides information about the replication filters
    configured on specific replication channels.

  + [`replication_applier_global_filters`](performance-schema-replication-applier-global-filters-table.html "29.12.11.7 The replication_applier_global_filters Table"):
...
* Tables that contain information about Group Replication
  ...
  + [`replication_group_members`](performance-schema-replication-group-members-table.html "29.12.11.16 The replication_group_members Table"):
    Provides network and status information for group
    members.

  + [`replication_group_member_stats`](performance-schema-replication-group-member-stats-table.html "29.12.11.15 The replication_group_member_stats Table"):
...
produced by
[`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") and the replication table columns in
...
fields from
[`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") are not represented in the tables.
...
* Prior to execution of [`CHANGE
  ...
  [`CHANGE MASTER TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"), the tables
  are empty.
...
* After [`CHANGE REPLICATION SOURCE
  ...
  TO`](change-master-to.html "15.4.2.1 CHANGE MASTER TO Statement"), the configuration parameters can be seen in
...
* After [`START
  REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") (or before MySQL 8.0.22,
  [`START
  SLAVE`](start-slave.html "15.4.2.7 START SLAVE Statement")), non-`NULL`
...
* After [`STOP
  REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement"), the `THREAD_ID` columns
  become `NULL` and the
...
* The tables are preserved after
  [`STOP
  REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement") or threads stopping due to an error.
...
* The
  ...
  when [`START
  REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") is executed, and the number of rows shows
...
[`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") because the tables are oriented toward
...
[`SHOW
REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") columns are not preserved in the
...
* The following fields are based on
  [`server_id`](replication-options.html#sysvar_server_id), not
  [`server_uuid`](replication-options.html#sysvar_server_uuid), and are not
  preserved:
...
* The `Replica_IO_State` and
  ...
  `INFORMATION_SCHEMA`
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table") table to select the
...
replication channel. See [Section 19.2.2, “Replication Channels”](replication-channels.html "19.2.2 Replication Channels")
and [Section 19.1.5.8, “Monitoring Multi-Source Replication”](replication-multi-source-monitoring.html "19.1.5.8 Monitoring Multi-Source Replication") for
more information.
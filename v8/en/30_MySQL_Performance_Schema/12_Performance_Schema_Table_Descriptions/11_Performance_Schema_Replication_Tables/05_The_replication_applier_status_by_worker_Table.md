...
[`START
REPLICA`](start-replica.html "15.4.2.6 START REPLICA Statement") statement, the columns beginning
...
* `WORKER_ID`
  ...
  [`STOP
  REPLICA`](stop-replica.html "15.4.2.8 STOP REPLICA Statement"), the `THREAD_ID` column
...
* `LAST_ERROR_NUMBER`,
  ...
  [`RESET
  REPLICA`](reset-replica.html "15.4.2.4 RESET REPLICA Statement") resets the values shown in these
  columns.
...
<table summary="Correspondence between replication_applier_status_by_worker columns and SHOW REPLICA STATUS columns"><col style="width: 60%"/><col style="width: 40%"/><thead><tr>

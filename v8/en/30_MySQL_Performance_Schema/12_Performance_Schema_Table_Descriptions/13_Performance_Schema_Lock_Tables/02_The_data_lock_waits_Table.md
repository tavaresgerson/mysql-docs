...
The [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table
implements a many-to-many relationship showing which data lock
requests in the [`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table") table
are blocked by which held data locks in the
[`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table") table. Held locks in
[`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table") appear in
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") only if they
...
Use the [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table to
...
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table are similar
to those in the [`data_locks`](performance-schema-data-locks-table.html "29.12.13.1 The data_locks Table") table,
...
The [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table has
these columns:
...
for the [`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table.

Note

Prior to MySQL 8.0.1, information similar to that in the
Performance Schema
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table is
available in the
...
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") should be used
instead.

The tables differ in the privileges required: The
`INNODB_LOCK_WAITS` table requires the global
[`PROCESS`](privileges-provided.html#priv_process) privilege. The
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") table requires
...
[`data_lock_waits`](performance-schema-data-lock-waits-table.html "29.12.13.2 The data_lock_waits Table") columns. Use this
...
<table summary="Mapping from INNODB_LOCK_WAITS to data_lock_waits columns."><col style="width: 50%"/><col style="width: 50%"/><thead><tr>

...
[`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") database objects which cannot
...
* `REASON`: The reason for exclusion
  ...
  change in future [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0")
  releases.

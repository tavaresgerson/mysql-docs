...
size of the [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table. For
...
Because the [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table
...
The [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table has these
columns:
...
* `COUNT_HOST_ACL_ERRORS`
  ...
  the server returns
  [`ER_HOST_NOT_PRIVILEGED`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_host_not_privileged) and
...
* `COUNT_UNKNOWN_ERRORS`
  ...
  of the [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table is
  required.
...
the [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table. It requires

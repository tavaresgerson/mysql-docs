...
The [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table contains a row
...
[`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table based on the
...
Removal of rows from the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
...
row in the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table that has
...
`INSTRUMENTED` and `HISTORY`
columns of [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table rows.
...
For a comparison of the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
...
[`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table, information
...
[`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table; all rows are
...
users by accessing the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
table should not be given the
[`SELECT`](privileges-provided.html#priv_select) privilege for it.

The [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table has these
columns:
...
* `PROCESSLIST_ID`
  ...
  [`PROCESSLIST`](information-schema-processlist-table.html "28.3.23 The INFORMATION_SCHEMA PROCESSLIST Table") table, displayed
  in the `Id` column of
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") output,
  and returned by the
...
* `INSTRUMENTED`
  ...
  + For foreground threads, the initial
    ...
    again for the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table")
...
for the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table.
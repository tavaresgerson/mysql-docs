...
server. The [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table is
...
The [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table can be
...
[`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table also serves
...
The [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table contains a
...
The [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table has these
columns:
...
* `ID`
  ...
  [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table, and returned
...
* `USER`
  ...
  [Section 27.4, “Using the Event Scheduler”](event-scheduler.html "27.4 Using the Event Scheduler")).
...
for the [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table.

As mentioned previously, if the
[`performance_schema_show_processlist`](performance-schema-system-variables.html#sysvar_performance_schema_show_processlist)
system variable is enabled, the
[`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table serves as the
...
* The [**mysqladmin processlist**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command
  (which uses [`SHOW
  PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement") statement).

The default [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")
...
alternative [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")
...
[`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table contents as
follows:
...
* Minimum required configuration:
  ...
  satisfied, the [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table")
  table (and thus [`SHOW
...
* Recommended configuration:
  ...
  [`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") table (and thus
  [`SHOW PROCESSLIST`](show-processlist.html "15.7.7.29 SHOW PROCESSLIST Statement")) produce
...
[`processlist`](performance-schema-processlist-table.html "29.12.21.7 The processlist Table") contents are
unaffected by the
[`performance_schema_show_processlist`](performance-schema-system-variables.html#sysvar_performance_schema_show_processlist)
setting.

...
[Section 7.6.7, “The Clone Plugin”](clone-plugin.html "7.6.7 The Clone Plugin")). The tables provide information
...
and unloaded (see [Section 7.6.7.1, “Installing the Clone Plugin”](clone-plugin-installation.html "7.6.7.1 Installing the Clone Plugin")).

...
<td><a class="ulink" href="/doc/c-api/8.0/en/mysql-stmt-prepare.html" target="_top"><code class="literal">mysql_stmt_prepare()</code></a></td>
<td><code class="literal">COM_STMT_PREPARE</code></td>
</tr><tr>
<td><a class="ulink" href="/doc/c-api/8.0/en/mysql-stmt-execute.html" target="_top"><code class="literal">mysql_stmt_execute()</code></a></td>
<td><code class="literal">COM_STMT_EXECUTE</code></td>
</tr><tr>
<td><a class="ulink" href="/doc/c-api/8.0/en/mysql-stmt-close.html" target="_top"><code class="literal">mysql_stmt_close()</code></a></td>
...
[`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") resets the

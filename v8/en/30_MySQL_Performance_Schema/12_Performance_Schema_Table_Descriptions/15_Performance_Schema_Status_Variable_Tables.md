...
in the [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table. Statistics
...
TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") for status variable tables as follows:

...
The [`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table") table lists
...
[`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table"). When a file is
deleted from the disk, it is also removed from the
[`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table") table.

The [`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table") table has
these columns:
...
for the [`file_instances`](performance-schema-file-instances-table.html "29.12.3.2 The file_instances Table") table.
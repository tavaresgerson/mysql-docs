...
PROFILES`](show-profiles.html "15.7.7.31 SHOW PROFILES Statement") and [`SHOW
PROFILE`](show-profile.html "15.7.7.30 SHOW PROFILE Statement") statements.
...
5. Identify the `EVENT_ID` of the statement by
   ...
   [`SHOW PROFILES`](show-profiles.html "15.7.7.31 SHOW PROFILES Statement") to identify the

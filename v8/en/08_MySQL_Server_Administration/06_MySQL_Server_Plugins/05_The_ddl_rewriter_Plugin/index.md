...
plugin that modifies [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")
...
* `ddl_rewriter` considers only
  ...
  consider [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")

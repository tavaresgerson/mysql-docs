...
* The Information Schema [`PLUGINS`](information-schema-plugins-table.html "28.3.22 The INFORMATION_SCHEMA PLUGINS Table")
...
* The [`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") statement
...
* The `mysql.plugin` table shows which plugins
  ...
  as the [`PLUGINS`](information-schema-plugins-table.html "28.3.22 The INFORMATION_SCHEMA PLUGINS Table") table or the

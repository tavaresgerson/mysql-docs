...
[Section 7.6.4.2, “Using the Rewriter Query Rewrite Plugin”](rewriter-query-rewrite-plugin-usage.html "7.6.4.2 Using the Rewriter Query Rewrite Plugin"). For
reference information, see
[Section 7.6.4.3, “Rewriter Query Rewrite Plugin Reference”](rewriter-query-rewrite-plugin-reference.html "7.6.4.3 Rewriter Query Rewrite Plugin Reference").
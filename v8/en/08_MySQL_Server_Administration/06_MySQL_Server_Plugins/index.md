...
[7.6.6 Version Tokens](version-tokens.html)

[7.6.7 The Clone Plugin](clone-plugin.html)

[7.6.8 The Keyring Proxy Bridge Plugin](daemon-keyring-proxy-plugin.html)

[7.6.9 MySQL Plugin Services](plugin-services.html)
...
* A connection control plugin that enables administrators to
  ...
  [Section 8.4.2, “Connection Control Plugins”](connection-control-plugin.html "8.4.2 Connection Control Plugins").
...
* MySQL Enterprise Edition includes an audit plugin for monitoring and logging of
  connection and query activity. See [Section 8.4.5, “MySQL Enterprise Audit”](audit-log.html "8.4.5 MySQL Enterprise Audit").
...
* Version Tokens enables creation of and synchronization around
  ...
  functions. See [Section 7.6.6, “Version Tokens”](version-tokens.html "7.6.6 Version Tokens").
...
* Keyring plugins provide secure storage for sensitive
  ...
  See [Section 7.6.8, “The Keyring Proxy Bridge Plugin”](daemon-keyring-proxy-plugin.html "7.6.8 The Keyring Proxy Bridge Plugin").
...
* Clone permits cloning `InnoDB` data from a
  ...
  [Section 7.6.7, “The Clone Plugin”](clone-plugin.html "7.6.7 The Clone Plugin").
...
plugins, see [The MySQL Plugin API](/doc/extending-mysql/8.0/en/plugin-api.html).
...
The [`VERSION_TOKEN_ADMIN`](privileges-provided.html#priv_version-token-admin)
...
[Section 7.6.6.3, “Using Version Tokens”](version-tokens-usage.html "7.6.6.3 Using Version Tokens"), which provides details
...
* Version Tokens locking functions are based on the locking
  service described at [Section 7.6.9.1, “The Locking Service”](locking-service.html "7.6.9.1 The Locking Service").
...
installed (see [Section 7.6.6.2, “Installing or Uninstalling Version Tokens”](version-tokens-installation.html "7.6.6.2 Installing or Uninstalling Version Tokens")).
...
<td><code class="literal">NULL</code></td>
  ...
  + A token name in the
    ...
    case, an
    [`ER_VTOKEN_PLUGIN_TOKEN_NOT_FOUND`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_vtoken_plugin_token_not_found)
    error occurs.
  ...
  + A token value in the
    ...
    [`ER_VTOKEN_PLUGIN_TOKEN_MISMATCH`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_vtoken_plugin_token_mismatch)
    error occurs.
  ...
  The first [`SELECT`](select.html "15.2.13 SELECT Statement") succeeds
  ...
  The second [`SELECT`](select.html "15.2.13 SELECT Statement") fails

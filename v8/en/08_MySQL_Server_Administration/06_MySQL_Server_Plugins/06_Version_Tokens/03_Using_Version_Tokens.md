...
[`VERSION_TOKEN_ADMIN`](privileges-provided.html#priv_version-token-admin) privilege (or
...
[`version_tokens_set()`](version-tokens-reference.html#function_version-tokens-set) function.
...
[`version_tokens_session`](version-tokens-reference.html#sysvar_version_tokens_session) system
variable:
...
this, it uses
[`version_tokens_edit()`](version-tokens-reference.html#function_version-tokens-edit) to modify
...
[`version_tokens_edit()`](version-tokens-reference.html#function_version-tokens-edit) modifies
...
* [`version_tokens_edit()`](version-tokens-reference.html#function_version-tokens-edit) enables
...
[`version_tokens_set()`](version-tokens-reference.html#function_version-tokens-set) call results
...
[`version_tokens_set()`](version-tokens-reference.html#function_version-tokens-set) return the
...
service described at [Section 7.6.9.1, “The Locking Service”](locking-service.html "7.6.9.1 The Locking Service"), and
...
see [Locking Service Monitoring](locking-service.html#locking-service-monitoring "Locking Service Monitoring").

...
To use [`CLONE`](clone.html "15.7.5 CLONE Statement") syntax, the clone
...
LOCAL DATA DIRECTORY`](clone.html "15.7.5 CLONE Statement") statements.
...
user with the [`BACKUP_ADMIN`](privileges-provided.html#priv_backup-admin)
privilege on \*.\*.
...
progress, see [Section 7.6.7.10, “Monitoring Cloning Operations”](clone-plugin-monitoring.html "7.6.7.10 Monitoring Cloning Operations").
...
TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"), are not permitted during a cloning operation.
...
The [`clone_ddl_timeout`](clone-plugin-options-variables.html#sysvar_clone_ddl_timeout) variable
...
the [`clone_block_ddl`](clone-plugin-options-variables.html#sysvar_clone_block_ddl) variable.
Concurrent DDL support can be enabled and disabled dynamically
using a [`SET`](set.html "13.3.6 The SET Type") statement.
...
[`clone_block_ddl=OFF`](clone-plugin-options-variables.html#sysvar_clone_block_ddl), which
...
regardless of the
[`clone_block_ddl`](clone-plugin-options-variables.html#sysvar_clone_block_ddl) setting
include:

...
* [Monitoring Cloning Operations Using Performance Schema Stage Events](clone-plugin-monitoring.html#clone-plugin-monitoring-stage-events "Monitoring Cloning Operations Using Performance Schema Stage Events")
* [Monitoring Cloning Operations Using Performance Schema Clone
  Instrumentation](clone-plugin-monitoring.html#clone-plugin-performance-schema-instruments "Monitoring Cloning Operations Using Performance Schema Clone Instrumentation")

* [The Com\_clone Status Variable](clone-plugin-monitoring.html#clone-plugin-com-clone "The Com_clone Status Variable")
...
[`clone_status`](performance-schema-clone-status-table.html "29.12.19.1 The clone_status Table") and
[`clone_progress`](performance-schema-clone-progress-table.html "29.12.19.2 The clone_progress Table") Performance Schema
tables.

Note

The [`clone_status`](performance-schema-clone-status-table.html "29.12.19.1 The clone_status Table") and
[`clone_progress`](performance-schema-clone-progress-table.html "29.12.19.2 The clone_progress Table") Performance
...
* The [`clone_status`](performance-schema-clone-status-table.html "29.12.19.1 The clone_status Table") table
...
* The [`clone_progress`](performance-schema-clone-progress-table.html "29.12.19.2 The clone_progress Table") table
...
The [`SELECT`](privileges-provided.html#priv_select) and
[`EXECUTE`](privileges-provided.html#priv_execute) privileges on the
...
2. Query the [`clone_status`](performance-schema-clone-status-table.html "29.12.19.1 The clone_status Table") table:
...
query the [`clone_status`](performance-schema-clone-status-table.html "29.12.19.1 The clone_status Table") table for
error information:
...
1. Connect to the recipient MySQL server instance.
2. Query the [`clone_progress`](performance-schema-clone-progress-table.html "29.12.19.2 The clone_progress Table")
   ...
   [Section 29.12.19, “Performance Schema Clone Tables”](performance-schema-clone-tables.html "29.12.19 Performance Schema Clone Tables").
...
4. Check the progress of the cloning operation by querying
   ...
   The [`events_stages_current`](performance-schema-events-stages-current-table.html "29.12.5.1 The events_stages_current Table")
...
[Section 29.12.4, “Performance Schema Wait Event Tables”](performance-schema-wait-tables.html "29.12.4 Performance Schema Wait Event Tables").
...
stage events, see
[Monitoring Cloning Operations Using Performance Schema Stage Events](clone-plugin-monitoring.html#clone-plugin-monitoring-stage-events "Monitoring Cloning Operations Using Performance Schema Stage Events"). For
...
[`clone_max_concurrency`](clone-plugin-options-variables.html#sysvar_clone_max_concurrency) and
...
* `statement/clone/local`: Tracks clone
  ...
  when executing a
  [`CLONE
  LOCAL`](clone.html "15.7.5 CLONE Statement") statement.
...
* `statement/clone/client`: Tracks remote
  ...
  [`CLONE
  INSTANCE`](clone.html "15.7.5 CLONE Statement") statement on the recipient.
...
[`CLONE`](clone.html "15.7.5 CLONE Statement") statement executions.

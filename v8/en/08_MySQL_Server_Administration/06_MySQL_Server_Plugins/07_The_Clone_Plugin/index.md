...
[7.6.7.1 Installing the Clone Plugin](clone-plugin-installation.html)

[7.6.7.2 Cloning Data Locally](clone-plugin-local.html)

[7.6.7.3 Cloning Remote Data](clone-plugin-remote.html)

[7.6.7.4 Cloning and Concurrent DDL](clone-plugin-concurrent-ddl.html)

[7.6.7.5 Cloning Encrypted Data](clone-plugin-encrypted-data.html)

[7.6.7.6 Cloning Compressed Data](clone-plugin-compressed-data.html)

[7.6.7.7 Cloning for Replication](clone-plugin-replication.html)

[7.6.7.8 Directories and Files Created During a Cloning Operation](clone-plugin-directories.html)

[7.6.7.9 Remote Cloning Operation Failure Handling](clone-plugin-failure-handling.html)

[7.6.7.10 Monitoring Cloning Operations](clone-plugin-monitoring.html)

[7.6.7.11 Stopping a Cloning Operation](clone-plugin-stop.html)

[7.6.7.12 Clone System Variable Reference](clone-plugin-option-variable-reference.html)

[7.6.7.13 Clone System Variables](clone-plugin-options-variables.html)

[7.6.7.14 Clone Plugin Limitations](clone-plugin-limitations.html)
...
[Section 7.6.7.7, “Cloning for Replication”](clone-plugin-replication.html "7.6.7.7 Cloning for Replication")). Group Replication
...
data. See [Section 7.6.7.5, “Cloning Encrypted Data”](clone-plugin-encrypted-data.html "7.6.7.5 Cloning Encrypted Data"), and
[Section 7.6.7.6, “Cloning Compressed Data”](clone-plugin-compressed-data.html "7.6.7.6 Cloning Compressed Data").

The clone plugin must be installed before you can use it. For
installation instructions, see
[Section 7.6.7.1, “Installing the Clone Plugin”](clone-plugin-installation.html "7.6.7.1 Installing the Clone Plugin"). For cloning
instructions, see [Section 7.6.7.2, “Cloning Data Locally”](clone-plugin-local.html "7.6.7.2 Cloning Data Locally"), and

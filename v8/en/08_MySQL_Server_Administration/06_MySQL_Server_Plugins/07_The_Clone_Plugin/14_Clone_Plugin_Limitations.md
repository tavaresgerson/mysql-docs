...
* Prior to MySQL 8.0.27, DDL on the donor and recipient,
  including [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"), is
  ...
  controlled by the
  [`clone_block_ddl`](clone-plugin-options-variables.html#sysvar_clone_block_ddl) variable.
  See [Section 7.6.7.4, “Cloning and Concurrent DDL”](clone-plugin-concurrent-ddl.html "7.6.7.4 Cloning and Concurrent DDL").
...
* The clone plugin does not support cloning of MySQL server
  ...
  settings (see [Section 7.1.9.3, “Persisted System Variables”](persisted-system-variables.html "7.1.9.3 Persisted System Variables").)
...
* The clone plugin only clones data stored in
  ...
  cloned. [`MyISAM`](myisam-storage-engine.html "18.2 The MyISAM Storage Engine") and
  [`CSV`](csv-storage-engine.html "18.4 The CSV Storage Engine") tables stored in any schema

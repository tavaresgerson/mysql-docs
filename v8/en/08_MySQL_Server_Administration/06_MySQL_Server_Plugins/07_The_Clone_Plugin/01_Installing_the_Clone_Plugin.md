...
[`plugin_dir`](server-system-variables.html#sysvar_plugin_dir) at server startup to
...
[`INSTALL PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") or is loaded with

...
* Plugins that are active on the donor, including any
  ...
  [`SHOW PLUGINS`](show-plugins.html "15.7.7.25 SHOW PLUGINS Statement") statement or
...
* The same [`innodb_page_size`](innodb-parameters.html#sysvar_innodb_page_size)
  ...
  VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") syntax.
...
* If cloning encrypted or page-compressed data, the donor
  ...
  use them, see
  [Section 7.6.7.5, “Cloning Encrypted Data”](clone-plugin-encrypted-data.html "7.6.7.5 Cloning Encrypted Data"), and
  [Section 7.6.7.6, “Cloning Compressed Data”](clone-plugin-compressed-data.html "7.6.7.6 Cloning Compressed Data"). To

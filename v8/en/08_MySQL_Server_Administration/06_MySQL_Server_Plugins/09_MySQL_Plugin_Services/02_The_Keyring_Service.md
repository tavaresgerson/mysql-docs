...
functions, [Section 8.4.4.15, “General-Purpose Keyring Key-Management Functions”](keyring-functions-general-purpose.html "8.4.4.15 General-Purpose Keyring Key-Management Functions").
For general keyring information, see [Section 8.4.4, “The MySQL Keyring”](keyring.html "8.4.4 The MySQL Keyring").
...
* `my_key_generate()`
  ...
  keyring plugin. See [Section 8.4.4.13, “Supported Keyring Key Types and Lengths”](keyring-key-types.html "8.4.4.13 Supported Keyring Key Types and Lengths").

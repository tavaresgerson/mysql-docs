...
[`--thread-pool-size`](server-system-variables.html#sysvar_thread_pool_size) option; this
...
[`Max_used_connections`](server-status-variables.html#statvar_Max_used_connections) status
...
that you set
[`thread_pool_algorithm`](server-system-variables.html#sysvar_thread_pool_algorithm) to 1 for
high concurrency.
...
[`tp_thread_group_stats`](performance-schema-tp-thread-group-stats-table.html "29.12.16.2 The tp_thread_group_stats Table") table is

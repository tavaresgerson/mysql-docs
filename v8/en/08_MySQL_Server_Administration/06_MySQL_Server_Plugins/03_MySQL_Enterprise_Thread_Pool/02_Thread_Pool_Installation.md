...
* [Thread Pool Installation as of MySQL 8.0.14](thread-pool-installation.html#thread-pool-installation-ps-tables "Thread Pool Installation as of MySQL 8.0.14")
* [Thread Pool Installation Prior to MySQL 8.0.14](thread-pool-installation.html#thread-pool-installation-is-tables "Thread Pool Installation Prior to MySQL 8.0.14")
...
[`TABLES`](information-schema-tables-table.html "28.3.38 The INFORMATION_SCHEMA TABLES Table") table or use the
[`SHOW TABLES`](show-tables.html "15.7.7.39 SHOW TABLES Statement") statement. For
example:
...
[`--plugin-load-add`](server-options.html#option_mysqld_plugin-load-add) option. For
...
[`TP_THREAD_STATE`](information-schema-tp-thread-state-table.html "28.5.4 The INFORMATION_SCHEMA TP_THREAD_STATE Table")

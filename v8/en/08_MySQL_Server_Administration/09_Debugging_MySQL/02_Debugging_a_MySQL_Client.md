...
[`-DWITH_DEBUG=1`](source-configuration-options.html#option_cmake_with_debug). See
...
known to work. Do this by running [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") in
...
See [Section 1.5, “How to Report Bugs or Problems”](bug-reports.html "1.5 How to Report Bugs or Problems").

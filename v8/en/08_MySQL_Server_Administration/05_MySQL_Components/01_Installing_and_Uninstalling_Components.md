...
described in [Section 7.5.2, “Obtaining Component Information”](obtaining-component-information.html "7.5.2 Obtaining Component Information").

The [`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") and
[`UNINSTALL COMPONENT`](uninstall-component.html "15.7.4.5 UNINSTALL COMPONENT Statement") SQL statements
...
* [`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") loads
  ...
  [`--skip-grant-tables`](server-options.html#option_mysqld_skip-grant-tables) option. The
  optional `SET` clause permits setting
  component system-variable values when you install components.

* [`UNINSTALL COMPONENT`](uninstall-component.html "15.7.4.5 UNINSTALL COMPONENT Statement") deactivates
...
PLUGIN`](install-plugin.html "15.7.4.4 INSTALL PLUGIN Statement") statement for server plugins, the
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") statement for
...
[`INSTALL COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement") statement can be

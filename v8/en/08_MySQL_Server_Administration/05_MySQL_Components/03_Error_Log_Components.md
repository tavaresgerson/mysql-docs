...
* A sink is a destination (writer) for log events. Typically, a
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table; see
  [Section 29.12.21.2, “The error\_log Table”](performance-schema-error-log-table.html "29.12.21.2 The error_log Table"). Events
...
* For a sink component, whether it supports an interface to the
  Performance Schema [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table")
  table.
...
* Performance Schema support: Writes to the
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table. Provides a
...
* Performance Schema support: Does not write to the
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table. Does not

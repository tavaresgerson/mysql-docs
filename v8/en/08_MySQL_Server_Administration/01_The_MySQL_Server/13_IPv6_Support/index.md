...
* From MySQL 8.0.14, Group Replication group members can use
  ...
  IPv4. See [Section 20.5.5, “Support For IPv6 And For Mixed IPv6 And IPv4 Groups”](group-replication-ipv6.html "20.5.5 Support For IPv6 And For Mixed IPv6 And IPv4 Groups").

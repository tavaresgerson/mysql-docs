...
* To see the current values used by a running server, use the
  [`SHOW VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement") statement or the
...
<td>String</td>
  ...
  + Support for the TLSv1 and TLSv1.1 connection protocols
    ...
    [Removal of Support for the TLSv1 and TLSv1.1 Protocols](encrypted-connection-protocols-ciphers.html#encrypted-connection-deprecated-protocols "Removal of Support for the TLSv1 and TLSv1.1 Protocols")
...
<td>String</td>
  ...
  + [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy), in
    conjunction with
  ...
  *`N`* in the list has implications for
  ...
  + If element *`N`* is an
    ...
    [The Default Authentication Plugin](pluggable-authentication.html#pluggable-authentication-default-plugin "The Default Authentication Plugin").
  ...
  + If element *`N`* is missing from
    ...
    *`N`* is forbidden. For example, a
    ...
    [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") or changes to
    existing accounts made with [`ALTER
    USER`](alter-user.html "15.7.1.1 ALTER USER Statement"). In this case, such statements cannot
    specify authentication for factors 2 or 3.

  When an [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy)
  ...
  When [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy)
  element *`N`* is `*`,
  ...
  *`N`* in account definitions are
  ...
  [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy) values
...
<td>String</td>
  ...
  [`--ssl`](server-options.html#option_mysqld_ssl) are specified, and the
...
<td><code class="literal">65535</code></td>
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") implicitly upgrades temporal columns found to
  be in pre-5.6.4 format ([`TIME`](time.html "13.2.3 The TIME Type"),
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"), and
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns without
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") not to rebuild
...
<td><code class="literal">65535</code></td>
  ...
  [`max_connections`](server-system-variables.html#sysvar_max_connections), which
...
<td><code class="literal">65535</code></td>
  ...
  + Prior to MySQL 8.0.13,
    [`bind_address`](server-system-variables.html#sysvar_bind_address) accepts a
  ...
  + As of MySQL 8.0.13,
    [`bind_address`](server-system-variables.html#sysvar_bind_address) accepts
...
<td><code class="literal">NULL</code></td>
  ...
  + [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") was started with the
...
<td><code class="literal">NULL</code></td>
  ...
  [`ER_CONN_LIMIT`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_conn_limit), including any
...
<td><code class="literal">NULL</code></td>
  ...
  + `mysql_native_password`: Use MySQL native
    passwords; see
    [Section 8.4.1.1, “Native Pluggable Authentication”](native-pluggable-authentication.html "8.4.1.1 Native Pluggable Authentication").

  + `sha256_password`: Use SHA-256 passwords;
    see [Section 8.4.1.3, “SHA-256 Pluggable Authentication”](sha256-pluggable-authentication.html "8.4.1.3 SHA-256 Pluggable Authentication").
  ...
  see [caching\_sha2\_password as the Preferred Authentication Plugin](upgrading-from-previous-series.html#upgrade-caching-sha2-password "caching_sha2_password as the Preferred Authentication Plugin").
  ...
  + It determines which authentication plugin the server
    ...
    [`CREATE USER`](create-user.html "15.7.1.3 CREATE USER Statement") statements that
  ...
  precedence than the
  [`authentication_policy`](server-system-variables.html#sysvar_authentication_policy) system
...
<td><code class="literal">NULL</code></td>
  ...
  + [`SHOW COLLATION`](show-collation.html "15.7.7.4 SHOW COLLATION Statement") and
  ...
  + [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") and
    [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") having a
    `CHARACTER SET utf8mb4` clause without a
    `COLLATION` clause, either for the table
    character set or for a column character set.

  + [`CREATE DATABASE`](create-database.html "15.1.12 CREATE DATABASE Statement") and
...
<td><code class="literal">NULL</code></td>
  ...
  the [`SHOW ENGINES`](show-engines.html "15.7.7.16 SHOW ENGINES Statement") statement or
...
<td><code class="literal">NULL</code></td>
  ...
  tables (created with
  [`CREATE TEMPORARY
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement")). To set the storage engine for permanent
  tables, set the
...
<td><code class="literal">NULL</code></td>
  ...
  TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") statements.
...
<td><code class="literal">NULL</code></td>
  ...
  [`CREATE TABLESPACE`](create-tablespace.html "15.1.21 CREATE TABLESPACE Statement"), and cannot
  be used with
  [`ALTER TABLE ...
  ENGINE`](alter-table.html "15.1.9 ALTER TABLE Statement") or
  [`ALTER
  TABLESPACE ... ENGINE`](alter-tablespace.html "15.1.10 ALTER TABLESPACE Statement") to change the storage engine
  of existing tables or tablespaces. Attempts to do so result in
  an [`ER_DISABLED_STORAGE_ENGINE`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_disabled_storage_engine)
  error.
  ...
  [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"),
  [`ANALYZE TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement"),
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement"), or
  [`DROP TABLESPACE`](drop-tablespace.html "15.1.33 DROP TABLESPACE Statement"). This permits a
  ...
  means such as
  [`ALTER TABLE ...
  ENGINE permitted_engine`](alter-table.html "15.1.9 ALTER TABLE Statement").
  ...
  Setting
  [`disabled_storage_engines`](server-system-variables.html#sysvar_disabled_storage_engines)
  might cause an issue with [**mysql\_upgrade**](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables").
  For details, see [Section 6.4.5, “mysql\_upgrade — Check and Upgrade MySQL Tables”](mysql-upgrade.html "6.4.5 mysql_upgrade — Check and Upgrade MySQL Tables").
...
<td><code class="literal">NULL</code></td>
  ...
  *************************** 1. row ***************************
  ...
  WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") indicates the “decompiled”
  ...
  [Section 7.4.2.4, “Types of Error Log Filtering”](error-log-filtering.html "7.4.2.4 Types of Error Log Filtering"), and
...
<td><code class="literal">NULL</code></td>
  ...
  detail in [Section 27.4.2, “Event Scheduler Configuration”](events-configuration.html "27.4.2 Event Scheduler Configuration")
...
<td><code class="literal">NULL</code></td>
  ...
  Likewise, an [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement")
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables as it does for
  ...
  [`DROP
  SCHEMA`](drop-database.html "15.1.24 DROP DATABASE Statement") drops a schema even if it contains tables
  that have foreign keys that are referred to by tables outside
  the schema, and [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement")
...
<td><code class="literal">NULL</code></td>
  ...
  are rejected with
  [`ER_GLOBAL_CONN_LIMIT`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_global_conn_limit).
...
* [`have_openssl`](server-system-variables.html#sysvar_have_openssl)
  ...
  As of MySQL 8.0.26,
  [`have_openssl`](server-system-variables.html#sysvar_have_openssl) is deprecated
  and subject to removal in a future MySQL version. For
  information about TLS properties of MySQL connection
  interfaces, use the
  [`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.21.9 The tls_channel_status Table") table.
...
<td><code class="literal">NULL</code></td>
  ...
  As of MySQL 8.0.26, [`have_ssl`](server-system-variables.html#sysvar_have_ssl)
...
<td><code class="literal">NULL</code></td>
  ...
  the Performance Schema [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table")
  ...
  + Changing the size at runtime causes an implicit host cache
    ...
    the [`host_cache`](performance-schema-host-cache-table.html "29.12.21.3 The host_cache Table") table, and
  ...
  Using the [`--skip-host-cache`](server-options.html#option_mysqld_skip-host-cache)
  ...
  [`--skip-host-cache`](server-options.html#option_mysqld_skip-host-cache) does not
  ...
  rather than the
  [`--skip-host-cache`](server-options.html#option_mysqld_skip-host-cache) option is
...
<td>String</td>
  ...
  such as [`sql_mode`](server-system-variables.html#sysvar_sql_mode),
  [`character_set_server`](server-system-variables.html#sysvar_character_set_server),
  [`collation_server`](server-system-variables.html#sysvar_collation_server),
  [`completion_type`](server-system-variables.html#sysvar_completion_type),
  [`explicit_defaults_for_timestamp`](server-system-variables.html#sysvar_explicit_defaults_for_timestamp),
...
* [`insert_id`](server-system-variables.html#sysvar_insert_id)
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") statement when
...
<td>String</td>
  ...
  [`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html). See also
...
<td>String</td>
  ...
  [`SHOW STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") statement and
  examining the
...
<td>String</td>
  ...
  [`ER_LOCK_WAIT_TIMEOUT`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_lock_wait_timeout) is
  reported.
...
<td>String</td>
  ...
  in the [`log_error_services`](server-system-variables.html#sysvar_log_error_services) is
  implicitly loaded if it is not already loaded. Before MySQL
  8.0.30, any loadable (not built in) component named in the
  [`log_error_services`](server-system-variables.html#sysvar_log_error_services) value must
  first be installed with [`INSTALL
  COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement"). For more information, see
...
<td>String</td>
  ...
  [MySQL 8.0 Error Message Reference](/doc/mysql-errors/8.0/en/).
...
<td>String</td>
  ...
  include [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"),
  [`ANALYZE TABLE`](analyze-table.html "15.7.3.1 ANALYZE TABLE Statement"),
...
<td>String</td>
  ...
  [Section 7.4.2.8, “Error Logging to the System Log”](error-log-syslog.html "7.4.2.8 Error Logging to the System Log")), so this type of logging
  can be enabled by adding that component to the
  [`log_error_services`](server-system-variables.html#sysvar_log_error_services) system
  variable. [`log_syslog`](server-system-variables.html#sysvar_log_syslog) is
  removed. (Prior to MySQL 8.0.13,
  [`log_syslog`](server-system-variables.html#sysvar_log_syslog) exists but is
...
<td>String</td>
  ...
  to exclude most or all of [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")’s
  queries from the slow query log, you can set
  [**mysqldump**](mysqldump.html "6.5.4 mysqldump — A Database Backup Program")’s
...
<td>String</td>
  ...
  [`lower_case_table_names`](server-system-variables.html#sysvar_lower_case_table_names) sets
  the value to 1.
...
<td>String</td>
  ...
  [`SHOW GRANTS`](show-grants.html "15.7.7.21 SHOW GRANTS Statement") displays mandatory
...
<td>String</td>
  ...
  [`mysql_stmt_send_long_data()`](/doc/c-api/8.0/en/mysql-stmt-send-long-data.html) C
...
<td>String</td>
  ...
  ERRORS`](show-errors.html "15.7.7.17 SHOW ERRORS Statement") and [`SHOW
  WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement") statements. This is the same as the number
...
<td>String</td>
  ...
  [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") or altered with
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") or
  [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement"). A server
  ...
  [Section 19.5.1.21, “Replication and MEMORY Tables”](replication-features-memory.html "19.5.1.21 Replication and MEMORY Tables"), and
  [Section 19.5.1.39, “Replication and Variables”](replication-features-variables.html "19.5.1.39 Replication and Variables"), for more
  information.
...
<td>String</td>
  ...
  *MySQL 8.0.30 and earlier*: Do not permit
  ...
  [Using Safe-Updates Mode (--safe-updates)](mysql-tips.html#safe-updates "Using Safe-Updates Mode (--safe-updates)").

  Regardless of MySQL release version, setting this variable to
  a value other than `DEFAULT` resets the value
  of [`sql_big_selects`](server-system-variables.html#sysvar_sql_big_selects) to
  `0`. If you set the
...
<td>String</td>
  ...
  use. See [Section 10.2.1.16, “ORDER BY Optimization”](order-by-optimization.html "10.2.1.16 ORDER BY Optimization").
...
<td>String</td>
  ...
  [Section 15.7.7.22, “SHOW INDEX Statement”](show-index.html "15.7.7.22 SHOW INDEX Statement")). By setting this to a low value
...
<td>String</td>
  ...
  [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement") for
...
<td>String</td>
  ...
  indexes with [`CREATE INDEX`](create-index.html "15.1.15 CREATE INDEX Statement") or
...
<td>String</td>
  ...
  [`replica_net_timeout`](replication-options-replica.html#sysvar_replica_net_timeout) and
...
<td>String</td>
  ...
  [`NDB`](mysql-cluster.html "Chapter 25 MySQL NDB Cluster 8.0") tables. This experimental
  feature is not supported in production, and is now deprecated
  and thus subject to removal in a future release. For
  additional information, see
  [User-defined partitioning and the NDB storage engine (NDB Cluster)](partitioning-limitations-storage-engines.html#partitioning-limitations-ndb "User-defined partitioning and the NDB storage engine (NDB Cluster)").
...
<td>String</td>
  ...
  receive an
  [`ER_SERVER_OFFLINE_MODE`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_server_offline_mode) error.
  ...
  + From MySQL 8.0.30, if the user that puts a server in
    ...
    [`SYSTEM_USER`](privileges-provided.html#priv_system-user) privilege,
    connected client users who have the
...
<td>String</td>
  ...
  [`old`](server-system-variables.html#sysvar_old) is a compatibility
  variable. It is disabled by default, but can be enabled at
  startup to revert the server to behaviors present in older
  versions.

  When [`old`](server-system-variables.html#sysvar_old) is enabled, it
  ...
  [Section 10.9.4, “Index Hints”](index-hints.html "10.9.4 Index Hints").) Take care about enabling this
...
<td>String</td>
  ...
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") operation. It reverts to using a temporary
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), see
...
<td><code class="literal">65535</code></td>
  ...
  variables; a keyring component (see [Section 8.4.4, “The MySQL Keyring”](keyring.html "8.4.4 The MySQL Keyring"))
...
<td><code class="literal">65535</code></td>
  ...
  [`print_identified_with_as_hex`](server-system-variables.html#sysvar_print_identified_with_as_hex)
  causes [`SHOW CREATE USER`](show-create-user.html "15.7.7.12 SHOW CREATE USER Statement") to
...
<td><code class="literal">65535</code></td>
  ...
  From MySQL 8.0.26,
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) is used
  in place of
  [`pseudo_slave_mode`](server-system-variables.html#sysvar_pseudo_slave_mode), which is
  ...
  + If false, the server rejects the statement with
    [`ER_UNSUPPORTED_SQL_MODE`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_unsupported_sql_mode).
...
<td><code class="literal">65535</code></td>
  ...
  From MySQL 8.0.26,
  [`pseudo_slave_mode`](server-system-variables.html#sysvar_pseudo_slave_mode) is
  deprecated and the alias
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) is used
  instead. [`pseudo_slave_mode`](server-system-variables.html#sysvar_pseudo_slave_mode) is
  ...
  [`pseudo_replica_mode`](server-system-variables.html#sysvar_pseudo_replica_mode) system
...
<td><code class="literal">65535</code></td>
  ...
  output of [`SHOW VARIABLES`](show-variables.html "15.7.7.41 SHOW VARIABLES Statement").
...
<td><code class="literal">65535</code></td>
  ...
  + Updates to Performance Schema tables, such as
    ...
    [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") operations.
...
<td><code class="literal">65535</code></td>
  ...
  [`ER_SECURE_TRANSPORT_REQUIRED`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_secure_transport_required)
  error.
  ...
  an
  [`ER_NO_SECURE_TRANSPORTS_CONFIGURED`](/doc/mysql-errors/8.0/en/server-error-reference.html#error_er_no_secure_transports_configured)
  error.
...
<td><code class="literal">65535</code></td>
  ...
  [Optional Result Set Metadata](/doc/c-api/8.0/en/c-api-optional-metadata.html).
...
<td><code class="literal">65535</code></td>
  ...
  [`check_proxy_users`](server-system-variables.html#sysvar_check_proxy_users) system
...
<td><code class="literal">65535</code></td>
  ...
  key, see [Section 8.4.1.3, “SHA-256 Pluggable Authentication”](sha256-pluggable-authentication.html "8.4.1.3 SHA-256 Pluggable Authentication").
...
<td><code class="literal">65535</code></td>
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") normally does
  not show the `ROW_FORMAT` table option if the
  row format is the default format. Enabling this variable
  causes [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") to
...
<td><code class="literal">65535</code></td>
  ...
  Whether [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement")
  output includes comments to flag temporal columns found to be
  in pre-5.6.4 format ([`TIME`](time.html "13.2.3 The TIME Type"),
  [`DATETIME`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"), and
  [`TIMESTAMP`](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types") columns without
  support for fractional seconds precision). This variable is
  disabled by default. If enabled, [`SHOW
  CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") output looks like this:
  ...
  Information Schema [`COLUMNS`](information-schema-columns-table.html "28.3.8 The INFORMATION_SCHEMA COLUMNS Table") table
...
<td><code class="literal">65535</code></td>
  ...
  DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") statement if they do not have the
  ...
  [`SHOW DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") statement is
  ...
  [`SHOW DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") is permitted to
  ...
  [`SHOW DATABASES`](show-databases.html "15.7.7.14 SHOW DATABASES Statement") or by
  examining the [`SCHEMATA`](information-schema-schemata-table.html "28.3.31 The INFORMATION_SCHEMA SCHEMATA Table") table of
...
<td><code class="literal">65535</code></td>
  ...
  in [`SHOW GLOBAL
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") output, you can consider increasing the
...
<td><code class="literal">65535</code></td>
  ...
  REPLICATION SOURCE TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement, optionally
...
<td><code class="literal">65535</code></td>
  ...
  [`SHOW CREATE TABLE`](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement") and
  ...
  that require quoting. See [Section 15.7.7.10, “SHOW CREATE TABLE Statement”](show-create-table.html "15.7.7.10 SHOW CREATE TABLE Statement"),
  and [Section 15.7.7.6, “SHOW CREATE DATABASE Statement”](show-create-database.html "15.7.7.6 SHOW CREATE DATABASE Statement").
...
<td><code class="literal">65535</code></td>
  ...
  TO`](change-replication-source-to.html "15.4.2.3 CHANGE REPLICATION SOURCE TO Statement") statement (MySQL 8.0.23 and later) or
...
<td><code class="literal">65535</code></td>
  ...
  [`ALTER INSTANCE RELOAD TLS`](alter-instance.html#alter-instance-reload-tls) or
...
<td><code class="literal">65535</code></td>
  ...
  the [dictionary
  object cache](glossary.html#glos_dictionary_object_cache "dictionary object cache"). The stored procedure and stored function
...
<td><code class="literal">65535</code></td>
  ...
  [dictionary object
  cache](glossary.html#glos_dictionary_object_cache "dictionary object cache"). Both caches store table definitions but serve
...
* [`temptable_use_mmap`](server-system-variables.html#sysvar_temptable_use_mmap)
...
<td><code class="literal">65535</code></td>
  ...
  [`temptable_max_ram`](server-system-variables.html#sysvar_temptable_max_ram) variable.
  When [`temptable_use_mmap`](server-system-variables.html#sysvar_temptable_use_mmap) is
...
<td><code class="literal">NULL</code></td>
  ...
  [`replica_load_tmpdir`](replication-options-replica.html#sysvar_replica_load_tmpdir) or
  [`slave_load_tmpdir`](replication-options-replica.html#sysvar_slave_load_tmpdir) variable.
...
<td><code class="literal">NULL</code></td>
  ...
  [`version_comment`](server-system-variables.html#sysvar_version_comment) is set by the
  [`COMPILATION_COMMENT`](source-configuration-options.html#option_cmake_compilation_comment) option.) See
...
<td><code class="literal">NULL</code></td>
  ...
  [`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html)). See
...
* [`warning_count`](server-system-variables.html#sysvar_warning_count)
  ...
  read only. See [Section 15.7.7.42, “SHOW WARNINGS Statement”](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement").

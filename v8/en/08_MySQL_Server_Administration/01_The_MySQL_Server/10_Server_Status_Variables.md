...
STATUS` statement (see [Section 15.7.7.37, “SHOW STATUS Statement”](show-status.html "15.7.7.37 SHOW STATUS Statement")).
...
* `Com_xxx`
  ...
  **mysql\_stmt\_execute()**, and so forth are
  ...
  of [`CHANGE REPLICATION FILTER`](change-replication-filter.html "15.4.2.2 CHANGE REPLICATION FILTER Statement")
  statements executed.
...
* [`Created_tmp_tables`](server-status-variables.html#statvar_Created_tmp_tables)
  ...
  STATUS`](show-status.html "15.7.7.37 SHOW STATUS Statement") statement uses an internal temporary table
...
* [`Current_tls_ca`](server-status-variables.html#statvar_Current_tls_ca)
  ...
  Performance Schema
  [`tls_channel_status`](performance-schema-tls-channel-status-table.html "29.12.21.9 The tls_channel_status Table") table. See
...
* [`Error_log_buffered_bytes`](server-status-variables.html#statvar_Error_log_buffered_bytes)
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table. It is possible
...
* [`Error_log_buffered_events`](server-status-variables.html#statvar_Error_log_buffered_events)
  ...
  Schema [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table. As with
...
* [`Error_log_expired_events`](server-status-variables.html#statvar_Error_log_expired_events)
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table to make room for
  new events.
...
* [`Error_log_latest_write`](server-status-variables.html#statvar_Error_log_latest_write)
  ...
  [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table.
...
* [`Innodb_buffer_pool_bytes_data`](server-status-variables.html#statvar_Innodb_buffer_pool_bytes_data)
  ...
  when [compressed](glossary.html#glos_compression "compression") tables
...
* [`Last_query_cost`](server-status-variables.html#statvar_Last_query_cost)
  ...
  [`UNION`](union.html "15.2.18 UNION Clause"). (For the latter, the
  value was set to 0.)
...
* [`Ongoing_anonymous_gtid_violating_transaction_count`](server-status-variables.html#statvar_Ongoing_anonymous_gtid_violating_transaction_count)
  ...
  [`gtid_next=ANONYMOUS`](replication-options-gtids.html#sysvar_gtid_next) and that
...
* [`Replica_open_temp_tables`](server-status-variables.html#statvar_Replica_open_temp_tables)
  ...
  [`Replica_open_temp_tables`](server-status-variables.html#statvar_Replica_open_temp_tables) in
  place of
  ...
  [Section 19.5.1.31, “Replication and Temporary Tables”](replication-features-temptables.html "19.5.1.31 Replication and Temporary Tables"). This
  variable reports the total count of open temporary tables for
  *all* replication channels.

* [`Replica_rows_last_search_algorithm_used`](server-status-variables.html#statvar_Replica_rows_last_search_algorithm_used)
...
* [`Slave_open_temp_tables`](server-status-variables.html#statvar_Slave_open_temp_tables)
  ...
  From MySQL 8.0.26,
  [`Slave_open_temp_tables`](server-status-variables.html#statvar_Slave_open_temp_tables) is
  deprecated and the alias
  [`Replica_open_temp_tables`](server-status-variables.html#statvar_Replica_open_temp_tables)
  should be used instead. In releases before MySQL 8.0.26, use
  [`Slave_open_temp_tables`](server-status-variables.html#statvar_Slave_open_temp_tables).

  [`Slave_open_temp_tables`](server-status-variables.html#statvar_Slave_open_temp_tables) shows

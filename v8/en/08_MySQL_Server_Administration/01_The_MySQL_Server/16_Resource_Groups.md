...
* The Information Schema
  [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.26 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table exposes
...
* Each group has a type, which is either
  ...
  [`threads`](performance-schema-threads-table.html "29.12.21.8 The threads Table") table.
...
[`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.26 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table, which is
...
Initially, the [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.26 The INFORMATION_SCHEMA RESOURCE_GROUPS Table")
...
the [`RESOURCE_GROUPS`](information-schema-resource-groups-table.html "28.3.26 The INFORMATION_SCHEMA RESOURCE_GROUPS Table") table:

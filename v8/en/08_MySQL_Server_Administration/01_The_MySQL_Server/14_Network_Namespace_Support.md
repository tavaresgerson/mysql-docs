...
In this case, the expected [`USER()`](information-functions.html#function_user)
...
* The MySQL server, [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server").
* X Plugin.
* The [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client and the
...
* [Host System Prerequisites](network-namespace-support.html#network-namespaces-host-prerequisites "Host System Prerequisites")
* [MySQL Configuration](network-namespace-support.html#network-namespaces-mysql-configuration "MySQL Configuration")
* [Network Namespace Monitoring](network-namespace-support.html#network-namespaces-monitoring "Network Namespace Monitoring")
...
[`--network-namespace`](mysql-command-options.html#option_mysql_network-namespace) option fails
like this:
...
[`admin_address`](server-system-variables.html#sysvar_admin_address), and
[`mysqlx_bind_address`](x-plugin-options-system-variables.html#sysvar_mysqlx_bind_address) system
...
* [`bind_address`](server-system-variables.html#sysvar_bind_address) and (as of
  MySQL 8.0.21)
  [`mysqlx_bind_address`](x-plugin-options-system-variables.html#sysvar_mysqlx_bind_address) accept
...
* For the [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") client and the
  **mysqlxtest** test suite client, use the
  [`--network-namespace`](mysql-command-options.html#option_mysql_network-namespace) option.
  For example:
  ...
  If the [`--network-namespace`](mysql-command-options.html#option_mysql_network-namespace)
...
3. Verify that you can connect to the server in each named
   ...
   [`USER()`](information-functions.html#function_user), which can return a
   ...
   You might also try invoking [**mysql**](mysql.html "6.5.1 mysql — The MySQL Command-Line Client") without
   the [`--network-namespace`](mysql-command-options.html#option_mysql_network-namespace) option
   to see whether the connection attempt succeeds, and, if so,
   how the [`USER()`](information-functions.html#function_user) value is
   affected.
...
* The
  [`SHOW
  REPLICA STATUS`](show-replica-status.html "15.7.7.35 SHOW REPLICA STATUS Statement") (or before MySQL 8.0.22,
  [`SHOW
  SLAVE STATUS`](show-slave-status.html "15.7.7.36 SHOW SLAVE | REPLICA STATUS Statement")) statement. See

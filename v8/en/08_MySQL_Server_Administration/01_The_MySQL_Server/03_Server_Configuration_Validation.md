...
[`--validate-config`](server-options.html#option_mysqld_validate-config) option that
...
[`--validate-config`](server-options.html#option_mysqld_validate-config) to check the

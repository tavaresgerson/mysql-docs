...
for inserted datetime values; see [Section 13.2.2, “The DATE, DATETIME, and TIMESTAMP Types”](datetime.html "13.2.2 The DATE, DATETIME, and TIMESTAMP Types"), for
more information.
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") program to load the time
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") and send the output into
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") reads your system's time
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") also can be used to load
...
* To load a single time zone file
  *`tz_file`* that corresponds to a
  ...
  [**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") like this:
...
After running [**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables"), restart
...
[**mysql\_tzinfo\_to\_sql**](mysql-tzinfo-to-sql.html "6.4.4 mysql_tzinfo_to_sql — Load the Time Zone Tables") utility instead.

...
* [`mysql_session_track_get_first()`](/doc/c-api/8.0/en/mysql-session-track-get-first.html)
  fetches the first part of the state-change information
  received from the server. See
  [mysql\_session\_track\_get\_first()](/doc/c-api/8.0/en/mysql-session-track-get-first.html).

* [`mysql_session_track_get_next()`](/doc/c-api/8.0/en/mysql-session-track-get-next.html)
  ...
  See [mysql\_session\_track\_get\_next()](/doc/c-api/8.0/en/mysql-session-track-get-next.html).

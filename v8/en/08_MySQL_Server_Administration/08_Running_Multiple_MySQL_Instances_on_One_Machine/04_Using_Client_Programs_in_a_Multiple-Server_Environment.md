...
* In a C program, you can specify the socket file or port number
  arguments in the
  [`mysql_real_connect()`](/doc/c-api/8.0/en/mysql-real-connect.html) call. You
  can also have the program read option files by calling
  [`mysql_options()`](/doc/c-api/8.0/en/mysql-options.html). See
  [C API Basic Function Descriptions](/doc/c-api/8.0/en/c-api-function-descriptions.html).

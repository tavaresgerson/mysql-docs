...
logging. By default,
[`log_error_services`](server-system-variables.html#sysvar_log_error_services) has this
value:
...
3. Enable the component by listing it in the
   ...
   COMPONENT`](install-component.html "15.7.4.3 INSTALL COMPONENT Statement"), do not persist or set
...
the Performance Schema [`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table")
...
[`error_log`](performance-schema-error-log-table.html "29.12.21.2 The error_log Table") table. This enables

...
ERROR LOGS`](flush.html#flush-error-logs) or [`FLUSH
LOGS`](flush.html#flush-logs) statement, or a [**mysqladmin
flush-logs**](mysqladmin.html "6.5.2 mysqladmin — A MySQL Server Administration Program") command, the server closes and reopens any
...
[**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server"). For information about handling this
case, see [Section 7.4.6, “Server Log Maintenance”](log-file-maintenance.html "7.4.6 Server Log Maintenance").

...
* [Core Error Event Fields](error-log-event-fields.html#error-log-event-core-fields "Core Error Event Fields")
* [Optional Error Event Fields](error-log-event-fields.html#error-log-event-optional-fields "Optional Error Event Fields")
...
* `prio`
  ...
  <table summary="Error event priority levels."><col style="width: 35%"/><col style="width: 35%"/><thead><tr>
<th>Event Type</th>
...
* Identification of the client for which the event occurred:
  ...
  + `thread`
    ...
    The ID of the thread within [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server")

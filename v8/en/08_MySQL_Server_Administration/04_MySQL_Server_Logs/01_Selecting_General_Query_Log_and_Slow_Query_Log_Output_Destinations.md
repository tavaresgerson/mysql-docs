...
* [`CREATE TABLE`](create-table.html "15.1.20 CREATE TABLE Statement"),
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement"), and
  [`DROP TABLE`](drop-table.html "15.1.32 DROP TABLE Statement") are valid
  operations on a log table. For [`ALTER
  TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") and [`DROP
  TABLE`](drop-table.html "15.1.32 DROP TABLE Statement"), the log table cannot be in use and must be
...
* By default, the log tables use the `CSV`
  ...
  [`ALTER TABLE`](alter-table.html "15.1.9 ALTER TABLE Statement") to alter a log
...
* [`TRUNCATE TABLE`](truncate-table.html "15.1.37 TRUNCATE TABLE Statement") is a valid
  operation on a log table. It can be used to expire log
  entries.

* [`RENAME TABLE`](rename-table.html "15.1.36 RENAME TABLE Statement") is a valid

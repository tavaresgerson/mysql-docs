...
output of [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement")) and
through the [**mysqld**](mysqld.html "6.3.1 mysqld — The MySQL Server") error log. A warning is
added to the [`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement")
...
<th scope="row"><a class="link" href="mysql-cluster.html" title="Chapter 25 MySQL NDB Cluster 8.0"><code class="literal">NDB</code></a></th>
<td>Yes</td>
<td>No</td>
</tr></tbody></table>
...
[`SHOW WARNINGS`](show-warnings.html "15.7.7.42 SHOW WARNINGS Statement")). The information

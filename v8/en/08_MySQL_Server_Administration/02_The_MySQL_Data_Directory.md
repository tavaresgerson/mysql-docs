...
* Data directory subdirectories. Each subdirectory of the data
  ...
  + The `mysql` directory corresponds to the
    ...
    tables. See [Section 7.3, “The mysql System Schema”](system-schema.html "7.3 The mysql System Schema").
  ...
  + The `sys` directory corresponds to the
    ...
    more easily. See [Chapter 30, *MySQL sys Schema*](sys-schema.html "Chapter 30 MySQL sys Schema").
  ...
  [`INFORMATION_SCHEMA`](information-schema.html "Chapter 28 INFORMATION_SCHEMA Tables") is a
...
[`--datadir`](server-system-variables.html#sysvar_datadir) option enables the

...
* MySQL Enterprise Edition includes functions that provide an SQL-level API for
  ...
  [MySQL Enterprise Data Masking and De-Identification Elements](/doc/refman/5.7/en/data-masking-elements.html).
...
* MySQL Enterprise Edition includes audit logging for monitoring and logging of
  ...
  and [Section 8.4.6, “The Audit Message Component”](audit-api-message-emit.html "8.4.6 The Audit Message Component").
...
* MySQL Enterprise Edition includes a firewall capability that implements an
  ...
  patterns for accepted statement. See [Section 8.4.7, “MySQL Enterprise Firewall”](firewall.html "8.4.7 MySQL Enterprise Firewall").
...
* A locking service provides a locking interface for application
  use. See [Section 7.6.9.1, “The Locking Service”](locking-service.html "7.6.9.1 The Locking Service").
...
[Adding Functions to MySQL](/doc/extending-mysql/8.0/en/adding-functions.html).
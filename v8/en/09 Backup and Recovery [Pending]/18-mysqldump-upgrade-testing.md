--- title: MySQL 8.4 Reference Manual :: 9.4.5.5 Using mysqldump to Test for Upgrade Incompatibilities url: https://dev.mysql.com/doc/refman/8.4/en/mysqldump-upgrade-testing.html order: 18 ---

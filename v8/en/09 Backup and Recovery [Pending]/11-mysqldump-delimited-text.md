--- title: MySQL 8.4 Reference Manual :: 9.4.3 Dumping Data in Delimited-Text Format with mysqldump url: https://dev.mysql.com/doc/refman/8.4/en/mysqldump-delimited-text.html order: 11 ---

--- title: MySQL 8.4 Reference Manual :: 9.4.5.2 Copy a Database from one Server to Another url: https://dev.mysql.com/doc/refman/8.4/en/mysqldump-copying-to-other-server.html order: 15 ---

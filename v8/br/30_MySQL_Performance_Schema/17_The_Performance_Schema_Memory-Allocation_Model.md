...
- Com o valor definido em `N` > 0:
  ...
  - Quando o tamanho do buffer atinge `N`, mais memória não é alocada. Os dados coletados pelo Schema de Desempenho para este buffer são perdidos e quaisquer contadores de "instância perdida" correspondentes são incrementados.

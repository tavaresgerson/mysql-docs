...
A tabela `events_waits_history` tem as mesmas colunas e indexação que a tabela `events_waits_current`. Veja a Seção 29.12.4.1, “A tabela events\_waits\_current”.

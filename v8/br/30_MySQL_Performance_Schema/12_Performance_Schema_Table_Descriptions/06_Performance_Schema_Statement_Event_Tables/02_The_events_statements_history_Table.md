...
A tabela `events_statements_history` tem as mesmas colunas e indexação que a tabela `events_statements_current`. Veja a Seção 29.12.6.1, “A tabela events\_statements\_current”.

...
A tabela `setup_consumers` lista os tipos de consumidores para os quais as informações do evento podem ser armazenadas e que estão habilitados:
...
As configurações de consumidor na tabela `setup_consumers` formam uma hierarquia de níveis mais altos para níveis mais baixos. Para informações detalhadas sobre o efeito de habilitar diferentes consumidores, consulte a Seção 29.4.7, “Pré-filtragem por Consumidor”.

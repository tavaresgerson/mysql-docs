#### 29.12.9.1 Tabela session\_account\_connect\_attrs

Os programas de aplicação podem fornecer atributos de conexão de chave-valor a serem passados ao servidor no momento da conexão. Para descrições de atributos comuns, consulte a Seção 29.12.9, “Tabelas de Atributos de Conexão do Schema de Desempenho”.

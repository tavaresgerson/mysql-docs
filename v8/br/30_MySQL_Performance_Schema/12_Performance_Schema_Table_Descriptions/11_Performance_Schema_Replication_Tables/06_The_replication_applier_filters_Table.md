...
Esta tabela mostra os filtros específicos do canal de replicação configurados nesta replica. Cada linha fornece informações sobre o tipo de filtro configurado de um canal de replicação. A tabela `replication_applier_filters` tem as seguintes colunas:
...
- `FILTER_NAME`
  ...
  O tipo de filtro de replicação configurado para este canal de replicação.

...
A tabela `TABLES_EXTENSIONS` (disponível a partir do MySQL 8.0.21) fornece informações sobre os atributos da tabela definidos para os motores de armazenamento primário e secundário.

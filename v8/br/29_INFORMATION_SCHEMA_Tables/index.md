# Capítulo 28 PLANILHAS do esquema de informações

**Índice**

28.1 Introdução

28.2 Referência da Tabela INFORMATION\_SCHEMA

28.3 INFORMATION\_SCHEMA Tabelas Gerais:   28.3.1 Referência da Tabela Geral INFORMATION\_SCHEMA
...
28.4 INFORMATION\_SCHEMA Tabelas InnoDB:   28.4.1 Referência da Tabela INFORMATION\_SCHEMA InnoDB
...
28.5 Tabelas do Conjunto de Filas de Tråda do Schema\_Informações:   28.5.1 Referência da Tabela do Conjunto de Filas de Tråda do Schema\_Informações
...
28.6 Tabelas de Controle de Conexão do Schema de Informações:   28.6.1 Referência da Tabela de Controle de Conexão do Schema de Informações

```
28.6.2 The INFORMATION_SCHEMA CONNECTION_CONTROL_FAILED_LOGIN_ATTEMPTS Table
```

28.7 INFORMATION\_SCHEMA MySQL Enterprise Firewall Tables:   28.7.1 Referência da Tabela Firewall INFORMATION\_SCHEMA

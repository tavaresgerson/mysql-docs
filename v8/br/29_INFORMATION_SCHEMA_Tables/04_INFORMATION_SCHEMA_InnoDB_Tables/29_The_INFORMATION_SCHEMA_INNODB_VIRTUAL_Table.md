...
- Se um valor constante for atribuído a uma coluna gerada virtualmente, como na tabela a seguir, uma entrada para a coluna não aparecerá na tabela `INNODB_VIRTUAL`. Para que uma entrada apareça, uma coluna gerada virtualmente deve ter uma coluna base.
  ...
  No entanto, os metadados para essa coluna aparecem na tabela `INNODB_COLUMNS`.

...
- O nome do animal de estimação para que saibam a que animal pertence cada evento.
...
Dadas essas considerações, a instrução \[`CREATE TABLE`] ((create-table.html) para a tabela `event` pode ser assim:
...
Tal como acontece com a tabela `pet`, é mais fácil carregar os registros iniciais criando um arquivo de texto delimitado por tabulação contendo as seguintes informações.

<table><col style="width: 15%"/><col style="width: 15%"/><col style="width: 15%"/><col style="width: 35%"/><thead><tr> <th scope="col">nome</th> <th scope="col">data</th> <th scope="col">tipo de</th> <th scope="col">observação</th> </tr></thead><tbody><tr> <th>Peluchoso</th> <td>Relatório da Comissão</td> <td>dejetos</td> <td>4 gatinhos, 3 fêmeas, 1 macho</td> </tr><tr> <th>Buffy ,</th> <td>1993-06-23 (em inglês)</td> <td>dejetos</td> <td>5 filhotes, 2 fêmeas, 3 machos</td> </tr><tr> <th>Buffy ,</th> <td>1994-19 de Junho</td> <td>dejetos</td> <td>3 filhotes, 3 fêmeas</td> </tr><tr> <th>Alegria</th> <td>1999-03-21 Comissão</td> <td>veterinário</td> <td>O bico precisa de ser endireitado.</td> </tr><tr> <th>Escasso</th> <td>1997-08-03</td> <td>veterinário</td> <td>costela partida</td> </tr><tr> <th>Bowser .</th> <td>11 de Outubro</td> <td>canil</td> <td></td> </tr><tr> <th>Fang</th> <td>11 de Outubro</td> <td>canil</td> <td></td> </tr><tr> <th>Fang</th> <td>1998-08-28 Comissão Europeia</td> <td>aniversário</td> <td>Dei-lhe um novo brinquedo para mastigar</td> </tr><tr> <th>Armadilhas</th> <td>1998-03-17 Comissão</td> <td>aniversário</td> <td>Dei-lhe um novo colar para pulgas.</td> </tr><tr> <th>Whistler</th> <td>1998-12-09 (em inglês)</td> <td>aniversário</td> <td>Primeiro aniversário</td> </tr></tbody></table>
...
Com base no que você aprendeu com as consultas que você executou na tabela `pet`, você deve ser capaz de realizar buscas nos registros na tabela `event`; os princípios são os mesmos. Mas quando a tabela `event` por si só é insuficiente para responder a perguntas que você pode fazer?
...
- Como a coluna `name` ocorre em ambas as tabelas, você deve ser específico sobre qual tabela você quer referir ao se referir à coluna. Isso é feito prependendo o nome da tabela ao nome da coluna.

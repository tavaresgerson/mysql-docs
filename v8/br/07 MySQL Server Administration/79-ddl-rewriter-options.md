...
Esta seção descreve as opções de comando que controlam a operação do plugin `ddl_rewriter`. Se os valores especificados no momento do início forem incorretos, o plugin `ddl_rewriter` pode não ser inicializado corretamente e o servidor não o carregará.

Para controlar a ativação do plugin `ddl_rewriter`, use esta opção:

*  `--ddl-rewriter[=valor]`

  <table><tbody><tr><th>Formato de Linha de Comando</th> <td><code>--ddl-rewriter[=valor]</code></td> </tr><tr><th>Tipo</th> <td>Enumeração</td> </tr><tr><th>Valor Padrão</th> <td><code>ON</code></td> </tr><tr><th>Valores Válidos</th> <td><p class="valor-válido"><code>ON</code></p><p class="valor-válido"><code>OFF</code></p><p class="valor-válido"><code>FORCE</code></p><p class="valor-válido"><code>FORCE_PLUS_PERMANENT</code></p></td> </tr></tbody></table>

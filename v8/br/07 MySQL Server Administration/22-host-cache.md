...
3. Se ocorrer um erro ao processar uma conexão de cliente em recebimento de um endereço IP específico, o servidor atualiza os contadores de erro correspondentes na entrada para esse IP. Para uma descrição dos erros registrados, consulte a Seção 29.12.22.3, “A tabela host\_cache”.

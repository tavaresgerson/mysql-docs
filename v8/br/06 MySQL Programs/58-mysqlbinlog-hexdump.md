#### 6.6.9.1 Formato de Hex Dump de `mysqlbinlog`
...
A saída hexadecimal consiste em linhas de comentário começando com `#`, então a saída pode parecer assim para o comando anterior:
...
A saída do dump hexadecimal atualmente contém os elementos da lista a seguir. Esse formato está sujeito a alterações. Para mais informações sobre o formato do log binário, consulte MySQL Internals: The Binary Log.
...
* `Flags`: Valores de flags de evento.
...
A sintaxe da segunda invocação faz com que `mysql_tzinfo_to_sql` carregue um único arquivo de fuso horário `tz_file` que corresponde a um nome de fuso horário `tz_name`:

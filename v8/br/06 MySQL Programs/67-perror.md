...
O `perror` tenta ser flexível ao entender seus argumentos. Por exemplo, para o erro `ER_WRONG_VALUE_FOR_VAR`, o `perror` entende qualquer um desses argumentos: `1231`, `001231`, `MY-1231` ou `MY-001231`, ou `ER_WRONG_VALUE_FOR_VAR`.
...
Se um número de erro estiver dentro do intervalo onde os erros do MySQL e do sistema operacional se sobrepõem, o `perror` exibe ambas as mensagens de erro:

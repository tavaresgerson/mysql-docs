...
2. Selecione a Edição Empresarial do MySQL.
   ...
   A visão da Edição Empresarial do MySQL é exibida.
3. Clique em Iniciar Instância para iniciar o processo de lançamento da aplicação.
   ...
   Consulte  Para criar uma instância Linux para obter informações sobre como preencher os campos.
...
Consulte  Conectando-se com SSH para obter mais informações.

O seguinte software do MySQL é instalado:

* MySQL Server EE
* MySQL Backup Empresarial
* MySQL Shell
* MySQL Router
...
* `firewalld`: para mais informações, consulte  Controlando o Serviço de Firewall `firewalld`

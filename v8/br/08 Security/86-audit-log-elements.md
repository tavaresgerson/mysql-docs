#### 8.4.5.1 Elementos do Auditoramento do MySQL Enterprise

O Auditoramento do MySQL Enterprise é baseado no plugin de log de auditoria e nos elementos relacionados:

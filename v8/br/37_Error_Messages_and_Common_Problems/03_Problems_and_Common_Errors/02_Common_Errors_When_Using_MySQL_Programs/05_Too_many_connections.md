...
Se os clientes encontrarem erros `Too many connections` ao tentarem se conectar ao servidor **mysqld**, todas as conexões disponíveis estão sendo usadas por outros clientes.

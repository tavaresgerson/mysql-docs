...
**Informações de licenciamento — MySQL 8.0.** Este produto pode incluir software de terceiros, utilizado sob licença. Se você estiver usando uma versão *Comercial* do MySQL 8.0, consulte o Manual do Usuário de Informações de Licenciamento da Versão Comercial do MySQL 8.0 para obter informações de licenciamento, incluindo informações de licenciamento relacionadas ao software de terceiros que possa estar incluído nesta versão Comercial. Se você estiver usando uma versão *Comunitária* do MySQL 8.0, consulte o Manual do Usuário de Informações de Licenciamento da Versão Comunitária do MySQL 8.0 para obter informações de licenciamento, incluindo informações de licenciamento relacionadas ao software de terceiros que possa estar incluído nesta versão Comunitária.

**Informações de licenciamento — MySQL NDB Cluster 8.0.** Se você estiver usando uma versão *Comercial* do MySQL NDB Cluster 8.0, consulte o Manual do Usuário de Informações de Licenciamento da Versão Comercial do MySQL NDB Cluster 8.0 para obter informações sobre a licença, incluindo informações sobre software de terceiros que possam estar incluídos nesta versão Comercial. Se você estiver usando uma versão *Comunitária* do MySQL NDB Cluster 8.0, consulte o Manual do Usuário de Informações de Licenciamento da Versão Comunitária do MySQL NDB Cluster 8.0 para obter informações sobre a licença, incluindo informações sobre software de terceiros que possam estar incluídos nesta versão Comunitária.

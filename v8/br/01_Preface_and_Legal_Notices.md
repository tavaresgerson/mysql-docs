...
Este é o Manual de Referência para o Sistema de Banco de Dados MySQL, versão 8.0, até a versão 8.0.44. As diferenças entre as versões menores do MySQL 8.0 são mencionadas neste texto com referência aos números de versão (8.0.*`x`*). Para informações sobre a licença, consulte os [Avisos Legais](preface.html#legalnotice "Legal Notices").

Este manual não é destinado para uso com versões mais antigas do software MySQL, devido às muitas diferenças funcionais e outras entre o MySQL 8.0 e as versões anteriores. Se você está usando uma versão anterior do software MySQL, consulte o manual apropriado. Por exemplo, o *Manual de Referência do MySQL 5.7* cobre a série de versões do software MySQL 5.7.

Se você está usando o MySQL 8.4, consulte o [Manual de Referência do MySQL 8.4][(/doc/refman/8.4/en/)].

**Informações de licenciamento — MySQL 8.0.** Este produto pode incluir software de terceiros, utilizado sob licença. Se você estiver usando uma versão *Comercial* do MySQL 8.0, consulte o [Manual do Usuário de Informações de Licença de Revisão Comercial do MySQL 8.0](https://downloads.mysql.com/docs/licenses/mysqld-8.0-com-en.pdf) para informações de licenciamento, incluindo informações de licenciamento relacionadas ao software de terceiros que pode ser incluído nesta versão Comercial. Se você estiver usando uma versão *Comunitária* do MySQL 8.0, consulte o [Manual do Usuário de Informações de Licença de Revisão Comunitária do MySQL 8.0](https://downloads.mysql.com/docs/licenses/mysqld-8.0-gpl-en.pdf) para informações de licenciamento, incluindo informações de licenciamento relacionadas ao software de terceiros que pode ser incluído nesta versão Comunitária.

**Informações de licenciamento — MySQL NDB Cluster 8.0.** Se você estiver usando uma versão *comercial* do MySQL NDB Cluster 8.0, consulte o [Manual do Usuário de Informações de Licenciamento da Versão Comercial do MySQL NDB Cluster 8.0][(https://downloads.mysql.com/docs/licenses/cluster-8.0-com-en.pdf)] para informações sobre licenciamento, incluindo informações sobre software de terceiros que podem ser incluídas nesta versão comercial. Se você estiver usando uma versão *comunitária* do MySQL NDB Cluster 8.0, consulte o [Manual do Usuário de Informações de Licenciamento da Versão Comunitária do MySQL NDB Cluster 8.0][(https://downloads.mysql.com/docs/licenses/cluster-8.0-gpl-en.pdf)] para informações sobre licenciamento, incluindo informações sobre software de terceiros que podem ser incluídas nesta versão comunitária.
...
USUÁRIOS FINAIS DO GOVERNO DOS EUA: Os programas da Oracle (incluindo qualquer sistema operacional, software integrado, quaisquer programas incorporados, instalados ou ativados em hardware entregue e as modificações desses programas) e a documentação de computadores da Oracle ou outros dados da Oracle entregues ou acessados por usuários finais do governo dos EUA são considerados "software de computador comercial", "documentação de software de computador comercial" ou "dados com direitos limitados" de acordo com o Regulamento Federal de Aquisição aplicável e regulamentos suplementares específicos da agência. Como tal, o uso, reprodução, duplicação, liberação, exibição, divulgação, modificação, preparação de obras derivadas e/ou adaptação de i) os programas da Oracle (incluindo qualquer sistema operacional, software integrado, quaisquer programas incorporados, instalados ou ativados em hardware entregue e as modificações desses programas), ii) a documentação de computadores da Oracle e/ou iii) outros dados da Oracle está sujeito aos direitos e limitações especificados na licença contida no contrato aplicável. Os termos que regem o uso dos serviços da nuvem da Oracle pelo governo dos EUA são definidos pelo contrato aplicável para tais serviços. Nenhum outro direito é concedido ao governo dos EUA.
...
Os clientes da Oracle que adquiriram suporte têm acesso ao suporte eletrônico por meio do My Oracle Support. Para obter informações, visite <http://www.oracle.com/pls/topic/lookup?ctx=acc&id=info> ou, se você tiver deficiência auditiva, visite `http://www.oracle.com/pls/topic/lookup?ctx=acc&id=trs`.
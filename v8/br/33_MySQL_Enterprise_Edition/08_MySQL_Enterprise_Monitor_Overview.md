...
- Use o Enterprise Manager para MySQL. Este é um produto gratuito para clientes com um contrato de suporte válido da Oracle. Para obter mais informações, visite Monitoramento abrangente e Gerenciamento de conformidade para bancos de dados MySQL usando o Enterprise Manager.

- Utilize as capacidades de monitoramento de banco de dados do serviço de Gerenciamento de Banco de Dados OCI e do serviço Ops Insights. Isso está disponível para o MySQL HeatWave e o MySQL on-premises. Para mais informações, acesse Gerenciamento de Banco de Dados para MySQL HeatWave e MySQL on-premises e Ops Insights para HeatWave e MySQL on-premises.

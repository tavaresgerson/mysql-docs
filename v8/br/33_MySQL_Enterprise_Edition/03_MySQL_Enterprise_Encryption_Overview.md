## 32.3 Visão geral da criptografia empresarial do MySQL
...
Para mais informações, consulte a Seção 8.6, “Encriptação Empresarial do MySQL”.

Para outras características de segurança da Empresa relacionadas, consulte a Seção 32.2, “Visão geral da segurança da MySQL Enterprise”.
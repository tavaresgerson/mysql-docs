...
O log de consultas lentas do MySQL contém informações sobre consultas que levam muito tempo para serem executadas (consulte a Seção 7.4.5, “O Log de Consultas Lentas”). O **mysqldumpslow** analisa os arquivos de log de consultas lentas do MySQL e resume seu conteúdo.
...
- `--debug`, `-d`
  ...
  <table summary="Propriedades para depuração"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--debug</code>]]</td> </tr></tbody></table>
...
- `-g pattern`
  ...
  <table summary="Propriedades para grep"><tbody><tr><th>Tipo</th> <td>Ferramenta de cordas</td> </tr></tbody></table>

  Considere apenas as consultas que correspondem ao padrão (estilo **grep**).

- `-h host_name`

  <table summary="Propriedades para o anfitrião"><tbody><tr><th>Tipo</th> <td>Ferramenta de cordas</td> </tr><tr><th>Valor padrão</th> <td>[[<code>*</code>]]</td> </tr></tbody></table>
...
- `-i name`
  ...
  <table summary="Propriedades, por exemplo"><tbody><tr><th>Tipo</th> <td>Ferramenta de cordas</td> </tr></tbody></table>
...
- `-n N`
  ...
  <table summary="Propriedades para números abstratos"><tbody><tr><th>Tipo</th> <td>Numérico</td> </tr></tbody></table>
...
- `-s sort_type`
  ...
  <table summary="Propriedades para classificação"><tbody><tr><th>Tipo</th> <td>Ferramenta de cordas</td> </tr><tr><th>Valor padrão</th> <td>[[<code>at</code>]]</td> </tr></tbody></table>
...
- `-t N`
  ...
  <table summary="Propriedades para topo"><tbody><tr><th>Tipo</th> <td>Numérico</td> </tr></tbody></table>

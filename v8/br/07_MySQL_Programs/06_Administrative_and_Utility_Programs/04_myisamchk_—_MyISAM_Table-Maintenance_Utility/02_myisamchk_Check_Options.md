...
- `--check-only-changed`, `-C`
  ...
  <table summary="Propriedades para verificação apenas de alterações"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--check-only-changed</code>]]</td> </tr></tbody></table>
...
- `--fast`, `-F`
  ...
  <table summary="Propriedades para rápido"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--fast</code>]]</td> </tr></tbody></table>
...
- `--information`, `-i`
  ...
  <table summary="Propriedades para informações"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--information</code>]]</td> </tr></tbody></table>

  Imprima estatísticas informativas sobre a tabela que está sendo verificada.

- `--medium-check`, `-m`

  <table summary="Propriedades para médio-controle"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--medium-check</code>]]</td> </tr></tbody></table>
...
- `--read-only`, `-T`
  ...
  <table summary="Propriedades para leitura somente"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--read-only</code>]]</td> </tr></tbody></table>
...
- `--update-state`, `-U`
  ...
  <table summary="Propriedades para atualização de estado"><tbody><tr><th>Formato de linha de comando</th> <td>[[<code>--update-state</code>]]</td> </tr></tbody></table>

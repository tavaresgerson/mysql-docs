### 6.2.2 Especificação das Opções do Programa
...
6.2.2.4 Modificadores de Opção do Programa

6.2.2.5 Usar Opções para Definir Variáveis do Programa
...
Para o servidor, uma exceção se aplica: o arquivo de opção **mysqld-auto.cnf** no diretório de dados é processado por último, portanto, ele tem precedência mesmo sobre as opções da linha de comando.

...
* O elemento do array `<map>` para o elemento `<ctype>` tem 257 palavras. Os outros elementos do array `<map>` depois disso têm 256 palavras. Veja a Seção 12.13.1, “Arrays de Definição de Caracteres”.
...
### 12.13.2 Suporte para a Colaboração de Cadeias para Conjuntos de Caracteres Complexos

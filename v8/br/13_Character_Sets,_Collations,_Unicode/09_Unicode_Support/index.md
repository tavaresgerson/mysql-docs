...
- Seus valores de código estão entre 0 e 65535 (ou `U+0000` e `U+FFFF`).
...
Além disso, no MySQL 8.0.30, todas as colorações que usam o prefixo `utf8_` são renomeadas usando o prefixo `utf8mb3_`.

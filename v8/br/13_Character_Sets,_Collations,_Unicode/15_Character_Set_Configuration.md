...
Para conjuntos de caracteres Unicode, você pode definir colatâncias sem recompilar usando a notação LDML. Veja a Seção 12.14.4, “Adicionando uma colatância UCA a um conjunto de caracteres Unicode”.

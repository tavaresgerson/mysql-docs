...
* Se o servidor não conseguir encontrar o arquivo de mensagem configurado, ele escreve uma mensagem no log de erro para indicar o problema e opta por mensagens internas em inglês.

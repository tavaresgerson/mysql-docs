...
Para especificar valores de bits, pode-se usar a notação `b'value'`. `value` é um valor binário escrito usando zeros e uns. Por exemplo, `b'111'` e `b'10000000'` representam 7 e 128, respectivamente. Veja a Seção 11.1.5, “Literais de Valor de Bits”.
...
**NBD Cluster.** O tamanho combinado máximo de todas as colunas `BIT` usadas em uma tabela específica `NDB` não deve exceder 4096 bits.

...
13.2.1 Data e Hora Tipo de Dados Sintaxe
...
13.2.9 Anos de 2 dígitos nas datas
...
- Por padrão, quando o MySQL encontra um valor para um tipo de data ou hora que está fora do intervalo ou é inválido para o tipo, ele converte o valor para o valor “zero” para esse tipo. A exceção é que os valores fora do intervalo `TIME` são cortados para o ponto final apropriado da faixa `TIME`.

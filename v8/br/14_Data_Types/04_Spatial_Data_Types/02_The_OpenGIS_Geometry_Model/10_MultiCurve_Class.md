...
- Uma fronteira `MultiCurve` é obtida aplicando a regra de união "mod 2" (também conhecida como regra "ímpar-par"): um ponto está na fronteira de um `MultiCurve` se estiver nas fronteiras de um número ímpar de elementos `Curve`.

...
O procedimento a seguir se aplica às tabelas `MyISAM`. Para obter informações sobre os passos a serem seguidos ao encontrar corrupção na tabela `InnoDB`, consulte a Seção 1.5, “Como relatar erros ou problemas”.
...
6. Inicie o **mysqld** com o log binário habilitado. Se você quiser encontrar uma declaração que faz o **mysqld** parar, você deve iniciar o servidor com o log de consulta geral habilitado também. Veja a Seção 7.4.3, “O Log de Consulta Geral”, e a Seção 7.4.4, “O Log Binário”.

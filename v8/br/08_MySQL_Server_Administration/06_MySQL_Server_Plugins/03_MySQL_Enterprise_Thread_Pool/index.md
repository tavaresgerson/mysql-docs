### 7.6.3 Piscina de Fios da Empresa MySQL
...
- Muitas transações executando em paralelo aumentam a disputa por recursos. Em `InnoDB`, isso aumenta o tempo gasto mantendo mutexes centrais. O pool de threads controla quando as transações começam para garantir que não sejam executadas em paralelo muitas delas.

#### Recursos adicionais

Seção A.15, “Perguntas frequentes sobre o MySQL 8.0: Pool de threads do MySQL Enterprise”

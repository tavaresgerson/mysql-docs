...
Esta seção descreve a sintaxe para referenciar variáveis estruturadas. As variáveis de cache de chave são usadas para exemplos de sintaxe, mas detalhes específicos sobre como as caches de chave funcionam são encontrados em outro lugar, na Seção 10.10.2, “A Cache de Chave MyISAM”.

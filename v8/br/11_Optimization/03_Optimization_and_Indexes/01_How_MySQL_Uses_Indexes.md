...
Em geral, os índices são usados conforme descrito na discussão a seguir. As características específicas dos índices de hash (como os usados nas tabelas `MEMORY`) são descritas na Seção 10.3.9, “Comparação entre Índices B-Tree e Índices de Hash”.

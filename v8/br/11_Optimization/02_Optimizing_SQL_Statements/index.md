## 10.2 Otimizando instruções SQL

10.2.1 Otimização de instruções SELECT

10.2.2 Otimização de subconsultas, tabelas derivadas, referências de visualizações e expressões de tabela comuns

10.2.3 Otimizando consultas do INFORMATION\_SCHEMA

10.2.4 Otimização das consultas do esquema de desempenho

10.2.5 Otimização das declarações de alteração de dados

10.2.6 Otimização dos privilégios do banco de dados

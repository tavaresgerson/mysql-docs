#### 10.4.2.3 Otimização para tipos de BLOB
...
- Consulte a Seção 10.4.2.2, “Otimização para Tipos de Caracteres e Strings”, para entender as razões pelas quais uma coluna binária `VARCHAR` às vezes é preferível a uma coluna BLOB equivalente.

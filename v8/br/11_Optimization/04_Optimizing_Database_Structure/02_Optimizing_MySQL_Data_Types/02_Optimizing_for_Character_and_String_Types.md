...
- Consulte a Seção 10.4.2.1, “Otimização para Dados Numéricos”, para entender as razões pelas quais uma coluna numérica é geralmente preferível a uma coluna de texto equivalente.

...
2. Na segunda fase, o TM informa aos RM se devem comprometer ou reverter. Se todos os ramos indicarem que estavam prontos para comprometer, todos os ramos são informados para comprometer. Se algum ramo indicar que não estava pronto para comprometer, todos os ramos são informados para reverter.

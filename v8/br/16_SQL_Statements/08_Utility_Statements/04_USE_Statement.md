...
A declaração `USE` instrui o MySQL a usar o banco de dados nomeado como o banco de dados padrão (atual) para declarações subsequentes. Esta declaração requer algum privilégio para o banco de dados ou algum objeto dentro dele.

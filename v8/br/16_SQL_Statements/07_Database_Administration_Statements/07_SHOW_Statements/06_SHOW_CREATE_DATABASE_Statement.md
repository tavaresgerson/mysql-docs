...
A tabela e os nomes das colunas são citados pelo `SHOW CREATE DATABASE` de acordo com o valor da opção `sql_quote_show_create`. Veja a Seção 7.1.8, “Variáveis do Sistema do Servidor”.

### 15.6.8 Restrições para o manuseio de condições

`SIGNAL`, `RESIGNAL` e `GET DIAGNOSTICS` não são permitidos como instruções preparadas. Por exemplo, essa instrução é inválida:

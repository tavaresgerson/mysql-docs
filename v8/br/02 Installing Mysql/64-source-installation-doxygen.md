...
1. Instale o `doxygen` 1.9.2 ou versão posterior. As distribuições estão disponíveis aqui em <http://www.doxygen.nl/>.
...
3. Defina o `PLANTUML_JAR_PATH` ambiente para o local onde você instalou o PlantUML. Por exemplo:

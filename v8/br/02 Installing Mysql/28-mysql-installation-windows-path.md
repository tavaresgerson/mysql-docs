...
- Coloque o cursor no final do texto que aparece no espaço marcado Valor variável. (Use a tecla `End` para garantir que o cursor esteja posicionado no final do texto neste espaço.) Em seguida, insira o nome completo do caminho do seu diretório MySQL `bin` (por exemplo, `C:\Program Files\MySQL\MySQL Server 8.4\bin`)

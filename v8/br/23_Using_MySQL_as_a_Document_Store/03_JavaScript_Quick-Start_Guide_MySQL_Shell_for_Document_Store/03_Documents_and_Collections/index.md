...
Os exemplos nesta seção usam a coleção `countryinfo` no esquema `world_x`. Para obter instruções sobre como configurar o esquema `world_x`, consulte a Seção 22.3.2, “Baixar e importar o banco de dados world\_x”.

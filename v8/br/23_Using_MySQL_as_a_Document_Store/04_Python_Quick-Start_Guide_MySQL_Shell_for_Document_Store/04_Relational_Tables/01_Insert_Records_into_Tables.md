...
Para inserir um registro completo, passe para o método `insert()` todas as colunas da tabela. Em seguida, passe para o método `values()` um valor para cada coluna. Por exemplo, para adicionar um novo registro à tabela de cidades no banco de dados `world_x`, insira o seguinte registro e pressione **Enter** duas vezes.

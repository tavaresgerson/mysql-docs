...
Para inserir um documento na coluna de uma tabela, passe para o método `values()` um documento JSON bem formado na ordem correta. No exemplo a seguir, um documento é passado como o valor final a ser inserido na coluna Info.
...
- Consulte a Seção 13.5, “O Tipo de Dados JSON”, para uma descrição detalhada do tipo de dados.

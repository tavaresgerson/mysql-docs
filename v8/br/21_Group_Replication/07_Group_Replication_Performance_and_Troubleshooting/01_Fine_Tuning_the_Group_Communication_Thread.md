### 20.7.1 Ajustar o fio de comunicação do grupo
...
Para forçar o GCT a fazer uma espera ativa, use a opção `group_replication_poll_spin_loops`, que faz o GCT fazer um loop, sem fazer nada relevante para o número configurado de loops, antes de realmente coletar a fila para a próxima mensagem.

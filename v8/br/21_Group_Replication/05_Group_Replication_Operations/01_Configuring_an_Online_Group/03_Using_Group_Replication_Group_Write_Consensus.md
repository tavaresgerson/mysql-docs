#### 20.5.1.3 Usar o consenso de escrita de grupo de replicação de grupo

Esta seção explica como inspecionar e configurar o número máximo de instâncias de consenso a qualquer momento para um grupo. Esse máximo é referido como o horizonte de eventos para um grupo e é o número máximo de instâncias de consenso que o grupo pode executar em paralelo. Isso permite que você ajuste o desempenho da implantação da Replicação de Grupo. Por exemplo, o valor padrão de 10 é adequado para um grupo que está em uma LAN, mas para grupos que operam em uma rede mais lenta, como uma WAN, aumente esse número para melhorar o desempenho.

...
* `myisamchk -m tbl_name`
  ...
  Isso encontra 99,999% de todos os erros. Primeiro, ele verifica todas as entradas de índice em busca de erros e, em seguida, lê todas as linhas. Ele calcula um checksum para todos os valores de chave nas linhas e verifica se o checksum corresponde ao checksum para as chaves na árvore de índice.

...
Esta seção fornece alguns exemplos que mostram os resultados das consultas de matemática de precisão no MySQL. Esses exemplos demonstram os princípios descritos nas Seções 14.24.3, “Tratamento de Expressões”, e 14.24.4, “Comportamento de Arredondamento”.
...
A soma de ambos os `d` e `f` logicamente deve ser 1, mas isso é verdadeiro apenas para o cálculo decimal. O cálculo de ponto flutuante introduz pequenos erros:
...
- O arredondamento para colunas de valor exato (`DECIMAL` - DECIMAL, NUMERIC) e inteiros) e números com valor exato usa a regra "arredonde para o lado oposto de zero". Um valor com uma parte fracionária de .5 ou maior é arredondado para o lado oposto de zero para o número inteiro mais próximo, como mostrado aqui:

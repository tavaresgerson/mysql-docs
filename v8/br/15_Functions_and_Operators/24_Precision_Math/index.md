...
14.24.3 Gerenciamento de Expressões
...
- **Cálculos precisos**: Para números com valor exato, os cálculos não introduzem erros de ponto flutuante. Em vez disso, é usada precisão exata. Por exemplo, o MySQL trata um número como `.0001` como um valor exato, em vez de uma aproximação, e somando-o 10.000 vezes, o resultado é exatamente `1`, e não um valor que é apenas “próximo” de 1.

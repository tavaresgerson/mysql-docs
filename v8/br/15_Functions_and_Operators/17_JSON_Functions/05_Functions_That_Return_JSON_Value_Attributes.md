...
- `JSON_TYPE(json_val)`
  ...
  Para um resultado não `NULL`, não erro, a seguinte lista descreve os possíveis valores de retorno `JSON_TYPE()`:
  ...
  - Tipos de strings:
    ...
    - `STRING`: Tipos de caracteres escalares do MySQL `utf8mb3`: `CHAR`, `VARCHAR`, `TEXT`, `ENUM` e `SET`

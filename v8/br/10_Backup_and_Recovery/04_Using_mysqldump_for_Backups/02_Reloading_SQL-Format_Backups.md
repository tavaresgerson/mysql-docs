...
Para usuários do Windows PowerShell: Como o caractere "<" é reservado para uso futuro no PowerShell, é necessário uma abordagem alternativa, como o uso de aspas `cmd.exe /c "mysql < dump.sql"`.

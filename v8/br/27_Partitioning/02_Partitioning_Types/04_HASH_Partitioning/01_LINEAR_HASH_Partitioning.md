...
Suponha que a tabela `t1`, usando partição hash linear e com 6 partições, seja criada usando esta declaração:
...
Agora, suponha que você queira inserir dois registros no `t1` com os valores das colunas `col3` e `'1998-10-19'`. O número de partição para o primeiro desses registros é determinado da seguinte forma:

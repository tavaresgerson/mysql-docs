## 27.2 Uso de Rotinas Armazenadas
...
27.2.4 Procedimentos Armazenados, Funções, Triggers e LAST\_INSERT\_ID()
...
- Você pode achar útil o Fórum de Usuários de Procedimentos Armazenados ao trabalhar com procedimentos e funções armazenadas.

- Para respostas a algumas perguntas frequentes sobre rotinas armazenadas no MySQL, consulte a Seção A.4, “Perguntas Frequentes do MySQL 8.0: Procedimentos e Funções Armazenadas”.

- Há algumas restrições sobre o uso de rotinas armazenadas. Veja a Seção 27.8, “Restrições sobre Programas Armazenados”.

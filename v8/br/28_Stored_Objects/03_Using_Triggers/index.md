...
- Você pode achar os fóruns de usuários do MySQL úteis ao trabalhar com gatilhos.

- Para respostas a perguntas frequentes sobre gatilhos no MySQL, consulte a Seção A.5, “Perguntas Frequentes do MySQL 8.0: Gatilhos”.

...
O `utf32` ocupa o dobro do espaço do `ucs2` e mais espaço do que o `utf16`, mas o `utf32` tem a mesma vantagem do `ucs2` de ser previsível para armazenamento: O número de bytes necessários para `utf32` é igual ao número de caracteres vezes 4. Além disso, diferente do `utf16`, não há truques para codificação no `utf32`, então o valor armazenado é igual ao valor do código.

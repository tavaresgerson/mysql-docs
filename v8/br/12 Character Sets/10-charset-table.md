...
O conjunto de caracteres da tabela e a colagem são usados como valores padrão para as definições de coluna se a colagem e o conjunto de caracteres da coluna não forem especificados nas definições de coluna individuais. O conjunto de caracteres da tabela e a colagem são extensões do MySQL; não existem tais coisas no SQL padrão.
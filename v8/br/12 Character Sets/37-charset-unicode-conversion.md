...
* `utf8mb3` usa um máximo de três bytes por caractere. `utf8mb4` usa um máximo de quatro bytes por caractere. ::: info Nota
...
* `SET NAMES 'utf8mb4'` causa o uso do conjunto de caracteres de 4 bytes para conjuntos de caracteres de conexão. Enquanto nenhum caractere de 4 bytes for enviado pelo servidor, não deve haver problemas. Caso contrário, aplicativos que esperam receber um máximo de três bytes por caractere podem ter problemas. Por outro lado, aplicativos que esperam enviar caracteres de 4 bytes devem garantir que o servidor os entenda.
* Para replicação, se conjuntos de caracteres que suportam caracteres suplementares devem ser usados na fonte, todas as réplicas devem entendê-los também.

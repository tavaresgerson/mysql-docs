...
O conjunto de caracteres `utf8mb3` é desatualizado. `utf8mb3` continua sendo suportado pelo tempo de vida das séries de lançamentos MySQL 8.0.x e MySQL 8.4.x LTS.
...
`utf8mb3` também é válido (mas desatualizado) em contextos diferentes de cláusulas de `CHARACTER SET`. Por exemplo:

...
Mensagens de erro retornadas pelo servidor para o cliente são convertidas para o conjunto de caracteres do cliente automaticamente, como com os metadados.

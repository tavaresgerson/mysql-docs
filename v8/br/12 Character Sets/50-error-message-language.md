...
* Se o arquivo de mensagem não for encontrado no diretório construído como descrito acima, o servidor ignora o valor `lc_messages` e usa apenas o valor `lc_messages_dir` como local para procurar.

...
- `in_start_fresh BOOLEAN`: Se deve reiniciar todos os dados do Schema de Desempenho antes da execução do rastreamento.
...
- `in_debug BOOLEAN`: Se incluir as informações de `file:lineno` no gráfico.

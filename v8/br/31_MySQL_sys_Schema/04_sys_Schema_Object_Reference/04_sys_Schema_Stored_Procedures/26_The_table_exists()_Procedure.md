#### 30.4.4.26 Procedimento table\_exists()
...
- `in_table VARCHAR(64)`: O nome da tabela a ser verificada para verificar sua existência.

- `out_exists ENUM('', 'BASE TABLE', 'VIEW', 'TEMPORARY')`: O valor de retorno. Este é um parâmetro `OUT`, portanto, ele deve ser uma variável na qual o tipo de tabela pode ser armazenado. Quando o procedimento retornar, a variável terá um dos seguintes valores para indicar se a tabela existe:

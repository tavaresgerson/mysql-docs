#### 30.4.5.1 A função extract\_schema\_from\_file\_name()

Dada um nome de caminho de arquivo, retorna o componente de caminho que representa o nome do esquema. Esta função assume que o nome do arquivo está dentro do diretório do esquema. Por essa razão, ela não funciona com partições ou tabelas definidas usando a opção de tabela `DATA_DIRECTORY` própria.

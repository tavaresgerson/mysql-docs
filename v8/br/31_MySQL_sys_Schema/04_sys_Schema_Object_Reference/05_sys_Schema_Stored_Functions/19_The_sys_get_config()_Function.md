#### 30.4.5.19 A função sys\_get\_config()
...
- `in_variable_name VARCHAR(128)`: O nome da opção de configuração para a qual deseja-se retornar o valor.

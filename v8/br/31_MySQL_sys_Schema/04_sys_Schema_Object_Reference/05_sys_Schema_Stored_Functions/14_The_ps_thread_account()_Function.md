...
- `in_thread_id BIGINT UNSIGNED`: O ID do thread para o qual você deseja retornar a conta. O valor deve corresponder à coluna `THREAD_ID` de alguma linha da tabela do `threads` do Gerenciamento de Desempenho.

#### 30.4.3.40 As declarações com tabelas temporárias e as visualizações x$declarações com tabelas temporárias
...
As visualizações `statements_with_temp_tables` e `x$statements_with_temp_tables` possuem essas colunas:

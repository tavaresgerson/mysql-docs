...
As visualizações `io_by_thread_by_latency` e `x$io_by_thread_by_latency` possuem essas colunas:
...
- `processlist_id`
  ...
  Para os threads de primeiro plano, o ID do processo list. Para os threads de segundo plano, `NULL`.

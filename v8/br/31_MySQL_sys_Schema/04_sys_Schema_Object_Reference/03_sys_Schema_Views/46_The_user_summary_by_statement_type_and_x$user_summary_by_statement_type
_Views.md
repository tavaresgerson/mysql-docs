#### 30.4.3.46 As visualizações user\_summary\_by\_statement\_type e x$user\_summary\_by\_statement\_type
...
As visualizações `user_summary_by_statement_type` e `x$user_summary_by_statement_type` possuem essas colunas:

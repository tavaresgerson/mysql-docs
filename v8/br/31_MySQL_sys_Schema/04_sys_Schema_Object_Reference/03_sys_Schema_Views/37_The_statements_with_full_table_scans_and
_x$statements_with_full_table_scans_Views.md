#### 30.4.3.37 As declarações com varreduras completas da tabela e as visualizações x$declarativas\_com\_varreduras\_completos\_da\_tabela
...
As visualizações `statements_with_full_table_scans` e `x$statements_with_full_table_scans` possuem essas colunas:

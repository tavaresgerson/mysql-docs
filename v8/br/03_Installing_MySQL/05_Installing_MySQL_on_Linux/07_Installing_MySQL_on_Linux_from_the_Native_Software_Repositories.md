...
- **Red Hat Linux, Fedora, CentOS**
  ...
  Agora, o MySQL e o servidor MySQL devem estar instalados. Um arquivo de configuração de exemplo está instalado em `/etc/my.cnf`. Para iniciar o servidor MySQL, use **systemctl**:
...
- **Debian, Ubuntu, Kubuntu**
  ...
  Para as versões do Debian e Ubuntu suportadas, o MySQL pode ser instalado usando o Repositório APT do MySQL em vez do repositório de software nativo da plataforma. Consulte a Seção 2.5.2, “Instalando o MySQL no Linux Usando o Repositório APT do MySQL”, para obter detalhes.
  ...
  Antes de instalar, certifique-se de que você atualize seus arquivos de índice `apt-get` para garantir que esteja baixando a versão mais recente disponível.
  ...
  O servidor já deve estar iniciado. Você pode iniciar e parar o servidor manualmente usando:

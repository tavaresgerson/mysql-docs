...
A seguinte chave de construção pública do GPG (keyID `3A79BD29`) pode ser usada para verificar a autenticidade e a integridade das versões dos pacotes do MySQL 8.0.28 a 8.0.35, 8.1.0 e 8.2.0. Para instruções de verificação de assinatura, consulte a Seção 2.1.4.2, “Verificação de Assinatura Usando o GnuPG”. Ela expirou em 14 de dezembro de 2023.

##### Chave de construção pública do GPG para pacotes do MySQL 8.0.36 a 8.0.43, e 8.3.0 a 8.4.6, e 9.0.0 a 9.4.0
...
##### Chave de construção pública do GPG para MySQL 8.0.28 a 8.0.35 e pacotes 8.1.0/8.2.0
...
A seguinte chave de compilação pública do GPG (keyID `5072E1F5`) pode ser usada para verificar a autenticidade e a integridade dos pacotes do MySQL 8.0.27 e anteriores. Para instruções de verificação de assinatura, consulte a Seção 2.1.4.2, “Verificação de Assinatura Usando o GnuPG”.

##### Chave de construção pública do GPG para pacotes do MySQL 8.0.27 e versões anteriores

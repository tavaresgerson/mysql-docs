...
A chave de construção pública GPG para pacotes de versões anteriores do MySQL (keyID `A8D3785C`, `5072E1F5` ou `3A79BD29`), consulte a Seção 2.1.4.5, “Chave de Construção Pública GPG para Pacotes Arquivados”.
...
<table><thead><tr> <th>Tipo de arquivo</th> <th>Nome do arquivo</th> </tr></thead><tbody><tr> <td>Arquivo de distribuição</td> <td>[[<code>mysql-8.0.44-linux-glibc2.28-x86_64.tar.xz</code>]]</td> </tr><tr> <td>Arquivo de assinatura</td> <td>[[<code>mysql-8.0.44-linux-glibc2.28-x86_64.tar.xz.asc</code>]]</td> </tr></tbody></table>
...
Se o pacote baixado for válido, você deve ver uma mensagem `Good signature` semelhante a esta:

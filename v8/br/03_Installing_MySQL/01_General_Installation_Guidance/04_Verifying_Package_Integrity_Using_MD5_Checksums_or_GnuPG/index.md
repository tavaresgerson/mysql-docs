...
Depois de baixar o pacote MySQL que atende às suas necessidades e antes de tentar instalá-lo, certifique-se de que ele está intacto e não foi alterado. Existem três meios de verificação de integridade:

- Códigos de verificação MD5

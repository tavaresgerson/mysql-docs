...
- **Aliases do sistema de arquivos**
  ...
  Essa ferramenta é frequentemente usada para mover os arquivos de dados e de índice para um RAID ou outra solução rápida.
...
- **Diretório e nomes de arquivos**
  ...
  A mesma limitação se aplica aos nomes de diretórios e arquivos mencionados em declarações SQL, como o nome do caminho do arquivo de dados em `LOAD DATA`.

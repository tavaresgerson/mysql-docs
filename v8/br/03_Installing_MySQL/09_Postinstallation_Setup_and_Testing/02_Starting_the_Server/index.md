...
Para sistemas Linux nos quais o MySQL é instalado usando pacotes RPM, o início e o desligamento do servidor são gerenciados usando o systemd, e não o **mysqld\_safe**, e o **mysqld\_safe** não é instalado. Veja a Seção 2.5.9, “Gerenciamento do Servidor MySQL com o systemd”.

...
- Opcionalmente, preencha as tabelas de fuso horário para permitir o reconhecimento de fusos horários nomeados. Para obter instruções, consulte a Seção 7.1.15, "Suporte de Fuso Horário do MySQL Server".

Quando estiver pronto para criar contas de usuário adicionais, você pode encontrar informações sobre o sistema de controle de acesso e gerenciamento de contas do MySQL na Seção 8.2, “Controle de Acesso e Gerenciamento de Contas”.

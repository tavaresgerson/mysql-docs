...
No GitHub, o MySQL Server e outros projetos do MySQL estão disponíveis na página do MySQL. O projeto MySQL Server é um único repositório que contém ramos para várias séries do MySQL.
...
6. Para obter as alterações feitas após a configuração inicial do repositório Git do MySQL, mude para o ramo que deseja atualizar e execute o comando **git pull**:
   ...
   Você também pode navegar pelo histórico de commits e pelo código-fonte no site do GitHub MySQL.

   Se você vir alterações ou código sobre o qual você tenha alguma dúvida, pergunte no Slack da Comunidade MySQL.

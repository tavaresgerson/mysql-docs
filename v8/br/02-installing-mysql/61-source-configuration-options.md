...
<table frame="box" rules="all" summary="CMake opções que estão disponíveis para configurar o MySQL ao construir a partir do código fonte."><col style="width: 37%"/><col style="width: 37%"/><col style="width: 25%"/><thead><tr><th scope="col">Formato</th> <th scope="col">Descrição</th> <th scope="col">Default</th> </tr></thead><tbody><tr><th>[[PH_HTML_CODE_<code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se permitir a geração de secção .gdb_index em arquivos binários</td> <td></td> </tr><tr><th>[[PH_HTML_CODE_<code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Usar as mesmas opções de compilação que as versões oficiais</td> <td></td> </tr><tr><th>[[PH_HTML_CODE_<code>PREFIX/lib/plugin</code>]</th> <td>Embalagem de bibliotecas de tempo de execução com pacotes MSI e Zip para Windows</td> <td>[[PH_HTML_CODE_<code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[PH_HTML_CODE_<code>INSTALL_SBINDIR</code>]</th> <td>Tipo de construção a produzir</td> <td>[[PH_HTML_CODE_<code>PREFIX/bin</code>]</td> </tr><tr><th>[[PH_HTML_CODE_<code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Bandeiras para o compilador C++</td> <td></td> </tr><tr><th>[[PH_HTML_CODE_<code>platform specific</code>]</th> <td>Bandeiras para o compilador C</td> <td></td> </tr><tr><th>[[PH_HTML_CODE_<code>INSTALL_SHAREDIR</code>]</th> <td>Diretório da base de instalação</td> <td>[[PH_HTML_CODE_<code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Comentário sobre o ambiente de compilação</td> <td></td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Comentário sobre o ambiente de compilação para uso pelo mysqld</td> <td></td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>PREFIX/lib/plugin</code>]</th> <td>Compressar seções de depuração de executáveis binários</td> <td>[[<code>BUILD_CONFIG</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>INSTALL_SBINDIR</code>]</th> <td>Se a compilação de pacotes produz um único ficheiro</td> <td>[[<code>BUILD_CONFIG</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Conjunto de caracteres padrão do servidor</td> <td>[[<code>BUILD_CONFIG</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>BUILD_CONFIG</code><code>INSTALL_SHAREDIR</code>]</th> <td>A collação padrão do servidor</td> <td>[[<code>BUILD_CONFIG</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Excluir a instrumentação das condições do esquema de desempenho</td> <td>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>PREFIX/lib/plugin</code>]</th> <td>Excluir a instrumentação de bloqueio de dados do esquema de desempenho</td> <td>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_SBINDIR</code>]</th> <td>Excluir a instrumentação de erro do servidor do esquema de desempenho</td> <td>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Excluir a instrumentação do ficheiro do esquema de desempenho</td> <td>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>INSTALL_SHAREDIR</code>]</th> <td>Excluir a instrumentação em vazio do esquema de desempenho</td> <td>[[<code>BUNDLE_RUNTIME_LIBRARIES</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Excluir a instrumentação de memória do esquema de desempenho</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</th> <td>Excluir a instrumentação dos metadados do esquema de desempenho</td> <td>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</th> <td>Excluir a instrumentação de desempenho do Schema mutex</td> <td>[[<code>OFF</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Excluir as declarações preparadas para o esquema de desempenho</td> <td>[[<code>OFF</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>Excluir a instrumentação de bloqueio do esquema de desempenho</td> <td>[[<code>OFF</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Excluir a instrumentação do soquete do esquema de desempenho</td> <td>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>CMAKE_BUILD_TYPE</code><code>PREFIX/lib/plugin</code>]</th> <td>Excluir a instrumentação do programa armazenado no Performance Schema</td> <td>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_SBINDIR</code>]</th> <td>Excluir a instrumentação da fase do esquema de desempenho</td> <td>[[<code>CMAKE_BUILD_TYPE</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Excluir a instrumentação da declaração do esquema de desempenho</td> <td>[[<code>CMAKE_BUILD_TYPE</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>CMAKE_BUILD_TYPE</code><code>INSTALL_SHAREDIR</code>]</th> <td>Excluir declarações de esquema de desempenho_digest instrumentação</td> <td>[[<code>CMAKE_BUILD_TYPE</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>RelWithDebInfo</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Excluir a instrumentação da tabela do esquema de desempenho</td> <td>[[<code>RelWithDebInfo</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>RelWithDebInfo</code><code>PREFIX/lib/plugin</code>]</th> <td>Excluir a instrumentação de rosca do esquema de desempenho</td> <td>[[<code>RelWithDebInfo</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>RelWithDebInfo</code><code>INSTALL_SBINDIR</code>]</th> <td>Excluir a instrumentação de transacções do esquema de desempenho</td> <td>[[<code>RelWithDebInfo</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>RelWithDebInfo</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Se habilitar LOCAL para LOAD DATA</td> <td>[[<code>RelWithDebInfo</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>RelWithDebInfo</code><code>INSTALL_SHAREDIR</code>]</th> <td>Se o código de perfis de consulta deve ser habilitado</td> <td>[[<code>RelWithDebInfo</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se as variáveis experimentais do sistema InnoDB estão habilitadas</td> <td>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>PREFIX/lib/plugin</code>]</th> <td>Incluir ou não o suporte do GCOV</td> <td></td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Ativar gprof (somente compilações do Linux otimizadas)</td> <td>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>PREFIX/bin</code>]</th> <td>Se a saída do compilador deve ser colorida</td> <td>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>platform specific</code>]</th> <td>Se forçar uma compilação no código-fonte</td> <td>[[<code>CMAKE_CXX_FLAGS</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_CXX_FLAGS</code><code>PREFIX/share</code>]</th> <td>Permitir compiladores não suportados</td> <td>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se deve gerar dados de otimização guiados por perfis</td> <td>[[<code>CMAKE_C_FLAGS</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Utilização de dados de otimização guiados por perfis</td> <td>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_C_FLAGS</code><code>PREFIX/bin</code>]</th> <td>Ativar o módulo de rastreamento de memória de esquema de desempenho para funções de alocação de memória utilizadas em armazenamento dinâmico de tipos sobre-alinhados</td> <td>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_C_FLAGS</code><code>platform specific</code>]</th> <td>Com -DBUILD_CONFIG=mysql_release, ignore a verificação libaio</td> <td>[[<code>CMAKE_C_FLAGS</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_C_FLAGS</code><code>PREFIX/share</code>]</th> <td>Diretório de executáveis do usuário</td> <td>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Repertório de documentação</td> <td>[[<code>CMAKE_INSTALL_PREFIX</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Directório de arquivos README</td> <td>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_INSTALL_PREFIX</code><code>PREFIX/bin</code>]</th> <td>Diretório do arquivo de cabeçalho</td> <td>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_INSTALL_PREFIX</code><code>platform specific</code>]</th> <td>Diretório de ficheiros de informação</td> <td>[[<code>CMAKE_INSTALL_PREFIX</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>CMAKE_INSTALL_PREFIX</code><code>PREFIX/share</code>]</th> <td>Selecionar o layout predefinido da instalação</td> <td>[[<code>/usr/local/mysql</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>/usr/local/mysql</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Diretório de arquivos de biblioteca</td> <td>[[<code>/usr/local/mysql</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>/usr/local/mysql</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Guia de páginas manuais</td> <td>[[<code>/usr/local/mysql</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>/usr/local/mysql</code><code>PREFIX/bin</code>]</th> <td>Directório de dados partilhados</td> <td>[[<code>/usr/local/mysql</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>/usr/local/mysql</code><code>platform specific</code>]</th> <td>diretório mysql-test</td> <td>[[<code>/usr/local/mysql</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>/usr/local/mysql</code><code>PREFIX/share</code>]</th> <td>Diretório para o arquivo mysqlclient.pc pkg-config</td> <td>[[<code>INSTALL_LIBDIR/pkgconfig</code>]]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Diretório de Plugins</td> <td>[[<code>PREFIX/lib/plugin</code>]]</td> </tr><tr><th>[[<code>INSTALL_PRIV_LIBDIR</code>]]</th> <td>Directório de instalação de biblioteca privada</td> <td></td> </tr><tr><th>[[<code>INSTALL_SBINDIR</code>]]</th> <td>Diretório executável do servidor</td> <td>[[<code>PREFIX/bin</code>]]</td> </tr><tr><th>[[<code>INSTALL_SECURE_FILE_PRIVDIR</code>]]</th> <td>Valor padrão de secure_file_priv</td> <td>[[<code>platform specific</code>]]</td> </tr><tr><th>[[<code>INSTALL_SHAREDIR</code>]]</th> <td>diretório de instalação aclocal/mysql.m4</td> <td>[[<code>PREFIX/share</code>]]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se instalar bibliotecas estáticas</td> <td>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT_SERVER</code><code>PREFIX/lib/plugin</code>]</th> <td>Directório de arquivos de suporte adicionais</td> <td>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_SBINDIR</code>]</th> <td>Se a ordem dos símbolos no sistema binário mysqld deve ser aleatória</td> <td>[[<code>COMPILATION_COMMENT_SERVER</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Valor de semente para a opção LINK_RANDOMIZE</td> <td>[[<code>COMPILATION_COMMENT_SERVER</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>COMPILATION_COMMENT_SERVER</code><code>INSTALL_SHAREDIR</code>]</th> <td>Índices máximos por quadro</td> <td>[[<code>COMPILATION_COMMENT_SERVER</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Ativar a análise do código MSVC.</td> <td>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>PREFIX/lib/plugin</code>]</th> <td>Tipo InnoDB mutex</td> <td>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_SBINDIR</code>]</th> <td>Número de porta TCP/IP usado pelo X Plugin</td> <td>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Arquivo de soquete do Unix usado pelo X Plugin</td> <td>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>INSTALL_SHAREDIR</code>]</th> <td>Repertório de dados</td> <td></td> </tr><tr><th>[[<code>COMPRESS_DEBUG_SECTIONS</code><code>PREFIX/share</code>]</th> <td>Ativar ou não o ambiente de desenvolvimento específico do mantenedor do MySQL</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Nome do projeto Windows/macOS</td> <td>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Número da porta TCP/IP</td> <td>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/bin</code>]</th> <td>Arquivo de soquete Unix</td> <td>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>platform specific</code>]</th> <td>Fazer com que as ferramentas do NDB estejam ligadas dinamicamente ao cliente do NDB</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>ODBC inclui diretório</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/share</code>]</th> <td>Diretório da biblioteca ODBC</td> <td></td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se o rastreamento do optimizador deve ser suportado</td> <td></td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se otimizar construções de desinfetante</td> <td>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Tome cuidado extra para criar um resultado de construção independente de construção local e tempo</td> <td></td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_SBINDIR</code>]</th> <td>Se mostrar avisos de compilador suprimidos e não falhar com -Werror.</td> <td>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Diretório de arquivos de opções</td> <td></td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>platform specific</code>]</th> <td>Directório para arquivo PID sob systemd</td> <td>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>CPACK_MONOLITHIC_INSTALL</code><code>PREFIX/share</code>]</th> <td>Nome do serviço MySQL sob systemd</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Valor padrão de tmpdir</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</th> <td>Desativar a função inlining</td> <td>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</th> <td>Não construa o servidor; apenas para uso interno</td> <td>[[<code>OFF</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Excluir o motor de armazenamento xxx da construção</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>platform specific</code>]</th> <td>Caminho para a Ant para a construção do wrapper Java da GCS</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>Ativar AddressSanitizer</td> <td>[[<code>OFF</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Ativar AddressSanitizer -fsanitize-address-use-after-scope Clang flag</td> <td>[[<code>DEFAULT_CHARSET</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>PREFIX/lib/plugin</code>]</th> <td>Ativado automaticamente se qualquer plug-in de autenticação de servidor correspondente for construído</td> <td></td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Se deve ser comunicado um erro se os complementos de autenticação LDAP não puderem ser construídos</td> <td>[[<code>DEFAULT_CHARSET</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>PREFIX/bin</code>]</th> <td>Construir plugin de autenticação PAM</td> <td>[[<code>DEFAULT_CHARSET</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>platform specific</code>]</th> <td>Localização do kit de desenvolvimento de software do Amazon Web Services</td> <td></td> </tr><tr><th>[[<code>DEFAULT_CHARSET</code><code>INSTALL_SHAREDIR</code>]</th> <td>Em sistemas Linux, gerar um ID de compilação exclusivo</td> <td>[[<code>DEFAULT_CHARSET</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>utf8mb4</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Path de classes para usar ao criar o MySQL Cluster Connector para Java. O padrão é uma string vazia.</td> <td>[[<code>utf8mb4</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>utf8mb4</code><code>PREFIX/lib/plugin</code>]</th> <td>Construir o protocolo de rastreamento do lado do cliente</td> <td>[[<code>utf8mb4</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4</code><code>INSTALL_SBINDIR</code>]</th> <td>Localização da biblioteca de curl</td> <td></td> </tr><tr><th>[[<code>utf8mb4</code><code>PREFIX/bin</code>]</th> <td>Se incluir suporte para depuração</td> <td>[[<code>utf8mb4</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4</code><code>platform specific</code>]</th> <td>Se usar opções padrão do compilador</td> <td>[[<code>utf8mb4</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4</code><code>PREFIX/share</code>]</th> <td>Se adicionar o direito "get-task-allow" a todos os executáveis no macOS para gerar um core dump em caso de parada inesperada do servidor</td> <td>[[<code>DEFAULT_COLLATION</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DEFAULT_COLLATION</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Qual biblioteca libedit/editline usar</td> <td>[[<code>DEFAULT_COLLATION</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>DEFAULT_COLLATION</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Ativar a injeção de erros no motor de armazenamento NDB. Não deve ser utilizado para a construção de binários destinados à produção.</td> <td>[[<code>DEFAULT_COLLATION</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>DEFAULT_COLLATION</code><code>PREFIX/bin</code>]</th> <td>Tipo de suporte da UTI</td> <td>[[<code>DEFAULT_COLLATION</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>DEFAULT_COLLATION</code><code>platform specific</code>]</th> <td>Se incluir suporte extra de depuração para InnoDB.</td> <td>[[<code>DEFAULT_COLLATION</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>DEFAULT_COLLATION</code><code>PREFIX/share</code>]</th> <td>Se ligar com -ljemalloc</td> <td>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Se utilizar o LLVM Ild ou molde linker</td> <td>[[<code>utf8mb4_0900_ai_ci</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Qual biblioteca libevent usar</td> <td>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4_0900_ai_ci</code><code>PREFIX/bin</code>]</th> <td>Incluir ou não suporte para libwrap (wrappers TCP)</td> <td>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4_0900_ai_ci</code><code>platform specific</code>]</th> <td>Se a ferramenta LOCK_ORDER deve ser habilitada</td> <td>[[<code>utf8mb4_0900_ai_ci</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>utf8mb4_0900_ai_ci</code><code>PREFIX/share</code>]</th> <td>Se executar LeakSanitizer, sem AddressSanitizer</td> <td>[[<code>DISABLE_PSI_COND</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_COND</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Ativar o optimizador de tempo de ligação</td> <td>[[<code>DISABLE_PSI_COND</code><code>PREFIX/lib/plugin</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_COND</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Tipo de suporte à biblioteca LZ4</td> <td>[[<code>DISABLE_PSI_COND</code><code>INSTALL_SBINDIR</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_COND</code><code>PREFIX/bin</code>]</th> <td>Compila MeCab</td> <td></td> </tr><tr><th>[[<code>DISABLE_PSI_COND</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Ativar o MemorySanitizer</td> <td>[[<code>DISABLE_PSI_COND</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_COND</code><code>INSTALL_SHAREDIR</code>]</th> <td>Ativar o rastreamento de vazamento de memória Visual Studio CRT</td> <td>[[<code>DISABLE_PSI_COND</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Desativar o protocolo X</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</th> <td>Construir MySQL NDB Cluster, incluindo o motor de armazenamento NDB e todos os programas NDB</td> <td>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</th> <td>Crie programas de exemplo de API.</td> <td>[[<code>OFF</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>NDB 8.0.30 e anteriores: Construa o motor de armazenamento NDB. NDB 8.0.31 e posterior: Desaproveitado; use WITH_NDB em vez disso</td> <td>[[<code>OFF</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>Antes da NDB 8.0.31, isso era apenas para uso interno.</td> <td>[[<code>OFF</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Construir um nó de dados binário multithreaded</td> <td>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_DATA_LOCK</code><code>PREFIX/lib/plugin</code>]</th> <td>Produzir uma compilação de depuração para testes ou solução de problemas.</td> <td>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_SBINDIR</code>]</th> <td>Ativar a construção do suporte Java e ClusterJ. Ativado por padrão. Só suportado no MySQL Cluster.</td> <td>[[<code>DISABLE_PSI_DATA_LOCK</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Porta padrão usada por um servidor de gerenciamento construído com esta opção. Se esta opção não foi usada para construí-lo, a porta padrão do servidor de gerenciamento é 1186.</td> <td>[[<code>DISABLE_PSI_DATA_LOCK</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_DATA_LOCK</code><code>INSTALL_SHAREDIR</code>]</th> <td>Incluir os programas de teste da API do NDB.</td> <td>[[<code>DISABLE_PSI_DATA_LOCK</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Caminho padrão usado pelos programas NDB para procurar arquivos de certificado e chave TLS.</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</th> <td>Definição da política de atribuição de memória NUMA</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Para as bandeiras normalmente utilizadas para pacotes RPM/DEB, se devem ser adicionadas a compilações independentes nessas plataformas</td> <td></td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</th> <td>Qual pacote de Protocol Buffers usar</td> <td>[[<code>OFF</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Se construir plugins de ciclo de desenvolvimento rápido</td> <td>[[<code>OFF</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>Tipo de suporte ao RapidJSON</td> <td>[[<code>OFF</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Construir ou não Roteador MySQL</td> <td>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>PREFIX/lib/plugin</code>]</th> <td>Apenas para uso interno</td> <td></td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_PRIV_LIBDIR</code>]</th> <td>Suporte para instruções de depuração SHOW PARSE_TREE</td> <td></td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_SBINDIR</code>]</th> <td>Tipo de suporte SSL</td> <td>[[<code>DISABLE_PSI_ERROR</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Permitir a instalação de arquivos de suporte do systemd</td> <td>[[<code>DISABLE_PSI_ERROR</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_ERROR</code><code>INSTALL_SHAREDIR</code>]</th> <td>Ativar informações adicionais de depuração do sistema</td> <td>[[<code>DISABLE_PSI_ERROR</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Defina o valor de sistema das opções de biblioteca não definidas explicitamente</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>PREFIX/lib/plugin</code>]</th> <td>Se ligar com -ltcmalloc. BUNDLED é suportado apenas no Linux</td> <td>[[<code>OFF</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SBINDIR</code>]</th> <td>Construir protocolo de teste plug-in de rastreamento</td> <td>[[<code>OFF</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Ativar o ThreadSanitizer</td> <td>[[<code>OFF</code><code>platform specific</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_SHAREDIR</code>]</th> <td>Ativar Desinfetante de Comportamento Não Definido</td> <td>[[<code>OFF</code><code>PREFIX/share</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Compilar MySQL com testes unitários</td> <td>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>PREFIX/lib/plugin</code>]</th> <td>Ativar suporte UNIXODBC</td> <td>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_PRIV_LIBDIR</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_SBINDIR</code>]</th> <td>Se deve compilar em arquivos de cabeçalho Valgrind</td> <td>[[<code>DISABLE_PSI_FILE</code><code>PREFIX/bin</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_SECURE_FILE_PRIVDIR</code>]</th> <td>Caminho para o diretório que contém jemalloc.dll</td> <td></td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>platform specific</code>]</th> <td>Tipo de suporte zlib</td> <td>[[<code>DISABLE_PSI_FILE</code><code>INSTALL_SHAREDIR</code>]</td> </tr><tr><th>[[<code>DISABLE_PSI_FILE</code><code>PREFIX/share</code>]</th> <td>Tipo de suporte zstd</td> <td>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</td> </tr><tr><th>[[<code>OFF</code><code>INSTALL_LIBDIR/pkgconfig</code>]</th> <td>Compilar o motor de armazenamento xxx estaticamente no servidor</td> <td></td> </tr></tbody></table>
...
Onde instalar o `aclocal/mysql.m4`.
...
A localização do diretório de dados MySQL.

Este valor pode ser definido na inicialização do servidor com a opção `--datadir`.

- `-DODBC_INCLUDES=dir_name`

A localização do ODBC inclui o diretório, que pode ser usado ao configurar o Connector/ODBC.
...
Por exemplo, para compilar sem instrumentação mutex, configure o MySQL usando `-DDISABLE_PSI_MUTEX=1`.
...
Se excluir a instrumentação ociosa do Performance Schema. O padrão é `OFF` (incluir).
...
Se deve excluir a instrumentação de bloqueio rwlock do esquema de desempenho. O padrão é `OFF` (incluir).

- `-DDISABLE_PSI_SOCKET=bool`

Se excluir a instrumentação do soquete do Performance Schema. O padrão é `OFF` (incluir).
...
Se excluir a instrumentação de estágio do esquema de desempenho. O padrão é `OFF` (incluir).

- `-DDISABLE_PSI_STATEMENT=bool`

Se excluir a instrumentação de instrução do esquema de desempenho. O padrão é `OFF` (incluir).
...
Excluir a instrumentação de transação do Performance Schema. O padrão é `OFF` (incluir).
...
Se habilitar variáveis experimentais do sistema `InnoDB`. As variáveis experimentais do sistema são destinadas àqueles envolvidos no desenvolvimento do MySQL, devem ser usadas apenas em um ambiente de desenvolvimento ou teste, e podem ser removidas sem aviso prévio em uma versão futura do MySQL. Para informações sobre variáveis experimentais do sistema, consulte `/storage/innobase/handler/ha_innodb.cc` na árvore de fontes do MySQL. As variáveis experimentais do sistema podem ser identificadas pesquisando PLUGIN\_VAR\_EXPERIMENTAL.
...
Esta opção está disponível para experimentar com PGO com GCC. Veja `cmake/fprofile.cmake` na distribuição de origem do MySQL para informações sobre o uso de `FPROFILE_GENERATE` e `FPROFILE_USE`. Estas opções foram testadas com GCC 8 e 9.

- `-DFPROFILE_USE=bool`

Se usar dados de otimização guiada por perfil (PGO). Esta opção está disponível para experimentar com PGO com GCC. Veja o arquivo `cmake/fprofile.cmake` em uma distribuição de origem MySQL para informações sobre o uso de `FPROFILE_GENERATE` e `FPROFILE_USE`. Estas opções foram testadas com GCC 8 e 9.

Ativar `FPROFILE_USE` também ativa `WITH_LTO`.

- `-DHAVE_PSI_MEMORY_INTERFACE=bool`

Se deve ser habilitado o módulo de rastreamento de memória do esquema de desempenho para funções de alocação de memória (funções de biblioteca `ut::aligned_name`) utilizadas no armazenamento dinâmico de tipos sobrealinhados.
...
Se habilitar um ambiente de desenvolvimento específico para o mantenedor do MySQL. Se ativada, esta opção faz com que os avisos do compilador se tornem erros.

- `-DWITH_DEVELOPER_ENTITLEMENTS=bool`

Se adicionar o direito `get-task-allow` a todos os executáveis para gerar um core dump no caso de uma parada inesperada do servidor.
...
- `event`: Use mutex de evento. Este é o valor padrão e a implementação original de mutex `InnoDB`.
- `sys`: Use mutex POSIX em sistemas UNIX. Use objetos `CRITICAL_SECTION` no Windows, se disponível.
- `futex`: Use futexes do Linux em vez de variáveis de condição para agendar tópicos de espera.
...
O número de porta em que o servidor escuta para conexões TCP/IP. O padrão é 3306.
...
Defina o caminho para o Ant, necessário ao construir o wrapper do Java GCS. Defina `WITH_ANT` para o caminho de um diretório onde o Ant tarball ou arquivo desempacotado é salvo. Quando `WITH_ANT` não é definido, ou é definido com o valor especial `system`, o processo de compilação assume que um `ant` binário existe no `$PATH`.

- `-DWITH_ASAN=bool`

Se o AddressSanitizer deve ser ativado, para compiladores que o suportam. O padrão é `OFF`.
...
A localização do kit de desenvolvimento de software do Amazon Web Services.

- `-DWITH_CLIENT_PROTOCOL_TRACING=bool`

Se a estrutura de rastreamento do protocolo do lado do cliente deve ser construída na biblioteca do cliente. Por padrão, esta opção está habilitada.
...
A localização da biblioteca `curl` \* `curl_type` \* pode ser `system` (use a biblioteca do sistema `curl`), um nome de caminho para a biblioteca `curl`, `no` \* `off` \* `none` para desativar o suporte ao curl, ou `bundled` para usar a distribuição de curl em bundle no `extra/curl/`.
...
Ativação de `WITH_INNODB_EXTRA_DEBUG` ativa verificações de depuração de erros InnoDB extra. Esta opção só pode ser ativada quando `WITH_DEBUG` está ativado.

- `-DWITH_JEMALLOC=bool`

Se ligar com `-ljemalloc`. Se ativado, as rotinas `malloc()`, `calloc()`, `realloc()`, e `free()` são desativadas. O padrão é `OFF`.

`WITH_JEMALLOC` e `WITH_TCMALLOC` são mutuamente exclusivas.

- `-DWITH_LIBEVENT=string`

Qual biblioteca `libevent` usar. Os valores permitidos são `bundled` (padrão) e `system`. Se o `system` é especificado e nenhuma biblioteca `libevent` do sistema pode ser encontrada, um erro ocorre independentemente e o `libevent` não é usado.

A biblioteca `libevent` é necessária pelo Plugin X e pelo Roteador MySQL.
...
Se o link-time optimizer deve ser ativado, se o compilador o suporta. O padrão é `OFF` a menos que `FPROFILE_USE` esteja ativado.
...
Use esta opção para compilar o parser do MeCab. Se você instalou o MeCab no seu diretório de instalação padrão, defina `-DWITH_MECAB=system`. A opção `system` se aplica às instalações do MeCab realizadas a partir de código-fonte ou de binários usando um utilitário de gerenciamento de pacotes nativo. Se você instalou o MeCab em um diretório de instalação personalizado, especifique o caminho para a instalação do MeCab, por exemplo, `-DWITH_MECAB=/opt/mecab`. Se a opção `system` não funcionar, especificar o caminho de instalação do MeCab deve funcionar em todos os casos.

Para informações relacionadas, ver Secção 14.9.9, "MeCab Full-Text Parser Plugin".
...
Se deve construir com suporte para o X Plugin. O padrão é `ON`. Veja Capítulo 22, *Using MySQL as a Document Store*.
...
Para bandeiras tipicamente usadas para pacotes RPM e Debian, se devem ser adicionadas a compilações autônomas nessas plataformas. O padrão é `ON` para compilações não depuradas.
...
O tipo de suporte à biblioteca RapidJSON a ser incluído. `rapidjson_type` pode ser um dos seguintes valores:
...
- `ssl_type` pode ser um dos seguintes valores:
  ...
  - `system`: Use a biblioteca OpenSSL do sistema. Este é o padrão.
    ...
    Em macOS e Windows, usando `system` configura o MySQL para construir como se o CMake fosse invocado com \* `path_name` \* aponta para uma biblioteca OpenSSL instalada manualmente. Isso ocorre porque eles não têm bibliotecas SSL do sistema. No macOS, \* brew install abre as instalações do SSL \* para `/usr/local/opt/openssl` para que `system` possa encontrá-lo. No Windows, ele verifica `%ProgramFiles%/OpenSSL`, `%ProgramFiles%/OpenSSL-Win32`, `%ProgramFiles%/OpenSSL-Win64`, `C:/OpenSSL`, `C:/OpenSSL-Win32`, e `C:/OpenSSL-Win64`.
...
- `path_name` é o nome do caminho para a instalação do OpenSSL. Isso pode ser preferível ao uso do `ssl_type` valor `system` porque pode impedir que o CMake detecte e use uma versão mais antiga ou incorreta do OpenSSL instalada no sistema. (Outra maneira permitida de fazer a mesma coisa é definir `WITH_SSL` para `system` e definir a opção `CMAKE_PREFIX_PATH` para \*`path_name`) \*

Para obter informações adicionais sobre a configuração da biblioteca SSL, consulte a Secção 2.8.6, "Configuração do suporte da biblioteca SSL".
...
Se deve permitir a instalação de arquivos de suporte \*\* systemd \*\*. Por padrão, essa opção está desativada. Quando ativada, os arquivos de suporte \*\* systemd \*\* são instalados e scripts como \*\* mysqld\_safe \*\* e o script de inicialização do System V não são instalados. Em plataformas onde \*\* systemd \*\* não está disponível, habilitar `WITH_SYSTEMD` resulta em um erro do \*\* CMake \*\*.
...
Se ligar com `-ltcmalloc`. Se ativado, as rotinas `malloc()`, `calloc()`, `realloc()`, e `free()` são desativadas. O padrão é `OFF`.
...
Se construir o plug-in do cliente de rastreamento do protocolo de teste (ver Usando o Plug-in de rastreamento do protocolo de teste). Por padrão, essa opção está desativada. Ativar essa opção não tem efeito a menos que a opção `WITH_CLIENT_PROTOCOL_TRACING` esteja ativada. Se o MySQL estiver configurado com ambas as opções ativadas, a biblioteca do cliente `libmysqlclient` é criada com o plug-in de rastreamento do protocolo de teste incorporado e todos os clientes padrão do MySQL carregam o plug-in. No entanto, mesmo quando o plug-in de teste está ativado, ele não tem efeito por padrão. O controle sobre o plugin é oferecido usando variáveis de ambiente; veja Usando o Plug-in de rastreamento do protocolo de teste.

::: info Note

Se você já criou o MySQL com o plugin de rastreamento de protocolo de teste ativado para ver como ele funciona, você deve reconstruir o MySQL sem ele antes de poder usar seus próprios plugins.
...
Se ativar o Desinfetador de Comportamento Não Definido, para compiladores que o suportam.

- `-DWITH_UNIT_TESTS={ON|OFF}`

Se ativado, compile o MySQL com testes unitários. O padrão é `ON` a menos que o servidor não esteja sendo compilado.

- `-DWITH_UNIXODBC=1`

Permite o suporte unixODBC, para Connector/ODBC.
...
Alguns recursos exigem que o servidor seja construído com suporte à biblioteca de compressão, como as funções `COMPRESS()` e `UNCOMPRESS()`, e compressão do protocolo cliente/servidor. A opção `WITH_ZLIB` indica a fonte de suporte a `zlib`:
...
A compressão de conexão usando o algoritmo `zstd` (ver Seção 6.2.8, Connection Compression Control) requer que o servidor seja construído com suporte à biblioteca `zstd`. A opção `WITH_ZSTD` indica a fonte de suporte ao `zstd`:
...
Se construir sem o MySQL Server. O padrão é OFF, que faz construir o servidor.
...
Controla se os utilitários NDB, como **ndb\_drop\_table**, estão ligados com o `ndbclient` estaticamente (`OFF`) ou dinamicamente (`ON`); `OFF` (ligação estática) é o padrão. Normalmente, a ligação estática é usada ao construí-los para evitar problemas com o `LD_LIBRARY_PATH`, ou quando várias versões do `ndbclient` estão instaladas. Esta opção destina-se a criar imagens do Docker e possivelmente outros casos em que o ambiente de destino está sujeito a controle preciso e é desejável reduzir o tamanho da imagem.

- `-DWITH_CLASSPATH=path`

Define o caminho de classe para construir o MySQL NDB Cluster Connector para Java. O padrão é vazio. Esta opção é ignorada se `-DWITH_NDB_JAVA=OFF` for usado.
...
Construa programas de exemplo da API do NDB em `storage/ndb/ndbapi-examples/`. Veja Exemplos da API do NDB, para informações sobre estes.
...
Ativar a construção das versões de depuração dos binários do cluster NDB. Este é o `OFF` por padrão.
...
Faz com que o servidor de gerenciamento de cluster NDB (**ndb\_mgmd**) que é construído use esta `port` por padrão. Se esta opção for desativada, o servidor de gerenciamento resultante tentará usar a porta 1186 por padrão.
...
Defina o caminho padrão pesquisado por **ndb\_sign\_keys** e outros programas `NDB` para arquivos de certificado e chave TLS.

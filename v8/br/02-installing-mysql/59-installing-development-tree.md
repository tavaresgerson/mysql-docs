...
Para instalar o MySQL a partir de uma árvore de origem de desenvolvimento, seu sistema deve satisfazer os requisitos da ferramenta listados na Seção 2.8.2, "Precondições de Instalação de Fonte".

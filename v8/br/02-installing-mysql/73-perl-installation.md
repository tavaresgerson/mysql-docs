...
Os arquivos necessários para o suporte ao Perl podem ser obtidos no CPAN (Comprehensive Perl Archive Network) em \[<http://search.cpan.org>]<http://search.cpan.org>].
...
2. Alterar localização no diretório de nível superior da distribuição desembalada:

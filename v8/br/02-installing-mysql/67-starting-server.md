...
Se você tiver outros problemas ao iniciar o servidor, consulte a Seção 2.9.2.1, "Solução de Problemas ao iniciar o MySQL Server". Para mais informações sobre `mysqld_safe`, consulte a Seção 6.3.2, "mysqld\_safe" "MySQL Server Startup Script". Para mais informações sobre o suporte do systemd, consulte a Seção 2.5.9, "Gerenciamento do MySQL Server com o systemd".

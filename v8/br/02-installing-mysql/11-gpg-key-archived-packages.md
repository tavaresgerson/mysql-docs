...
A seguinte chave de compilação pública GPG (keyID `3A79BD29`) pode ser usada para verificar a autenticidade e integridade dos pacotes MySQL versões 8.0.28 a 8.0.35, 8.1.0 e 8.2.0.
...
A seguinte chave de compilação pública do GPG (keyID `5072E1F5`) pode ser usada para verificar a autenticidade e integridade dos pacotes do MySQL 8.0.27 e anteriores.

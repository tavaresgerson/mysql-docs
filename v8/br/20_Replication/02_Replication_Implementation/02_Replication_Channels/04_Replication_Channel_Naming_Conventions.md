...
Cada canal de replicação tem um nome único, que é uma string com um comprimento máximo de 64 caracteres e é case-insensitive. Como os nomes dos canais são usados no repositório de metadados do aplicativo da réplica, o conjunto de caracteres usado para esses é sempre UTF-8. Embora você geralmente possa usar qualquer nome para os canais, os seguintes nomes estão reservados:

...
O MySQL Server não suporta a extensão `SELECT ... INTO TABLE` do Sybase SQL. Em vez disso, o MySQL Server suporta a sintaxe SQL padrão `INSERT INTO ... SELECT`, que é basicamente a mesma coisa. Veja a Seção 15.2.7.1, “Instrução INSERT ... SELECT”. Por exemplo:

### 10.14.8 Estados de Fios de Clúster NDB
...
* `Parando`
* `Sincronizando a operação de esquema da tabela ndb e o binlog`
...
* `Aguardando evento do ndbcluster`
  ...
  O servidor está atuando como um nó SQL em um Clúster NDB e está conectado a um nó de gerenciamento de clúster.

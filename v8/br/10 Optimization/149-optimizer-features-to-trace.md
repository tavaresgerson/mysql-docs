...
Alguns recursos do otimizador podem ser acionados várias vezes durante a otimização e execução de instruções, o que pode fazer com que o rastreamento cresça além do que é razoável. Eles são:
...
* *Subconsultas*: Uma subconsulta na qual a cláusula `WHERE` pode ser executada uma vez por registro.

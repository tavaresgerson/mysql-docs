...
3. Mover o diretório do banco de dados para um disco onde você tenha espaço livre. Por exemplo, use `tar` ou `mv`. Se você usar um método que copia em vez de mover o diretório do banco de dados, remova o diretório do banco de dados original após copiá-lo.

...
As funções embutidas do MySQL são tipicamente altamente otimizadas, mas pode haver algumas exceções. `BENCHMARK()` é uma excelente ferramenta para descobrir se alguma função está causando problemas para suas consultas.
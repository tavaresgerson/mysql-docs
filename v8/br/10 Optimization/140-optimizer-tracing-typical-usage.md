...
2. Execute a instrução a ser rastreada. Consulte a Seção 10.15.3, “Instruções Rastreadas”, para uma lista de instruções que podem ser rastreadas.
...
Você pode rastrear apenas instruções executadas dentro da sessão atual; não é possível ver rastros de outras sessões.
#### 1.7.2.4 `'--'` como o início de um comentário
...
Considere o que acontece quando `charge` tem um valor negativo como `-1`, o que pode ser o caso quando um valor é creditado na conta.

## 17.9 Compressão de Tabelas e Páginas do InnoDB

17.9.1 Compressão de Tabelas InnoDB

17.9.2 Compressão de Páginas do InnoDB

Esta seção fornece informações sobre as funcionalidades de compressão da tabela `InnoDB` e compressão de página `InnoDB`. O recurso de compressão de página também é conhecido como compressão transparente de página.

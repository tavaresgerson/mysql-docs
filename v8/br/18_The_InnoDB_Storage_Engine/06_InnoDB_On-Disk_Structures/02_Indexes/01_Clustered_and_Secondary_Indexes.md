#### 17.6.2.1 Indekses agrupados e secundários
...
Para obter orientações sobre como aproveitar os índices agrupados e secundários `InnoDB`, consulte a Seção 10.3, “Otimização e índices”.

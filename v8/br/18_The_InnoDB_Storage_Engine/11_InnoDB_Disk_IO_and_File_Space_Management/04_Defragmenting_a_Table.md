...
Tanto o `ALTER TABLE tbl_name ENGINE=INNODB` quanto o `ALTER TABLE tbl_name FORCE` utilizam DDL online. Para mais informações, consulte a Seção 17.12, “InnoDB e DDL Online”.
...
Se as inserções em um índice forem sempre ascendentes e os registros forem excluídos apenas do final, o algoritmo de gerenciamento do espaço de armazenamento `InnoDB` garante que a fragmentação no índice não ocorra.

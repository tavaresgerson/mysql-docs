## 17.11 Gerenciamento de I/O de disco e espaço de arquivo do InnoDB

17.11.1 I/O de disco InnoDB

17.11.1 Gerenciamento de Espaço em Arquivos

17.11.3 Pontos de verificação do InnoDB

17.11.4 Desfragmentação de uma Tabela

17.11.5 Recuperação do Espaço em Disco com TRUNCATE TABLE
...
Esta seção discute as principais considerações para I/O e espaço em disco com o tipo padrão de tabelas do MySQL (também conhecidas como tabelas `InnoDB`):

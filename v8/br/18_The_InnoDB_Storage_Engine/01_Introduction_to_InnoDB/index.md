...
- A lista de aprimoramentos `InnoDB` na Seção 1.3, “O que há de novo no MySQL 8.0”.
...
- `InnoDB` é publicado sob a mesma Licença GPL Versão 2 (de junho de 1991) do MySQL. Para mais informações sobre a licença do MySQL, consulte <http://www.mysql.com/company/legal/licensing/>.

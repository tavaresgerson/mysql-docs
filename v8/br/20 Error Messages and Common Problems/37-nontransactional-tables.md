...
Veja a Seção 15.7.7.38, “Instrução SHOW TABLE STATUS”, e a Seção 15.7.7.11, “Instrução SHOW CREATE TABLE”.
...
Veja a Seção 15.7.7.17, “Instrução SHOW ENGINES” para detalhes completos.
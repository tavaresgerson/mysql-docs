...
4. Faça uma  `SELECT` para a coluna que deveria ter correspondido a uma linha contra a tabela que foi removida da consulta.
...
Anexe o arquivo de teste a um relatório de bug, que você pode registrar seguindo as instruções na Seção 1.6, “Como Relatar Bugs ou Problemas”.
...
*  Interface de Mensagem de Erro Cliente
...
* A instrução `GET DIAGNOSTICS` pode ser usada para inspecionar as informações diagnósticas na área de diagnóstico. Veja a Seção 15.6.7.3, “Instrução GET DIAGNOSTICS”.
...
Os programas cliente recebem erros de duas fontes:
...
Independentemente de um erro se originar dentro da biblioteca do cliente ou ser recebido do servidor, um programa cliente MySQL obtém o código de erro, o valor SQLSTATE, a string de mensagem e outras informações relacionadas, chamando funções da API C na biblioteca do cliente:
...
Para descrições das funções de erro da biblioteca do cliente, consulte o  MySQL 8.4 C API Developer Guide.
...
O programa `perror` fornece informações da linha de comando sobre números de erro. Consulte  Seção 6.8.1, “perror — Display MySQL Error Message Information”.
...
Para erros do MySQL NDB Cluster, use **ndb\_perror**. Consulte  Seção 25.5.16, “ndb\_perror — Obtain NDB Error Message Information”.

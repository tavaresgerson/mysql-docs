...
* Outros threads podem estar esperando pela tabela que causou a condição de disco cheio. Se você tiver vários threads “bloqueados”, matar o thread que está esperando pela condição de disco cheio permite que os outros threads continuem.

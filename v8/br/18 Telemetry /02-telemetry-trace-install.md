...
Se `component_telemetry` estiver presente na coluna `component_urn`, o componente foi instalado.

A instalação do componente também adiciona variáveis de sistema específicas para a telemetria.
...
Consulte Configuração do Servidor.

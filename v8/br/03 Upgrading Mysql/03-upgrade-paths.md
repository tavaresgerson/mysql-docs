...
- Certifique-se de que você entende \[o modelo de lançamento do MySQL] (mysql-releases.html) para o MySQL para as versões de suporte de longo prazo (LTS) e inovação do MySQL antes de prosseguir com uma atualização.

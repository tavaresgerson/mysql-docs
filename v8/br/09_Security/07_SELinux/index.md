...
8.7.1 Verifique se o SELinux está ativado

8.7.2 Alterando o Modo SELinux
...
Um contexto SELinux (o rótulo aplicado a um objeto do sistema) tem os seguintes campos: `user`, `role`, `type` e `security level`. A informação de tipo, em vez do contexto SELinux inteiro, é comumente usada para definir regras sobre como os processos interagem com outros objetos do sistema. Os módulos de políticas SELinux do MySQL, por exemplo, definem regras de política usando informações `type`.

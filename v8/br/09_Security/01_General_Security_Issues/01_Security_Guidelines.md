...
- Saiba como o sistema de privilégios de acesso do MySQL funciona (consulte a Seção 8.2, “Controle de Acesso e Gerenciamento de Contas”). Use as instruções `GRANT` e `REVOKE` para controlar o acesso ao MySQL. Não conceda mais privilégios do que o necessário. Nunca conceda privilégios a todos os hosts.
...
- As aplicações que acessam o MySQL não devem confiar em nenhum dado inserido pelos usuários e devem ser escritas usando técnicas de programação defensiva adequadas. Veja a Seção 8.1.7, “Diretrizes de Segurança para Programação de Clientes”.

...
Criar um banco de dados não o seleciona para uso; você deve fazer isso explicitamente. Para tornar o `menagerie` o banco de dados atual, use esta instrução:

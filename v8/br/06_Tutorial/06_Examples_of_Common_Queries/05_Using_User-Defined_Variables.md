...
Você pode usar variáveis de usuário do MySQL para lembrar os resultados sem precisar armazená-los em variáveis temporárias no cliente. (Veja a Seção 11.4, “Variáveis Definidas pelo Usuário”.)

...
Você também pode fazer isso classificando todas as linhas em ordem decrescente de preço e obtendo apenas a primeira linha usando a cláusula específica do MySQL `LIMIT`, assim:

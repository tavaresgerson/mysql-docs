...
A maioria das palavras-chave não reservadas é permitida como identificadores sem aspas. Algumas palavras-chave que, de outra forma, são consideradas não reservadas, estão restritas ao uso como identificadores não citados para funções, rótulos de programas armazenados ou, em alguns casos, para ambos. Consulte Palavras-chave restritas do MySQL 8.0 para listas dessas palavras-chave.

Palavras reservadas são permitidas como identificadores se você as citar conforme descrito na Seção 11.2, “Nomes de Objetos do Esquema”:
...
Os nomes das funções embutidas são permitidos como identificadores, mas podem exigir cuidado para serem usados como tais. Por exemplo, `COUNT` é aceitável como nome de coluna. No entanto, por padrão, não há espaço em branco permitido em invocações de função entre o nome da função e o caractere seguinte `(`. Essa exigência permite que o analisador distinga se o nome é usado em uma chamada de função ou em um contexto não funcional. Para mais detalhes sobre o reconhecimento de nomes de funções, consulte a Seção 11.2.5, “Análise e Resolução de Nomes de Função”.

A tabela `INFORMATION_SCHEMA.KEYWORDS` lista as palavras consideradas palavras-chave pelo MySQL e indica se elas são reservadas. Veja a Seção 28.3.17, “A tabela INFORMATION\_SCHEMA KEYWORDS”.
...
A lista a seguir mostra as palavras-chave e as palavras reservadas no MySQL 8.0, juntamente com as alterações nas palavras individuais de uma versão para outra. As palavras-chave reservadas são marcadas com (R). Além disso, `_FILENAME` está reservado.
...
- `ROW_COUNT`
- `ROW_FORMAT`
- `ROW_NUMBER` (R); adicionado em 8.0.2 (reservado)
- `RTREE`
...
- `SOURCE_LOG_FILE`; adicionado em 8.0.23 (não reservado)
- `SOURCE_LOG_POS`; adicionado em 8.0.23 (não reservado)
- `SOURCE_PASSWORD`; adicionado em 8.0.23 (não reservado)
- `SOURCE_PORT`; adicionado em 8.0.23 (não reservado)
- `SOURCE_PUBLIC_KEY_PATH`; adicionado em 8.0.23 (não reservado)
- `SOURCE_RETRY_COUNT`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CA`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CAPATH`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CERT`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CIPHER`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CRL`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_CRLPATH`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_KEY`; adicionado em 8.0.23 (não reservado)
- `SOURCE_SSL_VERIFY_SERVER_CERT`; adicionado em 8.0.23 (não reservado)
- `SOURCE_TLS_CIPHERSUITES`; adicionado em 8.0.23 (não reservado)
- `SOURCE_TLS_VERSION`; adicionado em 8.0.23 (não reservado)
- `SOURCE_USER`; adicionado em 8.0.23 (não reservado)
- `SOURCE_ZSTD_COMPRESSION_LEVEL`; adicionado em 8.0.23 (não reservado)
- `SPATIAL` (R)
- `SPECIFIC` (R)
- `SQL` (R)
- `SQLEXCEPTION` (R)
...
- `SQL_TSI_WEEK`
- `SQL_TSI_YEAR`
- `SRID`; adicionado em 8.0.3 (não reservado)
- `SSL` (R)
- `STACKED`
- `START`
- `STARTING` (R)
...
- `STORED` (R)
- `STRAIGHT_JOIN` (R)
- `STREAM`; adicionado em 8.0.20 (não reservado)
- `STRING`
- `SUBCLASS_ORIGIN`
- `SUBJECT`
- `SUBPARTITION`
...
- `SWAPS`
- `SWITCHES`
- `SYSTEM` (R); adicionado em 8.0.3 (reservado)

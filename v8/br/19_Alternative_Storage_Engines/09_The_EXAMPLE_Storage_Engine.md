...
Quando você cria uma tabela `EXAMPLE`, nenhum arquivo é criado. Nenhuma informação pode ser armazenada na tabela. As consultas retornam um resultado vazio.
...
O motor de armazenamento `EXAMPLE` não suporta particionamento.
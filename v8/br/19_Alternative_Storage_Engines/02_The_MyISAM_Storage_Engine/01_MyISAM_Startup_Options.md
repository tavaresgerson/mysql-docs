...
- `delay_key_write=ALL`
  ...
  Não descarte os buffers de chave entre os escritos para qualquer tabela `MyISAM`.
...
Se você especificar `FORCE`, uma mensagem de alerta como esta será escrita:

```
Warning: Found 344 of 354 rows when repairing ./test/g00pages
```

Se o valor de recuperação automática incluir `BACKUP`, o processo de recuperação criará arquivos com nomes do tipo `tbl_name-datetime.BAK`. Você deve ter um **cron** script que mova automaticamente esses arquivos dos diretórios do banco de dados para os meios de backup.

...
O mecanismo de armazenamento `CSV` armazena dados em arquivos de texto usando o formato de valores separados por vírgula.
...
Quando você cria uma tabela `CSV`, o servidor cria um arquivo de dados em texto simples com um nome que começa com o nome da tabela e tem a extensão `.CSV`. Quando você armazena dados na tabela, o mecanismo de armazenamento os salva no arquivo de dados no formato de valores separados por vírgula.

...
Para reparar uma tabela, use `REPAIR TABLE`, que copia o maior número possível de linhas válidas dos dados existentes da `CSV` e, em seguida, substitui o arquivo existente da `CSV` pelo arquivo recuperado. Quaisquer linhas além dos dados corrompidos são perdidas.

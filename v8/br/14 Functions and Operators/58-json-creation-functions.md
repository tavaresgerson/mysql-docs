...
*  `JSON_QUOTE(string)`
  ...
  Certos caracteres especiais são escapados com barras invertidas de acordo com as sequências de escape mostradas na Tabela 14.23, “Sequências de escape especiais JSON_UNQUOTE()”.

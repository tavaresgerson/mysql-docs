...
* Uma unidade é suportada se ela for encontrada na tabela `INFORMATION_SCHEMA` `ST_UNITS_OF_MEASURE`. Veja a Seção 28.3.37, “A Tabela `INFORMATION_SCHEMA` ST_UNITS_OF_MEASURE”.

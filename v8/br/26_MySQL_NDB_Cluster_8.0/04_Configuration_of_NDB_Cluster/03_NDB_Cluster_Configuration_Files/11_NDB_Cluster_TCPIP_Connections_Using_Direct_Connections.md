...
Para configurar um clúster usando conexões diretas entre os nós de dados, é necessário especificar explicitamente os endereços IP de crossover dos nós de dados conectados na seção `[tcp]` do arquivo do clúster `config.ini`.

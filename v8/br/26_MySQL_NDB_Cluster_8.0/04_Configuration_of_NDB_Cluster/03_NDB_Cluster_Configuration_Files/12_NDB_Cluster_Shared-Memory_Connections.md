...
- Configurando o parâmetro de configuração do nó de dados `UseShm` para `1` e configurando `HostName` para o nó de dados e `HostName` para o nó da API com o mesmo valor.
...
Antes de iniciar nós de dados que utilizam conexões SHM, também é necessário garantir que o sistema operacional de cada computador que hospeda um desses nós de dados tenha memória suficiente alocada para os segmentos de memória compartilhada. Consulte a documentação da sua plataforma operacional para obter informações sobre isso. Em configurações em que vários hosts estão executando cada um um nó de dados e um nó de API, é possível habilitar a memória compartilhada em todos esses hosts, definindo `UseShm` na seção `[ndbd default]` do arquivo de configuração. Isso é mostrado no exemplo mais adiante nesta seção.
...
- `SendSignalId`: Indica que um ID de sinal está incluído em cada sinal enviado através do transportador.

- `Checksum`: Indica que um checksum está incluído em cada sinal enviado através do transportador.

- `PreSendChecksum`: As verificações do checksum são feitas antes de enviar o sinal; o checksum também deve estar ativado para que isso funcione
...
- `Group`
  ...
  <table summary="Tipo e valor de parâmetro de configuração da memória em grupo" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>não assinado</td> </tr><tr> <th>Padrão</th> <td>35</td> </tr><tr> <th>Gama</th> <td>0 - 200</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>
...
- `HostName1`
  ...
  <table summary="Tipo e valor da informação do parâmetro de configuração da memória HostName1" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>nome ou endereço IP</td> </tr><tr> <th>Padrão</th> <td>[...]</td> </tr><tr> <th>Gama</th> <td>...</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>
...
- `HostName2`
  ...
  <table summary="Tipo e valor de parâmetro de configuração de memória hospedeira HostName2" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>nome ou endereço IP</td> </tr><tr> <th>Padrão</th> <td>[...]</td> </tr><tr> <th>Gama</th> <td>...</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>

  Os parâmetros `HostName1` e `HostName2` podem ser usados para especificar interfaces de rede específicas a serem utilizadas para uma conexão SHM específica entre dois nós. Os valores usados para esses parâmetros podem ser nomes de host ou endereços IP.

- `NodeId1`

  <table summary="Tipo e valor da informação do parâmetro de configuração da memória de nó Id1" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>numérico</td> </tr><tr> <th>Padrão</th> <td>[nenhum]</td> </tr><tr> <th>Gama</th> <td>1 - 255</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>
...
- `NodeId2`
  ...
  <table summary="Tipo e valor da informação do parâmetro de configuração da memória compartilhada NodeId2" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>numérico</td> </tr><tr> <th>Padrão</th> <td>[nenhum]</td> </tr><tr> <th>Gama</th> <td>1 - 255</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>

  Para identificar uma conexão entre dois nós, é necessário fornecer os identificadores de nó para cada um deles, como `NodeId1` e `NodeId2`.

- `NodeIdServer`

  <table summary="Tipo e valor da informação do parâmetro de configuração da memória compartilhada NodeIdServer" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>numérico</td> </tr><tr> <th>Padrão</th> <td>[nenhum]</td> </tr><tr> <th>Gama</th> <td>1 - 63</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>

  Identifique o final do servidor de uma conexão de memória compartilhada. Por padrão, este é o ID do nó do nó de dados.

- `OverloadLimit`

  <table summary="Tipo e valor da informação do parâmetro de configuração de memória de sobrecarga do OverloadLimit" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>bytes</td> </tr><tr> <th>Padrão</th> <td>0</td> </tr><tr> <th>Gama</th> <td>0 - 4294967039 (0xFFFFFEFF)</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>

  Quando houver mais de esse número de bytes não enviados no buffer de envio, a conexão será considerada sobrecarregada. Consulte a Seção 25.4.3.14, “Configurando Parâmetros do Buffer de Envio do NDB Cluster”, e a Seção 25.6.16.65, “A Tabela de Transportadores ndbinfo”, para obter mais informações.

- `PreSendChecksum`

  <table summary="Parâmetro de configuração de memória compartilhada PreSendChecksum tipo e informações de valor" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>booleano</td> </tr><tr> <th>Padrão</th> <td>falsa</td> </tr><tr> <th>Gama</th> <td>verdadeiro, falso</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>

  Se este parâmetro e `Checksum` estiverem ativados, realize verificações de checksum pré-envio e verifique todos os sinais SHM entre os nós em busca de erros. Não tem efeito se `Checksum` não estiver também ativado.

- `SendBufferMemory`

  <table summary="Tipo e valor da informação do parâmetro de configuração da memória compartilhada SendBufferMemory" width="35%"><tbody><tr> <th>Versão (ou posterior)</th> <td>NDB 8.0.13</td> </tr><tr> <th>Tipo ou unidades</th> <td>inteiro</td> </tr><tr> <th>Padrão</th> <td>2M</td> </tr><tr> <th>Gama</th> <td>256K - 4294967039 (0xFFFFFEFF)</td> </tr><tr> <th>Tipo de reinício</th> <td><p> <span class="bold"><strong>Reiniciar o nó:</strong></span>Requer um reinício contínuo do clúster. (NDB 8.0.13)</p></td> </tr></tbody></table>
...
- `SendSignalId`
  ...
  Para rastrear o caminho de uma mensagem distribuída, é necessário atribuir um identificador único a cada mensagem. Definir este parâmetro para `Y` faz com que esses IDs de mensagem sejam transportados pela rede também. Este recurso é desativado por padrão em builds de produção e ativado em builds de `-debug`.
...
- `ShmKey`
  ...
  Ao configurar segmentos de memória compartilhada, um ID de nó, expresso como um inteiro, é usado para identificar de forma única o segmento de memória compartilhada a ser usado para a comunicação. Não há um valor padrão. Se `UseShm` estiver habilitado, a chave da memória compartilhada é calculada automaticamente pelo `NDB`.

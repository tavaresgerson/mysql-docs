...
**Opções obrigatórias do my.cnf para nós SQL.** Os servidores MySQL que atuam como nós SQL do NDB Cluster devem ser iniciados sempre com as opções `--ndbcluster` e `--ndb-connectstring`, na linha de comando ou no `my.cnf`.

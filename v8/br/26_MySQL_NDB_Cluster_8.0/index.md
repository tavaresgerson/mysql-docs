...
25.6 Gerenciamento do NDB Cluster:   25.6.1 Comandos no Cliente de Gerenciamento do NDB Cluster
...
25.7 Replicação de NDB Cluster:   25.7.1 Replicação de NDB Cluster: Abreviações e Símbolos

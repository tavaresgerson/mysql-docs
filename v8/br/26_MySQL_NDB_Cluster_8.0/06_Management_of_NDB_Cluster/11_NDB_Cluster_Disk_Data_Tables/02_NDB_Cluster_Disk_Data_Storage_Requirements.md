...
- Colunas de comprimento variável das tabelas de Dados de disco ocupam um espaço fixo. Para cada linha, isso equivale ao espaço necessário para armazenar o valor maior possível para essa coluna.
  ...
  Para obter informações gerais sobre o cálculo desses valores, consulte a Seção 13.7, “Requisitos de Armazenamento de Tipo de Dados”.

  Você pode obter uma estimativa do espaço disponível em arquivos de dados e arquivos de registro de desfazer consultando a tabela do esquema de informações `FILES`. Para obter mais informações e exemplos, consulte a Seção 28.3.15, “A tabela INFORMATION\_SCHEMA FILES”.

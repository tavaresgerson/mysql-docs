...
A coluna `tc_block_instance` fornece o número da instância do bloco `DBTC`. Você pode usar isso junto com o nome do bloco para obter informações sobre threads específicas da tabela `threadblocks`.

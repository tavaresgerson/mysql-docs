...
A tabela `disk_write_speed_aggregate_node` fornece informações agregadas por nó sobre a velocidade de escrita em disco durante operações de LCP, backup e restauração.

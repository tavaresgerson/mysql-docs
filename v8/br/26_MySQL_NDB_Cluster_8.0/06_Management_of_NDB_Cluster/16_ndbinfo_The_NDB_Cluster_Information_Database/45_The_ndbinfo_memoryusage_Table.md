#### 25.6.16.45 Tabela ndbinfo memoryusage
...
Neste caso, os valores da coluna `total` para a memória de índice são ligeiramente maiores que o valor definido para `IndexMemory`, devido à arredondamento interno.

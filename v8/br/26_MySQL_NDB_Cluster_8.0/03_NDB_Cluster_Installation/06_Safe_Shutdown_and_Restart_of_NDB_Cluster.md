...
Nas plataformas Windows, assumindo que você instalou todos os processos do NDB Cluster como serviços do Windows usando os nomes de serviço padrão (consulte a Seção 25.3.2.4, “Instalando Processos do NDB Cluster como Serviços do Windows”), você pode reiniciar o cluster da seguinte forma:
...
- No nó de gerenciamento, use o cliente **ndb\_mgm** para verificar se o nó de gerenciamento e ambos os nós de dados iniciaram com sucesso (consulte a Seção 25.3.2.3, “Início Inicial do NDB Cluster no Windows”).
